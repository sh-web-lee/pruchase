...
<html lang="nl">
	<head>
		...
		<title>Bespaar tot wel 70% op Smart Defrag PRO – Speciale aanbieding van IObit</title>
	...
	<script type="text/javascript" src="<?php echo $pRootUrl; ?>tpl/js/stats.js"></script>
		...
		<div class="header">
			<div class="wrapper">
				...
				<h1>Tot wel 70% KORTING Flash Sale €40 aan gifts met SD 7 PRO</h1>
			...
			<div class="content">
				...
				<div class="right">
					<dl class="message">
						<dt><strong>Smart Defrag 7 PRO <span>(1 Jaar/ 1 PC)</span></strong> <b>€19,99</b> <del>€29,99</del></dt>
					...
					<dl class="buy">
						...
						<dd><a href="https://www.iobit.com/buy.php?product=nl-sd61y3pcamc1999&ref=nl_sd73pcamcpurchase2105<?php echo $refStr;?>&refs=nl_purchase_sd" onclick="ga('send', 'event', 'sdbuy', 'buy', 'sdpurchase1807-nl')" class="buybtn">Activeer Nu</a></dd>
      ...
      <li>
		...
		<div class="wrapper sd-content clearfix">
			<h2>Maximaliseer de harde schijf prestaties en snelheid van uw PC met SD 7 PRO</h2>
			<dl>
		...
		<div class="wrapper between-buy clearfix">
			...
			<div class="pop-content hidden">
				...
				<dl>
					...
					<dd>De licentie code van Smart Defrag 7 PRO ondersteunt 2 pc's extra, zodat u deze kunt delen met uw familie en vrienden!</dd>
      ...
      <table border="0" cellspacing="0" cellpadding="0" width="100%">
        ...
        <tr>
          ...
          <th class="itema"><span>SD PRO + Gratis Geschenk</span>
            <span class="last"><strong>€19,99</strong> <del>€69,97</del></span>
            1 Jaar / 3 PCs
            <a href="https://www.iobit.com/buy.php?product=nl-sd61y3pcamc1999&ref=nl_sd73pcamcpurchase2105<?php echo $refStr;?>&refs=nl_purchase_sd" onclick="ga('send', 'event', 'sdbuy', 'buy', 'sdpurchase1807-nl')" class="tbbuybtn">Activeer Nu</a>
        ...
        <tfoot>
	        <tr>
	          <th colspan="2"></th>
	          <th class="itemb">Smart Defrag FREE</th>
	          <th class="itema"><span>Smart Defrag PRO <br>+ Gratis Geschenk</span>
	           </th>
	        </tr>
        </tfoot>
      </table>
  ...
  <div class="fy-banner wrapper">
  	...
  	<dl>
  		...
  		<dt>
  			<a href="https://www.iobit.com/buy.php?product=nl-sd61y3pcamc1999&ref=nl_sd73pcamcpurchase2105<?php echo $refStr;?>&refs=nl_purchase_sd" onclick="ga('send', 'event', 'sdbuy', 'buy', 'sdpurchase1807-nl')" class="buybtn">Activeer Nu</a>
  		</dt>
  	</dl>
  </div>
