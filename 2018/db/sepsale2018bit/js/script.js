...
function soldoutGift() {
  ...
  // 1anno/5pc db
  $(".bottom-buy .message del").html("99,99");
  $(".bottom-buy .message strong").html("27");
  $(".gift-message .buybtn,.gift-message .buybtn").attr("href", "http://www.iobit.com/buy.php?product=it-db65pc2799&ref=it_db65pc2799purchase1809b"+refStr+"&refs=it_purchase_db").attr("onclick", "ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase5PC1809b-it')");
}
// 1anno/3pc db
function onePc() {
  $(".bottom-buy .buybtn").attr("href", " http://www.iobit.com/buy.php?product=it-db63pc2599&ref=it_db63pc2599purchase1809b"+refStr+"&refs=it_purchase_db");
  $(".bottom-buy .buybtn").attr("onclick", "ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase3PC1809b-it')");
...
// 1anno/5pc db
function threePc() {
  $(".bottom-buy .buybtn").attr("href", "http://www.iobit.com/buy.php?product=it-db65pc2799&ref=it_db65pc2799purchase1809b"+refStr+"&refs=it_purchase_db");
  $(".bottom-buy .buybtn").attr("onclick", "ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase5PC1809b-it')");
  $(".bottom-buy .message del").html("99,99");
  $(".bottom-buy .message strong").html("27");
  $(".bottom-buy ul li").eq(2).addClass("active").siblings().removeClass("active");
  $(".bottom-buy .img-box").addClass("three-pc").removeClass("three-gift");
...
function threePcAndGift() {
  $(".bottom-buy .buybtn").attr("href", "http://www.iobit.com/buy.php?product=it-db65pcsdpf2799&ref=it_db65pcsdpf2799purchase1809b"+refStr+"&refs=it_purchase_db");
  $(".bottom-buy .buybtn").attr("onclick", "ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase5PCsdpf1809b-it')");
  $(".bottom-buy .message del").html("169,93");
  $(".bottom-buy .message strong").html("27");
