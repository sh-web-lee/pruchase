...
<div class="banner">
  <div class="wrapper">
    ...
    <div class="db-off fr">
      <!-- only -->
      <h3 class="only">
       <strong>Nur<span>0€  </span> zahlen</strong>
        für Driver Booster 6 PRO
      </h3>
      <!-- progressbar -->
      ...
      <!-- buybtn -->
      <a class="buybtn" href="https://www.iobit.com/buy.php?product=de-db6preorder30d&ref=de_db6preorderpopup<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=de_purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'db6preorder-popup-de');">
...
<div class="between-buy">
  <div class="wrapper">
    <h3><img src="<?php echo getStaticUrl('images/money.png')?>">zahlen für eine bessere PC- und Spieleleistung
    </h3>
    <a class="buybtn" href="https://www.iobit.com/buy.php?product=de-db6preorder30d&ref=de_db6preorderpopup<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=de_purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'db6preorder-popup-de');">
      <span>Jetzt vorbestellen</span>
    </a>
...
<div class="comparision">
  <div class="comparision-content">
    <div class="wrapper">
      <h3>Es lohnt sich, die neueste PRO-Version zu erhalten</h3>
      <table>
        <thead>
        <tr>
          <td class="item"></td>
          <td class="small">
            <p>Ihre aktuelle Version</p>
          </td>
          <td class="space12"></td>
          <td class="small">
        ...
        <tr>
          <td class="item">
             Treiber-Download-Beschleunigung
          </td>
          <td class="small"></td>
          <td class="space12"></td>
          <td class="small">
            <span class="right grey">√</span>
            <span class="top top200">200%</span>
          </td>
          <td class="space14"></td>
          <td class="large">
            <span class="right golden">√</span>
            <span class="top top250">250%</span>
          </td>
        </tr>
        <!-- 3 -->
        <tr>
        ...
        <tr>
          <td class="item">
            <p><i>↑</i><span>* Download-Geschwindigkeit erhöhen</p>
          </td>
          <td class="small"></td>
          <td class="space12"></td>
          <td class="small"></td>
...
<div class="floatlayer">
    <div class="wrapper clearfix">
      ...
      <!-- buybtn -->
      <a class="buybtn fr" href="https://www.iobit.com/buy.php?product=de-db6preorder30d&ref=de_db6preorderpopup<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=de_purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'db6preorder-popup-de');">
        <span>Jetzt vorbestellen – 0€</span>
      </a>
    </div>
</div>
