...
<head>
  ...
  <title>Gelukkig Nieuwjaar: 80% korting op Driver Booster PRO - IObit</title>
...
<div class="banner">
  ...
  <div class="wrapper">
    ...
    <h1>
      Gelukkig Nieuwjaar!
      <span>Ga voordelig 2019 in met 80% korting en twee GRATIS CADEAUS!</span>
    </h1>
    <!-- content -->
    <div class="content clearfix">
      ...
      <div class="right-message fr">
        ...
        <!-- buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=nl-db63pciupf2499&ref=nl_db63pciupf2499purchase1812<?php echo $refStr;?>&refs=nl_purchase_db"
           onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase1812-nl')">
          Profiteer Nu
        </a>
        <!-- attention -->
...
<div class="gift-box">
  <div class="wrapper clearfix">
    ...
    <p class="surplus">Vandaag nog maar <b class="packsNum"><?php echo $packsNum;?></b> over</p>
    <!-- buybtn -->
    <a class="buybtn"
       href="https://www.iobit.com/buy.php?product=nl-db63pciupf2499&ref=nl_db63pciupf2499purchase1812<?php echo $refStr;?>&refs=nl_purchase_db"
       onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase1812-nl')">
      CLAIM UW GRATIS CADEAUS
    </a>
  </div>
</div>
<!-- gift-box end -->
...
<div class="bottomcart">
  <div class="wrapper">
    ...
    <dl class="price-content">
      <dt>
        <h3>Beperkt beschikbaar! Slechts <span>00</span> over</h3>
        <!-- price -->
        <p class="price">
          <strong>24</strong>
          <sup>99</sup>
      ...
      <dd>
        ...
        <!-- attention -->
        <p class="attention"><span class="viewNum"><?php echo $viewNum;?></span> mensen bekijken deze deal</p>
      </dd>
    </dl>
  </div>
</div>
...
<div class="footer">
  ...
  <!-- copyright -->
  <p class="copyright">Copyright ©2005-2019 IObit. Alle Rechten Voorbehouden</p>
</div>
<!-- footer end -->
