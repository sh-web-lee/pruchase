...
<html lang="fr">
	<head>
		...
		<title>Jusqu'à -83% sur Driver Booster PRO pour le rendez-vous football 2018 – 3-Jours Vente Flash chez IObit !</title>
		...
		<div class="banner">
			<div class="wrapper">
				...
				<div class="title">
					...
					<h2>Jusqu’à -83% sur Driver Booster PRO pour supporter votre équipe de foot. Bravo !</h2>
				</div>
				<div class="box">
					<h3>-10%</h3>
					...
					<dl class="price-content">
						...
						<dd>
							<a href="https://www.iobit.com/buy.php?product=fr-db51pc2299&ref=fr_db51pc2299purchase1806<?php echo $refStr;?>&aff=<?php echo $aff;?>&refs=fr_purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase1806c-fr')" class="buybtn border"><i></i> VITE, J’EN PROFITE</a>
						</dd>
					</dl>
				</div>
				<div class="three-box box">
					...
					<dl class="price-content">
						...
						<dd>
							<a href="https://www.iobit.com/buy.php?product=fr-db5sdpf2499&ref=fr_db5sdpf2499purchase1806<?php echo $refStr;?>&aff=<?php echo $aff;?>&refs=fr_purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase1806a-fr')" class="buybtn"><i></i> VITE, J’EN PROFITE</a>
						</dd>
				...
				<div class="three-pc box">
					...
					<dl class="price-content">
						...
						<dd>
							<a href="https://www.iobit.com/buy.php?product=fr-db53pc2499&ref=fr_db53pc2499purchase1806<?php echo $refStr;?>&aff=<?php echo $aff;?>&refs=fr_purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase1806b-fr')" class="buybtn border"><i></i> VITE, J’EN PROFITE</a>
						</dd>
					</dl>
				</div>
			</div>
	...
	<div class="feature">
		<div class="wrapper">
			<h2>Regardez le match de foot sans ralentissement <br> grâce à tous les pilotes à jour</h2>
	...
	<div class="gift-box">
		...
		<div class="wrapper clearfix"> 	
			...
			<a href="https://www.iobit.com/buy.php?product=fr-db5sdpf2499&ref=fr_db5sdpf2499purchase1806<?php echo $refStr;?>&aff=<?php echo $aff;?>&refs=fr_purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase1806a-fr')" class="buybtn red"><i></i> VITE, J’EN PROFITE</a>
    ...
    <div class="wrapper ">
      ...
      <div class="review-message">
		...
		<div class="wrapper">
			...
			<ul>
				<li class="active" data-url="https://www.iobit.com/buy.php?product=fr-db5sdpf2499&ref=fr_db5sdpf2499purchase1806<?php echo $refStr;?>&aff=<?php echo $aff;?>&refs=fr_purchase_db" data-ga="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase1806a-fr')" data-price="24" data-original="144,83€"><span>1 An / 3 PC+Paquet Cadeau</span> <strong>-83%</strong></li>
				<li class="three-pc" data-url="https://www.iobit.com/buy.php?product=fr-db53pc2499&ref=fr_db53pc2499purchase1806<?php echo $refStr;?>&aff=<?php echo $aff;?>&refs=fr_purchase_db" data-ga="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase1806b-fr')" data-price="24" data-original="74,85€"><i></i> <span> 1 An / 3 PC </span> <strong>-60%</strong></li>
				<li class="one-pc" data-url="https://www.iobit.com/buy.php?product=fr-db51pc2299&ref=fr_db51pc2299purchase1806<?php echo $refStr;?>&aff=<?php echo $aff;?>&refs=fr_purchase_db" data-ga="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase1806c-fr')" data-price="22" data-original="24,95€"><i></i> <span>1 An / 1 PC  </span> <strong>-10%</strong></li>
			</ul>
			<dl class="price-content">
				<dt>
