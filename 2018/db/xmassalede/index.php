...
<script type="text/javascript" src="<?php echo $pRootUrl; ?>tpl/js/stats.js"></script>
  ...
  <div class="banner">
    <div class="wrapper">
      ...
      <div class="title">
        <h1>Weihnachtssale - täglich stehen nur Pakete zur verfügung.</h1>
      ...
      <div class="panel clearfix">
        <div class="offer left" data-num="2">
          ...
          <a class="buybtn" href="http://www.iobit.com/buy.php?product=de-db61pcnouvp2499&ref=de_db61pcpurchase1812<?php echo $refStr;?>&refs=de_purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase1PC1812-de')">
            <b>Jetzt kaufen</b>
            <p>21€ sparen</p>
          </a>
        </div>
        <div class="offer center" data-num="0">
          ...
          <a class="buybtn yellowbtn" href="http://www.iobit.com/buy.php?product=de-db63pcsdpf2699&ref=de_db6sdpfpurchase1812<?php echo $refStr;?>&refs=de_purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase3PCsd1812-de')">
            <b>Jetzt kaufen</b>
            <p>132,94€ sparen</p>
          </a>
        ...
        <div class="offer right" data-num="1">
          ...
          <a class="buybtn" href="http://www.iobit.com/buy.php?product=de-db63pcnouvp2699&ref=de_db63pcpurchase1812<?php echo $refStr;?>&refs=de_purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase3PC1812-de')">
            <b>Jetzt kaufen</b>
            <p>39€ sparen</p>
          </a>
        </div>
      ...
      <div class="clearfix">
        ...
        <dl class="pf">
          ...
          <dd>
            ...
            <strong>0€</strong>
            <p>Bietet Passwortschutz für Order und Dateien für Windowsnutzer.</p>
          </dd>
        </dl>
      </div>
