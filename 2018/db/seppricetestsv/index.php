...
<script type="text/javascript" src="<?php echo $pRootUrl; ?>tpl/js/stats.js"></script>
  ...
  <div class="banner">
    <div class="wrapper">
      ...
      <div class="right-message">
        ...
        <dl class="price">
          <dt><del>1 367 kr</del> <strong>299 kr</strong></dt>
          <dd><a href="https://www.iobit.com/buy.php?product=sv-db63pcpfsd299&ref=sv_db63pcpfsdpurchase1809test<?php echo $refStr;?>&refs=sv_purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase1809t-sv');" class="buybtn">KÖP NU</a></dd>
  ...
  <div class="gift-message">
   <div class="wrapper">
      ...
      <a href="https://www.iobit.com/buy.php?product=sv-db63pcpfsd299&ref=sv_db63pcpfsdpurchase1809test<?php echo $refStr;?>&refs=sv_purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase1809t-sv');" class="buybtn">Hämta mina gratis gåvor</a>
   </div>
  </div>
  <!-- media start -->
