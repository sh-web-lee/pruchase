...
//if(in_array($_GET['ref'],array('x_db','db3irsource'))){
	...
	$refArr=array();
	$refArr[0]=$refArr[1]=$refArr[2]=$refArr[3]=$refArr[4]='x_db';
}else{
		...
		<div class="content clearfix">
			...
			<div class="right-message lato">
				...
				<dl>
					...
					<dd>
						<a href="https://www.iobit.com/buy.php?product=db6sdiupf&ref=<?php echo $refArr[0];?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_db" onclick="ga('send', 'event', 'dbbuya', 'buy', 'dbpurchase-popup');" class="buybtn"><i></i>
...
<div class="between-buy bg lato">
	<div class="wrapper">
		<div class="content">
			...
			<a href="https://www.iobit.com/buy.php?product=db6sdiupf&ref=<?php echo $refArr[1];?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_db" onclick="ga('send', 'event', 'dbbuyb', 'buy', 'dbpurchase-popup');" class="buybtn save"><i></i> <span>Activate Now & <strong>Save 80%</strong></span></a>
...
<div class="activate ">
	<div class="wrapper">
		...
		<div class="clear"></div>
		<a href="https://www.iobit.com/buy.php?product=db6sdiupf&ref=<?php echo $refArr[2];?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_db" onclick="ga('send', 'event', 'dbbuyc', 'buy', 'dbpurchase-popup');" class="buybtn save"><i></i> <span>Get My Free Gifts</span></a>
...
<div class="floatlayer" id="floatlayer">
	<div class="wrapper clearfix">
		...
		<div class="right">
			...
			<a class="buybtn" href="https://www.iobit.com/buy.php?product=db6sdiupf&ref=<?php echo $refArr[4];?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_db" onclick="ga('send', 'event', 'dbbuye', 'buy', 'dbpurchase-popup');"><i></i> <span>Activate Now</span></a>
		</div>
	</div>
</div>
<div class="float">
