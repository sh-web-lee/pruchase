...
<div class="banner">
  <div class="wrapper">
    ...
    <div class="db-off fr">
      ...
      <!-- buybtn -->
      <a class="buybtn" href="https://www.iobit.com/buy.php?product=fr-db6preorder&ref=fr_db6preorderpopup<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=fr_purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'db6presalepopup-fr');">
...
<div class="between-buy">
  <div class="wrapper">
    <h3>
      ...
      <img src="<?php echo getStaticUrl('images/money.png')?>">
    </h3>
    <a class="buybtn" href="https://www.iobit.com/buy.php?product=fr-db6preorder&ref=fr_db6preorderpopup<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=fr_purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'db6presalepopup-fr');">
      <span>J’EN PROFITE VITE</span>
    </a>
...
<div class="comparision">
  <div class="comparision-content">
    <div class="wrapper">
      <h3>Ce que vous gagnerez en passant à la dernière version PRO</h3>
      <table>
        <thead>
        <tr>
          <td class="item"></td>
        ...
        <tr>
          <td class="item">
            Téléchargement rapide des pilotes
          </td>
          <td class="small"></td>
          <td class="space12"></td>
          <td class="small">
        ...
        <tr>
          <td class="item">
            Assistance technique gratuite 24/7
          </td>
          <td class="small"></td>
          <td class="space12"></td>
          <td class="small">
...
<div class="floatlayer">
    <div class="wrapper clearfix">
      ...
      <!-- buybtn -->
      <a class="buybtn fr" href="https://www.iobit.com/buy.php?product=fr-db6preorder&ref=fr_db6preorderpopup<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=fr_purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'db6presalepopup-fr');">
        <span>J’EN PROFITE VITE</span>
      </a>
    </div>
</div>
