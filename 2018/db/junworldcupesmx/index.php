...
<head>
	...
	<title>Oferta especial de la Copa Mundial. 90% de descuento y regalos para Driver Booster PRO – IObit</title>
...
<div class="banner">
  <div class="wrapper">
    ...
    <dl class="price">
      <dt><del>MXN 3,549.00</del> <strong>MXN 319.00</strong></dt>
      <dd>
        <a class="buybtn" 
           href="https://www.iobit.com/buy.php?product=mx-db53pciusdpf319&ref=mx_db53pciusdpfxmaspurchase1806wc<?php echo $refStr;?>&refs=mx_purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase1806wc-mx')">
...
<div class="gift-intro  clearfix">
  <div class="wrapper">
  	<h2> <img src="<?php echo $pResUrl; ?>images/gift-icon.png" alt="">¡Regalos limitados!¡Sólo <strong id="packs"><?php echo $packsNum ?></strong> regalos disponibles hoy!</h2>
		...
		<tfoot>
			<tr>
				...
				<th class="itema">
					...
					<strong>MXN 319.00</strong> <del>MXN 3,549.00</del> 
					<a class="buybtn" 
             href="https://www.iobit.com/buy.php?product=mx-db53pciusdpf319&ref=mx_db53pciusdpfxmaspurchase1806wc<?php echo $refStr;?>&refs=mx_purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase1806wc-mx')">
            <i></i> <span>Comprar ahora</span>
          </a> 
