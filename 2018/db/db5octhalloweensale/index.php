...
<div class="banner">
  <div class="wrapper clearfix">
    ...
    <div class="right-message fr">
      ...
      <!-- buybtn -->
      <a class="buybtn"
         href="https://www.iobit.com/buy.php?product=db6sdiupf&ref=db5octhalloween<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=purchase_db"
  ...
  <div class="container">
    ...
    <dl class="clearfix">
      ...
      <dd class="fr">
        ...
        <!-- buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=db630trial&ref=db5octhalloweentrial<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=purchase_db"
