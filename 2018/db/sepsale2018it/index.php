...
<head>
  ...
  <title>Saldi 2018, sconti fino all’80% su Driver Booster PRO – Offerta Speciale di IObit</title>
...
<div class="header">
  <div class="wrapper">
    ...
    <h1>SALDI SCONTI  FINO A 80%  SUL NUOVO RILASCIO</h1>
    <div class="box">
      <h2>-50%</h2>
      ...
      <a href="http://www.iobit.com/buy.php?product=it-db81pc2499&ref=it_db81pc2499purchase1809<?php echo $refStr;?>&refs=it_purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase1PC1809a-it')" class="buybtn db-box"><i></i> <span>ACQUISTA ORA</span></a>
    </div>
    <div class="box gift-box">
      ...
      <a href="http://www.iobit.com/buy.php?product=it-db83pcsdpf2499&ref=it_db83pcsdpf2499purchase1809<?php echo $refStr;?>&refs=it_purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase3PCsdpf1807a-it')" class="buybtn"><i></i> <span>APPROFITTANE SUBITO</span></a>
    ...
    <div class="box three-pc ">
      ...
      <a href="http://www.iobit.com/buy.php?product=it-db83pc2999&ref=it_db83pc2999purchase1809<?php echo $refStr;?>&refs=it_purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase3PC1809a-it')" class="buybtn db-box"><i></i> <span>ACQUISTA ORA</span></a>
    </div>
  </div>
</div>
...
<div class="db-message">
  <div class="wrapper">
    <h2>Vuoi le massime prestazioni del PC e un’esperienza di gioco più fluida? <span>Scopri Driver Booster 8 PRO!</span>  </h2>
     <div class="img-box">
      <div class="inner">
        <ul>
...
<div class="gift-message ">
  ...
  <div class="wrapper"> 
    ...
    <a href="http://www.iobit.com/buy.php?product=it-db83pcsdpf2499&ref=it_db83pcsdpf2499purchase1809<?php echo $refStr;?>&refs=it_purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase3PCsdpf1807a-it')" class="buybtn"><i></i> <span>OTTIENI I REGALI SUBITO!</span></a>
  </div>
</div>
<div class="review">
  <div class="wrapper ">
  ...
  <div id="compare" class="comparison wrapper">
    <table border="0" cellspacing="0" cellpadding="0" width="100%">
      ...
      <tr>
        <td class="icons" width="45"><img src="<?php echo $pResUrl; ?>images/icons14.png"></td>
        <td class="virtue">Scegli tra priorità per driver più stabili per una maggiore sicurezza o driver più recenti per una migliore esperienza di gioco <em class="nuo">Nuovo</em></td>
        <td class="space"></td>
        <td class="itema"><i class="all-icons">√</i> <b>4.500.000+ <br> driver</b></td>
        <td class="space"></td>
        <td class="itema"><i class="all-icons red">√</i> <b>3.500.000+ <br> driver</b></td>
      </tr>
      <tr>
...
<div class="bottom-buy">
  <div class="wrapper">
    <h2>Con soli <strong>€0,02</strong> al giorno potrai godere di un PC più stabile e di un'esperienza di gioco più fluida!</h2>
    <div class="img-box three-gift"></div>
    <ul>
      <li class="one-pc"> <span>1 Anno / 1 PC</span> <strong>-50%</strong></li>
      <li class="active  three-gift"> <span>1 Anno / 3 PC+SD+PF</span> <strong>-80%</strong></li>
      <li class="three-pc"> <span>1 Anno / 3 PC</span> <strong>-60%</strong></li>
    </ul>
    <div class="message">
       <p class="price">
        <strong>24</strong>
      ...
      <a href="http://www.iobit.com/buy.php?product=it-db83pcsdpf2499&ref=it_db83pcsdpf2499purchase1809<?php echo $refStr;?>&refs=it_purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase3PCsdpf1807a-it')" class="buybtn"><i></i> <span>ACQUISTA ORA</span></a>
    </div>
  </div>
</div>
