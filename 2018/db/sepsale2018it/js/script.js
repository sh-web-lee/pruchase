...
function soldoutGift() {
  ...
  $(".bottom-buy .message strong").html("29");
  $(".gift-message .buybtn,.gift-message .buybtn").attr("href", "http://www.iobit.com/buy.php?product=it-db83pc2999&ref=it_db83pc2999purchase1809"+refStr+"&refs=it_purchase_db").attr("onclick", "ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase3PC1809a-it')");
}
function onePc() {
  $(".bottom-buy .buybtn").attr("href", "http://www.iobit.com/buy.php?product=it-db81pc2499&ref=it_db81pc2499purchase1809"+refStr+"&refs=it_purchase_db");
  $(".bottom-buy .buybtn").attr("onclick", "ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase1PC1809a-it')");
...
function threePc() {
  $(".bottom-buy .buybtn").attr("href", "http://www.iobit.com/buy.php?product=it-db83pc2999&ref=it_db83pc2999purchase1809"+refStr+"&refs=it_purchase_db");
  $(".bottom-buy .buybtn").attr("onclick", "ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase3PC1809a-it')");
  $(".bottom-buy .message del").html("74,85");
  $(".bottom-buy .message strong").html("29");
  $(".bottom-buy ul li").eq(2).addClass("active").siblings().removeClass("active");
  $(".bottom-buy .img-box").addClass("three-pc").removeClass("three-gift");
...
function threePcAndGift() {
  $(".bottom-buy .buybtn").attr("href", "http://www.iobit.com/buy.php?product=it-db83pcsdpf2499&ref=it_db83pcsdpf2499purchase1809"+refStr+"&refs=it_purchase_db");
  $(".bottom-buy .buybtn").attr("onclick", "ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase3PCsdpf1807a-it')");
