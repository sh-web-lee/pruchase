...
function maskShow() {
  ...
  $('.main').append('<div class="mask"></div><div class="mask-box"><h2>Sorpresa di Natale</h2><div class="clearfix"><div class="fl left"><img src="' + imgSrc + '" alt="Driver Booster 6 PRO"/></div><div class="price fl"><h3>Hai vinto <b>€1</b> di extra sconto esclusivo!</h3><p><i>SOLO</i> <strong>18<big>,</big></strong> <span>99 <del>€164,78</del></span></p> <a class="buybtn" href="' + _href + '" onclick="' + _ga + '">ATTIVA ORA</a><p class="year">Cogli questa ultima opportunità per il <br> grande risparmio in assoluto! </p></div></div></div>');
