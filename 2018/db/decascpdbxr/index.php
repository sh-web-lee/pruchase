...
<title>73% OFF Driver Booster PRO to Enjoy Better PC & Game Performance Together with ASC PRO</title>
  ...
  <div class="main">
        ...
        <div class="palen clearfix">
          ...
          <div class="right fr">
            ...
            <div class="price">
              ...
              <a class="buybtn" href="https://www.iobit.com/buy.php?product=db3pc1995x&ref=xr_ascpdb&refs=purchase_dbx" onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase-xmas');">
                Activate Now
              </a>
    ...
    <div class="centbuy">
      ...
      <div class="wrapper clearfix">
        <div class="fl">
          <img src="<?php echo getStaticUrl('images/db-center-box.jpg')?>" alt="Driver Booster 6 Pro"/>
        </div>
        <div class="price fr">
          <div class="count">
            <p class="watching">
          ...
          <p><strong>$<big>19</big>.95</strong> <del>$74.85</del></p>
          <a class="buybtn yellow" href="https://www.iobit.com/buy.php?product=db3pc1995x&ref=xr_ascpdb&refs=purchase_dbx" onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase-xmas');">
            Activate Now
          </a>
          <p class="year">1 Year Subscription / 3 PCs</p>
          <img class="moneyback" src="<?php echo getStaticUrl('images/moneyback.png')?>" alt=""/>
        ...
        <table border="0" cellspacing="0" cellpadding="0" width="100%">
          <thead>
            <tr>
              ...
              <th class="itemc"><span>Driver Booster 6 PRO</span></th>
            </tr>
          </thead>
          <tbody>
            <tr>
    ...
    <div class="floatlayer">
        <div class="wrapper clearfix">
          ...
          <!-- buybtn -->
          <a class="buybtn yellow fr" href="https://www.iobit.com/buy.php?product=db3pc1995x&ref=xr_ascpdb&refs=purchase_dbx" onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase-xmas');">
            Activate Now
          </a>
        </div>
    </div>
    ...
    <div class="popShow">
      ...
      <div class="clearfix">
        ...
        <div class="price fl">
          ...
          <a class="buybtn yellow" href="https://www.iobit.com/buy.php?product=db3pc2295x&ref=xr_ascpdb2295&refs=purchase_dbx" onclick="ga('send', 'event', 'dbbuypop', 'buy', 'dbpurchase-xmas');">
            Activate Now
          </a>
          <p class="year">1 Year Subscription / 3 PCs</p>
        </div>
