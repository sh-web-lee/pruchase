...
$saleType=(($statusNow==2)?'5 PC/1 Anno':((rand(1,4)==4)?'5 PC/1 Anno':'5 PC/1 Anno+REGALI'));
...
<title> Saldi! Sconti fino al 85% su Driver Booster PRO – Offerta natale 2018 di IObit</title>
...
<script type="text/javascript" src="<?php echo $pRootUrl; ?>tpl/js/stats.js"></script>
  ...
  <div class="banner">
    <div class="wrapper">
      ...
      <div class="title">
        <h1>SUPER OFFERTA DI NATALE!</h1>
        <p>Risparmi fino all'85% su DB PRO e ricevi un EXTRA pacchetto REGALO GRATIS!</p>
      </div>
      <div class="panel clearfix">
        <div class="offer left" data-num="2">
          <img src="<?php echo getStaticUrl('images/discount-55.png')?>" alt=""/>
          <p> 1 Anno /​ 3​ PC</p>
          <p><strong class="discount">24,99</strong> <span class="uvp">Anziché <del class="original">€74,85</del></span></p>
          <a class="buybtn" href="https://www.iobit.com/buy.php?product=it-db63pc2499&ref=it_db63pc2499purchase1811b<?php echo $refStr;?>&refs=it_purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'db3pc2499purchase1811b-it')">
            <b>ACQUISTA ORA</b>
            <p>Risparmi €35,86</p>
          </a>
        </div>
        <div class="offer center" data-num="0">
          <div class="countdown">
            <i></i>
            <span><strong>08</strong> Min: <strong>48</strong> Sec: <strong class="last">126</strong> Ms</span>
          </div>
          <div class="counter">
            <div class="bar">
          ...
          <p>1 Anno /​ 5 ​PC</p>
          <p><strong class="discount">27,99</strong> <span class="uvp">Anziché <del class="original">€1​89​,92</del></span></p>
          <a class="buybtn yellowbtn" href="https://www.iobit.com/buy.php?product=it-db65pcsdpfamc2799&ref=it_db65pcsdpfamc2799purchase1811b<?php echo $refStr;?>&refs=it_purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'db5pcsdpfamc2799purchase1811b-it')">
            <b>APPROFITTANE ORA</b>
            <p>Risparmi €1​61​,93</p>
          </a>
        ...
        <div class="offer right" data-num="1">
          ...
          <p>DB6 1 Anno /​ 5​ PC</p>
          <p><strong class="discount">29,99</strong> <span class="uvp">Anziché <del class="original">€99,99</del></span></p>
          <a class="buybtn" href="https://www.iobit.com/buy.php?product=it-db65pc2999&ref=it_db65pc2999purchase1811b<?php echo $refStr;?>&refs=it_purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'db5pc2999purchase1811b-it')">
            <b>ACQUISTA ORA</b>
            <p>Risparmi €70</p>
          </a>
        </div>
  ...
  <div class="centbuy">
    <div class="wrapper">
      ...
      <div class="clearfix">
        ...
        <dl class="amc">
          <dt><img src="<?php echo getStaticUrl('images/boxshot-amc.png')?>" alt="Advanced MobileCare"/></dt>
          <dd>
    ...
    <div class="wrapper clearfix">
      ...
      <ul class="fl">
        ...
        <li class="center active" data-num="1">
          <i class="all-icons">◎</i>
          <b>DB6 1 Anno /​ 5 ​PC +SD+PF+AMC</b>
          <strong>Risparmi 1​61​,93</strong>
        </li>
        <li class="right" data-num="2">
          <i class="all-icons">◎</i>
          <b>DB6 1 Anno /​ 5​ PC</b>
          <strong>Risparmi 70</strong>
        </li>
      </ul>
      <div class="price fr">
        <p><strong class="discount">€29,99 </strong> <span>Anziché <del class="original">1​61​,93</del></span></p>
        <a class="buybtn yellowbtn" href="https://www.iobit.com/buy.php?product=it-db65pcsdpfamc2799&ref=it_db65pcsdpfamc2799purchase1811b<?php echo $refStr;?>&refs=it_purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'db5pcsdpfamc2799purchase1811b-it')">
         APPROFITTANE ORA
        </a>
      </div>
...
<script>
  ...
  var amcimgSrc = "<?php echo getStaticUrl('images/boxshot-amc-gray.png')?>";
