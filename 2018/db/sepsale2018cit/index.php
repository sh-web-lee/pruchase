...
<div class="header">
  <div class="wrapper">
    ...
    <div class="box">
      ...
      <a href="http://www.iobit.com/buy.php?product=it-db81pc2499&ref=it_db81pc2499purchase1809c<?php echo $refStr;?>&refs=it_purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase1PC1809c-it')" class="buybtn db-box"><i></i> <span>ACQUISTA ORA</span></a>
    </div>
    <div class="box gift-box">
      ...
      <a href="http://www.iobit.com/buy.php?product=it-db83pcsdpf2499&ref=it_db83pcsdpf2499purchase1809c<?php echo $refStr;?>&refs=it_purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase3PCsdpf1809c-it')" class="buybtn"><i></i> <span>APPROFITTANE SUBITO</span></a>
    ...
    <div class="box three-pc ">
      ...
      <a href="http://www.iobit.com/buy.php?product=it-db83pc2599&ref=it_db83pc2599purchase1809c<?php echo $refStr;?>&refs=it_purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase3PC1809c-it')" class="buybtn db-box"><i></i> <span>ACQUISTA ORA</span></a>
    </div>
  </div>
</div>
...
<div class="gift-message ">
  ...
  <div class="wrapper"> 
    ...
    <a href="http://www.iobit.com/buy.php?product=it-db83pcsdpf2499&ref=it_db83pcsdpf2499purchase1809c<?php echo $refStr;?>&refs=it_purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase3PCsdpf1809c-it')" class="buybtn"><i></i> <span>OTTIENI I REGALI SUBITO!</span></a>
  </div>
</div>
  ...
  <div id="compare" class="comparison wrapper">
    <table border="0" cellspacing="0" cellpadding="0" width="100%">
      ...
      <tr>
        ...
        <td class="space"></td>
        <td class="itema"><i class="all-icons">√</i> <b>3.500.000+ <br> driver</b></td>
        <td class="space"></td>
        <td class="itema"><i class="all-icons red">√</i> <b>4.500.000+ <br> driver</b></td>
      </tr>
      <tr>
...
<div class="bottom-buy">
  <div class="wrapper">
    ...
    <div class="message">
      ...
      <a href="http://www.iobit.com/buy.php?product=it-db83pcsdpf2499&ref=it_db83pcsdpf2499purchase1809c<?php echo $refStr;?>&refs=it_purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase3PCsdpf1809c-it')" class="buybtn"><i></i> <span>ACQUISTA ORA</span></a>
    </div>
  </div>
</div>
...
<script type="text/javascript" src="<?php echo getStaticUrl('js/script.min.js')?>"></script>
</html>