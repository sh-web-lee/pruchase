...
function three() {
    $(".bottom-buy .buybtn").attr("href", "https://www.iobit.com/buy.php?product=es-db63pciu1999&ref=es_db63pciu1999purchase1804"+refStr+"&refs=es_purchase_db");
    $(".bottom-buy .buybtn").attr("onclick", "ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase3pciu1804-es')");
...
function oneBox() {
    $(".bottom-buy .buybtn").attr("href", "https://www.iobit.com/buy.php?product=es-db61pc1799&ref=es_db61pc1799purchase1804"+refStr+"&refs=es_purchase_db");
    $(".bottom-buy .buybtn").attr("onclick", "ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase1pc1804-es')");
...
function threeSold() {
    ...
    $(".gift-intro .buybtn,.banner .three .buybtn").attr("href", "https://www.iobit.com/buy.php?product=es-db61pc1799&ref=es_db61pc1799purchase1804"+refStr+"&refs=es_purchase_db");
    $(".gift-intro .buybtn,.banner .three .buybtn").attr("onclick", "ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase1pc1804-es')");
}
