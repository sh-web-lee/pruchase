...
<div class="banner">
  <div class="wrapper clearfix">
    ...
    <div class="right-message fr">
      ...
      <!-- buybtn -->
      <a class="buybtn"
         href="https://www.iobit.com/buy.php?product=db6sdiupf&ref=db6octhalloween<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=purchase_db"
         onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase-db610');">
        ACTIVATE NOW
      </a>
      <!-- attention -->
  ...
  <table border="0" cellspacing="0" cellpadding="0" width="100%">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="w304 grey">2,500,000+</td>
        <td class="space"></td>
...
<div class="feature wrapper">
  <div class="flex clearfix">
    ...
    <dl>
      ...
      <dd>
        <img src="<?php echo $pResUrl;?>images/feature-percent20.png" alt="">
        <p>
          <span>Larger</span><br>
          Driver Database
        </p>
...
<div class="pop">
  <div class="container">
    ...
    <dl class="clearfix">
      ...
      <dd class="fr">
        <ul>
          <li><b>20%</b> larger driver database</li>
          <li><b>150%</b> quicker driver download</li>
          <li><b>28%</b> faster game performance</li>
        </ul>
        <!-- buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=db630trial&ref=db6octhalloweentrial<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=purchase_db"
           onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase-db610popup');">
          GET MY FREE TRIAL
        </a>
        <!-- note -->
