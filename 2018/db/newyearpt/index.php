...
<head>
  ...
  <title>Adquira Driver Booster 6 Pro com 75% de desconto e leve um super brinde para cuidar dos discos do seu PC. Oferta Especial de Ano Novo da IObit.  </title>
...
<div class="banner">
  <div class="wrapper">
    ...
    <!-- title -->
    <h1>
      Promoção Relâmpago no Ano Novo!
    ...
    <div class="content clearfix">
      ...
      <div class="left-message fl">
        ...
        <!-- surplus -->
        <p class="surplus">  Oferta termina em 
          <ul>
            <li>00</li>
            <li>00</li>
            <li>00</li>
      ...
      <div class="right-message fr">
        ...
        <!-- buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=pt-db63pcsd7999&ref=pt_db63pcsdpurchase1812<?php echo $refStr;?>&refs=pt_purchase_db"
           onclick="ga('send', 'event', 'dbbuy', 'buy', 'db6purchase1812-pt')">
          COMPRAR AGORA
        </a>
        <!-- people-box -->
...
<div class="gift-box">
  <div class="wrapper clearfix">
    <!-- gift-box title -->
    <h2>Brindes Grátis exclusivo apenas na venda exclusiva de Ano Novo</h2>
    <!-- SD -->
...
<div class="bottomcart">
  <div class="wrapper">
    ...
    <dl class="price-content">
      <dt>
        <h3>    Só no ANO NOVO! Quantidade Limitada！</h3>
        <!-- price -->
        <p class="price">
      ...
      <dd>
        ...
        <!-- attention -->
        <p class="attention"><i></i>Atenção, oferta por tempo limitado</p>
      </dd>
    </dl>
  </div>
</div>
