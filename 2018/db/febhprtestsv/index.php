...
<title>Spara upp till 57% på Driver Booster PRO och du får extra skydd helt gratis!</title>
...
<script type="text/javascript" src="<?php echo $pRootUrl; ?>tpl/js/stats.js"></script>
  ...
  <div class="banner">
    <div class="wrapper">
      ...
      <div class="title">
        <h1>Slutförsäljning -57%</h1>
        <p>Köp nu och du kan dra nytta av <strong>57%</strong> rabatt på DB PRO!</p>
      </div>
      <!-- time -->
      ...
      <div class="panel clearfix">
        <div class="box redbox">
          ...
          <strong>379.00 SEK</strong>
          <div class="sign"><b>-520.00 SEK</b> <del>899.00 SEK</del></div>
          <a class="buybtn redbtn" href="http://www.iobit.com/buy.php?product=sv-db53pc379&ref=sv_db53pcpurchase1802h<?php echo $refStr;?>&refs=sv_purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase1802h-sv');">
            <i class="all-icons"></i>
            KÖP NU
          </a>
        </div>
        <div class="box graybox">
          <div class="inner">
            ...
            <strong>299.00 SEK</strong>
            <div class="sign"><b>-400.00 SEK</b> <del>699.00 SEK</del></div>
            <a class="buybtn graybtn" href="http://www.iobit.com/buy.php?product=sv-db51pc299&ref=sv_db51pcpurchase1802h<?php echo $refStr;?>&refs=sv_purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase1802h-sv');">
              <i class="all-icons"></i>
              KÖP NU
            </a>
          </div>
  ...
  <div class="center-banner">
    <div class="wrapper clearfix">
      <h3>Köp nu och spara upp till 57% på DB 5 PRO</h3>
      <dl class="show">
        <dt><img src="<?php echo getStaticUrl('images/db-cent.png')?>"></dt>
        <dd class="first active" data-name="pcs" data-url="http://www.iobit.com/buy.php?product=sv-db53pc379&ref=sv_db53pcpurchase1802h<?php echo $refStr;?>&refs=sv_purchase_db">
          <span>
            <i class="all-icons">×</i>
            1 År/ 3 PC 
          </span>
          <strong><ins>379.00 SEK</ins> <del>899.00 SEK</del></strong>
        </dd>
        <dd data-name="pc" data-url="http://www.iobit.com/buy.php?product=sv-db51pc299&ref=sv_db51pcpurchase1802h<?php echo $refStr;?>&refs=sv_purchase_db">
          <span>
            <i class="all-icons">×</i>
            1 År/ 1 PC 
          </span>
          <strong><ins>299.00 SEK</ins> <del>699.00 SEK </del></strong>
        </dd>
      </dl>
      <dl class="total">
        <dt><strong class="price">379.00 SEK</strong></dt>
        <dd>
          <a class="buybtn redbtn" href="http://www.iobit.com/buy.php?product=sv-db53pc379&ref=sv_db53pcpurchase1802h<?php echo $refStr;?>&refs=sv_purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase1802h-sv');">
