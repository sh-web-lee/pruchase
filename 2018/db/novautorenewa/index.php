	...
	<div class="wrapper clearfix">
		...
		<div class="message box ">
			<div class="top-message">
				...
				<a href="https://www.iobit.com/buy.php?product=driverbooster6&ref=db63pc2018novautorenew<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_db" onclick="ga('send', 'event', 'db3pcbuyautorenew', 'buy', 'dbpurchase-autorenew')" class="buybtn"><i></i> <span>Activate Now</span></a>

			</div>
			<p class="border"> only $1.95 / Month</p>
			<p>$51.9 Saved</p>
		</div>
		<div class="gift-box message">
			<div class="top-message">
				...
				<a href="https://www.iobit.com/buy.php?product=db6sdiupf&ref=db6bundle2018novautorenew<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_db" onclick="ga('send', 'event', 'dbbuyautorenew', 'buy', 'dbpurchase-autorenew')" class="buybtn"><i></i> <span>Activate Now</span></a>
				<span class="info"></span>
				<p class="date">Hurry! <strong>04</strong>M: <strong>04</strong>S: <strong>004</strong> Ms Left</p>
			</div>
			<p class="border">only $2.09 / Month</p>
			<p> $89.88 Saved</p>
		</div>
	</div>
...
<div class="between-buy">
	<div class="wrapper">
		<div class="content">
			...
			<a href="https://www.iobit.com/buy.php?product=db6sdiupf&ref=db6bundle2018novautorenew<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_db" onclick="ga('send', 'event', 'dbbuyautorenew', 'buy', 'dbpurchase-autorenew')" class="buybtn save"><i></i> Activate Now</a>
	...
	<div class="wrapper">
		...
		<table>
			...
			<th class="itemb">
				...
				<a href="https://www.iobit.com/buy.php?product=db6sdiupf&ref=db6bundle2018novautorenew<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_db" onclick="ga('send', 'event', 'dbbuyautorenew', 'buy', 'dbpurchase-autorenew')" class="buybtn"><i></i>
...
<div class="floatlayer" id="floatlayer">
	<div class="wrapper clearfix">
		...
		<div class="right">
			...
			<a class="buybtn" href="https://www.iobit.com/buy.php?product=db6sdiupf&ref=db6bundle2018novautorenew<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_db" onclick="ga('send', 'event', 'dbbuyautorenew', 'buy', 'dbpurchase-autorenew')">Activate Now</a>
		</div>
	</div>
</div>
<div class="float">
