...
function soldOut() {
	...
	$(".banner .gift-box p.border").html("only $1.95 / Month")
	$(".banner .gift-box p:last-child").html("$51.9 Saved")
	$(".between-buy strong,.comparison th strong").html("$22.95")
	$(".buybtn").attr("href","https://www.iobit.com/buy.php?product=driverbooster6&ref=db63pc2018soldout"+refStr+"&aff=" + aff + "&refs=purchase_db&tw=" + tw)
}
