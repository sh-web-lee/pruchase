...
function maskShow() {
  ...
  $('.main').append('<div class="mask"></div><div class="mask-box"><h2>Kerstcadeautje</h2><div class="clearfix"><div class="fl left"><img src="' + imgSrc + '" alt="Driver Booster 6 PRO"/></div><div class="price fl"><h3><b>€1</b> extra KORTING speciaal voor jou!</h3><p><i>Slechts</i> <strong>€18<big>,</big></strong> <span>99 <del>€144,79</del></span></p> <a class="buybtn" href="' + _href + '" onclick="' + _ga + '">Activeer Nu</a><p class="year">Grijp uw laatste kans!</p></div></div></div>');
...
function packsInit() {
  ...
  packs = Math.ceil(timeDiff / 4.1) > 0 ? Math.ceil(timeDiff / 4.1) : 0;
  reduceNum(packs, 1);
...
function getSales() {
  ...
  var nowTime = Math.floor(date.getTime() / 1000);
  var timeDiff = countTime - nowTime;
  var packsNow = Math.ceil(timeDiff / 4.1) > 0 ? Math.ceil(timeDiff / 4.1) : 0;
  if (packsNow != packs) {
    if (statusCheck() == 2) {
      packs = 0;
    } else {
