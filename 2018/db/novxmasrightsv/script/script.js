...
function maskFirst() {
  ...
  $('.main').append('<div class="mask"></div><div class="mask-box"><h2>Julöverraskning</h2><div class="clearfix"><div class="fl left"><img src="' + imgSrc + '" alt="Driver Booster 6 PRO"/></div><div class="price fl"><h3>Extra <b>10kr</b> Rabatt bara för dig!</h3><p>Bara <strong>269<small>kr</small></strong> 1 år / 3 PC</p> <a class="buybtn" href="' + _href + '" onclick="' + _ga + '">Aktivera Nu</a><p class="year">Missa inte din sista chans till största <br>besparingen någonsin!</p></div></div></div>');
}
...
function timeInit() {
  var date = new Date();
  var cName = "svdbpre" + date.getDate();
