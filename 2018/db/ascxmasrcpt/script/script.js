...
function maskShow() {
  ...
  $('.main').append('<div class="mask"></div><div class="mask-box"><h2>Surpresa de Natal</h2><p>Aproveite o Preço mais Baixo da História!</p><div class="clearfix"><div class="fl left"><img src="' + imgSrc + '" alt="Advanced SystemCare 12 Pro"/></div><div class="price"><h3><b>R$ 4</b> extra de desconto pra você!</h3> <p><strong><big>R$</big>55<big>,</big></strong> <span>99 <del>R$399,98 </del></span></p> <a class="buybtn" href="' + _href + '" onclick="' + _ga + '">Comprar Agora</a><p class="year">1 Ano de Assinatura / 3 PCs</p></div></div></div>');
...
function packsInit() {
  ...
  packs = Math.ceil(timeDiff / 4.77) > 0 ? Math.ceil(timeDiff / 4.77) : 0;
  reduceNum(packs, 1);
...
function getSales() {
  ...
  var nowTime = Math.floor(date.getTime() / 1000);
  var timeDiff = countTime - nowTime;
  var packsNow = Math.ceil(timeDiff / 4.77) > 0 ? Math.ceil(timeDiff / 4.77) : 0;
  if (packsNow != packs) {
    if (statusCheck() == 2) {
      packs = 0;
    } else {
...
$(window).on('scroll', function() {
  ...
  var _botH = $(".review").offset().top - 130;
  if (winPos >= _botH) {
    $(".footbuy").addClass("on");
    $(".bottom").addClass("on");
  } else {
