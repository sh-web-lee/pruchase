...
<head>
	...
	<title>85% de descuento y regalo para Driver Booster PRO – IObit</title>
	...
	<script type="text/javascript">
		...
		if (reg.test(ver) && (paramTo == 'purchase-6')) {
			window.location.replace('./aprdriverupdatees.php' + queryStr);
		}
     	function decreasingPacks() {
        $.ajax({
          type: "GET",
          url: "novnavidades.php",
...
<div class="banner">
  <div class="wrapper">
    <h1>Superior redimiento y estabilidad para PC - Driver Booster 5 PRO </h1>
    <h2>-85%</h2>
    <h3>Sólo <strong> <span>23</span>h: <span>23</span>min: <span>23</span>s: <span class="last">23</span>ms*</strong> para conseguir 85% dto. y paquete de regalo gratis </h3>
    <dl class="price">
      <dt><del>174,78€</del> <strong>19,99€</strong></dt>
      <dd><a href="http://www.iobit.com/buy.php?product=es-db53pciupfsd1999&ref=es_db53pciupfsdpurchase1801<?php echo $refStr;?>&refs=es_purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase1801-es')" class="buybtn">Comprar ahora</a></dd>
      <dd class="text">Suscripción de 1 año / 3 PCs</dd>
    </dl>
    <div class="db-content clearfix">
      <img class="db-message" src="<?php echo getStaticUrl('images/db-message.png')?>" alt="" />
...
<div class="gift-intro  clearfix">
  <div class="wrapper">
  	<h2>Paquete de regalo gratis sólo para oferta exclusiva</h2>
    <div class="box clearfix">
      <dl>
        <dt><img src="<?php echo getStaticUrl('images/iu.png')?>" alt="" /></dt>
        <dd><h3>IObit Uninstaller PRO</h3></dd>
        <dd class="price"><del>29,99€</del> <strong>0€</strong></dd>
        <dd>El mejor desinstalador para remover programs <span>y plugins maliciosos.</span></dd>
      </dl>
      <dl>
        <dt><img src="<?php echo getStaticUrl('images/pf.png')?>" alt="" /></dt>
        <dd><h3>Protected Folder</h3></dd>
        <dd class="price"><del>39,95€</del> <strong>0€</strong></dd>
        <dd>La herramienta de protección de carpeta <span>fácil de usar y con una contraseña.</span></dd>
      </dl>
      <dl>
        <dt><img src="<?php echo getStaticUrl('images/sd.png')?>" alt="" /></dt>
        <dd><h3>Smart Defrag</h3></dd>
        <dd class="price"><del>29,99€</del> <strong>0€</strong></dd>
        <dd>Desfragmentador de disco confiable e <span>inteligente con 7,000,000+ usuarios.</span></dd>
      </dl>
    </div>
  </div>
</div>
<div class="between-buy">
    ...
    <div class="left-message">
      <p>-85% y paquete de regalo gratis <br>por comprar Driver Booster 5 PRO</p>
      <h2>-85%</h2>
    </div>
	...
	<table border="0" cellspacing="0" cellpadding="0" width="100%">
		...
		<tfoot>
			<tr>
				...
				<th class="itemb">Driver Booster FREE</th>
				<th class="itema">
					<span class="name">Driver Booster PRO </span> (1 año / 3 PCs) <br>
					<strong>19,99€</strong>  <del>174,78€</del>
					<a class="buybtn" href="http://www.iobit.com/buy.php?product=es-db53pciupfsd1999&ref=es_db53pciupfsdpurchase1801<?php echo $refStr;?>&refs=es_purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase1801-es')">Comprar ahora</a></th>
			</tr>
		</tfoot>
  </table>
</div>
...
<div class="footer">
  <div class="payment wrapper clearfix">
    ...
    <dl>
      <dt><img src="<?php echo getStaticUrl('images/dias.png')?>" alt="" /></dt>
