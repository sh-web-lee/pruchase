    ...
    <div class="wrapper">
      ...
      <div class="panel clearfix">
        <div class="box redbox">
          ...
          <a class="buybtn redbtn" href="http://www.iobit.com/buy.php?product=sv-db53pc329&ref=sv_db53pcpurchase1803kr<?php echo $refStr;?>&refs=sv_purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase1803kr-sv');">
            <i class="all-icons"></i>
            KÖP NU
          </a>
        </div>
        <div class="box graybox">
          <div class="inner">
            ...
            <a class="buybtn graybtn" href="http://www.iobit.com/buy.php?product=sv-db51pc299&ref=sv_db51pcpurchase1803kr<?php echo $refStr;?>&refs=sv_purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase1803kr-sv');">
              <i class="all-icons"></i>
              KÖP NU
            </a>
          </div>
  ...
  <div class="center-banner">
    <div class="wrapper clearfix">
      ...
      <dl class="show">
        ...
        <dd class="first active" data-name="pcs" data-url="http://www.iobit.com/buy.php?product=sv-db53pc329&ref=sv_db53pcpurchase1803kr<?php echo $refStr;?>&refs=sv_purchase_db">
          <span>
            <i class="all-icons">×</i>
            1 År/ 3 PC 
          </span>
        ...
        <dd data-name="pc" data-url="http://www.iobit.com/buy.php?product=sv-db51pc299&ref=sv_db51pcpurchase1803kr<?php echo $refStr;?>&refs=sv_purchase_db">
          <span>
            <i class="all-icons">×</i>
            1 År/ 1 PC 
          </span>
