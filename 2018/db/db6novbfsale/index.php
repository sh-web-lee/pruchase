...
<div class="banner">
  <div class="wrapper clearfix">
    ...
    <!-- banner-colour -->
    <img class="colour" src="<?php echo $pResUrl;?>images/banner-colour.png" alt="">
    <!-- left-message -->
    ...
    <div class="right-message fr">
      ...
      <!-- buybtn -->
      <a class="buybtn"
         href="https://www.iobit.com/buy.php?product=db6sdiupf&ref=db6novbf<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=purchase_db"
  ...
  <div class="container">
    ...
    <dl class="clearfix">
      ...
      <dd class="fr">
        ...
        <!-- buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=db630trial&ref=db6novbftrial<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=purchase_db"
