...
<div class="banner">
  <div class="wrapper clearfix">
    ...
    <!-- title -->
    <h1>happy Halloween Buy 1 Free 3</h1>
    <!-- left-message -->
    <div class="left-message fl">
      <img class="box" src="<?php echo $pResUrl;?>images/banner-db.png" alt="">
      <img class="off" src="<?php echo $pResUrl;?>images/banner-off.png" alt="">
      <!-- reduce -->
    ...
    <div class="right-message fr">
      ...
      <P class="cut-off">seats left</P>
      <!-- price -->
      <p class="price">Now <strong>$24.95</strong> <del>$114.83</del></p>
      <!-- buybtn -->
      <a class="buybtn"
         href="https://www.iobit.com/buy.php?product=db6sdiupf&ref=db4octhalloween<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=purchase_db"
         onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase-db410');">
        ACTIVATE NOW
      </a>
      <!-- attention -->
...
<div class="feature wrapper">
  <div class="flex clearfix">
    ...
    <dl>
      ...
      <dd>
        <img src="<?php echo $pResUrl;?>images/feature-percent650.png" alt="">
        <p>
          <span>Larger</span><br>
          Driver Database
        </p>
      ...
      <dl>
        ...
        <dd>
          ...
          <p class="pro-describe">
            ...
            for <b>Secured Privacy</b>
          </p>
        </dd>
      </dl>
    </div>
    <!-- buybtn -->
    <img class="ribbon2" src="<?php echo $pResUrl;?>images/ribbon-icon1.png" alt="">
    <a class="buybtn"
       href="https://www.iobit.com/buy.php?product=db6sdiupf&ref=db4octhalloween<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=purchase_db"
       onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase-db410');">
      get my free gifts
...
<div class="pop">
  <div class="container">
    <!-- title -->
    <h3>Try Driver Booster 6 PRO for <b>30 days</b> for <span>FREE!</span></h3>
    <!-- countdown -->
    <p class="countdown">
    ...
    <dl class="clearfix">
      ...
      <dd class="fr">
        <ul>
          <li><b>650%</b> larger driver database</li>
          <li><b>150%</b> quicker driver download</li>
          <li><b>28%</b> faster game performance</li>
        </ul>
        <!-- buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=db630trial&ref=db4octhalloweentrial<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=purchase_db"
           onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase-db410popup');">
          GET MY FREE TRIAL
        </a>
        <!-- note -->
