...
function maskShow() {
  ...
  $('.main').append('<div class="mask"></div><div class="mask-box"><h2>Oops! Black  Friday Sale Has Ended!</h2><div class="clearfix"><div class="fl left"><img src="' + imgSrc + '" alt="Driver Booster 6 Pro"/></div><div class="price fl"><img src="' + imgOff + '" alt="70% OFF"/><p><strong>$<big>21</big>.95</strong> <b><del>$74.85</del></b></p><a class="buybtn" href="' + _href + '" onclick="' + _ga + '"><i class="all-icons"></i><span>Activate Now</span></a></div></div></div>');
...
function packsInit() {
  var date = new Date();
  var cName = "ascpdbprepa" + date.getDate();
