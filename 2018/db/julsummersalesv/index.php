...
<title>Spara upp till 75% på Driver Booster PRO och du får extra skydd helt gratis!</title>
...
<script type="text/javascript" src="<?php echo $pRootUrl; ?>tpl/js/stats.js"></script>
  ...
  <div class="banner">
    <div class="wrapper">
      ...
      <h1>Begränsat Erbjudande</h1>
      <h2>Spara 75% på Driver Booster PRO + Gratis Gåvor</h2>
      ...
      <div class="right-message">
        ...
        <dl class="price">
          ...
          <dd><a href="https://www.iobit.com/buy.php?product=sv-db63pcpfsd329&ref=sv_db63pcpfsdpurchase1807<?php echo $refStr;?>&refs=sv_purchase_db" onclick=" ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase1807-sv');" class="buybtn">KÖP NU</a></dd>
  ...
  <div class="gift-message">
   <div class="wrapper">
      <p><span>75% Rabatt</span>  på Activate Driver Booster Today,</p>
      ...
      <dl>
        ...
        <dd><strong> IObit Uninstaller PRO</strong> <del>249 kr</del></dd>
        <dd>Ingen läckage av viktiga filer för <br> säker personlig integritet</dd>
      </dl>
      <a href="https://www.iobit.com/buy.php?product=sv-db63pcpfsd329&ref=sv_db63pcpfsdpurchase1807<?php echo $refStr;?>&refs=sv_purchase_db" onclick=" ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase1807-sv');" class="buybtn">Hämta mina gratis gåvor</a>
   </div>
  </div>
  <!-- media start -->
  ...
  <div class="footer-buy">
    <div class="wrapper">
      <div class="content">
        <h2>Aktivera PRO-versionen nu för att hjälpa dig att bli av med dators frustrerande problem</h2>
        <dl class="price">
          <dt><del>1 367 kr</del> <strong>329 kr</strong></dt>
          <dd><a href="https://www.iobit.com/buy.php?product=sv-db63pcpfsd329&ref=sv_db63pcpfsdpurchase1807<?php echo $refStr;?>&refs=sv_purchase_db" onclick=" ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase1807-sv');" class="buybtn">KÖP NU</a></dd>
          <dd>1 års prenumeration / 3 PC</dd>
        </dl>
      </div>
      <dl class="moneyback">
