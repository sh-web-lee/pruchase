...
<body>
  ...
  <div class="banner">
    <div class="wrapper clearfix">
      ...
      <!-- head -->
      <h1 class="head">Sommer Sale 2018</h1>
      <!-- subhead -->
      <h2 class="subhead">Driver Booster bringt dir an diesem heißen Sommertag ein neues Gefühl!</h2>
      <!-- banner-box -->
      <img class="banner-box fl" src="<?php echo $pResUrl;?>images/banner-box.png" alt="">
      <!-- banner-off -->
      <img class="banner-off fr" src="<?php echo $pResUrl;?>images/banner-off.png" alt="">
      <!-- clear float -->
      <div class="clear"></div>
      <!-- price -->
      <p class="price"><strong>26,99€</strong><i></i> <del>183.74€</del></p>
      <!-- buybtn -->
      <a class="buybtn" href="http://www.iobit.com/buy.php?product=de-db53pciusdpf2699&ref=de_db53bundle1807<?php echo $refStr;?>&refs=de_purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase201807-de');"><span>JETZT KAUFEN</span></a>
      <!-- attention -->
      <p class="attention">Von <strong class="buyNum"><?php echo $buyNum;?></strong> Personen gekauft</p>
    </div>
  </div>
  <!-- banner end -->
  ...
  <div class="centbuy">
    <div class="wrapper">
      ...
      <div class="donation clearfix">
        <h2>Das kostenfreie Geschenkpaket nur im Sommmer 2018!</h2>
        ...
        <dl>
          ...
          <dd>
            ...
            <p>Keine Sorgen um Datendiebstahl <br>Deine wichtigen und persönlichen Dateien schützen</p>
          </dd>
        </dl>
        <dl>
  ...
  <div class="floatlayer" id="floatlayer">
    <div class="wrapper clearfix">
      <img class="floatlayer-box fl" src="<?php echo $pResUrl;?>images/floatlayer-box.png" alt=""/>
      <img class="floatlayer-off fl" src="<?php echo $pResUrl;?>images/floatlayer-off.png" alt="">
      <h2 class="fl">85% Rabatt auf DB PRO und erhältest du ein besonderes Geschenkpaket (im Wert von 93,75€) Gratis!</h2>
      <div class="detail fr">
        <p class="price"><strong>26,99€</strong><i></i> <del>183,74€</del></p>
        <a class="buybtn" href="http://www.iobit.com/buy.php?product=de-db53pciusdpf2699&ref=de_db53bundle1807<?php echo $refStr;?>&refs=de_purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase201807-de');">
