...
<html lang="fr">
	<head>
		...
		<title>Economisez jusqu'à 85% sur Driver Booster PRO et obtenez gratuitement le super paquet cadeau – Vente Flash de Pâques</title>
	...
	<body>
		...
		<div class="banner">
			<div class="wrapper">
				<h1><strong>Vente Flash</strong> de Pâques 2018</h1>
				...
				<div class="right-message">
					...
					<dl class="price-content">
						...
						<dd><a href="http://www.iobit.com/buy.php?product=fr-db5sdpfiu2499&ref=fr_db5sdpfiupurchase1804&refs=fr_purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase1804-fr')" class="buybtn">VITE, J’EN PROFITE</a></dd>
				...
				<tfoot>
					<tr>
						...
						<th class="itema">
							...
							<a href="http://www.iobit.com/buy.php?product=fr-db5sdpfiu2499&ref=fr_db5sdpfiupurchase1804&refs=fr_purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase1804-fr')" class="buybtn">VITE, J’EN PROFITE</a>
						</th>
					</tr>
				</tfoot>
			</table>
