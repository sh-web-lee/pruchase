...
<div class="banner bg">
	<div class="wrapper">
		...
		<div class="title">
			...
			<h2>Thanks for your loyal support</h2>
		</div>
		<div class="content clearfix">
			...
			<div class="right-message lato">
				...
				<dl>
					...
					<dd>
						<a href="https://www.iobit.com/buy.php?product=db6sdiupf&ref=db62018novautorenew<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_db" onclick="ga('send', 'event', 'dbbuyautorenew', 'buy', 'dbpurchase-autorenew')" class="buybtn"><i></i>
		...
		<p class="try lato">
			<span class="day"><i></i>Auto-renewal Statement ><span class="pop-bg">
					The price shown in the page is valid only for this promotion. 
		 			...
		 			<br>Please note by clicking "Activate Now", you accept to receive the gifted products. Your subscription for the gifts will also continue after the initial subscription period at the non-promotional price shown on each product page.
		 			<br>
		 			<span>
		 			Cancel Auto-renewal
		 		  <br>
			...
			<span><i></i>60-Day Money-back Guarantee</span>
		</p>
	</div>
</div>
...
<div class="between-buy bg lato">
	<div class="wrapper">
		<div class="content">
			...
			<a href="https://www.iobit.com/buy.php?product=db6sdiupf&ref=db62018novautorenew<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_db" onclick="ga('send', 'event', 'dbbuyautorenew', 'buy', 'dbpurchase-autorenew')" class="buybtn save"><i></i> <span>Activate Now & <strong>Save 80%</strong></span></a>
...
<div class="activate ">
	<div class="wrapper">
		...
		<div class="clear"></div>
		<a href="https://www.iobit.com/buy.php?product=db6sdiupf&ref=db62018novautorenew<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_db" onclick="ga('send', 'event', 'dbbuyautorenew', 'buy', 'dbpurchase-autorenew')" class="buybtn save"><i></i> <span>Get My Free Gifts</span></a>
...
<div class="floatlayer" id="floatlayer">
	<div class="wrapper clearfix">
		...
		<div class="right">
			...
			<a class="buybtn" href="https://www.iobit.com/buy.php?product=db6sdiupf&ref=db62018novautorenew<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_db" onclick="ga('send', 'event', 'dbbuyautorenew', 'buy', 'dbpurchase-autorenew')"><i></i> <span>Activate Now</span></a>
		</div>
	</div>
</div>
<div class="float">
