...
function maskFirst() {
  ...
  $('.main').append('<div class="mask"></div><div class="mask-box"><h2>Sorpresa de Navidad</h2><div class="clearfix"><div class="fl left"><img src="' + imgSrc + '" alt="Driver Booster PRO"/></div><div class="price fl"><h3>¡Extra <b>1€</b> de descuento sólo para ti!</h3><p><strong>16<big>, </big></strong><span>99€ <del>164,78€</del></span></p><a class="buybtn" href="' + _href + '" onclick="' + _ga + '">Comprar ahora</a><p class="year">¡Aprovecha tu última oportunidad para ahorrar más!</p></div></div></div>');
}
