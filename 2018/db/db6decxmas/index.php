...
<div class="banner">
  ...
  <div class="wrapper clearfix">
    ...
    <div class="right-message fr">
      ...
      <!-- buybtn -->
      <a class="buybtn"
         href="https://www.iobit.com/buy.php?product=db6sdiupf&ref=db6decxmas<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=purchase_db"
    ...
    <dl class="clearfix">
      ...
      <dd class="fl">
        ...
        <a class="buybtn green"
           href="https://www.iobit.com/buy.php?product=db630trial&ref=db6decxmastrial<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=purchase_db"
