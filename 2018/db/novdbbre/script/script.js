...
function maskShow() {
  $(".banner").removeClass("sold");
  $(".mask").remove();
  $(".mask-box").remove();
  var aff = $.getUrlParam('aff');
  $('.main').append('<div class="mask"></div><div class="mask-box"><h2>OPPS! Black Friday Sale Has Ended!</h2><h3>Don ont worry, grab your another (also the last) chance</h3><div class="clearfix"><div class="fl left"><img src="' + imgSrc + '" alt="Driver Booster PRO"/></div><div class="price fl"><img src="' + imgoffSrc + '" alt="70% OFF"/><p><strong>$<big>19</big>.95</strong> <del>$74.85</del></p><a class="buybtn" href="' + _href + '" onclick="' + _ga + '">Renew Now</a></div></div></div>');
