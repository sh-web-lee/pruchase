...
<title>Promozione Limitata, sconti fino al 70% su Smart Defrag PRO – Offerte di Capodanno 2018 di IObit</title>
      ...
      <div class="offer clearfix">
        ...
        <div class="fr informa">
          ...
          <div class="price">
            ...
            <a class="buybtn" 
               href="https://www.iobit.com/buy.php?product=it-sd63pcpf1799&ref=it_sd63pcpfpurchase1709<?php echo $refStr;?>&refs=it_purchase_sd" onclick="ga('send', 'event', 'sdbuy', 'buy', 'sdpurchase1709-it')">
              ACQUISTA ORA
            </a>
  ...
  <div class="intro wrapper">
    ...
    <div class="cont clearfix">
      ...
      <div class="fl fl-right">
        ...
        <a class="compareBtn" href="javascript: void(0);">Comparazione tra la versione Free &amp; PRO >></a>
      </div>
    </div>
  </div>
  <!-- intro end -->
