...
<body>
    ...
    <div class="container">
      <div class="wrapper">
        ...
        <div class="header">
           ...
           <div class="title">
             <h1>Mid-Year Big  Sale</h1>
             <p> Smart Defrag 6 PRO </p>
           </div>
        </div>
        <!-- activity -->
        <div class="activity">
  ...
  <div class="gift-pack wrapper">
    <h2>Mid-Year Sale Free Gift Pack</h2>
    <dl>
      <dt><img src="<?php echo $pResUrl; ?>images/boxshot-sd-two.png" alt="Smart Defrag PRO"></dt>
