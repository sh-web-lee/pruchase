...
<head>
  ...
  <title>Adquira Smart Defrag 6 Pro para 3 PCs com 35% de desconto. Oferta Limitada da IObit.</title>
...
<script type="text/javascript" src="<?php echo $pRootUrl; ?>tpl/js/stats.js"></script>
  ...
  <div class="banner">
    <div class="wrapper">
      ...
      <p class="subhead">Compre Smart Defrag Pro com e leve suporte para 2 PCs extras!</p>
      <div class="offer clearfix">
        ...
        <div class="right fr">
          ...
          <p>Otimiza o seu disco para um PC mais rápido</p>
          <div class="price">
          ...
          <a class="buybtn"
             href="http://www.iobit.com/buy.php?product=pt-sd63pc7699&ref=pt_sd6purchase1803<?php echo $refStr;?>&refs=pt_purchase_sd" 
      ...
      <table border="0" cellspacing="0" cellpadding="0" width="100%">
        <thead>
          <tr>
            ...
            <th class="speac"></th>
            <th class="itemb">Smart Defrag PRO <p>1 Ano, 3 PCs</p></th>
          </tr>
        </thead>
        <tbody>
          <tr>
