	...
	<script type="text/javascript" src="<?php echo $pRootUrl; ?>tpl/js/stats.js"></script>
		...
		<div class="header">
			<div class="wrapper">
				...
				<h1>Tot wel 70% KORTING Flash Sale €40 aan gifts met SD 6 PRO</h1>
          ...
          <img src="<?php echo getStaticUrl('images/sd-box.png')?>" alt=""/>
				...
				<div class="right">
					<dl class="message">
						<dt><strong>Smart Defrag 6 PRO <span>(1 Jaar/ 1 PC)</span></strong> <b>€19,99</b> <del>€29,99</del></dt>
					...
					<dl class="buy">
						...
						<dd><a href="https://www.iobit.com/buy.php?product=nl-sd61y3pcamc1999&ref=nl_sd63pcamcpurchase1805<?php echo $refStr;?>&refs=nl_purchase_sd" onclick="ga('send', 'event', 'sdbuy', 'buy', 'sdpurchase1805-nl')" class="buybtn">Activeer Nu</a></dd>
      ...
      <table border="0" cellspacing="0" cellpadding="0" width="100%">
        ...
        <tr>
          ...
          <th class="itema"><span>SD PRO + Gratis Geschenk</span>
            ...
            1 Jaar / 3 PCs
            <a href="https://www.iobit.com/buy.php?product=nl-sd61y3pcamc1999&ref=nl_sd63pcamcpurchase1805<?php echo $refStr;?>&refs=nl_purchase_sd" onclick="ga('send', 'event', 'sdbuy', 'buy', 'sdpurchase1805-nl')" class="tbbuybtn">Activeer Nu</a>
  ...
  <div class="fy-banner wrapper">
    <img src="<?php echo getStaticUrl('images/bottom-sd-content.png')?>" alt=""/>
  	<dl>
  		...
  		<dt>
  			<a href="https://www.iobit.com/buy.php?product=nl-sd61y3pcamc1999&ref=nl_sd63pcamcpurchase1805<?php echo $refStr;?>&refs=nl_purchase_sd" onclick="ga('send', 'event', 'sdbuy', 'buy', 'sdpurchase1805-nl')" class="buybtn">Activeer Nu</a>
  		</dt>
  	</dl>
  </div>
