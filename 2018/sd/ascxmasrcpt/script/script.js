...
function maskShow() {
  ...
  $('.main').append('<div class="mask"></div><div class="mask-box"><h2>Promoção de Natal!</h2><div class="clearfix"><div class="fl left"><img src="' + imgSrc + '" alt="Advanced SystemCare 12 Pro"/></div><div class="price"><h3><b>R$4</b> extra de desconto para você</h3><p><strong><big>R$</big>72<big>,</big></strong> <span>99 <del>R$ 199,90</del></span></p> <a class="buybtn" href="' + _href + '" onclick="' + _ga + '">Comprar agora</a><p class="year">1 ano de assinatura / 3 PCs</p></div></div></div>');
...
function packsInit() {
  ...
  packs = Math.ceil(timeDiff / 4.42) > 0 ? Math.ceil(timeDiff / 4.42) : 0;
  reduceNum(packs, 1);
...
function getSales() {
  ...
  var nowTime = Math.floor(date.getTime() / 1000);
  var timeDiff = countTime - nowTime;
  var packsNow = Math.ceil(timeDiff / 4.42) > 0 ? Math.ceil(timeDiff / 4.42) : 0;
  if (packsNow != packs) {
    if (statusCheck() == 2) {
      packs = 0;
    } else {
