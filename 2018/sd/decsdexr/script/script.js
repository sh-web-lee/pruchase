...
function timeInit() {
  var date = new Date();
  var cName = "sdexrpre" + date.getDate();
...
function packsInit() {
  var date = new Date();
  var cName = "sdexrprepa" + date.getDate();
...
$(function() {
  ...
  $(window).scrollWindow($(".feature .screen"), $('.floatlayer'), ("on"));
  $("#backtotop").target($(".banner"), 0);
  numberJump($('.viewNum'), viewNum, 500, 1500);

  $(window).scroll(function() {
    var scrollTop = $(this).scrollTop();
    var stopHeight = $(".comparison h2").offset().top;
