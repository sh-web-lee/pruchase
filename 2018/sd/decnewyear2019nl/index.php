...
<head>
  ...
  <title>Gelukkig Nieuwjaar: 75% korting op Smart Defrag PRO - IObit</title>
...
<div class="header">
  <div class="wrapper">
    ...
    <h1>75% KORTING Gelukkig Nieuwjaar! Tijdelijke aanbieding</h1>
  ...
  <div class="content">
    ...
    <div class="right">
      ...
      <dl class="buy">
        ...
        <dd>
          <!-- buybtn -->
          <a href="https://www.iobit.com/buy.php?product=nl-sd61y3pcamc1799&ref=nl_sd63pcamcpurchase1812<?php echo $refStr;?>&refs=nl_purchase_sd"
             onclick="ga('send', 'event', 'sdbuy', 'buy', 'sdpurchase1812-nl')"
             class="buybtn">
            <i></i>
            Activeer Nu
          </a>
...
<!-- footer -->
<div class="footer">
  <p>Copyright © 2005 - 2019 IObit. Alle rechten voorbehouden</p>
</div>
<!-- footer end -->
