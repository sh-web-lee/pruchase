...
<head>
  ...
  <title>Adquira Smart Defrag 6 Pro com 75% de desconto e leve um super brinde para cuidar do desempenho e segurança do seu dispositivo móvel. Oferta Especial de Ano Novo da IObit. </title>
...
<script type="text/javascript" src="<?php echo $pRootUrl; ?>tpl/js/stats.js"></script>
  ...
  <div class="banner">
    <div class="wrapper">
      ...
      <h1>Ano Novo Oferta Limitada</h1>
      <div class="offer clearfix">
        ...
        <div class="right fr">
          ...
          <a class="buybtn"
             href="https://www.iobit.com/buy.php?product=pt-sd63pcamc7699&ref=pt_sd63pcamcpurchase1812<?php echo $refStr;?>&refs=pt_purchase_sd"
             onclick="ga('send', 'event', 'sdbuy', 'buy', 'sd6purchase1812-pt')">
            COMPRAR AGORA
          </a>
  ...
  <div class="donation wrapper">
    <h2>No ano novo, você leva um super brinde grátis para cuidar <br>do seu dispositivo móvel!</h2>
    <dl class="clearfix">
  ...
  <div class="footbuy">
    <div class="wrapper">
      ...
      <p>Aproveite a super oferta de Ano Novo e leve Smart Defrag Pro para 3 PCs e mais um super brinde!  </p>
      <dl class="clearfix">
