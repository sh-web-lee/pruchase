...
function maskShow() {
  $(".mask").remove();
  $(".mask-box").remove();
  $('.main').append('<div class="mask"></div><div class="mask-box"><h2>Julöverraskning</h2><div class="clearfix"><div class="fl left"><img src="' + imgSrc + '" alt="Advanced SystemCare 12 Pro"/></div><div class="price fl"><h3>Extra <b>10kr Rabatt</b> bara för dig!</h3><p><strong>239</strong><span>kr <del>1 098kr</del></span></p> <a class="buybtn" href="' + _href + '" onclick="' + _ga + '">Aktivera Nu</a></div></div><p class="year">Missa inte din sista chans till största besparingen någonsin!</p></div>');
...
function timeInit() {
  var date = new Date();
  var cName = "sviupre" + date.getDate();
