...
function maskShow() {
  ...
  $('.main').append('<div class="mask"></div><div class="mask-box"><h2>Julöverraskning</h2><div class="clearfix"><div class="fl left"><img src="' + imgSrc + '" alt="Driver Booster PRO 6"/></div><div class="price fl"><h3>Extra <b>10kr Rabatt</b> som <br> vår present till dig</h3><p><i>Bara</i> <strong>209</strong> <span>kr </span> <i>1 År / 3 Datorer</i></p> <a class="buybtn" href="' + _href + '" onclick="' + _ga + '">Aktivera Nu</a><p class="year">Ta sista chans till den största <br> besparingen någonsin!</p></div></div></div>');
