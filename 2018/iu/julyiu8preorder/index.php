...
<body>
    ...
    <div class="wrapper">
     ...
     <div class="message clearfix">
        ...
        <div class="right-message">
          ...
          <a href="https://www.iobit.com/buy.php?product=iu8preorder&ref=iu8preorder<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_iu" onclick="ga('send', 'event', 'iubuy', 'buy', 'iu8predorder');" class="buybtn"><span>Pre-order Now</span></a>
  ...
  <div class="feature wrapper clearfix">
    ...
    <h3>new features and improvements worth trying</h3>
    <dl>
      <dt><img src="<?php echo getStaticUrl('images/icons01.png')?>" alt=""></dt>
      <dd><span>Bundleware Uninstall</span></dd>
      <dd>Detect adware, toolbars, and unwanted third-party programs that install alongside freeware to advertise or steal your privacy data.</dd>
    </dl>
    <dl>
      <dt><img src="<?php echo getStaticUrl('images/icons02.png')?>" alt=""></dt>
      <dd><span>Stubborn Programs Uninstall</span></dd>
      <dd>Completely uninstall unwanted programs or stubborn programs you can't uninstall by Windows or other programs.</dd>
    </dl>
    <dl>
    ...
    <dl>
      ...
      <dd><span>Identify Malicious Plugins </span></dd>
      <dd>Remove malicious or advertising supported plug-ins from browser to ensure secure & clean browsing experience.</dd>
    </dl>
  </div>
  <!-- end feature -->
  <!-- compar-tab start -->
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%">
      <thead>
        <tr>
          <th class="itema"></th>
          <th class="itemb">
            Bundleware <br> Uninstall
          </th>
          <th class="itemb">
            Stubborn Programs  <br> Uninstall
          </th>
          <th class="itemb">
            Software Update
          </th>
          <th class="itemb">
            Malicious Plugins   <br> Removal
          </th>
        </tr>
      </thead>
      <tbody>
        <tr>
          <td class="itema">Your current version</td>
          <td class="itemb"><i class="close"></i>Not available</td>
          <td class="itemb"><i class="close"></i>Not available</td>
          <td class="itemb"><i class="close"></i>Not available</td>
          <td class="itemb"><i class="close"></i>Not available</td>
        </tr>
  ...
  <div class="between-buy wrapper">
    <h2>and pay <strong>$0</strong> to enjoy the latest PRO version today</h2>
    <a href="https://www.iobit.com/buy.php?product=iu8preorder&ref=iu8preorder<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_iu" onclick="ga('send', 'event', 'iubuy', 'buy', 'iu8predorder');" class="buybtn"><span>Pre-order Now</span></a>
...
<!-- end payments -->
  ...
  <div class="float clearfix">
    <div class="wrapper">
      ...
      <a href="https://www.iobit.com/buy.php?product=iu8preorder&ref=iu8preorder<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_iu" onclick="ga('send', 'event', 'iubuy', 'buy', 'iu8predorder');" class="buybtn"><span>$0 Pre-order Now</span></a>
    </div>
  </div>
  <div class="pop-over">
    <h2>OOPS</h2>
    <h3>Pre-order reservations are full today.</h3>
    <a href="https://purchase.iobit.com/en/iu/index.php" onclick="ga('send', 'event', 'iu7buy', 'buy', 'iu8predorder');">Check another offer>></a>
  </div>
