...
<head>
  ...
  <title>Ahorra 75% para comprar Advanced SystemCare PRO y IObit Uninstaller PRO- IObit</title>
...
<div class="banner">
  <div class="wrapper">
    ...
    <h1>IObit Uninstaller PRO OFERTA EXCLUSIVA</h1>
    ...
    <div class="container clearfix">
      <dl class="left">
        ...
        <dd><strong>MXN 369.00 </strong><del> MXN 609.00</del></dd> 
        <dd><a class="buybtn" href="https://www.iobit.com/buy.php?product=mx-iu73pc369&ref=mx_iu73pcxmaspurchase1801<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=mx_purchase_iu" onclick="ga('send', 'event', 'iubuy', 'buy', 'iuascpurchase1801-mx')"> Comprar ahora</a></dd>
        <dd class="last">
          ...
          <p class="no">Limpieza y reparación de PC más </p>
          <p><del>MXN 609.00</del> ahorra MXN 260.00</p>
        </dd>
      </dl>
      <dl class="right">
        ...
        <dd><strong>MXN 399.00 </strong><del> MXN 1,628.00</del></dd>
        <dd><a class="buybtn" href="https://www.iobit.com/buy.php?product=mx-iuasc3pc399&ref=mx_iu7asc11purchase1801<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=mx_purchase_iu" onclick="ga('send', 'event', 'iubuy', 'buy', 'iuascpurchase1801-mx')">Comprar ahora</a></dd>
        <dd class="last">
          ...
          <p><del>MXN 1,628.00 </del> Ahorra  <strong>MXN 1,229.00</strong> </p>
        </dd>
      </dl>
    </div>
  </div>
...
<div class="product">
  ...
  <div class="wrapper">
    <dl class="left">
      ...
      <dd>Limpia automáticamente RAM y rastro de privacidad online</dd>
      <dd>Limpia y repara todos los tipos de problemas de PC con un clic</dd>
    </dl>
    <dl class="right">
      <dt><img src="<?php echo $pResUrl; ?>images/product-free.png" alt=""><strong>IObit Uninstaller PRO</strong></dt>
      <dd>Detecta y desinstala Bundleware y Plug-ins incluidos</dd>
      <dd>Navegación más rápida y más segura mediante eliminación de barras de herramientas maliciosas </dd>
      <dd>Limpia automáticamente restos que otros programas no <br> pudieron desinstalar</dd>
...
<div class="foot-banner">
  <div class="wrapper">
    ...
    <dl>
      <dt>Sólo <strong> MXN 399.00</strong> <del>MXN 1,628.00</del></dt>
      <dd><a href="https://www.iobit.com/buy.php?product=mx-iuasc3pc399&ref=mx_iu7asc11purchase1801<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=mx_purchase_iu" onclick="ga('send', 'event', 'iubuy', 'buy', 'iuascpurchase1801-mx')" class="buybtn">Comprar ahora</a></dd>
