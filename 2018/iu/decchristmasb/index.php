...
<head>
  ...
  <link href='https://fonts.googleapis.com/css?family=Lato:400,700,700i' rel='stylesheet' type='text/css'>
        ...
        <div class="showcase">
          ...
          <div class="checkout">
            <dl>
              ...
              <dd>
                <a class="buybtn activebtn" href="https://www.iobit.com/buy.php?product=iu8pro1677&ref=<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_iu" onclick="ga('send', 'event', 'iubuy', 'buy', 'iupurchase-201812');">
                  Activate Now
                </a>
              </dd>
  ...
  <div class="benfits wrapper">
    ...
    <div class="benfits-list clearfix">
      ...
      <div class="list fr">
        ...
        <dl>
          <dt>Safe Software Update <i>ATTENTION</i></dt>
          <dd>
            With just one click, you can update important software without any user intervention, including <b>WinRAR*, whose existing security flaw may put your computer at risk for years.</b>
          ...
          <tr>
            ...
            <th class="item-pro">
              <dl>
                ...
                <dd>
                  <a class="buybtn activesmall" href="https://www.iobit.com/buy.php?product=iu8pro1677&ref=<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_iu" onclick="ga('send', 'event', 'iubuy', 'buy', 'iupurchase-201812');">
                    ACTIVATE NOW
                  </a>
                </dd>
