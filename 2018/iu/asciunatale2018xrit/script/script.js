...
function maskShow() {
  ...
  $('.main').append('<div class="mask"></div><div class="mask-box"><h2>Sorpresa di Capodanno!</h2><div class="clearfix"><div class="fl left"><img src="' + imgSrc + '" alt="Advanced SystemCare 12 Pro"/></div><div class="price"><h3>Hai vinto <b>€1</b> di extra sconto esclusivo!</h3><p><strong>18<small>,</small></strong> <span><b>99</b><del>€79,98</del> </span></p> <a class="buybtn" href="' + _href + '" onclick="' + _ga + '">Approfittane Ora!</a><p class="year">Cogli questa ultima opportunità per il grande risparmio in assoluto!</p></div></div></div>');
...
function packsInit() {
  ...
  packs = Math.ceil(timeDiff / 5.46) > 0 ? Math.ceil(timeDiff / 5.46) : 0;
  reduceNum(packs, 1);
...
function getSales() {
  ...
  var nowTime = Math.floor(date.getTime() / 1000);
  var timeDiff = countTime - nowTime;
  var packsNow = Math.ceil(timeDiff / 5.46) > 0 ? Math.ceil(timeDiff / 5.46) : 0;
  if (packsNow != packs) {
    if (statusCheck() == 2) {
      packs = 0;
    } else {
