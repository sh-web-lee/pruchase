...
function onePc() {
  $(".bottomcart .buybtn").attr("href","https://www.iobit.com/buy.php?product=it-iu81pc1999&ref=it_iu81pcpurchase1812"+ refStr +"&refs=it_purchase_iu&tw=-8");
  $(".bottomcart dl dt").html("<strong><b>19</b> ,99</strong>");
  $(".showcase .img").addClass("one-pc");
}
function threePc() {
  $(".bottomcart .buybtn").attr("href","https://www.iobit.com/buy.php?product=it-iu83pcsdpf1599&ref=it_iu83pcsdpfpurchase1812"+ refStr +"&refs=it_purchase_iu&tw=-8");
  $(".bottomcart dl dt").html("<strong><b>15</b> ,99</strong> <del>99,93<i></i></del> <sup>Risparmi 83,94</sup>");
...
$(function () {
  ...
  $(".benfits .detail-list dl").hover(function() {
    $(".benfits .detail-list dl").removeClass("active").eq($(this).index()).addClass('active');
