...
function maskShow() {
  ...
  $('.main').append('<div class="mask"></div><div class="mask-box"><h2>Sorpresa deNavidad</h2><div class="clearfix"><div class="fl left"><img src="' + imgSrc + '" alt="Advanced SystemCare 12 Pro"/></div><div class="price fl"><h3>¡Extra <b>1€</b> de descuento sólo para ti!</h3><p><strong><small>Sólo</small>18</strong> <span><del>79,98€</del><b>,99€</b> </span></p> <a class="buybtn" href="' + _href + '" onclick="' + _ga + '">Comprar ahora</a><p class="year">¡Aprovecha tu última oportunidadpara ahorrar más!</p></div></div></div>');
...
function packsInit() {
  ...
  packs = Math.ceil(timeDiff / 6.67) > 0 ? Math.ceil(timeDiff / 6.67) : 0;
...
function getSales() {
  ...
  var nowTime = Math.floor(date.getTime() / 1000);
  var timeDiff = countTime - nowTime;
  var packsNow = Math.ceil(timeDiff / 6.67) > 0 ? Math.ceil(timeDiff / 6.67) : 0;
  if (packsNow != packs) {
    if (statusCheck() == 2) {
      packs = 0;
    } else {
