...
<body>
  ...
  <div class="main">
        ...
        <div class="palen clearfix">
          ...
          <div class="right fr">
            ...
            <div class="price">
              ...
              <a class="buybtn" href="https://www.iobit.com/buy.php?product=iu83pc1477&ref=xr_iu&refs=purchase_iux" onclick="ga('send', 'event', 'iubuy', 'buy', 'iupurchase-xmas');">
                Activate Now
              </a>
    ...
    <div class="feature">
      <div class="wrapper">
        <h2>Keep Stubborn Programs & Malicious Plug-ins away from Your PC  </h2>
        <p class="over">
         Trusted by 25,000,000+ users worldwide, IObit Uninstaller PRO keeps your computer free of clutter and ensures safe online browsing. 
        </p>
        <img class="screen" src="<?php echo getStaticUrl('images/iu-screen.png')?>" alt="IObit Uninstaller PRO"/>
        <div class="clearfix">
          <div class="fl">
            <dl class="clearfix">
              <dt><img src="<?php echo getStaticUrl('images/feature-01.png')?>" alt=""/></dt>
              <dd>
                <h3>Bundleware Cleaning </h3>
                <p>
                 Get rid of annoying bundleware, which installed unnoticeably, to free up space.
                 <b> *PRO Only</b>
                </p>
              </dd>
            </dl>
            <dl class="clearfix">
              ...
              <dd>
                <h3>No Stubborn Programs</h3>
                <p>Programs that can’t be deleted by other utilities couldn’t be piled up.
                 <b>*PRO Only</b>
                </p>
              </dd>
            </dl>
          ...
          <div class="fr">
            <dl class="clearfix">
              ...
              <dd>
                <h3>Malicious Plug-ins Removal</h3>
                <p>
                  Remove malicious or ad-based plug-ins to ensure safe online browsing.
                  <b>*PRO Only</b>
                </p>
              </dd>
            </dl>
            <dl class="clearfix">
              ...
              <dd>
                ...
                <p>
                  Automatically detect & clean leftovers of uninstalled programs 
                   <b>*PRO Only</b>
                </p>
              </dd>
            </dl>
    ...
    <!-- centbuy start -->
    <div class="centbuy">
      <h2>So Get PRO Now for Cleaner PC & Safer Browsing </h2>
      <div class="wrapper clearfix">
        <div class="fl">
          <img src="<?php echo getStaticUrl('images/iu-small-box.png')?>" alt="IObit Uninstaller PRO"/>
        </div>
        <div class="price fr">
          <div class="count">
            <p class="watching">
          ...
          <p><strong>$<big>14</big>.77</strong> <del>$29.99</del></p>
          <a class="buybtn yellow" href="https://www.iobit.com/buy.php?product=iu83pc1477&ref=xr_iu&refs=purchase_iux" onclick="ga('send', 'event', 'iubuy', 'buy', 'iupurchase-xmas');">
            Activate Now
          </a>
          <p class="year">1 Year Subscription / 3 PCs</p>
          <img class="moneyback" src="<?php echo getStaticUrl('images/moneyback.png')?>" alt=""/>
  ...
  <div class="comparison" id="compare">
    <div class="wrapper">
      <h2>To See Exactly What You Would Enjoy, if You Activate Now:</h2>
      <table border="0" cellspacing="0" cellpadding="0" width="100%">
        ...
        <tr>
          ...
          <td class="itemb">Uninstall Unwanted Programs & Plug-ins</td>
          <td class="itemc"><i class="all-icons pro">√</i></td>
        </tr>
        <tr>
          <td class="itema"><i class="all-icons close">×</i></td>
          <td class="itemb">Uninstall Bundleware</td>
          <td class="itemc"><i class="all-icons pro">√</i></td>
        </tr>
        <tr>
          <td class="itema"><i class="all-icons close">×</i></td>
          <td class="itemb">Remove Stubborn Programs</td>
          <td class="itemc"><i class="all-icons pro">√</i></td>
        </tr>
        <tr>
          <td class="itema"><i class="all-icons close">×</i></td>
          <td class="itemb">Remove Malicious/Ad-based Plug-ins</td>
          <td class="itemc"><i class="all-icons pro">√</i></td>
        </tr>
        <tr>
          <td class="itema"><i class="all-icons close">×</i></td>
          <td class="itemb">Clean Leftovers</td>
          <td class="itemc"><i class="all-icons pro">√</i></td>
        </tr>
        <tr>
          <td class="itema"><i class="all-icons close">×</i></td>
          <td class="itemb">Update Programs with 1-click</td>
          <td class="itemc"><i class="all-icons pro">√</i></td>
        </tr>
        <tr>
          <td class="itema"><i class="all-icons close">×</i></td>
  ...
  <div class="between-message wrapper">
    ...
    <h3>Get Exclusive 50% OFF to Make Your PC Cleaner, Safer & Faster</h3>
    <div class="price">
       <p><strong>$<big>14</big>.77</strong> <del>$29.99</del></p>
       <a class="buybtn" href="https://www.iobit.com/buy.php?product=iu83pc1477&ref=xr_iu&refs=purchase_iux" onclick="ga('send', 'event', 'iubuy', 'buy', 'iupurchase-xmas');">
        Activate Now
  ...
  <!-- between-message end -->
    ...
    <div class="review wrapper">
      <div id="dg-container" class="dg-container">
        ...
        <div class="content dg-wrapper">
          <dl class="reviews">
            <dt><img src="<?php echo getStaticUrl('images/giga.png')?>" alt="PC Magazine"></dt>
            <dd>
              <h2>Editor Review</h2>
              <p>
          ...
          <dl class="reviews">
            <dt><img src="<?php echo getStaticUrl('images/fernando-lourenco-gomes.png')?>" alt="Fernando Lourenço Gomes"></dt>
            <dd>
              <h2>User Review</h2>
        ...
        <div class="service clearfix">
          <dl class="fl">
            ...
            <dd>
              ...
              <p>
                We’re confident that activating PRO edition will <strong>give you a cleaner PC and safer online browsing </strong> for affordable price! 
              </p>
            </dd>
          </dl>
          <dl class="fr">
    ...
    <div class="floatlayer">
        <div class="wrapper clearfix">
          <img class="fl" src="<?php echo getStaticUrl('images/iu-fl-box.png')?>" alt="IObit Uninstaller PRO"/>
          <div class="price fl">
            <div class="count">
              <ul class="clearfix">
          ...
          <!-- buybtn -->
          <a class="buybtn yellow fr" href="https://www.iobit.com/buy.php?product=iu83pc1477&ref=xr_iu&refs=purchase_iux" onclick="ga('send', 'event', 'iubuy', 'buy', 'iupurchase-xmas');">
            Activate Now
          </a>
        </div>
    </div>
    ...
    <div class="popShow">
      ...
      <div class="clearfix">
        <div class="imgbox fl">
          <img src="<?php echo getStaticUrl('images/iu-pop-box.png')?>" alt="IObit Uninstaller PRO"/>
        </div>
        <div class="price fl">
         <h3>Extra $<b>1</b> OFF as our gift for you!</h3>
          <p>Only $<strong><big>13</big>.<span>77</span></strong> <span>1 year / 3 PCs</span></p>
          <a class="buybtn yellow" href="https://www.iobit.com/buy.php?product=iu83pc1377&ref=xr_iu1377&refs=purchase_iux" onclick="ga('send', 'event', 'iubuypop', 'buy', 'iupurchase-xmas);">
            Activate Now
          </a>
