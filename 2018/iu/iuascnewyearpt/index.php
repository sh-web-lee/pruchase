...
<head>
  ...
  <title>Adquira Advanced SystemCare 12 Pro e IObit Uninstaller Pro com 75% de desconto. Oferta Especial de Ano Novo da IObit.</title>
        ...
        <div class="right fr">
          ...
          <div class="price">
            <div class="count">
              ...
              <p id="bandown" class="countdown">Corra! <b>00</b>H:<b>05</b>M:<b>00</b>S:<b class="last">000</b>Ms restantes</p>
            </div>
            <p><strong><small>R$</small>64</strong> <span><del>R$ 299,89</del><b>,99</b> </span></p>
            <!-- buybtn -->
            <a class="buybtn"
               href="http://www.iobit.com/buy.php?product=pt-iuasc123pc6499&ref=pt_asciu3pcpurchase1812rc<?php echo $refStr;?>&refs=pt_purchase_asc&aff=<?php echo $_GET['aff']; ?>"
               onclick="ga('send', 'event', 'iubuy', 'buy', 'iuascpurchase1812-pt');">
              Comprar Agora
            </a>
...
<script>
  ...
  var _href = "http://www.iobit.com/buy.php?product=pt-asciu3pc5999&ref=pt_asciu3pcpurchase1812<?php echo $refStr;?>&refs=pt_purchase_asc&aff=<?php echo $_GET['aff']; ?>&tw=-8";
  var _ga = "ga('send', 'event', 'iubuy', 'buy', 'iuascpurchase1812-pt');";
