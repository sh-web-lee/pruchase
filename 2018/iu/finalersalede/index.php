...
<script type="text/javascript" src="<?php echo $pRootUrl; ?>tpl/js/stats.js"></script>
  ...
  <div class="banner">
    <div class="wrapper">
      ...
      <h2>Letzte Chance - bis zu 80% reduziert</h2>
      <div class="panel clearfix">
        ...
        <div class="offer fl">
          ...
          <div class="price">
            ...
            <a class="buybtn" 
               href="https://www.iobit.com/buy.php?product=de-iu8pfsd1899&ref=de_iu8pfsd1809<?php echo $refStr;?>&aff=&refs=de_purchase_iu"
               onclick="ga('send', 'event', 'iubuy', 'buy', 'iupurchase201809-de')"
  ...
  <div class="intro wrapper">
    ...
    <div class="feature clearfix">
      ...
      <ul class="fl">
        ...
        <li>Bündel-Software, Adware und Plug-Ins werden erkannt und gelöscht.</li>
        <li>Dank des verbesserten Tiefenscans werden alle Programmreste automatisch gefunden und bereinigt.</li>
        <li>
  ...
  <div id="test" class="donation" >
    <div class="wrapper">
      <h2>Kostenlose Geschenke nur für kurze Zeit!</h2>
      <div class="clearfix">
        <dl class="fl">
      ...
      <table border="0" cellspacing="0" cellpadding="0" width="100%">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="virtue">Erweiterte Datenbasis zur Entfernung hartnäckigster Programme <span class="two">Verbessert</span></td>
          ...
          <tr>
            ...
            <td class="virtue">Erweiterte Datenbasis für die Findung und Entfernung bösartiger Plug-Ins <span class="two">Verbessert</span></td>
            <td class="itemb"><i class="all-icons circle">√</i></td>
            <td class="itema"><i class="all-icons red">√</i></td>
          </tr>
          <tr>
            <td class="icons" width="45"><img src="<?php echo getStaticUrl('images/icon_07.png')?>" alt="" /></td>
            <td class="virtue">Erweiterte Datenbasis für die Findung und Entfernung von Werbe-Plug-Ins <span class="two">Verbessert</span></td>
            <td class="itemb"><i class="all-icons circle">√</i></td>
            <td class="itema"><i class="all-icons red">√</i></td>
          </tr>
          <tr>
            <td class="icons" width="45"><img src="<?php echo getStaticUrl('images/icon_08.png')?>" alt="" /></td>
            <td class="virtue">Updatet noch mehr essenzielle Software mit einem Klick <span class="two five">Verbessert</span></td>
            <td class="itemb"><i class="all-icons circle">√</i></td>
            <td class="itema"><i class="all-icons red">√</i></td>
          </tr>
          <tr>
  ...
  <div class="floatlayer" id="floatlayer">
    <div class="wrapper clearfix">
      <div class="left fl">
        <h2><span>Sofortrabatt nur für kurze Zeit!</span> Solange Vorrat reicht!</h2>
