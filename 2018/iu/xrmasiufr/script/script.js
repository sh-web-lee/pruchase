...
function maskShow() {
  ...
  $('.main').append('<div class="mask"></div><div class="mask-box"><h2>Surprise de Noël </h2><div class="clearfix"><div class="fl left"><img src="' + imgSrc + '" alt="Driver Booster PRO 6"/></div><div class="price fl"><h3>Réduction de <b>1€</b> exclusivement <br>pour vous !</h3><p><strong>13<big>,99€</big></strong> <del>99,97€</del></p> <a class="buybtn" href="' + _href + '" onclick="' + _ga + '">VITE, J’EN PROFITE</a><p class="year">Saisissez votre dernière chance</p></div></div></div>');
...
function timeInit() {
  var date = new Date();
  var cName = "friupre" + date.getDate();
