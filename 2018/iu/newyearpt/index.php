...
<head>
    ...
    <title>Adquira IObit Uninstaller 8 Pro com 70% de desconto e leve um super brinde para proteger suas pastas importantes. Oferta Especial Ano Novo da IObit.</title>
...
<body>
    ...
    <div class="banner">
      <div class="wrapper">
        ...
        <!-- title -->
        <h1> Promoção Exclusiva de Ano Novo! Tempo limitado, Apenas uma Vez no Ano!</h1>
        <!-- banner-content -->
        <div class="banner-content">
          ...
          <div class="banner-right fr">
            ...
            <!-- buybtn -->
            <a class="buy-btn"
               href="https://www.iobit.com/buy.php?product=pt-iu83pcpf5599&ref=pt_iu83pcpfpurchase1812<?php echo $refStr;?>&refs=pt_purchase_iu" onclick="ga('send', 'event', 'iubuy', 'buy', 'iu8purchase1812-pt')">
              COMPRAR AGORA
            </a>
        ...
        <thead>
          <tr>
            ...
            <th class="itema"><strong>IObit Uninstaller 8 PRO</strong>
                ...
                <a href="https://www.iobit.com/buy.php?product=pt-iu83pcpf5599&ref=pt_iu83pcpfpurchase1812<?php echo $refStr;?>&refs=pt_purchase_iu" onclick="ga('send', 'event', 'iubuy', 'buy', 'iu8purchase1812-pt')" class="buybtn">Comprar Agora</a>
            </th>
          </tr>
        </thead>
        <tbody>
    ...
    <!--footer end -->
    <div class="fl-bg">
      <img src="<?php echo getStaticUrl('images/left-bg.jpg')?>" alt="" class="fl">
      <img src="<?php echo getStaticUrl('images/right-bg.jpg')?>" alt="" class="fr">
    </div>
