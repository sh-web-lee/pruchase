$(document).ready(function() {
	$('#dg-container').gallery();
		$('.progress-bar .bar >span').addClass("normal").css("width","46px");
		setTimeout(function () {
...
function timeInit() {
	var date = new Date();
	var cName = "eniupreoff_e" + date.getDate();
...
function packsInit() {
	var date = new Date();
	var cName = "eniupreoff_p" + date.getDate();
