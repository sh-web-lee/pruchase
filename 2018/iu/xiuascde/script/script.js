...
function maskShow() {
  ...
  $('.main').append('<div class="mask"></div><div class="mask-box"><h2>Überraschung zu Weihnachten!</h2><div class="clearfix"><div class="fl left"><img src="' + imgSrc + '" alt="Advanced SystemCare 12 Pro"/></div><div class="price fl"><h3>Unser Geschenk nur für Sie: <b>1€</b> Rabatt</b> </h3><p><strong>20</strong> <span><b>,99€</b> </span> <sub>1 Jahr / 3 PCs</sub></p> <a class="buybtn" href="' + _href + '" onclick="' + _ga + '">Jetzt aktivieren</a><p class="year">Nutzen Sie ihre letzte Chance an <br>Weihnachten zu Sparen!</p></div></div></div>');
...
function packsInit() {
  ...
  packs = Math.ceil(timeDiff / 4.92) > 0 ? Math.ceil(timeDiff / 4.92) : 0;
  reduceNum(packs, 1);
...
function getSales() {
  ...
  var nowTime = Math.floor(date.getTime() / 1000);
  var timeDiff = countTime - nowTime;
  var packsNow = Math.ceil(timeDiff / 4.92) > 0 ? Math.ceil(timeDiff / 4.92) : 0;
  if (packsNow != packs) {
    if (statusCheck() == 2) {
      packs = 0;
    } else {
