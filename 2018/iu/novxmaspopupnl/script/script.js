...
function maskShow() {
  ...
  $('.main').append('<div class="mask"></div><div class="mask-box"><h2>Kerstcadeautje</h2><div class="clearfix"><div class="fl left"><img src="' + imgSrc + '" alt="Driver Booster PRO 6"/></div><div class="price fl"><h3> <b> €1</b>  extra KORTING speciaal voor jou!</h3><p> Slechts <strong><big>€</big>13<big>,99</big></strong> <del> €99,93 </del></p> <a class="buybtn" href="' + _href + '" onclick="' + _ga + '">Activeer Nu</a><p class="year">Grijp uw laatste kans!</p></div></div></div>');
...
function packsInit() {
  ...
  packs = Math.ceil(timeDiff / 3.8) > 0 ? Math.ceil(timeDiff / 3.8) : 0;
  reduceNum(packs, 1);
...
function getSales() {
  ...
  var nowTime = Math.floor(date.getTime() / 1000);
  var timeDiff = countTime - nowTime;
  var packsNow = Math.ceil(timeDiff / 3.8) > 0 ? Math.ceil(timeDiff / 3.8) : 0;
  if (packsNow != packs) {
    if (statusCheck() == 2) {
      packs = 0;
    } else {
