...
function maskShow() {
  ...
  $('.main').append('<div class="mask"></div><div class="mask-box"><h2>Promoção Surpresa de Natal</h2><div class="clearfix"><div class="fl left"><img src="' + imgSrc + '" alt="Advanced SystemCare 12 Pro"/></div><div class="price fl"><h3><b>R$5</b> extra de desconto pra você</h3><p><strong><small>R$</small>59</strong> <span><del>R$ 299,89</del><b>,99</b> </span> <sub>1 Ano / 3 PCs</sub></p> <a class="buybtn" href="' + _href + '" onclick="' + _ga + '">Comprar Agora</a><p class="year">Sua última chance de aproveitar o preço mais baixo da história!</p></div></div></div>');
...
function packsInit() {
  ...
  packs = Math.ceil(timeDiff / 4.23) > 0 ? Math.ceil(timeDiff / 4.23) : 0;
  reduceNum(packs, 1);
...
function getSales() {
  ...
  var nowTime = Math.floor(date.getTime() / 1000);
  var timeDiff = countTime - nowTime;
  var packsNow = Math.ceil(timeDiff / 4.23) > 0 ? Math.ceil(timeDiff / 4.23) : 0;
  if (packsNow != packs) {
    if (statusCheck() == 2) {
      packs = 0;
    } else {
