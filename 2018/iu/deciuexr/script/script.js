...
function dataHide() {
  if (!$(".feature dl").hasClass("datahide")) {
    ...
    $(".feature dl").find("b").addClass("hide");
  }
}
...
function timeInit() {
  var date = new Date();
  var cName = "iuexrpre" + date.getDate();
...
function packsInit() {
  var date = new Date();
  var cName = "iuexrprepa" + date.getDate();
