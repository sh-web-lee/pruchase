...
function maskShow() {
  ...
  $('.main').append('<div class="mask"></div><div class="mask-box"><h2>Verrassing!</h2><div class="clearfix"><div class="fl left"><img src="' + imgSrc + '" alt="Advanced SystemCare 12 Pro"/></div><div class="price fl"><h3>Speciaal voor jou <b>€1 EXTRA KORTING</b> </h3><p><strong><small>€</small>18</strong> <span><del>€79,98</del><b>99</b> </span> <sub>1 Jaar / 3 PC’s</sub></p> <a class="buybtn" href="' + _href + '" onclick="' + _ga + '">Activeer Nu</a><p class="year">Uw allerlaatste kans op een grote besparing!</p></div></div></div>');
