...
<body>
    ...
    <div class="wrapper">
     ...
     <div class="message clearfix">
        ...
        <div class="right-message">
          ...
          <a href="https://www.iobit.com/buy.php?product=fr-iu8preorder30day&ref=fr_iu8preorder<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=fr_purchase_iu" onclick="ga('send', 'event', 'iubuy', 'buy', 'iu8predorder-fr');" class="buybtn"><span>VITE, J’EN PROFITE</span></a>
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%">
      <thead>
        <tr>
          <th class="itema"></th>
          <th class="itemb">
            Base de données de <br>Bundleware     
          </th>
          <th class="itemb">
            Base de données des <br>programmes tenaces
          </th>
          <th class="itemb">
            Base de données <br>Software Updater
          </th>
          <th class="itemb">
            Base de données de <br>plugins malveillants
          </th>
        </tr>
      </thead>
      <tbody>
        <tr>
          <td class="itema">Votre version actuelle</td>
          <td class="itemb"><i class="close"></i>Non disponible</td>
          <td class="itemb"><i class="close"></i>Non disponible</td>
          <td class="itemb"><i class="close"></i>Non disponible</td>
          <td class="itemb"><i class="close"></i>Non disponible</td>
        </tr>
  ...
  <div class="between-buy wrapper">
    <h2>Profitez de la dernière version PRO aujourd'hui pour <strong>0€</strong></h2>
    <a href="https://www.iobit.com/buy.php?product=fr-iu8preorder30day&ref=fr_iu8preorder<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=fr_purchase_iu" onclick="ga('send', 'event', 'iubuy', 'buy', 'iu8predorder-fr');" class="buybtn"><span>VITE, J’EN PROFITE</span></a>
  ...
  <div class="benfits ">
    <div class="wrapper">
      <h2>Comment opère IObit Uninstaller 8 PRO</h2>
      <h3>pour garder votre ordinateur propre, rapide et sûr</h3>
      <img src="<?php echo getStaticUrl('images/snapshoot.png')?>" alt="" class="img-box">
      <dl class="list01">
        <dt><i>1</i></dt>
        <dd>Vous aide à trouver rapidement et à désinstaller les programmes <br>indésirables et tenaces</dd>
      </dl>
      <dl class="list02">
        <dt><i>2</i></dt>
        <dd>Vous avertit lorsqu'un téléchargement comporte une barre d'outils ou des programmes tiers fournis</dd>
      </dl>
      <dl class="list03">
        <dt><i>3</i></dt>
        <dd>Identifie et balise les plug-ins malveillants ou publicitaires</dd>
      </dl>
      <dl class="list04">
        <dt><i>4</i></dt>
        <dd>1 clic pour garder votre logiciel <br>essentiel à jour</dd>
      </dl>
      <dl class="list05">
        <dt><i>5</i></dt>
        <dd>Nettoie automatiquement tous <br>les restes de programmes et <br>plug-ins non installés</dd>
      </dl>
      <div class="between-buy">
        <h2>Nettoyez et protégez votre ordinateur pour <strong>0€</strong> maintenant</h2>
        <a href="https://www.iobit.com/buy.php?product=fr-iu8preorder30day&ref=fr_iu8preorder<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=fr_purchase_iu" onclick="ga('send', 'event', 'iubuy', 'buy', 'iu8predorder-fr');" class="buybtn"><span>VITE, J’EN PROFITE</span></a>
        <p><span class="viewNum"><?php echo $viewNum?></span> clients en ligne, plus que
          <strong class="gift">35</strong> dispo!</p>
      </div>
    </div>
  </div>
  <!-- end benfits -->
...
<!-- end payments -->
  ...
  <div class="float clearfix">
    <div class="wrapper">
      ...
      <a href="https://www.iobit.com/buy.php?product=fr-iu8preorder30day&ref=fr_iu8preorder<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=fr_purchase_iu" onclick="ga('send', 'event', 'iubuy', 'buy', 'iu8predorder-fr');" class="buybtn"><span>0€ VITE, J’EN PROFITE</span></a>
    </div>
  </div>
  <div class="pop-over">
    <h2>OOPS</h2>
