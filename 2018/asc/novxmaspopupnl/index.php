...
<body>
  <div class="main">
        ...
        <div class="palen clearfix">
          ...
          <div class="right fr">
            ...
            <div class="price">
              ...
              <a class="buybtn" href="https://www.iobit.com/buy.php?product=nl-asc123pcsdpf1799&ref=nl_asc12rightcorner1799purchase1811a<?php echo $refStr;?>&refs=nl_purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchasexr1811a-nl')">
                 Activeer Nu
              </a>
    ...
    <div class="centbuy">
      ...
      <div class="wrapper clearfix">
        ...
        <div class="price fr">
          ...
          <p><strong>€17<big>,</big></strong> <span>99 <del>€119,93</del></span></p>
          <a class="buybtn" href="https://www.iobit.com/buy.php?product=nl-asc123pcsdpf1799&ref=nl_asc12rightcorner1799purchase1811b<?php echo $refStr;?>&refs=nl_purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchasexr1811b-nl')">
            Activeer Nu
          </a>
          <p class="year">1-jarig abonnement / 3 PC’s</p>
        </div>
    ...
    <div class="footbuy">
      <div class="wrapper">
        ...
        <div class="price">
          <p><strong>€17<big>,</big></strong> <span>99 <del>€119,93</del></span></p> 
          <a class="buybtn" href="https://www.iobit.com/buy.php?product=nl-asc123pcsdpf1799&ref=nl_asc12rightcorner1799purchase1811c<?php echo $refStr;?>&refs=nl_purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchasexr1811c-nl')">
            Activeer Nu
          </a>
  ...
  <script>
    ...
    var _href = "https://www.iobit.com/buy.php?product=nl-asc123pcsdpf1699&ref=nl_asc12rightcornerpopup1699purchase1811<?php echo $refStr;?>&refs=nl_purchase_asc";
    var _ga = "ga('send', 'event', 'ascbuy', 'buy', 'ascpurchasexr1811-nl')";
