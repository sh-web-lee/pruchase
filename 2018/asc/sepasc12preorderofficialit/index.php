...
<body>
  ...
  <div class="main">
        ...
        <div class="palen clearfix">
          ...
          <div class="right fr">
            ...
            <div class="price">
              ...
              <a class="buybtn" 
                 href="https://www.iobit.com/buy.php?product=it-asc12preorder&ref=it_ asc12preorderofficial<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=it_ purchase_asc"
                 onclick="ga('send', 'event', 'ascbuy', 'buy', 'asc12predorderofficial-it');"
    ...
    <div class="intro wrapper">
      <h2>Perché Pre-ordinare Advanced SystemCare 12 PRO </h2>
      <div class="top clearfix">
        <div class="fl">
          <h3>Prova le ultime funzionalità prima di tutti!</h3>
        ...
        <div class="fr">
          <dl>
            ...
            <dd>
              <h4>Scudo della Privacy</h4>
              <h5>Blocca l’accesso segreto ai tuoi file e foto</h5>
              <p>
                Ti informa quando rileva gli accessi segreti ai tuoi file e alle foto private consentendoti di bloccarli immediatamente.
              </p>
              <span>Funzionalità esclusiva dell’edizione PRO</span>
            </dd>
          </dl>
          <dl>
            <dt><img src="<?php echo getStaticUrl('images/intro_02.png')?>" alt=""/></dt>
            <dd>
              <h4>Pulizia dell’ Impronta Digitale</h4>
              <h5>Nessuno può sapere cosa stai facendo online</h5>
              <p>
                Impedisci agli inseguitori di mettere il naso su ciò che leggi, vedi e acquisti camuffando la tua impronta digitale.
              </p>
              <span>Funzionalità esclusiva dell’edizione PRO</span>
            </dd>
          </dl>
          <dl>
            ...
            <dd>
              <h4>Anti-Mining delle Criptovalute </h4>
              <h5>Dì addio ai crash improvvisi, a surriscaldamento e arresto del computer</h5>
              <p>
                Impedisci ai siti web maligni che visiti di usare il tuo computer per minare le criptovalute, provocando crash del browser, surriscaldamento del computer e improvvisi arresti del sistema.
              </p>
            </dd>
          </dl>
        </div>
      ...
      <div class="bot clearfix">
        <div class="fl">
          <h3>Goditi i nuovi miglioramenti il prima possibile!</h3>
          <dl>
            <dt><img src="<?php echo getStaticUrl('images/intro_04.png')?>" alt=""/></dt>
            <dd>
              <h4>Pulizia e Ottimizzazione</h4>
              <h5>Accelera il PC lento fino al 200% in più</h5>
              <p>
                Pulisce tutti i file inutili e ottimizza la CPU e la  RAM per accelerare l’avvio e aumenta la velocità del sistema per renderlo due volte più veloce.
              </p>
              <span>Funzionalità esclusiva dell’edizione PRO</span>
            </dd>
          </dl>
          <dl class="last">
            ...
            <dd>
              ...
              <h5>Accelera la connessione di rete  fino al 300% in più</h5>
              <p>
                Ottimizza le impostazioni del browser per triplicare la velocità di download, navigazione online, gioco online e visualizzazione di Youtube.
              </p>
              <span>Funzionalità esclusiva dell’edizione PRO</span>
            </dd>
          </dl>
    ...
    <div class="comparison" id="compare">
      <div class="wrapper">
        <h2 class="steps-title"> Risolve i problemi frustranti del tuo PC con un solo clic</h2>
    ...
    <div class="centbuy">
      <div class="wrapper">
        <h2>Preordina a <b>€0</b> ora per rendere il tuo PC ancora più veloce, pulito e sicuro</h2>
        <a class="buybtn" 
           href="https://www.iobit.com/buy.php?product=it-asc12preorder&ref=it_ asc12preorderofficial<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=it_ purchase_asc"
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'asc12predorderofficial-it');"
           data-text="Pre-ordina Ora">
  ...
  <script src="<?php echo getStaticUrl('script/script.min.js')?>"></script>
   <script>
      ...
      var _ga = "ga('send', 'event', 'ascbuy', 'buy', 'asc12predorderofficial-it');";
      var _url = "https://www.iobit.com/buy.php?product=it-asc12preorder1499&ref=it_ asc12preorderofficial1677<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=it_ purchase_asc";
    </script>
</body>
</html>