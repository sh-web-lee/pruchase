...
function maskShow() {
  $(".mask").remove();
  $(".mask-box").remove();
  $('.main').append('<div class="mask"></div><div class="mask-box"><p>OPS! I pre-ordini sono esauriti per oggi. </p><h2>Non preoccuparti! Se ordini ora, otterrai uno sconto esclusivo del 70%!</h2><div class="imgbox"><img src="' + imgUrl + '" alt="Advanced SystemCare 12 PRO"/><p>Abbonamento 1 Anno / 3 PC</p></div><p class="price"><strong>€14,99</strong> <del>€49,99</del></p><a class="buybtn" href="' + _url + '" onclick="' + _ga + '" data-text="Approfittane Ora"><span>Approfittane Ora</span></a></div>');
