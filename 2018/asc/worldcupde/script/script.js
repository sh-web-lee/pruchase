...
function soldout() {
	...
	threePc();
	$(".centbuy .buybtn").attr("href", "https://www.iobit.com/buy.php?product=de-asc113pc2499&ref=de_asc113pc2499purchase1806" + refStr + "&refs=de_purchase_asc");
	$(".centbuy .buybtn").attr("onclick", "ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase3PC1806-de')");
}
...
function onePc() {
	...
	$(".footbuy dl .buybtn").attr("href", "https://www.iobit.com/buy.php?product=de-asc111pc2299&ref=de_asc111pc2299purchase1806" + refStr + "&refs=de_purchase_asc");
	$(".footbuy dl .buybtn").attr("onclick", "ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase1PC1806-de')");
}
...
function threePc() {
	...
	$(".footbuy dl .buybtn").attr("href", "https://www.iobit.com/buy.php?product=de-asc113pc2499&ref=de_asc113pc2499purchase1806" + refStr + "&refs=de_purchase_asc");
	$(".footbuy dl .buybtn").attr("onclick", "ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase3PC1806-de')");
}
...
function threeBox() {
	...
	$(".footbuy dl .buybtn").attr("href", "https://www.iobit.com/buy.php?product=de-asc11iu3pc2499&ref=de_asc113pciu2499purchase1806" + refStr + "&refs=de_purchase_asc");
	$(".footbuy dl .buybtn").attr("onclick", "ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase3PCiu1806-de')");
}
