...
function maskShow() {
  $(".mask").remove();
  $(".mask-box").remove();
  $('.main').append('<div class="mask"></div><div class="mask-box"><h2>OPS!</h2><p>I pre-ordini sono esauriti per oggi.</p><a href="https://purchase.iobit.com/it/asc/index.php">Trova un’altra offerta>></a><i class="all-icons close"></i></div>');
