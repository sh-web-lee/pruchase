...
function maskShow() {
  ...
  $('.main').append('<div class="mask"></div><div class="mask-box"><h2>Helaas, uitverkocht!</h2><p>Grijp Uw Laatste Kans Om Dit Jaar een Hoop Geld te Besparen!</p><div class="clearfix"><div class="fl left"><img src="' + imgSrc + '" alt="Advanced SystemCare 12 Pro"/></div><div class="price"><h3>55% KORTING</h3><p><strong>€21<big>,99</big></strong> <span><del>€49,99</del></span></p> <a class="buybtn" href="' + _href + '" onclick="' + _ga + '">Activeer Nu</a><p class="year">1-jarig abonnement / 3 PC’s</p></div></div></div>');
...
function packsInit() {
  ...
  packs = Math.round(timeDiff / 3.61) > 0 ? Math.round(timeDiff / 3.61) : 0;
  reduceNum(packs, 1);
...
function getSales() {
  ...
  var nowTime = Math.floor(date.getTime() / 1000);
  var timeDiff = countTime - nowTime;
  var packsNow = Math.round(timeDiff / 3.61) > 0 ? Math.round(timeDiff / 3.61) : 0;
  if (packsNow != packs) {
    if (statusCheck() == 2) {
      packs = 0;
    } else {
