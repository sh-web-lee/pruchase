...
function maskShow() {
  ...
  $('.main').append('<div class="mask"></div><div class="mask-box"><h2>Sorpresa de Navidad</h2><div class="clearfix"><div class="fl left"><img src="' + imgSrc + '" alt="Advanced SystemCare 12 Pro"/></div><div class="price"><h3>¡Extra <b>1€ </b> de descuento sólo para ti!</h3><p><strong>15<big>,</big></strong> <span>77€ <del>139,92€ </del></span></p>  <a class="buybtn" href="' + _href + '" onclick="' + _ga + '">Comprar ahora</a><p class="year"> ¡Aprovecha tu última oportunidad para ahorrar más!</p></div></div></div>');
...
function timeInit() {
  var date = new Date();
  var cName = "esascpre" + date.getDate();
