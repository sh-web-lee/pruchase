...
<head>
  ...
  <title>Adquira Advanced SystemCare 12 Pro com 40% de desconto e leve IObit Uninstaller Pro grátis. Oferta Limitada da IObit.</title>
  ...
  k='17473586-687',d=document,l=d.location,c=d.cookie;
    ...
    <div class="wrapper">
      ...
      <div class="panel clearfix">
        ...
        <div class="fr text gradient">
          <h3>
            Advanced SystemCare 12 - 1 ano / 3 PCs<br>
            <span>+ IObit Uninstaller 8 Pro (Grátis!)</span>
          </h3>
          ...
          <dl>
            <dt>
              <a class="buybtn" href="http://www.iobit.com/buy.php?product=pt-asc123pciu7699&ref=pt_asc12iupurchase1808<?php echo $refStr;?>&refs=pt_purchase_asc&tw=-8" onclick="ga('send', 'event', 'ascbuy', 'buy', 'asc12purchase1808-pt');">
  ...
  <div class="intro wrapper clearfix">
    ...
    <div class="fr">
      ...
      <dl>
        ...
        <dd>
          <i class="all-icons">.</i>
          <span>Limpeza automática de rastros de privacidade e disfarça sua <br>assinatura digital.</span>
        </dd>
        <dd>
          <i class="all-icons">.</i>
          <span>Mantém seus dados pessoais protegidos contra qualquer <br>acesso secreto.</span>
        </dd>
      </dl>
    </div>
  </div>
        ...
        <tfoot>
          <tr>
            ...
            <th class="itema">
              ...
              <strong>R$ 76,99 </strong>
              <p>Licença de 1 Ano / 3 PCs</p>
              <a class="tbuybtn" href="http://www.iobit.com/buy.php?product=pt-asc123pciu7699&ref=pt_asc12iupurchase1808<?php echo $refStr;?>&refs=pt_purchase_asc&tw=-8" onclick="ga('send', 'event', 'ascbuy', 'buy', 'asc12purchase1808-pt');">
                Compre Agora
              </a>
            </th>
          </tr>
