...
function maskFirst() {
  ...
  $('.main').append('<div class="mask"></div><div class="mask-box"><h2>Ergreifen Sie die letzt Chance in diesem Jahr, um so richtig zu sparen! </h2><div class="clearfix"><div class="fl left"><img src="' + imgSrc + '" alt="Advanced SystemCare 12 Pro"/></div><div class="price"><h3>Advanced SystemCare 12 Pro <b>57% RABATT</b></h3><p><strong><small>€</small>21<small>,</small></strong> <span><del>€59,99</del>99</span></p><a class="buybtn" href="' + _href + '" onclick="' + _ga + '">Jetzt aktivieren</a><p class="year">1 Jahr / 3 PC´s</p></div></div></div>');
}
