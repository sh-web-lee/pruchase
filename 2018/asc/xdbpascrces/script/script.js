...
function maskShow() {
  ...
  $('.main').append('<div class="mask"></div><div class="mask-box"><h2>Oferta de Navidad</h2><div class="clearfix"><div class="fl left"><img src="' + imgSrc + '" alt="Advanced SystemCare 12 Pro"/></div><div class="price"><h3>Aprovecha última ooprtunidad de ahorro con <b>55% dto</b>.</h3><p><strong>21<big>,</big></strong> <span>99€ <del>49,99€</del></span></p> <a class="buybtn" href="' + _href + '" onclick="' + _ga + '">Comprarahora</a><p class="year">1 año de suscripción / 3 PCs</p></div></div></div>');
