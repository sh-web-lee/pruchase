...
<head>
  ...
  <meta http-equiv="x-ua-compatible" content="IE=Edge,chrome=1">
	<title>Adquira Advanced SystemCare 12 Pro com 75% de desconto e leve dois super brindes para o seu computador. Oferta Especial de Ano Novo da IObit.</title>
...
<body>
	...
	<div class="banner">
	 	<div class="wrapper">
			...
			<h1>Super Promoção de Ano Novo</h1>
			<h2>Oferta limitada, Apenas uma Vez no Ano!</h2>
 			...
 			<div class="sold-box">
 				...
 				<dl>
 					...
 					<dd>
            <!-- 75% buybtn  -->
            <a href="http://www.iobit.com/buy.php?product=pt-asc123pciusd7699&ref=pt_asc123pciusdpurchase1812<?php echo $refStr;?>&refs=pt_purchase_asc"
               onclick="ga('send', 'event', 'ascbuy', 'buy', 'asc12purchase1812-pt')"
 			...
 			<div class="one-pc-box">
 				...
 				<dl>
 					...
 					<dd>
            <!-- 60% buybtn -->
            <a href="http://www.iobit.com/buy.php?product=pt-asc123pc7699&ref=pt_asc123pcpurchase1812<?php echo $refStr;?>&refs=pt_purchase_asc"
               onclick="ga('send', 'event', 'ascbuy', 'buy', 'asc12purchase1812-pt')"
               class="button">
              COMPRAR AGORA!
            </a>
	...
	<div class="bottomcart">
		<div class="wrapper">
			<h2>No Ano Novo, dê um PRESENTÃO para o seu PC!</h2>
				<div class="showcase">
					<span class="img"></span>
				</div>
				<div class="selection">
