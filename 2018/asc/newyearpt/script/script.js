...
function soldOut() {
	...
	$(".banner .one-pc-box dl .button").html("Aproveitar");
	$(".banner .sold-box h3").html("");
	$(".selection li").eq(0).addClass("default").removeClass("active");
	$(".selection li").eq(1).addClass("active");
	$(".gifts dl").addClass("exceed");
	$(".banner .sold-box .button,.gifts .button").attr("href","http://www.iobit.com/buy.php?product=pt-asc123pc7699&ref=pt_asc123pcpurchase1812"+refStr+"&refs=pt_purchase_asc");
	$(".banner .sold-box .button,.gifts .button").attr("onclick","ga('send', 'event', 'ascbuy', 'buy', 'asc12purchase1812-pt')");
	 onePc();
}
function zoomout () {
...
function onePc() {
	$(".bottomcart .button").attr("href","http://www.iobit.com/buy.php?product=pt-asc123pc7699&ref=pt_asc123pcpurchase1812"+refStr+"&refs=pt_purchase_asc");
	$(".bottomcart .button").attr("onclick","ga('send', 'event', 'ascbuy', 'buy', 'asc12purchase1812-pt')");
	$(".bottomcart dl strong").html("R$ <b>76</b>,99");
	$(".bottomcart dl dt del").html("R$ 199,90");
	$(".showcase .img").addClass("one-pc");
}
function threePc() {
	$(".bottomcart .button").attr("href","http://www.iobit.com/buy.php?product=pt-asc123pciusd7699&ref=pt_asc123pciusdpurchase1812"+refStr+"&refs=pt_purchase_asc");
	$(".bottomcart .button").attr("onclick","ga('send', 'event', 'ascbuy', 'buy', 'asc12purchase1812-pt')");
	$(".bottomcart dl strong").html("R$ <b>76</b>,99");
	$(".bottomcart dl del").html("R$ 399,88");
...
function getSalesNum(packsNow) {
	...
	var buyNum=7691542 +daysDiff * 42+(55-Math.floor(timeDiff/10));
	if(statusNow==2){
		buyNum+=(42 - packsNow);
	}
