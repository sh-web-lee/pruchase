...
function soldOut() {
	...
	$(".banner .sold-box dl dt strong").html("89%");
	$(".banner .one-pc-box dl dt strong").html("90%");
	$(".banner .one-pc-box dl .button").html("ПОЛУЧИТЬ СЕЙЧАС");
	$(".banner .sold-box h3").html("<span class='viewNum'>"+viewNum+"</span> людей смотрят,<span class='num'>только <span class='pack packsNum'>42</span> <span class='popup-font packsNum'>42</span></span> мест осталось");
	$(".selection li").eq(0).addClass("default").removeClass("active");
	$(".selection li").eq(1).addClass("active");
	$(".gifts dl").addClass("exceed");
	$(".banner .sold-box .button,.gifts .button").attr("href","https://www.iobit.com/buy.php?product=ru-asc123pc499&ref=ru_asc123pc499purchase"+refStr+"&refs=ru_purchase_asc");
	$(".banner .sold-box .button,.gifts .button").attr("onclick","ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase3pc1811christ-ru')");
	 onePc();
}
function zoomout () {
...
function onePc() {
	$(".bottomcart .button").attr("href","https://www.iobit.com/buy.php?product=ru-asc123pc499&ref=ru_asc123pc499purchase"+refStr+"&refs=ru_purchase_asc");
	$(".bottomcart .button").attr("onclick","ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase3pc1811christ-ru')");
	$(".bottomcart dl strong").html("<b>499 руб</b>");
	$(".bottomcart dl dt del").html("4497 руб");
	$(".showcase .img").addClass("one-pc");
}
function threePc() {
	$(".bottomcart .button").attr("href","https://www.iobit.com/buy.php?product=ru-asc123pcsd499&ref=ru_asc123pcsd499purchase"+refStr+"&refs=ru_purchase_asc");
	$(".bottomcart .button").attr("onclick","ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase3pcsd1811christ-ru')");
	$(".bottomcart dl strong").html("<b>499 руб</b>");
	$(".bottomcart dl del").html("5487 руб");
...
$(".benfits .detail-list dl").hover(function() {
  $(".benfits .showcase .screenshot").css('marginLeft', -550*($(this).index()+1));
...
$(".benfits .list-icon li").hover(function() {
  $(".benfits .showcase .screenshot").css('marginLeft', -550*($(this).index()));
