...
function soldOut() {
	...
	$(".banner .sold-box .button,.gifts .button").attr("href","https://www.iobit.com/buy.php?product=it-asc123pc1799&ref=it_asc123pc1799purchase1801"+refStr+"&refs=it_purchase_asc");
	$(".banner .sold-box .button,.gifts .button").attr("onclick","ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase1PC1801-it')");
	 onePc();
}
function zoomout () {
...
function onePc() {
	$(".bottomcart .button").attr("href","https://www.iobit.com/buy.php?product=it-asc123pc1799&ref=it_asc123pc1799purchase1801"+refStr+"&refs=it_purchase_asc");
	$(".bottomcart .button").attr("onclick","ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase1PC1801-it')");
...
function threePc() {
	$(".bottomcart .button").attr("href","https://www.iobit.com/buy.php?product=it-asc12iu3pc1799&ref=it_asc123pciu1799purchase1801"+refStr+"&refs=it_purchase_asc");
	$(".bottomcart .button").attr("onclick","ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase3PCiu1801-it')");
	$(".bottomcart dl strong").html("<b>17</b>,99")
