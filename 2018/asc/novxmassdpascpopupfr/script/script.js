...
function maskShow() {
  ...
  $('.main').append('<div class="mask"></div><div class="mask-box"><h2>Dernière démarque</h2><div class="clearfix"><div class="fl left"><img src="' + imgSrc + '" alt="Advanced SystemCare 12 Pro"/></div><div class="price"><h3>Saisissez votre dernière chance pour <br>économiser <b>60%</b>.</h3><p><strong>19<big>,</big></strong> <span>99€ <del>49,99€</del></span></p> <a class="buybtn" href="' + _href + '" onclick="' + _ga + '">VITE, J’EN PROFITE</a><p class="year">1 an d’abonnement / 3 PC</p></div></div></div>');
...
function packsInit() {
  ...
  packs = Math.ceil(timeDiff / 5.36) > 0 ? Math.ceil(timeDiff / 5.36) : 0;
  reduceNum(packs, 1);
...
function getSales() {
  ...
  var nowTime = Math.floor(date.getTime() / 1000);
  var timeDiff = countTime - nowTime;
  var packsNow = Math.ceil(timeDiff / 5.36) > 0 ? Math.ceil(timeDiff / 5.36) : 0;
  if (packsNow != packs) {
    if (statusCheck() == 2) {
      packs = 0;
    } else {
