...
<head>
  ...
  <title>Jusqu'à -85% sur Advanced SystemCare PRO – Vente Flash d'été - IObit</title>
  <link rel="icon" href="<?php echo $pRootUrl; ?>tpl/img/favicon.ico" mce_href="<?php echo $pRootUrl; ?>tpl/img/favicon.ico" type="image/x-icon">
  <link rel="shortcut icon" href="<?php echo $pRootUrl; ?>tpl/img/favicon.ico" mce_href="<?php echo $pRootUrl; ?>tpl/img/favicon.ico" type="image/x-icon">
  <link href="https://fonts.googleapis.com/css?family=Lato:400,700,400i" rel="stylesheet">
  <link rel="stylesheet" href="<?php echo getStaticUrl('style/style.min.css')?>">
...
<body>
    ...
    <div class="wrapper">
      ...
      <!-- title -->
      <h1 class="title">Ventes Flash spéciale été</h1>
      <h3>Il fait trop chaud ! Rafraichissez-vous avec nos offres d'été !</h3>
      <p>Economisez jusqu'à 85% et booster votre PC tout de suite !</p>
      <!-- offer65 -->
      <div class="offer65 clearfix">
        ...
        <div class="message fl">
          ...
          <!-- buybtn -->
          <a class="buybtn" href="https://www.iobit.com/buy.php?product=fr-asc113pc1799&ref=fr_asc113pcpurchase1808b<?php echo $refstr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase18081799-fr');">Profiter de l'Offre</a>
        </div>
      </div>
      <!-- offer85 -->
      <div class="offer85 clearfix">
        ...
        <div class="message fl">
          ...
          <!-- price -->
          <p class="price">
            <strong>19.99 €</strong> Au lieu de <del>119.97 €</del><br>
            <small> 1 an d’abonnement / 3 PC</small>
          </p>
          <!-- buybtn -->
          <a class="buybtn" href="https://www.iobit.com/buy.php?product=fr-asc11pfsd1999&ref=fr_asc113pcpfsdpurchase1808b<?php echo $refstr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase18081999-fr');">Profiter de l'Offre</a>
        </div>
        <!-- pop -->
        <div class="pop">
          <dl>
  ...
  <div class="feature">
    <div class="wrapper">
      <!-- title -->
      <h3 class="title">Pourquoi choisir Advanced SystemCare 11 PRO</h3>
  ...
  <!-- feature end -->
    ...
    <!-- 03 -->
			<tr>
				...
				<td class="virtue">
          Le moniteur de performance redessiné pour surveiller et <strong>accélérer</strong> votre PC <sup class="red">amélioré</sup>
        </td>
				<td class="spac"></td>
        <td class="itemb gray">
          <i class="star grey"></i>
    ...
    <!-- 04 -->
			<tr>
				...
				<td class="virtue">
          Capturer <strong>automatiquement</strong> les intrus avec FaceID
        </td>
				<td class="spac"></td>
        <td class="itemb gray">
          <i class="star grey"></i>
  ...
  <div class="bottombuy">
    <div class="wrapper clearfix">
      ...
      <div class="asc-select fl">
        <!-- offer65 -->
        <div class="selecter offer65" data-discount="<?php echo $pResUrl;?>images/bottombuy-offer65.png" data-original="49.99 €" data-href="https://www.iobit.com/buy.php?product=fr-asc113pc1799&ref=fr_asc113pcpurchase1808b<?php echo $refstr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_asc" data-ga="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase18081799-fr')">
          <img src="<?php echo getStaticUrl('images/bottombuy-offer65-off.png')?>" alt=""/>
          <p>ASC PRO 11 <span>1 an / 3 PC</span></p>
        </div>
        <!-- offer85 -->
        <div class="selecter offer85 active" data-discount="<?php echo $pResUrl;?>images/bottombuy-offer85.png" data-original="119.97 €" data-href="https://www.iobit.com/buy.php?product=fr-asc11pfsd1999&ref=fr_asc113pcpfsdpurchase1808b<?php echo $refstr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_asc" data-ga="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase18081999-fr');">
          <img src="<?php echo getStaticUrl('images/bottombuy-offer85-off.png')?>" alt=""/>
          <p>ASC PRO 11 <span>1 an / 3 PC</span> + <br>Smart Defrag PRO+Protected Folder</p>
        </div>
      </div>
      <!-- asc-message -->
      <div class="asc-message fr">
        <img class="discount" src="<?php echo $pResUrl;?>images/bottombuy-offer85.png" alt="">
        <p>Au lie de <del>119.97 €</del></p>
        <!-- buybtn -->
        <a class="buybtn" href="https://www.iobit.com/buy.php?product=fr-asc11pfsd1999&ref=fr_asc113pcpfsdpurchase1808b<?php echo $refstr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase18081999-fr');">Profiter de l'Offre</a>
      </div>
      <!-- pop -->
  ...
  <div class="service wrapper clearfix">
    ...
    <dl class="paiement fl">
      ...
      <dd>
        ...
        <P>
          IObit vous propose huit modes de
