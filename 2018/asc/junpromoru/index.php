...
<title>Сэкономьте 90% на Advanced SystemCare PRO c Бесплатным Подарком!</title>
...
<?php echo $gJavascript['public'];?>
  ...
  <script>function utmx_section(){}function utmx(){}(function(){var
        k='114018648-679',d=document,l=d.location,c=d.cookie;
...
<script type="text/javascript" src="<?php echo $pRootUrl; ?>tpl/js/stats.js"></script>
  ...
  <div class="banner">
    <div class="wrapper">
      ...
      <div class="title">
        ...
        <h2>Купите сейчас и получите <b>90%</b> скидку на ASC PRO c бесплатным подарком!</h2>
      </div>
      <div class="box one-box">
        ...
        <dl>
          <dt><strong><b>399</b>руб</strong><del>1499 руб</del> </dt>
          <dd>
            <a href="https://www.iobit.com/buy.php?product=ru-asc111pc399&ref=ru_asc111pc399purchase<?php echo $refStr;?>&refs=ru_purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase1pc1806-ru')" class="buybtn"><i></i> Купить Сейчас</a>
          </dd>
        </dl>
      </div>
      <div class="box three-gift">
        <img src="<?php echo getStaticUrl('images/90-sold.png')?>" alt="" class="sold">
        <ul>
        ...
        <dl>
          <dt><strong><b>499</b>руб</strong> <del>5487 руб</del> </dt>
          <dd>
            <a href="https://www.iobit.com/buy.php?product=ru-asc113pcsd499&ref=ru_asc113pcsd499purchase<?php echo $refStr;?>&refs=ru_purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase3pcsd1806-ru')" class="buybtn"><i></i> Купить Сейчас</a>
          </dd>
  ...
  <div class="donation">
    <div class="wrapper clearfix">
      ...
      <div class="gift">
        ...
        <h4>Advanced SystemCare PRO <strong>499</strong>руб <del>4497 руб</del></h4>
  ...
  <div class="bottom-buy">
    <div class="wrapper">
      ...
      <ul>
        <li data-url="https://www.iobit.com/buy.php?product=ru-asc111pc399&ref=ru_asc111pc399purchase<?php echo $refStr;?>&refs=ru_purchase_asc" data-price="399" data-original="1499 руб" data-ga="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase1pc1806-ru')"><strong>-73%</strong> <span> 1 Год / 1 ПК   </span></li>
        <li class="three-box active" data-url="https://www.iobit.com/buy.php?product=ru-asc113pcsd499&ref=ru_asc113pcsd499purchase<?php echo $refStr;?>&refs=ru_purchase_asc" data-price="499" data-original="5487 руб" data-ga="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase3pcsd1806-ru')"><strong>-90%</strong> <span>1 Год / 3 ПК + подарок SD  </span></li>
      </ul>
      <dl>
        <dt> <strong class="price">499</strong>руб <del class="original">5487 руб</del></dt>
        <dd>
          <a href="https://www.iobit.com/buy.php?product=ru-asc113pcsd499&ref=ru_asc113pcsd499purchase<?php echo $refStr;?>&refs=ru_purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase3pcsd1806-ru')" class="buybtn"><i></i> Купить Сейчас</a>
        </dd>
      </dl>
