...
function soldOut() {
	...
	$(".banner .sold-box .button,.gifts .button").attr("href","http://www.iobit.com/buy.php?product=it-asc123pc1799&ref=it_asc123pc1799purchase1812"+refStr+"&refs=it_purchase_asc");
	$(".banner .sold-box .button,.gifts .button").attr("onclick","ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase3PC1812-it')");
	 onePc();
}
function zoomout () {
...
function onePc() {
	$(".bottomcart .button").attr("href","http://www.iobit.com/buy.php?product=it-asc123pc1799&ref=it_asc123pc1799purchase1812"+refStr+"&refs=it_purchase_asc");
	$(".bottomcart .button").attr("onclick","ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase3PC1812-it')");
...
function threePc() {
	$(".bottomcart .button").attr("href","http://www.iobit.com/buy.php?product=it-asc123pcsdpf1799&ref=it_asc123pcsdpf1799purchase1812"+refStr+"&refs=it_purchase_asc");
	$(".bottomcart .button").attr("onclick","ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase3PCsdpf1812-it')");
	$(".bottomcart dl strong").html("<b>17</b>,99");
