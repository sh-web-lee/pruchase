function onePc() {
	$(".bottomcart .button").attr("href","https://www.iobit.com/buy.php?product=nl-asc121pc1899&ref=nl_asc121pc1899purchase1811"+refStr+"&refs=nl_purchase_asc");
...
function packs() {
	$(".bottomcart .button").attr("href","https://www.iobit.com/buy.php?product=nl-asc123pcsdpf1999&ref=nl_asc123pcsdpf1999purchase1811"+refStr+"&refs=nl_purchase_asc");
...
function threePc() {
	$(".bottomcart .button").attr("href","https://www.iobit.com/buy.php?product=nl-asc121y3pc1999&ref=nl_asc123pc1999purchase1811"+refStr+"&refs=nl_purchase_asc");
	// $(".bottomcart .button").attr("onclick","ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase3PCsdpf1811-it')");
	$(".bottomcart dl strong").html("<b>19</b>,99")
