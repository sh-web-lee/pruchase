...
<body>
	<div class="banner">
	 	<div class="wrapper">
			...
			<h2>Wees er  snel bij, de laagste prijs van het jaar!</h2>
 			...
 			<div class="one-pc-box">
 				...
 				<dl>
 					...
 					<dd><a href="https://www.iobit.com/buy.php?product=nl-asc121pc1899&ref=nl_asc121pc1899purchase1811<?php echo $refStr;?>&refs=nl_purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase1811-nl')" class="button">Activeer Nu!</a></dd>
 				</dl>
 			</div>
 			<div class="sold-box">
 				<h3><strong>55</strong> uur <strong>55</strong> min <strong>55</strong> sec <strong>55</strong> ms *</h3>
 				<div class="img-box">
 					<img src="<?php echo $pResUrl; ?>images/packs.png" alt="">
 				</div>
 				<dl>
 					<dt><strong>80%</strong> KORTING</dt>
 					<dd><a href="https://www.iobit.com/buy.php?product=nl-asc123pcsdpf1999&ref=nl_asc123pcsdpf1999purchase1811<?php echo $refStr;?>&refs=nl_purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase1811-nl')" class="button button-btm-lag"> <span></span>Activeer Nu!</a></dd>
 			...
 			<div class="one-pc-box">
 				...
 				<dl>
 					...
 					<dd><a href="https://www.iobit.com/buy.php?product=nl-asc121y3pc1999&ref=nl_asc123pc1999purchase1811<?php echo $refStr;?>&refs=nl_purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase1811-nl')" class="button">Activeer Nu!</a></dd>
 				</dl>
 			</div>
	 	</div>
	...
	<div class="gifts">
		<div class="wrapper">
			<h2>Twee gratis Kerstcadeaus!</h2>
			...
			<a href="https://www.iobit.com/buy.php?product=nl-asc123pcsdpf1999&ref=nl_asc123pcsdpf1999purchase1811<?php echo $refStr;?>&refs=nl_purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase1811-nl')" class="button btn-mid-lag"> <span></span>Claim uw kerstcadeaus!</a>
		...
		<div class="wrapper">
			<h2>Geef deze kerst ook een MOOI CADEAU aan uw oude pc!</h2>
				...
				<dl class="btnarea">
					...
					<dd>
						<a href="https://www.iobit.com/buy.php?product=nl-asc123pcsdpf1999&ref=nl_asc123pcsdpf1999purchase1811<?php echo $refStr;?>&refs=nl_purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase1811-nl')" class="button button-top-lag"> <span></span>Activeer Nu!</a>
					</dd>
				</dl>
		</div>
	</div>
