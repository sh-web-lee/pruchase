...
<div class="header container clearfix">
	<div class="wrapper head">
		...
		<h1>Advanced SystemCare PRO Autumn Big Sale </h1>
			...
			<div class="banner-left fr">
            	<div class="defult">
                    ...
                    <div class="price-box">
                        <div class="price-btn clearfix">
                            ...
                            <a href="https://www.iobit.com/buy.php?product=asc11sdiuamc2198gb&ref=ascsdiuamc2198may2018gb&aff=<?php echo $_GET['aff'];?>&refs=purchase_asc" onclick="ga('send', 'event', 'asc2198buy', 'buy', 'ascpurchase-gb');" class="buy-btn banner-btn-words fr"><i class="car"></i><span>ACTIVATE NOW</span></a>
                        </div>
                        <ul class="price-dec">
                            <li class="first">
                                <span>Original</span>
				...
				<div class="sold-out-banner">
                    ...
                    <div class="price-box">
                        <div class="price-btn clearfix">
                            <span class="price-num">Now £<strong>21</strong>.98</span>
                            <a href="https://www.iobit.com/buy.php?product=asc113pc2198gb&ref=asc3pc2198may2018gb&aff=<?php echo $_GET['aff'];?>&refs=purchase_asc" onclick="ga('send', 'event', 'asc2198buy', 'buy', 'ascpurchase-gb');" class="buy-btn banner-btn-words fr"><i class="car"></i><span>ACTIVATE NOW</span></a>
                        </div>
                        <ul class="price-dec">
                            <li class="first">
                                <span>Original</span>
...
<div class="middle-buy container clearfix">
	<div class="wrapper">
		...
		<a href="https://www.iobit.com/buy.php?product=asc11sdiuamc2198gb&ref=ascsdiuamc2198may2018gb&aff=<?php echo $_GET['aff'];?>&refs=purchase_asc" onclick="ga('send', 'event', 'asc2198buy', 'buy', 'ascpurchase-gb');" class="middle-btn">
		...
		<div class="bar-banner">
			...
			<div class="bar-right fr">
				...
				<div class="price-btn bar-btn">
					<span class="price-num">Now £<strong>21</strong>.98</span>
					<a href="https://www.iobit.com/buy.php?product=asc113pc2198gb&ref=asc3pc2198may2018gb&aff=<?php echo $_GET['aff'];?>&refs=purchase_asc" onclick="ga('send', 'event', 'asc2198buy', 'buy', 'ascpurchase-gb');" class="buy-btn banner-btn-words"><i class="car"></i><span>ACTIVATE NOW</span></a>
				</div>
			</div>
		</div>
	</div>
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%">
    	...
    	<tr>
            ...
            <th class="item-pro">
            	...
            	<a href="https://www.iobit.com/buy.php?product=asc11sdiuamc2198gb&ref=ascsdiuamc2198may2018gb&aff=<?php echo $_GET['aff'];?>&refs=purchase_asc" onclick="ga('send', 'event', 'asc2198buy', 'buy', 'ascpurchase-gb');" class="buy-btn table-btn"><i class="car"></i><span>ACTIVATE NOW</span></a>
...
<div class="mask-box">
	...
	<div class="mask-main clearfix">
		...
		<div class="mask-main-right fl">
			...
			<div class="btn-box">
				<a href="https://www.iobit.com/buy.php?product=asc11sdiuamc1999gb&ref=ascsdiuamc1999may2018gb&aff=<?php echo $_GET['aff'];?>&refs=purchase_asc" onclick="ga('send', 'event', 'asc1999buy', 'buy', 'ascpurchase-gb');" class="buy-btn mask-btn clearfix"><i class="car"></i><span>Get My Extra 10% OFF & 3 FREE Gifts</span></a>
			</div>
