...
<body>
  <div class="main">
    ...
    <div class="banner">
      <div class="wrapper">
        ...
        <p class="best">Pour Noël, offrez à votre PC une nouvelle santé !</p>
        <div class="palen clearfix">
          ...
          <div class="right fr">
            ...
            <div class="price">
              ...
              <a class="buybtn" href="https://www.iobit.com/buy.php?product=fr-asc123pc1999&ref=fr_dbpascxmas1811purchase1999a<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=fr_purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'asc12dbpascpurchase1811a-fr');">
                VITE, J’EN PROFITE
              </a>
    ...
    <div class="together">
      <div class="wrapper">
        <h2>
          A l’aide de Driver Booster PRO, vous profiterez <br>d’une expérience de jeu maximale et des performances PC optimales !
        </h2>
        <div class="panel clearfix">
          <div class="asc-box fl clearfix">
            <div class="box fl">
              <h3><span>Expérience de jeu maximale</span> <i></i></h3>
              <dl>
                <dt><strong>Performance de jeu plus fluide</strong></dt>
                <dd>
                  Nettoie automatiquement la RAM et désactive les processus inutiles.
                  <span>*Fonction exclusive à Advanced SystemCare PRO</span>
                </dd>
              </dl>
              <dl>
                <dt><strong>Meilleure expérience de jeu</strong></dt>
                <dd>
                  Les pilotes Game Ready et composants de jeu disponibles pour améliorer l’expérience de jeu.
                  <span>*Fonction exclusive à Driver Booster PRO</span>
                </dd>
              </dl>
            </div>
          ...
          <div class="db-box fl clearfix">
            ...
            <div class="box fl">
              <h3><i></i> PERFORMANCES PC OPTIMALES</h3>
              <dl>
                <dt><strong>PC plus proper & plus rapide</strong></dt>
                <dd>
                  Nettoie automatiquement les fichiers inutiles et optimise les registres afin d’accélérer le fonctionnement de votre PC.
                  <span>*Fonction exclusive à Advanced SystemCare PRO</span>
                </dd>
              </dl>
              <dl>
                <dt><strong>Système plus stable</strong></dt>
                <dd>
                  Analyse et met automatiquement les pilotes obsoletes, manquants, rares, incompatibles
                  <span>*Fonction exclusive à Driver Booster PRO</span>
                </dd>
              </dl>
            </div>
    ...
    <div class="centbuy">
      ...
      <div class="wrapper clearfix">
        ...
        <div class="price fr">
          ...
          <p><strong>19<big>,</big></strong> <span>99€ <del>49,99€</del></span></p>
          <a class="buybtn" href="https://www.iobit.com/buy.php?product=fr-asc123pc1999&ref=fr_dbpascxmas1811purchase1999b<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=fr_purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'asc12dbpascpurchase1811b-fr');">
            VITE, J’EN PROFITE
          </a>
          <p class="year">1 an d’abonnement / 3 PC</p>
        </div>
    ...
    <div class="footbuy">
      <div class="wrapper">
        ...
        <h2>Bénéficiez de <b>60%</b> de réduction exclusive pour un ordinateur plus rapide, plus propre et plus sûr</h2>
        <div class="price">
          <p><strong>19<big>,</big></strong> <span>99€ <del>49,99€</del></span></p>
          <a class="buybtn" href="https://www.iobit.com/buy.php?product=fr-asc123pc1999&ref=fr_dbpascxmas1811purchase1999c<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=fr_purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'asc12dbpascpurchase1811c-fr');">
            VITE, J’EN PROFITE
          </a>
  ...
  <script>
    ...
    var _href = "https://www.iobit.com/buy.php?product=fr-asc123pc2199&ref=fr_dbpascxmas1811purchase2199pop<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=fr_purchase_asc&tw=-8";
    var _ga = "ga('send', 'event', 'ascbuy', 'buy', 'asc12dbpascpurchase1811pop-fr');";
