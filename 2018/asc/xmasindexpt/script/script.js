...
function soldOut() {
	...
	$(".banner .sold-box .button,.gifts .button").attr("href","http://www.iobit.com/buy.php?product=pt-asc123pc7699&ref=pt_asc123pcpurchase1811"+refStr+"&refs=pt_purchase_asc");
	$(".banner .sold-box .button,.gifts .button").attr("onclick","ga('send', 'event', 'ascbuy', 'buy', 'asc12purchase1811-pt')");
	 onePc();
}
function zoomout () {
...
function onePc() {
	$(".bottomcart .button").attr("href","http://www.iobit.com/buy.php?product=pt-asc123pc7699&ref=pt_asc123pcpurchase1811"+refStr+"&refs=pt_purchase_asc");
	$(".bottomcart .button").attr("onclick","ga('send', 'event', 'ascbuy', 'buy', 'asc12purchase1811-pt')");
	$(".bottomcart dl strong").html("R$ <b>76</b>,99");
	$(".bottomcart dl dt del").html("R$ 199,90");
	$(".showcase .img").addClass("one-pc");
}
function threePc() {
	$(".bottomcart .button").attr("href","http://www.iobit.com/buy.php?product=pt-asc123pciusd7699&ref=pt_asc123pciusdpurchase1811"+refStr+"&refs=pt_purchase_asc");
	$(".bottomcart .button").attr("onclick","ga('send', 'event', 'ascbuy', 'buy', 'asc12purchase1811-pt')");
	$(".bottomcart dl strong").html("R$ <b>76</b>,99");
