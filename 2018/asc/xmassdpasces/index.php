...
<body>
  <div class="main">
        ...
        <div class="palen clearfix">
          ...
          <div class="right fr">
            ...
            <div class="price">
              ...
              <a class="buybtn" href="https://www.iobit.com/buy.php?product=es-asc123pc1799&ref=es_asc123pcsdpascpurchase1812rc<?php echo $refStr;?>&refs=es_purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'asc12sdpascpurchase1812rc-es');">
                 Comprar ahora
              </a>
    ...
    <div class="together">
      <div class="wrapper">
        <h2>
          Junto con Smart Defrag Pro,  <br>maximizarás el rendimiento del disco duro y acelerarás PC!
        </h2>
        <div class="panel clearfix">
          <div class="asc-box fl clearfix">
            <div class="box fl">
              <h3>MEJOR RENDIMIENTO<i></i></h3>
              <dl>
                <dt><strong>Hasta 200%* más rápido</strong></dt>
                <dd>
                  Acelera la velocidad de acceso a los archivos y la de inicio del juego. 
                  <span>*Sólo disponible en Smart Defrag Pro!</span>
                </dd>
              </dl>
              <dl>
                <dt><strong>Mejor rendimiento del disco</strong></dt>
                <dd>
                  Rendimiento del disco estable y rápido con limpieza automática y profunda de archivos basura y registro. 
          ...
          <div class="db-box fl clearfix">
            ...
            <div class="box fl">
              <h3><i></i> PC más rápido</h3>
              <dl>
                <dt><strong>Hasta 200%* más rápido </strong></dt>
                <dd>Reduce el fallo o retraso de sistema para acelerar PC .
                  <span>*Sólo disponible en Advanced SystemCare Pro!</span>
                </dd>
              </dl>
              <dl>
                <dt><strong>Inicio de PC rápido </strong></dt>
                <dd>Disfruta del inicio de PC rápido y la máxima velocidad de funcionamiento de sistema con Defrag de Inicio.  
                  <span>*Sólo disponible en Smart Defrag Pro!</span>
                </dd>
              </dl>
            </div>
    ...
    <div class="centbuy">
      ...
      <div class="wrapper clearfix">
        ...
        <div class="price fr">
          ...
          <p class="year">¡Oferta exclusiva para <b>SD</b> usuarios honorables!</p>
        </div>
      </div>
    </div>
    <!-- centbuy end -->
    ...
    <div class="footbuy">
      <div class="wrapper">
        <h3>¡No te pierdas!</h3>
        <h2>¡<b>65%</b> de descuento exclusivo para obtener un PC más limpio, rápido y seguro!</h2>
        <div class="price">
          <p><strong>17<big>,</big></strong> <span>99€ <del>49,99€ </del></span></p> 
          <a class="buybtn" href="https://www.iobit.com/buy.php?product=es-asc123pc1799&ref=es_asc123pcsdpascpurchase1812rc<?php echo $refStr;?>&refs=es_purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'asc12sdpascpurchase1812rc-es')">
            Comprar ahora
  ...
  <script>
    ...
    var _href = "https://www.iobit.com/buy.php?product=es-asc123pc1999&ref=es_asc123pcsdpascpurchase1812poprc<?php echo $refStr;?>&refs=es_purchase_asc";
    var _ga = "ga('send', 'event', 'ascbuy', 'buy', 'asc12sdpascpurchase1812poprc-es')";
