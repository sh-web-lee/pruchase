...
if($_GET['action']=='clickCount'){
	try{
		...
		$sql="insert into enascbdaye (ip,addTime,timezone,c_type,c_des,type,packs) values(:ip,:addTime,:timezone,:cType,:cDes,:type,:packs)";
		$pre=$pdo->prepare($sql);
	...
	<div class="wrapper">
		...
		<div class="gift-box three-gift">
           ...
           PC packs left only
				...
				<a href="https://www.iobit.com/buy.php?product=asc113pcsdiupf&ref=marbdaysaleepca&aff=<?php echo $_GET['aff'];?>&refs=purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase-marepca');clickCount(1,'pc top')" class="buybtn orange"><i></i>Activate Now</a>
			</div>
		</div>
		...
		<div class="gift-box one-gift">
           ...
           multi-device packs left only
				...
				<a href="https://www.iobit.com/buy.php?product=asc113pciot&ref=marbdaysaleemultia&aff=&refs=purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase-maremultia');clickCount(2,'md top')" class="buybtn blue"><i></i>Activate Now</a>
			</div>
		</div>
	</div>
</div>
...
<div class="between-buy">
	<div class="wrapper">
		<div class="box three-box">
			...
			<a href="https://www.iobit.com/buy.php?product=asc113pcsdiupf&ref=marbdaysaleepcb&aff=&refs=purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase-marepcb');clickCount(3,'pc mid')"  class="buybtn bottom"><i></i> Get Free Gifts Now</a>
			<div class="message">	
				<div class="countdown">
          <div class="scroll-tick">
            <span>0</span>
		...
		<div class="box one-box">
			...
			<a href="https://www.iobit.com/buy.php?product=asc113pciot&ref=marbdaysaleemultib&aff=&refs=purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase-maremultib');clickCount(4,'md mid')" class="buybtn bottom"><i></i> Get Free Gift Now</a>
			<div class="message">	
				<div class="countdown">
          <div class="scroll-tick">
            <span>0</span>
	...
	<div class="wrapper">
		<div class="box active three-box ">
			...
			<p>
				...
				<a href="https://www.iobit.com/buy.php?product=asc113pcsdiupf&ref=marbdaysaleepcc&aff=&refs=purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase-marepcc');clickCount(5,'pc bot')" class="buybtn"><i></i>Activate Now</a>
			</p>
		</div>
		<div class="box one-box ">
			...
			<p>
				...
				<a href="https://www.iobit.com/buy.php?product=asc113pciot&ref=marbdaysaleemultic&aff=&refs=purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase-maremultic');clickCount(6,'md bot')" class="buybtn"><i></i>Activate Now</a>
			</p>
		</div>
	</div>
</div>
<div class="mask"></div>
<div class="mask-box">
	<h2>You’re Our Lucky Visitor Today!<br>
		Enjoy <b>Extra 10% OFF </b>Special for You Now! 
		<i class="close">×</i>
	</h2>
	<div class="mask-main">
		<img class="small-img" src="<?php echo $pResUrl; ?>images/mask-box.png">
		<div class="mask-main-right">
			<p>Only Valid in</p>
			<span class="time-count"><span>01</span>m: <span>59</span>s</span>
			<ul>
				<li>
					<span>Original</span>
					<del>$149.9</del>
				...
				<li>
					<span>After extra 10% off</span>
					<strong>$<b>19</b>.99</strong>
				</li>
			</ul>
			<a href="https://www.iobit.com/buy.php?product=asc113pcsdiupf1999&ref=marbdaysaleepcd&aff=&refs=purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase-marepcd');clickCount(11,'mask click')" class="buybtn">Save 95% & Get 3 Free Gifts Now</a>
			<a href="javascript:void(0)" class="close-msg">No need, sale price works for me</a>
		</div>
	</div>
</div>
