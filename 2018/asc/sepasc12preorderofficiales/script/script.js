...
function maskShow() {
  ...
  $(".mask").remove();
  $(".mask-box").remove();
  $('.main').append('<div class="mask"></div><div class="mask-box"><p>OOPS, la actividad de 0€ preventa ha terminado hoy.</p><h2>¡No te preocupes! Si ordenas ahora, puedes disfrutar del 70% de <br> descuento exclusivo.</h2><div class="imgbox"><img src="' + imgUrl + '" alt="Advanced SystemCare 12 PRO"/><p>1 año de suscripción / 3 PC</p></div><p class="price"><strong>14,99€</strong> <del>49,99€</del></p><a class="buybtn" href="https://www.iobit.com/buy.php?product=es-asc12preorder1499&ref=es_asc12preorderofficial1499'+refStr+'&aff=' + aff + '&refs=es_purchase_asc" onclick="' + onGa + '" data-text="Ordenar ahora"><span>Ordenar ahora</span></a></div>');
