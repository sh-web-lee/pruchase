    ...
    <div class="banner">
      ...
      <div class="right-message">
        ...
        <dl class="price">
          ...
          <dd>
            <a href="https://www.iobit.com/buy.php?product=ar-asc113pcpfsdiu279&ref=ar_asc113pcpfsdiupurchase1806wc<?php echo $refStr;?>&refs=ar_purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase1806wc-ar')" class="buybtn">
      ...
      <table border="0" cellspacing="0" cellpadding="0" width="100%">
        ...
        <tfoot>
          <tr>
            ...
            <th class="itema">
              <del>ARS 2.992,00</del>  <strong>ARS 279,00</strong>
              <a class="buybtn" href="https://www.iobit.com/buy.php?product=ar-asc113pcpfsdiu279&ref=ar_asc113pcpfsdiupurchase1806wc<?php echo $refStr;?>&refs=ar_purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase1806wc-ar')">
                Comprar ahora
              </a>
              1 año / 3 PCs+ Regalos
            </th>
