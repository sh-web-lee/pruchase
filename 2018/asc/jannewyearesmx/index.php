    ...
    <div class="banner">
      ...
      <div class="right-message">
        ...
        <dl class="price">
          ...
          <dd>
            <a href="https://www.iobit.com/buy.php?product=mx-asc113pcpfsdiu299&ref=mx_asc113pcpfsdiupurchase1801<?php echo $refStr;?>&refs=mx_purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase1801-mx')" class="buybtn">
      ...
      <table border="0" cellspacing="0" cellpadding="0" width="100%">
        ...
        <tfoot>
          <tr>
            ...
            <th class="itema">
              <del>MXN 3,066.00</del> <strong>MXN 299.00</strong>
              <a class="buybtn" href="https://www.iobit.com/buy.php?product=mx-asc113pcpfsdiu299&ref=mx_asc113pcpfsdiupurchase1801<?php echo $refStr;?>&refs=mx_purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase1801-mx')">
                Comprar ahora
              </a>
              1 año / 3 PCs+ Regalos
            </th>
