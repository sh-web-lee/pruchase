...
<title>Pague R$0 para adquirir o novo Advanced SystemCare PRO</title>
...
<body>
  ...
  <div class="main">
        ...
        <div class="palen clearfix">
          ...
          <div class="right fr">
            ...
            <div class="price">
              ...
              <a class="buybtn" 
                 href="https://www.iobit.com/buy.php?product=pt-asc12preorder30&ref=pt_asc12preorderpopup<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=pt_purchase_asc"
                 onclick="ga('send', 'event', 'ascbuy', 'buy', 'asc12preorder-pt');"
    ...
    <div class="flow wrapper clearfix">
      <p>Tenha 60% de DESCONTO no preço original 30 dias após a pré-venda</p>
      <h2>R$0 hoje na pré-venda</h2>
      <p>Cancele dentro de 30 dias sem pagar nada</p>
    </div>
    <!-- flow end -->

    <!-- intro start -->
    <div class="intro wrapper">
      <h2><b>3 Motivos</b> para Adquirir Advanced SystemCare 12 PRO</h2>
      <h3 class="steps-title"><b>1</b> Novas Funções que Valem a Pena Serem Testadas</h3>
      <div class="panel">
        <img src="<?php echo getStaticUrl('images/screen.png')?>" alt=""/>
        <dl class="first">
          <dt><img src="<?php echo getStaticUrl('images/intro_01.png')?>" alt=""/></dt>
          <dd>
            <h4>Escudo de Privacidade <b>NOVO</b></h4>
            <h5>Bloqueia acesso secreto aos seus arquivos e fotos</h5>
            <p>
              Protege seus arquivos e fotos privados contra acesso não autorizado para evitar vazamento de privacidade e riscos vindos de mensagens lixo, sites de phishing e programas de blackmail. 
            </p>
          </dd>
        </dl>
        <dl class="two">
          ...
          <dd>
            <h4>Limpeza de Assinatura Digital  <b>NOVO</b></h4>
        ...
        <dl class="three">
          ...
          <dd>
            <h4>Anti-Mineração de Cryptomoedas <b>NOVO</b></h4>
            <h5>Evita super-aquecimento, lentidão e desligamento súbito do PC</h5>
            <p>
              Impede que websites maliciosos usem seu computador para minerar criptomoedas o que pode resultar em falhas no navegador, superaquecimento do computador e desligamento súbito do sistema.
            </p>
          </dd>
        </dl>
      </div>
    ...
    <div class="feature">
      <div class="wrapper">
        <h2 class="steps-title"><b>2</b> Melhorias Para uma Experiência Superior </h2>
        <ul class="clearfix">
        ...
        <div class="note">
          <span><i>□</i> Sua Versão Atual</span>
          <span class="blue"><i>■</i> Advanced SystemCare 12 PRO</span>
        </div>
        <p>Nós testamos Advanced SystemCare 12 PRO no nossos laboratórios internos de teste. Seus resultados podem variar.</p>
      </div>
    </div>
    <!-- feature end -->
    ...
    <div class="comparison" id="compare">
      <div class="wrapper">
        <h2 class="steps-title"><b>3</b> A Solução Perfeita para Problemas Frustrantes do seu PC</h2>
    ...
    <div class="centbuy">
      <div class="wrapper">
        <h2>Adquira Advanced SystemCare 12 PRO por <b>R$0*</b>Hoje! </h2>
        <a class="buybtn" 
           href="https://www.iobit.com/buy.php?product=pt-asc12preorder30&ref=pt_asc12preorderpopup<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=pt_purchase_asc"
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'asc12preorder-pt');"
           data-text="Adquirir Agora">
    ...
    <div class="bottom">
      <div class="wrapper">
        ...
        <div class="footer">
          <dl>
            <dd>
              * No fim do periodo grátis de 30 dias, você será cobrado automaticamente R$ 76,99 no seu cartão de crédito ou Paypal. Este desconto de 60% no preço original de R$199,90 <br> é um desconto apenas para pré-venda!
            </dd>
          </dl>
