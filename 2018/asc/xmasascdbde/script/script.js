...
function maskShow() {
  ...
  $('.main').append('<div class="mask"></div><div class="mask-box"><h2>Überraschung zu Weihnachten</h2><div class="clearfix"><div class="fl left"><img src="' + imgSrc + '" alt="Advanced SystemCare 12 Pro"/></div><div class="price"><h3><b>1€ günstiger</b> besonders für Sie</h3><p><strong>28<big>,</big></strong> <span><del>149,98€</del>99€ </span></p> <a class="buybtn" href="' + _href + '" onclick="' + _ga + '">Jetzt aktivieren</a><p class="year">Letzte Chance auf den größten Rabatt des Jahres!</p></div></div></div>');
...
function packsInit() {
  ...
  packs = Math.ceil(timeDiff / 3.41) > 0 ? Math.ceil(timeDiff / 3.41) : 0;
  reduceNum(packs, 1);
...
function getSales() {
  ...
  var nowTime = Math.floor(date.getTime() / 1000);
  var timeDiff = countTime - nowTime;
  var packsNow = Math.ceil(timeDiff / 3.41) > 0 ? Math.ceil(timeDiff / 3.41) : 0;
  if (packsNow != packs) {
    if (statusCheck() == 2) {
      packs = 0;
    } else {
