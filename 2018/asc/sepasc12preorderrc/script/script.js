...
function maskShow() {
  ...
  $('.main').append('<div class="mask"></div><div class="mask-box"><p>OOPS, $0 pre-order reservations are full today. </p><h3>No worries! If you order now, you can enjoy exclusive 70% OFF.</h3><span class="img-box"></span><p class="price"><strong> $16.77</strong> <del>$49.99</del></p><a href="https://www.iobit.com/buy.php?product=asc12preorder1677&ref=asc12preorderrc1677'+refStr+'&aff='+aff+'&refs=purchase_asc" onclick="ga("send", "event", "asc1677buy", "buy", "asc12predorderrc");" class="buybtn">Buy Now</a></div>');
