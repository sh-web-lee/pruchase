...
if($_GET['action']=='clickCount'){
	try{
		...
		$sql="insert into enascbday (ip,addTime,timezone,c_type,c_des,local_time) values(:ip,:addTime,:timezone,:cType,:cDes,:localTime)";
		$pre=$pdo->prepare($sql);
...
<div class="banner">
	<div class="wrapper">
		...
		<h2>Get the Birthday Pack You Prefer & Make Your PC Run like New from Now on!</h2>
		<div class="gift-box one-gift">
			<div class="box">
				<h3>82% OFF</h3>
				<h4>for better Multi-device Performance</h4>
				<dl>
					<dt>
						<h5>Advanced SystemCare 11 PRO</h5> 1 Year / 3 PCs
					</dt>
					<dd><i></i><span>MacBooster 6 Lite</span> <i class="gift"></i></dd>
					<dd><i></i><span>IOTransfer 2</span> <i class="gift"></i></dd>
				</dl>
				<p><strong>$29.99</strong> <del>$169.91</del></p>
				<a href="https://www.iobit.com/buy.php?product=asc113pcmbiot&ref=marbdaysalemultia&aff=<?php echo $_GET['aff'];?>&refs=purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase-marmultia');clickCount(1,'mdtop')" class="buybtn blue"><i></i>Activate Now</a>
			</div>
		</div>
		...
		<div class="gift-box three-gift">
			<div class="box">
				...
				<p><strong>$21.98</strong> <del>$149.9</del></p>
				<a href="https://www.iobit.com/buy.php?product=asc113pcsdiupf&ref=marbdaysalepca&aff=<?php echo $_GET['aff'];?>&refs=purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase-marpca');clickCount(2,'pctop')" class="buybtn orange"><i></i>Activate Now</a>
				<p class="date">
...
<div class="asc-message">
	<div class="wrapper">
		...
		<p class="more"><a href="javascript: ;">Learn more about PRO edition ></a></p>
	</div>
</div>
<div class="between-buy">
	<div class="wrapper">
		<h2>+ Get Free Utilities for PC or Multi-device</h2>
		<div class="gift one-gift">
			<h3>Better Multi-device Performance</h3>
			<dl>
				<dt>MacBooster 6 Lite</dt>
				<dd>Speed up & Protect Mac</dd>
			</dl>
			<dl>
				<dt>IOTransfer 2</dt>
				<dd>Transfer Files between iOS & Windows</dd>
			</dl>
			<a href="https://www.iobit.com/buy.php?product=asc113pcmbiot&ref=marbdaysalemultib&aff=<?php echo $_GET['aff'];?>&refs=purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase-marmultib');clickCount(3,'mdbot')" class="buybtn blue"> <strong>Get Free Utilities</strong> Valued at $79.94</a>
		</div>
	  <span class="img-box"></span>
		<div class="gift three-gift">
			<h3>Top PC Performance</h3>
			<dl>
				<dt>Smart Defrag 5 PRO</dt>
				<dd>Manage Disk Space</dd>
			</dl>
			<dl>
				<dt>IObit Uninstaller 7 PRO</dt>
				<dd>Remove Stubborn Programs</dd>
			</dl>
			<dl>
				<dt>Protected Folder</dt>
				<dd>Protect Important Files</dd>
			</dl>
			<a href="https://www.iobit.com/buy.php?product=asc113pcsdiupf&ref=marbdaysalepcb&aff=<?php echo $_GET['aff'];?>&refs=purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase-marpcb');clickCount(4,'pcbot')" class="buybtn orange"> <strong>Get Free Utilities</strong> Valued at  $59.93</a>
		</div>
	</div>
</div>
<!-- review -->
	...
	<table border="0" cellspacing="0" cellpadding="0" width="100%">
		...
		<tr>
			...
			<div class="pro-box">
					...
					<p><i></i> PC Performance Pack <i class="gift"></i></p>
			</div>
			</th>
		</tr>
		</thead>
		...
		<tr>
			...
			<th class="item-pro">
				...
				<a href="https://www.iobit.com/buy.php?product=asc113pcsdiupf&ref=marbdaysalepcc&aff=<?php echo $_GET['aff'];?>&refs=purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase-marpcc');" class="buybtn">ACTIVATE NOW</a>
...
<div class="footer">
	<div class="wrapper">
		...
		<dl class="annotation">
			...
			<dd>*.License for Macbooster/IOTransfer is valid forever for current version.</dd>
