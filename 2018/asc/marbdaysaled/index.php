...
if($_GET['action']=='clickCount'){
	try{
		...
		$sql="insert into enascbdayd (ip,addTime,timezone,c_type,c_des,type,packs) values(:ip,:addTime,:timezone,:cType,:cDes,:type,:packs)";
		$pre=$pdo->prepare($sql);
	...
	<div class="wrapper">
		...
		<div class="gift-box three-gift">
           ...
           packs left only
				...
				<a href="https://www.iobit.com/buy.php?product=asc113pcsdiupf&ref=marbdaysaledpca&aff=<?php echo $_GET['aff'];?>&refs=purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase-mardpca');clickCount(1,'pc top')" class="buybtn orange"><i></i>Activate Now</a>
			</div>
		</div>
		...
		<div class="gift-box one-gift">
           ...
           packs left only
				...
				<dl>
					<dt>
						<h5>Advanced SystemCare 11 PRO</h5> 1 Year / 1 PC
					</dt>
					<dd><i></i><span>IObit Uninstaller 7 PRO</span> <i class="gift"></i></dd>
				</dl>
				<p><strong>$<b>19</b>.99</strong> <del> $69.98</del></p>
				<a href="https://www.iobit.com/buy.php?product=asc11iu71pc&ref=marbdaysaledasciua&aff=<?php echo $_GET['aff'];?>&refs=purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase-mardasciua');clickCount(2,'md top')" class="buybtn blue"><i></i>Activate Now</a>
			</div>
		</div>
	</div>
</div>
...
<div class="between-buy">
	<div class="wrapper">
		<div class="box three-box">
			<h3>Free Utilities of PC Performance Pack</h3>
			...
			<a href="https://www.iobit.com/buy.php?product=asc113pcsdiupf&ref=marbdaysaledpcb&aff=<?php echo $_GET['aff'];?>&refs=purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase-mardpcb');clickCount(3,'pc mid')"  class="buybtn bottom"><i></i> Get Free Gifts Now</a>
			<div class="message">	
				<div class="countdown">
          <div class="scroll-tick">
            <span>0</span>
		...
		<div class="box one-box">
			<h3>Free IObit Uninstaller for Cleaner PC</h3>
			<img src="<?php echo getStaticUrl('images/bottom-one-box.png')?>" alt="" class="img">
			<dl>
				<dt>IObit Uninstaller 7 PRO</dt>
				<dd>To Remove Stubborn & Bundled Programs</dd>
				<dd>To Delete Malicious Plug-ins</dd>
				<dd>To AutoClean Leftover Files</dd>
			</dl>
			<a href="https://www.iobit.com/buy.php?product=asc11iu71pc&ref=marbdaysaledasciub&aff=<?php echo $_GET['aff'];?>&refs=purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase-mardasciub');clickCount(4,'md mid')" class="buybtn bottom"><i></i> Get Free Gift Now</a>
			<div class="message">	
				<div class="countdown">
          <div class="scroll-tick">
            <span>0</span>
	...
	<div class="wrapper">
		<div class="box active three-box ">
			...
			<p>
				...
				<a href="https://www.iobit.com/buy.php?product=asc113pcsdiupf&ref=marbdaysaledpcc&aff=<?php echo $_GET['aff'];?>&refs=purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase-mardpcc');clickCount(5,'pc bot')" class="buybtn"><i></i>Activate Now</a>
			</p>
		</div>
		<div class="box one-box ">
			<img src="<?php echo getStaticUrl('images/fl-one-box.png')?>" alt="" class="img">
			<p>
				<strong>$<b>19</b>.99 </strong> <del>$69.98</del>
				<a href="https://www.iobit.com/buy.php?product=asc11iu71pc&ref=marbdaysaledasciuc&aff=<?php echo $_GET['aff'];?>&refs=purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase-mardasciuc');clickCount(6,'md bot')" class="buybtn"><i></i>Activate Now</a>
			</p>
		</div>
	</div>
</div>
