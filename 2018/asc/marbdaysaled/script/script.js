...
function soldOut() {
	...
	$(".banner .gift-box.one-gift .buybtn").attr("href","https://www.iobit.com/buy.php?product=asc11iu71pc&ref=marbdaysaledasciud&aff="+aff+"&refs=purchase_asc&tw="+tw);
	$(".banner .gift-box.one-gift .buybtn").attr("onclick","ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase-mardasciud');clickCount(7,'md top exp')");
	$(".between-buy .one-box .buybtn").attr("href","https://www.iobit.com/buy.php?product=asc11iu71pc&ref=marbdaysaledasciue&aff="+aff+"&refs=purchase_asc&tw="+tw);
	$(".between-buy .one-box .buybtn").attr("onclick","ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase-mardasciue');clickCount(8,'md mid exp')");
	$(".float .buybtn").attr("href","https://www.iobit.com/buy.php?product=asc11iu71pc&ref=marbdaysaledasciuf&aff="+aff+"&refs=purchase_asc&tw="+tw);
	$(".float .buybtn").attr("onclick","ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase-mardasciuf');clickCount(9,'md bot exp')");
}
...
function packsInit(){
	var date = new Date();
	var cName = "enascbdayd" + date.getDate();
