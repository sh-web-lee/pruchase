...
function maskShow() {
  $(".mask").remove();
  $(".mask-box").remove();
  $('.main').append('<div class="mask"></div><div class="mask-box"><h2>OEPS</h2><p>Deze voorverkoopaanbieding is voor <br> vandaag helaas uitverkocht.</p><a href="https://purchase.iobit.com/nl/asc/index.php">Bekijk een andere aanbieding >></a></div>');
