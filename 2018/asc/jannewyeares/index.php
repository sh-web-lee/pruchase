...
<title> 75% de descuento y regalo para ASC PRO – IObit</title>
...
<script type="text/javascript" src="<?php echo $pRootUrl; ?>tpl/js/stats.js"></script>
  ...
  <div class="wrapper">
    ...
    <div class="banner">
      ...
      <h2>- 75% y obtén regalos exclusivos para Advanced SystemCare 12 PRO</h2>
      ...
      <div class="right-message">
        <h2>Advanced SystemCare PRO 12 </h2>
        <p>1 año / 3 PCs <strong>+ Paquete de regalo exclusivo</strong></p>
        <dl class="price">
          <dt>
            <del>79,89€</del> <strong>17,99€</strong> <span>¡Se ahorra 61,90€!</span>
          </dt>
          <dd>
            <a href="https://www.iobit.com/buy.php?product=es-asc123pcpfsd1799&ref=es_asc123pcpfsdpurchase1801<?php echo $refStr;?>&refs=es_purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase1801-es')" class="buybtn">
    ...
    <div class="asc-message clearfix">
      <h2>Disfruta de un PC más rápido y seguro con el mejor rendimiento y protección con <br> Advanced SystemCare 12 PRO</h2>
    ...
    <div class="between-buy">
      <img src="<?php echo $pResUrl; ?>images/bottom-asc-box.png" alt="" class="asc-box">
      <div class="right-message">
        <h2>OFERTA EXCLUSIVA</h2>
        <h3>Suscripción de 1 año / 3 PCs y 2 REGALOS <img src="<?php echo $pResUrl; ?>images/gift.png" alt=""></h3>
        <dl class="price">
          <dt>
      ...
      <table border="0" cellspacing="0" cellpadding="0" width="100%">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="virtue">Mantiene tus datos personales lejos de programas no confiables</td>
            <td class="spac"></td>
            <td class="itemb"><img src="<?php echo $pResUrl; ?>images/mark-free.png"></td>
            <td class="spac"></td>
            <td class="itema"><img src="<?php echo $pResUrl; ?>images/mark-pro.png"></td>
          ...
          <tr>
            ...
            <td class="virtue">Nadie puede robar tu huella digital para espiar tu comportamiento en navegación de web</td>
            <td class="spac"></td>
            <td class="itemb"><img src="<?php echo $pResUrl; ?>images/mark-free.png"></td>
            <td class="spac"></td>
            <td class="itema"><img src="<?php echo $pResUrl; ?>images/mark-pro.png"></td>
        ...
        <tfoot>
          <tr>
            ...
            <th class="itema">
              <del>79,89€  </del> <strong>17,99€</strong>
              <a class="buybtn" href="https://www.iobit.com/buy.php?product=es-asc123pcpfsd1799&ref=es_asc123pcpfsdpurchase1801<?php echo $refStr;?>&refs=es_purchase_asc " onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase1801-es')">
                Comprar ahora
              </a>
              1 año / 3 PCs+ Regalos
            </th>
