...
function maskShow() {
  ...
  $(".mask").remove();
  $(".mask-box").remove();
  $('.main').append('<div class="mask"></div><div class="mask-box"><p>OOPS, Les réservations en pré-commande sont complètes aujourd\'hui.\n</p><h2>Pas de soucis ! Profitez maintenant d\'une remise exclusive de 70% .</h2><div class="imgbox"><img src="' + imgUrl + '" alt="Advanced SystemCare 12 PRO"/><p>1 An d’abonnement / 3 PC</p></div><p class="price"><strong>14,99€</strong> <del>49,99€</del></p><a class="buybtn" href="https://www.iobit.com/buy.php?product=fr_asc12preorder1499&ref=fr_1499asc12preorderexpired1499&aff=' + aff + '&refs=fr_purchase_asc" onclick="' + onGa + '" data-text="J’EN PROFITE"><span>J’EN PROFITE</span></a></div>');
...
window.onload = function () {
  ...
  $(window).scrollWindow($(".intro-part02"), $('.floatlayer'), ("on"));
  $(window).on('scroll', function () {
