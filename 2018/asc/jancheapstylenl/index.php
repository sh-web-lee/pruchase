    ...
    <div class="wrapper">
        ...
        <div class="panel">
            <div class="list">
                ...
                <a class="buybtn"
                   href="https://www.iobit.com/buy.php?product=nl-asc121pc1899&ref=nl_asc121pc1899purchase1803<?php echo $refStr;?>&refs=nl_purchase_asc"
                   onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase1803c-nl')">
                    Nu Activeren
                </a>
            </div>
            <div class="list center">
                ...
                <a class="buybtn"
                   href="https://www.iobit.com/buy.php?product=nl-asc123pcsd1999&ref=nl_asc123pcsd1999purchase1803<?php echo $refStr;?>&refs=nl_purchase_asc"
                   onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase1803a-nl')">
                    Nu Activeren
                </a>
            ...
            <div class="list">
                ...
                <a class="buybtn"
                   href="https://www.iobit.com/buy.php?product=nl-asc121y3pc1999&ref=nl_asc123pc1999purchase1803<?php echo $refStr;?>&refs=nl_purchase_asc"
                   onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase1803b-nl')">
                    Nu Activeren
                </a>
            </div>
        </div>
