...
$(function() {
  ...
  $(".footbuy li").on("click", function() {
    ...
    var dataUrl = $(".banner .list").eq(dataName).find(".buybtn").attr("href");
    var dataGa = $(".banner .list").eq(dataName).find(".buybtn").attr("onclick");
    var original = $(".banner .list").eq(dataName).find(".original").text();
    var discount = $(".banner .list").eq(dataName).find(".discount").text();
    var off = $(".banner .list").eq(dataName).find(".price").attr("data-off");
