...
function maskShow() {
  $(".mask").remove();
  $(".mask-box").remove();
  $('.main').append('<div class="mask"></div><div class="mask-box"><h2>UPS</h2><p>Das heute Angebot ist bereits erschöpft.</p><a href="https://purchase.iobit.com/de/asc/index.php">Weitere Angebote ansehen>></a></div>');
