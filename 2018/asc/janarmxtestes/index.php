...
<script type="text/javascript" src="<?php echo $pRootUrl; ?>tpl/js/stats.js"></script>
  ...
  <div class="wrapper">
    ...
    <div class="banner">
      ...
      <h2>- 85% y obtén regalos exclusivos para Advanced SystemCare 11 PRO</h2>
      ...
      <div class="right-message">
        ...
        <dl class="price">
          ...
          <dd>
            <a href="http://www.iobit.com/buy.php?product=es-asc113pcpfsdiu1799&ref=es_asc113pcpfsdiupurchase1801test<?php echo $refStr;?>&refs=es_purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase1801test-es')" class="buybtn">
      ...
      <table border="0" cellspacing="0" cellpadding="0" width="100%">
        ...
        <tfoot>
          <tr>
            ...
            <th class="itema">
              <del>149,92€ </del> <strong>17,99€</strong>
              <a class="buybtn" href="http://www.iobit.com/buy.php?product=es-asc113pcpfsdiu1799&ref=es_asc113pcpfsdiupurchase1801test<?php echo $refStr;?>&refs=es_purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase1801test-es')">
                Comprar ahora
              </a>
              1 año / 3 PCs+ Regalos
            </th>
