...
function maskShow() {
  ...
  $('.main').append('<div class="mask"></div><div class="mask-box"><h2>Surprise de Noël</h2><div class="clearfix"><div class="fl left"><img src="' + imgSrc + '" alt="Advanced SystemCare 12 Pro"/></div><div class="price fl"><h3>Rabais de <b>1 €</b> pour vous exclusivement !</h3><p><strong>16<big>,</big></strong> <span>99€ <del>139,96€</del></span></p> <a class="buybtn" href="' + _href + '" onclick="' + _ga + '">VITE, J’EN PROFITE</a><p class="year">Saisissez votre dernière chance </p></div></div></div>');
