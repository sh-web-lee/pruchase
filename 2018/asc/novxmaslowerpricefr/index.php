...
<body>
  <div class="main">
        ...
        <div class="palen clearfix">
          ...
          <div class="right fr">
            ...
            <div class="price">
              ...
              <a class="buybtn" href="https://www.iobit.com/buy.php?product=fr-asc123pcsdpfamc1799&ref=fr_asc12pfsdamc1799purchase1811a<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=fr_purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase1799xrasca-fr');">
                 VITE, J’EN PROFITE
              </a>
    ...
    <div class="centbuy">
      ...
      <div class="wrapper clearfix">
        ...
        <div class="price fr">
          ...
          <p><strong>17<big>,</big></strong> <span>99€ <del>139,96€</del></span></p>
          <a class="buybtn" href="https://www.iobit.com/buy.php?product=fr-asc123pcsdpfamc1799&ref=fr_asc12pfsdamc1799purchase1811b<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=fr_purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase1799xrascb-fr');">
            VITE, J’EN PROFITE
          </a>
          <p class="year">1 an d’abonnement / 3 PC</p>
        </div>
    ...
    <div class="comparison" id="compare">
      <div class="wrapper">
        <h2>Les avantages de Pro, si vous l’activez maintenant</h2>
        <table border="0" cellspacing="0" cellpadding="0" width="100%">
          ...
          <tbody>
            ...
            <tr>
              <td class="itema"><i class="all-icons close">×</i></td>
              <td class="itemb">Supprime automatiquement les traces de confidentialité pour une navigation en toute sécurité</td>
              <td class="itemc"><i class="all-icons pro">√</i></td>
            </tr>
            <tr>
              <td class="itema"><i class="all-icons close">×</i></td>
    ...
    <div class="footbuy">
      <div class="wrapper">
        ...
        <div class="price">
          <p><strong>17<big>,</big></strong> <span>99€ <del>139,96€</del></span></p> 
          <a class="buybtn" href="https://www.iobit.com/buy.php?product=fr-asc123pcsdpfamc1799&ref=fr_asc12pfsdamc1799purchase1811c<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=fr_purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase1799xrascc-fr')">
            VITE, J’EN PROFITE
          </a>
  ...
  <script>
    ...
    var _href = "https://www.iobit.com/buy.php?product=fr-asc123pcsdpfamc1699&ref=fr_asc12pfsdamc1699purchase1811<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=fr_purchase_asc&tw=-8";
    var _ga = "ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase1699xrascpop-fr')";
