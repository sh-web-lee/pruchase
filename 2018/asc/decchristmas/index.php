...
<div class="header container clearfix">
    ...
    <div class="wrapper head">
                ...
                <div class="defult">
                    ...
                    <div class="price-box">
                        <div class="price-btn clearfix">
                            ...
                            <!-- buybtn -->
                            <a href="https://www.iobit.com/buy.php?product=asc12sdiuamc2198&ref=ascsdiuamc2198may2017<?php echo $refStr; ?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_asc"
                               onclick="ga('send', 'event', 'asc2198buy', 'buy', 'ascpurchase-201705');clickCount(2)"
                               class="buy-btn">
                                ACTIVATE NOW
                            </a>
                        </div>
        ...
        <p class="banner-msg">Try it RISK FREE - Activate Now to keep PC in excellent status and get a 60-day Money Back
            Guarantee</p>
    </div>
</div>
...
<div class="wrapper hightlight clearfix">
    ...
    <div class="hight-light clearfix">
        ...
        <dl class="list5 animate fl">
            ...
            <dd><h3>Privacy Security</h3>
                ...
                <p>Keep your sensitive data like contact, e-mail data, Dropbox, OneDrive etc. away from any secret
                    access.</p></dd>
        </dl>
    ...
    <a href="javascript:void (0);" class="go-table" onclick="Totarget($('.compar-tab'), 100)">Learn more about PRO
        edition ></a>
</div>
...
<div class="middle-buy container clearfix">
    <div class="wrapper">
        ...
        <a href="https://www.iobit.com/buy.php?product=asc12sdiuamc2198&ref=ascsdiuamc2198may2017<?php echo $refStr; ?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_asc"
           onclick="ga('send', 'event', 'asc2198buy', 'buy', 'ascpurchase-201705');clickCount(2)"
           class="buy-btn middle-btn yellow">
            <div class="inner">
                <span>Get My Free Gifts</span>
            </div>
        </a>

        <p class="gift-last-num">Hurry, <span class="count-num">36</span> bought <span class="cut-num"><i
                    class="left-num">64</i> left</span> now </p>
    </div>
</div>
    ...
    <div class="review wrapper">
        <div class="review-box">
            <div class="reviews clearfix">
                ...
                <p>"I like many started off with the free version and eventually purchased the full version. It's been
                    working to keep my computer clean and "bug" free for years now and it hasn't let me down yet. I
                    contacted Advanced System Care recently and they responded within a day or two with all I needed to
                    know. In my mind support is huge in the decision to stay with a product and ASC wins in both product
                    and support."</p>
            </div>
            <div class="reviews clearfix">
                <h2>User Review</h2>
                ...
                <p>"We used to use up to a dozen different programs to keep our machines running smoothly and keep the
                    bad guys out. It took hours every week to maintain security and performance. Now, with Advanced
                    System Care Pro, everything is in one place and it takes us just a few minutes every couple of days
                    to do the same jobs with much more confidence"</p>
            </div>
            <div class="reviews clearfix active">
                ...
                <p>IObit Avanced SystemCare is one of our favorite PC cleanup and maintenance tools, and the latest
                    version builds on an already great toolkit with new security-focused options.</p>
            </div>
            <div class="reviews clearfix">
                <h2>User Review</h2>
                ...
                <p>"As a computer repair tech I find by downloading and scanning with ASC free most common problems are
                    resolved. When finished with a repair I usually suggest the client purchase the Pro package. Who
                    needs a tech when you have the power of Advanced System Care Pro working your system 24-7? This is
                    the best product a home user can buy. Thank you for making my job easier."</p>
            </div>
            <div class="reviews clearfix">
                <h2>User Review</h2>
                ...
                <p>"In my opinion, IObit's ASC Pro is the best maintenance application available for the Windows user,
                    providing excellent value and function in both its shareware and freeware versions. IObit provides
                    expert technical support that is competent, knowledgeable and responsive, adding significant value
                    to their products and services for their customers."</p>
            </div>
        </div>

        <ul class="handle clearfix">
            <li>
                <div class="badge"><img src="<?php echo $pResUrl; ?>images/Bruce-Ramsay.png"
                                        alt="Bruce Ramsay"><span></span></div>
            ...
            <li class="active">
                <div class="badge"><img src="<?php echo $pResUrl; ?>images/techradar.png" alt="Techradar"><span></span>
                </div>
                <strong>Techradar</strong>
            </li>
            <li>
                <div class="badge"><img src="<?php echo $pResUrl; ?>images/Charles-R-Widick.png"
                                        alt="Charles R. Widick"><span></span></div>
                <strong>Charles R. Widick</strong>

            </li>
            <li class="last">
                <div class="badge"><img src="<?php echo $pResUrl; ?>images/Gordon-Griswold.png"
                                        alt="Gordon Griswold"><span></span></div>
...
<div class="compar-tab wrapper clearfix">
    <table border="0" cellspacing="0" cellpadding="0" width="100%">
        ...
        <tr>
            ...
            <td class="text">No One Can Steal Your Digital Fingerprint to Track Your Web Browsing <sup
                    class="new">NEW</sup></td>
            <td class="space"></td>
            <td class="item-free"><span class="icon close">x</span></td>
            <td class="space"></td>
            <td class="item-pro"><span class="icon red">v</span></td>
        ...
        <tr>
            ...
            <th class="item-pro">
                ...
                <a href="https://www.iobit.com/buy.php?product=asc12sdiuamc2198&ref=ascsdiuamc2198may2017<?php echo $refStr; ?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_asc"
                   onclick="ga('send', 'event', 'asc2198buy', 'buy', 'ascpurchase-201705');clickCount(2)"
                   class="buy-btn table-btn"><i class="car"></i><span>ACTIVATE NOW</span></a>
...
<div class="awards clearfix">
    <div class="wrapper">
        ...
        <p>
            <a href="https://www.pcmag.com/review/351094/iobit-driver-booster-pro?ref=ascindex" target="_blank"><img
                    src="<?php echo $pResUrl; ?>images/pc-magazine.png"></a>
            <a href="http://download.cnet.com/IObit-Malware-Fighter/3000-8022_4-10967594.html?ref=ascindex"
               target="_blank"><img src="<?php echo $pResUrl; ?>images/clnet.png"></a>
            <a href="http://www.majorgeeks.com/files/details/iobit_smartdefrag.html?ref=ascindex" target="_blank"><img
                    src="<?php echo $pResUrl; ?>images/major-geers.png"></a>
            <a href="https://www.pcworld.com/article/2304854/iobit-advanced-system-care-7-review-comprehensive-utility-set-high-profile-interface.html?ref=ascindex"
               target="_blank"><img src="<?php echo $pResUrl; ?>images/pc-world.png"></a>
            <a href="http://www.chip.de/downloads/IObit-Uninstaller_43121217.html?ref=ascindex" target="_blank"><img
                    src="<?php echo $pResUrl; ?>images/chlp.png"></a>
            <a href="http://www.softpedia.com/get/Tweak/System-Tweak/Advanced-WindowsCare-Professional.shtml?ref=ascindex"
               target="_blank"><img src="<?php echo $pResUrl; ?>images/softpedia.png"></a>
            <a href="http://driver-booster.updatestar.com/?ref=ascindex" target="_blank"><img
                    src="<?php echo $pResUrl; ?>images/updatestar.png"></a>
        </p>
    </div>
</div>
        ...
        <div class="service clearfix">
            <dl class="fl">
                ...
                <dd>
                    ...
                    <p>We’re confident that activating PRO edition will improve your PC <br> performance for affordable
                        price!</p>
                </dd>
            </dl>
            <dl class="fr">
...
<div class="mask-box">
    <h2>You are today's Lucky Visitor!
        Enjoy Your Exclusive Extra 10% OFF Now!
        <i class="close">×</i>
    </h2>
    ...
    <div class="mask-main clearfix">
        ...
        <div class="mask-main-right fl">
            ...
            <ul class="price-dec mask-list clearfix">
                <li class="first">
                    <span>Original</span>
            ...
            <div class="btn-box">
                <!-- buybtn -->
                <a href="https://www.iobit.com/buy.php?product=asc12sdiuamc1999&ref=ascsdiuamc1999may2017<?php echo $refStr; ?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_asc"
                   onclick="ga('send', 'event', 'asc1999buy', 'buy', 'ascpurchase-201705');clickCount(3)"
                   class="buy-btn mask-btn yellow">
                    Get My Extra 10% OFF & 3 FREE Gifts
                </a>
            </div>
