...
function maskShow() {
  $(".mask").remove();
  $(".mask-box").remove();
  $('.main').append('<div class="mask"></div><div class="mask-box"><h2>OOPS</h2><p>Pre-order reservations are full today.</p><a href="https://purchase.iobit.com/en/asc/index.php?st=a12preorderpopup">Check another offer>></a></div>');
