...
<body>
  ...
  <div class="main">
        ...
        <div class="palen clearfix">
          ...
          <div class="right fr">
            ...
            <div class="price">
              ...
              <a class="buybtn" 
                 href="https://www.iobit.com/buy.php?product=asc12preorder&ref=asc12preorderpopup<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_asc"
                 onclick="ga('send', 'event', 'ascbuy', 'buy', 'asc12predorderpopup');"
    ...
    <div class="intro wrapper">
      <h2><b>3 Reasons</b> Why Pre-order Advanced SystemCare 12 PRO</h2>
      <h3 class="steps-title"><b>1</b> New features worth trying</h3>
      <div class="panel">
        <img src="<?php echo getStaticUrl('images/screen.png')?>" alt=""/>
        <dl class="first">
          <dt><img src="<?php echo getStaticUrl('images/intro_01.png')?>" alt=""/></dt>
          <dd>
            <h4>Privacy Shield <b>New</b></h4>
        ...
        <dl class="two">
          ...
          <dd>
            <h4>Digital Fingerprint Protection <b>New</b></h4>
        ...
        <dl class="three">
          ...
          <dd>
            <h4>Anti-Cryptocurrency Mining <b>New</b></h4>
    ...
    <div class="feature">
      <div class="wrapper">
        <h2 class="steps-title"><b>2</b> Better experience with improvements</h2>
        <ul class="clearfix">
        ...
        <div class="note">
          <span><i>□</i> Your Current Version</span>
          <span class="blue"><i>■</i> Advanced SystemCare 12 PRO</span>
        </div>
        <p>*We tested Advanced SystemCare 12 PRO in our internal test lab. Your results may vary.</p>
      </div>
    </div>
    <!-- feature end -->
    ...
    <div class="comparison" id="compare">
      <div class="wrapper">
        <h2 class="steps-title"><b>3</b> Perfect solution for your frustrating PC problems</h2>
    ...
    <div class="centbuy">
      <div class="wrapper">
        <h2>Now Pre-order for <b>$0</b> to Activate All PRO Features</h2>
        <a class="buybtn" 
           href="https://www.iobit.com/buy.php?product=asc12preorder&ref=asc12preorderpopup<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_asc"
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'asc12predorderpopup');"
           data-text="Pre-order Now">
