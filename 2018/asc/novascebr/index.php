...
<title>75% OFF to Get Advanced SystemCare PRO- Black Friday Sale | IObit</title>
...
<body>
  ...
  <div class="main">
        ...
        <div class="palen clearfix">
          ...
          <div class="right fr">
            ...
            <div class="price">
              ...
              <a class="buybtn" href="https://www.iobit.com/buy.php?product=asc123pc1297&ref=br_asce&refs=purchase_ascbf" onclick="ga('send', 'event', 'ascebuy', 'buy', 'ascepurchase-bf');">
                Renew Now
              </a>
    ...
    <div class="feature">
      <div class="wrapper">
        ...
        <h2 class="btitle">What Have Advanced SystemCare PRO Help You</h2>
          ...
          <div class="fl">
            <dl class="one clearfix <?php echo $junk?'':'datahide';?>">
              ...
              <dd>
                ...
                <h3 class="data <?php echo $junk?'':'hide';?>"><span><?php echo $junk;?></span> GB</h3>
    ...
    <div class="centbuy">
      <div class="wrapper">
        <h2 class="btitle">Now Come Back with New Advanced SystemCare PRO</h2>
        ...
        <div class="price">
          <a class="buybtn bigbtn" href="https://www.iobit.com/buy.php?product=asc123pc1297&ref=br_asce&refs=purchase_ascbf" onclick="ga('send', 'event', 'ascebuy', 'buy', 'ascepurchase-bf');">
            Renew Now & Save 75%
          </a>
          <p class="year">1 Year Subscription / 3 PCs</p>
        </div>
    ...
    <div class="floatlayer">
        <div class="wrapper clearfix">
          ...
          <!-- buybtn -->
          <a class="buybtn bigbtn fr" href="https://www.iobit.com/buy.php?product=asc123pc1297&ref=br_asce&refs=purchase_ascbf" onclick="ga('send', 'event', 'ascebuy', 'buy', 'ascepurchase-bf');">
            Renew Now & Save 75%
          </a>
        </div>
    </div>
  ...
  <script>
    ...
    var _href = "https://www.iobit.com/buy.php?product=asc123pc1677&ref=br_asce1677&refs=purchase_ascbf&tw=-8";
