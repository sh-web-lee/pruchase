...
if($_GET['action']=='viewCount'){
  try{
    ...
    $insertSql="insert into enascmdcount (ip,addtime,timezone,statusCode) VALUES (:ip,:addtime,:timezone,:statusCode)";
...
<title>Save Up to 85% OFF on Advanced SystemCare PRO</title>
      ...
      <div class="offer" data-num="1">
        <div class="left fl">
          <div class="top">
            ...
            <div class="price">
              <h4>Special Price</h4>
              <h5><strong><small>$</small>12.97</strong>/ year</h5>
            </div>
            <del>$29.99</del>
            <p>1 PC, $12.97 per PC <b>SAVE 55%</b></p>
          </div>
          <a class="buybtn" href="https://www.iobit.com/buy.php?product=asc111pc1297&ref=asc1pc1297midyearb&aff=<?php echo $_GET['aff']; ?>&refs=purchase_asc" onclick="ga('send', 'event', 'asc1pcbuy', 'buy', 'ascpurchase-201805b');">
            <i class="all-icons"></i>
        ...
        <div class="right fr">
          ...
          <a class="buybtn" href="https://www.iobit.com/buy.php?product=asc113pcs1677&ref=asc3pc1677midyearb&aff=<?php echo $_GET['aff']; ?>&refs=purchase_asc" onclick="ga('send', 'event', 'asc3pcbuy', 'buy', 'ascpurchase-201805b');">
            <i class="all-icons"></i>
            <span>Activate Now</span>
          </a>
        </div>
