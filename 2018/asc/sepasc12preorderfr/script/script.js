...
function maskShow() {
  $(".mask").remove();
  $(".mask-box").remove();
  $('.main').append('<div class="mask"></div><div class="mask-box"><h2>OOPS</h2><p>Les réservations en pré-commande sont<br>complètes aujourd\'hui.</p><a href="https://purchase.iobit.com/fr/asc/index.php">Vérifiez une autre offre >></a><i class="all-icons close"></i></div>');
