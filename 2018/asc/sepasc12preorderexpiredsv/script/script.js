...
function maskShow() {
  $(".mask").remove();
  $(".mask-box").remove();
  $('.main').append('<div class="mask"></div><div class="mask-box"><p>Hoppsan! Det finns ingen plats för gratis förbokning idag </p><h2>Om du beställer nu kan du njuta av exklusiva 66% rabatt.</h2><div class="imgbox"><img src="' + imgUrl + '" alt="Advanced SystemCare 12 PRO"/><p>1 Ärs Prenumeration / 3 Datorer</p></div><p class="price"><strong>199kr</strong> <del>599kr</del></p><a class="buybtn" href="' + _url + '" onclick="' + _ga + '" data-text="Köp Nu"><span>Köp Nu</span></a></div>');
