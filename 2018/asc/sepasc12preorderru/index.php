...
<body>
  ...
  <div class="main">
        ...
        <div class="palen clearfix">
          ...
          <div class="right fr">
            ...
            <div class="price">
              ...
              <a class="buybtn" 
                 href="https://www.iobit.com/buy.php?product=ru-asc12preorder&ref=ru_asc12preorderpopup<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=ru_purchase_asc"
                 onclick="ga('send', 'event', 'ascbuy', 'buy', 'asc12predorder-ru');"
    ...
    <div class="intro wrapper">
      <h2><b>3 Причины,</b> Почему Предзаказать Advanced SystemCare 12 PRO</h2>
      <h3 class="steps-title"><b>1</b> Новые возможности стоит попробовать</h3>
      <div class="panel">
        <img src="<?php echo getStaticUrl('images/screen.png')?>" alt=""/>
        <dl class="first">
          <dt><img src="<?php echo getStaticUrl('images/intro_01.png')?>" alt=""/></dt>
          <dd>
            <h4>Защита Конфиденциальности <b>НОВИНКА</b></h4>
            <h5>Блокирует секретный доступ к вашим файлам и фото</h5>
            <p>
              Защищает ваши личные файлы и фотографии от секретных или несанкционированных доступов, чтобы избежать утечки информации и рисков от программ-вымогателей, фишинговых сайтов и ненужных сообщений.
            </p>
          </dd>
        </dl>
        <dl class="two">
          ...
          <dd>
            <h4>Защита Цифровых Опечатков Пальцев <b>НОВИНКА</b></h4>
            <h5>Никто не может знать, что вы делаете в Интернете</h5>
            <p>
              Автоматически замаскирует ваш цифровой отпечаток пальца. Предотвратит посторонним компаниям отслеживать, что вы читаете, просматриваете и покупаете. 
            </p>
          </dd>
        </dl>
        <dl class="three">
          ...
          <dd>
            <h4>Анти-Майнинг Криптовалюты <b>НОВИНКА</b></h4>
            <h5>Остановит внезапные сбои, перегрев и выключение компьютера</h5>
            <p>
              Остановит вредоносные веб-сайты, которые вы посещаете, от использования вашего компьютера для добычи криптоконверсий, что может привести к сбою браузера, перегреву компьютера и внезапному закрытию системы.
            </p>
          </dd>
        </dl>
      </div>
    ...
    <div class="feature">
      <div class="wrapper">
        <h2 class="steps-title"><b>2</b> Лучший опыт с улучшениями </h2>
        <ul class="clearfix">
        ...
        <div class="note">
          <span><i>□</i> Ваша Текущая Версия</span>
          <span class="blue"><i>■</i> Advanced SystemCare 12 PRO</span>
        </div>
        <p>*мы протестировали Advanced Systemcare PRO в нашей внутренней тестовой лаборатории. Ваши результаты могут отличаться.</p>
      </div>
    </div>
    <!-- feature end -->
    ...
    <div class="comparison" id="compare">
      <div class="wrapper">
        <h2 class="steps-title"><b>3</b> Идеальное решение для вашего разочаровывающего ПК</h2>
    ...
    <div class="centbuy">
      <div class="wrapper">
        <h2>Предзаказать Advanced SystemCare 12 PRO за <b>0 руб</b> Сегодня!</h2>
        <a class="buybtn" 
           href="https://www.iobit.com/buy.php?product=ru-asc12preorder&ref=ru_asc12preorderpopup<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=ru_purchase_asc"
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'asc12predorder-ru');"
           data-text="Предзаказать Сейчас">
