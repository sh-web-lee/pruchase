...
function maskShow() {
  $(".mask").remove();
  $(".mask-box").remove();
  $('.main').append('<div class="mask"></div><div class="mask-box"><h2>ОЙ</h2><p>Предзаказ на сегодня переполнен.</p><a href="https://ru.iobit.com/purchase/asc/?st=a12preorderpopup">Проверьте другое предложение>></a></div>');
