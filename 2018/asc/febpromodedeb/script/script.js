...
function soldout() {
		...
		threePc();
		$(".centbuy .buybtn").attr("href", "https://www.iobit.com/buy.php?product=de-asc123pc2499&ref=de_asc123pc2499purchase1903"+refStr+"&refs=de_purchase_asc&tw="+tw);
		$(".centbuy .buybtn").attr("onclick", "ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase3PC1803-de')");
}
function onePc() {
		$(".footbuy dl strong b").html("22")
		$(".footbuy dl del").html("39,99€")
		$(".footbuy .left-img .box").addClass("one-pc").removeClass("three-pc");
		$(".footbuy dl .buybtn").attr("href", "https://www.iobit.com/buy.php?product=de-asc121pc2299&ref=de_asc121pc2299purchase1903"+refStr+"&refs=de_purchase_asc&tw="+tw);
		$(".footbuy dl .buybtn").attr("onclick", "ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase1PC1803-de')");
}
function threePc() {
		$(".footbuy dl strong b").html("24")
		$(".footbuy dl del").html("59,99€")
		$(".footbuy .left-img .box").addClass("three-pc").removeClass("one-pc");
		$(".footbuy dl .buybtn").attr("href", "https://www.iobit.com/buy.php?product=de-asc123pc2499&ref=de_asc123pc2499purchase1903"+refStr+"&refs=de_purchase_asc&tw="+tw);
		$(".footbuy dl .buybtn").attr("onclick", "ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase3PC1803-de')");
}
function threeBox() {
		$(".footbuy dl strong b").html("24")
		$(".footbuy dl del").html("99,94€")
		$(".footbuy .left-img .box").removeClass("three-pc").removeClass("one-pc");
		$(".footbuy dl .buybtn").attr("href", "https://www.iobit.com/buy.php?product=de-asc12iu3pc2499&ref=de_asc123pciu2499purchase1903"+refStr+"&refs=de_purchase_asc&tw="+tw);
		$(".footbuy dl .buybtn").attr("onclick", "ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase3PCiu1803-de')");
}
function zoomout() {
