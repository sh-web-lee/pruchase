...
<title>Oferta especial de la Copa Mundial.  90% de descuento y regalo para Advanced SystemCare PRO – IObit</title>
  ...
  <div class="wrapper">
    ...
    <div class="banner">
      ...
      <div class="right-message">
        ...
        <dl class="price">
          <dt>
            <del>MXN 3,066.00</del> <strong>MXN 299.00</strong> <span>¡Se ahorra MXN 2,767.00!</span>
          </dt>
          <dd>
            <a href="https://www.iobit.com/buy.php?product=mx-asc113pcpfsdiu299&ref=mx_asc113pcpfsdiupurchase1806wc<?php echo $refStr;?>&refs=mx_purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase1806wc-mx')" class="buybtn">
    ...
    <div class="gift-message clearfix">
      <h2>Regalos gratis sólo para oferta especial de La Copa Mundial de Fútbol 2018</h2>
      <dl>
    ...
    <div class="between-buy">
      ...
      <div class="right-message">
        ...
        <dl class="price">
          <dt>
            <del>MXN 3,066.00</del> <strong>MXN 299.00</strong>
          </dt>
          <dd>
            <a href="https://www.iobit.com/buy.php?product=mx-asc113pcpfsdiu299&ref=mx_asc113pcpfsdiupurchase1806wc<?php echo $refStr;?>&refs=mx_purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase1806wc-mx')" class="buybtn">
              <span><i></i> <em>Comprar ahora</em></span>
      ...
      <table border="0" cellspacing="0" cellpadding="0" width="100%">
        ...
        <tfoot>
          <tr>
            ...
            <th class="itema">
              <del>MXN 3,066.00</del> <strong>MXN 299.00</strong>
              <a class="buybtn" href="https://www.iobit.com/buy.php?product=mx-asc113pcpfsdiu299&ref=mx_asc113pcpfsdiupurchase1806wc<?php echo $refStr;?>&refs=mx_purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase1806wc-mx')">
                Comprar ahora
              </a>
              1 año / 3 PCs+ Regalos
            </th>
