...
function maskShow() {
  ...
  $('.main').append('<div class="mask"></div><div class="mask-box"><h2>Überraschung zu Weihnachten</h2><div class="clearfix"><div class="fl left"><img src="' + imgSrc + '" alt="Advanced SystemCare 12 Pro"/></div><div class="price"><h3>Spar yderligere <b> kr. 10. </b> Det er en gave fra os til dig</h3><p><strong>kr. <big>239</big></strong> 1 år / 3 PC’er</p> <a class="buybtn" href="' + _href + '" onclick="' + _ga + '">Aktiver nu</a><p class="year">Grib din sidste chance for en stor julebesparelse!</p></div></div></div>');
