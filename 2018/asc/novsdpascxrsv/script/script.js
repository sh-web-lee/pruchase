...
function maskShow() {
  ...
  $('.main').append('<div class="mask"></div><div class="mask-box"><h2>Exklusiv Jul Rea</h2><div class="clearfix"><div class="fl left"><img src="' + imgSrc + '" alt="Advanced SystemCare 12 Pro"/></div><div class="price"><h3>Missa inte din sista chans till största besparingen någonsin! <br><b>55% RABATT </b>.</h3><p><strong>269<big>kr</big></strong> <span> <del>599kr</del></span></p> <a class="buybtn" href="' + _href + '" onclick="' + _ga + '">Aktivera Nu</a><p class="year">Registrering av 3 PC / 1 år</p></div></div></div>');
...
function packsInit() {
  ...
  packs = Math.ceil(timeDiff / 7.4) > 0 ? Math.ceil(timeDiff / 7.4) : 0;
  reduceNum(packs, 1);
...
function getSales() {
  ...
  var nowTime = Math.floor(date.getTime() / 1000);
  var timeDiff = countTime - nowTime;
  var packsNow = Math.ceil(timeDiff / 7.4) > 0 ? Math.ceil(timeDiff / 7.4) : 0;
  if (packsNow != packs) {
    if (statusCheck() == 2) {
      packs = 0;
    } else {
