...
function maskShow() {
  ...
  $('.main').append('<div class="mask"></div><div class="mask-box"><h2>OЙ! АКЦИЯ ЗАКОНЧИЛАСЬ!</h2><p>Ловите Ваш Последний Шанс Сэкономить Много в Этом Году!</p><div class="clearfix"><div class="fl left"><img src="' + imgSrc + '" alt="Advanced SystemCare 12 Pro"/></div><div class="price"><h3>80% скидка</h3><p><strong>799<big>руб</big></strong> <span><del>4497 руб</del></span></p> <a class="buybtn" href="' + _href + '" onclick="' + _ga + '">Активировать сейчас</a><p class="year">1 год подписки / 3 ПК</p></div></div></div>');
...
function packsInit() {
  ...
  packs = Math.ceil(timeDiff / 6.2) > 0 ? Math.ceil(timeDiff / 6.2) : 0;
  reduceNum(packs, 1);
...
function getSales() {
  ...
  var nowTime = Math.floor(date.getTime() / 1000);
  var timeDiff = countTime - nowTime;
  var packsNow = Math.ceil(timeDiff / 6.2) > 0 ? Math.ceil(timeDiff / 6.2) : 0;
  if (packsNow != packs) {
    if (statusCheck() == 2) {
      packs = 0;
    } else {
