...
<title>Specialerbjudanden upp till 75% rabatt för att heja för 2018 FIFA VM   – IObit</title>
...
<script type="text/javascript" src="<?php echo $pRootUrl; ?>tpl/js/stats.js"></script>
  ...
  <div class="banner">
    <div class="wrapper">
      ...
      <div class="title">
        ...
        <h2>Köp nu och du kan dra nytta av <strong>73%</strong> rabatt och gratis gåvor på ASC PRO!</h2>
      </div>
      <div class="box one-box">
        ...
        <dl>
          ...
          <dd>
            <a href="https://www.iobit.com/buy.php?product=sv-asc111pc199&ref=sv_asc111pcpurchase1806wc<?php echo $refStr;?>&refs=sv_purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase1806wc-sv')" class="buybtn"><i></i> KÖP NU</a>
          </dd>
        </dl>
      </div>
      <div class="box three-gift">
        ...
        <dl>
          <dt><strong><b>299</b> kr</strong> <del>1 097 kr</del> </dt>
          <dd>
            <a href="https://www.iobit.com/buy.php?product=sv-asc113pcsdpf299&ref=sv_asc113pcsdpfpurchase1806wc<?php echo $refStr;?>&refs=sv_purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase1806wc-sv')" class="buybtn"><i></i> KÖP NU</a>
          </dd>
  ...
  <div class="donation">
    <div class="wrapper clearfix">
      <h2>Gratis gåvaförpackning endast för specialerbjudanden under VM 2</h2>
  ...
  <div class="bottom-buy">
    <div class="wrapper">
      <h2>Köp Advanced SystemCare PRO förattgöra din datorsnabbare med bä</h2>
      <span class="img-box"></span>
      <ul>
        <li data-url="https://www.iobit.com/buy.php?product=sv-asc111pc199&ref=sv_asc111pcpurchase1806wc<?php echo $refStr;?>&refs=sv_purchase_asc" data-price="199" data-original="399 kr"><strong>-50%</strong> <span>1 PC / 1 År </span></li>
        <li class="three-box active" data-url="https://www.iobit.com/buy.php?product=sv-asc113pcsdpf299&ref=sv_asc113pcsdpfpurchase1806wc<?php echo $refStr;?>&refs=sv_purchase_asc" data-price="299" data-original="1 097 kr"><strong>-73%</strong> <span>3 PC / 1 År + gratis gåvor (SD&PF)  </span></li>
      </ul>
      <dl>
        <dt> <strong class="price">299</strong> kr <del class="original">1 097 kr</del></dt>
        <dd>
          <a href="https://www.iobit.com/buy.php?product=sv-asc113pcsdpf299&ref=sv_asc113pcsdpfpurchase1806wc<?php echo $refStr;?>&refs=sv_purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase1806wc-sv')" class="buybtn"><i></i> KÖP NU</a>
        </dd>
      </dl>
