...
function maskShow() {
  $(".mask").remove();
  $(".mask-box").remove();
  $('.main').append('<div class="mask"></div><div class="mask-box"><h2>Hoppsan</h2><p>Det finns ingen plats för förbokning idag.</p><a href="https://purchase.iobit.com/sv/asc/index.php?st=a12preorderpopup_sv">Kolla andra erbjudande >></a></div>');
