...
<title>Förbeställ Advanced SystemCare 12 PRO på 0kr Idag</title>
...
<body>
  ...
  <div class="main">
        ...
        <div class="palen clearfix">
          ...
          <div class="right fr">
            ...
            <div class="price">
              ...
              <a class="buybtn" 
                 href="https://www.iobit.com/buy.php?product=sv-asc12preorder&ref=sv_asc12preorderpopup<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=sv_purchase_asc"
                 onclick="ga('send', 'event', 'ascbuy', 'buy', 'asc12predorder-sv');"
    ...
    <div class="intro wrapper">
      <h2><b>3 skäl</b> till förbeställning av Advanced SystemCare 12 PRO</h2>
      <h3 class="steps-title"><b>1</b> Nya funktioner är värda att försöka</h3>
      <div class="panel">
        <img src="<?php echo getStaticUrl('images/screen.png')?>" alt=""/>
        <dl class="first">
          <dt><img src="<?php echo getStaticUrl('images/intro_01.png')?>" alt=""/></dt>
          <dd>
            <h4>Sekretessskydd <b>Ny</b></h4>
            <h5>Blockera hemlig åtkomst till dina filer och foton</h5>
            <p>
              Skydda dina privata filer och foton mot hemlig eller obehöriga åtkomstar för att undvika sekretessläcka och risker från utpressningsprogram, nätfiske och skräppost.
            </p>
          </dd>
        </dl>
        <dl class="two">
          ...
          <dd>
            <h4>Rengöring av Digitalt Fingeravtryck  <b>Ny</b></h4>
        ...
        <dl class="three">
          ...
          <dd>
            <h4>Förhindra Kryptovaluta-brytning  <b>Ny</b></h4>
            <h5>Sluta plötsliga kraschar, överhettning och avstängning av datorn</h5>
            <p>
              Förhindra skadliga webbplatser du besöker från att använd din dator till Kryptovaluta-brytning som kan leda till att webbläsaren kraschar, datorn överhettar och systemet plötsligt stängs av. 
            </p>
          </dd>
        </dl>
      </div>
    ...
    <div class="feature">
      <div class="wrapper">
        <h2 class="steps-title"><b>2</b> Bättre erfarenhet av förbättringar</h2>
        <ul class="clearfix">
        ...
        <div class="note">
          <span><i>□</i> Din nuvarande version</span>
          <span class="blue"><i>■</i> Advanced SystemCare 12 PRO</span>
        </div>
        <p>*Vi testade Advanced SystemCare 12 PRO i vårt interna testlabb. Dina resultat kan variera.</p>
      </div>
    </div>
    <!-- feature end -->
    ...
    <div class="comparison" id="compare">
      <div class="wrapper">
        <h2 class="steps-title"><b>3</b> Perfekt lösning för dina frustrerande datorproblem</h2>
    ...
    <div class="centbuy">
      <div class="wrapper">
        <h2>Förbeställ nu för <b>0kr</b> och alla PRO funktioner aktiveras</h2>
        <a class="buybtn" 
           href="https://www.iobit.com/buy.php?product=sv-asc12preorder&ref=sv_asc12preorderpopup<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=sv_purchase_asc"
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'asc12predorder-sv');"
           data-text="Förbeställ Nu">
