...
if($_GET['action']=='clickCount'){
	try{
		...
		$sql="insert into enascbdayc (ip,addTime,timezone,c_type,c_des,type,packs) values(:ip,:addTime,:timezone,:cType,:cDes,:type,:packs)";
		$pre=$pdo->prepare($sql);
	...
	<div class="wrapper">
		...
		<div class="gift-box three-gift">
           ...
           PC packs left only
				...
				<a href="https://www.iobit.com/buy.php?product=asc113pcsdiupf&ref=marbdaysalecpca&aff=<?php echo $_GET['aff'];?>&refs=purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase-marcpca');clickCount(1,'pc top')" class="buybtn orange"><i></i>Activate Now</a>
			</div>
		</div>
		...
		<div class="gift-box one-gift">
           ...
           multi-device packs left only
				...
				<a href="https://www.iobit.com/buy.php?product=asc113pciot&ref=marbdaysalecmultia&aff=&refs=purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase-marcmultia');clickCount(2,'md top')" class="buybtn blue"><i></i>Activate Now</a>
			</div>
		</div>
	</div>
</div>
...
<div class="between-buy">
	<div class="wrapper">
		<div class="box three-box">
			...
			<a href="https://www.iobit.com/buy.php?product=asc113pcsdiupf&ref=marbdaysalecpcb&aff=&refs=purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase-marcpcb');clickCount(3,'pc mid')"  class="buybtn bottom"><i></i> Get Free Gifts Now</a>
			<div class="message">	
				<div class="countdown">
          <div class="scroll-tick">
            <span>0</span>
		...
		<div class="box one-box">
			...
			<a href="https://www.iobit.com/buy.php?product=asc113pciot&ref=marbdaysalecmultib&aff=&refs=purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase-marcmultib');clickCount(4,'md mid')" class="buybtn bottom"><i></i> Get Free Gift Now</a>
			<div class="message">	
				<div class="countdown">
          <div class="scroll-tick">
            <span>0</span>
	...
	<div class="wrapper">
		<div class="box active three-box ">
			...
			<p>
				...
				<a href="https://www.iobit.com/buy.php?product=asc113pcsdiupf&ref=marbdaysalecpcc&aff=&refs=purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase-marcpcc');clickCount(5,'pc bot')" class="buybtn"><i></i>Activate Now</a>
			</p>
		</div>
		<div class="box one-box ">
			...
			<p>
				...
				<a href="https://www.iobit.com/buy.php?product=asc113pciot&ref=marbdaysalecmultic&aff=&refs=purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase-marcmultic');clickCount(6,'md bot')" class="buybtn"><i></i>Activate Now</a>
			</p>
		</div>
	</div>
</div>
