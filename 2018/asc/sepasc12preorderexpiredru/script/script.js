...
function maskShow() {
  ...
  $(".mask").remove();
  $(".mask-box").remove();
  $('.main').append('<div class="mask"></div><div class="mask-box"><p>ОЙ, предзаказ за 0 руб на сегодня переполнен.</p><h2>Не беспокойтесь, если Вы заказываете сейчас, Вы можете <br>наслаждаться эксклюзивной 65% СКИДКОЙ.</h2><div class="imgbox"><img src="' + imgUrl + '" alt="Advanced SystemCare 12 PRO"/><p>1 год подписки / 3 ПК</p></div><p class="price"><strong>499 руб</strong> <del>1499</del></p><a class="buybtn" href="' + _url + '" onclick="' + _ga + '" data-text="Купить сейчас"><span>Купить сейчас</span></a></div>');
