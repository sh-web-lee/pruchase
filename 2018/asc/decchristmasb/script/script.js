...
function soldOut() {
    TweenMax.to($('.cut-box'), 3, {
        ...
        onComplete: function() {
            ...
            $(".buy-btn").attr("href", "https://www.iobit.com/buy.php?product=asc123pc2198&ref=asc3pc2198may2017b" + refStr + "&aff=" + aff + "&refs=purchase_asc&tw=" + tw).attr('onclick', "ga('send', 'event', 'asc3pcbuy', 'buy', 'ascpurchase-201812');clickCount(4)");
...
function countOut() {
    var aff = MApp(2.2).url.getParameters('aff');
    var tw = MApp(2.2).datetime.getTimeZone();
    var refLink = 'asc3pc2198may2017b' + refStr;
    $(".banner-boxshot").addClass("sold-out");
    $(".defult").css("display", "none");
    $(".sold-out-banner").css("display", "block");
    $(".middle-buy").remove();
    ...
    $(".item-pro del").html("$89.97");
    $(".table-peice").html("<span>75% OFF </span>Save $67.99");
    $(".buy-btn").attr("href", "https://www.iobit.com/buy.php?product=asc123pc2198&ref=" + refLink + "&aff=" + aff + "&refs=purchase_asc&tw=" + tw).attr('onclick', "ga('send', 'event', 'asc3pcbuy', 'buy', 'ascpurchase-201812');clickCount(4)");
    $("#floatlayer,.gotop").hide();
}
