...
<head>
	<meta charset="UTF-8">
	<title>Offerta di Natale, sconti fino all'87% su Advanced SystemCare PRO – Offerta natalizia di IObit 2018</title>
...
<body>
	<div class="banner">
	 	<div class="wrapper">
			...
			<h1>Super  Offerte di Natale</h1>
			<h2>Non fartele scappare, solo pochi pezzi disponibili!</h2>
 			...
 			<div class="sold-box">
 				...
 				<dl>
 					...
 					<dd><a href="http://www.iobit.com/buy.php?product=it-asc123pcsdpf1799&ref=it_asc123pcsdpf1799purchase1811<?php echo $refStr;?>&refs=it_purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase3PCsdpf1811-it')" class="button button-btm-lag"> <span></span>Approfittane Ora!</a></dd>
 			...
 			<div class="one-pc-box">
 				...
 				<dl>
 					...
 					<dd><a href="http://www.iobit.com/buy.php?product=it-asc123pc1799&ref=it_asc123pc1799purchase1811<?php echo $refStr;?>&refs=it_purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase3PC1811-it')" class="button">ACQUISTA Ora!</a></dd>
 				</dl>
 			</div>
	 	</div>
	...
	<div class="gifts">
		<div class="wrapper">
			...
			<a href="http://www.iobit.com/buy.php?product=it-asc123pcsdpf1799&ref=it_asc123pcsdpf1799purchase1811<?php echo $refStr;?>&refs=it_purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase3PCsdpf1811-it')" class="button btn-mid-lag"> <span></span>OTTIENI I REGALI SUBITO!</a>
	...
	<div class="bottomcart">
		<div class="wrapper">
			<h2>A Natale, fai il MIGLIOR REGALO al tuo vecchio PC!</h2>
				...
				<dl class="btnarea">
					<dt> <strong><b>17</b>,99</strong> <del>79,98</del>   Risparmi <span> 101,94</span></dt>
					<dd>
						<a href="http://www.iobit.com/buy.php?product=it-asc123pcsdpf1799&ref=it_asc123pcsdpf1799purchase1811<?php echo $refStr;?>&refs=it_purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase3PCsdpf1811-it')" class="button button-top-lag"> <span></span>Approfittane Ora!</a>
					</dd>
				</dl>
		</div>
	</div>
