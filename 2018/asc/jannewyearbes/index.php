...
<title> 85% de descuento y regalo para ASC PRO – IObit</title>
...
<script type="text/javascript" src="<?php echo $pRootUrl; ?>tpl/js/stats.js"></script>
  ...
  <div class="wrapper">
    <!-- banner start -->
    <div class="banner">
      <h1>¡Feliz Año Nuevo! OFERTA EXCLUSIVA</h1>
      ...
      <div class="right-message">
        ...
        <p>1 año / 3 PCs <strong>+ Paquete de Año Nuevo</strong></p>
        <dl class="price">
          <dt>
            <del>149,92€ </del> <strong>17,99€</strong> <span>¡Se ahorra 131,93€!</span>
          </dt>
          <dd>
            <a href="http://www.iobit.com/buy.php?product=es-asc113pcpfsdiu1799&ref=es_asc113pcpfsdiupurchase1801b<?php echo $refStr;?>&refs=es_purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase1801b-es')" class="buybtn">
              <span><i></i> <em>ADQUIRIR YA</em></span>
            </a>
          </dd>
    ...
    <div class="gift-message clearfix">
      <h2>Paquete de regalo sólo para oferta exclusiva de Año Nuevo</h2>
      <dl>
      ...
      <table border="0" cellspacing="0" cellpadding="0" width="100%">
        ...
        <tfoot>
          <tr>
            ...
            <th class="itema">
              <del>149,92€ </del> <strong>17,99€</strong>
              <a class="buybtn" href="http://www.iobit.com/buy.php?product=es-asc113pcpfsdiu1799&ref=es_asc113pcpfsdiupurchase1801b<?php echo $refStr;?>&refs=es_purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase1801b-es')">
                ADQUIRIR YA
              </a>
              1 año / 3 PCs+ Regalos
            </th>
