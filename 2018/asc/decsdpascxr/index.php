...
<body>
  ...
  <div class="main">
        ...
        <div class="palen clearfix">
          ...
          <div class="right fr">
            ...
            <div class="price">
              ...
              <a class="buybtn" href="https://www.iobit.com/buy.php?product=asc123pc1999x&ref=xr_sdpasc&refs=purchase_ascx" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase-xmas');">
                Activate Now
              </a>
    ...
    <div class="together">
      <div class="wrapper">
        <h2>
          Together with Smart Defrag Pro, <br> you will maximize hard drive performance and speed up PC!
        </h2>
        <div class="panel clearfix">
          <div class="asc-box fl clearfix">
            <div class="box fl">
              <h3>Maximum Hard Drive Performance <i></i></h3>
              <dl>
                <dt><strong>Up to 200%* Faster</strong></dt>
                <dd>
                  Accelerate file access speed & game launching speed efficiently.
                  <span>*Smart Defrag Pro only!</span>
                </dd>
              </dl>
              <dl>
                <dt><strong>Better Disk Performance</strong></dt>
                <dd>
                  More stable and faster disk performance with junk files AutoClean and deeper registry cleaning.
          ...
          <div class="db-box fl clearfix">
            ...
            <div class="box fl">
              <h3><i></i> Faster PC Speed</h3>
              <dl>
                <dt><strong>Up to 200%* Faster</strong></dt>
                <dd>
                  Reduce system stutter/lag to speed up PC.
                  <span>*Advanced SystemCare Pro only!</span>
                </dd>
              </dl>
              <dl class="four">
                <dt><strong>Quick PC Startup</strong></dt>
                <dd>
                  Enjoy quick PC startup and top <br>system running speed with Boot Time Defrag.
                  <span>*Smart Defrag Pro only!</span>
                </dd>
              </dl>
            </div>
    ...
    <!-- centbuy start -->
    <div class="centbuy">
      <h2>Activate Advanced SystemCare Pro Now - Last Chance to Save Big in 2018!</h2>
      <div class="wrapper clearfix">
        ...
        <div class="price fr">
          ...
          <p><strong>$<big>19</big>.99</strong> <del>$49.99</del></p>
          <a class="buybtn yellow" href="https://www.iobit.com/buy.php?product=asc123pc1999x&ref=xr_sdpasc&refs=purchase_ascx" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase-xmas');">
            Activate Now
          </a>
          <p class="year">1 Year Subscription / 3 PCs</p>
          <img class="moneyback" src="<?php echo getStaticUrl('images/moneyback.png')?>" alt=""/>
    ...
    <div class="footbuy">
      <div class="wrapper">
        ...
        <h2>Get Exclusive 60% OFF to Get Cleaner, Faster and More Secure PC!</h2>
        <div class="price">
          <p><strong>$<big>19</big>.99</strong> <del>$49.99</del></p>
          <a class="buybtn" href="https://www.iobit.com/buy.php?product=asc123pc1999x&ref=xr_sdpasc&refs=purchase_ascx" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase-xmas');">
            Activate Now
    ...
    <div class="floatlayer">
        <div class="wrapper clearfix">
          ...
          <!-- buybtn -->
          <a class="buybtn yellow fr" href="https://www.iobit.com/buy.php?product=asc123pc1999x&ref=xr_sdpasc&refs=purchase_ascx" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase-xmas');">
            Activate Now
          </a>
        </div>
    </div>
    ...
    <div class="popShow">
      ...
      <div class="clearfix">
        ...
        <div class="price fl">
          ...
          <a class="buybtn yellow" href="https://www.iobit.com/buy.php?product=asc123pc2199x&ref=xr_sdpasc2199&refs=purchase_ascx" onclick="ga('send', 'event', 'ascbuypop', 'buy', 'ascpurchase-xmas');">
            Activate Now
          </a>
          <p class="year">1 Year Subscription / 3 PCs</p>
        </div>
