...
function maskShow() {
  $(".mask").remove();
  $(".mask-box").remove();
  $('.main').append('<div class="mask"></div><div class="mask-box"><h2>OOPS</h2><p>La actividad de preventa ha terminado hoy.</p><a href="https://purchase.iobit.com/es/asc/index.php">Ver otra oferta >></a></div>');
