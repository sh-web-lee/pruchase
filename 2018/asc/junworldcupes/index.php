...
<title>Oferta especial de Advanced SystemCare PRO para animar a la Copa Mundial 2018   – IObit</title>
...
<script type="text/javascript" src="<?php echo $pRootUrl; ?>tpl/js/stats.js"></script>
  ...
  <div class="banner">
    <div class="wrapper">
      ...
      <div class="title">
        <h1>¡Vamos a animar a la Copa Mundial 2018!</h1>
        <h2>Oferta especial hasta 75% de descuento para animar a los equipo</h2>
      </div>
      <div class="left-message">Sale Compra Advanced SystemCare PRO, consigue 2 regalos gratis! </div>
      <div class="right-box">
        <img src="<?php echo $pResUrl; ?>images/asc-box.png" alt="" class="img-box">
        <dl class="price">
          <dt><del>79,89€ </del> <strong>17,99€ </strong></dt>
          <dd><a href="https://www.iobit.com/buy.php?product=es-asc113pcpfsd1799&ref=es_asc113pcpfsdpurchase1806wc<?php echo $refStr;?>&refs=es_purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase1806wc-es')" class="buybtn">Comprar ahora</a></dd>
          <dd><img src="<?php echo $pResUrl; ?>images/people.png" alt="">Más de <strong>6,378,528</strong> personas han comprado </dd>
        </dl>
      </div>
    </div>
  </div>
  <!-- banner end -->
  <div class="asc-message wrapper clearfix">
    <h2>Disfruta de un PC más rápido y seguro con Advanced SystemCare 11 PRO</h2>
    ...
    <ul>
      ...
      <li><a href="javascript: void(0);">Ver más sobre la edición PRO>></a></li>
    </ul>
    <div class="line"></div>
  </div>
  <div class="gift-message clearfix">
    <div class="wrapper">
      <h2>Regalo gratis sólo para oferta especial de la Copa Mundial de Fútbol 2018</h2>
      <dl>
        <dt> <img src="<?php echo $pResUrl; ?>images/pf-box.png" alt=""></dt>
        <dd>
          <h3>Protected Folder     <del>19,95€</del> 0€  </h3>
      ...
      <dl>
        ...
        <dd>
          <h3>Smart Defrag PRO     <del>19,99€</del> 0€  </h3>
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%">
      ...
      <tfoot>
        <tr>
          ...
          <th class="spac"></th>
          <th class="itema">
            <del>79,89€  </del> <strong>17,99€</strong>
            <a class="buybtn" href="https://www.iobit.com/buy.php?product=es-asc113pcpfsd1799&ref=es_asc113pcpfsdpurchase1806wc<?php echo $refStr;?>&refs=es_purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase1806wc-es')">
              Comprar ahora
            </a>
            1 año / 3 PCs+ Regalos
          </th>
  ...
  <div class="floatlayer" id="floatlayer">
    <div class="wrapper clearfix">
      <div class="left">
        <h2>Oferta especial para animar a la Copa Mundial 2018</h2>
        <h3>Compra Advanced SystemCare PRO para hacer tu PC <br> más rápido con mejor rendimiento</h3>
      </div>
      <dl class="price">
        <dt> <del>79,89€</del> <strong>17,99€</strong></dt>
        <dd><a class="buybtn" href="https://www.iobit.com/buy.php?product=es-asc113pcpfsd1799&ref=es_asc113pcpfsdpurchase1806wc<?php echo $refStr;?>&refs=es_purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase1806wc-es')">Comprar ahora</a>
        </dd>
      </dl>
...
<script> 
  ...
  $(".asc-message  a").target($("#compare"),0);
