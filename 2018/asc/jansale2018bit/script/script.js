...
function soldOut() {
	...
	$(".banner .sold-box dl dt strong").html("60%");
	$(".banner .one-pc-box dl dt strong").html("83%");
	$(".banner .one-pc-box dl .button").html("Approfittane Ora!");
	$(".banner .sold-box h2").html("<span class='num'><span class='pack packsNum'>55</span> <span class='popup-font packsNum'>55</span></span> Pezzi Rimasti Oggi");
	$(".selection li").eq(0).addClass("default").removeClass("active");
	$(".selection li").eq(1).addClass("active");
	$(".gifts .lists").addClass("exceed");
	$(".banner .sold-box .button,.gifts .button").attr("href","https://www.iobit.com/buy.php?product=it-asc123pc1799&ref=it_asc123pc1799purchase1801b"+refStr+"&refs=it_purchase_asc");
	$(".banner .sold-box .button,.gifts .button").attr("onclick","ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase3pc1801b-it')");
	 onePc();
}
function zoomout () {
...
function onePc() {
	$(".bottomcart .button").attr("href","https://www.iobit.com/buy.php?product=it-asc123pc1799&ref=it_asc123pc1799purchase1801b"+refStr+"&refs=it_purchase_asc");
	$(".bottomcart .button").attr("onclick","ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase3pc1801b-it')");
...
function threePc() {
	$(".bottomcart .button").attr("href","https://www.iobit.com/buy.php?product=it-asc125pcsd1999&ref=it_asc125pcsd1999purchase1801b"+refStr+"&refs=it_purchase_asc");
	$(".bottomcart .button").attr("onclick","ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase5pcsd1801b-it')");
	$(".bottomcart dl strong").html("<b>19</b>,99");
	$(".bottomcart dl del").html("119,98");
	$(".bottomcart dl dt span").html("99,99");
...
$(window).scrollWindow($(".payments"), $('.content ul'), ("on"));
