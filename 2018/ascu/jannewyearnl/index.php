...
<head>
	...
	<title> Bespaar tot 75% op Advanced SystemCare Ultimate PRO – Flash Aanbieding van IObit</title>
...
<div class="header clearfix">
	<div class="header-container">
		...
		<img class="godaddy" src="<?php echo $pResUrl; ?>images/godaddy.png" alt="IObit" />
	</div>
</div>
...
<div class="banner clearfix">
	<div class="title-container clearfix">
		...
		<div class="buy-info">
			...
			<a href="https://www.iobit.com/buy.php?product=nl-ascu13pfiu2999&ref=nl_au13pfiupurchase2001<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=nl_purchase_ascu" onclick="ga('send', 'event', 'ascubuy', 'buy', 'ascupurchase1801-nl')" class="buy-btn">Koop Nu</a>
...
<div class="bottom-bg clearfix">
	<div class="wrapper bottom-banner clearfix">
		<h2> <b>75% Korting</b> tijdens de Flash Sale en 2 GRATIS producten!</h2>
