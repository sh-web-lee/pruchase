...
<head>
  ...
  <title>Grande Offerta! sconti fino al 75% su Advanced SystemCare Ultimate – Offerta capodanno 2019 di IObit</title>
  ...
  <div class="wrapper clearfix">
    ...
    <div class="right-message fr">
      ...
      <h3>
        ...
        <span>
          +<br>
          REGALI GRATIS solo per Capodanno
        </span>
      </h3>
      <!-- notes -->
      ...
      <!-- price -->
      <p class="price">
        <strong>29</strong><del>€129,93</del><b>,99</b><br>
        Risparmi €99,94!
      </p>
      <!-- buybtn -->
      <a class="buybtn"
         href="https://www.iobit.com/buy.php?product=it-au12sdpf2999&ref=it_au12sdpfpurchase1812<?php echo $refStr;?>&refs=it_purchase_ascu"
         onclick="ga('send', 'event', 'ascubuy', 'buy', 'ascupurchase1812-it')">
...
<div class="container">
  ...
  <div class="betweenbuy">
    ...
    <h3>Ottieni un pacchetto regalo <span>(Valore di € 69,94)</span> solo per l'esclusiva offerta natalizia</h3>
    <div class="wrapper">
      <div class="clearfix">
        <!-- SD box -->
...
<div class="bottombuy">
  <div class="wrapper clearfix">
    <!-- left-message -->
    <div class="left-message fl">
      <img class="banner-asc" src="<?php echo getStaticUrl('images/bottombuy-ascu.png')?>" alt=" Advanced SystemCare Ultimate"/>
    ...
    <div class="right-message fr">
      <!-- ASC12 -->
      <h3>
        <b>OFFERTA ESCLUSIVA CON 75% DI SCONTI</b>
        <span>REGALI GRATIS solo per ANNO NUOVO</span>
      </h3>
      <!-- notes -->
