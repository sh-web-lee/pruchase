...
<div class="banner">
  <div class="wrapper">
    ...
    <h1>
      BLITZ-DEAL 2019
      Sparen Sie 76% auf ASC Ultimate und erhalten Sie zusätzlich Gratisgeschenke!
    </h1>
    <!-- content -->
    <div class="content clearfix">
      ...
      <div class="right-message fr">
        ...
        <!-- buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=de-ascu123pcpfsd2999eu&ref=de_au12pfsd6purchase1812<?php echo $refStr;?>&refs=de_purchase_ascu"
           onclick="ga('send', 'event', 'ascubuy', 'buy', 'ascupurchase201812-de')">
             JETZT SPAREN
        </a>
        <!-- attention -->
        <p class="attention">    1 Jahresabo für 3 PCs</p>
        <!-- moneyback -->
  ...
  <div class="wrapper">
    ...
    <dl class="price-content">
      ...
      <dd>
        ...
        <!-- attention -->
        <p class="attention"><i></i>Achtung, nur noch <b class="packsNum"><?php echo $packsNum ?></b> Plätze übrig!</p>
      </dd>
    </dl>
  </div>
</div>
