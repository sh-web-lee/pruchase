...
<div id="banner">
    ...
    <h2>Köp Advanced SystemCare Ultimate för endast  <strong>349 kr</strong> och få Protected Folder som gåva. Helt Gratis!</h2>
    <div class="content">
      <div class="left">
      ...
      <div class="right">
        ...
        <p><a href="https://www.iobit.com/buy.php?product=sv-ascu123pcpf349&ref=sv_ascu123pcpfpurchase1811<?php echo $refStr;?>&refs=sv_purchase_ascu" onclick="ga('send', 'event', 'ascubuy', 'buy', 'ascupurchase1811-sv')" class="btn"><i></i>Aktivera NU</a><img src="<?php echo getStaticUrl('images/days.png')?>" alt="" /></p>
        <div class="clear"></div>
...
<div class="floatlayer" id="floatlayer">
      ...
      <dl class="left">
        ...
        <dl class="checkarea">
          ...
          <dd><a class="btn " href="https://www.iobit.com/buy.php?product=sv-ascu123pcpf349&ref=sv_ascu123pcpfpurchase1811<?php echo $refStr;?>&refs=sv_purchase_ascu" onclick="ga('send', 'event', 'ascubuy', 'buy', 'ascupurchase1811-sv')"><i></i>Aktivera Nu</a></dd>
        </dl>
    </div>
  </div>
