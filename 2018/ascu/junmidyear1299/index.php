...
<script type="text/javascript" src="<?php echo $pRootUrl; ?>tpl/js/stats.js"></script>
  ...
  <div class="header">
    <div class="wrapper">
      ...
      <h2>
        ...
        Left to Get <span>85</span>% OFF & Free Gifts
      </h2>
        ...
        <div class="infor fr">
          ...
          <dl>
            <dt>
              ...
              <strong class="infor-price price">$12.99</strong>
              <span class="original">
            ...
            <dd>
              <a class="buybtn inforbtn" href="https://www.iobit.com/buy.php?product=ascu11pf-6&ref=<?php echo $ref; ?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_ascu"  onclick="ga('send', 'event', 'ascubuy', 'buy', 'ascupurchase-1299');">
                <i></i>
  ...
  <div class="wrapper main">
    ...
    <h2 class="exclus">Exclusive Discount for Advanced SystemCare PRO User – Activate before Trial Expiring!</h2>
      ...
      <div class="descrip clearfix">
        ...
        <dl class="handle fr">
          <dt>
            Only <strong  class="price">$12.99</strong> <del>$109.93</del>
          </dt>
          <dd>
            <a class="buybtn descripbtn" href="https://www.iobit.com/buy.php?product=ascu11pf-6&ref=<?php echo $ref; ?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_ascu"  onclick="ga('send', 'event', 'ascubuy', 'buy', 'ascupurchase-1299');">
              <i></i>
  ...
  <div class="floatlayer">
    <div class="wrapper">
      ...
      <dl>
        <dt>Only <strong class="price">$12.99</strong> <del>$109.93</del></dt>
        <dd>
          <a class="buybtn floatbtn" href="https://www.iobit.com/buy.php?product=ascu11pf-6&ref=<?php echo $ref; ?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_ascu"  onclick="ga('send', 'event', 'ascubuy', 'buy', 'ascupurchase-1299');">
            <i></i>
            <span>Activate Now</span>
          </a>
        </dd>
