...
<head>
  <meta charset="UTF-8">
  <title>Jusqu'à -70% sur Advanced SystemCare Ultimate - Vente Flash - IObit</title>
  ...
  <div class="wrapper">
    ...
    <div class="panel clearfix">
      <div class="box small">
        ...
        <a class="buy-btn" href="https://www.iobit.com/buy.php?product=fr-ascu113pc2999&ref=fr_ascu113pc1806purchase<?php echo $refStr;?>&aff=&refs=fr_purchase_ascu" onclick="ga('send', 'event', 'ascubuy', 'buy', 'ascupurchase1806bfr');">
          J’EN PROFITE VITE
        </a>
      </div>
      <div class="box">
        ...
        <a class="buy-btn red" href="https://www.iobit.com/buy.php?product=fr-ascu113pcpf&ref=fr_ascu113pcpf1806purchase<?php echo $refStr;?>&aff=&refs=fr_purchase_ascu" onclick="ga('send', 'event', 'ascubuy', 'buy', 'ascupurchase1806fr');">
          J’EN PROFITE VITE
        </a>
        <p class="bought">
  ...
  <div class="clearfix">
    ...
    <div class="high-light fl">
      <ul>
        ...
        <li><i>√</i> Protège votre vie privée en ligne en temps réel.</li>
...
<div class="buy-mid wrapper">
  <h2>Profitez d’un PC plus sûr grâce à un outil PRO supplémentaire </h2>
  <dl class="clearfix">
    ...
    <dd>
      ...
      <ul>
        <li><i class="all-icons"></i> <span>ll fait office de coffre-fort pour vos fichiers et dossiers</span></li>
        <li><i class="all-icons"></i> <span>Un mot de passe empêche quiconque de les ouvrir</span></li>
      </ul>
    </dd>
  </dl>
  <a href="https://www.iobit.com/buy.php?product=fr-ascu113pcpf&ref=fr_ascu113pcpf1806purchase<?php echo $refStr;?>&aff=&refs=fr_purchase_ascu" onclick="ga('send', 'event', 'ascubuy', 'buy', 'ascupurchase1806fr');" class="buy-btn red middle"><i></i> <span>J’EN PROFITE VITE</span></a>
  <ul id="countdown2" class="countdown countdowntwo">
    <li><strong>00</strong> H : </li>
    <li><strong>00</strong> M : </li>
    <li><strong>00</strong> : </li>
...
<div class="comparison wrapper">
  <h2>Pourquoi choisissez-vous l’Advanced SystemCare Ultimate 11 ?</h2>
...
<div class="buy-bottom bg">
  <div class="wrapper clearfix">
    ...
    <div class="buy-container fr">
      ...
      <a class="buy-btn red middle" href="https://www.iobit.com/buy.php?product=fr-ascu113pcpf&ref=fr_ascu113pcpf1806purchase<?php echo $refStr;?>&aff=&refs=fr_purchase_ascu" onclick="ga('send', 'event', 'ascubuy', 'buy', 'ascupurchase1806fr');">
          <i></i>
