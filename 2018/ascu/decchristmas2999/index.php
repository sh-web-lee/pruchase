...
//  主要内容
if (empty($_GET['ref'])) $_GET['ref'] = 'ascu12';
...
if(in_array($_GET['to'],array('buyascu'))){
  $refStr.='-'.$_GET['to'];
}

// 折扣信息
$discountListArr = array(
  // 折扣比例、价格、购买链接标签、ref参数
  '6m' => array('90', '9', 'ascu12pf-6m','ascu12999'), // 到期大于6个月 pro2
  '6' => array('85', '12', 'ascu12pf-6', 'ascu121299'), // 到期小于6个月 pro1
  'default' => array('70', '29', 'ascu12pf', 'ascu122999'),
  'title' => array(
    'um10trial' => array(
...
if ($_POST['action'] == 'getDiscount') exit($discount.'|'.$price.'|'.$buyTag.'|'.$refStrWithCode);
    ...
    function getDiscountInfo(codeType){
      $.ajax({
        ...
        success : function(discount) {
          ...
          $('#balloon').attr('class', 'balloon_'+percent);
          $('.price').html(price);
          $('.price').eq(0).html($('.price').eq(0).html().replace('$',''));
          var tw = MApp(2.2).datetime.getTimeZone();
          buyUrl = 'https://www.iobit.com/buy.php?product='+discountArr[2]+'&ref='+discountArr[3]+'&aff=<?php echo $_GET['aff']; ?>&refs=purchase_ascu&tw='+tw;
  ...
  <div class="wrapper">
    ...
    <div class="panel clearfix">
      <div class="product fl">
        ...
        <div id="balloon" class="balloon_70"></div>
      </div>
      <div class="infor fr">
        <div class="infor-top">
        ...
        <dl>
          ...
          <dd>
            <!-- buybtn -->
            <a class="buybtn"
               href="https://www.iobit.com/buy.php?product=<?php echo $buyTag; ?>&ref=<?php echo $refStr; ?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_ascu"
               onclick="ga('send', 'event', 'ascubuy', 'buy', 'ascupurchase');">
              <i></i>
              Activate Now
            </a>
          </dd>
...
<div class="floatlayer">
  <div class="wrapper">
    ...
    <dl>
      ...
      <dd>
        <!-- buybtn -->
        <a class="buybtn floatbtn yellow"
           href="https://www.iobit.com/buy.php?product=<?php echo $buyTag; ?>&ref=<?php echo $refStr; ?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_ascu"
           onclick="ga('send', 'event', 'ascubuy', 'buy', 'ascupurchase');">
          <i></i>
