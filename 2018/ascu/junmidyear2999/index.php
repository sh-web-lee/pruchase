...
$discountListArr = array(
  // 折扣比例、价格、购买链接标签
  '6m' => array('90', '$9.99', 'ascu11pf-6m'), // 到期大于6个月 pro2
  '6' => array('85', '$12.99', 'ascu11pf-6'), // 到期小于6个月 pro1
  'default' => array('70', '$29.99', 'ascu11pf'),
  'title' => array(
    'um10trial' => array(
...
<script type="text/javascript">
  ...
  if(lan=='sv'){
    window.location.replace('http://purchase.iobit.com/sv/ascu/index.php');
  }
function getDiscountInfo(codeType){
  $.ajax({
    ...
    success : function(discount) {
      ...
      buyUrl = 'http://www.iobit.com/buy.php?product='+discountArr[2]+'&ref=<?php echo $refStr; ?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_ascu&tw='+tw;
...
<script type="text/javascript" src="<?php echo $pRootUrl; ?>tpl/js/stats.js"></script>
  ...
  <div class="header">
    <div class="wrapper">
      ...
      <h2>
        ...
        Left to Get <span class="percent"><?php echo $discount; ?></span>% OFF & Free Gifts
      </h2>
        ...
        <div class="infor fr">
          ...
          <dl>
            <dt>
              ...
              <strong class="infor-price price"><?php echo $price; ?></strong>
              <span class="original">
  ...
  <div class="wrapper main">
    ...
    <div class="descrip clearfix">
      ...
      <dl class="handle fr">
        <dt>
          Only <strong  class="price"><?php echo $price; ?></strong> <del>$109.93</del>
        </dt>
        <dd>
          <a class="buybtn" href="https://www.iobit.com/buy.php?product=<?php echo $buyTag; ?>&ref=<?php echo $refStr; ?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_ascu"  onclick="ga('send', 'event', 'ascubuy', 'buy', 'ascupurchase');">
            <i></i>
  ...
  <div class="floatlayer">
    <div class="wrapper">
      ...
      <dl>
        <dt>Only <strong class="price"><?php echo $price; ?></strong> <del>$109.93</del></dt>
        <dd>
