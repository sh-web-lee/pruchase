  ...
  <div class="wrapper">
    ...
    <div class="panel clearfix">
      ...
      <div class="infor fr">
        ...
        <dl>
          <dt>
            <b class="price-small">$</b><strong class="infor-price price">9</strong><b class="price-small">.99</b>
            <span class="original">
                Original: <del>$109.93</del>
              </span>
          </dt>
          <dd>
            <a class="buybtn inforbtn" href="https://www.iobit.com/buy.php?product=ascu12pf-6m&ref=<?php echo $ref; ?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_ascu"  onclick="ga('send', 'event', 'ascubuy', 'buy', 'ascupurchase-999');">
              <i></i>
...
<div class="wrapper main">
  ...
  <div class="descrip clearfix">
    ...
    <dl class="handle fr">
      <dt>
        Only <b class="price-small">$</b><strong  class="price">9</strong><b class="price-small">.99</b> <del>$109.93</del>
      </dt>
      <dd>
        <a class="buybtn descripbtn" href="https://www.iobit.com/buy.php?product=ascu12pf-6m&ref=<?php echo $ref; ?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_ascu"  onclick="ga('send', 'event', 'ascubuy', 'buy', 'ascupurchase-999');">
          <i></i>
...
<div class="floatlayer">
  <div class="wrapper">
    ...
    <dl>
      <dt>Only <b class="price-small">$</b><strong class="price">9</strong><b class="price-small">.99</b> <del>$109.93</del></dt>
      <dd>
        <a class="buybtn floatbtn yellow" href="https://www.iobit.com/buy.php?product=ascu12pf-6m&ref=<?php echo $ref; ?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_ascu"  onclick="ga('send', 'event', 'ascubuy', 'buy', 'ascupurchase-999');">
          <i></i>
          <span>Activate Now</span>
        </a>
      </dd>
