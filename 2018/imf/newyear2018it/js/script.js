...
function soldoutGift() {
  ...
  $(".gift-message .buy-btn a").attr('href',"https://www.iobit.com/buy.php?product=it-imf63pcpf1999&ref=it_imf63pcpf1999purchase1711"+refStr+"&refs=it_purchase_imf");
}
function onePc() {
  $(".bottom-buy .buybtn").attr("href","https://www.iobit.com/buy.php?product=it-imf61pc1799&ref=it_imf61pc1799purchase1711"+refStr+"&refs=it_purchase_imf");
  $(".bottom-buy dl del").html("€39,95");
  $(".bottom-buy dl strong span").html("17,99");
...
function threePc() {
  $(".bottom-buy .buybtn").attr("href","https://www.iobit.com/buy.php?product=it-imf63pcpf1999&ref=it_imf63pcpf1999purchase1711"+refStr+"&refs=it_purchase_imf");
...
function threePcAndGift() {
  $(".bottom-buy .buybtn").attr("href","https://www.iobit.com/buy.php?product=it-imf63pcsdiupf1999&ref=it_imf63pcsdiupf1999purchase1711"+refStr+"&refs=it_purchase_imf");
