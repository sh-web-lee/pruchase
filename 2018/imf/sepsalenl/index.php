  ...
  <div class="banner">
    <div class="wrapper clearfix">
      ...
      <div class="offer offer3 fl">
        ...
        <!-- offer3 buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=nl-imf81pc1999&ref=nl_imf81pc1999purchase1809<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=nl_purchase_imf"
           onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase1809c-nl')">
          <i></i>
          <span>BESTEL NU</span>
        </a>
      </div>
      ...
      <div class="offer offer1 fl">
        ...
        <!-- offer1 buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=nl_imf83pcpf2199&ref=nl_imf83pcpf2199purchase1809<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=nl_purchase_imf"
           onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase1809a-nl')">
          <i></i>
          <span>BESTEL NU</span>
        </a>
      </div>
      ...
      <div class="offer offer2 fr">
        ...
        <!-- offer2 buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=nl-imf83pc2199&ref=nl_imf83pc2199purchase1809<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=nl_purchase_imf"
           onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase1809b-nl')">
          <i></i>
          <span>BESTEL NU</span>
        </a>
      </div>
...
<!--      <img src="--><?php //echo $pResUrl;?><!--images/awards.png" alt="">-->
      <h2>Bekend uit de ComputerIdee en andere gerenommeerde media</h2>
      <!-- magazine -->
      <div class="magazine clearfix">
        <img class="fl" src="<?php echo $pResUrl;?>images/magazine.png" alt="">
        <p class="fr">
          <img src="<?php echo $pResUrl;?>images/idea.png" alt="">
          <span>“De Kluis beschermt bestanden extra tegen malafide programma’s. Daarnaast is de bescherming tegen cryptominers verbeterd en wordt de bootsector beschermt tegen ransomware die zich hier specifiek op richt. Het uitvoeren van virusscans gaat sneller dan voorheen, maar is nog net zo grondig!”</span>
        </p>
      </div>
      <!-- content -->
      <div class="content">
      ...
      <tbody>
        ...
        <tr>
          <td>
            ...
            <span class="two">Herken nieuwe virusvarianten met behulp van de nieuwe Heuristiek-methode die onbekende <br>
              virussen detecteert op basis van kennis over bekende virussen <span class="nieuw">Nieuw</span></span>
          </td>
          <td class="space"></td>
          <td class="width240"></td>
          <td class="space"></td>
        ...
        <tr>
          <td>
            ...
            <span class="two">Krachtige Anti-ransomware Engine die voorkomt dat uw computer vergrendeld <br>
              wordt door criminelen<span class="verbeterd">verbeterd</span></span>
          </td>
          <td class="space"></td>
          <td class="width240"></td>
          <td class="space"></td>
        ...
        <tr>
          <td>
            ...
            <span class="two">Extra bescherming tegen ransomware-aanvallen voor uw belangrijke bestanden <br>
              en gevoelige gegevens<span class="nieuw">Nieuw</span></span>
          </td>
          <td class="space"></td>
          <td class="width240"></td>
          <td class="space"></td>
  ...
  <div class="bottombuy">
    <div class="wrapper clearfix">
      ...
      <ul class="option fl clearfix">
        <!-- IMF 3PC|1YEAR & PF -->
        <li class="active"
            data-url="https://www.iobit.com/buy.php?product=nl_imf83pcpf2199&ref=nl_imf83pcpf2199purchase1809<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=nl_purchase_imf&tw=-8"
            data-ga="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase1809a-nl')"
            data-price="€21,99"
            data-del="€119,94">
        ...
        <!-- IMF 3PC|1YEAR -->
        <li
            data-url="https://www.iobit.com/buy.php?product=nl-imf83pc2199&ref=nl_imf83pc2199purchase1809<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=nl_purchase_imf&tw=-8"
            data-ga="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase1809b-nl')"
            data-price="€21,99"
            data-del="€79,99">
        ...
        <!-- IMF 1PC|1YEAR -->
        <li
            data-url="https://www.iobit.com/buy.php?product=nl-imf81pc1999&ref=nl_imf81pc1999purchase1809<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=nl_purchase_imf&tw=-8"
            data-ga="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase1809c-nl')"
            data-price="€19.99"
            data-del="€39,95">
      ...
      <div class="bottombuy-message fr">
        <p class="price price00"><span>€21,99</span></p>
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=nl_imf83pcpf2199&ref=nl_imf83pcpf2199purchase1809<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=nl_purchase_imf"
           onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase1809a-nl')">
          <i></i>
