...
<body>
			...
			<!-- header -->
				...
				<div class="stage before active">
					...
					<div class="details">
						...
						<dl class="checkout">
							...
							<dd><a href="https://www.iobit.com/buy.php?product=imf73pcpfamc2599&ref=imf3pcpfamcb<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase-201905');" class="checkbtn large buylink">Activate Now</a></dd>
				...
				<div class="extra single">
					...
					<dl class="checkout">
						...
						<dd><a href="https://www.iobit.com/buy.php?product=imf71pc&ref=imf1pcb<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase-2019051pcx');" class="checkbtn middle link1pc buylink">Activate Now</a></dd>
					</dl>
				</div>
				<div class="extra family-pack">
					...
					<dl class="checkout">
						...
						<dd><a href="https://www.iobit.com/buy.php?product=imf73pc&ref=imf3pcb<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase-2019053pc');" class="checkbtn middle buylink">Activate Now</a></dd>
					</dl>
				</div>
			...
			<tr>
				...
				<th class="item-pro">
					...
					<dl>
						...
						<dd><a href="https://www.iobit.com/buy.php?product=imf73pcpfamc2599&ref=imf3pcpfamcb<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase-201905');" class="checkbtn small link3pc buylink">Activate Now</a></dd>
					</dl>
				</th>
			</tr>
			</thead>
	...
	<!-- float -->
	<div class="float">
		<a href="https://www.iobit.com/buy.php?product=imf73pcpfamc2599&ref=imf3pcpfamcb<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase-201905');" class="buylink">
			<div class="inner">
