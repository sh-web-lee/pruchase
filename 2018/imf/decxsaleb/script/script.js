...
function change() {
	...
	var packs = '<div class="packs">' +
		'<div class="info">' +
		'<h2>IObit Malware Fighter 7 PRO Valuable Birthday Pack</h2>' +
	...
	var details = '<div class="details">' +
		'<div class="info">' +
		'<h3>New Launch Pack Sold Out!</h3>' +
		'<dl>' +
	...
	var new3pc = "https://www.iobit.com/buy.php?product=imf73pc&ref=imf3pcab"+refStr+"&aff=" + aff + "&refs=purchase_imf&tw=" + tw;
	var new3pcStat = "ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase-2019053pca');"
	var new1pc = "https://www.iobit.com/buy.php?product=imf71pc&ref=imf1pcab"+refStr+"&aff=" + aff + "&refs=purchase_imf&tw=" + tw;
	var new1pcStat = "ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase-2019051pca');"
