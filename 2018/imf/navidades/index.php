...
<head>
  ...
  <title>Hasta 85% de descuento y regalos de navidad para IObit Malware Fighter PRO – IObit</title>
...
<div class="banner">
  <div class="wrapper">
    ...
    <!-- title -->
    <h1> Súper oferta de navidad  Cantidades limitadas, sólo una vez al año</h1>
    <div class="panel clearfix">
      <div class="box small">
        ...
        <!-- 1pc buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=es-imf61pc1799&ref=es_imf61pcpurchase1812<?php echo $refStr;?>&refs=es_purchase_imf"
           onclick="ga('send', 'event', 'imfbuy', 'buy', 'imf1pcpurchase1812-es')">
      ...
      <div class="box">
        ...
        <p><strong>19</strong><span><b>99</b> <del class="original">149,88€</del></span></p>
        <!-- 3pc buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=es-imf63pcpfsdamc1999&ref=es_imf63pcpfsdamcpurchase1812<?php echo $refStr;?>&refs=es_purchase_imf"
           onclick="ga('send', 'event', 'imfbuy', 'buy', 'imf3pcpurchase1812-es')">
          <i></i> <span>Comprar ahora</span>
        </a>
        <p class="bought">
  ...
  <div class="wrapper clearfix">
    ...
    <div class="right-lists">
      <ul>
        ...
        <li class="icon3"> Limpia automáticamente el rastreo de navegación<br>
          para evitar el seguimiento malicioso.
        </li>
  ...
  <div class="wrapper">
    ...
    <div class="right-message">
      ...
      <div class="box">
        ...
        <h3><i></i>AMC Security PRO</h3>
        <p>Limpiador y amplificador todo en uno para dispositivos Android.</p>
      </div>
    </div>
  </div>
</div>
...
<div class="between-buy">
  <div class="wrapper">
    <p class="price"><strong>19,99€ </strong> <del>149,88€</del></p>
    <!-- 3pc buybtn -->
    <a href="https://www.iobit.com/buy.php?product=es-imf63pcpfsdamc1999&ref=es_imf63pcpfsdamcpurchase1812<?php echo $refStr;?>&refs=es_purchase_imf"
       onclick="ga('send', 'event', 'imfbuy', 'buy', 'imf3pcpurchase1812-es')" class="buybtn">
      <i></i>
  ...
  <table border="0" cellspacing="0" cellpadding="0" width="100%">
    ...
    <tr>
      ...
      <th class="itemb">
        ...
        <del> 39,95€</del>
        <!-- 1pc buybtn -->
        <a href="https://www.iobit.com/buy.php?product=es-imf61pc1799&ref=es_imf61pcpurchase1812<?php echo $refStr;?>&refs=es_purchase_imf"
           onclick="ga('send', 'event', 'imfbuy', 'buy', 'imf1pcpurchase1812-es')"
           class="buybtn">
          Comprar ahora
        </a>
    ...
    <tr>
      ...
      <td class="virtue">Protección avanzada contra amenazas con motor<br>
        antivirus Bitdefender <sup class="improved">MEJORADO</sup></td>
    ...
    <tr>
      ...
      <td class="virtue">Nuevo Motor Anti-ransomware para bloquear Accesos<br>
        no Autorizados	 <sup class="new">NUEVO</sup></td>
      <td class="itemb"><img src="<?php echo $pResUrl; ?>images/greyerror.png"></td>
      <td class="itema"><img src="<?php echo $pResUrl; ?>images/redmark.png"></td>
      <td class="itemb"><img src="<?php echo $pResUrl; ?>images/redmark.png"></td>
    </tr>
    ...
    <tr>
      ...
      <td class="virtue">Archivos Específicos Protegidos contra Accesos no<br>
        Autorizados en Caja Fuerte  <sup class="new">NUEVO</sup></td>
      <td class="itemb"><img src="<?php echo $pResUrl; ?>images/greyerror.png"></td>
      <td class="itema"><img src="<?php echo $pResUrl; ?>images/redmark.png"></td>
      <td class="itemb"><img src="<?php echo $pResUrl; ?>images/redmark.png"></td>
    </tr>
    ...
    <tr>
      ...
      <td class="virtue">Protege tu cámara contra el acceso no autorizado <sup class="new">NUEVO</sup></td>
      <td class="itemb"><img src="<?php echo $pResUrl; ?>images/greyerror.png"></td>
      <td class="itema"><img src="<?php echo $pResUrl; ?>images/redmark.png"></td>
      <td class="itemb"><img src="<?php echo $pResUrl; ?>images/redmark.png"></td>
    </tr>
