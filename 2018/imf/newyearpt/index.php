...
<head>
  ...
  <title>Adquira IObit Malware Fighter 6 Pro com 70% de desconto e leve um super brinde para proteger suas pastas importantes. Oferta Especial de Ano Novo da IObit.</title>
...
<div class="banner">
  <div class="wrapper">
    ...
    <h1>
      ...
      <span>Tempo limitado, Apenas uma Vez no Ano!</span>
    </h1>
    <!-- banner-content -->
    <div class="banner-content">
      ...
      <div class="banner-right fr">
        ...
        <!-- buybtn -->
        <a class="buy-btn"
           href="https://www.iobit.com/buy.php?product=pt-imf63pcpf6999&ref=pt_imf63pcpfpurchase1812<?php echo $refStr;?>&refs=pt_purchase_imf"
           onclick="ga('send', 'event', 'imfbuy', 'buy', 'imf6purchase1812-pt')">
          COMPRAR AGORA
        </a>
