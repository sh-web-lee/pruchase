...
<head>
	<meta charset="UTF-8">
	<title>Bespaar 85% op Volledige Online Bescherming met de Kluis - IObit Malware Fighter </title>
...
<body>
	...
	<div class="banner">
		<div class="wrapper">
			...
			<h1>De Kluis: Geen Toegang Zonder Wachtwoord</h1>
			<h2>Eenvoudige maar krachtige bescherming voor uw persoonlijke bestanden</h2>
			<div class="left-img">
			...
			<div class="right-message">
				<div class="box">
					...
					<dl class="price">
						<dt>
							 Slechts <strong>€21,99</strong> <del>€139,93</del>
						</dt>
						<dd><a href="https://www.iobit.com/buy.php?product=nl-imf7amcpf2199&ref=nl_imfsb<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=nl_purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase1804c-nl');" class="buybtn"><i></i> Activeer Nu</a></dd>
					</dl>
				</div>
	...
	<div class="cruces">
		<div class="wrapper clearfix">
			...
			<ul>
				<li>
					<h3>Waarom Belangrijke Bestanden Beschermen? </h3>
					<p>Hackers kunnen gemakkelijk uw identiteit stelen als ze zich toegang verschaffen tot uw persoonlijk bestanden, zoals uw financiële gegevens. Bovendien kan bedrijfsgevoelige informatie die op uw computer staat, openbaar worden gemaakt om uw bedrijf te saboteren.</p>
				</li>
				<li class="last">
					<h3>Pas op voor ransomware!</h3>
					<p>Naast identiteitsfraude en diefstal van gegevens, zijn ransomware-aanvallen een steeds meer voorkomend probleem waar u zich bewust van moet zijn. Hackers versleutelen uw belangrijke bestanden en eisen geld. Miljoenen organisaties en particulieren zijn afgelopen jaar slachtoffer geworden van de beruchte WannaCry en Petya ransomware.</p>
				</li>
			</ul>
		</div>
	</div>
	...
	<div class="db-message wrapper">
		<h2>Krachtige Bescherming van uw Bestanden d.m.v. een Wachtwoord</h2>
		<p>Met IObit Malware Fighter 7 PRO kunt u belangrijke bestanden afzonderlijk beschermen met een wachtwoord, om alle ongewenste toegang te blokkeren.</p>
		<div class="message-box">
			<dl class="list01">
				<dt>Privacy Schild</dt>
				<dd>Scherm uw belangrijke bestanden zoals persoonlijke informatie en uw financiën af van andere bestanden zodat niemand er zonder toestemming bij kan. </dd>
			</dl>
			<dl class="list02">
				<dt>Geen ransomware-aanvallen</dt>
				<dd>Als bestanden in de Kluis zitten, kan geen hacker erbij. Ransomware kan deze bestanden dan ook niet versleutelen.</dd>
			</dl>
