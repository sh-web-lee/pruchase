...
<head>
	<meta charset="UTF-8">
	<title>Bespaar 85% op Volledige Online Bescherming met de Bitdefender Engine - IObit Malware Fighter</title>
...
<body>
	...
	<div class="banner">
		<div class="wrapper">
			...
			<h1>Bitdefender Engine: Bescherming van de Hoogste Klasse</h1>
			<h2>Bescherm uw pc tegen meer dan 200 miljoen bedreigingen</h2>
			<div class="left-img">
			...
			<div class="right-message">
				<div class="box">
					...
					<dl class="price">
						...
						<dd><a href="https://www.iobit.com/buy.php?product=nl-imf8amcpf2199&ref=nl_imfbdengine<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=nl_purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase1804d-nl');" class="buybtn"><i></i> Activeer Nu</a></dd>
					</dl>
				</div>
	...
	<div class="cruces">
		<div class="wrapper clearfix">
			...
			<ul class="clearfix">
				<li>
					<h3>Malware is overal! </h3>
					<p>Het internet is in toenemende mate een gevaarlijke plek. Tal van nieuwe malware zoals, virussen, wormen, spyware, adware en Trojans proberen elke dag uw computer binnen te dringen.</p>
				</li>
				<li class="last">
					<h3>Ernstige gevolgen bij infectie</h3>
					<p>Zulke malware kan persoonlijke, financiële of bedrijfsinformatie die op uw computer staat, stelen.</p>
				</li>
			</ul>
		</div>
	</div>
	...
	<div class="db-message wrapper">
		<h2>Krachtige PC-bescherming met de Nieuwste Bitdefender Engine</h2>
		<p>Met de laatste versie van de Bitdefender engine, beschermt IObit Malware Fighter u tegen meer dan 209.000.000 bedreigingen.</p>
		<div class="message-box">
			<dl class="list01">
				<dt>Up-to-date Database</dt>
				<dd>Nieuwe malware wordt constant toegevoegd aan de Bitdefender database om te garanderen dat uw computer beschermd is tegen deze schadelijke infecties. </dd>
			</dl>
			<dl class="list02">
				<dt>Real-time Bescherming</dt>
				<dd>Als Bitdefender engine is ingeschakeld, wordt uw computer volledig beschermd in real-time. Bedreigingen die binnen proberen te dringen worden direct geblokkeerd of verwijderd.</dd>
			</dl>
