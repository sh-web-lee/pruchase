...
<head>
	<meta charset="UTF-8">
	<title>73% RABATT för att skydda datorn från Skadliga Program & Virus- IObit Malware Fighter 7 Ny Specialutgåva | IObit </title>
...
<body>
	...
	<div class="banner">
		<div class="wrapper">
			...
			<h1>Bitdefender Motor: Topp datorsäkerhet för dig</h1>
			<h2>Skydda din dator mot över 200 miljoner hot</h2>
			<div class="left-img">
			...
			<div class="right-message">
				<div class="box">
					...
					<dl class="price">
						...
						<dd><a href="https://www.iobit.com/buy.php?product=sv-imf73pcpfamc329&ref=sv_imfbdengine3pcpfamc1804<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=sv_purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase-bdengine-sv');" class="buybtn"><i></i> Aktivera Nu</a></dd>
					</dl>
				</div>
	...
	<div class="cruces">
		<div class="wrapper clearfix">
			<h2>Saker som du måste veta</h2>
			<ul>
				<li>
					<h3>Skadliga program finns överallt!</h3>
					<p>Internet är en ökande farlig plats. Flertal nya skadliga program inkluderat virus, maskar, spionprogram, reklamprogram och trojaner dyker upp dagligen för att försöka skada din dator.</p>
				</li>
				<li class="last">
					<h3>Allvarliga följder om din dator blir infekterad</h3>
					<p>Om din dator har blivit attackerad, kan dessa skadliga program stjäla personliga, finansiella eller företagsinformation från din dator.</p>
				</li>
			</ul>
		</div>
	</div>
	...
	<div class="db-message wrapper">
		<h2>Starkt skydd för din dator med den senaste Bitdefender Motorn</h2>
		<p>IObit Malware Fighter 7 PRO är utrustat med den senaste Bitdefender antivirusmotorn och hindrar över 203.000.000 säkerhetshot från att skada din dator.</p>
		<div class="message-box">
			<dl class="list01">
				<dt>Aktuell Databas</dt>
				<dd>Nya skadliga program blir kontinuerligt tillagda till Bitdefender databas för att se till att din dator är säker från dessa skadliga infektioner.</dd>
			</dl>
			<dl class="list02">
				<dt>Realtidsskydd</dt>
				<dd>När Bitdefender motorn är aktiverad blir din dator helt skyddad I realtid. Eventuella hot som försöker bryta sig in blockeras eller tas bort omedelbart.</dd>
			</dl>
	...
	<div class="gift-message">
		<div class="wrapper">
			...
			<h3>Få 2 extra skyddsverktyg (värda 498 kr) GRATIS</h3>
			<dl>
				<dt>
