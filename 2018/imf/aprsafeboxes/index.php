...
<head>
	<meta charset="UTF-8">
	<title>-85% para doble protección de tus archivos importantes - IObit Malware Fighter 8 | IObit</title>
...
<body>
	...
	<div class="banner">
		<div class="wrapper">
			...
			<h1>Caja Fuerte: Sin contraseña, sin acceso</h1>
			<h2>Protección simple y potente para tus datos personales</h2>
			<div class="left-img">
			...
			<div class="right-message">
				<div class="box">
					...
					<dl class="price">
						...
						<dd><a href="https://www.iobit.com/buy.php?product=es-imf83pcpfsd1999&ref=es_imfsb3pcpfsd1804<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=es_purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase-safebox1804-es');" class="buybtn"><i></i> Activar Ahora</a></dd>
					</dl>
				</div>
	...
	<div class="cruces">
		<div class="wrapper clearfix">
			...
			<ul>
				<li class="first">
					<h3>¿Por qué proteger archivos importantes ? </h3>
					<p>Usuarios desconocidos pueden robar tu identidad cibernética fácilmente , como por ejemplo, historial financiero y otros archivos importantes.  Archivos confidenciales pueden ser encriptados y arruinar tu negocio, por esta razón es imperativo protegerlos.   </p>
				</li>
				<li class="last">
					<h3>¡Ojo con el ransomware!</h3>
					<p>A parte de los robos de información, debe de preocuparse de los ataques ransomware, ya que han incrementado con el pasar de los últimos dos años. Los piratas cibernéticos, encriptan y bloquean el uso de archivos fundamentales para así solicitar un monto de dinero para liberarlos. Los casos de WannaCry y Petya han afectado a millones de organizaciones y usuarios personales. </p>
				</li>
			</ul>
		</div>
	</div>
	...
	<div class="db-message wrapper">
		<h2>Protección eficaz con contraseña para tus datos personales</h2>
		<p>IObit Malware Fighter PRO permite mantener archivos importantes por separado con  contraseñ para evitar cualquier tipo de acceso no autorizado.</p>
		<div class="message-box">
			<dl class="list01">
				<dt>Escudo de privacidad</dt>
				<dd>Puedes mantener tus archivos importantes como tu información personal y archivos financieros separados de otros archivos. Nadie podrá acceder a ellos sin permiso.</dd>
			</dl>
			<dl class="list02">
				<dt>Sin ataques de ransomware</dt>
				<dd>Una vez que los archivos se añaden a la Caja Fuerte, pasarán a estar fuera del alcance de los hackers. Ataques de ransomware tampoco podrán cifrar estos archivos.  </dd>
			</dl>
