...
<head>
	<meta charset="UTF-8">
	<title>82% OFF to Get All-round Protection -  New Released IObit Malware Fighter 6 | IObit</title>
...
<body>
					...
					<dl class="message">
						<dt>
	      				...
	      				Security Packs Left Today! 
							...
							<span>  Whole Year Protection for 3 PCs</span> <del>599 kr</del>
						</dt>
						<dd>
							<span><i></i> Protected Folder</span> <del>435 kr</del><em>  Free</em>
						</dd>
						<dd>
							<span><i></i> AMC Security PRO </span> <del>379 kr</del><em>  Free</em>
						</dd>
					</dl>
					<dl class="price">
						<dt>
							 Only <strong>249 kr</strong> <del> 1,413 kr</del>
						</dt>
						<dd><a href="https://www.iobit.com/buy.php?product=dk-imf6amcpf249&ref=dk_imfcg3pcpfamc1804&aff=<?php echo $_GET['aff']; ?>&refs=dk_purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase-cameraguard-dk');" class="buybtn"><i></i> Activate Now</a></dd>
					</dl>
				</div>
	...
	<div class="gift-message">
		<div class="wrapper">
			...
			<h3>  Get 2 Extra Protection Tools (valued at $39.94) for FREE</h3>
			<dl>
				<dt>
					<img src="<?php echo getStaticUrl('images/pf-box.png')?>" alt="">
				</dt>
				<dd>
					<strong>Protected Folder</strong> <del> 435 kr </del> (1 Y / 1 PC)
				</dd>
			...
			<dl>
				...
				<dd>
					<strong>AMC Security PRO</strong> <del> 379 kr</del> (1 Y / 1 device)
				</dd>
