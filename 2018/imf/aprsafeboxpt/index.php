...
<head>
	<meta charset="UTF-8">
	<title>Economize 75% para Proteção Dupla para Seus Arquivos Importantes - IObit Malware Fighter 7 Oferta Especial de Lançamento | IObit</title>
...
<body>
			...
			<div class="right-message">
				<div class="box">
					...
					<dl class="price">
						...
						<dd><a href="https://www.iobit.com/buy.php?product=pt-imf73pcpfamc6999&ref=pt_imfsb<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=pt_purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase-safebox-pt');" class="buybtn"><i></i> Ativar Agora</a></dd>
					</dl>
				</div>
	...
	<div class="cruces">
		<div class="wrapper clearfix">
			...
			<ul>
				<li>
					<h3>Por que Proteger Arquivos Importantes?</h3>
					<p>Hackers podem roubar sua identidade ao obter acesso a seus arquivos pessoais como relatórios financeiros e outros arquivos importantes e você pode ver suas informações pessoais expostas na internet ou usadas por criminosos. </p>
				</li>
				<li class="last">
					<h3>Cuidado com ransomware!</h3>
					<p>Você também deve estar alerta com o número crescente de ataques de ransomware. Ransomware é um tipo de ataque onde hackers criptografam seus arquivos importante e pedem por dinheiro como resgate. No ano passado, os ransomware WannaCry e Petya afetaram milhões de usuários domésticos e organizações.</p>
				</li>
			</ul>
		</div>
	</div>
	...
	<div class="db-message wrapper">
		<h2>Proteção Poderosa dos seus Dados Pessoais com Senha</h2>
		<p>IObit Malware Fighter 7 PRO permite que você mantenha seus arquivos importantes separados com senha para evitar qualquer tipo de acesso não-autorizado.</p>
		<div class="message-box">
			<dl class="list01">
				<dt>Mantém seus Arquivos Seguros</dt>
				<dd>Arquivos importantes são mantidos separados no Cofre para evitar que sejam alvo de ataques maliciosos.</dd>
			</dl>
			<dl class="list02">
				<dt>Sem Ataques de Ransomware</dt>
				<dd>Quando os arquivos são adicionados ao Cofre, eles estão fora do alcance de hackers. É impossível que Ransomware criptografe os arquivos no Cofre. </dd>
			</dl>
