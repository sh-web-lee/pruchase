...
<head>
	<meta charset="UTF-8">
	<title>Save up to 73% OFF on IMF PRO. Black Friday Exclusive Discount - IObit</title>
...
<body>
			...
			<!-- header -->
				...
				<div class="stage before active">
					...
					<div class="details">
						...
						<dl class="checkout">
							...
							<dd><a href="https://www.iobit.com/buy.php?product=imf63pcpfamc2599&ref=imf3pcpfamc<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase-imf6');" class="checkbtn large buylink">Activate Now</a></dd>
				...
				<div class="extra single">
					...
					<dl class="checkout">
						...
						<dd><a href="https://www.iobit.com/buy.php?product=imf61pc&ref=imf1pc<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase-imf61pc');" class="checkbtn middle link1pc buylink">Activate Now</a></dd>
					</dl>
				</div>
				<div class="extra family-pack">
					...
					<dl class="checkout">
						...
						<dd><a href="https://www.iobit.com/buy.php?product=imf63pc&ref=imf3pc<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase-imf63pc');" class="checkbtn middle buylink">Activate Now</a></dd>
					</dl>
				</div>
	...
	<div class="gift-pack">
		<div class="wrapper">
			<h2>​IObit Malware Fighter 6 PRO Black Friday Pack Includes​</h2>
			<div class="container clearfix">
				<ul>
			...
			<tr>
				...
				<th class="item-pro">
					...
					<dl>
						...
						<dd><a href="https://www.iobit.com/buy.php?product=imf63pcpfamc2599&ref=imf3pcpfamc<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase-imf6');" class="checkbtn small link3pc buylink">Activate Now</a></dd>
					</dl>
				</th>
			</tr>
			</thead>
	    ...
	    <div class="service clearfix">
	      <dl class="fl">
	        ...
	        <dd>
	          ...
	          <p>We’re confident that activating PRO edition will ensure your PC security <br> for affordable price!</p>
	        </dd>
	      </dl>
	      <dl class="fr">
	        <dd>
	...
	<!-- float -->
	<div class="float">
		<a href="https://www.iobit.com/buy.php?product=imf63pcpfamc2599&ref=imf3pcpfamc<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase-imf6');" class="buylink">
			<div class="inner">
