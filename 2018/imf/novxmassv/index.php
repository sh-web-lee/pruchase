...
<div class="banner">
  <div class="wrapper">
    ...
    <div class="title">
      ...
      <p>Exklusiva gåvor ENDAST under denna jul! Bara några få paket kvar!</p>
    </div>
    <div class="panel clearfix">
      <div class="box small">
        ...
        <a class="buybtn" href="https://www.iobit.com/buy.php?product=sv-imf61pc249&ref=sv_imf61pcpurchase1811<?php echo $refStr;?>&refs=sv_purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imf1pcpurchase1811-sv');">
      ...
      <div class="box">
        ...
        <a class="buybtn" href="https://www.iobit.com/buy.php?product=sv-imf63pcpfsdamc329&ref=sv_imf63pcpfsdamcpurchase1811<?php echo $refStr;?>&refs=sv_purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imf3pcpurchase1811-sv');">
          <i></i> <span>KÖP NU</span>
        </a>
        <p class="bought">
  ...
  <div class="wrapper clearfix">
    ...
    <div class="right-lists">
      ...
      <dl>
        ...
        <dd>SafeBoxskyddardinamarkerademapparfrånickeauktoriserad<br>tillgång&senaste hot</dd>
      </dl>
