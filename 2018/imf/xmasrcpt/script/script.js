...
function reduceNum(num, numRe) {
  ...
  setTimeout('$(".progressbar span .reduce").remove();', 1500);
  if (numRe == 1) {
    setTimeout(function() {
      flipNum(num, 2);
    }, 100);
...
function maskFirst() {
  ...
  $('.main').append('<div class="mask"></div><div class="mask-box"><h2>SURPRESA!! Feliz Natal</h2><div class="clearfix"><div class="fl left"><img src="' + imgSrc + '" alt="Advanced SystemCare 12 Pro"/></div><div class="price fl"><h3><b>R$ 4</b>  extra de desconto pra você!</h3><p><strong><big>R$</big>55<big>, </big></strong><span>99</span></p><p class="pcs"><b>1 ano / 3 PCs</b></p> <a class="buybtn" href="' + _href + '" onclick="' + _ga + '">Ativar Agora</a></div></div><p class="year">Sua última chance de aproveitar o preço mais baixo da história!</p></div>');
}
...
function packsInit() {
  ...
  packs = Math.ceil(timeDiff / 4) > 0 ? Math.ceil(timeDiff / 4) : 0;
  reduceNum(packs, 1);
...
function getSales() {
  ...
  var nowTime = Math.floor(date.getTime() / 1000);
  var timeDiff = countTime - nowTime;
  var packsNow = Math.ceil(timeDiff / 4) > 0 ? Math.ceil(timeDiff / 4) : 0;
  if (packsNow != packs) {
    if (statusCheck() == 2) {
      packs = 0;
    } else {
