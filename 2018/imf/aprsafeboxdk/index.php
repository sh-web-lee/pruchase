...
<body>
	...
	<div class="banner">
		<div class="wrapper">
			...
			<h1>Safe Box: Ingen kodeord, ingen adgang </h1>
			<h2>Simpel men kraftfuld beskyttelse af dine personlige data  </h2>
			<div class="left-img">
			...
			<div class="right-message">
				<div class="box">
					...
					<dl class="price">
						...
						<dd><a href="https://www.iobit.com/buy.php?product=dk-imf8amcpf199&ref=dk_imfsb3pcpfamc1904<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=dk_purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase-safebox-dk');" class="buybtn"><i></i> Aktiver nu</a></dd>
					</dl>
				</div>
	...
	<div class="cruces">
		<div class="wrapper clearfix">
			...
			<ul>
				<li>
					<h3>Hvorfor beskytte vigtige filer?</h3>
					<p>Hackere derude kan nemt stjæle din identitet, hvis de får adgang til dine personlige filer såsom finansielle poster og andre vigtige filer. Fortrolige forretningsfiler gemt på din computer kan blive røbet og sabotere din forretning. </p>
				</li>
				<li class="last">
					<h3>Pas på ransomware! </h3>
					<p>Udover identitets- og datatyveri, er ransomware-angreb et stigende problem, som du burde være opmærksom på.  Hackere enkrypterer dine vigtige filer for at bede om penge. Berygtede WannaCry og Petya påvirkede millioner af organisationer og private brugere sidste år.</p>
				</li>
			</ul>
		</div>
	</div>
	...
	<div class="db-message wrapper">
		<h2>Kraftfuld kodeordsbeskyttelse for dine personlige data</h2>
		<p>IObit Malware Fighter 8 PRO giver mulighed for at holde dine vigtige filer separate med kodeord for at undgå enhver form for uautoriseret adgang.</p>
		<div class="message-box">
			<dl class="list01">
				<dt>Privacy Shield</dt>
				<dd>Du kan holde dine vigtige filer såsom dine personlige informationer, finansielle filer separate fra andre filer. Ingen kan få adgang til dem uden tilladelse. </dd>
			</dl>
			<dl class="list02">
				<dt>Ingen Ransomware-angreb</dt>
				<dd>Når filer er tilføjet Safe Box, er de uden for hackers rækkevidde. Ransomware vil ikke kunne kryptere disse filer. </dd>
			</dl>
	...
	<div class="feature">
		<div class="wrapper">
			...
			<dl>
				...
				<dd><h3>Bitdefender</h3></dd>
				<dd>Uovervindelig virusbeskyttelse med opgraderet Bitdefender Anti-virus.</dd>
			</dl>
			<dl>
