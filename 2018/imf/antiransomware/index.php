...
<head>
	<meta charset="UTF-8">
	<title>Save 73% to Get Full Online Protection - IObit Malware Fighter 8 New Release Special | IObit</title>
...
<body>
	...
	<div class="banner">
		<div class="wrapper">
			...
			<h1>Anti-ransomware: Stops Attacks, Protects PCs </h1>
			<h2>Keep your important files away from being held as hostage </h2>
			<div class="left-img">
			...
			<div class="right-message">
				<div class="box">
					...
					<dl class="price">
						...
						<dd><a href="https://www.iobit.com/buy.php?product=imf83pciusd2599&ref=en-imf3pciusdar<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase-antiransomware');" class="buybtn"><i></i> Activate Now</a></dd>
					</dl>
				</div>
				<dl class="payment">
	...
	<div class="cruces">
		<div class="wrapper clearfix">
			...
			<ul>
				<li>
					<h3>Ransomware</h3>
					<p>A type of malware attack that infects, encrypts or takes control of a system and demands ransom to regain access. </p>
				</li>
				<li>
					<h3>Your loss once infected</h3>
					<p>Various amount of money; no access to your system and files; possibility of damage on your important and personal file and data; other serious results;</p>
				</li>
				<li class="last">
					<h3>Most notorious ransomware</h3>
					<p>Since the most famous WannaCry attacks, several variants of ransomware such as Petya/GoldenEye, Bad Rabbit have been a growing trend for the past two years. </p>
				</li>
			</ul>
		</div>
	</div>
	...
	<div class="db-message wrapper">
		<h2>Your Comprehensive & Powerful Prevent Solution</h2>
		<p>Anti-ransomware Engine in IObit Malware Fighter 8 PRO will intelligently protect all the files on your pc from unauthorized access.</p>
		<div class="message-box">
			<dl class="list01">
				<dt>Smart Anti-ransomware</dt>
				<dd>We use intelligent analytics to block any untrusted access to your important files before they affect you. </dd>
			</dl>
			<dl class="list02">
				<dt>Large Database</dt>
				<dd>Numerous ransomware variants stored in our database and our smart scan will prevent from hanging, deleting, or encrypting your personal data and files.</dd>
			</dl>
