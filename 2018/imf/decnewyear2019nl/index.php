...
<div class="banner">
  <div class="wrapper">
    ...
    <div class="title">
      ...
      <h2>Ga Voordelig 2019 in met Spectaculaire Kortingen</h2>
    </div>
    <div class="panel clearfix">
      <div class="box small">
        ...
        <!-- 1995 buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=nl-imf61pc1995&ref=nl_imf61pc1995purchase1812<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=nl_purchase_imf"
           onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase1812-nl')">
      ...
      <div class="box">
        ...
        <!-- 2195 buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=nl-imf6amcpf2195&ref=nl_imf6amcpf2195purchase1812<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=nl_purchase_imf"
           onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase1812-nl')">
          <i></i> <span>Profiteer nu</span>
        </a>
        <p class="bought">
...
<div class="container">
  ...
  <div class="between-buy">
    <div class="wrapper">
      ...
      <!-- 2195 buybtn -->
      <a href="https://www.iobit.com/buy.php?product=nl-imf6amcpf2195&ref=nl_imf6amcpf2195purchase1812<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=nl_purchase_imf"
         onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase1812-nl')"
         class="buybtn">
        <i></i>
  ...
  <div class="comparison_table wrapper" id="compare">
    <table border="0" cellspacing="0" cellpadding="0" width="100%">
      <thead>
      <tr>
        <th colspan="2" class="text"><p>Alle voordelen van IObit Malware Fighter PRO in één oogopslag</p></th>
        <th class="space10"></th>
        <th class="itemb"><p>IObit Malware Fighter <br> FREE</p></th>
        <th class="space5"></th>
        <th class="itema"><p>IObit Malware Fighter <br> PRO <img src="<?php echo $pResUrl;?>images/comparison-1pc.png"></p></th>
        <th class="space5"></th>
        <th class="itema"><p>IObit Malware Fighter <br> PRO <img src="<?php echo $pResUrl;?>images/comparison-3pc.png"></p></th>
      </tr>
      </thead>
      <tbody>
      <!-- 01 -->
      ...
      <tr>
        ...
        <td class="virtue">Beveiliging tijdens downloaden & AdBlocker voor een veilige <br> online omgeving <sup>Verbeterd</sup></td>
        <td class="space10"></td>
        <td class="itemb"><img src="<?php echo $pResUrl; ?>images/bluemark.png"></td>
        <td class="space5"></td>
        <td class="itema"><img src="<?php echo $pResUrl; ?>images/redmark.png"></td>
      ...
      <tr>
        ...
        <td class="virtue">Gloednieuwe Anti-ransomware Engine om Verdachte Toegang tot <br> BelangrijkeBestanden te Blokkeren <sup class="red">Nieuw</sup></td>
        <td class="space10"></td>
        <td class="itemb"></td>
        <td class="space5"></td>
        <td class="itema"><img src="<?php echo $pResUrl; ?>images/redmark.png"></td>
      ...
      <tr>
        ...
        <td class="virtue">Bescherm Specifieke Belangrijke Mappen tegen Ongewenste <br> Toegang met de Kluis <sup class="red">Nieuw</sup></td>
        <td class="space10"></td>
        <td class="itemb"></td>
        <td class="space5"></td>
        <td class="itema"><img src="<?php echo $pResUrl; ?>images/redmark.png"></td>
      ...
      <tr>
        ...
        <td class="virtue">Anti-Malware bescherming met de unieke Dual Core Engine <sup>Verbeterd</sup></td>
        <td class="space10"></td>
        <td class="itemb"></td>
        <td class="space5"></td>
        <td class="itema"><img src="<?php echo $pResUrl; ?>images/redmark.png"></td>
      ...
      <tr>
        ...
        <td class="virtue">Opstart Schijfbescherming Tegen Kwaadaardige Aanvallen <br> met MBR Guard <sup>Verbeterd</sup> </td>
        <td class="space10"></td>
        <td class="itemb"></td>
        <td class="space5"></td>
        <td class="itema"><img src="<?php echo $pResUrl; ?>images/redmark.png"></td>
      ...
      <tr>
        ...
        <td class="virtue letter-space">Geavanceerde bescherming in real-time voor ultieme bescherming <sup>Verbeterd</sup></td>
        <td class="space10"></td>
        <td class="itemb"></td>
        <td class="space5"></td>
        <td class="itema"><img src="<?php echo $pResUrl; ?>images/redmark.png"></td>
      ...
      <tr>
        ...
        <th class="space5"></th>
        <th class="itema">
          <span>IMF PRO voor 1 PC</span>
          <strong>€19,95</strong>
          <del>€39,95</del>
          <!-- 1995 buybtn -->
          <a href="https://www.iobit.com/buy.php?product=nl-imf61pc1995&ref=nl_imf61pc1995purchase1812<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=nl_purchase_imf"
             onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase1812-nl')"
            class="buybtn">
            PROFITEER NU
          </a>
        ...
        <th class="space5"></th>
        <th class="itema">
          <span>IMF PRO voor 3 PC’s</span>
          <strong class="red">€21,95</strong>
          <del>€139,93</del>
          <!-- 2195 buybtn -->
          <a href="https://www.iobit.com/buy.php?product=nl-imf6amcpf2195&ref=nl_imf6amcpf2195purchase1812<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=nl_purchase_imf"
             onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase1812-nl')"
