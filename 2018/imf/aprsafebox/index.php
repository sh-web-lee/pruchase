...
<head>
	<meta charset="UTF-8">
	<title>73% OFF to Double-protect Your Important Files - IObit Malware Fighter 8 New Release Special | IObit</title>
...
<body>
	...
	<div class="banner">
		<div class="wrapper">
			...
			<h1>Safe Box: No Password, No Access </h1>
			<h2>Simple yet powerful protection for your personal data  </h2>
			<div class="left-img">
			...
			<div class="right-message">
				<div class="box">
					...
					<dl class="price">
						...
						<dd><a href="https://www.iobit.com/buy.php?product=imf83pciusd2599&ref=en-imf3pciusdsb<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase-safebox');" class="buybtn"><i></i> Activate Now</a></dd>
					</dl>
				</div>
				<dl class="payment">
	...
	<div class="cruces">
		<div class="wrapper clearfix">
			...
			<ul>
				<li>
					<h3>Why protect important files?</h3>
					<p>Snoops out there can easily steal your identity if they gain access to your personal files like financial records and other important files. And confidential business files kept on your computer could be disclosed to sabotage your business. </p>
				</li>
				<li class="last">
					<h3>Watch out ransomware! </h3>
					<p>Besides identity theft and data stealing, ransomware attack is the rising problem you should be aware of. Hackers encrypt your important files to ask for money. Notorious WannaCry and Petya affected millions of organizations & personal users last year.</p>
				</li>
			</ul>
		</div>
	</div>
	...
	<div class="db-message wrapper">
		<h2>Powerful Password Protection for Your Personal Data</h2>
		<p>IObit Malware Fighter 8 PRO allows keeping important files separately with password to avoid any kind of unauthorized access.</p>
		<div class="message-box">
			<dl class="list01">
				<dt>Privacy Shield</dt>
				<dd>You can keep your important files like your personal information, financial files separately from other files. No one can access to them without permission.</dd>
			</dl>
			<dl class="list02">
				<dt>No Ransomware Attacks</dt>
				<dd>Once files are added to Safe Box, they are out of reach to hackers. Ransomware would fail to encrypt these files. </dd>
			</dl>
	...
	<div class="feature">
		<div class="wrapper">
			...
			<dl>
				...
				<dd>Unbeatable virus detection with advanced Bitdefender Engine.</dd>
			</dl>
			<dl>
