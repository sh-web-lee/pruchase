...
<title> Économiser jusqu'à -87% sur IObit Malware Fighter PRO - Vente Flash - IObit</title>
...
<script type="text/javascript" src="<?php echo $pRootUrl; ?>tpl/js/stats.js"></script>
  ...
  <div class="banner">
    <div class="wrapper">
      <h1>2018 Vente Flash Automne </h1>
      ...
      <div class="box">
        ...
        <dl class="price">
          <dt><strong>17</strong><span><span>€99</span> <del>39,95€</del></span></dt>
          <dd><a href="https://www.iobit.com/buy.php?product=fr-imf61pc1799&ref=fr_imf61pcpurchase1804<?php echo $refStr;?>&aff=<?php echo $aff;?>&refs=fr_purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase1801b-fr')" class="buybtn">VITE, J’EN PROFITE</a></dd>
        </dl>
      </div>
      <div class="box three-gift">
        <p><span>04</span> H :<span>04</span> M :<span>04</span> S <span>04</span> MS <sup>*</sup></p>
        <div class="img-box">
          <img src="<?php echo getStaticUrl('images/three-gift-box.png')?>" alt="">
        </div>
        <dl class="price red">
          <dt><strong>21</strong><span><span>€99</span> <del>169,96€</del></span></dt>
          <dd><a href="https://www.iobit.com/buy.php?product=fr-imf6amcpfsd2199&ref=fr_imf6amcpfsdpurchase1804<?php echo $refStr;?>&aff=<?php echo $aff;?>&refs=fr_purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase1801a-fr')" class="buybtn red"><i></i><span>VITE, J’EN PROFITE</span></a></dd>
          <dd class="people"> <i class="all-icons "></i>5,956,638 personnes l’ont acheté!</dd>
        </dl>
      </div>
      <div class="box three-box">
        ...
        <dl class="price">
          <dt><strong>21</strong><span><span>€99</span> <del>79,99€</del></span></dt>
          <dd><a href="https://www.iobit.com/buy.php?product=fr-imf63pc2199&ref=fr_imf63pcpurchase1804<?php echo $refStr;?>&aff=<?php echo $aff;?>&refs=fr_purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase1801c-fr')" class="buybtn">VITE, J’EN PROFITE</a></dd>
        </dl>
      </div>
    </div>
  </div>
  ...
  <div class="donation wrapper">
    ...
    <a href="https://www.iobit.com/buy.php?product=fr-imf6amcpfsd2199&ref=fr_imf6amcpfsdpurchase1804<?php echo $refStr;?>&aff=<?php echo $aff;?>&refs=fr_purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase1801a-fr')" class="buybtn red"><i></i> <span>VITE, J’EN PROFITE</span></a>
  </div>
  <!-- donation end -->
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%">
      ...
      <tbody>
        <tr>
          ...
          <td class="virtue">Fonctionnalité Essentielle d’Anti-Malware <sup>Amélioré</sup></td>
          <td class="space"></td>
  ...
  <div class="wrapper">
    ...
    <ul>
      <li> <span>1 An / 1 PC</span> <strong>-50%</strong></li>
      <li class="active"> <span>1 An / 3 PCs + Cadeaux offerts </span> <strong>-87%</strong></li>
      <li> <span>1 An / 3 PCs</span> <strong>-70%</strong></li>
    </ul>
   <dl class="price red">
      <dt><strong>21</strong><span><span>€99</span> <del>169,96€</del></span></dt>
      <dd><a href="https://www.iobit.com/buy.php?product=fr-imf6amcpfsd2199&ref=fr_imf6amcpfsdpurchase1804<?php echo $refStr;?>&aff=<?php echo $aff;?>&refs=fr_purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase1801a-fr')" class="buybtn red"><i></i><span>VITE, J’EN PROFITE</span></a></dd>
