...
function change() {
	...
	var details = '<div class="details">' +
		'<div class="info">' +
		'<h3>Valuable Birthday Pack Sold Out </h3>' +
		'<dl>' +
		...
		'<dd><a class="checkbtn large link3pc buylink"><i></i>Activate Now</a></dd>' +
	...
	var new3pc = "https://www.iobit.com/buy.php?product=imf53pc&ref=imf3pc201804a&aff="+aff+"&refs=purchase_imf&tw=" + tw;
	var new3pcStat = "ga('send', 'event', 'imfbuya', 'buy', 'imfpurchase-2018043pc');"
	var new1pc = "https://www.iobit.com/buy.php?product=imf51pc&ref=imf1pc201804a&aff="+aff+"&refs=purchase_imf&tw=" + tw;
	var new1pcStat = "ga('send', 'event', 'imfbuya', 'buy', 'imfpurchase-2018041pc');;"
