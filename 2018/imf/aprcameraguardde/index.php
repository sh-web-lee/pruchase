...
<head>
	<meta charset="UTF-8">
	<title>Sparen Sie 82% für Rundumschutz – Sonderangebot für den neuen IObit Malware Fighter 6 | IObit</title>
...
<body>
	...
	<div class="banner">
		<div class="wrapper">
			...
			<h1>IObit Malware Fighter 6 - Superrabatt </h1>
			<h2>Umfassender Online-Schutz für Sie und Ihre Lieben </h2>
			<div class="left-img">
			...
			<div class="right-message">
				<div class="box">
					...
					<dl class="price">
						...
						<dd><a href="https://www.iobit.com/buy.php?product=de-imf6amcpf2199&ref=de_imfcg&aff=<?php echo $_GET['aff']; ?>&refs=de_purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchasecg1805-de')" class="buybtn"><i></i> Jetzt aktivieren</a></dd>
					</dl>
				</div>
	...
	<div class="cruces">
		<div class="wrapper clearfix">
			...
			<ul>
				<li>
					<h3>Kamera-Wächter</h3>
					<p>Eine Computer-Kamera ist nicht so sicher wie gedacht. Im Gegensatz dazu können viele Programme innerhalb von Minuten in eine internetfähige Kamera einbrechen. Die nicht geschützten Computer-Kameras können gehackt werden.</p>
				</li>
				<li>
					<h3> Keine Privatsphäre mehr</h3>
					<p>Alles, was Sie vor der Kamera machen, wird von Fremden beobachtet. Ihr Leben wird online geteilt und über das Internet übertragen. Sobald angegriffen, wird alle Ihre Privatsphäre exponiert.</p>
				</li>
				<li class="last">
					<h3>Wie soll man sowas vermeiden?</h3>
					<p>Ändern Sie regelmäßig das Passwort im Internet oder wählen Sie einen vertrauenswürdigen Kamerawächter. </p>
				</li>
			</ul>
		</div>
	</div>
	...
	<div class="db-message wrapper">
		<h2>Der super starke Schutz, den Ihre Kamera braucht</h2>
		<p>Kamera-Wächter in IObit Malware Fighter 6 PRO informiert Sie sofort , sobald unautorisierte Software Ihre <br> Kamera heimlich nutzt.</p>
		<div class="message-box">
			<dl class="list01">
				<dt>Unbefugten Zugriff blockieren</dt>
				<dd>Sobald die Kamera von einem nicht autorisierten Programm verwendet wird, erkennt Kamera-Wächter das und hält Sie auf dem Laufenden, um ein Datenschutzleck zu vermeiden. </dd>
			</dl>
			<dl class="list02">
				<dt>Vollkommender Schutz</dt>
				<dd>Um vollen Schutz zu gewährleisten, wird Kamera-Wächter jedes Mal mit Ihnen bestätigen, wenn Programme versuchen, die Kamera zu benutzen, es sei denn, Sie auf "Remember" klicken , wenn Sie dem Programm stark vertrauen.</dd>
			</dl>
	...
	<div class="feature">
		<div class="wrapper">
			...
			<dl>
				...
				<dd><h3>Autom.Update</h3></dd>
				<dd>Automatisches Update auf die neueste Version</dd>
			</dl>
		</div>
	</div>
	<!--end feature-->
