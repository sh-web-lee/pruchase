...
<head>
  ...
  <title>Offerta speciale, sconti fino al 80% su IObit Malware Fighter PRO – Offerta natale 2018 di IObit</title>
...
<div class="banner">
  <div class="wrapper">
    ...
    <div class="title">
      ...
      <h3>Saldi più pazzi dell’anno con sconti fino all’80%, non perderteli!</h3>
    </div>
    <div class="panel clearfix">
      <div class="box small">
        ...
        <a class="buybtn" href="https://www.iobit.com/buy.php?product=it-imf61pc1899&ref=it_imf61pc1899purchase1811<?php echo $refStr;?>&refs=it_purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase1811-it')">
      ...
      <div class="box" id="topCountdown">
        ...
        <a class="buybtn" href="https://www.iobit.com/buy.php?product=it-imf63pcpfamc1999&ref=it_imf63pcpfamc1999purchase1811<?php echo $refStr;?>&refs=it_purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase1811-it')">
          <i></i> <span>ACQUISTA ORA</span>
        </a>
        <p class="bought">
...
<div class="footbuy">
  <div class="wrapper clearfix">
    ...
    <div class="imfbox fl">
      <img class="one" src="<?php echo getStaticUrl('images/foot-box.png')?>" alt="" />
