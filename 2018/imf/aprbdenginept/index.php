...
<head>
	<meta charset="UTF-8">
	<title>Economize 75% para Proteção Total contra Malware e Vírus - IObit Malware Fighter 7 Oferta Especial de Lançamento | IObit</title>
...
<body>
			...
			<div class="right-message">
				<div class="box">
					...
					<dl class="price">
						...
						<dd><a href="https://www.iobit.com/buy.php?product=pt-imf73pcpfamc6999&ref=pt_imfbd<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=pt_purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase-bdengine-pt');" class="buybtn"><i></i> Ativar Agora</a></dd>
					</dl>
				</div>
	...
	<div class="cruces">
		<div class="wrapper clearfix">
			...
			<ul>
				<li>
					<h3>Malware está em todos os cantos da Internet!</h3>
					<p>A internet está cada vez mais perigosa, novos malware como vírus, spyware, adware e trojans emergem todos os dias com o intuito de danificar computadores e roubar dados privados. </p>
				</li>
				<li class="last">
					<h3>Consequências de ser infectado por Malware </h3>
					<p>Malware pode roubar informações pessoais, financeiras ou de negócios do seu computador ao infectá-lo.</p>
				</li>
			</ul>
		</div>
	</div>
	...
	<div class="db-message wrapper">
		<h2>Proteçao Poderosa Anti-malware do Bitdefender</h2>
		<p>Equipado com o último motor anti-vírus Bitdefender, IObit Malware Fighter 7 PRO previne que mais de 200 milhões <br>de ameaças de segurança danifiquem seu computador.</p>
		<div class="message-box">
			<dl class="list01">
				<dt>Banco de Dados Atualizado</dt>
				<dd>Novos malwares são diariamente adicionados ao banco de dados do Bitdefender para garantir a segurança do seu computador contra infecções maliciosas.</dd>
			</dl>
			<dl class="list02">
				<dt>Proteção em Tempo Real</dt>
				<dd>Assim que o motor Bitdefender for ativado, seu computador contará com proteção total em tempo real. Qualquer ameaça que tentar invadir seu sistema será removida imediatamente.</dd>
			</dl>
	...
	<div class="feature">
		<div class="wrapper">
			...
			<dl>
				...
				<dd><h3>Cofre</h3></dd>
				<dd>Protege com senha suas pastas importantes contra acesso não-autorizado e as ameaças mais recentes.</dd>
			</dl>
			<dl>
