...
function maskShow() {
  ...
  $('.main').append('<div class="mask"></div><div class="mask-box"><h2>Überraschung zu Weihnachten </h2><div class="clearfix"><div class="fl left"><img src="' + imgSrc + '" alt="Advanced SystemCare 12 Pro"/></div><div class="price fl"><h3>  <b>1€</b>   Rabatt nur für Sie!</h3><p>  Nur <strong>18,99€ </strong> 1 Jahr, 3 PCs</p><a class="buybtn" href="' + _href + '" onclick="' + _ga + '">Jetzt aktivieren</a><p class="year">Letzte Chance auf den größten Rabatt des Jahres! </p></div></div></div>');
...
function timeInit() {
  var date = new Date();
  var cName = "deimfpre" + date.getDate();
