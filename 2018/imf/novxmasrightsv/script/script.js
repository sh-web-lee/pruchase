...
function maskFirst() {
  ...
  $('.main').append('<div class="mask"></div><div class="mask-box"><h2>Julöverraskning</h2><div class="clearfix"><div class="fl left"><img src="' + imgSrc + '" alt="Advanced SystemCare 12 Pro"/></div><div class="price fl"><h3>Extra <b>10kr</b> Rabatt enbart för dig exclusively!</h3><p>Bara <strong>269<big>kr </big></strong><span></span>1 år / 3 datorer</p><a class="buybtn" href="' + _href + '" onclick="' + _ga + '">Aktivera Nu</a><p class="year">Ta sista chans till den största besparingen någonsin!</p></div></div></div>');
}
...
function timeInit() {
  var date = new Date();
  var cName = "svimfpre" + date.getDate();
