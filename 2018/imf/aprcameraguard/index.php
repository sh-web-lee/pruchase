			...
			<div class="right-message">
				<div class="box">
					<dl class="message">
						...
						<dd>
							<span><i></i> Protected Folder</span> <del>$19.95</del><em>  Free</em>
						</dd>
						<dd>
							<span><i></i> AMC Security PRO </span> <del>$19.99</del><em>  Free</em>
						</dd>
					</dl>
					<dl class="price">
						<dt>
							 Only <strong>$25.99</strong> <del>$94.89</del>
						</dt>
						<dd><a href="https://www.iobit.com/buy.php?product=imf63pcpfamc2599&ref=imfcg<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase-cameraguard');" class="buybtn"><i></i> Activate Now</a></dd>
					</dl>
				</div>
	...
	<div class="gift-message">
		<div class="wrapper">
			...
			<dl>
				...
				<dd>
					<strong>Protected Folder</strong> <del> $19.95</del> (1 Y / 1 PC)
				</dd>
			...
			<dl>
				...
				<dd>
					<strong>AMC Security PRO</strong> <del> $19.99</del> (1 Y / 1 device)
				</dd>
