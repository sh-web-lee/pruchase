...
<body>
	...
	<div class="banner">
		<div class="wrapper">
			...
			<h1>Anti-ransomware: Stopper angreb, beskytter PC’en </h1>
			<h2>Holder dine vigtige filer fra at blive holdt gidsel  </h2>
			<div class="left-img">
			...
			<div class="right-message">
				<div class="box">
					...
					<dl class="price">
						...
						<dd><a href="https://www.iobit.com/buy.php?product=dk-imf8amcpf199&ref=dk_imfar3pcpfamc1904<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=dk_purchase_imf " onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase-antiransomware-dk');" class="buybtn"><i></i> Aktiver nu</a></dd>
					</dl>
				</div>
	...
	<div class="cruces">
		<div class="wrapper clearfix">
			...
			<ul>
				<li>
					<h3>Ransomware</h3>
					<p>En type af malware-angreb som inficerer, enkrypterer eller tager kontrol over systemet og forlanger løsepenge for genvinding af adgang.  </p>
				</li>
				<li>
					<h3>Dit tab ved inficering</h3>
					<p>Varierende summer af penge; ingen adgang til dine systemfiler; muligvis beskadigelse af vigtige og personlige filer og data; andre alvorlige trusler. </p>
				</li>
				<li class="last">
					<h3>Mest berygtede siden de berømte </h3>
					<p>WannaCry-angreb såsom Petya/GoldenEye, Bad Rabbit er tendensen af ransomware, som er vokset i løbet af de seneste to år. </p>
				</li>
			</ul>
		</div>
	</div>
	...
	<div class="db-message wrapper">
		<h2>Din omfattende og kraftfulde forebyggende løsning</h2>
		<p>Anti-ransomware i IObit Malware Fighter 7 PRO beskytter alle dine filer på din pc intelligent fra uautoriseret adgang.</p>
		<div class="message-box">
			<dl class="list01">
				<dt>Smart Anti-ransomware</dt>
				<dd>Vi burger intelligente analyser til at blokere enhver utroværdig adgang til dine vigtige filer inden de påvirker dig.  </dd>
			</dl>
			<dl class="list02">
				<dt>Stor Database</dt>
				<dd>Flere ransomware varianter lagret i vores databare og vores smarte skanning vil forebygge hanging, sletning eller enkryptering af dine personlige data og filer. </dd>
			</dl>
