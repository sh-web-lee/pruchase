...
<meta property="og:url" content="http://purchase.iobit.com/pt/iu-ac-register/index.php">
<meta property="og:image" content="http://purchase.iobit.com/pt/iu-ac-register/images/snapshot.png">
...
<div id="main" class="wrapper">
	<div class="intro">
		...
		<div class="discount">
			...
			<dl>
				...
				<dd class="price">apenas <em>R$17,99</em> <del>R$ 66,99 </del> <span>1 Ano / 1 PC</span></dd>
				<dd>
					<a class="checkbtn" href="http://www.iobit.com/buy.php?product=pt-iu11-ac&ref=pt_iu-ac-register<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=pt_ac_iu" title="CHECKOUT" onclick="ga('send', 'event', 'iubuy', 'buy', 'iuac-pt');">
						Compre Agora >>
					</a>
				</dd>
		...
		<div class="leftbox">
			...
			<ul>
				<li>
					...
					Mais Poderoso para Remover Programas Teimosos e pacotes de instalação.
				</li>
				<li>
	...
	<div class="checkout">
		<div class="moneyback">
				Você está totalmente protegido pela nossa garantia de reembolso 100% e você VAI ver uma melhora significativa no desempenho do seu PC DENTRO DE 60 DIAS ou devolveremos todo seu dinheiro. Sem perguntas. <a href="http://www.iobit.com/buy.php?product=pt-iu11-ac&ref=pt_iu-ac-register<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=pt_ac_iu" title="CHECKOUT" onclick="ga('send', 'event', 'iubuy', 'buy', 'iuac-pt');"> Compre agora</a>
			</div>
			<div class="btn">
				<a href="http://www.iobit.com/buy.php?product=pt-iu11-ac&ref=pt_iu-ac-register<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=pt_ac_iu" title="CHECKOUT" onclick="ga('send', 'event', 'iubuy', 'buy', 'iuac-pt');" class="checkbtn">
					Compre Agora >>
				</a>
