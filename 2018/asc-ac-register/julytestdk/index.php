...
<title>50% OFF on Advanced SystemCare PRO - IObit</title>
...
<meta property="og:title" content="50% OFF on Advanced SystemCare PRO - IObit">
...
<meta property="og:image" content="http://purchase.iobit.com/2018/asc-ac-register/julytestdk/images/snapshot-large.png">
...
<body>
  ...
  <div class="banner">
    <div class="wrapper">
      ...
      <div class="pricebox">
        <dl class="price">
          <dt>KUN: <strong>225 kr </strong><del>449 kr</del></dt>
          <dd>
            <a class="buybtn bigbtn" href="http://www.iobit.com/buy.php?product=dk-asc11-ac&ref=dk_asc3pc-actest&aff=<?php echo $_GET['aff']; ?>&refs=dk_ac_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascactest-dk');">
              <div class="inner">
                <i class="all-icons"></i>
  ...
  <div class="feature wrapper">
    ...
    <div class="clearfix">
      <dl>
        ...
        <dd>
          <h3>DEEP CLEAN</h3>
          <p>Deep clean to fix registry issues and prevent Windows crash and error messages.</p>
        </dd>
      </dl>
      <dl class="right">
        <dt><img src="<?php echo $pResUrl; ?>images/feature_icons_02.png" alt=""></dt>
        <dd>
          <h3>AUTOCARE YOUR PC</h3>
    ...
    <div class="clearfix">
      <dl>
        ...
        <dd>
          <h3>SPEED UP PC</h3>
          <p>Boost startup and internet speed to 200% and 300% faster respectively to reduce system lag and improve online experience.* </p>
        </dd>
      </dl>
      <dl class="right">
        <dt><img src="<?php echo $pResUrl; ?>images/feature_icons_04.png" alt=""></dt>
        <dd>
          <h3>NO PRIVACY LEAK & ANNOYING ADS</h3>
          <p>Erase privacy traces to prevent from being tracked and block pop-up ads in real time.</p>
        </dd>
      </dl>
    </div>
  </div>
  ...
  <div class="review wrapper">
    <div class="content">
      ...
      <dl>
        ...
        <dd>"In my opinion, IObit's ASC Pro is the best maintenance application available for the Windows user, providing excellent value and function in both its shareware and freeware versions. IObit provides expert technical support that is competent, knowledgeable and responsive, adding significant value to their products and services for their customers."
        </dd>
      </dl>
    </div>
  ...
  <div class="floatlayer" id="floatlayer">
    <div class="wrapper clearfix">
      <div class="left">
        ...
        <p><strong>50% OFF</strong> to Keep Your PC Running at Peak Performance</p>
      </div>
      <div class="pricebox">
        <dl class="price fr">
          <dt><strong> 225 kr </strong><del>449 kr</del></dt>
          <dd>
            <a class="buybtn smallbtn" href="http://www.iobit.com/buy.php?product=dk-asc11-ac&ref=dk_asc3pc-actest&aff=<?php echo $_GET['aff']; ?>&refs=dk_ac_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascactest-dk');">
              <div class="inner">
                <i class="all-icons"></i>
                <span>Activate Now</span>
              </div>
