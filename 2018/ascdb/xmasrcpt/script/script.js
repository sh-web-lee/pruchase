...
function maskShow() {
  ...
  $('.main').append('<div class="mask"></div><div class="mask-box"><h2>Aproveite a Nossa Oferta Especial de Natal!</h2><div class="clearfix"><div class="fl left"><img src="' + imgSrc + '" alt="Advanced SystemCare 12 Pro"/></div><div class="price"><h3><b>R$5</b> extra de desconto pra você</h3><p><strong><big>R$</big>114<big>,</big></strong> <span> 99 <del>R$ 499,80</del> </span></p> <a class="buybtn" href="' + _href + '" onclick="' + _ga + '">Comprar Agora</a><p class="year">Sua última chance de aproveitar o preço mais baixo da história!</p></div></div></div>');
