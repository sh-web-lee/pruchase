...
<div id="main">
    ...
    <div class="intro">
      ...
      <div class="discount">
        ...
        <div class="disprice">80%<span> rabat</span></div>
        <div class="wprice">Kun <em>kr.69</em> <del>kr.379</del> <span>1 år, 1 pc</span></div>
        <div class="btnarea">
          <a class="checkbtn"
             href="https://www.iobit.com/buy.php?product=dk-sd6-ac&ref=<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=dk_ac_sd"
             onclick="ga('send', 'event', 'sdbuy', 'buy', 'sdacmay-dk');" >
            KØB NU
          </a>
    ...
    <div class="checkout">
      <div class="moneyback">
        Du er fuldt beskyttet af vores 100% pengene-tilbage-garanti og vil opleve en betydelig forbedring af din pc's ydeevne indenfor 60 dage, ellers får du alle pengene tilbage. Ingen yderligere spørgsmål. <a href="https://www.iobit.com/buy.php?product=dk-sd6-ac&ref=<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=dk_ac_sd"
             onclick="ga('send', 'event', 'sdbuy', 'buy', 'sdacmay-dk');">
          Køb nu
        </a>
      </div>
