    ...
    <div class="wrapper">
        ...
        <div class="intro">
            ...
            <div class="discount">
                ...
                <div class="disprice">73% Rabat</div>
                <div class="wprice"><strong>KUN kr.99</strong>  <del>kr.379</del><span>1 år, 1 pc</span></div>
                <div class="btnarea">
                    <a href="https://www.iobit.com/buy.php?product=dk-imf8-ac&ref=<?php echo $refStr; ?>&aff=<?php echo $_GET['aff']; ?>&refs=dk_ac_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfacapr-dk')" class="checkbtn">KØB NU >></a>
        ...
        <div class="checkout">
            <div class="moneyback">
                Du er fuldt beskyttet af vores 100% pengene-tilbage-garanti og du vil opleve en betydelig forbedring af din pc's ydeevne indenfor 60 dage, ellers får du alle pengene tilbage. Ingen yderligere spørgsmål.  <a href="https://www.iobit.com/buy.php?product=dk-imf8-ac&ref=<?php echo $refStr; ?>&aff=<?php echo $_GET['aff']; ?>&refs=dk_ac_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfacapr-dk')">Køb nu</a>
            </div>
            <div class="btn">
                <a href="https://www.iobit.com/buy.php?product=dk-imf8-ac&ref=<?php echo $refStr; ?>&aff=<?php echo $_GET['aff']; ?>&refs=dk_ac_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfacapr-dk')" class="checkbtn">KØB NU >></a>
                <span>100% tilbagebetalingsgaranti</span>
