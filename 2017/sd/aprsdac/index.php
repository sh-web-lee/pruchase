...
<meta property="og:url" content="https://purchase.iobit.com/sd-ac-register/index.php">
...
<meta property="og:image" content="https://purchase.iobit.com/2017/sd/aprsdac/images/snapshot-large.jpg">
...
<script type="text/javascript" src="<?php echo $pRootUrl; ?>tpl/js/stats.js"></script>
  ...
  <div class="banner">
    <div class="wrapper">
      ...
      <div class="pricebox">
        <dl class="price">
          <dt>ONLY: <strong>$3.99 </strong><del>$29.99</del></dt>
          <dd>
            <a class="paddle_button buybtn bigbtn" href="#!" data-product="663350" data-theme="none" onclick="ga('send', 'event', 'sdbuy', 'buy', 'sdac');"> 
              <div class="inner">
                <i class="all-icons"></i>
  ...
  <div class="floatlayer" id="floatlayer">
    <div class="wrapper clearfix">
      ...
      <div class="pricebox">
        <dl class="price fr">
          <dt><strong>$3.99 </strong><del>$29.99</del></dt>
          <dd>
            <a class="paddle_button buybtn smallbtn" href="#!" data-product="663350" data-theme="none" onclick="ga('send', 'event', 'sdbuy', 'buy', 'sdac');"> 
              <div class="inner">
                <i class="all-icons"></i>
                <span>Activate Now</span>
              </div>
