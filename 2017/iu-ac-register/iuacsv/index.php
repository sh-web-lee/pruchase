...
<title>65% Rabatt på IObit Uninstaller PRO</title>
...
<div id="main" class="wrapper">
	<div class="intro">
		...
		<div class="discount">
			...
			<dl>
				<dt>65% Rabatt</dt>
				<dd class="price">ENDAST <em> 129kr</em> <del>399kr</del> <span>1 År / 1 PC</span></dd>
				<dd><a href="https://www.iobit.com/buy.php?product=sv-iu11-ac&ref=sv_iu-ac<?php echo $refStr;?>&refs=sv_ac_iu" onclick="ga('send', 'event', 'iubuy', 'buy', 'iuac-sv')" class="checkbtn iubuybtn">Köp Nu >></a></dd>
	...
	<div class="checkout">
		<div class="moneyback">
				Du skyddas helt av vår 100% pengarna tillbaka garanti och du KOMMER att se en betydande förbättring av datorns prestanda INOM 60 DAGAR, eller så gör vi en full återbetalning. Inga frågor. <a class="iubuybtn" href="https://www.iobit.com/buy.php?product=sv-iu11-ac&ref=sv_iu-ac<?php echo $refStr;?>&refs=sv_ac_iu" onclick="ga('send', 'event', 'iubuy', 'buy', 'iuac-sv')">Köp Nu</a>
			</div>
			<div class="btn">
				<a href="https://www.iobit.com/buy.php?product=sv-iu11-ac&ref=sv_iu-ac<?php echo $refStr;?>&refs=sv_ac_iu" onclick="ga('send', 'event', 'iubuy', 'buy', 'iuac-sv')" class="checkbtn iubuybtn">Köp Nu >></a>
