...
<title>85% Rabatt auf Driver Booster</title>
<meta name="Copyright" content="IObit">
<meta name="description" content="Exklusiv für die von IObit geschätzten Kunden, der beste Driver Updater, um PC-Treiber einfach, sicher und schnell zu aktualisieren.">
...
<script type="text/javascript" src="<?php echo $pRootUrl; ?>tpl/js/stats.js"></script>
  ...
  <div class="banner">
    <div class="wrapper">
      ...
      <div class="title">
        ...
        <p>Der beste Driver Updater, um PC-Treiber einfach, sicher und schnell zu aktualisieren</p>
      </div>
      ...
      <div class="pricebox">
        <dl class="price">
          <dt>NUR: <strong>9,99€</strong> <del>74,85€</del></dt>
          <dd>
            <a class="buybtn bigbtn" href="https://www.iobit.com/buy.php?product=de-db8-ac&ref=<?php echo $refStr;?>&aff=&refs=de_ac_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbac-de');">
              <div class="inner">
                <i class="all-icons"></i>
  ...
  <div class="feature wrapper">
    <h2>Was IObit Driver Booster PRO für Sie tun kann?</h2>
    <div class="clearfix">
      <dl>
        <dt><img src="<?php echo getStaticUrl('images/feature_icons_01.png')?>" alt=""></dt>
        <dd>
          <h3>Große Treiberdatenbank</h3>
          <p>Erfasst & updatet über 4.500.000 Treiber mit 1-Klick, was die Stabilität und Performance Ihres Computers verbessert.</p>
        </dd>
      </dl>
      <dl class="right">
        <dt><img src="<?php echo getStaticUrl('images/feature_icons_02.png')?>" alt=""></dt>
        <dd>
          <h3>Peak Game Erfahrung</h3>
          <p>Steigert die Performance mit den neuesten Game Ready Treibern und führe Spiele flüssig mit notwendigen Spielekomponenten aus.</p>
        </dd>
      </dl>
    </div>
    <div class="clearfix">
      <dl>
        ...
        <dd>
          <h3>Automatische Treiber-Updates</h3>
          <p>Aktualisiert Treiber automatisch während der Systemleerlaufzeit.</p>
        </dd>
      </dl>
      <dl class="right">
        <dt><img src="<?php echo getStaticUrl('images/feature_icons_04.png')?>" alt=""></dt>
        <dd>
          <h3>Sichere Treiber Updates</h3>
          <p>Automatische Sicherung früherer Treiber vor dem Aktualisieren.</p>
        </dd>
      </dl>
    </div>
  </div>
  ...
  <div class="footbuy">
    <div class="wrapper">
      <h2>Bessere PC Leistung &amp; geschmeidigeres Spielerlebnis garantiert</h2>
      <div class="pricebox">
        <dl class="price">
          <dt>NUR: <strong>9,99€ </strong><del>74,85€</del></dt>
          <dd>
  ...
  <div class="floatlayer" id="floatlayer">
    <div class="wrapper clearfix">
      <div class="left">
        ...
        <p><strong>85% Sale</strong>, um Systemabstürtze und instabile Spielerfahrungen loszuwerden.</p>
      </div>
      <div class="pricebox">
        <dl class="price fr">
          <dt><strong>9,99€ </strong><del>74,85€</del></dt>
          <dd>
            <a class="buybtn smallbtn" href="https://www.iobit.com/buy.php?product=de-db8-ac&ref=<?php echo $refStr;?>&aff=&refs=de_ac_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbac-de');">
              <div class="inner">
                <i class="all-icons"></i>
                <span>Jetzt kaufen</span>
              </div>
