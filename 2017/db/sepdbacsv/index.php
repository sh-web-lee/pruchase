...
<title>78% Rabatt på IObit Driver Booster PRO - IObit</title>
...
<script type="text/javascript" src="<?php echo $pRootUrl; ?>tpl/js/stats.js"></script>
  ...
  <div class="banner">
    <div class="wrapper">
      ...
      <div class="title">
        ...
        <p>Bästa drivrutinuppdaterare för att uppdatera dators drivrutiner enkelt, säkert och snabbt</p>
      </div>
      ...
      <div class="pricebox">
        <dl class="price">
          <dt>ENDAST: <strong>199 kr </strong><del>899 kr</del></dt>
          <dd>
            <a class="buybtn bigbtn" href="https://www.iobit.com/buy.php?product=sv-db8-ac&ref=<?php echo $refStrA;?>&aff=<?php echo $_GET['aff']; ?>&refs=sv_ac_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbac-sv');">
              <div class="inner">
                <i class="all-icons"></i>
                <span>Köp Nu</span>
              </div>
          ...
          <dd>1 års prenumeration / 1 PC</dd>
        </dl>
      </div>
    </div>
  </div>
  ...
  <div class="feature wrapper">
    <h2>Vad kan Driver Booster PRO göra för dig?</h2>
    <div class="clearfix">
      <dl>
        <dt><img src="<?php echo $pResUrl; ?>images/feature_icons_01.png" alt=""></dt>
        <dd>
          <h3>STOR DRIVRUTINSDATABAS</h3>
          <p>Upptäck och uppdatera över 4 500 000 drivrutiner med 1 klick vilket förbättrar din dators stabilitet och prestanda.</p>
        </dd>
      </dl>
      <dl class="right">
        <dt><img src="<?php echo $pResUrl; ?>images/feature_icons_02.png" alt=""></dt>
        <dd>
          <h3>TOPP SPELUPPLEVELSE</h3>
          <p>Förbättra prestanda med den senaste Game Ready Drivrutinen</p>
        </dd>
      </dl>
    </div>
    <div class="clearfix">
      <dl>
        ...
        <dd>
          <h3>AUTOMATISK UPPDATERING AV DRIVRUTIN</h3>
          <p>Uppdatera drivrutiner automatiskt när systemet<br> är i viloläge</p>
        </dd>
      </dl>
      <dl class="right">
        <dt><img src="<?php echo $pResUrl; ?>images/feature_icons_04.png" alt=""></dt>
        <dd>
          <h3>SÄKER DRIVRUTINUPPDATERING</h3>
          <p>Säkerhetskopiera tidigare drivrutiner automatiskt innan uppdatering.</p>
        </dd>
      </dl>
    </div>
  </div>
  ...
  <div class="footbuy">
    <div class="wrapper">
      <h2>Garantera en Bättre Prestanda av Dator och Smidigare Spelupplevelse</h2>
      <div class="pricebox">
        <dl class="price">
          <dt>ENDAST: <strong>199 kr </strong><del>899 kr</del></dt>
          <dd>
  ...
  <div class="floatlayer" id="floatlayer">
    <div class="wrapper clearfix">
      <div class="left">
        ...
        <p><strong>78% RABATT</strong> för att Bli Av med Systemkrasch och Instabil Spelupplevelse</p>
      </div>
      <div class="pricebox">
        <dl class="price fr">
          <dt>ENDAST: <strong>199 kr </strong><del>899 kr</del></dt>
          <dd>
            <a class="buybtn smallbtn" href="https://www.iobit.com/buy.php?product=sv-db8-ac&ref=<?php echo $refStrA;?>&aff=<?php echo $_GET['aff']; ?>&refs=sv_ac_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbac-sv');">
              <div class="inner">
                <i class="all-icons"></i>
                <span>Köp Nu</span>
              </div>
