...
<html lang="fr">
	<head>
		...
		<title>Jusqu'à -85% sur Driver Booster PRO – Soldes d'été chez IObit </title>
		...
		k='17473586-620',d=document,l=d.location,c=d.cookie;
	...
	<body>
		...
		<div class="banner">
			<div class="wrapper">
				<h1><strong>Soldes d’été</strong> sur Driver Booster PRO</h1>
				<h2>Offre valable uniquement aujourd’hui, c’est premier arrivé, permier servi!</h2>
				<img src="<?php echo $pResUrl; ?>images/db-box.png" alt="" class="db-box">
				<div class="right-message">
					<h2>-85%</h2>
					<h3>Jusqu’à -85% sur Driver Booster PRO et profitez d’un super <br> <span></span> paquet cadeau pour votre famille! <span></span></h3>
					<dl class="price-content">
						<dt>24,99€ <del>174,82€</del></dt>
						<dd><a href="https://www.iobit.com/buy.php?product=fr-db5sdpfiu2499&ref=fr_db5sdpfiupurchase1807<?php echo $refStr;?>&refs=fr_purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase1807-fr')" class="buybtn">VITE, J’EN PROFITE</a></dd>
		...
		<div class="db-message wrapper clearfix">
			<h2>Mettre à jour automatiquement les pilotes périmés, défectueux pour des performances au top!</h2> 
		...
		<div class="gift-box">
			<h2>Cadeaux Exclusifs seulement pour nos utilisateurs importants</h2>
			<div class="wrapper clearfix"> 	
				<dl>
					...
					<dd>Maximiser les performances de <br> disque dur de votre PC</dd>
				</dl>
				<dl>
					<dt>
				...
				<dl>
					...
					<dd>Détecter et désinstaller les bundlewares  et les plug-ins regroupés</dd>
				</dl>
			</div>
		</div>
		<div class="between-buy">
		  <div class="wrapper">
		    ...
		    <div class="buy-bg">
		      ...
		      <ul>
		        <li><img src="<?php echo $pResUrl; ?>images/gift.png" alt=""> IObit Uninstaller 8 PRO</li>
		        <li><img src="<?php echo $pResUrl; ?>images/gift.png" alt=""> Smart Defrag 6 PRO</li>
				...
				<tfoot>
					<tr>
						...
						<th class="itema">
							...
							<a href="https://www.iobit.com/buy.php?product=fr-db5sdpfiu2499&ref=fr_db5sdpfiupurchase1807<?php echo $refStr;?>&refs=fr_purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase1807-fr')" class="buybtn">VITE, J’EN PROFITE</a>
						</th>
					</tr>
				</tfoot>
			</table>
		...
		<!-- main end -->
		<div class="footer">Copyright © 2005 - 2018 IObit. Tous droits réservés</div>
		<div class="floatlayer">
		  <div class="wrapper clearfix">
		    <h2>Economisez jusqu’à <strong>85%</strong> sur Driver Booster PRO et obtenez <br> gratuitement les cadeaux supplémentaires!</h2>
		    <dl>
