...
<meta property="og:image" content="https://purchase.iobit.com/2017/db/mardbac/images/snapshot-large-db8.png">
...
<script type="text/javascript" src="<?php echo $pRootUrl; ?>tpl/js/stats.js"></script>
  ...
  <div class="banner">
    <div class="wrapper">
      ...
      <div class="pricebox">
        <dl class="price">
          <dt>ONLY: <strong>$9.99 </strong><del>$74.85</del></dt>
          <dd>
            <a class="buybtn bigbtn" href="https://www.iobit.com/buy.php?product=db8-acak&ref=<?php echo $refStrA;?>&aff=<?php echo $_GET['aff']; ?>&refs=ac_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbac-newa');">
              <div class="inner">
                <i class="all-icons"></i>
  ...
  <div class="feature wrapper">
    ...
    <div class="clearfix">
      <dl>
        ...
        <dd>
          ...
          <p>Detect & update over 4,500,000 drivers with 1-click, <br>which improves your computer’s stability and performance.</p>
        </dd>
      </dl>
      <dl class="right">
    ...
    <div class="clearfix">
      <dl>
        ...
        <dd>
          <h3>AUTO DRIVER UPDATING</h3>
          <p>Automatically update drivers during system idle time.</p>
        </dd>
      </dl>
      <dl class="right">
    ...
    <div class="wrapper">
      ...
      <div class="pricebox">
        <dl class="price">
          <dt>ONLY: <strong>$9.99 </strong><del>$74.85</del></dt>
          <dd>
            <a class="buybtn bigbtn" href="https://www.iobit.com/buy.php?product=db8-acak&ref=<?php echo $refStrA;?>&aff=<?php echo $_GET['aff']; ?>&refs=ac_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbac-newc');">
              <div class="inner">
                <i class="all-icons"></i>
                <span>Activate Now</span>
              </div>
    ...
    <div class="wrapper clearfix">
      ...
      <div class="pricebox">
        <dl class="price fr">
          ...
          <dd>
            <a class="buybtn smallbtn" href="https://www.iobit.com/buy.php?product=db8-acak&ref=<?php echo $refStrA;?>&aff=<?php echo $_GET['aff']; ?>&refs=ac_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbac-newb');">
              <div class="inner">
                <i class="all-icons"></i>
                <span>Activate Now</span>
              </div>
