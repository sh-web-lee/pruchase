...
<title>75% di  Sconto su IObit Uninstaller PRO</title>
...
<div id="main" class="wrapper">
	<div class="intro">
		...
		<div class="discount">
			...
			<dl>
				<dt>75% DISCONTI</dt>
				<dd class="price">Solo <em>4,99€</em> <del>19,99€</del> <span>1PC / 1 Anno</span></dd>
				<dd>
					<a class="checkbtn" href="https://www.iobit.com/buy.php?product=it-iu11-ac&ref=it_iu-ac-register<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=it_ac_iu" title="CHECKOUT" onclick="ga('send', 'event', 'iubuy', 'buy', 'iuac-it')">
						ACQUISTA ORA >>
					</a>
				</dd>
		...
		<div class="leftbox">
			...
			<ul>
				...
				<li>
					...
					Rimuove completamente i programmi con problemi di disinstallazione e gli avanzi con un solo clic.
				</li>
				<li class="last">
	...
	<div class="checkout">
		<div class="moneyback">
				Sei stato protetto completamente dalla nostra garanzia di 100% rimborso. Scoprirai un miglioramento significativo della prestazione del tuo PC ENTRO 60 giorni, altrimenti, ti procederemo il rimborso subito. Senza preoccupazione. <a href="https://www.iobit.com/buy.php?product=it-iu11-ac&ref=it_iu-ac-register<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=it_ac_iu" title="CHECKOUT" onclick="ga('send', 'event', 'iubuy', 'buy', 'iuac-it')"> Acquista Ora</a>
			</div>
			<div class="btn">
				<a href="https://www.iobit.com/buy.php?product=it-iu11-ac&ref=it_iu-ac-register<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=it_ac_iu" title="CHECKOUT" onclick="ga('send', 'event', 'iubuy', 'buy', 'iuac-it')" class="checkbtn">
					ACQUISTA ORA >>
				</a>
