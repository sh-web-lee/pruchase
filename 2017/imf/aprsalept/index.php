...
<head>
    ...
    <title>Adquira IObit Malware Fighter 8 Pro para 3 PCs com 55% de desconto. Oferta Limitada da IObit.</title>
    ...
    k='114018648-643',d=document,l=d.location,c=d.cookie;
    ...
    <div class="wrapper">
        ...
        <div class="banner">
            ...
            <div class="banner-right fr">
                <h2>IObit Malware Fighter 8 Pro - 1 ano / 3 PCs</h2>
                ...
                <span class="banner-line"></span>
                <a class="buy-btn" href="https://www.iobit.com/buy.php?product=pt-imf83pc6999&ref=pt_imf83pcpfpurchase1704<?php echo $refStr;?>&refs=pt_purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase1704-pt')">COMPRAR AGORA</a>
