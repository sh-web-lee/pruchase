...
function change() {
	...
	var packs = '<div class="packs">' +
		'<div class="info">' +
		'<h2>IObit Malware Fighter 8 PRO Family Protection Pack</h2>' +
	...
	var details = '<div class="details">' +
		'<div class="info">' +
		'<h3>Valuable New Member Pack Sold Out!</h3>' +
		'<dl>' +
	...
	var new3pc = "https://www.iobit.com/buy.php?product=imf83pc&ref=en-imf3pcinstall" + refStr + "&aff=" + aff + "&refs=purchase_imf&tw=" + tw;
	var new3pcStat = "ga('send', 'event', 'imf3pcbuy', 'buy', 'imfpurchase-201804');"
