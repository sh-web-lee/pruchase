...
function change() {
  ...
  var packs = '<div class="packs">' + '<div class="info">' + "<h2>IObit Malware Fighter 8 PRO Family Protection Pack</h2>" + "<strong>56% OFF</strong>" + "Save<del>$30.96</del>" + "</div>" + "</div>";
  var details = '<div class="details">' + '<div class="info">' + "<h3>Valuable New Member Pack Sold Out!</h3>" + "<dl>" + "<dt> But IObit Malware Fighter 8 PRO Family Protection Pack on Sale Now!</dt>" + "<dd>Hurry up, seize your another chance</dd>" + "</dl>" + "</div>" + '<dl class="checkout">' + "<dt>only <strong>$23.99</strong> <del>$54.95</del></dt>" + '<dd><a class="checkbtn large link3pc">Activate Now</a></dd>' + '<dd class="last"><i></i>100% 60-Day Money Back Guarantee</dd>' + "</dl>" + "</div>";
  $(".stage").append(packs);
  $(".stage").append(details);
  var valuePack = '<div class="extra value-pack sold-out">' + '<div class="info">' + "<h3>Valuable New Year Pack</h3>" + "<p>1 Year / 3 PCs + Gift Pack</p>" + "</div>" + '<dl class="checkout">' + "<dt><strong>$25.99</strong> <del>$94.93</del></dt>" + '<dd><a class="checkbtn middle">Activate Now</a></dd>' + "</dl>" + "</div>";
