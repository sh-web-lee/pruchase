...
<meta property="og:url" content="http://purchase.iobit.com/imf-ac-register/index.php">
...
<meta property="og:image" content="https://purchase.iobit.com/2017/imf/aprimfac/images/snapshot-large.png">
...
<script type="text/javascript" src="<?php echo $pRootUrl; ?>tpl/js/stats.js"></script>
  ...
  <div class="banner">
    <div class="wrapper">
      ...
      <div class="pricebox">
        <dl class="price">
          <dt>ONLY: <strong>$5.99 </strong><del>$39.99</del></dt>
          <dd>
            <a class="buybtn bigbtn" href="https://www.iobit.com/buy.php?product=imf8-acak&ref=imf-ac<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=ac_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfac');">
              <div class="inner">
                <i class="all-icons"></i>
    ...
    <div class="wrapper clearfix">
      ...
      <div class="pricebox">
        <dl class="price fr">
          ...
          <dd>
            <a class="buybtn smallbtn" href="https://www.iobit.com/buy.php?product=imf8-acak&ref=imf-ac<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=ac_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfac');">
              <div class="inner">
                <i class="all-icons"></i>
                <span>Activate Now</span>
              </div>
