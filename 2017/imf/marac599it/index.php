		...
		<div class="wrapper">
				...
				<div class="intro">
						...
						<div class="discount">
								...
								<div class="wprice">Solo <em>5.99€</em> <del>39.99€</del><span>1PC / 1 Anno</span></div>
								<div class="btnarea">
										<a href="https://www.iobit.com/buy.php?product=it-imf81pc599-ac&ref=<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=it_ac_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfac-it');" class="checkbtn">Acquista Ora >></a>
				...
				<div class="checkout">
						<div class="moneyback">
								Sei stato protetto completamente dalla nostra garanzia di 100% rimborso. Scoprirai un miglioramento significativo della prestazione del tuo PC ENTRO 60 giorni, altrimenti, ti procederemo il rimborso subito. Senza preoccupazione.<a href="https://www.iobit.com/buy.php?product=it-imf81pc599-ac&ref=<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=it_ac_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfac-it');">Acquista Ora.</a>
						</div>
						<div class="btn">
								<a href="https://www.iobit.com/buy.php?product=it-imf81pc599-ac&ref=<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=it_ac_imf" title="CHECKOUT" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfac-it');" class="checkbtn">Acquista Ora >></a>
								<span>100% GARANZIA DI RIMBORSO</span>
						</div>
				</div>
				<div class="clear"></div>
