...
<title>50% RABATT på Advanced SystemCare PRO - IObit</title>
...
<script type="text/javascript" src="<?php echo $pRootUrl; ?>tpl/js/stats.js"></script>
  ...
  <div class="banner">
    <div class="wrapper">
      ...
      <div class="pricebox">
        <dl class="price">
          <dt>&nbsp;&nbsp;ENDAST <strong>299kr</strong> <del>599kr</del></dt>
          <dd>
            <a class="buybtn bigbtn" 
               href="https://www.iobit.com/buy.php?product=sv-asc15a299-ac&ref=sv_asc-ac299&aff=<?php echo $_GET['aff']?>&refs=sv_ac_asc"
               onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascac299-sv');">
              <div class="inner">
                <i class="all-icons"></i>
  ...
  <div class="floatlayer" id="floatlayer">
    <div class="wrapper clearfix">
      <div class="left">
        ...
        <p><strong>REA 50%</strong> för att maximera din dators prestanda</p>
      </div>
      <div class="pricebox">
        <dl class="price fr">
          <dt><strong>299kr </strong><del> 599kr</del></dt>
          <dd>
