...
<title>Adquira Advanced SystemCare 15 PRO com 55% de desconto. Oferta Limitada da IObit.</title>
...
<meta property="og:title" content="Adquira Advanced SystemCare 10 PRO com 55% de desconto. Oferta Limitada da IObit.">
...
<script type="text/javascript" src="<?php echo $pRootUrl; ?>tpl/js/stats.js"></script>
  ...
  <div class="banner">
    <div class="wrapper">
      ...
      <div class="pricebox">
        <dl class="price">
          <dt>APENAS: <strong>R$ 69,99 </strong><del>R$159,99</del></dt>
          <dd>
            <a class="buybtn bigbtn"
               href="https://www.iobit.com/buy.php?product=pt-asc15a6999-ac&ref=pt_asc3pc6999-ac&aff=<?php echo $_GET['aff']?>&refs=pt_ac_asc"
               onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascacindex-pt')">
              <div class="inner">
                <i class="all-icons"></i>
  ...
  <div class="floatlayer" id="floatlayer">
    <div class="wrapper clearfix">
      <div class="left">
        ...
        <p><strong>55% OFF</strong> para Manter seu PC Rodando com Desempenho Máximo</p>
      </div>
      <div class="pricebox">
        <dl class="price fr">
          <dt><strong>R$ 69,99  </strong><del>R$ 159,99</del></dt>
          <dd>
