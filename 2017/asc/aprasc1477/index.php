...
$refStr='';
if(in_array($_GET['to'],array('db_ac_asc_p3'))){
  $refStr.='-'.$_GET['to'];
}
...
<title>70% OFF on Advanced SystemCare PRO - IObit</title>
...
<meta property="og:url" content="http://purchase.iobit.com/asc-ac-register/newprice.php">
<meta property="og:type" content="website">
<meta property="og:title" content="70% OFF on Advanced SystemCare PRO - IObit">
...
<meta property="og:image" content="http://purchase.iobit.com/2017/asc/aprasc1477/images/snapshot-large.png?t=51">
...
<script type="text/javascript" src="<?php echo $pRootUrl; ?>tpl/js/stats.js"></script>
  ...
  <div class="banner">
    <div class="wrapper">
      ...
      <div class="pricebox">
        <dl class="price">
          <dt>ONLY: <strong>$14.77 </strong><del>$49.99</del></dt>
          <dd>
            <a class="buybtn bigbtn" href="https://www.iobit.com/buy.php?product=asc15b-acak&ref=asc1477-ac<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=ac_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascac1477');">
              <div class="inner">
                <i class="all-icons"></i>
  ...
  <div class="feature wrapper">
    ...
    <div class="clearfix">
      ...
      <dl class="right">
        ...
        <dd>
          <h3>200% Faster PC</h3>
          <p>Fix slow computer and free up disk space to keep your PC running faster.</p>
        </dd>
      </dl>
    </div>
    <div class="clearfix">
      ...
      <dl class="right">
        ...
        <dd>
          ...
          <p>Fully prevent your online behaviors from being tracked in real-time with privacy eraser.</p>
        </dd>
      </dl>
    </div>
    <div class="clearfix">
      ...
      <dl class="right">
        ...
        <dd>
          <h3>Automates PC maintenance</h3>
          <p>Auto care your system as scheduled and auto clean RAM for optimal PC performance.</p>
        </dd>
      </dl>
    </div>
  </div>
    ...
    <div id="dg-container" class="dg-container">
      ...
      <div class="content dg-wrapper">
        ...
        <dl class="reviews">
          <dt><h2><span>User Review</span></h2></dt>
          <dd> 
            <p>"I have been using Advanced SystemCare Pro for a long time and this latest version 15 is even better than version 13. It can find and fix problems very quickly and has so many extra features you can use to keep your computer running well and stable. I cannot recommend it more highly."</p>
  ...
  <div class="floatlayer" id="floatlayer">
    <div class="wrapper clearfix">
      ...
      <div class="left">
        ...
        <p><strong>70% OFF</strong> to Keep Your PC Running at Peak Performance</p>
      </div>
      <div class="pricebox">
        <dl class="price fr">
          <dt><strong>$14.77 </strong><del>$49.99</del></dt>
          <dd>
            <a class="buybtn smallbtn" href="https://www.iobit.com/buy.php?product=asc15b-acak&ref=asc1477-ac<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=ac_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascac1477');">
              <div class="inner">
                <i class="all-icons"></i>
                <span>Activate Now</span>
              </div>
