...
<title>70% de rabais sur Advanced SystemCare PRO</title>
...
<script type="text/javascript" src="<?php echo $pRootUrl; ?>tpl/js/stats.js"></script>
  ...
  <div class="banner">
    <div class="wrapper">
      ...
      <div class="pricebox">
        <dl class="price">
          <dt>Seulement: <strong>14,99€ </strong><del>49,99€</del></dt>
          <dd>
            <a class="buybtn bigbtn" 
               href="https://www.iobit.com/buy.php?product=fr-asc153pc1499&ref=fr_asc1499-ac-register&aff=<?php echo $_GET['aff']?>&refs=fr_ac_asc"
               onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascac1499-fr');">
              <div class="inner">
                <i class="all-icons"></i>
    ...
    <div id="dg-container" class="dg-container">
      ...
      <div class="content dg-wrapper">
        ...
        <dl class="reviews">
          <dt><h2><span>Avis des utilisateurs</span></h2></dt>
          <dd> 
            <p>« J’utilise Advanced SystemCare Pro depuis longtemps et cette dernière version 15 est encore meilleure que la version 14. Il peut détecter et résoudre les problèmes très rapidement et dispose de nombreuses fonctionnalités supplémentaires dont vous pouvez bénéficier pour un démarrage du PC plus rapide et un système plus stable. Je le recommande vivement. »</p>
  ...
  <div class="floatlayer" id="floatlayer">
    <div class="wrapper clearfix">
      <div class="left">
        ...
        <p><strong>-70%</strong> sur ASC PRO pour rendre votre PC fonctionner à sa vitesse maximale</p>
      </div>
      <div class="pricebox">
        <dl class="price fr">
