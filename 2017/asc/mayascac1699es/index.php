        ...
        <dl class="price">
          ...
          <dd>
            <a class="buybtn bigbtn" 
               href="https://www.iobit.com/buy.php?product=es-asc15a1699-ac&ref=es_asc-ac1699&aff=<?php echo $_GET['aff']?>&refs=es_ac_asc"
               onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascac1699-es');">
              <div class="inner">
                <i class="all-icons"></i>
