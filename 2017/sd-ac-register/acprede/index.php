...
<div id="main">
    ...
    <div class="intro">
      ...
      <div class="discount">
        ...
        <div class="wprice">Nur <em>3,99€</em> <del>29,99€</del><span>für ein Jahresabo für 1 PC</span></div>
        <div class="btnarea">
          <a class="checkbtn"
             href="https://www.iobit.com/buy.php?product=de-sd6-ac&ref=<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=de_ac_sd"
             onclick="ga('send', 'event', 'sdbuy', 'buy', 'sdac-de');" >
            Jetzt kaufen >>
          </a>
    ...
    <div class="checkout">
      <div class="moneyback">
        ...
        <a href="https://www.iobit.com/buy.php?product=de-sd6-ac&ref=<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=de_ac_sd"
             onclick="ga('send', 'event', 'sdbuy', 'buy', 'sdac-de');">
          Jetzt kaufen
        </a>
      </div>
