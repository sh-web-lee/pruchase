    ...
    <div class="wrapper">
        ...
        <div class="intro">
            ...
            <div class="discount">
                ...
                <div class="wprice">APENAS <em>R$ 18,99</em> <del>R$122,90</del><span>1 Ano de Assinatura/ 1PC</span></div>
                <div class="btnarea">
                    <a href="https://www.iobit.com/buy.php?product=pt-imf8-ac&ref=<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=pt_ac_imf" onclick="a('send', 'event', 'imfbuy', 'buy', 'imfac-pt');" class="checkbtn">Compre Agora >></a>
            ...
            <div class="leftbox">
              ...
              <ul>   
                <li>
                  ...
                  Remoção Profunda de Malware com o Motor Antivírus Bitdefender
                </li>
                <li>
                  <span><img src="<?php echo getStaticUrl('images/icon-threate-remove.png')?>" alt="" /></span>
                  Detecta e Remove mais de 209 Milhões de Ameaças Ocultas
                </li>
                <li>
                  <span style="padding-top: 6px;"><img src="<?php echo getStaticUrl('images/icon-videor.png')?>" alt="" /></span>
                  Adiciona uma camada extra de proteção para seus dados sensíveis como documentos, imagens e vídeos.
                </li>
                <li>
                  <span><img src="<?php echo getStaticUrl('images/icon-file-money-protect.png')?>" alt="" /></span>
                  Impede que Ransomware tente criptografar seus arquivos.
                </li>
                <li>
                  <span><img src="<?php echo getStaticUrl('images/icon-camera-protect.png')?>" alt="" /></span>
                  Cofre mantém pastas importantes livres de acesso não-autorizado e das últimas ameaças
                </li>
              </ul>
             </div>
