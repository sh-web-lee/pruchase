  ...
  $(function() {
    ...
    if (paramTo != 'buyascu') {
      var maskStatus = cGet('enascuanni_s');
      if (maskStatus != -1) {
  ...
  function getReTime() {
    var packsNumTotal = cGet('enascuanni_t');
    if (packsNumTotal > 1) {
  ...
  function timeInit() {
    if (cGet('enascuanni_s') == -1) {
      ...
      var date = new Date();
      var cName = "enascuanni_c";
      var arr = cGet("enascuanni_c");
