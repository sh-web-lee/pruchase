...
<head>
  ...
  <title>Adquira Advanced SystemCare Ultimate 13 para 3 PCs com 55% de desconto. Oferta Especial de Ano Novo da IObit.</title>
    ...
    <div class="wrapper">
        ...
        <div class="banner">
            ...
            <div class="banner-right fr">
                ...
                <p class="decri">Otimização e Antivírus para o seu PC em um único programa</p>
                ...
                <span class="banner-line"></span>
                <a class="buy-btn"
                   href="https://www.iobit.com/buy.php?product=pt-ascu133pc8999&ref=pt_ascu133pc1912<?php echo $refStr;?>&refs=pt_purchase_ascu"
                   onclick="ga('send', 'event', 'ascubuy', 'buy', 'ascu133pcpurchase1911-pt')">
                  COMPRAR AGORA
                </a>
...
<div class="bottom-buy wrapper clearfix">
  ...
  <h3>Assine por um ano e leve Advanced SystemCare Ultimate 13 para 2 PCs Extras</h3>
  <div class="box-contain">
    <img src="<?php echo getStaticUrl('images/boxsort-ascu-small.png')?>" alt=""/>
