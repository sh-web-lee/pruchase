...
<head>
  ...
  <title>Disfruta de 80% de descuento y regalos gratis en Advanced SystemCare Ultimate – IObit</title>
...
<div class="banner">
  <div class="wrapper clearfix">
    ...
    <div class="right-message fr">
      ...
      <!-- price -->
      <p class="price">
        <del>119,93€</del> <strong>22</strong><b>,95€</b><br>
        ¡Se ahorra 96,98€!
      </p>
      <!-- ribbon -->
      <i class="ribbon"></i>
      <!-- buybtn -->
      <a class="buybtn"
         href="https://www.iobit.com/buy.php?product=es-ascu123pcsdpf2295&ref=es_ascu123pcsdpf1901<?php echo $refStr;?>&refs=es_purchase_ascu"
         onclick="ga('send', 'event', 'ascubuy', 'buy', 'ascupurchase1901-es')">
...
<div class="betweenbuy clearfix">
  <!-- title -->
  <p><span>80% DTO.</span> para activar Advanced SystemCare Ultimate 12 hoy,</p>
