...
<head>
  ...
  <title>Zaoszczędź do 80% na Advanced SystemCare Ultimate – IObit</title>
...
<div class="banner">
  ...
  <div class="wrapper">
    ...
    <!-- title -->
    <h1>
      WYJĄTKOWA OFERTA SPECJALNIE DLA CIEBIE!
    </h1>
    <div class="left-box">
    ...
    <div class="right-box">
      ...
      <dl>
        ...
        <dd><strong>IObit Uninstaller 10 PRO</strong> <del>119,90 zł</del></dd>
    ...
    <dl class="price">
      ...
      <dd>
        <a href="http://www.iobit.com/buy.php?product=pl-au133pciusdpf109&ref=pl_au123pcsdiupf109purchase2011<?php echo $refStr;?>&refs=pl_purchase_au" 
           onclick="ga('send', 'event', 'ascubuy', 'buy', 'ascuxmas1912-pl');" class="buybtn">Kup teraz</a>
      </dd>
...
<div class="gift-box">
  <div class="wrapper clearfix">
    <!-- gift-box title -->
    <h2>Ekskluzywny świąteczny pakiet prezentów, nie przegap go!</h2>
    <!-- SD -->
    <dl>
    ...
    <div class="betwwen-buy">
      <div class="content">
        ...
        <dl>
          ...
          <dd><a href="http://www.iobit.com/buy.php?product=pl-au133pciusdpf109&ref=pl_au123pcsdiupf109purchase2011<?php echo $refStr;?>&refs=pl_purchase_au" 
                 onclick="ga('send', 'event', 'ascubuy', 'buy', 'ascuxmas1912-pl');" class="buybtn red">KUP TERAZ <span>–80%</span> </a></dd>
