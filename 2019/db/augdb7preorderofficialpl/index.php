      ...
      <div class="offer clearfix">
        ...
        <div class="right fl">
          ...
          <ul class="price clearfix">
            ...
            <li class="last">
              <a class="buybtn"
                 href="https://www.iobit.com/buy.php?product=pl-db7preorder&ref=pl_db7preorderofficial<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=pl_purchase_db"
                 onclick="ga('send', 'event', 'dbbuy', 'buy', 'db7preorderofficial-pl');">
                Zamów już teraz
              </a>
            </li>
          </div>
  ...
  <div class="function-wrap">
    <div class="wrapper">
      ...
      <div class="db-message">
        <h2>Proces inteligentnej aktualizacji dla ponad <span>3 500 000</span> sterowników</h2>
        <div class="screenshot">
          <img src="<?php echo getStaticUrl('images/screenshot.png')?>" alt="" class="img-box">
          <div class="maglist one">
            <h3><big>Automatyczna</big> aktualizacja sterowników</h3>
            <span class="tag">tylko PRO</span>
            <p>Automatycznie sprawdzaj stan sterowników zgodnie z harmonogramem oraz aktualizuj je podczas bezczynności systemu.</p>
          </div>
          <div class="maglist two">
            <h3><big>Szybka</big> aktualizacja <br> sterowników</h3>
            <span class="tag">tylko PRO</span>
            <p>
              Odblokuj pełną prędkość pobierania <br> sterowników i zaoszczędź czas.
            </p>
          </div>
          <div class="maglist three">
            <h3><big>Bezpieczna</big> aktualizacja sterowników</h3>
            <span class="tag">tylko PRO</span>
            <p>
              Utwórz punkt przywracania systemu i wykonaj kopię zapasową poprzednich sterowników, aby zagwarantować bezpieczną aktualizację i zapobiec nieoczekiwanym wydarzeniom.
            </p>
          </div>
        </div>
      </div>
      <div class="db-feature">
        <h2>Może więcej niż aktualizator sterowników</h2>
        <div class="featlist one">
          <div class="inner">
            <img src="<?php echo getStaticUrl('images/feature-icons01.png')?>" alt=""/>
            <h3>Poprawia <br> wydajność gry </h3>
            <span class="tag">tylko PRO</span>
            <p>Aktualizuje sterowniki do gier i zaleca odpowiednie ich komponenty, aby naprawić powolne ładowanie i słabą wydajność.</p>
          </div>
        </div>
        <div class="featlist two">
          <div class="inner">
            <img src="<?php echo getStaticUrl('images/feature-icons02.png')?>" alt=""/>
            <h3>Rozwiązuje problemy <br> ze sprzętem </h3>
            <span class="tag">tylko PRO</span>
            <p>Wystarczy jedno kliknięcie w celu wykrycia i naprawy błędów urządzenia, takich jak „Windows nie może zidentyfikować urządzenia”, „urządzenie jest wyłączone” lub „urządzenie nie działa” itp.</p>
          </div>
        </div>
        <div class="featlist three">
          <div class="inner">
            <img src="<?php echo getStaticUrl('images/feature-icons03.png')?>" alt=""/>
            <h3>Nie <br> przeszkadza</h3>
            <span class="tag red">Nowość</span>
            <p>Automatycznie wycisza wszystkie powiadomienia Driver Booster, gdy uruchomione są zadanie pełnoekranowe lub program ze specjalnej listy.</p>
          </div>
        </div>
      </div>
    </div>
