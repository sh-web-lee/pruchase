...
function soldout() {
  ...
  $(".floatlayer .numbox").html('Soyez le premier à obtenir Driver Booster 7 PRO pour des <br> performances optimales sur PC et les jeux ');
	$(".comparison h4").text("PROFITEZ DE TOUTES LES FONCTIONNALITES PRO MAINTENANT");
	$(".buybtn").attr({
		"href": 'https://www.iobit.com/buy.php?product=fr-db7preorder2499&ref=fr_db7preorder2499pre'+refStr+'&aff=' + aff + '&refs=fr_purchase_db&tw=' + tw,
		"onclick": "ga('send', 'event', 'db3pcbuy', 'buy', 'db7preorderpre-fr');"
	});
}
