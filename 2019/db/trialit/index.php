  ...
  <div class="wrapper">
    ...
    <div class="panel clearfix">
      ...
      <div class="box">
        ...
        <!-- db 1anno/1pc buybtn -->
        <a href="http://www.iobit.com/buy.php?product=it-db81pc2499&ref=it_db81pc2499purchase1809ctrial<?php echo $refStr;?>&refs=it_purchase_db"
           onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase1PC1809ctrial-it')"
           class="buybtn db-box">
          <i></i>
      ...
      <div class="box gift-box">
        ...
        <a href="http://www.iobit.com/buy.php?product=it-db83pcsdpf2499&ref=it_db83pcsdpf2499purchase1809ctrial<?php echo $refStr;?>&refs=it_purchase_db"
           onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase3PCsdpf1809ctrial-it')"
           class="buybtn">
          <i></i>
      ...
      <div class="box three-pc ">
        ...
        <!-- db 1anno/3pc buybtn -->
        <a href="http://www.iobit.com/buy.php?product=it-db83pc2599&ref=it_db83pc2599purchase1809ctrial<?php echo $refStr;?>&refs=it_purchase_db"
           onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase3PC1809ctrial-it')"
           class="buybtn db-box">
          <i></i>
          <span>ACQUISTA ORA</span>
        </a>
    ...
    <tr>
      ...
      <th class="itemb">
        ...
        <a class="buybtn other"
           href="http://www.iobit.com/buy.php?product=it-db83pc2599&ref=it_db83pc2599purchase1809ctrial<?php echo $refStr;?>&refs=it_purchase_db"
           onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase3PC1809ctrial-it')">
      ...
      <th class="itemc">
        ...
        <a class="buybtn other shadow"
           href="http://www.iobit.com/buy.php?product=it-db83pcsdpf2499&ref=it_db83pcsdpf2499purchase1809ctrial<?php echo $refStr;?>&refs=it_purchase_db"
           onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase3PCsdpf1809ctrial-it')">
          <i class="all-icons"></i> Acquista Ora
        </a>
...
<script>
  ...
  var _href = "http://www.iobit.com/buy.php?product=it-db83pc2599&ref=it_db83pc2599purchase1809ctrial<?php echo $refStr;?>&refs=it_purchase_db";
  var _ga = "ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase3PC1809ctrial-it')";
