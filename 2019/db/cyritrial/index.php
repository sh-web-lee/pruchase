...
if($_GET['type']=='free'&&$_GET['to']=='trialbuy_13'){
	header("location:https://purchase.iobit.com/aff/en/db/2019launchsale/cyri.php".(empty($_SERVER['QUERY_STRING'])?'':('?'.$_SERVER['QUERY_STRING'])));
}
				...
				<div class="offer left">
					...
					<div class="price">
						...
						<a class="buybtn nonshadow"
						   href="https://www.iobit.com/buy.php?product=driverbooster8cyri&ref=<?= $ref; ?>-db3pctrial<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_db"
						   onclick="ga('send', 'event', 'cyridb3pcbuy', 'buy', 'dbpurchase-trial1')">
				...
				<div class="offer right">
					...
					<div class="price">
						...
						<a class="buybtn shadow"
						   href="https://www.iobit.com/buy.php?product=db8sdiupfcyri&ref=<?= $ref; ?>-db3pcsdiupftrial<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_db"
						   onclick="ga('send', 'event', 'cyridbbundlebuy', 'buy', 'dbpurchase- trial1')">
	  ...
	  <table>
	    ...
	    <tbody>
	      ...
	      <tr>
	        ...
	        <td class="virtue">Advanced Game Boost feature</td>
	        <td class="itema"><i class="all-icons">√</i></td>
	        <td class="space"></td>
	        <td class="itemb"><i class="all-icons black">√</i></td>
	        <td class="space"></td>
...
<script>
	...
	var _href = "https://www.iobit.com/buy.php?product=driverbooster8cyri&ref=<?= $ref; ?>-db3pctrial<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_db&tw=-8";
	var _ga="ga('send', 'event', 'cyridb3pcsoldoutbuy', 'buy', 'dbpurchase-trial1');";
	var transDataJson='<?php echo base64_decode($_GET['tdata']);?>';
