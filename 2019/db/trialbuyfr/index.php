			...
			<div class="offer clearfix">
				...
				<div class="right fr">
					...
					<ul class="price clearfix">
						...
						<li class="last">
							<a class="buybtn" 
							   href="https://www.iobit.com/buy.php?product=db7spin3pcfr&ref=fr_trialdb83pc1999<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=fr_purchase_db"
							   onclick="ga('send', 'event', 'db3pcbuy', 'buy', 'dbpurchase-trialbuy-fr')">
