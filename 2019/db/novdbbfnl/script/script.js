...
function soldOut() {
  ...
  $(".price,.numbox").addClass("soldout");
  $(".banner .numbox").remove();
  $(".floatlayer .numbox").html('Helaas, <b>-77%</b> deal is uitverkocht');
  $(".change-price").html("€<big>19</big>,99");
  $(".price strong").html("€<b>19</b>,99");
  $(".discount").addClass("soldout");
  $(".banner .buybtn small").text("- €19,99");
  $(".buybtn").attr({
    "href": 'https://www.iobit.com/buy.php?product=db7spin3pcnl&ref=nl_db73pcblackfriday1999purchase1911'+refStr+'&aff=&refs=nl_purchase_db',
    "onclick": "ga('send', 'event', 'dbbuy', 'buy', 'dbblackfriday1999-nl');"
  });
}
// soldOut();
