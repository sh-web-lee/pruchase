...
<head>
	...
	<title>Save 77% on Driver Booster PRO + Free Gifts - IObit</title>
	...
	<div class="wrapper clearfix">
		...
		<div class="message box ">
			<div class="top-message">
				...
				<h2>67% OFF</h2>
				<p><strong>$<b>24</b>.95</strong>  was <del>$74.85</del></p>
				<a href="https://www.iobit.com/buy.php?product=driverbooster62495&ref=db63pc2019usb<?php echo $refStr?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_db" onclick="ga('send', 'event', 'db3pcbuyusb', 'buy', 'dbpurchase-201901') " class="buybtn"><i></i> <span>Activate Now</span></a>
		...
		<div class="gift-box message">
			<div class="top-message">
				...
				<h2>77% OFF</h2>
				<p><strong>$<b>26</b>.95</strong>  was <del>$114.83</del></p>
				<a href="https://www.iobit.com/buy.php?product=db6sdiupf2695&ref=db6bundle2019usb<?php echo $refStr?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_db" onclick="ga('send', 'event', 'db2695buyusb', 'buy', 'dbpurchase-201901')" class="buybtn"><i></i> <span>Activate Now</span></a>
...
<div class="between-buy">
	<div class="wrapper">
		<div class="content">
			<h2 class="">SAVE 77% to Activate Now to Enjoy More Stable PC!</h2>
			<p>Now <strong>$26.95</strong> Was <del>$114.83</del></p>
			<a href="https://www.iobit.com/buy.php?product=db6sdiupf2695&ref=db6bundle2019usb<?php echo $refStr?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_db" onclick="ga('send', 'event', 'db2695buyusb', 'buy', 'dbpurchase-201901')" class="buybtn save"><i></i> Activate Now</a>
...
<div class="comparison">
	<div class="wrapper">
		...
		<table>
			...
			<th class="itema"></th>
			<th class="itemb">
				Only <strong>$26.95</strong>
				<a href="https://www.iobit.com/buy.php?product=db6sdiupf2695&ref=db6bundle2019usb<?php echo $refStr?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_db" onclick="ga('send', 'event', 'db2695buyusb', 'buy', 'dbpurchase-201901')" class="buybtn"><i></i>
...
<div class="floatlayer" id="floatlayer">
	<div class="wrapper clearfix">
		...
		<div class="right">
			...
			<a class="buybtn" href="https://www.iobit.com/buy.php?product=db6sdiupf2695&ref=db6bundle2019usb<?php echo $refStr?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_db" onclick="ga('send', 'event', 'db2695buyusb', 'buy', 'dbpurchase-201901')">Activate Now</a>
		</div>
	</div>
</div>
<div class="float">
