...
function soldOut() {
	...
	$(".banner .gift-box strong b").html("24")
	$(".banner .gift-box del,.between-buy del").html("$74.85")
	$(".banner .gift-box p:eq(1)").html("only $2.08 / Month")
	$(".banner .gift-box p:eq(2)").html("$49.9 Saved")
	...
	$(".between-buy p strong,.comparison th strong").html("$24.95")
	$(".buybtn").attr("href","https://www.iobit.com/buy.php?product=driverbooster62495&ref=db63pcsoldout2019usb"+refStr+"&aff=" + aff + "&refs=purchase_db&tw=" + tw)
	$(".buybtn").attr("onclick","ga('send', 'event', 'db3pcsoldbuyusb', 'buy', 'dbpurchase-201901')")
}
