...
function soldOut() {
	...
	$(".buybtn").attr("href","https://www.iobit.com/buy.php?product=driverbooster6&ref=db63pcsoldout2019tka"+refStr+"&aff=" + aff + "&refs=purchase_db&tw=" + tw);
	$(".buybtn").attr("onclick","ga('send', 'event', 'dbsoldbuy', 'buy', 'dbpurchase-tka')");
}
...
function timeInit(){
	var date = new Date();
	var cName = "endbstate_a" + date.getDate();
