	...
	<div class="wrapper clearfix">
		...
		<div class="message box ">
			<div class="top-message">
				...
				<a href="https://www.iobit.com/buy.php?product=driverbooster6&ref=db63pc2019tka<?php echo $refStr?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_db" onclick="ga('send', 'event', 'db3pcbuy', 'buy', 'dbpurchase-tka') " class="buybtn"><i></i> <span>Activate Now</span></a>
		...
		<div class="gift-box message">
			<div class="top-message">
				...
				<h2>80% OFF</h2>
				<p><strong>$<b>24</b>.95</strong>  was <del>$134.78</del></p>
				<a href="https://www.iobit.com/buy.php?product=db6sdiupf&ref=db6bundle2019tka<?php echo $refStr?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase-tka')  " class="buybtn"><i></i> <span>Activate Now</span></a>
...
<div class="between-buy">
	<div class="wrapper">
		<div class="content">
			...
			<p>Now <strong>$24.95</strong> Was <del>$134.78</del></p>
			<a href="https://www.iobit.com/buy.php?product=db6sdiupf&ref=db6bundle2019tka<?php echo $refStr?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase-tka')  " class="buybtn save"><i></i> Activate Now</a>
	...
	<div class="wrapper">
		...
		<table>
			...
			<th class="itemb">
				...
				<a href="https://www.iobit.com/buy.php?product=db6sdiupf&ref=db6bundle2019tka<?php echo $refStr?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase-tka')  " class="buybtn"><i></i>
...
<div class="floatlayer" id="floatlayer">
	<div class="wrapper clearfix">
		...
		<div class="right">
			...
			<a class="buybtn" href="https://www.iobit.com/buy.php?product=db6sdiupf&ref=db6bundle2019tka<?php echo $refStr?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase-tka')  ">Activate Now</a>
		</div>
	</div>
</div>
<div class="float">
