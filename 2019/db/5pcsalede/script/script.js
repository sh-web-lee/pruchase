...
function over() {
  var _href3 = $(".banner .box").eq(1).find(".buybtn").attr("href");
  var _ga3 = $(".banner .box").eq(1).find(".buybtn").attr("onclick");
  var _discount3 = "63 €";
  $(".footbuy li").removeClass("active");
  $(".footbuy .imgbox img").removeClass("active");
  $(".footbuy li").eq(2).addClass("sold");
  $(".footbuy li").eq(1).addClass("active");
  $(".footbuy .imgbox img").eq(1).addClass("active");
  $(".footbuy .imgbox").find(".point").remove();
  $(".banner .right").html('<div class="gray"></div><div class="ausbox"></div>');
  $(".footbuy li.five").addClass("default");
  $(".footbuy .buybtn").attr({
    "href": _href3,
    "onclick": _ga3
  });
  $(".footbuy .price .off").text(_discount3);
  setTimeout(function() {
