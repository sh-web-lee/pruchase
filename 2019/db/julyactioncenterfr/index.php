...
<div class="banner">
  <div class="wrapper">
    ...
    <div class="pricebox">
      <dl class="price">
        <dt>Seulement : <strong>9,99€ </strong><del>74,85€</del></dt>
        <dd>
          <a class="buybtn bigbtn"
             href="https://www.iobit.com/buy.php?product=fr-db81pc999&ref=fr_db-acb-register<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_ac_db"
             onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbac-fr');">
            <div class="inner">
              <i class="all-icons"></i>
  ...
  <div class="clearfix">
    <dl>
      ...
      <dd>
        ...
        <p>Détecte et met à jour plus de 4 500 000 pilotes en 1 clic afin d’améliorer la stabilité et les performances de votre ordinateur.</p>
      </dd>
    </dl>
    <dl class="right">
