...
function addUrl(name) {
	switch (name) {
		case "sd":
			$(".buybtn").attr({
				"href": "https://www.iobit.com/buy.php?product=db7sd&ref=en-db3pcsd" + refStr + "&aff=" + affStr + "&refs=purchase_db&tw=" + tw,
				"onclick": "ga('send', 'event', 'db6sdnewbuy', 'buy', 'dbsdpurchase-201904')",
			});
			break;
		case "iu":
			$(".buybtn").attr({
				"href": "https://www.iobit.com/buy.php?product=db7iu&ref=en-db3pciu" + refStr + "&aff=" + affStr + "&refs=purchase_db&tw=" + tw,
				"onclick": "ga('send', 'event', 'db6iunewbuy', 'buy', 'dbiupurchase-201904')",
			});
			break;
		case "iusd":
			$(".buybtn").attr({
				"href": "https://www.iobit.com/buy.php?product=db7sdiu&ref=en-db3pcsdiu" + refStr + "&aff=" + affStr + "&refs=purchase_db&tw=" + tw,
				"onclick": "ga('send', 'event', 'db6sdiunewbuy', 'buy', 'dbsdiupurchase-201904')",
			});
			break;
		default:
	}
...
function soldProduct() {
	...
	$(".buybtn").attr({
		"href": "https://www.iobit.com/buy.php?product=driverbooster72395&ref=en-db3pcsoldout" + refStr + "&aff=" + affStr + "&refs=purchase_db&tw=" + tw,
		"onclick": "ga('send', 'event', 'db6soldnewbuy', 'buy', 'dbsoldpurchase-201904')",
	});
	$(".subscript em").text("3");
}
// soldProduct();
		...
		if (!$(this).hasClass("on")) {
			...
			if (0 < length < 4) {
				...
				if (arrone === 1) {
					...
					$(".banner .price").append('<p class="only">only $1.99 / Month </p>');
					$(".buybtn").attr({
						"href": "https://www.iobit.com/buy.php?product=driverbooster72395&ref=en-db3pc" + refStr + "&aff=" + affStr + "&refs=purchase_db&tw=" + tw,
						"onclick": "ga('send', 'event', 'db6newbuy', 'buy', 'dbpurchase-201904')",
					});
					$(".banner .price .tips").remove();
				}
			}
...
$(document).ready(function() {
	...
	setTimeout('$(".banner .offer").addClass("on")', 800);
