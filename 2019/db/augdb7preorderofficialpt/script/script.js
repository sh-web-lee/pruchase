...
function soldout() {
	...
	$(".banner .numbox").html('<h4>Os pacotes de Pré-venda do Driver Booster terminaram por agora</h4><p>Mas ainda temos <b>70% de Desconto</b> para você</p>');
	...
	$(".buybtn").attr({
		"href": 'https://www.iobit.com/buy.php?product=pt-db7preorder7999&ref=pt-db7preorder7999official' + refStr + '&aff=' + aff + '&refs=pt_purchase_db&tw=-8',
		"onclick": "ga('send', 'event', 'db3pcbuy', 'buy', 'db7preorderofficial-pt');"
	});
}
// soldout();
