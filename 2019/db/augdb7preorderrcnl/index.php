      ...
      <div class="offer clearfix">
        ...
        <div class="right fl">
          ...
          <ul class="price clearfix">
            ...
            <li class="last">
              <a class="buybtn"
                 href="https://www.iobit.com/buy.php?product=nl-db7preorder1999&ref=nl_db7preorderrc<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=nl_purchase_db"
                 onclick="ga('send', 'event', 'dbbuy', 'buy', 'db7preorderrc-nl');">
                Bestel Nu
              </a>
            </li>
          </div>
      ...
      <div class="db-feature">
        ...
        <div class="featlist one">
          <div class="inner">
            ...
            <p class="red"><span class="one">Veilige Https-verbinding </span></p>
          </div>
        </div>
