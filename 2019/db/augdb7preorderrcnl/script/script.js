...
function soldout() {
  ...
  $(".floatlayer .db-box").attr("src", dbImg[1]);
	$(".buybtn").attr({
		"href": 'https://www.iobit.com/buy.php?product=nl-db7preorder2499&ref=nl_db7preorder2499rc'+refStr+'&aff=' + aff + '&refs=nl_purchase_db&tw=' + tw,
		"onclick": "ga('send', 'event', 'dbbuy', 'buy', 'db7preorderrcsoldout-nl');"
	});
}
