...
function addUrl(name) {
	switch (name) {
		case "sd":
			$(".buybtn").attr({
				"href": "https://www.iobit.com/buy.php?product=db7sd&ref=db7sdnew" + refStr + "&aff=" + affStr + "&refs=purchase_db&tw=" + tw,
				"onclick": "ga('send', 'event', 'db6sdnewbuy', 'buy', 'dbsdpurchase-201904')",
			});
			break;
		case "iu":
			$(".buybtn").attr({
				"href": "https://www.iobit.com/buy.php?product=db7iu&ref=db7iunew" + refStr + "&aff=" + affStr + "&refs=purchase_db&tw=" + tw,
				"onclick": "ga('send', 'event', 'db6iunewbuy', 'buy', 'dbiupurchase-201904')",
			});
			break;
		case "iusd":
			$(".buybtn").attr({
				"href": "https://www.iobit.com/buy.php?product=db7sdiu&ref=db7sdiunew" + refStr + "&aff=" + affStr + "&refs=purchase_db&tw=" + tw,
...
function soldProduct() {
	...
	$(".buybtn").attr({
		"href": "https://www.iobit.com/buy.php?product=driverbooster72395&ref=db7soldnew" + refStr + "&aff=" + affStr + "&refs=purchase_db&tw=" + tw,
		...
		if (!$(this).hasClass("on")) {
			...
			if (0 < length < 4) {
				...
				if (arrone === 1) {
					...
					$(".banner .price").append('<p class="only">only $1.99 / Month </p>');
					$(".buybtn").attr({
						"href": "https://www.iobit.com/buy.php?product=driverbooster72395&ref=db7new" + refStr + "&aff=" + affStr + "&refs=purchase_db&tw=" + tw,
