...
<head>
  <meta charset="UTF-8">
  <title>Køb Driver Booster 7 PRO for 0kr.</title>
    ...
    <div class="offer clearfix">
      ...
      <div class="right fl">
        ...
        <ul class="price clearfix">
          ...
          <li class="last">
            <a class="buybtn"
               href="https://www.iobit.com/buy.php?product=dk-db7preorder30day&ref=dk_db7preorderofficial<?php echo $refStr; ?>&aff=<?php echo $_GET['aff']; ?>&refs=dk_purchase_db"
               onclick="ga('send', 'event', 'dbbuy', 'buy', 'db7preorderofficial-dk');">
              Forudbestil nu
            </a>
          </li>
      </div>
...
<div class="function-wrap">
  <div class="wrapper">
    <h2 class="why">
      Det er den bedste Driver Updater <br> du kan tænke dig <span class="arrow-wrap"><i class="top"></i><i class="bot"></i></span>
    </h2>
    <div class="db-message">
      <h2 style="font-size: 28px;">Intelligent opdateringsproces for at holde <span>3,500,000+</span> drivere opdateret</h2>
      <div class="screenshot">
        <img src="<?php echo getStaticUrl('images/screenshot.png') ?>" alt="" class="img-box">
        <div class="maglist one">
          <h3><big>Sikker </big> drevopdatering</h3>
          <span class="tag">kun PRO</span>
          <p>Opretter gendannelsespunkt for dit system og sikkerhedskopierer tidligere drev inden opdatering for sikkerhedsgaranti og undgå uforudsete omstændigheder.</p>
        </div>
        <div class="maglist two">
          <h3><big>Hurtig</big> drevopdatering</h3>
          <span class="tag">kun PRO</span>
          <p>Få fuld downloadhastighed af drev og spar tid.</p>
        </div>
        <div class="maglist three">
          <h3><big>Automatisk</big> drevopdatering</h3>
          <span class="tag">kun PRO</span>
          <p>Tjekker drevtilstanden automatisk efter tidsplan og opdaterer drev automatisk, når dit system er ledigt.</p>
        </div>
      </div>
    </div>
    <div class="db-feature">
      <h2>Det gør mere end en Driver Updater</h2>
      <div class="featlist one">
        <div class="inner">
          <img src="<?php echo getStaticUrl('images/feature-icons01.png') ?>" alt="" />
          <h3>Forbedrer spilpræstationer</h3>
          <span class="tag">kun PRO</span>
          <p>Holder spilklare drev opdaterede og anbefaler passende spilkomponenter til f.eks. at rette langsom spilindlæsning og dårlig spilpræstationer.</p>
        </div>
      </div>
      <div class="featlist two">
        <div class="inner">
          <img src="<?php echo getStaticUrl('images/feature-icons02.png') ?>" alt="" />
          <h3>Løser <br> hardware-problemer</h3>
          <span class="tag">kun PRO</span>
          <p>Kun 1 klik til at opfange og reparere enhedsfejl såsom; Windows kan ikke identificere en enhed, enheden er ikke sat til eller enheden virker ikke m.fl.</p>
        </div>
      </div>
      <div class="featlist three">
        <div class="inner">
          <img src="<?php echo getStaticUrl('images/feature-icons03.png') ?>" alt="" />
          <h3>Undgå <br> forstyrrelser</h3>
          <span class="tag red">Ny</span>
          <p>Sætter Driver Boosters notifikationer på lydløs automatisk når et program er i brug eller kører på fuldskærm.</p>
        </div>
      </div>
    </div>
  </div>
