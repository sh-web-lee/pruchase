...
function soldout() {
	...
	$(".buybtn").attr({
		"href": 'https://www.iobit.com/buy.php?product=sv-db7preorder329&ref=sv_db7preorder329official'+refStr+'&aff=' + aff + '&refs=sv_purchase_db&tw=-8',
		"onclick": "ga('send', 'event', 'db3pcbuy', 'buy', 'db7preorderofficial-sv');"
	});
}
