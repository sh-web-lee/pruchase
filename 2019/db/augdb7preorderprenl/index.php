...
<body>
      ...
      <div class="offer clearfix">
        ...
        <div class="right fl">
          ...
          <ul class="price clearfix">
            ...
            <li class="last">
              <a class="buybtn"
                 href="https://www.iobit.com/buy.php?product=nl-db7preorder1999&ref=nl_db7preorderpre<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=nl_purchase_db"
                 onclick="ga('send', 'event', 'dbbuy', 'buy', 'db7preorderpre-nl');">
                Bestel Nu
              </a>
            </li>
          </div>
  ...
  <div class="function-wrap">
    <div class="wrapper">
      <h2 class="why">
        Waarom Upgraden Naar<br> Driver Booster 7 PRO? <span class="arrow-wrap"><i class="top"></i><i class="bot"></i></span>
      </h2>
      <div class="db-message">
        <h2>Verhelp Alle Drivergerelateerde Computerproblemen</h2>
        <div class="screenshot">
          <div class="maglist one">
            <h3><big>Verhelp</big> Laggende games</h3>
            <p>
              Update Game Ready Drivers en geschikte gamecomponenten om traag laden en lage prestaties van games te verhelpen.
            </p>
            <span class="tag">Alleen PRO</span>
          </div>
          <div class="maglist two">
            <h3><big>Verhelp</big> Crashes</h3>
            <p>
              Scan 3.500.000+ drivers en houd ze up-to-date om blauwe schermen, systeemcrashes en andere problemen te voorkomen en verhelpen.
            </p>
            <span class="tag">PRO Verhelpt Meer</span>
          </div>
          <div class="maglist three">
            <h3><big>Verhelp</big> Apparaatfouten</h3>
            <p>
              Detecteer en repareer apparaatfouten in 1 klik om driverproblemen, systeembron conflicten en andere hardwareproblemen te herstellen.
            </p>
            <span class="tag last">Alleen PRO</span>
          </div>
        </div>
      </div>
      <div class="db-feature">
        <span class="arrow-wrap"><i class="top"></i><i class="bot"></i></span>
        <h2>Automatisch & Veilig Driver Update Proces</h2>
        <div class="featlist one">
          <div class="inner">
            <img src="<?php echo getStaticUrl('images/feature-icons01.png')?>" alt=""/>
            <h3>SCAN</h3>
            <p>automatisch uw drivers om ze altijd up-to-date te houden.</p>
            <p class="red"><span>Veilige Https-verbinding </span></p>
          </div>
        </div>
        <div class="featlist two">
          <div class="inner">
            ...
            <h3>DOWNLOAD</h3>
            <p>automatisch drivers als het systeem inactief is.</p>
            <p class="red"><span>Alleen drivers die voldoen aan <br> WHQL & IObit eisen </span></p>
          </div>
        </div>
        <div class="featlist three">
          <div class="inner">
            ...
            <h3>INSTALLEER</h3>
            <p>automatisch drivers als het systeem inactief is.</p>
            <p class="red"><span class="one">Back-up vorige drivers</span></p>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="comparison">
    <div class="wrapper">
      <span class="arrow-wrap"><i class="top"></i><i class="bot"></i></span>
      <h2>Driver Booster 7 PRO Biedt Meer</h2>
      <table>
        <thead>
        <tr>
          <th class="text"></th>
        ...
        <tbody>
        <tr>
          <td class="text"><img src="<?php echo $pResUrl;?>images/icon01.png" alt=""> Driver database</td>
          <td class="itema">2.500.000+</td>
          <td class="space"></td>
          <td class="itemb">3.500.000+</td>
        </tr>
        <tr>
          <td class="text"><img src="<?php echo $pResUrl;?>images/icon02.png" alt=""> Boost driver downloadsnelheid</td>
          <td class="itema"></td>
          <td class="space"></td>
          <td class="itemb"></td>
        </tr>
        <tr>
          <td class="text"><img src="<?php echo $pResUrl;?>images/icon03.png" alt=""> Automatisch scannen en updaten op gepland moment</td>
          <td class="itema"></td>
          <td class="space"></td>
          <td class="itemb"></td>
        </tr>
        <tr>
          <td class="text"><img src="<?php echo $pResUrl;?>images/icon04.png" alt=""> Back-up vorige drivers</td>
          <td class="itema"></td>
          <td class="space"></td>
          <td class="itemb"></td>
        </tr>
        <tr>
          <td class="text"><img src="<?php echo $pResUrl;?>images/icon05.png" alt=""> Update spelcomponenten</td>
          <td class="itema"></td>
          <td class="space"></td>
          <td class="itemb"></td>
        </tr>
        <tr>
          <td class="text"><img src="<?php echo $pResUrl;?>images/icon06.png" alt=""> Voorrang op Game Ready Drivers</td>
          <td class="itema"></td>
          <td class="space"></td>
          <td class="itemb"></td>
        </tr>
        <tr>
          <td class="text"><img src="<?php echo $pResUrl;?>images/icon07.png" alt=""> Voorkom hardwareproblemen</td>
          <td class="itema"></td>
          <td class="space"></td>
          <td class="itemb"></td>
        </tr>
      ...
      <h4>Verkrijg Nu Alle Pro Functies met Hoge Korting</h4>
      <a class="buybtn"
         href="https://www.iobit.com/buy.php?product=nl-db7preorder1999&ref=nl_db7preorderpre<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=nl_purchase_db"
         onclick="ga('send', 'event', 'dbbuy', 'buy', 'db7preorderpre-nl');">
        Bestel Nu
