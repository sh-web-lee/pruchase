...
function soldout() {
	...
	$(".buybtn").attr({
		"href": 'https://www.iobit.com/buy.php?product=nl-db7preorder2499&ref=nl_db7preorder2499pre' + refStr + '&aff=' + aff + '&refs=nl_purchase_db&tw=' + tw,
		"onclick": "ga('send', 'event', 'dbbuy', 'buy', 'db7preorderpresoldout-nl');"
	});
}
...
function getReTime() {
	var packsNumTotal = cGet('nldbpre_t');
	if (packsNumTotal > 1) {
