  ...
  <div class="wrapper">
    ...
    <div class="content">
      ...
      <div class="right-message fr">
        ...
        <!-- buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=es-db83pcpfsd1999&ref=es_trialdb83pcpfsd<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=es_purchase_db"
           onclick="ga('send', 'event', 'dbbundlebuy', 'buy', 'dbpurchase-trial1-es')">
          Cómpralo ya
        </a>
        <!-- attention -->
