...
function soldout() {
  ...
  $(".floatlayer .numbox").html('Kaufen Sie den neuen Driver Booster 7 PRO <br> für eine bessere PC- und Gaming-Leistung');
	$(".comparison h4").text("Jetzt upgraden, um alle PRO-Features zu aktivieren");
	$(".buybtn").attr({
		"href": 'https://www.iobit.com/buy.php?product=de-db7preorder2699&ref=de_db7preorder2699pre'+refStr+'&aff=' + aff + '&refs=de_purchase_db&tw=' + tw,
		"onclick": "ga('send', 'event', 'db3pcbuy', 'buy', 'db7preorderpre-de');"
	});
}
