    ...
    <div class="content clearfix">
      ...
      <dl class="fl">
        ...
        <dd>
          ...
          <!-- 1pc buybtn -->
          <a class="buybtn"
             href="https://www.iobit.com/buy.php?product=dk-db81pc189&ref=dk_db1pcpurchase202009<?php echo $refStr;?>&refs=dk_purchase_db"
             onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase1904-dk');">
            Køb nu
          </a>
        </dd>
      </dl>
      ...
      <dl class="fl large">
        ...
        <dd>
          ...
          <a class="buybtn black"
             href="https://www.iobit.com/buy.php?product=dk-db83pcsd199&ref=dk_db3pcbundle202009<?php echo $refStr;?>&refs=dk_purchase_db"
             onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase1904-dk');">
            Køb nu
          </a>
          <!-- person -->
      ...
      <dl class="fr">
        ...
        <dd>
          ...
          <!-- 3pc buybtn -->
          <a class="buybtn"
             href="https://www.iobit.com/buy.php?product=dk-db83pc199&ref=dk_db3pcpurchase202009<?php echo $refStr;?>&refs=dk_purchase_db"
             onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase1904-dk');">
            Køb nu
          </a>
        </dd>
...
<div class="gifts">
  <div class="wrapper">
    ...
    <!-- message -->
    <dl class="clearfix">
      <dt class="fl"><img src="<?php echo getStaticUrl('images/gifts-sd.png')?>" alt="Smart Defrag PRO 6"></dt>
      <dd class="fl">
  ...
  <div class="wrapper clearfix">
    ...
    <ul class="selector fl">
      ...
      <li class="active clearfix"
          data-url="https://www.iobit.com/buy.php?product=dk-db83pcsd199&ref=dk_db3pcbundle202009<?php echo $refStr;?>&refs=dk_purchase_db"
          data-price="199,-"
          data-del="1.058,-">
        3 pc`er+ Smart Defrag
        <strong>-85%</strong>
      </li>

      <!-- 3pc -->
      <li class="clearfix"
          data-url="https://www.iobit.com/buy.php?product=dk-db83pc199&ref=dk_db3pcpurchase202009<?php echo $refStr;?>&refs=dk_purchase_db"
          data-price="199,-"
          data-del="679,-">
        3 pc`er
        <strong>-70%</strong>
      ...
      <!-- 1pc -->
      <li class="clearfix"
          data-url="https://www.iobit.com/buy.php?product=dk-db81pc189&ref=dk_db1pcpurchase202009<?php echo $refStr;?>&refs=dk_purchase_db"
          data-price="189,-"
          data-del="399,-">
        1 pc
        <strong>-52%</strong>
