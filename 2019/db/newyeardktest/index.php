    ...
    <div class="wrapper">
      ...
      <div class="clearfix">
        ...
        <div class="right fr">
          ...
          <div class="choice">
            <div class="list pcs active" data-url="https://www.iobit.com/buy.php?product=dk-db63pcpf199&ref=dk_db3pcpfpurchase1901test&refs=dk_purchase_db" data-off=" kr. 879" data-percent="80%">
              <div class="fl">
            ...
            <div class="list pc" data-url="https://www.iobit.com/buy.php?product=dk-db61pc189&ref=dk_db1pcpurchase1901test&refs=dk_purchase_db" data-off="kr. 210" data-percent="52%">
              <div class="fl">
                <h3>Driver Booster PRO</h3>
                <b>1 pc, 1 år </b>
              </div>
          ...
          <a class="buybtn" 
             href="https://www.iobit.com/buy.php?product=dk-db63pcpf199&ref=dk_db3pcpfpurchase1901test&refs=dk_purchase_db"
             onclick="ga ('send', 'event', 'dbbuy', 'buy', dbpurchase1901test-dk')">
            Køb nu
          </a>
          <p>
            <i class="all-icons"></i>
...
<div class="pop">
   <h4><a class="smaller" href="javascript::">- minimer</a> <a class="close" href="javascript::">x luk</a></h4>
    ...
    <!-- buybtn -->
    <a class="buybtn" href="https://www.iobit.com/buy.php?product=dk-db63pcpf189&ref=dk_dbpfpurchase1901popuptest&refs=dk_purchase_db" onclick="ga ('send', 'event', 'dbbuy', 'buy', dbpurchase1901popuptest-dk')">
