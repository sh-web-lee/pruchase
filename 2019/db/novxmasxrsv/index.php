...
<head>
  ...
  <title>Spara 86% rabatt på Driver Booster PRO och få extra skydd på köpet. Stor Julrea - IObit</title>
...
<body>
    ...
    <div class="wrapper clearfix">
      ...
      <div class="right fr">
        <div class="chart">
          ...
          <div class="clist two">
            <span class="cost"><strong><big>279</big> kr</strong></span>
            <span class="line"></span>
            <span class="point"></span>
        ...
        <div class="price">
          <p><strong><big>279</big> kr</strong> <del>2 056 kr</del></p>
          <a class="buybtn"
             href="https://www.iobit.com/buy.php?product=sv-db73pcpfsdisu279&ref=sv_db73pcpfsdisuxmaspurchase1911xr<?php echo $refStr;?>&refs=sv_purchase_db"
             onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbxrpurchasexmas1911-sv')">
            KÖP NU
          </a>
        </div>
      </div>
  ...
  <div class="gifts">
    <div class="wrapper clearfix">
      <h2>BETALA ETT RABATTERAT PRIS OCH FÅ TRE! *</h2>
      <h3>ALLT DU VILL HA FÖR DIN DATOR ÄR HÄR, PÅ DIN KLICK!</h3>
      <dl class="iu">
        <dt>
          <span class="ribbon"></span>
          <img src="<?php echo getStaticUrl('images/gifts-isu.png')?>" alt="IObit Software Updater PRO"/>
        </dt>
        <dd>
  ...
  <div class="centbuy price wrapper">
    <p><strong>279 kr</strong> <del>2 056 kr</del></p>
    <p>JULPRIS </p>
    <a class="buybtn"
       href="https://www.iobit.com/buy.php?product=sv-db73pcpfsdisu279&ref=sv_db73pcpfsdisuxmaspurchase1911xr<?php echo $refStr;?>&refs=sv_purchase_db"
       onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbxrpurchasexmas1911-sv')">
