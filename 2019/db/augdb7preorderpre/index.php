...
if ($_GET['action'] == 'getPacks') {
  $date = $_GET['d'];
  $c_name = 'endbpre_p' . $date;
  $c_name_t='endbpre_t' . $date;
    ...
    <div class="offer clearfix">
      ...
      <div class="right fl">
        ...
        <ul class="price clearfix">
          ...
          <li class="last">
            <a class="buybtn"
               href="https://www.iobit.com/buy.php?product=db7preorder&ref=db7preorderpre<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_db"
               onclick="ga('send', 'event', 'dbbuy', 'buy', 'db7preorderpre');">
              Pre-order Now
            </a>
          </li>
      </div>
...
<div class="comparison">
  <div class="wrapper">
    <span class="arrow-wrap"><i class="top"></i><i class="bot"></i></span>
    <h2>Absolutely Driver Booster 7 PRO Gives You More </h2>
    <table>
      <thead>
      <tr>
        <th class="text"></th>
      ...
      <tr>
        <td class="text"><img src="<?php echo $pResUrl;?>images/icon02.png" alt=""> Boost driver download speed	</td>
        <td class="itema"></td>
        <td class="space"></td>
        <td class="itemb"></td>
      </tr>
      <tr>
        <td class="text"><img src="<?php echo $pResUrl;?>images/icon03.png" alt=""> Auto scan and update as scheduled</td>
        <td class="itema"></td>
        <td class="space"></td>
        <td class="itemb"></td>
      </tr>
      <tr>
        <td class="text"><img src="<?php echo $pResUrl;?>images/icon04.png" alt=""> Backup previous drivers</td>
        <td class="itema"></td>
        <td class="space"></td>
        <td class="itemb"></td>
      </tr>
      <tr>
        <td class="text"><img src="<?php echo $pResUrl;?>images/icon05.png" alt=""> Update game components</td>
        <td class="itema"></td>
        <td class="space"></td>
        <td class="itemb"></td>
      </tr>
      <tr>
        <td class="text"><img src="<?php echo $pResUrl;?>images/icon06.png" alt=""> Priority to update game-ready drivers</td>
        <td class="itema"></td>
        <td class="space"></td>
        <td class="itemb"></td>
      </tr>
      <tr>
        <td class="text"><img src="<?php echo $pResUrl;?>images/icon07.png" alt=""> Reduce hardware problems</td>
        <td class="itema"></td>
        <td class="space"></td>
        <td class="itemb"></td>
      </tr>
    ...
    <h4>Upgrade for <strong>$<big>0</big></strong> to Unlock All PRO Features Now</h4>
    <a class="buybtn"
       href="https://www.iobit.com/buy.php?product=db7preorder&ref=db7preorderpre<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_db"
       onclick="ga('send', 'event', 'dbbuy', 'buy', 'db7preorderpre');">
      Pre-order Now
