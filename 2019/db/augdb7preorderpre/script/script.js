...
function soldout() {
	...
	$(".comparison h4").text("Upgrade to Unlock All PRO Features Now");
	$(".buybtn").attr({
		"href": 'https://www.iobit.com/buy.php?product=db7preorder2295&ref=db7preorder2295pre'+refStr+'&aff=' + aff + '&refs=purchase_db&tw=' + tw,
		"onclick": "ga('send', 'event', 'db3pcbuy', 'buy', 'db7preorderpre');"
	});
}
