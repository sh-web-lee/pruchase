...
<head>
  ...
  <title>Dernière démarque ! Les soldes encore plus fort, jusqu'à -85% sur Driver Booster PRO et profitez d'un paquet cadeau à durée limitée !</title>
...
<div class="banner">
  <div class="wrapper">
    ...
    <!-- banner-title -->
    <h1 class="title">Dernière Démarque</h1>
    <!--
        banner-subtitle
    ...
    <ul class="content">
      ...
      <li id="db-1pc" class="on-left">
        ...
        <!-- buybtn -->
        <a class="buybtn cart"
           href="https://www.iobit.com/buy.php?product=fr-db61y3pc2699&ref=fr_db61y3pc2699purchase1901<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_db"
           onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase1901a-fr')">
          <span>VITE, J’EN PROFITE</span>
        </a>
      </li>

      <!-- Middle DB-5PC -->
      <li id="db-5pc" class="on-middle">
        <!-- off -->
        <img class="off" src="<?php echo $pResUrl;?>images/banner-offer75.png" alt="">
        <!-- box -->
        <img class="box" src="<?php echo $pResUrl;?>images/banner-db-box5pc.png" alt="">
        <!-- price -->
        <p class="price">
          <strong>29</strong>
          <span>
        ...
        <!-- buybtn -->
        <a class="buybtn cart"
           href="https://www.iobit.com/buy.php?product=fr-db61y5pc2999&ref=fr_db61y5pc2999purchase1901<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_db"
           onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase1901b-fr')">
          <span>VITE, J’EN PROFITE</span>
        </a>
        <!-- attention -->
      ...
      <li id="db-pf-sd" class="on-right nobegin">
        ...
        <!-- buybtn -->
        <a class="buybtn cart"
           href="https://www.iobit.com/buy.php?product=fr-db65pcsdiu2999&ref=fr_db65pcsdiu2999purchase1901<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_db"
           onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase1901c-fr')">
          <span>VITE, J’EN PROFITE</span>
        </a>
        <!-- attention -->
...
<div class="gift-box">
  <div class="wrapper clearfix">
    ...
    <!-- sd box -->
    <div class="box sd clearfix">
      <img class="fl" src="<?php echo $pResUrl; ?>images/sd-gift.png" alt="">
      <dl class="fl">
        <dt>
    ...
    <!-- iu box -->
    <div class="box iu clearfix">
      <img class="fl" src="<?php echo $pResUrl; ?>images/iu-gift.png" alt="">
      <dl class="fl">
        <dt>
    ...
    <a class="buybtn cart disabled"
       disabled="ture"
       data-url="https://www.iobit.com/buy.php?product=fr-db65pcsdiu2999&ref=fr_db65pcsdiu2999purchase1901<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_db"
       data-ga="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase1901c-fr')"
...
<div class="bottomcart">
  <div class="wrapper">
    ...
    <ul>
      <!-- 1 An / 5 PC -->
      <li class="five-pc active"
          data-url="https://www.iobit.com/buy.php?product=fr-db61y5pc2999&ref=fr_db61y5pc2999purchase1901<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_db"
          data-ga="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase1901b-fr')"
          data-price="29"
          data-original="124,75€">
        <span>1 An / 5 PC</span>
        <strong>-75%</strong>
      </li>
      <!-- 1 An / 3 PC -->
      <li class="three-pc"
          data-url="https://www.iobit.com/buy.php?product=fr-db61y3pc2699&ref=fr_db61y3pc2699purchase1901<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_db"
          data-ga="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase1901a-fr')"
          data-price="26"
          data-original="74,85€">
        <i></i> <span>1 An / 3 PC  </span>
        <strong>-60%</strong>
      </li>
      <!-- 1 An / 5 PC+Paquet Cadeau-->
      <li class="gift-pc"
          data-url="https://www.iobit.com/buy.php?product=fr-db65pcsdiu2999&ref=fr_db65pcsdiu2999purchase1901<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_db"
          data-ga="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase1901c-fr')"
          data-price="29"
          data-original="184,73€">
        <i></i> <span> 1 An / 5 PC+Paquet Cadeau</span>
        <strong>-85%</strong>
      </li>
    </ul>
