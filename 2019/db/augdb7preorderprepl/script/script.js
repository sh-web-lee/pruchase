...
function soldout() {
	...
	$(".banner .numbox").html('<h4>Darmowa przedsprzedaż Driver Booster niedostępna</h4><p>Mamy jednak <b>70% zniżki </b> specjalnie dla Ciebie</p>');
	$(".price li.first").html('<p><nobr><strong><big>79</big>,90 zł</strong><del>279,90 zł</del></nobr></p><p>Roczna subskrypcja / 3 PC</p>');
	...
	$(".buybtn").attr({
		"href": 'https://www.iobit.com/buy.php?product=pl-db7preorder79&ref=pl_db7preorderpre79' + refStr + '&aff=' + aff + '&refs=pl_purchase_db&tw=-8',
		"onclick": "ga('send', 'event', 'dbbuy', 'buy', 'db7preorderpre79-pl');"
	});
}
