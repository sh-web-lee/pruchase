...
function soldout() {
	...
	$(".buybtn").attr({
		"href": 'https://www.iobit.com/buy.php?product=nl-db7preorder2499&ref=nl_db7preorder2499official' + refStr + '&aff=' + aff + '&refs=nl_purchase_db&tw=' + tw,
		"onclick": "ga('send', 'event', 'dbbuy', 'buy', 'db7preorderofficialsoldout-nl');"
	});
}
...
function getReTime() {
	var packsNumTotal = cGet('nldboffice_t');
	if (packsNumTotal > 1) {
