...
function soldout() {
	...
	$(".comparison big").html("79,99")
	$(".floatlayer .numbox").html('Seja o Primeiro a Adquirir o Último Driver Booster 7 PRO para um Desempenho Melhor do PC e Jogos');
	$(".buybtn").attr({
		"href": 'https://www.iobit.com/buy.php?product=pt-db7preorder7999&ref=pt-db7preorderpre7999' + refStr + '&aff=' + aff + '&refs=pt_purchase_db&tw=-8',
		"onclick": "ga('send', 'event', 'db3pcbuy', 'buy', 'db7preorderpre-pt');"
	});
}
// soldout();
