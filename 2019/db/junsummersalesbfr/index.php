...
<head>
  ...
  <title>Economisez 85% sur Driver Booster PRO et profitez de votre paquet cadeau uniquement pour l'été !</title>
...
<div class="banner">
  <div class="wrapper">
    ...
    <!-- banner-title -->
    <div class="title">
      <h1>DERNIÈRE DÉMARQUE -85% Il fait trop chaud ! Les prix ont fondus !!</h1>
    </div>
    <h3 class="date">
    ...
    <div class="img-box">
      <img src="<?php echo $pResUrl; ?>images/db-banner-box.png" alt="">
      <div class="info">
        <dl>
          <dt>Paquet cadeau comprend:</dt>
          <dd><span>Smart Defrag 6 PRO</span> 1 an / 1 PC</dd>
          <dd><span>Start Menu 8 PRO</span> 1 an / 1 PC</dd>
          <dd><span>Protected Folder</span> 1 an / 1 PC</dd>
        </dl>
      </div>
    </div>
    <dl class="price">
      <dt>
        <strong>24,€99</strong> <del>164,82€</del>
      </dt>
      <dd><a 
        href="https://www.iobit.com/buy.php?product=fr-db6sdpfsm2499&ref=fr_db6sdpfsm2499purchase1907<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=fr_purchase_db"
        onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase1907-fr') " class="buybtn">VITE, J’EN PROFITE</a></dd>
      <dd> <strong>3,289,585</strong>  personnes l’ont acheté !</dd>
    </dl>
  </div>
</div>
<!-- banenr end -->
...
<div class="gift-box">
  <div class="wrapper clearfix">
    <!-- gift-box title -->
    <h2>Profitez vite d’un paquet  cadeau uniquement pour cet été ! </h2>
    <!-- sd box -->
    <div class="box sd">
      <img src="<?php echo $pResUrl; ?>images/sm-gift.png" alt="">
      <dl>
        <dt>
        ...
        <dd>
          Retrouvez le menu Démarrer classique en <br> un clic et recherchez rapidement et <br> précisément les fichiers que vous voulez.
        </dd>
      </dl>
    </div>
    <!-- pf box -->
    ...
    <div class="box iu">
      ...
      <dl>
        ...
        <dd>
          Protégez vos fichiers et vos données <br> importants contre le vol, la perte et les <br> fuites.
        </dd>
      </dl>
    </div>
    <!-- clear float -->
    <div class="clear"></div>
    <!-- buybtn -->
    <a class="buybtn " href="https://www.iobit.com/buy.php?product=fr-db6sdpfsm2499&ref=fr_db6sdpfsm2499purchase1907<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=fr_purchase_db"
        onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase1907-fr') ">
      Profite de mes cadeaux 
    </a>
    <p class="last">Plus que <strong class="packsNum">50</strong> paquets cadeaux disponibles</p>
  </div>
</div>
<!-- gift-box end -->
...
<div class="bottomcart">
  <div class="wrapper">
    <h2>Profitez de TROIS CADEAUX GRATUITS ! Quantité très limitée !</h2>
