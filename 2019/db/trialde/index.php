    ...
    <div class="panel">
      ...
      <dl class="small-box left">
        ...
        <dd>
          ...
          <!-- buybtn -->
          <a class="buybtn"
             href="https://www.iobit.com/buy.php?product=de-db81pc2499&ref=de_trialdb81pc<?php echo $refStr;?>&refs=de_purchase_db"
             onclick="ga('send', 'event', 'db1pcbuy', 'buy', 'dbpurchase-trial1-de')">
      ...
      <dl class="large-box middle sold">
        ...
        <dd>
          ...
          <!-- buybtn -->
          <a class="buybtn"
             href="https://www.iobit.com/buy.php?product=de-db83pcsd2699&ref=de_trialdb8bundle<?php echo $refStr;?>&refs=de_purchase_db"
             onclick="ga('send', 'event', 'dbbundlebuy', 'buy', 'dbpurchase-trial1-de')">
            <strong>JETZT KAUFEN</strong>
            92,90€ sparen
          </a>
      ...
      <dl class="small-box right sold">
        ...
        <dd>
          ...
          <!-- buybtn -->
          <a class="buybtn"
             href="https://www.iobit.com/buy.php?product=de-db83pc2699&ref=de_trialdb83pcsingle<?php echo $refStr;?>&refs=de_purchase_db"
             onclick="ga('send', 'event', 'db3pcbuy', 'buy', 'dbpurchase-trial1-de')">
            <strong>JETZT KAUFEN</strong>
            63€ sparen
          </a>
        </dd>
    ...
    <tr>
      ...
      <th class="itemc">
        ...
        <a class="buybtn other shadow"
           href="https://www.iobit.com/buy.php?product=de-db83pcsd2699&ref=de_trialdb7bundle<?php echo $refStr;?>&refs=de_purchase_db"
           onclick="ga('send', 'event', 'dbbundlebuy', 'buy', 'dbpurchase-trial1-de')">
          <i class="all-icons"></i> Jetzt kaufen
        </a>
