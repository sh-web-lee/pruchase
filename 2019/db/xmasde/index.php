...
<title>Sparen Sie bis zu 85% auf Driver Boooster& erhalten Sie ein Geschenkpaket kostenlos!</title>
...
<body>
  ...
  <div class="banner">
    <div class="wrapper clearfix">
      ...
      <h1>
        Täglich stehen nur <b>300</b> Pakete zur Verfügung
      </h1>
      <p>Spare bis zu 85% auf DB PRO und erhalte extra ein nützliches Geschenkpaket gratis! </p>
      <div class="offer left">
        ...
        <div class="price">
          ...
          <a class="buybtn small"
             href="https://www.iobit.com/buy.php?product=de-db73pc2699&ref=de_db73pcpurchase1912<?php echo $refStr;?>&refs=de_purchase_db"
             onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase1pc1912-de');">
            <i class="all-icons"></i>
      ...
      <div class="offer center">
        ...
        <div class="discount">
          <strong>-85%</strong>
          <b>156,84€ <small>sparen</small></b>
        </div>
        <img src="<?php echo getStaticUrl('images/db-gift-box.png')?>" alt=""/>
        <div class="price">
          <p class="name">1 Jahr, 3 PCs</p>
          <p><strong>26,99€</strong> UVP  <del>183,83€</del></p>
          <a class="buybtn"
             href="https://www.iobit.com/buy.php?product=de-db7sdpfiu2699&ref=de_db73pcbundlepurchase1912<?php echo $refStr;?>&refs=de_purchase_db"
             onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase3pcbundle1912-de');">
            <i class="all-icons"></i>
            Jetzt kaufen
          </a>
        </div>
      ...
      <div class="offer right">
        ...
        <div class="price">
          ...
          <a class="buybtn small"
             href="https://www.iobit.com/buy.php?product=de-db75pc2999&ref=de_db75pcpurchase1912<?php echo $refStr;?>&refs=de_purchase_db"
             onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase5pc1912-de');">
            <i class="all-icons"></i>
            <span>Jetzt kaufen</span>
          </a>
        </div>
