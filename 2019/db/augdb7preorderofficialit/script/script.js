...
function soldout() {
	...
	$(".buybtn").attr({
		"href": 'https://www.iobit.com/buy.php?product=it-db7preorder2295&ref=it_db7preorder2295official'+refStr+'&aff=' + aff + '&refs=it_purchase_db&tw=-8',
		"onclick": "ga('send', 'event', 'dbbuy', 'buy', 'db7preorderofficial2295-it');"
	});
}
// soldout();
