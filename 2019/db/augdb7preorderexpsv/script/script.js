...
function soldout() {
	...
	$(".buybtn").attr({
		"href": 'https://www.iobit.com/buy.php?product=sv-db7preorder329&ref=sv_db7preorder329exp'+refStr+'&aff=' + aff + '&refs=sv_purchase_db&tw=-8',
		"onclick": "ga('send', 'event', 'db3pcbuy', 'buy', 'db7preorderexp-sv');"
	});
	$(".db-feature .buybtn").html("Förbeställ Nu");
}
...
function getReTime() {
	var packsNumTotal = cGet('svdbexp_t');
	if (packsNumTotal > 1) {
