...
<body>
      ...
      <div class="offer clearfix">
        ...
        <div class="right fl">
          ...
          <ul class="price clearfix">
            ...
            <li class="last">
              <a class="buybtn big"
                 href="https://www.iobit.com/buy.php?product=sv-db7preorder30day&ref=sv_db7preorderexp<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=sv_purchase_db"
                 onclick="ga('send', 'event', 'dbbuy', 'buy', 'db7preorderexp-sv');">
                Förbeställ Nu
              </a>
            </li>
          </div>
  ...
  <div class="foryou">
    <div class="wrapper">
      <h2>Vad kan Driver Booster 6 PRO göra för dig?</h2>
      <div class="screen">
        <img src="<?php echo getStaticUrl('images/screen01.png')?>" alt=""/>
        <span class="rocket"></span>
        <div class="forlist left">
          <h3>Förbättra <b>Dators</b> Prestanda</h3>
          <p><i class="circle">.</i> Uppdatera <b>x</b> PC drivrutiner för att hålla sig borta från systemproblem;</p>
          <p><i class="circle">.</i> Fixa <b>x</b> enhetsfel för att lösa hårdvaruproblem; </p>
        </div>
        <div class="forlist right">
          <h3>Förbättra <b>Spelprestanda</b></h3>
          <p><i class="circle">.</i> Uppdatera <b>x</b> spelkomponenter för att garantera framgångsrik lansering av spel;</p>
          <p>
            <i class="circle">.</i> 
            <span>Uppdatera <b>x</b> game-ready drivrutiner med prioritet till att njuta av nya funktioner<br> och fixa buggar;</span>
          </p>
        </div>
      </div>
  ...
  <div class="hashow">
    <div class="wrapper">
      <h2>Din Driver Booster PRO Har Nu Löpt ut</h2>
      <div class="screen clearfix">
        ...
        <ul class="right fr">
          <li><i class="all-icons arrow"></i> <span>Förare databas krymper till <b>2 500 000</b></span></li>
          <li><i class="all-icons"></i> <span><b>Ingen</b> ökning av nedladdningshastighet</span></li>
          <li><i class="all-icons"></i> <span><b>Ingen</b> automatisk drivrutinuppdatering</span></li>
          <li><i class="all-icons"></i> <span><b>Ingen</b> drivrutins säkerhetskopia i förväg</span></li>
          <li><i class="all-icons"></i> <span><b>Inget</b> fixning av enhetskod</span></li>
          <li><i class="all-icons"></i> <span><b>Ingen</b> uppdatering av spelkomponenter</span></li>
          <li class="last"><i class="all-icons"></i> <span><b>Ingen</b> prioritet till att uppdatera game-ready drivrutiner</span></li>
        </ul>
      </div>
      <span class="arrow-wrap"><i class="top"></i><i class="bot"></i>
    </div>
  ...
  <div class="db-feature">
    <div class="wrapper">
      <h2>Driver Booster 7 PRO <br>är tillgängligt för Förbeställning, Det Kan Göra Mer för Dig</h2>
      <div class="clearfix">
        <div class="featlist one">
          <img src="<?php echo getStaticUrl('images/feature-icons01.png')?>" alt=""/>
          <h3>3,500,000+</h3>
          <p>PC drivtruiner som stöds</p>
        </div>
        <div class="featlist two">
          <img src="<?php echo getStaticUrl('images/feature-icons02.png')?>" alt=""/>
          <h3>20% more</h3>
          <p>komponenter som stöds</p>
        </div>
        <div class="featlist three">
          <img src="<?php echo getStaticUrl('images/feature-icons03.png')?>" alt=""/>
          <h3>20% Snabbare</h3>
          <p>kcanning på drivrutiner</p>
        </div>
        <div class="featlist four">
          <img src="<?php echo getStaticUrl('images/feature-icons04.png')?>" alt=""/>
          <h3>Förhindra Aviseringar</h3>
          <p>om Driver Booster när du arbetar med helskärm.</p>
        </div>
      </div>
      <h3 class="subtitle">Tillbaka till PRO nu för att njuta av alla PRO funktioner</h3>
      <ul class="price">
        <li class="last">
          <a class="buybtn big"
             href="https://www.iobit.com/buy.php?product=sv-db7preorder30day&ref=sv_db7preorderexp<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=sv_purchase_db"
             onclick="ga('send', 'event', 'dbbuy', 'buy', 'db7preorderexp-sv');">
            Förbeställ Nu – <big>0 kr</big>
          </a>
        </li>
      </ul>
