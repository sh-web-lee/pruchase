...
<head>
  ...
  <title>Zaoszczędź do 67% na Driver Booster PRO i otrzymaj dodatkowe prezenty za darmo!</title>
...
<div class="banner">
  <div class="wrapper">
    ...
    <h1>Oferta limitowana</h1>
    <h2>Zaoszczędź 67% na Driver Booster PRO - ustabilizuj i ulepsz swój komputer</h2>
    ...
    <div class="right-message">
      <h3>Driver Booster 7 PRO - 3 PC, 1 rok</h3>
      ...
      <dl class="price">
        <dt><del>279,90 zł</del> <strong>89,90 zł</strong></dt>
        <dd>
          <a href="https://www.iobit.com/buy.php?product=pl-db73pc89&ref=pl_db73pc89purchase1906<?php echo $refStr;?>&refs=pl_purchase_db"
             onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase3PC1906-pl')"
             class="buybtn">
            KUP TERAZ
          </a>
        </dd>
