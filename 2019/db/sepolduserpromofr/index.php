...
<head>
  ...
  <title>Economisez 85% sur Driver Booster 7 PRO et obtenez gratuitement des cadeaux exclusifs uniquement pour le nouveau lancement !</title>
...
<div class="banner">
  <div class="wrapper">
    ...
    <!-- banner-title -->
    <h1 class="title">OFFRE SPÉCIALE POUR LE NOUVEAU LANCEMENT</h1>
    <!--
        banner-subtitle
    ...
    <ul class="content">
      ...
      <li id="db-1pc" class="on-left">
        ...
        <!-- buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=fr-db81pc2999&ref=fr_db81pcolduserpurchase1909<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_db"
           onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase1909b-fr')">
      ...
      <li id="db-3pc" class="on-middle">
        ...
        <!-- buybtn -->
        <a class="buybtn cart"
           href="https://www.iobit.com/buy.php?product=fr-db63pc2499&ref=fr_db63pc2499purchase1908<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_db"
           onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase1908-fr')">
      ...
      <li id="db-pf-sd" class="on-right nobegin">
        ...
        <!-- buybtn -->
        <a class="buybtn cart"
           href="https://www.iobit.com/buy.php?product=fr-db814msdpfiu2499&ref=fr_db814monthsolduserpurchase1909<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_db"
           onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase1909a-fr')">
          <span>VITE, J’EN PROFITE</span>
        </a>
        <!-- attention -->
...
<div class="benfits wrapper clearfix">
  ...
  <div class="detail-list">
    <dl class="active first">
      ...
      <dd>
        <h3>Met à jour plus de 4 500 000 pilotes</h3>
        <p>
          Solution “one-stop” pour mettre à jour automatiquement<br>
          plus de 4 500 000 pilotes obsolètes et incompatibles.
        </p>
      </dd>
    </dl>
    <dl>
...
<div class="gift-box">
  <div class="wrapper clearfix">
    <!-- gift-box title -->
    <h2>Profitez d’un paquet cadeau à durée limitée et d’un cadeau spécial lancement !</h2>
    <div class="box sd">
      <img src="<?php echo $pResUrl; ?>images/box.png" alt="">
      <dl>
        <dt>
          <h3>Driver Booster 8 PRO</h3>
          <span>2 mois supplémentaires pour 3 PC</span>
        </dt>
        <dd>
          Cadeau Exclusif pour le nouveau lancement.
        </dd>
      </dl>
    </div>
    <!-- sd box -->
    ...
    <a class="buybtn cart disabled"
       disabled="ture"
       data-url="https://www.iobit.com/buy.php?product=fr-db814msdpfiu2499&ref=fr_db814monthsolduserpurchase1909<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_db"
       data-ga="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase1909a-fr')"
  ...
  <div class="wrapper">
    ...
    <ul>
      <li class="active"
        ...
        <span>14 Mois / 3 PC+Paquet Cadeau</span>
        <strong>-85%</strong>
      </li>
      <li class="one-pc"
          data-url="https://www.iobit.com/buy.php?product=fr-db81pc2999&ref=fr_db81pcolduserpurchase1909<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_db"
          data-ga="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase1909b-fr')"
          data-price="29"
          data-original="">
        <i></i> <span>1 An / 1 PC  </span>
      </li>
      <li class="three-pc"
          data-url="https://www.iobit.com/buy.php?product=fr-db63pc2499&ref=fr_db63pc2499purchase1908<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_db"
          data-ga="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase1908-fr')"
          data-price="24"
          data-original="74,85€">
