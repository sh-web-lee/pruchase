	...
	<div class="wrapper clearfix">
		...
		<div class="message box ">
			<div class="top-message">
				...
				<a href="https://www.iobit.com/buy.php?product=driverbooster6&ref=db63pc2019usa<?php echo $refStr?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_db" onclick="ga('send', 'event', 'db3pcbuyusa', 'buy', 'dbpurchase-201901')" class="buybtn"><i></i> <span>Activate Now</span></a>
		...
		<div class="gift-box message">
			<div class="top-message">
				...
				<a href="https://www.iobit.com/buy.php?product=db6sdiupf&ref=db6bundle2019usa<?php echo $refStr?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_db" onclick="ga('send', 'event', 'db2495buyusa', 'buy', 'dbpurchase-201901')" class="buybtn"><i></i> <span>Activate Now</span></a>
...
<div class="between-buy">
	<div class="wrapper">
		<div class="content">
			...
			<a href="https://www.iobit.com/buy.php?product=db6sdiupf&ref=db6bundle2019usa<?php echo $refStr?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_db" onclick="ga('send', 'event', 'db2495buyusa', 'buy', 'dbpurchase-201901')" class="buybtn save"><i></i> Activate Now</a>
	...
	<div class="wrapper">
		...
		<table>
			...
			<th class="itemb">
				...
				<a href="https://www.iobit.com/buy.php?product=db6sdiupf&ref=db6bundle2019usa<?php echo $refStr?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_db" onclick="ga('send', 'event', 'db2495buyusa', 'buy', 'dbpurchase-201901')" class="buybtn"><i></i>
...
<div class="floatlayer" id="floatlayer">
	<div class="wrapper clearfix">
		...
		<div class="right">
			...
			<a class="buybtn" href="https://www.iobit.com/buy.php?product=db6sdiupf&ref=db6bundle2019usa<?php echo $refStr?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_db" onclick="ga('send', 'event', 'db2495buyusa', 'buy', 'dbpurchase-201901')">Activate Now</a>
		</div>
	</div>
</div>
<div class="float">
