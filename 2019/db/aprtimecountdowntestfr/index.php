  ...
  <div class="wrapper">
    ...
    <ul class="content">
      ...
      <li id="db-1pc" class="on-left">
        ...
        <!-- buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=fr-db71pc2999&ref=fr_db71pc2999purchase1908<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_db"
      ...
      <li id="db-pf-sd" class="on-right nobegin">
        ...
        <!-- buybtn -->
        <a class="buybtn cart"
           href="https://www.iobit.com/buy.php?product=fr-db7iusdpf2499&ref=fr_db7sdpfiu2499purchase1908<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_db"
           onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase1908-fr')">
          <span>VITE, J’EN PROFITE</span>
        </a>
        <!-- attention -->
...
<div class="gift-box">
  <div class="wrapper clearfix">
    ...
    <a class="buybtn cart disabled"
       disabled="ture"
       data-url="https://www.iobit.com/buy.php?product=fr-db7iusdpf2499&ref=fr_db7sdpfiu2499purchase1908<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_db"
...
<div class="bottomcart">
  <div class="wrapper">
    ...
    <ul>
      ...
      <li class="one-pc"
          data-url="https://www.iobit.com/buy.php?product=fr-db71pc2999&ref=fr_db71pc2999purchase1908<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_db"
          data-ga="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase1908-fr')"
          data-price="29"
          data-original="">
