...
<body>
  ...
  <div class="banner">
    <div class="wrapper clearfix">
      ...
      <h1>Gelukkig Nieuwjaar! Slechts <b>300</b> pakketten beschikbaar vandaag</h1>
      <div class="offer left">
        ...
        <div class="price">
          ...
          <a class="buybtn small"
             ...
             onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase1911-nl');">
            <i class="all-icons"></i>
            <span>Nu Kopen</span>
          </a>
        </div>
      ...
      <div class="offer center">
        ...
        <div class="discount">
          <strong>-85%</strong>
          <b>Gratis <small>Cadeaus</small></b>
        </div>
        ...
        <div class="price">
          ...
          <a class="buybtn"
             href="https://www.iobit.com/buy.php?product=nl-db73pciupf2499&ref=nl_db73pciupf2499purchase1911<?php echo $refStr;?>&refs=nl_purchase_db"
             onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase1911-nl');">
            <i class="all-icons"></i>
            Nu Kopen
          </a>
  ...
  <div class="main">
    ...
    <div class="giftbox">
      <div class="wrapper">
        <h2>Twee Cadeaus helemaal gratis als u nu koopt!</h2>
        <div class="clearfix">
          <dl class="clearfix">
