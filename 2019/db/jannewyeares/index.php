...
<head>
  ...
  <title>Consigue Driver Booster 7 Pro con 85% de descuento y regalos gratis – IObit</title>
...
<div class="banner">
  <div class="wrapper">
    ...
    <h1>
      ...
      <span>Ahorra 85% en DB PRO y consigue un EXTRA paquete de REGALO GRATIS</span>
    </h1>
    <!-- content -->
    <div class="content clearfix">
      ...
      <div class="right-message fr">
        ...
        <!-- buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=es-db73pcpfsd1999&ref=es_db73pcpfsdpurchase1901<?php echo $refStr;?>&refs=es_purchase_db"
           onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase1901-es')">
           Comprar ahora
        </a>
        <!-- attention -->
...
<div class="gift-box">
  <div class="wrapper clearfix">
    <!-- gift-box title -->
    <h2>Regalos exclusivos sólo para la oferta especial</h2>
    <!-- SD -->
    <dl class="fl sd-box">
