...
<div class="banner">
  <div class="wrapper">
    ...
    <div class="title">
      ...
      <p>Specialerbjudande för lojala användare</p>
    </div>
    <!-- panel -->
    <div class="panel">
      ...
      <dl class="small-box left">
        ...
        <dd>
          ...
          <!-- 1pc buybtn -->
          <a class="buybtn"
             href="https://www.iobit.com/buy.php?product=sv-db81pc279&ref=sv_db81pcpurchase1909newlaunch<?php echo $refStr;?>&refs=sv_purchase_db"
             onclick="ga('send', 'event', 'dbbuy', 'buy', 'db1pcnewlaunch1909-sv');">
            KÖP NU
          </a>
        </dd>
      </dl>
      ...
      <dl class="large-box">
        ...
        <dd>
          ...
          <a class="buybtn large green"
             href="https://www.iobit.com/buy.php?product=sv-db83pc14mpfsd299&ref=sv_db83pc14mpfsdpurchase1909newlaunch<?php echo $refStr;?>&refs=sv_purchase_db"
             onclick="ga('send', 'event', 'dbbuy', 'buy', 'db3pcnewlaunch1909-sv');">
            <span>KÖP NU</span>
          </a>
        </dd>
      </dl>
      ...
      <dl class="small-box right">
        ...
        <dd>
          ...
          <!-- 5pc buybtn -->
          <a class="buybtn"
             href="https://www.iobit.com/buy.php?product=sv-db85pc349&ref=sv_db85pcpurchase1909newlaunch<?php echo $refStr;?>&refs=sv_purchase_db"
             onclick="ga('send', 'event', 'dbbuy', 'buy', 'db5pcnewlaunch1909-sv');">
            KÖP NU
          </a>
        </dd>
      </dl>
...
<div class="gifts wrapper clearfix">
  <h2>VIP GÅVA. endast för användare av Driver Booster PRO </h2>
  <!-- pf -->
...
<div class="bottombuy">
  <div class="wrapper clearfix">
    ...
    <ul class="fl">
      <!-- 5pc -->
      <li class=""
          data-url="https://www.iobit.com/buy.php?product=sv-db85pc349&ref=sv_db85pcpurchase1909newlaunch<?php echo $refStr;?>&refs=sv_purchase_db"
          data-ga="ga('send', 'event', 'dbbuy', 'buy', 'db5pcnewlaunch1909-sv');"
          data-price="349"
          data-del="1 099 kr">
        5PC / 1 År
      ...
      <!-- 3pcs + gifts -->
      <li class="active"
          data-url="https://www.iobit.com/buy.php?product=sv-db83pc14mpfsd299&ref=sv_db83pc14mpfsdpurchase1909newlaunch<?php echo $refStr;?>&refs=sv_purchase_db"
          data-ga="ga('send', 'event', 'dbbuy', 'buy', 'db3pcnewlaunch1909-sv');"
          data-price="299 "
          data-del="1 367 kr">
      ...
      <!-- 1pc -->
      <li class=""
          data-url="https://www.iobit.com/buy.php?product=sv-db81pc279&ref=sv_db81pcpurchase1909newlaunch<?php echo $refStr;?>&refs=sv_purchase_db"
          data-ga="ga('send', 'event', 'dbbuy', 'buy', 'db1pcnewlaunch1909-sv');"
          data-price="279"
          data-del="699 kr">
        1PC / 1 År
