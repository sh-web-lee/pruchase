...
<div class="banner">
  <div class="wrapper">
    ...
    <!-- title -->
    <h1>Nyt specialtilbud for din loyale støtte</h1>
    <!-- content -->
    <div class="content clearfix">
      ...
      <dl class="fl">
        ...
        <dd>
          ...
          <!-- 1pc buybtn -->
          <a class="buybtn"
             href="https://www.iobit.com/buy.php?product=dk-db81pc189&ref=dk_db1pcpurchase202009newlaunch<?php echo $refStr;?>&refs=dk_purchase_db"
             onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase1pcnewlaunch-dk');">
            Køb nu
          </a>
        </dd>
      </dl>
      ...
      <dl class="fl large">
        ...
        <dd>
          ...
          <a class="buybtn black"
             href="https://www.iobit.com/buy.php?product=dk-db814msd&ref=dk_db3pc14mbundle202009newlaunch<?php echo $refStr;?>&refs=dk_purchase_db"
             onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase3pc14mnewlaunch-dk');">
            Køb nu
          </a>
          <!-- person -->
      ...
      <dl class="fr">
        ...
        <dd>
          ...
          <!-- 3pc buybtn -->
          <a class="buybtn"
             href="https://www.iobit.com/buy.php?product=dk-db83pc199&ref=dk_db3pcpurchase202009newlaunch<?php echo $refStr;?>&refs=dk_purchase_db"
             onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase3pcnewlaunch-dk');">
            Køb nu
          </a>
        </dd>
      </dl>
  ...
  <div class="wrapper clearfix">
    ...
    <ul class="selector fl">
      ...
      <li class="first active clearfix"
          data-url="https://www.iobit.com/buy.php?product=dk-db814msd&ref=dk_db3pc14mbundle202009newlaunch<?php echo $refStr;?>&refs=dk_purchase_db"
          data-ga="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase3pc14mnewlaunch-dk');"
          data-price="199,-"
          data-del="1.178,-">
      ...
      <!-- 3pc -->
      <li class="clearfix"
          data-url="https://www.iobit.com/buy.php?product=dk-db83pc199&ref=dk_db3pcpurchase202009newlaunch<?php echo $refStr;?>&refs=dk_purchase_db" 
          data-ga="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase3pcnewlaunch-dk');"
          data-price="199,-"
          data-del="679,-">
        3 pc`er
        <strong>-70%</strong>
      ...
      <!-- 1pc -->
      <li class="clearfix"
          data-url="https://www.iobit.com/buy.php?product=dk-db81pc189&ref=dk_db1pcpurchase202009newlaunch<?php echo $refStr;?>&refs=dk_purchase_db"
          data-ga="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase1pcnewlaunch-dk');"
          data-price="189,-"
          data-del="399,-">
        1 pc
        <strong>-52%</strong>
