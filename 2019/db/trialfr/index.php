			...
			<div class="clearfix">
			  ...
			  <div class="offer bundle">
			  	...
			  	<div class="price">
			  		...
			  		<a class="buybtn" 
			  		   href="https://www.iobit.com/buy.php?product=fr-db8iusdpf2499&ref=fr_trialdb8sdpfiu2499<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=fr_purchase_db"
			  		   onclick="ga('send', 'event', 'dbbundlebuy', 'buy', 'dbpurchase- trial1-fr')">
			  ...
			  <div class="offer one">
			  	...
			  	<div class="price">
			  		...
			  		<a class="buybtn" 
			  		   href="https://www.iobit.com/buy.php?product=fr-db81pc2999&ref=fr_trialdb81pc2999purchase<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=fr_purchase_db"
			  		   onclick="ga('send', 'event', 'db1pcbuy', 'buy', 'dbpurchase-trial1-fr')">
			  			Activez Maintenant
			  		</a>
			  	</div>
			  </div>
