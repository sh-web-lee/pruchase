...
if ($_GET['action'] == 'getPacks') {
  $date = $_GET['d'];
  $c_name = 'esdbpre_p' . $date;
  $c_name_t='esdbpre_t' . $date;
    ...
    <div class="offer clearfix">
      ...
      <div class="right fl">
        ...
        <ul class="price clearfix">
          ...
          <li class="last">
            <a class="buybtn"
               href="https://www.iobit.com/buy.php?product=es-db7preorder&ref=es_db7preorderpre<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=es_purchase_db"
               onclick="ga('send', 'event', 'dbbuy', 'buy', 'db7preorderpre-es');">
              Resérvalo ahora
            </a>
          </li>
      </div>
...
<div class="comparison">
  <div class="wrapper">
    <span class="arrow-wrap"><i class="top"></i><i class="bot"></i></span>
    <h2>Driver Booster 7 PRO te ofrece mucho más</h2>
    <table>
      <thead>
      <tr>
        <th class="text"></th>
        <th class="itema">
          <h3>Tu versión actual</h3>
        </th>
        <th class="space"></th>
        <th class="itemb">
      ...
      <tbody>
      <tr>
        <td class="text"><img src="<?php echo $pResUrl;?>images/icon01.png" alt=""> Mayor Base de Datos de controladores</td>
        <td class="itema">2,500,000+</td>
        <td class="space"></td>
        <td class="itemb">3,500,000+</td>
      </tr>
      <tr>
        <td class="text"><img src="<?php echo $pResUrl;?>images/icon02.png" alt=""> Aumenta la velocidad de descarga del controlador	</td>
        <td class="itema"></td>
        <td class="space"></td>
        <td class="itemb"></td>
      </tr>
      <tr>
        <td class="text"><img src="<?php echo $pResUrl;?>images/icon03.png" alt=""> Escaneo automático y actualización según lo programado</td>
        <td class="itema"></td>
        <td class="space"></td>
        <td class="itemb"></td>
      </tr>
      <tr>
        <td class="text"><img src="<?php echo $pResUrl;?>images/icon04.png" alt=""> Copia de seguridad de controladores anteriores </td>
        <td class="itema"></td>
        <td class="space"></td>
        <td class="itemb"></td>
      </tr>
      <tr>
        <td class="text"><img src="<?php echo $pResUrl;?>images/icon05.png" alt=""> Actualización de componentes del juego</td>
        <td class="itema"></td>
        <td class="space"></td>
        <td class="itemb"></td>
      </tr>
      <tr>
        <td class="text"><img src="<?php echo $pResUrl;?>images/icon06.png" alt=""> Prioridad de actualizar driver de Game Ready</td>
        <td class="itema"></td>
        <td class="space"></td>
        <td class="itemb"></td>
      </tr>
      <tr>
        <td class="text"><img src="<?php echo $pResUrl;?>images/icon07.png" alt=""> Reduce y corrige los problemas en el hardware </td>
        <td class="itema"></td>
        <td class="space"></td>
        <td class="itemb"></td>
      </tr>
    ...
    <h4>Actualiza por <strong><big>0</big>€</strong> para desbloquear todas las funciones PRO ahora</h4>
    <a class="buybtn"
       href="https://www.iobit.com/buy.php?product=es-db7preorder&ref=es_db7preorderpre<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=es_purchase_db"
       onclick="ga('send', 'event', 'dbbuy', 'buy', 'db7preorderpre-es');">
      Resérvalo ahora
