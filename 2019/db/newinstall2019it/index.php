...
<div class="banner">
  <div class="wrapper">
    ...
    <!-- title -->
    <div class="title">
      <h1>OFFERTA SPECIALE PER IL NUOVO RILASCIO</h1>
      <p>CORREGGI E AGGIORNA TUTTI I DRIVER ORA</p>
    </div>
    <!-- left-message -->
    <dl class="left-message fl">
      <dt>SALE -65%</dt>
      <dd><img src="<?php echo getStaticUrl('images/db-box.png')?>" alt="Driver Booster PRO + Smart Defrag PRO + Protected Folder"></dd>
    </dl>
    <!-- right-message -->
    <div class="right-message fr">
      ...
      <div class="chart">
        ...
        <dl class="two">
          <dd class="point"></dd>
          <dd class="line"></dd>
          <dd class="text"><strong>25,99€</strong></dd>
        </dl>
        <dl class="three">
          <dd class="point"></dd>
          <dd class="line"></dd>
      ...
      <!-- price -->
      <p class="price"><strong>25,99€</strong> &nbsp; <del>74,85€</del></p>
      <!-- buybtn -->
      <a class="buybtn"
         href="http://www.iobit.com/buy.php?product=it-db83pciusdpf2599&ref=it_db8newinstallb<?php echo $refStr;?>&refs=it_purchase_db"
         onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchasenewinstall-it')">
        Approfittane Ora
      </a>
    </div>
  </div>
...
<div class="feature wrapper">
  ...
  <img class="machine" src="<?php echo getStaticUrl('images/feature-machine.png')?>" alt="">
</div>
<!-- end feature -->
...
<div class="gifts">
  <div class="wrapper clearfix">
    ...
    <h3>RENDERE IL PC PIÙ SICURO NON È MAI STATO COSÌ FACILE, A PORTATA DI CLIC!</h3>
    <dl class="iu">
      <dt>
        <span class="ribbon"></span>
        <img src="<?php echo $pResUrl;?>images/gifts-iu.png" alt="IObit Uninstaller PRO">
      </dt>
      <dd>
        <h4>IObit Uninstaller PRO</h4>
        <p>
          Elimina definitivamente programmi, <br>
          plugin e app di Windows <br>
          indesiderati con un solo clic!
        </p>
      </dd>
    </dl>
    <dl class="sd">
...
<div class="comparison wrapper">
  <table>
    ...
    <tr>
      <td class="icons"><img src="<?php echo $pResUrl;?>images/icon11.png" alt=""></td>
      <td class="text">
        <span class="new">
      ...
      <td class="space"></td>
      <td class="itema"><i style="display:inline-block; vertical-align: middle; margin-left: 100px;"></i><b>4.500.000+<br> driver</b></td>
      <td class="space"></td>
      <td class="itemb"><i class="yes" style="display:inline-block;vertical-align: middle;margin-left: 100px;"></i><b>3.500.000+<br> driver</b></td>
    </tr>
    <!-- 02 -->
    <tr>
    ...
    <tr>
      ...
      <td class="text">
        <span>Download, aggiornamento e installazione automatica dei driver <br> durante i periodi di inattività del sistema	</span>
      </td>
      <td class="space"></td>
      <td class="itema"><i></i></td>
      <td class="space"></td>
...
<div class="bottombuy wrapper clearfix">
  ...
  <img class="fl" src="<?php echo getStaticUrl('images/bottombuy-db.png')?>" alt="Driver Booster PRO + Smart Defrag PRO + Protected Folder">
  <dl class="fr">
    <dd>
      <!-- price -->
      <p class="price"><strong>25,99€</strong> &nbsp; <del>74,85€</del></p>
...
<div class="footer">
  <div class="wrapper">
    ...
    <dl class="note">
      ...
      <dd>* Smart Defrag PRO / Protected Folder / IObit Uninstaller PRO per un anno di iscrizione su 1 PC</dd>
    </dl>
