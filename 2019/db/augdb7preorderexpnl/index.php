    ...
    <div class="wrapper">
      ...
      <div class="screen">
        ...
        <div class="forlist left">
          ...
          <p><i class="circle">.</i> <b>x</b> drivers geüpdatet om systeemfouten te voorkomen;</p>
        ...
        <div class="forlist right">
          ...
          <p><i class="circle">.</i> <b>x</b> gamecomponenten geüpdatet om succesvol starten van games te garanderen;</p>
          <p><i class="circle">.</i> <b>x</b> Game Ready Drivers met voorrang geüpdatet om van de nieuwste functies te <br> genieten en bugs te verhelpen;</p>
        </div>
      </div>
