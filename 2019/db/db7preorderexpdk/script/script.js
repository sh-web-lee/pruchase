...
function soldout() {
	...
	$(".buybtn").attr({
		"href": 'https://www.iobit.com/buy.php?product=dk-db7preorder199&ref=dk_db7preorder199exp' + refStr + '&aff=' + aff + '&refs=dk_purchase_db&tw=' + tw,
		"onclick": "ga('send', 'event', 'db3pcbuy', 'buy', 'db7preorderexp-dk');"
	});
}
