...
function soldout() {
	...
	$(".buybtn").attr({
		"href": 'https://www.iobit.com/buy.php?product=de-db7preorder2699&ref=de_db7preorderrc2699'+refStr+'&aff=' + aff + '&refs=de_purchase_db&tw=-8',
		"onclick": "ga('send', 'event', 'db3pcbuy', 'buy', 'db7preorderrc-de');"
	});
}
// soldout();
