...
if ($_GET['action'] == 'getPacks') {
  $date = $_GET['d'];
  $c_name = 'endecdbxr_p' . $date;
  $c_name_t='endecdbxr_t' . $date;
  $isInit=$_GET['isInit'];
...
<title>70% OFF to Keep Drivers Always Up-to-date - Christmas Sale | IObit</title>
...
<body>
          ...
          <ul class="price">
            ...
            <li>
              <a class="buybtn exbtn"
                 href="https://www.iobit.com/buy.php?product=db73pc1995x&ref=xr_db<?php echo $refStr;?><?php echo $popStr;?>&refs=purchase_dbx"
                 onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase-xmas');">
                Activate Now
              </a>
            </li>
          </ul>
  ...
  <div class="intro">
    ...
    <div class="wrapper intro-box">
      <div class="intro-img">
        ...
        <div class="downbox">
          ...
          <div id="down" class="downloading">
            ...
            <div class="down-info">
              <p class="down-num">Downloading (<span>1</span>%)...</p>
              <div class="down-bar">
        ...
        <div class="installbox">
          ...
          <div id="install" class="downloading">
            <i class="down-icon"><em></em></i>
            <div class="down-info">
              <p class="down-num">Installing (<span>1</span>%)...</p>
              <div class="down-bar">
                <span class="down-red-bar"><span class="down-red-light"></span></span>
              </div>
            </div>
      ...
      <div class="intro-txt">
        <div class="slow">
          <h3><span>Unstable PC</span></h3>
          <p>
            <span class="one">Your computer may become less efficient, </span>
            <span class="two">experience hardware failures or even crash.</span>
          </p>
        </div>
        <div class="fast">
          ...
          <div class="fast-list">
            <div id="inner" class="inner">
              <div class="one">
                <dl>
                  <dt><b>3,500,000+ Drivers</b></dt>
                  <dd>Automatically check driver status and latest updates for over 3,500,000 drivers.</dd>
                </dl>
                <dl>
  ...
  <div class="popbox">
    ...
    <div class="msgbox fl">
      ...
      <div class="price">
        ...
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=db73pc1895&ref=xr_db1895pop<?php echo $refStr;?><?php echo $popStr;?>&refs=purchase_dbx"
           onclick="ga('send', 'event', 'dbbuypop', 'buy', 'dbpurchase-xmas);">
          Activate Now
        </a>
        <p>1 year subscription / 3 PCs</p>
      </div>
  ...
  <?php if ($isNewRef):?>
    <script>
      ...
      $(".comparison thead .free").html("Driver Booster Free");
    </script>
  <?php endif;?>
