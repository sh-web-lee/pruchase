	...
	<script>
		...
		if(browserLanguage=='tr'){
			...
			if (reg.test(ver) && ((paramTo == 'gaexpired')||(paramTo == 'multipcexpired_2'))) {
				...
				var pageAb = cGet(cName);
				if (pageAb == 'tob') {
					window.location.replace('./anniversarymarchnew.php' + queryStr);
				} else {
					if (pageAb == null) {
						var randNum = Math.random();
						if (randNum > 0.5) {
			...
			<div class="offer clearfix">
				...
				<div class="right fr">
					...
					<div class="price line">
						...
						<a class="buybtn"
						   href="https://www.iobit.com/buy.php?product=db6sd&ref=db6sd<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_db"
