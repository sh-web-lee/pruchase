				...
				<div class="offer left">
					...
					<div class="price">
						...
						<a class="buybtn nonshadow"
						   href="https://www.iobit.com/buy.php?product=driverbooster8&ref=en-db3pctrial<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_db"
						   onclick="ga('send', 'event', 'db3pcbuy', 'buy', 'dbpurchase-trial1')">
				...
				<div class="offer right">
					...
					<div class="price">
						...
						<a class="buybtn shadow"
						   href="https://www.iobit.com/buy.php?product=db8sdiupf&ref=en-db3pcsdiupftrial<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_db"
						   onclick="ga('send', 'event', 'dbbundlebuy', 'buy', 'dbpurchase- trial1')">
					...
					<ul>
						...
						<li><i class="all-icons">√</i> Driver Booster 8 Pro   <del>$74.85</del></li>
						<li><i class="all-icons">√</i> IObit Uninstaller 11 Pro  <del>$19.99</del></li>
						<li><i class="all-icons">√</i> Smart Defrag 7 Pro  <del>$19.99</del></li>
...
<script>
	...
	var _href = "https://www.iobit.com/buy.php?product=driverbooster8&ref=en-db3pcsoldouttrial<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_db&tw=-8";
