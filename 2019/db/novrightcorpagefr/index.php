...
$cName='frfrnovrightcorpagefr_re';
	 	...
	 	<div class="wrapper">
			...
			<h2>Offre à durée limitée <div class="date"><span>Plus que </span> <strong>00</strong> H <strong>55</strong> Min <strong>55</strong> Sec <strong>55</strong> Ms</div></h2>
 			...
 			<div class="one-pc-box">
 				...
 				<a href="https://www.iobit.com/buy.php?product=fr-db71y3pc2999&ref=fr_db71y3pcrightcor2999purchase1911<?php echo $refStr;?>&aff=&refs=fr_purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbrightcorpurchase1911b-fr')" class="button border">J’en profite !</a>
 			</div>
 			...
 			<div class="packs">
 				...
 				<a href="https://www.iobit.com/buy.php?product=fr-db71y3pcisusdpf1999&ref=fr_db71y3pcbundlerightcor1999purchase1911<?php echo $refStr;?>&aff=&refs=fr_purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbrightcorpurchase1911a-fr')" class="button">J’en profite !</a>
 			...
 			<div class="one-pc-box three-pcs">
 				...
 				<a href="https://www.iobit.com/buy.php?product=fr-db71y1pc2499&ref=fr_db71y1pcrightcor2499purchase1911<?php echo $refStr;?>&aff=&refs=fr_purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbrightcorpurchase1911c-fr')" class="button border">J’en profite !</a>
 			</div>
	 	</div>
	</div>
	...
	<div class="gifts">
		<div class="wrapper">
			...
			<a class="button btn-mid-lag"
			   href="https://www.iobit.com/buy.php?product=fr-db71y3pcisusdpf1999&ref=fr_db71y3pcbundlerightcor1999purchase1911<?php echo $refStr;?>&aff=&refs=fr_purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbrightcorpurchase1911a-fr')">
