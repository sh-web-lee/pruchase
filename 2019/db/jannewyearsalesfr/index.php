...
<div class="banner">
  <div class="wrapper">
    ...
    <!-- banner-title -->
    <h1 class="title">Dernière Démarque, les soldes encore plus fort!</h1>
    <!--
        banner-subtitle
    ...
    <ul class="content">
      ...
      <li id="db-1pc" class="on-left">
        ...
        <!-- buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=fr-db61pc2999&ref=fr_db61pc2999purchase1812<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_db"
           onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase1812-fr')">
      ...
      <li id="db-3pc" class="on-middle">
        ...
        <!-- buybtn -->
        <a class="buybtn cart"
           href="https://www.iobit.com/buy.php?product=fr-db63pc2499&ref=fr_db63pc2499purchase1812<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_db"
           onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase1812-fr')">
      ...
      <li id="db-pf-sd" class="on-right nobegin">
        ...
        <!-- buybtn -->
        <a class="buybtn cart"
           href="https://www.iobit.com/buy.php?product=fr-db6iusdpf2499&ref=fr_db6sdpfiu2499purchase1812<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_db"
           onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase1812-fr')">
          <span>VITE, J’EN PROFITE</span>
        </a>
        <!-- attention -->
...
<div class="gift-box">
  <div class="wrapper clearfix">
    ...
    <a class="buybtn cart disabled"
       disabled="ture"
       data-url="https://www.iobit.com/buy.php?product=fr-db6iusdpf2499&ref=fr_db6sdpfiu2499purchase1812<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_db"
       data-ga="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase1812-fr')"
...
<div class="bottomcart">
  <div class="wrapper">
    ...
    <ul>
      ...
      <li class="one-pc"
          data-url="https://www.iobit.com/buy.php?product=fr-db61pc2999&ref=fr_db61pc2999purchase1812<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_db"
          data-ga="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase1812-fr')"
          data-price="29"
          data-original="">
      ...
      <li class="three-pc"
          data-url="https://www.iobit.com/buy.php?product=fr-db63pc2499&ref=fr_db63pc2499purchase1812<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_db"
          data-ga="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase1812-fr')"
          data-price="24"
          data-original="74,85€">
