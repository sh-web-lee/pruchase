...
function soldout() {
	...
	$(".buybtn").attr({
		"href": 'https://www.iobit.com/buy.php?product=es-db7preorder1999&ref=es_db7preorder1999rc'+refStr+'&aff=' + aff + '&refs=es_purchase_db&tw=' + tw,
		"onclick": "ga('send', 'event', 'db3pcbuy', 'buy', 'db7preorderrc-es');"
	});
}
// soldout();
