...
function soldOut() {
  ...
  $(".change-price").html("<big>22</big>,99€");
  $(".price strong").html("<b>22</b>,99€");
  $(".discount").addClass("soldout");
  $('.banner .price strong').after("<del>89,99€</del>");
  $("p.change").html("Oops, 77% Rabatt ist leider ausverkauft.");
  $(".banner .buybtn small").text("- 22,99€");
  $(".banner .numbox").css({'visibility': 'hidden','height': '20'});
  $(".floatlayer .change").css({'marginLeft': '0'});
  $(".buybtn").attr({
    "href": 'https://www.iobit.com/buy.php?product=de-db3pc2299&ref=de_dbbf2299sale1911'+refStr+'&refs=de_purchase_db&tw=' + tw,
    "onclick": "ga('send', 'event', 'dbbuy', 'buy', 'db2299bfsale1911-de');"
  });
}
