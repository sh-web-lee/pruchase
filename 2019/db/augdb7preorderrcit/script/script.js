...
function soldout() {
	...
	$(".buybtn").attr({
		"href": 'https://www.iobit.com/buy.php?product=it-db7preorder2295&ref=it_db7preorder2295rc'+refStr+'&aff=' + aff + '&refs=it_purchase_db&tw=-8',
		"onclick": "ga('send', 'event', 'dbbuy', 'buy', 'db7preorderrc2295-it');"
	});
}
// soldout();
