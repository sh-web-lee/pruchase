...
function soldout() {
	...
	$(".buybtn").attr({
		"href": 'https://www.iobit.com/buy.php?product=fr-db7preorder2499&ref=fr_db7preorder2499official'+refStr+'&aff=' + aff + '&refs=fr_purchase_db&tw=-8',
		"onclick": "ga('send', 'event', 'db3pcbuy', 'buy', 'db7preorderofficial-fr');"
	});
}
// soldout();
...
$(document).ready(function() {
	...
	// flipNum(1000, 4, 100);
	// setTimeout('flipNum(999, 4, 300);', 200);
	// setTimeout('flipNum(79, 4, 1500);', 700);
});
...
function getReTime() {
	var packsNumTotal = cGet('frdboffice_t');
	if (packsNumTotal > 1) {
