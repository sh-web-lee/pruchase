...
if ($_GET['action'] == 'getPacks') {
  $date = $_GET['d'];
  $c_name = 'dkdbxnov_p' . $date;
  $c_name_t='dkdbxnov_t' . $date;
...
<head>
  ...
  <title>Begrænset tilbud, spar op til 89% på Driver Booster PRO - IObit 2019</title>
...
<body>
    ...
    <div class="wrapper clearfix">
      ...
      <div class="right fr">
        <div class="chart">
          ...
          <div class="clist two">
            <span class="cost"><strong><big>199</big>kr.</strong></span>
            <span class="line"></span>
            <span class="point"></span>
        ...
        <div class="price">
          <p><strong><big>199</big> kr.</strong> <del>1836 kr.</del></p>
          <a class="buybtn"
             href="https://www.iobit.com/buy.php?product=dk-db73pcsdpf199&ref=dk_db7bundle199ny202001<?php echo $refStr;?>&refs=dk_purchase_db"
             onclick="ga('send', 'event', 'dbbuy', 'buy', 'db199xmas1912-dk');">
            Køb nu
          </a>
        </div>
      </div>
  ...
  <div class="centbuy price wrapper">
    <p><strong>199 kr.</strong> <del>1836 kr.</del></p>
    <p>Nuværende pris</p>
    <a class="buybtn"
       href="https://www.iobit.com/buy.php?product=dk-db73pcsdpf199&ref=dk_db7bundle199ny202001<?php echo $refStr;?>&refs=dk_purchase_db"
       onclick="ga('send', 'event', 'dbbuy', 'buy', 'db199xmas1912-dk');">
