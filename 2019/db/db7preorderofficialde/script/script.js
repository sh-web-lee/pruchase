...
function soldout() {
	...
	$(".buybtn").attr({
		"href": 'https://www.iobit.com/buy.php?product=de-db7preorder2699&ref=de_db7preorder2699official'+refStr+'&aff=' + aff + '&refs=de_purchase_db&tw=-8',
		"onclick": "ga('send', 'event', 'db3pcbuy', 'buy', 'db7preorderofficial-de');"
	});
}
// soldout();
