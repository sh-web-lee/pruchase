			...
			<div class="offer clearfix">
				...
				<div class="right fr">
					...
					<ul class="price clearfix">
						...
						<li class="last">
							<a class="buybtn" 
							   href="https://www.iobit.com/buy.php?product=db83pc1995&ref=en-db3pctrialbuy<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_db"
							   onclick="ga('send', 'event', 'db3pcbuy', 'buy', 'dbpurchase-trialbuy')">
