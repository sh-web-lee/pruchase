...
<div class="banner">
  <div class="wrapper">
    ...
    <h1>Ekskluzywna oferta dla nowych użytkowników </h1>
    <h2>70% ZNIŻKI na Driver Booster 8 PRO oraz 2 miesiące za darmo!</h2>
    ...
    <div class="right-message">
      ...
      <dl class="price">
        ...
        <dd>
          <a href="https://www.iobit.com/buy.php?product=pl-db83pc14m89&ref=pl_db8newinstall14m<?php echo $refStr;?>&aff=<?php echo $aff;?>&refs=pl_purchase_db"
