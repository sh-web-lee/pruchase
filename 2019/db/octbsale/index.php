...
<body>
	...
	<div class="banner">
		<div class="wrapper">
			...
			<div class="title">
				<h1 class="new _hide">Black Firfay Sale</h1>
			...
			<div class="offer clearfix">
				...
				<div class="right two fr">
					...
					<div class="price line">
						...
						<a class="buybtn"
						   href="https://www.iobit.com/buy.php?product=db7sdiu&ref=db7sdiunew<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_db"
	...
	<div class="giftbox">
		<div class="wrapper">
			<h2 class="new _hide">Black Friday Sale - Buy IObit Signature Products for $1</h2>
