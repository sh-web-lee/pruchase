...
<title>Bis zu 93€ Rabatt auf Driver Booster PRO und ein kostenloses Geschenk - IObit</title>
...
<body>
  ...
  <div class="banner">
    <div class="wrapper">
      <div class="clearfix">
        ...
        <div class="title fr">
          <h1>Winter Sale</h1>
          <h5>Täglich ist das Angebot für 1 Jahr, 3 Computer zeitlich begrentzt. NICHT VERPASSEN! </h5>
        </div>
      </div>
      <div class="panel clearfix">
        <div class="box left">
          ...
          <div class="price">
            ...
            <a class="buybtn"
               href="https://www.iobit.com/buy.php?product=de-db71pc2499&ref=de_db71pcpurchase<?php echo $refStr;?>&refs=de_purchase_db"
               onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase1pc1903-de')">
              <i class="all-icons"></i> 
              JETZT SPAREN
            </a>
          </div>
        ...
        <div class="box right">
          ...
          <div class="price">
            <p><strong>26<sup>99</sup></strong> UVP: <del>119,99€</del></p>
            <a class="buybtn red"
               href="https://www.iobit.com/buy.php?product=de-db73pcsd2699&ref=de_db73pcsdpurchase<?php echo $refStr;?>&refs=de_purchase_db"
               onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase3pc1903-de')">
              <i class="all-icons"></i> 
              JETZT SPAREN
            </a>
          </div>
        ...
        <div class="box center active">
          ...
          <div class="price">
            ...
            <a class="buybtn"
               href="https://www.iobit.com/buy.php?product=de-db75pc2999&ref=de_db75pcpurchase<?php echo $refStr;?>&refs=de_purchase_db"
               onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase5pc1903-de')">
              <i class="all-icons"></i> 
              JETZT SPAREN
            </a>
          </div>
  ...
  <div class="footbuy">
    <div class="wrapper clearfix">
      <p class="discount fl">Bis zu <b>-93€</b></p>
      <div class="imgbox fl">
      ...
      <div class="price fr">
        <p><strong class="off">93 €</strong> Rabatt</p>
        <a class="buybtn red"
           href="https://www.iobit.com/buy.php?product=de-db73pcsd2699&ref=de_db73pcsdpurchase<?php echo $refStr;?>&refs=de_purchase_db"
           onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase3pc1903-de')">
          <i class="all-icons"></i> 
