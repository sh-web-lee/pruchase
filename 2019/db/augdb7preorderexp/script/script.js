...
function soldout() {
	...
	$(".buybtn").attr({
		"href": 'https://www.iobit.com/buy.php?product=db7preorder2295&ref=db7preorder2295exp' + refStr + '&aff=' + aff + '&refs=purchase_db&tw=-8',
		"onclick": "ga('send', 'event', 'db3pcbuy', 'buy', 'db7preorderexp');"
	});
	$(".db-feature .buybtn").html("Pre-order Now");
}
