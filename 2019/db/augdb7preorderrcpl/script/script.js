...
function soldout() {
	...
	$(".buybtn").attr({
		"href": 'https://www.iobit.com/buy.php?product=pl-db7preorder79&ref=pl_db7preorder79rc'+refStr+'&aff=' + aff + '&refs=pl_purchase_db&tw=-8',
		"onclick": "ga('send', 'event', 'dbbuy', 'buy', 'db7preorderrc79-pl');"
	});
}
