...
function soldout() {
	...
	$(".buybtn").attr({
		"href": 'https://www.iobit.com/buy.php?product=pt-db7preorder7999&ref=pt-db7preorder7999rc' + refStr + '&aff=' + aff + '&refs=pt_purchase_db&tw=-8',
		"onclick": "ga('send', 'event', 'db3pcbuy', 'buy', 'db7preorderrc-pt');"
	});
}
// soldout();
