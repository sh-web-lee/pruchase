          ...
          <div class="curvebox">
            ...
            <span class="four">
					...
					<ul class="price clearfix">
						...
						<li class="last">
							<a class="buybtn" 
							   href="https://www.iobit.com/buy.php?product=de-db83pc2499&ref=de_trialbuydb83pc<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=de_purchase_db"
							   onclick="ga('send', 'event', 'db3pcbuy', 'buy', 'dbpurchase-trialbuy-de')">
