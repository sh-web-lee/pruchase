...
<div class="banner">
  ...
  <div class="wrapper">
    ...
    <dl class="price">
      ...
      <dd>
        <a href="https://www.iobit.com/buy.php?product=es-db73pcsdpfiu1799&ref=es_db73pcsdpfiupurchase1911xr<?php echo $refStr;?>&refs=es_purchase_db"
           onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbxrpurchase1911-es')"
           class="buybtn">
          Comprar ahora
        </a>
      </dd>
    ...
    <div class="message">
      <div class="left-message">
        ...
        <div class="title">
          ...
          <p>3 PCs / 1 año <strong>17,99€</strong> <del>74,85€</del></p>
        </div>
        <ul>
  ...
  <table border="0" cellspacing="0" cellpadding="0" width="100%">
    ...
    <tfoot>
      <tr>
        <th colspan="4"></th>
        <th class="itema">
          <del>164,78€ </del> <strong>17,99€</strong>
          <a href="https://www.iobit.com/buy.php?product=es-db73pcsdpfiu1799&ref=es_db73pcsdpfiupurchase1911xr<?php echo $refStr;?>&refs=es_purchase_db"
             onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbxrpurchase1911-es')"
             class="buybtn">
            Comprar ahora
