          ...
          <div class="curvebox">
            ...
            <span class="four">
					...
					<ul class="price clearfix">
						...
						<li class="last">
							<a class="buybtn"
							   href="https://www.iobit.com/buy.php?product=it-db83pc1999&ref=it_db83pc1999trial<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=it_purchase_db"
							   onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase3PC1999trial-it')">
                APPROFITTANE SUBITO
							</a>
						</li>
					</ul>
