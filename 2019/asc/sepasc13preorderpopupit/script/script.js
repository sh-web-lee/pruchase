...
function soldOut() {
  ...
  $(".floatlayer .number").html("Non perdere di nuovo lo sconto di <strong>65%</strong>!").addClass("soldout");
  $(".buybtn").attr({
    "href": 'https://www.iobit.com/buy.php?product=it-asc13preorder1799&ref=it_asc13predorderpopup1799' + refStr + '&aff=' + aff + '&refs=it_purchase_asc&tw=-8',
    "onclick": "ga('send', 'event', 'ascbuy', 'buy', 'asc13predorder1799popup-it');"
  });
