...
<title>Eksklusive 77% rabat på Advanced SystemCare Pro & og få en product gratis</title>
...
<!--  end -->
  ...
  <div class="banner">
    <div class="wrapper">
      ...
      <div class="title">
        <h1>Stortudsalg</h1>
        <p> Spar op til 77% på ASC PRO og få en brugbar gratis gave med i købet!</p>
      </div>
      <div class="box">
        <h3>54% RABAT</h3>
        <dl>
        ...
        <a href="https://www.iobit.com/buy.php?product=dk-asc121pc179&ref=dk_asc121pcpurchase201904<?php echo $refStr;?>&refs=dk_purchase_asc" onclick="ga ('send', 'event', 'ascbuy', 'buy', ascpurchase1903-dk')" class="buybtn border">Køb nu</a>
      </div>
       <div class="box three-box">
        ...
        <a href="https://www.iobit.com/buy.php?product=dk-asc123pcpf189&ref=dk_asc123pcpfpurchase201903<?php echo $refStr;?>&refs=dk_purchase_asc" onclick="ga ('send', 'event', 'ascbuy', 'buy', ascpurchase1903-dk')" class="buybtn">Køb nu</a>
      </div>
    </div>
  </div>
  <!-- banner end -->
  ...
  <div class="donation">
    <div class="wrapper">
      ...
      <p>Lige nu får du gratis 1 nyttige værktøjer!</p>
      <div class="list">
        <img src="<?php echo getStaticUrl('images/gift_pf.png')?>" alt="Protected Folder" />
        <div class="text">
          <h3>Protected Folder</h3>
          <strong>kr. 0</strong> <del>kr. 399</del>
          <p><i class="all-icons"></i>Ingen lækage af vigtige filer for at sikre dit privatliv</p>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="footbuy">
    <div class="content">
       ...
       <ul>
        <li>
           <i></i>
           1 PC <strong>179 kr</strong> Normalpris:  <del>349 kr</del> <a href="https://www.iobit.com/buy.php?product=dk-asc121pc179&ref=dk_asc121pcpurchase201904<?php echo $refStr;?>&refs=dk_purchase_asc" onclick="ga ('send', 'event', 'ascbuy', 'buy', ascpurchase1903-dk')" class="buybtn">Køb nu</a>
         </li>
         <li class="active three-box">
           <i></i>
           3 pc`er <strong>189 kr</strong> Normalpris:  <del>848 kr</del> <a href="https://www.iobit.com/buy.php?product=dk-asc123pcpf189&ref=dk_asc123pcpfpurchase201903<?php echo $refStr;?>&refs=dk_purchase_asc" onclick="ga ('send', 'event', 'ascbuy', 'buy', ascpurchase1903-dk')" class="buybtn">Køb nu</a>
         </li>
       </ul>
