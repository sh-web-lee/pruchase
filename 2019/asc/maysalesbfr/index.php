...
<body>
    ...
    <div class="wrapper">
      ...
      <!-- title -->
      <h1 class="title">SOLDES ÉTÉ</h1>
      <h3>Jusqu’à <b>-85%</b> sur Advanced SystemCare 12 PRO, premier arrivé, premier servi !</h3>
      ...
      <div class="offer85 clearfix">
        ...
        <div class="message fl">
          ...
          <p class="countdown">
            ...
            <strong>00</strong>M :
            <strong>00</strong>s :
            <strong class="small">000</strong>*
          </p>
          <!-- price -->
          <p class="price">
            <strong>19</strong><span>€99</span> Au lieu de <del>149,97€</del><br>
            <small> 1 an d’abonnement / <b>5</b> PC</small>
          </p>
          <!-- 5pc+gifts  buybtn -->
          <a class="buybtn"
             href="https://www.iobit.com/buy.php?product=fr-asc125pcpfamc1999&ref=fr_asc125pcpfiu1999purchase1905test<?php echo $refstr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_asc"
             onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase1905atest-fr')">
            VITE, J'EN PROFITE
          </a>
        </div>
      </div>
      ...
      <div class="offer65 clearfix">
        ...
        <div class="message fl">
          ...
          <!-- 3pc buybtn -->
          <a class="buybtn"
             href="https://www.iobit.com/buy.php?product=fr-asc123pc1999&ref=fr_asc123pc1999purchase1905test<?php echo $refstr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_asc"
             onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase1905btest-fr')">
            VITE, J'EN PROFITE
          </a>
        </div>
      </div>
...
<?php endif;?>
  ...
  <!-- giftbox end -->
      ...
      <!-- thead -->
		  <thead>
              ...
              Advanced SystemCare  <br> <strong>Free</strong>
				  ...
				  <th class="itema">
					  <div class="box">
              Advanced SystemCare  <br> <strong>PRO</strong> <br> <span>1 an d’abonnement / 3 PC</span>
					  </div>
				  </th>
          <th class="spac"></th>
          <th class="itema">
            <div class="box">
              Advanced SystemCare  <br> <strong>PRO</strong> <br> <span>1 an d’abonnement / <b>5</b> PC</span>
            </div>
          </th>
			  </tr>
		  </thead>
    ...
    <!-- 04 -->
			<tr>
				...
				<td class="virtue">
          Personne ne peut voler votre empreinte digitale numérique <br> pour suivre vos comportements en ligne <sup class="green">nouveau</sup>
        </td>
				<td class="spac"></td>
        <td class="itemb"></td>
        <td class="spac"></td>
    ...
    <!-- 08 -->
			<tr>
				...
				<td class="virtue">
          Nouveau moteur d'optimisation du disque pour <strong>maximiser</strong> les <br> performances PC <sup class="green">nouveau</sup>
				</td>
				<td class="spac"></td>
				<td class="itemb"></td>
				<td class="spac"></td>
    ...
    <!-- 11 -->
			<tr>
				...
				<td class="virtue">
          <strong>Suppression Automatique des publicités & protège</strong> vos infos <br> personnelles une navigation plus sûre
        </td>
				<td class="spac"></td>
				<td class="itemb"></td>
				<td class="spac"></td>
    ...
    <tr>
      ...
      <td class="virtue">
        Prise en charge de 5 PC
      </td>
      <td class="spac"></td>
      <td class="itemb"></td>
      <td class="spac"></td>
      <td class="itema nobg"></td>
      <td class="spac"></td>
      <td class="itema"><i class="star red"></i></td>
    </tr>
		</tbody>
	</table>
	</div>
    ...
    <div class="wrapper clearfix">
      ...
      <div class="asc-select fl">
        ...
        <div class="selecter offer65"
             data-original="49,99 €"
             data-discount="19"
             data-href="https://www.iobit.com/buy.php?product=fr-asc123pc1999&ref=fr_asc123pc1999purchase1905test<?php echo $refstr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_asc"
             data-ga="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase1905btest-fr')">
        ...
        <div class="selecter offer85 active"
             data-original="149,97 €"
             data-discount="19"
             data-href="https://www.iobit.com/buy.php?product=fr-asc125pcpfamc1999&ref=fr_asc125pcpfiu1999purchase1905test<?php echo $refstr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_asc"
             data-ga="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase1905atest-fr')">
          <img src="<?php echo getStaticUrl('images/bottombuy-offer85-off.png')?>" alt=""/>
          <p>ASC PRO 12 <span>1 an / 5 PC</span> + 2 outils Pro</p>
        </div>
      </div>
      <!-- asc-message -->
      <div class="asc-message fr">
        <p class="price"><strong>19</strong><span>€99</span><del>149,97 €</del></p>
        <!-- 19,99 buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=fr-asc125pcpfamc1999&ref=fr_asc125pcpfiu1999purchase1905test<?php echo $refstr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_asc"
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase1905atest-fr')">
  ...
  <div class="popbox">
    ...
    <div class="clearfix">
      ...
      <div class="right fl">
        ...
        <a class="button orange yellow"
           href="https://www.iobit.com/buy.php?product=fr-asc123pc1799&ref=fr_asc123pc1799purchasepop1905test<?php echo $refstr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_asc"
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase1905poptest-fr')">
  ...
  <script>
    ...
    var offer65 = {
        ...
        href: "https://www.iobit.com/buy.php?product=fr-asc123pc1999&ref=fr_asc123pc1999purchase1905test<?php echo $refstr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_asc&tw="+tw,
        ga: "ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase1905btest-fr')",
