...
function soldOut() {
  ...
  $(".buybtn").attr({
    "href": 'https://www.iobit.com/buy.php?product=de-asc13preorder2499&ref=de_asc13preorderrc2499'+refStr+'&aff=' + aff + '&refs=de_purchase_asc&tw=-8',
    "onclick": "ga('send', 'event', 'asc2499buy', 'buy', 'asc13predorderrc-de');"
  });
}
