function soldout() {
	...
	$(".banner .packs .button,.bottomcart .button,.gifts .button").attr("href", $(".banner .three-pcs .button").attr("href"));
	$(".gifts.default").remove();
	$(".gifts.exceed").removeClass("hide");
	$(".bottomcart").addClass("exceed");
	$(".bottomcart h2").html("Odpicuj swój komputer na święta");
	$(".banner h2").html("Prezenty wyprzedane. Zdobądź 65% rabatu świątecznego, póki jeszcze możesz!");
	$(".banner .packs del,.bottomcart del").html("199,90 zł");
...
function timeInit() {
	var date = new Date();
	var cName = "novxmasxr2019pl_t" + date.getDate();
