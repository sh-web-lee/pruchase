...
function soldout() {
	...
	$(".floatlayer .buybtn,.banner .box:eq(1) .buybtn,.comparison .itemd .buybtn").attr("href", "https://www.iobit.com/buy.php?product=asc3m&ref=asc3msold"+refStr+"&aff=" + aff + "&refs=purchase_asc&tw=" + tw);
  $(".floatlayer .buybtn,.banner .box:eq(1) .buybtn,.comparison .itemd .buybtn").attr("onclick", "ga('send', 'event', 'asc3msoldbuy', 'buy', 'ascpurchase-tkb')");
  $(".banner .box:eq(0) .buybtn,.comparison .itemc .buybtn").attr("href", "https://www.iobit.com/buy.php?product=asc1m&ref=asc1msold"+refStr+"&aff=" + aff + "&refs=purchase_asc&tw=" + tw);
  $(".banner .box:eq(0) .buybtn,.comparison .itemc .buybtn").attr("onclick", "ga('send', 'event', 'asc1msoldbuy', 'buy', 'ascpurchase-tkb')");
...
function timeInit() {
	var date = new Date();
	var cName = "enasctkb_t" + date.getDate();
