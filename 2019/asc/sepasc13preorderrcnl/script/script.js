...
function soldOut() {
  ...
  $(".buybtn").attr({
    "href": 'https://www.iobit.com/buy.php?product=nl-asc13preorder1999&ref=nl_asc13preorderrc1999'+refStr+'&aff=' + aff + '&refs=nl_purchase_asc&tw=-8',
    "onclick": "ga('send', 'event', 'ascbuy', 'buy', 'asc13predorderrcsoldout-nl');"
  });
}
