...
function soldout() {
	...
	$(".bottomcart h2").html("Zgarnij zniżkę i odpicuj swój komputer")
	$(".banner h2").html("Prezenty niedostępne. Zdobądź 60% rabatu, póki jeszcze możesz!")
...
function timeInit(){
	var date = new Date();
	var cName = "plascxmas_t" + date.getDate();
