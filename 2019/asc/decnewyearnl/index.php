...
<body>
	 	...
	 	<div class="wrapper">
			...
			<h2>Tijdelijke aanbieding <div class="date"><span>nog maar</span> <strong>00</strong> uur <strong>55</strong> min <strong>55</strong> sec <strong>55</strong> ms</div></h2>
 			...
 			<div class="one-pc-box">
 				...
 				<a href="https://www.iobit.com/buy.php?product=nl-asc131pc1899&ref=nl_asc131pc1899purchase1912<?php echo $refStr;?>&refs=nl_purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase1912-nl')" class="button border">Activeer Nu!</a>
 			</div>
 			<div class="packs">
 				<h2>80% Korting</h2>
 				<div class="img-box clearfix">
 				...
 				<a href="https://www.iobit.com/buy.php?product=nl-asc133pcsdpf1999&ref=nl_asc133pcsdpf1999purchase1912<?php echo $refStr;?>&refs=nl_purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase1912-nl')" class="button">Activeer Nu!</a>
 			</div>
 			<div class="one-pc-box three-pcs">
 				...
 				<a href="https://www.iobit.com/buy.php?product=nl-asc131y3pc1999&ref=nl_asc133pc1999purchase1912<?php echo $refStr;?>&refs=nl_purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase1912-nl')" class="button border">Activeer Nu!</a>
 			</div>
	 	</div>
	</div>
	<div class="payments ">
	...
	<div class="gifts default ">
		<div class="wrapper">
			...
			<a href="https://www.iobit.com/buy.php?product=nl-asc133pcsdpf1999&ref=nl_asc133pcsdpf1999purchase1912<?php echo $refStr;?>&refs=nl_purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase1912-nl')" class="button btn-mid-lag">Claim uw Gratis Cadeaus!</a>
	...
	<div class="gifts exceed hide">
		<div class="wrapper">
			...
			<div class="message">
				<h2>Toch nog 60% Nieuwjaarskorting!</h2>
				<img src="<?php echo $pResUrl; ?>images/gift-box-exceed.png" alt="">
				<dl>
					<dt> <strong>€<b>19</b>,99</strong> <del>€49,99</del></dt>
					<dd><a href="https://www.iobit.com/buy.php?product=nl-asc131y3pc1999&ref=nl_asc133pc1999purchase1912<?php echo $refStr;?>&refs=nl_purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase1912-nl')" class="button">Activeer Nu!</a></dd>
				</dl>
			</div>
		</div>
	</div>
	...
	<div class="bottomcart">
		<div class="wrapper">
			...
			<div class="price">
				...
				<a href="https://www.iobit.com/buy.php?product=nl-asc133pcsdpf1999&ref=nl_asc133pcsdpf1999purchase1912<?php echo $refStr;?>&refs=nl_purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase1912-nl')" class="button btn-mid-lag">Activeer Nu!</a>
				<div class="date"><strong>00</strong> uur <strong>55</strong> min <strong>55</strong> sec <strong>55</strong> ms</div>
			</div>
		</div>
	</div>
