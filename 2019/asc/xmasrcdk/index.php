...
<title>Begrænset tilbud, spar op til 88% på Advanced SystemCare PRO - IObit</title>
...
<div class="banner">
  <div class="wrapper clearfix">
    ...
    <h1>Det helt rigtige til Jul!</h1>
    <div class="banlist">
      ...
      <div class="price">
        ...
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=dk-asc133pc199&&ref=dk_asc133pc199xmasrc1912<?php echo $refStr;?>&refs=dk_purchase_asc"
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'asc3pc199xmasrc1912-dk')">
          Køb nu
        </a>
      </div>
      <ul class="txtlist">
    ...
    <div class="banlist big">
      ...
      <div class="price">
        <p><strong><big>159</big> kr.</strong> Normalpris <del>1.366 kr.</del></p>
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=dk-asc13pfsdamc159&ref=dk_asc13pfsdamc159xmasrc1912<?php echo $refStr;?>&refs=dk_purchase_asc"
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascbun159xmasrc1912-dk')">
          Køb nu
        </a>
      </div>
      <ul class="txtlist">
        <li><i class="all-icons"></i>Spar 1.207 kr.</li>
        <li><i class="all-icons"></i> Advanced SystemCare PRO <del>449 kr.</del></li>
        ...
        <li><i class="all-icons red"></i> AMC Security PRO <del>139 kr.</del></li>
      </ul>
      <div class="discount">
        <b>88% rabat</b>
        <p>1 år</p>
  ...
  <div class="wrapper">
    ...
    <div class="intro-box">
      ...
      <dl class="four">
        ...
        <dd>
          <h3>Frigørelse af mere plads</h3>
          <p>
            Rydder grundigt for junk filer, invalide links, system logfiler og ufuldstændige downloadfiler med avanceret optimering.
          </p>
        </dd>
      </dl>
      <div class="scan"></div>
...
<div class="giftbox">
  <div class="wrapper clearfix">
    <h2>Specialgaver kun til juleudsalg</h2>
    <dl>
    ...
    <dl class="last">
      ...
      <dd>
        ...
        <strong>0 kr.</strong> <del>139 kr.</del>
        <p>All-in-one-beskyttelse og optimering for Android-enheder.</p>
      </dd>
    </dl>
    <div class="price">
      <p><strong><big>159</big> kr.</strong> Normalpris <del>1.366 kr.</del></p>
...
<div class="footer">
  <div class="wrapper">
    <dl>
      ...
      <dd>
        *. Smart Defrag PRO og Protected Folder til 1 år / 1 PC.
      </dd>
      <dd>
        *. Licens til AMC Security PRO med indbyggede annoncer i appen.
      </dd>
    </dl>
...
<div id="floatlayer" class="floatlayer">
  <div class="wrapper clearfix">
    ...
    <h2 class="fl">Giv din gamle PC den perfekte julegave!</h2>
    <div class="price fr">
      <p><strong><big>159</big> kr.</strong> Normalt: <del>1.366 kr.</del></p>
      <a class="buybtn"
         href="https://www.iobit.com/buy.php?product=dk-asc13pfsdamc159&ref=dk_asc13pfsdamc159xmasrc1912<?php echo $refStr;?>&refs=dk_purchase_asc"
         onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascbun159xmasrc1912-dk')">
        Køb nu – spar 88%
