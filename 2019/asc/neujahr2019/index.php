...
<body>
	<div class="banner">
	 	<div class="wrapper">
			...
			<h1>Prost Neujahr! - täglich stehen nur 200 Pakete zur Verfügung</h1>
			<h2>Bis zu <b>80%</b> auf ASC PRO sparen und zwei nützliche Produkte gratis erhalten! </h2>
 			...
 			<div class="box one-pc-box four">
 				...
 				<div class="price">
 					...
 					<a class="buybtn small" href="https://www.iobit.com/buy.php?product=de-asc121pc2299&ref=de_asc121pc2299purchase1901<?php echo $refStr;?>&refs=de_purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase1PC1901-de')">
 						JETZT KAUFEN
 					</a>
 				</div>
 			</div>
 			<div class="box sold-box">
 				...
 				<div class="price">
 					...
 					<a class="buybtn yellow" href="https://www.iobit.com/buy.php?product=de-asc12sdpf2499&ref=de_asc123pcbundle1901<?php echo $refStr;?>&refs=de_purchase_asc"  onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase3PCpfsd1901-de')">
 			...
 			<div class="box one-pc-box five">
 				...
 				<div class="price">
 					...
 					<a class="buybtn small" href="https://www.iobit.com/buy.php?product=de-asc123pc2499&ref=de_asc123pc2499purchase1901<?php echo $refStr;?>&refs=de_purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase3PC1901-de')">
 						JETZT KAUFEN
 					</a>
 				</div>
 			</div>
	...
	<div class="gifts">
		<div class="wrapper">
			<h2>Das speizielle Geschenkpaket nur für Neujahr Sale</h2>
			...
			<a class="buybtn orange" href="https://www.iobit.com/buy.php?product=de-asc12sdpf2499&ref=de_asc123pcbundle1901<?php echo $refStr;?>&refs=de_purchase_asc"  onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase3PCpfsd1901-de')">
				<span class="all-icons"></span> Ergreifen Sie Ihre Geschenke schnell
			</a>
	...
	<div class="reviews">
		<div class="wrapper">
			<h2>Weltweite Medien-Auszeichnungen und Kundenbewertungen</h2>
	...
	<div class="compare wrapper">
		...
		<tbody>
			...
			<tr>
				<td class="itemb"><i class="all-icons close">X</i></td>
				<td class="virtue">
					Verringert den digitalen Fingerabrduck, um die Privatsphäre beim Online Surfen <em>zu schützen
		...
		<div class="wrapper">
			<div class="clearfix">
				...
				<div class="price">
					...
					<a class="buybtn yellow orange" href="https://www.iobit.com/buy.php?product=de-asc12sdpf2499&ref=de_asc123pcbundle1901<?php echo $refStr;?>&refs=de_purchase_asc"  onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase3PCpfsd1901-de')">
						<span class="all-icons"></span>
						JETZT KAUFEN
					</a>
				</div>
