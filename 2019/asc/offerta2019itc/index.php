  ...
  <div class="wrapper">
    ...
    <ul>
      ...
      <li class="basic">
        ...
        <!-- 1PC buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=it-asc131pc1999&ref=it_asc131pc1999purchase1902c<?php echo $refStr;?>&refs=it_purchase_asc"
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase1PC1902c-it')">
      ...
      <li class="professional">
        ...
        <!-- 3PC buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=it-asc133pc1799&ref=it_asc133pc1799purchase1902c<?php echo $refStr;?>&refs=it_purchase_asc"
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase3PC1902c-it')">
          <i><img src="<?php echo $pResUrl;?>images/buycart.png" alt=""></i>
          ACQUISTA SUBITO
        </a>
      </li>
      ...
      <li class="professional-plus">
        ...
        <!-- 3PC + gifts buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=it-asc133pciusdpf1999&ref=it_asc133pciusdpf1999purchase1902c<?php echo $refStr;?>&refs=it_purchase_asc"
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase3PCsdiupf1902c-it')">
          <i><img src="<?php echo $pResUrl;?>images/buycart.png" alt=""></i>
          ACQUISTA SUBITO
        </a>
      </li>
...
<div class="gifts wrapper">
  ...
  <a class="buybtn"
     href="https://www.iobit.com/buy.php?product=it-asc133pciusdpf1999&ref=it_asc133pciusdpf1999purchase1902c<?php echo $refStr;?>&refs=it_purchase_asc"
     onclick="ga('send', 'event', 'ascbuy', 'buy', ' ascpurchase3PCsdiupf1902mc-it')">
    ATTIVA ORA!
  </a>
</div>
<!-- end gifts -->
  ...
  <div class="wrapper clearfix">
    ...
    <ul class="selector fl">
      <li class="asc5pc active clearfix"
          data-url="https://www.iobit.com/buy.php?product=it-asc133pciusdpf1999&ref=it_asc133pciusdpf1999purchase1902c<?php echo $refStr;?>&refs=it_purchase_asc&tw=-8"
          data-ga="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase3PCsdiupf1902c-it')"
          data-price="€19,99"
          data-del="€139,99">
        <i></i>
        Professional Plus
      ...
      <li class="asc3pc"
          data-url="https://www.iobit.com/buy.php?product=it-asc133pc1799&ref=it_asc133pc1799purchase1902c<?php echo $refStr;?>&refs=it_purchase_asc&tw=-8"
          data-ga="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase3PC1902c-it')"
          data-price="€17,99"
          data-del="€49,99">
        <i></i>
        Professional
      ...
      <li class="asc1pc"
          data-url="https://www.iobit.com/buy.php?product=it-asc131pc1999&ref=it_asc131pc1999purchase1902c<?php echo $refStr;?>&refs=it_purchase_asc&tw=-8"
          data-ga="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase1PC1902c-it')"
          data-price="€19,99"
          data-del="€29,99">
        <i></i>
        Basic
