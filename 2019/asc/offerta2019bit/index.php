  ...
  <div class="wrapper">
    ...
    <ul>
      ...
      <li class="basic">
        ...
        <!-- 1PC buybtn -->
        <a class="buybtn"
           href="http://www.iobit.com/buy.php?product=it-asc121pc2199&ref=it_asc121pc2199purchase1902b<?php echo $refStr;?>&refs=it_purchase_asc"
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase1PC1902b-it')">
      ...
      <li class="professional">
        ...
        <!-- 3PC buybtn -->
        <a class="buybtn"
           href="http://www.iobit.com/buy.php?product=it-asc123pc1799&ref=it_asc123pc1799purchase1902b<?php echo $refStr;?>&refs=it_purchase_asc"
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase3PC1902b-it')">
          <i><img src="<?php echo $pResUrl;?>images/buycart.png" alt=""></i>
          ACQUISTA SUBITO
        </a>
      </li>
      ...
      <li class="professional-plus">
        ...
        <div class="box">
          <img src="<?php echo $pResUrl;?>images/asc-5pc.png" alt="Advanced SystemCare PRO 12">
        ...
        <!-- 3PC buybtn -->
        <a class="buybtn"
           href="http://www.iobit.com/buy.php?product=it-asc125pciusdpf2199&ref=it_asc125pc2199purchase1902b<?php echo $refStr;?>&refs=it_purchase_asc"
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase5PC1902b-it')">
          <i><img src="<?php echo $pResUrl;?>images/buycart.png" alt=""></i>
          ACQUISTA SUBITO
        </a>
      </li>
...
<div class="benfits">
  <div class="wrapper">
    <h2>
      Più funzioni esclusive, <br>
      Più veloce e più sicuro sarà il tuo PC!</h2>
    <div class="showcase">
      <div class="inner">
        <ul class="screenshot">
          <li>
...
<div class="gifts wrapper">
  ...
  <dl class="asc">
    <dt>ASC PRO</dt>
    <dd>
      <h3>ASC PRO <span>5PC / 1 Anno</span></h3>
  ...
  <a class="buybtn"
     href="http://www.iobit.com/buy.php?product=it-asc125pciusdpf2199&ref=it_asc125pc2199purchase1902b<?php echo $refStr;?>&refs=it_purchase_asc"
     onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase5PC1902mb-it')">
    ATTIVA ORA!
  </a>
</div>
<!-- end gifts -->
  ...
  <div class="wrapper clearfix">
    ...
    <ul class="selector fl">
      <li class="asc5pc active clearfix"
          data-url="http://www.iobit.com/buy.php?product=it-asc125pciusdpf2199&ref=it_asc125pc2199purchase1902b<?php echo $refStr;?>&refs=it_purchase_asc"
          data-ga="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase5PC1902b-it')"
          data-price="€21,99"
          data-del="€139,99">
        <i></i>
        Professional Plus
      ...
      <li class="asc3pc"
          data-url="http://www.iobit.com/buy.php?product=it-asc123pc1799&ref=it_asc123pc1799purchase1902b<?php echo $refStr;?>&refs=it_purchase_asc"
          data-ga="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase3PC1902b-it')"
          data-price="€17,99"
          data-del="€49,99">
        <i></i>
        Professional
      ...
      <li class="asc1pc"
          data-url="http://www.iobit.com/buy.php?product=it-asc121pc2199&ref=it_asc121pc2199purchase1902b<?php echo $refStr;?>&refs=it_purchase_asc"
          data-ga="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase1PC1902b-it')"
          data-price="€21,99"
          data-del="€29,99">
        <i></i>
        Basic
