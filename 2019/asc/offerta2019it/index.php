  ...
  <div class="wrapper">
    ...
    <ul>
      ...
      <li class="basic">
        ...
        <!-- 1PC buybtn -->
        <a class="buybtn"
           href="http://www.iobit.com/buy.php?product=it-asc121pc2199&ref=it_asc121pc2199purchase1902<?php echo $refStr;?>&refs=it_purchase_asc"
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase1PC1902-it')">
      ...
      <li class="professional">
        ...
        <!-- 3PC buybtn -->
        <a class="buybtn"
           href="http://www.iobit.com/buy.php?product=it-asc123pc1799&ref=it_asc123pc1799purchase1902<?php echo $refStr;?>&refs=it_purchase_asc"
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase3PC1902-it')">
          <i><img src="<?php echo $pResUrl;?>images/buycart.png" alt=""></i>
          ACQUISTA SUBITO
        </a>
      </li>
      ...
      <li class="professional-plus">
        ...
        <!-- 3PC buybtn -->
        <a class="buybtn"
           href="http://www.iobit.com/buy.php?product=it-asc125pciusdpf2199&ref=it_asc125pc2199purchase1902<?php echo $refStr;?>&refs=it_purchase_asc"
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase5PC1902-it')">
          <i><img src="<?php echo $pResUrl;?>images/buycart.png" alt=""></i>
          ACQUISTA SUBITO
        </a>
      </li>
...
<div class="gifts wrapper">
  ...
  <a class="buybtn"
     href="http://www.iobit.com/buy.php?product=it-asc125pciusdpf2199&ref=it_asc125pc2199purchase1902<?php echo $refStr;?>&refs=it_purchase_asc"
     onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase5PC1902m-it')">
    ATTIVA ORA!
  </a>
</div>
<!-- end gifts -->
  ...
  <div class="wrapper clearfix">
    ...
    <ul class="selector fl">
      <li class="asc5pc active clearfix"
          data-url="http://www.iobit.com/buy.php?product=it-asc125pciusdpf2199&ref=it_asc125pc2199purchase1902<?php echo $refStr;?>&refs=it_purchase_asc"
          data-ga="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase5PC1902-it')"
          data-price="€21,99"
          data-del="€139,99">
        <i></i>
        Professional Plus
      ...
      <li class="asc3pc"
          data-url="http://www.iobit.com/buy.php?product=it-asc123pc1799&ref=it_asc123pc1799purchase1902<?php echo $refStr;?>&refs=it_purchase_asc"
          data-ga="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase3PC1902-it')"
          data-price="€17,99"
          data-del="€49,99">
        <i></i>
        Professional
      ...
      <li class="asc1pc"
          data-url="http://www.iobit.com/buy.php?product=it-asc121pc2199&ref=it_asc121pc2199purchase1902<?php echo $refStr;?>&refs=it_purchase_asc"
          data-ga="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase1PC1902-it')"
          data-price="€21,99"
          data-del="€29,99">
        <i></i>
        Basic
