...
<script type="text/javascript" src="<?php echo $pRootUrl; ?>tpl/js/stats.js"></script>
 <div class="header">
   <div class="wrapper">
     ...
     <p>On <strong>May 14<sup>th</sup> 2019</strong>, Microsoft released a patch for a remote code execution vulnerability in Remote Desktop Services that affects Windows XP, Windows 7 or other early operating systems. This vulnerability is pre-authentication and requires no user interaction. In other words, once attackers exploit this vulnerability, they could take control of your computer to view, change or delete your data and even lead to system paralysis. To make things worse, the affected systems may propagate the virus from vulnerable computer to vulnerable computer in a similar way as the WannaCry malware spread across the globe in 2017.</p>
   </div>
 </div>
 <div class="asc-message wrapper">
   <p>So, we strongly recommend our users to upgrade to Advanced SystemCare PRO to reduce the risk of being attacked. Advanced SystemCare PRO could provide double protection by timely applying important windows updates to avoid future attacks and reinforcing your system to defend against potential attacks. Now, upgrade with <strong>75% OFF! </strong></p>
   <div class="buy-content">
     <img src="<?php echo getStaticUrl('images/asc-message.png')?>" alt="Advanced SystemCare PRO" class="asc-box">
     <dl class="price">
       <dt><a href="https://www.iobit.com/buy.php?product=asc123pc1999&ref=asc19992019event1<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_asc " onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase-2019event1');" class="buybtn">Upgrade Now - <strong>$19.99 </strong></a></dt>
       <dd>1 Year Subscription / 3 PCs</dd>
       <dd><p>Save <strong>$69.98</strong> for IObit Valued Users Only</p></dd>
     </dl>
   </div>
 </div>
