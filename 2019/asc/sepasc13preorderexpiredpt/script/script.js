...
function soldOut() {
  ...
  $(".price strong").html("R$ <b>76,99</b>");
  $('.banner .price strong').after("<del>R$ 199,90</del>");
  $(".banner .number").html("As ofertas de pré-venda esgotaram por hoje. Não perca <strong>60%</strong> de desconto!").addClass("soldout");
  $(".floatlayer .number").html("Não perca <strong>60%</strong> de desconto!").addClass("soldout");
  $(".buybtn").attr({
    "href": 'https://www.iobit.com/buy.php?product= pt-asc13preorder7699&ref=pt_asc13preorderexpiredsoldout'+refStr+'&aff=' + aff + '&refs=pt_purchase_asc&tw=-8',
    "onclick": "ga('send', 'event', 'ascbuy', 'buy', 'asc13predorderexpiredsoldout-pt'); "
  });
}
// soldOut();
...
$(".dg-next").click(function(){ 
  ...
  $('.dg-container ul li:eq(1)').removeClass("active")
  $('.dg-container ul li:eq(2)').removeClass("two")
  $('.dg-container ul li:eq(3)').removeClass("three")


  $('.dg-container ul').find('li:first').appendTo($('.dg-container ul'));

  $('.dg-container ul li:eq(0)').addClass("first")
  $('.dg-container ul li:eq(1)').addClass("active")
  $('.dg-container ul li:eq(2)').addClass("two")
  //$('.dg-container ul li:eq(3)').addClass("three")
  $('.dg-container ul li:eq(3)').addClass("three")
