...
<head>
  ...
  <title>60% OFF Advanced SystemCare PRO + Free Mid-year Gifts</title>
...
<div class="banner">
  <div class="wrapper clearfix">
    ...
    <div class="left-message">
      <img class="box" src="<?php echo $pResUrl;?>images/banner-box.png" alt="Advanced SystemCare PRO 12">
      <img class="off" src="<?php echo $pResUrl;?>images/banner-off.png" alt="60% off">
      <img class="gift" src="<?php echo $pResUrl;?>images/banner-gift.png" alt="Smart Defrag PRO 6 + Protected Folder">
    </div>
    <!-- right-message -->
    <div class="right-message">
      <h3>Top PC Cleaner + 2 Free Gifts</h3>
      <!-- countdown -->
      <div class="number">
      ...
      <!-- price -->
      <p class="price">$<strong>19</strong>.99 <del> $89.93</del></p>
      <!-- buybtn -->
      <a class="buybtn"
         href="https://www.iobit.com/buy.php?product=asc12sdpf1999&ref=ascsdpf1999midyear<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=purchase_asc"
         onclick="ga('send', 'event', 'asc1999buymid', 'buy', 'ascpurchase-midyear');">
        Buy Now
      </a>
      <!-- note -->
...
<div class="feature">
  <div class="wrapper">
    <h2>Why Is Advanced SystemCare PRO Worth Paying for?</h2>
    <dl class="top-message clearfix">
      <dd class="fl">
        <h3>Clean & Speed up PC</h3>
        <ul>
          <li>1-click to release disk space by removing junk files, useless <br> shortcuts etc.</li>
          <li>Prevent system crash and improve pc performance by <br> getting rid of registries and cleaning RAM automatically.</li>
          <li>Optimize browser settings to accelerate internet <br> connection to 300%* faster.</li>
          <li>Quickly disable unnecessary startup items for boost PC <br> startup to 200%* faster. </li>
        </ul>
      </dd>
    ...
    <dl class="bottom-message clearfix">
      ...
      <dd class="fr">
        ...
        <ul>
          <li>Stop untrusted programs attempting to access your personal data.</li>
          <li>Automatically clear online trace for you to avoid malicious tracking.</li>
          <li>Remove the deepest infections and protect pc against various threats.</li>
          <li>Stop malicious infection with real-time protection.</li>
        </ul>
      </dd>
    </dl>
  </div>
  ...
  <div class="service wrapper clearfix">
    <dl class="fl clearfix">
      ...
      <dd class="fl">
        ...
        <p>
          We're confident that activating PRO edition will improve your <br>
          PC performance for affordable price!
        </p>
      </dd>
    </dl>
    <dl class="fr">
...
<div class="float">
  <div class="wrapper clearfix">
    <div class="left-message">
      <img class="box" src="<?php echo $pResUrl;?>images/float-box.png" alt="Advanced SystemCare PRO 12">
      <img class="off" src="<?php echo $pResUrl;?>images/float-off.png" alt="60% off">
...
<script>
  var soldout = {
    ...
    bannerTitle: "Top PC Cleaner",
    floatGift: "<?php echo $pResUrl;?>images/float-gift-soldout.png",
    del: "$49.99",
    href: "https://www.iobit.com/buy.php?product=asc12ebook3pc&ref=asc1999midyear<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=purchase_asc",
    ga: "ga('send', 'event', 'asc1999buymid', 'buy', 'ascpurchase-midyearsold');"
  }
</script>
</body>
</html>