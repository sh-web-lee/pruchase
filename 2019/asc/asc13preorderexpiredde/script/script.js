...
function soldOut() {
  ...
  $(".floatlayer .number").html("<strong>58%</strong> Rabatt nicht verpassen!").addClass("soldout")
  $(".buybtn").attr({
    "href": 'https://www.iobit.com/buy.php?product=de-asc13preorder2499&ref=de_asc13preorderexpired2499' + refStr + '&aff=' + aff + '&refs=de_purchase_asc&tw=-8',
    "onclick": "ga('send', 'event', 'asc2499buy', 'buy', 'asc13predorderexp-de');"
  });
}
// soldOut();
