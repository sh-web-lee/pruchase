...
function soldOut() {
  ...
  $(".buybtn").attr({
    "href": 'https://www.iobit.com/buy.php?product=fr-asc13preorder1699&ref=fr_asc13preorderrc1699'+refStr+'&aff=' + aff + '&refs=fr_purchase_asc&tw=-8',
    "onclick": "ga('send', 'event', 'asc1699buy', 'buy', 'asc13predorderrc-fr'); "
  });
}
