...
<script type="text/javascript" src="<?php echo $pRootUrl; ?>tpl/js/stats.js"></script>
  ...
  <div class="banner">
    <div class="wrapper clearfix">
      ...
      <div class="title">
        ...
        <h2> Bis zu 75% reduziert! Nur solange der Vorrat reicht!</h2>
      </div>
      <div class="box">
        <dl class="clearfix">
          <dt><img src="<?php echo getStaticUrl('images/asc-box.png')?>" alt="" /></dt>
          <dd>
            Normalpreis: <del>59,99€</del>
            <strong>24,99€</strong>
            <span>3 PCs</span>
          </dd>
        </dl>
        <a href="https://www.iobit.com/buy.php?product=de-asc131pc2299&ref=de_asc131pcpurchase1905<?php echo $refStr;?>&refs=de_purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase1pc1910-de')" class="buybtn border">Jetzt kaufen</a>

      </div>
      <div class="box three-box">
       <dl class="clearfix">
          <dd>
            Normalpreis: <del>111,99€</del>
            <strong>27,99€</strong>
            <span>5 PCs</span>
          </dd>
          <dt><img src="<?php echo getStaticUrl('images/asc-gift-box.png')?>" alt="" /><i class="info"></i></dt>
        </dl>
        <a href="https://www.iobit.com/buy.php?product=de-asc13sdpf2499&ref=de_asc133pcsdpf1905<?php echo $refStr;?>&refs=de_purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase3pc1910-de')" class="buybtn">Jetzt kaufen</a>
  ...
  <div class="intro">
    <div class="wrapper">
      ...
      <a href="#" class="tag"> Für weitere Details klicken Sie hier</a>
    </div>
  </div>
  <!-- intro end -->
    ...
    <div class="wrapper">
      ...
      <div class="gift">
        ...
        <dl>
          ...
          <dd>Passwortschutz für Ordner und Dateien  <br> unter Windows bieten. </dd>
  ...
  <div class="floatlayer" id="floatlayer">
   <div class="wrapper">
     ...
     <h2> 1 Jahr, 5 Rechner  <strong> 27,99</strong></h2>
