...
<title>68% ZNIŻKI na Advanced SystemCare PRO - IObit</title>
...
<meta property="og:title" content="68% ZNIŻKI na Advanced SystemCare PRO - IObit">
...
<script type="text/javascript" src="<?php echo $pRootUrl; ?>tpl/js/stats.js"></script>
  ...
  <div class="banner">
    <div class="wrapper">
      ...
      <div class="pricebox">
        <dl class="price">
          <dt>TYLKO: <strong>64,90 zł </strong><del>199,90 zł</del></dt>
          <dd>
            <a class="buybtn bigbtn" href="https://www.iobit.com/buy.php?product=pl-asc1564-ac&ref=pl_asc-ac-register&aff=<?php echo $_GET['aff']; ?>&refs=pl_ac_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascac-pl');">
              <div class="inner">
                <i class="all-icons"></i>
                <span>KUP TERAZ</span>
              </div>
  ...
  <div class="floatlayer" id="floatlayer">
    <div class="wrapper clearfix">
      <div class="left">
        ...
        <p><strong>68% TANIEJ</strong>, aby Twój komputer działał z maksymalną wydajnością</p>
      </div>
      <div class="pricebox">
        <dl class="price fr">
          <dt><strong>64,90 zł </strong><del>199,90 zł</del></dt>
          <dd>
            <a class="buybtn smallbtn" href="https://www.iobit.com/buy.php?product=pl-asc1564-ac&ref=pl_asc-ac-register&aff=<?php echo $_GET['aff']; ?>&refs=pl_ac_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascac-pl');">
              <div class="inner">
                <i class="all-icons"></i>
                <span>KUP TERAZ</span>
              </div>
