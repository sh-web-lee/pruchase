...
if(in_array($_GET['pop'],array('x_asc','xr_sdpasc','xr_dbpasc','xi_asc','xb_asc','xr_asc'))){
  $refstr.='-'.$_GET['pop'];
}
...
<head>
  ...
  <title>Spécial Noël - ne manquez pas nos cadeaux préparés pour vous - IObit</title>
  ...
  <div class="wrapper">
    ...
    <div class="message clearfix">
      ...
      <div class="message-box small fl">
        ...
        <!-- buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=fr-asc131pc1799&ref=fr_asc131pc1799rightcor<?php echo $refstr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_asc"
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchaserightcorb-fr')">
      ...
      <div class="message-box large fr">
        ...
        <a class="buybtn large"
           href="https://www.iobit.com/buy.php?product=fr-asc13isuiusd1799&ref=fr_asc13isuiusd1799rightcor<?php echo $refstr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_asc"
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchaserightcora-fr')">
          <i class="all-icons"></i> Vite, J’en Profite
        </a>
        <!-- countdown -->
        <p class="countdown">
...
<div class="bottombuy">
  <div class="wrapper clearfix">
    ...
    <dl class="fr">
      <dd>
        <!-- price -->
        <p class="price white"><span><big>17</big> <sup>€</sup> <sub>99</sub></span> <del>139,96€</del></p>
        <!-- buybtn -->
...
<div class="float">
  ...
  <a class="buybtn small"
     href="https://www.iobit.com/buy.php?product=fr-asc13isuiusd1799&ref=fr_asc13isuiusd1799rightcorpop<?php echo $refstr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_asc"
     onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchaserightcorpp-fr')">
    J’en Profite
  </a>
  <!-- close -->
  <a class="close"
...
<div class="pop">
  <div class="coupon">
    <a class="pop-buy"
       href="https://www.iobit.com/buy.php?product=fr-asc133pc1799&ref=fr_asc133pc1799purchase1911<?php echo $refstr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_asc"
       onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase1911pop-fr')"></a>
    <!-- hand -->
    <img class="hand" src="<?php echo getStaticUrl('images/hand.png')?>" alt="">
    <!-- close -->
    <a class="pop-close"
       href="javascript: closePop();"
       onclick="ga('send', 'event', 'ascclose', 'click', 'purchaseb-fr');">
      ×</a>
  </div>
</div>

<script>
  var ref = "<?php echo $refstr;?>";
</script>
