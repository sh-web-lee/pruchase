...
function soldOut() {
  ...
  $(".banner .number").html("I pre-ordini con €0 sono esauriti oggi. Non perdere di nuovo lo sconto di <strong>65%</strong> !").addClass("soldout");
  $(".floatlayer .number").html("Non perdere di nuovo questo sconto del <strong>65%</strong> !").addClass("soldout");
  $(".buybtn").attr({
    "href": 'http://www.iobit.com/buy.php?product=it-asc13preorder1799&ref=it_asc13preorderofficial1799'+refStr+'&aff=' + aff + '&refs=it_purchase_asc&tw=-8',
    "onclick": "ga('send', 'event', 'ascbuy', 'buy', 'asc13 predorderofficialsd-it');"
  });
}
var c =0;
var d =0;
