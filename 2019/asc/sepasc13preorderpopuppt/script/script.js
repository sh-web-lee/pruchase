...
function soldOut() {
  ...
  $(".buybtn").attr({
    "href": 'https://www.iobit.com/buy.php?product= pt-asc13preorder7699&ref=pt_asc13preorderpopupsoldout' + refStr + '&aff=' + aff + '&refs=pt_purchase_asc&tw=-8',
    "onclick": "ga('send', 'event', 'ascbuy', 'buy', 'asc13predorderpopupsoldout-pt');"
  });
}
