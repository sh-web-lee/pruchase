$.fn.scrollWindow=function(topheight,scrollclass,ClassName,rehight){
  $(window).on('scroll', function () {
    if ($(window).scrollTop() > topheight.offset().top -rehight) {
...
$(function() {
  ...
  //feature + popbox
  $(window).scrollWindow($(".feature h2"),$('.feature dl,.feature .scan,.popbox'),("on"), 100);
  //intro
