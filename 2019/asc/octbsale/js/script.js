...
function soldOut() {
	...
	$(".between-buy").css({"background" : "none"});
	$(".between-buy .content").remove();
	$(".between-buy p strong,.comparison th strong").html("$19.99");
	$(".banner .buybtn,.between-buy .buybtn,.comparison .buybtn,.floatlayer .buybtn").attr("href", "https://www.iobit.com/buy.php?product=asc133pc1999&ref=asc1999av2019soldout"+refStr+"&aff=" + aff + "&refs=purchase_asc&tw=" + tw).attr("onclick", "ga('send', 'event', 'asc1999soldbuy', 'buy', 'ascpurchase-2019av');");
}
