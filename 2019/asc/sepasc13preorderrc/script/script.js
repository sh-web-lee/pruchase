...
function soldOut() {
  ...
  $(".buybtn").attr({
    "href": 'https://www.iobit.com/buy.php?product=asc13preorder1677&ref=asc13preorderrc1677'+refStr+'&aff=' + aff + '&refs=purchase_asc&tw=-8',
    "onclick": "ga('send', 'event', 'asc1677buy', 'buy', 'asc13predorderrc');"
  });
}
