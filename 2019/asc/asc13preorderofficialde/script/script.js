...
function sect03() {
 var tl = new TimelineMax();
 tl.to(".icon-list .icons01", 1, {top:18,left: 3},'+=.5')
   .to(".icon-list .icons02", 1, {top:25,right: 23},'-=1')
   .to(".icon-list .icons03", 1, {bottom:112,left: -30},'-=1')
   .to(".icon-list .icons04", 1, {bottom:-25,left: 167},'-=1')
   .to(".icon-list .icons05", 1, {bottom:17,right: 0},'-=1')

} 
function soldOut() {
  var aff = MApp(2.2).url.getParameters('aff');
  $(".price").addClass("soldout");
  $(".price strong").html("<b>24</b>.77€");
  $('.banner .price strong').after("<del>59.99€</del>");
  $(".banner .number").html("0€ Vorbestellung ist nun nicht verfügbar. <strong>58%</strong> Rabatt nicht verpassen!").addClass("soldout");
  $(".floatlayer .number").html("Verpassen Sie nicht <strong>58%</strong> Rabatt wieder!").addClass("soldout");
  $(".buybtn").attr({
    "href": 'https://www.iobit.com/buy.php?product=de-asc13preorder2499&ref=de_asc13preorderofficial2499'+refStr+'&aff=' + aff + '&refs=de_purchase_asc&tw=-8',
    "onclick": "ga('send', 'event', 'asc2499buy', 'buy', 'asc13predorderofficial-de');"
  });
}
var c =0;
var d =0;
