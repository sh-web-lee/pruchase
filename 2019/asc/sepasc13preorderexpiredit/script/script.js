...
function soldOut() {
  ...
  $(".price,.floatlayer img").addClass("soldout");
  ...
  $(".buybtn").attr({
    "href": 'https://www.iobit.com/buy.php?product=it-asc13preorder1799&ref=it_asc13preorderexpired1799' + refStr + '&aff=' + aff + '&refs=it_purchase_asc&tw=-8',
    "onclick": "ga('send', 'event', 'ascbuy', 'buy', 'asc13predorde1799rexpired-it');"
  });
}
// soldOut();
