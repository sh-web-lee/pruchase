...
function soldOut() {
  ...
  $(".buybtn").attr({
    "href": 'https://www.iobit.com/buy.php?product=sv-asc13preorder299&ref=sv_asc13preorderofficial299' + refStr + '&aff=' + aff + '&refs=sv_purchase_asc&tw=-8',
    "onclick": "ga('send', 'event', 'ascbuy', 'buy', 'asc13predorderofficial299-sv');"
  });
}
// soldOut();
