...
if ($_GET['action'] == 'getPacks') {
  $date = $_GET['d'];
  $c_name = 'esascxnovxr_p' . $date;
  $c_name_t='esascxnovxr_t' . $date;
...
<body>
    ...
    <div class="wrapper clearfix">
      ...
      <div class="right fr">
        ...
        <div class="price">
          ...
          <a class="buybtn"
             href="https://www.iobit.com/buy.php?product=es-asc133pcsdpfisu1677&ref=es_asc133pcpfsdisu1677purchase1911xr<?php echo $refStr;?>&refs=es_purchase_asc"
             onclick="ga('send', 'event', 'ascbuy', 'buy', 'asc3pcpurchase1911xr-es')">
            COMPRAR AHORA
          </a>
        </div>
      </div>
  ...
  <div class="centbuy price wrapper">
    ...
    <p class="pick">Solo <b class="pickNum">39</b> piezas disponibles ahora, ¡date prisa!</p>
  </div>
  <!-- centbuy end -->
  ...
  <div class="bottombuy wrapper clearfix">
    <h2>!Aprovecha la oportunidad de la oferta exclusiva de Navidad!</h2>
