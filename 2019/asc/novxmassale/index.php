...
<head>
  ...
  <meta name="viewport" content="width=device-width,initial-scale=1">
    ...
    pageDevice('enascnew','springsale.php');
...
//		}else {
			...
			}else if((deviceStr=='asc_so1')||(deviceStr=='asc_so3')){
				window.location.replace('./updater.php' + queryStr);
			}*/
//		}
	</script>
...
<div class="banner">
  ...
  <div class="cloud pink"></div>
  <div class="tree large"></div>
  ...
  <!-- wrapper -->
    ...
    <!-- fawn -->
    <div class="fawn"><div class="fawn-head"></div></div>
    <!-- xmastree -->
    ...
    <!-- asc message -->
        ...
        <!-- buybtn -->
				<a class="buybtn"
           href="https://www.iobit.com/buy.php?product=asc133pc1999&ref=en-asc3pc<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_asc"
           onclick="ga('send', 'event', 'asc1999buy', 'buy', 'ascpurchase-2019av');">
    ...
    <!-- asc bundle message -->
        ...
        <!-- buybtn -->
				<a class="buybtn"
           href="https://www.iobit.com/buy.php?product=asc13sdiuamc2198&ref=en-asc3pcsdiuamc<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_asc"
           onclick="ga('send', 'event', 'asc2198buy', 'buy', 'ascpurchase-2019av');">
          <i></i> <span>Activate Now</span>
        </a>
  ...
  <div class="pop-container clearfix">
      ...
      <div class="message clearfix">
        <dl>
          ...
          <dd>
            ...
            <!-- buybtn -->
            <a class="buybtn"
               href="https://www.iobit.com/buy.php?product=asc133pc1799&ref=en-asc3pc1799pop<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=purchase_asc"
               onclick="ga('send', 'event', 'asc1799buy', 'buy', 'ascpurchase-2019av');">
              Get It Now
            </a>
            <ul>
        ...
        <dl>
          ...
          <dd>
            ...
            <a class="buybtn another"
               href="https://www.iobit.com/buy.php?product=asc13sdiuamc1978&ref=en-asc3pcsdiuamc1978pop<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=purchase_asc"
               onclick="ga('send', 'event', 'asc1978buy', 'buy', 'ascpurchase-2019av');">
              Get It Now
            </a>
            <ul>
    ...
    <dl class="message-soldout clearfix">
      ...
      <dd class="fl">
        ...
        <!-- buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=asc133pc1799&ref=en-asc3pc1799soldoutpop<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=purchase_asc"
           onclick="ga('send', 'event', 'asc1799soldbuy', 'buy', 'ascpurchase-2019av');">
          Get It Now
        </a>
      </dd>
    </dl>
