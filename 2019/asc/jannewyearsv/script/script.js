function soldOut() {
  ...
  $(".banner .one-pc-box dl dt strong").html("73%");
  ...
  $(".banner .sold-box .button,.gifts .button").attr("href", "https://www.iobit.com/buy.php?product=sv-asc123pc299&ref=sv_asc123pc299purchase1901" + refStr + "&refs=sv_purchase_asc");
  $(".banner .sold-box .button,.gifts .button").attr("onclick", "ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase3PC1901-sv')");
  onePc();
}
...
function onePc() {
  $(".bottomcart .button").attr("href", "https://www.iobit.com/buy.php?product=sv-asc123pc299&ref=sv_asc123pc299purchase1901" + refStr + "&refs=sv_purchase_asc");
  $(".bottomcart .button").attr("onclick", "ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase3PC1901-sv')");
  $(".bottomcart dl strong").html("<b>299</b>KR");
  $(".bottomcart dl dt del").html("599KR");
  $(".bottomcart dl dt span").html("300kr");
  $(".showcase .img").addClass("one-pc");
}

function threePc() {
  $(".bottomcart .button").attr("href", "https://www.iobit.com/buy.php?product=sv-asc123pcsdpf299&ref=sv_asc123pcsdpfpurchase1901" + refStr + "&refs=sv_purchase_asc");
  $(".bottomcart .button").attr("onclick", "ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase3PCsdpf1901-sv')");
  $(".bottomcart dl strong").html("<b>299</b>KR");
  $(".bottomcart dl del").html("1 097KR");
  $(".bottomcart dl dt span").html("798kr");
