...
//				window.location.replace('./updater.php' + queryStr);
				pageDivide('enasctestab1','./updater.php');
			}
//		}
	</script>
...
<div class="banner">
    ...
    <!-- asc message -->
        ...
        <!-- buybtn -->
				<a class="buybtn"
           href="https://www.iobit.com/buy.php?product=asc133pc1999&ref=asc1999av2019<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_asc"
    ...
    <!-- asc bundle message -->
        ...
        <!-- buybtn -->
				<a class="buybtn"
           href="https://www.iobit.com/buy.php?product=asc13sdiuamc2198&ref=ascsdiuamc2398av2019<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_asc"
  ...
  <div class="pop-container clearfix">
      ...
      <div class="message clearfix">
        <dl>
          ...
          <dd>
            ...
            <!-- buybtn -->
            <a class="buybtn"
               href="https://www.iobit.com/buy.php?product=asc133pc1799&ref=asc1799av2019<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=purchase_asc"
        ...
        <dl>
          ...
          <dd>
            ...
            <a class="buybtn another"
               href="https://www.iobit.com/buy.php?product=asc13sdiuamc1978&ref=ascsdiuamc1978av2019<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=purchase_asc"
    ...
    <dl class="message-soldout clearfix">
      ...
      <dd class="fl">
        ...
        <!-- buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=asc133pc1799&ref=asc1799av2019soldout<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=purchase_asc"
