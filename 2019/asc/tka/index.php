			...
			<div class="banner-left fr">
				<div class="defult">
					...
					<div class="price-box">
						<div class="price-btn clearfix">
							...
							<a href="https://www.iobit.com/buy.php?product=asc12sdiuamc2198&ref=ascsdiuamc2198may2019tka<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_asc" onclick="ga('send', 'event', 'asc2198buy', 'buy', 'ascpurchase-tka');clickCount(2)" class="buy-btn banner-btn-words fr buy-link"><i class="car"></i><span>ACTIVATE NOW</span></a>
						</div>
						<ul class="price-dec">
							<li class="first">
								<span>Original</span>
				...
				<div class="sold-out-banner">
					...
					<div class="price-box">
						<div class="price-btn clearfix">
							<span class="price-num">Now $<strong>21</strong>.98</span>
							<a href="https://www.iobit.com/buy.php?product=asc123pc2198&ref=asc3pc2198may2019tka<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_asc" onclick="ga('send', 'event', 'asc3pcbuy', 'buy', 'ascpurchase-tka');clickCount(2)" class="buy-btn banner-btn-words fr buy-link"><i class="car"></i><span>ACTIVATE NOW</span></a>
						</div>
						<ul class="price-dec">
							<li class="first">
								<span>Original</span>
...
<div class="middle-buy container clearfix">
	<div class="wrapper">
		...
		<div class="btn-content">
			<a href="https://www.iobit.com/buy.php?product=asc12sdiuamc2198&ref=ascsdiuamc2198may2019tka<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_asc" onclick="ga('send', 'event', 'asc2198buy', 'buy', 'ascpurchase-tka');clickCount(2)" class="buy-btn middle-btn">
					<i class="car"></i>
		...
		<div class="bar-banner">
			...
			<div class="bar-right fr">
				...
				<div class="price-btn bar-btn">
					<span class="price-num">Now $<strong>21</strong>.98</span>
					<a href="https://www.iobit.com/buy.php?product=asc123pc2198&ref=asc3pc2198may2019tka<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_asc" onclick="ga('send', 'event', 'asc2198buy', 'buy', 'ascpurchase-201812');clickCount(2)" class="buy-btn banner-btn-words buy-link"><i class="car"></i><span>ACTIVATE NOW</span></a>
				</div>
			</div>
		</div>
	</div>
		...
		<tfoot>
			<tr>
				...
				<th class="item-pro">
					...
					<a href="https://www.iobit.com/buy.php?product=asc12sdiuamc2198&ref=ascsdiuamc2198may2019tka<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_asc" onclick="ga('send', 'event', 'asc2198buy', 'buy', 'ascpurchase-tka');clickCount(2)" class="buy-btn smail-btn"><i class="car"></i><span>ACTIVATE NOW</span></a>
...
<div class="mask-box" style="display: none;">
	...
	<div class="mask-main clearfix">
		...
		<div class="mask-main-right fl">
			...
			<div class="btn-box">
				<a href="https://www.iobit.com/buy.php?product=asc12sdiuamc1999&ref=ascsdiuamc1999may2019tka<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_asc" onclick="ga('send', 'event', 'asc1999buy', 'buy', 'ascpurchase-tka');clickCount(3)" class="buy-btn mask-btn "><i class="car"></i><span>Get My Extra 10% OFF &amp; 3 FREE Gifts</span></a>
			</div>
