...
function soldOut() {
    TweenMax.to($('.cut-box'), 3, {
        ...
        onComplete: function() {
            ...
            $(".buy-btn").attr("href", "https://www.iobit.com/buy.php?product=asc123pc2198&ref=asc3pc2198may2019tka" + refStr + "&aff=" + aff + "&refs=purchase_asc&tw=" + tw).attr('onclick', "ga('send', 'event', 'asc3pcbuy', 'buy', 'ascpurchase-tka');clickCount(4)");
