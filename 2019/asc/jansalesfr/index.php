...
<body>
    ...
    <div class="wrapper">
      ...
      <h3>Jusqu’à <b>-85%</b> sur Advanced SystemCare 12 PRO ( 5 PC ) et obtenez des cadeaux gratuits !</h3>
      <!-- offer65 -->
      <div class="offer65 clearfix">
        ...
        <div class="message fl">
          ...
          <!-- 19,99 buybtn -->
          <a class="buybtn"
             href="https://www.iobit.com/buy.php?product=fr-asc123pc1999&ref=fr_asc123pc1999purchase1901<?php echo $refstr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_asc"
             onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase1901a-fr')">
            VITE, J'EN PROFITE
          </a>
        </div>
      </div>
      ...
      <div class="offer85 clearfix">
        ...
        <div class="message fl">
          ...
          <!-- 19,99 buybtn -->
          <a class="buybtn"
             href="https://www.iobit.com/buy.php?product=fr-asc125pcpfamc1999&ref=fr_asc125pcpfiu1999purchase1903<?php echo $refstr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_asc"
             onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase1901b-fr')">
            VITE, J'EN PROFITE
          </a>
        </div>
      </div>
...
<?php endif;?>
  ...
  <div class="giftbox">
    <div class="wrapper">
      <h2>Profitez des cadeaux exclusives uniquement pour les utilsateurs 5 PC</h2>
      <div class="clearfix">
        <dl class="clearfix">
      ...
      <div class="price">
        <h3>Vite, les cadeaux exclusifs sont disponibles à quantité limitée !</h3>
    ...
    <div class="wrapper clearfix">
      ...
      <div class="asc-select fl">
        ...
        <div class="selecter offer65"
             data-original="49,99 €"
             data-discount="19"
             data-href="https://www.iobit.com/buy.php?product=fr-asc123pc1999&ref=fr_asc123pc1999purchase1901<?php echo $refstr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_asc"
             data-ga="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase1901a-fr')">
        ...
        <div class="selecter offer85 active"
             ...
             data-discount="19"
             data-href="https://www.iobit.com/buy.php?product=fr-asc125pcpfamc1999&ref=fr_asc125pcpfiu1999purchase1903<?php echo $refstr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_asc"
             data-ga="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase1901b-fr')">
