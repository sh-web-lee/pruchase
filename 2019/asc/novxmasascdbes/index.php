...
<title>Consigue Advanced SystemCare PRO y Driver Booster PRO con 76% de descuento. Oferta especial de Navidad – IObit</title>
...
<body>
  ...
  <div class="banner">
    <div class="wrapper">
      ...
      <h1 class="title">OFERTA ESPECIAL Navidad! ¡Última oportunidad para ahorrar a lo grande!</h1>
      <div class="clearfix">
        ...
        <div class="msgbox fl">
          <div class="change-title"><h2>76% de descuento para los PRIMEROS 999 clientes</h2></div>
          <div class="numbox">
          ...
          <ul class="price">
            ...
            <li>
              <a class="buybtn exbtn"
                 href="https://www.iobit.com/buy.php?product=es-asc13db73pc2999&ref=es_asc13db73pcpurchase1911xmas<?php echo $refStr;?>&refs=es_purchase_asc"
                 onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascdbpurchase1911-es');">
                Comprar ahora 
              </a>
            </li>
          </ul>
