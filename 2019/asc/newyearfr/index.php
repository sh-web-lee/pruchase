...
<head>
  ...
  <title>Jusqu'à -85% sur Advanced SystemCare PRO – Vente Flash de Nouvel An - IObit</title>
...
<body>
    ...
    <div class="wrapper">
      ...
      <!-- title -->
      <h1 class="title">Soldes d'Hiver 2019</h1>
      <h3>Jusqu'à 85% de remise sur Advanced SystemCare 12 PRO</h3>
      <!-- offer65 -->
      <div class="offer65 clearfix">
        ...
        <div class="message fl">
          ...
          <!-- 17.99 buybtn -->
          <a class="buybtn"
             href="https://www.iobit.com/buy.php?product=fr-asc123pc1799&ref=fr_asc123pcpurchase1901b<?php echo $refstr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_asc"
             onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase1812a-fr')">
            VITE, J'EN PROFITE
          </a>
        </div>
      </div>
      ...
      <div class="offer85 clearfix">
        ...
        <div class="message fl">
          ...
          <!-- 19.99 buybtn -->
          <a class="buybtn"
             href="https://www.iobit.com/buy.php?product=fr-asc123pcsdpfamc1999&ref=fr_asc123pcpfsdamcpurchase1901<?php echo $refstr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_asc"
             onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase1812b-fr')">
            VITE, J'EN PROFITE
          </a>
        </div>
        <!-- pop -->
  ...
  <div class="giftbox">
    <div class="wrapper">
      <h2>Un  paquet cadeau exclusif à quantité limitée à ne pas rater</h2>
      <div class="clearfix">
        <dl>
    ...
    <div class="wrapper clearfix">
      ...
      <div class="asc-select fl">
        ...
        <div class="selecter offer65"
             data-original="49.99 €"
             data-discount="17.99 €"
             data-href="https://www.iobit.com/buy.php?product=fr-asc123pc1799&ref=fr_asc123pcpurchase1901b<?php echo $refstr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_asc"
             data-ga="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase1812a-fr')">
        ...
        <div class="selecter offer85 active"
             data-original="139.96 €"
             data-discount="19.99 €"
             data-href="https://www.iobit.com/buy.php?product=fr-asc123pcsdpfamc1999&ref=fr_asc123pcpfsdamcpurchase1901<?php echo $refstr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_asc"
             data-ga="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase1812b-fr')">
