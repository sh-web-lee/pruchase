...
function soldOut() {
    TweenMax.to($('.cut-box'), 3, {
        ...
        onComplete: function() {
            ...
            $(".table-peice").html("<span>73% OFF </span>Save $65.99");
            $(".buy-btn").attr("href", "https://www.iobit.com/buy.php?product=asc123pc2398&ref=asc3pc2398may2019usb" + refStr + "&aff=" + aff + "&refs=purchase_asc&tw=" + tw).attr('onclick', "ga('send', 'event', 'asc3pcbuyusb', 'buy', 'ascpurchase-201901');clickCount(4)");
...
function countOut() {
    var aff = MApp(2.2).url.getParameters('aff');
    var tw = MApp(2.2).datetime.getTimeZone();
    var refLink = 'asc3pc2398may2019usb' + refStr;
    $(".banner-boxshot").addClass("sold-out");
    $(".defult").css("display", "none");
    $(".sold-out-banner").css("display", "block");
    $(".middle-buy").remove();
    ...
    $(".item-pro del").html("$89.97");
    $(".table-peice").html("<span>73% OFF </span>Save $65.99");
    $(".buy-btn").attr("href", "https://www.iobit.com/buy.php?product=asc123pc2398&ref=" + refLink + "&aff=" + aff + "&refs=purchase_asc&tw=" + tw).attr('onclick', "ga('send', 'event', 'asc3pcbuyusb', 'buy', 'ascpurchase-201901');clickCount(4)");
    $("#floatlayer,.gotop").hide();
}
