...
<title>Save up to 84% OFF. New Year Exclusive Discount - IObit</title>
		...
		<div class="banner clearfix">
			...
			<div class="banner-left fr">
				<div class="defult">
					...
					<div class="price-box">
						<div class="price-btn clearfix">
							<span class="price-num">Now $<strong>23</strong>.98</span>
							<a href="https://www.iobit.com/buy.php?product=asc12sdiuamc2398&ref=ascsdiuamc2398may2019usb<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_asc" onclick="ga('send', 'event', 'asc2398buyusb', 'buy', 'ascpurchase-201901');clickCount(2)" class="buy-btn banner-btn-words fr buy-link"><i class="car"></i><span>ACTIVATE NOW</span></a>
						</div>
						<ul class="price-dec">
							<li class="first">
								<span>Original</span>
				...
				<div class="sold-out-banner">
					<h2>No More Free Gifts,<br> Seize Your Last Chance To Get <strong>73% OFF</strong> Now!</h2>
...
<div class="middle-buy container clearfix">
	<div class="wrapper">
		...
		<div class="btn-content">
			<a href="https://www.iobit.com/buy.php?product=asc12sdiuamc2398&ref=ascsdiuamc2398may2019usb<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_asc" onclick="ga('send', 'event', 'asc2398buyusb', 'buy', 'ascpurchase-201901');clickCount(2)"class="buy-btn middle-btn">
					<i class="car"></i>
...
<div class="sold-out-bar container clearfix">
	<div class="wrapper">
		<h2>Seize Your Last Chance To Get 73% OFF</h2>
		...
		<div class="bar-banner">
			...
			<div class="bar-right fr">
				...
				<div class="price-btn bar-btn">
					<span class="price-num">Now $<strong>23</strong>.98</span>
					<a href="https://www.iobit.com/buy.php?product=asc12sdiuamc2398&ref=ascsdiuamc2398may2019usb<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_asc" onclick="ga('send', 'event', 'asc2398buyusb', 'buy', 'ascpurchase-201901');clickCount(2)" class="buy-btn banner-btn-words buy-link"><i class="car"></i><span>ACTIVATE NOW</span></a>
				</div>
			</div>
		</div>
	</div>
	...
	<table border="0" cellspacing="0" cellpadding="0" width="100%">
		...
		<tfoot>
			<tr>
				...
				<th class="space"></th>
				<th class="item-pro">
					<p>$<b>23.98</b><del>$149.94</del></p>
					<a href="https://www.iobit.com/buy.php?product=asc12sdiuamc2398&ref=ascsdiuamc2398may2019usb<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_asc" onclick="ga('send', 'event', 'asc2398buyusb', 'buy', 'ascpurchase-201901');clickCount(2)" class="buy-btn smail-btn"><i class="car"></i><span>ACTIVATE NOW</span></a>
					<p class="table-peice">84% OFF Save $125.96</p>
				</th>
			</tr>		
		</tfoot>
	</table>
...
<div class="mask-box" style="display: none;">
	...
	<div class="mask-main clearfix">
		...
		<div class="mask-main-right fl">
			...
			<div class="btn-box">
				<a href="https://www.iobit.com/buy.php?product=asc12sdiuamc2198usb&ref=ascsdiuamc2198may2019usb<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_asc" onclick="ga('send', 'event', 'asc2198buyusb', 'buy', 'ascpurchase-201901');clickCount(3)" class="buy-btn mask-btn "><i class="car"></i><span>Get My Extra 10% OFF &amp; 3 FREE Gifts</span></a>
			</div>
