...
function soldOut() {
  ...
  $(".buybtn").attr({
    "href": 'https://www.iobit.com/buy.php?product=es-asc13preorder1799&ref=es_asc13preorderexpired1799' + refStr + '&aff=' + aff + '&refs=es_purchase_asc&tw=-8',
    "onclick": "ga('send', 'event', 'ascbuy', 'buy', 'asc13predorderexpired1799-es');"
  });
}
// soldOut();
