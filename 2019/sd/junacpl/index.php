...
<title>88% ZNIŻKI na Smart Defrag PRO - IObit</title>
...
<meta property="og:title" content="88% ZNIŻKI na Smart Defrag PRO - IObit">
...
<meta property="og:image" content="https://purchase.iobit.com/2019/sd/junacpl/images/snapshot.png">
...
<script type="text/javascript" src="<?php echo $pRootUrl; ?>tpl/js/stats.js"></script>
  ...
  <div class="banner">
    <div class="wrapper">
      ...
      <div class="pricebox">
        <dl class="price">
          <dt>TYLKO:  <strong>14,90 zł </strong><del>119,90 zł</del></dt>
          <dd>
            <a class="buybtn bigbtn" href="https://www.iobit.com/buy.php?product=pl-sd14-ac&ref=pl_sd-ac-register<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=pl_ac_sd" onclick="ga('send', 'event', 'sdbuy', 'buy', 'sdac-pl');">
              <div class="inner">
                <i class="all-icons"></i>
  ...
  <div class="floatlayer" id="floatlayer">
    <div class="wrapper clearfix">
      <div class="left">
        ...
        <p><strong>88% ZNIŻKI</strong> na naprawę powolnego PC i poprawienie czasu dostępu do plików</p>
      </div>
      <div class="pricebox">
        <dl class="price fr">
          <dt><strong>14,90 zł </strong><del>119,90 zł</del></dt>
          <dd>
            <a class="buybtn smallbtn" href="https://www.iobit.com/buy.php?product=pl-sd14-ac&ref=pl_sd-ac-register<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=pl_ac_sd" onclick="ga('send', 'event', 'sdbuy', 'buy', 'sdac-pl');">
              <div class="inner">
                <i class="all-icons"></i>
                <span>Aktywuj teraz</span>
              </div>
