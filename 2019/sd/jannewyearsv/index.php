	...
	<script type="text/javascript" src="<?php echo $pRootUrl; ?>tpl/js/stats.js"></script>
		...
		<div class="header">
          ...
          <img src="<?php echo getStaticUrl('images/logo.png')?>" alt="" />
				...
				<h1>60% DENNA VECKAS SPECIALERBJUDANDE</h1>
        ...
        <div class="content">
          ...
          <div class="right">
            ...
            <dl class="buy">
              ...
              <dd>
                <a href="https://www.iobit.com/buy.php?product=sv-sd6amc299&ref=sv_sd63pcamcpurchase1901<?php echo $refStr;?>&refs=sv_purchase_sd"
                   onclick="ga('send', 'event', 'sdbuy', 'buy', 'sdpurchase1901-sv');"
                   class="buybtn">
                  Aktivera Nu
                </a>
              </dd>
...
<!--    <dd>* .License för AMC Security Full Version med in-app-annonser.</dd>-->
    ...
    <!-- footer -->
    <div class="footer">
      <p>Copyright ©2005 - 2019 IObit. Alla Rättigheter Förbehålls</p>
    </div>
    <!-- footer end -->
