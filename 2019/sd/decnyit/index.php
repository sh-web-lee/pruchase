...
<head>
  ...
  <title>Grande Offerta! sconti fino al 80% su Smart Defrag PRO – Offerta capodanno 2019 di IObit</title>
...
<div class="banner">
  <div class="wrapper">
    ...
    <!-- title -->
    <h1>Offerta Speciale di Capodanno 2019!</h1>
    <h4>80% di sconti Su Smart Defrag PRO e Extra Regali Gratis! </h4>
    <!-- content -->
    <div class="clearfix">
      <!-- left-message -->
      <div class="left fl">
        <img src="<?php echo $pResUrl;?>images/sd-box.png" alt="">
        <img class="reduce" src="<?php echo getStaticUrl('images/sd-box-reduce.png')?>" alt="">
      </div>
      <!-- right-message -->
      <div class="offer fl">
        <!-- title -->
        ...
        <!-- view -->
        <p class="view">
          <i class="all-icons"></i> <b class="viewNum"><?php echo $viewNum;?></b> utenti stanno guardando
        </p>
        <!-- price -->
        <p class="price">
          <strong>17</strong>
        ...
        <!-- buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=it-sd63pciupf1799&ref=it_sd63pciupfpurchase1812<?php echo $refStr;?>&refs=it_purchase_sd"
           onclick="ga('send', 'event', 'sdbuy', 'buy', 'sdpurchase1812-it')">
           APPROFITTANE ORA
        </a>
        <!-- attention -->
        <p class="attention">
          <i class="all-icons"></i> Più di <span class="buyNum">626,078</span> acquistati
        </p>
        <!-- moneyback -->
...
<!-- gift-box start -->
<div class="gift-box">
  <div class="title"><h2 class="wrapper">REGALI GRATIS ESCLUSIVI PER NATALE 2018!</h2></div>
  ...
  <div class="wrapper cleartfix">
    ...
    <dl class="price-content">
      <dt>
        ...
        <!-- price -->
        <p class="price">
          <strong>17</strong><sup>99</sup><del>€99,93</del>
        </p>
      </dt>
      <dd>
        <!-- buybtn -->
        ...
        <!-- attention -->
        <p class="attention">
          <i class="all-icons"></i> ATTENZIONE, solo <span class="packsNum"><?php echo $packsNum?></span> pezzi disponibili !
        </p>
      </dd>
    </dl>
  </div>
