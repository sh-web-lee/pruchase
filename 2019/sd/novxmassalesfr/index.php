...
if(in_array($_GET['pop'],array('x_imf','xr_sd'))){
  $refStr.='-'.$_GET['pop'];
}
?>
...
<div class="container">
  ...
  <div class="spree wrapper">
    <div class="spree-box">
      ...
      <a class="spree-buy"
         href="https://www.iobit.com/buy.php?product=fr-sd63pcpf1799&ref=fr_sd63pcpf1799purchase1911<?php echo $refStr;?>&refs=fr_purchase_sd"
         onclick="ga('send', 'event', 'sdbuy', 'buy', 'sdpurchase1911a-fr');">
      </a>
    </div>
  </div>
  <!-- end spree -->
    ...
    <div class="panel clearfix">
      ...
      <div class="message small fl">
        ...
        <dl>
          ...
          <dd>
            <a class="buybtn"
               href="https://www.iobit.com/buy.php?product=fr-sd61y3pc1999&ref=fr_sd61y3pc1999purchase1911<?php echo $refStr;?>&refs=fr_purchase_sd"
               onclick="ga('send', 'event', 'sdbuy', 'buy', 'sdpurchase1911b-fr');"
               data-num="2">
      ...
      <div class="message small fr">
        ...
        <dl>
          ...
          <dd>            
            <a class="buybtn"
               href="https://www.iobit.com/buy.php?product=fr-sd61pc1799&ref=fr_sd61pc1799purchase1911<?php echo $refStr;?>&refs=fr_purchase_sd"
               onclick="ga('send', 'event', 'sdbuy', 'buy', 'sdpurchase1911c-fr');"
               data-num="1">
              <i class="all-icons"></i> J’en profite !
            </a>
          </dd>
