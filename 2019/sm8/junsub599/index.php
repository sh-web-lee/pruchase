...
<title>Big Sales - 60% OFF to Get Start Menu 8 PRO - IObit</title>
...
<body>
  ...
  <div class="banner">
    <div class="wrapper">
      ...
      <h2>Get 60% OFF to Easily Return to Classic Start Menu</h2>
      <div class="panel clearfix">
        <div class="offer small">
          <div class="imgbox"><img src="<?php echo getStaticUrl('images/sm-one-box.png')?>" alt=""/></div>
          <div class="price">
            <p><strong>$<big>5</big>.99  </strong> <del>$12.99</del></p>
            <a class="buybtn yellow"
               href="https://www.iobit.com/buy.php?product=sm81pc599&ref=en-sm81pc&aff=&refs=purchase_sm8"
               onclick="ga('send', 'event', 'sm81pc', 'buy', 'sm8purchase-201906');">
              <i class="all-icons"></i>
          ...
          <ul>
            ...
            <li><b>$0.50</b> / Month / PC</li>
            <li class="last"><b>$7</b> Saved</li>
          </ul>
        </div>
        <div class="offer big">
          <div class="imgbox">
          ...
          <div class="price">
            ...
            <a class="buybtn"
               href="https://www.iobit.com/buy.php?product=sm83pc&ref=en-sm83pc&aff=&refs=purchase_sm8"
               onclick="ga('send', 'event', 'sm83pc', 'buy', 'sm8purchase-201906');">
              <i class="all-icons"></i>
              <span>Activate Now</span>  
            </a>
          </div>
  ...
  <div class="intro">
    <div class="wrapper">
      <h2 class="subtitle">What Start Menu 8 can do for you?</h2>
      <div class="imgbox">
