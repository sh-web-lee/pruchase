...
function giftSold() {
  if (!$(".banner").hasClass("sold")) {
    ...
    $(".offer.big .imgbox").append('<b>55% OFF</b>');
    $(".floatlayer .imgbox").find("b").text('55% OFF');
    $(".floatlayer .price,.comparison tfoot strong").find("big").text("5");
    ...
    $(".buybtn").attr({
      "href": 'https://www.iobit.com/buy.php?product=sm81pc599&ref=en-sm81pcsoldout&aff=&refs=purchase_sm8',
      "onclick": "ga('send', 'event', 'sm81pcsold', 'buy', 'sm8purchase-201906')",
    });
  }
}
