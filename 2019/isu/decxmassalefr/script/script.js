...
function soldOut() {
	...
	$(".banner .right-message .progress").html("<h3>IObit Software Updater 3 PRO</h3> <p>1 an d’abonnement / 3 PC</p>")
	...
	$(".buybtn").attr({
		"href": 'https://www.iobit.com/buy.php?product=fr-isu31y3pc1499&ref=fr_isu3soldout1499purchase2012' + refStr + '&aff=' + aff + '&refs=fr_purchase_isu&tw=' + tw,
		"onclick": "ga('send', 'event', 'isubuy', 'buy', 'isusoldoutpurchase2012-fr');"
	});
}
...
function getReTime() {
	var packsNumTotal = cGet('isdecxmassalefr2020_t');
	if (packsNumTotal > 1) {
