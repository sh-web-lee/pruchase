...
function soldOut() {
	...
	$(".banner .right-message .progress").html("<h3>IObit Software Updater 4 PRO</h3> <p>1 Jahr / 3 PCs</p>");
	...
	$(".buybtn").attr({
		"href": 'https://www.iobit.com/buy.php?product=de-isu43pc1499&ref=de_isu3pcsoldout2101' + refStr + '&aff=' + aff + '&refs=de_purchase_isu&tw=' + tw,
		"onclick": "ga('send', 'event', 'isu3pcbuy', 'buy', 'isu3pcsinglesale2101-de');"
	});
}
// soldOut();
...
function getReTime() {
	var packsNumTotal = cGet('isuxmasde2021_t');
	if (packsNumTotal > 1) {
