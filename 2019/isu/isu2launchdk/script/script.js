...
function soldOut() {
	...
	$(".banner .right-message .progress").html("<h3>IObit Software Updater 2 PRO</h3> <p>1 års abonnement / 3 PC’er</p>")
  ...
  $(".banner .right-message ul span:eq(2)").html("160 kr.")
	...
	$(".buybtn").attr({
		"href": 'https://www.iobit.com/buy.php?product=dk-isu23pc129&ref=dk_isu23pcsale1906'+refStr+'&aff=' + aff + '&refs=dk_purchase_isu&tw=' + tw,
		"onclick": " ga('send', 'event', 'isubuy', 'buy', 'isusinglepurchase1906-dk');"
	});
}
