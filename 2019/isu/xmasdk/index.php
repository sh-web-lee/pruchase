...
if ($_GET['action'] == 'getPacks') {
	$date = $_GET['d'];
	$c_name = 'isuxmas2021_p' . $date;
	$c_name_t='isuxmas2021_t' . $date;
...
<body>
	...
	<div class="banner">
		<div class="wrapper">
          ...
          <p class="price">
            ...
            <a href="https://www.iobit.com/buy.php?product=dk-isu43pcpf129&ref=dk_isu43pcpfsale2101<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=dk_purchase_isu" onclick="ga('send', 'event', 'isubuy', 'buy', 'isubundlepurchase2101-dk');" class="buybtn">Aktiver nu</a>
          </p>
          <ul class="list">
          	<li class="frist">
	...
	<div class="intro">
		<div class="wrapper clearfix">
			...
			<img src="<?php echo getStaticUrl('images/intro-box.jpg?t=32')?>" class="img-box" alt="IObit Software Update PRO"/>
			...
			<div class="clearfix">
				...
				<div class="right fr">
					<ul class="feature-list">
						...
						<li>Understøtter direkte download af fjerne arbejdsværktøjer. </li>
