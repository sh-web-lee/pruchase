...
function soldOut() {
	...
	$(".banner .right-message h2").html("<span>Sorry, het gratis cadeau is uitverkocht.</span> Pak toch nog <strong>50% KORTING</strong> op");
	$(".banner .right-message .progress").html("<h3>IObit Software Updater 3 PRO</h3> <p>1-jarig abonnement / 3 pc’s</p>");
  ...
  $(".banner .right-message ul span:eq(2)").html("€15");
	$(".floatlayer .number").html("<h2>Update uw programma’s  <br> Herstel veiligheidslekken nu </h2>");
	$(".floatlayer .price del").html("€29,99");
	$(".feature .price span >span").remove();
	$(".floatlayer .wrapper").append("<p class='year'>1-jarig abonnement / 3 pc’s</p>");

	$(".buybtn").attr({
		"href": 'https://www.iobit.com/buy.php?product=nl-isu31y3pc1499&ref=nl_isu31y3pc1499purchase2004'+refStr+'&aff='+ aff +'&refs=nl_purchase_isu&tw=' + tw,
		"onclick": "ga('send', 'event', 'isu3pcbuy', 'buy', 'isupurchase-nl');"
	});
}
