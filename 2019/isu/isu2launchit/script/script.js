...
function soldOut() {
	...
	$(".banner .right-message .progress").html("<h3>IObit Software Updater 2 PRO</h3> <p>1 Anno Abbonamento / 3 PC</p>");
  ...
  $(".banner .right-message ul span:eq(2)").html("€17.00");
	...
	$(".buybtn").attr({
		"href": 'https://www.iobit.com/buy.php?product=it-isu23pc1299&ref=it_isu3pcsoldout1299'+refStr+'&aff='+ aff +'&refs=it_purchase_isu&tw=' + tw,
