...
<head>
	...
	<title>50% Rabatt auf IObit Software Updater PRO und ein kotenloses Geschenkpaket erhalten - IObit  </title>
	...
	<div class="banner">
		<div class="wrapper">
          ...
          <p class="price">
            ...
            <a href="https://www.iobit.com/buy.php?product=de-isu23pcpfsd1499&ref=de_isu3pcsdpf<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=de_purchase_isu" onclick="ga('send', 'event', 'isubundlebuy', 'buy', 'isupurchase-de');" class="buybtn">Jetzt aktivieren</a>
          </p>
          <ul class="list">
          	<li>
			...
			<div class="clearfix">
				...
				<div class="right fr">
					<ul class="feature-list">
						<li><i class="all-icons">◎</i> Software mit 1-Klick aktualisieren</li>
						...
						<li><i class="all-icons">◎</i> Direkter Download anderer beliebter Software ist möglich</li>
