...
function soldOut() {
	...
	$(".banner .right-message .progress").html("<h3>IObit Software Updater 2 PRO</h3> <p>1 año de suscripción / 3 PCs</p>");
	...
	$(".buybtn").attr({
		"href": 'https://www.iobit.com/buy.php?product=es-isu23pc1299&ref=es_isu3pcsoldout1906&aff=' + aff + '&refs=es_purchase_isu&tw=' + tw,
		"onclick": "ga('send', 'event', 'isu3pcbuy', 'buy', 'isupurchase-es');"
	});
}
// soldOut();
