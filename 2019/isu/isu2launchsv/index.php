...
<head>
	...
	<title>Spara upp till 75% på IObit Software Updater PRO och få ett gåvopaket – IObit  </title>
...
<body>
	...
	<div class="banner">
		<div class="wrapper">
          ...
          <p class="price">
            <span><strong><b>199</b>kr</strong> <del>797 kr</del></span>
            <a href="https://www.iobit.com/buy.php?product=sv-isu23pcsdpf199&ref=sv_isu3pcsdpf1906<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=sv_purchase_isu" onclick="ga('send', 'event', 'isubundlebuy', 'buy', 'isupurchase-sv'); "  class="buybtn">Aktivera nu</a>
          </p>
          <ul class="list">
          	<li class="frist">
          		Originalpris <span>797 kr</span>
          	</li>
          	<li>Rabatt <span>75% </span></li>
          	<li> Spara <span>598 kr </span></li>
          </ul>
        </div>
		</div>
	</div>
			...
			<div class="clearfix">
				...
				<div class="right fr">
					<ul class="feature-list">
						...
						<li>Stöder direkt nedladdning av andra populära programvaror</li>
						<li>Inaktivera sponsrade annonser som visas i den fria versionen</li>
					</ul>
					 <p class="price">
            <span>Endast <strong><b>199</b>kr</strong> <span>Skynda, endast <b class="buyNum">50</b> paket kvar!</span></span>
            <a href="https://www.iobit.com/buy.php?product=sv-isu23pcsdpf199&ref=sv_isu3pcsdpf1906<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=sv_purchase_isu" onclick="ga('send', 'event', 'isubundlebuy', 'buy', 'isupurchase-sv'); " class="buybtn">Aktivera nu</a>
          </p>
				</div>
			</div>
	...
	<div id="floatlayer" class="floatlayer">
	  <div class="wrapper clearfix">
       ...
       <p class="price">
          <span>Endast<strong><b>199</b>kr</strong>  </span>
          <a href="https://www.iobit.com/buy.php?product=sv-isu23pcsdpf199&ref=sv_isu3pcsdpf1906<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=sv_purchase_isu" onclick="ga('send', 'event', 'isubundlebuy', 'buy', 'isupurchase-sv'); " class="buybtn">Aktivera nu</a>
       </p>
	  </div>
	</div>
