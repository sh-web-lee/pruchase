...
<head>
	...
	<title> Économisez 50% sur IObit Software Updater PRO et obtenez un paquet cadeau gratuit - IObit  </title>
...
<body>
	...
	<div class="banner">
		<div class="wrapper">
          ...
          <p class="price">
            <span>Maintenant <strong><b>14</b> <span>€<b>99</b></span></strong></span>
            <a href="https://www.iobit.com/buy.php?product=fr-isu33pcpfsd1499&ref=fr_isu33pcsdpfindexpuchase2004<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_isu" onclick="ga('send', 'event', 'isubundlebuy', 'buy', 'isupurchase-fr');  "  class="buybtn">J’EN PROFITE VITE</a>
          </p>
          <ul class="list">
          	<li>
          		 Prix original  <span>99,97€</span>
          	</li>
          	<li>Remise  <span>85%  </span></li>
          	<li> Économie <span>84,98€ </span></li>
          </ul>
        </div>
		</div>
	</div>
			...
			<div class="clearfix">
				...
				<div class="right fr">
					<ul class="feature-list">
					 ...
					 <p class="price">
            <span><strong><b>14</b> <span>€<b>99</b></span></strong> <span>Il ne reste plus que <b class="buyNum">50</b> places!</span></span>
            <a href="https://www.iobit.com/buy.php?product=fr-isu33pcpfsd1499&ref=fr_isu33pcsdpfindexpuchase2004<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_isu" onclick="ga('send', 'event', 'isubundlebuy', 'buy', 'isupurchase-fr');  " class="buybtn">J’EN PROFITE VITE </a>
          </p>
				</div>
			</div>
	...
	<div id="floatlayer" class="floatlayer">
	  <div class="wrapper clearfix">
       ...
       <p class="price">
          <span> <strong><b>14</b> <span>€<b>99</b></span></strong> <del>99,97€</del>  </span>
          <a href="https://www.iobit.com/buy.php?product=fr-isu33pcpfsd1499&ref=fr_isu33pcsdpfindexpuchase2004<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_isu" onclick="ga('send', 'event', 'isubundlebuy', 'buy', 'isupurchase-fr');  " class="buybtn">J’EN PROFITE VITE</a>
       </p>
	  </div>
	</div>
