...
function soldOut() {
	...
	$(".banner .right-message .progress").html("<h3>IObit Software Updater 2 PRO</h3> <p>1-jarig abonnement / 3 pc’s</p>");
  ...
  $("span.snow02").fadeOut();
	$(".buybtn").attr({
		"href": 'https://www.iobit.com/buy.php?product=nl-isu21y3pc1499&ref=nl_isu21y3pc1499purchase1911'+refStr+'&aff='+ aff +'&refs=nl_purchase_isu&tw=' + tw,
...
function getReTime(){
	var packsNumTotal=cGet('isunovxmas_t');
	if(packsNumTotal>1) {
