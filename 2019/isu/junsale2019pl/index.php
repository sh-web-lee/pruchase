...
<body>
	...
	<div class="banner">
		<div class="wrapper">
			...
			<h1>Oferta specjalna na nową wersję</h1>
			<div class="img-box">
          ...
          <div class="progress">
            <p><strong class="viewNum"><?php echo $viewNum;?></strong> gości, <nobr class="unit-bef">pozostało</nobr>  <span class="buyNum">51</span> <em class="miejsc unit-af">miejsc</em></p>
            <div class="bar">
          ...
          <p class="price">
            ...
            <a href="http://www.iobit.com/buy.php?product=pl-isu3pcsdpf49&ref=pl_isu3pcsdpf49purchase1906<?php echo $refStr;?>&refs=pl_purchase_isu" onclick="ga('send', 'event', 'isubuy', 'buy', 'isupurchase3PCsdpf1906-pl')" class="buybtn">Aktywuj teraz</a>
          </p>
          <ul class="list">
          	<li class="first">
		...
		<div class="wrapper clearfix">
			...
			<div class="right-message">
				...
				<dl class="list01">
					...
					<dd><strong>Prostota</strong> Aktualizacje oprogramowania są pobierane bez otwierania przeglądarki internetowej. </dd>
				</dl>
				<dl>
	...
	<div class="feature">
		<div class="wrapper">
			<h2>Jakie korzyści płyną z IObit Software Updater PRO?</h2>
			<div class="clearfix">
				<div class="left fl">
				...
				<div class="right fr">
					<ul class="feature-list">
						<li><i class="all-icons">◎</i>Aktualizuj oprogramowanie za pomocą 1 kliknięcia</li>
						<li><i class="all-icons">◎</i>Pobieraj i instaluj aktualizacje po cichu</li>
						<li><i class="all-icons">◎</i>Ustaw automatyczne skanowanie i aktualizacje</li>
						<li><i class="all-icons">◎</i>Wyklucz programy, których nie chcesz aktualizować</li>
						<li><i class="all-icons">◎</i>Opcja automatycznego tworzenia punktu przywracania przed instalacją</li>
						<li><i class="all-icons">◎</i>Opcja automatycznego usuwania plików instalacyjnych po instalacji</li>
						<li><i class="all-icons">◎</i>Możliwość bezpośredniego pobierania innego popularnego oprogramowania</li>
						<li><i class="all-icons">◎</i>Możliwość wyłączenia reklam sponsorowanych wyświetlanych w bezpłatnej wersji</li>
					</ul>
					 <p class="price">
            <span>Tylko   <strong><b>49</b>,90 zł </strong> <span>Szybko, <nobr class="unit-bef">pozostało tylko</nobr> <b class="buyNum">50</b> <em class="miejsc unit-af">miejsc</em></span></span>
            <a href="http://www.iobit.com/buy.php?product=pl-isu3pcsdpf49&ref=pl_isu3pcsdpf49purchase1906<?php echo $refStr;?>&refs=pl_purchase_isu" onclick="ga('send', 'event', 'isubuy', 'buy', 'isupurchase3PCsdpf1906-pl')" class="buybtn">Aktywuj teraz</a>
          </p>
				</div>
			</div>
	...
	<div class="gift-message">
		<div class="wrapper">
			<h2>Jakie korzyści otrzymasz dzięki darmowym prezentom?</h2>
			<dl>
	...
	<div id="floatlayer" class="floatlayer">
	  <div class="wrapper clearfix">
        ...
        <p><span class="viewNum"><?php echo $viewNum;?></span>  gości, <nobr class="unit-bef">pozostało tylko</nobr> <strong class="buyNum">86</strong> <em class="miejsc unit-af">miejsc</em></p>
      </div>
       <p class="price">
