...
<head>
  ...
  <title>Adquira IObit Software Updater 2 Pro com 45% de Desconto e leve Protected Folder de brinde. Promoção de Ano Novo da IObit</title>
    ...
    <div class="wrapper">
        ...
        <div class="banner">
            ...
            <div class="banner-left fl">
                <img class="box-imf" src="<?php echo $pResUrl; ?>images/isu-box.png" alt=""/>
            ...
            <div class="banner-right fr">
                <h2>IObit Software Updater 2 – 1 ano / 3 PCs</h2>
                ...
                <span class="banner-line"></span>
                <a class="buy-btn" href="https://www.iobit.com/buy.php?product=pt-isu23pcpf5199&ref=pt_isu23pcpfpurchase1911<?php echo $refStr;?>&refs=pt_purchase_isu" onclick="ga('send', 'event', 'isubuy', 'buy', 'isu2purchase1911-pt')">COMPRAR AGORA</a>
                ...
                <p class="people-box"><img src="<?php echo $pResUrl; ?>images/people.png" alt=""/>Mais de <b>225.810</b> pessoas já compraram</p>
                <div class="payments">
