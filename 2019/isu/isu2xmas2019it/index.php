    ...
    <div class="clearfix">
      ...
      <div class="right fr">
        <ul class="feature-list">
          <li>1 clic per aggiornare il software, senza bundlware e senza limiti di quantità (<span>Versione gratuita: 2 al giorno</span>)</li>
          ...
          <li>Disattiva le pubblicità sponsorizzate nella versione free</li>
        </ul>
        <p class="price">
          <!-- price -->
  ...
  <div class="wrapper">
    ...
    <dl class="pf">
      ...
      <dd>
        ...
        <P>Non preoccuparti più della perdita dei tuoi dati e della tua privacy!</P>
      </dd>
    </dl>
  </div>
</div>
