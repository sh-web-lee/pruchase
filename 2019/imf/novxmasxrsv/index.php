...
<head>
  ...
  <title>Spara 85% rabatt på IObit Malware Fighter PRO丨Stor Julrea - IObit</title>
...
<div class="banner">
  ...
  <div class="wrapper">
    ...
    <div class="left-box">
      ...
      <h2><strong>85%</strong> RABATT <span>EN GÅNG PER ÅR, MISSA INTE!</span></h2>
    ...
    <div class="right-box">
      ...
      <dl>
        <dt><strong>IObit Malware Fighter PRO 7 PRO</strong> <span>279kr</span> <del>699kr</del></dt>
        <dd><strong>Protected Folder</strong> <span>0kr</span></dd>
        <dd><strong>Smart Defrag 6 PRO</strong> <span>0kr</span></dd>
        <dd><strong>AMC Security</strong> <span>0kr</span></dd>
        <dd class="last"><b>1 157kr</b> <span>värde</span></dd>
      </dl>
    </div>
    <dl class="price">
      <dt> <del>1 856kr</del> <strong>279kr</strong></dt>
      <dd>
        <a href="https://www.iobit.com/buy.php?product=sv-imf73pcpfsdamc279&ref=sv_imf73pcpfsdamc279purchase1911xr<?php echo $refStr;?>&refs=sv_purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imf3pcpfsdamcpurchase1911xr-sv');" class="buybtn">KÖP NU</a>
      </dd>
...
<div class="gift-box">
  <div class="wrapper clearfix">
    ...
    <dl>
      ...
      <dd>
        <p>
         Skydda dina filer från skadliga attacker 1 lösenord för alla filer Skydda ditt privatliv från intrång 
        </p>
    ...
    <dl>
      ...
      <dd>
        <p>
          Rensa din mobil och gör automatiska genomsökningar. <br>Anti-phishing & anti-stöld. 
        </p>
        <p><b>0kr</b> <del> 199kr</del></p>
      </dd>
    </dl>
    <div class="message">
      <div class="left-message">
        <img src="<?php echo $pResUrl; ?>images/gift-imf-box.png" alt="" class="img-box">
        <div class="title">
          <h3>IObit Malware Fighter 7 PRO</h3>
          <p>3 PCs / 1 År <strong> 279kr</strong> <del>699kr</del></p>
        </div>
        <ul>
          <li><i></i> <span>Smart Defrag 6 PRO </span> <b>0kr</b> <del>459kr</del></li>
          <li><i></i> <span>AMC Security </span> <b>0kr</b> <del>199kr</del></li>
  ...
  <table border="0" cellspacing="0" cellpadding="0" width="100%">
    <thead>
      <tr>
        ...
        <th class="itemb"><div>IObit Malware Fighter 7<br> FREE</div></th>
        <th class="space"></th>
        <th class="itema"><div>IObit Malware Fighter 7 PRO <span>(1 År / 3 PC )+Gåva</span></div></th>
      </tr>    
    </thead>
    <tbody>
      <tr>
    ...
    <tfoot>
      <tr>
        <th colspan="4"></th>
        <th class="itema">
          <del>1 856kr </del> <strong>279kr</strong>
          <a href="https://www.iobit.com/buy.php?product=sv-imf73pcpfsdamc279&ref=sv_imf73pcpfsdamc279purchase1911xr<?php echo $refStr;?>&refs=sv_purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imf3pcpfsdamcpurchase1911xr-sv');" class="buybtn">KÖP NU</a>
