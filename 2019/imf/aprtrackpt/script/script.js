...
(function($) {
 ...
 function soldout() {
 	...
 	$(".banner .three-pcs p strong,.float dl dt strong").html("R$ 63,99")
 	$(".banner .three-pcs p del,.float dl dt del").html("R$ 79,99")
 	$(".banner .one-pc p strong").html("R$ 69,99")
 	$(".banner .one-pc p del").html("R$ 159,99")
 	$(".float h2").html("<strong>25% OFF</strong> para Ter o seu Computador <br> Totalmente Protegido ")
 	$(".number").remove();

 	var aff = $.getUrlParam('aff');
	var tw = MApp(2.2).datetime.getTimeZone();
	var new1pc = "https://www.iobit.com/buy.php?product=pt-imf71pc6399&ref=pt_imf71pctracking2019sold"+refStr+"&aff=" + aff + "&refs=pt_purchase_imf&tw=" + tw;
	var new1pcStat = "ga('send', 'event', 'imftrack1pcbuysold', 'buy', 'imfpurchase1904track1pcsold-pt');"
...
function packsGet() {
	var date = new Date();
	var cName = "ptimftra" + date.getDate();
