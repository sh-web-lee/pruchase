...
function soldout() {
  ...
  $(".banner .three-pcs p strong,.float dl dt strong").html("$19.95")
  $(".banner .three-pcs p del,.float dl dt del").html("$39.95")
  $(".banner .one-pc p strong").html("$21.99")
  $(".banner .one-pc p del").html("$54.95")
  $(".float h2").html("<strong>50% OFF</strong> to Have Your Personal <br>Computer Fully Protected ")
  $(".number").remove();

  var aff = $.getUrlParam('aff');
  var tw = MApp(2.2).datetime.getTimeZone();
  var new1pc = "https://www.iobit.com/buy.php?product=imf81pc&ref=en-imf1pcsoldouttrack" + refStr + "&aff=" + aff + "&refs=purchase_imf&tw=" + tw;
  var new1pcStat = "ga('send', 'event', 'imftrack1pcbuysold', 'buy', 'imfpurchase-201904track1pcsold');"
