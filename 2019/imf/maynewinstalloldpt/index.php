    ...
    <div class="wrapper">
        ...
        <div class="banner">
            ...
            <div class="banner-right fr">
                ...
                <span class="banner-line"></span>
                <a class="buy-btn" href="https://www.iobit.com/buy.php?product=pt-imf8newlaunchpackage&ref=pt_imf83pcnewlaunchpackage<?php echo $refStr;?>&refs=pt_purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imf3pcnewlaunch-pt');">COMPRAR AGORA</a>
