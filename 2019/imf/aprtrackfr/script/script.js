...
function soldout() {
  ...
  $(".float h2").html("Protégez complètement votre ordinateur <br>personnel en profitant de <strong>50% de</strong> réduction!");
  $(".number").remove();

  var aff = $.getUrlParam('aff');
  var tw = MApp(2.2).datetime.getTimeZone();
  var new1pc = "https://www.iobit.com/buy.php?product=fr-imf71pc1999&ref=fr_imf71pc1999tracking1905sold"+refStr+"&aff=" + aff + "&refs=fr_purchase_imf&tw=" + tw;
  var new1pcStat = "ga('send', 'event', 'imftrack1pcbuysold', 'buy', 'imfpurchase1905track1pcsold-fr');";
...
function packsGet() {
  var date = new Date();
  var cName = "frimftra" + date.getDate();
