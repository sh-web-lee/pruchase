...
<head>
  ...
  <title>Jusqu'à -70% sur IObit Malware Fighter PRO pour effacer les cookies malveillants automatiquement</title>
...
<body>
  ...
  <div class="banner">
    <div class="wrapper">
      ...
      <p class="fast <?php echo (intval($_GET['cookie'])>0)?'':'hide';?>"><?php echo (intval($_GET['cookie'])>0)?intval($_GET['cookie']):'';?> cookie(s) malveillant(s) trouvé(s)</p>
      <h1>Effacez les cookies malveillants automatiquement maintenant !</h1>
      <div class="box three-pcs">
        <div class="img-box"></div>
        <p>Maintenant: <strong>21,99€</strong> <del>79,99€</del></p>
        <a href="https://www.iobit.com/buy.php?product=fr-imf73pc2199&ref=fr_imf73pc2199tracking1905<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=fr_purchase_imf" onclick="ga('send', 'event', 'imftrackbuy', 'buy', 'imfpurchase1905track-fr');" class="buybtn"><span>VITE, J’EN PROFITE</span></a>
        <div class="number">
          Vite, plus que  
          <div class="countdown">
      ...
      <div class="box one-pc">
        ...
        <a href="https://www.iobit.com/buy.php?product=fr-imf71pc1999&ref=fr_imf71pc1999tracking1905<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=fr_purchase_imf" onclick="ga('send', 'event', 'imftrack1pcbuy', 'buy', 'imfpurchase1905track1pc-fr');" class="buybtn border"><span>VITE, J’EN PROFITE</span></a>
      </div>
    </div>
  </div>
  <!-- end banner -->
  ...
  <div class="feature feature01 wrapper clearfix">
    <h2>POURQUOI SUPPRIMER<br> LES COOKIES DE SUIVI DANS LE NAVIGATEUR WEB ?</h2>
    <div class="img-box"><img src="<?php echo getStaticUrl('images/feature-box.jpg')?>"></div>
    <dl class="list01">
      <dt>Navigation en ligne remplie <br>d’annonces</dt>
      <dd>Les annonceurs sur les sites Web que <br>vous avez visités peuvent suivre vos <br>activités en ligne et vous montrer <br>partout des publicités ciblées de <br>façon répétée. </dd>
    </dl>
    <dl class="list02">
      <dt>Fuite de la confidentialité en <br>ligne</dt>
      <dd>Les pirates informatiques sont autorisés à <br>accéder à vos informations personnelles <br>et envahir vos comptes sans mot de <br>passe.</dd>
    </dl>
  </div>
  <!-- feature -->
  <div class="feature feature02 ">
    <div class="wrapper">
      <h2>COMMENT ANTI-TRACKING TRAVAILLE-T-ELLE <br>POUR ASSURER UNE NAVIGATION PROPRE ET PLUS DE CONFIDENTIALITÉ EN LIGNE</h2>
      <div class="img-box"></div>
      <dl class="list01">
        <dt><img src="<?php echo getStaticUrl('images/list01.png')?>"> Suppression automatique des cookies</dt>
        <dd>Une fois que l’anti-tracking est activée, les <br>cookies de suivi et autre données du <br>navigateur sont automatiquement effacés <br>lors que vous avez fini de naviguer.</dd>
      </dl>
      <dl class="list02">
        <dt><img src="<?php echo getStaticUrl('images/list02.png')?>"> Protection des données peronnelles</dt>
        <dd>Les annonceurs n’arrivent pas à suivre vos <br>activités en ligne et vos informations <br>personnelles resteront sécurisées.</dd>
      </dl>
    </div>
  </div>
  <!-- benfits -->
    ...
    <div class="message">
      <div class="wrapper">
        ...
        <dl class="last">
          ...
          <dd><strong>Protection de Clés USB</strong></dd>
          <dd class="txt">Bloque les virus cachés sur les <br>clés USB qui pourraient mettre en <br>danger l’intégrité de l’information <br>stockée dans l’ordinateur.</dd>
          <dd><span>*Exclusive PRO</span></dd>
        </dl>
      </div>
    </div>
  ...
  <div class="float clearfix">
    <div class="wrapper">
      ...
      <div class="message">
        <h2>Profitez d’une confidentialité complète et d’une <br>liberté totale sur Internet !</h2>
        <div class="number">
          Vite, plus que
          <div class="countdown">
            <div class="scroll-tick" ><span>0</span></div>
     ...
     <dl>
       ...
       <dd><a href="https://www.iobit.com/buy.php?product=fr-imf73pc2199&ref=fr_imf73pc2199tracking1905<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=fr_purchase_imf" onclick="ga('send', 'event', 'imftrackbuy', 'buy', 'imfpurchase1905track-fr');" class="buybtn"><span>VITE, J’EN PROFITE</span></a></dd>
     </dl>
    </div>
  </div>
