...
$(function() {
  ...
  $(".review").on("hover", "li", function() {
    ...
    $(".review .content > span").stop().animate({
      left: (10 + index * 20) + "%"
    }, 150);
    setTimeout(function() {
...
function soldOut() {
  ...
  $(".banner .offer1 .box").attr("src", _src).css({
    "width": 227,
    "height": 217,
    "marginTop": 34,
    "marginLeft": 80
  });
  $(".banner .offer1 .buybtn").attr({
    "href": $(".banner .offer2 .buybtn").attr("href"),
    "onclick": $(".banner .offer2 .buybtn").attr("onclick")
  });
  ...
  $(".bottombuy ul li").eq(0).css({
    "visibility": "hidden"
  });
  $(".bottombuy p.price").css({
    "backgroundImage": "url(\"" + imgUrl + "images/price-pass3.png\")"
  });
