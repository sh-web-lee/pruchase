...
<head>
  ...
  <title>Oferta exclusivo sólo para nuevo miembro de IObit Malware Fighter – IObit</title>
...
<div class="banner">
  <div class="wrapper">
    ...
    <!-- title -->
    <h1>OFERTA ESPECIAL para Nuevos Miembros</h1>
    <div class="panel clearfix">
      <div class="box small">
        ...
        <!-- 1pc buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=es-imf81pc1799&ref=es_imf81pcnewinstall<?php echo $refStr;?>&refs=es_purchase_imf"
           onclick="ga('send', 'event', 'imfbuy', 'buy', 'imf1pcnewinstall-es')">
      ...
      <div class="box">
        ...
        <!-- 3pc buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=es-imf83pcpfsd14m1999&ref=es_imf83pcnewinstallpfsd14m<?php echo $refStr;?>&refs=es_purchase_imf"
           onclick="ga('send', 'event', 'imfbuy', 'buy', 'imf3pcnewinstall-es')">
          <i></i> <span>Comprar ahora</span>
        </a>
        <p class="bought">
...
<div class="between-buy">
  <div class="wrapper">
    ...
    <!-- 3pc buybtn -->
    <a href="https://www.iobit.com/buy.php?product=es-imf83pcpfsd14m1999&ref=es_imf83pcnewinstallpfsd14m<?php echo $refStr;?>&refs=es_purchase_imf"
       onclick="ga('send', 'event', 'imfbuy', 'buy', 'imf3pcnewinstall-es')" class="buybtn">
      <i></i>
  ...
  <table border="0" cellspacing="0" cellpadding="0" width="100%">
    ...
    <tr>
      ...
      <th class="itemb">
        ...
        <del> 39,95€</del>
        <!-- 1pc buybtn -->
        <a href="https://www.iobit.com/buy.php?product=es-imf81pc1799&ref=es_imf81pcnewinstall<?php echo $refStr;?>&refs=es_purchase_imf"
           onclick="ga('send', 'event', 'imfbuy', 'buy', 'imf1pcnewinstall-es')"
           class="buybtn">
          Comprar ahora
        </a>
