...
<body>
  ...
  <div class="banner">
    <div class="wrapper">
      ...
      <h1>Partecipa alla prevendita a €0 e resta con noi</h1>
      ...
      <div class="clearfix">
        ...
        <div class="right-message">
          ...
          <!-- buybtn -->
           <a class="buybtn" href="https://www.iobit.com/buy.php?product=it-imf7preorder30d&ref=it_imf7preorderexpired<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=it_purchase_imf"
              onclick="ga('send', 'event', 'imfbuy', 'buy', 'imf7predorderexpired-it');">
      ...
      <div class="step">
        ...
        <span>Se insoddisfatto, annulla entro 30 giorni senza alcun <br> addebito</span>
      </div>
    </div>
  ...
  <div class="main-bg">
    ...
    <div class="feature wrapper clearfix">
      <h2>Ti ricordi come IObit Malware Fighter PRO protegge il tuo Computer?</h2>
      ...
      <div class="message">
        <dl <?php echo empty($transData)?'class="emp"':'';?>>
          ...
          <?php if(!empty($_GET['fileto'])):?>
            <dd><strong><?php echo number_format($_GET['fileto'],0,'','.')?></strong></dd>
          <?php endif;?>
          <dd>minacce alla sicurezza per mantenere il tuo PC e le tue informazioni personali al sicuro. </dd>
        </dl>
        <dl <?php echo empty($transData)?'class="emp"':'';?>>
          <dt>Blocca</dt>
          <?php if(!empty($_GET['rsto'])):?>
            <dd><strong><?php echo number_format($_GET['rsto'],0,'','.')?></strong></dd>
          <?php endif;?>
          <dd>ransomware dalla crittografia dei tuoi file.</dd>
        </dl>
        <dl <?php echo empty($transData)?'class="emp"':'';?>>
          <dt>Pulisce</dt>
          <?php if(!empty($_GET['traceto'])):?>
            <dd><span><?php echo number_format($_GET['traceto'],0,'','.')?></span></dd>
          <?php endif;?>
          <dd>tracce online per evitare le perdite di privacy. </dd>
        </dl>
        <dl <?php echo empty($transData)?'class="emp"':'';?>>
          <dt>Abilita</dt>
          <dd><strong>Completamente </strong></dd>
          <dd>la protezione in tempo reale per bloccare attività sospette. </dd>
        </dl>
       </div>
    </div>
    <!-- benfits -->
    <div class="compar-tab wrapper clearfix">
      <h2>PROTEZIONE COMPLETA PERSA!  <br> I PROBLEMI DI SICUREZZA POSSONO INFASTIDIRTI DI TANTO IN TANTO</h2>
      <div class="message">
        <h3>Protezioni che non hai più</h3>
        <p><strong>no</strong> motore anti-virus di Bitdefender </p>
        <p><strong>no</strong> motore anti-ransomware  </p>
        <p><strong>no</strong> protezione delle cartelle </p>
        <p><strong>no</strong> guardia della webcam  </p>
        <p><strong>no</strong> guardia USB  </p>
        <p><strong>no</strong> anti-tracciamento </p>
        <p><strong>no</strong> aggiornamento automatico </p>
      </div>
      <div class="message right">
        <h3>Problemi che potresti incontrare </h3>
        <p>virus che invadono il tuo PC rubandone le informazioni</p>
        <p>file importanti che vengono crittografati</p>
        <p>altri accessi ai tuoi file personali</p>
        <p>programmi che eseguono la videocamera segretamente</p>
        <p>virus nascosti nell'unità USB che danneggiano il tuo PC </p>
        <p>hacker che violano la tua privacy online</p>
        <p>minacce alla sicurezza più recenti non identificate</p>
      </div>
    </div>
    <!-- end benfits -->
    <div class="more-than wrapper">
      <h2>IL NUOVO IOBIT MALWARE FIGHTER 7 PRO TI OFFRE DI PIÙ</h2>
      <dl>
        <dt><img src="<?php echo getStaticUrl('images/list01.png')?>" alt=""></dt>
        <dd><strong>60% Più grande  </strong></dd>
        <dd>Database di Malware </dd>
      </dl>
      <dl class="center">
        <dt><img src="<?php echo getStaticUrl('images/list02.png')?>" alt=""></dt>
        <dd><strong>Password protetta   </strong></dd>
        <dd>Dati personali</dd>
      </dl>
      <dl>
        <dt><img src="<?php echo getStaticUrl('images/list03.png')?>" alt=""></dt>
        <dd><strong>300% Più veloce      </strong></dd>
        <dd>Scansione delle minacce</dd>
      </dl>
    </div>
  </div>
  ...
  <div class="float clearfix">
    <div class="wrapper">
      ...
      <!-- buybtn -->
      <a class="buybtn"
         href="https://www.iobit.com/buy.php?product=it-imf7preorder30d&ref=it_imf7preorderexpired<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=it_purchase_imf"
         onclick="ga('send', 'event', 'imfbuy', 'buy', 'imf7predorderexpired-it');">
  ...
  <div class="pop-over ">
    ...
    <h3>Non perdere di nuovo questo <strong> sconto del 70%</strong></h3>
    ...
    <div class="message">
       ...
       <a class="buybtn"
         href="https://www.iobit.com/buy.php?product=it-imf7preorder3pc1799&ref=it_imf7preorderexpired1799<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=it_purchase_imf"
         onclick="ga('send', 'event', 'imfbuy', 'buy', 'imf7predorderexpired1799-it');">
         <span>Pre-ordina Ora</span>
      </a>
