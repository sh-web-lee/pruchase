...
function soldout() {
  ...
  var new1pc = "https://www.iobit.com/buy.php?product=it-imf81pc1799&ref=it_imf1pctrackingsold" + refStr + "&aff=" + aff + "&refs=it_purchase_imf&tw=" + tw;
  var new1pcStat = "ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase1904track1pcsold-it');";
...
function packsGet() {
  var date = new Date();
  var cName = "itimftra" + date.getDate();
