...
function getCycleCountdown() {
  var date = new Date();
  if (MApp(2.2).cookie.get('deimfxmasrc2019')) {
    dt = MApp(2.2).cookie.get('deimfxmasrc2019');

  } else {
    dt = date.setMinutes(date.getMinutes() + 10);
    MApp(2.2).cookie.set('deimfxmasrc2019', dt);
  }
...
function getPacksNum() {
  var e = new Date;
  var n1 = MApp(2.2).cookie.get('deimfxmasrc2019') / 1000;
