...
<title>Jusqu'à -87% sur IObit Malware Fighter PRO et profitez de la protection de Bitdefender !</title>
...
<body>
  ...
  <div class="banner">
    <div class="wrapper">
      ...
      <div class="title">
        ...
        <h3>Jusqu’à -87% ! Achetez-en 1 et obtenez-en 4 GRATUIT ! Profitez de 2 mois d’abonnement offerts pour aujourd’hui seulement. </h3>
      </div>
      <div class="clearfix">
        <div class="box small">
          <div class="imgbox one"><b>-55%</b></div>
          <div class="price">
            <p><strong><big class="discount">17</big>,99€</strong> <del class="original">39,95€</del></p>
            <a class="buybtn" 
               href="https://www.iobit.com/buy.php?product=fr-imf81y1pc1799&ref=fr_imf81pcolduserpurchase2006<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_imf"
               onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfolduserpurchase2006-fr')">
              VITE, J'EN PROFITE
            </a>
          </div>
        </div>
        <div class="box big">
          ...
          <div class="price">
            ...
            <a class="buybtn orange" 
               href="https://www.iobit.com/buy.php?product=fr-imf8newinstallpackage&ref=fr_imf8olduserpurchase2006<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_imf"
               onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfolduserpurchase2006-fr')">
              <i class="all-icons"></i>
              VITE, J'EN PROFITE
            </a>
          </div>
          <p>14 mois d’abonnement / 3 PC</p>
        </div>
        <div class="box small right">
          ...
          <div class="price">
            ...
            <a class="buybtn" 
               href="https://www.iobit.com/buy.php?product=fr-imf83pc2199&ref=fr_imf83pcolduserpurchase2006<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_imf"
               onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfolduserpurchase2006-fr')">
              VITE, J'EN PROFITE
            </a>
          </div>
  ...
  <div class="intro wrapper">
    <ul class="cont">
      <li class="one active">
        ...
        <p>Plus de 209 millions de menaces telles que virus, logiciels malveillants, sypwares, cryptojacking, peuvent être facilement éliminées.</p>
      </li>
      <li class="two">
        <h5><i class="i-icons"></i>Protection des données sensibles</h5>
        <p>Les actions coordonnées du coffre-fort et de la protection des données sensibles offrent plusieurs niveaux de protection bloquant ainsi les accès non-autorisés aux intrus.</p>
      </li>
      <li class="three">
        <h5><i class="i-icons"></i>Moteur Anti-Ransomware</h5>
      ...
      <li class="four">
        <h5><i class="i-icons"></i>Navigation plus sûre sur Internet</h5>
        <p>Effacez automatiquement les cookies et traces dangereuses lors que vous fermez le navigateur Web et empêchez les hackers de rechercher ce que vous lisez, visualisez et achetez en ligne.</p>
      </li>
    </ul>
    <div class="imgcont">
  ...
  <div class="donation ">
    <div class="wrapper">
      <h2>Les cadeaux exclusifs réservés uniquement à nos utilisateurs fi</h2>
      <p id="giftdown" class="countdown">
        Se terminera dans <b>00</b> H : <b>09</b> M : <b>59</b> S <b>000</b> MS
      </p>
      <div class="clearfix">
        <dl>
          <dt>
            <img src="<?php echo getStaticUrl('images/imf-gift.png')?>" alt="" />
            <h3>IObit Malware Fighter 8 PRO</h3>
            <p>2 mois d’abonnement offerts</p>
          </dt>
          <dd>Un cadeau réservé uniquement à <br> nos utilisateurs fidèles</dd>
        </dl>
        <dl>
          <dt>
            <img src="<?php echo getStaticUrl('images/sd-gift.png')?>" alt="" />
            <h3>Smart Defrag 6 PRO</h3>
            <p><del>29,99€</del> 1 an / 1 PC</p>
          </dt>
          <dd>Maximisez les performances du <br> disque dur et de votre PC.</dd>
        </dl>
        <dl>
          <dt>
            <img src="<?php echo getStaticUrl('images/pf-gift.png')?>" alt="" />
            <h3>Protected Folder</h3>
            <p><del>39,99€</del> 1 an / 1 PC</p>
          </dt>
          <dd>Protégez vos fichiers et vos données <br> importants contre le vol, <br> la perte et les fuites.</dd>
        </dl>
        <dl>
          <dt>
            <img src="<?php echo getStaticUrl('images/amc-gift.png')?>" alt="" />
            <h3>AMC Security PRO</h3>
            <p><del>19,99€</del> 1 an / 1 appareil</p>
          </dt>
          <dd>Accélérez votre appareil Android <br> jusqu’à 200% plus rapide.</dd>
        </dl>
      </div>
      <h3>Seulement:  <strong>21,99€</strong> <del>169,96€</del></h3>
      <a class="buybtn orange" 
         href="https://www.iobit.com/buy.php?product=fr-imf8newinstallpackage&ref=fr_imf8olduserpurchase2006<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_imf"
         onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfolduserpurchase2006-fr')">
        <i class="all-icons"></i>
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="virtue">Détecter 209 millions de  menaces grâce aux moteurs de Bitdefender & d’IObit <sup>Amélioré</sup></td>
          <td class="space"></td>
          <td class="itemb"></td>
          <td class="space"></td>
          <td class="itema"><i class="all-icons red">√</i></td>
  ...
  <div class="footbuy">
    <div class="wrapper clearfix">
      ...
      <ul class="fl">
        ...
        <li class="active">
          <i class="all-icons"></i>
          <span>14 mois / 3 PC + Cadeaux offerts</span>
          <em>-87%</em>
        </li>
        <li class="three">
          <i class="all-icons"></i>
