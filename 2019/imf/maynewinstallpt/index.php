...
<head>
    ...
    <title>Adquira IObit Malware Fighter 8 PRO para 3 PCs com 55% de desconto e dois meses extras de assinatura. Oferta Limitada da IObit.</title>
...
<div class="container header clearfix">
    <div class="wrapper">
        <div class="head">
            ...
            <h1>PRESENTE EXCLUSIVO DE BOAS-VINDAS!</h1>
            <h2>Aproveite 55% de desconto e 2 meses extras de assinatura apenas para novos usuários!</h2>
        </div>
        <div class="banner">
            ...
            <div class="banner-right fr">
                <h2>IObit Malware Fighter 8 Pro – 14 meses / 3 PCs</h2>
                <p class="decri">Garante sua segurança sem afetar a velocidade do seu PC</p>
                <span class="banner-line"></span>
                <p class="de-price">De <del>R$ 159,90</del></p>
                <p class="main-price">6x de <b>R$ 11,67</b></p>
                <p class="small-price">ou <b>R$ 69,99</b> a vista</p>
                <span class="banner-line"></span>
                <a class="buy-btn" href="https://www.iobit.com/buy.php?product=pt-imf8newinstallpackage&ref=pt_imf83pcnewinstallpackage<?php echo $refStr;?>&refs=pt_purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imf3pcnewinstall-pt')">COMPRAR AGORA</a>
...
<div class="imf-message wrapper clearfix">
    ...
    <div class="wrapper">
        <ul class="message clearfix">
            ...
            <li class="three">
                <h4>Proteção de Dados Sensíveis</h4>
                <p>Adiciona uma camada extra de proteção além do motor anti-ransomware para proteger múltiplos tipos de arquivos e pastas de invasores.</p>
            </li>
            <li class="four">
                <h4>Segurança na Inicialização</h4>
                <p>Protege a inicialização do seu PC para impedir que Malware danifique seu sistema durante o boot.</p>
            </li>
        </ul>
            ...
            <div class="continer">
                <div class="roll">
                    <div class="content" data-num="0">
                        <img src="<?php echo getStaticUrl('images/img-list01.png')?>" alt=""/>
                        <span></span>
                    </div>
...
<div class="bottom-buy wrapper clearfix">
    <h2>Com apenas R$ 0,19 por dia, você mantém seu PC e seus dados seguros.</h2>
    <h3>Assine por um ano e leve IObit Malware Fighter Pro por 2 meses extras para 3 PCs.</h3>
    <div class="box-contain">
        <img src="<?php echo getStaticUrl('images/boxsort-imf-small.png')?>" alt=""/>
        <div class="bottom-btn">
            <p class="bottom-price">6x de <b>R$ 11,67</b>(ou R$ 69,99 a vista)</p>
            <a class="buy-btn" href="https://www.iobit.com/buy.php?product=pt-imf8newinstallpackage&ref=pt_imf83pcnewinstallpackage<?php echo $refStr;?>&refs=pt_purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imf3pcnewinstall-pt')">COMPRAR AGORA</a>
            <span class="btn-prce">Economize <b>R$ 89,91</b></span>
        </div>
    </div> 
</div>
<!--service-->
