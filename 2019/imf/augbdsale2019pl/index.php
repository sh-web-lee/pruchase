...
<head>
	<meta charset="UTF-8">
	<title> Zaoszczędź 70% na ochronie przed malware i wirusami - IObit Malware Fighter 8 nowe wydanie | IObit</title>
...
<body>
	...
	<div class="banner">
		<div class="wrapper">
			...
			<h1>Silnik Bitdefender: Najlepsza ochrona komputera dla Ciebie</h1>
			<h2>Chroń swój komputer przed ponad 209 milionami zagrożeń </h2>
			<div class="left-img">
			...
			<div class="right-message">
				<div class="box">
					...
					<dl class="price">
						...
						<dd><a href="https://www.iobit.com/buy.php?product=pl-imf83pcsdiu89&ref=pl_imfbd<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=pl_purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase-bd1908-pl');" class="buybtn"><i></i> Aktywuj teraz</a></dd>
					</dl>
				</div>
				<dl class="payment">
	...
	<div class="cruces">
		<div class="wrapper clearfix">
			...
			<ul>
				<li>
					<h3>Malware jest wszędzie!</h3>
					<p> Internet staje się coraz bardziej niebezpieczny. Codziennie pojawia się wiele nowych złośliwych programów, w tym wirusy, robaki, programy szpiegujące, adware i trojany, które próbują wyrządzić szkodę Twojemu komputerowi.  </p>
				</li>
				<li class="last">
					<h3>Infekcja ma poważne konsekwencje </h3>
					<p>Złośliwe oprogramowanie może zaatakować, a następnie wykraść osobiste, finansowe lub biznesowe informacje znajdujące się na Twoim komputerze..</p>
				</li>
			</ul>
		</div>
	</div>
	...
	<div class="db-message wrapper">
		<h2>Twoje wszechstronne i wydajne rozwiązanie zapobiegające</h2>
		<p>Silnik ochrony przeciw ransomware w IObit Malware Fighter 8 PRO inteligentnie chroni wszystkie pliki na komputerze przed nieautoryzowanym dostępem.</p>
		<div class="message-box">
			<dl class="list01">
				<dt>Aktualizacja do aktualnej bazy danych</dt>
				<dd>Nowe złośliwe oprogramowanie jest stale dodawane do bazy danych Bitdefender, aby upewnić się, że komputer jest zabezpieczony przed tymi szkodliwymi infekcjami. </dd>
			</dl>
			<dl class="list02">
				<dt>Ochrona w czasie rzeczywistym</dt>
				<dd>Po włączeniu silnika Bitdefender komputer będzie w pełni chroniony w czasie rzeczywistym. Wszelkie zagrożenia próbujące się włamać zostaną natychmiast zablokowane lub usunięte.</dd>
			</dl>
