...
<script type="text/javascript" src="<?php echo $pRootUrl; ?>tpl/js/stats.js"></script>
  ...
  <div class="banner">
    <div class="wrapper">
      ...
      <div class="pricebox">
        <dl class="price">
          <dt>TYLKO:  <strong>29,90 zł </strong><del>149,90 zł</del></dt>
          <dd>
            <a class="buybtn bigbtn" href="https://www.iobit.com/buy.php?product=pl-imf29-ac&ref=pl_imf-ac-register<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=pl_ac_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfac-pl');">
              <div class="inner">
                <i class="all-icons"></i>
  ...
  <div class="floatlayer" id="floatlayer">
    <div class="wrapper clearfix">
      <div class="left">
        ...
        <p><strong>80% ZNIŻKI </strong> na ochronę przed złośliwymi atakami i wyciekami prywatności</p>
      </div>
      <div class="pricebox">
        <dl class="price fr">
          <dt><strong>29,90 zł  </strong><del>149,90 zł</del></dt>
          <dd>
            <a class="buybtn smallbtn" href="https://www.iobit.com/buy.php?product=pl-imf29-ac&ref=pl_imf-ac-register<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=pl_ac_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfac');">
              <div class="inner">
                <i class="all-icons"></i>
                <span>Aktywuj teraz</span>
              </div>
