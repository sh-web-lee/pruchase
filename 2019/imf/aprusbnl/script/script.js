...
(function($) {
 ...
 function soldout() {
	...
	var new1pc = "https://www.iobit.com/buy.php?product=nl-imf71pc1999&ref=nl_imf1pcusbguard2019sold"+refStr+"&aff=" + aff + "&refs=nl_purchase_imf&tw=" + tw;
	var new1pcStat = "ga('send', 'event', 'imfusb1pcbuysold', 'buy', 'imfpurchase1904usb1pcsold-nl');";
