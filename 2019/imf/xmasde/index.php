...
<head>
  ...
  <title>Sparen Sie bis zu 83% auf IObit Malware Fighter& erhalten Sie ein Geschenkpaket kostenlos!</title>
...
<div class="container">
  ...
  <div class="spree wrapper">
    <div class="spree-box">
      ...
      <a class="spree-buy"
         href="https://www.iobit.com/buy.php?product=de-imf83pcsdpf2199&ref=de_imf83pcbundlepurchase2006<?php echo $refStr;?>&refs=de_purchase_imf"
         onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase3pcbundle2006-de');">
      </a>
    </div>
  </div>
  <!-- end spree -->
...
<div class="main wrapper">
  ...
  <div class="banner">
    ...
    <!-- title -->
    <h1>BLITZANGEBOT - 2021</h1>
    <!-- subtitle -->
    <p>Die besten Angebote des Jahres! Bis zu <span>-83%</span></p>
    <!-- panel -->
    <div class="panel clearfix">
      ...
      <div class="message small fl">
        ...
        <dl>
          ...
          <dd>
            <a class="buybtn"
               href="https://www.iobit.com/buy.php?product=de-imf81pc1999&ref=de_imf81pcpurchase2006<?php echo $refStr;?>&refs=de_purchase_imf"
               onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase1pc2006-de')"
               data-num="2">
      ...
      <div class="message large fl">
        ...
        <dl>
          <dd class="clearfix">
            Reduziert: <span class="fr">107,94€</span>
          </dd>
          <dd class="one">
            Weihnachtsgeschenke <i class="all-icons"></i>
            <p class="point">
              Weihnachtsgeschenke beinhalten<br> Smart Defrag PRO und Protected Folder.
            </p>
          </dd>
          <dd class="two">
            <p class="price red"><b>21</b> <del>129,93€</del></p>
          </dd>
          <dd>
      ...
      <div class="message small fr">
        ...
        <dl>
          ...
          <dd>
            <a class="buybtn"
               href="https://www.iobit.com/buy.php?product=de-imf83pc2199&ref=de_imf83pcpurchase2006<?php echo $refStr;?>&refs=de_purchase_imf"
               onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase3pc2006-de')"
               data-num="1">
              <i class="all-icons"></i> Jetzt kaufen
            </a>
          </dd>
  ...
  <div class="feature">
    ...
    <!-- title -->
    <h2>Nutzen Sie den Schutz<br> von Bitfender für eine überlegene Internetsicherheit!</h2>
    <p>
      Ausgestattet mit den weltweit führenden Bitdefender Anti-Virus- und Anti-Malware-Einheiten,<br> können <span>über 209 Millionen</span> neue Online-Bedrohungen wie Adware, Viren, Malware, Spyware usw. problemlos von Ihrem<br> PC entfernt werden.
    </p>
  ...
  <div class="intro">
    ...
    <dl class="one clearfix">
      ...
      <dd class="fl">
        ...
        <p>
          Fügt einen weiteren Schutz basierend auf der<br> Anti-Ransomware-Maschine hinzu, um mehrere<br> Dateitypen und Ordner vor Angreifern zu schützen.
        </p>
      </dd>
    </dl>
    <!-- 02 -->
  ...
  <div class="comparison">
    ...
    <!-- subtitle -->
    <h3>Aktivieren Sie IObit Malware Fighter PRO mit einem <span>83%</span>-Rabatt für einen umfassenden Schutz. </h3>
    <!-- imf-85 buybtn -->
    <a class="buybtn red"
       href="https://www.iobit.com/buy.php?product=de-imf83pcsdpf2199&ref=de_imf83pcbundlepurchase2006<?php echo $refStr;?>&refs=de_purchase_imf"
       onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase3pcbundle2006-de')">
  ...
  <div class="bottom-buy clearfix">
    <!-- title -->
    <h2 class="on">Machen Sie ihrem Computer die besten GESCHENKE</h2>
    <!-- box -->
    <div class="box fl">
    ...
    <dl class="fr">
      <dd>
        <p class="price"><b>21</b> <del>129,93€</del></p>
      </dd>
      <dd>
