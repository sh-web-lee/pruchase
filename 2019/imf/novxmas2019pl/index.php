...
if(in_array($_GET['to'],array('ar','sb','bd'))){
  $refStr.='-'.$_GET['to'];
}
...
<head>
  ...
  <title>Nie daj się zagrożeniom z najnowszym IObit Malware Fighter!</title>
...
<div class="container">
  ...
  <div class="spree wrapper">
    <div class="spree-box">
      ...
      <a class="spree-buy"
         href="http://www.iobit.com/buy.php?product=pl-imf73pcsdpf89&ref=pl_imf73pcsdpf89purchase1912<?php echo $refStr;?>&refs=pl_purchase_imf  "
         onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfxmas1912-pl');">
      </a>
    </div>
  </div>
  <!-- end spree -->
...
<div class="main wrapper">
  ...
  <div class="banner">
    ...
    <!-- title -->
    <h1>Specjalna promocja z IObit</h1>
    <!-- subtitle -->
    <p>Najlepsze oferty już są! Aż do <span>-80%,</span> po co czekać?</p>
    <!-- panel -->
    <div class="panel clearfix">
      ...
      <div class="message small fl">
        ...
        <dl>
          ...
          <dd>
            <a class="buybtn"
               href="http://www.iobit.com/buy.php?product=pl-imf71pc79&ref=pl_imf71pc79purchase1912<?php echo $refStr;?>&refs=pl_purchase_imf"
               onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfxmas1912-pl');"
               data-num="2">
      ...
      <div class="message large fl">
        ...
        <dl>
          ...
          <dd class="one">
            Darmowe prezenty<i class="all-icons"></i>
            <p class="point">
              Prezenty obejmują Protectred Folder i Smart Defrag PRO
            </p>
          </dd>
          <dd class="two">
      ...
      <div class="message small fr">
        ...
        <dl>
          ...
          <dd>
            <a class="buybtn"
               href="http://www.iobit.com/buy.php?product=pl-imf73pc89&ref=pl_imf73pc89purchase1912<?php echo $refStr;?>&refs=pl_purchase_imf  "
               onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfxmas1912-pl');"
               data-num="1">
              <i class="all-icons"></i> KUP TERAZ
            </a>
