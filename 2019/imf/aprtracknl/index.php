...
<body>
  ...
  <div class="banner">
    <div class="wrapper">
      ...
      <!-- fast -->
      <p class="fast <?php echo (intval($_GET['cookie'])>0)?'':'hide';?>"><?php echo (intval($_GET['cookie'])>0)?intval($_GET['cookie']):'';?> schadelijke cookie(s) gevonden</p>
      <!-- title -->
      <h1>Verwijder automatisch alle schadelijk cookies!</h1>
      <!-- box -->
      ...
      <div class="box three-pcs">
        ...
        <!-- 3pc buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=nl-imf73pc2199&ref=nl_imf3pctracking2019<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=nl_purchase_imf"
           onclick="ga('send', 'event', 'imftrackbuy', 'buy', 'imfpurchase1904track-nl');">
      ...
      <div class="box one-pc">
        ...
        <a class="buybtn border"
           href="https://www.iobit.com/buy.php?product=nl-imf71pc1999&ref=nl_imf1pctracking2019<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=nl_purchase_imf"
           onclick="ga('send', 'event', 'imftrack1pcbuy', 'buy', 'imfpurchase1904track1pc-nl');">
          <span>Activeer Nu</span>
        </a>
      </div>
    </div>
  ...
  <div class="feature feature01 wrapper clearfix">
    <h2>WAAROM MOET U TRACKING COOKIES UIT UW BROWSER VERWIJDEREN?</h2>
    <div class="img-box"><img src="<?php echo getStaticUrl('images/feature-box.jpg')?>" alt=""></div>
    <dl class="list01">
      <dt>Advertenties Achtervolgen U</dt>
      <dd>
        Adverteerders op websites die u heeft <br>
        bezocht, kunnen u volgen en overal <br>
        advertenties laten zien.
      </dd>
    </dl>
    <dl class="list02">
      <dt>Online Privacy Schending</dt>
      <dd>
        Hackers kunnen uw persoonlijke <br>
        gegevens stelen en uw accounts <br>
        binnendringen.
      </dd>
    </dl>
  </div>
  ...
  <div class="feature feature02 ">
    <div class="wrapper">
      <h2>
        HOE ANTI-TRACKING BIJDRAAGT AAN <br>
        EEN SCHONE BROWSER EN BEWAKING VAN UW PRIVACY
      </h2>
      <div class="img-box"><img src="<?php echo getStaticUrl('images/feature-box02.jpg')?>" alt=""></div>
      <dl class="list01">
        <dt><img src="<?php echo getStaticUrl('images/list01.png')?>" alt=""> Automatisch Cookies Wissen</dt>
        <dd>
          Als anti-tracking aanstaat, worden tracking <br>
          cookies automatisch verwijderd.
        </dd>
      </dl>
      <dl class="list02">
        <dt><img src="<?php echo getStaticUrl('images/list02.png')?>" alt=""> Persoonlijke Gegevens Beschermen</dt>
        <dd>
          Adverteerders kunnen uw online activiteit <br>
          niet traceren en uw persoonlijke informatie <br>
          blijft veilig.
        </dd>
      </dl>
    </div>
      ...
      <div class="wrapper">
        <dl>
          ...
          <dd>
            ...
            worden snel gedetecteerd <br>
            en bij u weggehouden.
          </dd>
         ...
         <dl class="last">
          ...
          <dd><strong>Geen USB-infecties</strong></dd>
          <dd>
            Virussen verborgen in USB-schijven <br>
            kunnen uw computer niet <br>
            besmetten.
          </dd>
          <dd><span>*alleen PRO</span></dd>
        </dl>
  ...
  <div class="float clearfix">
    <div class="wrapper">
      ...
      <div class="message">
        <h2>
          <strong>70% KORTING</strong>
          op volledige bescherming voor <br>
          het hele gezin!
        </h2>
        <div class="number">
          Wees er snel bij! Slechts
