...
<head>
  ...
  <title>80% Korting op IObit Malware Fighter 7 PRO, exclusief in de voorverkoop!</title>
...
<body>
  ...
  <div class="banner">
    <div class="wrapper">
      ...
      <h1>80% Korting Tijdens de Voorverkoop!</h1>
      ...
      <div class="clearfix">
        ...
        <div class="right-message">
          ...
          <p class="price">
            Nu: <strong>€<b>15</b>,99</strong> <del>€79,99</del>
          </p>
          <!-- buybtn -->
           <a class="buybtn" href="https://www.iobit.com/buy.php?product=nl-imf7preorder1y3pc1599&ref=nl_imf7preorder1y3pc1599<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=nl_purchase_imf"
              onclick="ga('send', 'event', 'imfbuy', 'buy', 'imf7preorderrc-nl');">
                 <span>Bestel Nu</span>
           </a>
        </div>
      </div>
      <div class="step">
        U kunt direct na de bestelling aan de slag met de RC versie van IObit Malware Fighter 7 PRO. Deze versie bevat vrijwel alle functies van het nieuwe IObit Malware Fighter 7 PRO. <br>Bij de officiële lancering van IObit Malware Fighter 7, laten we u weten dat u kunt updaten naar de definitieve versie. 
      </div>
    </div>
  ...
  <div class="feature">
    <div class="wrapper">
      <h2>WAAROM KIEST U IOBIT MALWARE FIGHTER 7 PRO?</h2>
      <h3>Geweldige PRO functies voor de beste bescherming van uw PC</h3>
      <dl class="list01">
        <dt>Geen Ransomware-aanvallen</dt>
        <dd>U hoeft zich geen zorgen meer te maken <br>over hackers die uw bestanden en <br>gegevens versleutelen.</dd>
      </dl>
      <dl class="list02">
        <dt>Wachtwoordbeveiliging voor <br>Belangrijke Bestanden</dt>
        <dd>Isoleer uw belangrijke bestanden zodat niemand <br>zonder wachtwoord toegang kan krijgen.</dd>
      </dl>
      <dl class="list03">
        <dt>Laatste Bitdefender Engine</dt>
        <dd>Met de laatste Bitdefender Engine, worden <br><span>200.000.000+</span> bedreigingen zoals virussen, malware <br>en spyware uit uw computer gehouden.</dd>
      </dl>
      <dl class="list04">
        <dt>Veilig Online Browsen</dt>
        <dd>Automatisch cookies en surfsporen wissen zodat <br>uw surfgedrag niet meer gevolgd kan worden en <br>uw privacy gewaarborgd is.  </dd>
      </dl>
  ...
  <div class="compar-tab">
    <div class="wrapper">
      <h2>Nieuwe PRO functies Garanderen Volledige Veiligheid</h2>
      <table border="0" cellspacing="0" cellpadding= "0" width="100%">
        <thead>
          <tr>
            <th class="itema"></th>
            <th class="space"></th>
            <th class="itemb"><span>Nu heeft u</span></th>
            <th class="space"></th>
            <th class="itemc">Met PRO krijgt u</th>
          </tr>
        </thead>
        <tbody>
          <tr class="protection">
            <td colspan="5">PC Beschermen</td>
          </tr>
          <tr>
          ...
          <tr>
            <td class="itema">Realtime bescherming</td>
            <td class="space"></td>
            <td class="itemb size14">Basis</td>
            <td class="space"></td>
            <td class="itemc size14">Volledig</td>
          </tr>
          <tr>
            <td class="itema">Betere detectie met dubbele engines</td>
            <td class="space"></td>
            <td class="itemb">-</td>
            <td class="space"></td>
          ...
          <tr>
            <td class="itema">Voorkom USB-virussen</td>
            <td class="space"></td>
            <td class="itemb">-</td>
            <td class="space"></td>
            <td class="itemc"><i></i></td>
          ...
          <tr>
            <td class="itema">Database automatisch updaten</td>
            <td class="space"></td>
            <td class="itemb">-</td>
            <td class="space"></td>
            <td class="itemc"><i></i></td>
          ...
          <tr class="protection">
            <td colspan="5">Bestanden Beschermen</td>
          </tr>
           <tr>
            <td class="itema">Voorkom ransomware</td>
            <td class="space"></td>
            <td class="itemb">-</td>
            <td class="space"></td>
            <td class="itemc"><i></i></td>
          ...
          <tr>
            <td class="itema">Bestanden beschermen met wachtwoord</td>
            <td class="space"></td>
            <td class="itemb">-</td>
            <td class="space"></td>
            <td class="itemc"><i></i></td>
          ...
          <tr class="protection">
            <td colspan="5">Browser Beschermen</td>
          </tr>
          <tr>
            <td class="itema">Blokkeer schadelijke websites en reclames</td>
            <td class="space"></td>
          ...
          <tr>
            <td class="itema">Geen schadelijke bestanden downloaden</td>
            <td class="space"></td>
            <td class="itemb"><i></i></td>
            <td class="space"></td>
            <td class="itemc"><i></i></td>
          ...
          <tr>
            <td class="itema">Voorkom dat u online gevolgd wordt</td>
            <td class="space"></td>
            <td class="itemb">-</td>
            <td class="space"></td>
            <td class="itemc"><i></i></td>
  ...
  <div class="between-buy wrapper">
    <h2>KRIJG NU TOEGANG TOT ALLE PRO FUNCTIES VOOR KRACHTIGE BESCHERMING</h2>
    <p class="price">
      Nu: <strong>€<b>15</b>,99</strong> <del>€79,99</del>
    </p>
    <!-- buybtn -->
     ...
     <p class="last">Slechts <strong class="packnum">*</strong> over, al <strong class="buyNum">*</strong> verkocht!</p>
  </div>
  ...
  <div class="pop-over ">
    ...
    <div class="message">
       ...
       <a class="buybtn"
         href="https://www.iobit.com/buy.php?product=nl-imf7preorder1y3pc1999&ref=nl_imf7preorder1y3pc1999<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=nl_purchase_imf"
         onclick="ga('send', 'event', 'imfbuy', 'buy', 'imf7predorderrc1999-nl');">
         <span>Bestel Nu</span>
      </a>
