...
<head>
  ...
  <title> Bis zu 77% Rabatt nur für Neumitglieder von IObit Malware Fighter PRO- IObit </title>
  ...
  <div class="wrapper">
    <div class="clearfix">
      ...
      <div class="title fr">
        ...
        <h3> Holen Sie sich bis zu 77% Rabatt auf IObit Malware Fighter PRO</h3>
    ...
    <div class="clearfix">
      <div class="offer">
        ...
        <div class="sign">
          ...
          <p><b>1 PC,</b> 1 Jahr</p>
          <a class="buybtn gray" 
             href="https://www.iobit.com/buy.php?product=de-imf81pc2099&ref=de_imf1pcnewinstall<?php echo $refStr;?>&refs=de_purchase_imf"
             onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfnewinstall-de')">
            JETZT SPAREN
          </a>
        </div>
      </div>
      <div class="offer seven">
        ...
        <div class="sign">
          ...
          <a class="buybtn" 
             href="https://www.iobit.com/buy.php?product=de-imf83pcpf2299&ref=de_imf3pcnewinstall<?php echo $refStr;?>&refs=de_purchase_imf"
             onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfnewinstall-de')">
            JETZT SPAREN  
          </a>
          <p class="last">IObit Malware Fighter PRO (3 PCs, 1 Jahr)</p>
        </div>
      </div>
    </div>
  ...
  <div class="feature">
    ...
    <div class="clearfix">
      ...
      <div class="right fr">
        ...
        <dl class="three">
          <dt>3、</dt>
          <dd>Bitdefender Engine schützt Ihren PC vor den 209 Millionen Sicherheitsbedrohungen.</dd>
        </dl>
        <dl class="four">
          <dt>4、</dt>
...
<div class="footbuy bg">
  <div class="box clearfix">
    ...
    <ul class="fl">
      ...
      <li class="two active">
        <i class="all-icons"></i> 
        <span>3 PCs <b>22,99</b> im Wert von 99,94€</span>
        <a class="buybtn" href="https://www.iobit.com/buy.php?product=de-imf83pcpf2299&ref=de_imf3pcnewinstall<?php echo $refStr;?>&refs=de_purchase_imf"
             onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfnewinstall-de')">
          JETZT SPAREN
        </a>
      </li>
...
<div class="float">
  ...
  <ul class="clearfix">
    <li>
      <p>19,99</p>
      <a class="buybtn" 
         href="https://www.iobit.com/buy.php?product=de-imf81pc1999&ref=de_imf1pcnewinstallpop<?php echo $refStr;?>&refs=de_purchase_imf"
         onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfnewinstallpop-de')">
        <i class="all-icons"></i>
        1 PC
      </a>
    </li>
    <li>
      <p>21,99</p>
      <a class="buybtn" 
         href="https://www.iobit.com/buy.php?product=de-imf83pcpf2199&ref=de_imf3pcnewinstallpop<?php echo $refStr;?>&refs=de_purchase_imf"
         onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfnewinstallpop-de')">
        <i class="all-icons"></i>
        3 PCs
      </a>
