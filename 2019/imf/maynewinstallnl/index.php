...
<!DOCTYPE html>
  ...
  <div class="banner">
    <div class="wrapper clearfix">
      ...
      <!-- title -->
      <h1>Exclusief Welkomstcadeau voor Nieuwe Gebruikers!</h1>
      ...
      <div class="offer offer3 fl">
        ...
        <!-- offer3 buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=nl-imf81pc1999&ref=nl_imf81pc1999purchase1905<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=nl_purchase_imf"
           onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase1905c-nl');">
          <i></i>
          <span>BESTEL NU</span>
        </a>
      </div>
      ...
      <div class="offer offer1 fl">
        ...
        <!-- offer1 buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=nl_imf8newinstallpackage&ref=nl_imf8newinstallpackagepurchase1905<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=nl_purchase_imf"
           onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase1905a-nl');">
          <i></i>
          <span>BESTEL NU</span>
        </a>
      </div>
      ...
      <div class="offer offer2 fr">
        ...
        <!-- offer2 buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=nl-imf83pc2199&ref=nl_imf83pc2199purchase1905<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=nl_purchase_imf"
           onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase1905b-nl');">
          <i></i>
          <span>BESTEL NU</span>
        </a>
      </div>
  ...
  <div class="bottombuy">
    <div class="wrapper clearfix">
      ...
      <ul class="option fl clearfix">
        <!-- IMF 3PC|1YEAR & PF -->
        <li class="active"
            data-url="https://www.iobit.com/buy.php?product=nl_imf8newinstallpackage&ref=nl_imf8newinstallpackagepurchase1905<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=nl_purchase_imf"
            data-ga="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase1905a-nl');"
            data-price="€21,99"
            data-del="€119,94">
        ...
        <!-- IMF 3PC|1YEAR -->
        <li
            data-url="https://www.iobit.com/buy.php?product=nl-imf83pc2199&ref=nl_imf83pc2199purchase1905<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=nl_purchase_imf"
            data-ga="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase1905b-nl');"
            data-price="€21,99"
            data-del="€79,99">
        ...
        <!-- IMF 1PC|1YEAR -->
        <li
            data-url="https://www.iobit.com/buy.php?product=nl-imf81pc1999&ref=nl_imf81pc1999purchase1905<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=nl_purchase_imf"
            data-ga="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase1905c-nl');"
            data-price="€19.99"
            data-del="€39,95">
