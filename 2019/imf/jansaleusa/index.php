...
<body>
			...
			<!-- header -->
				...
				<div class="stage before active">
					...
					<div class="details">
						...
						<dl class="checkout">
							...
							<dd><a href="https://www.iobit.com/buy.php?product=imf63pcpfamc2599&ref=imf3pcpfamc2019usa<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_imf" onclick="ga('send', 'event', 'imf2599buyusa', 'buy', 'imfpurchase-201901'); " class="checkbtn large buylink">Activate Now</a></dd>
				...
				<div class="extra single">
					...
					<dl class="checkout">
						...
						<dd><a href="https://www.iobit.com/buy.php?product=imf61pc&ref=imf1pc2019usa<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_imf" onclick="ga('send', 'event', 'imf1pcbuyusa', 'buy', 'imfpurchase-201901');" class="checkbtn middle link1pc buylink">Activate Now</a></dd>
					</dl>
				</div>
				<div class="extra family-pack">
					...
					<dl class="checkout">
						...
						<dd><a href="https://www.iobit.com/buy.php?product=imf63pc&ref=imf3pc2019usa<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_imf" onclick="ga('send', 'event', 'imf3pcbuyusa', 'buy', 'imfpurchase-201901');" class="checkbtn middle buylink">Activate Now</a></dd>
					</dl>
				</div>
			...
			<tr>
				...
				<th class="item-pro">
					...
					<dl>
						...
						<dd><a href="https://www.iobit.com/buy.php?product=imf63pcpfamc2599&ref=imf3pcpfamc2019usa<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_imf" onclick="ga('send', 'event', 'imf2599buyusa', 'buy', 'imfpurchase-201901'); " class="checkbtn small link3pc buylink">Activate Now</a></dd>
					</dl>
				</th>
			</tr>
			</thead>
	...
	<!-- float -->
	<div class="float">
		<a href="https://www.iobit.com/buy.php?product=imf63pcpfamc2599&ref=imf3pcpfamc2019usa<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_imf" onclick="ga('send', 'event', 'imf2599buyusa', 'buy', 'imfpurchase-201901'); " class="buylink">
			<div class="inner">
