...
<div class="container">
  ...
  <div class="spree wrapper">
    <div class="spree-box">
      ...
      <a class="spree-buy"
         href="https://www.iobit.com/buy.php?product=nl-imf73pcpfamc1999&ref=nl_imf73pcpfamc1999purchase1911<?php echo $refStr;?>&refs=nl_purchase_imf "
         onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfrightcornerpurchase1911-nl')">
      </a>
    </div>
  </div>
  <!-- end spree -->
...
<div class="main wrapper">
  ...
  <div class="comparison">
    ...
    <!-- subtitle -->
    <h3>Krijg <span>85%</span> korting op IObit Malware Fighter PRO voor meervoudige bescherming van uw pc</h3>
    <!-- imf-85 buybtn -->
    <a class="buybtn red"
       href="https://www.iobit.com/buy.php?product=nl-imf73pcpfamc1999&ref=nl_imf73pcpfamc1999purchase1911<?php echo $refStr;?>&refs=nl_purchase_imf "
       onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfrightcornerpurchase1911-nl')">
  ...
  <div class="bottom-buy clearfix">
    ...
    <!-- ul -->
    <ul class="fl">
      <li class="active top">1 Jaar / 3 PC’s + Kerstcadeaus</li>
    ...
    <dl class="fr">
      <dd>
        <p class="price"><small>€</small><b>19</b> <del>€139,93</del></p>
      </dd>
      <dd>
