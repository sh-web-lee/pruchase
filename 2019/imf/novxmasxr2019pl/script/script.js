...
function getCycleCountdown() {
  ...
  if (MApp(2.2).cookie.get('novxmasxr2019pl')) {
    dt = MApp(2.2).cookie.get('novxmasxr2019pl');

  } else {
    dt = date.setMinutes(date.getMinutes() + 10);
    MApp(2.2).cookie.set('novxmasxr2019pl', dt);
  }
...
function getPacksNum() {
  var e = new Date;
  var n1 = MApp(2.2).cookie.get('novxmasxr2019pl') / 1000;
