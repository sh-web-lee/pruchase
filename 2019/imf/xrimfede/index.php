...
<div class="container">
  ...
  <div class="spree wrapper">
    <div class="spree-box">
      ...
      <a class="spree-buy"
         href="https://www.iobit.com/buy.php?product=de-imf73pcsdpf1799&ref=de_imf73pcbundlepurchase201912exp<?php echo $refStr;?>&refs=de_purchase_imf"
         onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase3pcbundle1912exp-de');">
      </a>
    </div>
  </div>
  <!-- end spree -->
...
<div class="main wrapper">
    ...
    <div class="panel clearfix">
      ...
      <div class="message small fl">
        ...
        <dl>
          ...
          <dd>
            <a class="buybtn"
               href="https://www.iobit.com/buy.php?product=de-imf71pc1999&ref=de_imf71pcpurchase201912exp<?php echo $refStr;?>&refs=de_purchase_imf"
               onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase1pc1912exp-de');"
               data-num="2">
      ...
      <div class="message large fl">
        ...
        <dl>
          ...
          <dd class="two">
            <p class="price red"><b>17</b> <del>129,93€</del></p>
          </dd>
          <dd>
      ...
      <div class="message small fr">
        ...
        <dl>
          ...
          <dd>
            <a class="buybtn"
               href="https://www.iobit.com/buy.php?product=de-imf73pc1799&ref=de_imf3pcpurchase1912exp<?php echo $refStr;?>&refs=de_purchase_imf"
               onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase3pc1912exp-de');"
               data-num="1">
              <i class="all-icons"></i> Jetzt kaufen
            </a>
          </dd>
  ...
  <div class="comparison">
    <h2>Mit unserem Rundumschutz haben Sie keine Sicherheitsprobleme!</h2>
    <table>
      <thead>
        <tr>
          <th class="itema"><big>Sicherheitsprobleme</big>, die auftreten können:</th>
          <th class="itemb"><big>Schutz</big>, den Sie zurückerhalten können:</th>
        </tr>
      </thead>
      <tbody>
        <tr>
          <td class="itema">
            Die <span>verkleinerte Datenbank</span> deckt möglicherweise nicht die seltensten und aktuellsten Virenbedrohungen ab
          </td>
          <td class="itemb">
            Die <span>Bitdefender</span>- und IObit-Antiviren-Module bieten <span>doppelten Schutz</span>
          </td>
        </tr>
        <tr>
          <td class="itema">
            Ihre wichtigen Dateien werden möglicherweise <span>von Ransomware verschlüsselt</span>
          </td>
          <td class="itemb">
            Das <span>Anti-Ransomware-Modul</span> schützt Ihre Dateien vor Verschlüsselung und Ransomware
          </td>
        </tr>
        <tr>
          <td class="itema">
            <span>Private Dateien</span> und Informationen können <span>freigegen</span> werden, wenn der PC angegriffen wird
          </td>
          <td class="itemb">
            <span>Safe-Box</span> bietet eine zweite Sicherheitsebene, um Ihre Dateien vor unsicherem Zugriff zu schützen
          </td>
        </tr>
        <tr>
          <td class="itema">
            <span>Eingeschränkter Schutz</span> gegen die Verfolgung Ihrer Privatsphäre
          </td>
          <td class="itemb">
            <span>Die Anti-Verfolgung</span> bereinigt automatisch Ihre Surfspuren
          </td>
        </tr>
        <tr>
          <td class="itema">
            Programme können <span>Ihre Kamera unbemerkt aktivieren und laufen lassen</span>
          </td>
          <td class="itemb">
            <span>Der Kamera-Wächter</span> stoppt den nicht autorisierten Kamerazugriff
          </td>
        </tr>
        <tr>
          <td class="itema">
            <span>Keine Priorität</span>, um aktuellen Schutz zu erhalten
          </td>
          <td class="itemb">
            <span>Die Automatische Aktualisierung</span> hält Sie von aktuellen Sicherheitsbedrohungen fern.
          </td>
        </tr>
      </tbody>
    </table>
  ...
  <div class="offermore clearfix">
    <h2>Der neue IObit Malware Fighter 7 kann<br> viel mehr als Sie denken!</h2>
    <dl>
      <dt><img src="<?php echo getStaticUrl('images/offermore-01.png')?>" alt=""/></dt>
      <dd>
        <span><em>verbessert</em></span>
        <h3>60% größere</h3>
    ...
    <dl>
      ...
      <dd>
        <span class="nuovo"><em>neu</em></span>
        <h3>Passwortschutz</h3>
        <p>für Persönliche Daten</p>
      </dd>
    </dl>
    <dl class="last">
...
<div id="floatlayer" class="floatlayer">
  <div class="wrapper clearfix">
    <div class="left fl"><img src="<?php echo getStaticUrl('images/float-box.png')?>" alt=""/></div>
    <div class="center fl"><h2>Exklusivangebot zu Weihnachten 2019!</h2></div>
    <div class="price fr">
