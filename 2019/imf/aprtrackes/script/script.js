...
(function($) {
 ...
 function soldout() {
 	...
 	$(".banner .one-pc p del").html("79,95€")
 	$(".float h2").html("<strong>50%</strong> de descuento para obtener una <br /> protección completa para tu PC")
 	$(".number").remove();

 	var aff = $.getUrlParam('aff');
	var tw = MApp(2.2).datetime.getTimeZone();
	var new1pc = "https://www.iobit.com/buy.php?product=es-imf81pc1799&ref=es_imf81pctracking2005sold"+refStr+"&aff=" + aff + "&refs=es_purchase_imf&tw=" + tw;
	var new1pcStat = "ga('send','event','imftrack1pcbuysold','buy','imfpurchase1904track1pcsold-es');"
...
function packsGet() {
	var date = new Date();
	var cName = "esimftra" + date.getDate();
