...
<head>
  ...
  <title> Bis zu 80% Rabatt nur für treue Kunden von IObit Malware Fighter PRO- IObit</title>
...
<div class="banner bg">
  <div class="wrapper">
    <div class="clearfix">
      ...
      <div class="title fr">
        <h1>Sonderangebot nur für treue Kunden</h1>
        <h3> Holen Sie sich nicht nur Protected Folder, sondern extra 2 Monate für IMF PRO.</h3>
    ...
    <div class="clearfix">
      <div class="offer">
        ...
        <div class="sign">
          ...
          <p><b>1 PC,</b> 1 Jahr</p>
          <a class="buybtn gray" 
             href="https://www.iobit.com/buy.php?product=de-imf81pc2099&ref=de_imf1pcnewlaunch<?php echo $refStr;?>&refs=de_purchase_imf"
             onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfnewlaunch-de')">
            JETZT SPAREN
          </a>
        </div>
      </div>
      <div class="offer seven">
        ...
        <p class="gratis">Gratisgeschenk für Neumitglieder</p>
        <div class="sign">
          <p><b>3 PCs,</b> 1 Jahr + <strong>2 Monate</strong></p>
          <a class="buybtn" 
             href="https://www.iobit.com/buy.php?product=de-imf814mpf&ref=de_imf3pcnewlaunch<?php echo $refStr;?>&refs=de_purchase_imf"
             onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfnewlaunch-de')">
            JETZT SPAREN  
          </a>
          <p class="last">IObit Malware Fighter PRO (3 PCs, 14 Monate)</p>
        </div>
      </div>
    </div>
...
<div class="wrapper">
  <!-- feature start -->
  <div class="feature">
    <h2>Was kann IObit Malware Fighter 8 PRO?</h2>
    <div class="clearfix">
      <div class="left fl">
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="virtue">Erkennt 209.000.000 + Bedrohungen mit Bitdefender und IObit-Engine</td>
          <td class="itema"></td>
          <td class="space"></td>
          <td class="itemb"><i class="all-icons">√</i></td>
        </tr>
...
<div class="footbuy bg">
  <div class="box clearfix">
    ...
    <ul class="fl">
      ...
      <li class="two active">
        <i class="all-icons"></i> 
        <span>3 PCs <b>22,99</b> im Wert von 114,99</span>
        <a class="buybtn" href="https://www.iobit.com/buy.php?product=de-imf814mpf&ref=de_imf3pcnewlaunch<?php echo $refStr;?>&refs=de_purchase_imf"
         onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfnewlaunch-de')">
          JETZT SPAREN
        </a>
      </li>
...
<div class="float">
  ...
  <ul class="clearfix">
    <li>
      <p>19,99</p>
      <a class="buybtn"  href="https://www.iobit.com/buy.php?product=de-imf81pc1999&ref=de_imf1pcnewlaunchpop<?php echo $refStr;?>&refs=de_purchase_imf"
           onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfnewlaunchpop-de')">
        <i class="all-icons"></i>
        1 PC
      </a>
    </li>
    <li>
      <p>21,99</p>
      <a class="buybtn"  href="https://www.iobit.com/buy.php?product=de-imf814mpfpop&ref=de_imf3pcnewlaunchpop<?php echo $refStr;?>&refs=de_purchase_imf"
           onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfnewlaunchpop-de')">
        <i class="all-icons"></i>
        3 PCs
      </a>
...
<div class="maxbox">
  ...
  <ul class="clearfix">
    <li>
      <span>12 Monate, <b>1 PC</b></span>
      <p>Gutschein <b>-</b> <strong>1€</strong></p>
      <p>
        <a class="buybtn gray" 
           href="https://www.iobit.com/buy.php?product=de-imf81pc1999&ref=de_imf1pcnewlaunchpop<?php echo $refStr;?>&refs=de_purchase_imf"
           onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfnewlaunchpop-de')">
          Jetzt nur <b>19,99€</b>
        </a>
      </p>
    ...
    <li class="last">
      <span>14 Monate, <b>3 PCs</b></span>
      <p>Gutschein <b>-</b> <strong>1€</strong></p>
      <p>
        <a class="buybtn" 
           href="https://www.iobit.com/buy.php?product=de-imf814mpfpop&ref=de_imf3pcnewlaunchpop<?php echo $refStr;?>&refs=de_purchase_imf"
           onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfnewlaunchpop-de')">
          Jetzt nur <b>21,99€</b>
        </a>
      </p>
