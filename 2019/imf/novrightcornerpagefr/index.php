...
<div class="container">
  ...
  <div class="spree wrapper">
    <div class="spree-box">
      ...
      <a class="spree-buy"
         href="https://www.iobit.com/buy.php?product=fr-imf7pfiuamc1999&ref=fr_imf7bundlerightcorspecial1999purchase1911<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_imf"
         onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfrightcorpurchase1911d-fr');">
      </a>
    </div>
  </div>
  <!-- end spree -->
...
<div class="main wrapper">
    ...
    <div class="panel clearfix">
      ...
      <div class="message small fl">
        ...
        <dl>
          ...
          <dd>
            <a class="buybtn"
               href="https://www.iobit.com/buy.php?product=fr-imf71pc1799&ref=fr_imf71pcrightcor1799purchase1911<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_imf"
               onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfrightcorpurchase1911c-fr')"
               data-num="2">
        ...
        <dl>
          ...
          <dd>
            <a class="buybtn large"
               href="https://www.iobit.com/buy.php?product=fr-imf7pfiuamc1999&ref=fr_imf7bundlerightcor1999purchase1911<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_imf"
               onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfrightcorpurchase1911a-fr')"
               data-num="0">
              <i class="all-icons"></i> VITE, J’EN PROFITE
            </a>
      ...
      <div class="message small fr">
        ...
        <dl>
          ...
          <dd>
            <a class="buybtn"
               href="https://www.iobit.com/buy.php?product=fr-imf73pc2199&ref=fr_imf73pcrightcor2199purchase1911<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_imf"
               onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfrightcorpurchase1911b-fr')"
               data-num="1">
              <i class="all-icons"></i> VITE, J’EN PROFITE
            </a>
          </dd>
  ...
  <div class="comparison">
    ...
    <!-- subtitle -->
    <h3>Achetez IObit Malware Fighter PRO avec <span>88% de réduction</span> pour une protection multicouche</h3>
    <!-- imf-85 buybtn -->
    <a class="buybtn red"
       href="https://www.iobit.com/buy.php?product=fr-imf7pfiuamc1999&ref=fr_imf7bundlerightcor1999purchase1911<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_imf"
       onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfrightcorpurchase1911a-fr')">
  ...
  <div class="bottom-buy clearfix">
    ...
    <dl class="fr">
      <dd>
        <p class="price"><b>19</b> <del>169,96€</del></p>
      </dd>
      <dd>
