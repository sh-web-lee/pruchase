...
<body>
  ...
  <div class="banner">
    <div class="wrapper">
      ...
      <div class="title">
        <h1>Offres Spéciales Pour Les Nouveaux Membres</h1>
        <h3>Jusqu’à -87% ! Achetez-en 1 et obtenez-en 3 GRATUIT ! Dernières heures, derniers petits prix ! </h3>
      </div>
      <div class="clearfix">
        <div class="box small">
          ...
          <div class="price">
            ...
            <a class="buybtn" 
               href="https://www.iobit.com/buy.php?product=fr-imf81y1pc1799&ref=fr_imf81pcnewuserpurchase2006<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_imf"
               onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfnewuserpurchase2006-fr')">
              VITE, J'EN PROFITE
            </a>
          </div>
        </div>
        <div class="box big">
          ...
          <div class="price">
            ...
            <a class="buybtn orange" 
               href="https://www.iobit.com/buy.php?product=fr-imf8pfsdamc2199&ref=fr_imf8newuserpurchase2006<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_imf"
               onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfnewuserpurchase2006-fr')">
              <i class="all-icons"></i>
              VITE, J'EN PROFITE
            </a>
        ...
        <div class="box small right">
          ...
          <div class="price">
            ...
            <a class="buybtn" 
               href="https://www.iobit.com/buy.php?product=fr-imf83pc2199&ref=fr_imf83pcnewuserpurchase2006<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_imf"
               onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfnewuserpurchase2006-fr')">
              VITE, J'EN PROFITE
            </a>
          </div>
    ...
    <div class="wrapper">
      ...
      <div class="clearfix">
        ...
        <dl>
          ...
          <dd>Accélère votre appareil Android <br> jusqu’à 200% plus rapide.</dd>
        </dl>
      </div>
