...
function change() {
	...
	var details = '<div class="details">' +
		...
		'</div>' +
		'<dl class="checkout">' +
		'<dt>only <strong>$25.99</strong> <del>$54.95</del></dt>' +
	...
	var valuePack = '<div class="extra value-pack sold-out">' +
		...
		'</div>' +
		'<dl class="checkout">' +
		'<dt><strong>$27.99</strong> <del>$94.89</del></dt>' +
	...
	var new3pc = "https://www.iobit.com/buy.php?product=imf63pc2599&ref=imf3pc2019usbb"+refStr+"&aff=" + aff + "&refs=purchase_imf&tw=" + tw;
	var new3pcStat = "ga('send', 'event', 'imf3pcbuyusbb', 'buy', 'imfpurchase-201901');"
	var new1pc = "https://www.iobit.com/buy.php?product=imf61pc2199&ref=imf1pc2019usbb"+refStr+"&aff=" + aff + "&refs=purchase_imf&tw=" + tw;
	var new1pcStat = "ga('send', 'event', ' imf1pcbuyusbb', 'buy', 'imfpurchase-201901');"
	...
	$('.priceExtra').html('<strong>$25.99</strong> <del>$54.95</del>')
