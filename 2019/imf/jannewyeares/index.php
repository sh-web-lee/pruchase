  ...
  <div class="wrapper">
    ...
    <div class="panel clearfix">
      <div class="box small">
        ...
        <!-- 1pc buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=es-imf71pc1799&ref=es_imf71pcpurchase1901<?php echo $refStr;?>&refs=es_purchase_imf"
           onclick="ga('send', 'event', 'imfbuy', 'buy', 'imf1pcpurchase1901-es')">
      ...
      <div class="box">
        ...
        <!-- 3pc buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=es-imf73pcpfsd1999&ref=es_imf73pcpfsdpurchase1901<?php echo $refStr;?>&refs=es_purchase_imf"
           onclick="ga('send', 'event', 'imfbuy', 'buy', 'imf3pcpurchase1901-es')">
          <i></i> <span>Comprar ahora</span>
        </a>
        <p class="bought">
...
<div class="between-buy">
  <div class="wrapper">
    ...
    <!-- 3pc buybtn -->
    <a href="https://www.iobit.com/buy.php?product=es-imf73pcpfsd1999&ref=es_imf73pcpfsdpurchase1901<?php echo $refStr;?>&refs=es_purchase_imf"
       onclick="ga('send', 'event', 'imfbuy', 'buy', 'imf3pcpurchase1901-es')" class="buybtn">
      <i></i>
  ...
  <table border="0" cellspacing="0" cellpadding="0" width="100%">
    ...
    <tr>
      ...
      <th class="itemb">
        ...
        <del> 39,95€</del>
        <!-- 1pc buybtn -->
        <a href="https://www.iobit.com/buy.php?product=es-imf71pc1799&ref=es_imf71pcpurchase1901<?php echo $refStr;?>&refs=es_purchase_imf"
           onclick="ga('send', 'event', 'imfbuy', 'buy', 'imf1pcpurchase1901-es')"
           class="buybtn">
          Comprar ahora
        </a>
    ...
    <tr>
      ...
      <td class="virtue">Detecta más de 203,000,000 de amenazas con los motores Bitdefender y IObit</td>
    ...
    <tr>
      ...
      <td class="virtue">Bloquea ransomware que intentan cifrar tus archivos importantes 	 <sup class="new">NUEVO</sup></td>
      <td class="itemb"><img src="<?php echo $pResUrl; ?>images/greyerror.png"></td>
      <td class="itema"><img src="<?php echo $pResUrl; ?>images/redmark.png"></td>
      <td class="itemb"><img src="<?php echo $pResUrl; ?>images/redmark.png"></td>
    </tr>
