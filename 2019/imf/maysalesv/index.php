...
<head>
  ...
  <title>Spara upp till 80% RABATT! Aktivera IMF PRO för att skydda din PC och online-upplevelse! – IObit</title>
  ...
  <div class="wrapper">
    ...
    <div class="panel clearfix">
      <div class="box small">
        ...
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=sv-imf71pc249&ref=sv_imf71pcpurchase1905<?php echo $refStr;?>&refs=sv_purchase_imf"
           onclick="ga('send', 'event', 'imfbuy', 'buy', 'imf1pcpurchase1905-sv');">
          <span>KÖP NU</span>
        </a>
      </div>
      <div class="box good">
        ...
        <p class="price"><strong>329 kr</strong> <del class="original">1 198 kr</del></p>
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=sv-imf73pcpf329&ref=sv_imf73pcpfpurchase1905<?php echo $refStr;?>&refs=sv_purchase_imf"
           onclick="ga('send', 'event', 'imfbuy', 'buy', 'imf3pcpurchase1905-sv');">
          <span>KÖP NU</span>
        </a>
        <p class="bought">
  ...
  <div class="comparison_table wrapper" id="compare">
    <table border="0" cellspacing="0" cellpadding="0" width="100%">
      ...
      <tr>
        ...
        <th class="space"></th>
        <th class="itemb">
          1 År / <span>3</span> PC + Gåva<p><strong>329<small> kr</small></strong> <del>1 198 kr</del></p>
          <a class="buybtn"
             href="https://www.iobit.com/buy.php?product=sv-imf73pcpf329&ref=sv_imf73pcpfpurchase1905<?php echo $refStr;?>&refs=sv_purchase_imf"
             onclick="ga('send', 'event', 'imfbuy', 'buy', 'imf3pcpurchase1905-sv');">
            <span>KÖP NU</span>
