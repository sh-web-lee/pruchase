...
<div class="container">
  ...
  <div class="banner wrapper">
    ...
    <!-- title -->
    <h1>
      Addio a <strong>malware</strong> e <strong>virus</strong>
      <span>PC più sicuro con la protezione in tempo reale!</span>
    </h1>
    <!-- content -->
    <div class="content clearfix">
      ...
      <div class="box smallbox fl">
        <!-- box -->
        <img src="<?php echo $pResUrl;?>images/imf-1pc.png" alt="IObit Malware Fighter PRO6">
        <!-- brand -->
        ...
        <a class="buybtn small"
           href="http://www.iobit.com/buy.php?product=it-imf71pc1899&ref=it_imf71pc1899purchase1901b<?php echo $refStr;?>&refs=it_purchase_imf"
           onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase1PC1902a-it')">
          ACQUISTA SUBITO
        </a>
      </div>
      ...
      <div class="box largebox fl">
        ...
        <!-- brand -->
        <p class="brand">1 Anno / 3 PC + Regalo Gratis</p>
        <!-- number -->
        <p class="number">Pacchetti limitati, solo <strong class="packsNum-gift" >XXX</strong> restanti!</p>
        <!-- price -->
        <p class="price"><del>€99.99</del> €19.99</p>
        <!-- 3pc+pf buybtn -->
        <a class="buybtn"
           href="http://www.iobit.com/buy.php?product=it-imf73pcpf1999&ref=it_imf73pcpf1999purchase1901b<?php echo $refStr;?>&refs=it_purchase_imf"
           onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase3PCpf1902c-it')">
      ...
      <div class="box smallbox fr">
        ...
        <!-- 3pc buybtn -->
        <a class="buybtn small"
           href="http://www.iobit.com/buy.php?product=it-imf73pc1999&ref=it_imf73pc1999purchase1901b<?php echo $refStr;?>&refs=it_purchase_imf"
           onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase3PC1902b-it')">
          ACQUISTA SUBITO
        </a>
      </div>
    </div>
...
<div class="feature wrapper clearfix">
  <!-- title -->
  <h2>Il tuo PC ha bisogno della protezione omnicomplesiva di IObit Malware Fighter 7 PRO</h2>
  <!-- list -->
  <ul>
    <!-- 01 -->
    <li>
    ...
    <li>
      <dl class="clearfix">
        ...
        <dd>
          ...
          <p>
            Usa la password per proteggere i tuoi dati personali in modo che <br>
            nessuno possa ottenere l'accesso senza autorizzazione.
          </p>
        </dd>
      </dl>
    </li>
    ...
    <li>
      <dl class="clearfix">
        ...
        <dd>
          <h3>Protezione in tempo reale più approfondita</h3>
          <p>
            Blocca i ransomware che tentano di entrare nel tuo computer o <br>
            crittografare i tuoi file importanti.
          </p>
        </dd>
      </dl>
    </li>
...
<div class="gift wrapper clearfix">
  <!-- title -->
  <h2>Puoi ottenere il Protected Folder come un regalo GRATIS!</h2>
...
<div class="comparison wrapper">
  <table border="0" cellspacing="0" cellpadding="0" width="100%">
    ...
    <tr>
      ...
      <td class="text">Rileva oltre 203.000.000 di minacce con motori Bitdefender e di Iobit <em class="tab-icons right">Migliorato</em></td>
      <td class="space"></td>
      <td class="itemfree"><i class="all-icons circle">●</i></td>
      <td class="space"></td>
      <td class="itempro"><i class="all-icons red">√</i></td>
    ...
    <div class="content clearfix">
      ...
      <ul class="fl clearfix">
        ...
        <li class="imf3pcpf active"
            data-url="http://www.iobit.com/buy.php?product=it-imf73pcpf1999&ref=it_imf73pcpf1999purchase1901b<?php echo $refStr;?>&refs=it_purchase_imf"
            data-ga="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase3PCpf1902c-it')"
            data-price="19"
            data-del="€99.99"
            data-off="€80">
          1 Anno / 3 PC+PF
        ...
        <!-- 3pc -->
        <li class="imf3pc"
            data-url="http://www.iobit.com/buy.php?product=it-imf73pc1999&ref=it_imf73pc1999purchase1901b<?php echo $refStr;?>&refs=it_purchase_imf"
            data-ga="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase3PC1902b-it')"
            data-price="19"
            data-del="€59.95"
            data-off="€39.96">
          1 Anno / 3 PC
        ...
        <!-- 1pc -->
        <li class="imf1pc"
            data-url="http://www.iobit.com/buy.php?product=it-imf71pc1899&ref=it_imf71pc1899purchase1901b<?php echo $refStr;?>&refs=it_purchase_imf"
            data-ga="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase1PC1902a-it')"
            data-price="18"
            data-del="€39.95"
            data-off="€20.96">
          1 Anno / 1 PC
