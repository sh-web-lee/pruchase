...
<title>Jusqu'à -85% sur IObit Malware Fighter PRO et profitez des cadeaux exclusifs à durée limitée - Vente Flash !</title>
  ...
  <div class="banner">
    <div class="wrapper">
      ...
      <div class="clearfix">
        ...
        <div class="box big">
          <h2 id="bandown" class="countdown">Expirera dans  <b>10</b> H : <b>59</b> M : <b>46</b> S <b>81</b> MS *</h2>
          <div class="imgbox gift"><b>-87%</b></div>
          <div class="price">
            <p><strong><big class="discount">21</big>,99€</strong> <del class="original">149,97€</del></p>
            <a class="buybtn orange" 
               href="https://www.iobit.com/buy.php?product=fr-imf6pfsd2199&ref=fr_imf6pfsd2199purchase1904&aff=<?php echo $_GET['aff'];?>&refs=fr_purchase_imf"
               onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase1904-fr')">
              <i class="all-icons"></i>
              VITE, J'EN PROFITE
            </a>
          </div>
          <p class="last"><span class="buyNum"><?php echo $buyNum;?></span> personnes l’ont acheté!</p>
        </div>
        <div class="box small right">
          <div class="imgbox three"><b>-87%</b></div>
          <div class="price">
            <p><strong><big class="discount">19</big>,99€</strong> <del class="original">39,95€</del></p>
            <a class="buybtn" 
               href="https://www.iobit.com/buy.php?product=fr-imf61y1pc1999&ref=fr_imf61y1pc1999purchase1904&aff=<?php echo $_GET['aff'];?>&refs=fr_purchase_imf  "
               onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase1904-fr')">
              VITE, J'EN PROFITE
            </a>
          </div>
      ...
      <div class="clearfix">
        <dl>
          ...
          <dd>
            ...
            <p><span>1 An / 1 PC</span> <del>29,99€</del> <strong>0€</strong>  </p>
            
            Maximisez les performances du disque dur et <br> de votre PC.
          </dd>
        </dl>
        <dl>
          <dt>
          ...
          <dd>
            ...
            <p><span>1 An / 1 PC</span> <del>39,99€</del> <strong>0€</strong>  </p>
            
            Protégez vos fichiers et vos données <br> importants contre le vol, la perte et les fuites.
          </dd>
        </dl>
      </div>
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="virtue">Protège les dossiers spécifiques importants contre les accès non autorisés grâce au Coffre-fort  <sup class="red">Nouveau </sup></td>
          <td class="space"></td>
          <td class="itemb"></td>
          <td class="space"></td>
          <td class="itema"><i class="all-icons red">√</i></td>
