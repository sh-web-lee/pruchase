...
if(!empty($_GET['ver'])){
  $matches = explode('.',$_GET['ver']);
  $refStr.='-'.$matches[0].$matches[1];
}
...
<div class="banner">
  ...
  <div class="wrapper">
    ...
    <h1 class="title">New Year Sale</h1>
    ...
    <div class="stage before active">
      ...
      <div class="details">
        ...
        <dl class="checkout">
          ...
          <dd>
            <a href="https://www.iobit.com/buy.php?product=imf73pciusd2599&ref=en-imf3pciusdxmas<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_imf"
               onclick="ga('send', 'event', 'imf2599buy', 'buy', 'imfpurchase-201912');"
               class="checkbtn large new buylink">
              Activate Now
            </a>
          </dd>
    ...
    <div class="extra single">
      ...
      <dl class="checkout">
        ...
        <dd>
          <a href="https://www.iobit.com/buy.php?product=imf71pc&ref=en-imf1pcxmas<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_imf"
             onclick="ga('send', 'event', 'imf1pcbuy', 'buy', 'imfpurchase-201912');"
    ...
    <div class="extra family-pack">
      ...
      <dl class="checkout">
        ...
        <dd>
          <a href="https://www.iobit.com/buy.php?product=imf73pc&ref=en-imf3pcxmas<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_imf"
             onclick="ga('send', 'event', 'imf3pcbuy', 'buy', 'imfpurchase-201912');"
  ...
  <div class="wrapper">
    ...
    <div class="container clearfix">
      <ul>
        ...
        <li class="last">Protect Your PC from Virus, Malware &amp; <br> Ransomware in Real Time</li>
      </ul>
      <ul>
        ...
        <li class="last">Uninstall Unwanted Plug-ins for Cleaner <br> PC & Browsing  </li>
      </ul>
      <ul class="last">
        <li><img src="<?php echo getStaticUrl('images/boxshot-sd.png')?>.png" alt=""></li>
        <li><strong>Smart Defrag PRO</strong></li>
        <li><del>$19.99</del>   1 Year / 1 PC</li>
        <li class="last">Maximize Hard Drive Optimization for <br> Faster PC  </li>
      </ul>
    </div>
    <div class="cartarea clearfix">
      ...
      <dl class="checkout">
        ...
        <dd>
          <a href="https://www.iobit.com/buy.php?product=imf73pciusd2599&ref=en-imf3pciusdxmas<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_imf"
             onclick="ga('send', 'event', 'imf2599buy', 'buy', 'imfpurchase-201912');"
             class="checkbtn large mid-new buylink">
            Activate Now
          </a>
        </dd>
        <dd class="last"><i></i>100% 60-DAY MONEY BACK GUARANTEE</dd>
      ...
      <th class="item-pro">
        ...
        <dl>
          ...
          <dd>
            <a href="https://www.iobit.com/buy.php?product=imf73pciusd2599&ref=en-imf3pciusdxmas<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_imf"
               onclick="ga('send', 'event', 'imf2599buy', 'buy', 'imfpurchase-201912');"
               class="checkbtn small-new link3pc buylink">
              Activate Now
            </a>
          </dd>
        </dl>
