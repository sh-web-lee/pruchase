...
<head>
  ...
  <title>Oferta exclusivo para nueva lanzamiento de IObit Malware Fighter – IObit</title>
  ...
  <div class="wrapper">
    ...
    <div class="panel clearfix">
      <div class="box small">
        ...
        <p><strong>16</strong><span><b>99</b> <del class="original">39,95€</del></span></p>
        <!-- 1pc buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=es-imf81pc1699&ref=es_imf81pcnewlaunch<?php echo $refStr;?>&refs=es_purchase_imf"
           onclick="ga('send', 'event', 'imfbuy', 'buy', 'imf1pcnewlaunch-es')">
      ...
      <div class="box">
        ...
        <p><strong>17</strong><span><b>99</b> <del class="original">149,89€</del></span></p>
        <!-- 3pc buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=es-imf83pcpfsd14m1799&ref=es_imf83pcnewlaunchpfsd14m<?php echo $refStr;?>&refs=es_purchase_imf"
           onclick="ga('send', 'event', 'imfbuy', 'buy', 'imf3pcnewlaunch-es')">
          <i></i> <span>Comprar ahora</span>
        </a>
        <p class="bought">
...
<div class="bg">
    ...
    <div class="wrapper clearfix">
      ...
      <div class="right-lists">
        <ul>
          ...
          <li class="icon2">Añade una nueva capa de protección además del motor anti-ransomware para proteger múltiples archivos y carpetas de los atacantes.
          </li>
  ...
  <div class="gift-message">
    <div class="wrapper clearfix">
      <img class="img-box" src="<?php echo getStaticUrl('images/imf-center-box.png')?>" alt=""/>
      <div class="right-message clearfix">
        ...
        <div class="box">
          ...
          <h3><i></i>IObit Malware Fighter 8 PRO (Extra 2 meses)</h3>
...
<div class="between-buy">
  <div class="wrapper">
    <p class="price"><strong>17,99€ </strong> <del>149,89€</del></p>
    <!-- 3pc buybtn -->
    <a href="https://www.iobit.com/buy.php?product=es-imf83pcpfsd14m1799&ref=es_imf83pcnewlaunchpfsd14m<?php echo $refStr;?>&refs=es_purchase_imf"
           onclick="ga('send', 'event', 'imfbuy', 'buy', 'imf3pcnewlaunch-es')" class="buybtn">
      <i></i>
  ...
  <table border="0" cellspacing="0" cellpadding="0" width="100%">
    ...
    <tr>
      ...
      <th class="itemb">
        ...
        <del> 39,95€</del>
        <!-- 1pc buybtn -->
        <a href="https://www.iobit.com/buy.php?product=es-imf81pc1699&ref=es_imf81pcnewlaunch<?php echo $refStr;?>&refs=es_purchase_imf"
           onclick="ga('send', 'event', 'imfbuy', 'buy', 'imf1pcnewlaunch-es')"
           class="buybtn">
          Comprar ahora
        </a>
