  ...
  <div class="wrapper">
    ...
    <div class="banner-buy clearfix">
      ...
      <div class="banner-1pc buy-box fl">
        ...
        <a class="buy-btn" href="https://www.iobit.com/buy.php?product=dk-imf71pc189&ref=dk_imf71pcpurchase1901b<?php echo $refStr;?>&refs=dk_purchase_imf"
           onclick="ga ('send', 'event', 'imfbuy', 'buy', imfpurchase1903-dk')">Køb nu</a>
      </div>​
      <div class="banner-3pc buy-box fl">
        ...
        <a class="buy-btn" href="https://www.iobit.com/buy.php?product=dk-imf73pc199&ref=dk_imf73pcpurchase1901b<?php echo $refStr;?>&refs=dk_purchase_imf"
           onclick="ga ('send', 'event', 'imfbuy', 'buy', imfpurchase1903-dk')">Køb nu</a>
      </div>
    </div>
  </div>
  ...
  <div class="comparison" id="compare">
    <table border="0" cellspacing="0" cellpadding="0" width="100%">
      ...
      <tr>
        ...
        <td class="virtue">Anti-malware med den seneste IObit malware database <sup>forbedret</sup></td>
        <td class="space"></td>
      ...
      <tr>
        ...
        <td class="virtue">Opdager trusler, som gemmer sig i din pc hurtigt <sup>forbedret</sup></td>
        <td class="space"></td>
        <td class="itemb gray"><i class="all-icons">√</i></td>
        <td class="space"></td>
        <td class="itema"><i class="all-icons star">√</i></td>
      ...
      <tr>
        ...
        <td class="virtue">Opdager 203,000,000+ trusler med Bitdefender og IObit <sup>forbedret</sup></td>
        <td class="space"></td>
        <td class="itemb"></td>
        <td class="space"></td>
        <td class="itema"><i class="all-icons star">√</i></td>
      ...
      <tr>
        ...
        <td class="virtue">Stopper ransomware fra at forsøge at kryptere dine vigtige filer <sup class="ny">ny</sup></td>
        <td class="space"></td>
        <td class="itemb"></td>
        <td class="space"></td>
        <td class="itema"><i class="all-icons star">√</i></td>
      ...
      <tr>
        ...
        <td class="virtue">Ingen kan få adgang til dine personlige data uden kodeord <sup>forbedret</sup></td>
        <td class="space"></td>
        <td class="itemb"></td>
        <td class="space"></td>
        <td class="itema"><i class="all-icons star">√</i></td>
...
<div class="floatlayer" id="floatlayer">
  <div class="wrapper clearfix">
    <div class="floatlayer-left fl">
      ...
      <ul>
        <li data-url="https://www.iobit.com/buy.php?product=dk-imf71pc189&ref=dk_imf71pcpurchase1901b<?php echo $refStr;?>&refs=dk_purchase_imf">
          <span class="name"><i></i>1 år, 1 pc</span>
          <span><strong>kr. 189</strong>&nbsp;&nbsp;<del>kr. 379</del></span>
        </li>
        <li class="active" data-url="https://www.iobit.com/buy.php?product=dk-imf73pc199&ref=dk_imf73pcpurchase1901b<?php echo $refStr;?>&refs=dk_purchase_imf">
    ...
    <div class="floatlayer-right fl">
      <em class="">Spar kr. 380</em>
      <a class="buy-btn"
         href="https://www.iobit.com/buy.php?product=dk-imf73pc199&ref=dk_imf73pcpurchase1901b<?php echo $refStr;?>&refs=dk_purchase_imf"
         onclick="ga ('send', 'event', 'imfbuy', 'buy', imfpurchase1903-dk')">Køb nu</a>
    </div>
  </div>
</div>
