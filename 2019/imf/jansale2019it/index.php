...
$name=explode(' ',trim(get_line('data/names_jan.txt',rand(1,69))));
    ...
    <div class="content clearfix">
      ...
      <div class="box smallbox fl">
        ...
        <a class="buybtn small"
           href="http://www.iobit.com/buy.php?product=it-imf61pc1899&ref=it_imf61pc1899purchase1901<?php echo $refStr;?>&refs=it_purchase_imf"
           onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase1PC1901a-it')">
          ACQUISTA SUBITO
        </a>
      </div>
      ...
      <div class="box largebox fl">
        ...
        <!-- 3pc+pf buybtn -->
        <a class="buybtn"
           href="http://www.iobit.com/buy.php?product=it-imf63pcpf1999&ref=it_imf63pcpf1999purchase1901<?php echo $refStr;?>&refs=it_purchase_imf"
           onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase3PCpf1901c-it')">
      ...
      <div class="box smallbox fr">
        ...
        <!-- price -->
        <p class="price"><del>€59.95</del> €19.99</p>
        <!-- 3pc buybtn -->
        <a class="buybtn small"
           href="http://www.iobit.com/buy.php?product=it-imf63pc1999&ref=it_imf63pc1999purchase1901<?php echo $refStr;?>&refs=it_purchase_imf"
           onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase3PC1901b-it')">
          ACQUISTA SUBITO
        </a>
      </div>
    </div>
...
<div class="feature wrapper clearfix">
  <!-- title -->
  <h2>Il tuo computer ha bisogno della protezione di IObit Malware Fighter Pro</h2>
  <!-- list -->
  <ul>
    <!-- 01 -->
    <li>
      <dl class="clearfix">
        ...
        <dd>
          ...
          <p>
            Blocca e rimuove automaticamente oltre 200 milioni di minacce in <br>
            tempo reale e cancella i dati di tracciamento.
          </p>
        </dd>
      </dl>
    </li>
    ...
    <li>
      <dl class="clearfix">
        ...
        <dd>
          ...
          <p>
            La Cassetta di Sicurezza protegge separatamente i tuoi file per <br>
            renderli irraggiungibili agli hacker.
          </p>
        </dd>
      </dl>
    </li>
    ...
    <li>
      <dl class="clearfix">
        ...
        <dd>
          <h3>Antivirus e Anti-malware</h3>
          <p>
            Raddoppiata protezione offerta dal motore antivirus Advanced <br>
            Bitdefender e dal motore IObit Anti-malware.
          </p>
        </dd>
      </dl>
    </li>
    ...
    <li>
      <dl class="clearfix">
        ...
        <dd>
          <h3>Nessun Attacco Ransomeware</h3>
          <p>
    ...
    <div class="content clearfix">
      ...
      <ul class="fl clearfix">
        ...
        <li class="imf3pcpf active"
            data-url="http://www.iobit.com/buy.php?product=it-imf63pcpf1999&ref=it_imf63pcpf1999purchase1901<?php echo $refStr;?>&refs=it_purchase_imf"
            data-ga="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase3PCpf1901c-it')"
            data-price="19"
            data-del="€99.99"
            data-off="€80">
          1 Anno / 3 PC+PF
        ...
        <!-- 3pc -->
        <li class="imf3pc"
            data-url="http://www.iobit.com/buy.php?product=it-imf63pc1999&ref=it_imf63pc1999purchase1901<?php echo $refStr;?>&refs=it_purchase_imf"
            data-ga="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase3PC1901b-it')"
            data-price="19"
            data-del="€59.95"
            data-off="€39.96">
          1 Anno / 3 PC
        ...
        <!-- 1pc -->
        <li class="imf1pc"
            data-url="http://www.iobit.com/buy.php?product=it-imf61pc1899&ref=it_imf61pc1899purchase1901<?php echo $refStr;?>&refs=it_purchase_imf"
            data-ga="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase1PC1901a-it')"
            data-price="18"
            data-del="€39.95"
            data-off="€20.96">
          1 Anno / 1 PC
