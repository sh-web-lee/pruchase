...
<head>
  ...
  <title>88% de descuento de Navidad para IObit Malware Fighter PRO – IObit</title>
...
<div class="container">
  ...
  <div class="spree wrapper">
    <div class="spree-box">
      ...
      <a class="spree-buy"
         href="https://www.iobit.com/buy.php?product=es-imf73pcpfsdamc1999&ref=es_imf73pcpfsdamc1999purchase1911<?php echo $refStr;?>&refs=es_purchase_imf"
...
<div class="main wrapper">
  ...
  <div class="banner">
    ...
    <!-- title -->
    <h1>VENTA FLASH - NAVIDAD ESPECIAL</h1>
    <!-- subtitle -->
    <p>La mejor oferta en todo el año, ¡Descuendo hasta <span>88%</span> y tres regalos gratis!</p>
    <!-- panel -->
    <div class="panel clearfix">
      ...
      <div class="message small fl">
        ...
        <dl>
          ...
          <dd>
            <a class="buybtn"
               href="https://www.iobit.com/buy.php?product=es-imf71pc1799&ref=es_imf71pc1799purchase1911xr<?php echo $refStr;?>&refs=es_purchase_imf"
               onclick="ga('send', 'event', 'imfbuy', 'buy', 'imf1pcpurchase1911xr-es')"
               data-num="2">
      ...
      <div class="message large fl">
        ...
        <dl>
          ...
          <dd class="two">
            <p class="price red"><b>17</b> <del>149,88€</del></p>
          </dd>
          <dd>
            <a class="buybtn large"
               href="https://www.iobit.com/buy.php?product=es-imf73pcpfsdamc1799&ref=es_imf73pcpfsdamc1799purchase1911xr<?php echo $refStr;?>&refs=es_purchase_imf"
               onclick="ga('send', 'event', 'imfbuy', 'buy', 'imf3pcpfsdamcpurchase1911xr-es')"
               data-num="0">
              <i class="all-icons"></i> COMPRAR AHORA
            </a>
      ...
      <div class="message small fr">
        ...
        <dl>
          ...
          <dd>
            <a class="buybtn"
               href="https://www.iobit.com/buy.php?product=es-imf73pc1999&ref=es_imf73pc1999purchase1911xr<?php echo $refStr;?>&refs=es_purchase_imf"
               onclick="ga('send', 'event', 'imfbuy', 'buy', 'imf3pcpurchase1911xr-es')"
               data-num="1">
              <i class="all-icons"></i> COMPRAR AHORA
            </a>
          </dd>
  ...
  <div class="gifts">
    <!-- title -->
    <h2 class="on">SOLO PARA NAVIDAD, ¡PAGA UN PRECIO CON DESCUENTO Y OBTÉN TRES REGALOS! *</h2>
    <!-- dl -->
  ...
  <div class="comparison">
    ...
    <!-- subtitle -->
    <h3>Compra IObit Malware Fighter PRO con <span>88%</span> de descuento para protección completa a tu PC</h3>
    <!-- imf-85 buybtn -->
    <a class="buybtn red"
       href="https://www.iobit.com/buy.php?product=es-imf73pcpfsdamc1999&ref=es_imf73pcpfsdamc1999purchase1911<?php echo $refStr;?>&refs=es_purchase_imf"
       onclick="ga('send', 'event', 'imfbuy', 'buy', 'imf3pcpfsdamcpurchase1911-es')">
  ...
  <div class="bottom-buy clearfix">
    <!-- title -->
    <h2 class="on">!Aprovecha la oportunidad solo una vez al año de la oferta exclusiva de Navidad!</h2>
    <!-- box -->
    <div class="box fl">
    ...
    <dl class="fr">
      <dd>
        <p class="price"><b>17</b> <del>149,88€</del></p>
      </dd>
      <dd>
