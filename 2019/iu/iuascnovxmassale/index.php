...
<div class="banner">
  ...
  <div class="wrapper">
    ...
    <h1 class="title">IObit's 15th Anniversary</h1>
...
<div class="product">
  ...
  <div class="wrapper">
    <dl class="left">
      <dt><img src="<?php echo getStaticUrl('images/product-sale.png')?>" alt=""><strong>What you can get by activating ASC PRO</strong></dt>
