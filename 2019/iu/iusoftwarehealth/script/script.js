...
function soldOut() {
	...
	$(".price b").html("16")
	$(".buybtn").not('.buybtn-pop').attr("href", "https://www.iobit.com/buy.php?product=iu93pc1677&ref=iu9softwarehealthsold1677" + refStr + "&aff=" + aff + "&refs=purchase_iu&tw=" + tw);
	$(".buybtn").not('.buybtn-pop').attr("onclick", "ga('send', 'event', 'iu3pcsoldbuy', 'buy', 'iupurchase-softwarehealth');");
	$(".countdown").removeClass("twinkle");
}
...
function packsInit() {
	var date = new Date();
	var cName = "eniusoft" + date.getDate();
