...
<head>
  ...
  <title>Hasta 77% de descuento y regalos exclusivos sólo para nuevos miembros de IObit Uninstaller PRO – IObit</title>
...
<div class="banner">
  <div class="wrapper clearfix">
    ...
    <!-- title -->
    <h1>Regalos de bienvenida para nuevos miembros</h1>
    <h2>Buena suerte para ti con mejor descuento</h2>
    <div class="box">
      <img src="<?php echo getStaticUrl('images/three-box.png')?>" alt="" class="img-box">
      <div class="message">
        <h3><strong>05</strong>H : <strong>05</strong>MIN : <strong>05</strong>S : <strong>005</strong>MS*</h3>
        <h4>IObit Uninstaller 10 PRO (3 PCs) + <span>Regalos Gratis</span></h4>
        <p><strong>15,99€</strong> <del>69,94€</del></p>
        <a href="https://www.iobit.com/buy.php?product=es-iu103pc14mpf1599&ref=es_iu103pcnewinstallpackage2008<?php echo $refStr;?>&refs=es_purchase_iu"
           onclick="ga('send', 'event', 'iubuy', 'buy', 'iu3pcnewinstall-es')"
           class="buybtn">
          Comprar ahora
        </a>
      </div>
    ...
    <div class="box one-box">
      ...
      <div class="message">
        <h4>IObit Uninstaller 10 PRO (1 PC)</h4>
        <p><strong>12,99€</strong> <del>19,99€</del></p>
        <a href="https://www.iobit.com/buy.php?product=es-iu101pc1299&ref=es_iu101pcnewinstall2008<?php echo $refStr;?>&refs=es_purchase_iu"
           onclick="ga('send', 'event', 'iubuy', 'buy', 'iu1pcnewinstall-es')"
           class="buybtn">
          Comprar ahora
        </a>
      </div>
  ...
  <div class="wrapper clearfix">
    ...
    <dl class="list04">
      ...
      <dd class="fl">
        ...
        <p>
          Identifica complementos maliciosos y basados<br> en anuncios y elimina las notificaciones<br> del navegador para garantizar una<br> experiencia de navegación segura y limpia.
        </p>
      </dd>
    </dl>
    <!-- clear float -->
...
<div class="betweenbuy clearfix">
  <!-- title -->
  <h2>Regalos gratis sólo para la oferta de 3PCs / 1año</h2>
  <div class="wrapper">
    <div class="clearfix">
      <!-- PF box -->
      <dl>
        ...
        <dd>
          ...
          <p class="rate"> <strong> 0<b>€</b></strong></p>
          <p class="des">
            Archivos y datos más seguros con una contraseña
          </p>
          <p class="des">
            El modo de protección de privacidad mejorado
          </p>
        </dd>
      </dl>
      <!-- IU9 box -->
      <dl>
        <dt><img src="<?php echo getStaticUrl('images/extra-box.png')?>" alt=""></dt>
        <dd>
          <h3>IObit Uninstaller 10 PRO <small>(Extra 2 meses)</small></h3>
          <p class="rate"> <strong> 0<b>€</b></strong></p>
          <p class="des">
            El regalo de bienvenida para nuestros nuevos <br> miembros.
          </p>
        </dd>
      </dl>
    </div>
    <!-- buybtn -->
    <a class="buybtn"
       href="https://www.iobit.com/buy.php?product=es-iu103pc14mpf1599&ref=es_iu103pcnewinstallpackage2008<?php echo $refStr;?>&refs=es_purchase_iu"
       onclick="ga('send', 'event', 'iubuy', 'buy', 'iu3pcnewinstall-es')">
...
<div class="bottombuy">
  <div class="wrapper">
    ...
    <ul>
      <li class="active"><span>1 año / 3 PCs + <b>regalos GRATIS</b> </span> <strong>-77%</strong></li>
