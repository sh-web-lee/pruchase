...
function soldOut() {
	...
	$(".buybtn").attr({
		"href": 'https://www.iobit.com/buy.php?product=it-iu9preorder1599&ref=it_iu9preorder1599official' + refStr + '&aff=' + aff + '&refs=it_purchase_iu',
		"onclick": "ga('send', 'event', 'iu3pcbuy', 'buy', 'iu9predorderex-it');"
	});
}
// soldOut();
