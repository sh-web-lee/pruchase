...
function soldOut() {
	...
	$(".buybtn").attr({
		"href": 'https://www.iobit.com/buy.php?product=nl-iu9preorder1699&ref=nl_iu9preorder1699rc' + refStr + '&aff=' + aff + '&refs=nl_purchase_iu&tw=' + tw,
		"onclick": "ga('send', 'event', 'iu3pcbuy', 'buy', 'iu9preorderrcsoldout-nl');"
	});
}
// soldOut();
