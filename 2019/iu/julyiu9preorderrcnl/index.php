...
if ($_GET['action'] == 'getPacks') {
	$date = $_GET['d'];
	$c_name = 'nliurcjune_p' . $date;
	$c_name_t='nliurcjune_t' . $date;
...
<body>
				...
				<div class="right fr">
					...
					<?php else:?>
          			<p class="data">
            			...
            			Verwijder <strong><?php echo intval($transData->softwarehealth->plugin);?></strong> schadelijke plug-in(s) in één klik<br>
						<?php endif;?>
						<?php if(intval($transData->softwarehealth->software)>0):?>
            			<?php echo (intval($transData->softwarehealth->plugin)>0)?'en':'';?> update <strong><?php echo intval($transData->softwarehealth->software);?></strong> verouderde software op uw pc
						<?php endif;?>
          			</p>
					<?php endif;?>
					<ul class="price clearfix">
						...
						<li>
							<a class="buybtn"
							   href="https://www.iobit.com/buy.php?product=nl-iu9preorder1499&ref=nl_iu9preorder1499rc<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=nl_purchase_iu"
							   onclick="ga('send', 'event', 'iubuy', 'buy', 'iu9predorderrc-nl');">
							  Profiteer Nu
							</a>
						</li>
					</ul>
	...
	<!-- banner end -->
		...
		<!-- intro start -->
		<div class="intro">
	    <h2>Waarom upgraden naar PRO?</h2>
	    <!-- content -->
	    <div class="content">
	      <div class="wrapper">
	        <ul class="clearfix">
	          ...
	          <div class="inlist">
	            <div class="indetail first clearfix">
	              ...
	              <dl class="fr">
	                ...
	                <dd>
	                	Gebundelde programma’s die meekomen met freeware en adverteren of gegevens stelen <em>alleen bij IObit</em>
	                </dd>
	                <dd>
	                  Schadelijke en reclamemakende plug-ins die advertenties of schadelijke links in webpagina’s toevoegen <em>alleen bij IObit</em>
	                </dd>
	              </dl>
	            ...
	            <div class="indetail last clearfix">
	              ...
	              <dl class="fr">
	                ...
	                <dd>
	                  <h4>Scant</h4>
	                  Restanten van programma’s die eerder zonder IObit Uninstaller zijn gedeïnstalleerd. <em>alleen bij IObit</em>
	                </dd>
	              </dl>
	              <img class="face" src="<?php echo getStaticUrl('images/face.png')?>" alt="">
	            </div>
