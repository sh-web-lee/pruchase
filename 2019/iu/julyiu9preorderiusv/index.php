	...
	<div class="banner">
      ...
      <!-- title -->
        ...
        <!-- right-message -->
              ...
              <!-- buybtn -->
							<a class="buybtn"
							   href="https://www.iobit.com/buy.php?product=sv-iu9preorder&ref=sv_iu9preorderiu<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=sv_purchase_iu"
							   onclick="ga('send', 'event', 'iubuy', 'buy', 'iu9predorderiu-sv');">
                Förbeställ Nu
							</a>
						</li>
					</ul>
          ...
          <div class="inlist">
            <div class="indetail first clearfix">
              ...
              <dl class="fr">
                <dt>
                  ...
                  <h4>Avinstallera <i>FÖRBÄTTRAD</i></h4>
                </dt>
                <dd>
                  Program, browser extensions och <br>
                  Windows-appar.
                ...
                <dd>
                  ...
                  <em class="space">unik på marknaden</em>
                </dd>
                <dd>
            ...
            <div class="indetail last clearfix">
              ...
              <dl class="fr">
                ...
                <dd>
                  <h4>Ta bort <i>FÖRBÄTTRAD</i></h4>
                  15% flera restfiler och register efter <br>
                  avinstallation.
                </dd>
                <dd>
                  <h4>Upptäck <i class="new">Ny</i></h4>
                  systemändringar gjorda av ett program <br>
                  och återställ dem efter avinstallation <br>
                  av programmet.
                </dd>
                <dd>
                  <h4>Sök <i class="new">Ny</i></h4>
                  Kvarvarande filer av avinstallerade program <br>
                  som tidigare avinstallerats utan IObit Uninstaller. <br>
                  <em class="space">unik på marknaden</em>
                </dd>
              </dl>
              <img class="face" src="<?php echo getStaticUrl('images/face.png')?>" alt="">
