...
<title>Ekskluzywna oferta, zniżki do 45% na oferty specjalne IObit Uninstaller PRO - IObit 2019</title>
...
<body>  
  ...
  <div class="banner">
    <div class="wrapper">
      ...
      <h1>WYŁĄCZNA OFERTA DLA CIEBIE!</h1>
        ...
        <div class="list left">
          ...
          <div class="price">
            ...
            <a class="buybtn small"
               href="https://www.iobit.com/buy.php?product=pl-iu91pc59&ref=pl_iu91pc59purchase1906<?php echo $refStr;?>&refs=pl_purchase_asc"
               onclick="ga('send', 'event', 'iubuy', 'buy', 'iupurchase1PC1906-pl')">
              <i class="all-icons"></i>
              <big>KUP TERAZ</big>  
            </a>
          </div>
        ...
        <div class="list right">
          ...
          <div class="price">
            <p>
              ...
              <b>
                <span>Zaoszczędź <font class="discount">324,80 zł</font></span>
                <small>,90 zł <del class="original">389,70 zł</del></small>
              </b>
            </p>
            <a class="buybtn"
               href="https://www.iobit.com/buy.php?product=pl-iu93pcsdpf64&ref=pl_iu93pcsdpf64purchase1906<?php echo $refStr;?>&refs=pl_purchase_asc"
  ...
  <div class="benfits wrapper clearfix">
    <h2>Ciesz się potężną deinstalacją, aby szybciej i bezpieczniej przeglądać Internet!</h2>
    <div class="snapshoot">
    ...
    <div class="benfits-list clearfix">
      <div class="list fl">
        ...
        <dl>
          <dt><b>NOWOŚĆ!</b> Monitorowanie instalacji</dt>
          <dd>Automatyczne przywracanie zmian w systemie dokonanych po dezinstalacji niechcianego programu.</dd>
        </dl>
      </div>
  ...
  <div class="complimentary">
    <div class="wrapper">
      ...
      <a class="buybtn yellow"
         ...
         onclick="ga('send', 'event', 'iubuy', 'buy', 'iupurchase3PC1906-pl');">
        <i class="all-icons"></i>
        <big>Zdobądź prezent już teraz!</big>
      </a>
      <!-- countdown -->
      <p class="countdown countdown2"><b>05</b> Godz <b>25</b> min <b>47</b> sek <b>241</b> ms*</p>
    </div>
  </div>
  <!-- complimentary end -->
  ...
  <div class="comparison wrapper" id="compare">
    <table border="0" cellspacing="0" cellpadding="0" width="100%">
      <thead>
        <tr>
          <th class="text" colspan="2">Jakie masz korzyści jako użytkownik PRO?</th>
      ...
      <tbody>
        <tr>
          ...
          <td class="virtue">
            <b>Odinstalowuje programy bezpośrednio z ikony na pulpicie, w otwartym oknie lub z nowej ikony paska zadań</b>
        ...
        <tr>
          ...
          <td class="virtue">Obsługuje usuwanie upartych programów <span class="two">Migliorato</span></td>
          <td class="itemb"><i class="all-icons circle">√</i></td>
          <td class="itema"><i class="all-icons red">√</i></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td class="virtue"><b>Aktualizuje wszystkie ważne oprogramowania jednym kliknięciem </b> <span class="two five">Migliorato</span></td>
          <td class="itemb"><i class="all-icons circle">√</i></td>
          <td class="itema"><i class="all-icons red">√</i></td>
        </tr>
        <tr>
      ...
      <div class="panel clearfix">
        ...
        <ul class="fl">
          <li class="active anno" data-num="1">
            <h3>1 rok / 3 PC + Darmowy prezent</h3>
          </li>
          <li data-num="0"><h3>1 rok / 1 PC </h3></li>
        </ul>
        <div class="price fr">
          <p>
            <strong class="sale">64</strong>
            <b>
              <span>Zaoszczędź <font class="discount">324,80 zł</font></span>
              <small>,90 zł <del class="original">349,80 zł</del></small>
            </b>
          </p>
          <a class="buybtn"
             href="https://www.iobit.com/buy.php?product=pl-iu93pcsdpf64&ref=pl_iu93pcsdpf64purchase1906<?php echo $refStr;?>&refs=pl_purchase_asc"
