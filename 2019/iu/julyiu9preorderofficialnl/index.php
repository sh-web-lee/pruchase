	...
	<div class="intro">
		<div class="wrapper">
			...
			<div class="one clearfix">
				...
				<div class="right fr">
					<h3><b>Snelle Deïnstallatie</b></h3>
					<dl>
			...
			<div class="two clearfix">
				<div class="right fl">
					...
					<dl class="safe">
						...
						<dd>
							Verwijdert alle overgebleven bestanden, mappen en register items na deïnstallatie van een programma.
						</dd>
					</dl>
					<dl>
			...
			<div class="clearfix">
				...
				<div class="right fr">
					<ul class="feature-list">
						...
						<li><i class="all-icons">√</i> Verwijder restanten automatisch na deïnstallatie<sup>VERBETERD</sup></li>
						<li><i class="all-icons">√</i> Verwijder restanten van reeds verwijderde programma’s <sup class="green"> NIEUW</sup></li>
						<li><i class="all-icons">√</i> Maak automatisch een herstelpunt aan voor deïnstallatie</li>
						<li><i class="all-icons">√</i> Update alle verouderde programma’s in één klik</li>
