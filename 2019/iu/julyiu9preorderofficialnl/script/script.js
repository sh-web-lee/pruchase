...
function soldOut() {
	...
	$(".buybtn").attr({
		"href": 'http://www.iobit.com/buy.php?product=nl-iu9preorder1699&ref=nl_iu9preorder1699official'+refStr+'&aff=' + aff + '&refs=nl_purchase_iu&tw=' + tw,
		"onclick": "ga('send', 'event', 'iubuy', 'buy', 'iu9preorderofficialsoldout-nl');"
	});
}
// soldOut();
