...
<head>
  ...
  <title>Offerta speciale - Sconti fino all’80% su IObit Uninstaller PRO</title>
...
<div class="banner">
  <div class="wrapper">
    ...
    <!-- title -->
    <h1>
      REGALO DI BENVENUTO PER I NUOVI UTENTI
      <span>Tempo limitato, non farti scappare neanche un minuto!</span>
    </h1>
    <!-- product-message -->
    <ul class="message">
      <!-- 3pc -->
      <li class="prev">
        ...
        <!-- box -->
        <div class="box">IObit Uninstaller PRO 10</div>
        <!-- price -->
        <p class="price"><strong>15</strong> <sup>99€</sup> <del>39,99€</del></p>
        <!-- buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=it-iu103pc1599&ref=it_iu103pcpurchase1904new<?php echo $refStr;?>&refs=it_purchase_iu"
           onclick="ga('send', 'event', 'iubuy', 'buy', 'iupurchase1PC1907new-it')">
          ACQUISTA ORA
        </a>
      </li>
      <!-- 3pc+gifts -->
      <li class="last">
        ...
        <!-- box -->
        <div class="box">IObit Uninstaller PRO 10 + Smart Defrag PRO 6 + Protected Folder</div>
        <!-- price -->
        <p class="price small"><strong>15</strong> <sup>99€</sup> <del>117,92€</del></p>
        <!-- buybtn -->
        <a class="buybtn yellow"
           href="https://www.iobit.com/buy.php?product=it-iu1014msdpf1599&ref=it_iu103pcsdpfpurchase1904new<?php echo $refStr;?>&refs=it_purchase_iu"
           onclick="ga('send', 'event', 'iubuy', 'buy', 'iupurchase3PCsdpf1907new-it')">
          APPROFITTANE ORA
        </a>
      </li>
    </ul>
...
<div class="intro wrapper">
  <h2>Goditi una disinstallazione potente per una navigazione più sicura e veloce!</h2>
  <div class="showcase">
    <div class="imglist">
      <ul>
        <li class="shot2"><img src="<?php echo getStaticUrl('images/screenshot01.png')?>" alt=""></li>
        <li class="shot1"><img src="<?php echo getStaticUrl('images/screenshot02.png')?>" alt=""></li>
  ...
  <div class="features clearfix">
    <dl>
      ...
      <dd>
        ...
        <p>
          Rileva le modifiche del sistema da un programma e le ripristina dopo aver disinstallato il programma.
        </p>
      </dd>
    </dl>
    <dl>
      ...
      <dd>
        ...
        <p>
          Rileva e disinstalla i plugin pubblicitari maligni che immettono annunci o link dannosi nelle pagine visualizzate.
        </p>
      </dd>
    </dl>
    <dl class="bot">
      ...
      <dd>
        ...
        <p>
          Pulisce automaticamente i dati inutili dei programmi disinstallati per un PC più pulito e veloce.
        </p>
      </dd>
    </dl>
    <dl class="udp bot">
      ...
      <dd>
        <h3><span class="green">MIGLIORATO!</span> Aggiornamento di Software Sicuro <img src="<?php echo $pResUrl;?>images/attention.png" alt="ATTENTION" style="margin-right: -60px;" /> </h3>
        <p>
          Con un solo clic, puoi aggiornare tutti i software importanti, incluso <b>WinRAR *, la cui falla di sicurezza potrebbe <br>
...
<div class="complimentary">
  <div class="wrapper">
    ...
    <div class="gift-list clearfix">
      ...
      <dl>
        <dt><img src="<?php echo $pResUrl;?>images/gift-iu.png" alt="Protected Folder"></dt>
        <dd>
          <h3>Extra 2 Mesi <strong>0€ </strong> <del>7,99€</del></h3>
          <ul>
            <li>Il programma di disinstallazione più efficace </li>
            <li>garantisce la disinstallazione completa </li>
            <li>del software e la rimozione degli avanzi.</li>
          </ul>
        </dd>
      </dl>
    </div>
  ...
  <table border="0" cellspacing="0" cellpadding="0" width="100%">
    ...
    <tr>
      ...
      <td class="virtue">
        ...
        <p>
          <span class="txt two">Disinstalla i programmi dall'icona sul desktop, dalla finestra aperta o dall'icona della barra delle applicazioni <span class="all-icons">Migliorato</span> </span>
        </p>
      </td>
    ...
    <tr>
      <td class="itemb"><i class="all-icons close">X</i></td>
      <td class="virtue" style="padding-left: 17px;">
        <img src="<?php echo $pResUrl;?>images/icons-12.png" alt="" style="margin-right:8px;">
        <p>
          <span class="txt two">Ripristina automaticamente le modifiche che un programma ha apportato al sistema dopo averlo disinstallato. <span class="all-icons nuo">Nuovo</span></span>
        </p>
      </td>
      <td class="itema"><i class="all-icons red">√</i></td>
    </tr>
...
<div class="bottombuy">
  <div class="wrapper clearfix">
    ...
    <div class="middle fl">
      <ul class="select">
        <li class="active"
            data-url="https://www.iobit.com/buy.php?product=it-iu1014msdpf1599&ref=it_iu103pcsdpfpurchase1904new<?php echo $refStr;?>&refs=it_purchase_iu"
            data-ga="ga('send', 'event', 'iubuy', 'buy', 'iupurchase3PCsdpf1907new-it')"
            data-del="117,92€">
          <i></i>
        ...
        <li class="second"
            data-url="https://www.iobit.com/buy.php?product=it-iu103pc1599&ref=it_iu103pcpurchase1904new<?php echo $refStr;?>&refs=it_purchase_iu"
            data-ga="ga('send', 'event', 'iubuy', 'buy', 'iupurchase1PC1907new-it')"
            data-del="39,99€">
          <i></i>
          1 Anno / 3 PC
          <span>-60%</span>
    ...
    <div class="fr another">
      <p class="price"><strong>15</strong> <sup>99€</sup> <del>117,92€</del></p>
      <a class="buybtn yellow"
         href="https://www.iobit.com/buy.php?product=it-iu1014msdpf1599&ref=it_iu103pcsdpfpurchase1904new<?php echo $refStr;?>&refs=it_purchase_iu"
         onclick="ga('send', 'event', 'iubuy', 'buy', 'iupurchase3PCsdpf1907new-it')">
        APPROFITTANE ORA
