...
function soldOut() {
	...
	$(".buybtn").attr({
		"href": 'https://www.iobit.com/buy.php?product=iu9preorder1477&ref=iu9preorder1477official' + refStr + '&aff=' + aff + '&refs=purchase_iu',
		"onclick": "ga('send', 'event', 'iu3pcbuy', 'buy', 'iu9predorderofficial');"
	});
}
// soldOut();
