...
<body>
		...
		<div class="wrapper">
			...
			<div class="clearfix">
				...
				<div class="right-message fr">
					...
					<a href="http://www.iobit.com/buy.php?product=it-iu9preorder&ref=it_iu9preorderofficialitb<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=it_purchase_iu  "
					onclick="ga('send', 'event', 'iubuy', 'buy', 'iu9predorderofficialitb-it');" 
					class="buybtn"><strong>PROVA 1 MESE GRATIS </strong> (Valore €39,99)</a>
					<a href="http://www.iobit.com/buy.php?product=it-iu9preorder1599&ref=it_iu9preorder1599officialitb<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=it_purchase_iu"
					onclick="ga('send', 'event', 'iubuy', 'buy', 'iu9predorder1599officialitb-it');" 
	...
	<div class="bottom">
		...
		<div class="annotation">
			<dl class="wrapper">
				<dt>Note:</dt>
				<dd>*. Dopo il mese di valutazione gratuita, IObit Uninstaller 9 PRO è disponibile a €15,99 con lo sconto del 60% sul prezzo originale €29,99. Annullabile in qualsiasi momento <br> senza alcun addebito.</dd>
	...
	<div id="floatlayer" class="floatlayer">
		...
		<i class="close"></i>
		<a href="http://www.iobit.com/buy.php?product=it-iu9preorder&ref=it_iu9preorderofficialitb<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=it_purchase_iu"
			 onclick="ga('send', 'event', 'iubuy', 'buy', 'iu9predorderofficialitb-it');"class="buybtn"><strong>PROVA GRATIS ORA </strong></a>
		<a href="http://www.iobit.com/buy.php?product=it-iu9preorder1599&ref=it_iu9preorder1599officialitb<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=it_purchase_iu"
			 onclick="ga('send', 'event', 'iubuy', 'buy', 'iu9predorder1599officialitb-it');" class="buybtn white"><strong>ACQUISTA SUBITO</strong> -60%</a>
