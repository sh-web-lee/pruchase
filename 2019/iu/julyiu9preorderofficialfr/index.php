...
<body>
			...
			<div class="clearfix">
				...
				<div class="right fr">
					...
					<ul class="price clearfix">
						...
						<li>
							<a class="buybtn"
							   href="http://www.iobit.com/buy.php?product=fr-iu9preorder30day&ref=fr_iu9preorderofficial<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_iu"
							   onclick="ga('send', 'event', 'iubuy', 'buy', 'iu9predorderofficial-fr');">
                VITE, J’EN PROFITE
							</a>
						</li>
					</ul>
	...
	<div class="intro">
		<div class="wrapper">
			...
			<div class="one clearfix">
				...
				<div class="right fr">
					<h3><b>Désinstaller rapidement</b></h3>
					<dl>
						<dt><h4>Logiciels récalcitrants et bundleware <span><em>Unique sur le marché</em></span></h4></dt>
						<dd>
              Supprime totalement les programmes indésirables, persistants et bundlewares qui ne peuvent pas être désinstallés de manière normale.
						</dd>
					</dl>
					<dl>
						<dt><h4>Extensions malveillantes de navigateur <span><em>Unique sur le marché</em></span></h4></dt>
						<dd>
              Supprime les barres d’outils, les modules et les extensions indésirables de votre navigateur et vous indique ceux qui peuvent être laissés en sécurité sur votre PC.
						</dd>
					</dl>
					<dl>
						<dt><h4>Applications pré-installées sur Windows</h4></dt>
						<dd>Désinstalle les applications intégrées sous Windows 10 que vous ne souhaitez plus.</dd>
					</dl>
				</div>
			</div>
			<div class="two clearfix">
				<div class="right fl">
					<h3><b>Nettoyer en profondeur</b></h3>
					<dl class="safe">
						<dt><h4>Des données de programme inutiles</h4></dt>
						<dd>
              Nettoie tous les fichiers, dossiers et registres restants associés au programme après la désinstallation.
						</dd>
					</dl>
					<dl>
						<dt><h4>Résidus sur PC  <span><em>Unique sur le marché</em></span></h4></dt>
						<dd>
              Analyse et nettoie, en un clic, les résidus de programmes désinstallés qui ne peuvent pas être supprimés par d’autres programmes de désinstallation.
						</dd>
					</dl>
					<dl>
						<dt><h4>Modification du système causée par un programme </h4></dt>
						<dd>
              Détecte toutes les modifications approtées par un programme et supprime tous les fichiers que le programme a modifiés lors de son installation.
						</dd>
					</dl>
				</div>
				<div class="left fr">
	...
	<div class="feature">
		<div class="wrapper">
			<div class="iumouse"><div class="mouse"></div></div>
			<h2>QueIs avantages profiterez-vous d’IObit Uninstaller 9 PRO ?</h2>
			<div class="clearfix">
				<div class="left fl">
            ...
            <li class="clearfix"><i class="all-icons">√</i> <span>Réaliser des désinstallations par lots de programme et applications de Windows</span></li>
            <li class="clearfix"><i class="all-icons">√</i> <span>Détecter et supprimer bundleware</span></li>
            <li class="clearfix"><i class="all-icons">√</i> <span>Détecter et annuler les modifications du système effectuées par un programme d’installation <sup class="green">NOUVEAU</sup></span></li>
            <li class="clearfix"><i class="all-icons">√</i> <span>Supprimer les programmes persistants <sup>Amélioré</sup></span></li>
            <li class="clearfix"><i class="all-icons">√</i> <span class="nowrap">Détecter les extensions malveillantes et publicitaires <sup>Amélioré</sup></span></li>
            <li class="clearfix"><i class="all-icons">√</i> <span>Nettoyer automatiquement les résidus après la désinstallation standard <sup>Amélioré</sup></span></li>
            <li class="clearfix"><i class="all-icons">√</i> <span class="nowrap">Analyser les résidus de programmes déjà désinstallés <sup class="green">NOUVEAU</sup></span></li>
            <li class="clearfix"><i class="all-icons">√</i> <span class="nowrap">Créer automatiquement un point de restauration avant la désinstallation</span></li>
            <li class="clearfix"><i class="all-icons">√</i> <span>Mettre à jour tous les programmes obsolètes en un clic</span></li>
            <li class="clearfix"><i class="all-icons">√</i> <span class="nowrap">Mise à jour automatique une fois qu’une nouvelle version est disponible</span></li>
            <li class="clearfix"><i class="all-icons">√</i> <span>Assistance téléphonique 7j/7 et 24h/24</span></li>
					</ul>
					<ul class="price clearfix">
						<li class="first">
							<strong><sup>*</sup><big>0</big>€</strong> <del>29,99€</del>
