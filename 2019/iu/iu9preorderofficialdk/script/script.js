...
function soldOut() {
	...
	$(".banner .left, .floatlayer .imgbox").append('<span class="discount">60% RABAT</span>');
	setTimeout('$(".discount").addClass("on")', 300);
	$(".floatlayer").find(".one").html('<p>0 kr. i reservation er udsolgt, gå ikke <br> glip af dette tilbud igen!</p>');
	$(".feature .price li.first").find("p").remove();
	$(".price").find("strong").html("<big>159</big>kr.");
	$(".buybtn").attr({
		"href": 'https://www.iobit.com/buy.php?product=dk-iu9preorder159&ref=dk_iu9preorder159official'+refStr+'&aff=' + aff + '&refs=dk_purchase_iu&tw=' + tw,
		"onclick": "ga('send', 'event', 'iu3pcbuy', 'buy', 'iu9predorderofficialsoldout-dk');"
	});
}
// soldOut();
