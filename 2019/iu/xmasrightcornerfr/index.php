...
<div class="banner">
  ...
  <div class="wrapper">
    ...
    <!-- title -->
    <h1>Vente Flash – DE NOËL 85% d’économie </h1>
    <div class="box">
      <dl>
      ...
      <a href="https://www.iobit.com/buy.php?product=fr-iu93pc1599&ref=fr_iu93pcpurchaserightcor<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=fr_purchase_iu" onclick="ga('send', 'event', 'iubuy', 'buy', 'iupurchase1912single-fr')" class="buybtn small">VITE, J’EN PROFITE</a>
    </div>
    <div class="box gift-box">
      ...
      <a href="https://www.iobit.com/buy.php?product=fr-iu93pcsm8pf1499&ref=fr_iu93pcsm8pf1599purchaserightcor<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=fr_purchase_iu" onclick="ga('send', 'event', 'iubuy', 'buy', 'iupurchase1912-fr')" class="buybtn">VITE, J’EN PROFITE</a>
  ...
  <div class="gift-content wrapper clearfix">
    ...
    <dl>
      ...
      <dd>
        ...
        <p>Retour au menu Démarrer classique en 1 clic</p>
        <p>Recherche de fichiers rapide et puissante</p>
      </dd>
    </dl>
    <dl>
    ...
    <div class="betwwen-buy">
      <div class="content">
        ...
        <dl>
          ...
          <dd><a href="https://www.iobit.com/buy.php?product=fr-iu93pcsm8pf1499&ref=fr_iu93pcsm8pf1599purchaserightcor<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=fr_purchase_iu" onclick="ga('send', 'event', 'iubuy', 'buy', 'iupurchase1912-fr')" class="buybtn red">J’en Profite   <span>– 85% d’économie</span></a></dd>
  ...
  <div class="wrapper">
    <div class="content">
      ...
      <ul>
        ...
        <li class="active"><i></i> <strong>1 AN / 3 PC <b> + 2 Outils PRO</b></strong> <span>14</span>,99€</li>
      </ul>
      <dl>
        <dt><span>85%</span> de remise</dt>
        <dd><a href="https://www.iobit.com/buy.php?product=fr-iu93pcsm8pf1499&ref=fr_iu93pcsm8pf1599purchaserightcor<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=fr_purchase_iu" onclick="ga('send', 'event', 'iubuy', 'buy', 'iupurchase1912-fr')" class="buybtn">VITE, J’EN PROFITE</a></dd>
        <dd class="last">Quantité limitée</dd>
      </dl>
    </div>
  </div>
