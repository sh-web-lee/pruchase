...
function soldOut() {
	...
	$(".number p").html(" Free Gifts Have Sold Out. <p class='zoomout'> Free Gifts Have Sold Out.</p>");
	$(".buybtn").not("#fl-buybtn").html("<p>Activate Now & Save 70%</p>");
	$(".price del").text("$59.93");
	$(".gifts-box").hide();
	// soldOut buybtn
	$(".buybtn").not("#fl-buybtn").attr("href", "https://www.iobit.com/buy.php?product=iu113pc1677&ref=en-iu3pcsoldoutupdater" + refStr + "&aff=" + aff + "&refs=purchase_iu&tw=" + tw);
	$(".buybtn").not("#fl-buybtn").attr("onclick", "ga('send', 'event', 'iubuy-updaterb', 'buy', 'iupurchase-updaterb03sold');");
	$(".countdown").removeClass("twinkle");
	$(".gifts").hide();
	//soldOut pop
	if (maskTime != -1) {
		$(".pop-over").addClass("soldout");
		$(".pop-over dl dd p del").text("$59.93");
		$(".pop-over .imgbox").attr("src", soldoutPopBox);
		$(".pop-over .buybtn").html("Get My Special Offer").attr({
			"href": "https://www.iobit.com/buy.php?product=iu113pc1477&ref=en-iu3pcsdpf1477popupdater" + refStr + "&aff=" + aff + "&refs=purchase_iu&tw=" + tw,
			"onclick": "ga('send', 'event', 'iubuy-pop', 'buy', 'iupurchase-updaterb03soldpop');"
		})
	}
}
