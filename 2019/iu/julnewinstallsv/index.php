...
<head>
  ...
  <title>Välkomstgåva till våra nya medlemmar - IObit Uninstaller PRO</title>
...
<div class="banner">
  <div class="wrapper clearfix">
    ...
    <!-- title -->
    <div class="title"><h1>Specialerbjudande för nya medlemmar</h1></div>
    <!-- left-message -->
    ...
    <div class="right-message fr">
      ...
      <!-- buybtn -->
      <a class="buybtn"
         href="https://www.iobit.com/buy.php?product=sv-iu103pc14msdamc239&ref=sv_iu103pcsdamcnewinstall1907<?php echo $refStr;?>&aff=&refs=sv_purchase_iu"
         onclick="ga('send', 'event', 'iubuy', 'buy', ' iu3pcnewinstall1907-sv');">
        <span>KÖP NU</span>
        <!-- ribbon -->
      ...
      <tfoot>
        <tr>
          ...
          <th class="itema">
            ...
            <a href="https://www.iobit.com/buy.php?product=sv-iu103pc14msdamc239&ref=sv_iu103pcsdamcnewinstall1907<?php echo $refStr;?>&aff=&refs=sv_purchase_iu"
         onclick="ga('send', 'event', 'iubuy', 'buy', ' iu3pcnewinstall1907-sv');" class="buybtn">KÖP NU</a>
