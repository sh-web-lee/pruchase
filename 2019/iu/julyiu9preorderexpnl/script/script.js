...
function soldOut() {
	...
	$(".buybtn").attr({
		"href": 'https://www.iobit.com/buy.php?product=nl-iu9preorder1699&ref=nl_iu9preorder1699expired' + refStr + '&aff=' + aff + '&refs=nl_purchase_iu&tw=' + tw,
		"onclick": "ga('send', 'event', 'iubuy', 'buy', 'iu9predorderexpsoldout-nl');"
	});
}
// soldOut();
