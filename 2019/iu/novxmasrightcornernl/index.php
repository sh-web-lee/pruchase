  ...
  <div class="wrapper">
    ...
    <div class="box">
      ...
      <a href="https://www.iobit.com/buy.php?product=nl-iu93pc1999&ref=nl_iu93pc1999purchase1911<?php echo $refStr;?>&refs=nl_purchase_iu "
         onclick="ga('send', 'event', 'iubuy', 'buy', 'iurightcornerpurchase1911-nl')"
         class="buybtn small">
        Bestel Nu
      </a>
    </div>
    ...
    <div class="box gift-box">
      ...
      <a href="https://www.iobit.com/buy.php?product=nl-iu93pcsdpf1499&ref=nl_iu93pcsdpf1499purchase1911<?php echo $refStr;?>&refs=nl_purchase_iu"
         onclick="ga('send', 'event', 'iubuy', 'buy', 'iurightcornerpurchase1911-nl')"
         class="buybtn">
        Bestel Nu
      </a>
  ...
  <div class="wrapper">
    <div class="betwwen-buy">
      <div class="content">
        ...
        <dl>
          <dt><strong>€14,99</strong> i.p.v. <del>€99,93</del></dt>
          <dd>
            <a href="https://www.iobit.com/buy.php?product=nl-iu93pcsdpf1499&ref=nl_iu93pcsdpf1499purchase1911<?php echo $refStr;?>&refs=nl_purchase_iu"
               onclick="ga('send', 'event', 'iubuy', 'buy', 'iurightcornerpurchase1911-nl')"
               class="buybtn red">
          ...
          <dd class="last">Kerstcadeaus beperkt beschikbaar</dd>
        </dl>
      </div>
    </div>
  </div>
  ...
  <div class="wrapper">
    <div class="content">
      ...
      <ul>
        ...
        <li class="active"><i></i> <strong>1 Jaar, <b>3 PC’s + Cadeaus</b></strong> €<span>14</span>,99</li>
      </ul>
      <dl>
        <dt><span>85%</span> Korting</dt>
        <dd>
          <a href="https://www.iobit.com/buy.php?product=nl-iu93pcsdpf1499&ref=nl_iu93pcsdpf1499purchase1911<?php echo $refStr;?>&refs=nl_purchase_iu"
             onclick="ga('send', 'event', 'iubuy', 'buy', 'iurightcornerpurchase1911-nl')"
             class="buybtn">
