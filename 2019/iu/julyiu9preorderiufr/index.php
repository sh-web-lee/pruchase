...
<body>
			...
			<div class="clearfix">
				...
				<div class="right fr">
					...
					<ul class="price clearfix">
						...
						<li>
							<a class="buybtn"
							   href="http://www.iobit.com/buy.php?product=fr-iu9preorder30day&ref=fr_iu9preorderiu<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_iu"
					 			 nclick="ga('send', 'event', 'iubuy', 'buy', 'iu9predorderiu-fr');">
                VITE, J’EN PROFITE
							</a>
						</li>
					</ul>
          ...
          <div class="inlist">
            <div class="indetail first clearfix">
              <dl class="fl">
                ...
                <dd>
                 Les programmes, extension de navigateur et applications pré-installées sur Windows.
                </dd>
              </dl>
              <dl class="fr">
                <dt>
                  <h3>IObit Uninstaller 9 PRO</h3>
                  <h4>Désinstalle <i>AMELIORE</i></h4>
                </dt>
            ...
            <div class="indetail last clearfix">
              ...
              <dl class="fr">
                ...
                <dd><h4>Nettoie <i>AMELIORE</i></h4> les fichiers et registres résiduels après la désinstallation.</dd>
                <dd>
                  <h4>Détecte  <i class="new">NOUVEAU </i></h4>
                  Les modifications du système causées par l’installation d’un programme et les annule après la désinstallation
                </dd>
                <dd>
                  <h4>Analyse <i class="new">NOUVEAU </i></h4>
                  Les fichiers résiduels qui persistent après la suppression du programme effectuée par tiers. <br> 
                  <em class="space">unique sur le marché</em>
                </dd>
              </dl>
              <img class="face" src="<?php echo getStaticUrl('images/face.png')?>" alt="">
	...
	<div class="feature">
      ...
      <div class="price clearfix">
        ...
        <a class="buybtn fl"
           href="http://www.iobit.com/buy.php?product=fr-iu9preorder30day&ref=fr_iu9preorderiu<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_iu"
					 onclick="ga('send', 'event', 'iubuy', 'buy', 'iu9predorderiu-fr');">
          VITE, J’EN PROFITE
        </a>
      </div>
		</div>
