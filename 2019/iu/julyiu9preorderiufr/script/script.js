...
function soldOut() {
	...
	$(".buybtn").attr({
		"href": 'http://www.iobit.com/buy.php?product=fr-iu9preorder1499&ref=fr_iu9preorder1499iu' + refStr + '&aff=' + aff + '&refs=fr_purchase_iu&tw=' + tw,
		"onclick": "ga('send', 'event', 'iu3pcbuy', 'buy', 'iu9predorderiu-fr');"
	});
}
// soldOut();
