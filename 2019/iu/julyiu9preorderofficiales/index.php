...
<body>
			...
			<div class="clearfix">
				...
				<div class="right fr">
					...
					<ul class="price clearfix">
						...
						<li>
							<a class="buybtn"
							   href="https://www.iobit.com/buy.php?product=es-iu9preorder&ref=es_iu9preorderofficial<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=es_purchase_iu"
							   onclick="ga('send', 'event', 'iubuy', 'buy', 'iu9predorderofficial-es');">
							  Resérvalo ya
							</a>
						</li>
					</ul> 
	...
	<div class="intro">
		<div class="wrapper">
			...
			<h2>¿Qué puede hacer por ti IObit Uninstaller 9 PRO?</h2>
			<div class="one clearfix">
				<div class="left fl">
					<img src="<?php echo getStaticUrl('images/iu-screen-01.png')?>" alt="IObit Uninstaller PRO"/>
				</div>
				<div class="right fr">
					<h3><b>Desinstalación rápida de</b></h3>
					<dl>
						<dt><h4>Software obstinado y Paquetes de programas <span><em>Función única</em></span></h4></dt>
						<dd>
							Elimina forzadamente los programas no deseados y obstinados, y los paquetes de programas que no pueden ser desinstalados por los métodos convencionales.
						</dd>
					</dl>
					<dl>
						<dt><h4>Extensiones de navegador maliciosas <span><em>Función única</em></span></h4></dt>
						<dd>
							Te ayuda a eliminar cualquier barra de herramientas, complementos y extensiones de navegador no deseados y te dice cuáles son seguros para tu PC.
						</dd>
					</dl>
					<dl>
						<dt><h4>Aplicaciones de Windows</h4></dt>
						<dd>Te ayuda a eliminar las aplicaciones predeterminadas de Windows 10 que ya no usas. </dd>
					</dl>
				</div>
			</div>
			<div class="two clearfix">
				<div class="right fl">
					<h3><b>Limpieza profunda de</b></h3>
					<dl class="safe">
						<dt><h4>Datos inútiles de programas</h4></dt>
						<dd>
							Elimina todos los archivos, carpetas y registros asociados después de desinstalar un programa.
						</dd>
					</dl>
					<dl>
						<dt><h4>Los restos residuales en el PC <span><em>Función única</em></span></h4></dt>
						<dd>
							1-click para escanear y eliminar archivos residuales de los programas desinstalados que se desinstalaron sin usar IObit Uninstaller.
						</dd>
					</dl>
					<dl>
						<dt><h4>Los cambios realizados en el sistema por el instalador</h4></dt>
						<dd>
							Identifica cualquier cambio realizado por un instalador y elimina todos los archivos que el programa modificó durante su instalación. 
						</dd>
					</dl>
				</div>
				<div class="left fr">
	...
	<div class="feature">
		<div class="wrapper">
			<div class="iumouse"><div class="mouse"></div></div>
			<h2>¿Por qué escoger IObit Uninstaller 9 PRO?</h2>
			<div class="clearfix">
				<div class="left fl">
				...
				<div class="right fr">
					<ul class="feature-list">
						<li><i class="all-icons">√</i> Elimina programas y aplicaciones de Windows por lotes</li>
						<li><i class="all-icons">√</i> Identifica y elimina bundleware</li>
						<li class="three">
							<i class="all-icons">√</i>
							<span>
								Detecta y revierte los cambios realizados en el sistema <br>por una instalación <sup class="green">Nuevo</sup>
							</span>
						</li>
						<li><i class="all-icons">√</i> Elimina programas obstinados <sup>Mejorado</sup></li>
						<li class="three">
							<i class="all-icons">√</i>
							<span>
								Identifica extensiones maliciosas y publicitarias <sup>Mejorado</sup>
							</span>
						</li>
						<li class="three">
							<i class="all-icons">√</i> 
							<span>Elimina automáticamente los restos después de la <br>desinstalación estándar <sup>Mejorado</sup></span>
						</li>
						<li>
							<i class="all-icons">√</i> 
							Escanea los restos de los programas desinstalados <sup class="green">Nuevo</sup>
						</li>
						<li class="three">
							<i class="all-icons">√</i> 
							<span>Crea un punto de restauración automáticamente antes de <br>desinstalar Update all outdated programs with one click</span>
						</li>
						<li><i class="all-icons">√</i> Actualiza todos los programas obsoletos con un clic</li>
						<li class="three">
							<i class="all-icons">√</i> 
							<span>Actualiza automáticamente cuando una nueva versión <br>está disponible</span>
						</li>
						<li><i class="all-icons">√</i> Soporte técnico Gratuito 24/7</li>
					</ul>
					<ul class="price clearfix">
						<li class="first">
							<strong><big>0</big>€<sup>*</sup></strong> <del>29,99€</del>
					...
					<p class="change">Date prisa, sólo quedan <b class="giftNum">50</b></p>
				</div>
			</div>
		</div>
	</div>
