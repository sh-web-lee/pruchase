...
function soldOut() {
	...
	$(".buybtn").attr({
		"href": 'https://www.iobit.com/buy.php?product=es-iu9preorder1599&ref=es_iu9preorder1599official' + refStr + '&aff=' + aff + '&refs=es_purchase_iu',
		"onclick": "ga('send', 'event', 'iu3pcbuy', 'buy', 'iu9predorderofficial-es');"
	});
}
// soldOut();
