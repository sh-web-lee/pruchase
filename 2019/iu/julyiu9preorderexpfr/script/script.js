...
function soldOut() {
	...
	$(".buybtn").attr({
		"href": 'https://www.iobit.com/buy.php?product=fr-iu9preorder1499&ref=fr_iu9preorder1499expired' + refStr + '&aff=' + aff + '&refs=fr_purchase_iu&tw=' + tw,
		"onclick": "ga('send', 'event', 'iu3pcbuy', 'buy', 'iu9predorderexp-fr');"
	});
	$(".between-buy h2").text("Profitez d'IObit Uninstaller 9 PRO maintenant !");
}
// soldOut();
...
function getReTime() {
	var packsNumTotal = cGet('friuexpjune_t');
