...
function soldOut() {
  ...
  $(".buybtn").attr({
    "href": 'https://www.iobit.com/buy.php?product=dk-iu9preorder159&ref=dk_iu9preorder159iu' + refStr + '&aff=' + aff + '&refs=dk_purchase_iu&tw=' + tw,
    "onclick": "ga('send', 'event', 'iu3pcbuy', 'buy', 'iu9predorderiu-dk');"
  });
}
