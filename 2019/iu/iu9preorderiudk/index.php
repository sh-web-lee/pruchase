...
<body>
	...
	<div class="banner">
      ...
      <!-- title -->
        ...
        <!-- right-message -->
              ...
              <!-- buybtn -->
							<a class="buybtn"
							   href="https://www.iobit.com/buy.php?product=dk-iu9preorder&ref=dk_iu9preorderiu<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=dk_purchase_iu"
							   onclick="ga('send', 'event', 'iubuy', 'buy', 'iu9predorderiu-dk');">
                Forudbestil nu
							</a>
						</li>
					</ul>
	...
	<!-- intro start -->
	<div class="intro">
    <h2>Hvorfor opgradere til IObit Uninstaller 9 PRO?</h2>
    <!-- content -->
    <div class="content">
      <div class="wrapper">
        <ul class="clearfix">
          <li class="active">Grundigere afinstalleringer</li>
            ...
            <div class="indetail first clearfix">
              ...
              <dl class="fr">
                <dt>
                  ...
                  <h4>Afinstaller <i>FORBEDRET</i></h4>
                </dt>
                <dd>
                  Programmer, browser udvidelser <br>
                  og Windows apps.
            ...
            <div class="indetail last clearfix">
              ...
              <dl class="fr">
                ...
                <dd>
                  ...
                  program og vend tilbage til den <br>
                  oprindelige tilstand(før ændringerne) <br>
                  efter afinstallering af programmetr.
                </dd>
                <dd>
                  <h4>Skanner <i class="new">NY</i></h4>
                  Resterende filer fra tidligere <br>
                  afinstallerede programmer uden brug <br>
                  af IObit Uninstaller. <br>
                  <em class="space">Unik på markedet</em>
                </dd>
              </dl>
              <img class="face" src="<?php echo getStaticUrl('images/face.png')?>" alt="">
