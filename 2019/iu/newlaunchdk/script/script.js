...
$(".right-message .box").on("click",function(){
  ...
  var new3pchref="http://www.iobit.com/buy.php?product=dk-iu113pcpf159&ref=dk_iu113pcpf1907newlaunch"+refStr+"&aff=" + aff + "&refs=dk_purchase_iu&tw=" + tw;
  var new3pcga="ga('send', 'event', 'iubuy', 'buy', 'iupurchase3pc1907newlaunch-dk')";
  var new1pchref="http://www.iobit.com/buy.php?product=dk-iu113pc179&ref=dk_iu111pc1907newlaunch"+refStr+"&aff=" + aff + "&refs=dk_purchase_iu&tw=" + tw;
  var new1pcga="ga('send', 'event', 'iubuy', 'buy', 'iupurchase1pc1907newlaunch-dk')";
...
function soldout() {
  var aff = $.getUrlParam('aff');
  var tw = MApp(2.2).datetime.getTimeZone();
  var new1pchref="http://www.iobit.com/buy.php?product=dk-iu113pc179&ref=dk_iu111pc1907newinstall"+refStr+"&aff=" + aff + "&refs=dk_purchase_iu&tw=" + tw;
  var new1pcga="ga('send', 'event', 'iubuy', 'buy', 'iupurchase1pc1907newlaunch-dk')";
  $(".banner,.bottom-buy").addClass("banner-iu");
...
function timeInit(){
  var date = new Date();
  var cName = "dkascjan" + date.getDate();
