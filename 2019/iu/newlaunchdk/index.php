...
<script type="text/javascript" src="<?php echo $pRootUrl; ?>tpl/js/stats.js"></script>
  ...
  <div class="banner">
    <div class="wrapper">
      ...
      <h2>Opgrader til ny IObit Uninstaller 11 PRO og ekstra gaver helt gratis</h2>
      <div class="left-img">
      ...
      <div class="right-message">
        ...
        <dl class="price">
          ...
          <dd><a href="http://www.iobit.com/buy.php?product=dk-iu113pcpf159&ref=dk_iu113pcpf1907newlaunch<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=dk_purchase_iu" onclick="ga('send', 'event', 'iubuy', 'buy', 'iupurchase3pc1907newlaunch-dk')" class="buybtn"><i class="all-icons"></i> <span>Køb nu</span></a></dd>
        </dl>
      </div>
    </div>
  </div>
  ...
  <div class="gift-message">
    <div class="wrapper">
      ...
      <dl class="price">
        <dt><strong>kr. <b>159</b></strong> <del>kr. 798</del></dt>
        <dd><a href="http://www.iobit.com/buy.php?product=dk-iu113pcpf159&ref=dk_iu113pcpf1907newinstall<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=dk_purchase_iu" onclick="ga('send', 'event', 'iubuy', 'buy', 'iupurchase3pc1907newlaunch-dk')" class="buybtn"><i class="all-icons"></i> <span>Køb nu</span></a></dd>
      </dl>
    </div>
  </div>
  <!-- awards start -->
