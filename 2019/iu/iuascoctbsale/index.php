...
<head>
  ...
  <title>80% OFF to Get ASC PRO & IObit Uninstaller 9 PRO - IObit</title>
  ...
  <div class="wrapper">
    ...
    <div class="container clearfix">
      <dl class="left">
        ...
        <dd>
          <a class="buybtn"
             href="https://www.iobit.com/buy.php?product=iu9pro1999&ref=2016iu93pcasc10<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=purchase-iu"
      ...
      <dl class="right">
        ...
        <dd>
          <a class="buybtn"
             href="https://www.iobit.com/buy.php?product=asc13iu93pc&ref=2016asc13iu93pc<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=purchase-iu"
...
<div class="product">
  ...
  <div class="wrapper">
    <dl class="left">
      ...
      <dd><img src="<?php echo $pResUrl; ?>images/greenmark.png" alt="">Deep PC Cleaning to Fix Problems and Tune up Your PC</dd>
    </dl>
    <dl class="right">
...
<div class="foot-banner">
  <div class="wrapper">
    ...
    <dl>
      ...
      <dd>
        <a href="https://www.iobit.com/buy.php?product=asc13iu93pc&ref=2016asc13iu93pc<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=purchase-iu"
           onclick="ga('send', 'event', 'asciubuy', 'buy', ' iupurchase-asc201612');"
           class="buybtn bottom">
          Activate Now
        </a>
