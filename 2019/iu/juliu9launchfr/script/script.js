...
function soldout() {
  ...
  $(".floatlayer .number").html("Profitez d'une désinstallation complète et <br> d'un nettoyage en profondeur");
  $(".banner .price del").html("29,99€");
  $(".floatlayer .message p,.disappear,.ghost").remove();
  $(".banner .right .message").html("<h2>Passez au nouvel IObit Uninstaller 11 PRO</h2>")
  $(".floatlayer .buybtn").html("J’EN PROFITE VITE")
  $(".floatlayer .price").append("<p>1 an d’abonnement / 3 PC</p><p class='money'><strong><b>12</b></strong><span><del>29,99€</del><cite>,99€</cite></span></p>")
  $(".buybtn").attr("href", "https://www.iobit.com/buy.php?product=fr-iu113pc1299&ref=fr_iu3pc1299olduser"+refStr+"&aff=" + aff + "&refs=fr_purchase_iu&tw=" + tw);
  $(".buybtn").attr("onclick", "ga('send', 'event', 'iu3pcbuy', 'buy', 'iuolduserpurchase-fr');");
