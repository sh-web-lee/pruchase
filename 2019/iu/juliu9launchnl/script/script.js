...
function dissolve(num) {
  ...
  $(".banner .disappear").css({ "opacity": 0, "top":244}).animate({ "opacity": 1}, 500).animate({ "top": 200,"opacity": 0},500);
  $(".banner .ghost").css({ "opacity": 0, "top":164}).animate({ "opacity": 1}, 500).animate({ "top": 100,"opacity": 0},500);
  $(".floatlayer .disappear").css({ "opacity": 0, "top":53}).animate({ "opacity": 1}, 500).animate({ "top": 3,"opacity": 0},500);
  $(".floatlayer .ghost").css({ "opacity": 0, "top":0}).animate({ "opacity": 1}, 500).animate({ "top": -50,"opacity": 0},500);
}
...
function soldout() {
  ...
  $(".banner .price del").html("€29,99");
  $(".banner .right .message").html("<h2>Upgrade Naar Het Nieuwe IObit Uninstaller 11 PRO</h2>");
  $(".banner .left .iu-box").attr("src", iuImg);
  $(".floatlayer .number").html("Profiteer van Volledige Deïnstallatie en Diepe Opschoning");
  $(".floatlayer .message p,.disappear,.ghost").remove();
  $(".floatlayer .buybtn").html("Activeer Nu");
  $(".floatlayer .price").append("<p>1-jarig abonnement / 3 pc’s</p><p class='money'><strong>€<b>15</b></strong><span><del>29,99</del><cite>,99</cite></span></p>");
  $(".buybtn").attr("href", "https://www.iobit.com/buy.php?product=nl-iu113pc1599&ref=nl_iu3pc1599purchaselaunch"+refStr+"&aff=" + aff + "&refs=nl_purchase_iu&tw=" + tw);
  $(".buybtn").attr("onclick", "ga('send', 'event', 'iubuy', 'buy', 'iupurchase-newlaunchsoldout-nl');");
