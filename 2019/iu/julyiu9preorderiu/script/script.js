...
function soldOut() {
  ...
  $(".feature .price h3").text("Pre-order Now to Unlock All PRO Features");
  $(".feature .price div.fl").css({"marginTop": 55});
  $(".price").find("strong").html("$<big>14</big>.77");
  $(".buybtn").attr({
    "href": 'https://www.iobit.com/buy.php?product=iu9preorder1477&ref=iu9preorder1477iu' + refStr + '&aff=' + aff + '&refs=purchase_iu&tw=' + tw,
    "onclick": "ga('send', 'event', 'iu3pcbuy', 'buy', 'iu9predorderiu');"
  });
}
