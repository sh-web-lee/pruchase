...
function soldOut() {
  ...
  $(".buybtn").attr({
    "href": 'https://www.iobit.com/buy.php?product=it-iu9preorder1599&ref=it_iu9preorder1599iu' + refStr + '&aff=' + aff + '&refs=it_purchase_iu&tw=' + tw,
    "onclick": "ga('send', 'event', 'iubuy', 'buy', 'iu9predorder1599iu-it');"
  });
}
