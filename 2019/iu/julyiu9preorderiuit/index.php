      ...
      <div class="right fr">
        ...
        <ul class="price clearfix">
          ...
          <li>
            <!-- buybtn -->
            <a class="buybtn"
               href="https://www.iobit.com/buy.php?product=it-iu9preorder&ref=it_iu9preorderiu<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=it_purchase_iu"
               onclick="ga('send', 'event', 'iubuy', 'buy', 'iu9predorderiu-it');">
              Pre-ordina Ora
            </a>
          </li>
        </ul>
        ...
        <div class="inlist">
          <div class="indetail first clearfix">
            ...
            <dl class="fr">
              <dt>
                ...
                <h4>Disinstalla <i>MIGLIORATO</i></h4>
              </dt>
              <dd>
                Programmi, estensioni del browser <br>
                e app di Windows.
              ...
              <dd>
                ...
                essere disinstallati con metodi <br>
                convenzionali.
              </dd>
              <dd>
                Programmi in bundle e freeware per <br>
                pubblicizzare o rubare i dati sulla privacy. <br>
                <em class="space">unico sul mercato</em>
              </dd>
              <dd>
                Plugin pubblicitari maligni che <br>
                iniettano annunci o link dannosi <br>
                nelle pagine visualizzate. <br>
                <em class="space">unico sul mercato</em>
              </dd>
            </dl>
          ...
          <div class="indetail last clearfix">
            ...
            <dl class="fr">
              ...
              <dd>
                <h4>Rimuove <i>MIGLIORATO</i></h4>
                15% in più di File e registri <br>
                rimasti dopo la disinstallazione.
              </dd>
              <dd>
                <h4>Rileva <i class="new">NUOVO</i></h4>
                Modifiche del sistema da un programma <br>
                e le ripristina dopo aver disinstallato <br>
                il programma.
              </dd>
              <dd>
                <h4>Scansiona <i class="new">NUOVO</i></h4>
