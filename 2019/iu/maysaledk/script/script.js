...
$(".right-message .box").on("click",function(){
  ...
  var new3pchref="http://www.iobit.com/buy.php?product=dk-iu93pcpf159&ref=dk_iu93pcpf1908"+refStr+"&aff=" + aff + "&refs=dk_purchase_iu&tw=" + tw;
  var new3pcga="ga('send', 'event', 'iubuy', 'buy', 'iupurchase3pc1908-dk')";
  var new1pchref="http://www.iobit.com/buy.php?product=dk-iu93pc179&ref=dk_iu93pc1908"+refStr+"&aff=" + aff + "&refs=dk_purchase_iu&tw=" + tw;
  var new1pcga="ga('send', 'event', 'iubuy', 'buy', 'iupurchase1pc1908-dk')";
...
function soldout() {
  var aff = $.getUrlParam('aff');
  var tw = MApp(2.2).datetime.getTimeZone();
  var new1pchref= "http://www.iobit.com/buy.php?product=dk-iu83pc179&ref=dk_iu83pc1905"+refStr+"&aff=" + aff + "&refs=dk_purchase_iu&tw=" + tw;
  var new1pcga="ga('send', 'event', 'iubuy', 'buy', 'iupurchase3pcsingle1905-dk') ";
  $(".banner,.bottom-buy").addClass("banner-iu");
  ...
  $(".banner .box:eq(1) .left-message").html("<strong>IObit Uninstaller PRO</strong> (1 år, 3 pc'er)<span><i class='all-icons'></i>  Protected Folder gave</span>");
