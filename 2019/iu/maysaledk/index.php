...
<script type="text/javascript" src="<?php echo $pRootUrl; ?>tpl/js/stats.js"></script>
  ...
  <div class="banner">
    <div class="wrapper">
      ...
      <h1>Eksklusivt tilbud</h1>
      <h2>Spar op til kr. 639 på IObit Uninstaller 9 Pro & få et produkt gratis!</h2>
      <div class="left-img">
      ...
      <div class="right-message">
        ...
        <dl class="price">
          ...
          <dd><a href="http://www.iobit.com/buy.php?product=dk-iu93pcpf159&ref=dk_iu93pcpf1908<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=dk_purchase_iu" onclick="ga('send', 'event', 'iubuy', 'buy', 'iupurchase3pc1908-dk')" class="buybtn"><i class="all-icons"></i> <span>Køb nu</span></a></dd>
        </dl>
      </div>
    </div>
  </div>
