...
function soldout() {
  ...
  document.title = '70% di sconto di IObit Uninstaller PRO e regali gratis di ringraziamento - IObit';
  $(".banner,.gift-message,.floatlayer").addClass("soldout");
  $(".banner .left").append('<span class="discount">70% DI SCONTO</span>');
  $(".floatlayer .number").html("Goditi la disinstallazione completa <br>e la pulizia approfondita");
  $(".banner .price del").html("€39,99");
  $(".floatlayer .message p,.disappear,.ghost").remove();
  $(".banner .right .message").html("<h2>Aggiorna al Nuovo IObit Uninstaller 9 PRO</h2>");
  $(".floatlayer .buybtn").html("Attiva Ora");
  $(".floatlayer .price").append("<p>1 Anno Abbonamento / 3 PC</p><p class='money'><strong><small>€</small><b>12</b></strong><span><del>€39,99</del><cite>,99</cite></span></p>");
  $(".buybtn").attr("href", "https://www.iobit.com/buy.php?product=it-iu103pc1299&ref=it_iu103pc1299launch" + refStr + "&aff=" + aff + "&refs=it_purchase_iu&tw=" + tw);
  $(".buybtn").attr("onclick", "ga('send', 'event', 'iubuy', 'buy', 'iu3pc-newlaunch-it');");
}
// soldout();
...
function getReTime() {
  var packsNumTotal = cGet('itiulaun_t');
  if (packsNumTotal > 1) {
