  ...
  <div class="wrapper">
    ...
    <ul class="message">
      ...
      <li class="prev">
        ...
        <!-- buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=fr-iu101y3pc1599&ref=fr_iu103pcspecialpurchase<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_iu"
           onclick="ga('send', 'event', 'iubuy', 'buy', 'iupurchase1902a-fr')">
          VITE, J’EN PROFITE
        </a>
      </li>
      <!-- 3pc+gifts -->
      <li class="last">
        ...
        <!-- box -->
        <div class="box">IObit Uninstaller PRO 9 + Protected Folder + AMC Security PRO</div>
        <!-- price -->
        <p class="price small"><strong>15</strong> <sup>99€</sup> <del>109,97€</del></p>
        <!-- buybtn -->
        <a class="buybtn yellow"
           href="https://www.iobit.com/buy.php?product=fr-iu103pcsdpf1599&ref=fr_iu103pcbundlespecialpurchase<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_iu"
           onclick="ga('send', 'event', 'iubuy', 'buy', 'iupurchase1902b-fr')">
          VITE, J’EN PROFITE
        </a>
      </li>
    </ul>
...
<div class="intro wrapper">
  ...
  <div class="showcase">
    <div class="imglist">
      <ul>
        <li class="shot1"><img src="<?php echo $pResUrl;?>images/screenshot03.png" alt=""></li>
        <li class="shot2"><img src="<?php echo $pResUrl;?>images/screenshot01.png" alt=""></li>
        <li class="shot3"><img src="<?php echo $pResUrl;?>images/screenshot02.png" alt=""></li>
        <li class="shot4"><img src="<?php echo $pResUrl;?>images/screenshot04.png" alt=""></li>
      </ul>
    </div>
  ...
  <div class="wrapper">
    ...
    <div class="gift-list clearfix">
      <dl>
        ...
        <dd>
          <h3>Smart Defrag 6 PRO<strong>0€ </strong> <del>39,99€</del></h3>
          <ul>
            <li>Défragmenter automatiquement les fichiers et disques sélectionnés en temps réel.</li>
...
<div class="comparison wrapper">
  <table border="0" cellspacing="0" cellpadding="0" width="100%">
    ...
    <tr>
      ...
      <th class="itemb">IObit Uninstaller 10 FREE</th>
      <th class="itema">IObit Uninstaller 10 PRO</th>
    </tr>
    </thead>
    <tbody>
    <tr>
...
<div class="bottombuy">
  <div class="wrapper clearfix">
    ...
    <div class="middle fl">
      <ul class="select">
        <li class="active"
            data-url="https://www.iobit.com/buy.php?product=fr-iu103pcsdpf1599&ref=fr_iu103pcbundlespecialpurchase<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_iu"
            data-ga="ga('send', 'event', 'iubuy', 'buy', 'iupurchase1902b-fr')"
            data-del="109,97€">
          <i></i>
        ...
        <li class="second"
            data-url="https://www.iobit.com/buy.php?product=fr-iu101y3pc1599&ref=fr_iu103pcspecialpurchase<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_iu"
            data-ga="ga('send', 'event', 'iubuy', 'buy', 'iupurchase1902a-fr')"
            data-del="39,99€">
          <i></i>
          1 AN / 3 PC
          <span>-45%</span>
