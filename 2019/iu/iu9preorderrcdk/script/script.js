...
function soldOut() {
  ...
  flipNum(0, 4);
  $(".banner").find(".change").html("0 kr. i reservation er udsolgt, gå ikke glip af dette tilbud igen!");
  $(".banner .left, .floatlayer .imgbox").append('<span class="discount">-60% BABAT</span>');
  setTimeout('$(".discount").addClass("on")', 300);
  $(".floatlayer").find(".one").html('<p>0 kr. i reservation er udsolgt, <br> gå ikke glip af dette tilbud igen!</p>');
  $(".feature .price").find("p").remove();
  $(".feature .price h3").text("Forudbestil nu for at få adgang til alle PRO-funktioner");
  $(".feature .price div.fl").css({"marginTop": 55});
  $(".price").find("strong").html("<big>159</big> kr.");
  $(".buybtn").attr({
    "href": 'https://www.iobit.com/buy.php?product=dk-iu9preorder159&ref=dk_iu9preorder159rc' + refStr + '&aff=' + aff + '&refs=dk_purchase_iu&tw=' + tw,
    "onclick": "ga('send', 'event', 'iu3pcbuy', 'buy', 'iu9predorderrc-dk');"
  });
}
