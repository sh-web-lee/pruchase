	...
	<div class="banner">
      ...
      <!-- title -->
        ...
        <!-- right-message -->
				<div class="right fr">
					...
					<?php else:?>
          			<p class="data">
            			...
            			1-click to remove <strong><?php echo intval($transData->softwarehealth->plugin);?></strong> malicious plug-in(s) <br>
						<?php endif;?>
						<?php if(intval($transData->softwarehealth->software)>0):?>
            			<?php echo (intval($transData->softwarehealth->plugin)>0)?'and':'1-click to';?> update <strong><?php echo intval($transData->softwarehealth->software);?></strong> outdated software on your PC
						<?php endif;?>
          			</p>
					<?php endif;?>
              ...
              <!-- buybtn -->
							<a class="buybtn"
							   href="https://www.iobit.com/buy.php?product=iu9preorder&ref=iu9preorderrc<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=purchase_iu"
							   onclick="ga('send', 'event', 'iubuy', 'buy', 'iu9predorderrc');">
							  Pre-order Now	
							</a>
						</li>
					</ul>
