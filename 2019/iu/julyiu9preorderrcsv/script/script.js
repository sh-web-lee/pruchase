...
function soldOut() {
  ...
  $(".buybtn").attr({
    "href": 'https://www.iobit.com/buy.php?product=sv-iu9preorder239&ref=sv_iu9preorder239rc' + refStr + '&aff=' + aff + '&refs=sv_purchase_iu&tw=' + tw,
    "onclick": "ga('send', 'event', 'iu3pcbuy', 'buy', 'iu9predorderrc-sv');"
  });
}
