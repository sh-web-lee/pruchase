...
function soldOut(num) {
	...
	$(".btnbox .hurry").html("58% Rabatt ist nun nicht verfügbar! <p class='zoomout'>58% Rabatt ist nun nicht verfügbar!</p>");
	$(".banner .buybtn").html("<h4>Jetzt aktivieren & 53% sparen </h4> Nicht mehr verpassen!");
	$(".price b").html("18");
	$(".numberbox").removeClass("twinkle");

	$(".buybtn").not(".buybtn-pop").attr("href", "https://www.iobit.com/buy.php?product=de-iu113pc1899&ref=iu11monitorsold1899b" + refStr + "&aff=" + aff + "&refs=de_purchase_iu&tw=" + tw);
	$(".buybtn").not(".buybtn-pop").attr("onclick", "ga('send', 'event', 'iubuy', 'buy', 'iu-monitor1899b-de');");
}
...
function packsInit() {
	var date = new Date();
	var cName = "deiumon_b" + date.getDate();
...
function getReTime() {
	var packsTotal = cGet('deiumonb_t');
	var reTime = 6.3;
