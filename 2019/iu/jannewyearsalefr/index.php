...
<head>
  ...
  <title> Jusqu'à -80% sur IObit Uninstaller PRO et obtenez les cadeaux exclusifs uniquement pour le nouvel an !</title>
...
<div class="banner">
  <div class="wrapper">
    ...
    <!-- title -->
    <h1>
           Vente Flash pour le Nouvel An
      Offre valable uniquement aujourd’hui, n'attendez pas la dernièr
    </h1>
    <!-- showcase -->
    <div class="showcase clearfix">
      <div class="single">
        <dl>
          ...
          <dd>
            <!-- 12.99buybtn -->
            <a href="https://www.iobit.com/buy.php?product=fr-iu81pc1299&ref=fr_iu81pcpurchase1812<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_iu"
               onclick="ga('send', 'event', 'iubuy', 'buy', 'iupurchase1812a-fr')"
               class="button ghost">
              VITE , J’EN PROFITE
            </a>
          </dd>
      ...
      <div class="packs">
        ...
        <dl>
          ...
          <dd>
            <!-- 15.99buybtn -->
            <a href="https://www.iobit.com/buy.php?product=fr-iu8pfamc1599&ref=fr_iu83pcpurchase1812<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_iu"
               onclick="ga('send', 'event', 'iubuy', 'buy', 'iupurchase1812b-fr')"
               class="buybtn stand">
              VITE , J’EN PROFITE
            </a>
          </dd>
  ...
  <div class="wrapper">
    ...
    <dl class="price-content">
      ...
      <dd>
        <!-- buybtn -->
        <a class="buybtn cart"
           href="https://www.iobit.com/buy.php?product=fr-iu8pfamc1599&ref=fr_iu83pcpurchase1812<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_iu"
           onclick="ga('send', 'event', 'iubuy', 'buy', 'iupurchase1812b-fr')">
