...
<head>
  ...
  <title>Zaoszczędź do 80% na IObit Uninstaller PRO - IObit</title>
...
<div class="banner">
  <div class="wrapper">
    ...
    <!-- title -->
    <h1>wyprzedaż świąteczna do  -80%</h1>
    <div class="box">
      <dl>
      ...
      <a href="http://www.iobit.com/buy.php?product=pl-iu91pc59&ref=pl_iu91pc59purchase1912<?php echo $refStr;?>&refs=pl_purchase_iu" 
         onclick="ga('send', 'event', 'iubuy', 'buy', 'iuxmas1912-pl');" class="buybtn small">
         KUP TERAZ
       </a>
    </div>
    <div class="box gift-box">
      ...
      <a href="http://www.iobit.com/buy.php?product=pl-iu93pcsdpf64&ref=pl_iu93pcsdpf64purchase1912<?php echo $refStr;?>&refs=pl_purchase_iu " 
         onclick="ga('send', 'event', 'iubuy', 'buy', 'iuxmas1912-pl');" class="buybtn">KUP TERAZ</a>
  ...
  <div class="wrapper">
    <div class="betwwen-buy">
      <div class="content">
        ...
        <dl>
          <dt><strong>64,90 zł </strong> <del>389,70 zł</del></dt>
          <dd><a href="http://www.iobit.com/buy.php?product=pl-iu93pcsdpf64&ref=pl_iu93pcsdpf64purchase1912<?php echo $refStr;?>&refs=pl_purchase_iu " 
                 onclick="ga('send', 'event', 'iubuy', 'buy', 'iuxmas1912-pl');" class="buybtn red">
                KUP TERAZ <span>– 80% </span>
               </a>
          </dd>
...
<div class="bottom">
  <div class="wrapper">
    <div class="content">
      ...
      <ul>
        <li><i></i> <strong>1 rok / <b>1 komputer</b></strong> teraz: <span>59</span>,90 zł</li>
        <li class="active"><i></i> <strong>1 rok / <b>3 komputery </b></strong> teraz: <span>64</span>,90 zł</li>
      </ul>
      <dl>
        <dt><span>80%</span>  zniżki</dt>
        <dd><a href="http://www.iobit.com/buy.php?product=pl-iu93pcsdpf64&ref=pl_iu93pcsdpf64purchase1912<?php echo $refStr;?>&refs=pl_purchase_iu " 
               onclick="ga('send', 'event', 'iubuy', 'buy', 'iuxmas1912-pl');" class="buybtn">
            KUP TERAZ 
          </a>
        </dd>
        <dd class="last">Dostępnych tylko kilka sztuk</dd>
