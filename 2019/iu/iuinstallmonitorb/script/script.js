...
function soldOut(num) {
	...
	$(".btnbox .hurry").html("75% OFF Special Offer Has Ended. <p class='zoomout'>75% OFF Special Offer Has Ended.</p>");
	$(".banner .buybtn").html("<h4>Activate Now & Save 70% </h4> Don't Miss Again!");
	$(".price b").html("16");
	$(".numberbox").removeClass("twinkle");

	$(".buybtn").not(".buybtn-pop").attr("href", "https://www.iobit.com/buy.php?product=iu113pc1677&ref=en-iu3pcmonitorsoldb" + refStr + "&aff=" + aff + "&refs=purchase_iu&tw=" + tw);
	$(".buybtn").not(".buybtn-pop").attr("onclick", "ga('send', 'event', 'iu3pcsoldbuy', 'buy', 'iupurchase-monitorb');");
}
...
function packsInit() {
	var date = new Date();
	var cName = "eniumon_b" + date.getDate();
