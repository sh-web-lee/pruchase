...
function soldout() {
  ...
  $(".banner .right .message").html("<h2>Consigue el Nuevo IObit Uninstaller 10 PRO</h2>");
  $(".banner .left .iu-box").attr("src", iuImg);
  $(".floatlayer .number").html("Disfruta de la desinstalación completa y una limpieza profunda");
  $(".floatlayer .message p,.disappear,.ghost").remove();
  $(".floatlayer .buybtn").html("Comprar ahora").css({
    "fontSize": 18
  });
  $(".floatlayer .price").append("<p>1 año de suscripción / 3 PCs</p><p class='money'><strong><b>15</b></strong><span><del> 29,99€</del><cite>,99€</cite></span></p>");
  $(".buybtn").attr("href", "https://www.iobit.com/buy.php?product=es-iu103pc1599&ref=es_iu103pc1599launch" + refStr + "&aff=" + aff + "&refs=es_purchase_iu&tw=" + tw);
  $(".buybtn").attr("onclick", "ga('send', 'event', 'iu3pcbuy', 'buy', 'iupurchase-newlaunch-es');");
}
