...
<div class="banner">
  ...
  <div class="wrapper">
    ...
    <div class="box">
      ...
      <a href="https://www.iobit.com/buy.php?product=pt-iu93pc5999&ref=pt_iu93pcpurchase1911rc<?php echo $refStr;?>&refs=pt_purchase_iu"
         onclick="ga('send', 'event', 'iubuy', 'buy', 'iupurchase1911rc-pt')"
         class="buybtn small">
        Comprar Agora
      </a>
    </div>
    <div class="box gift-box">
      ...
      <a href="https://www.iobit.com/buy.php?product=pt-iu93pcpf5199&ref=pt_iu93pcpfpurchase1911rc<?php echo $refStr;?>&refs=pt_purchase_iu"
         onclick="ga('send', 'event', 'iubuy', 'buy', 'iupurchase1911rc-pt')"
         class="buybtn">
        Comprar Agora
      </a>
  ...
  <div class="wrapper">
    <div class="betwwen-buy">
      <div class="content">
        ...
        <dl>
          <dt><strong>R$ 51,99</strong> <del>R$ 199,98</del></dt>
          <dd>
            <a href="https://www.iobit.com/buy.php?product=pt-iu93pcpf5199&ref=pt_iu93pcpfpurchase1911rc<?php echo $refStr;?>&refs=pt_purchase_iu"
               onclick="ga('send', 'event', 'iubuy', 'buy', 'iupurchase1911rc-pt')"
               class="buybtn red">
  ...
  <div class="wrapper">
    <div class="content">
      ...
      <ul>
        ...
        <li class="active"><i></i> <strong>1 Ano, 3 PCs <b>+ Brinde  </b></strong> Por: R$ <span>51</span>,99</li>
      </ul>
      <dl>
        <dt><span>75%</span> de Desconto</dt>
        <dd>
          <a href="https://www.iobit.com/buy.php?product=pt-iu93pcpf5199&ref=pt_iu93pcpfpurchase1911rc<?php echo $refStr;?>&refs=pt_purchase_iu"
             onclick="ga('send', 'event', 'iubuy', 'buy', 'iupurchase1911rc-pt')"
             class="buybtn">
