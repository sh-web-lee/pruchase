...
function soldOut() {
	...
	flipNum(0, 4);
	$(".banner").find(".change").html("Förbeställningsreservationer på 0 kr är fullbokade. Missa inte denna rabatt igen!");
	$(".banner .left, .floatlayer .imgbox").append('<span class="discount">52% OFF</span>');
	...
	$(".feature .price li.first").find("p")[1].remove();
	$(".price").find("strong").html("<big>239</big>kr");
	$(".buybtn").attr({
		"href": 'https://www.iobit.com/buy.php?product=sv-iu9preorder239&ref=sv_iu9preorder239official' + refStr + '&aff=' + aff + '&refs=sv_purchase_iu',
		"onclick": "ga('send', 'event', 'iu3pcbuy', 'buy', 'iu9predorderofficial-sv');"
	});
}
// soldOut();
