...
<title>Tijdelijk in prijs verlaagd - IObit Uninstaller PRO</title>
...
<script type="text/javascript" src="<?php echo $pRootUrl; ?>tpl/js/stats.js"></script>
  ...
  <div class="banner">
    <div class="wrapper">
      ...
      <h1>Verwijder hardnekkige software voor een spectaculaire prijs!</h1>
      ...
      <div class="box">
        ...
        <a href="https://www.iobit.com/buy.php?product=nl-iu91y3pcpfsd2500&ref=nl_iu93pcpfsd2500purchase1903<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=nl_purchase_iu" onclick="ga('send', 'event', 'iubuy', 'buy', 'iupurchase1903-nl')" class="buybtn"><i></i><span>BESTEL NU</span></a>
      </div>
      <div class="box three-pc">
        <h3>Tijdelijk in prijs verlaagd!</h3>
        <dl>
        ...
        <a href="https://www.iobit.com/buy.php?product=nl-iu91y3pc1899&ref=nl_iu93pc1899purchase1903<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=nl_purchase_iu" onclick="ga('send', 'event', 'iubuy', 'buy', 'iupurchase1903-nl')" class="buybtn"><i></i><span>BESTEL NU</span></a>
      </div>
      <div class="payment">
  ...
  <div class="intro">
    <div class="wrapper">
      ...
      <dl class="list02 ">
        ...
        <dd>
          <strong>Detecteer Systeemwijzigingen <sup>NIEUW</sup></strong>
       ...
       <dl class="list03">
        ...
        <dd>
          <strong>Houd restanten weg en software up-to-date <sup>NIEUW</sup></strong>
      ...
      <dl class="list04">
        ...
        <dd>
          <strong>Verwijder vervelende en schadelijke plug-ins</strong>
          <p>IObit Uninstaller PRO geeft een handig overzicht van <br> browser plug-ins en of ze te vertrouwen zijn. Verwijder <br> schadelijke of storende plug-ins in 1 klik.</p>
        </dd>
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%">
      <thead>
        <tr>
          ...
          <th class="space"></th>
          <th class="itemb"><span>IObit Uninstaller 9 <b>FREE</b></span></th>
          <th class="space"></th>
          <th class="itema">
            <span>IObit Uninstaller 9 <b>PRO</b></span>
          </th>
        </tr>
      </thead>
      <tbody>
        ...
        <tr>
          ...
          <td class="virtue">Update automatisch alle belangrijke software in 1 klik<span class="three five">Verbeterd</span></td>
          <td class="space"></td>
          <td class="itemb">-</td>
          <td class="space"></td>
          <td class="itema"><i class="all-icons red">√</i></td>
      ...
      <tbody class="change hide">
        ...
        <tr>
          ...
          <td class="virtue">Update software automatisch zonder websites te bezoeken <span class="three five">Verbeterd</span></td>
          <td class="space"></td>
          <td class="itemb">-</td>
          <td class="space"></td>
          <td class="itema"><i class="all-icons red">√</i></td>
