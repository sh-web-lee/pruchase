...
if(in_array($_GET['to'],array('softall','soft','iuself','bdplug','plug','uqprom','bdfail',
    'bdprog','iuasc','iuofficialfree','iuofficialpro'))){
  $refStr.='-'.$_GET['to'];
}
...
<head>
  ...
  <title>Jusqu'à -80% sur IObit Uninstaller PRO et obtenez les cadeaux exclusifs - Soldes d'hiver !</title>
...
<div class="banner">
  <div class="wrapper">
    ...
    <h1>
      LES SOLDES D’HIVER
      <span>Offre valable uniquement aujourd’hui, n'attendez pas la dernière minute !</span>
    </h1>
    <!-- showcase -->
    <div class="showcase clearfix">
      <div class="single">
        <dl>
          ...
          <dd>
            <!-- 12.99buybtn -->
            <a href="https://www.iobit.com/buy.php?product=fr-iu81pc1299&ref=fr_iu81pcpurchase1901<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_iu"
               onclick="ga('send', 'event', 'iubuy', 'buy', 'iupurchase1901-fr')"
               class="button ghost">
              VITE , J’EN PROFITE
            </a>
          </dd>
      ...
      <div class="packs">
        ...
        <dl>
          ...
          <dd>
            <!-- 15.99buybtn -->
            <a href="https://www.iobit.com/buy.php?product=fr-iu8pfamc1599&ref=fr_iu83pcpurchase1901<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_iu"
               onclick="ga('send', 'event', 'iubuy', 'buy', 'iupurchase1901-fr')"
               class="buybtn stand">
              VITE , J’EN PROFITE
            </a>
...
<!-- intro start -->
<div class="intro wrapper hidden">
...
<div class="complimentary">
  <div class="wrapper">
    <h2>  Les cadeaux exclusifs uniquement pour nos utilisateurs import</h2>
  ...
  <div class="wrapper">
    ...
    <dl class="price-content">
      ...
      <dd>
        <!-- buybtn -->
        <a class="buybtn cart"
           href="https://www.iobit.com/buy.php?product=fr-iu8pfamc1599&ref=fr_iu83pcpurchase1901<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_iu"
           onclick="ga('send', 'event', 'iubuy', 'buy', 'iupurchase1901-fr')">
