...
<head>
	...
	<title>Save up to 45% OFF on IObit Uninstaller PRO and Get free gift pack - IObit</title>
...
<body>
	...
	<div class="banner">
		<div class="wrapper">
			...
			<h6>when you choose any plan of IObit Uninstaller 10 PRO below</h6>
				...
				<div class="electbox fl">
					...
					<ul>
						<li>
							...
							<h2>IObit Uninstaller 10 PRO <span>1 year subscription</span></h2>
							<h3>1 PC</h3>
							<div class="price">
						...
						<li class="on active">
							...
							<h3>3 PCs</h3>
							<div class="price">
								<strong><small>$</small>16.77</strong> <del>$29.99</del>
								<p>Saving 45%</p>
							</div>
						</li>
					</ul>
			...
			<div class="allprice clearfix">
				...
				<a class="buybtn fr"
				   href="https://www.iobit.com/buy.php?product=iu10sdpfsm3pc&ref=en-iu3pcsdpfsminstallb<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_iu"
				   onclick="ga('send', 'event', 'iu3pcbuy', 'buy', 'iupurchase-newinstallb');">
					Activate Now
				</a>
			</div>
	  ...
	  <table border="0" cellspacing="0" cellpadding="0" width="100%">
	    ...
	    <tbody>
	      <tr>
	        ...
	        <td class="itema first">Uninstall unwanted programs and Windows apps.</td>
	        <td class="itemb">Uninstall unwanted programs and Windows apps.</td>
	      </tr>
	      <tr>
	        <td class="itema"><i class="all-icons">×</i></td>
	        <td class="itemb">Uninstall stubborn programs that refuse to uninstall.</td>
	      </tr>
	      <tr>
	        <td class="itema"><i class="all-icons">×</i></td>
	        <td class="itemb">Identify bundled programs secretly installed alongside freeware.</td>
	      </tr>
	      ...
	      <tr>
	        ...
	        <td class="itema first gray">Remove plug-ins/add-ons/extensions in multiple browsers.</td>
	        <td class="itemb gray">Remove plug-ins/add-ons/extensions in multiple browsers.</td>
	      </tr>
	      <tr>
	        <td class="itema"><i class="all-icons">×</i></td>
	      ...
	      <tr>
	        ...
	        <td class="itema first gray">Auto clean leftovers after uninstalling programs.</td>
	        <td class="itemb gray">Auto clean leftovers after uninstalling programs.</td>
	      </tr>
	      <tr>
	        <td class="itema"><i class="all-icons">×</i></td>
	        <td class="itemb">Auto clean leftovers of programs uninstalled by other uninstaller.</td>
	      </tr>
	      <tr>
	        <td class="itema"><i class="all-icons">×</i></td>
	      ...
	      <tr>
	        ...
	        <td class="itemb gray">Update all outdated programs with one click.</td>
	      </tr>
	      <tr>
	        <td class="itema"><i class="all-icons">×</i></td>
	        <td class="itemb">Auto update when a new version is available.</td>
	      </tr>
	      <tr>
