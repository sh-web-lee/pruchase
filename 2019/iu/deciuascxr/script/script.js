...
function soldOut() {
  ...
  $(".exbtn.soldout").attr({
    "href": 'https://www.iobit.com/buy.php?product=2019asciu2295&ref=xr_iuasc2295' + refStr + '&refs=purchase_iux',
    "onclick": "ga('send', 'event', 'iuascbuysold', 'buy', 'iuascpurchase-xmas');",
  });
}
// soldOut();
...
function getRetime(isInit) {
  if (isInit == 2) {
    ...
    var reTime = 6.3;
    var packsNumTotal = cGet('endeciuascxr_t');
    if (packsNumTotal > 1) {
