...
function popShow() {
	...
	setTimeout('$(".popbg,.popbox").remove();$(window).scrollWindow($(".banner .buybtn"), $(".floatlayer"), ("on"));', 3000);
}


var aff = MApp(2.2).url.getParameters('aff');
var arr = [{
	_href: "https://www.iobit.com/buy.php?product=de-iu111pcpfsdsm1799&ref=de_iu1pcsdpfsmnewinstall"+refStr+"&tw=-8",
	_ga: "ga('send', 'event', 'iu1pcbuy', 'buy', 'iupurchase-newinstall-de');",
	_price: '17'
}, {
	_href: "https://www.iobit.com/buy.php?product=de-iu113pcpfsdsm1899&ref=de_iu3pcsdpfsmnewinstall"+refStr+"&tw=-8",
	_ga: "ga('send', 'event', 'iu3pcbuy', 'buy', 'iupurchase-newinstall-de');",
	_price: '18'
}];
