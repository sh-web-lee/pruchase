        ...
        <div class="showcase">
          ...
          <div class="checkout">
            <dl>
              ...
              <dd>
                <a class="buybtn activebtn" href="https://www.iobit.com/buy.php?product=iu8pro1677&ref=<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_iu " onclick="ga('send', 'event', 'iu1677buyusa', 'buy', 'iupurchase-201901');">
                  Activate Now
                </a>
              </dd>
          ...
          <tr>
            ...
            <th class="item-pro">
              <dl>
                ...
                <dd>
                  <a class="buybtn activesmall" href="https://www.iobit.com/buy.php?product=iu8pro1677&ref=<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_iu " onclick="ga('send', 'event', 'iu1677buyusa', 'buy', 'iupurchase-201901');">
                    ACTIVATE NOW
                  </a>
                </dd>
