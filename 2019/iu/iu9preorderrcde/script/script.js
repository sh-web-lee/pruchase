...
function soldOut() {
	...
	$(".buybtn").attr({
		"href": 'https://www.iobit.com/buy.php?product=de-iu9preorder1899&ref=de_iu9preorder1899rc' + refStr + '&aff=' + aff + '&refs=de_purchase_iu',
		"onclick": "ga('send', 'event', 'iu3pcbuy', 'buy', 'iu9predorderrc-de');"
	});
...
function getReTime() {
	var packsNumTotal = cGet('deiurcjune_t');
