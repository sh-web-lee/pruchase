...
<head>
  ...
  <title>Hasta 85% de descuento y regalos gratis en IObit Uninstaller Pro. Oferta especial de Navidad – IObit</title>
...
<div class="banner">
  ...
  <div class="wrapper">
    ...
    <div class="box">
      ...
      <!-- 1pc buybtn -->
      <a href="https://www.iobit.com/buy.php?product=es-iu91pc1299&ref=es_iu91pcpurchasexr1911<?php echo $refStr;?>&refs=es_purchase_iu"
         onclick="ga('send', 'event', 'iubuy', 'buy', 'iu91pcxr1911-es')"
         class="buybtn small">
        Comprar ahora
      </a>
    </div>
    <div class="box gift-box">
      ...
      <!-- 3pc buybtn -->
      <a href="https://www.iobit.com/buy.php?product=es-iu93pcpfamc1499&ref=es_iu93pcpfamcpurchasexr1911<?php echo $refStr;?>&refs=es_purchase_iu"
         onclick="ga('send', 'event', 'iubuy', 'buy', 'iu93pcxr1911-es')"
         class="buybtn">
        Comprar ahora
      </a>
  ...
  <div class="wrapper">
    <div class="content">
      ...
      <ul>
        ...
        <li class="active"><i></i> <strong>1 año, <b>3 PC</b></strong> <span>14</span>,99€</li>
      </ul>
      <dl>
        <dt><span>85%</span> de descuento</dt>
        <dd>
          <!-- 3pc buybtn -->
          <a href="https://www.iobit.com/buy.php?product=es-iu93pcpfamc1499&ref=es_iu93pcpfamcpurchasexr1911<?php echo $refStr;?>&refs=es_purchase_iu"
             onclick="ga('send', 'event', 'iubuy', 'buy', 'iu93pcxr1911-es')"
