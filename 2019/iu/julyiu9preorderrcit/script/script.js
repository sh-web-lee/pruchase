...
function soldOut() {
  ...
  $(".banner .left, .floatlayer .imgbox").append('<span class="discount">60% DISCOCNTO</span>');
  ...
  $(".feature .price h3").text("Pre-ordina ora per sbloccare tutte le funzionalità di PRO");
  $(".feature .price div.fl").css({"marginTop": 55});
  $(".price").find("strong").html("€<big>15</big>,99");
  $(".buybtn").attr({
    "href": 'https://www.iobit.com/buy.php?product=it-iu9preorder1599&ref=it_iu9preorder1599rc' + refStr + '&aff=' + aff + '&refs=it_purchase_iu&tw=' + tw,
    "onclick": "ga('send', 'event', 'iubuy', 'buy', 'iu9predorder1599rc-it');"
  });
}
