...
<head>
  ...
  <title>Spara upp till 81% rabatt på IObit Uninstaller PRO – IObit</title>
...
<div class="banner">
  ...
  <div class="wrapper">
    ...
    <!-- title -->
    <h1>Stor Julrea upp till 81% rabatt</h1>
    <div class="box">
      <dl>
      ...
      <a href="https://www.iobit.com/buy.php?product=sv-iu91pc199&ref=sv_iu91pcpurchasexmas1911xr<?php echo $refStr;?>&refs=sv_purchase_iu" 
         onclick="ga('send', 'event', 'iubuy', 'buy', 'iu91pcxr-sv')" class="buybtn small">KÖP NU</a>
    </div>
    <div class="box gift-box">
      <dl>
        <dt>Ord. pris  <del>1 157 kr</del></dt>
        <dd>
          <strong>219 kr</strong>
          <span>1 År, <b> 3 PC</b></span>
        </dd>
      </dl>
      <img src="<?php echo getStaticUrl('images/iu-gift-box.png')?>" alt="" class="img-box">
      <a href="https://www.iobit.com/buy.php?product=sv-iu93pcsdamc219&ref=sv_iu93pcsdamcpurchasexmas1911xr<?php echo $refStr;?>&refs=sv_purchase_iu" 
         onclick="ga('send', 'event', 'iubuy', 'buy', 'iu93pcxr-sv')" class="buybtn">KÖP NU</a>
      <p>Aktivera nu och spara 938 kr!</p>
    </div>
  ...
  <div class="gift-content wrapper clearfix">
    ...
    <dl>
      ...
      <dd>
        ...
        <p>Bästa allt-i-ett städaren och boostaren för Android-enheterl.</p>
        <p>Betala tryggt när du shoppar online</p>
      </dd>
    </dl>
  </div>
  <div class="wrapper">
    <div class="betwwen-buy">
      <div class="content">
        ...
        <dl>
          <dt><strong> 219 kr</strong>  <del>1 157 kr</del></dt>
          <dd><a href="https://www.iobit.com/buy.php?product=sv-iu93pcsdamc219&ref=sv_iu93pcsdamcpurchasexmas1911xr<?php echo $refStr;?>&refs=sv_purchase_iu" 
                 onclick="ga('send', 'event', 'iubuy', 'buy', 'iu93pcxr-sv')" class="buybtn red">KÖP NU</a></dd>
          <dd class="last"> Aktivera nu och spara 938 kr!</dd>
        </dl>
      </div>
    </div>
  </div>
...
<div class="bottom">
  <div class="wrapper">
    <div class="content">
      ...
      <ul>
        <li><i></i> <strong>1 År,  <b>1 PC</b></strong> Endast <span>199 </span>kr</li>
        <li class="active"><i></i> <strong>1 År, <b>3 PC</b></strong> Endast <span> 219 </span>kr</li>
      </ul>
      <dl>
        <dt><span>81%</span> rabatt</dt>
        <dd><a href="https://www.iobit.com/buy.php?product=sv-iu93pcsdamc219&ref=sv_iu93pcsdamcpurchasexmas1911xr<?php echo $refStr;?>&refs=sv_purchase_iu" 
               onclick="ga('send', 'event', 'iubuy', 'buy', 'iu93pcxr-sv')" class="buybtn">KÖP NU</a></dd>
