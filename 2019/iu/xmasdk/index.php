...
<head>
  ...
  <title>Spar op til 78% på IObit Uninstaller PRO til 2020 - IObit</title>
...
<!--    <div class="star"></div>-->
    ...
    <div class="box">
      ...
      <!-- 1pc buybtn -->
      <a href="https://www.iobit.com/buy.php?product=dk-iu91pc159&ref=dk_iu91pc159sale202001<?php echo $refStr;?>&refs=dk_purchase_iu"
         onclick="ga('send', 'event', 'iubuy', 'buy', 'iu159xmas1912-dk')"
         class="buybtn small">
        Køb nu
      </a>
    </div>
    <div class="box gift-box">
      <dl>
        <dt>Normalpris: <del>798 kr.</del></dt>
        <dd>
      ...
      <!-- 3pc buybtn -->
      <a href="https://www.iobit.com/buy.php?product=dk-iu9pf179&ref=dk_iu9pf179sale202001<?php echo $refStr;?>&refs=dk_purchase_iu"
         onclick="ga('send', 'event', 'iubuy', 'buy', 'iu179xmas1912-dk')"
         class="buybtn">
        Køb nu
      </a>
  ...
  <div class="wrapper">
    <div class="betwwen-buy">
      <div class="content">
        ...
        <dl>
          <dt><strong>179 kr.</strong> <del>798 kr.</del></dt>
          <dd>
            <!-- 3pc buybtn -->
            <a href="https://www.iobit.com/buy.php?product=dk-iu9pf179&ref=dk_iu9pf179sale202001<?php echo $refStr;?>&refs=dk_purchase_iu"
               onclick="ga('send', 'event', 'iubuy', 'buy', 'iu179xmas1912-dk')"
               class="buybtn red">
              Køb nu <span>– spar 78%</span>
            </a>
          </dd>
  ...
  <div class="wrapper bottom-content clearfix">
    <div class="content">
      ...
      <ul>
        ...
        <li class="active"><i></i> <strong>1 år, <b>3 PC‘er</b></strong>  nu: <span>179</span> kr.</li>
      </ul>
      <dl>
        <dt><span>78%</span> rabat</dt>
        <dd>
          <!-- 3pc buybtn -->
          <a href="https://www.iobit.com/buy.php?product=dk-iu9pf179&ref=dk_iu9pf179sale202001<?php echo $refStr;?>&refs=dk_purchase_iu"
             onclick="ga('send', 'event', 'iubuy', 'buy', 'iu179xmas1912-dk')"
