...
<head>
  ...
  <title>Gelukkig Nieuwjaar: 80% korting op IObit Uninstaller PRO</title>
...
<div class="banner">
  <div class="wrapper">
    ...
    <!-- title -->
    <h1>Gelukkig Nieuwjaar! EXCLUSIEVE AANBIEDING</h1>
    <div class="panel">
      <!-- left-message -->
      ...
      <div class="right-message fr">
        ...
        <!-- notes -->
        <p class="notes">+ Twee Gratis Cadeaus</p>
        <!-- line -->
        <hr>
        <!-- price -->
        <p class="price">
        ...
        <!-- buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=nl-iu81y3pcpfsd1799&ref=nl_iu83pcpfsdpurchase1812<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=nl_purchase_iu"
           onclick="ga('send', 'event', 'iubuy', 'buy', 'iupurchase1812-nl')">
...
<div class="betweenbuy wrapper clearfix">
  ...
  <h2>Twee Gratis Cadeaus <span>(T.W.V. €69,94) </span> exclusief met Nieuwjaar!</h2>
  <div class="clearfix">
    <dl>
