<?php
	...
	if (empty($_GET['ref'])) $_GET['ref'] = 'asc7trial';
?>
...
<div id="main">
	<div class="floatlayer" id="floatlayer">
		...
		<div class="btn"> <span>Original <del>$68.97</del> Now $19.99</span> <a href="http://www.iobit.com/buy.php?product=asc7ebook3pc&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" title="CHECKOUT" class="checkbtn">Checkout >></a> <span>100% money back guarantee</span> </div>
	</div>
	<div class="head">
		<div class="wrapper">
	...
	<div class="mainbody">			
		...
		<div class="proinfo">
			...
			<dl class="benifits">
				<dt>Advanced SystemCare 7 PRO</dt>
		...
		<div class="comprestab">
			...
			<table cellpadding="0" cellspacing="0" width="100%" class="compress">
				<tr>
					<td width="315">
						<a href="http://www.iobit.com/buy.php?product=asc71pc1297&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>">
							<table cellpadding="0" cellspacing="0" width="100%">
								...
								<tr>
									<td><a href="http://www.iobit.com/buy.php?product=asc71pc1297&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" class="btna">Activate Now</a></td>
								</tr>
							</table>
						</a>
					</td>
					<td width="350">
						<a href="http://www.iobit.com/buy.php?product=asc7ebook3pc&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>">
							<table cellpadding="0" cellspacing="0" width="100%">
								<tr>
								...
								<tr>
									<td><a href="http://www.iobit.com/buy.php?product=asc7ebook3pc&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" class="btnb">Activate Now<span></span></a></td>
								</tr>
							</table>
						</a>
