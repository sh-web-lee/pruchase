...
function soldOut() {
  ...
  $(".buybtn").attr({
    "href": 'https://www.iobit.com/buy.php?product=asc14preorder1677&ref=en-asc14preorderexpiredsoldout'+refStr+'&aff=' + aff + '&refs=purchase_asc&tw=-8',
    "onclick": "ga('send', 'event', 'asc3pcbuy', 'buy', 'asc14preorderexpired');"
  });
}
...
function getReTime() {
  var packsNumTotal = cGet('enascexpir_t');
  if (packsNumTotal > 1) {
