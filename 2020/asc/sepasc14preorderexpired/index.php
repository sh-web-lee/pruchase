...
if ($_GET['action'] == 'getPacks') {
  $date = $_GET['d'];
  $c_name = 'enascexpir_p' . $date;
  $c_name_t='enascexpir_t' . $date;
...
if($junk == '0.00'){
    $content[6]='Deleted useless files for Cleaner PC';
}
?>
<!DOCTYPE html>
<html lang="en">
  ...
  <div class="wrapper">
    ...
    <div class="right-message">
      ...
      <div class="price">
        ...
        <a href="https://www.iobit.com/buy.php?product=asc14preorder&ref=en-asc14preorderexpired<?php echo $refStr; ?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_asc" 
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'asc14preorderexpired');" class="buybtn"><?php echo $content[4]; ?></a>
      </div>
    </div>
  </div>
</div>
...
<div id="floatlayer" class="floatlayer">
  <div class="wrapper clearfix">
    ...
    <div class="price">
        <strong>$<b>0</b> <sup>*</sup></strong>
        <a href="https://www.iobit.com/buy.php?product=asc14preorder&ref=en-asc14preorderexpired<?php echo $refStr; ?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_asc" 
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'asc14preorderexpired');" class="buybtn"><?php echo $content[49]; ?></a>
      </div>
  </div>
</div>
<!-- floatlayer end -->
