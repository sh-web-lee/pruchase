...
function soldOut() {
  ...
  $(".buybtn").attr({
    "href": 'http://www.iobit.com/buy.php?product=fr-asc14preorder1799&ref=fr_asc14preorderofficialsoldout' + refStr + '&aff=' + aff + '&refs=fr_purchase_asc&tw=-8',
    "onclick": "ga('send', 'event', 'ascbuy', 'buy', 'asc14preorderofficial1799-fr');"
  });
}
// soldOut();
...
function getReTime() {
  var packsNumTotal = cGet('frascoff_t');
  if (packsNumTotal > 1) {
