...
<div class="banner">
  <div class="wrapper">
    ...
    <h1>N’offrez que le meilleur à votre PC</h1>
    <h3>offrez-lui des logiciels Professionnels</h3>
    <div class="clearfix">
      <div class="offer left">
        ...
        <div class="price">
          ...
          <a class="buybtn gray"
             href="https://www.iobit.com/buy.php?product=fr-asc133pc1999&ref=fr_asc133pc1999purchase2003<?php echo $refstr; ?>&aff=&refs=fr_purchase_asc"
             onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase2003a-fr');">
            <i class="all-icons"></i>
      ...
      <div class="offer big">
        ...
        <div class="price">
          ...
          <a class="buybtn"
             href="https://www.iobit.com/buy.php?product=fr-asc133pcpfiusd1999&ref=fr_asc133pcpfiusd1999purchase2003<?php echo $refstr; ?>&aff=&refs=fr_purchase_asc"
             onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase2003b-fr');">
            <i class="all-icons"></i>
            <span>VITE,J’EN PROFITE</span>
          </a>
        </div>
      ...
      <div class="offer right">
        ...
        <div class="price">
          ...
          <a class="buybtn gray"
             href="https://www.iobit.com/buy.php?product=fr-asc131pc1799&ref=fr_asc131pc1799purchase2003<?php echo $refstr; ?>&aff=&refs=fr_purchase_asc"
             onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase2003c-fr');">
            <i class="all-icons"></i>
            <span>VITE,J’EN PROFITE</span>
          </a>
        </div>
  ...
  <div class="wrapper">
    ...
    <div class="clearfix">
      <div class="giftlist">
        ...
        <h3>IObit Uninstaller 9 PRO <small>(1 an / 1 PC)</small></h3>
        <ul>
  ...
  <div class="pop-offer">
    ...
    <div class="price fr">
      ...
      <a class="buybtn greenbtn"
         href="https://www.iobit.com/buy.php?product=fr-asc133pcpfiusd1799&ref=fr_asc133pcpfiusd1799purchase2003<?php echo $refstr;?>&aff=&refs=fr_purchase_asc"
         onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchasepop2003-fr')">
        <i class="all-icons"></i>
        VITE,J’EN PROFITE
      </a>
    </div>
