...
function maskShow() {
  ...
  $('.main').append('<div class="mask"></div><div class="mask-box"><h2>Julöverraskning</h2><div class="clearfix"><div class="fl left"><img src="' + imgSrc + '" alt="Advanced SystemCare 12 Pro"/></div><div class="price"><h3>Extra <b>10kr</b> Rabatt bara för dig!</h3><p><strong>339<big>kr</big></strong> <span>1 År / 3 PC</span></p> <a class="buybtn" href="' + _href + '" onclick="' + _ga + '">Aktivera nu</a><p class="year">Missa inte din sista chans till största besparingen någonsin!</p></div></div></div>');
...
/*var countdown = function(countdown, tType) {
  ...
  $(countdown).each(function() {
    $(this).find('b').eq(1).html(i).end().eq(2).html(s).end().eq(3).html(mi);
  });
...
var countdown = function(countdown) {
  getCycleCountdown();
  $(countdown).find('b').eq(0).html(h).end().eq(1).html(i).end().eq(2).html(s).end().eq(3).html(mi);
...
$(window).on('scroll', function() {
  if ($(window).scrollTop() > $(".together").offset().top) {
