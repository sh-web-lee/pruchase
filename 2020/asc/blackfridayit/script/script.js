...
function soldOut() {
  ...
  $(".change").html('Siamo spiacenti, lo SCONTO del 72% è esaurito.');
  $(".change-price").html('<big>15</big>,99€');
  $(".floatlayer .change-price").html('15,99€');
  $(".banner .buybtn small").html('- 15,99€');
  $(".buybtn.soldout").attr({
    "href": _href,
    "onclick": _ga,
  });
...
function getRetime(isInit) {
  if(isInit==2){
    ...
    var packsNumTotal = cGet('itascnovbr_t');
    if (packsNumTotal > 1) {
