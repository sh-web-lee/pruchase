...
function soldOut() {
  ...
  $(".buybtn").attr({
    "href": 'http://www.iobit.com/buy.php?product=fr-asc14preorder1799&ref=fr_asc14preorderrcfreesoldout' + refStr + '&aff=' + aff + '&refs=purchase_asc&tw=-8',
    "onclick": "ga('send', 'event', 'ascbuy', 'buy', 'asc14preorder1799-fr') ;"
  });
}
...
function getReTime() {
  var packsNumTotal = cGet('frascrc_t');
  if (packsNumTotal > 1) {
