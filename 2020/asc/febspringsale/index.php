  ...
  <meta name="viewport" content="width=device-width,initial-scale=1">
	...
	<script>
        ...
        function pageDevice(targetUrl,cookieName){
            var param = (location.search === undefined) ? '' : location.search;
            targetUrl = targetUrl + param;
            if(cGet(cookieName) == 'tob'){
                window.location.href=targetUrl;
                return;
            }else{
                if(cGet(cookieName) == undefined){
        ...
        //pageDevice('springb.php','cookiename');
	</script>
...
<div class="banner">
  <!-- wrapper -->
	...
	<div class="message box ">
		<div class="top-message">
			...
			<p><strong>$<b>19</b>.99</strong>  was <del>$89.97</del></p>
       		<!-- buybtn -->
			<a class="buybtn"
           href="https://www.iobit.com/buy.php?product=asc133pc1999&ref=en-asc3pcspring<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=purchase_asc"
           onclick="ga('send', 'event', 'asc1999buy', 'buy', 'ascpurchase-2020spring');">
    ...
    <!-- asc bundle message -->
        ...
        <!-- buybtn -->
				<a class="buybtn"
           href="https://www.iobit.com/buy.php?product=asc13sdiuamc2198&ref=en-asc3pcsdiuamcspring<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=purchase_asc"
           onclick="ga('send', 'event', 'asc2198buy', 'buy', 'ascpurchase-2020spring');">
          <i></i> <span>Activate Now</span>
        </a>
  ...
  <div class="pop-container clearfix">
      ...
      <div class="message clearfix">
        <dl>
          ...
          <dd>
            ...
            <!-- buybtn -->
            <a class="buybtn"
               href="https://www.iobit.com/buy.php?product=asc133pc1799&ref=en-asc3pc1799popspring<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=purchase_asc"
               onclick="ga('send', 'event', 'asc1799buy', 'buy', 'ascpurchase-2020spring');">
              Get It Now
            </a>
            <ul>
        ...
        <dl>
          ...
          <dd>
            ...
            <a class="buybtn another"
               href="https://www.iobit.com/buy.php?product=asc13sdiuamc1978&ref=en-asc3pcsdiuamc1978popspring<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=purchase_asc"
               onclick="ga('send', 'event', 'asc1978buy', 'buy', 'ascpurchase-2020spring');">
              Get It Now
            </a>
            <ul>
    ...
    <dl class="message-soldout clearfix">
      ...
      <dd class="fl">
        ...
        <!-- buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=asc133pc1799&ref=en-asc3pc1799soldoutpopspring<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=purchase_asc "
           onclick="ga('send', 'event', 'asc1799soldbuy', 'buy', 'ascpurchase-2020spring');">
          Get It Now
        </a>
      </dd>
    </dl>
