  ...
  <header>
    ...
    <div class="content clearfix">
      ...
      <div class="message right">
        ...
        <!-- price -->
        <p class="price"><big>17</big> <del>149,92€</del></p>
        <!-- buybtn -->
        <a class="buybtn" href="https://www.iobit.com/buy.php?product=es-asc143pciusdpf1799&ref=es_asc143pciusdpf1799purchase2011<?= $refStr; ?>&refs=es_purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'asc3pcpurchase2011-es')">
  ...
  <div id="floatlayer" class="floatlayer">
    <div class="ayer">
      ...
      <div style="  color: #FFF4C7;font-size: 21px;">
        <i style="font-size: 21px;color: #FFFFFF;; ">88%</i> DTO y regalos exclusivos del Año Nuevo para Advanced SystemCare PRO
      </div>
      <div class="text">
        <p style="margin-top: -35px;"><span>17<strong>,99€</strong> <b></b><i>149,92€</i></span> </p>
        <p>
          <a href="https://www.iobit.com/buy.php?product=es-asc143pciusdpf1799&ref=es_asc143pciusdpf1799purchase2011<?= $refStr; ?>&refs=es_purchase_asc" target="_blank">
            <button onclick="ga('send', 'event', 'ascbuy', 'buy', 'asc3pcpurchase2011-es')">
