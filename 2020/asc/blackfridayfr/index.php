...
if ($_GET['action'] == 'getPacks') {
    $date = $_GET['d'];
    $c_name = 'frblackfriday_p' . $date;
    $c_name_t = 'frblackfriday_t' . $date;
    $isInit = $_GET['isInit'];
...
<body>
  ...
  <div class="banner">
    <div class="wrapper">
      ...
      <div class="price clearfix">
        ...
        <div class="btnbox fl">
          <a class="buybtn"
             href="https://www.iobit.com/buy.php?product=fr-asc143pc1499&ref=fr_asc143pc1499bf2020<?php echo $refStr;?>&refs=fr_purchase_asc"
             onclick="ga('send', 'event', 'ascbuy', 'buy', 'asc3pc1499bf2020-fr');">
              <?= $content[11]; ?>
          </a>
          <p><?= $content[12]; ?></p>
        </div>
  ...
  <div id="feature" class="feature">
    <div class="wrapper">
      ...
      <div class="price">
        <p><strong class="change-price"><?= $content[52]; ?></p>
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=fr-asc143pc1499&ref=fr_asc143pc1499bf2020<?php echo $refStr;?>&refs=fr_purchase_asc"
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'asc3pc1499bf2020-fr');">
            <?= $content[53]; ?>
  ...
  <div id="floatlayer" class="floatlayer">
    <div class="wrapper clearfix">
      ...
      <div class="price fl">
        <strong class="change-price"><?= $content[91]; ?></strong> <del class="original"><?= $content[92]; ?></del>
        <p><?= $content[93]; ?></p>
      </div>
      <a class="buybtn fr"
         href="https://www.iobit.com/buy.php?product=fr-asc143pc1499&ref=fr_asc143pc1499bf2020<?php echo $refStr;?>&refs=fr_purchase_asc"
  ...
  <script>
    ...
    var soldStr = '<?= $content[95]; ?>';
    var _href = "https://www.iobit.com/buy.php?product=fr-asc143pc1699&ref=fr_asc143pc1699bf2020<?= $refStr; ?>&refs=fr_purchase_asc&tw=-8";
    var _ga = "ga('send', 'event', 'ascbuy', 'buy', 'asc3pc1699bf2020-fr');";
  </script>
