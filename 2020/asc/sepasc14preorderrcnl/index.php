...
if ($_GET['action'] == 'getPacks') {
  $date = $_GET['d'];
  $c_name = 'nlascrc_p' . $date;
  $c_name_t='nlascrc_t' . $date;
...
<!--        <span>--><?php //echo $content[3]; ?><!--</span>-->
          <strong>€<b>14</b>,99</strong> <del>€49,99</del>
        <a href="https://www.iobit.com/buy.php?product=nl-asc14preorder1499&ref=nl_asc14preorderrc1499<?php echo $refStr; ?>&aff=<?php echo $_GET['aff'];?>&refs=nl_purchase_asc" 
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'asc14preorderrc-nl');" class="buybtn"><?php echo $content[4]; ?></a>
      </div>
    </div>
  </div>
</div>
...
<div class="feature-main">
  ...
  <div class="feature feature03 wrapper clearfix" data-name='animation'>
	  ...
	  <table>
		  ...
		  <tr>
		  	  <td><span class="olduser_othico12"></span><?= $content[66]; ?></td>
		  	  <td></td>
		  	  <td class="olduser_cor"></td>
		  </tr>
		  <tr>
		  	  <td><span class="olduser_othico13"></span><?= $content[67]; ?></td>
		  	  <td></td>
		  	  <td class="olduser_cor"></td>
		  </tr>
		  <tr>
...
<div id="floatlayer" class="floatlayer">
  <div class="wrapper clearfix">
    ...
    <div class="price">
        <strong>€<b>14</b>,99</strong> <del>€49,99</del>
        <a href="https://www.iobit.com/buy.php?product=nl-asc14preorder1499&ref=nl_asc14preorderrc1499<?php echo $refStr; ?>&aff=<?php echo $_GET['aff'];?>&refs=nl_purchase_asc" 
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'asc14preorderrc-nl');" class="buybtn"><?php echo $content[61]; ?></a>
      </div>
  </div>
</div>
<!-- floatlayer end -->
