...
<body>
  ...
  <div class="main">
        ...
        <div class="palen clearfix">
          ...
          <div class="right fr">
            ...
            <div class="price">
              ...
              <a class="buybtn" href="https://www.iobit.com/buy.php?product=2020asc3pc1477&ref=br_asc<?= $refStr; ?>&refs=purchase_ascbf" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase-bf');">
                <div class="inner">
                  <i class="all-icons"></i>
	...
	<div class="floatlayer">
	    <div class="wrapper clearfix">
	      ...
	      <div class="exc fl">
	        <div class="count">
	          <h5>Get Exclusive <span>70% OFF</span> to Your PC for a Whole Year.</h5>
  ...
  <script>
    ...
    var _href = "https://www.iobit.com/buy.php?product=2020asc3pc1377&ref=br_asc1377" + refStr + "&refs=purchase_ascbf&tw=-8";
