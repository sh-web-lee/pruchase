...
if ($_GET['action'] == 'getPacks') {
    $date = $_GET['d'];
    $c_name = 'esblackfrid_p' . $date;
    $c_name_t = 'esblackfrid_t' . $date;
    $isInit = $_GET['isInit'];
...
<div class="banner">
    <div class="wrapper">
        ...
        <div class="chart">
            <div class="chartbox bigg one"><span><?= $content[5]; ?></span></div>
            <div class="chartbox big two"><span><?= $content[6]; ?></span></div>
            <div class="chartbox center three"><span><?= $content[7]; ?></span></div>
            <div class="chartbox big four"><span><?= $content[8]; ?></span>
            </div>
            <div class="chartbox bigg five"><span><?= $content[9]; ?></span></div>
        </div>
        <div class="price clearfix">
            ...
            <div class="btnbox fl">
                <a class="buybtn"
                   href="https://www.iobit.com/buy.php?product=es-asc143pc1399&ref=es_asc143pc1399bf2010<?php echo $refStr; ?>&refs=es_purchase_asc"
                   onclick="ga('send', 'event', 'ascbuy', 'buy', 'asc143pc1399bf2010-es');">
                    <?= $content[11]; ?>
                </a>
                <p><?= $content[12]; ?></p>
            </div>
    ...
    <div class="wrapper">
        ...
        <div class="review">
            <div id="dg-container" class="dg-container">
                ...
                <ul>
                    <li class="first" data-num="4"><img src="<?php echo getStaticUrl('images/tony-fisher.png') ?>"
                                                        alt="Tony Fisher"></li>
                    <li class="two" data-num="5"><img src="<?php echo getStaticUrl('images/daniel-sanders.png') ?>"
                                                      alt="Daniel Sanders"></li>
                    <li class="three" data-num="6"><img src="<?php echo getStaticUrl('images/richard-preston.png') ?>"
                                                        alt="Richard Preston"></li>
                    <li class="active" data-num="0"><img src="<?php echo getStaticUrl('images/cnet.png') ?>" alt="Cnet">
                    </li>
                    <li class="four" data-num="1"><img src="<?php echo getStaticUrl('images/richard-beavers.png') ?>"
                                                       alt="Richard Beavers"></li>
                    <li class="five" data-num="2"><img src="<?php echo getStaticUrl('images/patsy-clark.png') ?>"
                                                       alt="Patsy Clark"></li>
                    <li class="six last" data-num="3"><img src="<?php echo getStaticUrl('images/danny-r-sheets.png') ?>"
                                                           alt="Danny R. Sheets"></li>
                </ul>
            </div>
        </div>
    </div>
...
<script>
    ...
    soldStr = "<?php echo $content[95];?>";
    var _href = "https://www.iobit.com/buy.php?product=es-asc143pc1599&ref=es_asc143pc1599bf2010<?php echo $refStr;?>&refs=es_purchase_asc";
    var _ga = "ga('send', 'event', 'ascbuy', 'buy', 'asc143pc1599bf2010-es');";
</script>
