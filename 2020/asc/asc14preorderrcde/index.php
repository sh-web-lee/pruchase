...
if ($_GET['action'] == 'getPacks') {
  $date = $_GET['d'];
  $c_name = 'deascrc_p' . $date;
  $c_name_t='deascrc_t' . $date;
  ...
  <div class="wrapper">
    ...
    <div class="right-message">
      ...
      <div class="price">
        ...
        <a href="https://www.iobit.com/buy.php?product=de-asc14preorder&ref=de_asc14preorderrc<?php echo $refStr; ?>&aff=<?php echo $_GET['aff'];?>&refs=de_purchase_asc" 
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'asc14predorderrc-de');" class="buybtn"><?php echo $content[4]; ?></a>
      </div>
    </div>
  </div>
</div>
...
<div id="floatlayer" class="floatlayer">
  <div class="wrapper clearfix">
    ...
    <div class="price">
        <strong><b>0</b>€ <sup>*</sup></strong>
        <a href="https://www.iobit.com/buy.php?product=de-asc14preorder&ref=de_asc14preorderrc<?php echo $refStr; ?>&aff=<?php echo $_GET['aff'];?>&refs=de_purchase_asc" 
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'asc14predorderrc-de');" class="buybtn"><?php echo $content[61]; ?></a>
      </div>
  </div>
</div>
<!-- floatlayer end -->
