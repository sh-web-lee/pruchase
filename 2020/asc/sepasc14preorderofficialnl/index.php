...
if ($_GET['action'] == 'getPacks') {
  $date = $_GET['d'];
  $c_name = 'nlascoff_p' . $date;
  $c_name_t='nlascoff_t' . $date;
  ...
  <div class="wrapper">
    ...
    <div class="right-message">
      ...
      <div class="price">
        ...
        <a href="https://www.iobit.com/buy.php?product=nl-asc14preorder1499&ref=nl_asc14preorderofficial1499<?php echo $refStr; ?>&aff=<?php echo $_GET['aff'];?>&refs=nl_purchase_asc"
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'asc14preorderofficial-nl');" class="buybtn"><?php echo $content[4]; ?></a>
      </div>
    </div>
  </div>
</div>
...
<div id="floatlayer" class="floatlayer">
  <div class="wrapper clearfix">
    ...
    <div class="price">
        <strong>€<b>14</b>,99</strong> <del>€49,99</del>
        <a href="https://www.iobit.com/buy.php?product=nl-asc14preorder1499&ref=nl_asc14preorderofficial1499<?php echo $refStr; ?>&aff=<?php echo $_GET['aff'];?>&refs=nl_purchase_asc"
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'asc14preorderofficial-nl');" class="buybtn"><?php echo $content[55]; ?></a>
      </div>
  </div>
</div>
<!-- floatlayer end -->
