...
function getCycleCountdown () {
  var date=new Date();
  if (MApp(2.2).cookie.get('xmasfrasc2020')) {
    dt = MApp(2.2).cookie.get('xmasfrasc2020');

  }else{
    dt=date.setMinutes(date.getMinutes()+12);
    MApp(2.2).cookie.set('xmasfrasc2020', dt);
  }
...
function getPacksNum(){
  var e = new Date;
  var n1 = MApp(2.2).cookie.get('xmasfrasc2020')/1000;
...
function soldOut() {
  ...
  $(".largeolsa em").html("30");
  $(".largeold em").html("49.99");
  $(".message-tips").hide();
  //bottom-buy
