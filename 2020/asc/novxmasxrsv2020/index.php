...
if ($_GET['action'] == 'getPacks') {
  $date = $_GET['d'];
  $c_name = 'novxmasxrsv2020_p' . $date;
  $c_name_t = 'novxmasxrsv2020_t' . $date;
...
<head>
  ...
  <title>Spara upp till 89% på Advanced SystemCare PRO och få ett gåvopaket – IObit  </title>
...
<body>
  <header>
    ...
    <div style="text-align: center;">
      ...
      <p style="margin-top: -41px;font-size: 20px; color: #442325;font-weight: 600;">Bästa chansen att spara stort – bara en gång per år!</p>
    </div>
    <div class="box">
      <div class="box1">
        ...
        <a href="https://www.iobit.com/buy.php?product=sv-asc141pc249&ref=sv_asc141pc249purchase2011xr<?= $refStr; ?>&refs=sv_purchase_asc">
          <button onclick="ga('send', 'event', 'ascbuy', 'buy', 'asc1pcpurchase2011xr-sv')">KÖP PRO</button></a>
      </div>
      <div class="box2">
        <div class="boxinser">
          <img src="<?= $pResUrl; ?>images/ASCbox.png" alt="" class="postimg">
          <h1>-89%</h1>
          <h3>239<i>kr</i> <span>2 096kr</span></h3>
          <a href="https://www.iobit.com/buy.php?product=sv-asc143pcsdpfisu239&ref=sv_asc143pcsdpfisu239purchase2011xr<?= $refStr; ?>&refs=sv_purchase_asc">
            <button onclick="ga('send', 'event', 'ascbuy', 'buy', 'asc3pcsdpfisupurchase2011xr-sv')">KÖP PRO</button></a>
  ...
  <aside>
    <div>
      ...
      <span style="font-size: 38px; font-weight: 600; color: #233653;;margin-left: 22px;">
        Spara upp till 89% rabatt på Advanced SystemCare pro och få en gratis paket</span>
    </div>
    <div class="asibox">
      <ul>
        <li>
          <div><img src="<?= $pResUrl; ?>images/isu.png" alt=""></div>
  ...
  <div id="floatlayer" class="floatlayer">
    <div class="ayer">
      ...
      <div style="  color: #FFF4C7;font-size: 21px;">
        Spara upp till <i style="font-size: 21px;color: #FFFFFF;; ">89%</i> rabatt på Advanced SystemCare pro och få en gratis paket
      </div>
      <div class="text">
        <p style="margin-top: -35px;"><span>239<strong>kr</strong> <i>2 096kr</i></span> </p>
        <p>
          <a href="https://www.iobit.com/buy.php?product=sv-asc143pcsdpfisu239&ref=sv_asc143pcsdpfisu239purchase2011xr<?= $refStr; ?>&refs=sv_purchase_asc">
            <button onclick="ga('send', 'event', 'ascbuy', 'buy', 'asc3pcsdpfisupurchase2011xr-sv')">
              KÖP PRO</button>
          </a>
        </p>
