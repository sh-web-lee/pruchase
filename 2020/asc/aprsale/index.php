...
$se = $data->se!=0?$data->se:'';
$ps = $data->ps!=0?$data->ps:'';
$st = $data->st!=0?$data->st:'';
...
<div class="banner">
  <!-- wrapper -->
    ...
    <!-- title -->
	<div class="title">
		<h1><span class="title-left">fix</span> <strong></strong> <span class="title-right">More Problems Now</span></h1>
	</div>
    <!-- asc message -->
	<div class="message box ">
		<div class="top-message">
			...
			<p><strong>$<b>19</b>.99</strong>  was <del>$89.97</del></p>
       		<!-- buybtn -->
			<a class="buybtn"
           href="https://www.iobit.com/buy.php?product=asc133pc1999&ref=en-asc3pcmar<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=purchase_asc"
           onclick="ga('send', 'event', 'asc1999buy', 'buy', 'ascpurchase-2020mar');">
    ...
    <!-- asc bundle message -->
        ...
        <!-- buybtn -->
				<a class="buybtn"
           href="https://www.iobit.com/buy.php?product=asc13sdiuamc2198&ref=en-asc3pcsdiuamcmar<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=purchase_asc"
           onclick="ga('send', 'event', 'asc2198buy', 'buy', 'ascpurchase-2020mar');">
          <i></i> <span>Activate Now</span>
        </a>
			...
			<p>$127.96 Saved</p>
      <p class="nomal">Advanced SystemCare Pro   <del>$89.97</del></p>
      <p class="nomal">IObit Uninstaller 9 Pro   <del>$19.99</del></p>
...
<div class="asc-message">
	<div class="wrapper">
      ...
      <!-- 200%* -->
          ...
          <span class="note"><b><?php echo $ps;?></b> items are slowing down your computer now.</span>
				</dd>
			</dl>
      <!-- 300%* -->
			<dl class="two">
      ...
      <!-- Deeper -->
          ...
          <span class="note"><b><?php echo $se;?></b> existing system errors may affect<br> computer performance.</span>
				</dd>
			</dl>
      <!-- Auto -->
			<dl class="four">
      ...
      <!-- Privacy Security -->
          ...
          <span class="note"><b><?php echo $st;?></b> security threats need to be removed now.</span>
				</dd>
			</dl>
      <!-- Safer Browsing -->
      <dl class="six">
...
<div class="floatlayer" id="floatlayer">
	<div class="wrapper clearfix">
		<div class="img-box">
      <img src="<?php echo getStaticUrl('images/fl-gift-box.png')?>" alt=""/>  
    </div>
    <div class="float-center">
      <h2><big>85%</big> <span>OFF to Fix Following Problems Now</span></h2>
      <ul class="float-list">
        <li><b><?php echo $se;?></b> system errors</li>
        <li class="center"><b><?php echo $ps;?></b> items slowing down PC</li>
        <li><b><?php echo $st;?></b> security threats</li>
      </ul>
    </div>
		<div class="right">
			<a class="buybtn"
  ...
  <div class="pop-container clearfix">
      ...
      <div class="message clearfix">
        <dl>
          ...
          <dd>
            ...
            <!-- buybtn -->
            <a class="buybtn"
               href="https://www.iobit.com/buy.php?product=asc133pc1799&ref=en-asc3pc1799popmar<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=purchase_asc"
               onclick="ga('send', 'event', 'asc1799buy', 'buy', 'ascpurchase-2020mar');">
              Get It Now
            </a>
            <ul>
        ...
        <dl>
          ...
          <dd>
            ...
            <a class="buybtn another"
               href="https://www.iobit.com/buy.php?product=asc13sdiuamc1978&ref=en-asc3pcsdiuamc1978popmar<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=purchase_asc"
               onclick="gga('send', 'event', 'asc1978buy', 'buy', 'ascpurchase-2020mar');">
              Get It Now
            </a>
            <ul>
    ...
    <dl class="message-soldout clearfix">
      ...
      <dd class="fl">
        ...
        <!-- buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=asc133pc1799&ref=en-asc3pc1799soldoutpopmar<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=purchase_asc"
           onclick="ga('send', 'event', 'asc1799soldbuy', 'buy', 'ascpurchase-2020mar');">
          Get It Now
        </a>
      </dd>
    </dl>
...
<script>
  ...
  var imgSrc = "<?php echo getStaticUrl('images/fl-asc-box.png')?>";
</script>
