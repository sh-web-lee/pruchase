...
function soldOut() {
  ...
  $(".buybtn").attr({
    "href": 'http://www.iobit.com/buy.php?product=it-asc14preorder1799&ref=it_asc14preorderexpiredsoldout' + refStr + '&aff=' + aff + '&refs=it_purchase_asc&tw=-8',
    "onclick": "ga('send', 'event', 'ascbuy', 'buy', 'asc14preorderexpsoldout-it');"
  });
}
...
function getReTime() {
  var packsNumTotal = cGet('itascexpir_t');
  if (packsNumTotal > 1) {
