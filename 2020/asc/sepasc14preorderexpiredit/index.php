...
if ($_GET['action'] == 'getPacks') {
  $date = $_GET['d'];
  $c_name = 'itascexpir_p' . $date;
  $c_name_t='itascexpir_t' . $date;
...
if($junk == "0.00"){
    $content[6] = "Eliminato file inutili per un PC più pulito";
}
if($data['reg'] == 1){
    $content[7] = "Eliminato <span>1</span> registro per un PC più fluido";
}
if($data['antitrack'] == 1){
    $content[10] = "Cancellato <span>1</span> traccia online per una maggiore sicurezza online";
}
if($data['program'] == 1){
    $content[11] = "Bloccato <span>1</span> accesso non attendibile per mantenere al sicuro i tuoi dati";
}
  ...
  <div class="wrapper">
    ...
    <div class="right-message">
      ...
      <div class="price">
        ...
        <a href="http://www.iobit.com/buy.php?product=it-asc14preorder&ref=it_asc14preorderexpired<?php echo $refStr; ?>&aff=<?php echo $_GET['aff'];?>&refs=it_purchase_asc"
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'asc14preorderexp-it');" class="buybtn"><?php echo $content[4]; ?></a>
      </div>
    </div>
  </div>
</div>
...
<div id="floatlayer" class="floatlayer">
  <div class="wrapper clearfix">
    ...
    <div class="price">
        <strong><b>0</b>€ <sup>*</sup></strong>
        <a href="http://www.iobit.com/buy.php?product=it-asc14preorder&ref=it_asc14preorderexpired<?php echo $refStr; ?>&aff=<?php echo $_GET['aff'];?>&refs=it_purchase_asc"
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'asc14preorderexp-it');" class="buybtn"><?php echo $content[49]; ?></a>
      </div>
  </div>
</div>
<!-- floatlayer end -->
