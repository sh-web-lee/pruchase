...
if ($_GET['action'] == 'getPacks') {
  $date = $_GET['d'];
  $c_name = 'esascoff_p' . $date;
  $c_name_t='esascoff_t' . $date;
  ...
  <div class="wrapper">
    ...
    <div class="right-message">
      ...
      <div class="price">
        ...
        <a href="http://www.iobit.com/buy.php?product=es-asc14preorder&ref=es_asc14preorderofficial<?php echo $refStr; ?>&aff=<?php echo $_GET['aff'];?>&refs=es_purchase_asc"
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'asc14preorderofficial-es');" class="buybtn"><?php echo $content[4]; ?></a>
      </div>
    </div>
  </div>
</div>
...
<div id="floatlayer" class="floatlayer">
  <div class="wrapper clearfix">
    ...
    <div class="price">
        <strong><b>0</b>€<sup>*</sup></strong>
        <a href="http://www.iobit.com/buy.php?product=es-asc14preorder&ref=es_asc14preorderofficial<?php echo $refStr; ?>&aff=<?php echo $_GET['aff'];?>&refs=es_purchase_asc"
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'asc14preorderofficial-es');" class="buybtn"><?php echo $content[55]; ?></a>
      </div>
  </div>
</div>
<!-- floatlayer end -->
