...
if ($_GET['action'] == 'getPacks') {
  $date = $_GET['d'];
  $c_name = 'ptascoff_p' . $date;
  $c_name_t='ptascoff_t' . $date;
  ...
  <div class="wrapper">
    ...
    <div class="right-message">
      ...
      <div class="price">
        ...
        <strong>R$<b>66</b>,99 <sup></sup></strong>
        <a href="http://www.iobit.com/buy.php?product=pt-asc14preorder6699&ref=pt-asc14preorderofficial<?php echo $refStr; ?>&aff=<?php echo $_GET['aff'];?>&refs=pt_purchase_asc"
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'asc14preorderofficial-pt');" class="buybtn"><?php echo $content[4]; ?></a>
      </div>
    </div>
  </div>
</div>
...
<div id="floatlayer" class="floatlayer">
  <div class="wrapper clearfix">
    ...
    <div class="price">
        <strong>R$<b>66</b>,99 <sup></sup></strong>
        <a href="http://www.iobit.com/buy.php?product=pt-asc14preorder6699&ref=pt-asc14preorderofficial<?php echo $refStr; ?>&aff=<?php echo $_GET['aff'];?>&refs=pt_purchase_asc"
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'asc14preorderofficial-pt');" class="buybtn"><?php echo $content[55]; ?></a>
      </div>
  </div>
</div>
<!-- floatlayer end -->
