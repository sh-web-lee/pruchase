...
function soldOut() {
  ...
  $(".price strong").html("R$<b>76</b>,99")
  $(".banner h1").html(soldout_banner)
  $(".banner .numbox").remove();
  $(".floatlayer .numbox").html(soldout_float).css('margin-top', '8px')
  $(".buybtn").attr({
    "href": 'http://www.iobit.com/buy.php?product=pt-asc14preorder7699&ref=pt-asc14preorderofficialsoldout'+refStr+'&aff=' + aff + '&refs=pt_purchase_asc&tw=-8',
    "onclick": "ga('send', 'event', 'asc3pcbuy', 'buy', 'asc14preorderofficial-pt');"
  });
}
...
function getReTime() {
  var packsNumTotal = cGet('ptascoff_t');
  if (packsNumTotal > 1) {
