...
function soldOut() {
  ...
  $(".buybtn").attr({
    "href": 'http://www.iobit.com/buy.php?product=sv-asc14preorder299&ref=sv_asc14preorderofficialsoldout' + refStr + '&aff=' + aff + '&refs=sv_purchase_asc',
    "onclick": "ga('send', 'event', 'asc3pcbuy', 'buy', 'asc14preorderofficial-sv');"
  });
  $('.floatlayer .numbox').css('margin-top','7px')
}
...
function getReTime() {
  var packsNumTotal = cGet('svascoff_t');
  if (packsNumTotal > 1) {
