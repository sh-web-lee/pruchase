...
if ($_GET['action'] == 'getPacks') {
  $date = $_GET['d'];
  $c_name = 'svascoff_p' . $date;
  $c_name_t='svascoff_t' . $date;
  ...
  <div class="wrapper">
    ...
    <div class="right-message">
      ...
      <div class="price">
        ...
        <a href="http://www.iobit.com/buy.php?product=sv-asc14preorder&ref=sv_asc14preorderofficial<?php echo $refStr; ?>&aff=<?php echo $_GET['aff'];?>&refs=sv_purchase_asc"
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'asc14preorderofficial-sv');" class="buybtn"><?php echo $content[4]; ?></a>
      </div>
    </div>
  </div>
</div>
...
<div class="bottom-bg">
  ...
  <div class="review wrapper">
    ...
    <ul>
      <li><img src="<?php echo getStaticUrl('images/cnet01.png')?>" alt="Cnet"> </li>
      <li><img src="<?php echo getStaticUrl('images/bruce-ramsay.png')?>" alt="Bruce Ramsay"> </li>
      <li class="active"><img src="<?php echo getStaticUrl('images/hank-ewert.png')?>" alt="Hank Ewert"> </li>
...
<div id="floatlayer" class="floatlayer">
  <div class="wrapper clearfix">
    ...
    <div class="price">
        <strong><b>0</b>kr<sup>*</sup></strong>
        <a href="http://www.iobit.com/buy.php?product=sv-asc14preorder&ref=sv_asc14preorderofficial<?php echo $refStr; ?>&aff=<?php echo $_GET['aff'];?>&refs=sv_purchase_asc"
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'asc14preorderofficial-sv');" class="buybtn"><?php echo $content[55]; ?></a>
      </div>
  </div>
</div>
<!-- floatlayer end -->
