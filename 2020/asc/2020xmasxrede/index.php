    ...
    <div class="asc-box">
      <ul>
        <li>
          ...
          <h2>Intelligenter</h2>
          <p>Der neue AI-Modus kann Ihren PC vollständig nach Bedarf optimieren</p>
        </li>
        <li>
          <div class="po"><img src="<?= $pResUrl; ?>images/icon 2.png" alt=""></div>
          <h2>Sauberer</h2>
          <p>Entfernt 50% mehr Junk-Dateien für ein sauber System</p>
        </li>
        <li>
        ...
        <li>
          ...
          <h2>Up-to-date</h2>
          <p>Hält 33% mehr wichtige Software auf dem neuesten Stand, damit Hacker Schwachstellen nicht missbrauchen können.</p>
        </li>
      </ul>
    </div>
  </div>
  <div class="sect">
    ...
    <div class="contains">
      <table>
        ...
        <tr>
          <td>Ihr PC <b>reagiert langsam</b> und lässt Sie warten</td>
          <td>Komplette Systemreinigung für einen <b>schnelleren PC</b></td>
        </tr>
        <tr>
          <td>Instabile Internetverbindung und <b>lange Ladezeit von Seiten</b> </td>
          <td>Browseroptimierung für eine bis zu <b>300% schnellere Internetverbindung</b></td>
        </tr>
        <tr>
          <td>Instabiles System <b> fällt aus oder einfriert </b> ab und zu</td>
          <td>Gründliche Register-Reinigung für ein stabiles <b>System</b></td>
        </tr>
        ...
        <tr>
          <td>Programme können auf <b>Ihre persönlichen Daten</b> zugreifen</td>
          <td><b>Voller Schutz der Privatsphäre,</b> um nicht vertrauenswürdige Programme zu blockieren</td>
        </tr>
        <tr>
          <td>Ihr PC kann <b>große Software ausführen</b></td>
          <td>Durch automatische RAM-Bereinigung <b> läuft</b> Ihr PC <b>reibungslos</b></td>
        </tr>
        <tr>
          <td>Spyware kann in Ihren PC eindringen und <b>Ihre Daten stehlen</b></td>
          <td><b>Echtzeitschutz,</b> der Spyware und andere Malware von Ihrem PC fernhält</td>
        </tr>
      </table>
    </div>
