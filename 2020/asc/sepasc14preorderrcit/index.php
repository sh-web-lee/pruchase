...
if ($_GET['action'] == 'getPacks') {
  $date = $_GET['d'];
  $c_name = 'itascrc_p' . $date;
  $c_name_t='itascrc_t' . $date;
  ...
  <div class="wrapper">
    ...
    <div class="right-message">
      ...
      <div class="price">
        ...
        <a href="https://www.iobit.com/buy.php?product=it-asc14preorder&ref=it_asc14preorderrc<?php echo $refStr; ?>&aff=<?php echo $_GET['aff'];?>&refs=it_purchase_asc" 
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'asc14predorderrc-it');" class="buybtn"><?php echo $content[4]; ?></a>
      </div>
    </div>
  </div>
</div>
...
<div id="floatlayer" class="floatlayer">
  <div class="wrapper clearfix">
    ...
    <div class="price">
        <strong><b>0</b>€ <sup>*</sup></strong>
        <a href="https://www.iobit.com/buy.php?product=it-asc14preorder&ref=it_asc14preorderrc<?php echo $refStr; ?>&aff=<?php echo $_GET['aff'];?>&refs=it_purchase_asc" 
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'asc14predorderrc-it');" class="buybtn"><?php echo $content[61]; ?></a>
      </div>
  </div>
</div>
<!-- floatlayer end -->
