...
function soldOut() {
  ...
  $(".buybtn").attr({
    "href": 'https://www.iobit.com/buy.php?product=it-asc14preorder1799&ref=it_asc14preorderrcsoldout' + refStr + '&aff=' + aff + '&refs=it_purchase_asc&tw=-8',
    "onclick": "ga('send', 'event', 'ascbuy', 'buy', 'asc14predorderrcsoldout-it');"
  });
}
...
function getReTime() {
  var packsNumTotal = cGet('itascrc_t');
  if (packsNumTotal > 1) {
