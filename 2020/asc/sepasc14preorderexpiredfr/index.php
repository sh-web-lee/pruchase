...
if ($_GET['action'] == 'getPacks') {
  $date = $_GET['d'];
  $c_name = 'frascexpir_p' . $date;
  $c_name_t='frascexpir_t' . $date;
...
if($junk == "0.00"){
    $content[6] = "Suppression de de fichiers inutiles pour un PC plus propre";
}
?>
<!DOCTYPE html>
<html lang="en">
  ...
  <div class="wrapper">
    ...
    <div class="right-message">
      ...
      <div class="price">
        ...
        <a href="http://www.iobit.com/buy.php?product=fr-asc14preorder&ref=fr_asc14preorderexpired<?php echo $refStr; ?>&aff=<?php echo $_GET['aff'];?>&refs=fr_purchase_asc"
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'asc14preorderexpired-fr');" class="buybtn"><?php echo $content[4]; ?></a>
      </div>
    </div>
  </div>
</div>
...
<div id="floatlayer" class="floatlayer">
  <div class="wrapper clearfix">
    ...
    <div class="price">
        <strong><b>0</b>€ <sup>*</sup></strong>
        <a href="http://www.iobit.com/buy.php?product=fr-asc14preorder&ref=fr_asc14preorderexpired<?php echo $refStr; ?>&aff=<?php echo $_GET['aff'];?>&refs=fr_purchase_asc"
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'asc14preorderexpired-fr');" class="buybtn"><?php echo $content[49]; ?></a>
      </div>
  </div>
</div>
<!-- floatlayer end -->
