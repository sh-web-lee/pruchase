...
function soldOut() {
  ...
  $(".price strong").html("<b>74</b>,90zł")
  $(".banner h1").html(soldout_banner)
  $(".banner .numbox").remove();
  $(".floatlayer .numbox").html(soldout_float)
  $(".buybtn").attr({
    "href": 'https://www.iobit.com/buy.php?product=pl-asc14preorder74&ref=pl_asc14preorderrcsoldout'+refStr+'&aff=' + aff + '&refs=pl_purchase_asc&tw=-8',
    "onclick": "ga('send', 'event', 'ascbuy ', 'buy', 'asc14predorderrc-pl')"
  });
}
...
function getReTime() {
  var packsNumTotal = cGet('plascrc_t');
  if (packsNumTotal > 1) {
