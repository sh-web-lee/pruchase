function packNum(number, starnumber) {
  ...
  function soldOut() {
    ...
    $(".buybtn").attr({
      "href": 'http://www.iobit.com/buy.php?product=asc14preorder1677&ref=en-asc14preorderofficialsoldout'+refStr+'&aff=' + aff + '&refs=purchase_asc&tw=-8',
      "onclick": "ga('send', 'event', 'asc3pcbuy', 'buy', 'asc14preorderofficial');"
    });
  }
  ...
  function getSales(isInit) {
    ...
    $.ajax({
      type: "GET",
      url: "http://192.168.6.245/purchase.iobit.com/es/asc/asc14preorderofficial.php",
