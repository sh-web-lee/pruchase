...
function soldOut() {
  ...
  $(".buybtn").attr({
    "href": 'http://www.iobit.com/buy.php?product=es-asc14preorder1799&ref=es_asc14preorderexpiredsoldout' + refStr + '&aff=' + aff + '&refs=es_purchase_asc&tw=-8',
    "onclick": "ga('send', 'event', 'asc3pcbuy', 'buy', 'asc14preorderexpired-es');"
  });
}
...
function getReTime() {
  var packsNumTotal = cGet('esascexpir_t');
  if (packsNumTotal > 1) {
