...
<head>
  ...
  <title>Adquira Advanced SystemCare 14 Pro com 80% de desconto e leve dois super brindes para o seu computador. Oferta Especial de Natal da IObit. </title>
    ...
    <div class="panel clearfix">
      ...
      <ul>
        ...
        <li class="price">
          ...
          <!-- 1pc buybtn -->
          <a class="buybtn"
             href="https://www.iobit.com/buy.php?product=pt-asc141pc7499&ref=pt_asc14purchase1pc2011rc<?php echo $refStr;?>&refs=pt_purchase_asc"
             onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase2011rc-pt');">
            COMPRAR AGORA
          </a>
        </li>
      </ul>
      ...
      <ul class="asc3pcs">
        ...
        <li class="off">
          <h2>80% OFF</h2>
          <p>(De: <del>399,98</del> Por: 66,99)</p>
        </li>
        <!-- price -->
        <li class="price">
          <p>ou 6x de <strong>R$ 11,17</strong></p>
          <p>Sem juros no cartão</p>
          <!-- 3pcs buybtn -->
          <a class="buybtn red"
             href="https://www.iobit.com/buy.php?product=pt-asc143pciusd6699&ref=pt_asc14purchase3pcsdiu2011rc<?php echo $refStr;?>&refs=pt_purchase_asc"
             onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase2011rc-pt');">
            COMPRAR AGORA
          </a>
        </li>
...
<div class="bottombuy">
  <div class="wrapper clearfix">
    ...
    <ul>
      <!-- 3pcs -->
      <li class="active"
          data-url="https://www.iobit.com/buy.php?product=pt-asc143pciusd6699&ref=pt_asc14purchase3pcsdiu2011rc<?php echo $refStr;?>&refs=pt_purchase_asc"
          data-ga="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase2011rc-pt');"
          data-price="66"
      ...
      <!-- 1pc -->
      <li class=""
          data-url="https://www.iobit.com/buy.php?product=pt-asc141pc7499&ref=pt_asc14purchase1pc2011rc<?php echo $refStr;?>&refs=pt_purchase_asc"
          data-ga="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase2011rc-pt');"
          data-price="74"
    ...
    <dl>
      <dd>
        <p class="price">R$ <strong>66</strong>,99 <del> 399,98</del></p>
      </dd>
      <dd>
        <!-- 3pcs buybtn -->
        <a class="buybtn red"
        &refs=pt_purchase_asc
           href="https://www.iobit.com/buy.php?product=pt-asc143pciusd6699&ref=pt_asc14purchase3pcsdiu2011rc<?php echo $refStr;?>&refs=pt_purchase_asc"
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase2011rc-pt');">
          COMPRAR AGORA
        </a>
