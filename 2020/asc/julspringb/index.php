	...
	<div class="wrapper">
      ...
      <!-- buybtn -->
        ...
        <i></i> Activate Now
			...
			<p class="last count-time"> Hurry! <span>04</span>M:<span>53</span>S Ms Left</p>
		</div>
		<dl class="days">
...
<div class="comparison" id="compare">
	<div class="wrapper">
      ...
      <!-- 11 -->
      <tr>
        <td class="icons"><img src="<?php echo getStaticUrl('images/com-icon17.png')?>" alt=""></td>
