...
<head>
  ...
  <link rel="icon" href="https://codes.iobit.com/iobit/images/favicon.ico"
    mce_href="https://codes.iobit.com/iobit/images/favicon.ico" type="image/x-icon">
  ...
  <title>Zaoszczędź do 88% na Advanced SystemCare PRO z okazji Bożego Narodzenia - IObit!</title>
...
<body>
  <header>
    <a href="https://www.iobit.com/de/index.php" style="position: absolute;left: 20%; top: 14%;">
      <img src="<?= $pResUrl; ?>images/logo.png" alt="">
    </a>
    <div style="text-align: center;">
      <img src="<?= $pResUrl; ?>images/title.png" alt="">
      <p style="margin-top: -21px;font-size: 20px; color: #442325;font-weight: 600;">Do <strong
          style="font-size: 24px;color:#E42D35;font-weight: 600;">88%</strong>
    ...
    <div class="box">
      <div class="box1">
        ...
        <h1>67% zniżki</h1>
        <h3>64<i>,90 zł</i> <span>199,90 zł</span></h3>
        <a href="http://www.iobit.com/buy.php?product=pl-asc143pc64&ref=pl_asc133pc64purchase2011xr<?= $refStr; ?>&refs=pl_purchase_asc"
          target="_blank">
          <button onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascxmasxr2011-pl')">KUP TERAZ</button></a>
      </div>
      <div class="box2">
        ...
        <div class="boxinser">
          ...
          <h1>88% zniżki</h1>
          <h3>64<i>,90 zł</i> <span>599,60 zł</span></h3>
          <a href="http://www.iobit.com/buy.php?product=pl-asc143pcsdpfiu64&ref=pl_asc143pcsdpfiu64purchase2011xr<?= $refStr; ?>&refs=pl_purchase_asc"
            target="_blank">
            <button onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascxmasxr2011-pl')">KUP TERAZ</button></a>
  ...
  <div id="floatlayer" class="floatlayer">
    <div class="ayer">
      ...
      <div style="  color: #FFF4C7;font-size: 21px;">
        Do <i style="font-size: 21px;color: #FFFFFF;; ">88%</i> zniżki na wyprzedaż świąteczną
      </div>
      <div class="text">
        <p style="margin-top: -35px;"><span>64<strong>,90 zł</strong> <b>wcześniej: </b><i>599,60 zł</i></span> </p>
        <p>
          <a href="http://www.iobit.com/buy.php?product=pl-asc143pcsdpfiu64&ref=pl_asc143pcsdpfiu64purchase2011xr<?= $refStr; ?>&refs=pl_purchase_asc"
            target="_blank">
            <button onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascxmasxr2011-pl')">
              KUP TERAZ</button>
          </a>
        </p>
