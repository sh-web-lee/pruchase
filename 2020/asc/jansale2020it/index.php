...
<title>Offerta di Natale - Sconti fino all’85% per Advanced SystemCare PRO</title>
...
<body>
  ...
  <div class="banner">
    <div class="wrapper clearfix">
      ...
      <h1>Offerte Speciali - solo <b>100</b> pezzi disponibili ogni giorno</h1>
      ...
      <div class="offer left">
        ...
        <div class="price">
          ...
          <a class="buybtn small"
             href="https://www.iobit.com/buy.php?product=it-asc131pc1699&ref=it_asc131pc1699purchase2001<?php echo $refStr;?>&refs=it_purchase_asc"
             onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase2001-it');">
            <i class="all-icons"></i>
      ...
      <div class="offer center">
        ...
        <div class="price">
          ...
          <a class="buybtn"
             href="https://www.iobit.com/buy.php?product=it-asc133pciusdpf1799&ref=it_asc133pciusdpf1799purchase2001<?php echo $refStr;?>&refs=it_purchase_asc"
             onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase3pciusdpf2001-it');">
            <i class="all-icons"></i>
            ACQUISTA ORA
          </a>
        </div>
        <div class="gift">Solo <b class="reduceNum giftnum"><span>30</span></b> pezzi disponibili ora!</div>
      ...
      <div class="offer right">
        ...
        <div class="price">
          ...
          <a class="buybtn small"
             href="https://www.iobit.com/buy.php?product=it-asc133pc1799&ref=it_asc133pc1799purchase2001<?php echo $refStr;?>&refs=it_purchase_asc"
             onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase3pc2001-it');">
            <i class="all-icons"></i>
            <span>ACQUISTA ORA</span>
          </a>
        </div>
