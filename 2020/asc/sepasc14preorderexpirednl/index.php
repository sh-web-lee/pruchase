...
if ($_GET['action'] == 'getPacks') {
  $date = $_GET['d'];
  $c_name = 'nlascexpir_p' . $date;
  $c_name_t='nlascexpir_t' . $date;
...
if($junk == "0.00"){
    $content[6] = "Overbodige bestanden verwijderd voor een Schone PC";
}
?>
<!DOCTYPE html>
<html lang="en">
...
<!--        <span>--><?php //echo $content[3]; ?><!--</span>-->
        ...
        <a href="https://www.iobit.com/buy.php?product=nl-asc14preorder1499&ref=nl_asc14preorderexpired1499<?php echo $refStr; ?>&aff=<?php echo $_GET['aff'];?>&refs=nl_purchase_asc"
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'asc14preorderexpired-nl');" class="buybtn"><?php echo $content[4]; ?></a>
      </div>
    </div>
  </div>
</div>
...
<div id="floatlayer" class="floatlayer">
  <div class="wrapper clearfix">
    ...
    <div class="price">
        <strong>€<b>14</b>,99</strong><del>€49,99</del>
        <a href="https://www.iobit.com/buy.php?product=nl-asc14preorder1499&ref=nl_asc14preorderexpired1499<?php echo $refStr; ?>&aff=<?php echo $_GET['aff'];?>&refs=nl_purchase_asc"
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'asc14preorderexpired-nl');" class="buybtn"><?php echo $content[49]; ?></a>
      </div>
  </div>
</div>
<!-- floatlayer end -->
