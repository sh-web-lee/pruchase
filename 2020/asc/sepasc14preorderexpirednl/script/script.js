...
function soldOut() {
  ...
  $(".buybtn").attr({
    "href": 'https://www.iobit.com/buy.php?product=nl-asc14preorder1999&ref=nl_asc14preorderexpired1999'+refStr+'&aff=' + aff + '&refs=nl_purchase_asc&tw=-8',
    "onclick": "ga('send', 'event', 'ascbuy', 'buy', 'asc14preorderexpiredsoldout-nl');"
  });
}
...
function getReTime() {
  var packsNumTotal = cGet('nlascexpir_t');
  if (packsNumTotal > 1) {
