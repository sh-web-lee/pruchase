...
if ($_GET['action'] == 'getPacks') {
  $date = $_GET['d'];
  $c_name = 'ascdbxmasfr_p' . $date;
  $c_name_t='ascdbxmasfr_t' . $date;
  $isInit=$_GET['isInit'];
...
<body>
  ...
  <div class="banner">
    <div class="wrapper">
      ...
      <h1 class="title"> Spécial Noël Vente Flash Ne ratez pas la plus grande remise !</h1>
      <div class="clearfix">
          ...
          <ul class="price">
            ...
            <li>
              <a class="buybtn exbtn"
                 href="https://www.iobit.com/buy.php?product=fr-asc14db83pc2999&ref=fr_ascdbbundle2999purchase2012<?php echo $refStr?>&aff=&refs=fr_purchase_asc"
                 onclick="ga('send', 'event', 'ascdbbuy', 'buy', 'ascpurchase-ascdb2020-fr')">
                 J’en profite !
              </a>
            </li>
          </ul>
    ...
    <div class="try">
    RISQUE GRATUIT – Activez-le maintenant pour redonner à votre PC une nouvelle vie et bénéficiez d’une garantie de remboursement de 60 jours
    </div>
  </div>
  <!-- banner end -->
    ...
    <div class="wrapper">
      ...
      <div class="computer">
        ...
        <dl class="db">
          ...
          <dd>Le meilleur logiciel de mise à jour de pilotes pour mettre à jour automatiquement les pilotes et composants de jeu obsolètes. </dd>
        </dl>
  ...
  <div class="feature">
    ...
    <div class="asc wrapper clearfix">
      ...
      <div class="msgbox fr">
      <dl>
          <dt><b>Plus intelligent</b> <span> Exclusif PRO</span></dt>
          <dd>
          Réduisez complètement les pannes et les messages d'erreur de Windows avec le nouveau mode IA
          </dd>
        </dl>
        <dl>
        ...
        <dl>
          ...
          <dd>
          Bloquez les accès non autorisés à vos contacts, courriers et autres données sensibles. 
          </dd>
        </dl>
        <dl>
          <dt><b>Navigation en ligne sécurisée</b> <span> Exclusif PRO</span></dt>
          <dd>
          Empêchez les hackers de rechercher ce que vous lisez, visualisez et achetez en ligne. 
          </dd>
        </dl>
    ...
    <div class="db wrapper clearfix">
      <div class="msgbox fl">
        <dl>
          <dt><b>Base de données plus grande </b> <span> Exclusif PRO</span></dt>
          <dd>Analysez et mettez à jour plus de 4500 000 pilotes.</dd>
        </dl>
        <dl>
        ...
        <dl>
          <dt><b>Téléchargement sécurisé du pilote</b> <span> Exclusif PRO</span></dt>
          <dd>Sauvegarde et création automatiques d'un point de restauration système avant la mise à jour</dd>
        </dl>
        <dl>
          <dt><b>Mise à jour du pilote hors ligne</b> <span> Exclusif PRO</span></dt>
          <dd>Mettez à jour et installez les pilotes réseaux hors ligne</dd>
        </dl>
      </div>
      <div class="imgbox fr">
      ...
      <div id="dg-container" class="dg-container">
        ...
        <div class="content dg-wrapper">
          ...
          <dl class="reviews">
            ...
            <dd>
              <p>
              « Advanced SystemCare est un excellent logiciel. J’ai utilisé ce logiciel pendant de nombreuses années et il fonctionne très bien. IObit ne cesse pas d’améliorer leur produit ces dernières années pour les rendre meilleurs. La plupart de leurs logiciels sont installés sur mon ordinateur et ils marchent tous très bien. »
              </p>
        ...
        <ul>
          ...
          <li class="six" data-num="3"><img src="<?php echo getStaticUrl('images/danny-r-sheets.png')?>" alt="Lyle Stelmaschuk"></li>
