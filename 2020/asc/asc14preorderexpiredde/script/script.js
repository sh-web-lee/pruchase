...
function soldOut() {
  ...
  $(".buybtn").attr({
    "href": 'https://www.iobit.com/buy.php?product=de-asc14preorder2499&ref=de_asc14preorderexpiredsoldout' + refStr + '&aff=' + aff + '&refs=de_purchase_asc&tw=-8',
    "onclick": "ga('send', 'event', 'ascbuy', 'buy', 'asc14preorderexpiredsoldout-de');"
  });
}
...
function getReTime() {
  var packsNumTotal = cGet('deascexpir_t');
  if (packsNumTotal > 1) {
