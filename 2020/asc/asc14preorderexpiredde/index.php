...
if ($_GET['action'] == 'getPacks') {
  $date = $_GET['d'];
  $c_name = 'deascexpir_p' . $date;
  $c_name_t='deascexpir_t' . $date;
...
if($junk == "0.00"){
    $content[6] = "nutzlose Dateien gelöscht";
}
  ...
  <div class="wrapper">
    ...
    <div class="right-message">
      ...
      <div class="price">
        ...
        <a href="https://www.iobit.com/buy.php?product=de-asc14preorder&ref=de_asc14preorderexpired<?= $refStr; ?>&aff=<?= $_GET['aff']; ?>&refs=de_purchase_asc"
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'asc14preorderexpired-de');" class="buybtn"><?php echo $content[4]; ?></a>
      </div>
    </div>
  </div>
</div>
...
<div class="bottom-bg">
  ...
  <div class="review wrapper">
    <h2 class="review_media"><?php echo $content[33]; ?></h2>
	<h2 class="review_user"><?php echo $content[53]; ?></h2>
    <ul>
...
<div id="floatlayer" class="floatlayer">
  <div class="wrapper clearfix">
    ...
    <div class="price">
        <strong><b>0</b>€ <sup>*</sup></strong>
        <a href="https://www.iobit.com/buy.php?product=de-asc14preorder&ref=de_asc14preorderexpired<?= $refStr; ?>&aff=<?= $_GET['aff']; ?>&refs=de_purchase_asc"
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'asc14preorderexpired-de');" class="buybtn"><?php echo $content[49]; ?></a>
      </div>
  </div>
</div>
<!-- floatlayer end -->
