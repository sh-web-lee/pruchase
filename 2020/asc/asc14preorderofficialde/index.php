...
if ($_GET['action'] == 'getPacks') {
  $date = $_GET['d'];
  $c_name = 'deascoff_p' . $date;
  $c_name_t='deascoff_t' . $date;
  ...
  <div class="wrapper">
    ...
    <div class="right-message">
      ...
      <div class="price">
        ...
        <a href="https://www.iobit.com/buy.php?product=de-asc14preorder&ref=de_asc14preorderofficial<?php echo $refStr; ?>&aff=<?php echo $_GET['aff'];?>&refs=de_purchase_asc"
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'asc14preorderofficial-de');" class="buybtn"><?php echo $content[4]; ?></a>
      </div>
    </div>
  </div>
</div>
...
<div class="bottom-bg">
  ...
  <div class="review wrapper">
    <h2 class="_review_title"><?php echo $content[39]; ?></h2>
    <h2 class="_review_Media_title"><?php echo $content[59]; ?></h2>
    <ul>
...
<div id="floatlayer" class="floatlayer">
  <div class="wrapper clearfix">
    ...
    <div class="price">
        <strong><b>0</b> €<sup>*</sup></strong>
        <a href="https://www.iobit.com/buy.php?product=de-asc14preorder&ref=de_asc14preorderofficial<?php echo $refStr; ?>&aff=<?php echo $_GET['aff'];?>&refs=de_purchase_asc"
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'asc14preorderofficial-de');" class="buybtn"><?php echo $content[55]; ?></a>
      </div>
  </div>
</div>
<!-- floatlayer end -->
