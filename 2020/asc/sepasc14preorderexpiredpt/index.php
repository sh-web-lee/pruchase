...
if ($_GET['action'] == 'getPacks') {
  $date = $_GET['d'];
  $c_name = 'ptascexpir_p' . $date;
  $c_name_t='ptascexpir_t' . $date;
...
if($junk == '0.00'){
    $content[6] = 'Deletou de arquivos inúteis para um PC mais limpo';
}
  ...
  <div class="wrapper">
    ...
    <div class="right-message">
      ...
      <div class="price">
        ...
        <a href="http://www.iobit.com/buy.php?product=pt-asc14preorder&ref=pt-asc14preorderexpired<?php echo $refStr; ?>&aff=<?php echo $_GET['aff'];?>&refs=pt_purchase_asc"
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'asc14preorderexpired-pt');" class="buybtn"><?php echo $content[4]; ?></a>
      </div>
    </div>
  </div>
</div>
...
<div id="floatlayer" class="floatlayer">
  <div class="wrapper clearfix">
    ...
    <div class="price">
        <strong>R$<b>0</b> <sup>*</sup></strong>
        <a href="http://www.iobit.com/buy.php?product=pt-asc14preorder&ref=pt-asc14preorderexpired<?php echo $refStr; ?>&aff=<?php echo $_GET['aff'];?>&refs=pt_purchase_asc"
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'asc14preorderexpired-pt');" class="buybtn"><?php echo $content[49]; ?></a>
      </div>
  </div>
</div>
<!-- floatlayer end -->
