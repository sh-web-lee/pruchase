...
function soldOut() {
  ...
  $(".buybtn").attr({
    "href": 'http://www.iobit.com/buy.php?product=pt-asc14preorder7699&ref=pt-asc14preorderexpiredsoldout' + refStr + '&aff=' + aff + '&refs=pt_purchase_asc&tw=-8',
    "onclick": "ga('send', 'event', 'asc3pcbuy', 'buy', 'asc14preorderexpired-pt');"
  });
}
...
function getReTime() {
  var packsNumTotal = cGet('ptascexpir_t');
  if (packsNumTotal > 1) {
