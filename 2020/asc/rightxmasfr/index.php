...
<head>
  ...
  <title>Jusqu'à -88% sur Advanced SystemCare PRO - vente flash de Noël - IObit</title>
...
<body>
  ...
  <div class="banner">
    ...
    <!-- subtitle -->
    <p>
      Jusqu'à -<b>88</b>% ! Achetez-en 1 et obtenez-en 3 GRATUITS ! Ne vous en manquez pas !
    </p>
    <!-- panel -->
    <div class="panel clearfix">
      ...
      <div class="message small fl">
        ...
        <dl>
          ...
          <dd>
            <a class="buybtn" href="https://www.iobit.com/buy.php?product=fr-asc141pc1799&ref=fr_asc141pc1799purchase2012<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchaseright2corner012b-fr');"> <i class="all-icons"></i> VITE, J’EN PROFITE </a>
          </dd>
        </dl>
      </div>
      ...
      <div class="message large fr">
		...
		<div class="message-box">
			<div class="message-box-sale message-box-eaux"><p>-88%</p></div>
			<img class="box" src="<?php echo getStaticUrl('images/xmas-ascbox.png')?>" alt="IObit Malware Fighter PRO">
        ...
        <dl>
          <dd class="clearfix">
            Réduction : <span class="fr largeolsa"><em>131,97</em>€</span>
          </dd>
          <dd class="two">
            <p class="price"><b>17</b> <del class="largeold"><em>149,96</em>€</del></p>
          </dd>
          <dd>
            <a class="buybtn large"
               href="https://www.iobit.com/buy.php?product=fr-asc143pcpfiusd1799&ref=fr_asc143pcpfiusd1799purchase2012<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchaserightcorner2012a-fr');"> <i class="all-icons"></i> VITE, J’EN PROFITE </a>
          </dd>
        </dl>
      </div>
    </div>
...
<div class="gifts-store">
	...
	<a class="buybtn" href="https://www.iobit.com/buy.php?product=fr-asc143pcpfiusd1799&ref=fr_asc143pcpfiusd1799purchase2012<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchaserightcorner2012a-fr');"> <i class="all-icons"></i>Profitez-en maintenant</a>
	</dd>
</div>
  <!-- comparison -->
    ...
    <table>
      <thead>
        <tr>
          ...
          <th class="item-b"></th>
		  <th class="space"></th>
          <th class="item-c"><p>Advanced SystemCare 14 PRO</p><img src="<?php echo getStaticUrl('images/xmas-santa.png') ?>" class="xmas-santa" alt=""></th>
        </tr>
      </thead>
      <tbody>
        <!-- 01 -->
  ...
  <div class="bottom-buy clearfix">
    ...
    <dl class="fr">
      <dd>
        <p class="price"><b>17</b> <del>149,96€</del></p>
      </dd>
      <dd>
        <a class="buybtn small" href="https://www.iobit.com/buy.php?product=fr-asc143pcpfiusd1799&ref=fr_asc143pcpfiusd1799purchase2012<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchaserightcorner2012a-fr');">
