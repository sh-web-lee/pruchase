function onePc() {
	$(".bottomcart .button").attr("href","https://www.iobit.com/buy.php?product=pl-asc131pc69test&ref=pl_asc131pc69purchase2002"+refStr+"&refs=pl_purchase_asc&tw=-8");
	$(".bottomcart dl strong b").html("69")
	$(".bottomcart dl dt del").html("119,90 zł")
	$(".showcase span").removeClass().addClass('one-pc');
	$(".bottomcart .selection li:eq(2)").addClass('active').siblings().removeClass("active");
}
function packs() {
	$(".bottomcart .button").attr("href","https://www.iobit.com/buy.php?product=pl-asc133pciupf74test&ref=pl_asc133pciupf74purchase2002"+refStr+"&refs=pl_purchase_asc&tw=-8");
	$(".bottomcart dl strong b").html("74")
	$(".bottomcart dl del").html("469,70 zł")
	$(".showcase span").removeClass().addClass('packs');
	$(".bottomcart .selection li:eq(1)").addClass('active').siblings().removeClass("active");
}
function threePc() {
	$(".bottomcart .button").attr("href","https://www.iobit.com/buy.php?product=pl-asc133pc74test&ref=pl_asc133pc74purchase2002"+refStr+"&refs=pl_purchase_asc&tw=-8");
	$(".bottomcart dl strong b").html("74")
	$(".bottomcart dl del").html("199,90 zł")
...
function soldout() {
	...
	$(".banner .packs h3").html("Dla <span>3</span> komputerów już od:")
	$(".banner .packs dl strong").html("60%")
	$(".banner .packs dl dd:last-child,.bottomcart .btnarea dd:last-child").remove();
	$(".banner .three-pcs dl strong").html("80%")
	$(".banner .three-pcs").addClass("sold-out");
	$(".banner .packs .button").attr("href","https://www.iobit.com/buy.php?product=pl-asc133pc74test&ref=pl_asc133pc74purchase2002"+refStr+"&refs=pl_purchase_asc&tw=-8");
...
function timeInit(){
	var date = new Date();
	var cName = "plascfeb_t" + date.getDate();
	var arr = document.cookie.match(new RegExp("(^| )" + cName + "=([^;]*)(;|$)"));
	var nowTime = Math.floor(date.getTime() / 1000);
	if (arr == null) {
		countTime = nowTime + 952;
