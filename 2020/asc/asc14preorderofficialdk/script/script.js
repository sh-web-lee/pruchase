...
function soldOut() {
  ...
  $(".price strong").html("<b>199</b> kr.")
  $(".banner h1").html(soldout_banner)
  $(".banner .numbox").remove();
  $(".floatlayer .numbox").html(soldout_float)
  $(".buybtn").attr({
    "href": 'https://www.iobit.com/buy.php?product=dk-asc14preorder199&ref=dk_asc14preorderofficialsoldout'+refStr+'&aff=' + aff + '&refs=dk_purchase_asc&tw=-8',
    "onclick": "ga('send', 'event', 'ascbuy', 'buy', 'asc14preorderofficialsoldout-dk');"
  });
}
...
function getReTime() {
  var packsNumTotal = cGet('dkascoff_t');
  if (packsNumTotal > 1) {
