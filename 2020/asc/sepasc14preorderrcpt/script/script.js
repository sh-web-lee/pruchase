...
function soldOut() {
  ...
  $(".buybtn").attr({
    "href": 'https://www.iobit.com/buy.php?product=pt-asc14preorder7699&ref=pt-asc14preorderrcsoldout'+refStr+'&aff=' + aff + '&refs=pt_purchase_asc&tw=-8',
    "onclick": "ga('send', 'event', 'asc3pcbuy', 'buy', 'asc14predorderrc-pt');"
  });
}
...
function getReTime() {
  var packsNumTotal = cGet('ptascrc_t');
  if (packsNumTotal > 1) {
