...
//showArticle()
var artical = "Auf den ersten Blick hat sich bei der neuen Version des IObit-Tools wenig getan. Und tatsächlich stecken die meisten Neuerungen unter der Haube. So wollen die Entwickler unter anderem die Reinigungs- und Optimierungsleistung ebenso verbessert haben, wie die Säuberung der Windows-Registry. Im Test auf einem Windows-10-PC findet Advanced SystemCare Pro (ASC) zahlreiche „Mängel“ und beseitigt sie in einem Rutsch. Das sorgt für zusätzlichen Speicherplatz und eine verbesserte Privatspäre mit dem Schutz vertraulicher Daten. Neu sind Spam-Filter, Surf-Schutz und Werbeblocker für Edge und Firefox – Chrome wird nicht unterstützt. Insgesamt hinterlässt Advanced SystemCare Pro einen guten und ausgereiften Eindruck. Die vielen Funktionen im prall gefüllten Werkzeugkasten laden zum Ausprobieren ein. Clevere Extras wie der Software-Updater und der  Turbo-Booster  bringen  einen  echten  Mehr- und Nutzwert.<br><br>" +
  "<b>Fazit</b>: ASC 13 Pro macht konsequent da weiter, wo die schon sehr gute 12er-Version aufgehört hat. Das umfassende Tool bietet viel und kann beim Aufräumen, Tunen und Optimieren bestens helfen. ";
function showArticle() {
  $(".magazine .article p").html(artical);
}
...
function packsInit() {
  var date = new Date();
  var cName = "deascma" + date.getDate();
  var packsArr;
