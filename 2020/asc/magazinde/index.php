  ...
  <div class="wrapper">
    ...
    <div class="panel">
      ...
      <div class="message left">
        ...
        <!-- buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=de-asc131pc2299&ref=de_asc131pcsinglemagazin<?php echo $refStr;?>&refs=de_purchase_asc"
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'asc1pcsinglemagazin-de')">
          JETZT KAUFEN
        </a>
      </div>
      ...
      <div class="message large middle">
        ...
        <!-- buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=de-asc131pcpf2399&ref=de_asc131pcbundlemagazin<?php echo $refStr;?>&refs=de_purchase_asc"
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'asc1pcbundlemagazin-de')">
          JETZT KAUFEN
        </a>
        <!-- hint -->
      ...
      <div class="message large right">
        ...
        <!-- buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=de-asc133pcpf2499&ref=de_asc133pcbundlemagazin<?php echo $refStr;?>&refs=de_purchase_asc"
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'asc3pcbundlemagazin-de')">
          JETZT KAUFEN
        </a>
        <!-- hint -->
        <span class="hint-icon"></span>
    ...
    <!-- h4 -->
    <h4>Der Lizenzcode ist auch für die nächste Version gültig</h4>
  </div>
</div>
<!-- end banner -->
...
<div class="feature wrapper clearfix">
  <!-- feature-title -->
  <h2>
    Die PRO-Edition macht Ihren PC schneller, stabiler und sicherer
    Andernfalls erstatten wir Ihnen den Kaufpreis umgehend! <img class="bottombtn" src="<?php echo getStaticUrl('images/tip02.png')?>" alt="">
  </h2>
  <!-- 01 -->
  <dl>
...
<div class="magazine wrapper clearfix">
  ...
  <div class="article">
    <h3><span>Advanced SystemCare 13 Pro</span></h3>
    <img src="<?php echo getStaticUrl('images/magazine-icon.png')?>" alt="">
    <p>
      Auf den ersten Blick hat sich bei der neuen Version des IObit-Tools wenig getan. Und tatsächlich stecken die meisten Neuerungen unter der Haube. So wollen die Entwickler unter anderem die Reinigungs- und Optimierungsleistung ebenso verbessert haben, wie die Säuberung der Windows-Registry. Im Test auf einem Windows-10-PC findet Advanced SystemCare Pro (ASC) zahlreiche „Mängel“ und beseitigt sie in einem Rutsch. Das sorgt für zusätzlichen Speicherplatz und eine verbesserte Privatspäre mit dem Schutz vertraulicher Daten.
      <a href="javascript: showArticle();" onclick="ga('send', 'event', 'ascclick', 'click', 'purchasemagazin-de')">Weitere Infos</a>
    </p>
  </div>
</div>
<!-- end magazine -->
...
<div class="bottombuy">
  <div class="wrapper clearfix">
    ...
    <ul>
      <li class=""
          data-url="https://www.iobit.com/buy.php?product=de-asc131pc2299&ref=de_asc131pcsinglemagazin<?php echo $refStr;?>&refs=de_purchase_asc&tw=-8"
          data-ga="ga('send', 'event', 'ascbuy', 'buy', 'asc1pcsinglemagazin-de')"
          data-price="22"
          data-del="39,99€">
          <div>
            ASC 1 PC
      ...
      <li class="active"
          data-url="https://www.iobit.com/buy.php?product=de-asc133pcpf2499&ref=de_asc133pcbundlemagazin<?php echo $refStr;?>&refs=de_purchase_asc&tw=-8"
          data-ga="ga('send', 'event', 'ascbuy', 'buy', 'asc3pcbundlemagazin-de')"
          data-price="24"
          data-del="99,94€">
        <div>
      ...
      <li class=""
          data-url="https://www.iobit.com/buy.php?product=de-asc131pcpf2399&ref=de_asc131pcbundlemagazin<?php echo $refStr;?>&refs=de_purchase_asc&tw=-8"
          data-ga="ga('send', 'event', 'ascbuy', 'buy', 'asc1pcbundlemagazin-de')"
          data-price="23"
          data-del="79,94€">
        <div>
...
<div class="footer">
  <div class="wrapper">
    <dl>
      ...
      <dd>* Wenn Sie nicht zufrieden sind, können Sie die Bestellung innerhalb von 60 Tagen ohne Zahlung einer Gebühr stornieren. Das Geld wird automatisch auf Ihre Kreditkarte <br> &nbsp;&nbsp; oder Ihr PayPal-Konto zurückerstattet.</dd>
    </dl>
