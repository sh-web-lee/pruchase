...
function soldOut() {
  ...
  $(".price strong").html("$<b>76</b>.99")
  $(".banner h1").html(soldout_banner)
  $(".banner .numbox").remove();
  $(".floatlayer .numbox").html(soldout_float)
  $(".buybtn").attr({
    "href": 'https://www.iobit.com/buy.php?product=asc14preorder1677&ref=en-asc14preorderofficialsoldout'+refStr+'&aff=' + aff + '&refs=purchase_asc&tw=-8',
