...
<head>
  ...
  <title> Op til 90% rabat på Advanced SystemCare PRO - IObit</title>
...
<body>
  <header>
    ...
    <div style="text-align: center;">
      ...
      <p style="margin-top: -30px;font-size: 20px; color: #442325;font-weight: 600;"> Op til <strong style="font-size: 24px;color:#E42D35;font-weight: 600;"> 90%</strong> rabat på Advanced SystemCare PRO</p>
    </div>
    <div class="box">
      <div class="box1">
        ...
        <a href="https://www.iobit.com/buy.php?product=dk-asc143pc199&&ref=dk_asc1433pcsingle2020xmasxr<?= $refStr; ?>&refs=dk_purchase_asc">
          <button onclick="ga('send', 'event', 'ascbuy', 'buy', 'asc3pcsinglesale2012xr-dk')">KØB NU</button></a>
      </div>
      <div class="box2">
        ...
        <div class="boxinser">
          ...
          <h1>90% rabat</h1>
          <h3>159 kr. <span>førpris:1.606 kr</span></h3>
          <a href="https://www.iobit.com/buy.php?product=dk-asc143pciusdpf159&ref=dk_asc143pcbundle2020xmasxr<?= $refStr; ?>&refs=dk_purchase_asc">
            <button onclick="ga('send', 'event', 'ascbuy', 'buy', 'asc3pcbundle2012xr-dk')">KØB NU</button></a>
  ...
  <div id="floatlayer" class="floatlayer">
    <div class="ayer">
      ...
      <div style="  color: #FFF4C7;font-size: 21px;">
        Op til <i style="font-size: 21px;color: #FFFFFF;; "> 90% rabat </i> under Xmas-udsalg
      </div>
      <div class="text">
        <p style="margin-top: -14px;"><span>159 kr. <b>førpris:</b><i>1.606kr.</i></span> </p>
        <p>
          <a href="https://www.iobit.com/buy.php?product=dk-asc143pciusdpf159&ref=dk_asc143pcbundle2020xmasxr<?= $refStr; ?>&refs=dk_purchase_asc">
            <button onclick="ga('send', 'event', 'ascbuy', 'buy', 'asc3pcbundle2012xr-dk')">
              KØB NU</button>
          </a>
        </p>
