...
<head>
  ...
  <title>Jusqu'à -85% sur Advanced SystemCare PRO - Vente Spéciale - IObit</title>
...
<body>
  ...
  <div class="banner">
    <div class="wrapper">
      ...
      <h1>Offre à Durée Limitée
        <!-- SOLDES D'HIVER -->
        <!-- Offre spÉciale pour le nouveau lancement  -->
      </h1>
      ...
      <div class="clearfix">
        <div class="offer left">
          ...
          <div class="price">
            ...
            <a class="buybtn gray" href="https://www.iobit.com/buy.php?product=fr-asc143pc1999&ref=fr_asc143pc1999purchase2007<?php echo $refstr; ?>&aff=&refs=fr_purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase2007a-fr');">
              <i class="all-icons"></i>
        ...
        <div class="offer big">
          ...
          <div class="price">
            ...
            <a class="buybtn" href="https://www.iobit.com/buy.php?product=fr-asc143pcpfiusd1999&ref=fr_asc143pcpfiusd1999purchase2007<?php echo $refstr; ?>&aff=&refs=fr_purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase2007b-fr');">
              <i class="all-icons"></i>
              <span>VITE,J’EN PROFITE</span>
            </a>
          </div>
        ...
        <div class="offer right">
          ...
          <div class="price">
            ...
            <a class="buybtn gray" href="https://www.iobit.com/buy.php?product=fr-asc141pc1799&ref=fr_asc141pc1799purchase2007<?php echo $refstr; ?>&aff=&refs=fr_purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase2007c-fr');">
              <i class="all-icons"></i>
              <span>VITE,J’EN PROFITE</span>
            </a>
          </div>
    ...
    <div class="wrapper">
      ...
      <div class="clearfix">
        <div class="giftlist">
          ...
          <h3>IObit Uninstaller 11 PRO <small>(1 an / 1 PC)</small></h3>
          <ul>
  ...
  <div class="pop">
    ...
    <div class="pop-offer">
      ...
      <div class="price fr">
        ...
        <a class="buybtn greenbtn" href="https://www.iobit.com/buy.php?product=fr-asc143pcpfiusd1799&ref=fr_asc143pcpfiusd1799purchase2007<?php echo $refstr; ?>&aff=&refs=fr_purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchasepop2007-fr')">
          <i class="all-icons"></i>
          VITE,J’EN PROFITE
        </a>
      </div>
