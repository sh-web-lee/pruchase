...
function soldout() {
  ...
  $(".banner h1").text("NIE ZWLEKAJ I WYKORZYSTAJ SPECJALNĄ PROMOCJĘ");
  ...
  $(".bottombuy h2").text("Nie zwlekaj i przyspiesz komputer TERAZ!");
  $(".bottombuy h4").hide();
...
function timeInit(){
  var date = new Date();
  var cName = "plascaprsale2020_t" + date.getDate();
