...
$(function() {
  $(window).on('scroll', function() {
    if ($(window).scrollTop() > $(".feature").offset().top - 100) {
      $(".feature-box.one li span").removeClass("on").addClass("on");
      setTimeout('$(".feature-box.one li b").removeClass("on").addClass("on");', 100);
      if (flag) {
        flag = false;
        numberJump(".feature-box.one b.one em,.feature-box.one li b.three em", 57);
        numberJump(".feature-box.one b.two em", 60);
        numberJump(".feature-box.one b.four em", 69);
        numberJump(".feature-box.one b.five em", 104);
        numberJump(".feature-box.one b.six em", 58);
        // numberJumptwo(".feature-box.one b.seven em", 4.21);
        // numberJumptwo(".feature-box.one b.eight em", 14);
      } else {
        return;
      }
    }
