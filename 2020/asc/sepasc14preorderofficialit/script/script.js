...
function soldOut() {
  ...
  $(".buybtn").attr({
    "href": 'http://www.iobit.com/buy.php?product=it-asc14preorder1799&ref=it_asc14preorderofficialsoldout1799' + refStr + '&aff=' + aff + '&refs=it_purchase_asc&tw=-8',
    "onclick": "ga('send', 'event', 'ascbuy', 'buy', 'asc14preorderofficialsoldout-it');"
  });
}
...
function getReTime() {
  var packsNumTotal = cGet('itascoff_t');
  if (packsNumTotal > 1) {
