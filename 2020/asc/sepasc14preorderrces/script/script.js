...
function soldOut() {
  ...
  $(".buybtn").attr({
    "href": 'https://www.iobit.com/buy.php?product=es-asc14preorder1799&ref=es_asc14preorderrcsoldout' + refStr + '&aff=' + aff + '&refs=es_purchase_asc&tw=-8',
    "onclick": "ga('send', 'event', 'asc3pcbuy', 'buy', 'asc14predorderrc-es');"
  });
}
...
function getReTime() {
  var packsNumTotal = cGet('esascrc_t');
  if (packsNumTotal > 1) {
