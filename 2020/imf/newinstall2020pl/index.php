...
<head>
  ...
  <title>Nie przegap promocji na najnowszy IObit Malware Fighter 8 PRO! - IObit</title>
...
<div class="banner">
  ...
  <div class="panel clearfix">
      ...
      <dl>
        ...
        <dd>
          <a class="buybtn border"
             href=" http://www.iobit.com/buy.php?product=pl-imf81pc79&ref=pl_imf81pc79purchase2006newinstall<?php echo $refStr;?>&refs=pl_purchase_imf"
             onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfnewinstall2020-pl');"
             data-num="2">
    ...
    <div class="message large fl">
      ...
      <dl>
        <dd class="clearfix">
          Taniej o:      <span class="fr">414,70 zł</span>
        </dd>
        <dd class="two">
          <p class="price red"><b>89</b> <del>504,60 zł </del></p>
        </dd>
        <dd>
          <a class="buybtn large"
             href="http://www.iobit.com/buy.php?product=pl-imf83pcsdpf2m89&ref=pl_imf83pcsdpf2m89purchase2006newinstall<?php echo $refStr;?>&refs=pl_purchase_imf"
             onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfnewinstall2020-pl');"
             data-num="0">
            <i class="all-icons"></i> KUP TERAZ
          </a>
    ...
    <div class="message small fr">
      ...
      <dl>
        ...
        <dd>
          <a class="buybtn border"
             href="http://www.iobit.com/buy.php?product=pl-imf83pc89&ref=pl_imf83pc89purchase2006newinstall<?php echo $refStr;?>&refs=pl_purchase_imf"
             onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfnewinstall2020-pl');"
             data-num="1">
            <i class="all-icons"></i> KUP TERAZ
          </a>
...
<div class="feature">
  ...
  <p>
    Dzięki wiodącemu na świecie silnikowi antywirusowemu Bitdefender, <span>ponad 209 milionów nowych</span> zagrożeń online, <br> takich jak adware, wirusy, złośliwe oprogramowanie, oprogramowanie szpiegujące itp., można łatwo usunąć z komputera.
  </p>
...
<div class="gifts">
  <div class="wrapper">
    ...
    <a href="http://www.iobit.com/buy.php?product=pl-imf83pcsdpf2m89&ref=pl_imf83pcsdpf2m89purchase2006newinstall<?php echo $refStr;?>&refs=pl_purchase_imf"
       onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfnewinstall2020-pl');"
       class="buybtn">
      <i class="all-icons"></i>
      KUP TERAZ
...
<div class="comparison">
  ...
  <table>
    ...
    <tbody>
      <!-- 01 -->
      <tr>
        <td class="item-a">9 mln</td>
        <td class="item-b">Baza danych złośliwego oprogramowania</td>
        <td class="item-c"> Ponad 209 mln</td>
      </tr>
      <!-- 02 -->
      <tr>
...
<div class="bottom-buy clearfix">
  <div class="wrapper">
    ...
    <!-- ul -->
    <ul class="fl">
      <li class="active top">14 miesięcy / 3 PC + prezenty</li>
    ...
    <dl class="fr">
      <dd>
        <p class="price"><b>89</b> <del>504,60 zł </del></p>
      </dd>
      <dd>
