...
<head>
  ...
  <title>Wykorzystaj specjalną promocję na najnowszy IObit Malware Fighter 8 PRO! - IObit</title>
...
<div class="banner">
  ...
  <!-- title -->
  <h1>KOMPLEKSOWA OCHRONA W SIECI</h1>
  <!-- subtitle -->
    <p>Specjalnie dla Ciebie nawet <span>83%</span> taniej!</p>
  <!-- panel -->
  <div class="panel clearfix">
      ...
      <dl>
        ...
        <dd>
          <a class="buybtn border"
             href="http://www.iobit.com/buy.php?product=pl-imf81pc79&ref=pl_imf81pc79purchase2006newlaunch<?php echo $refStr;?>&refs=pl_purchase_imf"
             onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfnewlaunch2020-pl');"
             data-num="2">
    ...
    <div class="message large fl">
      ...
      <dl>
        <dd class="clearfix">
          Taniej o:      <span class="fr"> 389,90 zł</span>
        </dd>
        <dd class="two">
        ...
        <dd>
          <a class="buybtn large"
             href="http://www.iobit.com/buy.php?product=pl-imf83pcsdpf79&ref=pl_imf83pcsdpf79purchase2006newlaunch<?php echo $refStr;?>&refs=pl_purchase_imf"
             onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfnewlaunch2020-pl');"
             data-num="0">
            <i class="all-icons"></i> KUP TERAZ
          </a>
    ...
    <div class="message small fr">
      ...
      <dl>
        ...
        <dd>
          <a class="buybtn border"
             href="http://www.iobit.com/buy.php?product=pl-imf83pc89&ref=pl_imf83pc89purchase2006newlaunch<?php echo $refStr;?>&refs=pl_purchase_imf"
             onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfnewlaunch2020-pl');"
             data-num="1">
            <i class="all-icons"></i> KUP TERAZ
          </a>
...
<div class="gifts">
  <div class="wrapper">
    ...
    <a href="http://www.iobit.com/buy.php?product=pl-imf83pcsdpf79&ref=pl_imf83pcsdpf79purchase2006newlaunch<?php echo $refStr;?>&refs=pl_purchase_imf"
       onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfnewlaunch2020-pl');""
       class="buybtn">
      <i class="all-icons"></i>
      KUP TERAZ
