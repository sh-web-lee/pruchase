...
<head>
  ...
  <title>Upp till 80% rabatt på IObit Malware Fighter PRO och vänta inte på den sista prisminskningen - IObit</title>
...
<div class="banner">
  <div class="wrapper">
    <!-- logo -->
    <a class="logo" href="https://www.iobit.com/sv/index.php">IObit</a>
    <!-- sun -->
    <span class="sun"></span>
    <!-- h1 -->
    <h1>Särskild Sommarkampanj</h1>
    <!-- h2 -->
    <h2>Det är för varmt ! De prisen har smält! Först till kvarn!</h2>
    <!-- container -->
    <div class="container">
      <!-- large offer -->
      <div class="offer large">
        ...
        <dl>
          <dd>
            <!-- price -->
            <p class="price"><big>319</big><span>kr</span> <del>1 657 kr</del></p>
            <!-- buybtn -->
            <a class="buybtn"
               href="https://www.iobit.com/buy.php?product=sv-imf83pcpfsd319&ref=sv_imf83pcpfsd319purchase2007<?php echo $refStr;?>&refs=sv_purchase_imf"
               onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpfsdpurchase2007-sv') ">
              <i class="all-icons"></i>
              KÖP NU
            </a>
            <!-- view -->
            <p class="view"><i class="all-icons"></i> Mer än  <b class="viewNum">4,006,553</b> personer har redan köpt den</p>
          </dd>
        </dl>
      </div>
      ...
      <div class="offer medium dns">
        <!-- h3 -->
        <h3>Andra Prissänkning</h3>
        <!-- off -->
        <span class="off">-54%</span>
        <!-- box -->
        ...
        <dl>
          <dd>
            <!-- price -->
            <p class="price"><big>319</big> <b>kr</b> <del>699 kr</del></p>
            <!-- buybtn -->
            <a class="buybtn"
               href="https://www.iobit.com/buy.php?product=sv-imf83pc319&ref=sv_imf83pcpurchase2007<?php echo $refStr;?>&refs=sv_purchase_imf"
               onclick="ga('send', 'event', 'imfbuy', 'buy', 'imf3pcpurchase2007-sv')">
              <i class="all-icons"></i>
              KÖP NU
            </a>
          </dd>
    ...
    <div class="service">
      <dl class="one fl">
        ...
        <dd>Accepterade Betalningssätt</dd>
      </dl>
      <dl class="fl">
...
<div class="gifts">
  <div class="wrapper clearfix">
    <!-- h2 -->
    <h2>Exklusiva presenter till våra PRO användare! Begränsade kvantiteter!</h2>
    <!-- sd -->
    <dl class="sd fl">
      <dt><img src="<?php echo getStaticUrl('images/gifts-sd.png')?>" alt="Smart Defrag PRO"></dt>
      <dd>
       Defragmentera snabbt och grundligt för att optimera <br> hårddiskens och datorns prestanda.
      </dd>
    </dl>
    <!-- pf -->
    <dl class="pf fl">
      ...
      <dd>
        Effektivt filskyddsverktyg som garanterar <br> säkerheten för dina viktiga mappar, data och din <br> integritet.
      </dd>
    </dl>
  </div>
</div>
...
<div class="review">
  <div class="wrapper">
    <!-- h2 -->
    <h2>
     IObit Malware Fighter PRO har redan skyddat fler än <b class="userNum">5 381 569</b> <br>
      datorer, det är dags att skydda din.
    </h2>
    <!-- container -->
    ...
    <dl class="media clearfix">
      <dt class="fl"><img src="<?php echo getStaticUrl('images/bn.png')?>" alt=""></dt>
      <dd class="fl">
        <h4>Vad folk säger om oss: <i class="all-icons"></i></h4>
...
<div class="coupon">
  <div class="coupon-content hide">
    ...
    <dl>
      <dd>
        <!-- price -->
        <p class="price"><big>299<span> kr</span></big>  <big class="black">319 <span>kr</span></big></p>
        <!-- buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=sv-imf83pcpfsd299popup&ref=sv_imf83pcpfsd319purchase2007popup<?php echo $refStr;?>&refs=sv_purchase_imf"
           onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpoppurchase2007-sv')">
          <i class="all-icons"></i>
          Hämta det nu
        </a>
      </dd>
