    ...
    <div class="wrapper">
        ...
        <div class="right-message">
            ...
            <div class="price">
                ...
                <a href="https://www.iobit.com/buy.php?product=imf83pciusd1995&ref=en-imf3pciusdloyal<?php echo $refStr; ?>&aff=<?php echo $_GET['aff'] ?>&refs=purchase_imf"
...
<?php
if ($_GET['ref'] == 'launchnewsmin') {
    ?>
    <!--launchnewsmin-->
    <!-- feature start -->
    <div class="feature feature-message">
        <div class="wrapper">
            <div class="arrow-down"></div>
            <h2>Upgrade to the Latest PRO, Enjoy Our Best Protection</h2>
            <h3>Stronger & All-round protection</h3>
            <div class="content">
                <div class="wrapper">
                    <img src="<?php echo getStaticUrl('images/computer.png') ?>" alt="" class="computer">
                    <div class="list list01">
                        <div class="img"><img src="<?php echo getStaticUrl('images/list01.png') ?>" alt="">
                            <span>ONLINE</span></div>
                        <p>
                            <strong>Browsing Protection</strong>
                            Block malicious websites
                        </p>
                        <p>
                            <strong>E-mail Protection</strong>
                            Detect malicious links in mail
                        </p>
                        <p class="pro">
                            <strong>Online Trace Protection <sup>PRO</sup></strong>
                            Auto delete online traces
                        </p>
                    </div>
                    <div class="list list02">
                        <div class="img"><img src="<?php echo getStaticUrl('images/list02.png') ?>" alt=""> <span>PRIVACY</span>
                        </div>
                        <p class="pro">
                            <strong>Camera Protection <sup>PRO</sup></strong>
                            Can’t open camera without permission
                        </p>
                        <p class="pro">
                            <strong>Personal Data Protection <sup>PRO</sup></strong>
                            Can’t access without password
                        </p>
                    </div>
                    <div class="list list03">
                        <div class="img"><img src="<?php echo getStaticUrl('images/list03.png') ?>" alt=""> <span>SECURITY</span>
                        </div>
                        <p>
                            <strong>Malware Protection</strong>
                            Detect 6 million malware
                        </p>
                        <p class="pro">
                            <strong>Bitdefender Virus Protection <sup>PRO</sup></strong>
                            Detect 200 million malware & virus
                        </p>
                        <p class="pro">
                            <strong>Ransomware Protection <sup>PRO</sup></strong>
    ...
    <div class="compartab wrapper">
        <h2><span>And There Is More</span></h2>
        <table>
            <thead>
            <tr>
                <th class="text"></th>
                <th class="itema">
                    <div>Your Current <br> Version</div>
                </th>
                <th class="space"></th>
                <th class="itemb">
                    <div>IObit <br> Malware Fighter 8 <strong>PRO</strong></div>
                </th>
            </tr>
            </thead>
            <tbody>
            <tr>
                <td>Basic real-time protection</td>
                <td class="itema"><i></i></td>
                <td class="space"></td>
                <td class="itemb"><i></i></td>
            </tr>
            <tr>
                <td>Comprehensive real-time protection with multiple security guards</td>
                <td class="itema"></td>
                <td class="space"></td>
                <td class="itemb"><i></i></td>
            </tr>
            <tr>
                <td>USB drive virus can’t harm your computer</td>
                <td class="itema"></td>
                <td class="space"></td>
                <td class="itemb"><i></i></td>
            </tr>
            <tr>
                <td>Auto scan your computer to detect existing threats</td>
                <td class="itema"></td>
                <td class="space"></td>
                <td class="itemb"><i></i></td>
            </tr>
            <tr>
                <td>Auto update to latest database to identify more threats</td>
                <td class="itema"></td>
                <td class="space"></td>
                <td class="itemb"><i></i></td>
            </tr>
            <tr>
                <td>Auto update to latest version</td>
                <td class="itema"></td>
                <td class="space"></td>
                <td class="itemb"><i></i></td>
            </tr>
            <tr>
                <td>24/7 premium technical support</td>
                <td class="itema"></td>
                <td class="space"></td>
                <td class="itemb"><i></i></td>
            </tr>
    ...
    <?php
} elseif ($_GET['ref'] == 'launchnews') {
    ?>
    <!--launchnews-->
    <!-- feature start -->
    <div class="launchnews feature-message">
        <div class="wrapper">
            <div class="arrow-down"></div>
            <h2>Upgrade to the Latest PRO, Enjoy Our Best Protection</h2>
            <h3><span>What we’ve optimized</span></h3>
            <img src="<?php echo getStaticUrl('images/launchnews-computer.png') ?>" alt="" class="imgbox">
    ...
    <!-- feature end -->
    <div class="compartab compartab-launchnews wrapper">
...
<div class="gift">
    <div class="wrapper">
        ...
        <div class="box">
            ...
            <p>Remove Useless Programs & Plug-ins <br> for Cleaner PC</p>
        </div>
    </div>
</div>
...
<div class="review">
    <div class="wrapper">
        ...
        <ul>
            ...
            <li data-num="2"><img src="<?php echo getStaticUrl('images/peter-stoffers.png') ?>" alt="Peter Stoffers">
            </li>
            <li class="active last" data-num="3"><img src="<?php echo getStaticUrl('images/software.png') ?>"
                                                      alt="software.informer.com"></li>
        </ul>
        <span class="prev"></span>
        <div class="message">
            <div>
                <h3>I have used many malware fighters but none has come near the efficiency and accuracy of IObit
                    Malware Fighter. </h3>
                <p>"It is easy to set up, easy to use and easy to feel relaxed that your computer is not to be invaded
                    by maleficent invaders set upon infecting your communications with viruses and program destroying
                    malware."</p>
            ...
            <div>
                ...
                <p>"We used to use up to a dozen different programs to keep our machines running smoothly and keep the
                    bad guys out. It took hours every week to maintain security and performance. Now, with IObit Malware
                    Fighter Pro, everything is in one place and it takes us just a few minutes every couple of days to
                    do the same jobs with much more confidence. We have not had a problem since using your
                    products."</p>
            ...
            <div>
                ...
                <p>"Some years ago somebody drew my attention to IObit Malware Fighter. First I was sceptic. But after
                    installing it, it became my favourite anti-malware program. It is very easy to use. Through the
                    years it already has detected several threats and removed it. In cooperation with the other IObit
                    programs, like for example ASC, I have a good PC protection. I now recommend these programs to all
            ...
            <div class="active">
                ...
                <p>"We used to use up to a dozen different programs to keep our machines running smoothly and keep the
                    bad guys out. It took hours every week to maintain security and performance. Now, with IObit Malware
                    Fighter Pro, everything is in one place and it takes us just a few
                    minutes every couple of days to do the same jobs with much more confidence. We have not had a
                    problem since using your products."</p>
...
<div id="floatlayer" class="floatlayer">
    <div class="wrapper clearfix">
        ...
        <div class="price fl">
            ...
            <a class="buybtn"
               href="https://www.iobit.com/buy.php?product=imf83pciusd1995&ref=en-imf3pciusdloyal<?php echo $refStr; ?>&aff=<?php echo $_GET['aff'] ?>&refs=purchase_imf"
...
<div class="pop-box">
    ...
    <div class="right-message">
        <h3>Offer Ends in <strong id='td'>59</strong>s</h3>
        <dl>
            <dt><strong>$<b>18</b>.95</strong>
                <del>$54.95</del>
            </dt>
            <dd>
                <a href="https://www.iobit.com/buy.php?product=imf83pc1895&ref=en-imf3pcpoployal<?php echo $refStr; ?>&aff=<?php echo $_GET['aff'] ?>&refs=purchase_imf"
                   onclick=" ga('send', 'event', 'imf3pcpopbuy', 'buy', 'imfpurchase-loyal');" class="buybtn">Buy
                    Now</a></dd>
        </dl>
    </div>
</div>
