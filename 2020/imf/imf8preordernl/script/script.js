...
function soldOut() {
  ...
  setTimeout(function() {
    $(".reducebar").html('Uitverkocht');
    $(".banner .barbox .numbox").remove();
  }, 600);
  $(".price strong").html('€<b>21</b>,99');
  $(".price sup").remove();
  $(".floatlayer h2").html('70% Korting in de Voorverkoop');
  $(".floatlayer .numbox").html('Schakel volledige bescherming in met PRO');
  $(".buybtn").attr({
    "href": "https://www.iobit.com/buy.php?product=nl-imf8preorder2199&ref=nl_imf8preorder2199" + refStr + "&aff=" + aff + "&refs=nl_purchase_imf&tw=" + tw,
    "onclick": "ga('send', 'event', 'imfbuy', 'buy', 'imf8preordersoldout-nl')",
  });
}

function getNumber() {
  num = cGet("marimf8preordernl");
  if (num == null) {
