    ...
    <div class="content">
      ...
      <dl class="small left">
        ...
        <dd>
          ...
          <!-- buybtn -->
          <a class="buybtn"
             href="https://www.iobit.com/buy.php?product=es-imf83pc1999&ref=es_imf83pc1999purchase2006<?php echo $refStr;?>&refs=es_purchase_imf"
             onclick="ga('send', 'event', 'imfbuy', 'buy', 'imf3pc2006-es');">
            <i class="all-icons"></i>
            Comprar ahora
          </a>
          <!-- type -->
      ...
      <dl class="large middle">
        ...
        <dd>
          ...
          <!-- buybtn -->
          <a class="buybtn"
             href="https://www.iobit.com/buy.php?product=es-imf83pcpfsd1999&ref=es_imf83pcpfsd1999purchase2006<?php echo $refStr;?>&refs=es_purchase_imf"
             onclick="ga('send', 'event', 'imfbuy', 'buy', 'imf3pcbundle2006-es');">
            <i class="all-icons"></i>
            Comprar ahora
          </a>
          <!-- type -->
...
<div class="compare wrapper">
  ...
  <table>
    ...
    <tbody>
      ...
      <!-- 02 -->
      <tr>
        <td class="free"><i class="all-icons"></i> No disponible</td>
        <td class="icon"></td>
      ...
      <!-- 09 -->
      <tr><td class="free"><i class="all-icons"></i> No disponible</td>
        <td class="icon"></td>
...
<div class="bottombuy">
  <div class="wrapper">
    ...
    <div class="content clearfix">
      ...
      <ul class="fl">
        <li class="two active"
            data-url="https://www.iobit.com/buy.php?product=es-imf83pcpfsd1999&ref=es_imf83pcpfsd1999purchase2006<?php echo $refStr;?>&refs=es_purchase_imf&tw=-8"
            data-ga="ga('send', 'event', 'imfbuy', 'buy', 'imf3pcbundle2006-es');"
            data-price="19,"
            data-del="149,89€">
          1 Año / 3 PCs + regalos gratis
        </li>
        <li class="three"
            data-url="https://www.iobit.com/buy.php?product=es-imf83pc1999&ref=es_imf83pc1999purchase2006<?php echo $refStr;?>&refs=es_purchase_imf&tw=-8"
            data-ga="ga('send', 'event', 'imfbuy', 'buy', 'imf3pc2006-es');"
            data-price="19,"
            data-del="79,95€">
          1 Año / 3 PCs
        </li>
