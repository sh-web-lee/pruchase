...
<head>
  ...
  <title>Spara upp till 70% på IObit Malware Fighter PRO ochen exklusiv present till dig -IObit</title>
...
<div class="banner">
  <div class="wrapper">
    ...
    <div class="title">
      <h1>Välkommen att Gå med Oss!</h1>
      <p>Vi har förberett en exklusiv present till dig - vår kära nya medlem.</p>
    </div>
    <div class="panel clearfix">
      <div class="box small">
        <img src="<?php echo getStaticUrl('images/imf-box.png')?>" alt="">
        <p class="price"><strong>249 kr</strong> <del class="original">499 kr</del></p>
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=sv-imf81pc249&ref=sv_imf81pcnewinstall2005<?php echo $refStr;?>&refs=sv_purchase_imf"
           onclick="ga('send', 'event', 'imfbuy', 'buy', 'imf1pcnewinstall2005-sv');">
          <span>KÖP NU</span>
        </a>
      </div>
      <div class="box good">
        ...
        <p class="price"><strong>319 kr</strong> <del class="original">1 198 kr</del></p>
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=sv-imf814mpf319&ref=sv_imf83pc14mpfnewinstall2005<?php echo $refStr;?>&refs=sv_purchase_imf"
           onclick="ga('send', 'event', 'imfbuy', 'buy', 'imf3pcnewinstall2005-sv');">
          <span>KÖP NU</span>
        </a>
        <p class="bought">
          <img src="<?php echo $pResUrl; ?>images/people.png" alt=""> <span class="buyNum"><?php echo $buyNum;?></span> personer har aktiverat
        </p>
      </div>
    </div>
  </div>
...
<div class="feature-bg">
  ...
  <div class="feature">
    <div class="wrapper clearfix">
      <h2>För mindre än <b>0.25 kr</b> per dag/PC kan du njuta av det bästa <br>dubbla skyddet för din PC!</h2>
      ...
      <div class="right-lists">
        ...
        <dl>
          ...
          <dd>Stoppa utpressningsprogram som försöker bryta sig in i din dator. Även Petya/GoldenEye ransomware kan blockeras och tas bort.</dd>
        </dl>
        <dl>
        ...
        <dl>
          ...
          <dd>Lägger till ett extra lager skydd ovanpå anti-ransomware motor för att skydda flera filtyper och mappar från angripare.</dd>
        </dl>
  ...
  <div class="gift-message">
    <div class="wrapper">
      ...
      <div class="right-message">
        <div class="box">
          <p><b><img src="<?php echo getStaticUrl('images/point.png')?>" alt=""> &nbsp; Protected Folder</b></p>
          <p> &nbsp;&nbsp;&nbsp;&nbsp; Filskyddsverktyg som garanterar säkerheten för dina viktiga mappar, <br> &nbsp;&nbsp;&nbsp;&nbsp; data och din integritet!</p>
          <p class="last"><b><img src="<?php echo getStaticUrl('images/point.png')?>" alt=""> &nbsp; IObit Malware Fighter 8 PRO (Extra 2 månader)</b></p>
          <p> &nbsp;&nbsp;&nbsp;&nbsp; Vi har förberett en exklusiv present till dig</p>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="wrapper">
    ...
    <div class="user_rev" id="user_rev">
      ...
      <ul class="users" id="users">
        ...
        <li><img src="<?php echo $pResUrl; ?>images/peter-stoffers.jpg" alt="">Peter Stoffers</li>
      </ul>
    </div>
  </div>
</div>
  ...
  <div class="comparison_table wrapper" id="compare">
    <table border="0" cellspacing="0" cellpadding="0" width="100%">
      ...
      <tr>
        ...
        <th class="space"></th>
        <th class="itemb red">IObit Malware Fighter <br>PRO <br>(1 År / 3 PC )+Gåva</th>
      </tr>
      </thead>
      <tbody>
      <tr>
      ...
      <tr>
        ...
        <th class="space"></th>
        <th class="itema">
          1 År / 1 PC <p><strong>249<small> kr</small></strong> <del>499 kr</del></p>
          <a class="buybtn"
             href="https://www.iobit.com/buy.php?product=sv-imf81pc249&ref=sv_imf81pcnewinstall2005<?php echo $refStr;?>&refs=sv_purchase_imf"
             onclick="ga('send', 'event', 'imfbuy', 'buy', 'imf1pcnewinstall2005-sv');">
            <span>KÖP NU</span>
        ...
        <th class="space"></th>
        <th class="itemb">
          1 År / <span>3</span> PC + Gåva<p><strong>319<small> kr</small></strong> <del>1 198 kr</del></p>
          <a class="buybtn"
             href="https://www.iobit.com/buy.php?product=sv-imf814mpf319&ref=sv_imf83pc14mpfnewinstall2005<?php echo $refStr;?>&refs=sv_purchase_imf"
             onclick="ga('send', 'event', 'imfbuy', 'buy', 'imf3pcnewinstall2005-sv');">
            <span>KÖP NU</span>
