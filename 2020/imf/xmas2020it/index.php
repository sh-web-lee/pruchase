...
<head>
  ...
  <title>Speciale Natale, sconti fino all'86% su IObit Malware Fighter PRO – IObit</title>
...
<body>
  ...
  <div class="banner">
    ...
    <!-- subtitle -->
    <p>
      Sconti fino all’<b>86</b>% ! Paghi 1 e hai 3 regali GRATUITI, approfittane ora!
    </p>
    <!-- panel -->
    <div class="panel clearfix">
      ...
      <div class="message small fl">
        ...
        <dl>
          ...
          <dd>
            <a class="buybtn" href="http://www.iobit.com/buy.php?product=it-imf81pc1799&ref=it_imf81pc1799purchasexmas2020<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=it_purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase1pcxmas2020-it');"> <i class="all-icons"></i> ACQUISTA ORA </a>
          </dd>
        </dl>
      </div>
      ...
      <div class="message large fr">
        ...
        <dl>
          <dd class="clearfix">
            Risparmi : <span class="fr largeolsa"><em>139,89</em>€</span>
          </dd>
          <dd class="two">
            <p class="price"><b>19</b>,99€ <del class="largeold"><em>159,88</em>€</del></p>
          </dd>
          <dd>
            <a class="buybtn large"
               href="http://www.iobit.com/buy.php?product=it-imf83pcsdisupf1999&ref=it_imf83pcsdisupf1999purchasexmas2020<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=it_purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase3pcsdisupfxmas2020-it');"> <i class="all-icons"></i> ACQUISTA ORA </a>
          </dd>
        </dl>
      </div>
	  ...
	  <div class="message message3">
	    <dl>
	      ...
	      <dd>
	        <a class="buybtn"
	           href="http://www.iobit.com/buy.php?product=it-imf83pc1999&ref=it_imf83pc1999purchasexmas2020<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=it_purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase3pcxmas2020-it');"> <i class="all-icons"></i> ACQUISTA ORA </a>
	      </dd>
	    </dl>
	  </div>
    </div>
...
<div class="gifts-store">
	...
	<a class="buybtn" href="http://www.iobit.com/buy.php?product=it-imf83pcsdisupf1999&ref=it_imf83pcsdisupf1999purchasexmas2020<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=it_purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase3pcsdisupfxmas2020-it');"> <i class="all-icons"></i>Approfittane ora</a>
	</dd>
</div>
  <!-- comparison -->
  ...
  <div class="bottom-buy clearfix">
    ...
    <dl class="fr">
      <dd>
        <p class="price"><b>19</b>,99€ <del>159,88€</del></p>
      </dd>
      <dd>
        <a class="buybtn small" href="http://www.iobit.com/buy.php?product=it-imf83pcsdisupf1999&ref=it_imf83pcsdisupf1999purchasexmas2020<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=it_purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase3pcsdisupfxmas2020-it');">
