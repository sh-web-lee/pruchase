    ...
    <div class="panel clearfix">
      ...
      <div class="message small fl">
        ...
        <dl>
          ...
          <dd> 
            <a class="buybtn" href="https://www.iobit.com/buy.php?product=de-imf81pc1999&ref=de_imf83pcpurchase2012xr<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=de_purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imf1pcsinglepurchase2012xr-de');"> <i class="all-icons"></i> Jetzt kaufen </a>
          </dd>
        </dl>
      </div>
        ...
        <dl>
          ...
          <dd>
            <a class="buybtn large"
               ...
               href="https://www.iobit.com/buy.php?product=de-imf83pcpfsdisu1799&ref=de_imf83pcpfsdisusale2012xr<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=de_purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imf3pcbundlepurchase2012xr-de');"> <i class="all-icons"></i> Jetzt kaufen </a>
	    ...
	    <dl>
	      ...
	      <dd>
	        <a class="buybtn"
	           ...
	           href="https://www.iobit.com/buy.php?product=de-imf83pc2199&ref=de_imf83pcpurchase2012xr<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=de_purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imf3pcsinglepurchase2012xr-de')"> <i class="all-icons"></i> Jetzt kaufen </a>
	      </dd>
	    </dl>
	  </div>
    </div>
...
<div class="gifts-store">
	...
	<a class="buybtn" href="https://www.iobit.com/buy.php?product=de-imf83pcpfsdisu1799&ref=de_imf83pcpfsdisusale2012xr<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imf3pcbundlepurchase2012xr-de');"> <i class="all-icons"></i>Geschenke bekommen</a>
	</dd>
</div>
  <!-- comparison -->
  ...
  <div class="bottom-buy clearfix">
    ...
    <dl class="fr">
      ...
      <dd>
        <a class="buybtn small" href="https://www.iobit.com/buy.php?product=de-imf83pcpfsdisu1799&ref=de_imf83pcpfsdisusale2012xr<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imf3pcbundlepurchase2012xr-de');">
