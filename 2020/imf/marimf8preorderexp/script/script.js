...
function flipNum(num, length) {
  ...
  if (num < 10) {
    $(".instead").removeClass("on").addClass("on");
  }
}
// flipNum(15, 3);
...
function soldOut() {
  ...
  $(".banner .subtitle p").text("Once-per-year Presale");
  $(".banner .subtitle h2").text("Get Back to PRO Version with 55% OFF");
  $(".instead").removeClass("on");
  ...
  $(".buybtn").attr({
    "href": "https://www.iobit.com/buy.php?product=imf8preorder2495&ref=en-imf8preorderexpsoldout" + refStr + "&aff=" + aff + "&refs=purchase_imf&tw=" + tw,
    "onclick": "ga('send', 'event', 'imfsoldbuy', 'buy', 'imf8preorderexp');",
  });
  $(".banner .numbox .change").html('places of <span class="totalNum">$0</span> presale left today!');
}

function getNumber() {
  num = cGet("marimf8preorderexp");
  if (num == null) {
