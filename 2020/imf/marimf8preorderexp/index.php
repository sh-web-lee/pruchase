<?php  
  ...
  if ($_GET['action'] == 'getPacks') {
    $date = $_GET['d'];
    $c_name = 'enimf8exp_p' . $date;
    $c_name_t='enimf8exp_t' . $date;
    $isInit=$_GET['isInit'];
...
<title>Pay $0 to renew to new IObit Malware Fighter PRO</title>
...
<body>
  ...
  <div class="banner">
    <div class="wrapper">
      ...
      <div class="clearfix">
        ...
        <div class="msgbox fl">
          <div class="subtitle">
            <p>Limited to First 500 Orders</p>
            <div><h2>Get Back to PRO Version for $0</h2></div>
          </div>
          <div class="numbox">
          ...
          <ul class="price">
            ...
            <li>
              <a class="buybtn"
                 href="https://www.iobit.com/buy.php?product=imf8preorder&ref=en-imf8preorderexp<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_imf"
                 onclick="ga('send', 'event', 'imfbuy', 'buy', 'imf8preorderexp');">
                Renew Now
              </a>
            </li>
          </ul>
    ...
    <div class="wrapper">
      ...
      <div class="clearfix">
        ...
        <div class="message fr">
          <h3>Protected Your PC</h3>
          <ul>
            <li>
              Removed <?php if(!empty($_GET['fileto'])):?><b class="remove"><?php echo number_format($_GET['fileto'])?></b><?php endif;?> security threats for safer PC
            </li>
            <li>
              Stopped <?php if(!empty($_GET['rsto'])):?><b class="stop"><?php echo number_format($_GET['rsto'])?></b><?php endif;?> ransomware hijacking your PC
            </li>
            <li>Stopped 
              <b class="stop2"></b> threats from USB drive infecting your PC 
            </li>
            <li>Enabled <b>full-round</b> real-time protection</li>
          </ul>
        </div>
      </div>
      <div class="clearfix">
        <div class="message message2 fl">
          <h3>Protected Your Privacy</h3>
          <ul>
            <li>
              Detected <?php if(!empty($_GET['camto'])):?><b class="detect"><?php echo number_format($_GET['camto'])?></b><?php endif;?> untrusted accesses to your webcam
            </li>
            <li>
              Erased <?php if(!empty($_GET['traceto'])):?><b class="online"><?php echo number_format($_GET['traceto'])?></b><?php endif;?> online traces to avoid snoopers
            </li>
            <li><b>Password-protected</b> your personal files</li>
          </ul>
        </div>
      ...
      <div class="fbottom">
        <h2>Without PRO Now, You Have to <b>Say Goodbye to:</b></h2>
        <div class="clearfix">
          <div class="imgbox fl">
          ...
          <div class="message fr">
            <ul>
              <li>Malware & virus protection from Bitdefender Engine</li>
              <li>Ransomware protection from IObit Anti-ransomware Engine</li>
              <li>Camera protection against unauthorized accesses</li>
              <li>Protection against security threats from USB drive</li>
              <li>Privacy protection with automatic online trace deletion</li>
              <li>Automatic malware database updating</li>
            </ul>
          </div>
        </div>
      </div>
  ...
  <!-- moregives start -->
  <div class="moregives">
    <h2>Come Back Now, the New Version Gives You More:</h2>
    <div class="wrapper">
      <dl>
      ...
      <dl>
        ...
        <dd>
          <big>E-mail Protection</big>
          <p>to identify malicious links</p>
        </dd>
      </dl>
    </div>
  </div>
  ...
  <div id="floatlayer" class="floatlayer">
    <div class="wrapper clearfix">
      ...
      <div class="barbox fl">
        ...
        <div class="numbox">
          <b class="reduceNum"><em>2</em><em class="packsNum">2</em></b> of 500 places left today!
          <span class="instead">Or you’ll have to pay $24.95 instead.</span>
        </div>
      </div>
      <ul class="price fl">
        <li class="first">
