...
function soldOut() {
  ...
  $(".banner .msgbox h2").html('Revenez à la version PRO avec 70% de réduction');
  setTimeout(function() {
  ...
  $(".buybtn").attr({
    ...
    "onclick": "ga('send', 'event', 'imfsoldbuy', 'buy', 'imf8preorderexp-fr');"
  });
}
// soldOut();

function getNumber() {
  num = cGet("marimf8preorderexpfr");
  if (num == null) {
