...
<div class="container">
  ...
  <div class="banner wrapper">
    ...
    <!-- title -->
    <h1>
     <strong>OFFERTA ESCLUSIVA PER I MEMBRI STIMATI</strong>
      <span>Protezione totale in tempo reale porta la tua sicurezza informatica al massimo livello.</span>
    </h1>
    <!-- content -->
    <div class="content clearfix">
      ...
      <div class="box smallbox fl">
        <!-- box -->
        <img src="<?php echo getStaticUrl('images/imf-1pc.png')?>" alt=""/>
        <!-- brand -->
        <p class="brand">1 Anno / 1 PC</p>
        <!-- price -->
        <p class="price"><del>€39.95</del> €17.99</p>
        <!-- 1pc buybtn -->
        <a class="buybtn small"
           href="http://www.iobit.com/buy.php?product=it-imf81pc1799&ref=it_imf81pc1799purchase2005newllaunch<?php echo $refStr;?>&refs=it_purchase_imf"
           onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase1pc17992005newlaunch-it')">
          ACQUISTA SUBITO
        </a>
      </div>
      ...
      <div class="box largebox fl">
        ...
        <!-- box -->
        <img src="<?php echo getStaticUrl('images/imf-3pc-gifts.png')?>" alt=""/>
        <!-- brand -->
        <p class="brand">1 Anno / 3 PC + <strong>SD + PF</strong></p>
        <!-- number -->
        <p class="number"> <i class="all-icons"></i> Regali Gratis esclusivi per i membri stimati</p>
        <!-- price -->
        <p class="price"><del>€129.89</del> €17.99</p>
        <!-- 3pc+pf buybtn -->
        <a class="buybtn"
           href="http://www.iobit.com/buy.php?product=it-imf83pcpfsd1799&ref=it_imf83pcsdpf1799purchase2005newlaunch<?php echo $refStr;?>&refs=it_purchase_imf"
           onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase3pcpfsd17992005newlaunch-it')">
      ...
      <div class="box smallbox fr">
        <!-- box -->
        <img src="<?php echo getStaticUrl('images/imf-3pc.png')?>" alt=""/>
        <!-- brand -->
        ...
        <!-- 3pc buybtn -->
        <a class="buybtn small"
           href="http://www.iobit.com/buy.php?product=it-imf83pc1999&ref=it_imf83pc1999purchase2005newlaunch<?php echo $refStr;?>&refs=it_purchase_imf"
           onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase3pc19992005newlaunch-it')">
          ACQUISTA SUBITO
        </a>
      </div>
    </div>
    ...
    <li>
      <dl class="clearfix">
        ...
        <dd>
          ...
          <p>
            Elimina automaticamente i cookie e le tracce pericolose quando<br> chiudi il browser web e impedisce agli hacker online.
          </p>
        </dd>
      </dl>
    </li>
    ...
    <li>
      <dl class="clearfix">
        ...
        <dd>
          ...
          <p>
            Previene gli attacchi ransomware come WannaCry, NotPetya<br> durante il processo di avvio.
          </p>
        </dd>
      </dl>
    </li>
...
<div class="gift wrapper clearfix">
  ...
  <dl class="imf clearfix">
    ...
    <dd>
      <h3>1 ANNO / 1 PC <span>€0</span> <del>€29.99</del></h3>
      <p>Offre la migliore deframmentazione<br> del disco e accelera al massimo<br> l'hard driver!</p>
    </dd>
  </dl>
  <!--  -->
  ...
  <div class="gift-bottom">
    <!-- price -->
    <p class="price"><del>€69.94</del> €0</p>
    <!-- 3pc+pf buybtn -->
    <a class="buybtn"
       href="http://www.iobit.com/buy.php?product=it-imf83pcpfsd1799&ref=it_imf83pcsdpf1799purchase2005newlaunch<?php echo $refStr;?>&refs=it_purchase_imf"
       onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase3pcpfsd17992005newlaunch-it')">
  ...
  <table border="0" cellspacing="0" cellpadding="0" width="100%">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="text">Protegge le tue cartelle e multiplo tipi di file contro gli attacchi ransomware</td>
        <td class="space"></td>
    ...
    <tr>
      ...
      <td class="text">Protegge le tue cartelle e multiplo tipi di file contro Ransomware <em class="tab-icons nuovo">Nuovo</em></td>
      <td class="space"></td>
      <td class="itemfree gray"><i class="all-icons circle">√</i></td>
      <td class="space"></td>
      <td class="itempro"><i class="all-icons red">√</i></td>
    </tr>
    <!-- 02 -->
...
<div class="bottombuy">
  <div class="wrapper">
    <!-- title -->
    <h2>Sconti fino all’ 85%, non perderti questa occasione!</h2>
    <!-- contdown -->
    <p class="countdown">
      <i></i>
      Offerta scade tra
    ...
    <div class="content clearfix">
      ...
      <ul class="fl clearfix">
        ...
        <li class="imf3pcpf active"
            data-url="http://www.iobit.com/buy.php?product=it-imf83pcpfsd1799&ref=it_imf83pcsdpf1799purchase2005newlaunch<?php echo $refStr;?>&refs=it_purchase_imf"
            data-ga="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase3pcpfsd17992005newlaunch-it')"
            data-price="17"
            data-del="€129.89"
            data-off="€111.90">
          12 Mesi / 3 PC +SD+PF
        ...
        <!-- 3pc -->
        <li class="imf3pc"
            data-url="http://www.iobit.com/buy.php?product=it-imf83pc1999&ref=it_imf83pc1999purchase2005newlaunch<?php echo $refStr;?>&refs=it_purchase_imf"
            data-ga="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase3pc19992005newlaunch-it')"
            data-price="19"
            data-del="€59.95"
            data-off="€39.96">
          12 Mesi / 3 PC
        ...
        <!-- 1pc -->
        <li class="imf1pc"
            data-url="http://www.iobit.com/buy.php?product=it-imf81pc1799&ref=it_imf81pc1799purchase2005newllaunch<?php echo $refStr;?>&refs=it_purchase_imf"
            data-ga="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase1pc17992005newlaunch-it')"
            data-price="17"
            data-del="€39.95"
            data-off="€21.96">
          12 Mesi / 1 PC
      ...
      <div class="else fr">
        <!-- price -->
        <p class="price"> <strong>17</strong>.99 <i>Risparmi €111.90</i> <del>€129.89</del></p>
        <!-- 3pc+pf buybtn -->
        <a class="buybtn"
           href="http://www.iobit.com/buy.php?product=it-imf83pcpfsd1799&ref=it_imf83pcsdpf1799purchase2005newlaunch<?php echo $refStr;?>&refs=it_purchase_imf"
           onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase3pcpfsd17992005newlaunch-it')">
