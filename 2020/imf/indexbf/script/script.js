...
function change() {
	...
	var details = '<div class="details">' +
		'<div class="info">' +
		'<h3>Protection & Optimization Pack Sold Out!</h3>' +
		'<dl>' +
		'<dt> But IObit Malware Fighter 8 PRO Family Protection Pack on Sale Now! </dt>' +
	...
	var valuePack = '<div class="extra value-pack sold-out">' +
		'<div class="info">' +
		'<h3>Valuable Protection & Optimization Pack</h3>' +
	...
	var new3pc = "https://www.iobit.com/buy.php?product=imf83pc&ref=en-imf3pc" + refStr + "&aff=" + aff + "&refs=purchase_imf&tw=" + tw;
	var new3pcStat = "ga('send', 'event', 'imf3pcbuy', 'buy', 'imfpurchase-201905'); ";
...
function packsGet() {
	var date = new Date();
	var cName = "imfblack2020" + date.getDate();
