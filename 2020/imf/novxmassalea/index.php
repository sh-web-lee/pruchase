...
<div class="banner">
  <div class="wrapper">
    ...
    <h1 class="title">Spring Special Offer</h1>
    ...
    <div class="stage before active">
      ...
      <div class="details">
        ...
        <dl class="checkout">
          ...
          <dd>
            <a href="https://www.iobit.com/buy.php?product=imf83pciusd2599&ref=en-imf3pciusd<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_imf"
               onclick="ga('send', 'event', 'imf2599buy', 'buy', 'imfpurchase-201905');"
    ...
    <div class="extra single">
      ...
      <dl class="checkout">
        ...
        <dd>
          <a href="https://www.iobit.com/buy.php?product=imf81pc&ref=en-imf1pc<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_imf"
             onclick="ga('send', 'event', 'imf1pcbuy', 'buy', 'imfpurchase-201905');"
    ...
    <div class="extra family-pack">
      ...
      <dl class="checkout">
        ...
        <dd>
          <a href="https://www.iobit.com/buy.php?product=imf83pc&ref=en-imf3pc<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_imf"
             onclick="ga('send', 'event', 'imf3pcbuy', 'buy', 'imfpurchase-201905');"
...
<div class="gift-pack">
  <div class="wrapper">
    ...
    <div class="cartarea clearfix">
      ...
      <dl class="checkout">
        <dt>only <strong>$25.99</strong> <del>$94.93</del></dt>
        <dd><a href="https://www.iobit.com/buy.php?product=imf83pciusd2599&ref=en-imf3pciusd<?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_imf" onclick="ga('send', 'event', 'imf2599buy', 'buy', 'imfpurchase-201905'); " class="checkbtn large buylink">Activate Now</a></dd>
        <dd class="last"><i></i>100% 60-DAY MONEY BACK GUARANTEE</dd>
      </dl>
    </div>
  </div>
