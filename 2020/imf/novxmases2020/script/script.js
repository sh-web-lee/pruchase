...
function getCycleCountdown () {
  var date=new Date();
  if (MApp(2.2).cookie.get('2021specialsale')) {
    dt = MApp(2.2).cookie.get('2021specialsale');

  }else{
    dt=date.setMinutes(date.getMinutes()+12);
    MApp(2.2).cookie.set('2021specialsale', dt);
  }
...
function getPacksNum(){
  var e = new Date;
  var n1 = MApp(2.2).cookie.get('2021specialsale')/1000;
