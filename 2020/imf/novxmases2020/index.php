...
<head>
  ...
  <title>Oferta Especial para IObit Malware Fighter PRO – IObit</title>
...
<body>
  ...
  <div class="banner">
    ...
    <!-- title -->
    <h1>Venta Flash del Año Nuevo</h1>
    <!-- subtitle -->
    <p>
      ¡Descuento hasta <b>89</b>% y los regalos gratis!
    </p>
    <!-- panel -->
    <div class="panel clearfix">
      ...
      <div class="message small fl">
        ...
        <dl>
          ...
          <dd>
            <a class="buybtn" href="https://www.iobit.com/buy.php?product=es-imf81pc1799&ref=es_imf81pc1799purchase2011<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=es_purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imf1pcpurchase2011-es');"> <i class="all-icons"></i>Comprar Ahora</a>
          </dd>
        </dl>
      </div>
      ...
      <div class="message large fr">
        ...
        <dl>
          ...
          <dd class="two">
            <p class="price"><b>19</b> <del class="largeold"><em>179,88</em>€</del></p>
          </dd>
          <dd>
            <a class="buybtn large"
               href="https://www.iobit.com/buy.php?product=es-imf83pcpfsdisu1999&ref=es_imf83pcpfsdisu1999purchase2011<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=es_purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imf3pcpfsdisupurchase2011-es');"> <i class="all-icons"></i>Comprar Ahora</a>
          </dd>
        </dl>
      </div>
    </div>
    ...
    <div class="wrapper gifts-cont">
		...
		<div class="gifts-giveway gifts-giveway1">
			...
			<div class="gifts-text">
				<h4>IObit Software Updater 4 Pro <b>0€</b> <del>19,99€</del> <span>(1 año / 1PC)</span></h4>
				<ul>
		...
		<div class="gifts-giveway gifts-giveway2">
			<div class="gifts-box"></div>
			<div class="gifts-text">
				<h4>Smart Defrag 7 Pro <b>0€</b> <del>29,99€</del> <span>(1 año / 1PC)</span></h4>
				<ul>
...
<div class="gifts-store">
	...
	<a class="buybtn" href="https://www.iobit.com/buy.php?product=es-imf83pcpfsdisu1999&ref=es_imf83pcpfsdisu1999purchase2011<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=es_purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imf3pcpfsdisupurchase2011-es');"> <i class="all-icons"></i>Comprar Ahora</a>
	</dd>
</div>
  <!-- comparison -->
  ...
  <div class="bottom-buy clearfix">
    ...
    <dl class="fr">
      <dd>
        <p class="price"><b>19</b> <del>179,88€</del></p>
      </dd>
      <dd>
        <a class="buybtn small" href="https://www.iobit.com/buy.php?product=es-imf83pcpfsdisu1999&ref=es_imf83pcpfsdisu1999purchase2011<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=es_purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imf3pcpfsdisupurchase2011-es');">
