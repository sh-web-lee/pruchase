...
<head>
  ...
  <script type="text/javascript">
		...
		/*if(paramTo=='ar'){
			window.location.href='./ar.php'+queryStr;
		}else */if(paramTo == 'bd'){
			//window.location.href='./bd.php'+queryStr;
		}/*else if(paramTo=='sb'){
			window.location.href='./sb.php'+queryStr;
		}else if(paramTo=='at'){
			window.location.href='./track.php'+queryStr;
		}else if(paramTo=='usb'){
			window.location.href='./usb.php'+queryStr;
		}*/
  </script>
</head>
<body>
...
<div class="container">
  ...
  <div class="spree wrapper">
    <div class="spree-box">
      ...
      <a class="spree-buy"
         href="https://www.iobit.com/buy.php?product=fr-imf8pfiuamc2199&ref=fr_imf8pfiuamc2199indexpurchase1912<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_imf"
         onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase1912a-fr')">
      </a>
    </div>
  </div>
  <!-- end spree -->
...
<div class="main wrapper">
  ...
  <div class="banner">
    ...
    <!-- title -->
    <h1>OFFRES À DURÉE LIMITÉE</h1>
    <!-- subtitle -->
    <p>
      Jusqu'à -87% ! Achetez-en 1 et obtenez-en 3 GRATUITS ! Ne vous en manquez pas !
    </p>
    <!-- panel -->
    <div class="panel clearfix">
      ...
      <div class="message small fl">
        ...
        <dl>
          <dd class="clearfix">
            Réduction : <span class="fr">19,96€</span>
          </dd>
          <dd class="two">
          ...
          <dd>
            <a class="buybtn"
               href="https://www.iobit.com/buy.php?product=fr-imf81pc1999&ref=fr_imf81pc1999indexpurchase1912<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_imf"
               onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase1912c-fr')"
               data-num="2">
      ...
      <div class="message large fl">
        <img class="box" src="<?php echo getStaticUrl('images/imf-851.png')?>" alt="IObit Malware Fighter PRO">
        <p> 1 an, 3 PC</p>
        <!-- progress -->
        ...
        <dl>
          ...
          <dd class="one">
            Cadeaux exclusifs <i class="all-icons"></i>
            <p class="point">Cadeaux exclusifs incluent IObit Uninstaller PRO, Protected Folder et AMC Security.</p>
          </dd>
          <dd class="two">
      ...
      <div class="message small fr">
        ...
        <dl>
          ...
          <dd>
            <a class="buybtn"
               href="https://www.iobit.com/buy.php?product=fr-imf83pc2199&ref=fr_imf83pc2199indexpurchase1912<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_imf"
               onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase1912b-fr')"
               data-num="1">
              <i class="all-icons"></i> VITE, J’EN PROFITE
            </a>
          </dd>
  ...
  <div class="feature">
    ...
    <p>
      Équipé des moteurs Anti-virus & Anti-malware de Bitdefender leader mondial, <span>plus de 209 millions</span> de nouvelles menaces <br>
  ...
  <div class="intro">
    ...
    <dl class="one clearfix">
      ...
      <dd class="fl">
        ...
        <p>
          Intégrez une protection supplémentaire <br>
          basée sur le moteur Anti-Ransomware pour <br>
          empêcher vos fichiers et dossiers d’être <br>
          verrouillés et pris en otage.
        </p>
      </dd>
    </dl>
    <!-- 02 -->
  ...
  <div class="gifts">
    <!-- title -->
    <h2 class="on">Les cadeaux exclusifs, rien que pour vous !</h2>
    <!-- dl -->
  ...
  <div class="comparison">
    ...
    <!-- subtitle -->
    <h3>Achetez IObit Malware Fighter PRO avec <span>87% de réduction</span> pour une protection multicouche</h3>
    <!-- imf-85 buybtn -->
    <a class="buybtn red"
       href="https://www.iobit.com/buy.php?product=fr-imf8pfiuamc2199&ref=fr_imf8pfiuamc2199indexpurchase1912<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_imf"
       onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase1912a-fr')">
  ...
  <div class="bottom-buy clearfix">
    ...
    <!-- box -->
    <div class="box fl">
      <img class="on" src="<?php echo getStaticUrl('images/bottombuy-imf-bundle1.png')?>" alt="IObit Malware Fighter PRO">
