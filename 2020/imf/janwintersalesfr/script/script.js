...
function getCycleCountdown () {
  var date=new Date();
  if (MApp(2.2).cookie.get('frimfsale2020')) {
    dt = MApp(2.2).cookie.get('frimfsale2020');

  }else{
    dt=date.setMinutes(date.getMinutes()+10);
    MApp(2.2).cookie.set('frimfsale2020', dt);
  }
...
function getPacksNum(){
  var e = new Date;
  var n1 = MApp(2.2).cookie.get('frimfsale2020')/1000;
