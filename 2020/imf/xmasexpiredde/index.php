...
<head>
  ...
  <title>Sparen Sie heute bis zu 89% auf IObit Malware Fighter PRO - IObit</title>
...
<body>
  ...
  <div class="banner">
    ...
    <!-- subtitle -->
    <p>
    Bis zu - <b>89</b> % reduziert! 1 bezahlen und 4 bekommen! Verpassen Sie nicht!
    </p>
    <!-- panel -->
    <div class="panel clearfix">
      ...
      <div class="message small fl">
        ...
        <dl>
          ...
          <dd>
            <a class="buybtn" href="https://www.iobit.com/buy.php?product=de-imf81pc1999&ref=de_imf83pcpurchase2012exp<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=de_purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imf1pcsinglepurchase2012exp-de');"> <i class="all-icons"></i> Jetzt kaufen </a>
          </dd>
        </dl>
      </div>
      ...
      <div class="message large fr">
		...
		<div class="message-box">
			...
			<div class="message-tips"><i class="all-icons"></i><p>Zusätzliche Geschenke enthalten Smart Defrag PRO, Protected Folder und IObit Software Updater.</p></div>
		</div>
        <p> 1 Jahr / 3 PCs + <del class="messagecad">Gratisgeschenke</del></p>
        <!-- dl -->
        <dl>
          <dd class="clearfix">
            sparen : <span class="fr largeolsa"><em>139,93</em>€</span>
          </dd>
          <dd class="two">
            <p class="price"><b>17</b> <del class="largeold"><em>157,92</em>€</del></p>
          </dd>
          <dd>
            <a class="buybtn large"
            
               href="https://www.iobit.com/buy.php?product=de-imf83pcpfsdisu1799&ref=de_imf83pcpfsdisusale2012exp<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=de_purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imf3pcbundlepurchase2012exp-de');"> <i class="all-icons"></i> Jetzt kaufen </a>
	    ...
	    <dl>
	      ...
	      <dd>
	        <a class="buybtn"
	           ...
	           href="https://www.iobit.com/buy.php?product=de-imf83pc2199&ref=de_imf83pcpurchase2012exp<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=de_purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imf3pcsinglepurchase2012exp-de')"> <i class="all-icons"></i> Jetzt kaufen </a>
	      </dd>
	    </dl>
	  </div>
    </div>
...
<div class="wrapper xmas-pour">
  ...
  <div class="gifts">
    <div class="wrapper gifts-cont">
		<h2>Drei nützliche Tools als Geschenke für eine begrenzte Zeit!</h2>
		...
		<div class="gifts-giveway gifts-giveway1">
			...
			<div class="gifts-text">
				<h4>IObit Software Updater 3 PRO <b>0€</b> <del>27,99€</del> <span>(1 Jahr / 1PC)</span></h4>
				<ul>
		...
		<div class="gifts-giveway gifts-giveway2">
			<div class="gifts-box"></div>
			<div class="gifts-text">
				<h4>Smart Defrag 6 PRO <b>0€</b> <del>29,99€</del> <span>(1 Jahr / 1PC)</span></h4>
				<ul>
					<li>Defragmentiert ihre Festplatte zügig und automatisch</li>
					<li>Beschleunigt Sie den Datenzugriff zu Ordnern erheblich</li>
				</ul>
			</div>
		</div>
		<div class="gifts-giveway gifts-giveway3">
			<div class="gifts-box"></div>
			<div class="gifts-text">
				<h4>Protected Folder <b>0€</b> <del>39,95€</del> <span>(1 Jahr / 1PC)</span></h4>
				<ul>
...
<div class="gifts-store">
	...
	<a class="buybtn" href="https://www.iobit.com/buy.php?product=de-imf83pcpfsdisu1799&ref=de_imf83pcpfsdisusale2012exp<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imf3pcbundlepurchase2012exp-de');"> <i class="all-icons"></i>Geschenke bekommen</a>
	</dd>
</div>
  <!-- comparison -->
  <div class="comparison">
    <!-- title -->
    <div class="title">
      <h2>Bekommen Sie alle PRO-Funktionen für  einen vollständig geschützten PC</h2>
      <img src="<?php echo getStaticUrl('images/b-border.png')?>" alt="">
    </div>
    <!-- table -->
    <div class="cont">
      <dl>
        <dd class="one"><span>Ohne PRO </span> kann das passieren</dd>
        <dd class="two"><span>Mit PRO </span> können Sie folgendes genießen<img src="<?php echo getStaticUrl('images/sd-icon.png')?>" alt=""></dd>
      </dl>
      <table>
        <tbody>
          <tr>
            <td><span>Virusinfektionen</span> schädigen Ihren PC aufgrund der begrenzten Datenbank </td>
            <td><span>Datenbank mit 209.000.000 Anti-Viren von Bitdefender </span>schützt Ihren PC</td>
          </tr>
          <tr>
            <td><span>Neue Virusvarianten infizieren </span> Ihren PC , weil sie nicht erkannt werden</td>
            <td>Verbesserte Heuristik nutzt das Wissen über vorhandene Viren, um sogar <span>die neuesten Varianten zu erkennen </span></td>
          </tr>
          <tr>
            <td>Ransomware entführt Ihren PC und <span> sperrt alle Ihre Dateien und Daten</span></td>
            <td>Die leistungsstarke Anti-Ransomware-Engine <span>blockiert Ransomware Angriffen</span>, um Ihre Dateien zu schützen</td>
          </tr>
          <tr>
            <td><span>Ihre wichtigsten Dateien </span> werden von anderen <span>gestohlen</span> oder aufgerufen</td>
            <td>Verschiebt Ihre wichtigsten Dateien in die <span> Safe-Box </span>und somit verhindern, dass Hacker oder Benutzer Ihres PCs darauf zugreifen</td>
          </tr>
          <tr>
            <td>Hackern und Unternehmen überwachen welche Websites Sie besuchen und <span>verfolgen Ihr Online-Verhalten</span></td>
            <td>Mit Anti-Verfolgung <span>löschen Sie Ihre Spuren </span>und stellen sicher, dass Ihre Privatsphäre nicht verletzt wird</td>
          </tr>

          <tr>
            <td>Ihr PC wird <span> durch ein USB-Stick</span> infiziert</td>
            <td>USB-Speicher-Wächter <span>überprüft USB-Stick und blockiert sie</span>,wenn sie schädliche Dateien enthalten</td>
          </tr>
          
          <tr>
            <td>Hacker haben <span>Zugriff auf Ihre Webcam </span>und beobachten Sie in Ihrem eigenen Haus</td>
            <td>Kamera-Wächter stellt sicher, dass <span>niemand </span>ohne Ihre Zustimmung <span>auf Ihre Webcam zugreifen </span>kann</td>
          </tr>
        </tbody>
      </table>
    </div>
  ...
  <div class="h-list">
    <div class="title">
      <h2>IObit Malware Fighter 8 PRO kann noch mehr als Ihre vorherige Version tun!</h2>
      <img src="<?php echo getStaticUrl('images/b-border.png')?>" alt="">
    </div>
    <div class="sw">
      ...
      <div class="cont">
          <ul>
            <li>
              ...
              <h4>Größere Datenbank</h4>
              <p>Mit der 100% größeren Malware-Datenbank werden alle Bedrohungen erkannt.</p>
            </li>
            <li>
              <img src="<?php echo getStaticUrl('images/icon2.png')?>" alt="">
              <h4>Intelligenter</h4>
              <p>Mit der verbesserten  Heuristik wird Ihr PC sogar vor neuen Virusvarianten geschützt.</p>
            </li>
            <li>
              <img src="<?php echo getStaticUrl('images/icon3.png')?>" alt="">
              <h4>Schneller</h4>
              <p>Scannt Ihren PC 50% schneller, um mehr Zeit zu sparen.</p>
            </li>
            <li>
              <img src="<?php echo getStaticUrl('images/icon4.png')?>" alt="">
              <h4>Sichere E-Mails</h4>
              <p>Schützt Ihre E-Mails auch vor Spam, Phishing und böswilligen Links.</p>
            </li>
  ...
  <div class="bottom-buy clearfix">
    ...
    <dl class="fr">
      <dd>
        <p class="price"><b>17</b> <del>157,92€</del></p>
      </dd>
      <dd>
        <a class="buybtn small" href="https://www.iobit.com/buy.php?product=de-imf83pcpfsdisu1799&ref=de_imf83pcpfsdisusale2012exp<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imf3pcbundlepurchase2012exp-de');">
  ...
  <div class="footer">
    <div class="content">
      <dl>
        ...
        <dd>* .Smart Defrag 6 PRO /Protected Folder/ IObit Software Updater unterstützt 1 Jahr / 1 PC.</dd>
      </dl>
