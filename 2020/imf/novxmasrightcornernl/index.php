    ...
    <div class="panel clearfix">
      ...
      <div class="message small fl">
        ...
        <dl>
          ...
          <dd>
            <a class="buybtn" href="https://www.iobit.com/buy.php?product=nl-imf83pc2199&ref=nl_imf83pc2199rightcornerpurchase2011<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=nl_purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfrightcornerpurchase2011-nl');"> <i class="all-icons"></i> Nu bestellen </a>
          </dd>
        </dl>
      </div>
        ...
        <dl>
          ...
          <dd>
            <a class="buybtn large"
               href="https://www.iobit.com/buy.php?product=nl-imf83pcsdiu1999&ref=nl_imf83pcsdiu1999rightcornerpurchase2011<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=nl_purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfrightcornerpurchase2011-nl');"> <i class="all-icons"></i> Nu bestellen</a>
          </dd>
        </dl>
      </div>
    </div>
...
<div class="gifts-store">
	...
	<a class="buybtn" href="https://www.iobit.com/buy.php?product=nl-imf83pcsdiu1999&ref=nl_imf83pcsdiu1999rightcornerpurchase2011<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=nl_purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfrightcornerpurchase2011-nl');"> <i class="all-icons"></i>BESTEL NU EN KRIJG CADEAUS</a>
	</dd>
</div>
  <!-- comparison -->
  ...
  <div class="bottom-buy clearfix">
    ...
    <dl class="fr">
      <dd>
        <p class="price">€<b>19</b>,99 <del>€133,88</del></p>
      </dd>
      <dd>
        <a class="buybtn small" href="https://www.iobit.com/buy.php?product=nl-imf83pcsdiu1999&ref=nl_imf83pcsdiu1999rightcornerpurchase2011<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=nl_purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfrightcornerpurchase2011-nl');">
