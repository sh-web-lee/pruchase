...
function soldOut() {
  ...
  $(".banner .msgbox h2").html('Gå Tillbaka till PRO version med 54% RABATT');
  setTimeout(function() {
  ...
  $(".buybtn").attr({
    ...
    "onclick": "ga('send', 'event', 'imfsoldbuy', 'buy', 'imf8predorderexp-sv');",
  });
}
// soldOut();

function getNumber() {
  num = cGet("marimf8preorderexpsv");
  if (num == null) {
