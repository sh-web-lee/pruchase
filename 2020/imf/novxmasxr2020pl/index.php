...
<head>
  ...
  <title>Zaoszczędź do 87% na IObit Malware Fighter PRO z okazji Bożego Narodzenia - IObit!</title>
...
<body>
      ...
      <div class="panel clearfix">
        ...
        <div class="message small fl">
          ...
          <dl>
            <dd class="clearfix">
              &emsp;&emsp;&emsp;&emsp;
              Oszczędzasz : <span class="fr">90 zł</span>
            </dd>
            <dd class="two">
              <p class="price"><b>69</b> <del>159,00 zł</del></p>
            </dd>
            <dd>
              <a class="buybtn" href="https://www.iobit.com/buy.php?product=pl-imf81pc69&ref=pl_imf81pc69purchase2011xr<?php echo $refStr; ?>&aff=<?php echo $_GET['aff'] ?>&refs=pl_purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfxmas2011xr-pl');"> <i class="all-icons"></i> KUP TERAZ </a>
            </dd>
          </dl>
        </div>
        ...
        <div class="message large fr">
          ...
          <dl>
            <dd class="clearfix">
              &emsp;&emsp;
              Oszczędzasz : <span class="fr largeolsa"><em>519,70</em> zł</span>
            </dd>
            <dd class="two">
              <p class="price"><b>79</b> <del class="largeold"><em>599,60</em> zł</del></p>
            </dd>
            <dd>
              <a class="buybtn large" href="https://www.iobit.com/buy.php?product=pl-imf83pcsdpfiu79&ref=pl_imf83pcsdpfiu79purchase2011xr<?php echo $refStr; ?>&aff=<?php echo $_GET['aff'] ?>&refs=pl_purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfxmas2011xr-pl');"> <i class="all-icons"></i> KUP TERAZ </a>
        ...
        <div class="message message3">
          <dl>
            <dd class="two">
              <p class="price"><b>79</b> <del>519,70 zł</del></p>
            </dd>
            <dd>
              <a class="buybtn" href="https://www.iobit.com/buy.php?product=pl-imf83pc79&ref=pl_imf83pc79purchase2011xr<?php echo $refStr; ?>&aff=<?php echo $_GET['aff'] ?>&refs=pl_purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfxmas2011xr-pl')"> <i class="all-icons"></i> KUP TERAZ </a>
            </dd>
          </dl>
        </div>
      </div>
  ...
  <div class="gifts-store">
    ...
    <a class="buybtn" href="https://www.iobit.com/buy.php?product=pl-imf83pcsdpfiu89&ref=pl_imf83pcsdpfiu89purchase2011<?php echo $refStr; ?>&aff=<?php echo $_GET['aff'] ?>&refs=pl_purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfxmas2011xr-pl');"> <i class="all-icons"></i>Ciesz się tym teraz</a>
    </dd>
  </div>
  ...
  <div class="bottom-buy clearfix">
    ...
    <div class="wrapper bottom-buy-center">
      ...
      <dl class="fr">
        <dd>
          <p class="price"><b>79</b> <del>599,60zł</del></p>
        </dd>
        <dd>
          <a class="buybtn small" href="https://www.iobit.com/buy.php?product=pl-imf83pcsdpfiu89&ref=pl_imf83pcsdpfiu89purchase2011<?php echo $refStr; ?>&aff=<?php echo $_GET['aff'] ?>&refs=pl_purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfxmas2011xr-pl');">
