...
function soldOut() {
  ...
  $(".price sup").remove();
  $(".banner h2").html('Tilbage til PRO-version med 66% rabat');
  ...
  $(".buybtn").attr({
    ...
    "onclick": "ga('send', 'event', 'imfbuy', 'buy', 'imf8predorderexpsoldout-dk');",
  });
}
// soldOut();

function getNumber() {
  num = cGet("marimf8preorderexpdk");
  if (num == null) {
