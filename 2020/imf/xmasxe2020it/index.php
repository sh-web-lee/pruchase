    ...
    <div class="panel clearfix">
      ...
      <div class="message small fl">
        ...
        <dl>
          ...
          <dd>
            <a class="buybtn" href="http://www.iobit.com/buy.php?product=it-imf81pc1799&ref=it_imf81pc1799purchasexmasxe2020<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=it_purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase1pcxmasxe2020-it');"> <i class="all-icons"></i> ACQUISTA ORA </a>
          </dd>
        </dl>
      </div>
        ...
        <dl>
          ...
          <dd>
            <a class="buybtn large"
               href="http://www.iobit.com/buy.php?product=it-imf83pcsdisupf1699&ref=it_imf83pcsdisupf1699purchasexmasxe2020<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=it_purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase3pcsdisupfxmasxe2020-it');"> <i class="all-icons"></i> ACQUISTA ORA </a>
          </dd>
        </dl>
      </div>
	  ...
	  <div class="message message3">
	    <dl>
	      ...
	      <dd>
	        <a class="buybtn"
	           href="http://www.iobit.com/buy.php?product=it-imf83pc1999&ref=it_imf83pc1999purchasexmasxe2020<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=it_purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase3pcxmasxe2020-it');"> <i class="all-icons"></i> ACQUISTA ORA </a>
	      </dd>
	    </dl>
	  </div>
    </div>
...
<div class="wrapper xmas-pour">
  ...
  <div class="comparison">
    <h2>Riottieni tutte le funzionalità PRO per un PC<br> completamente protetto</h2>
    <table class="wrapper">
      <thead>
        <tr>
          <th class="itema"><big>Attento!</big> Al momento rischi …</th>
          <th class="itemb"><big>Invece puoi godere di …</big></th>
        </tr>
      </thead>
      <tbody>
        <tr>
          <td class="itema">
            <span>Infezioni virus</span> che danneggiano il tuo PC a causa del database limitato
          </td>
          <td class="itemb">
            <span>Database di 209.000.000 virus di Bitdefender</span> che mantiene il tuo PC al sicuro
          </td>
        </tr>
        <tr>
          <td class="itema">
            <span>Nuove varianti di virus</span> che infettano il tuo PC perché non vengono riconosciute
          </td>
          <td class="itemb">
            Euristica Avanzata che utilizza la conoscenza dei virus esistenti per <span>rilevare anche le varianti più recenti</span>
          </td>
        </tr>
        <tr>
          <td class="itema">
            Ransomware che si infiltrano nel tuo PC e <span>bloccano tutti i tuoi file e dati personali</span>
          </td>
          <td class="itemb">
            Potente motore Anti-ransomware che <span>blocca gli attacchi ransomware</span> per mantenere i tuoi file al sicuro
          </td>
        </tr>
        <tr>
          <td class="itema">
            <span>I tuoi file più importanti vengono rubati</span> o visionati da altri
          </td>
          <td class="itemb">
            Protezione dei tuoi file più importanti nella <span>Cassetta di Sicurezza</span> per evitare che hacker o utenti del tuo PC vi accedano
          </td>
        </tr>
        <tr>
          <td class="itema">
            Hacker e aziende monitorano i siti web che visiti e <span>tracciano il tuo comportamento online</span>
          </td>
          <td class="itemb">
            Anti-tracking che <span>elimina le tue tracce</span> e ti assicura che la tua privacy non venga violata
          </td>
        </tr>
        <tr>
          <td class="itema">
            Il tuo PC viene <span>infettato tramite un disco USB</span>
          </td>
          <td class="itemb">
            Protezione Disco USB che <span>controlla i dischi USB e li blocca</span> se contengono file dannosi
          </td>
        </tr>
  		<tr>
  		  <td class="itema">
  		    Gli hacker hanno <span>accesso alla tua webcam</span> e ti spiano quando sei a casa
  		  </td>
  		  <td class="itemb">
  		    Protezione Camera che garantisce che <span>nessuno acceda alla tua webcam</span> senza il tuo consenso
  		  </td>
  		</tr>
      </tbody>
    </table>
  ...
  <div class="offermore clearfix">
    <h2>IObit Malware Fighter 8 PRO può fare molto di più<br> rispetto alla tua versione precedente!</h2>
  	<div class="offermorecnt">
    <dl>
      <dt><img src="<?php echo getStaticUrl('images/offermore-01.png')?>" alt=""/></dt>
      <dd>
        <h3>Database più grande</h3>
        <p>Con il database malware più grande del 100% vengono rilevate tutte le minacce</p>
      </dd>
    </dl>
    <dl>
      ...
      <dd>
        ...
        <p>Con l'Euristica Avanzata sei protetto anche dalle nuove varianti di virus.</p>
      </dd>
    </dl>
  	<dl>
  	  ...
  	  <dd>
  	    <h3>Più veloce</h3>
  	    <p>Scansiona il tuo PC con una velocità maggiore al 50% per farti risparmiare tempo prezioso.</p>
  	  </dd>
  	</dl>
    <dl>
      ...
      <dd>
        <h3>Email sicure</h3>
        <p>Ora IObit Malware Fighter protegge anche le tue email da spam, phishing e collegamenti dannosi.</p>
      </dd>
    </dl>
  </div>
  </div>
  ...
  <div class="bottom-buy clearfix">
    ...
    <dl class="fr">
      ...
      <dd>
        <a class="buybtn small" href="http://www.iobit.com/buy.php?product=it-imf83pcsdisupf1699&ref=it_imf83pcsdisupf1699purchasexmasxe2020<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=it_purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase3pcsdisupfxmasxe2020-it');">
