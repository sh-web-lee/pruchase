...
function soldOut() {
  ...
  $(".banner .msgbox h2").html('R$ 0 para adquirir o IObit Malware Fighter 8 PRO <br> na pré-venda');
  setTimeout(function() {
  ...
  $(".buybtn").attr({
    "href": "https://www.iobit.com/buy.php?product=pt-imf83pc6999&ref=pt-imf8preordersoldout"+ refStr +"&aff=" + aff + "&refs=pt_purchase_imf&tw=" + tw,
    "onclick": "ga('send', 'event', 'imfsoldbuy', 'buy', 'imf8predorderexp-pt');"
  });
}
// soldOut();

function getNumber() {
  num = cGet("marimf8preorderexppt");
  if (num == null) {
