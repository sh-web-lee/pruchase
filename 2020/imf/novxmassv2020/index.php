...
<head>
  ...
  <title>Spara upp till 85% på IObit Malware Fighter PRO och få ett gåvopaket – IObit</title>
...
<body>
  ...
  <div class="banner">
    ...
    <!-- subtitle -->
    <p>
      Upp till -<b> 85</b>% på IObit Malware Fighter och få en gratis
    </p>
    <!-- panel -->
    <div class="panel clearfix">
      ...
      <div class="message small fl">
        ...
        <dl>
          ...
          <dd>
            <a class="buybtn" href="https://www.iobit.com/buy.php?product=sv-imf83pc319&ref=sv_imf83pc319purchase2011<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=sv_purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imf3pcpurchase2011-sv')"> <i class="all-icons"></i> KÖP NU </a>
          </dd>
        </dl>
      </div>
      ...
      <div class="message large fr">
        ...
        <dl>
          ...
          <dd class="two">
            <p class="price"><b>319</b> <del class=""><em>2 196</em>kr</del></p>
          </dd>
          <dd>
            <a class="buybtn large"
               href="https://www.iobit.com/buy.php?product=sv-imf83pcpfsdisu319&ref=sv_imf83pcpfsdisu319purchase2011<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=sv_purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imf3pcpfsdisupurchase2011-sv');"> <i class="all-icons"></i> KÖP NU </a>
    ...
    <div class="wrapper gifts-cont">
		...
		<div class="gifts-giveway gifts-giveway1">
			...
			<div class="gifts-text">
				<h4>IObit Software Updater 4 PRO <b>0kr</b> <del>599kr</del> <span>(1 År / 1 PC)</span></h4>
				<ul>
		...
		<div class="gifts-giveway gifts-giveway2">
			<div class="gifts-box"></div>
			<div class="gifts-text">
				<h4>Smart Defrag 7 PRO <b>0kr</b> <del>459kr</del> <span>(1 År / 1 PC)</span></h4>
				<ul>
...
<div class="gifts-store">
	...
	<a class="buybtn" href="https://www.iobit.com/buy.php?product=sv-imf83pcpfsdisu319&ref=sv_imf83pcpfsdisu319purchase2011<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=sv_purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imf3pcpfsdisupurchase2011-sv');"> <i class="all-icons"></i>KÖP NU</a>
	</dd>
</div>
...
<!-- end awards -->
  ...
  <div class="bottom-buy clearfix">
    ...
    <ul class="fl">
      ...
      <li class="active mid">1 År / 3 PC + <small>GÅVOR PRO</small></li>
    </ul> 
    <!-- dl -->
    <dl class="fr">
      <dd>
        <p class="price"><b>319</b> <del>2 196kr</del></p>
      </dd>
      <dd>
        <a class="buybtn small" href="https://www.iobit.com/buy.php?product=sv-imf83pcpfsdisu319&ref=sv_imf83pcpfsdisu319purchase2011<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=sv_purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imf3pcpfsdisupurchase2011-sv');">
