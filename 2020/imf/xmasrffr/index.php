...
<head>
  ...
  <title>Jusqu'à -90% sur IObit Malware Fighter PRO - Vente Flash de Noël - IObit</title>
...
<body>
  ...
  <div class="banner">
    ...
    <!-- subtitle -->
    <p>
      Jusqu'à -<b>90</b>% ! Achetez-en 1 et obtenez-en 3 GRATUITS ! Ne vous en manquez pas !
    </p>
    <!-- panel -->
    <div class="panel clearfix">
      ...
      <div class="message small fl">
        ...
        <dl>
          ...
          <dd>
            <a class="buybtn" href="https://www.iobit.com/buy.php?product=fr-imf81pc1999&ref=fr_imf81pc1999purchase2012<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchasexrf2012a-fr');"> <i class="all-icons"></i> VITE, J’EN PROFITE </a>
          </dd>
        </dl>
      </div>
      ...
      <div class="message large fr">
        ...
        <dl>
          <dd class="clearfix">
            Réduction : <span class="fr largeolsa"><em>179,97</em>€</span>
          </dd>
          <dd class="two">
            <p class="price"><b>19</b> <del class="largeold"><em>199,96</em>€</del></p>
          </dd>
          <dd>
            <a class="buybtn large"
               href="https://www.iobit.com/buy.php?product=fr-imf83pcpfsdisu1999&ref=fr_imf83pcpfsdisu1999purchase2012<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchasexrf2012b-fr');"> <i class="all-icons"></i> VITE, J’EN PROFITE </a>
          </dd>
        </dl>
      </div>
    </div>
...
<div class="gifts-store">
	...
	<a class="buybtn" href="https://www.iobit.com/buy.php?product=fr-imf83pcpfsdisu1999&ref=fr_imf83pcpfsdisu1999purchase2012<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchasexrf2012b-fr');"> <i class="all-icons"></i>Profitez-en maintenant</a>
	</dd>
</div>
  <!-- comparison -->
  <div class="comparison">
    <!-- title -->
    <h2>La version PRO vous offre une protection plus complète !</h2>
    <!-- table -->
    <table>
      <thead>
        <tr>
  ...
  <div class="bottom-buy clearfix">
    ...
    <dl class="fr">
      <dd>
        <p class="price"><b>19</b> <del>199,96€</del></p>
      </dd>
      <dd>
        <a class="buybtn small" href="https://www.iobit.com/buy.php?product=fr-imf83pcpfsdisu1999&ref=fr_imf83pcpfsdisu1999purchase2012<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchasexrf2012b-fr');">
