...
function soldOut() {
  ...
  $(".price sup").remove();
  $(".banner h2").html('Einmal im Jahr Vorverkauf  <br> Zurück zur PRO-Version mit 63% Rabatt');
  ...
  $(".buybtn").attr({
    ...
    "onclick": "ga('send', 'event', 'imfsoldbuy', 'buy', 'imf8predorderexp-de');",
  });
}
// soldOut();

function getNumber() {
  num = cGet("marimf8preorderexpde");
  if (num == null) {
