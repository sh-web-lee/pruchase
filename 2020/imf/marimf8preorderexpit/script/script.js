...
function soldOut() {
  ...
  $(".banner .msgbox h2").html('Ottieni di nuovo la tua versione PRO con il<br> 65% DI SCONTO');
  setTimeout(function() {
  ...
  $(".buybtn").attr({
    ...
    "onclick": "ga('send', 'event', 'imfbuy', 'buy', 'imf8predordere1999xp-it');",
  });
}
// soldOut();

function getNumber() {
  num = cGet("marimf8preorderexpit");
  if (num == null) {
