...
<head>
  ...
  <title>Économisez jusqu'à 87% sur IObit Malware Fighter PRO et recevez un pack de 3 outils PRO en cadeau. Quantités limitées à 1 000 packs !</title>
...
<div class="container">
  ...
  <div class="spree wrapper">
    <div class="spree-box">
      ...
      <a class="spree-buy"
         href="https://www.iobit.com/buy.php?product=fr-imf7amcpfsd2199&ref=fr_imf7pfsdamc2199purchase2004<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_imf"
         onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase2004a-fr');">
      </a>
    </div>
  </div>
  <!-- end spree -->
...
<div class="main wrapper">
  ...
  <div class="banner">
    ...
    <!-- title -->
    <h1>Vente Spéciale de Pâques</h1>
    <!-- subtitle -->
    <p>Quantités limitées à 1 000 packs ! Déjà <b class="soldNum">853</b> vendus, n’attendez pas la dernière minute !</p>
    <!-- panel -->
    <div class="panel clearfix">
      ...
      <div class="message small fl">
        ...
        <dl>
          ...
          <dd>
            <a class="buybtn"
               href="https://www.iobit.com/buy.php?product=fr-imf71pc1999&ref=fr_imf71pc1999purchase2004<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_imf"
               onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase2004c-fr');"
               data-num="2">
      ...
      <div class="message large fl">
        <span class="reduce">-1</span>
        <img class="box" src="<?php echo getStaticUrl('images/imf-87.png')?>" alt="IObit Malware Fighter PRO">
        <p> 1 an, 3 PC</p>
        <!-- progress -->
        ...
        <dl>
          ...
          <dd class="one">
            ...
            <p class="point">Cadeaux exclusifs incluent Smart Defrag <br> 6 PRO, Protected Folder et AMC Security.</p>
          </dd>
          <dd class="two">
      ...
      <div class="message small fr">
        ...
        <dl>
          ...
          <dd>
            <a class="buybtn"
               href="https://www.iobit.com/buy.php?product=fr-imf73pc2199&ref=fr_imf73pc2199purchase2004<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_imf"
               onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase2004b-fr');"
               data-num="1">
              <i class="all-icons"></i> VITE, J’EN PROFITE
            </a>
          </dd>
    ...
    <div class="content clearfix">
      ...
      <dl class="sd">
        ...
        <dd>
          ...
          <p class="detail">
            Maximisez les performances et la durée de <br>
            votre disque en défragmentant les registres <br>
            et les fichiers du système
          </p>
        </dd>
      </dl>
      <!-- pf -->
