...
<head>
  ...
  <title>Spara upp till 75% för dig för att få vårt bästa skydd -IObit</title>
...
<div class="banner">
  <div class="wrapper">
    ...
    <div class="title">
      ...
      <p>Exklusiv gåva! Bara några få paket kvar!</p>
    </div>
    <div class="panel clearfix">
      <div class="box small">
        ...
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=sv-imf81pc249&ref=sv_imf81pcnewlaunch2005<?php echo $refStr;?>&refs=sv_purchase_imf"
           onclick="ga('send', 'event', 'imfbuy', 'buy', 'imf1pcnewlaunch2005-sv');">
          <span>KÖP NU</span>
        </a>
      </div>
      <div class="box good">
        ...
        <p class="price"><strong>299 kr</strong> <del class="original">1 198 kr</del></p>
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=sv-imf814mpf299&ref=sv_imf83pc14mpfnewlaunch2005<?php echo $refStr;?>&refs=sv_purchase_imf"
           onclick="ga('send', 'event', 'imfbuy', 'buy', 'imf3pcnewlaunch2005-sv');">
          <span>KÖP NU</span>
        </a>
        <p class="bought">
  ...
  <div class="comparison_table wrapper" id="compare">
    <table border="0" cellspacing="0" cellpadding="0" width="100%">
      ...
      <tr>
        ...
        <th class="space"></th>
        <th class="itemb">
          1 År / <span>3</span> PC + Gåva<p><strong>299<small> kr</small></strong> <del>1 198 kr</del></p>
          <a class="buybtn"
             href="https://www.iobit.com/buy.php?product=sv-imf814mpf299&ref=sv_imf83pc14mpfnewlaunch2005<?php echo $refStr;?>&refs=sv_purchase_imf"
             onclick="ga('send', 'event', 'imfbuy', 'buy', 'imf3pcnewlaunch2005-sv');">
            <span>KÖP NU</span>
