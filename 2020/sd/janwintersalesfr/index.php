...
<head>
  ...
  <title>Jusqu'à -80% sur Smart Defrag PRO et profitez dès maintenant ce prix baissé - Soldes d'hiver !</title>
...
<div class="container">
  ...
  <div class="spree wrapper">
    <div class="spree-box">
      ...
      <a class="spree-buy"
         href="https://www.iobit.com/buy.php?product=fr-sd63pcpf1799&ref=fr_sd63pcpf1799purchase2001<?php echo $refStr;?>&refs=fr_purchase_sd"
         onclick="ga('send', 'event', 'sdbuy', 'buy', 'sdpurchase2001a-fr');">
      </a>
    </div>
  </div>
  <!-- end spree -->
...
<div class="main wrapper">
  ...
  <div class="banner">
    ...
    <!-- subtitle -->
    <p>Si vous avez manqué Noël, ne ratez pas nos meilleures offres d’hiver ! Les prix baissés !</p>
    <!-- panel -->
    <div class="panel clearfix">
      ...
      <div class="message small fl">
        ...
        <dl>
          ...
          <dd>
            <a class="buybtn"
               href="https://www.iobit.com/buy.php?product=fr-sd61y3pc1999&ref=fr_sd61y3pc1999purchase2001<?php echo $refStr;?>&refs=fr_purchase_sd"
               onclick="ga('send', 'event', 'sdbuy', 'buy', 'sdpurchase2001b-fr');"
               data-num="2">
      ...
      <div class="message large fl">
        ...
        <dl>
          ...
          <dd class="two">
            <p class="price red"><b>17</b> <del>89,98€</del></p>
          </dd>
          <dd>
      ...
      <div class="message small fr">
        ...
        <dl>
          ...
          <dd>            
            <a class="buybtn"
               href="https://www.iobit.com/buy.php?product=fr-sd61pc1799&ref=fr_sd61pc1799purchase2001<?php echo $refStr;?>&refs=fr_purchase_sd"
               onclick="ga('send', 'event', 'sdbuy', 'buy', 'sdpurchase2001c-fr');"
               data-num="1">
              <i class="all-icons"></i> J’en profite !
            </a>
          </dd>
  ...
  <div class="comparison">
    ...
    <!-- subtitle -->
    <h4>Activez Smart Defrag PRO avec <span>80%</span> de remise pour un démarrage plus rapide (jusqu’à 200%)</h4>
    <!-- imf-85 buybtn -->
    <a class="buybtn red"
       href="https://www.iobit.com/buy.php?product=fr-sd63pcpf1799&ref=fr_sd63pcpf1799purchase2001<?php echo $refStr;?>&refs=fr_purchase_sd"
       onclick="ga('send', 'event', 'sdbuy', 'buy', 'sdpurchase2001a-fr');">
  ...
  <div class="bottom-buy clearfix">
    <!-- title -->
    <h2 class="on">Ne cherchez plus, les meilleures offres sont là !</h2>
    <!-- box -->
    <div class="box fl">
    ...
    <!-- ul -->
    <ul class="fl">
      <li class="active top">1 An / 3 PC + Cadeau Exclusif</li>
    ...
    <dl class="fr">
      <dd>
        <p class="price"><b>17</b> <del>89,98€</del></p>
      </dd>
      <dd>
