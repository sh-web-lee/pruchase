...
function maskShow() {
	...
	$(".mask-box").remove();
	$.getUrlParam("aff");
	$("body").append('<div class="mask"></div><div class="mask-box"><h2>A Christmas Surprice</h2><div class="clearfix"><div class="fl left"><img src="' + imgSrc + '" alt="Smart Defrag"/></div><div class="price fl"><h3>Extra <b>$ <big>1</big> OFF</b> for you exclusively!</h3><p><strong>Only $<big>10</big>.99</strong> <b>1 year / 3 PCs</b></p><a class="buybtn" href="' + _href + '" onclick="' + _ga + '"><i class="all-icons"></i><span>Activate Now</span></a><p class="year">Seize your last chance for the biggest saving ever!</p></div></div></div>'),
