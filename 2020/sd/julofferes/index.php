...
<div class="banner">
  <div class="wrapper">
    ...
    <dl class="price">
      ...
      <dd>
        <a href="https://www.iobit.com/buy.php?product=es-sd63pcpfamc1599&ref=es_sd63pcpfamc1599purchase2007<?php echo $refStr;?>&refs=es_purchase_sd"
           onclick="ga('send', 'event', 'sdbuy', 'buy', 'sd3pcpfamc2007-es')"
           class="buybtn">
          Comprar ahora
        </a>
      </dd>
  ...
  <div class="wrapper">
    ...
    <div class="clearfix">
      <div class="gift-list">
        ...
        <ul class="fl">
          <li>Escanea automáticamente y limpia tu móvil.</li>
          <li>Asegura el pago de tus compras.</li>
        </ul>
      </div>
    ...
    <div class="price">
      ...
      <a class="buybtn"
         href="https://www.iobit.com/buy.php?product=es-sd63pcpfamc1599&ref=es_sd63pcpfamc1599purchase2007<?php echo $refStr;?>&refs=es_purchase_sd"
         onclick="ga('send', 'event', 'sdbuy', 'buy', 'sd3pcpfamc2007-es')">
        Comprar ahora
      </a>
