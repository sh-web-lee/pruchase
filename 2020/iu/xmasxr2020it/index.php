...
<body>
  <nav>
    ...
    <div class="book clearfix">
      <div class="one left ">
        ...
        <a href="http://www.iobit.com/buy.php?product=it-iu103pc1599&ref=it_iu103pc1599purchasexmasxr2020<?= $refStr; ?>&refs=it_purchase_iu">
          <button onclick="ga('send', 'event', 'iubuy', 'buy', 'iupurchase3pcxmasxr2020-it')">ACQUISTA ORA</button>
        </a>
      </div>
      <div class="two left">
        <div class="two-up">
        ...
        <a href="http://www.iobit.com/buy.php?product=it-iu103pcsdisupf1399&ref=it_iu103pcsdisupf1399purchasexmasxr2020<?= $refStr; ?>&refs=it_purchase_iu">
          <button onclick="ga('send', 'event', 'iubuy', 'buy', 'iupurchase3pcsdisupfxmasxr2020-it')">
            ACQUISTA ORA
          </button>
        </a>
  ...
  <article id="arti">
    <div class="art">
      ...
      <div class="num3">
        <a href="http://www.iobit.com/buy.php?product=it-iu103pcsdisupf1399&ref=it_iu103pcsdisupf1399purchasexmasxr2020<?= $refStr; ?>&refs=it_purchase_iu">
          <button onclick="ga('send', 'event', 'iubuy', 'buy', 'iupurchase3pcsdisupfxmasxr2020-it')">APRI I REGALI</button>
          <p>
        </a>
  ...
  <section class="clearfix" id="sect">
    <div class="sec">
      ...
      <div class="sec-buy">
        ...
        <a href="http://www.iobit.com/buy.php?product=it-iu103pcsdisupf1399&ref=it_iu103pcsdisupf1399purchasexmasxr2020<?= $refStr; ?>&refs=it_purchase_iu" id="hrf">
          <button onclick="ga('send', 'event', 'iubuy', 'buy', 'iupurchase3pcsdisupfxmasxr2020-it')">ACQUISTA ORA</button>
        </a>
...
<script>
  ...
  function getCycleCountdown() {
    var date = new Date();
    if (MApp(2.2).cookie.get('xmasxrit2020')) {
      dt = MApp(2.2).cookie.get('xmasxrit2020');

    } else {
      dt = date.setMinutes(date.getMinutes() + 15);
      MApp(2.2).cookie.set('xmasxrit2020', dt);
    }
  ...
  function soldOut() {
    ...
    $('#hrf').attr('href', 'http://www.iobit.com/buy.php?product=it-iu103pc1599&ref=it_iu103pc1599purchasexmasxr2020<?= $refStr; ?>&refs=it_purchase_iu')
  }
  $('#btnidex').on('click', function() {
      if (numidex == 1) {
        ga('send', 'event', 'iubuy', 'buy', 'iupurchase3pcsdisupfxmasxr2020-it')
      } else {
        ga('send', 'event', 'iubuy', 'buy', 'iupurchase3pcxmasxr2020-it')
      }
    })
    (function() {
      countdown(("#timeout"));
