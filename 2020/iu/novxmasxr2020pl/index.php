...
<head>
  ...
  <title>Zaoszczędź do 88% na IObit Uninstaller PRO z okazji Bożego Narodzenia - IObit! </title>
...
<body>
    ...
    <div class="book clearfix">
      <div class="one left ">
        ...
        <p style="text-align: right;">
          54<span style="font-size: 18px;">,90 zł</span> <i style="font-size: 18px; color: #838395;text-decoration: line-through;">199,90 zł</i>
        </p>
        <div style="text-align: left;">
          <img src="<?= $pResUrl; ?>static/img/ISU.png" alt="">
        </div>
        <a href="http://www.iobit.com/buy.php?product=pl-iu103pc54&ref=pl_iu103pc54purchase2011xr<?= $refStr; ?>&refs=pl_purchase_iu">
      ...
      <div class="two left">
        ...
        <p style="text-align: right;font-size: 60px; font-weight: 600;margin-right: 20px;">
          54<span style="font-size: 22px;">,90zł</span> <i style="font-size: 22px; color: #838395;text-decoration: line-through;">509,60 zł</i>
        </p>
        <div style="text-align: left;margin-left: 25px;margin-top: -19px;">
          <img src="<?= $pResUrl; ?>static/img/box.png" alt="">
        </div>
        <a href="http://www.iobit.com/buy.php?product=pl-iu103pcisupfsd54&ref=pl_iu103pcsdpfisu54purchase2011xr<?= $refStr; ?>&refs=pl_purchase_iU">
          <button onclick="ga('send', 'event', 'iubuy', 'buy', 'iuxmas2011xr-pl')">
            KUP TERAZ
          </button>
        </a>
  ...
  <article id="arti">
    <div class="art">
      ...
      <div class="num3">
        <a href="http://www.iobit.com/buy.php?product=pl-iu103pcisupfsd54&ref=pl_iu103pcsdpfisu54purchase2011xr<?= $refStr; ?>&refs=pl_purchase_iU">
          <button onclick="ga('send', 'event', 'iubuy', 'buy', 'iuxmas2011xr-pl');">ODBIERZ PREZENTY</button>
        </a>
        <p>
    ...
    <div class="nothing">
      <h2 style=" text-align: center;font-size: 26px;  color: #292b2f;margin-top: 23px;">Nadal skorzystaj z 65% zniżki!
      </h2>
      <div class="arttwo">
        <div class="num1">
  ...
  <section class="clearfix" id="sect">
    <div class="sec">
      ...
      <div class="sec-buy">
        <p>54<span>,90 zł </span> <i>509,60 zł</i></p>
        <a href="http://www.iobit.com/buy.php?product=pl-iu103pcisupfsd54&ref=pl_iu103pcsdpfisu54purchase2011xr<?= $refStr; ?>&refs=pl_purchase_iU" target="_blank" id="hrf">
          <button onclick="ga('send', 'event', 'iubuy', 'buy', 'iuxmas2011xr-pl');">KUP TERAZ</button>
        </a>
...
<script>
  ...
  function soldOut() {
    ...
    $('#hrf').attr('href', 'http://www.iobit.com/buy.php?product=pl-iu103pc54&ref=pl_iu103pc54purchase2011xr<?= $refStr; ?>&refs=pl_purchase_iu')
  }
  (function() {
    countdown(("#timeout"));
    countdown(("#hidn i"));
