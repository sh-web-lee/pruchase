...
<body>
  <nav>
    <div class="logo"><a href="https://www.iobit.com/nl/index.php" target="_blank" onclick="ga('send', 'event', 'iubuy', 'buy', 'iurightcornerpurchase2011-nl')"><img src="<?= $pResUrl; ?>static/img/LOGO.png" alt=""></a>
    </div>
    ...
    <div class="book clearfix">
      <div class="one left ">
        ...
        <a href="https://www.iobit.com/buy.php?product=nl-iu103pc1999&ref=nl_iu103pc1999rightcornerpurchase2011<?= $refStr; ?>&refs=nl_purchase_iu" target="_blank">
          <button onclick="ga('send', 'event', 'iubuy', 'buy', 'iurightcornerpurchase2011-nl')">NU KOPEN</button>
        </a>
      </div>
      ...
      <div class="two left">
        ...
        <a href="https://www.iobit.com/buy.php?product=nl-iu103pcsdisu1799&ref=nl-iu103pcsdisu1799rightcornerpurchase2011<?= $refStr; ?>&refs=nl_purchase_iu" target="_blank">
          <button onclick="ga('send', 'event', 'iubuy', 'buy', 'iurightcornerpurchase2011-nl')">
            NU KOPEN
          </button>
        </a>
  ...
  <article id="arti">
    <div class="art">
      ...
      <div class="num3">
        <a href="https://www.iobit.com/buy.php?product=nl-iu103pcsdisu1799&ref=nl-iu103pcsdisu1799rightcornerpurchase2011<?= $refStr; ?>&refs=nl_purchase_iu" target="_blank">
          <button onclick="ga('send', 'event', 'iubuy', 'buy', 'iurightcornerpurchase2011-nl')">CLAIM CADEAUS</button>
          <p>
        </a>
      ...
      <div class="arttwo">
        ...
        <div class="num3">
          <p style="text-align: center;font-size: 48px; font-weight: 600;margin-right: 20px;">
            <span id="secBuy0">€17</span><span style="font-size: 18px;">,99</span>
            <i style="font-size: 18px; color: #838395;text-decoration: line-through;">€29,99</i>
          </p>
          <a class="hrf" href="https://www.iobit.com/buy.php?product=nl-iu103pcsdisu1799&ref=nl-iu103pcsdisu1799rightcornerpurchase2011<?= $refStr; ?>&refs=nl_purchase_iu" target="_blank">
            <button onclick="ga('send', 'event', 'iubuy', 'buy', 'iurightcornerpurchase2011-nl')">NU KOPEN</button>
          </a>
        </div>
      </div>
  ...
  <section class="clearfix" id="sect">
    <div class="sec">
      ...
      <div class="sec-buy">
        <p>
          <span id="secBuy1" style="font-size: 48px;">€17</span><span>,99</span>
          <i>€89,97</i>
        </p>
        <a class="hrf" href="https://www.iobit.com/buy.php?product=nl-iu103pcsdisu1799&ref=nl-iu103pcsdisu1799rightcornerpurchase2011<?= $refStr; ?>&refs=nl_purchase_iu" target="_blank">
          <button onclick="ga('send', 'event', 'iubuy', 'buy', 'iurightcornerpurchase2011-nl')">NU KOPEN</button>
...
<script>
  ...
  function soldOut() {
    ...
    $('.hrf').attr('href', 'https://www.iobit.com/buy.php?product=nl-iu103pc1999&ref=nl_iu103pc1999rightcornerpurchase2011<?= $refStr; ?>&refs=nl_purchase_iu')
    $('#secBuy0').text('€19');
    $('#secBuy1').text('€19');
  }
  (function() {
