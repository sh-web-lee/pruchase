...
function soldOut() {
  ...
  //price
  $(".floatlayer .number").html("Consigue el mejor desinstalador con <strong>46%</strong> de descuento")
  ...
  //buybtn
  $(".buybtn").attr({
    "href": 'https://www.iobit.com/buy.php?product=es-iu10preorder1599&ref=es_iu10preorderrcsoldout' + refStr + '&aff=' + aff + '&refs=es_purchase_iu&tw=' + tw,
    "onclick": "ga('send', 'event', 'iusoldbuy', 'buy', 'iu10predorderrc-es');"
  });
}
...
function getReTime() {
  var packsNumTotal = cGet('esiujunerc_t');
