...
<head>
  ...
  <title>Offerta speciale - Sconti fino all’87% su IObit Uninstaller PRO</title>
  ...
  <div class="wrapper">
    ...
    <ul class="message">
      ...
      <li class="prev">
        ...
        <!-- buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=it-iu103pc1599&ref=it_iu103pcpurchasespecialnew<?php echo $refStr;?>&refs=it_purchase_iu"
           onclick="ga('send', 'event', 'iubuy', 'buy', 'iu103pcpurchasespecialnew-it')">
          ACQUISTA ORA
        </a>
      </li>
      <!-- 3pc+gifts -->
      <li class="last">
        ...
        <!-- price -->
        <p class="price small"><strong>14</strong> <sup>99€</sup> <del>117,92€</del></p>
        <!-- buybtn -->
        <a class="buybtn yellow"
           href="https://www.iobit.com/buy.php?product=it-iu103pc14msdpf1499&ref=it_iu103pcsdpfpurchasespecialnew<?php echo $refStr;?>&refs=it_purchase_iu"
           onclick="ga('send', 'event', 'iubuy', 'buy', 'iu103pcsdpfpurchasespecialnew-it')">
          APPROFITTANE ORA
        </a>
      </li>
    </ul>
...
<div class="bottombuy">
  <div class="wrapper clearfix">
    ...
    <div class="fr another">
      <p class="price"><strong>14</strong> <sup>99€</sup> <del>117,92€</del></p>
      <a class="buybtn yellow"
         href="https://www.iobit.com/buy.php?product=it-iu103pc14msdpf1499&ref=it_iu103pcsdpfpurchasespecialnew<?php echo $refStr;?>&refs=it_purchase_iu"
         onclick="ga('send', 'event', 'iubuy', 'buy', 'iu103pcsdpfpurchasespecialnew-it')">
        APPROFITTANE ORA
