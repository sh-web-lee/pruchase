...
function soldOut() {
	...
	$(".buybtn").attr({
		"href": 'https://www.iobit.com/buy.php?product=it-iu10preorder1599&ref=it_iu10preorderexpsoldout1599' + refStr + '&aff=' + aff + '&refs=it_purchase_iu&tw=' + tw,
		"onclick": "ga('send', 'event', 'iubuy', 'buy', 'iu10predorderexpsoldout-it');"
	});
}
// soldOut();
...
function getReTime() {
	var packsNumTotal = cGet('itiujunexp0709_t');
