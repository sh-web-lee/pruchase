...
$ver_arr = explode('.',$ver);
$display = (in_array($ver_arr[0],['8','9'])) ? 0 : 1;
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<title>70% OFF to get rid of unwanted programs, plug-ins, Windows Apps - Christmas Sale | IObit</title>
...
<body>
      ...
      <div class="wrapper">
        ...
        <div class="clearfix">
          ...
          <div class="msgbox fl">
            ...
            <ul class="price">
              <li class="first">
                <p><strong class="change-price">$<big>12.97</big></strong> <del>$42.99</del></p>
                <p>1 year subscription / 3 PCs</p>
              </li>
              <li>
                <a class="buybtn exbtn" href="https://www.iobit.com/buy.php?product=2020iu3pc1297&ref=xr_iu<?= $refStr; ?>&refs=purchase_iuxr" onclick="ga('send', 'event', 'iubuy', 'buy', 'iupurchase-xr');">
                  Activate Now
                </a>
              </li>
            </ul>
    ...
    <div class="footbuy">
      <div class="wrapper">
        ...
        <div class="price">
          ...
          <a class="buybtn" href="https://www.iobit.com/buy.php?product=2020iu3pc1297&ref=xr_iu<?= $refStr; ?>&refs=purchase_iuxr" onclick="ga('send', 'event', 'iubuy', 'buy', 'iupurchase-xr');">
            <i class="all-icons"></i>
  ...
  <script>
    ...
    var _href = "https://www.iobit.com/buy.php?product=2020iu3pc1197&ref=xr_iu1197" + refStr + "&refs=purchase_iuxr&tw=-8";
    var _ga = "ga('send', 'event', 'iubuypop', 'buy', 'iupurchase-xr');";
