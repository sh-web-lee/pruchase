...
function soldOut() {
	...
	flipNum(0, 2);
	$(".banner .number").html("");
	// $(".banner h1").html("Bem-vindo a Nossa Pré-venda");
	$(".banner h2,.floatlayer .number").html("Adquira o melhor desinstalador com <strong>44% OFF</strong>");
	$(".price").find("strong").html("R$ 55,99");
	$(".buybtn").attr({
		"href": 'https://www.iobit.com/buy.php?product=pt-iu10preorder5599&ref=pt-iu10preorderofficialsoldout' + refStr + '&aff=' + aff + '&refs=pt_purchase_iu&tw=' + tw,
		"onclick": "ga('send', 'event', 'iusoldbuy', 'buy', 'iu10preorderofficial-pt');"
	});
}
// soldOut();
...
function getReTime() {
	var packsNumTotal = cGet('ptiujune_t');
