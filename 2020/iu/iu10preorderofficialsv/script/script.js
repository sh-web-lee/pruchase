...
function soldOut() {
	...
	flipNum(0, 2);
	$(".banner .number").html("");
	$(".banner h2").html("Få den bästa avinstallatören <br> med <strong>50% rabatt</strong>");
	$(".floatlayer .number").html('Få den bästa avinstallatören med <strong>50% rabatt</strong>');
	$(".price").find("strong").html("239 kr<del>499 kr</del>");
	$(".buybtn").attr({
		"href": 'https://www.iobit.com/buy.php?product=sv-iu10preorder239&ref=sv_iu10preorderofficialsoldout&aff=' + aff + '&refs=sv_purchase_iu&tw=' + tw,
		"onclick": "ga('send', 'event', 'iusoldbuy', 'buy', 'iu10preorderofficial-sv');"
	});
}
// soldOut();
var c =0;
...
function getReTime() {
	var packsNumTotal = cGet('sviujune_t');
