...
function soldOut() {
	...
	$(".buybtn").attr({
		"href": 'https://www.iobit.com/buy.php?product=fr-iu10preorder1499&ref=fr_iu10preorderexp1499' + refStr + '&aff=' + aff + '&refs=fr_purchase_iu&tw=' + tw,
		"onclick": "ga('send', 'event', 'iusoldbuy', 'buy', 'iu10predorderexp-fr');"
	});
}
// soldOut();
...
function getReTime() {
	var packsNumTotal = cGet('friujunexp0716_t');
