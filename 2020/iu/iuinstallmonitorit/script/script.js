...
function soldOut(num) {
	...
	$(".number p").html("Offerta speciale del 65%<br> DI SCONTO conclusa. <p class='zoomout'>Offerta speciale del 65% DI SCONTO conclusa.</p>")
	$(".buybtn").not('.buybtn-pop').html("<p>Attiva ora e risparmia 60%</p> Non perderlo di nuovo!");
	$(".price b").html("16");
	$(".countdown").removeClass("twinkle");
	$(".buybtn").not('.buybtn-pop').attr("href", "https://www.iobit.com/buy.php?product=it-iu113pc1699&ref=it_iu113pc1699monitor" + refStr + "&refs=it_purchase_iu&tw=" + tw);
	$(".buybtn").not('.buybtn-pop').attr("onclick", "ga('send', 'event', 'iubuy', 'buy', 'iumonitor1699-it');");
