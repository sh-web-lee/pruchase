...
function soldOut() {
	...
	flipNum(0, 2);
	$(".banner .number").html("");
	$(".banner h2,.floatlayer .number").html("Migliore programma per disinstallare <strong>60% DI SCONTO</strong>");
	$(".price").find("strong").html("€15,99");
	$(".buybtn").attr({
		"href": 'https://www.iobit.com/buy.php?product=it-iu10preorder1599&ref=it_iu10preorderofficialsoldout1599' + refStr + '&aff=' + aff + '&refs=it_purchase_iu&tw=' + tw,
		"onclick": "ga('send', 'event', 'iubuy', 'buy', 'iu10preorderofficialsoldout-it');"
	});
}
// soldOut();
var c = 0;
...
function getReTime() {
	var packsNumTotal = cGet('itiujune_t');
