...
function soldOut() {
	...
	$(".banner h2").html("Consigue el mejor desinstalador<br> con un <strong>46% de Descuento</strong>");
	...
	$(".buybtn").attr({
		"href": 'https://www.iobit.com/buy.php?product=es-iu10preorder1599&ref=es_iu10preorderexpsoldout' + refStr + '&aff=' + aff + '&refs=es_purchase_iu&tw=' + tw,
		"onclick": "ga('send', 'event', 'iusoldbuy', 'buy', 'iu10predorderexp-es');"
	});
}
// soldOut();
...
function getReTime() {
	var packsNumTotal = cGet('esiujunexp0716_t');
