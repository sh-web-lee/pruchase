...
<head>
  ...
  <title>Disfruta un 85% de descuento para IObit Uninstaller PRO – IObit</title>
...
<body>
  <nav class="banner">
    <div class="wrapper">
      ...
      <h1 class="title">¡Obtén Tu Regalo Gratis de Navidad!</h1>
      <div class="clearfix">
        <div class="offer">
          <h2>Oferta Normal</h2>
          ...
          <a class="buybtn empty"
             href="https://www.iobit.com/buy.php?product=es-iu103pc1599&ref=es_iu103pc1599purchase2011exp<?php echo $refStr;?>&refs=es_purchase_iu"
             onclick="a('send', 'event', 'iubuy', 'buy', 'iu3pcpurchase2011exp-es');">
            COMPRA YA
          </a>
        </div>
        <div class="offer big">
          ...
          <p class="price"><strong>14<small>,99€</small></strong> <del>99,93€</del></p>
          <div class="imgbox">
          ...
          <a class="buybtn"
             href="https://www.iobit.com/buy.php?product=es-iu103pcpfsd1499&ref=es_iu103pcpfsd1499purchase2011exp<?php echo $refStr;?>&refs=es_purchase_iu"
             onclick="ga('send', 'event', 'iubuy', 'buy', 'iu3pcpfsdpurchase2011exp-es');">
            COMPRA YA
          </a>
        </div>
      </div>
  ...
  <div class="intro">
    <div class="wrapper clearfix">
      <h2>¡IObit Uninstaller 10 PRO puede<br> hacer incluso más que la versión anterior!</h2>
      <dl>
        <dt><img src="<?php echo getStaticUrl('static/img/intro-icons01.png')?>" alt=""/></dt>
        <dd>
          <h3>Bloquear notificaciones</h3>
          <p>
            La última versión también bloquea las notificaciones del navegador para una experiencia sin interrupciones.
          </p>
        </dd>
      </dl>
      <dl class="two">
        ...
        <dd>
          <h3>Más limpio</h3>
          <p>
            Con la base de datos un 30% más grande, se eliminan más sobrantes para un sistema limpio y rápido.
          </p>
        </dd>
      </dl>
      <dl class="three">
        ...
        <dd>
          <h3>Más poderoso</h3>
          <p>Elimina software más rebelde, incluido Microsoft Edge (Chromium).</p>
        </dd>
      </dl>
      <dl class="last">
        <dt><img src="<?php echo getStaticUrl('static/img/intro-icons04.png')?>" alt=""/></dt>
        <dd>
          <h3>Soporte completo del navegador</h3>
          <p>Admite más navegadores, entre los que destaca el nuevo Microsoft Edge basado en Chromium.</p>
        </dd>
      </dl>
    </div>
  </div>
  ...
  <div class="comparison wrapper">
    <h2>Recupera todas las funciones PRO para un PC<br> limpio y salud del software perfecta</h2>
    <table>
      <thead>
        <tr>
          <th class="itema"><big>¡Cuidado!</big> Actualmente corres el riesgo de:</th>
          <th class="itemb"><big>En</big> su lugar, puedes disfrutar :</th>
        </tr>
      </thead>
      <tbody>
        <tr>
          <td class="itema">
            <span>No poder eliminar software obstinado y no deseado</span> de tu ordenador
          </td>
          <td class="itemb">
            Elimina incluso el software más obstinado, para un <span>PC limpio y más espacio libre en disco</span>
          </td>
        </tr>
        <tr>
          <td class="itema">
            Los sobrantes de software se quedan atrás después de la desinstalación y <span>contaminan tu sistema</span>
          </td>
          <td class="itemb">
            <span>Un sistema limpio</span> y más espacio libre en el disco porque todos los sobrantes se eliminan automáticamente
          </td>
        </tr>
        <tr>
          <td class="itema">
            <span>Bundleware se instala</span> en tu ordenador cuando descargas software gratuito
          </td>
          <td class="itemb">
            <span>Detecta el bundleware</span> tan pronto como esté instalado y elimínalo con un solo clic
          </td>
        </tr>
        <tr>
          <td class="itema">
            Los complementos maliciosos del navegador <span>dañan tu PC</span>
          </td>
          <td class="itemb">
            <span>Elimina todos los complementos</span> y barras de herramientas y comprueba si los complementos son dañinos o no
          </td>
        </tr>
        <tr>
          <td class="itema">
            <span>La configuración del sistema se modifica</span> y no puedes revertirla
          </td>
          <td class="itemb">
            Supervisa todas las instalaciones y <span>revierte todas las configuraciones del sistema</span> al eliminar el software
          </td>
        </tr>
        <tr>
          <td class="itema">
            El software obsoleto <span>pone en peligro a tu ordenador</span>
          </td>
          <td class="itemb">
            <span>Actualiza todo tu software importante</span> con un solo clic para obtener las funciones más recientes y un PC seguro
          </td>
        </tr>
      </tbody>
    </table>
  ...
  <div class="footbuy">
    ...
    <div class="wrapper clearfix">
      ...
      <div class="price fr">
        <p><strong>14<small>,99€</small></strong> <del>99,93€</del></p>
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=es-iu103pcpfsd1499&ref=es_iu103pcpfsd1499purchase2011exp<?php echo $refStr;?>&refs=es_purchase_iu"
           onclick="ga('send', 'event', 'iubuy', 'buy', 'iu3pcpfsdpurchase2011exp-es');">
          Abrir Mis Regalos
