...
function soldOut() {
  ...
  //buybtn
  $(".buybtn").attr({
    "href": 'https://www.iobit.com/buy.php?product=it-iu10preorder1599&ref=it_iu10preorderrcsoldout1599' + refStr + '&aff=' + aff + '&refs=it_purchase_iu&tw=' + tw,
    "onclick": "ga('send', 'event', 'iubuy', 'buy', 'iu10predorderrcsoldout-it');"
  }).html("<span>Ottienilo Ora - 60% OFF</span>");
}
