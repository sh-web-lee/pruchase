...
<head>
  ...
  <title>Promozione di Natale, sconti fino al 90% su IObit Uninstaller PRO – IObit</title>
...
<body>
  <nav>
    ...
    <div class="book clearfix">
      <div class="one left ">
        ...
        <a href="http://www.iobit.com/buy.php?product=it-iu103pc1599&ref=it_iu103pc1599purchasexmasxe2020<?= $refStr; ?>&refs=it_purchase_iu">
          <button onclick="ga('send', 'event', 'iubuy', 'buy', 'iupurchase3pcxmasxe2020-it')">ACQUISTA ORA</button>
        </a>
      </div>
      <div class="two left">
        <div class="two-up">
        ...
        <p style="text-align: right;font-size: 60px; font-weight: 600;margin-right: 20px;">
          €13<span style="font-size: 22px;">,99</span> <i style="font-size: 22px; color: #838395;text-decoration: line-through;">€139,92</i>
        </p>
        <div style="text-align: left;margin-left: 25px;margin-top: -19px;">
          <img src="<?= $pResUrl; ?>static/img/box.png" alt="">
        </div>
        <a href="http://www.iobit.com/buy.php?product=it-iu103pcsdisupf1399&ref=it_iu103pcsdisupf1399purchasexmasxe2020<?= $refStr; ?>&refs=it_purchase_iu">
          <button onclick="ga('send', 'event', 'iubuy', 'buy', 'iupurchase3pcsdisupfxmasxe2020-it')">
            ACQUISTA ORA
          </button>
        </a>
  ...
  <article id="arti">
    <div class="art">
      ...
      <div class="num3">
        <a href="http://www.iobit.com/buy.php?product=it-iu103pcsdisupf1399&ref=it_iu103pcsdisupf1399purchasexmasxe2020<?= $refStr; ?>&refs=it_purchase_iu">
          <button onclick="ga('send', 'event', 'iubuy', 'buy', 'iupurchase3pcsdisupfxmasxe2020-it')">APRI I REGALI</button>
          <p>
        </a>
  ...
  <div class="sect">
    <h1 style="margin-bottom: 10px;">Riottieni tutte le funzionalità PRO per un PC pulito e una salute dei tuoi software perfetta</h1>
    ...
    <div class="contains">
      <table>
        <thead>
          <tr>
            <th><b>Attento!</b> Al momento rischi…</th>
            <th><b>Invece puoi godere di…</b></th>
          </tr>
        </thead>
        <tr>
          <td><b class="obc">Non riuscire a rimuovere software ostinati</b> e indesiderati dal tuo computer</td>
          <td>Rimozione dei software più ostinati, per un <b>PC pulito e più spazio libero sul disco</b></td>
        </tr>
        <tr>
          <td>Avanzi di software che rimangono nel tuo PC dopo la disinstallazione e <b class="obc">danneggiano il tuo sistema</b></td>
          <td><b>Un sistema pulito</b> e più spazio libero sul disco perché tutti gli avanzi vengono rimossi automaticamente</td>
        </tr>
        <tr>
          <td><b class="obc">Bundleware che vengono installati</b> sul tuo computer quando scarichi freeware</td>
          <td><b>Rilevamento bundleware</b> non appena installati e rimozione con un clic</td>
        </tr>

        <tr>
          <td><b class="obc">Plugin browser dannosi</b> che danneggiano il tuo PC</td>
          <td><b>Rimozione di ogni plugin</b> e barra degli strumenti e verifica per determinare se i plugin siano dannosi o meno</td>
        </tr>
        <tr>
          <td><b class="obc">Impostazioni di sistema modificate</b> che non riesci a ripristinare</td>
          <td>Monitoraggio di tutte le installazioni e <b>ripristino di tutte le impostazioni di sistema</b> durante la rimozione dei software</td>
        </tr>
        <tr>
          <td>Software obsoleti che <b class="obc">mettono in pericolo il tuo computer</b></td>
          <td><b>Aggiornamento con un clic di tutti i tuoi software importanti</b> per le ultime funzionalità e per un PC sicuro</td>
        </tr>
      </table>
    </div>
  </div>
  <div class="asc">
    <h1>IObit Uninstaller 10 PRO può fare molto di più rispetto alla tua versione <br> precedente!</h1>
    <img src="<?= $pResUrl; ?>static/img/line.png" alt="">
    <div class="asc-box">
      <ul>
        <li>
          <div class="po"><img src="<?= $pResUrl; ?>static/img/icon 1.png" alt=""></div>
          <h2>Blocco notifiche</h2>
          <p>L'ultima versione blocca anche le notifiche del browser per un'esperienza di navigazione indisturbata</p>
        </li>
        <li>
          <div class="po"><img src="<?= $pResUrl; ?>static/img/icon 2.png" alt=""></div>
          <h2>Più pulito</h2>
          <p>Con un database più grande del 30%, vengono rimossi più avanzi per un sistema pulito e veloce</p>
        </li>
        <li>
          <div class="po"><img src="<?= $pResUrl; ?>static/img/icon 3.png" alt=""></div>
          <h2>Più potente</h2>
          <p>Rimuove i software più ostinati, incluso Microsoft Edge (Chromium) </p>
        </li>
        <li>
          <div class="po"><img src="<?= $pResUrl; ?>static/img/icon 4.png" alt=""></div>
          <h2>Supporto browser completo</h2>
          <p>Supporta più browser, tra cui il nuovo Microsoft Edge basato su Chromium.</p>
        </li>
      </ul>
    </div>
  </div>
  ...
  <section class="clearfix" id="sect">
    <div class="sec">
      ...
      <div class="sec-buy">
        <p><b>€13</b><span>,99</span> <i>€139,92</i></p>
        <a href="http://www.iobit.com/buy.php?product=it-iu103pcsdisupf1399&ref=it_iu103pcsdisupf1399purchasexmasxe2020<?= $refStr; ?>&refs=it_purchase_iu" id="hrf">
          <button id="btnidex">ACQUISTA ORA</button>
        </a>
...
<script>
  ...
  function getCycleCountdown() {
    var date = new Date();
    if (MApp(2.2).cookie.get('xmasxeit2020')) {
      dt = MApp(2.2).cookie.get('xmasxeit2020');

    } else {
      dt = date.setMinutes(date.getMinutes() + 15);
      MApp(2.2).cookie.set('xmasxeit2020', dt);
    }
  ...
  function soldOut() {
    ...
    $('#hrf').attr('href', 'http://www.iobit.com/buy.php?product=it-iu103pc1599&ref=it_iu103pc1599purchasexmasxe2020<?= $refStr; ?>&refs=it_purchase_iu')
  }
  $('#btnidex').on('click', function() {
      alert('1111')
      if (numidex == 1) {
        ga('send', 'event', 'iubuy', 'buy', 'iupurchase3pcsdisupfxmasxe2020-it')
      } else {
        ga('send', 'event', 'iubuy', 'buy', 'iupurchase3pcxmasxe2020-it')
      }
    })
    (function() {
      countdown(("#timeout"));
