...
function soldOut(num) {
	...
	$(".btnbox .hurry").html(" La oferta especial de 47% <br> de descuento ha terminado.<p class='zoomout'> La oferta especial de 47% <br> de descuento ha terminado.</p>");
	$(".banner .buybtn, .float .buybtn").text("Activar ahora y ahorra 40%");
	$(".price b").html("17");
	$(".numberbox").removeClass("twinkle");

	$(".buybtn").not(".buybtn-pop").attr("href", "https://www.iobit.com/buy.php?product=es-iu113pc1799&ref=es_iu113pcmonitorbsoldout2108" + refStr + "&refs=es_purchase_iu&tw=" + tw);
	$(".buybtn").not(".buybtn-pop").attr("onclick", "ga('send', 'event', 'iubuy', 'buy', 'iusoldout-monitorb-es');");
}
...
function packsInit() {
	var date = new Date();
	var cName = "esiumon_b" + date.getDate();
...
function getReTime() {
	var packsTotal = cGet('eniumonb_t');
	var reTime = 6.3;
