...
<head>
  ...
  <title>Spara upp till 80% rabatt på IObit Uninstaller PRO och få extra skydd på köpet - IObit</title>
...
<div class="banner">
  <div class="wrapper">
    ...
    <h1>EXKLUSIV REA</h1>
    <h2>Spara upp till <b>80% rabatt</b> på IObit Uninstaller PRO och få en gratis paket</h2>
    <div class="content clearfix">
      <div class="panel left small">
        ...
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=sv-iu111pc199&ref=sv_iu111pcpurchase2108<?php echo $refStr;?>&refs=sv_purchase_iu"
           onclick="ga('send', 'event', 'iubuy', 'buy', 'iu111pcpurchase2108-sv')">
          <i class="all-icons"></i>
          KÖP PRO
        </a>
      </div>
      <div class="panel middle large">
        ...
        <dl class="price large">
          <dt><span><big>239</big></span> kr <i>-80%</i></dt>
          <dd>Ord. pris <del>1 157 kr</del></dd>
        </dl>
        <a class="buybtn large"
           href="https://www.iobit.com/buy.php?product=sv-iu113pcpfsd239&ref=sv_iu113pcsdpfpurchase2108<?php echo $refStr;?>&refs=sv_purchase_iu"
           onclick="ga('send', 'event', 'iubuy', 'buy', 'iu113pcsdpfpurchase2108-sv')">
          <i class="all-icons"></i>
          KÖP PRO
        </a>
      </div>
...
<div class="feature">
  <div class="wrapper clearfix">
    <h2>Den nya programvaruhälsan och den förbättrade avinstallationsmotorn <br>ger dig en renare dator och säkrare surfning</h2>
      <dl class="list01">
      ...
      <dl class="list04 winrar">
        ...
        <dd class="fl">
          <h3>Helt ny Programvaruhälsa  <i>VIKTIGT</i></h3>
          <p>
          Med vår 40% förstorade databas kan du uppdatera <br>alla viktiga programvarorna med bara ett klick. <br>Och du kan enkelt hantera programvarutillstånd <br> vid startobjekt, schemalagda uppgifter och<br>högerklicksmeny för att garantera en ren surfning.
          </p>
...
<div class="gifts">
  <div class="wrapper">
    <h2>80% Rabatt på Aktivera IObit Uninstaller PRO, Få 2 PC Optimeringsverktyg GRATIS!</h2>
    <div class="content clearfix">
      <dl class="sd clearfix">
        <dt><img src="<?php echo getStaticUrl('images/gifts-sd.png'); ?>" alt=""></dt>
        <dd>
          <h3>Smart Defrag 7 PRO <del>459kr</del></h3>
          <p>
  ...
  <table border="0" cellspacing="0" cellpadding="0" width="100%">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="virtue">Övervaka automatiskt programvaruinstallationsprocess och generera övervakningslogg. <sup>Ny</sup></td>
        <td class="itemb"><i class="all-icons">√</i></td>
        <td class="space"></td>
        <td class="itema"><i class="all-icons red">√</i></td>
      </tr>
      <tr>
        <td class="icon"><img src="<?php echo $pResUrl;?>images/icon_12.png" alt=""></td>
        <td class="virtue">Tar bort de programmen med avinstallationsproblem. <sup>Ny</sup></td>
...
<div class="footbuy">
  <div class="wrapper clearfix">
    ...
    <div class="fr">
      <!-- price -->
      <dl class="price large">
        <dt><span><big>239</big></span> kr </dt>
        <dd>Ord. pris <del>1 157 kr</del></dd>
      </dl>
      <!-- buybtn -->
      <a class="buybtn large"
         href="https://www.iobit.com/buy.php?product=sv-iu93pcpfsd239&ref=sv_iu93pcsdpfpurchase2005<?php echo $refStr;?>&refs=sv_purchase_iu"
         onclick="ga('send', 'event', 'iubuy', 'buy', 'iubundlepurchase2005-sv')">
        <i class="all-icons"></i>
        KÖP PRO
      </a>
    </div>
