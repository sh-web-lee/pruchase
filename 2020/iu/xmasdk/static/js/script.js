function soldOut() {
  ...
  $(".gifts .price").prepend('<p><strong>179<small>kr</small></strong> <del>399kr</del></p>');
...
function getCycleCountdown() {
  var date = new Date();
  if (MApp(2.2).cookie.get('xmasdk2020')) {
    dt = MApp(2.2).cookie.get('xmasdk2020');

  } else {
    dt = date.setMinutes(date.getMinutes() + 12);
    MApp(2.2).cookie.set('xmasdk2020', dt);
  }
