...
function soldOut() {
	...
	$(".buybtn").attr({
		"href": 'https://www.iobit.com/buy.php?product=nl-iu10preorder1999&ref=nl_iu10preorderexp1999' + refStr + '&aff=' + aff + '&refs=nl_purchase_iu&tw=' + tw,
		"onclick": "ga('send', 'event', 'iubuy', 'buy', 'iu10predorderexpsoldout-nl');"
	});
}
// soldOut();
...
function getReTime() {
	var packsNumTotal = cGet('nliujunexp0716_t');
