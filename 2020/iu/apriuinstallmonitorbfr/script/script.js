...
$(window).on('scroll', function() {
	...
	if ($(window).scrollTop() > scrollHeightt) {
		$('.float').addClass('on');
	} else {
...
function soldOut(num) {
	...
	$(".price b").html("16");
	$(".countdown").removeClass("twinkle");
	$(".buybtn").not('.buybtn-pop').attr("href", "https://www.iobit.com/buy.php?product=fr-iu113pc1699&ref=fr_iu11soldoutmonitorb"+refStr+"&aff=" + aff + "&refs=fr_purchase_iu&tw=" + tw);
	$(".buybtn").not('.buybtn-pop').attr("onclick", "ga('send', 'event', 'iubuy', 'buy', 'iumonitorbsoldoutpurchase-fr');");
}
