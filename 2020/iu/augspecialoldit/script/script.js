...
function selectfun(selector) {
  ...
  var _price = $(".banner .message li").eq(_num).find(".price strong").text();
  var href = $(".banner .message li").eq(_num).find(".buybtn").attr("href");
  var ga = $(".banner .message li").eq(_num).find(".buybtn").attr("onclick");
  var del = $(".banner .message li").eq(_num).find(".price del").text();
  ...
  $(".bottombuy .another .price strong").text(_price);
  $(".bottombuy .another .buybtn").attr("href", href).attr("onclick", ga);
}

$(document).ready(function() {
  timeInit();
  $(".comparebtn").target($(".compare"));
  $(window).scrollWindow($(".complimentary"), $('.reviews dl'), ("on"));
...
function timeInit() {
  var date = new Date();
  var cName = "augspecialoldit" + date.getDate();
