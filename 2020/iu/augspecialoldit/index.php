...
<head>
  ...
  <title>Offerta speciale - Sconti fino all’88% su IObit Uninstaller PRO</title>
  ...
  <div class="wrapper">
    ...
    <ul class="message">
      ...
      <li class="prev">
        ...
        <!-- price -->
        <p class="price"><strong>14</strong> <sup>99€</sup> <del>29,99€</del></p>
        <!-- buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=it-iu103pc1499&ref=it_iu103pcpurchasespecialold<?php echo $refStr;?>&refs=it_purchase_iu"
           onclick="ga('send', 'event', 'iubuy', 'buy', 'iu103pcpurchasespecialold-it')">
          ACQUISTA ORA
        </a>
      </li>
      <!-- 3pc+gifts -->
      <li class="last">
        ...
        <!-- price -->
        <p class="price small"><strong>12</strong> <sup>99€</sup> <del>117,92€</del></p>
        <!-- buybtn -->
        <a class="buybtn yellow"
           href="https://www.iobit.com/buy.php?product=it-iu103pc14msdpf1299&ref=it_iu103pcsdpfpurchasespecialold<?php echo $refStr;?>&refs=it_purchase_iu"
           onclick="ga('send', 'event', 'iubuy', 'buy', 'iu103pcsdpfpurchasespecialold-it')">
          APPROFITTANE ORA
        </a>
      </li>
    </ul>
...
<div class="intro wrapper">
  ...
  <div class="features clearfix">
    ...
    <dl>
      ...
      <dd>
        <h3><span class="green">MIGLIORATO!</span> Disinstalla i Plugin Maligni e Pubblicitari</h3>
        <p>
          Rileva e disinstalla i plugin maligni e pubblicitari ed elimina le notifiche del browser per garantire un'esperienza di navigazione sicura e pulita.
        </p>
      </dd>
    </dl>
    <dl>
...
<div class="bottombuy">
  <div class="wrapper clearfix">
    ...
    <div class="fr another">
      <p class="price"><strong>12</strong> <sup>99€</sup> <del>117,92€</del></p>
      <a class="buybtn yellow"
         href="https://www.iobit.com/buy.php?product=it-iu103pc14msdpf1299&ref=it_iu103pcsdpfpurchasespecialold<?php echo $refStr;?>&refs=it_purchase_iu"
         onclick="ga('send', 'event', 'iubuy', 'buy', 'iu103pcsdpfpurchasespecialold-it')">
        APPROFITTANE ORA
