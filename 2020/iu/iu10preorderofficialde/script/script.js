...
function soldOut() {
	...
	$(".price").find("strong").html("18,99€");
	$(".buybtn").attr({
		"href": 'https://www.iobit.com/buy.php?product=de-iu10preorder1899&ref=de_iu10preorderofficialsoldout' + refStr + '&aff=' + aff + '&refs=de_purchase_iu&tw=' + tw,
		"onclick": "ga('send', 'event', 'iubuy', 'buy', 'iu10preorderofficialsoldout-de');"
	});
}
// soldOut();
...
function getReTime() {
	var packsNumTotal = cGet('deiujune_t');
