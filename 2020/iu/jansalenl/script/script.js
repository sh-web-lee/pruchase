...
var countdown = function (countdown){
  ...
  function getCycleCountdown () {
	if (MApp(2.2).cookie.get('iujansalenl2020')) {
	  dt = MApp(2.2).cookie.get('iujansalenl2020');
	}else{
	  var date=new Date();
	  dt=date.setSeconds(date.getSeconds()+576);
	  setCookie('iujansalenl2020',dt,1);
	}
...
function soldOut() {
  ...
  $(".bottombuy dl dt h2").text("Helaas! Gratis Cadeau uitverkocht. Pak toch nog 33% korting!");
