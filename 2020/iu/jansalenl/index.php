...
<head>
  ...
  <title>66% Korting op IObit Uninstaller PRO met gratis Cadeau!</title>
...
<div class="banner">
  <div class="wrapper">
    ...
    <!-- title -->
    <h1>Tijdelijke actie: Krijg een Gratis Cadeau bij IObit Uninstaller PRO!</h1>
    <!-- content -->
    <div class="content">
      ...
      <div class="panel small">
        ...
        <!-- buybtn -->
        <a class="buybtn" 
        href="https://www.iobit.com/buy.php?product=nl-iu113pc1999&ref=nl_iu113pc1999purchase2001<?php echo $refStr;?>&refs=nl_purchase_iu"
        onclick="ga('send', 'event', 'iubuy', 'buy', 'iupurchase2001-nl');">
        KOOP NU
        </a>
      </div>
      ...
      <div class="panel large">
        <!-- off -->
        <span class="off">-66%</span>
        <!-- h2 -->
        <h2>Met een Gratis Cadeau!</h2>
        <!-- box -->
        ...
        href="https://www.iobit.com/buy.php?product=nl-iu113pcsd1999&ref=nl_iu113pcsd1999purchase2001<?php echo $refStr;?>&refs=nl_purchase_iu"
        onclick="ga('send', 'event', 'iubuy', 'buy', 'iupurchase2001-nl');">
        KOOP NU
        </a>
        <!-- countdown -->
...
<div class="container">
  ...
  <div class="gifts">
    <div class="wrapper">
      ...
      <div class="content clearfix bundle">
        ...
        <ul>
          <li>Automatische Defragmentatie</li>
          <li>Sneller toegang tot uw bestanden</li>
          <li>SSDs trimmen voor de beste resultaten</li>
        </ul>
        <dl>
          <dd>
             <!-- buybtn -->
  ...
  <div class="bottombuy">
    <div class="wrapper clearfix">
      ...
      <dl>
        <dt><h2>Alleen Nu Met een Gratis Cadeau!</h2></dt>
        <dd>
          <!-- price -->
          <p class="price">
            <small>€</small><big>19</big>,99 
