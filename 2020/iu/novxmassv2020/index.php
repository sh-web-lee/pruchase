...
<body>
    ...
    <div class="wrapper">
      ...
      <div class="content clearfix">
        <div class="panel left small">
          ...
          <a class="buybtn" href="https://www.iobit.com/buy.php?product=sv-iu101pc199&ref=sv_iu101pcpurchase2011<?= $refStr; ?>&refs=sv_purchase_iu" onclick="ga('send', 'event', 'iubuy', 'buy', 'iu101pcpurchase2011-sv')">
            <i class="all-icons"></i>
            KÖP PRO
          </a>
        </div>
        <div class="panel middle large">
          ...
          <a class="buybtn large" href="https://www.iobit.com/buy.php?product=sv-iu103pcpfsd239&ref=sv_iu103pcsdpfpurchase2011<?= $refStr; ?>&refs=sv_purchase_iu" onclick="ga('send', 'event', 'iubuy', 'buy', 'iu103pcsdpfpurchase2011-sv')">
            <i class="all-icons"></i>
            KÖP PRO
          </a>
        </div>
  ...
  <div class="gifts">
    <div class="wrapper">
      ...
      <!-- buybtn -->
      <a class="buybtn large larger" href="https://www.iobit.com/buy.php?product=sv-iu103pcpfsd239&ref=sv_iu103pcsdpfpurchase2011<?= $refStr; ?>&refs=sv_purchase_iu" onclick="ga('send', 'event', 'iubuy', 'buy', 'iu103pcsdpfpurchase2011-sv')">
        <i class="all-icons"></i>
