...
function soldOut() {
  ...
  flipNum(0, 3);
  //banner
  $(".banner,.floatlayer,.buybtn").addClass("sold");
  //float
  $(".floatlayer .number").html("Adquira o melhor desinstalador com <strong>44% OFF</strong>");
  ...
  //buybtn
  $(".buybtn").attr({
    "href": 'https://www.iobit.com/buy.php?product=pt-iu10preorder5599&ref=pt-iu10preorderrcsoldout' + refStr + '&aff=' + aff + '&refs=purchase_iu&tw=' + tw,
    "onclick": "ga('send', 'event', 'iusoldbuy', 'buy', 'iu10predorderrcpt');"
  });
}
...
function getReTime() {
  var packsNumTotal = cGet('ptiujunerc_t');
