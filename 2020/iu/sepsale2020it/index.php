...
<head>
  ...
  <title> Super risparmio, sconti fino all’85% su IObit Uninstaller PRO – IObit</title>
...
<div class="banner">
  ...
  <div class="wrapper">
    ...
    <div class="title">
      <h1>SUPER RISPARMIO</h1>
      <p>Risparmia 84€ e ottieni tutti i prodotti per ottimizzare il tuo</p>
    </div>
    ...
    <div class="box gift-box">
      ...
      <a href="http://www.iobit.com/buy.php?product=it-iu113pcisusd1599&ref=it_iu113pcisusd1599purchase2009<?php echo $refStr;?>&refs=it_purchase_iu" 
         onclick="ga('send', 'event', 'iubuy', 'buy', 'iupurchase3pc2009-it')" class="buybtn">ACQUISTA ORA</a>
      <p class="last">Licenza valida per versioni future</p>
      <dl>
        <dt>REGALI PRO</dt>
        <dd>Pulizia completa per un PC più pulito <br> Accesso ai file più veloce</dd>
      </dl>
    </div>
    <div class="box">
      <img src="<?php echo getStaticUrl('images/iu-box.png')?>" alt="">
      <span class="hanging">-50% </span>
      ...
      <a href="http://www.iobit.com/buy.php?product=it-iu111pc1499&ref=it_iu111pc1499purchase2009<?php echo $refStr;?>&refs=it_purchase_iu" 
         onclick="ga('send', 'event', 'iubuy', 'buy', 'iupurchase1PC2009-it')" class="buybtn small">ACQUISTA ORA</a>
      <p class="last">Licenza valida per versioni future</p>
    </div>
    <div class="payment">
...
<div class="feature">
   ...
   <div class="wrapper">
     ...
     <dl class="right" data-num="1">
       ...
       <dd>Disinstalla completamente tutti i programmi con problemi di disinstallazione e le modifiche che hanno apportato al sistema</dd>
     </dl>
     <dl data-num="2">
...
<div class="comparison">
  ...
  <div class="wrapper">
    <table border="0" cellspacing="0" cellpadding="0" width="100%">
      ...
      <tr>
        <td class="icons" width="45"><img src="<?php echo getStaticUrl('images/icon02_02.png')?>" alt="" /></td>
        <td class="virtue">Rimuove i programmi con problemi di disinstallazione <i class="nuo"></i></td>
        <td class="space"></td>
        <td class="itema"><i class="all-icons gray">√</i></td>
        <td class="space"></td>
        <td class="itemb"><i class="all-icons red">√</i></td>
      ...
      <tr>
        ...
        <td class="virtue">Rimuove automaticamente le modifiche apportate al sistema da un programma non desiderato durante il processo di disinstallazione</td>
        <td class="space"></td>
        <td class="itema"><i class="all-icons gray">√</i></td>
        <td class="space"></td>
        <td class="itemb"><i class="all-icons red">√</i></td>
...
<div class="gift-content">
  <div class="wrapper ">
    ...
    <div class="price">
      ...
      <a href="http://www.iobit.com/buy.php?product=it-iu113pcisusd1599&ref=it_iu113pcisusd1599purchase2009<?php echo $refStr;?>&refs=it_purchase_iu" 
         onclick="ga('send', 'event', 'iubuy', 'buy', 'iupurchase3pc2009-it')"class="buybtn">ACQUISTA SUBITO</a>
...
<!--bottom-->
  ...
  <div class="bottom-content clearfix">
    ...
    <div class="wrapper">
      ...
      <ul>
        <li class="active"  data-num="0">1 anno / 3 PC+ 2 REGALI PRO</li>
        <li  data-num="1">1 anno / 1 PC</li>
      </ul>
      <dl>
         <dt class="price">
          <strong>15</strong>
        ...
        <dd>
          <!-- 3pc buybtn -->
          <a href="http://www.iobit.com/buy.php?product=it-iu113pcisusd1599&ref=it_iu113pcisusd1599purchase2009<?php echo $refStr;?>&refs=it_purchase_iu" 
             onclick="ga('send', 'event', 'iubuy', 'buy', 'iupurchase3pc2009-it')"
             class="buybtn">
            ACQUISTA ORA
          </a>
        </dd>
