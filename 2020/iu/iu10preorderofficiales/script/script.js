...
function soldOut() {
	...
	flipNum(0, 2);
	$(".banner .number").html("");
	$(".banner h2").html("Consigue el mejor desinstalador con <br> un <strong> 46% de Descuento</strong>");
	$(".floatlayer .number").html('Consigue el mejor desinstalador con un <strong> 46% de Descuento</strong>');
	$(".price").find("strong").html("15,99€ <del>29,99€</del>");
	$(".buybtn").attr({
		"href": 'https://www.iobit.com/buy.php?product=es-iu10preorder1599&ref=es_iu10preorderofficialsoldout' + refStr + '&aff=' + aff + '&refs=es_purchase_iu&tw=' + tw,
		"onclick": "ga('send', 'event', 'iusoldbuy', 'buy', 'iu10preorderofficial-es');"
	});
}
// soldOut();
var c =0;
...
function getReTime() {
	var packsNumTotal = cGet('esiujune_t');
