...
function soldout() {
  ...
  $(".bottom-content .img-box").removeClass("one-box").addClass("three-box");
  $(".bottom-content ul li:eq(1)").addClass("active")
  $(".bottom-content .discount").addClass("other-pc").html("-77<sup>%</sup>")
  $(".bottom-content .price").html("<strong>15</strong><span>99 €<b>&nbsp;</b></span>")
  $('.bottom-content .buybtn').attr("href",$(".banner .box").eq("2").find(".buybtn").attr("href"));
  $('.bottom-content .buybtn').attr("onclick",$(".banner .box").eq("2").find(".buybtn").attr("onclick"));
