...
<body>
  <nav>
    ...
    <div class="book clearfix">
      <div class="one left ">
        ...
        <a href="https://www.iobit.com/buy.php?product=de-iu103pc1999&ref=de_iu103pcpurchase2012exp<?= $refStr; ?>&refs=de_purchase_iu">
          <button onclick="ga('send', 'event', 'iubuy', 'buy', 'iu3pcsinglepurchase2012exp-de')">Jetzt kaufen</button>
        </a>
      </div>
      <div class="two left">
        <div class="two-up">
        ...
        <a href="https://www.iobit.com/buy.php?product=de-iu10pfsd1699&ref=de_de_iu103pcpfsdsale2012exp<?= $refStr; ?>&refs=de_purchase_iu">
          <button onclick="ga('send', 'event', 'iubuy', 'buy', 'iu3pcbundlepurchase2012exp-de')   ">
            Jetzt kaufen
          </button>
        </a>
  ...
  <article id="arti">
    <div class="art">
      ...
      <div class="num3">
        <a href="https://www.iobit.com/buy.php?product=de-iu10pfsd1699&ref=de_de_iu103pcpfsdsale2012exp<?= $refStr; ?>&refs=de_purchase_iu ">
          <button onclick="ga('send', 'event', 'iubuy', 'buy', 'iu3pcbundlepurchase2012exp-de')">Geschenke bekommen</button>
          <p>
        </a>
  ...
  <div class="mainbox clearfix">
    ...
    <div class="asc">
      <h1>IObit Uninstaller 10 PRO kann sogar mehr als Ihre vorherige Versionen tun!</h1>
      <!-- <img src="<?= $pResUrl; ?>images/line.png" alt=""> -->
      <div class="asc-box">
        <ul>
          <li>
            <div class="po"><img src="<?= $pResUrl; ?>static/img/icon 1.png" alt=""></div>
            <h2>Blockiert Benachrichtigungen </h2>
            <p>Die neueste Version blockiert auch die Browserbenachrichtigung für ein ungestörtes.</p>
          </li>
          <li>
            <div class="po"><img src="<?= $pResUrl; ?>static/img/icon 2.png" alt=""></div>
            <h2>Sauberer</h2>
            <p>Mit der 30% größeren Datenbank werden mehr Reste für ein sauberes und schnelles System entfernt.</p>
          </li>
          <li>
            <div class="po"><img src="<?= $pResUrl; ?>static/img/icon 3.png" alt=""></div>
            <h2>Stärker</h2>
            <p>Entfernt hartnäckigere Software einschließlich Microsoft Edge (Chromium).</p>
          </li>
          <li>
            <div class="po"><img src="<?= $pResUrl; ?>static/img/icon 4.png" alt=""></div>
            <h2>Volle Browser-Unterstützung</h2>
            <p>Unterstützt mehr Browser einschließlich des neuen Chromium-basierten Microsoft Edges.</p>
          </li>
        </ul>
      </div>
    </div>
    <div class="sect">
      <h1 style="margin-bottom: 10px;">Bekommen Sie alle PRO-Funktionen für einen sauberen PC und perfekte Software-Gesundheit </h1>
      ...
      <div class="contains">
        <table>
          ...
          <tr>
            <td><b>Hartnäckige,</b> unerwünschte Software <b>kann nicht</b> von Ihrem Computer entfernt werden</td>
            <td>Entfernt sogar die hartnäckigste Software für <b>einen sauberen PC und mehr freien Speicherplatz</b></td>
          </tr>
          <tr>
            <td>Software-Reste bleiben nach der Deinstallation zurück und <b>verschmutzen Ihr System</b> </td>
            <td><b>Ein sauberes System</b> und mehr freier Speicherplatz, da alle Überreste automatisch entfernt werden</td>
          </tr>
          <tr>
            <td>Wenn Sie kostenlose Software herunterladen,<b> wird Bundlerware</b> auf Ihrem Computer <b>installiert</b>.</td>
            <td><b>Erkennt Bundleware</b> und entfernt sie mit einem Klick, solange sie installiert wird.</td>
          </tr>

          <tr>
            <td>Böswillige <b>Browser-Plug-Ins beschädigen Ihren PC</b></td>
            <td><b>Entfernt jedes Plug-in</b> und Symbolleiste und merkt ob Plug-ins schädlich oder nicht sind.</td>
          </tr>
          <tr>
            <td><b>Die Systemeinstellungen werden geändert</b> und können nicht wiederherstellt werden</td>
            <td>Überwacht alle Installationen und <b>herstellt alle Systemeinstellungen</b> während des Entfernens der Software <b>wieder</b></td>
          </tr>
          <tr>
            <td>Veraltete Software bringt Ihren <b>Computer in Gefah</b></td>
            <td><b>Aktualisiert Ihre gesamte wichtige Software</b> mit einem Klick für die neusten Funktionen und einen sicheren PC</td>
          </tr>
        </table>
      </div>
    </div>
  ...
  <section class="clearfix" id="sect">
    <div class="sec">
      ...
      <div class="sec-buy">
        ...
        <a href="https://www.iobit.com/buy.php?product=de-iu10pfsd1699&ref=de_de_iu103pcpfsdsale2012exp<?= $refStr; ?>&refs=de_purchase_iu" id="hrf">
  ...
  <div class="laster">
    ...
    <h6>Copyright © 2005 - 2020 IObit. Alle Rechte vorbehalten</h6>
  </div>
</body>
<script>
  var valuenum = 1
  ...
  function soldOut() {
    ...
    $('#hrf').attr('href', 'https://www.iobit.com/buy.php?product=de-iu103pc1999&ref=de_iu103pcpurchase2012exp<?= $refStr; ?>&refs=de_purchase_iu')
    $('.sec1').hide()
    $('.sec2').show()
  ...
  $('#hrf button').on('click', function() {
      if (valuenum == 1) {
        ga('send', 'event', 'iubuy', 'buy', 'iu3pcbundlepurchase2012exp-de')
      } else {
        ga('send', 'event', 'iubuy', 'buy', 'iu3pcsinglepurchase2012exp-de')
      }
    })
    (function() {
      countdown(("#timeout"));
