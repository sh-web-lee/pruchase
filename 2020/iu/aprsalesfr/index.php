...
<head>
  ...
  <title>Vente Flash - Jusqu'à -85% sur IObit Uninstaller 11 PRO</title>
  ...
  <div class="wrapper">
    ...
    <div class="bundle-container clearfix">
      <div class="bundle left">
        ...
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=fr-iu111y3pc1599&ref=fr_iu113pcindexpurchase2004<?php echo $refstr; ?>&aff=&refs=fr_purchase_iu"
           onclick="ga('send', 'event', 'iubuy', 'buy', 'iupurchase2004-fr');"
        >VITE, J'EN PROFITE</a>
      </div>
      <div class="bundle right">
        ...
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=fr-iu113pcsdpf1599&ref=fr_iu113pcsdpf1599indexpurchase2004<?php echo $refstr; ?>&aff=&refs=fr_purchase_iu"
           onclick="ga('send', 'event', 'iubuy', 'buy', 'iupurchase2004bundle-fr')">VITE, J'EN PROFITE</a>
    ...
    <div class="detail-list">
      <dl class="two">
        ...
        <dd>
          ...
          <p>Suppression complète de tous les programmes (même ceux qui présentent des problèmes de désinstallation) et des modifications qu'ils ont apportées au système.</p>
        </dd>
      </dl>
      <dl class="two">
...
<div class="giftbox">
  ...
  <div class="wrapper">
    ...
    <a href="https://www.iobit.com/buy.php?product=fr-iu113pcsdpf1599&ref=fr_iu113pcsdpf1599indexpurchase2004<?php echo $refstr; ?>&aff=&refs=fr_purchase_iu" 
       onclick="ga('send', 'event', 'iubuy', 'buy', 'iupurchase2004bundle-fr')">
      VITE, J'EN PROFITE
    </a>
...
<div class="comparsion wrapper" id="compare">
  <table border="0" cellspacing="0" cellpadding="0" width="100%">
    ...
    <tr>
      ...
      <th class="space"></th>
      <th class="itemb">
        IObit Uninstaller 11 <strong>Free</strong>
      </th>
      <th class="space"></th>
      <th class="itema">
        IObit Uninstaller 11 <strong>PRO</strong>
      </th>
    </tr>
    </thead>
    <tbody>
      <tr>
        ...
        <td class="virtue">
          <span>Analyse et suppression des packages d'installation installés et inutilisés pour libérer de l'espace <sup class="nou first">nouveau </sup></span>
        </td>
        <td class="space"></td>
      ...
      <tr class="three">
        ...
        <td class="virtue"><span>Élimination complète des programmes présentant des problèmes de désinstallation & modifications qu'ils ont apportées au système <sup class="nou">nouveau </sup></span></td>
        <td class="space"></td>
        <td class="itemb"></td>
        <td class="space"></td>
        <td class="itema"><i class="all-icons red">★</i></td>
...
<div class="popbox">
  ...
  <div class="clearfix">
    ...
    <div class="right fl">
      ...
      <a
          href="https://www.iobit.com/buy.php?product=fr-asc133pcpfiusd1799&ref=fr_asc133pcpfiusd1799purchase1906<?php echo $refstr; ?>&aff=&refs=fr_purchase_asc"
