...
<head>
  ...
  <title> Sparen Sie heute bis zu 83% auf IObit Uninstaller PRO - IObit</title>
...
<body>
  <nav>
    ...
    <div class="book clearfix">
      <div class="one left ">
        ...
        <a href="https://www.iobit.com/buy.php?product=de-iu103pc1999&ref=de_iu103pcpurchase2012<?= $refStr; ?>&refs=de_purchase_iu">
          <button onclick="ga('send', 'event', 'iubuy', 'buy', 'iu3pcsinglepurchase2012-de')  ">Jetzt kaufen</button>
        </a>
      </div>
      <div class="two left">
        <div class="two-up">
        ...
        <p style="text-align: right;font-size: 60px; font-weight: 600;margin-right: 20px;">
          18<span style="font-size: 22px;">,99€</span> <i style="font-size: 22px; color: #838395;text-decoration: line-through;">109,89€</i>
        </p>
        <div style="text-align: left;margin-left: 25px;margin-top: -19px;">
          <img src="<?= $pResUrl; ?>static/img/box.png" alt="">
        </div>
        <a href="https://www.iobit.com/buy.php?product=de-iu10pfsd1899&ref=de_iu103pcpfsdsale2012<?= $refStr; ?>&refs=de_purchase_iu">
          <button onclick="ga('send', 'event', 'iubuy', 'buy', 'iu3pcbundlepurchase2012-de')">
            Jetzt kaufen
          </button>
        </a>
  ...
  <article id="arti">
    <div class="art">
      ...
      <div class="num3">
        <a href="https://www.iobit.com/buy.php?product=de-iu10pfsd1899&ref=de_iu103pcpfsdsale2012<?= $refStr; ?>&refs=de_purchase_iu">
          <button onclick="ga('send', 'event', 'iubuy', 'buy', 'iu3pcbundlepurchase2012-de')">Geschenke bekommen</button>
          <p>
        </a>
  ...
  <section class="clearfix" id="sect">
    <div class="sec">
      ...
      <div class="sec-buy">
        <p class="sec1">18<span>,99€</span> <i>109,89€</i></p>
        <p class="sec2">19<span>,99€</span> <i>39,95€</i></p>
        <a href="https://www.iobit.com/buy.php?product=de-iu10pfsd1899&ref=de_iu103pcpfsdsale2012<?= $refStr; ?>&refs=de_purchase_iu" id="hrf">
...
<script>
  ...
  function soldOut() {
    ...
    $('#hrf').attr('href', 'https://www.iobit.com/buy.php?product=de-iu103pc1999&ref=de_iu103pcpurchase2012<?= $refStr; ?>&refs=de_purchase_iu')
  ...
  $('#hrf button').on('click', function() {
      if (valuenum == 1) {
        ga('send', 'event', 'iubuy', 'buy', 'iu3pcsinglepurchase2012-de')
      } else {
        ga('send', 'event', 'iubuy', 'buy', 'iu3pcbundlepurchase2012-de')
      }
    })
    (function() {
      countdown(("#timeout"));
