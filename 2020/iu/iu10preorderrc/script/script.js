...
function soldOut() {
  ...
  if ($(".banner").hasClass("record")) {
    $(".buybtn").attr({
      ...
      "onclick": "ga('send', 'event', 'iusoldbuy', 'buy', 'iu10predordermonitorb');"
    }).html("<span>Get It Now - 50% OFF</span>");
  } else {
    $(".buybtn").attr({
      "href": 'https://www.iobit.com/buy.php?product=iu10preorder1477&ref=en-iu10preorderrcsoldout' + refStr + '&aff=' + aff + '&refs=purchase_iu&tw=' + tw,
      "onclick": "ga('send', 'event', 'iusoldbuy', 'buy', 'iu10predorderrc');"
    }).html("<span>Get It Now - 50% OFF</span>");
  }
}
...
function record() {
  ...
  if ($(".banner").hasClass("record")) {
    ...
    $(".buybtn").attr({
      "href": 'https://www.iobit.com/buy.php?product=iu10preorder&ref=en-iu10preorderrc' + refStr + '&aff=' + aff + '&refs=purchase_iu&tw=' + tw,
    ...
    $(".buybtn").attr({
      "href": 'https://www.iobit.com/buy.php?product=iu10preorder&ref=en-iu10preorderrc' + refStr + '&aff=' + aff + '&refs=purchase_iu&tw=' + tw,
      "onclick": "ga('send', 'event', 'iubuy', 'buy', 'iu10predordermonitorb');"
    });
  }
}
...
function getReTime() {
  var packsNumTotal = cGet('eniujunerc_t');
