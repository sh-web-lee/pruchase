...
function soldOut() {
  ...
  $(".banner .panel.right .buybtn,.gifts .buybtn,.bottombuy buybtn").attr({
    "href": "http://www.iobit.com/buy.php?product=pl-iu103pc64&ref=pl_iu103pc64purchase2008" + ref + "&refs=pl_purchase_iu&tw=-8",
...
function getCycleCountdown() {
  if (MApp(2.2).cookie.get('school2020pliu')) {
    dt = MApp(2.2).cookie.get('school2020pliu');
  } else {
    var date = new Date();
    dt = date.setMinutes(date.getMinutes() + 20);
    setCookie('school2020pliu', dt, 1);
