  ...
  <div class="wrapper">
    ...
    <div class="content">
      ...
      <div class="panel left in">
        ...
        <!-- buybtn -->
        <a class="buybtn"
           href="http://www.iobit.com/buy.php?product=pl-iu101pc6m54&ref=pl_iu101pc6m54purchase2008<?php echo $refStr;?>&refs=pl_purchase_iu"
           onclick="ga('send', 'event', 'iubuy', 'buy', 'iu-school2020-pl');">
          <i class="all-icons"></i>
          KUP TERAZ
        </a>
      </div>
      ...
      <div class="panel middle in">
        ...
        <!-- buybtn -->
        <a class="buybtn"
           href="http://www.iobit.com/buy.php?product=pl-iu101pc59&ref=pl_iu101pc59purchase2008<?php echo $refStr;?>&refs=pl_purchase_iu"
           onclick="ga('send', 'event', 'iubuy', 'buy', 'iu-school-2020-pl');">
          <i class="all-icons"></i>
          KUP TERAZ
        </a>
      </div>
      ...
      <div class="panel right in on">
        ...
        <a class="buybtn large"
           href="http://www.iobit.com/buy.php?product=pl-iu103pcsdpf64&ref=pl_iu103pcsdpf64purchase2008<?php echo $refStr;?>&refs=pl_purchase_iu"
           onclick="ga('send', 'event', 'iubuy', 'buy', 'iu-school2020-pl');">
          <i class="all-icons"></i>
          KUP TERAZ
        </a>
  ...
  <div class="wrapper clearfix">
    ...
    <div class="content">
      ...
      <dl class="two clearfix">
        ...
        <dd>
          <h3>Wykrywa i odinstalowuje Bundleware</h3>
          <p>
            Wykrywa i odinstalowuje pakiety programów, <br>
            np.: adware, wtyczki, przeglądarki i wiele innych.
          </p>
        </dd>
      </dl>
      <!-- 03 -->
  ...
  <table>
    <thead>
      <tr>
        ...
        <th class="free"><div>IObit Uninstaller 9 <br> FREE </div></th>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="text">
          Usuwa powiadomienia przeglądarki
