...
function soldOut() {
  ...
  //float
  $(".floatlayer .number").html('Profitez du meilleur programme de désinstallation');
  //price
  $(".price").find("strong").html("<del>39,99€</del> <span>14,99€</span>");
  setTimeout(function() {
    $(".price strong").addClass("remove");
  }, 500);
  //buybtn
  $(".buybtn").attr({
    "href": 'https://www.iobit.com/buy.php?product=fr-iu10preorder1499&ref=fr_iu10preorderrc1499' + refStr + '&aff=' + aff + '&refs=fr_purchase_iu&tw=' + tw,
    "onclick": "ga('send', 'event', 'iusoldbuy', 'buy', 'iu10predorderrc-fr');"
  }).html("<span>-60% - J’en Profite</span>");
}
...
function getReTime() {
  var packsNumTotal = cGet('friujunerc_t');
