...
function sect01() {
   ...
   tl.to(".feature .list01", .5, {top:60,opacity:1,ease: 'ease'},'+=1')
     .to(".feature .list01 .hand", .5, {opacity:1,top:13,ease: 'ease'},'+=0.5')
     .to(".feature .list01 .button", .5, {
     	onStart: function() {
				$(".feature .list01 .button").addClass("on")
			}
     },'+=0.1')
     .to(".feature .list01", .5, {scale:0,opacity:0,ease: 'ease'},'+=0.5')
     .to(".feature .list02", .5, {top:60,opacity:1,ease: 'ease'},'-=0.5')
     .to(".feature .list02", 1, {
			onStart: function() {
     ...
     .to(".feature .list02", .5, {scale:0,opacity:0,ease: 'ease'},'+=1')
     .to(".feature .list03", .7, {top:84,opacity:1,ease: 'ease'},'-=0.5')
     .to(".feature .list03 .bar span", 1, {width:360,ease: 'ease'},'+=0.7')
     .to(".feature .list03", .7, {scale:0,opacity:0,ease: 'ease'},'+=.2')
     .to(".feature .list04", .7, {
     	top:84,
     	opacity:1,
     	ease: 'ease',
...
function soldOut() {
	...
	flipNum(0, 2);
	$(".banner .number").html("");
	$(".banner h2").html("Få det bedste afinstalleringsværktøj <br> med <strong>60% rabat</strong>");
	$(".floatlayer .number").html('Få det bedste afinstalleringsværktøj med<strong> 60% rabat</strong>');
	$(".price").find("strong").html("159 kr.<del>399 kr.</del>");
	$(".buybtn").attr({
		"href": 'https://www.iobit.com/buy.php?product=dk-iu10preorder159&ref=dk_iu10preorderofficialsoldout' + refStr + '&aff=' + aff + '&refs=dk_purchase_iu&tw=' + tw,
		"onclick": "ga('send', 'event', 'iubuy', 'buy', 'iu10preorderofficialsoldout-dk');"
	}).text(" Køb nu");
}
// soldOut();
var c =0;
...
function getReTime() {
	var packsNumTotal = cGet('dkiujune_t');
