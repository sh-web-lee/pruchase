      ...
      <div class="clearfix">
        <div class="offer">
          ...
          <a class="buybtn empty"
             href="https://www.iobit.com/buy.php?product=es-iu103pc1599&ref=es_iu103pc1599purchase2011xr<?php echo $refStr;?>&refs=es_purchase_iu"
             onclick="ga('send', 'event', 'iubuy', 'buy', 'iu3pcpurchase2011xr-es');">
            COMPRA YA
          </a>
        </div>
        <div class="offer big">
          ...
          <a class="buybtn"
             href="https://www.iobit.com/buy.php?product=es-iu103pcpfsd1499&ref=es_iu103pcpfsd1499purchase2011xr<?php echo $refStr;?>&refs=es_purchase_iu"
             onclick="ga('send', 'event', 'iubuy', 'buy', 'iu3pcpfsdpurchase2011xr-es');">
            COMPRA YA
          </a>
        </div>
      </div>
