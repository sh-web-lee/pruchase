...
<body>
  ...
  <div class="banner">
    <div class="wrapper">
      ...
      <h3>¡Celebramos juntos el aniversario de IObit y aprovechamos las mejores ofertas que se hayan visto antes!</h3>
      ...
      <div class="detail-list">
        <dl class="two active">
          ...
          <dd>
            ...
            <p>Desinstala por completo todos los programas, incluso aquellos con problemas de desinstalación, y los cambios que hayan realizado en el sistema.</p>
          </dd>
        </dl>
        <dl class="two">
  ...
  <div class="comparison wrapper" id="compare">
    <table border="0" cellspacing="0" cellpadding="0" width="100%">
      <thead>
        <tr>
          <th class="text" colspan="2">¿Qué ventajas tiene la PRO edción?</th>
          <th class="space"></th>
          <th class="itemb">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="virtue">Elimina programas con problemas de desinstalación <span class="nuo">Nuevo</span></td>
          <td class="space"></td>
          <td class="itemb"><i class="all-icons">√</i></td>
          <td class="space"></td>
          <td class="itema"><i class="all-icons red">√</i></td>
        ...
        <tr>
          ...
          <td class="virtue">Revierte automáticamente los cambios del sistema que un programa ha realizado al desinstalarlo
