...
function soldOut() {
	...
	flipNum(0, 2);
	$(".banner .number").html("");
	$(".banner h2").html("Aanbieding uitverkocht.<br> Pak toch nog <strong>33% Korting!</strong>");
	$(".floatlayer .number").html('Pak toch nog <strong>33% Korting!</strong>');
	$(".price").find("strong").html("€<big>19</big>,99");
	$(".buybtn").attr({
		"href": 'https://www.iobit.com/buy.php?product=nl-iu10preorder1999&ref=nl_iu10preorderofficial1999' + refStr + '&aff=' + aff + '&refs=purchase_iu&tw=' + tw,
		"onclick": "ga('send', 'event', 'iubuy', 'buy', 'iu10preorderofficialsoldout-nl');"
	});
}
// soldOut();
...
function getReTime() {
	var packsNumTotal = cGet('nliujune_t');
