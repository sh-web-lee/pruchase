...
function soldOut() {
  ...
  $(".buybtn").attr({
    "href": 'https://www.iobit.com/buy.php?product=db8spin3pcfr&ref=fr_db3pc1999bf2020'+refStr+'&refs=fr_purchase_db&tw=' + tw,
    "onclick": "ga('send', 'event', 'dbbuy', 'buy', 'db3pc1999bf2020-fr');"
  });
}
...
function getRetime(isInit) {
  if(isInit==2){
    ...
    var packsNumTotal = cGet('frdbblack_t');
    if (packsNumTotal > 1) {
