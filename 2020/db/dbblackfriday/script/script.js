...
function maskShow() {
  ...
  $('.main').append('<div class="mask"></div><div class="mask-box"><h2>'+ soldStr +'</h2><div class="clearfix"><div class="fl left"><img src="' + imgSrc + '" alt="Driver Booster 6 Pro"/></div><div class="price fl"><img src="' + imgOff + '" alt="70% OFF"/><p><strong><big>26</big>,99€</strong> <b><del>89,99€</del></b></p><a class="buybtn" href="' + _href + '" onclick="' + _ga + '"><i class="all-icons"></i><span>Activate Now</span></a></div></div></div>');
