...
if (!empty($_GET['action']) && ($_GET['action'] == 'getPacks')) {
  $date = $_GET['d'];
  $cName_t = 'xmasxrede2020_t' . $date;
  $cName_p = 'xmasxrede2020_p' . $date;
  $maxNum = rand(70, 90);
  $minNum = 3;
...
<head>
  <meta charset="UTF-8">
  <title>Sparen Sie heute bis zu 88% auf Driver Booster PRO – IObit!</title>
...
<body>
    ...
    <div class="wrapper">
      ...
      <div class="clearfix">
        <div class="banlist big">
          ...
          <div class="price">
            <p><strong>22,99€</strong> <del>187,92 €</del></p>
            <a class="buybtn" href="https://www.iobit.com/buy.php?product=de-db83pcsdpfisu2299&ref=de_db83pcsdpfisu2012xmasxre-i-u-t-e<?= $refStr; ?>&refs=de_purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'db3pcbundle2012xmasxre-de')">
              Jetzt kaufen
            </a>
          </div>
          <ul class="txtlist">
            <li><i class="all-icons"></i> Spart 164,93€</li>
          ...
          <div class="discount"><b>-88%</b></div>
        </div>
        <div class="banlist">
          <img src="<?php echo getStaticUrl('images/db-box.png') ?>" alt="" />
          <div class="price">
            <p><strong>24,99€</strong> <del>69,99 €</del></p>
            <a class="buybtn" href="https://www.iobit.com/buy.php?product=de-db81pc2499&ref=de_db81pc2012xmasxre-i-u-t-e<?= $refStr; ?>&refs=de_purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'db1pcsingle2012xmasxre-de')">
              Jetzt kaufen
            </a>
          </div>
          <ul class="txtlist">
  ...
  <div class="asc">
    <h1>Driver Booster 8 PRO kann noch mehr als Ihre vorherige Version tun!</h1>
    ...
    <div class="asc-box">
      <ul>
        <li>
          ...
          <p> Aktualisiert Ihre Netzwerktreiber sogar ohne Internetverbindung.</p>
        </li>
        <li>
          <div class="po"><img src="<?= $pResUrl; ?>images/icon 2.png" alt=""></div>
          <h2>Scan-Priorität für Gerätetreiber</h2>
          <p>Wählen Sie, den neuesten Treiber oder den stabilsten Treiber zuerst zu aktualisieren.</p>
        </li>
        <li>
          <div class="po"><img src="<?= $pResUrl; ?>images/icon 3.png" alt=""></div>
          <h2>Schneller</h2>
          <p>Mit 30% schnellerer Aktualisierung als die vorherige Version sparen Sie noch mehr Zeit. </p>
        </li>
        <li>
          <div class="po"><img src="<?= $pResUrl; ?>images/icon 4.png" alt=""></div>
          <h2>Sicherer</h2>
          <p>Mit der erweiterten Treibersicherung machen Sie sich keine Sorge beim Aktualisieren </p>
        </li>
      </ul>
    </div>
  </div>
  ...
  <div class="sect">
    <h1 style="margin-bottom:40px; text-align: center;">Bekommen Sie alle PRO-Funktionen für eine bessere Hardwareleistung</h1>
    <!-- <div style="text-align:center;margin:50px 0">
      <img src="<?= $pResUrl; ?>images/line1.png" alt="">
    </div> -->
    <div class="contains">
      <table>
        <thead>
          <tr>
            ...
            <th>Mit Pro können Sie Folgendes genießen!</th>
          </tr>
        </thead>
        <tr>
          <td><b>Veraltete Treiber </b> wegen einer begrenzten Datenbank</td>
          <td>Aktualisiert alle Ihre Treiber mit einer größeren Datenbank, die <b>mehr als 4.500.000 Treiber enthält.</b></td>
        </tr>
        <tr>
          <td><b>Das System stürzt ab</b>, wenn ein Fehler während des Aktualisierungsvorgangs auftritt </td>
          <td><b>Automatische Treibersicherungen und Systemwiederherstellung</b> zum vermeiden aller Probleme</td>
        </tr>
        <tr>
          <td>Geräte <b>funktionieren plötzlich nicht mehr</b> oder funktionieren nicht mehr so gut wie sie könnten</td>
          <td>Funktionierende und <b>stabile Geräte</b> wie Maus, Tastatur und Webcam </td>
        </tr>

        <tr>
          <td><b>Keinen Ton, schlechte Bildsauflösung oder Netzwerkfehler.</b> </td>
          <td><b>Behebt Probleme</b> Ihrer Hardware mit nur einem Klick</td>
        </tr>
        <tr>
          <td><b>Lange Wartezeit</b> beim Aktualisieren der Treiber</td>
          <td>Aktualisiert Ihre Treiber mit der PRO-Version bis zu <b>100% schneller</b></td>
        </tr>
        <tr>
          <td><b>Spiele können nicht funktionert werden</b> oder es fehlen wichtige Funktionen</td>
          <td>Mit Zugriff auf alle Spielkomponenten und Game Ready-Treiber genießen Sie ein besseres <b>Spielerlebnis</b></td>
        </tr>
        <tr>
          <td><b>Videos und Spiele von schlechter Qualität</b> aufgrund ungeeigneter Grafiktreiber</b></td>
          <td>Video-, Streaming- und Spielerlebnis in <b>perfekter Qualität</b> mit besseren Grafiktreibern</td>
        </tr>
        <tr>
          <td style="border: 1px solid #e1dcdc;"><b>Unlösbare Netzwerkfehler,</b> da Sie Netzwerktreiber ohne Internetverbindung nicht aktualisieren können</td>
          <td style="border: 1px solid #e1dcdc;background-color: #fef4f4;">Aktualisiert Ihre Netzwerktreiber ohne Internetverbindung mit dem <b>Offline Driver Updater</b></td>
        </tr>
      </table>
    </div>
  </div>
  ...
  <div id="floatlayer" class="floatlayer">
    <div class="wrapper clearfix">
      ...
      <div class="price fr">
        <p><strong>22,99€</strong> <del>187,92 €</del></p>
        <a class="buybtn" href="https://www.iobit.com/buy.php?product=de-db83pcsdpfisu2299&ref=de_db83pcsdpfisu2012xmasxre-i-u-t-e<?= $refStr; ?>&refs=de_purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'db3pcbundle2012xmasxre-de')">Jetzt kaufen</a>
      </div>
    </div>
  </div>
  <!-- floatlayer end -->
