...
function soldout() {
  ...
  $(".banner .numbox,.price strong").remove();
  $(".price span").html("<strong>R$ <b>79</b>,99</strong><del>R$ 199,99 </del>")
  $(".floatlayer .numbox").html('Obtenha o Melhor Atualizador de Drivers com <strong>60% de Desconto</strong>');
  $(".buybtn").attr({
    "href": 'https://www.iobit.com/buy.php?product=pt-db8preorder7999&ref=pt-db8preorderrcsoldout' + refStr + '&aff=' + aff + '&refs=pt_purchase_db&tw=-8',
    "onclick": "ga('send', 'event', 'db3pcbuy', 'buy', 'db8preorderrc-pt');"
  });
...
function getReTime() {
  var packsNumTotal = cGet('ptdbpre_t');
  if (packsNumTotal > 1) {
