...
if (!empty($_GET['action']) && ($_GET['action'] == 'getPacks')) {
  $date = $_GET['d'];
  $cName_t = 'xmasdk2020_t' . $date;
  $cName_p = 'xmasdk2020_p' . $date;
  $maxNum = rand(70, 90);
  $minNum = 3;
...
<head>
  <meta charset="UTF-8">
  <title>Eksklusive 88% rabat på Driver Booster 8 Pro & og få en product gratis</title>
...
<body>
    ...
    <div class="wrapper">
      ...
      <div class="clearfix">
        <div class="banlist big">
          ...
          <div class="price">
            <p><strong>199 kr.</strong> <del>1.646 kr.</del></p>
            <a class="buybtn" href="https://www.iobit.com/buy.php?product=dk-db83pcisusdpf199&ref=dk_db3pcbundlexmas202012-i-u-t-e<?php echo $refStr; ?>&refs=dk_purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'db3pcbundlepurchase2012-dk') ">
              Køb nu
            </a>
          </div>
          <ul class="txtlist">
        ...
        <div class="banlist">
          ...
          <div class="price">
            ...
            <a class="buybtn" href="https://www.iobit.com/buy.php?product=dk-db81pc189&ref=dk_db1pcsinglexmas202012-i-u-t-e<?php echo $refStr; ?>&refs=dk_purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'db1pcsinglepurchase2012-dk')  ">
              Køb nu
            </a>
          </div>
          <ul class="txtlist">
  ...
  <div id="floatlayer" class="floatlayer">
    <div class="wrapper clearfix">
      ...
      <div class="price fr">
        <p><strong>199 kr.</strong> <del>1646 kr.</del></p>
        <a class="buybtn" href="https://www.iobit.com/buy.php?product=dk-db83pcisusdpf199&ref=dk_db3pcbundlexmas202012-i-u-t-e<?php echo $refStr; ?>&refs=dk_purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'db3pcbundlepurchase2012-dk')">Køb nu</a>
      </div>
    </div>
  </div>
  <!-- floatlayer end -->
