      ...
      <div class="offer clearfix">
        ...
        <p class="m">THE GLOBAL PRESALE IS ON</p>
          ...
          <div class="price">
            ...
            <a href="https://www.iobit.com/buy.php?product=db8preorder&ref=en-db8preorderrc<?php echo $refStr; ?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_db"
               onclick="ga('send', 'event', 'dbbuy', 'buy', 'db8preorderrc');" class="buybtn">Get It Now</a>
          </div>
          <div class="numbox">
            <h3>
        ...
        <div class="message01 mb-130">
          ...
          <div class="message-box animate__animated animation-box">
            <dl>
              ...
              <dt><i></i><div class="dt-cont">Unlimited <span class="market">drivers updating per day with 4,500,000 driver database;</span></div></dt>
                <?php else: ?>
              <dt><i></i><div class="dt-cont">Privilege<span class="market">of updating more rare drivers with 4,500,000 driver database;</span></div></dt>
                <?php endif;?>
        ...
        <div class="message01">
          ...
          <div class="message-box">
            <dl class="animate__animated animation-box">
              ...
              <dt><i></i><div class="dt-cont">Fix<span class="market">device errors like cannot access your external hard drives with 1-click; </span></div></dt>
            </dl>
          </div>
...
<div class="floatlayer clearfix">
  <div class="wrapper clearfix">
    ...
    <div class="price fr">
     ...
     <span></span>
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=db8preorder&ref=en-db8preorderrc<?php echo $refStr; ?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_db"
           onclick="ga('send', 'event', 'dbbuy', 'buy', 'db8preorderrc');">
           Get It Now
        </a>
    </div>
  </div>
