...
<head>
  ...
  <title>88% de descuento y regalos para DB PRO – IObit</title>
...
<div class="banner">
  <div class="wrapper">
    ...
    <p>Obtén un 88% de descuento en Driver Booster y regalos gratis</p>
    <div class="left-box">
      <h2><strong>88%</strong> de descuento <span>Una vez al año, ¡solo para año nuevo!</span></h2>
    ...
    <div class="right-box">
      ...
      <dl>
        <dt><strong>Driver Booster 8 PRO</strong> <span>19,99€</span> <del>74,85€</del></dt>
        <dd><strong>Protected Folder</strong> <span>0€</span></dd>
        <dd><strong>Smart Defrag 6 PRO</strong> <span>0€</span></dd>
        <dd><strong>IObit Uninstaller 10 PRO</strong> <span>0€</span></dd>
    ...
    <dl class="price">
      ...
      <dd>
        <a href="https://www.iobit.com/buy.php?product=es-db83pcsdpfiu1999&ref=es_db83pcsdpfiupurchase1912<?php echo $refStr;?>&refs=es_purchase_db"
           onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase1912-es')"
           class="buybtn">
          Comprar ahora
        </a>
      </dd>
...
<div class="gift-box">
  <div class="wrapper clearfix">
    <!-- gift-box title -->
    <h2>El paquete de regalo exclusivo sólo para año nuevo, no te lo pierdas</h2>
    <!-- SD -->
    <dl>
    ...
    <div class="message">
      <div class="left-message">
        ...
        <ul>
          ...
          <li><i></i> <span>IObit Uninstaller PRO </span> <b>0€</b> <del>29,99€</del></li>
...
<div class="comparison-table" id="compare">
  <table border="0" cellspacing="0" cellpadding="0" width="100%">
    ...
    <tr>
      ...
      <th class="space"></th>
      <th class="itema"><div>Driver Booster PRO <span>3 PCs / 1 año+ Paquete de regalos </span></div></th>
    </tr>
    </thead>
    <tbody>
    <tr>
