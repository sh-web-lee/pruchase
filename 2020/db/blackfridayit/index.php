...
if ($_GET['action'] == 'getPacks') {
  $date = $_GET['d'];
  $isInit=$_GET['isInit'];
  $c_name = 'itascnovbrb_p' . $date;
  $c_name_t='itascnovbrb_t' . $date;
...
<div class="banner">
  <div class="wrapper">
    ...
    <div class="chart">
      ...
      <div class="chartbox center three"><span><?= $content['7']; ?></b></span></div>
    ...
    <div class="price clearfix">
      ...
      <div class="btnbox">
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=it-db3pc1799&ref=it_db3pc1799bf2010<?php echo $refStr;?>&refs=it_purchase_db"
           onclick="ga('send', 'event', 'dbbuy', 'buy', 'db3pc1799bf2010-it');">
            <?= $content['12']; ?>
        </a>
        <p><?= $content['13']; ?></p>
      </div>
...
<div class="review">
  <div class="wrapper">
    ...
    <ul class="users clearfix">
      ...
      <li>
        <div class="pic"><img src="<?php echo $pResUrl; ?>images/fabio-tursi.png" alt="Fabio Tursi"></div>
        <p><?= $content['43']; ?></p>
      </li>
      <li>
        <div class="pic"><img src="<?php echo $pResUrl; ?>images/olorin89.png" alt="Olorin 89"></div>
        <p><?= $content['44']; ?></p>
      </li>
    </ul>
    <span class="arrow"></span>
