...
function soldOut() {
  ...
  $(".buybtn").attr({
    "href": 'https://www.iobit.com/buy.php?product=es-db83pc1699&ref=es_db83pc1699bf2010'+refStr+'&refs=es_purchase_db&tw=' + tw,
    "onclick": "ga('send', 'event', 'dbbuy', 'buy', 'db83pc1699bf2010-es');"
  });
}
...
function getRetime(isInit) {
  if(isInit==2){
    ...
    var packsNumTotal = cGet('esdbblack_t');
    if (packsNumTotal > 1) {
