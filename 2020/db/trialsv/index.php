  ...
  <div class="wrapper">
    ...
    <div class="content">
      ...
      <div class="right-message fr">
        ...
        <!-- buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=sv-db83pcsdisu299&ref=sv_trialdb83pcsdisu<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=sv_purchase_db"
           onclick="ga('send', 'event', 'dbbundlebuy', 'buy', 'dbpurchase-trial1-sv')">
          KÖP NU
        </a>
        <!-- attention -->
...
<div class="comparison wrapper">
  ...
  <table>
    ...
    <tr>
      ...
      <td class="itema"><p class="exTxt first">14 dagar</p></td>
      <td class="space"></td>
    ...
    <tr>
      ...
      <td class="itema"><p class="exTxt">14 dagar</p></td>
      <td class="space"></td>
      <td class="itemc"><i class="all-icons red">√</i></td>
    </tr>
    <tr>
