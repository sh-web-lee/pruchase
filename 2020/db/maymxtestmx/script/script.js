  ...
  $(".bottom-buy ul li").click(function() {
    ...
    $(".bottom-buy dl del").html($(".banner .box").eq(num).find("del").text())
     if(num==0) {
      ...
      $(".bottom-buy dl dt").html("<strong><b>MXN</b> 509</strong> <del>MXN 909  </del> ")
    }
    else if(num==1) {
      $(".bottom-buy .left-img").removeClass("one-box").removeClass("three-box");
      $(".bottom-buy dl dt").html("<strong> <b>MXN</b> 509</strong> <del>MXN 3,659  </del>")
    }
    else {
      $(".bottom-buy .left-img").addClass("three-box").removeClass("one-box");
      $(".bottom-buy dl dt").html("<strong><b>MXN</b> 509</strong> <del>MXN 1889  </del> ")
    }
  });
});
