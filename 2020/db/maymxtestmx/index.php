...
<div class="banner">
  <div class="wrapper">
    ...
    <div class="box">
      ...
      <p><del>MXN 909  </del> <strong><b>MXN</b> 459</strong></p>
      <a href="https://www.iobit.com/buy.php?product=mx-db71pc459&ref=es_db71pcpurchase2002mxmx<?php echo $refStr;?>&refs=es_purchase_db" 
         onclick="ga('send', 'event', 'ascubuy', 'buy', 'dbpurchase1pc2002mxmx-es')" class="buybtn border">Comprar ahora</a>
    </div>
    <div class="box gift-box">
      ...
      <p><del>MXN 3,659 </del> <strong><b>MXN</b> 509</strong></p>
      <a href="https://www.iobit.com/buy.php?product=mx-db73pcpfsd509&ref=es_db73pcpfsd2002mxmx<?php echo $refStr;?>&refs=es_purchase_db" 
         onclick="ga('send', 'event', 'ascubuy', 'buy', 'dbpurchase3pcbundle2002mxmx-es')" class="buybtn center">Comprar ahora</a>
    ...
    <div class="box three-box">
      ...
      <p><del>MXN 1889  </del> <strong><b>MXN</b> 509</strong></p>
      <a href="https://www.iobit.com/buy.php?product=mx-db73pc509&ref=es_db73pc2002mxmx<?php echo $refStr;?>&refs=es_purchase_db" 
         onclick="ga('send', 'event', 'ascubuy', 'buy', 'dbpurchase3pc2002mxmx-es')"  class="buybtn border">Comprar ahora</a>
    </div>
    </div>
  </div>
<!-- banner end -->
  ...
  <table border="0" cellspacing="0" cellpadding="0" width="100%">
    ...
    <tfoot>
      <tr>
        <th colspan="4"></th>
        <th class="itema">
          <del>MXN 3,659 </del> <strong>MXN 509</strong>
          <a href="https://www.iobit.com/buy.php?product=mx-db73pcpfsd509&ref=es_db73pcpfsd2002mxmx<?php echo $refStr;?>&refs=es_purchase_db" 
             onclick="ga('send', 'event', 'ascubuy', 'buy', 'dbpurchase3pcbundle2002mxmx-es')"
             class="buybtn center">
            Comprar ahora
          </a>
...
<div class="bottom-buy">
 <div class="wrapper">
   ...
   <dl>
     <dt> <strong><b>MXN</b> 509</strong> <del>MXN 3,659  </del></dt>
     <dd><a href="https://www.iobit.com/buy.php?product=mx-db73pcpfsd509&ref=es_db73pcpfsd2002mxmx<?php echo $refStr;?>&refs=es_purchase_db" 
            onclick="ga('send', 'event', 'ascubuy', 'buy', 'dbpurchase3pcbundle2002mxmx-es')" class="buybtn center">Comprar ahora</a></dd>
   </dl>
 </div>
</div>
<!--  footer start-->
