...
function soldout() {
	...
	$(".floatlayer .numbox").html('Ottieni il programma per l’aggiornamento dei <br> driver n.1 al mondo con  <strong>70% DI SCONTO</strong>');
	$(".buybtn").attr({
		"href": 'https://www.iobit.com/buy.php?product=it-db8preorder2295&ref=it_db8preorderofficialsoldout2295' + refStr + '&aff=' + aff + '&refs=it_purchase_db&tw=-8',
		"onclick": "ga('send', 'event', 'dbbuy', 'buy', 'db8preorderofficialsoldout-it');"
	})
	$(".banner .buybtn").html("Preordina Ora - 70% DI SCONTO");
}
function seview() {
...
function getReTime() {
	var packsNumTotal = cGet('itdbofficial_t');
	if (packsNumTotal > 1) {
