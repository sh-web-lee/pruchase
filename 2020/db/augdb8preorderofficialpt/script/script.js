...
function soldout() {
  ...
  $(".buybtn").attr({
    "href": 'https://www.iobit.com/buy.php?product=pt-db8preorder7999&ref=pt-db8preorderofficialsoldout' + refStr + '&aff=' + aff + '&refs=pt_purchase_db&tw=-8',
    "onclick": "ga('send', 'event', 'db3pcbuy', 'buy', 'db8preorderofficial-pt');"
  });
