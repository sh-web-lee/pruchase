...
if ($_GET['action'] == 'getPacks') {
  $date = $_GET['d'];
  $c_name = 'itdbjansale_p' . $date;
  $c_name_t='itdbjansale_t' . $date;
...
<head>
  ...
  <title>Offerta Speciale - Sconto fino all'85% per Driver Booster PRO</title>
...
<body>
  ...
  <div class="banner">
    <div class="wrapper clearfix">
      ...
      <div class="title">
        <h1>L'OFFERTA IMPERDIBILE DI OGGI!</h1>
      ...
      <div class="right fr">
        <div class="chart">
          ...
          <div class="clist two">
            <span class="cost"><strong><big>24</big>,99€</strong></span>
            <span class="line"></span>
            <span class="point"></span>
            <span class="text"><b class="pickNum">39</b>* <em class="reduce"></em> pezzi rimasti, affrettati!</span>
          </div>
        ...
        <div class="price">
          <p><strong><big>24</big>,99€</strong> <del>174,78€</del></p>
          <a class="buybtn"
             href="https://www.iobit.com/buy.php?product=it-db73pciusdpf2499&ref=it_db73pciusdpf2499purchase2001<?php echo $refStr;?>&refs=it_purchase_db "
             onclick="ga( 'send', 'event', 'dbbuy', 'buy', 'dbpurchase2001-it');">
            Approfittane Ora
          </a>
        </div>
      </div>
