...
function soldout() {
	...
	$(".buybtn").attr({
		"href": 'https://www.iobit.com/buy.php?product=nl-db8preorder2499&ref=nl_db8preorder2499' + refStr + '&aff=' + aff + '&refs=nl_purchase_db&tw=-8',
		"onclick": "ga('send', 'event', 'dbbuy', 'buy', 'db8preordersoldout-nl');"
	})
}
...
function getReTime() {
	var packsNumTotal = cGet('nldb8pre_t');
	if (packsNumTotal > 1) {
