...
function soldout() {
	...
	$(".buybtn").attr({
		"href": 'https://www.iobit.com/buy.php?product=es-db8preorder1999&ref=es_db8preorderofficialsoldout' + refStr + '&aff=' + aff + '&refs=es_purchase_db&tw=-8',
...
function getReTime() {
	var packsNumTotal = cGet('esdbofficial_t');
	if (packsNumTotal > 1) {
