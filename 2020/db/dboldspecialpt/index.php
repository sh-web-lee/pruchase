...
<div class="banner">
  <div class="wrapper">
    ...
    <h1>PROMOÇÃO EXCLUSIVA PARA USUÁRIOS DE LONGA DATA!</h1>
    <h2>Obtenha desempenho máximo com drivers atualizados pelo menor preço.</h2>
    <div class="panel clearfix">
      ...
      <div class="right fr">
        ...
        <p class="decri">Licença vale para versões futuras enquanto durar a assinatura.</p>
...
<div class="bottom-buy wrapper clearfix">
  <h2>Com apenas <strong>R$ 0,18</strong> por dia, você mantém seus drivers sempre atualizados.</h2>
