...
function soldout() {
  ...
  $(".buybtn").attr({
    "href": 'https://www.iobit.com/buy.php?product=es-db8preorder1999&ref=es_db8preordersoldout' + refStr + '&aff=' + aff + '&refs=es_purchase_db&tw=-8',
    "onclick": "ga('send', 'event', 'db3pcbuy', 'buy', 'db8preorderpre-es');"
  });
  $(".banner .buybtn").html("Resérvalo ahora – 73% DTO");
}
...
function getReTime() {
  var packsNumTotal = cGet('esdb8preorderpre_t');
  if (packsNumTotal > 1) {
