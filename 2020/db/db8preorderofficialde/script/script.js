...
function soldout() {
  ...
  $(".buybtn").attr({
    "href": 'https://www.iobit.com/buy.php?product=de-db8preorder2699&ref=de_db8preorderofficialsoldout' + refStr + '&aff=' + aff + '&refs=de_purchase_db&tw=-8',
    "onclick": "ga('send', 'event', 'dbbuy', 'buy', 'db8preorderofficialsoldout-de');"
  });
...
function getReTime() {
  var packsNumTotal = cGet('dedbofficial_t');
  if (packsNumTotal > 1) {
