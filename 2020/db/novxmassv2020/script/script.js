...
var soldout = function () {
  ...
  $('.banner .cont .center .time').css('margin','-54px 0px 0px -40px')
  ...
  $('.ga-button').each((i,v)=>{
    $(v).attr('href','https://www.iobit.com/buy.php?product=sv-db83pc299&ref=sv_db83pc299purchase2011'+refStr+'&refs=sv_purchase_db').removeAttr('onclick').attr('onclick',"ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase3pc2011-sv')")
  })
};
function sendGift() {
