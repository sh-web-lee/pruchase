...
<head>
  ...
  <title>Spara 87% rabatt på Driver Booster PRO och få extra skydd på köpet – IObit</title>
    ...
    <div class="cont">
        ...
        <dl class="center soldout-box">
          ...
          <dd>
            ...
            <p>Betala ett rabatterat pris och få också 3 gåvor</p>
          </dd>
        ...
        <dl class="right">
          ...
          <dd class="three">
              <p class="t">Total: <span>299<b>kr</b></span> <del class="original">2256kr</del></p>
              <a class="ga-button" href="https://www.iobit.com/buy.php?product=sv-db83pcpfsdiu299&ref=sv_db83pcpfsdiu299purchase2011<?= $refStr; ?>&refs=sv_purchase_db"
                 onclick="ga('send', 'event', 'dbbuy', 'buy', 'db83pcpfsdiupurchase2011-sv');"
              >
...
<div class="paquete soldout-box">
  ...
  <dt>Betala ett rabatterat pris och få också 3 gåvor</dt>
    <dd>
      <div class="item">
      ...
      <div class="item">
        ...
        <h4>IObit Uninstaller 11 PRO</h4>
...
<div class="wrapper new_w b-buy">
    <div class="cont">
        <div class="left">
          <img class="offer-img" src="<?php echo $pResUrl; ?>images/offer.png" alt="">
          <span class="num">299kr<span class="original">2256kr </span></span>
          <p>1 År / 3 PC</p>
          <i class="add"></i>
        </div>
        <dl class="center soldout-box">
