...
var soldout = function () {
  ...
  $('.ga-button').each((i,v)=>{
    $(v).attr('href','https://www.iobit.com/buy.php?product=es-db83pc1999&ref=es_db83pcpurchase2011'+refStr+'&refs=es_purchase_db').removeAttr('onclick').attr('onclick',"ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase3pc2011-es')")
  })
};
function sendGift() {
