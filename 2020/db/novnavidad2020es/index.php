...
<head>
  ...
  <title>89% de descuento y regalos para Driver Booster PRO – IObit </title>
    ...
    <div class="cont">
        ...
        <dl class="center soldout-box">
          ...
          <dd>
            ...
            <p>Tiempo limitado, ¡no te lo pierdas!</p>
          </dd>
        ...
        <dl class="right">
          ...
          <dd class="one">
            <span >19,99€</span> <del class="original">174.78€ </del> <span>Suscripción de 3PCs / 1 año</span>
          </dd>
          <dd class="two soldout-none">
            <img src="<?php echo $pResUrl; ?>images/lh.png" alt=""><span>Paquetes de regalo exclusivos</span>
          </dd>
          <dd class="three">
              <p class="t">En toal: <span>19<b>.99€</b></span> <del class="original">174.78€</del></p>
              <a class="ga-button" href="https://www.iobit.com/buy.php?product=es-db83pcpfsdisu1999&ref=es_db83pcpfsdisupurchase2011<?= $refStr; ?>&refs=es_purchase_db"
                 onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase3pcpfsdisu2011-es');"
              >
...
<div class="paquete soldout-box">
  ...
  <dl class="wrapper soldout-none">
    <dt>El paquete de regalo exclusivo solo por <br/> comprar Driver Booster PRO, ¡no te lo pierdas!</dt>
    <dd>
      <div class="item">
    ...
    <a class="ga-button" href="https://www.iobit.com/buy.php?product=es-db83pcpfsdisu1999&ref=es_db83pcpfsdisupurchase2011<?= $refStr; ?>&refs=es_purchase_db"
       onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase3pcpfsdisu2011-es');"
    >
      <button class="buy">Conseguir mis regalos ahora</button>
    </a>
  </dl>
...
<div class="wrapper new_w b-buy">
    <div class="cont">
        <div class="left">
          <img class="offer-img" src="<?php echo $pResUrl; ?>images/offer.png" alt="">
          <span class="num">19,99€<span class="original">174.78€ </span></span>
          <p>3PCs / 1 año</p>
          <i class="add"></i>
        </div>
        <dl class="center soldout-box">
