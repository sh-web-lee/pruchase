...
function soldout() {
	...
	$(".buybtn").attr({
		"href": 'https://www.iobit.com/buy.php?product=db8preorder2295&ref=en-db8preorderexpsoldout' + refStr + '&aff=' + aff + '&refs=purchase_db&tw=-8',
		"onclick": "ga('send', 'event', 'db3pcbuy', 'buy', 'db8preorderexp'); "
	})
