...
<head>
  <meta charset="UTF-8">
  <title>Offerta di Natale, fino a 89% di sconto su Driver Booster PRO – IObit</title>
...
<body>
  ...
  <div class="banner">
    ...
    <div class="wrapper">
      ...
      <h2>Driver aggiornati automaticamente e cura completa del tuo PC a soli 19,99€!</h2>
      ...
      <div class="clearfix">
        <div class="banlist ">
          ...
          <div class="price">
            ...
            <a class="buybtn" href="http://www.iobit.com/buy.php?product=it-db83pc2499&ref=it_db83pc2499purchasexmasxe2020<?php echo $refStr; ?>&aff=<?php echo $_GET['aff'] ?>&refs=it_purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase3pcxmasxe2020-it');">
            Acquista ora
            </a>
          </div>
          <ul class="txtlist">
        ...
        <div class="banlist big">
          ...
          <div class="price">
            ...
            <a class="buybtn" href="http://www.iobit.com/buy.php?product=it-db83pciuisupf1999&ref=it_db83pciuisupf1999purchasexmasxe2020<?php echo $refStr; ?>&aff=<?php echo $_GET['aff'] ?>&refs=it_purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase3pciuisupfxmasxe2020-it');">
              Approfittane ora
            </a>
          </div>
          <ul class="txtlist">
            <li><i class="all-icons"></i> Risparmia 154,79€</li>
 ...
 <div class="comparison">
    <!-- title -->
    <div class="title">
      <h2>Riottieni tutte le funzionalità PRO per prestazioni hardware migliori</h2>
      <img src="<?php echo getStaticUrl('images/b-border.png')?>" alt="">
    </div>
    <!-- table -->
    <div class="cont">
      <dl>
        <dd class="one"><span>Attento!</span> Al momento rischi…</dd>
        <dd class="two"><span>Invece </span> puoi godere di…<img src="<?php echo getStaticUrl('images/sd-icon.png')?>" alt=""></dd>
      </dl>
      <table>
        <tbody>
          <tr>
            <td><span>Driver obsoleti </span> a causa di un database limitato</td>
            <td>Aggiornamento di tutti i tuoi driver con un <span>database di 4.500.000+ driver</span></td>
          </tr>
          <tr>
            <td><span>Blocchi di sistema </span>se qualcosa va storto durante il processo di aggiornamento</td>
            <td><span>Backup automatici dei driver</span> e punti di ripristino del sistema per evitare qualsiasi problema</td>
          </tr>
          <tr>
            <td>Dispositivi che <span>improvvisamente smettono di funzionare</span> o non funzionano come dovrebbero</td>
            <td><span>Dispositivi funzionanti e stabili</span>,come mouse, tastiera e webcam</td>
          </tr>
          <tr>
            <td><span>Mancanza audio, cattiva risoluzione dello schermo o errori di connessione di rete.</span></td>
            <td><span>Risoluzione dei problemi </span>dei tuoi hardware con un solo clic</td>
          </tr>
          <tr>
            <td><span>Lunghi tempi d’attesa </span>durante l’aggiornamento dei driver</td>
            <td>Aggiornamento dei tuoi driver <span>fino al 100% più veloce</span> con la versione PRO</td>
          </tr>

          <tr>
            <td><span>Video e giochi di bassa qualità </span>a causa di driver grafici inadatti</td>
            <td><span>Perfetta qualità video</span>,streaming ed esperienza di gioco con i migliori driver grafici</td>
          </tr>
          <tr>
            <td><span>Problemi di rete irrisolvibili </span>perché non puoi aggiornare i driver di rete senza una connessione internet</td>
            <td>Aggiornamento dei tuoi driver di rete senza una connessione internet con l’<span>Aggiornamento Driver Offline</span></td>
          </tr>
        </tbody>
      </table>
    </div>
  ...
  <div class="h-list">
    <div class="title">
      <h2>Driver Booster 8 PRO può fare molto di più rispetto alla tua versione precedente!</h2>
      <img src="<?php echo getStaticUrl('images/b-border.png')?>" alt="">
    </div>
    <div class="sw">
      ...
      <div class="cont">
          <ul>
            <li>
              ...
              <h4>Aggiornamento Driver Offline</h4>
              <p>Aggiorna i tuoi driver di rete anche senza una connessione internet</p>
            </li>
            <li>
              <img src="<?php echo getStaticUrl('images/icon2.png')?>" alt="">
              <h4>Scegli la priorità d’aggiornamento</h4>
              <p>Scegli se Driver Booster deve dare priorità ai driver più recenti o più stabili</p>
            </li>
            <li>
              <img src="<?php echo getStaticUrl('images/icon3.png')?>" alt="">
              <h4>Più veloce</h4>
              <p>Con un aggiornamento più veloce del 30% rispetto alla versione precedente risparmi ancora più tempo</p>
            </li>
            <li>
              <img src="<?php echo getStaticUrl('images/icon4.png')?>" alt="">
              <h4>Più sicuro</h4>
              <p>Con il backup dei driver migliorato non devi preoccuparti di alcun problema durante l'aggiornamento</p>
            </li>
  ...
  <div class="feature-tile">
    ...
    <div class="giftbox">
      ...
      <dl class="fl clearfix">
        ...
        <dd class="fl">
          <ul class="fr">
          <li>Aggiorna e installa in modo sicuro i software sul tuo PC, ottimizzandone le prestazioni in tempo in tempo reale </li>
          </ul>
        </dd>
      </dl>
      <dl class="fl clearfix">
  ...
  <div id="floatlayer" class="floatlayer">
    <div class="wrapper clearfix">
      ...
      <div class="text fl">
        <h3>RISPARMIA <b>154,79€</b></h3>
        <h2>Elimina facilmente tutti i problemi dei tuoi driver e del tuo PC!</h2>
      </div>
      <div class="price fr">
        <p><strong>19,99€</strong> <del>174,78€</del></p>
        <a class="buybtn" href="http://www.iobit.com/buy.php?product=it-db83pciuisupf1999&ref=it_db83pciuisupf1999purchasexmasxe2020<?php echo $refStr; ?>&aff=<?php echo $_GET['aff'] ?>&refs=it_purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase3pciuisupfxmasxe2020-it');">Approfittane ora</a>
      </div>
    </div>
  </div>
  <!-- floatlayer end -->
    ...
    <div class="container">
      ...
      <div class="content cf">
        ...
        <div class="text fl">
          ...
          <a class="buybtn" href="http://www.iobit.com/buy.php?product=it-db83pciuisupf1999&ref=it_db83pciuisupf1999purchasexmasxe2020<?php echo $refStr; ?>&aff=<?php echo $_GET['aff'] ?>&refs=it_purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase3pciuisupfxmasxe2020-it');">Получить сейчас</a>
        </div>
      </div>
    </div>
  </div>
