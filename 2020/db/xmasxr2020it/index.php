      ...
      <div class="clearfix">
        <div class="banlist ">
          ...
          <div class="price">
            ...
            <a class="buybtn" href="http://www.iobit.com/buy.php?product=it-db83pc2499&ref=it_db83pc2499purchasexmasxr2020<?php echo $refStr; ?>&aff=<?php echo $_GET['aff'] ?>&refs=it_purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase3pcxmasxr2020-it');">
            Acquista ora
            </a>
          </div>
          <ul class="txtlist">
        ...
        <div class="banlist big">
          ...
          <div class="price">
            ...
            <a class="buybtn" href="http://www.iobit.com/buy.php?product=it-db83pciuisupf1999&ref=it_db83pciuisupf1999purchasexmasxr2020<?php echo $refStr; ?>&aff=<?php echo $_GET['aff'] ?>&refs=it_purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase3pciuisupfxmasxr2020-it');">
              Approfittane ora
            </a>
          </div>
          <ul class="txtlist">
...
rari e obsoleti
  ...
  <div id="floatlayer" class="floatlayer">
    <div class="wrapper clearfix">
      ...
      <div class="price fr">
        <p><strong>19,99€</strong> <del>174,78€</del></p>
        <a class="buybtn" href="http://www.iobit.com/buy.php?product=it-db83pciuisupf1999&ref=it_db83pciuisupf1999purchasexmasxr2020<?php echo $refStr; ?>&aff=<?php echo $_GET['aff'] ?>&refs=it_purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase3pciuisupfxmasxr2020-it');">Approfittane ora</a>
      </div>
    </div>
  </div>
  <!-- floatlayer end -->
    ...
    <div class="container">
      ...
      <div class="content cf">
        ...
        <div class="text fl">
          ...
          <a class="buybtn" href="http://www.iobit.com/buy.php?product=it-db83pciuisupf1999&ref=it_db83pciuisupf1999purchasexmasxr2020<?php echo $refStr; ?>&aff=<?php echo $_GET['aff'] ?>&refs=it_purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase3pciuisupfxmasxr2020-it');">Получить сейчас</a>
        </div>
      </div>
    </div>
  </div>
