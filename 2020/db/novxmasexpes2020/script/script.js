...
var soldout = function () {
  ...
  $('.banner .cont .right dd.one').html('<span style="font-size:20px;">75%</span>&nbsp; <span style="font-size:16px;opacity: 1;">de descuento</span>')
  $('.soldout-none').hide()
  $('.soldout-block').show()
  ...
  $('.banner .cont .right dd.three p.t').html('<span>19<b>.99€</b></span> <del>74,85€</del>')
  $('.b-buy .cont .right p.t span').html('19<b>.99€</b>')
  $('.b-buy .cont .left .num').text('19,99€')
  $('.original').text('74,85€')
  $('.banner .cont .right').addClass('_soldout')
  $('.ga-button').each((i,v)=>{
    $(v).attr('href','https://www.iobit.com/buy.php?product=es-db83pc1999&ref=es_db83pc1999purchase2011exp'+refStr+'&refs=es_purchase_db').removeAttr('onclick').attr('onclick',"ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase3pc2011exp-es')")
  })
};
function sendGift() {
