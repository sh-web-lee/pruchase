...
function soldout() {
  ...
  $(".buybtn").attr({
    "href": 'https://www.iobit.com/buy.php?product=sv-db8preorder299&ref=sv_db8preorderofficialsoldout' + refStr + '&aff=' + aff + '&refs=sv_purchase_db&tw=-8',
    "onclick": "ga('send', 'event', 'db3pcbuy', 'buy', 'db8preorderofficial-sv');"
  });
...
function getReTime() {
  var packsNumTotal = cGet('svdbofficial_t');
  if (packsNumTotal > 1) {
