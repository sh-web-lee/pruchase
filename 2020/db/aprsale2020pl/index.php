...
if ($_GET['action'] == 'getPacks') {
  $date = $_GET['d'];
  $c_name = 'pldbaprsale_p' . $date;
  $c_name_t='pldbaprsale_t' . $date;
...
<head>
  ...
  <title>Specjalna promocja - nawet do 85% rabatu na Driver Booster PRO - IObit!</title>
...
<body>
  ...
  <div class="feature wrapper">
    <h2>Zwiększ wydajność komputera i gier z najnowszym<br> Driver Booster PRO</h2>
