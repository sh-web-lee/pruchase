...
function soldout() {
    ...
    $(".price strong").remove();
    $(".price span").html("<strong><b>19</b>,99€</strong><del>74,85€</del>");
    $(".floatlayer .numbox").html('Obtén el mejor actualizador de controladores con <strong>73% DTO.</strong>');
    $(".buybtn").attr({
        "href": 'https://www.iobit.com/buy.php?product=es-db8preorder1999&ref=es-db8preorderofficialsoldout' + refStr + '&aff=' + aff + '&refs=purchase_db&tw=-8',
        "onclick": "ga('send', 'event', 'db3pcbuy', 'buy', 'db8preorderofficial-es');"
    })
    $(".banner .buybtn").html("Renovar ahora");
}
...
function getReTime() {
    var packsNumTotal = cGet('esdbexp_t');
    if (packsNumTotal > 1) {
