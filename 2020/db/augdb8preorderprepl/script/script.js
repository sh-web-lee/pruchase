...
function soldout() {
	...
	$(".buybtn").attr({
		"href": 'https://www.iobit.com/buy.php?product=pl-db8preorder79&ref=pl_db8preorderpresoldout79' + refStr + '&aff=' + aff + '&refs=pl_purchase_db&tw=-8',
		"onclick": "ga('send', 'event', 'dbbuy', 'buy', 'db8preorderpresoldout-pl');"
	})
...
function getReTime() {
	var packsNumTotal = cGet('pldbpre_t');
	if (packsNumTotal > 1) {
