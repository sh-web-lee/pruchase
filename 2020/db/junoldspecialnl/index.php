...
if ($_GET['action'] == 'getPacks') {
  $date = $_GET['d'];
  $c_name = 'nldbspe_p' . $date;
  $c_name_t='nldbspe_t' . $date;
  $isInit=$_GET['isInit'];
...
<head>
  ...
  <title>Exclusief voor onze trouwste gebruikers: Driver Booster PRO voor een speciale prijs - IObit</title>
...
<div class="banner">
  <div class="wrapper">
    ...
    <div class="title clearfix">
      <div class="left fl"><img src="<?php echo getStaticUrl('images/db-box.png')?>" alt="Driver Booster PRO"/></div>
      <div class="right fr">
        <b class="only">EEN SPECIALE PRIJS</b>
        <h1>EXCLUSIEF VOOR U</h1>
        <h5>ALLEEN VOOR ONZE ALLERTROUWSTE GEBRUIKERS</h5>
    ...
    <div class="chart">
      ...
      <div class="chartbox big two"><span>Promotieprijs <b>€24,99</b></span></div>
      <div class="chartbox center three"><span>UW PRIJS <b class="change-price">€<big>19</big>,99 </b></span></div>
      <div class="chartbox big four"><span>Promotieprijs <b>€24,99</b></span></div>
    ...
    <div class="price clearfix">
      <!-- countdown -->
      <p class="countdown">
        Tijdelijke Aanbieding! Nog maar
      ...
      <div class="btnbox">
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=db8spin3pcnl&ref=nl_db83pcoldspecial1999purchase2006<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=nl_purchase_db"
           onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase2006-nl');">
          Activeer Nu <small>- €19,99</small>
        </a>
    ...
    <div class="container clearfix">
      <div class='special left'>
        <dl>
          ...
          <dd>
            <h3>Soepelere PC</h3>
            <p>Houd automatisch<br> 4.500.000 drivers up-to-date</p>
          </dd>
        </dl>
      </div>
...
<div id="floatlayer" class="floatlayer">
  ...
  <div class="wrapper clearfix">
    ...
    <!-- price -->
    <div class="price fl">
      <strong class="change-price">€19,99</strong> <del>€74,85</del>
      <p>1-jarig abonnement / 3 pc’s</p>
    </div>
    <a class="buybtn fr"
       href="https://www.iobit.com/buy.php?product=db8spin3pcnl&ref=nl_db83pcoldspecial1999purchase2006<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=nl_purchase_db"
...
<script>refStr="<?php echo $refStr;?>"; aff="<?php echo $_GET['aff']?>"</script>
