...
function soldout() {
  ...
  $(".floatlayer .numbox").html('Holen Sie sich den besten<br> Treiber-Updater mit <strong>70% Rabatt</strong>');
  $(".buybtn").attr({
    "href": 'https://www.iobit.com/buy.php?product=de-db8preorder2699&ref=de_db8preorderexpsoldout' + refStr + '&aff=' + aff + '&refs=de_purchase_db&tw=-8',
    "onclick": "ga('send', 'event', 'db3pcbuy', 'buy', 'db8preorderexp-de'); "
  });
...
function getReTime() {
  var packsNumTotal = cGet('dedbexp0819_t');
  if (packsNumTotal > 1) {
