...
<title>Saldi Estivi, sconti fino all'80% su IObit Driver Booster PRO – IObit</title>
...
<body>
  ...
  <div class="banner">
    <div class="wrapper">
      ...
      <h1 class="title">SALDI ESTIVI</h1>
      <h2>Più saldi che mai! Prendi 3 paghi 1 e risparmi 109€</h2>
      <div class="clearfix">
        <div class="offer">
          <div class="imgbox">
          ...
          <div class="price">
            ...
            <strong><big>24</big>,99€</strong> <del>59,85€</del>
            <p>
              <a class="buybtn gray"
                 href="https://www.iobit.com/buy.php?product=it-db71pc2499&ref=it_db71pc2499purchase2008<?php echo $refStr;?>&refs=it_purchase_db"
                 onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase1PC2008-it');">
                Acquista ora   
              </a>
            </p>
        ...
        <div class="offer big">
          <div class="imgbox">
            ...
            <b class="discount">-<big>80</big>%</b>
            <span class="db-price"></span>
          </div>
          <div class="price">
            <p class="name">1 anno / 3 PC + 2 REGALI PRO</p>
            <strong><big>25</big>,99€</strong> <del>134.83€</del>
            <p>
              <a class="buybtn"
                 href="https://www.iobit.com/buy.php?product=it-db73pciusd2599&ref=it_db73pciusd2599purchase2008<?php echo $refStr;?>&refs=it_purchase_db"
                 onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase3pc2008-it');">
                Acquista ora   
              </a>
            </p>
            <p>Licenza valida per versioni future</p>
          ...
          <div class="countbox clearfix">
            <span class="offerta">OFFERTA LIMITATA: </span>
  ...
  <div class="feature">
    <div class="wrapper">
      <h2>Perché scelgo Driver Booster PRO? </h2>
      <div class="feature-wrap">
        <div class="feature-tab fl">
          <dl class="one on">
            <dt>1. </dt>
            <dd>
              <h3>+3.500.000 Driver supportati</h3>
  ...
  <div class="intro">
    ...
    <div class="wrapper">
      <h2>
        Non perdere l’occasione di avere in regalo anche due programmi IObit PRO per un PC più pulito e per accedere velocemente ai tuoi file
      </h2>
      <div class="intro-wrap">
        ...
        <div class="clearfix">
          <div class="intro-screen two fl">
            <img class="top" src="<?php echo getStaticUrl('images/sd-screen01.png')?>" alt=""/>
            <img class="bottom" src="<?php echo getStaticUrl('images/sd-screen02.png')?>" alt=""/>
          </div>
          <div class="intro-list two fr">
            <h3>Ottimizzazione delle prestazioni del tuo PC</h3>
            <p>
              Ottimizza la tua esperienza di gioco con un motore ultra veloce che ti permette di accelerare il caricamento del gioco.
            </p>
            <p>
              Deframmentazione a velocità accelerata per un accesso ai dati più rapido, una migliore prestazione del disco rigido e un avvio del sistema più veloce.
            </p>
          </div>
        </div>
      </div>
      ...
      <table border="0" cellspacing="0" cellpadding="0" width="100%">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="text">Backup automatico di tutti i driver per il ripristino sicuro </td>
            <td class="space small"></td>
            <td class="pro"><i class="all-icons"></i></td>
            <td class="space"></td>
            <td class="free"><i class="all-icons line"></i></td>
  ...
  <div class="footbuy">
    <div class="wrapper clearfix">
      <h2>L’aggiornamento dei tuoi driver non va mai in vacanza ! </h2>
      <div class="imglist fl">
        ...
        <span class="db-discount">-80%</span>
      </div>
      ...
      <div class="price fr">
        <p><strong><big>25</big>,99€</strong> <del>134,83€</del></p>
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=it-db73pciusd2599&ref=it_db73pciusd2599purchase2008<?php echo $refStr;?>&refs=it_purchase_db"
           onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase3pc2008-it');">
          Acquista ora  
