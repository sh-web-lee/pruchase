...
function soldout() {
    ...
    $(".floatlayer .numbox").html('Upgrade to the NO.1 Driver Updater with <strong>70% OFF</strong>');
    $(".buybtn").attr({
        "href": 'https://www.iobit.com/buy.php?product=db8preorder2295&ref=en-db8preorderpresoldout' + refStr + '&aff=' + aff + '&refs=purchase_db&tw=-8',
        "onclick": "ga('send', 'event', 'db3pcbuy', 'buy', 'db8preorderpre');"
    })
    $(".banner .buybtn").html("Upgrade Now – 70% OFF");
}
...
//
function getReTime() {
    var packsNumTotal = cGet('endb8preorderpre_t');
    if (packsNumTotal > 1) {
