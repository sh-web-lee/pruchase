...
function soldout() {
    ...
    $(".buybtn").attr({
        "href": 'https://www.iobit.com/buy.php?product=fr-db8preorder2499&ref=fr_db8preorderofficial2499' + refStr + '&aff=' + aff + '&refs=fr_purchase_db&tw=-8',
        "onclick": "ga('send', 'event',  'dbbuy', 'buy', 'db8preorderofficial2499-fr');"
    })
...
function getReTime() {
    var packsNumTotal = cGet('frdb8preorderofficial_t');
    if (packsNumTotal > 1) {
