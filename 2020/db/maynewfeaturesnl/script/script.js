...
function after20seconds() {
  ...
  $(".banner .title").html("Onze Speciale Kortingsactie is Begonnen <span>Wees er snel bij!</span>");
...
function rollBack() {
  ...
  $(".banner").removeClass("after");
  $(".banner .price p").not(".people").addClass("hidden");
  $(".footbuy").removeClass("after");
...
function packsInit() {
  var date = new Date();
  var cName = "nldbmay" + date.getDate();
