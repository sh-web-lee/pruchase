  ...
  <div class="wrapper clearfix">
    ...
    <div class="content">
      ...
      <div class="offer small">
        ...
        <!-- buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=it-db73pc2699&ref=it_db73pc2699purchase2003<?php echo $refStr;?>&refs=it_purchase_db"
           onclick="ga( 'send', 'event', 'dbbuy', 'buy', 'db3pc2699purchase2003-it');">
          ACQUISTA ORA
        </a>
      </div>
      ...
      <div class="offer large">
        ...
        <!-- buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=it-db73pciusdpf2599&ref=it_db73pciusdpf2599purchase2003<?php echo $refStr;?>&refs=it_purchase_db"
           onclick="ga( 'send', 'event', 'dbbuy', 'buy', 'db3pciusdpf2599purchase2003-it');">
          ACQUISTA ORA
        </a>
        <!-- packs -->
...
<div class="bottombuy">
  <div class="wrapper clearfix">
    ...
    <!-- box -->
    <div class="box">
      <img class="active" src="<?php echo getStaticUrl('images/bottombuy-bundle.png')?>" alt="Driver Booster PRO+Smart Defrag PRO+Protected Folder+IObit Uninstaller PRO">
