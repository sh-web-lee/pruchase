...
function soldout() {
	...
	$(".buybtn").attr({
		"href": 'https://www.iobit.com/buy.php?product=it-db8preorder2295&ref=it_db8preorderpresoldout2295' + refStr + '&aff=' + aff + '&refs=it_purchase_db&tw=-8',
		"onclick": "ga('send', 'event', 'dbbuy', 'buy', 'db8preorderpresoldout-it');"
	})
...
function getReTime() {
	var packsNumTotal = cGet('itdbpre_t');
	if (packsNumTotal > 1) {
