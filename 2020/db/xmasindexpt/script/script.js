...
$(function () {
  ...
  $('.footerbuy li').mouseover(function () {
    ...
    if (_num == 0) {
      $('#hrd').attr(
        'href',
        'https://www.iobit.com/buy.php?product=pt-db81pc6999&ref=pt_db81pcpurchase2011'+ refStr +'&refs=pt_purchase_db  '
      )
    } else {
      $('#hrd').attr(
        'href',
        'https://www.iobit.com/buy.php?product=pt-db83pcisu7999&ref=pt_db83pcisupurchase2011'+ refStr +'&refs=pt_purchase_db'
      )
    }
