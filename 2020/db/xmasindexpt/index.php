...
<head>
  ...
  <title>Adquira Driver Booster 8 Pro com 75% de desconto e leve um super brinde para manter seus programas também atualizados. Oferta Especial de Natal da IObit. </title>
...
<body>
  ...
  <div class="banner">
    <div class="wrapper">
      ...
      <div class="title">
        <h2>ADQUIRA O DRIVER BOOSTER 8 PRO COM 75% OFF E LEVE UM BRINDE DE NATAL</h2>
      ...
      <div class="clearfix">
        <div class="offer left" style="margin-left: 230px;">
          ...
          <div class="price">
            ...
            <a class="buybtn" href="https://www.iobit.com/buy.php?product=pt-db81pc6999&ref=pt_db81pcpurchase2011<?= $refStr; ?>&refs=pt_purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase2011-pt');">
              COMPRAR AGORA
            </a>
          </div>
        </div>
        <div class="offer bigbox">
          ...
          <div class="price">
            <p><strong>R$ 79,99 </strong> <del>R$ 399,89</del></p>
            <p><b>6x de</b> R$ 13,33</p>
            <p class="last"><span>3 PCs </span> / 1 Ano</p>
            <a class="buybtn" href="https://www.iobit.com/buy.php?product=pt-db83pcisu7999&ref=pt_db83pcisupurchase2011<?= $refStr; ?>&refs=pt_purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbxmas2011-pl');">
              COMPRAR AGORA
            </a>
          </div>
        </div>
  ...
  <div class="footerbuy">
    <div class="wrapper">
      ...
      <div class="clearfix">
        ...
        <div class="price fr">
          <p><strong>R$ 79,99 </strong> <del>R$ 399,89</del></p>
          <a class="buybtn" href="https://www.iobit.com/buy.php?product=pt-db83pcisu7999&ref=pt_db83pcisupurchase2011<?= $refStr; ?>&refs=pt_purchase_db  " onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase2011-pt');" id="hrd">
            COMPRAR AGORA
          </a>
        </div>
      </div>
