...
<div class="banner">
  <div class="wrapper">
    ...
    <div class="box">
      ...
      <a href="https://www.iobit.com/buy.php?product=mx-db71pc459&ref=es_db71pcpurchase2002mxes<?php echo $refStr;?>&refs=es_purchase_db" 
         onclick="ga('send', 'event', 'ascubuy', 'buy', 'dbpurchase1pc2002mxes-es')" class="buybtn border">Comprar ahora</a>
    </div>
    <div class="box gift-box">
      ...
      <a href="https://www.iobit.com/buy.php?product=mx-db73pcpfsd509&ref=es_db73pcpfsd2002mxes<?php echo $refStr;?>&refs=es_purchase_db" 
         onclick="ga('send', 'event', 'ascubuy', 'buy', 'dbpurchase3pcbundle2002mxes-es')" class="buybtn center">Comprar ahora</a>
    ...
    <div class="box three-box">
      ...
      <a href="https://www.iobit.com/buy.php?product=mx-db73pc509&ref=es_db73pc2002mxes<?php echo $refStr;?>&refs=es_purchase_db" 
         onclick="ga('send', 'event', 'ascubuy', 'buy', 'dbpurchase3pc2002mxes-es')"  class="buybtn border">Comprar ahora</a>
    </div>
    </div>
  </div>
<!-- banner end -->
    ...
    <tfoot>
      <tr>
        ...
        <th class="itema">
          ...
          <a href="https://www.iobit.com/buy.php?product=mx-db73pcpfsd509&ref=es_db73pcpfsd2002mxes<?php echo $refStr;?>&refs=es_purchase_db" 
             onclick="ga('send', 'event', 'ascubuy', 'buy', 'dbpurchase3pcbundle2002mxes-es')"
             class="buybtn center">
            Comprar ahora
          </a>
...
<div class="bottom-buy">
 <div class="wrapper">
   ...
   <dl>
     ...
     <dd><a href="https://www.iobit.com/buy.php?product=mx-db73pcpfsd509&ref=es_db73pcpfsd2002mxes<?php echo $refStr;?>&refs=es_purchase_db" 
            onclick="ga('send', 'event', 'ascubuy', 'buy', 'dbpurchase3pcbundle2002mxes-es')" class="buybtn center">Comprar ahora</a></dd>
   </dl>
 </div>
</div>
<!--  footer start-->
