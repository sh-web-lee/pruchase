...
<head>
  ...
  <title>Hasta 86% de descuento y regalos gratis en Driver Booster 8 PRO - IObit  </title>
...
<div class="banner">
  <div class="wrapper">
    ...
    <div class="box">
      ...
      <a href="https://www.iobit.com/buy.php?product=es-db81pc1799&ref=es_db81pcpurchase2002<?php echo $refStr;?>&refs=es_purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase1pc2002-es')" class="buybtn border">Comprar ahora</a>
    </div>
    <div class="box gift-box">
      ...
      <a href="https://www.iobit.com/buy.php?product=es-db83pcpfsd1999&ref=es_db83pcpfsd2002<?php echo $refStr;?>&refs=es_purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase3pcbundle2002-es')" class="buybtn center">Comprar ahora</a>
    ...
    <div class="box three-box">
      ...
      <a href="https://www.iobit.com/buy.php?product=es-db83pc1999&ref=es_db83pc2002<?php echo $refStr;?>&refs=es_purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase3pc2002-es')"  class="buybtn border">Comprar ahora</a>
    </div>
    </div>
  </div>
<!-- banner end -->
    ...
    <tfoot>
      <tr>
        ...
        <th class="itema">
          ...
          <a href="https://www.iobit.com/buy.php?product=es-db83pcpfsd1999&ref=es_db83pcpfsd2002<?php echo $refStr;?>&refs=es_purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase3pcbundle2002-es')"
             class="buybtn center">
            Comprar ahora
          </a>
...
<div class="bottom-buy">
 <div class="wrapper">
   ...
   <dl>
     ...
     <dd><a href="https://www.iobit.com/buy.php?product=es-db83pcpfsd1999&ref=es_db83pcpfsd2002<?php echo $refStr;?>&refs=es_purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase3pcbundle2002-es')" class="buybtn center">Comprar ahora</a></dd>
   </dl>
 </div>
</div>
<!--  footer start-->
