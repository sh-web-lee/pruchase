...
// header("Location:return.php?".$param);exit();
...
<head>
  ...
  e=1" >
  <title>Actualiza a Driver Booster PRO con un 75% de descuento para mantener todos tus controladores actualizados</title>
  ...
  <div class="wrapper">
    ...
    <div class="content">
      <div class="box" data-name="pc3">
        ...
        <a href="https://www.iobit.com/buy.php?product=es-db73pc999&ref=es_db73months999return<?php echo $refStr;?>&refs=es_purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchasereturn3m-es')" class="buybtn border">COMPRAR AHORA</a>
        <ul>
       ...
       <div class="box twelve" data-name="pc12">
        <h3>12 meses</h3>
        <p><strong><b>1</b>,58€</strong> / mes</p>
        <a href="https://www.iobit.com/buy.php?product=es-db73pc1899&ref=es_db712months1899return<?php echo $refStr;?>&refs=es_purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchasereturn12m-es')" class="buybtn yellow">COMPRAR AHORA</a>
        <ul>
          <li>12 meses / 3 PCs  <strong>74,85€  </strong></li>
          <li class="border">Descuento  <strong>-75%  </strong></li>
          <li class="border">Total  <strong class="red">18,99€ </strong></li>
          <li> <span>Ahorra 55,86€ </span></li>
        </ul>
      </div>
      <div class="box sixmouth" data-name="pc6">
        <h3>6 meses</h3>
        <p><strong><b>2</b>,50€</strong> / mes</p>
        <a href="https://www.iobit.com/buy.php?product=es-db73pc1499&ref=es_db76months1499return<?php echo $refStr;?>&refs=es_purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchasereturn6m-es')" class="buybtn border">COMPRAR AHORA</a>
        <ul>
          <li>6 meses / 3 PCs <strong>39,99€</strong></li>
          <li class="border">Descuento  <strong>-60%  </strong></li>
          <li class="border">Total  <strong class="red">14,99€ </strong></li>
          <li> <span>Ahorra 25€ </span></li>
        </ul>
      </div>
    </div>   
  </div>
  ...
  <div class="wrapper">
    ...
    <ul>
      <li class="active twelve" data-name="pc12">
        ...
        <strong>Mejor Precio: 18,99€</strong>
      </li>
      <li class="sixmouth" data-name="pc6">
         <span>6 meses, 3 PCs</span>
         <strong>Precio Reducido: 14,99€</strong>
      </li>
      <li data-name="pc3">
    ...
    <dl class="price-content">
      <dt>
        Sólo <strong><b>1</b>,58€</strong> por mes
      </dt>
      <dd>
        <a class="buybtn yellow"
           href="https://www.iobit.com/buy.php?product=es-db73pc1899&ref=es_db712months1899return<?php echo $refStr;?>&refs=es_purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchasereturn12m-es')">
