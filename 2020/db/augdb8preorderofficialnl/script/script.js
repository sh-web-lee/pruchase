...
function soldout() {
	...
	$(".buybtn").attr({
		"href": 'https://www.iobit.com/buy.php?product=nl-db8preorder2499&ref=nl_db8preorderofficial2499' + refStr + '&aff=' + aff + '&refs=nl_purchase_db&tw=-8',
		"onclick": "ga('send', 'event', 'dbbuy', 'buy', 'db8preorderofficialsoldout-nl');"
	})
}
function seview() {
...
function getReTime() {
	var packsNumTotal = cGet('nldbofficial_t');
	if (packsNumTotal > 1) {
