      ...
      <div class="clearfix">
        <div class="offer left">
          ...
          <div class="price">
            ...
            <a class="buybtn"
               href="https://www.iobit.com/buy.php?product=nl-db83pc2499&ref=nl_db83pc2499purchase2011<?php echo $refStr;?>&refs=nl_purchase_db"
               onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase2011-nl')">
               KOOP NU
            </a>
          </div>
        </div>
        <div class="offer bigbox">
          ...
          <div class="price">
            <p><strong>€24,99</strong> <del>€138,70</del></p>
            <a class="buybtn green"
               href="https://www.iobit.com/buy.php?product=nl-db83pciupf2499&ref=nl_db83pciupf2499purchase2011<?php echo $refStr;?>&refs=nl_purchase_db"
               onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase2011-nl')">
               PROFITEER NU	
            </a>
          </div>
        ...
        <div class="offer right">
          ...
          <div class="price">
            ...
            <a class="buybtn"
               href="https://www.iobit.com/buy.php?product=nl-db83pciupf2899&ref=nl_db83pciupf2899purchase2011<?php echo $refStr;?>&refs=nl_purchase_db"
               onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase2011-nl')">
               KOOP NU
            </a>
          </div>
...
<div class="payment-bg">
  ...
  <div class="giftbox">
    <div class="wrapper">
      ...
      <a href="https://www.iobit.com/buy.php?product=nl-db83pciupf2499&ref=nl_db83pciupf2499purchase2011<?php echo $refStr;?>&refs=nl_purchase_db"
         onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase2011-nl')" class="buybtn green">PROFITEER NU</a>
    </div>
  </div>
  <!-- giftbox end -->
