...
<div class="banner">
  <div class="wrapper">
    ...
    <h2 class="subtitle">Jusqu’à -85% ! Achetez-en 1 et obtenez-en 3 GRATUITS ! Dernières heures, derniers petits prix !</h2>
    <ul class="content clearfix">
      <li id="db-1pc" class="on-left">
        <img class="off" src="<?php echo getStaticUrl('images/offer15.png')?>" alt="">
        <img class="box" src="<?php echo getStaticUrl('images/db-one-box.png')?>" alt="">
        <div class="price">
          <p class="name">1 an, 1 PC</p>
          <p><strong><big>22</big>,99€</strong> <del>29,99€</del></p>
          <a class="buybtn gray"
             href="https://www.iobit.com/buy.php?product=fr-db81pc2299&ref=fr_db81pc2299indexpurchase2007<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_db"
             onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase2007b-fr');">
            J’EN PROFITE VITE 
          </a>
        </div>
      </li>
      <li id="db-pf-sd" class="on-middle">
        <div class="countdown">
          <i class="all-icons"></i> Plus que <b>00</b>H : <b>00</b>m : <b>00</b>s : <b>00</b>ms
        </div>
        ...
        <div class="price">
          ...
          <a class="buybtn red"
             href="https://www.iobit.com/buy.php?product=fr-db8iusdpf2499&ref=fr_db8sdpfiu2499indexpurchase2007<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_db"
             onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase2007-fr');">
            J’EN PROFITE VITE 
          </a>
      ...
      <li id="db-3pc" class="on-right">
        ...
        <div class="price">
          <p class="name">1 an, 3 PC</p>
          <p><strong><big>24</big>,99€</strong> <del>74,85€</del></p>
          <a class="buybtn gray"
             href="https://www.iobit.com/buy.php?product=fr-db83pc2499&ref=fr_db83pc2499indexpurchase2007<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_db"
             onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase2007a-fr');">
            J’EN PROFITE VITE 
          </a>
        </div>
      </li>
...
<div class="pop">
  <h2>Félicitations ! Profitez d’une réduction supplémentaire sur le prix régulier !</h2>
  <div class="secondbox">Les offres se terminent dans <b class="second"><em>6</em><em>0</em></b>s</div>
  <ul class="clearfix">
    <li>
      <img src="<?php echo getStaticUrl('images/db-one-box.png')?>" alt=""/>
      <div class="price">
        <p><strong><big>22</big>,99€</strong> au lieu de <del>24,99€</del></p>
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=fr-db71pc2299&ref=fr_db71pcpop2299indexpurchase2007<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_db"
           onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase2007d-fr');">
          Profitez de l’offre
        </a>
        <p class="prix">Prix régulier 24,99€</p>
        <p class="prix last">Prix original 29,99€</p>
      </div>
    </li>
    <li>
      <img src="<?php echo getStaticUrl('images/db-three-box.png')?>" alt=""/>
      <div class="price">
        <p><strong><big>24</big>,99€</strong> au lieu de <del>26,99€</del></p>
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=fr-db73pc2499&ref=fr_db73pcpop2499indexpurchase2007<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_db"
           onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase2007c-fr');">
          Profitez de l’offre
        </a>
        <p class="prix">Prix régulier 26,99€ </p>
        <p class="prix last">Prix original 74,85€</p>
      </div>
    </li>
  </ul>
  <em class="ou">OU</em>
