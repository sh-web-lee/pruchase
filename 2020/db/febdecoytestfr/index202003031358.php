...
<div class="banner">
  <div class="wrapper">
    ...
    <h2 class="subtitle">
      Dernière heures, derniers petits prix ! Ne vous en manquez pas !
    </h2>
    <!-- banner-content -->
    <ul class="content">
      <!-- Left BD-1PC -->
      <li id="db-1pc" class="on-left">
        ...
        <!-- buybtn -->
        <a class="buybtn cart"
           href="https://www.iobit.com/buy.php?product=fr-db71y1pc2499&ref=fr_db71y1pc2499purchase2002<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_db"
      ...
      <li id="db-pf-sd" class="on-middle">
        ...
        <!-- buybtn -->
        <a class="buybtn cart"
           href="https://www.iobit.com/buy.php?product=fr-db7iusdpf2499&ref=fr_db7sdpfiu2499purchase2002<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_db"
           onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase2002-fr')">
          <span>VITE, J’EN PROFITE</span>
        </a>
        <!-- attention -->
      ...
      <li id="db-3pc" class="on-right">
        ...
        <!-- buybtn -->
        <a class="buybtn cart"
           href="https://www.iobit.com/buy.php?product=fr-db73pc2699&ref=fr_db71y3pc2699purchase2002<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_db"
           onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase2002-fr')">
          <span>VITE, J’EN PROFITE</span>
        </a>
      </li>
