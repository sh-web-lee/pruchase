...
if (!empty($_GET['action']) && ($_GET['action'] == 'getPacks')) {
  $date = $_GET['d'];
  $cName_t = 'xmasxrde2020_t' . $date;
  $cName_p = 'xmasxrde2020_p' . $date;
  $maxNum = rand(70, 90);
  $minNum = 3;
...
<body>
      ...
      <div class="clearfix">
        <div class="banlist big">
          ...
          <div class="price">
            ...
            <a class="buybtn" href="https://www.iobit.com/buy.php?product=de-db83pcsdpfisu2299&ref=de_db83pcsdpfisu2012xmasxr-i-u-t-e<?= $refStr; ?>&refs=de_purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'db3pcbundle2012xmasxr-de')">
              Jetzt kaufen
            </a>
          </div>
          <ul class="txtlist">
        ...
        <div class="banlist">
          ...
          <div class="price">
            ...
            <a class="buybtn" href="https://www.iobit.com/buy.php?product=de-db81pc2499&ref=de_db81pc2012xmasxr-i-u-t-e<?= $refStr; ?>&refs=de_purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'db1pcsingle2012xmasxr-de')  ">
              Jetzt kaufen
            </a>
          </div>
          <ul class="txtlist">
  ...
  <div id="floatlayer" class="floatlayer">
    <div class="wrapper clearfix">
      ...
      <div class="price fr">
        <p><strong>22,99€</strong> <del>187,92 €</del></p>
        <a class="buybtn" href="https://www.iobit.com/buy.php?product=de-db83pcsdpfisu2299&ref=de_db83pcsdpfisu2012xmasxr-i-u-t-e<?= $refStr; ?>&refs=de_purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'db3pcbundle2012xmasxr-de') ">Jetzt kaufen</a>
      </div>
    </div>
  </div>
  <!-- floatlayer end -->
