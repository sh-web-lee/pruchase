...
<div class="banner">
  <div class="wrapper">
    ...
    <h2>Take <span class="percent">74</span>% OFF + Free Gift Pack</h2>
    ...
    <div class="message">
      ...
      <dl>
        <dt><a href="https://www.iobit.com/buy.php?product=ascu13iusdpf1299&ref=en-ascu3pciusdpfcd6<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_ascu" onclick="ga('send', 'event', 'ascubuy', 'buy', 'ascupurchase-1299');" class="buybtn change-buybtn">Activate Now</a></dt>
...
<div class="gift-message">
  ...
  <div class="wrapper clearfix">
    ...
    <a href="https://www.iobit.com/buy.php?product=ascu13iusdpf1299&ref=en-ascu3pciusdpfcd6<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_ascu" onclick="ga('send', 'event', 'ascubuy', 'buy', 'ascupurchase-1299');" class="buybtn change-buybtn">Get It Now</a>
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%">
      ...
      <tfoot>
        ...
        <th class="itemb">
          ...
          <a href="https://www.iobit.com/buy.php?product=ascu13iusdpf1299&ref=en-ascu3pciusdpfcd6<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_ascu" onclick="ga('send', 'event', 'ascubuy', 'buy', 'ascupurchase-1299');" class="buybtn change-buybtn">Activate Now</a>
        </th>
      </tfoot>
    </table>
  </div>
...
<div class="floatlayer">
  <div class="wrapper clearfix">
    ...
    <div class="price">
      <p></p>
      <a class="buybtn change-buybtn" href="https://www.iobit.com/buy.php?product=ascu13iusdpf1299&ref=en-ascu3pciusdpfcd6<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_ascu" onclick="ga('send', 'event', 'ascubuy', 'buy', 'ascupurchase-1299');">
        Get It Now
      </a>
    </div>
  </div>  
