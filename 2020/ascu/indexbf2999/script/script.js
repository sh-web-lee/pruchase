  ...
  $(function() {
    ...
    if (paramTo != 'buyascu') {
      var maskStatus = cGet('enascublack2020_s');
      if (maskStatus != -1) {
  ...
  function getReTime() {
    var packsNumTotal = cGet('enascublack2020_t');
    if (packsNumTotal > 1) {
  ...
  function timeInit() {
    if (cGet('enascublack2020_s') == -1) {
      ...
      var date = new Date();
      var cName = "enascublack2020_c";
      var arr = cGet("enascublack2020_c");
