  ...
  <div class="wrapper clearfix">
    ...
    <div class="banlist">
      ...
      <div class="price">
        ...
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=es-ascu133pc2295&ref=es_ascu133pc2295purchase2005<?php echo $refStr;?>&refs=es_purchase_ascu"
           onclick="ga('send', 'event', 'ascubuy', 'buy', 'ascu3pcpurchase2005-es');">
          COMPRAR AHORA
        </a>
      </div>
      <ul class="txtlist">
    ...
    <div class="banlist big">
      ...
      <div class="price">
        <p><strong><big>22</big>,95€</strong> <del>119,93€</del></p>
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=es-ascu133pcsdpf2295&ref=es_ascu133pcpfsd2295purchase2005<?php echo $refStr;?>&refs=es_purchase_ascu"
           onclick="ga('send', 'event', 'ascubuy', 'buy', 'ascubundlepurchase2005-es');">
          COMPRAR AHORA
        </a>
      </div>
      <ul class="txtlist">
        <li><i class="all-icons"></i> 96,98€ ahorrado</li>
        <li><i class="all-icons"></i> Advanced SystemCare Ultimate  <del>49,99€</del></li>
...
<div id="floatlayer" class="floatlayer">
  <div class="wrapper clearfix">
    <div class="left fl">
      <img src="<?php echo getStaticUrl('images/asc-gift-box.png')?>" alt="Advanced SystemCare Ultimate 12 PRO"/>
      <!--      <span class="cap"></span>-->
    </div>
