...
<body>
      ...
      <div class="clearfix">
        <div class="offer big">
          ...
          <div class="price">
            ...
            <a class="buybtn" href="https://www.iobit.com/buy.php?product=es-ascu143pcsdpfiu2295&ref=es_ascu143pcsdpfiu2295purchase2101-i-u-t-e<?php echo $refStr; ?>&refs=es_purchase_ascu" onclick="ga('send', 'event', 'ascubuy', 'buy', 'ascu3pcsdpfiupurchase2101-es')">
              Comprar Ahora
            </a>
        ...
        <div class="offer">
          ...
          <div class="price">
            ...
            <a class="buybtn empty" href="https://www.iobit.com/buy.php?product=es-ascu143pc2295&ref=es_ascu143pc2295purchase2101<?php echo $refStr; ?>&refs=es_purchase_ascu" onclick="ga('send', 'event', 'ascubuy', 'buy', 'ascu3pcpurchase2101-es')">
              Comprar Ahora
            </a>
            <p>licencia válida para futuras versiones</p>
          </div>
  ...
  <div class="footbuy">
    ...
    <div class="wrapper clearfix">
      ...
      <a class="buybtn fr" href="https://www.iobit.com/buy.php?product=es-ascu143pcsdpfiu2295&ref=es_ascu143pcsdpfiu2295purchase2101-i-u-t-e<?php echo $refStr; ?>&refs=es_purchase_ascu" onclick="ga('send', 'event', 'ascubuy', 'buy', 'ascu3pcsdpfiupurchase2101-es')">
        Comprar Ahora
      </a>
    </div>
  </div>
