...
function soldOut() {
  ...
  $(".footbuy .price").html("<strong>22.95<small>€</small></strong> <del>49,99€</del>");
...
var countdown = function countdown(_countdown) {
  getCycleCountdown();
  $(_countdown).eq(0).html(i).end().eq(1).html(s).end().eq(2).html(mi).end();
  if (d != 0 || h != 0 || i != 0 || s != 0 || mi != 0) setTimeout("countdown('" + _countdown + "')", 100);else soldOut();
};
