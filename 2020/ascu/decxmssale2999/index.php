...
$discountListArr = array(
  // 折扣比例、价格、购买链接标签
    '6m' => array('80', '$9.99', 'ascu13iusdpf999', '-$40', 'en-ascu13iusdpf999'.$refStr, 'ascu13999', 'en-ascu13soldout999'.$refStr), // 到期大于6个月 pro2
    '6' => array('74', '$12.99', 'ascu13iusdpf1299', '-$37', 'en-ascu13iusdpf1299'.$refStr, 'ascu131299', 'en-ascu13soldout1299'.$refStr), // 到期小于6个月 pro1
    'default' => array('40', '$29.99', 'ascu13iusdpf', '-$20','en-ascu13iusdpf2999'.$refStr,'ascu13','en-ascu13soldout2999'.$refStr),
    'title' => array(
        'um10trial' => array(
...
<div class="banner">
  <div class="wrapper">
    ...
    <div class="message">
      ...
      <dl>
        <dt><a href="https://www.iobit.com/buy.php?product=ascu13iusdpf&ref=en-ascu3pciusdpf<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_ascu" onclick="ga('send', 'event', 'ascubundlebuy', 'buy', 'ascupurchase-201902');" class="buybtn change-buybtn">Activate Now</a></dt>
...
<div class="gift-message">
  ...
  <div class="wrapper clearfix">
    ...
    <a href="https://www.iobit.com/buy.php?product=ascu13iusdpf&ref=en-ascu3pciusdpf<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_ascu" onclick="ga('send', 'event', 'ascubundlebuy', 'buy', 'ascupurchase-201902');" class="buybtn change-buybtn">Get It Now</a>
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%">
      ...
      <tfoot>
        ...
        <th class="itemb">
          ...
          <a href="https://www.iobit.com/buy.php?product=ascu13iusdpf&ref=en-ascu3pciusdpf<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_ascu" onclick="ga('send', 'event', 'ascubundlebuy', 'buy', 'ascupurchase-201902');" class="buybtn change-buybtn">Activate Now</a>
        </th>
      </tfoot>
    </table>
  </div>
...
<div class="floatlayer">
  <div class="wrapper clearfix">
    ...
    <div class="price">
      <p></p>
      <a class="buybtn change-buybtn" href="https://www.iobit.com/buy.php?product=ascu13iusdpf&ref=en-ascu3pciusdpf<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_ascu" onclick="ga('send', 'event', 'ascubundlebuy', 'buy', 'ascupurchase-201902');">
        Get It Now
      </a>
    </div>
  </div>  
...
<div class="congrats-pop hide">
  ...
  <div class="message number">
    ...
    <a href="https://www.iobit.com/buy.php?product=ascu13iusdpf2699&ref=en-ascu3pciusdpf2699pop<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_ascu" onclick="ga('send', 'event', 'ascupopbuy', 'buy', 'ascupurchase-201902');" class="buybtn">Get It Now</a>
  </div>
</div>
<div class='popout'><p>ASCU v13 will recognize ASCU v12 license key as <strong>valid for ASCU v13.</strong></p></div>
<?php if(explode('.',$_GET['ver'])[0] >= '14'):?>
<div class="pop-rc on">
  <p>Note: The license code of Version 13 can be used to activate Advanced SystemCare Ultimate 14.</p>
  <i class="pop-rc-close">X</i>
</div>
<?php endif;?>
