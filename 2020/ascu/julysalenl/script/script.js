...
function soldOut() {
  ...
  $("#botcount").remove();
  $(".buybtn").attr("href", 'https://www.iobit.com/buy.php?product=nl-ascu143pc2999&ref=nl_au14purchase2007&' + refStr + 'aff=&refs=nl_purchase_ascu&tw=' + tw);
}
// soldOut();
...
function timeInit() {
  var date = new Date();
  var cName = "julysalenl0731" + date.getDate();
