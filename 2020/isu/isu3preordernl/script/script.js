...
function soldOut() {
	...
	$(".banner .right-message .number").html("De 60% korting is helaas uitverkocht. <br>Pak toch nog 50% Korting!")
	$(".floatlayer .number").html("Pak Nu Uw 50% Korting!");
	$(".price span").html("<strong>€<b>14</b>,99</strong> <del> €29,99</del>")
	$(".buybtn").attr({
		"href": 'https://www.iobit.com/buy.php?product=nl-isu3preorder1499&ref=nl_isu3preorder1499' + refStr + '&aff=' + aff + '&refs=nl_purchase_isu&tw=' + tw,
		"onclick": "ga('send', 'event', 'isubuy', 'buy', 'isu3preordersoldout-nl');"
	});
}
// soldOut();
