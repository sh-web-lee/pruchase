...
function soldOut() {
  ...
  $(".buybtn").attr({
    "href": 'https://www.iobit.com/buy.php?product=isu3preorder3pc1297&ref=en-isu3preordersoldoutrc' + refStr + '&aff=' + aff + '&refs=purchase_isu&tw=' + tw,
    "onclick": "ga('send', 'event', 'isusoldbuyrc', 'buy', 'isu3preorderrc');"
  });
}
...
$(window).on('scroll', function() {
  ...
  if ($(window).scrollTop() > $('.intro dl').eq(4).offset().top) {
    //feature
    $('.feature table tr').addClass("on");
  }
});
