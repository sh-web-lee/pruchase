...
function getCycleCountdown() {
  if (MApp(2.2).cookie.get('novxmasnl2020')) {
    dt = MApp(2.2).cookie.get('novxmasnl2020');
  } else {
    var date = new Date();
    dt = date.setSeconds(date.getSeconds() + 505);
    setCookie('novxmasnl2020', dt, 1);
...
$(function() {
  ...
  $(".feature .left-message>ul li").hover(function() {
    ...
    $(".feature .screenshots>ul").stop().animate({
      "marginLeft": featureIndex * (-556)
    }, 500);
