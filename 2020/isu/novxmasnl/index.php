...
<head>
  ...
  <title>80% Kerstkorting op IObit Software Updater PRO - IObit</title>
...
<div class="banner">
  <div class="wrapper">
    ...
    <h2>Claim nu uw Gratis Kerstcadeau</h2>
    <!-- container -->
    <div class="container clearfix">
      ...
      <div class="message small fl">
        ...
        <!-- buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=nl-isu31y3pc1499&ref=nl_isu31y3pc1499purchase2011<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=nl_purchase_isu"
           onclick="ga('send', 'event', 'isubuy', 'buy', 'isupurchase2011-nl');"
           target="_blank">
          ACTIVEER NU!
        </a>
      </div>
      ...
      <div class="message large fr">
        <!-- tip -->
        <p class="tip">Speciaal Kerstpakket</p>
        <!-- box -->
        <span class="box">IObit Software Updater PRO+Protected Folder</span>
        <!-- price -->
        <p class="price"><big>€12</big>,99 <del>€69,94</del></p>
        <!-- buybtn -->
        <a class="buybtn large"
           href="https://www.iobit.com/buy.php?product=nl-isu33pcpf1299&ref=nl_isu33pcpf1299purchase2011<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=nl_purchase_isu"
           onclick="ga('send', 'event', 'isubuy', 'buy', 'isupurchase2011-nl');"
           target="_blank">
          ACTIVEER NU!
        </a>
