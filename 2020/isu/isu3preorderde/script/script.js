...
function soldOut() {
	...
	$(".banner .right-message .number").html("Oops! 0€ Vorverkauf ist jetzt unverfügbar. <br> Trotzdem können Sie den 50% Rabatt genießen.");
	$(".floatlayer .number").html("Verpassen Sie nicht den 50% Rabatt");
	$(".price span").html("<strong><b>14</b>,99€</strong> <del> 29,99€</del>");
	$(".buybtn").attr({
		"href": 'https://www.iobit.com/buy.php?product=de-isu3preorder1499&ref=de_isu3soldpreorder' + refStr + '&aff=' + aff + '&refs=de_purchase_isu&tw=' + tw,
		"onclick": "ga('send', 'event', 'isubuy', 'buy', 'isu3preorder1499-de');"
	});
}
