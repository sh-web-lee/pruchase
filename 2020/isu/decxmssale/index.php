	...
	<div class="banner">
		<div class="wrapper">
          ...
          <p class="price">
            ...
            <a href="https://www.iobit.com/buy.php?product=isu33pcsdpf&ref=en-isu3pcsdpf<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=purchase_isu" onclick="ga('send', 'event', 'isubundlebuy', 'buy', 'isupurchase');  " class="buybtn">Activate Now</a>
          </p>
          <ul class="list">
          	<li>
