...
function soldOut() {
	...
	$(".banner .right-message .number").html("Oops! $0 presale is unavailable now but you can <br> still enjoy 55% OFF now.")
	$(".floatlayer .number").html("Grab Your 55% OFF Discount");
	$(".price span").html("<strong>$<b>12</b>.97</strong> <del> $29.99</del>")
	$(".buybtn").attr({
		"href": 'https://www.iobit.com/buy.php?product=isu3preorder3pc1297&ref=en-isu3preordersoldoutofficial' + refStr + '&aff=' + aff + '&refs=purchase_isu&tw=' + tw,
		"onclick": "ga('send', 'event', 'isusoldbuy', 'buy', 'isu3preorder');  "
	});
}
