...
function soldOut() {
	...
	$(".banner .right-message .number").html("I pre-ordini con 0€ sono esauriti oggi. <br> Non perdere l’esclusivo sconto di 55%!")
	$(".floatlayer .number").html("Ottieni subito il tuo sconto del 55% ");
	$(".price span").html("<strong><b>12</b>,99€</strong> <del> 39,99€</del>")
	$(".buybtn").attr({
		"href": 'https://www.iobit.com/buy.php?product=it-isu3preorder1299&ref=it_isu3preorderofficial1299' + refStr + '&aff=' + aff + '&refs=it_purchase_isu&tw=' + tw,
		"onclick": "ga('send', 'event', 'isubuy', 'buy', 'isu3preordersoldout-it'); "
	});
}
