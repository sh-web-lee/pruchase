...
function soldOut() {
	...
	$(".banner .right-message .number").html("Oops! Los 0€ de preventa no están disponibles, <br> aunque todavía puedes conseguir un 55% de descuento")
	$(".floatlayer .number").html("Consigue tu 55% de descuento ahora ");
	$(".price span").html("<strong><b>12</b>,99 €</strong> <del> 29,99€</del>")
	$(".buybtn").attr({
		"href": 'https://www.iobit.com/buy.php?product=es-isu3preorder1299&ref=es_isu3preordersoldout' + refStr + '&aff=' + aff + '&refs=es_purchase_isu&tw=' + tw,
		"onclick": "ga('send', 'event', 'isubuy', 'buy', 'isu3preorder1299-es'); "
	});
}
