...
<head>
  ...
  <title>Adquira IObit Software Updater Pro com 45% de desconto e leve um super brinde. Oferta Especial de Natal da IObit.</title>
...
<div class="header clearfix">
    <div class="wrapper">
        <div class="head">
            ...
            <h2>Aproveite a melhor oferta de 2020 para manter seus programas atualizados e leve um brinde grátis!</h2>
        </div>
        <div class="banner">
            ...
            <div class="banner-right fr">
                <h2>IObit Software Updater 3 – 1 ano / 3 PCs</h2>
                ...
                <span class="banner-line"></span>
                <a class="buy-btn" href="https://www.iobit.com/buy.php?product=pt-isu33pcpf5199&ref=pt_isu33pcpfpurchase2011<?php echo $refStr;?>&refs=pt_purchase_isu" onclick="ga('send', 'event', 'isubuy', 'buy', 'isupurchase2011-pt');">COMPRAR AGORA</a>
...
<div class="bottom-buy wrapper clearfix">
  ...
  <div class="box-contain">
    <img src="<?php echo getStaticUrl('images/isu-small-box-new.png')?>" alt=""/>
