...
function soldOut() {
  ...
  $(".buybtn").attr({
    href: "http://www.iobit.com/buy.php?product=pl-isu3pc49&ref=pl_isu3pc49purchase1911" + refStr + "&aff=" + aff + "&refs=pl_purchase_isu&tw=" + tw,
...
function getViewNum() {
  $.ajax({
    ...
    success: function success(viewNum) {
      if (!isNaN(viewNum)) {
