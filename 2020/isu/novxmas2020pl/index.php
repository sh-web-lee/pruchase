...
<head>
  ...
  <title>Do 88% zniżki na IObit Software Updater PRO</title>
...
<body>
  ...
  <div class="banner">
    <div class="wrapper">
      ...
      <h1>Tylko teraz, nawet 88% taniej!</h1>
      <div class="img-box">
      ...
      <div class="right-message">
        ...
        <p class="price">
          ...
          <a href="http://www.iobit.com/buy.php?product=pl-isu33pcsdpf49&ref=pl_isu3pcsdpf49purchase1911<?php echo $refStr; ?>&refs=pl_purchase_isu" onclick="ga('send', 'event', 'isubuy', 'buy', 'isupurchase3PC1912-pl')" class="buybtn">Aktywuj teraz</a>
        </p>
        <ul class="list">
          <li class="first">
            Cena oryginalna <span>389,70 zł </span>
          </li>
          <li>Zniżka <span>88% </span></li>
  ...
  <div id="floatlayer" class="floatlayer">
    <div class="wrapper clearfix">
      ...
      <p class="price">
        ...
        <a href="http://www.iobit.com/buy.php?product=pl-isu33pcsdpf49&ref=pl_isu3pcsdpf49purchase1911<?php echo $refStr; ?>&refs=pl_purchase_isu" onclick="ga('send', 'event', 'isubuy', 'buy', 'isupurchase3PC1912s-pl')" class="buybtn">Aktywuj teraz</a>
      </p>
    </div>
  </div>
  <!-- floatlayer end -->
