...
if ($_GET['action'] == 'getPacks') {
  $date = $_GET['d'];
  $c_name = 'endbimfsd_p' . $date;
  $c_name_t='endbimfsd_t' . $date;
		...
		<div class="change clearfix">
			...
			<div class="right box">
				<dl>
					...
					<dd>
						<p class="clearfix"><span>Subtotal</span><span class="Subtotal right">$169.79</span></p>
						...
						<a 
						href="https://www.iobit.com/buy.php?product=2020dbimfsd2898&ref=xr_dbimfsd<?= $refStr; ?>&refs=purchase_3bundlexr"
						onclick="ga('send', 'event', 'dbimfsdbuy', 'buy', '3bundlepurchasexr-dbimfsd');" >
			...
			<dd>
				...
				<div class="buy-btn clearfix">
					...
					<a 
						...
						onclick="ga('send', 'event', 'dbbuy', 'buy', '3bundlepurchasexr-dbimfsd');" >
			...
			<dd>
				...
				<div class="buy-btn clearfix">
					...
					<a 
						...
						onclick="ga('send', 'event', 'imfbuy', 'buy', '3bundlepurchasexr-dbimfsd');" >
					<button class="buy-new"><i></i> Buy Now</button>
					</a>
				</div>
			</dd>
			...
			<dd>
				...
				<div class="buy-btn clearfix">
					...
					<a 
						...
						onclick="ga('send', 'event', 'sdbuy', 'buy', '3bundlepurchasexr-dbimfsd');" >
					<button class="buy-new"><i></i> Buy Now</button>
					</a>
				</div>
			</dd>
...
<div id="floatlayer" class="floatlayer">
	<img class="bg" src="<?php echo getStaticUrl('images/fl-bg.png')?>" alt=""/>	
  	<div class="wrapper default  clearfix">
		...
		<div class="price fr">
			<div class="buy-btn clearfix">
				<span><strong>$<b>28</b>.98</strong> <del>$169.79</del></span>
				<a 
						href="https://www.iobit.com/buy.php?product=2020dbimfsd2898&ref=xr_dbimfsd<?= $refStr; ?>&refs=purchase_3bundlexr"
						onclick="ga('send', 'event', 'dbimfsdbuy', 'buy', '3bundlepurchasexr-dbimfsd');" >
				<button class="buy-new"><i></i> Buy Now</button>
