...
var bannerObject = [{
  className:'one',
  body:'<tr><td>Driver Booster 8 PRO</td><td>3 PCs</td><td>$74.85</td><td>$0</td></tr><tr><td>Smart Defrag 6 PRO </td><td>3 PCs</td><td>$39.99</td><td>$11.99</td></tr><tr><td>IObit Malware Fighter 8 PRO</td><td>3 PCs</td><td>$54.95</td><td>$16.99</td></tr>',
  Discount:'70% OFF + Free Gift',
  Subtotal:'$169.79',
  Total:'$28.98',
  
  url:'https://www.iobit.com/buy.php?product=2020dbimfsd2898&ref=xr_dbimfsd'+refStr+'&refs=purchase_3bundlexr&tw='+tw,
  ga:"ga('send', 'event', 'dbimfsdbuy', 'buy', '3bundlepurchasexr-dbimfsd');"
},
{
  className:'two',
  ...
  ga:"ga('send', 'event', 'dbbuy', 'buy', '3bundlepurchasexr-dbimfsd');",
  soldoutUrlGa:"ga('send', 'event', 'dbsoldbuy', 'buy', '3bundlepurchasexr-dbimfsd');"
},
{
  className:'three',
  ...
  ga:"ga('send', 'event', 'imfbuy', 'buy', '3bundlepurchasexr-dbimfsd');",
  soldoutUrlGa:"ga('send', 'event', 'imfsoldbuy', 'buy', '3bundlepurchasexr-dbimfsd');"
},
{
  className:'four',
  ...
  ga:"ga('send', 'event', 'sdbuy', 'buy', '3bundlepurchasexr-dbimfsd');",
...
function getSales() {
  ...
  $.ajax({
    type: "GET",
    url: "xthreeb.php?pop=xr_dbimfsd",
    ...
    success: function (res) {
      ...
      if (packs > 0) {
        $(window).unload(function () {
          packs = cGet('endbimfsd_p');
        });
        var total = cGet('endbimfsd_t');
...
function getReTime() {
  var packsNumTotal = cGet('endbimfsd_t');
  if (packsNumTotal > 1) {
