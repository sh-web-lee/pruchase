...
if ($_GET['action'] == 'getPacks') {
  $date = $_GET['d'];
  $c_name = 'endbimfiu_p' . $date;
  $c_name_t='endbimfiu_t' . $date;
			...
			<div class="right box">
				<dl>
					...
					<dd>
						...
						<a 
						href="https://www.iobit.com/buy.php?product=2020dbimfiu2996&ref=xr_dbimfiu<?= $refStr; ?>&refs=purchase_3bundlexr"
						onclick="ga('send', 'event', 'dbimfiubuy', 'buy', '3bundlepurchasexr-dbimfiu');" >
			...
			<dd>
				...
				<div class="buy-btn clearfix">
					...
					<a 
						...
						onclick="ga('send', 'event', 'dbbuy', 'buy', '3bundlepurchasexr-dbimfiu');" >
			...
			<dd>
				...
				<div class="buy-btn clearfix">
					...
					<a 
						...
						onclick="ga('send', 'event', 'imfbuy', 'buy', '3bundlepurchasexr-dbimfiu');" >
					<button class="buy-new"><i></i> Buy Now</button>
					</a>
				</div>
			</dd>
			...
			<dd>
				...
				<div class="buy-btn clearfix">
					...
					<a 
						...
						onclick="ga('send', 'event', 'iubuy', 'buy', '3bundlepurchasexr-dbimfiu');" >
					<button class="buy-new"><i></i> Buy Now</button>
					</a>
				</div>
			</dd>
