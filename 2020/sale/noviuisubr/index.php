      ...
      <div class="content">
        ...
        <div class="right-message">
          ...
          <dl class="price">
            ...
            <dd><a href="https://www.iobit.com/buy.php?product=2020iuisu3pc1519&ref=br_iuisu<?= $refStr; ?>&refs=purchase_2bundlebf"
             	   onclick="ga('send', 'event', 'iuisubuy', 'buy', '2bundlepurchasebf-iuisu'); " class="buybtn">Get It Now</a></dd>
      ...
      <div class="box">
        ...
        <dl>
          ...
          <dd><a href="https://www.iobit.com/buy.php?product=2020iu3pc1297&ref=br_iu<?= $refStr; ?>&refs=purchase_2bundlebf"
                 onclick="ga('send', 'event', 'iubuy', 'buy', '2bundlepurchasebf-iuisu');" class="border-buybtn">Get It Now</a></dd>
        </dl>
      </div>
      <div class="box right">
        ...
        <dl>
          ...
          <dd><a href="https://www.iobit.com/buy.php?product=2020isu3pc999&ref=br_isu<?= $refStr; ?>&refs=purchase_2bundlebf"
                 onclick="ga('send', 'event', 'isubuy', 'buy', '2bundlepurchasebf-iuisu');" class="border-buybtn">Get It Now</a></dd>
        </dl>
      </div>
  	</div>
        ...
        <div class="message">
          ...
          <dl class="price">
            ...
            <dd><a href="https://www.iobit.com/buy.php?product=2020iu3pc1297&ref=br_iusold<?= $refStr; ?>&refs=purchase_2bundlebf"
                   onclick="ga('send', 'event', 'iusoldbuy', 'buy', '2bundlepurchasebf-iuisu');" class="buybtn">Get It Now</a></dd>
            <dd>1 Year / 3 PCs</dd>
          </dl>
        </div>
      </div>
        ...
        <div class="message">
          ...
          <dl class="price">
            ...
            <dd><a href="https://www.iobit.com/buy.php?product=2020isu3pc999&ref=br_isusold<?= $refStr; ?>&refs=purchase_2bundlebf"
                   onclick="ga('send', 'event', 'isusoldbuy', 'buy', '2bundlepurchasebf-iuisu');" class="buybtn">Get It Now</a></dd>
            <dd>1 Year / 3 PCs</dd>
          </dl>
        </div>
      </div>
				...
				<tr>
					...
					<th class="itema">
            			...
            			<a href="https://www.iobit.com/buy.php?product=2020iu3pc1297&ref=br_iu<?= $refStr; ?>&refs=purchase_2bundlebf"
                 		   onclick="ga('send', 'event', 'iubuy', 'buy', '2bundlepurchasebf-iuisu');" class="border-buybtn">Get It Now</a>
					</th>
					<th class="space"></th>
					<th class="itemb">
            			...
            			<a href="https://www.iobit.com/buy.php?product=2020isu3pc999&ref=br_isu<?= $refStr; ?>&refs=purchase_2bundlebf"
                 		   onclick="ga('send', 'event', 'isubuy', 'buy', '2bundlepurchasebf-iuisu');" class="border-buybtn">Get It Now</a>
					</th>
					<th class="space"></th>
					<th class="itemc">
						<p><strong>$<b>15</b>.19</strong> <del>$75.98</del></p>
						<a href="https://www.iobit.com/buy.php?product=2020iuisu3pc1519&ref=br_iuisu<?= $refStr; ?>&refs=purchase_2bundlebf"
             			   onclick="ga('send', 'event', 'iuisubuy', 'buy', '2bundlepurchasebf-iuisu'); " class="buybtn">Get It Now</a>
					</th>
				</tr>
			</tfoot> 
		</table>
...
<div id="floatlayer" class="floatlayer">
  <div class="wrapper default  clearfix">
    ...
    <div class="numer">
      ...
      <dd><a class="buybtn"
	 		 href="https://www.iobit.com/buy.php?product=2020iuisu3pc1519&ref=br_iuisu<?= $refStr; ?>&refs=purchase_2bundlebf"
             onclick="ga('send', 'event', 'iuisubuy', 'buy', '2bundlepurchasebf-iuisu'); " >
			Get It Now
      </a></dd>
    </dl>
  </div>
  <div class="wrapper soldout hide clearfix">
    ...
    <ul class="change">
      ...
      <dt><strong>$<b>12</b>.97</strong> <del>$42.99</del></dt>
      <dd><a class="buybtn"
	  		 href="https://www.iobit.com/buy.php?product=2020iu3pc1297&ref=br_iusold<?= $refStr; ?>&refs=purchase_2bundlebf"
             onclick="ga('send', 'event', 'iusoldbuy', 'buy', '2bundlepurchasebf-iuisu');">
		 Get It Now
      </a></dd>
    </dl>
  </div>
