...
if ($_GET['action'] == 'getPacks') {
  $date = $_GET['d'];
  $c_name = 'enbtwobdbisu_p' . $date;
  $c_name_t='enbtwobdbisu_t' . $date;
...
<head>
  ...
  <title>80% OFF to Get DB PRO & ISU PRO - Black Friday Sale | IObit</title>
   ...
   <div class="default">
      <div class="content">
        ...
        <div class="right-message">
          ...
          <dl class="price">
            <dt>Only <strong>$<b>21</b>.57</strong> <del>$107.84</del></dt>
            <dd><a href="https://www.iobit.com/buy.php?product=2020dbisu3pc2157&ref=br_dbisu<?= $refStr; ?>&refs=purchase_2bundlebf"
                   onclick="ga('send', 'event', 'dbisubuy', 'buy', '2bundlepurchasebf-dbisu');   "  class="buybtn">Get It Now</a></dd>
      ...
      <div class="box">
        ...
        <dl>
          ...
          <dd><a href="https://www.iobit.com/buy.php?product=2020db3pc1995&ref=br_db<?= $refStr; ?>&refs=purchase_2bundlebf"
                 onclick="ga('send', 'event', 'dbbuy', 'buy', '2bundlepurchasebf-dbisu'); " class="border-buybtn">Get It Now</a></dd>
        </dl>
      </div>
      <div class="box right">
        ...
        <dl>
          ...
          <dd><a href="https://www.iobit.com/buy.php?product=2020isu3pc999&ref=br_isu<?= $refStr; ?>&refs=purchase_2bundlebf"
                 onclick="ga('send', 'event', 'isubuy', 'buy', '2bundlepurchasebf-dbisu');" class="border-buybtn">Get It Now</a></dd>
        </dl>
      </div>
  </div>
        ...
        <div class="message">
          ...
          <dl class="price">
            ...
            <dd><a href="https://www.iobit.com/buy.php?product=2020db3pc1995&ref=br_dbsold<?= $refStr; ?>&refs=purchase_2bundlebf"
             		onclick="ga('send', 'event', 'dbsoldbuy', 'buy', '2bundlepurchasebf-dbisu');  " class="buybtn">Get It Now</a></dd>
            <dd>1 Year / 3 PCs</dd>
          </dl>
        </div>
      </div>
        ...
        <div class="message">
          ...
          <dl class="price">
            ...
            <dd><a href="https://www.iobit.com/buy.php?product=2020isu3pc999&ref=br_isusold<?= $refStr; ?>&refs=purchase_2bundlebf"
                   onclick="ga('send', 'event', 'isusoldbuy', 'buy', '2bundlepurchasebf-dbisu');" class="buybtn">Get It Now</a></dd>
            <dd>1 Year / 3 PCs</dd>
          </dl>
        </div>
      </div>
...
<div class="compare">
	<div class="wrapper">
		...
		<p>of both Driver Booster and IObit Software Updater</p>
		<table>
			<thead>
				<tr>
					<th class="text"></th>
				...
				<tr>
					...
					<th class="itema">
            			...
            			<a href="https://www.iobit.com/buy.php?product=2020db3pc1995&ref=br_db<?= $refStr; ?>&refs=purchase_2bundlebf"
                			onclick="ga('send', 'event', 'dbbuy', 'buy', '2bundlepurchasebf-dbisu'); " class="border-buybtn">Get It Now</a>
					</th>
					<th class="space"></th>
					<th class="itemb">
            			...
            			<a href="https://www.iobit.com/buy.php?product=2020isu3pc999&ref=br_isu<?= $refStr; ?>&refs=purchase_2bundlebf"
                 		   onclick="ga('send', 'event', 'isubuy', 'buy', '2bundlepurchasebf-dbisu');" class="border-buybtn">Get It Now</a>
					</th>
					<th class="space"></th>
					<th class="itemc">
						<p><strong>$<b>21</b>.57</strong> <del>$107.84</del></p>
						<a href="https://www.iobit.com/buy.php?product=2020dbisu3pc2157&ref=br_dbisu<?= $refStr; ?>&refs=purchase_2bundlebf"
                   		   onclick="ga('send', 'event', 'dbisubuy', 'buy', '2bundlepurchasebf-dbisu');   "   class="buybtn">Get It Now</a>
					</th>
				</tr>
			</tfoot> 
		</table>
...
<div id="floatlayer" class="floatlayer">
  <div class="wrapper default  clearfix">
    ...
    <div class="numer">
      ...
      <dl class="price fr">
      <dt><strong>$<b>21</b>.57</strong> <del>$107.84</del></dt>
      <dd><a class="buybtn"
	  				href="https://www.iobit.com/buy.php?product=2020dbisu3pc2157&ref=br_dbisu<?= $refStr; ?>&refs=purchase_2bundlebf"
                   onclick="ga('send', 'event', 'dbisubuy', 'buy', '2bundlepurchasebf-dbisu');   " >
			Get It Now
      </a></dd>
    </dl>
  </div>
  <div class="wrapper soldout hide clearfix">
    ...
    <ul class="change">
      ...
      <dd><a class="buybtn"
             ...
             onclick="ga('send', 'event', 'dbsoldbuy', 'buy', '2bundlepurchasebf-dbisu');  ">
		 Get It Now
      </a></dd>
    </dl>
  </div>
