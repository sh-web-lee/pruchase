...
var bannerObject = [{
  className:'one',
  body:'<tr><td>Advanced SystemCare 14 PRO</td><td>3 PCs</td><td>$49.99</td><td>$0</td></tr><tr><td>IObit Software Updater 3 PRO</td><td>3 PCs</td><td>$32.99</td><td>$9.99</td></tr><tr><td>IObit Uninstaller 10 PRO</td><td>3 PCs</td><td>$42.99</td><td>$12.97</td></tr>',
  Discount:'70% OFF + Free Gift',
  Subtotal:'$125.97',
  Total:'$22.96',
  
  url:'https://www.iobit.com/buy.php?product=2020asciuisu2296&ref=br_asciuisu'+refStr+'&refs=purchase_3bundlebftw='+tw,
  ga:"ga('send', 'event', 'asciuisubuy', 'buy', '3bundlepurchasebf-asciuisu');"
},
{
  className:'two',
  ...
  ga:"ga('send', 'event', 'ascbuy', 'buy', '3bundlepurchasebf-asciuisu');",
  soldoutUrlGa:"ga('send', 'event', 'ascsoldbuy', 'buy', '3bundlepurchasebf-asciuisu');"
},
{
  className:'three',
  ...
  ga:"ga('send', 'event', 'iubuy', 'buy', '3bundlepurchasebf-asciuisu');",
  soldoutUrlGa:"ga('send', 'event', 'iusoldbuy', 'buy', '3bundlepurchasebf-asciuisu');"
},
{
  className:'four',
  ...
  ga:"ga('send', 'event', 'isubuy', 'buy', '3bundlepurchasebf-asciuisu');",
  soldoutUrlGa:"ga('send', 'event', 'isusoldbuy', 'buy', '3bundlepurchasebf-asciuisu');"
}]
...
function getSales() {
  ...
  $.ajax({
    type: "GET",
    url: "bthreeb.php?pop=br_asciuisu",
    ...
    success: function (res) {
      ...
      if (packs > 0) {
        $(window).unload(function () {
          packs = cGet('enasciuisu_p');
        });
        var total = cGet('enasciuisu_t');
...
function getReTime() {
  var packsNumTotal = cGet('enasciuisu_t');
  if (packsNumTotal > 1) {
