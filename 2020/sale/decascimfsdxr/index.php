...
if ($_GET['action'] == 'getPacks') {
  $date = $_GET['d'];
  $c_name = 'enacimfsd_p' . $date;
  $c_name_t='enacimfsd_t' . $date;
		...
		<div class="left box clearfix">
			...
			<div class="right box">
				<dl>
					...
					<dd>
						<p class="clearfix"><span>Subtotal</span><span class="Subtotal right">$144.93</span></p>
						<p class="border clearfix"><span>Discount</span><span class="Discount right">70% OFF + Free Gift</span></p>
						<p class="clearfix total"><span>Total</span><span class="Total right">$28.98</span></p>
						<a 
						href="https://www.iobit.com/buy.php?product=2020ascimfsd2898gift&ref=xr_ascimfsd<?= $refStr; ?>&refs=purchase_3bundlexr"
						onclick="ga('send', 'event', 'ascimfsdbuy', 'buy', '3bundlepurchasexr-ascimfsd');" >
			...
			<dd>
				...
				<div class="buy-btn clearfix">
					...
					<a 
						...
						onclick="ga('send', 'event', 'ascbuy', 'buy', '3bundlepurchasexr-ascimfsd');" >
			...
			<dd>
				...
				<div class="buy-btn clearfix">
					...
					<a 
						...
						onclick="ga('send', 'event', 'imfbuy', 'buy', '3bundlepurchasexr-ascimfsd');" >
					<button class="buy-new"><i></i> Buy Now</button>
					</a>
				</div>
			</dd>
			...
			<dd>
				...
				<div class="buy-btn clearfix">
					...
					<a 
						...
						onclick="ga('send', 'event', 'sdbuy', 'buy', '3bundlepurchasexr-ascimfsd');" >
					<button class="buy-new"><i></i> Buy Now</button>
					</a>
				</div>
			</dd>
...
<div id="floatlayer" class="floatlayer">
	<img class="bg" src="<?php echo getStaticUrl('images/fl-bg.png')?>" alt=""/>	
  	<div class="wrapper default  clearfix">
		...
		<div class="price fl">
			<div class="buy-btn clearfix">
				<span><strong>$<b>28</b>.98</strong> <del>$144.93</del></span>
				<a 
						href="https://www.iobit.com/buy.php?product=2020ascimfsd2898gift&ref=xr_ascimfsd<?= $refStr; ?>&refs=purchase_3bundlexr"
						onclick="ga('send', 'event', 'ascimfsdbuy', 'buy', '3bundlepurchasexr-ascimfsd');" >
				<button class="buy-new"><i></i> Buy Now</button>
