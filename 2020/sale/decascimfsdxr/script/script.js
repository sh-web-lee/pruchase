...
var bannerObject = [{
  className:'one',
  body:'<tr><td>Advanced SystemCare 14 PRO</td><td>3 PCs</td><td>$49.99</td><td>$0</td></tr><tr><td>IObit Malware Fighter 8 PRO</td><td>3 PCs</td><td>$54.95</td><td>$16.99</td></tr><tr><td>Smart Defrag 6 PRO</td><td>3 PCs</td><td>$42.99</td><td>$12.97</td></tr>',
  Discount:'70% OFF + Free Gift',
  Subtotal:'$144.93',
  Total:'$28.98',
  url:'https://www.iobit.com/buy.php?product=2020ascimfsd2898gift&ref=xr_ascimfsd'+ refStr +'&refs=purchase_3bundlexr&tw='+tw,
  ga:"ga('send', 'event', 'ascimfsdbuy', 'buy', '3bundlepurchasexr-ascimfsd')"
},
{
  className:'two',
  ...
  ga:"ga('send', 'event', 'ascbuy', 'buy', '3bundlepurchasexr-ascimfsd')",
  soldoutUrlGa:"ga('send', 'event', 'ascsoldbuy', 'buy', '3bundlepurchasexr-ascdbsd')"
},
{
  className:'three',
  ...
  ga:"ga('send', 'event', 'sdbuy', 'buy', '3bundlepurchasexr-ascimfsd');",
...
},
{
  ...
  ga:"ga('send', 'event', 'imfbuy', 'buy', '3bundlepurchasexr-ascimfsd')",
...
function getSales() {
  ...
  $.ajax({
    type: "GET",
    url: "xthreeb.php?pop=xr_ascimfsd",
    ...
    success: function (res) {
      ...
      if (packs > 0) {
        $(window).unload(function () {
          packs = cGet('enacimfsd_p');
        });
        var total = cGet('enacimfsd_t');
...
function getReTime() {
  var packsNumTotal = cGet('enacimfsd_t');
  if (packsNumTotal > 1) {
