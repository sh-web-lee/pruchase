					...
					<div class="saleseordercnt">
						...
						<div class="saleseorder-cont">
							<div class="saleseorder-items">
								...
								<div class="saleseorder-price"><p>$<span class="orprice">177.92</p></span></div>
							</div>
							<div class="saleseorder-discount">
								<div class="saleseorder-name"><p>DISCOUNT (<span class="saleratio">90</span>% OFF) </p></div>
								<div class="saleseorder-price"><p>-$<span class="salernum">160.13</span></p></div>
							</div>
						</div>
						<div class="saleseorder-buy">
							<div class="saleseorder-total">
								<div class="saleseorder-name"><p><span>Total</span></p></div>
								<div class="saleseorder-price"><p>$<span class="salertotal">17.79</span></p></div>
							</div>
							<a href="https://www.iobit.com/buy.php?product=2020ascimfisusd1779&ref=xr_ascimfisusd<?= $refStr; ?>&refs=purchase_4bundlexr" onclick="ga('send', 'event', 'ascimfisusdbuy', 'buy', '4bundlepurchasexr-ascimfisusd');" class="buybtn banbuybtn"><span>Buy Now</span></a>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="salekeep-cntdes clearfix">
					...
					<div class="salekeep-cntstore">
						...
						<div class="salekeep-cntprice">
							...
							<a href="https://www.iobit.com/buy.php?product=2020asc3pc1477&ref=xr_asc<?= $refStr; ?>&refs=purchase_4bundlexr" onclick="ga('send', 'event', 'ascbuy', 'buy', '4bundlepurchasexr-ascimfisusd');" class="buybtn"><span>Buy Now</span></a>
				...
				<div class="salekeep-cntdes clearfix">
					...
					<div class="salekeep-cntstore">
						...
						<p class="salekeep-price">$<big>11</big>.99<del>$39.99</del></p>
							<a href="https://www.iobit.com/buy.php?product=2020sd3pc1199&ref=xr_sd<?= $refStr; ?>&refs=purchase_4bundlexr" onclick="ga('send', 'event', 'sdbuy', 'buy', '4bundlepurchasexr-ascimfisusd');" class="buybtn"><span>Buy Now</span></a>
							<div class="salekeep-cnttips">1 Year / 3 PCs</div>
						</div>
					</div>
				</div>
				...
				<div class="salekeep-cntdes clearfix">
					...
					<div class="salekeep-cntstore">
						...
						<p class="salekeep-price">$<big>9</big>.99<del>$32.99</del></p>
							<a href="https://www.iobit.com/buy.php?product=2020isu3pc999&ref=xr_isu<?= $refStr; ?>&refs=purchase_4bundlexr" onclick="ga('send', 'event', 'isubuy', 'buy', '4bundlepurchasexr-ascimfisusd');" class="buybtn"><span>Buy Now</span></a>
							<div class="salekeep-cnttips">1 Year / 3 PCs</div>
						</div>
					</div>
				</div>
				...
				<div class="salekeep-cntdes clearfix">
					...
					<div class="salekeep-cntstore">
						...
						<div class="salekeep-cntprice">
							...
							<a href="https://www.iobit.com/buy.php?product=2020imf3pc1699&ref=xr_imf<?= $refStr; ?>&refs=purchase_4bundlexr" onclick="ga('send', 'event', 'imfbuy', 'buy', '4bundlepurchasexr-ascimfisusd');" class="buybtn"><span>Buy Now</span></a>
							<div class="salekeep-cnttips">1 Year / 3 PCs</div>
						</div>
					</div>
				</div>
		...
		<div class="saleexclu-cont">
			...
			<div class="saleexclu-super">
				<div class="saleexclu-supcnt">
					...
					<p class="salekeep-price">$<big>17</big>.79<del>$177.92</del></p>
					<div class="saleexclu-buy"><a href="https://www.iobit.com/buy.php?product=2020ascimfisusd1779&ref=xr_ascimfisusd<?= $refStr; ?>&refs=purchase_4bundlexr" onclick="ga('send', 'event', 'ascimfisusdbuy', 'buy', '4bundlepurchasexr-ascimfisusd');" class="buybtn"><span>Buy Now</span></a></div>
