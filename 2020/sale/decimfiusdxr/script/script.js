...
var bannerObject = [{
  className:'one',
  body:'<tr><td>IObit Malware Fighter 8 PRO</td><td>3 PCs</td><td>$54.95</td><td>$0</td></tr><tr><td>Smart Defrag 6 PRO </td><td>3 PCs</td><td>$39.99</td><td>$11.99</td></tr><tr><td>IObit Uninstaller 10 PRO</td><td>3 PCs</td><td>$42.99</td><td>$12.97</td></tr>',
  Discount:'70% OFF + Free Gift',
  Subtotal:'$137.93',
  Total:'$24.96',
  
  url:'https://www.iobit.com/buy.php?product=2020imfiusd2496&ref=xr_imfiusd'+refStr+'&refs=purchase_3bundlexrtw='+tw,
  ga:"ga('send', 'event', 'imfiusdbuy', 'buy', '3bundlepurchasexr-imfiusd');"
},
{
  className:'two',
  ...
  ga:"ga('send', 'event', 'imfbuy', 'buy', '3bundlepurchasexr-imfiusd')",
  soldoutUrlGa:"ga('send', 'event', 'imfsoldbuy', 'buy', '3bundlepurchasexr-imfimfiu')"
},
{
  className:'three',
  ...
  ga:"ga('send', 'event', 'iubuy', 'buy', '3bundlepurchasexr-imfiusd');",
  soldoutUrlGa:"ga('send', 'event', 'iusoldbuy', 'buy', '3bundlepurchasexr-imfiusd');"
},
{
  className:'four',
  ...
  ga:"ga('send', 'event', 'sdbuy', 'buy', '3bundlepurchasexr-imfiusd');",
...
function getSales() {
  ...
  $.ajax({
    type: "GET",
    url: "xthreeb.php?pop=xr_imfiusd",
    ...
    success: function (res) {
      ...
      if (packs > 0) {
        $(window).unload(function () {
          packs = cGet('enimfiusd_p');
        });
        var total = cGet('enimfiusd_t');
...
function getReTime() {
  var packsNumTotal = cGet('enimfiusd_t');
  if (packsNumTotal > 1) {
