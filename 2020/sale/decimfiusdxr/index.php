...
if ($_GET['action'] == 'getPacks') {
  $date = $_GET['d'];
  $c_name = 'enimfiusd_p' . $date;
  $c_name_t='enimfiusd_t' . $date;
			...
			<div class="right box">
				<dl>
					...
					<dd>
						...
						<a 
						href="https://www.iobit.com/buy.php?product=2020imfiusd2496&ref=xr_imfiusd<?= $refStr; ?>&refs=purchase_3bundlexr"
						onclick="ga('send', 'event', 'imfiusdbuy', 'buy', '3bundlepurchasexr-imfiusd');" >
			...
			<ul class="clearfix mf">
				...
				<span><strong>$<b>16</b>.99</strong> <del>$54.95</del></span>
					<a 
						...
						onclick="ga('send', 'event', 'imfbuy', 'buy', '3bundlepurchasexr-imfiusd');" >
			...
			<dd>
				...
				<div class="buy-btn clearfix">
					...
					<a 
						...
						onclick="ga('send', 'event', 'iubuy', 'buy', '3bundlepurchasexr-imfiusd');" >
					<button class="buy-new"><i></i> Buy Now</button>
					</a>
				</div>
			</dd>
			...
			<dd>
				...
				<div class="buy-btn clearfix">
					...
					<a 
						...
						onclick="ga('send', 'event', 'sdbuy', 'buy', '3bundlepurchasexr-imfiusd');" >
					<button class="buy-new"><i></i> Buy Now</button>
					</a>
				</div>
			</dd>
...
<div id="floatlayer" class="floatlayer">
	<img class="bg" src="<?php echo getStaticUrl('images/fl-bg.png')?>" alt=""/>	
  	<div class="wrapper default  clearfix">
		...
		<div class="price fr">
			<div class="buy-btn clearfix">
				<span><strong>$<b>24</b>.96</strong> <del>$137.93</del></span>
				<a 
						href="https://www.iobit.com/buy.php?product=2020imfiusd2496&ref=xr_imfiusd<?= $refStr; ?>&refs=purchase_3bundlexr"
						onclick="ga('send', 'event', 'imfiusdbuy', 'buy', '3bundlepurchasexr-imfiusd');" >
				<button class="buy-new"><i></i> Buy Now</button>
