...
var bannerObject = [{
  className:'one',
  body:'<tr><td>IObit Uninstaller 10 PRO</td><td>3 PCs</td><td>$42.99</td><td>$0</td></tr><td>Smart Defrag 6 PRO </td><td>3 PCs</td><td>$39.99</td><td>$11.99</td></tr><tr><td>IObit Software Updater 3 PRO</td><td>3 PCs</td><td>$32.99</td><td>$9.99</td></tr>',
  Discount:'70% OFF + Free Gift',
  Subtotal:'$115.97',
  Total:'$21.98',
  
  url:'https://www.iobit.com/buy.php?product=2020iuisusd2198&ref=xr_iuisusd'+refStr+'&refs=purchase_3bundlexrtw='+tw,
  ga:"ga('send', 'event', 'iuisusdbuy', 'buy', '3bundlepurchasexr-iuisusd');"
},
{
  className:'two',
  ...
  ga:"ga('send', 'event', 'iubuy', 'buy', '3bundlepurchasexr-iuisusd');",
...
},
{
  ...
  ga:"ga('send', 'event', 'isubuy', 'buy', '3bundlepurchasexr-iuisusd');",
...
},
{
  ...
  ga:"ga('send', 'event', 'sdbuy', 'buy', '3bundlepurchasexr-iuisusd');",
  soldoutUrlGa:"ga('send', 'event', 'sdsoldbuy', 'buy', '3bundlepurchasexr-iudbsd');"
},]
...
function soldout(){
  ...
  $('.floatlayer .numer .s').eq(0).html('<b>Save 70%</b> on IObit Uninstaller 10 PRO')
  $('.floatlayer .numer .s').eq(1).html('Uninstall Any Programs and<br> Plug-ins Unwanted')
  ...
  $('.floatlayer .price .buy-btn span').html("<strong>$<b>12</b>.97</strong> <del>$42.99</del>")
...
function getSales() {
  ...
  $.ajax({
    type: "GET",
    url: "xthreeb.php?pop=xr_iuisusd",
    ...
    success: function (res) {
      ...
      if (packs > 0) {
        $(window).unload(function () {
          packs = cGet('eniuisusd_p');
        });
        var total = cGet('eniuisusd_t');
...
function getReTime() {
  var packsNumTotal = cGet('eniuisusd_t');
  if (packsNumTotal > 1) {
