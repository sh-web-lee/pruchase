...
if ($_GET['action'] == 'getPacks') {
  $date = $_GET['d'];
  $c_name = 'endbiusd_p' . $date;
  $c_name_t='endbiusd_t' . $date;
			...
			<div class="right box">
				<dl>
					...
					<dd>
						...
						<a 
						href="https://www.iobit.com/buy.php?product=2020dbiusd2496&ref=xr_dbiusd<?= $refStr; ?>&refs=purchase_3bundlexr"
						onclick="ga('send', 'event', 'dbiusdbuy', 'buy', '3bundlepurchasexr-dbiusd');" >
			...
			<dd>
				...
				<div class="buy-btn clearfix">
					...
					<a 
						...
						onclick="ga('send', 'event', 'dbbuy', 'buy', '3bundlepurchasexr-dbiusd');" >
			...
			<dd>
				...
				<div class="buy-btn clearfix">
					...
					<a 
						...
						onclick="ga('send', 'event', 'iubuy', 'buy', '3bundlepurchasexr-dbiusd');" >
					<button class="buy-new"><i></i> Buy Now</button>
					</a>
				</div>
			</dd>
			...
			<dd>
				...
				<div class="buy-btn clearfix">
					...
					<a 
						...
						onclick="ga('send', 'event', 'sdbuy', 'buy', '3bundlepurchasexr-dbiusd');" >
					<button class="buy-new"><i></i> Buy Now</button>
					</a>
				</div>
			</dd>
...
<div id="floatlayer" class="floatlayer">
	<img class="bg" src="<?php echo getStaticUrl('images/fl-bg.png')?>" alt=""/>	
  	<div class="wrapper default  clearfix">
		...
		<div class="price fr">
			<div class="buy-btn clearfix">
				<span><strong>$<b>24</b>.96</strong> <del>$157.83</del></span>
				<a 
						href="https://www.iobit.com/buy.php?product=2020dbiusd2496&ref=xr_dbiusd<?= $refStr; ?>&refs=purchase_3bundlexr"
						onclick="ga('send', 'event', 'dbiusdbuy', 'buy', '3bundlepurchasexr-dbiusd');" >
				<button class="buy-new"><i></i> Buy Now</button>
