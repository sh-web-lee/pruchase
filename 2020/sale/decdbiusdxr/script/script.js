...
var bannerObject = [{
  className:'one',
  body:'<tr><td>Driver Booster 8 PRO</td><td>3 PCs</td><td>$74.85</td><td>$0</td></tr><tr><td>Smart Defrag 6 PRO </td><td>3 PCs</td><td>$39.99</td><td>$11.99</td></tr><tr><td>IObit Uninstaller 10 PRO</td><td>3 PCs</td><td>$42.99</td><td>$12.97</td></tr>',
  Discount:'70% OFF + Free Gift',
  Subtotal:'$157.83',
  Total:'$24.96',
  url:'https://www.iobit.com/buy.php?product=2020dbiusd2496&ref=xr_dbiusd'+refStr+'&refs=purchase_3bundlexr&tw='+tw,
  ga:"ga('send', 'event', 'dbiusdbuy', 'buy', '3bundlepurchasexr-dbiusd');"
},
{
  className:'two',
  ...
  ga:"ga('send', 'event', 'dbbuy', 'buy', '3bundlepurchasexr-dbiusd');",
  soldoutUrlGa:"ga('send', 'event', 'dbsoldbuy', 'buy', '3bundlepurchasexr-dbiusd');"
},
{
  className:'three',
  ...
  ga:"ga('send', 'event', 'iubuy', 'buy', '3bundlepurchasexr-dbiusd');",
  soldoutUrlGa:"ga('send', 'event', 'iusoldbuy', 'buy', '3bundlepurchasexr-dbiusd');"
},
{
  className:'four',
  ...
  ga:"ga('send', 'event', 'sdbuy', 'buy', '3bundlepurchasexr-dbiusd');",
    ...
    success: function (res) {
      ...
      if (packs > 0) {
        $(window).unload(function () {
          packs = cGet('endbiusd_p');
        });
        var total = cGet('endbiusd_t');
...
function getReTime() {
  var packsNumTotal = cGet('endbiusd_t');
  if (packsNumTotal > 1) {
