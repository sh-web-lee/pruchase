...
$(".floatlayer ul li").click(function() {
    ...
    if(index==1) {
      ...
      $(".floatlayer .price dt").html("<strong>$<b>11</b>.99</strong> <del>$39.99</del>")
    }
    else {
...
function getReTime() {
  var packsNumTotal = cGet('enbtwobimfsd_t');
  if (packsNumTotal > 1) {
