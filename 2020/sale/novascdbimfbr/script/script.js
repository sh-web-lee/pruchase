...
var bannerObject = [{
  className:'one',
  body:'<tr><td>Advanced SystemCare 14 PRO</td><td>3 PCs</td><td>$49.99</td><td>$0</td></tr><tr><td>Driver Booster 8 PRO</td><td>3 PCs</td><td>$74.85</td><td>$19.95</td></tr><tr><td>IObit Malware Fighter 8 PRO</td><td>3 PCs</td><td>$54.95</td><td>$16.99</td></tr>',
  Discount:'70% OFF + Free Gift',
  Subtotal:'$179.79',
  Total:'$36.94',
  url:'https://www.iobit.com/buy.php?product=2020ascdbimf3694&ref=br_ascdbimf'+refStr+'&refs=purchase_3bundlebf&tw='+tw,
  ga:"ga('send', 'event', 'ascdbimfbuy', 'buy', '3bundlepurchasebf-ascdbimf')"
},
{
  className:'two',
  ...
  ga:"ga('send', 'event', 'ascbuy', 'buy', '3bundlepurchasebf-ascdbimf')",
  soldoutUrlGa:"ga('send', 'event', 'ascsoldbuy', 'buy', '3bundlepurchasebf-ascdbimf')"
},
{
  className:'three',
  ...
  ga:"ga('send', 'event', 'imfbuy', 'buy', '3bundlepurchasebf-ascdbimf')",
  soldoutUrlGa:"ga('send', 'event', 'imfsoldbuy', 'buy', '3bundlepurchasebf-ascdbimf')"
},
{
  className:'four',
  ...
  ga:"ga('send', 'event', 'dbbuy', 'buy', '3bundlepurchasebf-ascdbimf')",
  soldoutUrlGa:"ga('send', 'event', 'dbsoldbuy', 'buy', '3bundlepurchasebf-ascdbimf')"
}]
...
function getSales() {
  ...
  $.ajax({
    type: "GET",
    url: "bthreeb.php?pop=br_ascdbimf",
    ...
    success: function (res) {
      ...
      if (packs > 0) {
        $(window).unload(function () {
          packs = cGet('enacdbimf_p');
        });
        var total = cGet('enacdbimf_t');
...
function getReTime() {
  var packsNumTotal = cGet('enacdbimf_t');
  if (packsNumTotal > 1) {
