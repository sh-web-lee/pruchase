...
if ($_GET['action'] == 'getPacks') {
  $date = $_GET['d'];
  $c_name = 'enacdbimf_p' . $date;
  $c_name_t='enacdbimf_t' . $date;
		...
		<div class="change clearfix">
			...
			<div class="right box">
				<dl>
					...
					<dd>
						<p class="clearfix"><span>Subtotal</span><span class="Subtotal right">$179.79</span></p>
						<p class="border clearfix"><span>Discount</span><span class="Discount right">70% OFF + Free Gift</span></p>
						<p class="clearfix total"><span>Total</span><span class="Total right">$36.94</span></p>
						<a 
						href="https://www.iobit.com/buy.php?product=2020ascdbimf3694&ref=br_ascdbimf<?= $refStr; ?>&refs=purchase_3bundlebf"
						onclick="ga('send', 'event', 'ascdbimfbuy', 'buy', '3bundlepurchasebf-ascdbimf');" >
			...
			<dd>
				...
				<div class="buy-btn clearfix">
					...
					<a 
						...
						onclick="ga('send', 'event', 'ascbuy', 'buy', '3bundlepurchasebf-ascdbimf');" >
			...
			<dd>
				...
				<div class="buy-btn clearfix">
					...
					<a 
						...
						onclick="ga('send', 'event', 'dbbuy', 'buy', '3bundlepurchasebf-ascdbimf');" >
					<button class="buy-new"><i></i> Buy Now</button>
					</a>
				</div>
			</dd>
			...
			<dd>
				...
				<div class="buy-btn clearfix">
					...
					<a 
						...
						onclick="ga('send', 'event', 'imfbuy', 'buy', '3bundlepurchasebf-ascdbimf');" >
					<button class="buy-new"><i></i> Buy Now</button>
					</a>
				</div>
			</dd>
...
<div id="floatlayer" class="floatlayer">
	<img class="bg" src="<?php echo getStaticUrl('images/fl-bg.png')?>" alt=""/>	
  	<div class="wrapper default  clearfix">
		...
		<div class="price fr">
			<div class="buy-btn clearfix">
				<span><strong>$<b>36</b>.94</strong> <del>$179.79</del></span>
				<a 
						href="https://www.iobit.com/buy.php?product=2020ascdbimf3694&ref=br_ascdbimf<?= $refStr; ?>&refs=purchase_3bundlebf"
						onclick="ga('send', 'event', 'ascdbimfbuy', 'buy', '3bundlepurchasebf-ascdbimf');" >
				<button class="buy-new"><i></i> Buy Now</button>
