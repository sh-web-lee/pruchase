...
if ($_GET['action'] == 'getPacks') {
  $date = $_GET['d'];
  $c_name = 'endbiuisu_p' . $date;
  $c_name_t='endbiuisu_t' . $date;
		...
		<div class="change clearfix">
			...
			<div class="right box">
				<dl>
					...
					<dd>
						<p class="clearfix"><span>Subtotal</span><span class="Subtotal right">$150.83</span></p>
						...
						<a 
						href="https://www.iobit.com/buy.php?product=2020dbiuisu2296&ref=br_dbiuisu<?= $refStr; ?>&refs=purchase_3bundlebf"
						onclick="ga('send', 'event', 'dbiuisubuy', 'buy', '3bundlepurchasebf-dbiuisu');" >
			...
			<dd>
				...
				<div class="buy-btn clearfix">
					...
					<a 
						...
						onclick="ga('send', 'event', 'dbbuy', 'buy', '3bundlepurchasebf-dbiuisu');" >
			...
			<dd>
				...
				<div class="buy-btn clearfix">
					...
					<a 
						...
						onclick="ga('send', 'event', 'iubuy', 'buy', '3bundlepurchasebf-dbiuisu');" >
					<button class="buy-new"><i></i> Buy Now</button>
					</a>
				</div>
			</dd>
			...
			<dd>
				...
				<div class="buy-btn clearfix">
					...
					<a 
						...
						onclick="ga('send', 'event', 'isubuy', 'buy', '3bundlepurchasebf-dbiuisu');" >
					<button class="buy-new"><i></i> Buy Now</button>
					</a>
				</div>
			</dd>
...
<div id="floatlayer" class="floatlayer">
	<img class="bg" src="<?php echo getStaticUrl('images/fl-bg.png')?>" alt=""/>	
  	<div class="wrapper default  clearfix">
		...
		<div class="price fr">
			<div class="buy-btn clearfix">
				<span><strong>$<b>22</b>.96 </strong> <del>$150.83</del></span>
				<a 
						href="https://www.iobit.com/buy.php?product=2020dbiuisu2296&ref=br_dbiuisu<?= $refStr; ?>&refs=purchase_3bundlebf"
						onclick="ga('send', 'event', 'dbiuisubuy', 'buy', '3bundlepurchasebf-dbiuisu');" >
				<button class="buy-new"><i></i> Buy Now</button>
