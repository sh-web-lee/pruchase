...
var bannerObject = [{
  className:'one',
  body:'<tr><td>Driver Booster 8 PRO</td><td>3 PCs</td><td>$74.85</td><td>$0</td></tr><tr><td>IObit Software Updater 3 PRO</td><td>3 PCs</td><td>$32.99</td><td>$9.99</td></tr><tr><td>IObit Uninstaller 10 PRO</td><td>3 PCs</td><td>$42.99</td><td>$12.97</td></tr>',
  Discount:'70% OFF + Free Gift',
  Subtotal:'$150.83',
  Total:'$22.96',
  
  url:'https://www.iobit.com/buy.php?product=2020dbiuisu2296&ref=br_dbiuisu'+refStr+'&refs=purchase_3bundlebf&tw='+tw,
  ga:"ga('send', 'event', 'dbiuisubuy', 'buy', '3bundlepurchasebf-dbiuisu');"
},
{
  className:'two',
  ...
  ga:"ga('send', 'event', 'dbbuy', 'buy', '3bundlepurchasebf-dbiuisu');",
  soldoutUrlGa:"ga('send', 'event', 'dbsoldbuy', 'buy', '3bundlepurchasebf-dbiuisu');"
},
{
  className:'three',
  ...
  ga:"ga('send', 'event', 'iubuy', 'buy', '3bundlepurchasebf-dbiuisu');",
  soldoutUrlGa:"ga('send', 'event', 'iusoldbuy', 'buy', '3bundlepurchasebf-dbiuisu');"
},
{
  className:'four',
  ...
  ga:"ga('send', 'event', 'isubuy', 'buy', '3bundlepurchasebf-dbiuisu');",
  soldoutUrlGa:"ga('send', 'event', 'isusoldbuy', 'buy', '3bundlepurchasebf-dbiuisu');"
}]
...
function getSales() {
  ...
  $.ajax({
    type: "GET",
    url: "bthreeb.php?pop=br_dbiuisu",
    ...
    success: function (res) {
      ...
      if (packs > 0) {
        $(window).unload(function () {
          packs = cGet('endbiuisu_p');
        });
        var total = cGet('endbiuisu_t');
...
function getReTime() {
  var packsNumTotal = cGet('endbiuisu_t');
  if (packsNumTotal > 1) {
