...
$(".floatlayer ul li").click(function() {
    ...
    if(index==1) {
      ...
      $(".floatlayer .price dt").html("<strong>$<b>14</b>.77</strong> <del>$49.99</del>")
    }
...
$('.review .next').click(function(event) {
  $('.review .roll').stop(true, true).animate({marginLeft: -800}, 'slow',function(){
...
$('.review .prev').click(function(event) {
  ...
  $('.review .roll').css('marginLeft', -800);
...
function getReTime() {
  var packsNumTotal = cGet('enbtwobiu_t');
  if (packsNumTotal > 1) {
