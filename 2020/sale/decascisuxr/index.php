...
<head>
  ...
  <title>80% OFF to Get ASC PRO & ISU PRO - Christmas Sale | IObit</title>
      ...
      <div class="content">
        ...
        <div class="right-message">
          ...
          <dl class="price">
            ...
            <dd><a href="https://www.iobit.com/buy.php?product=2020ascisu3pc1659&ref=xr_ascisu<?= $refStr; ?>&refs=purchase_2bundlexr"
                   onclick="ga('send', 'event', 'ascisubuy', 'buy', '2bundlepurchasexr-ascisu');" class="buybtn">Get It Now</a></dd>
      ...
      <div class="box">
        ...
        <dl>
          ...
          <dd><a href="https://www.iobit.com/buy.php?product=2020asc3pc1477&ref=xr_asc<?= $refStr; ?>&refs=purchase_2bundlexr"
                 onclick="ga('send', 'event', 'ascbuy', 'buy', '2bundlepurchasexr-ascisu');" class="border-buybtn">Get It Now</a></dd>
        </dl>
      </div>
      <div class="box right">
        ...
        <dl>
          ...
          <dd><a href="https://www.iobit.com/buy.php?product=2020isu3pc999&ref=xr_isu<?= $refStr; ?>&refs=purchase_2bundlexr"
                 onclick="ga('send', 'event', 'isubuy', 'buy', '2bundlepurchasexr-ascisu');   " class="border-buybtn">Get It Now</a></dd>
        </dl>
      </div>
  	</div>
        ...
        <div class="message">
          ...
          <dl class="price">
            ...
            <dd><a href="https://www.iobit.com/buy.php?product=2020asc3pc1477&ref=xr_ascsold<?= $refStr; ?>&refs=purchase_2bundlexr"
             		onclick="ga('send', 'event', 'ascsoldbuy', 'buy', '2bundlepurchasexr-ascisu');" class="buybtn">Get It Now</a></dd>
            <dd>1 Year / 3 PCs</dd>
          </dl>
        </div>
      </div>
        ...
        <div class="message">
          ...
          <dl class="price">
            ...
            <dd><a href="https://www.iobit.com/buy.php?product=2020isu3pc999&ref=xr_isusold<?= $refStr; ?>&refs=purchase_2bundlexr"
                   onclick="ga('send', 'event', 'isusoldbuy', 'buy', '2bundlepurchasexr-ascisu');    " class="buybtn">Get It Now</a></dd>
            <dd>1 Year / 3 PCs</dd>
          </dl>
        </div>
      </div>
				...
				<tr>
					...
					<th class="itema">
            			...
            			<a href="https://www.iobit.com/buy.php?product=2020asc3pc1477&ref=xr_asc<?= $refStr; ?>&refs=purchase_2bundlexr"
                 		   onclick="ga('send', 'event', 'ascbuy', 'buy', '2bundlepurchasexr-ascisu');" class="border-buybtn">Get It Now</a>
					</th>
					<th class="space"></th>
					<th class="itemb">
            			...
            			<a href="https://www.iobit.com/buy.php?product=2020isu3pc999&ref=xr_isu<?= $refStr; ?>&refs=purchase_2bundlexr"
                 		   onclick="ga('send', 'event', 'isubuy', 'buy', '2bundlepurchasexr-ascisu');   " class="border-buybtn">Get It Now</a>
					</th>
					<th class="space"></th>
					<th class="itemc">
						<p><strong>$<b>16</b>.59</strong> <del>$82.98</del></p>
						<a href="https://www.iobit.com/buy.php?product=2020ascisu3pc1659&ref=xr_ascisu<?= $refStr; ?>&refs=purchase_2bundlexr"
                   		   onclick="ga('send', 'event', 'ascisubuy', 'buy', '2bundlepurchasexr-ascisu');" class="buybtn">Get It Now</a>
					</th>
				</tr>
			</tfoot> 
		</table>
...
<div id="floatlayer" class="floatlayer">
  <div class="wrapper default  clearfix">
    ...
    <div class="numer">
      ...
      <dd><a class="buybtn"
	 		 href="https://www.iobit.com/buy.php?product=2020ascisu3pc1659&ref=xr_ascisu<?= $refStr; ?>&refs=purchase_2bundlexr"
             onclick="ga('send', 'event', 'ascisubuy', 'buy', '2bundlepurchasexr-ascisu');" >
			Get It Now
      </a></dd>
    </dl>
  </div>
  <div class="wrapper soldout hide clearfix">
    ...
    <ul class="change">
      ...
      <dd><a class="buybtn"
             ...
             onclick="ga('send', 'event', 'ascsoldbuy', 'buy', '2bundlepurchasexr-ascisu');">
		 Get It Now
      </a></dd>
    </dl>
  </div>
