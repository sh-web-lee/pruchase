...
if ($_GET['action'] == 'getPacks') {
  $date = $_GET['d'];
  $c_name = 'enbtwobiusd_p' . $date;
  $c_name_t='enbtwobiusd_t' . $date;
...
<head>
  ...
  <title> 80% OFF to Get IU PRO & SD PRO - Christmas Sale | IObit</title>
      ...
      <div class="content">
        ...
        <div class="right-message">
          ...
          <dl class="price">
            ...
            <dd><a href="https://www.iobit.com/buy.php?product=2020iusd3pc1659&ref=xr_iusd<?= $refStr; ?>&refs=purchase_2bundlexr"
             	   onclick="ga('send', 'event', 'iusdbuy', 'buy', '2bundlepurchasexr-iusd'); " class="buybtn">Get It Now</a></dd>
      ...
      <div class="box">
        ...
        <dl>
          ...
          <dd><a href="https://www.iobit.com/buy.php?product=2020iu3pc1297&ref=xr_iu<?= $refStr; ?>&refs=purchase_2bundlexr"
                 onclick="ga('send', 'event', 'iubuy', 'buy', '2bundlepurchasexr-iusd');" class="border-buybtn">Get It Now</a></dd>
        </dl>
      </div>
      <div class="box right">
        ...
        <dl>
          ...
          <dd><a href="https://www.iobit.com/buy.php?product=2020sd3pc1199&ref=xr_sd<?= $refStr; ?>&refs=purchase_2bundlexr"
                 onclick="ga('send', 'event', 'sdbuy', 'buy', '2bundlepurchasexr-iusd');" class="border-buybtn">Get It Now</a></dd>
        </dl>
      </div>
  	</div>
        ...
        <div class="message">
          ...
          <dl class="price">
            ...
            <dd><a href=" https://www.iobit.com/buy.php?product=2020iu3pc1297&ref=xr_iusold<?= $refStr; ?>&refs=purchase_2bundlexr"
                   onclick="ga('send', 'event', 'iusoldbuy', 'buy', '2bundlepurchasexr-iusd');" class="buybtn">Get It Now</a></dd>
            <dd>1 Year / 3 PCs</dd>
          </dl>
        </div>
      </div>
        ...
        <div class="message">
          ...
          <dl class="price">
            ...
            <dd><a href="https://www.iobit.com/buy.php?product=2020sd3pc1199&ref=xr_sdsold<?= $refStr; ?>&refs=purchase_2bundlexr"
                   onclick="ga('send', 'event', 'sdsoldbuy', 'buy', '2bundlepurchasexr-iusd');" class="buybtn">Get It Now</a></dd>
            <dd>1 Year / 3 PCs</dd>
          </dl>
        </div>
      </div>
...
<div class="compare">
	<div class="wrapper">
		...
		<p>of both IObit Uninstaller and Smart Defrag</p>
		<table>
			<thead>
				<tr>
					<th class="text"></th>
				...
				<tr>
					...
					<th class="itema">
            			...
            			<a href="https://www.iobit.com/buy.php?product=2020iu3pc1297&ref=xr_iu<?= $refStr; ?>&refs=purchase_2bundlexr"
                 		   onclick="ga('send', 'event', 'iubuy', 'buy', '2bundlepurchasexr-iusd');" class="border-buybtn">Get It Now</a>
					</th>
					<th class="space"></th>
					<th class="itemb">
            			...
            			<a href="https://www.iobit.com/buy.php?product=2020sd3pc1199&ref=xr_sd<?= $refStr; ?>&refs=purchase_2bundlexr"
                 		   onclick="ga('send', 'event', 'sdbuy', 'buy', '2bundlepurchasexr-iusd');" class="border-buybtn">Get It Now</a>
					</th>
					<th class="space"></th>
					<th class="itemc">
						<p><strong>$<b>16</b>.59</strong> <del>$82.98</del></p>
						<a href="https://www.iobit.com/buy.php?product=2020iusd3pc1659&ref=xr_iusd<?= $refStr; ?>&refs=purchase_2bundlexr"
             			   onclick="ga('send', 'event', 'iusdbuy', 'buy', '2bundlepurchasexr-iusd');   " class="buybtn">Get It Now</a>
					</th>
				</tr>
			</tfoot> 
		</table>
...
<div id="floatlayer" class="floatlayer">
  <div class="wrapper default  clearfix">
    ...
    <div class="numer">
      ...
      <dd><a class="buybtn"
			       href="https://www.iobit.com/buy.php?product=2020iusd3pc1659&ref=xr_iusd<?= $refStr; ?>&refs=purchase_2bundlexr"
             			   onclick="ga('send', 'event', 'iusdbuy', 'buy', '2bundlepurchasexr-iusd');   ">
			Get It Now
      </a></dd>
    </dl>
  </div>
  <div class="wrapper soldout hide clearfix">
    ...
    <ul class="change">
      ...
      <dd><a class="buybtn"
             ...
             onclick="ga('send', 'event', 'iusoldbuy', 'buy', '2bundlepurchasexr-iusd');">
		 Get It Now
      </a></dd>
    </dl>
  </div>
