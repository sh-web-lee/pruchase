			...
			<div class="right box">
				<dl>
					...
					<dd>
						...
						<a 
						href="https://www.iobit.com/buy.php?product=2020ascdbimf3694&ref=xr_ascdbimf<?= $refStr; ?>&refs=purchase_3bundlexr"
						onclick="ga('send', 'event', 'ascdbimfbuy', 'buy', '3bundlepurchasexr-ascdbimf');" >
			...
			<dd>
				...
				<div class="buy-btn clearfix">
					...
					<a 
						...
						onclick="ga('send', 'event', 'ascbuy', 'buy', '3bundlepurchasexr-ascdbimf');" >
			...
			<dd>
				...
				<div class="buy-btn clearfix">
					...
					<a 
						...
						onclick="ga('send', 'event', 'dbbuy', 'buy', '3bundlepurchasexr-ascdbimf');" >
					<button class="buy-new"><i></i> Buy Now</button>
					</a>
				</div>
			</dd>
			...
			<dd>
				...
				<div class="buy-btn clearfix">
					...
					<a 
						...
						onclick="ga('send', 'event', 'imfbuy', 'buy', '3bundlepurchasexr-ascdbimf');" >
					<button class="buy-new"><i></i> Buy Now</button>
					</a>
				</div>
			</dd>
