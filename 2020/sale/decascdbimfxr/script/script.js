...
var bannerObject = [{
  ...
  url:'https://www.iobit.com/buy.php?product=2020ascdbimf3694&ref=xr_ascdbimf'+refStr+'&refs=purchase_3bundlexr&tw='+tw,
  ga:"ga('send', 'event', 'ascdbimfbuy', 'buy', '3bundlepurchasexr-ascdbimf')"
},
{
  className:'two',
  ...
  ga:"ga('send', 'event', 'ascbuy', 'buy', '3bundlepurchasexr-ascdbimf')",
},
{
  className:'three',
  ...
  ga:"ga('send', 'event', 'imfbuy', 'buy', '3bundlepurchasexr-ascdbimf')",
},
{
  className:'four',
  ...
  ga:"ga('send', 'event', 'dbbuy', 'buy', '3bundlepurchasexr-ascdbimf')",
}]
...
function getSales() {
  ...
  $.ajax({
    type: "GET",
    url: "xthreeb.php?pop=br_ascdbimf",
