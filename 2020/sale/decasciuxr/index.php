...
<head>
  ...
  <title>80% OFF to Get ASC PRO & IU PRO - Christmas Sale | IObit</title>
      ...
      <div class="content">
        ...
        <div class="right-message">
          ...
          <dl class="price">
            ...
            <dd><a href="https://www.iobit.com/buy.php?product=2020asciu3pc1859&ref=xr_asciu<?= $refStr; ?>&refs=purchase_2bundlexr"
                   onclick="ga('send', 'event', 'asciubuy', 'buy', '2bundlepurchasexr-asciu');" class="buybtn">Get It Now</a></dd>
      ...
      <div class="box">
        ...
        <dl>
          ...
          <dd><a href="https://www.iobit.com/buy.php?product=2020asc3pc1477&ref=xr_asc<?= $refStr; ?>&refs=purchase_2bundlexr"
                 onclick="ga('send', 'event', 'ascbuy', 'buy', '2bundlepurchasexr-asciu');" class="border-buybtn">Get It Now</a></dd>
        </dl>
      </div>
      <div class="box right">
        ...
        <dl>
          ...
          <dd><a href="https://www.iobit.com/buy.php?product=2020iu3pc1297&ref=xr_iu<?= $refStr; ?>&refs=purchase_2bundlexr"
                 onclick="ga('send', 'event', 'iubuy', 'buy', '2bundlepurchasexr-asciu');  " class="border-buybtn">Get It Now</a></dd>
        </dl>
      </div>
  	</div>
        ...
        <div class="message">
          ...
          <dl class="price">
            ...
            <dd><a href="https://www.iobit.com/buy.php?product=2020asc3pc1477&ref=xr_ascsold<?= $refStr; ?>&refs=purchase_2bundlexr"
             		onclick="ga('send', 'event', 'ascsoldbuy', 'buy', '2bundlepurchasexr-asciu');  " class="buybtn">Get It Now</a></dd>
            <dd>1 Year / 3 PCs</dd>
          </dl>
        </div>
      </div>
        ...
        <div class="message">
          ...
          <dl class="price">
            ...
            <dd><a href="https://www.iobit.com/buy.php?product=2020iu3pc1297&ref=xr_iusold<?= $refStr; ?>&refs=purchase_2bundlexr"
                   onclick="ga('send', 'event', 'iusoldbuy', 'buy', '2bundlepurchasexr-asciu');" class="buybtn">Get It Now</a></dd>
            <dd>1 Year / 3 PCs</dd>
          </dl>
        </div>
      </div>
				...
				<tr>
					...
					<th class="itema">
            			...
            			<a href="https://www.iobit.com/buy.php?product=2020asc3pc1477&ref=xr_asc<?= $refStr; ?>&refs=purchase_2bundlexr"
                 		   onclick="ga('send', 'event', 'ascbuy', 'buy', '2bundlepurchasexr-asciu');" class="border-buybtn">Get It Now</a>
					</th>
					<th class="space"></th>
					<th class="itemb">
            			...
            			<a href="https://www.iobit.com/buy.php?product=2020iu3pc1297&ref=xr_iu<?= $refStr; ?>&refs=purchase_2bundlexr"
                 			onclick="ga('send', 'event', 'iubuy', 'buy', '2bundlepurchasexr-asciu');  " class="border-buybtn">Get It Now</a>
					</th>
					<th class="space"></th>
					<th class="itemc">
						<p><strong>$<b>18</b>.59</strong> <del>$92.98</del></p>
						<a href="https://www.iobit.com/buy.php?product=2020asciu3pc1859&ref=xr_asciu<?= $refStr; ?>&refs=purchase_2bundlexr"
                   			onclick="ga('send', 'event', 'asciubuy', 'buy', '2bundlepurchasexr-asciu');" class="buybtn">Get It Now</a>
					</th>
				</tr>
			</tfoot> 
		</table>
...
<div id="floatlayer" class="floatlayer">
  <div class="wrapper default  clearfix">
    ...
    <div class="numer">
      ...
      <dd><a class="buybtn"
	  		 href="https://www.iobit.com/buy.php?product=2020asciu3pc1859&ref=xr_asciu<?= $refStr; ?>&refs=purchase_2bundlexr"
             onclick="ga('send', 'event', 'asciubuy', 'buy', '2bundlepurchasexr-asciu');" >
			Get It Now
      </a></dd>
    </dl>
  </div>
  <div class="wrapper soldout hide clearfix">
    ...
    <ul class="change">
      ...
      <dd><a class="buybtn"
             ...
             onclick="ga('send', 'event', 'ascsoldbuy', 'buy', '2bundlepurchasexr-asciu');  ">
		 Get It Now
      </a></dd>
    </dl>
  </div>
