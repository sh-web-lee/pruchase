...
var bannerObject = [{
  ...
  url:'https://www.iobit.com/buy.php?product=2020asciuisu2296&ref=xr_asciuisu'+refStr+'&refs=purchase_3bundlexrtw='+tw,
  ga:"ga('send', 'event', 'asciuisubuy', 'buy', '3bundlepurchasexr-asciuisu');"
},
{
  className:'two',
  ...
  ga:"ga('send', 'event', 'ascbuy', 'buy', '3bundlepurchasexr-asciuisu');",
  soldoutUrlGa:"ga('send', 'event', 'ascsoldbuy', 'buy', '3bundlepurchasexr-asciuisu');"
},
{
  className:'three',
  ...
  ga:"ga('send', 'event', 'iubuy', 'buy', '3bundlepurchasexr-asciuisu');",
  soldoutUrlGa:"ga('send', 'event', 'iusoldbuy', 'buy', '3bundlepurchasexr-asciuisu');"
},
{
  className:'four',
  ...
  ga:"ga('send', 'event', 'isubuy', 'buy', '3bundlepurchasexr-asciuisu');",
  soldoutUrlGa:"ga('send', 'event', 'isusoldbuy', 'buy', '3bundlepurchasexr-asciuisu');"
}]
...
function getSales() {
  ...
  $.ajax({
    type: "GET",
    url: "xthreeb.php?pop=xr_asciuisu",
