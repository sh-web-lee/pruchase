...
var bannerObject = [{
  ...
  url:'https://www.iobit.com/buy.php?product=2020dbimfisu2698&ref=xr_dbimfisu'+refStr+'&refs=purchase_3bundlexr&tw='+tw,
  ga:"ga('send', 'event', 'dbimfisubuy', 'buy', '3bundlepurchasexr-dbimfisu');"
},
{
  className:'two',
  ...
  ga:"ga('send', 'event', 'dbbuy', 'buy', '3bundlepurchasexr-dbimfisu');",
  soldoutUrlGa:"ga('send', 'event', 'dbsoldbuy', 'buy', '3bundlepurchasexr-dbimfisu');"
},
{
  className:'three',
  ...
  ga:"ga('send', 'event', 'imfbuy', 'buy', '3bundlepurchasexr-dbimfisu');",
  soldoutUrlGa:"ga('send', 'event', 'imfsoldbuy', 'buy', '3bundlepurchasexr-dbimfisu');"
},
{
  className:'four',
  ...
  ga:"ga('send', 'event', 'isubuy', 'buy', '3bundlepurchasexr-dbimfisu');",
  soldoutUrlGa:"ga('send', 'event', 'isusoldbuy', 'buy', '3bundlepurchasexr-dbimfisu');"
}]
...
function getSales() {
  ...
  $.ajax({
    type: "GET",
    url: "xthreeb.php?pop=xr_dbimfisu",
