...
if ($_GET['action'] == 'getPacks') {
  $date = $_GET['d'];
  $c_name = 'endbimfisu_p' . $date;
  $c_name_t='endbimfisu_t' . $date;
		...
		<div class="change clearfix">
			...
			<div class="right box">
				<dl>
					...
					<dd>
						<p class="clearfix"><span>Subtotal</span><span class="Subtotal right">$162.79</span></p>
						...
						<a 
						href="https://www.iobit.com/buy.php?product=2020dbimfisu2698&ref=br_dbimfisu<?= $refStr; ?>&refs=purchase_3bundlebf"
						onclick="ga('send', 'event', 'dbimfisubuy', 'buy', '3bundlepurchasebf-dbimfisu');" >
			...
			<dd>
				...
				<div class="buy-btn clearfix">
					...
					<a 
						...
						onclick="ga('send', 'event', 'dbbuy', 'buy', '3bundlepurchasebf-dbimfisu');" >
			...
			<dd>
				...
				<div class="buy-btn clearfix">
					...
					<a 
						...
						onclick="ga('send', 'event', 'imfbuy', 'buy', '3bundlepurchasebf-dbimfisu');" >
					<button class="buy-new"><i></i> Buy Now</button>
					</a>
				</div>
			</dd>
			...
			<dd>
				...
				<div class="buy-btn clearfix">
					...
					<a 
						...
						onclick="ga('send', 'event', 'isubuy', 'buy', '3bundlepurchasebf-dbimfisu');" >
					<button class="buy-new"><i></i> Buy Now</button>
					</a>
				</div>
			</dd>
...
<div id="floatlayer" class="floatlayer">
	<img class="bg" src="<?php echo getStaticUrl('images/fl-bg.png')?>" alt=""/>	
  	<div class="wrapper default  clearfix">
		...
		<div class="price fr">
			<div class="buy-btn clearfix">
				<span><strong>$<b>26</b>.98 </strong> <del>$162.97</del></span>
				<a 
						href="https://www.iobit.com/buy.php?product=2020dbimfisu2698&ref=br_dbimfisu<?= $refStr; ?>&refs=purchase_3bundlebf"
						onclick="ga('send', 'event', 'dbimfisubuy', 'buy', '3bundlepurchasebf-dbimfisu');" >
				<button class="buy-new"><i></i> Buy Now</button>
