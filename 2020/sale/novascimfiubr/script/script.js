...
var bannerObject = [{
  className:'one',
  body:'<tr><td>Advanced SystemCare 14 PRO</td><td>3 PCs</td><td>$49.99</td><td>$0</td></tr><tr><td>IObit Uninstaller 10 PRO</td><td>3 PCs</td><td>$42.99</td><td>$12.97</td></tr><tr><td>IObit Malware Fighter 8 PRO</td><td>3 PCs</td><td>$54.95</td><td>$16.99</td></tr>',
  Discount:'70% OFF + Free Gift',
  Subtotal:'$147.93',
  Total:'$29.96',
  
  url:'https://www.iobit.com/buy.php?product=2020ascimfiu2996gift&ref=br_ascimfiu'+refStr+'&refs=purchase_3bundlebf&tw='+tw,
  ga:"ga('send', 'event', 'ascimfiubuy', 'buy', '3bundlepurchasebf-ascimfiu')"
},
{
  className:'two',
  ...
  ga:"ga('send', 'event', 'ascbuy', 'buy', '3bundlepurchasebf-ascimfiu')",
  soldoutUrlGa:"ga('send', 'event', 'ascsoldbuy', 'buy', '3bundlepurchasebf-ascimfiu')"
},
{
  className:'three',
  ...
  ga:"ga('send', 'event', 'imfbuy', 'buy', '3bundlepurchasebf-ascimfiu')",
  soldoutUrlGa:"ga('send', 'event', 'imfsoldbuy', 'buy', '3bundlepurchasebf-ascimfiu')"
},
{
  className:'four',
  ...
  ga:"ga('send', 'event', 'iubuy', 'buy', '3bundlepurchasebf-ascimfiu')",
  soldoutUrlGa:"ga('send', 'event', 'iusoldbuy', 'buy', '3bundlepurchasebf-ascimfiu')"
}]
...
function getSales() {
  ...
  $.ajax({
    type: "GET",
    url: "bthreeb.php?pop=br_ascimfiu",
    ...
    success: function (res) {
      ...
      if (packs > 0) {
        $(window).unload(function () {
          packs = cGet('enascimfiu_p');
        });
        var total = cGet('enascimfiu_t');
...
function getReTime() {
  var packsNumTotal = cGet('enascimfiu_t');
  if (packsNumTotal > 1) {
