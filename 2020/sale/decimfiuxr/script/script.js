...
$(".floatlayer ul li").click(function() {
    ...
    if(index==1) {
      ...
      $(".floatlayer .price dt").html("<strong>$<b>12</b>.97</strong> <del>$42.99</del>")
    }
    else {
      $(".floatlayer .img-box").removeClass("db")
      $(".floatlayer .price dt").html("<strong>$<b>16</b>.99</strong> <del>$54.95</del>")
    }
...
function getReTime() {
  var packsNumTotal = cGet('enbtwobimfiu_t');
  if (packsNumTotal > 1) {
