...
<head>
  ...
  <title>80% OFF to Get IMF PRO & IU PRO - Christmas Sale | IObit  </title>
      ...
      <div class="content">
        ...
        <div class="right-message">
          ...
          <dl class="price">
            ...
            <dd><a href="https://www.iobit.com/buy.php?product=2020imfiu3pc1959&ref=xr_imfiu<?= $refStr; ?>&refs=purchase_2bundlexr"
                   onclick="ga('send', 'event', 'imfiubuy', 'buy', '2bundlepurchasexr-imfiu');  "class="buybtn">Get It Now</a></dd>
      ...
      <div class="box">
        ...
        <dl>
          ...
          <dd><a href="https://www.iobit.com/buy.php?product=2020imf3pc1699&ref=xr_imf<?= $refStr; ?>&refs=purchase_2bundlexr"
                 onclick="ga('send', 'event', 'imfbuy', 'buy', '2bundlepurchasexr-imfiu');" class="border-buybtn">Get It Now</a></dd>
        </dl>
      </div>
      <div class="box right">
        ...
        <dl>
          ...
          <dd><a href="https://www.iobit.com/buy.php?product=2020iu3pc1297&ref=xr_iu<?= $refStr; ?>&refs=purchase_2bundlexr"
                 onclick="ga('send', 'event', 'iubuy', 'buy', '2bundlepurchasexr-imfiu');" class="border-buybtn">Get It Now</a></dd>
        </dl>
      </div>
  </div>
        ...
        <div class="message">
          ...
          <dl class="price">
            ...
            <dd><a href="https://www.iobit.com/buy.php?product=2020imf3pc1699&ref=xr_imfsold<?= $refStr; ?>&refs=purchase_2bundlexr"
             	   onclick="ga('send', 'event', 'imfsoldbuy', 'buy', '2bundlepurchasexr-imfiu');" class="buybtn">Get It Now</a></dd>
            <dd>1 Year / 3 PCs</dd>
          </dl>
        </div> 
      </div>
        ...
        <div class="message">
          ...
          <dl class="price">
            ...
            <dd><a href="https://www.iobit.com/buy.php?product=2020iu3pc1297&ref=xr_iusold<?= $refStr; ?>&refs=purchase_2bundlexr"
                   onclick="ga('send', 'event', 'iusoldbuy', 'buy', '2bundlepurchasexr-imfiu');" class="buybtn">Get It Now</a></dd>
            <dd>1 Year / 3 PCs</dd>
          </dl>
        </div>
      </div>
				...
				<tr>
					...
					<th class="itema">
            			...
            			<a href="https://www.iobit.com/buy.php?product=2020imf3pc1699&ref=xr_imf<?= $refStr; ?>&refs=purchase_2bundlexr"
                 		   onclick="ga('send', 'event', 'imfbuy', 'buy', '2bundlepurchasexr-imfiu');"  class="border-buybtn">Get It Now</a>
					</th>
					<th class="space"></th>
					<th class="itemb">
            			...
            			<a href="https://www.iobit.com/buy.php?product=2020iu3pc1297&ref=xr_iu<?= $refStr; ?>&refs=purchase_2bundlexr"
                 		   onclick="ga('send', 'event', 'iubuy', 'buy', '2bundlepurchasexr-imfiu');"class="border-buybtn">Get It Now</a>
					</th>
					<th class="space"></th>
					<th class="itemc">
						<p><strong>$<b>19</b>.59</strong> <del>$97.94</del></p>
						<a href="https://www.iobit.com/buy.php?product=2020imfiu3pc1959&ref=xr_imfiu<?= $refStr; ?>&refs=purchase_2bundlexr"
                   		   onclick="ga('send', 'event', 'imfiubuy', 'buy', '2bundlepurchasexr-imfiu');  " class="buybtn">Get It Now</a>
					</th>
				</tr>
			</tfoot> 
		</table>
...
<div id="floatlayer" class="floatlayer">
  <div class="wrapper default  clearfix">
    ...
    <div class="numer">
      ...
      <dd><a class="buybtn" href="https://www.iobit.com/buy.php?product=2020imfiu3pc1959&ref=xr_imfiu<?= $refStr; ?>&refs=purchase_2bundlexr"
                   onclick="ga('send', 'event', 'imfiubuy', 'buy', '2bundlepurchasexr-imfiu');  ">
			Get It Now
      </a></dd>
    </dl>
  </div>
  <div class="wrapper soldout hide clearfix">
    ...
    <ul class="change">
      ...
      <dd><a class="buybtn"
             ...
             onclick="ga('send', 'event', 'imfsoldbuy', 'buy', '2bundlepurchasexr-imfiu');">
		 Get It Now
      </a></dd>
    </dl>
  </div>
