...
if ($_GET['action'] == 'getPacks') {
  $date = $_GET['d'];
  $c_name = 'enbtwobisu_p' . $date;
  $c_name_t='enbtwobisu_t' . $date;
...
<head>
  ...
  <title>80% OFF to Get ASC PRO & ISU PRO - Black Friday Sale | IObit</title>
   ...
   <div class="default">
      <div class="content">
        ...
        <div class="right-message">
          ...
          <dl class="price">
            <dt>Only <strong>$<b>16</b>.59</strong> <del>$82.98</del></dt>
            <dd><a href="https://www.iobit.com/buy.php?product=2020ascisu3pc1659&ref=br_ascisu<?= $refStr; ?>&refs=purchase_2bundlebf"
                   onclick="ga('send', 'event', 'ascisubuy', 'buy', '2bundlepurchasebf-ascisu');" class="buybtn">Get It Now</a></dd>
      ...
      <div class="box">
        ...
        <dl>
          ...
          <dd><a href="https://www.iobit.com/buy.php?product=2020asc3pc1477&ref=br_asc<?= $refStr; ?>&refs=purchase_2bundlebf"
                 onclick="ga('send', 'event', 'ascbuy', 'buy', '2bundlepurchasebf-ascisu');" class="border-buybtn">Get It Now</a></dd>
        </dl>
      </div>
      <div class="box right">
        ...
        <dl>
          ...
          <dd><a href="https://www.iobit.com/buy.php?product=2020isu3pc999&ref=br_isu<?= $refStr; ?>&refs=purchase_2bundlebf"
                 onclick="ga('send', 'event', 'isubuy', 'buy', '2bundlepurchasebf-ascisu');   " class="border-buybtn">Get It Now</a></dd>
        </dl>
      </div>
  	</div>
        ...
        <div class="message">
          ...
          <dl class="price">
            ...
            <dd><a href="https://www.iobit.com/buy.php?product=2020asc3pc1477&ref=br_ascsold<?= $refStr; ?>&refs=purchase_2bundlebf"
             		onclick="ga('send', 'event', 'ascsoldbuy', 'buy', '2bundlepurchasebf-ascisu');" class="buybtn">Get It Now</a></dd>
            <dd>1 Year / 3 PCs</dd>
          </dl>
        </div>
      </div>
      <div class="box db">
        ...
        <div class="message">
          ...
          <dl class="price">
            ...
            <dd><a href="https://www.iobit.com/buy.php?product=2020isu3pc999&ref=br_isusold<?= $refStr; ?>&refs=purchase_2bundlebf"
                   onclick="ga('send', 'event', 'isusoldbuy', 'buy', '2bundlepurchasebf-ascisu');    " class="buybtn">Get It Now</a></dd>
            <dd>1 Year / 3 PCs</dd>
          </dl>
        </div>
      </div>
...
<div class="compare">
	<div class="wrapper">
		...
		<p>of both Advanced SystemCare and IObit Software Updater</p>
		<table>
			<thead>
				<tr>
					<th class="text"></th>
				...
				<tr>
					...
					<th class="itema">
            			...
            			<a href="https://www.iobit.com/buy.php?product=2020asc3pc1477&ref=br_asc<?= $refStr; ?>&refs=purchase_2bundlebf"
                 		   onclick="ga('send', 'event', 'ascbuy', 'buy', '2bundlepurchasebf-ascisu');" class="border-buybtn">Get It Now</a>
					</th>
					<th class="space"></th>
					<th class="itemb">
						<p><strong>$<b>9</b>.99</strong> <del>$32.99</del></p>
            			<a href="https://www.iobit.com/buy.php?product=2020isu3pc999&ref=br_isu<?= $refStr; ?>&refs=purchase_2bundlebf"
                 		   onclick="ga('send', 'event', 'isubuy', 'buy', '2bundlepurchasebf-ascisu');   " class="border-buybtn">Get It Now</a>
					</th>
					<th class="space"></th>
					<th class="itemc">
						<p><strong>$<b>16</b>.59</strong> <del>$82.98</del></p>
						<a href="https://www.iobit.com/buy.php?product=2020ascisu3pc1659&ref=br_ascisu<?= $refStr; ?>&refs=purchase_2bundlebf"
                   		   onclick="ga('send', 'event', 'ascisubuy', 'buy', '2bundlepurchasebf-ascisu');" class="buybtn">Get It Now</a>
					</th>
				</tr>
			</tfoot> 
		</table>
...
<div id="floatlayer" class="floatlayer">
  <div class="wrapper default  clearfix">
    ...
    <div class="numer">
      ...
      <dl class="price fr">
      <dt><strong>$<b>16</b>.59</strong> <del>$82.98</del></dt>
      <dd><a class="buybtn"
	 		 href="https://www.iobit.com/buy.php?product=2020ascisu3pc1659&ref=br_ascisu<?= $refStr; ?>&refs=purchase_2bundlebf"
             onclick="ga('send', 'event', 'ascisubuy', 'buy', '2bundlepurchasebf-ascisu');" >
			Get It Now
      </a></dd>
    </dl>
  </div>
  <div class="wrapper soldout hide clearfix">
    ...
    <ul class="change">
      ...
      <dd><a class="buybtn"
             ...
             onclick="ga('send', 'event', 'ascsoldbuy', 'buy', '2bundlepurchasebf-ascisu');">
		 Get It Now
      </a></dd>
    </dl>
  </div>
