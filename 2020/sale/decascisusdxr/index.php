...
if ($_GET['action'] == 'getPacks') {
  $date = $_GET['d'];
  $c_name = 'enascisusd_p' . $date;
  $c_name_t='enascisusd_t' . $date;
		...
		<div class="change clearfix">
			...
			<div class="right box">
				<dl>
					...
					<dd>
						<p class="clearfix"><span>Subtotal</span><span class="Subtotal right">122.97 </span></p>
						...
						<a 
						href="https://www.iobit.com/buy.php?product=2020ascisusd2198&ref=xr_ascisusd<?= $refStr; ?>&refs=purchase_3bundlexr"
						onclick="ga('send', 'event', 'ascisusdbuy', 'buy', '3bundlepurchasexr-ascisusd');" >
			...
			<dd>
				...
				<div class="buy-btn clearfix">
					...
					<a 
						...
						onclick="ga('send', 'event', 'ascbuy', 'buy', '3bundlepurchasexr-ascisusd');" >
			...
			<ul class="clearfix as">
				...
				<div class="buy-btn clearfix">
					...
					<a 
						...
						onclick="ga('send', 'event', 'isubuy', 'buy', '3bundlepurchasexr-ascisusd');" >
					<button class="buy-new"><i></i> Buy Now</button>
					</a>
				</div>
			</dd>
			...
			<dd>
				...
				<div class="buy-btn clearfix">
					...
					<a 
						...
						onclick="ga('send', 'event', 'sdbuy', 'buy', '3bundlepurchasexr-ascisusd');" >
					<button class="buy-new"><i></i> Buy Now</button>
					</a>
				</div>
			</dd>
...
<div id="floatlayer" class="floatlayer">
	<img class="bg" src="<?php echo getStaticUrl('images/fl-bg.png')?>" alt=""/>	
  	<div class="wrapper default  clearfix">
		...
		<div class="price fr">
			<div class="buy-btn clearfix">
				<span><strong>$<b>21</b>.98</strong> <del>$122.97</del></span>
				<a 
						href="https://www.iobit.com/buy.php?product=2020ascisusd2198&ref=xr_ascisusd<?= $refStr; ?>&refs=purchase_3bundlexr"
						onclick="ga('send', 'event', 'ascisusdbuy', 'buy', '3bundlepurchasexr-ascisusd');" >
				<button class="buy-new"><i></i> Buy Now</button>
