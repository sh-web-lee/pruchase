...
var bannerObject = [{
  className:'one',
  body:'<tr><td>Advanced SystemCare 14 PRO</td><td>3 PCs</td><td>$49.99</td><td>$0</td></tr><tr><td>Smart Defrag 6 PRO </td><td>3 PCs</td><td>$39.99</td><td>$11.99</td></tr><tr><td>IObit Software Updater 3 PRO</td><td>3 PCs</td><td>$32.99</td><td>$9.99</td></tr>',
  Discount:'70% OFF + Free Gift',
  Subtotal:'$122.97',
  Total:'$21.98',
  url:'https://www.iobit.com/buy.php?product=2020ascisusd2198&ref=xr_ascisusd'+refStr+'&refs=purchase_3bundlexrtw='+tw,
  ga:"ga('send', 'event', 'ascisusdbuy', 'buy', '3bundlepurchasexr-ascisusd');"
},
{
  className:'two',
  ...
  ga:"ga('send', 'event', 'ascbuy', 'buy', '3bundlepurchasexr-ascisusd');",
  soldoutUrlGa:"ga('send', 'event', 'ascsoldbuy', 'buy', '3bundlepurchasexr-ascisusd');"
},
{
  className:'three',
  ...
  ga:"ga('send', 'event', 'isubuy', 'buy', '3bundlepurchasexr-ascisusd');",
...
},
{
  ...
  ga:"ga('send', 'event', 'sdbuy', 'buy', '3bundlepurchasexr-ascisusd');",
...
function getSales() {
  ...
  $.ajax({
    type: "GET",
    url: "xthreeb.php?pop=xr_ascisusd",
    ...
    success: function (res) {
      ...
      if (packs > 0) {
        $(window).unload(function () {
          packs = cGet('enascisusd_p');
        });
        var total = cGet('enascisusd_t');
...
function getReTime() {
  var packsNumTotal = cGet('enascisusd_t');
  if (packsNumTotal > 1) {
