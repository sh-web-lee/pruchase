...
if ($_GET['action'] == 'getPacks') {
  $date = $_GET['d'];
  $c_name = 'decascdbimfisusdxr' . $date;
				...
				<div class="saleseordercnt">
					...
					<div class="saleseorder-cont">
						<div class="saleseorder-items">
							...
							<div class="saleseorder-price"><p>$<span class="orprice">252.77</p></span></div>
						</div>
						<div class="saleseorder-discount">
							<div class="saleseorder-name"><p>DISCOUNT (<span class="saleratio">90</span>% OFF) </p></div>
							<div class="saleseorder-price"><p>-$<span class="salernum">227.49</span></p></div>
						</div>
					</div>
					<div class="saleseorder-buy">
						<div class="saleseorder-total">
							<div class="saleseorder-name"><p><span>Total</span></p></div>
							<div class="saleseorder-price"><p>$<span class="salertotal">25.28</span></p></div>
						</div>
						<a href="https://www.iobit.com/buy.php?product=2020ascdbimfisusd2528&ref=xr_ascdbimfisusd<?= $refStr; ?>&refs=purchase_5bundlexr" onclick="ga('send', 'event', 'ascdbimfisusdbuy', 'buy', '5bundlepurchasexr-ascdbimfisusd');" class="buybtn banbuybtn"><span>Buy Now</span></a>
					</div>
				</div>
			</div>
		</div>
					...
					<div class="salekeep-cntdes clearfix">
						...
						<div class="salekeep-cntstore">
							...
							<div class="salekeep-cntprice">
								...
								<a href="https://www.iobit.com/buy.php?product=2020asc3pc1477&ref=xr_asc<?= $refStr; ?>&refs=purchase_5bundlexr" onclick="ga('send', 'event', 'ascbuy', 'buy', '5bundlepurchasexr-ascdbimfisusd');" class="buybtn"><span>Buy Now</span></a>
					...
					<div class="salekeep-cntdes clearfix">
						...
						<div class="salekeep-cntstore">
							...
							<div class="salekeep-cntprice">
								...
								<a href="https://www.iobit.com/buy.php?product=2020db3pc1995&ref=xr_db<?= $refStr; ?>&refs=purchase_5bundlexr" onclick="ga('send', 'event', 'dbbuy', 'buy', '5bundlepurchasexr-ascdbimfisusd');" class="buybtn"><span>Buy Now</span></a>
								<div class="salekeep-cnttips">1 Year / 3 PCs</div>
							</div>
						</div>
					</div>
		...
		<div class="saleenjoy-cont clearfix">
			<div class="saleenjoy-probox saleenjoy-probox1 fl">
				<div class="saleenjoy-proboxcnt">
					...
					<a href="https://www.iobit.com/buy.php?product=2020imf3pc1699&ref=xr_imf<?= $refStr; ?>&refs=purchase_5bundlexr" onclick="ga('send', 'event', 'imfbuy', 'buy', '5bundlepurchasexr-ascdbimfisusd');" class="buybtn"><span>Buy Now</span></a>
			...
			<div class="saleenjoy-probox saleenjoy-probox2 fl">
				<div class="saleenjoy-proboxcnt">
					...
					<a href="https://www.iobit.com/buy.php?product=2020isu3pc999&ref=xr_isu<?= $refStr; ?>&refs=purchase_5bundlexr" onclick="ga('send', 'event', 'isubuy', 'buy', '5bundlepurchasexr-ascdbimfisusd');" class="buybtn"><span>Buy Now</span></a>
					<div class="saleenjoy-cnttips">1 Year / 3 PCs</div>
					<div class="saleenjoy-cntwordp">
						<ul>
			...
			<div class="saleenjoy-probox saleenjoy-probox3 fr">
				<div class="saleenjoy-proboxcnt">
					...
					<a href="https://www.iobit.com/buy.php?product=2020sd3pc1199&ref=xr_sd<?= $refStr; ?>&refs=purchase_5bundlexr" onclick="ga('send', 'event', 'sdbuy', 'buy', '5bundlepurchasexr-ascdbimfisusd');" class="buybtn"><span>Buy Now</span></a>
					<div class="saleenjoy-cnttips">1 Year / 3 PCs</div>
					<div class="saleenjoy-cntwordp">
						<ul>
			...
			<div class="saleexclu-cont">
				...
				<div class="saleexclu-super">
					...
					<div class="saleexclu-supcnt">
						...
						<p class="salekeep-price">$<big>25</big>.28<del>$252.77</del></p>
						<div class="saleexclu-buy"><a href="https://www.iobit.com/buy.php?product=2020ascdbimfisusd2528&ref=xr_ascdbimfisusd<?= $refStr; ?>&refs=purchase_5bundlexr" onclick="ga('send', 'event', 'ascdbimfisusdbuy', 'buy', '5bundlepurchasexr-ascdbimfisusd');" class="buybtn"><span>Buy Now</span></a></div>
