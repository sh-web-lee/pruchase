...
if ($_GET['action'] == 'getPacks') {
  $date = $_GET['d'];
  $c_name = 'enbtwobiu_p' . $date;
  $c_name_t='enbtwobiu_t' . $date;
...
<head>
  ...
  <title>80% OFF to Get ASC PRO & IU PRO - Black Friday Sale | IObit</title>
   ...
   <div class="default">
      <div class="content">
        ...
        <div class="right-message">
          ...
          <dl class="price">
            <dt>Only <strong>$<b>18</b>.59</strong> <del>$92.98</del></dt>
            <dd><a href="https://www.iobit.com/buy.php?product=2020asciu3pc1859&ref=br_asciu<?= $refStr; ?>&refs=purchase_2bundlebf"
                   onclick="ga('send', 'event', 'asciubuy', 'buy', '2bundlepurchasebf-asciu');" class="buybtn">Get It Now</a></dd>
      ...
      <div class="box">
        ...
        <dl>
          ...
          <dd><a href="https://www.iobit.com/buy.php?product=2020asc3pc1477&ref=br_asc<?= $refStr; ?>&refs=purchase_2bundlebf"
                 onclick="ga('send', 'event', 'ascbuy', 'buy', '2bundlepurchasebf-asciu');" class="border-buybtn">Get It Now</a></dd>
        </dl>
      </div>
      <div class="box right">
        ...
        <dl>
          ...
          <dd><a href="https://www.iobit.com/buy.php?product=2020iu3pc1297&ref=br_iu<?= $refStr; ?>&refs=purchase_2bundlebf"
                 onclick="ga('send', 'event', 'iubuy', 'buy', '2bundlepurchasebf-asciu');  " class="border-buybtn">Get It Now</a></dd>
        </dl>
      </div>
  	</div>
        ...
        <div class="message">
          ...
          <dl class="price">
            ...
            <dd><a href="https://www.iobit.com/buy.php?product=2020asc3pc1477&ref=br_ascsold<?= $refStr; ?>&refs=purchase_2bundlebf"
             		onclick="ga('send', 'event', 'ascsoldbuy', 'buy', '2bundlepurchasebf-asciu');  " class="buybtn">Get It Now</a></dd>
            <dd>1 Year / 3 PCs</dd>
          </dl>
        </div>
      </div>
        ...
        <div class="message">
          ...
          <dl class="price">
            ...
            <dd><a href="https://www.iobit.com/buy.php?product=2020iu3pc1297&ref=br_iusold<?= $refStr; ?>&refs=purchase_2bundlebf"
                   onclick="ga('send', 'event', 'iusoldbuy', 'buy', '2bundlepurchasebf-asciu');" class="buybtn">Get It Now</a></dd>
            <dd>1 Year / 3 PCs</dd>
          </dl>
        </div>
      </div>
...
<div class="compare">
	<div class="wrapper">
		...
		<p>of both Advanced SystemCare and IObit Uninstaller</p>
		<table>
			<thead>
				<tr>
					<th class="text"></th>
				...
				<tr>
					...
					<th class="itema">
            			...
            			<a href="https://www.iobit.com/buy.php?product=2020asc3pc1477&ref=br_asc<?= $refStr; ?>&refs=purchase_2bundlebf"
                 		   onclick="ga('send', 'event', 'ascbuy', 'buy', '2bundlepurchasebf-asciu');" class="border-buybtn">Get It Now</a>
					</th>
					<th class="space"></th>
					<th class="itemb">
            			...
            			<a href="https://www.iobit.com/buy.php?product=2020iu3pc1297&ref=br_iu<?= $refStr; ?>&refs=purchase_2bundlebf"
                 			onclick="ga('send', 'event', 'iubuy', 'buy', '2bundlepurchasebf-asciu');  " class="border-buybtn">Get It Now</a>
					</th>
					<th class="space"></th>
					<th class="itemc">
						<p><strong>$<b>18</b>.59</strong> <del>$92.98</del></p>
						<a href="https://www.iobit.com/buy.php?product=2020asciu3pc1859&ref=br_asciu<?= $refStr; ?>&refs=purchase_2bundlebf"
                   			onclick="ga('send', 'event', 'asciubuy', 'buy', '2bundlepurchasebf-asciu');" class="buybtn">Get It Now</a>
					</th>
				</tr>
			</tfoot> 
		</table>
...
<div id="floatlayer" class="floatlayer">
  <div class="wrapper default  clearfix">
    ...
    <div class="numer">
      ...
      <dl class="price fr">
      <dt><strong>$<b>18</b>.59</strong> <del>$92.98</del></dt>
      <dd><a class="buybtn"
	  		 href="https://www.iobit.com/buy.php?product=2020asciu3pc1859&ref=br_asciu<?= $refStr; ?>&refs=purchase_2bundlebf"
             onclick="ga('send', 'event', 'asciubuy', 'buy', '2bundlepurchasebf-asciu');" >
			Get It Now
      </a></dd>
    </dl>
  </div>
  <div class="wrapper soldout hide clearfix">
    ...
    <ul class="change">
      ...
      <dd><a class="buybtn"
             ...
             onclick="ga('send', 'event', 'ascsoldbuy', 'buy', '2bundlepurchasebf-asciu');  ">
		 Get It Now
      </a></dd>
    </dl>
  </div>
