...
var bannerObject = [{
  className:'one',
  body:'<tr><td>Advanced SystemCare 14 PRO</td><td>3 PCs</td><td>$49.99</td><td>$0</td></tr><tr><td>Driver Booster 8 PRO</td><td>3 PCs</td><td>$74.85</td><td>$19.95</td></tr><tr><td>IObit Software Updater 3 PRO </td><td>3 PCs</td><td>$32.99</td><td>$9.99</td></tr>',
  Discount:'70% OFF + Free Gift',
  Subtotal:'$157.83',
  Total:'$29.94',
  url:'https://www.iobit.com/buy.php?product=2020ascdbisu2994&ref=br_ascdbisu'+refStr+'&refs=purchase_3bundlebf&tw='+tw,
  ga:"ga('send', 'event', 'ascdbisubuy', 'buy', '3bundlepurchasebf-ascdbisu');"
},
{
  className:'two',
  ...
  ga:"ga('send', 'event', 'ascbuy', 'buy', '3bundlepurchasebf-ascdbisu');",
  soldoutUrlGa:"ga('send', 'event', 'ascsoldbuy', 'buy', '3bundlepurchasebf-ascdbisu');"
},
{
  className:'three',
  ...
  ga:"ga('send', 'event', 'isubuy', 'buy', '3bundlepurchasebf-ascdbisu');",
  soldoutUrlGa:"ga('send', 'event', 'isusoldbuy', 'buy', '3bundlepurchasebf-ascdbisu');"
},
{
  className:'four',
  ...
  ga:"ga('send', 'event', 'dbbuy', 'buy', '3bundlepurchasebf-ascdbisu');",
  soldoutUrlGa:"ga('send', 'event', 'dbsoldbuy', 'buy', '3bundlepurchasebf-ascdbisu');"
}]
...
function soldout(){
  ...
  $('.floatlayer .left .pc').attr('src',$('.floatlayer .left .pc').attr('src').replace(/box-one-true/, "box-two-true"))
...
function getSales() {
  ...
  $.ajax({
    type: "GET",
    url: "bthreeb.php?pop=br_ascdbisu",
    ...
    success: function (res) {
      ...
      if (packs > 0) {
        $(window).unload(function () {
          packs = cGet('enascdbisu_p');
        });
        var total = cGet('enascdbisu_t');
...
function getReTime() {
  var packsNumTotal = cGet('enascdbisu_t');
  if (packsNumTotal > 1) {
