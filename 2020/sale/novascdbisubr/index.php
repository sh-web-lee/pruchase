...
if ($_GET['action'] == 'getPacks') {
  $date = $_GET['d'];
  $c_name = 'enascdbisu_p' . $date;
  $c_name_t='enascdbisu_t' . $date;
		...
		<div class="change clearfix">
			...
			<div class="right box">
				<dl>
					...
					<dd>
						<p class="clearfix"><span>Subtotal</span><span class="Subtotal right">$157.83</span></p>
						<p class="border clearfix"><span>Discount</span><span class="Discount right">70% OFF + Free Gift</span></p>
						<p class="clearfix total"><span>Total</span><span class="Total right">$29.94</span></p>
						<a 
						href="https://www.iobit.com/buy.php?product=2020ascdbisu2994&ref=br_ascdbisu<?= $refStr; ?>&refs=purchase_3bundlebf"
						onclick="ga('send', 'event', 'ascdbisubuy', 'buy', '3bundlepurchasebf-ascdbisu');" >
		...
		<dl class="right">
			...
			<dd>
				...
				<div class="buy-btn clearfix">
					...
					<a 
						href="https://www.iobit.com/buy.php?product=2020asc3pc1477&ref=br_asc<?= $refStr; ?>&refs=purchase_3bundlebf"
						onclick="ga('send', 'event', 'ascbuy', 'buy', '3bundlepurchasebf-ascdbisu');" >
			...
			<dd>
				...
				<div class="buy-btn clearfix">
					...
					<a 
						...
						onclick="ga('send', 'event', 'dbbuy', 'buy', '3bundlepurchasebf-ascdbisu');" >
					<button class="buy-new"><i></i> Buy Now</button>
					</a>
				</div>
			</dd>
		</dl>
		<img class="right" src="<?php echo getStaticUrl('images/db.png')?>" alt="">
	</div>
</div>
<div class="mf-item project-item">
	<img class="bg" src="<?php echo getStaticUrl('images/mf-bg.png')?>" alt="">
	<div class="feature wrapper clearfix">
		<img class="left" src="<?php echo getStaticUrl('images/isu_left.png')?>" alt="">
		<dl class="right">
			<dt>
			...
			<dd>
				...
				<div class="buy-btn clearfix">
					...
					<a 
						href="https://www.iobit.com/buy.php?product=2020isu3pc999&ref=br_isu<?= $refStr; ?>&refs=purchase_3bundlebf"
						onclick="ga('send', 'event', 'isubuy', 'buy', '3bundlepurchasebf-ascdbisu');" >
					<button class="buy-new"><i></i> Buy Now</button>
					</a>
				</div>
			</dd>
...
<div id="floatlayer" class="floatlayer">
	<img class="bg" src="<?php echo getStaticUrl('images/fl-bg.png')?>" alt=""/>	
  	<div class="wrapper default  clearfix">
		...
		<div class="price fr">
			<div class="buy-btn clearfix">
				<span><strong>$<b>29</b>.94</strong> <del>$157.83</del></span>
				<a 
						href="https://www.iobit.com/buy.php?product=2020ascdbisu2994&ref=br_ascdbisu<?= $refStr; ?>&refs=purchase_3bundlebf"
						onclick="ga('send', 'event', 'ascdbisubuy', 'buy', '3bundlepurchasebf-ascdbisu');" >
				<button class="buy-new"><i></i> Buy Now</button>
