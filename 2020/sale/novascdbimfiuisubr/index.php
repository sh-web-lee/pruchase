...
<head>
  ...
  <title>90% OFF to get 5 PC optimization utilities - Black Friday Sale | IObit</title>
				...
				<div class="saleseorder">
					<div class="saleseordercnt">
						...
						<div class="saleseorder-buy">
							...
							<a href="https://www.iobit.com/buy.php?product=2020ascdbimfiuisu2558&ref=br_ascdbimfiuisu<?= $refStr; ?>&refs=purchase_5bundlebf" onclick="ga('send', 'event', 'ascdbimfiuisubuy', 'buy', '5bundlepurchasebf-ascdbimfiuisu');" class="buybtn banbuybtn"><span>Buy Now</span></a>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="salekeep-cntdes clearfix">
					...
					<div class="salekeep-cntstore">
						...
						<div class="salekeep-cntprice">
							...
							<a href="https://www.iobit.com/buy.php?product=2020asc3pc1477&ref=br_asc<?= $refStr; ?>&refs=purchase_5bundlebf" onclick="ga('send', 'event', 'ascbuy', 'buy', '5bundlepurchasebf-ascdbimfiuisu');" class="buybtn"><span>Buy Now</span></a>
				...
				<div class="salekeep-cntdes clearfix">
					...
					<div class="salekeep-cntstore">
						...
						<div class="salekeep-cntprice">
							...
							<a href="https://www.iobit.com/buy.php?product=2020db3pc1995&ref=br_db<?= $refStr; ?>&refs=purchase_5bundlebf" onclick="ga('send', 'event', 'dbbuy', 'buy', '5bundlepurchasebf-ascdbimfiuisu');" class="buybtn"><span>Buy Now</span></a>
							<div class="salekeep-cnttips">1 Year / 3 PCs</div>
						</div>
					</div>
				</div>
	...
	<div class="saleenjoy-cont clearfix">
		<div class="saleenjoy-probox saleenjoy-probox1 fl">
			<div class="saleenjoy-proboxcnt">
				...
				<a href="https://www.iobit.com/buy.php?product=2020imf3pc1699&ref=br_imf<?= $refStr; ?>&refs=purchase_5bundlebf" onclick="ga('send', 'event', 'imfbuy', 'buy', '5bundlepurchasebf-ascdbimfiuisu');" class="buybtn"><span>Buy Now</span></a>
		...
		<div class="saleenjoy-probox saleenjoy-probox2 fl">
			<div class="saleenjoy-proboxcnt">
				...
				<a href="https://www.iobit.com/buy.php?product=2020iu3pc1297&ref=br_iu<?= $refStr; ?>&refs=purchase_5bundlebf" onclick="ga('send', 'event', 'iubuy', 'buy', '5bundlepurchasebf-ascdbimfiuisu');" class="buybtn"><span>Buy Now</span></a>
				<div class="saleenjoy-cnttips">1 Year / 3 PCs</div>
				<div class="saleenjoy-cntwordp">
					<ul>
		...
		<div class="saleenjoy-probox saleenjoy-probox3 fr">
			<div class="saleenjoy-proboxcnt">
				...
				<a href="https://www.iobit.com/buy.php?product=2020isu3pc999&ref=br_isu<?= $refStr; ?>&refs=purchase_5bundlebf" onclick="ga('send', 'event', 'isubuy', 'buy', '5bundlepurchasebf-ascdbimfiuisu');" class="buybtn"><span>Buy Now</span></a>
				<div class="saleenjoy-cnttips">1 Year / 3 PCs</div>
				<div class="saleenjoy-cntwordp">
					<ul>
		...
		<div class="saleexclu-cont">
			...
			<div class="saleexclu-super">
				...
				<div class="saleexclu-supcnt">
					...
					<div class="saleexclu-buy"><a href="https://www.iobit.com/buy.php?product=2020ascdbimfiuisu2558&ref=br_ascdbimfiuisu<?= $refStr; ?>&refs=purchase_5bundlebf" onclick="ga('send', 'event', 'ascdbimfiuisubuy', 'buy', '5bundlepurchasebf-ascdbimfiuisu');" class="buybtn"><span>Buy Now</span></a></div>
