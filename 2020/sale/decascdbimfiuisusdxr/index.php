...
if ($_GET['action'] == 'getPacks') {
  $date = $_GET['d'];
  $c_name = 'decascdbimfiuisusdxr' . $date;
...
<head>
  ...
  <title>90% OFF to get 6 PC optimization & security utilities -  Christmas  Sale | IObit</title>
	...
	<div class="salecont">
		<div class="saleselbox">
			<ul class="clearfix">
				...
				<li class="selbox selbox5 checked" data-id="isu" data-price="3299">
					<img src="<?php echo getStaticUrl('images/salebox5.png')?>" alt=""/>
				</li>
				...
				<div class="saleseordercnt">
					...
					<div class="saleseorder-cont">
						<div class="saleseorder-items">
							<div class="saleseorder-name"><p>ITEMS SUBTOTAL <b>(<span class="quatynum">6</span>)</b></p></div>
							<div class="saleseorder-price"><p>$<span class="orprice">295.76</p></span></div>
						</div>
						<div class="saleseorder-discount">
							<div class="saleseorder-name"><p>DISCOUNT (<span class="saleratio">90</span>% OFF) </p></div>
							<div class="saleseorder-price"><p>-$<span class="salernum">266.18</span></p></div>
						</div>
					</div>
					<div class="saleseorder-buy">
						<div class="saleseorder-total">
							<div class="saleseorder-name"><p><span>Total</span></p></div>
							<div class="saleseorder-price"><p>$<span class="salertotal">29.58</span></p></div>
						</div>
						<a href="https://www.iobit.com/buy.php?product=2020ascdbimfiuisusd2958&ref=xr_ascdbimfiuisusdb<?= $refStr; ?>&refs=purchase_6bundlexr" onclick="ga('send', 'event', 'ascdbimfiuisusdbuy', 'buy', '6bundlepurchasexr-ascdbimfiuisusd');" class="buybtn banbuybtn"><span>Buy Now</span></a>
					</div>
				</div>
			</div>
		</div>
					...
					<div class="salekeep-cntdes clearfix">
						...
						<div class="salekeep-cntstore">
							...
							<div class="salekeep-cntprice">
								...
								<a href="https://www.iobit.com/buy.php?product=2020asc3pc1477&ref=xr_ascb<?= $refStr; ?>&refs=purchase_6bundlexr" onclick="ga('send', 'event', 'ascbuy', 'buy', '6bundlepurchasexr-ascdbimfiuisusd');" class="buybtn"><span>Buy Now</span></a>
					...
					<div class="salekeep-cntdes clearfix">
						...
						<div class="salekeep-cntstore">
							...
							<div class="salekeep-cntprice">
								...
								<a href="https://www.iobit.com/buy.php?product=2020db3pc1995&ref=xr_dbb<?= $refStr; ?>&refs=purchase_6bundlexr" onclick="ga('send', 'event', 'dbbuy', 'buy', '6bundlepurchasexr-ascdbimfiuisusd');" class="buybtn"><span>Buy Now</span></a>
								<div class="salekeep-cnttips">1 Year / 3 PCs</div>
							</div>
						</div>
					</div>
					...
					<div class="salekeep-cntdes clearfix">
						...
						<div class="salekeep-cntstore">
							...
							<div class="salekeep-cntprice">
								...
								<a href="https://www.iobit.com/buy.php?product=2020imf3pc1699&ref=xr_imfb<?= $refStr; ?>&refs=purchase_6bundlexr" onclick="ga('send', 'event', 'imfbuy', 'buy', '6bundlepurchasexr-ascdbimfiuisusd');" class="buybtn"><span>Buy Now</span></a>
								<div class="salekeep-cnttips">1 Year / 3 PCs</div>
							</div>
						</div>
					</div>
					...
					<div class="salekeep-cntdes clearfix">
						...
						<div class="salekeep-cntstore">
							...
							<div class="salekeep-cntprice">
								...
								<a href="https://www.iobit.com/buy.php?product=2020iu3pc1297&ref=xr_iub<?= $refStr; ?>&refs=purchase_6bundlexr" onclick="ga('send', 'event', 'iubuy', 'buy', '6bundlepurchasexr-ascdbimfiuisusd');" class="buybtn"><span>Buy Now</span></a>
								<div class="salekeep-cnttips">1 Year / 3 PCs</div>
							</div>
						</div>
					</div>
					...
					<div class="salekeep-cntdes clearfix">
						...
						<div class="salekeep-cntstore">
							...
							<div class="salekeep-cntprice">
								...
								<a href="https://www.iobit.com/buy.php?product=2020isu3pc999&ref=xr_isub<?= $refStr; ?>&refs=purchase_6bundlexr" onclick="ga('send', 'event', 'isubuy', 'buy', '6bundlepurchasexr-ascdbimfiuisusd');" class="buybtn"><span>Buy Now</span></a>
								<div class="salekeep-cnttips">1 Year / 3 PCs</div>
							</div>
						</div>
					</div>
					...
					<div class="salekeep-cntdes clearfix">
						...
						<div class="salekeep-cntstore">
							...
							<div class="salekeep-cntprice">
								...
								<a href="https://www.iobit.com/buy.php?product=2020sd3pc1199&ref=xr_sdb<?= $refStr; ?>&refs=purchase_6bundlexr" onclick="ga('send', 'event', 'sdbuy', 'buy', '6bundlepurchasexr-ascdbimfiuisusd');" class="buybtn"><span>Buy Now</span></a>
								<div class="salekeep-cnttips">1 Year / 3 PCs</div>
							</div>
						</div>
					</div>
			...
			<div class="saleexclu-cont">
				...
				<div class="saleexclu-super">
					...
					<div class="saleexclu-supcnt">
						...
						<p class="salekeep-price">$<big>29</big>.58<del>$295.76</del></p>
						<div class="saleexclu-buy"><a href="https://www.iobit.com/buy.php?product=2020ascdbimfiuisusd2958&ref=xr_ascdbimfiuisusdb<?= $refStr; ?>&refs=purchase_6bundlexr" onclick="ga('send', 'event', 'ascdbimfiuisusdbuy', 'buy', '6bundlepurchasexr-ascdbimfiuisusd');" class="buybtn"><span>Buy Now</span></a></div>
