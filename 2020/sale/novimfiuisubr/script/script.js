...
var bannerObject = [{
  className:'one',
  body:'<tr><td>IObit Malware Fighter 8 PRO</td><td>3 PCs</td><td>$54.95</td><td>$0</td></tr><tr><td>IObit Software Updater 3 PRO</td><td>3 PCs</td><td>$32.99</td><td>$9.99</td></tr><tr><td>IObit Uninstaller 10 PRO</td><td>3 PCs</td><td>$42.99</td><td>$12.97</td></tr>',
  Discount:'70% OFF + Free Gift',
  Subtotal:'$130.93',
  Total:'$22.96',
  
  url:'https://www.iobit.com/buy.php?product=2020imfiuisu2296&ref=br_imfiuisu'+refStr+'&refs=purchase_3bundlebf&tw='+tw,
  ga:"ga('send', 'event', 'imfiuisubuy', 'buy', '3bundlepurchasebf-imfiuisu');"
},
{
  className:'two',
  ...
  ga:"ga('send', 'event', 'imfbuy', 'buy', '3bundlepurchasebf-imfiuisu');",
  soldoutUrlGa:"ga('send', 'event', 'imfsoldbuy', 'buy', '3bundlepurchasebf-imfiuisu');"
},
{
  className:'three',
  ...
  ga:"ga('send', 'event', 'iubuy', 'buy', '3bundlepurchasebf-imfiuisu');",
  soldoutUrlGa:"ga('send', 'event', 'iusoldbuy', 'buy', '3bundlepurchasebf-imfiuisu');"
},
{
  className:'four',
  ...
  ga:"ga('send', 'event', 'isubuy', 'buy', '3bundlepurchasebf-imfiuisu');",
  soldoutUrlGa:"ga('send', 'event', 'isusoldbuy', 'buy', '3bundlepurchasebf-imfiuisu');"
}]
...
function getSales() {
  ...
  $.ajax({
    type: "GET",
    url: "bthreeb.php?pop=br_imfiuisu",
    ...
    success: function (res) {
      ...
      if (packs > 0) {
        $(window).unload(function () {
          packs = cGet('enimfiuisu_p');
        });
        var total = cGet('enimfiuisu_t');
...
function getReTime() {
  var packsNumTotal = cGet('enimfiuisu_t');
  if (packsNumTotal > 1) {
