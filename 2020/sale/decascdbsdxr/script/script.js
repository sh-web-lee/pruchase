...
var bannerObject = [{
  className:'one',
  body:'<tr><td>Advanced SystemCare 14 PRO</td><td>3 PCs</td><td>$49.99</td><td>$0</td></tr><tr><td>Driver Booster 8 PRO</td><td>3 PCs</td><td>$74.85</td><td>$19.95</td></tr><tr><td>Smart Defrag 6 PRO</td><td>3 PCs</td><td>$42.99</td><td>$12.97</td></tr>',
  Discount:'70% OFF + Free Gift',
  Subtotal:'$164.83',
  Total:'$31.94',
  url:'https://www.iobit.com/buy.php?product=2020ascdbsd3194&ref=xr_ascdbsd'+ refStr +'&refs=purchase_3bundlexr&tw='+tw,
  ga:"ga('send', 'event', 'ascdbsdbuy', 'buy', '3bundlepurchasexr-ascdbsd')"
},
{
  className:'two',
  ...
  ga:"ga('send', 'event', 'ascbuy', 'buy', '3bundlepurchasexr-ascdbsd')",
...
},
{
  ...
  ga:"ga('send', 'event', 'sdbuy', 'buy', '3bundlepurchasexr-ascdbsd');",
...
},
{
  ...
  ga:"ga('send', 'event', 'dbbuy', 'buy', '3bundlepurchasexr-ascdbsd')",
  soldoutUrlGa:"ga('send', 'event', 'dbsoldbuy', 'buy', '3bundlepurchasexr-ascdbsd')"
}]
...
function getSales() {
  ...
  $.ajax({
    type: "GET",
    url: "xthreeb.php?pop=xr_ascdbsd",
    ...
    success: function (res) {
      ...
      if (packs > 0) {
        $(window).unload(function () {
          packs = cGet('enacdbsd_p');
        });
        var total = cGet('enacdbsd_t');
...
function getReTime() {
  var packsNumTotal = cGet('enacdbsd_t');
  if (packsNumTotal > 1) {
