					...
					<div class="saleseordercnt">
						...
						<div class="saleseorder-cont">
							<div class="saleseorder-items">
								...
								<div class="saleseorder-price"><p>$<span class="orprice">222.78</p></span></div>
							</div>
							<div class="saleseorder-discount">
								<div class="saleseorder-name"><p>DISCOUNT (<span class="saleratio">90</span>% OFF) </p></div>
								<div class="saleseorder-price"><p>-$<span class="salernum">200.50</span></p></div>
							</div>
						</div>
						<div class="saleseorder-buy">
							<div class="saleseorder-total">
								<div class="saleseorder-name"><p><span>Total</span></p></div>
								<div class="saleseorder-price"><p>$<span class="salertotal">22.28</span></p></div>
							</div>
							<a href="https://www.iobit.com/buy.php?product=2020ascdbimfiu2228&ref=br_ascdbimfiu<?= $refStr; ?>&refs=purchase_4bundlebf" onclick="ga('send', 'event', 'ascdbimfiubuy', 'buy', '4bundlepurchasebf-ascdbimfiu');" class="buybtn banbuybtn"><span>Buy Now</span></a>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="salekeep-cntdes clearfix">
					...
					<div class="salekeep-cntstore">
						...
						<div class="salekeep-cntprice">
							...
							<a href="https://www.iobit.com/buy.php?product=2020asc3pc1477&ref=br_asc<?= $refStr; ?>&refs=purchase_4bundlebf" onclick="ga('send', 'event', 'ascbuy', 'buy', '4bundlepurchasebf-ascdbimfiu');" class="buybtn"><span>Buy Now</span></a>
				...
				<div class="salekeep-cntdes clearfix">
					...
					<div class="salekeep-cntstore">
						...
						<div class="salekeep-cntprice">
							...
							<a href="https://www.iobit.com/buy.php?product=2020db3pc1995&ref=br_db<?= $refStr; ?>&refs=purchase_4bundlebf" onclick="ga('send', 'event', 'dbbuy', 'buy', '4bundlepurchasebf-ascdbimfiu');" class="buybtn"><span>Buy Now</span></a>
							<div class="salekeep-cnttips">1 Year / 3 PCs</div>
						</div>
					</div>
				</div>
				...
				<div class="salekeep-cntdes clearfix">
					...
					<div class="salekeep-cntstore">
						...
						<div class="salekeep-cntprice">
							...
							<a href="https://www.iobit.com/buy.php?product=2020imf3pc1699&ref=br_imf<?= $refStr; ?>&refs=purchase_4bundlebf" onclick="ga('send', 'event', 'imfbuy', 'buy', '4bundlepurchasebf-ascdbimfiu');" class="buybtn"><span>Buy Now</span></a>
							<div class="salekeep-cnttips">1 Year / 3 PCs</div>
						</div>
					</div>
				</div>
				...
				<div class="salekeep-cntdes clearfix">
					...
					<div class="salekeep-cntstore">
						...
						<div class="salekeep-cntprice">
							...
							<a href="https://www.iobit.com/buy.php?product=2020iu3pc1297&ref=br_iu<?= $refStr; ?>&refs=purchase_4bundlebf" onclick="ga('send', 'event', 'iubuy', 'buy', '4bundlepurchasebf-ascdbimfiu');" class="buybtn"><span>Buy Now</span></a>
							<div class="salekeep-cnttips">1 Year / 3 PCs</div>
						</div>
					</div>
				</div>
		...
		<div class="saleexclu-cont">
			...
			<div class="saleexclu-super">
				...
				<div class="saleexclu-supcnt">
					...
					<p class="salekeep-price">$<big>22</big>.28<del>$222.78</del></p>
					<div class="saleexclu-buy"><a href="https://www.iobit.com/buy.php?product=2020ascdbimfiu2228&ref=br_ascdbimfiu<?= $refStr; ?>&refs=purchase_4bundlebf" onclick="ga('send', 'event', 'ascdbimfiubuy', 'buy', '4bundlepurchasebf-ascdbimfiu');" class="buybtn"><span>Buy Now</span></a></div>
