...
if ($_GET['action'] == 'getPacks') {
  $date = $_GET['d'];
  $c_name = 'enascdbiu_p' . $date;
  $c_name_t='enascdbiu_t' . $date;
		...
		<div class="change clearfix">
			...
			<div class="right box">
				<dl>
					...
					<dd>
						<p class="clearfix"><span>Subtotal</span><span class="Subtotal right">$167.83</span></p>
						<p class="border clearfix"><span>Discount</span><span class="Discount right">70% OFF + Free Gift</span></p>
						<p class="clearfix total"><span>Total</span><span class="Total right">$32.92</span></p>
						<a 
						href="https://www.iobit.com/buy.php?product=2020ascdbiu3292gift&ref=br_ascdbiu<?= $refStr; ?>&refs=purchase_3bundlebf"
						onclick="ga('send', 'event', 'ascdbiubuy', 'buy', '3bundlepurchasebf-ascdbiu')" >
			...
			<dd>
				...
				<div class="buy-btn clearfix">
					...
					<a 
						...
						onclick="ga('send', 'event', 'ascbuy', 'buy', '3bundlepurchasebf-ascdbiu');" >
			...
			<dd>
				...
				<div class="buy-btn clearfix">
					...
					<a 
						...
						onclick="ga('send', 'event', 'dbbuy', 'buy', '3bundlepurchasebf-ascdbiu');" >
					<button class="buy-new"><i></i> Buy Now</button>
					</a>
				</div>
			</dd>
			...
			<dd>
				...
				<div class="buy-btn clearfix">
					...
					<a 
						...
						onclick="ga('send', 'event', 'iubuy', 'buy', '3bundlepurchasebf-ascdbiu');" >
					<button class="buy-new"><i></i> Buy Now</button>
					</a>
				</div>
			</dd>
...
<div id="floatlayer" class="floatlayer">
	<img class="bg" src="<?php echo getStaticUrl('images/fl-bg.png')?>" alt=""/>	
  	<div class="wrapper default  clearfix">
		...
		<div class="price fr">
			<div class="buy-btn clearfix">
				<span><strong>$<b>32</b>.92</strong> <del>$167.83</del></span>
				<a 
						href="https://www.iobit.com/buy.php?product=2020ascdbiu3292gift&ref=br_ascdbiu<?= $refStr; ?>&refs=purchase_3bundlebf"
						onclick="ga('send', 'event', 'ascdbiubuy', 'buy', '3bundlepurchasebf-ascdbiu')" >
				<button class="buy-new"><i></i> Buy Now</button>
