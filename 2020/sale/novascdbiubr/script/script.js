...
var bannerObject = [{
  className:'one',
  body:'<tr><td>Advanced SystemCare 14 PRO</td><td>3 PCs</td><td>$49.99</td><td>$0</td></tr><tr><td>Driver Booster 8 PRO</td><td>3 PCs</td><td>$74.85</td><td>$19.95</td></tr><tr><td>IObit Uninstaller 10 PRO</td><td>3 PCs</td><td>$42.99</td><td>$12.97</td></tr>',
  Discount:'70% OFF + Free Gift',
  Subtotal:'$179.79',
  Total:'$36.94',
  url:'https://www.iobit.com/buy.php?product=2020ascdbiu3292gift&ref=br_ascdbiu'+ refStr +'&refs=purchase_3bundlebf&tw='+tw,
  ga:"ga('send', 'event', 'ascdbiubuy', 'buy', '3bundlepurchasebf-ascdbiu')"
},
{
  className:'two',
  ...
  ga:"ga('send', 'event', 'ascbuy', 'buy', '3bundlepurchasebf-ascdbiu')",
  soldoutUrlGa:"ga('send', 'event', 'ascsoldbuy', 'buy', '3bundlepurchasebf-ascdbiu')"
},
{
  className:'three',
  ...
  Subtotal:'$42.99',
  Total:'$12.97',
  url:'https://www.iobit.com/buy.php?product=2020iu3pc1297&ref=br_iu'+ refStr +'&refs=purchase_3bundlebf&tw='+tw,
  soldoutUrl:'https://www.iobit.com/buy.php?product=2020iu3pc1297&ref=br_iusold'+ refStr +'&refs=purchase_3bundlebf&tw='+tw,
  ga:"ga('send', 'event', 'iubuy', 'buy', '3bundlepurchasebf-ascdbiu')",
  soldoutUrlGa:"ga('send', 'event', 'iusoldbuy', 'buy', '3bundlepurchasebf-ascdbiu')"
},
{
  className:'four',
  ...
  Subtotal:'$74.85',
  Total:'$19.95',
  url:'https://www.iobit.com/buy.php?product=2020db3pc1995&ref=br_db'+ refStr +'&refs=purchase_3bundlebf&tw='+tw,
  soldoutUrl:'https://www.iobit.com/buy.php?product=2020db3pc1995&ref=br_dbsold'+ refStr +'&refs=purchase_3bundlebf&tw='+tw,
  ga:"ga('send', 'event', 'dbbuy', 'buy', '3bundlepurchasebf-ascdbiu')",
  soldoutUrlGa:"ga('send', 'event', 'dbsoldbuy', 'buy', '3bundlepurchasebf-ascdbiu')"
}]
...
function getSales() {
  ...
  $.ajax({
    type: "GET",
    url: "bthreeb.php?pop=br_ascdbiu",
    ...
    success: function (res) {
      ...
      if (packs > 0) {
        $(window).unload(function () {
          packs = cGet('enascdbiu_p');
        });
        var total = cGet('enascdbiu_t');
...
function getReTime() {
  var packsNumTotal = cGet('enascdbiu_t');
  if (packsNumTotal > 1) {
