				...
				<div class="saleseorder">
					<div class="saleseordercnt">
						...
						<div class="saleseorder-buy">
							...
							<a href="https://www.iobit.com/buy.php?product=2020ascdbimfisu2128&ref=xr_ascdbimfisu<?= $refStr; ?>&refs=purchase_4bundlexr" onclick="ga('send', 'event', 'ascdbimfisubuy', 'buy', '4bundlepurchasexr-ascdbimfisu');" class="buybtn banbuybtn"><span>Buy Now</span></a>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="salekeep-cntdes clearfix">
					...
					<div class="salekeep-cntstore">
						...
						<div class="salekeep-cntprice">
							...
							<a href="https://www.iobit.com/buy.php?product=2020asc3pc1477&ref=xr_asc<?= $refStr; ?>&refs=purchase_4bundlexr" onclick="ga('send', 'event', 'ascbuy', 'buy', '4bundlepurchasexr-ascdbimfisu');" class="buybtn"><span>Buy Now</span></a>
				...
				<div class="salekeep-cntdes clearfix">
					...
					<div class="salekeep-cntstore">
						...
						<div class="salekeep-cntprice">
							...
							<a href="https://www.iobit.com/buy.php?product=2020db3pc1995&ref=xr_db<?= $refStr; ?>&refs=purchase_4bundlexr" onclick="ga('send', 'event', 'dbbuy', 'buy', '4bundlepurchasexr-ascdbimfisu');" class="buybtn"><span>Buy Now</span></a>
							<div class="salekeep-cnttips">1 Year / 3 PCs</div>
						</div>
					</div>
				</div>
				...
				<div class="salekeep-cntdes clearfix">
					...
					<div class="salekeep-cntstore">
						...
						<div class="salekeep-cntprice">
							...
							<a href="https://www.iobit.com/buy.php?product=2020imf3pc1699&ref=xr_imf<?= $refStr; ?>&refs=purchase_4bundlexr" onclick="ga('send', 'event', 'imfbuy', 'buy', '4bundlepurchasexr-ascdbimfisu');" class="buybtn"><span>Buy Now</span></a>
							<div class="salekeep-cnttips">1 Year / 3 PCs</div>
						</div>
					</div>
				</div>
				...
				<div class="salekeep-cntdes clearfix">
					...
					<div class="salekeep-cntstore">
						...
						<div class="salekeep-cntprice">
							...
							<a href="https://www.iobit.com/buy.php?product=2020isu3pc999&ref=xr_isu<?= $refStr; ?>&refs=purchase_4bundlexr" onclick="ga('send', 'event', 'isubuy', 'buy', '4bundlepurchasexr-ascdbimfisu');" class="buybtn"><span>Buy Now</span></a>
							<div class="salekeep-cnttips">1 Year / 3 PCs</div>
						</div>
					</div>
				</div>
		...
		<div class="saleexclu-cont">
			...
			<div class="saleexclu-super">
				<div class="saleexclu-supcnt">
					...
					<div class="saleexclu-buy"><a href="https://www.iobit.com/buy.php?product=2020ascdbimfisu2128&ref=xr_ascdbimfisu<?= $refStr; ?>&refs=purchase_4bundlexr" onclick="ga('send', 'event', 'ascdbimfisubuy', 'buy', '4bundlepurchasexr-ascdbimfisu');" class="buybtn"><span>Buy Now</span></a></div>
