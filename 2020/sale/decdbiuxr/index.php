...
<head>
  ...
  <title>80% OFF to Get DB PRO & IU PRO - Christmas Sale | IObit</title>
      ...
      <div class="content">
        ...
        <div class="right-message">
          ...
          <dl class="price">
            ...
            <dd><a href="https://www.iobit.com/buy.php?product=2020dbiu3pc2357&ref=xr_dbiu<?= $refStr; ?>&refs=purchase_2bundlexr"
                   onclick="ga('send', 'event', 'dbiubuy', 'buy', '2bundlepurchasexr-dbiu');" class="buybtn">Get It Now</a></dd>
      ...
      <div class="box">
        ...
        <dl>
          ...
          <dd><a href="https://www.iobit.com/buy.php?product=2020db3pc1995&ref=xr_db<?= $refStr; ?>&refs=purchase_2bundlexr"
                 onclick="ga('send', 'event', 'dbbuy', 'buy', '2bundlepurchasexr-dbiu');  " class="border-buybtn">Get It Now</a></dd>
        </dl>
      </div>
      <div class="box right">
        ...
        <dl>
          ...
          <dd><a href="https://www.iobit.com/buy.php?product=2020iu3pc1297&ref=xr_iu<?= $refStr; ?>&refs=purchase_2bundlexr"
                 onclick="ga('send', 'event', 'iubuy', 'buy', '2bundlepurchasexr-dbiu');" class="border-buybtn">Get It Now</a></dd>
        </dl>
      </div>
  </div>
        ...
        <div class="message">
          ...
          <dl class="price">
            ...
            <dd><a href="https://www.iobit.com/buy.php?product=2020db3pc1995&ref=xr_dbsold<?= $refStr; ?>&refs=purchase_2bundlexr"
             	   onclick="ga('send', 'event', 'dbsoldbuy', 'buy', '2bundlepurchasexr-dbiu');" class="buybtn">Get It Now</a></dd>
            <dd>1 Year / 3 PCs</dd>
          </dl>
        </div>
      </div>
        ...
        <div class="message">
          ...
          <dl class="price">
            ...
            <dd><a href="https://www.iobit.com/buy.php?product=2020iu3pc1297&ref=xr_iusold<?= $refStr; ?>&refs=purchase_2bundlexr"
                   onclick="ga('send', 'event', 'iusoldbuy', 'buy', '2bundlepurchasexr-dbiu');" class="buybtn">Get It Now</a></dd>
            <dd>1 Year / 3 PCs</dd>
          </dl>
        </div>
      </div>
				...
				<tr>
					...
					<th class="itema">
            			...
            			<a href="https://www.iobit.com/buy.php?product=2020db3pc1995&ref=xr_db<?= $refStr; ?>&refs=purchase_2bundlexr"
                 		   onclick="ga('send', 'event', 'dbbuy', 'buy', '2bundlepurchasexr-dbiu');  " class="border-buybtn">Get It Now</a>
					</th>
					<th class="space"></th>
					<th class="itemb">
            			...
            			<a href="https://www.iobit.com/buy.php?product=2020iu3pc1297&ref=xr_iu<?= $refStr; ?>&refs=purchase_2bundlexr"
                 		   onclick="ga('send', 'event', 'iubuy', 'buy', '2bundlepurchasexr-dbiu');"  class="border-buybtn">Get It Now</a>
					</th>
					<th class="space"></th>
					<th class="itemc">
						<p><strong>$<b>23</b>.57</strong> <del>$117.84</del></p>
						<a href="https://www.iobit.com/buy.php?product=2020dbiu3pc2357&ref=xr_dbiu<?= $refStr; ?>&refs=purchase_2bundlexr"
                   			onclick="ga('send', 'event', 'dbiubuy', 'buy', '2bundlepurchasexr-dbiu');"  class="buybtn">Get It Now</a>
					</th>
				</tr>
			</tfoot> 
		</table>
...
<div id="floatlayer" class="floatlayer">
  <div class="wrapper default  clearfix">
    ...
    <div class="numer">
      ...
      <dd><a class="buybtn"
	  				href="https://www.iobit.com/buy.php?product=2020dbiu3pc2357&ref=xr_dbiu<?= $refStr; ?>&refs=purchase_2bundlexr"
                   onclick="ga('send', 'event', 'dbiubuy', 'buy', '2bundlepurchasexr-dbiu');" >
			Get It Now
      </a></dd>
    </dl>
  </div>
  <div class="wrapper soldout hide clearfix">
    ...
    <ul class="change">
      ...
      <dd><a class="buybtn"
             ...
             onclick="ga('send', 'event', 'dbsoldbuy', 'buy', '2bundlepurchasexr-dbiu');">
		 Get It Now
      </a></dd>
    </dl>
  </div>
