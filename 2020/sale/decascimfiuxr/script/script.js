...
var bannerObject = [{
  ...
  Subtotal:'$147.93',
  Total:'$29.96',
  url:'https://www.iobit.com/buy.php?product=2020ascimfiu2996gift&ref=xr_ascimfiu'+refStr+'&refs=purchase_3bundlexr&tw='+tw,
  ga:"ga('send', 'event', 'ascimfiubuy', 'buy', '3bundlepurchasexr-ascimfiu')"
},
{
  className:'two',
  ...
  ga:"ga('send', 'event', 'ascbuy', 'buy', '3bundlepurchasexr-ascimfiu')",
  soldoutUrlGa:"ga('send', 'event', 'ascsoldbuy', 'buy', '3bundlepurchasexr-ascimfiu')"
},
{
  className:'three',
  ...
  ga:"ga('send', 'event', 'imfbuy', 'buy', '3bundlepurchasexr-ascimfiu')",
  soldoutUrlGa:"ga('send', 'event', 'imfsoldbuy', 'buy', '3bundlepurchasexr-ascimfiu')"
},
{
  className:'four',
  ...
  ga:"ga('send', 'event', 'iubuy', 'buy', '3bundlepurchasexr-ascimfiu')",
  soldoutUrlGa:"ga('send', 'event', 'iusoldbuy', 'buy', '3bundlepurchasexr-ascimfiu')"
}]
...
function getSales() {
  ...
  $.ajax({
    type: "GET",
    url: "xthreeb.php?pop=xr_ascimfiu",
    ...
    success: function (res) {
      ...
      if (packs > 0) {
        $(window).unload(function () {
          packs = cGet('enacimfiu_p');
        });
        var total = cGet('enacimfiu_t');
...
function getReTime() {
  var packsNumTotal = cGet('enacimfiu_t');
  if (packsNumTotal > 1) {
