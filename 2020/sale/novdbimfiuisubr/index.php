				...
				<div class="saleseorder">
					<div class="saleseordercnt">
						...
						<div class="saleseorder-buy">
							...
							<a href="https://www.iobit.com/buy.php?product=2020dbimfiuisu2058&ref=br_dbimfiuisu<?= $refStr; ?>&refs=purchase_4bundlebf" onclick="ga('send', 'event', 'dbimfiuisubuy', 'buy', '4bundlepurchasebf-dbimfiuisu');" class="buybtn banbuybtn"><span>Buy Now</span></a>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="salekeep-cntdes clearfix">
					...
					<div class="salekeep-cntstore">
						...
						<div class="salekeep-cntprice">
							...
							<a href="https://www.iobit.com/buy.php?product=2020db3pc1995&ref=br_db<?= $refStr; ?>&refs=purchase_4bundlebf" onclick="ga('send', 'event', 'dbbuy', 'buy', '4bundlepurchasebf-dbimfiuisu');" class="buybtn"><span>Buy Now</span></a>
				...
				<div class="salekeep-cntdes clearfix">
					...
					<div class="salekeep-cntstore">
						...
						<div class="salekeep-cntprice">
							...
							<a href="https://www.iobit.com/buy.php?product=2020iu3pc1297&ref=br_iu<?= $refStr; ?>&refs=purchase_4bundlebf" onclick="ga('send', 'event', 'iubuy', 'buy', '4bundlepurchasebf-dbimfiuisu');" class="buybtn"><span>Buy Now</span></a>
							<div class="salekeep-cnttips">1 Year / 3 PCs</div>
						</div>
					</div>
				</div>
				...
				<div class="salekeep-cntdes clearfix">
					...
					<div class="salekeep-cntstore">
						...
						<div class="salekeep-cntprice">
							...
							<a href="https://www.iobit.com/buy.php?product=2020imf3pc1699&ref=br_imf<?= $refStr; ?>&refs=purchase_4bundlebf" onclick="ga('send', 'event', 'imfbuy', 'buy', '4bundlepurchasebf-dbimfiuisu');" class="buybtn"><span>Buy Now</span></a>
							<div class="salekeep-cnttips">1 Year / 3 PCs</div>
						</div>
					</div>
				</div>
				...
				<div class="salekeep-cntdes clearfix">
					...
					<div class="salekeep-cntstore">
						...
						<div class="salekeep-cntprice">
							...
							<a href="https://www.iobit.com/buy.php?product=2020isu3pc999&ref=br_isu<?= $refStr; ?>&refs=purchase_4bundlebf" onclick="ga('send', 'event', 'isubuy', 'buy', '4bundlepurchasebf-dbimfiuisu');" class="buybtn"><span>Buy Now</span></a>
							<div class="salekeep-cnttips">1 Year / 3 PCs</div>
						</div>
					</div>
				</div>
		...
		<div class="saleexclu-cont">
			...
			<div class="saleexclu-super">
				...
				<div class="saleexclu-supcnt">
					...
					<div class="saleexclu-buy"><a href="https://www.iobit.com/buy.php?product=2020dbimfiuisu2058&ref=br_dbimfiuisu<?= $refStr; ?>&refs=purchase_4bundlebf" onclick="ga('send', 'event', 'dbimfiuisubuy', 'buy', '4bundlepurchasebf-dbimfiuisu');" class="buybtn"><span>Buy Now</span></a></div>
