				...
				<div class="saleseorder">
					<div class="saleseordercnt">
						...
						<div class="saleseorder-buy">
							...
							<a href="https://www.iobit.com/buy.php?product=2020dbimfiusd2128&ref=xr_dbimfiusd<?= $refStr; ?>&refs=purchase_4bundlexr" onclick="ga('send', 'event', 'dbimfiusdbuy', 'buy', '4bundlepurchasexr-dbimfiusd');" class="buybtn banbuybtn"><span>Buy Now</span></a>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="salekeep-cntdes clearfix">
					...
					<div class="salekeep-cntstore">
						...
						<div class="salekeep-cntprice">
							...
							<a href="https://www.iobit.com/buy.php?product=2020db3pc1995&ref=xr_db<?= $refStr; ?>&refs=purchase_4bundlexr" onclick="ga('send', 'event', 'dbbuy', 'buy', '4bundlepurchasexr-dbimfiusd');" class="buybtn"><span>Buy Now</span></a>
				...
				<div class="salekeep-cntdes clearfix">
					...
					<div class="salekeep-cntstore">
						...
						<div class="salekeep-cntprice">
							...
							<a href="https://www.iobit.com/buy.php?product=2020iu3pc1297&ref=xr_iu<?= $refStr; ?>&refs=purchase_4bundlexr" onclick="ga('send', 'event', 'iubuy', 'buy', '4bundlepurchasexr-dbimfiusd');" class="buybtn"><span>Buy Now</span></a>
							<div class="salekeep-cnttips">1 Year / 3 PCs</div>
						</div>
					</div>
				</div>
				...
				<div class="salekeep-cntdes clearfix">
					...
					<div class="salekeep-cntstore">
						...
						<div class="salekeep-cntprice">
							...
							<a href="https://www.iobit.com/buy.php?product=2020imf3pc1699&ref=xr_imf<?= $refStr; ?>&refs=purchase_4bundlexr" onclick="ga('send', 'event', 'imfbuy', 'buy', '4bundlepurchasexr-dbimfiusd');" class="buybtn"><span>Buy Now</span></a>
							<div class="salekeep-cnttips">1 Year / 3 PCs</div>
						</div>
					</div>
				</div>
				...
				<div class="salekeep-cntdes clearfix">
					...
					<div class="salekeep-cntstore">
						...
						<p class="salekeep-price">$<big>11</big>.99<del>$39.99</del></p>
							<a href="https://www.iobit.com/buy.php?product=2020sd3pc1199&ref=xr_sd<?= $refStr; ?>&refs=purchase_4bundlexr" onclick="ga('send', 'event', 'sdbuy', 'buy', '4bundlepurchasexr-dbimfiusd');" class="buybtn"><span>Buy Now</span></a>
							<div class="salekeep-cnttips">1 Year / 3 PCs</div>
						</div>
					</div>
				</div>
		...
		<div class="saleexclu-cont">
			...
			<div class="saleexclu-super">
				<div class="saleexclu-supcnt">
					...
					<div class="saleexclu-buy"><a href="https://www.iobit.com/buy.php?product=2020dbimfiusd2128&ref=xr_dbimfiusd<?= $refStr; ?>&refs=purchase_4bundlexr" onclick="ga('send', 'event', 'dbimfiusdbuy', 'buy', '4bundlepurchasexr-dbimfiusd');" class="buybtn"><span>Buy Now</span></a></div>
