...
<head>
  ...
  <title>80% OFF to Get ASC PRO & DB PRO - Christmas Sale | IObit</title>
      ...
      <div class="content">
        ...
        <div class="right-message">
          ...
          <dl class="price">
            ...
            <dd><a href="https://www.iobit.com/buy.php?product=2020ascdb3pc2497&ref=xr_ascdb<?= $refStr; ?>&refs=purchase_2bundlexr"
                   onclick="ga('send', 'event', 'ascdbbuy', 'buy', '2bundlepurchasexr-ascdb');    " class="buybtn">Get It Now</a></dd>
      ...
      <div class="box">
        ...
        <dl>
          ...
          <dd><a href="https://www.iobit.com/buy.php?product=2020asc3pc1477&ref=xr_asc<?= $refStr; ?>&refs=purchase_2bundlexr"
                 onclick="ga('send', 'event', 'ascbuy', 'buy', '2bundlepurchasexr-ascdb'); " class="border-buybtn">Get It Now</a></dd>
        </dl>
      </div>
      <div class="box right">
        ...
        <dl>
          ...
          <dd><a href="https://www.iobit.com/buy.php?product=2020db3pc1995&ref=xr_db<?= $refStr; ?>&refs=purchase_2bundlexr"
                 onclick="ga('send', 'event', 'dbbuy', 'buy', '2bundlepurchasexr-ascdb');  " class="border-buybtn">Get It Now</a></dd>
        </dl>
      </div>
  </div>
        ...
        <div class="message">
          ...
          <dl class="price">
            ...
            <dd><a href="https://www.iobit.com/buy.php?product=2020asc3pc1477&ref=xr_ascsold<?= $refStr; ?>&refs=purchase_2bundlexr"
                   onclick="ga('send', 'event', 'ascsoldbuy', 'buy', '2bundlepurchasexr-ascdb'); " class="buybtn">Get It Now</a></dd>
            <dd>1 Year / 3 PCs</dd>
          </dl>
        </div>
      </div>
        ...
        <div class="message">
          ...
          <dl class="price">
            ...
            <dd><a href="https://www.iobit.com/buy.php?product=2020db3pc1995&ref=xr_dbsold<?= $refStr; ?>&refs=purchase_2bundlexr"
                   onclick="ga('send', 'event', 'dbsoldbuy', 'buy', '2bundlepurchasexr-ascdb');     " class="buybtn">Get It Now</a></dd>
            <dd>1 Year / 3 PCs</dd>
          </dl>
        </div>
      </div>
	...
	<div class="wrapper">
		...
		<table>
            ...
            <a href="https://www.iobit.com/buy.php?product=2020asc3pc1477&ref=xr_asc<?= $refStr; ?>&refs=purchase_2bundlexr"
              onclick="ga('send', 'event', 'ascbuy', 'buy', '2bundlepurchasexr-ascdb');" class="border-buybtn">Get It Now</a>
					</th>
					<th class="space"></th>
					<th class="itemb">
            ...
            <a href="https://www.iobit.com/buy.php?product=2020db3pc1995&ref=xr_db<?= $refStr; ?>&refs=purchase_2bundlexr"
               onclick="ga('send', 'event', 'dbbuy', 'buy', '2bundlepurchasexr-ascdb');  " class="border-buybtn">Get It Now</a>
					</th>
					<th class="space"></th>
					<th class="itemc">
						<p><strong>$<b>24</b>.97</strong> <del>$124.84</del></p>
						<a href="https://www.iobit.com/buy.php?product=2020ascdb3pc2497&ref=xr_ascdb<?= $refStr; ?>&refs=purchase_2bundlexr"
               onclick="ga('send', 'event', 'ascdbbuy', 'buy', '2bundlepurchasexr-ascdb');    "  class="buybtn">Get It Now</a>
					</th>
				</tr>
			</tfoot> 
		</table>
...
<div id="floatlayer" class="floatlayer">
  <div class="wrapper default  clearfix">
    ...
    <div class="numer">
      ...
      <dd><a class="buybtn"
            href="https://www.iobit.com/buy.php?product=2020ascdb3pc2497&ref=xr_ascdb<?= $refStr; ?>&refs=purchase_2bundlexr"
            onclick="ga('send', 'event', 'ascdbbuy', 'buy', '2bundlepurchasexr-ascdb');    " >
			Get It Now
      </a></dd>
    </dl>
  </div>
  <div class="wrapper soldout hide clearfix">
    ...
    <ul class="change">
      ...
      <dd><a class="buybtn"
             ...
             onclick="ga('send', 'event', 'ascsoldbuy', 'buy', '2bundlepurchasexr-ascdb'); ">
		 Get It Now
      </a></dd>
    </dl>
  </div>
