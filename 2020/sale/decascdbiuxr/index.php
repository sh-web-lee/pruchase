...
if ($_GET['action'] == 'getPacks') {
  $date = $_GET['d'];
  $c_name = 'enacdbiu_p' . $date;
  $c_name_t='enacdbiu_t' . $date;
			...
			<div class="right box">
				<dl>
					...
					<dd>
						...
						<a 
						href="https://www.iobit.com/buy.php?product=2020ascdbiu3292gift&ref=xr_ascdbiu<?= $refStr; ?>&refs=purchase_3bundlexr"
						onclick="ga('send', 'event', 'ascdbiubuy', 'buy', '3bundlepurchasexr-ascdbiu');" >
			...
			<dd>
				...
				<div class="buy-btn clearfix">
					...
					<a 
						...
						onclick="ga('send', 'event', 'ascbuy', 'buy', '3bundlepurchasexr-ascdbiu');" >
			...
			<dd>
				...
				<div class="buy-btn clearfix">
					...
					<a 
						...
						onclick="ga('send', 'event', 'dbbuy', 'buy', '3bundlepurchasexr-ascdbiu');" >
					<button class="buy-new"><i></i> Buy Now</button>
					</a>
				</div>
			</dd>
			...
			<dd>
				...
				<div class="buy-btn clearfix">
					...
					<a 
						...
						onclick="ga('send', 'event', 'iubuy', 'buy', '3bundlepurchasexr-ascdbiu');" >
					<button class="buy-new"><i></i> Buy Now</button>
					</a>
				</div>
			</dd>
