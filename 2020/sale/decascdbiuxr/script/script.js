...
var bannerObject = [{
  ...
  url:'https://www.iobit.com/buy.php?product=2020ascdbiu3292gift&ref=xr_ascdbiu'+ refStr +'&refs=purchase_3bundlexr&tw='+tw,
  ga:"ga('send', 'event', 'ascdbiubuy', 'buy', '3bundlepurchasexr-ascdbiu')"
},
{
  className:'two',
  ...
  ga:"ga('send', 'event', 'ascbuy', 'buy', '3bundlepurchasexr-ascdbiu')",
  soldoutUrlGa:"ga('send', 'event', 'ascsoldbuy', 'buy', '3bundlepurchasexr-ascdbiu')"
},
{
  className:'three',
  ...
  ga:"ga('send', 'event', 'iubuy', 'buy', '3bundlepurchasexr-ascdbiu')",
  soldoutUrlGa:"ga('send', 'event', 'iusoldbuy', 'buy', '3bundlepurchasexr-ascdbiu')"
},
{
  className:'four',
  ...
  ga:"ga('send', 'event', 'dbbuy', 'buy', '3bundlepurchasexr-ascdbiu')",
  soldoutUrlGa:"ga('send', 'event', 'dbsoldbuy', 'buy', '3bundlepurchasexr-ascdbiu')"
}]
...
function getSales() {
  ...
  $.ajax({
    type: "GET",
    url: "xthreeb.php?pop=xr_ascdbiu",
    ...
    success: function (res) {
      ...
      if (packs > 0) {
        $(window).unload(function () {
          packs = cGet('enacdbiu_p');
        });
        var total = cGet('enacdbiu_t');
...
function getReTime() {
  var packsNumTotal = cGet('enacdbiu_t');
  if (packsNumTotal > 1) {
