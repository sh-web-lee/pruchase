			...
			<div class="right box">
				<dl>
					...
					<dd>
						...
						<a 
						href="https://www.iobit.com/buy.php?product=2020dbiuisu2296&ref=xr_dbiuisu<?= $refStr; ?>&refs=purchase_3bundlexr"
						onclick="ga('send', 'event', 'dbiuisubuy', 'buy', '3bundlepurchasexr-dbiuisu');" >
			...
			<dd>
				...
				<div class="buy-btn clearfix">
					...
					<a 
						...
						onclick="ga('send', 'event', 'dbbuy', 'buy', '3bundlepurchasexr-dbiuisu');" >
			...
			<dd>
				...
				<div class="buy-btn clearfix">
					...
					<a 
						...
						onclick="ga('send', 'event', 'iubuy', 'buy', '3bundlepurchasexr-dbiuisu');" >
					<button class="buy-new"><i></i> Buy Now</button>
					</a>
				</div>
			</dd>
			...
			<dd>
				...
				<div class="buy-btn clearfix">
					...
					<a 
						...
						onclick="ga('send', 'event', 'isubuy', 'buy', '3bundlepurchasexr-dbiuisu');" >
					<button class="buy-new"><i></i> Buy Now</button>
					</a>
				</div>
			</dd>
