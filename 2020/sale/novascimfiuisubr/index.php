					...
					<div class="saleseordercnt">
						...
						<div class="saleseorder-cont">
							<div class="saleseorder-items">
								...
								<div class="saleseorder-price"><p>$<span class="orprice">180.92</p></span></div>
							</div>
							<div class="saleseorder-discount">
								<div class="saleseorder-name"><p>DISCOUNT (<span class="saleratio">90</span>% OFF) </p></div>
								<div class="saleseorder-price"><p>-$<span class="salernum">162.83</span></p></div>
							</div>
						</div>
						<div class="saleseorder-buy">
							<div class="saleseorder-total">
								<div class="saleseorder-name"><p><span>Total</span></p></div>
								<div class="saleseorder-price"><p>$<span class="salertotal">18.09</span></p></div>
							</div>
							<a href="https://www.iobit.com/buy.php?product=2020ascimfiuisu1809&ref=br_ascimfiuisu<?= $refStr; ?>&refs=purchase_4bundlebf" onclick="ga('send', 'event', 'ascimfiuisubuy', 'buy', '4bundlepurchasebf-ascimfiuisu');" class="buybtn banbuybtn"><span>Buy Now</span></a>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="salekeep-cntdes clearfix">
					...
					<div class="salekeep-cntstore">
						...
						<div class="salekeep-cntprice">
							...
							<a href="https://www.iobit.com/buy.php?product=2020asc3pc1477&ref=br_asc<?= $refStr; ?>&refs=purchase_4bundlebf" onclick="ga('send', 'event', 'ascbuy', 'buy', '4bundlepurchasebf-ascimfiuisu');" class="buybtn"><span>Buy Now</span></a>
				...
				<div class="salekeep-cntdes clearfix">
					...
					<div class="salekeep-cntstore">
						...
						<div class="salekeep-cntprice">
							...
							<a href="https://www.iobit.com/buy.php?product=2020iu3pc1297&ref=br_iu<?= $refStr; ?>&refs=purchase_4bundlebf" onclick="ga('send', 'event', 'iubuy', 'buy', '4bundlepurchasebf-ascimfiuisu');" class="buybtn"><span>Buy Now</span></a>
							<div class="salekeep-cnttips">1 Year / 3 PCs</div>
						</div>
					</div>
				</div>
				...
				<div class="salekeep-cntdes clearfix">
					...
					<div class="salekeep-cntstore">
						...
						<div class="salekeep-cntprice">
							...
							<a href="https://www.iobit.com/buy.php?product=2020imf3pc1699&ref=br_imf<?= $refStr; ?>&refs=purchase_4bundlebf" onclick="ga('send', 'event', 'imfbuy', 'buy', '4bundlepurchasebf-ascimfiuisu');" class="buybtn"><span>Buy Now</span></a>
							<div class="salekeep-cnttips">1 Year / 3 PCs</div>
						</div>
					</div>
				</div>
				...
				<div class="salekeep-cntdes clearfix">
					...
					<div class="salekeep-cntstore">
						...
						<div class="salekeep-cntprice">
							...
							<a href="https://www.iobit.com/buy.php?product=2020isu3pc999&ref=br_isu<?= $refStr; ?>&refs=purchase_4bundlebf" onclick="ga('send', 'event', 'isubuy', 'buy', '4bundlepurchasebf-ascimfiuisu');" class="buybtn"><span>Buy Now</span></a>
							<div class="salekeep-cnttips">1 Year / 3 PCs</div>
						</div>
					</div>
				</div>
		...
		<div class="saleexclu-cont">
			...
			<div class="saleexclu-super">
				...
				<div class="saleexclu-supcnt">
					...
					<p class="salekeep-price">$<big>18</big>.09<del>$180.92</del></p>
					<div class="saleexclu-buy"><a href="https://www.iobit.com/buy.php?product=2020ascimfiuisu1809&ref=br_ascimfiuisu<?= $refStr; ?>&refs=purchase_4bundlebf" onclick="ga('send', 'event', 'ascimfiuisubuy', 'buy', '4bundlepurchasebf-ascimfiuisu');" class="buybtn"><span>Buy Now</span></a></div>
