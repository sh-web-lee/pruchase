...
var bannerObject = [{
  ...
  url:'https://www.iobit.com/buy.php?product=2020dbimfiu2996&ref=br_dbimfiu'+refStr+'&refs=purchase_3bundlebf&tw='+tw,
  ga:"ga('send', 'event', 'dbimfiubuy', 'buy', '3bundlepurchasebf-dbimfiu');"
},
{
  className:'two',
  ...
  ga:"ga('send', 'event', 'dbbuy', 'buy', '3bundlepurchasebf-dbimfiu');",
  soldoutUrlGa:"ga('send', 'event', 'dbsoldbuy', 'buy', '3bundlepurchasebf-dbimfiu');"
},
{
  className:'three',
  ...
  ga:"ga('send', 'event', 'imfbuy', 'buy', '3bundlepurchasebf-dbimfiu');",
  soldoutUrlGa:"ga('send', 'event', 'imfsoldbuy', 'buy', '3bundlepurchasebf-dbimfiu');"
},
{
  className:'four',
  ...
  ga:"ga('send', 'event', 'iubuy', 'buy', '3bundlepurchasebf-dbimfiu');",
  soldoutUrlGa:"ga('send', 'event', 'iusoldbuy', 'buy', '3bundlepurchasebf-dbimfiu');"
}]
...
function getSales() {
  ...
  $.ajax({
    type: "GET",
    url: "bthreeb.php?pop=br_dbimfiu",
    ...
    success: function (res) {
      ...
      if (packs > 0) {
        $(window).unload(function () {
          packs = cGet('enbtwob_p');
        });
        var total = cGet('enbtwob_t');
...
function getReTime() {
  var packsNumTotal = cGet('enbtwob_t');
  if (packsNumTotal > 1) {
