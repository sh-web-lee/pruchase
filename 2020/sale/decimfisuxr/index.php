...
<head>
  ...
  <title>80% OFF to Get IMF PRO & ISU PRO - Christmas Sale | IObit    </title>
      ...
      <div class="content">
        ...
        <div class="right-message">
          ...
          <dl class="price">
            ...
            <dd><a href="https://www.iobit.com/buy.php?product=2020imfisu3pc1759&ref=xr_imfisu<?= $refStr; ?>&refs=purchase_2bundlexr"
                   onclick="ga('send', 'event', 'imfisubuy', 'buy', '2bundlepurchasexr-imfisu');   " class="buybtn">Get It Now</a></dd>
      ...
      <div class="box">
        ...
        <dl>
          ...
          <dd><a href="https://www.iobit.com/buy.php?product=2020imf3pc1699&ref=xr_imf<?= $refStr; ?>&refs=purchase_2bundlexr"
                 onclick="ga('send', 'event', 'imfbuy', 'buy', '2bundlepurchasexr-imfisu');" class="border-buybtn">Get It Now</a></dd>
        </dl>
      </div>
      <div class="box right">
        ...
        <dl>
          ...
          <dd><a href="https://www.iobit.com/buy.php?product=2020isu3pc999&ref=xr_isu<?= $refStr; ?>&refs=purchase_2bundlexr"
                 onclick="ga('send', 'event', 'isubuy', 'buy', '2bundlepurchasexr-imfisu');" class="border-buybtn">Get It Now</a></dd>
        </dl>
      </div>
  </div>
        ...
        <div class="message">
          ...
          <dl class="price">
            ...
            <dd><a href="https://www.iobit.com/buy.php?product=2020imf3pc1699&ref=xr_imfsold<?= $refStr; ?>&refs=purchase_2bundlexr"
             		onclick="ga('send', 'event', 'imfsoldbuy', 'buy', '2bundlepurchasexr-imfisu');" class="buybtn">Get It Now</a></dd>
            <dd>1 Year / 3 PCs</dd>
          </dl>
        </div> 
      </div>
        ...
        <div class="message">
          ...
          <dl class="price">
            ...
            <dd><a href="https://www.iobit.com/buy.php?product=2020isu3pc999&ref=xr_isusold<?= $refStr; ?>&refs=purchase_2bundlexr"
                   onclick="ga('send', 'event', 'isusoldbuy', 'buy', '2bundlepurchasexr-imfisu');" class="buybtn">Get It Now</a></dd>
            <dd>1 Year / 3 PCs</dd>
          </dl>
        </div>
      </div>
				...
				<tr>
					...
					<th class="itema">
            			...
            			<a href="https://www.iobit.com/buy.php?product=2020imf3pc1699&ref=xr_imf<?= $refStr; ?>&refs=purchase_2bundlexr"
                 		   onclick="ga('send', 'event', 'imfbuy', 'buy', '2bundlepurchasexr-imfisu');"  class="border-buybtn">Get It Now</a>
					</th>
					<th class="space"></th>
					<th class="itemb">
            			...
            			<a href="https://www.iobit.com/buy.php?product=2020isu3pc999&ref=xr_isu<?= $refStr; ?>&refs=purchase_2bundlexr"
                 		   onclick="ga('send', 'event', 'isubuy', 'buy', '2bundlepurchasexr-imfisu');" class="border-buybtn">Get It Now</a>
					</th>
					<th class="space"></th>
					<th class="itemc">
						<p><strong>$<b>17</b>.59</strong> <del>$87.94</del></p>
						<a href="https://www.iobit.com/buy.php?product=2020imfisu3pc1759&ref=xr_imfisu<?= $refStr; ?>&refs=purchase_2bundlexr"
                   		   onclick="ga('send', 'event', 'imfisubuy', 'buy', '2bundlepurchasexr-imfisu');   " class="buybtn">Get It Now</a>
					</th>
				</tr>
			</tfoot> 
		</table>
...
<div id="floatlayer" class="floatlayer">
  <div class="wrapper default  clearfix">
    ...
    <div class="numer">
      ...
      <dd><a class="buybtn" href="https://www.iobit.com/buy.php?product=2020imfisu3pc1759&ref=xr_imfisu<?= $refStr; ?>&refs=purchase_2bundlexr"
                   onclick="ga('send', 'event', 'imfisubuy', 'buy', '2bundlepurchasexr-imfisu');   ">
			Get It Now
      </a></dd>
    </dl>
  </div>
  <div class="wrapper soldout hide clearfix">
    ...
    <ul class="change">
      ...
      <dd><a class="buybtn"
             ...
             onclick="ga('send', 'event', 'imfsoldbuy', 'buy', '2bundlepurchasexr-imfisu');">
		 Get It Now
      </a></dd>
    </dl>
  </div>
