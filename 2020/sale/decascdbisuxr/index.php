...
if ($_GET['action'] == 'getPacks') {
  $date = $_GET['d'];
  $c_name = 'enacdbisu_p' . $date;
  $c_name_t='enacdbisu_t' . $date;
			...
			<div class="right box">
				<dl>
					...
					<dd>
						...
						<a 
						href="https://www.iobit.com/buy.php?product=2020ascdbisu2994&ref=xr_ascdbisu<?= $refStr; ?>&refs=purchase_3bundlexr"
						onclick="ga('send', 'event', 'ascdbisubuy', 'buy', '3bundlepurchasexr-ascdbisu');" >
			...
			<dd>
				...
				<div class="buy-btn clearfix">
					...
					<a 
						...
						onclick="ga('send', 'event', 'ascbuy', 'buy', '3bundlepurchasexr-ascdbisu');" >
			...
			<dd>
				...
				<div class="buy-btn clearfix">
					...
					<a 
						...
						onclick="ga('send', 'event', 'dbbuy', 'buy', '3bundlepurchasexr-ascdbisu');" >
					<button class="buy-new"><i></i> Buy Now</button>
					</a>
				</div>
			</dd>
			...
			<dd>
				<ul class="clearfix as">
					<li class="fl">
						<div class="item">
							<p>Easy Update</p>
							<span>by updating all software with <xr/>1-click.</span>
						</div>
						<div class="item">
							<p>Safe Update</p>
				...
				<div class="buy-btn clearfix">
					...
					<a 
						...
						onclick="ga('send', 'event', 'isubuy', 'buy', '3bundlepurchasexr-ascdbisu');" >
					<button class="buy-new"><i></i> Buy Now</button>
					</a>
				</div>
			</dd>
