...
var bannerObject = [{
  ...
  url:'https://www.iobit.com/buy.php?product=2020ascimfisu2698gift&ref=xr_ascimfisu'+refStr+'&refs=purchase_3bundlexr&tw='+tw,
  ga:"ga('send', 'event', 'ascimfisubuy', 'buy', '3bundlepurchasexr-ascimfisu');"
},
{
  className:'two',
  ...
  ga:"ga('send', 'event', 'ascbuy', 'buy', '3bundlepurchasexr-ascimfisu')",
  soldoutUrlGa:"ga('send', 'event', 'ascsoldbuy', 'buy', '3bundlepurchasexr-ascimfisu')"
},
{
  className:'three',
  ...
  ga:"ga('send', 'event', 'imfbuy', 'buy', '3bundlepurchasexr-ascimfisu')",
  soldoutUrlGa:"ga('send', 'event', 'imfsoldbuy', 'buy', '3bundlepurchasexr-ascimfisu')"
},
{
  className:'four',
  ...
  ga:"ga('send', 'event', 'isubuy', 'buy', '3bundlepurchasexr-ascimfisu')",
  soldoutUrlGa:"ga('send', 'event', 'isusoldbuy', 'buy', '3bundlepurchasexr-ascimfisu')"
}]
...
function getSales() {
  ...
  $.ajax({
    type: "GET",
    url: "xthreeb.php?pop=xr_ascimfisu",
    ...
    success: function (res) {
      ...
      if (packs > 0) {
        $(window).unload(function () {
          packs = cGet('enacimfisu_p');
        });
        var total = cGet('enacimfisu_t');
...
function getReTime() {
  var packsNumTotal = cGet('enacimfisu_t');
  if (packsNumTotal > 1) {
