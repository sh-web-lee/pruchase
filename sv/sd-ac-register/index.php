...
<title>70% Rabatt på Smart Defrag PRO</title>
	...
	<div class="wrapper">
		...
		<div class="intro">
			...
			<div class="discount">
				...
				<div class="wprice">ENDAST <em>129kr</em> <del>459kr</del><span>1 Års Prenumation / 1 PC</span></div>
				<div class="btnarea">
					<a href="https://www.iobit.com/buy.php?product=sv-sd6-ac&ref=sv_sd-ac<?php echo $refStr;?>&refs=sv_ac_sd" onclick="ga('send', 'event', 'sdbuy', 'buy', 'sdac-sv')" class="checkbtn sdbuybtn">Köp Nu >></a>
		...
		<div class="clear"></div>
		<div class="checkout">
			<div class="moneyback">Du skyddas helt av vår 100% pengarna tillbaka garanti och du KOMMER att se en betydande förbättring av datorns prestanda INOM 60 DAGAR, eller så gör vi en full återbetalning. Inga frågor.  <a class="sdbuybtn" href="https://www.iobit.com/buy.php?product=sv-sd6-ac&ref=sv_sd-ac<?php echo $refStr;?>&refs=sv_ac_sd" onclick="ga('send', 'event', 'sdbuy', 'buy', 'sdac-sv')">Köp nu</a></div>
			<div class="btn">
				<a href="https://www.iobit.com/buy.php?product=sv-sd6-ac&ref=sv_sd-ac<?php echo $refStr;?>&refs=sv_ac_sd" onclick="ga('send', 'event', 'sdbuy', 'buy', 'sdac-sv')" class="checkbtn sdbuybtn">Köp Nu >></a>
					<span>100% PENGARNA TILLBAKA GARANTI</span>
			</div>
