...
<div class="middle">
  <div class="warpper clearfix">
    <div class="lace">
      <div class="introduce">
        <h3>Save <span>75%</span> on Driver Booster 2 PRO & Get Super Gifts for FREE!</h3>
        <p>Activate Driver Booster 2 PRO for 3 PCs, get FREE Gift Pack your PC will adore! <span><em id="packs"><?php echo $packsNum; ?> Packs</em> Left Today!</span></p>
      ...
      <div class="control">
        <ul>
          ...
          <li class="link"><a href="http://www.iobit.com/buy.php?product=dbsdebook&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'dbpurchase');">ACTIVATE NOW</a></li>
    ...
    <div class="comparison_table">
      <table border="0" cellspacing="0" cellpadding="0" width="100%">
        ...
        <tbody>
          ...
          <tr>
            <td class="icons" width="45"><img src="img/icon_11.png"></td>
