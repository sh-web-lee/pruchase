...
if(in_array($_GET['st'],array('asc_acimf'))){
  ...
  if (empty($_GET['ref'])) $_GET['ref'] = 'plaff_imf7_2020acregister';
?>
<!DOCTYPE html>
<html lang="pl">
<head>
...
<title>80% ZNIŻKI na IObit Malware Fighter PRO - IObit</title>
...
<meta property="og:title" content="80% ZNIŻKI na IObit Malware Fighter PRO - IObit">
    ...
    <div class="wrapper">
      ...
      <div class="pricebox">
        <dl class="price">
          ...
          <dd>
            <a class="buybtn bigbtn" href="https://www.iobit.com/buy.php?product=plaff-imf7-ac&ref=<?php echo $_GET['ref'];?>&aff=<?php echo $_GET['aff'];?>" onclick="ga('send', 'event', 'imfbuy', 'buy', 'plaffimf7acregister')">
              <div class="inner">
                <i class="all-icons"></i>
  ...
  <div class="feature wrapper">
    ...
    <div class="clearfix">
      <dl>
        ...
        <dd>
          <h3>WYKRYJ PONAD 203 MLN ZAGROŻEŃ</h3>
          <p>
    ...
    <div class="clearfix">
      ...
      <dl class="right">
        ...
        <dd>
          <h3>MOCNA OCHRONA DYSKU USB</h3>
          <p>Ochroń komputer przed zagrożeniami ukrywającymi się na dysku USB.</p>
        </dd>
      </dl>
    </div>
    <div class="clearfix">
    ...
    <div class="wrapper clearfix">
      ...
      <div class="pricebox">
        <dl class="price fr">
          ...
          <dd>
            <a class="buybtn smallbtn" href="https://www.iobit.com/buy.php?product=plaff-imf7-ac&ref=<?php echo $_GET['ref'];?>&aff=<?php echo $_GET['aff'];?>" onclick="ga('send', 'event', 'imfbuy', 'buy', 'plaffimf7acregister')">
              <div class="inner">
                <i class="all-icons"></i>
                <span>Aktywuj teraz</span>
              </div>
