...
if (empty($_GET['ref'])) $_GET['ref'] = 'plaff_db8_2021acregister';
...
<title>85% zniżki na Driver Booster PRO dla wartościowych użytkowników - IObit</title>
...
<meta property="og:title" content="85% zniżki na Driver Booster PRO dla wartościowych użytkowników - IObit">
        ...
        <dl class="price">
          ...
          <dd>
            <a class="buybtn bigbtn"
               href="https://www.iobit.com/buy.php?product=plaff-db8-ac&ref=<?php echo $_GET['ref']?>&aff=<?php echo $_GET['aff']?>"
               onclick="ga('send', 'event', 'dbbuy', 'buy', 'plaffdb82021acregister');">
              <div class="inner">
                <i class="all-icons"></i>
  ...
  <div class="floatlayer" id="floatlayer">
    <div class="wrapper clearfix">
      <div class="left">
        ...
        <p><strong>85% ZNIŻKI</strong> na pozbycie się awarii systemu i niestabilnej gry</p>
      </div>
      <div class="pricebox">
        <dl class="price fr">
