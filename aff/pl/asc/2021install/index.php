...
if (empty($_GET['ref'])) $_GET['ref'] = 'plaff_asc14_2021install';
...
<title>Dziękujemy za zainstalowanie Advanced SystemCare 14 – IObit</title>
  ...
  <div class="pagebanner">
    <div class="container comp-heading clearfix">
      ...
      <div class="heading-info">
        ...
        <h3>Dziękujemy za zainstalowanie Advanced SystemCare Pro! <br>Zaktualizuj teraz, aby uzyskać szybszy, czystszy i bezpieczniejszy komputer</h3>
        <p>
        Advanced SystemCare PRO czyści, optymalizuje i chroni Twój komputer jeszcze lepiej. Czyści niepotrzebne wpisy rejestru, aby poprawić stabilność komputera i usuwa pliki tymczasowe, aby zwolnić miejsce na dysku. Przyspiesza uruchamianie komputera nawet o 200%, a Internet Booster optymalizuje połączenie internetowe nawet o 300%. Zapewnia również lepszą ochronę prywatności w Internecie, eliminując ślady odwiedzanych witryn internetowych i pamięci podręcznej programu. Więcej informacji na temat edycji PRO można znaleźć w poniższej tabeli.
        </p>
        <div class="price-zone clearfix">
          ...
          <a class="button btn-orange large"
             href="https://www.iobit.com/buy.php?product=plaff-asc141pc5490&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" 
             onclick="ga('send', 'event', 'ascbuy', 'buy', 'plaffasc142021install');">
            Kup Teraz
          </a>
        </div>
      </div>
    ...
    <div class="container">
      <div class="compare">
        <table border="0" cellspacing="0" cellpadding="0" width="100%" class="comparetab">
          ...
          <tbody>
												<tr>
							<td colspan="4" class="mid-header">Czyszczenie i optymalizacja wydajności komputera </td>
						</tr>
												<tr>
							<td class="icon">
							...
							<td class="describe">1 kliknięcie, aby naprawić błędy dysku dla bardziej stabilnego i wydajnego systemu PC  <i class="tags new"></i></td>
							...
							<td class="describe">Nowy tryb AI do inteligentnego skanowania oraz czyszczenia i optymalizacji komputera <i class="tags improved"></i></td>
							...
							<td class="itempro"><i class="fa fa-check" aria-hidden="true"></i></td>
																		...
																		<tr>
							<td colspan="4" class="mid-header">Zwiększenie prędkości komputera </td>
						</tr>
												<tr>
							<td class="icon">
							...
							<td class="itempro"><i class="fa fa-check" aria-hidden="true"></i></td>
																		...
																		<tr>
							<td colspan="4" class="mid-header">Zapewnienie bezpieczeństwa komputera oraz prywatności </td>
						</tr>
												<tr>
							<td class="icon">
								<img src="https://www.iobit.com/tpl/images/comparison/protect/pr_b_spy.png" alt="">
							</td>
							<td class="describe">Podstawowa ochrona komputera z usuwaniem programów szpiegujących </td>
							...
							<td class="describe">Ochrona surfowania Premium z automatycznie usuwanymi danymi śledzenia <i class="tags improved"></i></td>
							...
							<td class="itempro"><i class="fa fa-check" aria-hidden="true"></i></td>
																		...
																		<tr>
							<td colspan="4" class="mid-header">Optymalna usługa IObit </td>
						</tr>
												<tr>
							<td class="icon">
