...
$ref1pc='plaff_asc13_2020buy1pc';
$ref3pc='plaff_asc13_2020buy3pc';
if(!empty($_GET['ref'])){
    ...
    <div class="box pc">
      ...
      <div class="price">
        ...
        <a class="buybtn"
           ...
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'plaffasc132020buy1pc');">
          Dodaj do koszyka
        </a>
      </div>
    </div>
    ...
    <div class="box pcs">
      ...
      <div class="price">
        ...
        <a class="buybtn"
           ...
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'plaffasc132020buy3pc')">
          Dodaj do koszyka
        </a>
