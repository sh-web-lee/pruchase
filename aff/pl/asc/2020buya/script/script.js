...
var pcga = "ga('send', 'event', 'ascbuy', 'buy', 'plaffasc132020buya1pc');";
var pcsga = "ga('send', 'event', 'ascbuy', 'buy', 'plaffasc132020buya3pc');";

var pcgab = "ga('send', 'event', 'ascbuy', 'buy', 'plaffasc132020buya1pcoff');";
var pcsgab = "ga('send', 'event', 'ascbuy', 'buy', 'plaffasc132020buya3pcoff');";

var pcgabc = "ga('send', 'event', 'ascbuy', 'buy', 'plaffasc132020buya1pc');";
var pcsgabc = "ga('send', 'event', 'ascbuy', 'buy', 'plaffasc132020buya3pc')";

if ($ref1pc.length <= 0) $ref1pc = 'plaff_asc13_2020buya1pc';
if ($ref3pc.length <= 0) $ref3pc = 'plaff_asc13_2020buya3pc';

if ($ref1pcoff.length <= 0) $ref1pcoff = 'plaff_asc13_2020buya1pcoff';
if ($ref3pcoff.length <= 0) $ref3pcoff = 'plaff_asc13_2020buya3pcoff';
...
function planA() {
  ...
  $(".offer .pc").find(".price").html('' +
    ...
    '<a class="buybtn"' +
    ' href="https://www.iobit.com/buy.php?product=plaff-asc131pc5490&ref=' + $ref1pc + '&aff=' + aff + '&tw=' + tw + '"' +
    'onclick="' + pcga + '">' +
    'Dodaj do koszyka' +
    '</a>');
  $(".offer .pcs").find(".price").html('' +
    ...
    '<a class="buybtn" ' +
    'href="https://www.iobit.com/buy.php?product=plaff-asc133pc7990&ref=' + $ref3pc + '&aff=' + aff + '&tw=' + tw + '"' +
    'onclick="' + pcsga + '">' +
    'Dodaj do koszyka' +
    '</a>' +
...
function planB() {
  ...
  $(".offer .pc").find(".price").html('<table>' +
    ...
    '</tr></table>' +
    '<a class="buybtn" ' +
    'href=https://www.iobit.com/buy.php?product=plaff-asc131pc4118&ref=' + $ref1pcoff + '&aff=' + aff + '&tw=' + tw + '' +
    ' onclick="' + pcgab + '">' +
    'Dodaj do koszyka' +
    '</a>' +
  ...
  $(".offer .pcs").find(".price").html('<table>' +
    ...
    '</tr></table>' +
    '<a class="buybtn" ' +
    'href="https://www.iobit.com/buy.php?product=plaff-asc133pc5993&ref=' + $ref3pcoff + '&aff=' + aff + '&tw=' + tw + '" ' +
    'onclick="' + pcsgab + '">' +
    'Dodaj do koszyka' +
    '</a>' +
