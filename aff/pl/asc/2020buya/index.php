...
$ref1pc='plaff_asc13_2020buya1pc';
$ref3pc='plaff_asc13_2020buya3pc';
if(!empty($_GET['ref'])){
  ...
  <div class="offer clearfix">
    ...
    <div class="box pc">
      ...
      <div class="price">
        ...
        <!-- 1pc buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=plaff-asc131pc5490&ref=<?php echo $ref1pc;?>&aff=<?php echo $_GET['aff']?>"
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'plaffasc132020buya1pc');">
          Dodaj do koszyka
        </a>
      </div>
    </div>
    ...
    <div class="box pcs">
      ...
      <div class="price">
        ...
        <!-- 3pc buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=plaff-asc133pc7990&ref=<?php echo $ref3pc;?>&aff=<?php echo $_GET['aff']?>"
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'plaffasc132020buya3pc')">
          Dodaj do koszyka
        </a>
