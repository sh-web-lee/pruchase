...
var pcga = "ga('send', 'event', 'ascbuy', 'buy', 'plaffasc142021buy1pc');";
var pcsga = "ga('send', 'event', 'ascbuy', 'buy', 'plaffasc142021buy3pc');";

var pcgab = "ga('send', 'event', 'ascbuy', 'buy', 'plaffasc142021buy1pcoff');";
var pcsgab = "ga('send', 'event', 'ascbuy', 'buy', 'plaffasc142021buy3pcoff');";

var pcgabc = "ga('send', 'event', 'ascbuy', 'buy', 'plaffasc142021buy1pc');";
var pcsgabc = "ga('send', 'event', 'ascbuy', 'buy', 'plaffasc142021buy3pc')";

if ($ref1pc.length <= 0) $ref1pc = 'plaff_asc14_2021buy1pc';
if ($ref3pc.length <= 0) $ref3pc = 'plaff_asc14_2021buy3pc';

if ($ref1pcoff.length <= 0) $ref1pcoff = 'plaff_asc14_2021buy1pcoff';
if ($ref3pcoff.length <= 0) $ref3pcoff = 'plaff_asc14_2021buy3pcoff';
...
function planA() {
  ...
  $(".offer .pc").find(".price").html('' +
    ...
    '<a class="buybtn"' +
    ' href="https://www.iobit.com/buy.php?product=plaff-asc141pc5490&ref='+ $ref1pc +'&aff='+ aff +'&tw='+ tw +'"' +
    'onclick="' + pcga + '">' +
    'Dodaj do koszyka'+
    '</a>');
  $(".offer .pcs").find(".price").html('' +
    ...
    '<a class="buybtn" ' +
    'href="https://www.iobit.com/buy.php?product=plaff-asc143pc7990&ref='+ $ref3pc +'&aff='+ aff +'&tw='+ tw +'"' +
    'onclick="' + pcsga + '">' +
    'Dodaj do koszyka' +
    '</a>' +
...
function planB() {
  ...
  $(".offer .pc").find(".price").html('<table>' +
    ...
    '</tr></table>' +
    '<a class="buybtn" ' +
    'href=https://www.iobit.com/buy.php?product=plaff-asc141pc4118&ref='+ $ref1pcoff +'&aff='+ aff +'&tw='+ tw +'"' +
    ' onclick="' + pcgab + '">' +
    'Dodaj do koszyka' +
    '</a>' +
  ...
  $(".offer .pcs").find(".price").html('<table>' +
    ...
    '</tr></table>' +
    '<a class="buybtn" ' +
    'href="https://www.iobit.com/buy.php?product=plaff-asc143pc5993&ref='+ $ref3pcoff +'&aff='+ aff +'&tw='+ tw +'" ' +
    'onclick="' + pcsgab + '">' +
    'Dodaj do koszyka' +
    '</a>' +
