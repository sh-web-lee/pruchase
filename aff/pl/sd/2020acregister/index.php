...
if (empty($_GET['ref'])) $_GET['ref'] = 'plaff_sd6_2020acregister';
?>
<!DOCTYPE html>
<html lang="pl">
<head>
    ...
    <div class="wrapper">
      ...
      <div class="pricebox">
        <dl class="price">
          ...
          <dd>
            <a class="buybtn bigbtn" href="https://www.iobit.com/buy.php?product=plaff-sd6-acak&ref=<?php echo $_GET['ref']; ?><?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>" onclick="ga('send', 'event', 'sdbuy', 'buy', 'plaffsd62020acregister');">
              <div class="inner">
                <i class="all-icons"></i>
    ...
    <div class="wrapper clearfix">
      ...
      <div class="pricebox">
        <dl class="price fr">
          ...
          <dd>
            <a class="buybtn smallbtn" href="https://www.iobit.com/buy.php?product=plaff-sd6-acak&ref=<?php echo $_GET['ref']; ?><?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>" onclick="ga('send', 'event', 'sdbuy', 'buy', 'plaffsd62020acregister');">
              <div class="inner">
                <i class="all-icons"></i>
                <span>Aktywuj teraz</span>
              </div>
