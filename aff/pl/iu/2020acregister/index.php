...
if (empty($_GET['ref'])) $_GET['ref'] = 'plaff_iu9_2020acregister';
...
<title>85% ZNIŻKI na IObit Uninstaller PRO - IObit</title>
...
<script type="text/javascript" src="<?php echo $pRootUrl; ?>tpl/js/stats.js"></script>
    ...
    <div class="wrapper">
      ...
      <div class="pricebox">
        <dl class="price">
          ...
          <dd>
            <a class="buybtn bigbtn" href="https://www.iobit.com/buy.php?product=plaff-iu9-acak&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" onclick="ga('send', 'event', 'iubuy', 'buy', 'plaffiu92020acregister')">
              <div class="inner">
                <i class="all-icons"></i>
  ...
  <div class="feature wrapper">
    ...
    <div class="clearfix">
      <dl>
        ...
        <dd>
          <h3>WYKRYCIE I ODINSTALOWANIE BUNDLEWARE</h3>
          <p>Wykrywaj adware, paski narzędzi i niechciane programy innych firm wraz z oprogramowaniem freeware, aby zapobiec kradzieży Twoich danych dotyczących prywatności.</p>
        </dd>
      </dl>
      <dl class="right">
        <dt><img src="<?php echo getStaticUrl('images/feature_icons_02.png')?>" alt="" /></dt>
        <dd>
          <h3>KONIEC Z REKLAMAMI PODCZAS SURFOWANIA</h3>
          <p>Odinstaluj złośliwe i oparte na reklamach wtyczki dla bezpiecznego i czystego przeglądania.</p>
        </dd>
      </dl>
    </div>
    <div class="clearfix">
  ...
  <div class="footbuy">
    <div class="wrapper">
      <h2>Gwarancja czystego, lekkiego PC oraz bezpiecznego surfowania online</h2>
      <div class="pricebox">
        <dl class="price">
          <dt>TYLKO:  <strong>39,90 zł </strong><del>266 zł</del></dt>
          <dd>
  ...
  <div class="floatlayer" id="floatlayer">
    <div class="wrapper clearfix">
      <div class="left">
        ...
        <p><strong>85% ZNIŻKI</strong>, aby pozbyć się niechcianych programów i drażniących reklam typu pop-up</p>
      </div>
      <div class="pricebox">
        <dl class="price fr">
          <dt><strong>39,90 zł </strong><del>266 zł</del></dt>
          <dd>
            <a class="buybtn smallbtn" href="https://www.iobit.com/buy.php?product=plaff-iu9-acak&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" onclick="ga('send', 'event', 'iubuy', 'buy', 'plaffiu92020acregister')">
              <div class="inner">
                <i class="all-icons"></i>
                <span>Aktywuj teraz</span>
              </div>
