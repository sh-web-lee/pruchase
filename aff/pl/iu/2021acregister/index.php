...
if(in_array($_GET['st'],array('ascu_aciu','asc_aciu'))){
  ...
  if (empty($_GET['ref'])) $_GET['ref'] = 'plaff_iu10_2021acregister';
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<meta property="og:title" content="85% ZNIŻKI na IObit Uninstaller PRO - IObit">
    ...
    <div class="wrapper">
      ...
      <div class="pricebox">
        <dl class="price">
          ...
          <dd>
            <a class="buybtn bigbtn" href="https://www.iobit.com/buy.php?product=plaff-iu101pc3990&ref=<?php echo $_GET['ref']?>&aff=<?php echo $_GET['aff']?>" onclick="ga('send', 'event', 'iubuy', 'buy', 'plaffiu102021acregister') ;">
              <div class="inner">
                <i class="all-icons"></i>
    ...
    <div class="wrapper clearfix">
      ...
      <div class="pricebox">
        <dl class="price fr">
          ...
          <dd>
            <a class="buybtn smallbtn" href="https://www.iobit.com/buy.php?product=plaff-iu101pc3990&ref=<?php echo $_GET['ref']?>&aff=<?php echo $_GET['aff']?>" onclick="ga('send', 'event', 'iubuy', 'buy', 'plaffiu102021acregister') ;">
              <div class="inner">
                <i class="all-icons"></i>
                <span>Aktywuj teraz</span>
              </div>
