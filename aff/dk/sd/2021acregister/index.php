...
if (empty($_GET['ref'])) $_GET['ref'] = 'dkaff_sd6_2021acregister';
...
<head>
  ...
  <title>85% RABAT på Smart Defrag PRO – Iobit</title>
...
<div id="main">
    ...
    <div class="intro">
      ...
      <div class="discount">
        ...
        <div class="btnarea">
          <a class="checkbtn"
             href="https://www.iobit.com/buy.php?product=dkaff-sd61pc89&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>"
             onclick="ga('send', 'event', 'sdbuy', 'buy', 'dkaffsd62021acregister') ;" >
            KØB NU
          </a>
    ...
    <div class="checkout">
      <div class="moneyback">
        Du er fuldt beskyttet af vores 100% pengene-tilbage-garanti og vil opleve en betydelig forbedring af din pc's ydeevne indenfor 60 dage, ellers får du alle pengene tilbage. Ingen yderligere spørgsmål. <a href="https://www.iobit.com/buy.php?product=dkaff-sd61pc89&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>"
             onclick="ga('send', 'event', 'sdbuy', 'buy', 'dkaffsd62021acregister') ;">
          Køb nu
        </a>
      </div>
