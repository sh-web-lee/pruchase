...
if (empty($_GET['ref'])) $_GET['ref'] = 'dkaff_iu9_2020acregister';
...
<title>85% rabat -- Kun til IObits værdsatte kunder</title>
...
<script type="text/javascript" src="<?php echo $pRootUrl; ?>tpl/js/stats.js"></script>
  ...
  <div class="banner">
    <div class="wrapper">
      ...
      <div class="pricebox">
        <dl class="price">
          <dt>KUN: <strong>kr.89 </strong><del>kr.593</del></dt>
          <dd>
            <a class="buybtn bigbtn"
               href="https://www.iobit.com/buy.php?product=dkaff-iu9-acak&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>"
               onclick="ga('send', 'event', 'iubuy', 'buy', 'dkaffiu92020acregister')">
              <div class="inner">
                <i class="all-icons"></i>
  ...
  <div class="feature wrapper">
    ...
    <div class="clearfix">
      <dl>
        ...
        <dd>
          ...
          <p>Slet stædige programmer som ikke kan afinstalleres konventionelt fuldstændigt.</p>
        </dd>
      </dl>
      <dl class="right one">
    ...
    <div class="clearfix">
      ...
      <dl class="right">
        ...
        <dd>
          <h3>INGEN ANNONCER NÅR DU SURFER</h3>
          <p>Afinstaller annoncebaserede og ondsindede plug-ins for en bedre og sikrere browser oplevelse.</p>
        </dd>
      </dl>
    </div>
    <div class="clearfix">
  ...
  <div class="floatlayer" id="floatlayer">
    <div class="wrapper clearfix">
      <div class="left">
        ...
        <p>Få <strong>85% RABAT</strong> og fjern uønskede programmer og generende pop-op annoncer</p>
      </div>
      <div class="pricebox">
        <dl class="price fr">
          <dt><strong>kr.89 </strong><del>kr.593</del></dt>
          <dd>
