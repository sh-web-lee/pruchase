...
if(in_array($_GET['st'],array('ascu_aciu','asc_aciu'))){
  ...
  if (empty($_GET['ref'])) $_GET['ref'] = 'dkaff_iu10_2021acregister';
?>
<!DOCTYPE html>
<html lang="dk">
<head>
        ...
        <dl class="price">
          ...
          <dd>
            <a class="buybtn bigbtn"
               href="https://www.iobit.com/buy.php?product=dkaff-iu101pc89&ref=<?php echo $_GET['ref']?>&aff=<?php echo $_GET['aff']?>"
               onclick="ga('send', 'event', 'iubuy', 'buy', 'dkaffiu102021acregister') ;">
              <div class="inner">
                <i class="all-icons"></i>
