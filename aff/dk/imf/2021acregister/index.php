...
if (empty($_GET['ref'])) $_GET['ref'] = 'dkaff_imf8_2021acregister';
?>
<!DOCTYPE html>
<html lang="dk">
<head>
    ...
    <div class="wrapper">
        ...
        <div class="intro">
            ...
            <div class="discount">
				...
				<div class="wprice">KUN <em>kr.139</em> <del> kr.929 </del> <span> 1 år, 1 pc</span></div>
                <!-- <div class="wprice"><del>kr.379</del><span>1 år, 1 pc</span></div> -->
                <div class="btnarea">
                    <a href="https://www.iobit.com/buy.php?product=dkaff-imf81pc139&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" onclick="ga('send', 'event', 'imfbuy', 'buy', 'dkaffimf82021acregister') " class="checkbtn">KØB NU >></a>
            ...
            <div class="leftbox">
              ...
              <ul>
                  ...
                  <li>
                    ...
                    Opdager og fjerner over 209,000,000 skjulte trusler
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    Tilføjer et ekstra lag af beskyttelse oveni anti-ransomware motoren som beskytter flere filtyper og mapper fra angribere.
                  </li>
                  <li>
        ...
        <div class="checkout">
            <div class="moneyback">
                Du er fuldt beskyttet af vores 100% pengene-tilbage-garanti og du vil opleve en betydelig forbedring af din pc's ydeevne indenfor 60 dage, ellers får du alle pengene tilbage. Ingen yderligere spørgsmål.  <a href="https://www.iobit.com/buy.php?product=dkaff-imf81pc139&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" onclick="ga('send', 'event', 'imfbuy', 'buy', 'dkaffimf82021acregister') ">Køb nu</a>
            </div>
            <div class="btn">
                <a href="https://www.iobit.com/buy.php?product=dkaff-imf81pc139&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" onclick="ga('send', 'event', 'imfbuy', 'buy', 'dkaffimf82021acregister') " class="checkbtn">KØB NU >></a>
                <span>100% tilbagebetalingsgaranti</span>
