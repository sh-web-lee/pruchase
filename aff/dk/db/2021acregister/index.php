...
if (empty($_GET['ref'])) $_GET['ref'] = 'dkaff_db8_2021acregister';
...
<head>
  ...
  <title>85% rabat på Driver Booster PRO for værdsatte brugere – Iobit</title>
...
<div class="banner">
  <div class="wrapper">
    ...
    <div class="pricebox">
      <dl class="price">
        <dt>KUN: <strong>kr.139</strong> <del>kr.929</del></dt>
        <dd>
          <a class="buybtn bigbtn"
             href="https://www.iobit.com/buy.php?product=dkaff-db8-ac&ref=<?php echo $_GET['ref']?>&aff=<?php echo $_GET['aff']?>"
             onclick="ga('send', 'event', 'dbbuy', 'buy', 'dkaffdb82021acregister');">
            <div class="inner">
              <i class="all-icons"></i>
  ...
  <div class="clearfix">
    <dl>
      ...
      <dd>
        ...
        <p>Driverdatabase med 3.500.000+ muligheder. Finder og opdaterer dine forældede drivere med et enkelt klik.</p>
      </dd>
    </dl>
    <dl class="right">
...
<div class="floatlayer" id="floatlayer">
  <div class="wrapper clearfix">
    <div class="left">
      ...
      <p> Få <strong>85% RABAT </strong>og slip for pc-nedbrud og ustabile spil</p>
    </div>
    <div class="pricebox">
      <dl class="price fr">
        <dt><strong>kr.139 </strong><del>kr.929</del></dt>
        <dd>
