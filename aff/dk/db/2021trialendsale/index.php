...
if (empty($_GET['ref'])) $_GET['ref'] = 'dkaff_db8_2021trialendsale';
?>
<!DOCTYPE html>
<html lang="dk">
<head>
			...
			<div class="offer clearfix">
				...
				<div class="right fr">
					...
					<ul class="price clearfix">
						...
						<li class="last">
							<a class="buybtn" 
							   href="https://www.iobit.com/buy.php?product=dkaff-db83pc189&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff'];?>"
							   onclick="ga('send', 'event', 'dbbuy', 'buy', 'dkaffdb82021trialendsale')">
