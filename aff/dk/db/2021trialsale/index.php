...
if (empty($_GET['ref'])) $_GET['ref'] = 'dkaff_db8_2021trialsale';
      ...
      <div class="content clearfix">
        ...
        <dl class="fl">
          ...
          <dd>
            ...
            <!-- 1pc buybtn -->
            <a class="buybtn"
               href="https://www.iobit.com/buy.php?product=dkaff-db81pc189&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff'];?>"
               onclick="ga('send', 'event', 'dbbuy', 'buy', 'dkaffdb82021trialsale')">
              Køb nu
            </a>
          </dd>
        </dl>
        ...
        <dl class="fl large">
          ...
          <dd>
            ...
            <a class="buybtn black"
               href="https://www.iobit.com/buy.php?product=dkaff-db83pcsd199&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']?>"
               onclick="ga('send', 'event', 'dbbuy', 'buy', 'dkaffdb82021trialsale')">
              Køb nu
            </a>
            <!-- person -->
        ...
        <dl class="fr">
          ...
          <dd>
            ...
            <!-- 3pc buybtn -->
            <a class="buybtn"
               href="https://www.iobit.com/buy.php?product=dkaff-db83pc199&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']?>"
               onclick="ga('send', 'event', 'dbbuy', 'buy', 'dkaffdb82021trialsale')">
              Køb nu
            </a>
          </dd>
	  ...
	  <table>
	    ...
	    <tbody>
	      ...
	      <tr>
	        ...
	        <td class="itema"><p class="exTxt first">≤ <span class="days">7</span> dage</p></td>
	        <td class="space"></td>
	      ...
	      <tr>
	        ...
	        <td class="itema"><p class="exTxt">≤ <span class="days">7</span> dage</p></td>
	        <td class="space"></td>
	        <td class="itemb"><i class="all-icons black">√</i></td>
	        <td class="space"></td>
	        <td class="itemc"><i class="all-icons red">√</i></td>
	      ...
	      <tr>
	        ...
	        <td class="itema"><p class="exTxt">≤ <span class="days">7</span> dage</span></p></td>
	        <td class="space"></td>
	        <td class="itemb"><i class="all-icons black">√</i></td>
	        <td class="space"></td>
	        <td class="itemc"><i class="all-icons red">√</i></td>
