...
var pcga = "ga('send', 'event', 'ascbuy', 'buy', 'dkaffasc132020buya1pc');";
var pcsga = "ga('send', 'event', 'ascbuy', 'buy', 'dkaffasc132020buya3pc');";

var pcgab = "ga('send', 'event', 'ascbuy', 'buy', 'dkaffasc132020buya1pcoff');";
var pcsgab = "ga('send', 'event', 'ascbuy', 'buy', 'dkaffasc132020buya3pcoff');";

var pcgabc = "ga('send', 'event', 'ascbuy', 'buy', 'dkaffasc132020buya1pc');";
var pcsgabc = "ga('send', 'event', 'ascbuy', 'buy', 'dkaffasc132020buya3pc')";

if ($ref1pc.length <= 0) $ref1pc = 'dkaff_asc13_2020buya1pc';
if ($ref3pc.length <= 0) $ref3pc = 'dkaff_asc13_2020buya3pc';

if ($ref1pcoff.length <= 0) $ref1pcoff = 'dkaff_asc13_2020buya1pcoff';
if ($ref3pcoff.length <= 0) $ref3pcoff = 'dkaff_asc13_2020buya3pcoff';
...
function planA() {
  ...
  $(".offer .pc").find(".price").html('' +
    ...
    '<a class="buybtn"' +
    ' href="https://www.iobit.com/buy.php?product=dkaff-asc131pc159&ref=' + $ref1pc + '&aff=' + aff + '&tw=' + tw + '"' +
    'onclick="' + pcga + '">' +
    'Føj til kurv' +
    '</a>');
  $(".offer .pcs").find(".price").html('' +
    ...
    '<a class="buybtn" ' +
    'href="https://www.iobit.com/buy.php?product=dkaff-asc133pc219&ref=' + $ref3pc + '&aff=' + aff + '&tw=' + tw + '"' +
    'onclick="' + pcsga + '">' +
    'Føj til kurv ' +
    '</a>' +
...
function planB() {
  ...
  $(".offer .pc").find(".price").html('<table>' +
    ...
    '</tr></table>' +
    '<a class="buybtn" ' +
    'href=https://www.iobit.com/buy.php?product=dkaff-asc131pc120&ref=' + $ref1pcoff + '&aff=' + aff + '&tw=' + tw + ' ' +
    ' onclick="' + pcgab + '">' +
    'Føj til kurv' +
    '</a>' +
    '<h5> Spar: kr. 198</h5>');
  $(".offer .pcs").find(".price").html('<table>' +
    ...
    '</tr></table>' +
    '<a class="buybtn" ' +
    'href="https://www.iobit.com/buy.php?product=dkaff-asc133pc165&ref=' + $ref3pcoff + '&aff=' + aff + '&tw=' + tw + '" ' +
    'onclick="' + pcsgab + '">' +
    'Føj til kurv' +
    '</a>' +
    '<h5>Spar: kr. 382</h5>');
...
function maskB() {
  ...
  $(".mask-planb").html("<h2>TILLYKKE!</h2><p>Du er den heldige besøgende i dag! Få <b>25% ekstra i rabat</b>, <br> gælder i en begrænset tidsperiode!</p><img class='off' src='" + imgSrc + "'><div class='buybox'><a class='buybtn' href='javascript: void(0);' onclick='maskCount(1);cycleCountdown(2);'>GØR BRUG AF MIN RABAT NU</a><p onclick='maskClose()'>Nej tak, jeg vil gerne betale fuld pris</p></div>");
