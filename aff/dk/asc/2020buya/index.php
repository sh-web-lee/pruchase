...
$ref1pc='dkaff_asc13_2020buya1pc';
$ref3pc='dkaff_asc13_2020buya3pc';
if(!empty($_GET['ref'])){
  ...
  <div class="wrapper clearfix">
    <dl class="fl clearfix">
      ...
      <dd class="fl">
        ...
        <p>Køb nu og genopliv din langsomme computer. Med SystemCare 13 PRO kan <br> du få den op på fuld kapacitet!</p>
      </dd>
    </dl>
    <div class="right fr">
  ...
  <div class="offer clearfix">
    ...
    <div class="box pc">
      ...
      <div class="price">
        ...
        <!-- 1pc buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=dkaff-asc131pc159&ref=<?php echo $ref1pc;?>&aff=<?php echo $_GET['aff']?>"
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'dkaffasc132020buya1pc')">
          Føj til kurv
        </a>
      </div>
    </div>
    ...
    <div class="box pcs">
      ...
      <div class="price">
        ...
        <!-- 3pc buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=dkaff-asc133pc219&ref=<?php echo $ref3pc;?>&aff=<?php echo $_GET['aff']?>"
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'dkaffasc132020buya3pc')">
          Føj til kurv
        </a>
