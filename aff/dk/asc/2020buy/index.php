...
$ref1pc='dkaff_asc13_2020buy1pc';
$ref3pc='dkaff_asc13_2020buy3pc';
if(!empty($_GET['ref'])){
    ...
    <div class="box pc">
      ...
      <div class="price">
        ...
        <a class="buybtn"
           ...
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'dkaffasc132020buy1pc')">
          Føj til kurv
        </a>
      </div>
    </div>
    ...
    <div class="box pcs">
      ...
      <div class="price">
        ...
        <a class="buybtn"
           ...
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'dkaffasc132020buy3pc')">
          Føj til kurv
        </a>
