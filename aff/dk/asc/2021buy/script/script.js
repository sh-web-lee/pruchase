...
var pcga = "ga('send', 'event', 'ascbuy', 'buy', 'dkaffasc142021buy1pc');";
var pcsga = "ga('send', 'event', 'ascbuy', 'buy', 'dkaffasc142021buy3pc');";

var pcgab = "ga('send', 'event', 'ascbuy', 'buy', 'dkaffasc142021buy1pcoff');";
var pcsgab = "ga('send', 'event', 'ascbuy', 'buy', 'dkaffasc142021buy3pcoff');";

var pcgabc = "ga('send', 'event', 'ascbuy', 'buy', 'dkaffasc142021buy1pc');";
var pcsgabc = "ga('send', 'event', 'ascbuy', 'buy', 'dkaffasc142021buy3pc')";

if ($ref1pc.length <= 0) $ref1pc = 'dkaff_asc14_2021buy1pc';
if ($ref3pc.length <= 0) $ref3pc = 'dkaff_asc14_2021buy3pc';

if ($ref1pcoff.length <= 0) $ref1pcoff = 'dkaff_asc14_2021buy1pcoff';
if ($ref3pcoff.length <= 0) $ref3pcoff = 'dkaff_asc14_2021buy3pcoff';
...
function planA() {
  ...
  $(".offer .pc").find(".price").html('' +
    ...
    '<a class="buybtn"' +
    ' href="https://www.iobit.com/buy.php?product=dkaff-asc141pc159&ref='+ $ref1pc +'&aff='+ aff +'&tw='+ tw +'"' +
    'onclick="' + pcga + '">' +
    'Føj til kurv' +
    '</a>');
  $(".offer .pcs").find(".price").html('' +
    ...
    '<a class="buybtn" ' +
    'href="https://www.iobit.com/buy.php?product=dkaff-asc143pc219&ref='+ $ref3pc +'&aff='+ aff +'&tw='+ tw +'"' +
    'onclick="' + pcsga + '">' +
    'Føj til kurv ' +
    '</a>' +
...
function planB() {
  ...
  $(".offer .pc").find(".price").html('<table>' +
    ...
    '</tr></table>' +
    '<a class="buybtn" ' +
    'href=https://www.iobit.com/buy.php?product=dkaff-asc141pc120&ref='+ $ref1pcoff +'&aff='+ aff +'&tw='+ tw +'"' +
    ' onclick="' + pcgab + '">' +
    'Føj til kurv' +
    '</a>' +
    '<h5> Spar: kr. 198</h5>');
  $(".offer .pcs").find(".price").html('<table>' +
    ...
    '</tr></table>' +
    '<a class="buybtn" ' +
    'href="https://www.iobit.com/buy.php?product=dkaff-asc143pc165&ref='+ $ref3pcoff +'&aff='+ aff +'&tw='+ tw +'" ' +
    'onclick="' + pcsgab + '">' +
    'Føj til kurv' +
    '</a>' +
    '<h5>Spar: kr. 382</h5>');
