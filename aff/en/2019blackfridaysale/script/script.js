...
function reBuyLink(){
  ...
  if(refPattern.test(ref)){
    var buyBtn=$('.buybtn');
    buyBtn.eq(0).attr('href', '#').attr('data-fsc-action', 'Add,Checkout').attr('data-fsc-item-path-value','2019-iobit-black-friday-best-value-pack-1-pc-2797');
    buyBtn.eq(1).attr('href', '#').attr('data-fsc-action', 'Add,Checkout').attr('data-fsc-item-path-value','2019-iobit-black-friday-best-value-pack-3-pcs-3397');
    buyBtn.eq(2).attr('href', '#').attr('data-fsc-action', 'Add,Checkout').attr('data-fsc-item-path-value','advanced-systemcare-pro-1-year-subscription-1-pc-2019bf-1199');
    buyBtn.eq(3).attr('href', '#').attr('data-fsc-action', 'Add,Checkout').attr('data-fsc-item-path-value','advanced-systemcare-pro-1-year-subscription-3-pcs-2019bf-1499');
    buyBtn.eq(4).attr('href', '#').attr('data-fsc-action', 'Add,Checkout').attr('data-fsc-item-path-value','driver-booster-pro-1-year-subscription-1-pc-2019bf-1499');
    buyBtn.eq(5).attr('href', '#').attr('data-fsc-action', 'Add,Checkout').attr('data-fsc-item-path-value','driver-booster-pro-1-year-subscription-3-pcs-2019bf-1799');
    buyBtn.eq(6).attr('href', '#').attr('data-fsc-action', 'Add,Checkout').attr('data-fsc-item-path-value','iobit-malware-fighter-pro-1-year-subscription-1-pc-2019bf-1499');
    buyBtn.eq(7).attr('href', '#').attr('data-fsc-action', 'Add,Checkout').attr('data-fsc-item-path-value','iobit-malware-fighter-pro-1-year-subscription-3-pcs-2019bf-1799');
    buyBtn.eq(8).attr('href', '#').attr('data-fsc-action', 'Add,Checkout').attr('data-fsc-item-path-value','macbooster-lite-1-mac-2019bf-1799');
    buyBtn.eq(9).attr('href', '#').attr('data-fsc-action', 'Add,Checkout').attr('data-fsc-item-path-value','macbooster-standard-3-macs-2019bf-3299');
    buyBtn.eq(10).attr('href', '#').attr('data-fsc-action', 'Add,Checkout').attr('data-fsc-item-path-value','iobit-software-updater-pro-1-year-subscription-1-pc-899');
    buyBtn.eq(11).attr('href', '#').attr('data-fsc-action', 'Add,Checkout').attr('data-fsc-item-path-value','iobit-software-updater-pro-1-year-subscription-3-pcs-2019bf-1199');
    buyBtn.eq(12).attr('href', '#').attr('data-fsc-action', 'Add,Checkout').attr('data-fsc-item-path-value','iobit-uninstaller-pro-1-year-subscription-1-pc-2019bf-999');
    buyBtn.eq(13).attr('href', '#').attr('data-fsc-action', 'Add,Checkout').attr('data-fsc-item-path-value','iobit-uninstaller-pro-1-year-subscription-3-pcs-2019bf-1299');
    buyBtn.eq(14).attr('href', '#').attr('data-fsc-action', 'Add,Checkout').attr('data-fsc-item-path-value','2019-iobit-black-friday-pack-asc-db-1-pc-2248');
    buyBtn.eq(15).attr('href', '#').attr('data-fsc-action', 'Add,Checkout').attr('data-fsc-item-path-value','2019-iobit-black-friday-pack-asc-db-3-pcs');
    buyBtn.eq(16).attr('href', '#').attr('data-fsc-action', 'Add,Checkout').attr('data-fsc-item-path-value','2019-iobit-black-friday-pack-asc-imf-1-pc-2248');
    buyBtn.eq(17).attr('href', '#').attr('data-fsc-action', 'Add,Checkout').attr('data-fsc-item-path-value','2019-iobit-black-friday-pack-asc-imf-3-pcs');
    buyBtn.eq(18).attr('href', '#').attr('data-fsc-action', 'Add,Checkout').attr('data-fsc-item-path-value','2019-iobit-black-friday-pack-db-imf-1-pc-2498');
    buyBtn.eq(19).attr('href', '#').attr('data-fsc-action', 'Add,Checkout').attr('data-fsc-item-path-value','2019-iobit-black-friday-pack-db-imf-3-pcs');
  }
}
...
(function () {
  ...
  $(window).on('scroll', function () {
    ...
    if ($(window).scrollTop() > $(".offer70").offset().top) {
      $(".nav a").eq(1).addClass("active").siblings().removeClass("active");
    }
    if ($(window).scrollTop() > $(".offer75").offset().top) {
