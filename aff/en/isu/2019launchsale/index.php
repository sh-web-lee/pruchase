...
if (empty($_GET['ref'])) $_GET['ref'] = 'enaff_isu2_2019launchsale';
?>
<!DOCTYPE html>
<html lang="en">
<head>
	...
	<div class="banner">
		<div class="wrapper">
          ...
          <p class="price">
            ...
            <a href="https://www.iobit.com/buy.php?product=enaff-isu23pcsdpf&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']?>" onclick="ga('send', 'event', 'isubuy', 'buy', 'enaffisu22019launchsale');" class="buybtn">Activate Now</a>
          </p>
          <ul class="list">
          	<li>
		...
		<div class="wrapper clearfix">
			...
			<div class="right-message">
				...
				<dl class="list01">
					...
					<dd><strong>Simple</strong> Software updates get downloaded  without opening a web browser. </dd>
				</dl>
				<dl>
...
<script src="<?php echo getStaticUrl('script/jquery.animateNumber.min.js')?>"></script>
    ...
    <script>setTimeout('window.location.href="https://purchase.iobit.com/aff/en/isu/2020specialsale/index.php'+location.search+'"',5000);</script>
</div>
</body>
</html>