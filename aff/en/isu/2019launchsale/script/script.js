...
function soldOut() {
	...
	if (ref.length <= 0) ref = 'enaff_isu2_2019launchsale';
	...
	$(".banner .right-message .progress").html("<h3>IObit Software Updater 2 PRO</h3> <p>1 Year Subscription / 3 PCs</p>")
	...
	$(".buybtn").attr("href", 'https://www.iobit.com/buy.php?product=enaff-isu23pc&ref=' + ref + '&aff=' + aff + '&tw=' + tw);
}
