...
function soldOut() {
	...
	$(".buybtn").attr({
		"href": 'https://www.iobit.com/buy.php?product=enaff-isu3preorder3pc1297&ref=' + refGet + refStr + '&aff=' + aff + '&tw=' + tw,
	});
}
// soldOut();
...
$(function() {
  ...
  setTimeout('window.location.href="https://purchase.iobit.com/aff/en/isu/2020specialsale/index.php'+location.search+'"',5000);
