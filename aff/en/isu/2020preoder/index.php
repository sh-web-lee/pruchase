...
if (empty($_GET['ref'])) $_GET['ref'] = 'enaff_isu3_2020preorder';
?>
<!DOCTYPE html>
<html lang="en">
<head>
		...
		<div class="wrapper">
            ...
            left only, while <strong class="viewNum"><?php echo $viewNum;?></strong> are viewing 
					...
					<p class="price">
						...
						<a href="https://www.iobit.com/buy.php?product=enaff-isu3preorder&ref=<?php echo $_GET['ref']; ?><?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>" onclick="ga('send', 'event', 'isubuy', 'buy', 'enaffisu32020preorder');" class="buybtn">Pre-order Now</a>
					</p>
				</div>
		</div>
	</div>
