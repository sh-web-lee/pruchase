...
$viewNum=rand(99,189);
if (empty($_GET['ref'])) $_GET['ref'] = 'enaff_sd6_anniversarysale'; 
if (!empty($_GET['action'])&&$_GET['action'] == 'getPacks') {
  $date = $_GET['d'];
  $c_name='ensdanni'.$date;
  ...
  <div class="wrapper">
    ...
    <div class="offer clearfix">
      ...
      <div class="fr right">
        ...
        <!-- buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=enaff-sd63pcspf&ref=<?php echo $_GET['ref']?>&aff=<?php echo $_GET['aff']?>"
           onclick="ga('send', 'event', 'sdbuy', 'buy', 'enaffsd6anniversarysale')">
          <i class="all-icons"></i>
          Activate Now
        </a>
        <!-- attention -->
...
<div class="choose">
  <div class="wrapper">
    <h2>Why Need to Activate Smart Defrag 7 PRO? </h2>
    <hr>
    <p>
...
<div class="comparison wrapper">
  <h2> More Reasons to Activate Smart Defrag 7 PRO：</h2>
  <table>
    <thead>
    <tr>
      <th></th>
...
<script>
  ...
  var soldout = {
    _soldouthref: "https://www.iobit.com/buy.php?product=enaff-sd63pcs&ref=<?php echo $_GET['ref']?>&aff=<?php echo $_GET['aff']?>&tw=-8",
    _soldoutga: "ga('send', 'event', 'sdbuy', 'buy', 'enaffsd6anniversarysale');"
  }
</script>
</body>
</html>