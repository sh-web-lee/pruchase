...
$('.coupon').click(function(e){
  ...
  if(e.target.className.indexOf('showz') > -1){
    z()
    return
  }
})
...
$('.float').click(function(){
  ...
  if(isMobile){
    ...
    $('.float—max-box').css('visibility','visible')
  }
})
...
var domList = {
  Seventy:[
    {id:'asc',oneYear:{delac:'73',leftNum:'135',b:'$11.75',del:'$65.28',ga:"ga('send', 'event', 'ascbuy', 'buy', 'enaffasc142020bf1pc')",link:buyLinkAsc1pc},threeYear:{delac:'64',leftNum:'128',b:'$14.75',del:'$81.94',ga:"ga('send', 'event', 'ascbuy', 'buy', 'enaffasc142020bf3pc')",link:buyLinkAsc3pc},imgName:"./images/70-asc.png",title:"The World's 1st PC Tune-Up Utility",text:"Deep clean your PC with one-click & make your PC cleaner, faster and more secure."},
    {id:'db',oneYear:{delac:'58',leftNum :'119',b:'$14.95',del:'$83.06',ga:"ga('send', 'event', 'dbbuy', 'buy', 'enaffdb82020bf1pc') ",link:buyLinkDb1pc},threeYear:{delac:'73',leftNum:'116',b:'$17.95',del:'$99.72',ga:"ga('send', 'event', 'dbbuy', 'buy', 'enaffdb82020bf3pc')  ",link:buyLinkDb3pc},imgName:"./images/70-db.png",title:"Your Must-have Driver Updating Tool",text:"Automatically and safely keep over 4,500,000 drivers & popular game components up-to-date."},
    {id:'imf',oneYear:{delac:'133',leftNum :'353',b:'$13.95',del:'$77.50',ga:"ga('send', 'event', 'imfbuy', 'buy', 'enaffimf82020bf1pc') ",link:buyLinkImf1pc},threeYear:{delac:'118',leftNum:'314',b:'$16.95',del:'$94.17',ga:"ga('send', 'event', 'imfbuy', 'buy', 'enaffimf82020bf3pc') ",link:buyLinkImf3pc},imgName:"./images/70-up.png",title:"Stay Protected with Full-scale Antimalware ",text:"Triple engines to fully protect your PC against malware,virus & ransomware in real time."},
    {id:'mb',oneYear:{delac:'76',leftNum :'309',b:'$15.99',del:'$88.83',ga:"ga('send', 'event', 'mbbuy', 'buy', 'enaffmb82020bf1mac')",link:buyLinkMb1pc},threeYear:{delac:'76',leftNum:'316',b:'$27.99',del:'$155.50',ga:"ga('send', 'event', 'mbbuy', 'buy', 'enaffmb82020bf3mac')",link:buyLinkMb3pc},imgName:"./images/70-mb.png",title:"A Faster and more Secured Mac ",text:"Your one-stop Mac maintenance tool to clean up junks, boost Mac performance, and remove Mac malware & virus."},
    {id:'isu',oneYear:{delac:'92',leftNum :'235',b:'$6.99',del:'$38.83',ga:"ga('send', 'event', 'isubuy', 'buy', 'enaffisu32020bf1pc')",link:buyLinkIsu1pc},threeYear:{delac:'99',leftNum:'227',b:'$9.99',del:'$55.50',ga:"ga('send', 'event', 'isubuy', 'buy', 'enaffisu32020bf3pc')",link:buyLinkIsu3pc},imgName:"./images/70-isu.png",title:"Auto-Keep your Software Up-to-date",text:"Automatically update your software on schedule & download & install recommended essential software."},
    {id:'iu',oneYear:{delac:'106',leftNum :'213',b:'$9.99',del:'$55.50',ga:"ga('send', 'event', 'iubuy', 'buy', 'enaffiu102020bf1pc')",link:buyLinkIu1pc},threeYear:{delac:'95',leftNum:'206',b:'$12.97',del:'$72.06',ga:"ga('send', 'event', 'iubuy', 'buy', 'enaffiu102020bf3pc')",link:buyLinkIu3pc},imgName:"./images/70-iur.png",title:"Completely Remove Stubborn Programs",text:"Completely delete stubborn and bundled programs, Windows Apps & browser plug-ins without leaving a trace ."},
  ],
  seventyFive:[
    {oneYear:{b:'$19.28',del:'$148.33',ga:"ga('send', 'event', 'ascbuy', 'buy', 'enaffasc14db2020bf1pc')",link:buyLinkAscDb1pc},threeYear:{b:'$23.62',del:'$181.67',ga:"ga('send', 'event', 'ascbuy', 'buy', 'enaffasc14db2020bf3pc')",link:buyLinkAscDb3pc},imgName:"./images/asc-db.png",title:"Make your PC Faster and more Stable",text:"Includes:<br/> Advanced SystemCare PRO and <br/>Driver Booster PRO"},
    {oneYear:{b:'$15.70',del:'$120.78',ga:"ga('send', 'event', 'ascbuy', 'buy', 'enaffasc14iu2020bf1pc')",link:buyLinkAscIu1pc},threeYear:{b:'$20.02',del:'$154',ga:"ga('send', 'event', 'ascbuy', 'buy', 'enaffasc14iu2020bf3pc')",link:buyLinkAscIu3pc},imgName:"./images/asc-iu.png",title:"Keep your PC & Software in Top Condition",text:"Includes:<br/>Advanced SystemCare PRO and <br/>IObit Uninstaller PRO"},
    {oneYear:{b:'$20.87',del:'$160.56',ga:"ga('send', 'event', 'dbbuy', 'buy', 'enaffdb8imf2020bf1pc')",link:buyLinkDbImf1pc},threeYear:{b:'$25.21',del:'$193.89',ga:"ga('send', 'event', 'dbbuy', 'buy', 'enaffdb8imf2020bf3pc')",link:buyLinkDbImf3pc},imgName:"./images/db-imf.png",title:"Make your PC more Stable and Secure",text:"Includes:<br/>Driver Booster PRO and <br/>IObit Malware Fighter PRO"},
  ],
  Review:[
...
function zj(){
  cSet('2021salecj','1')
  ga('send', 'event', 'bfbuy', 'buy', 'enaff2020bfpopup1');
  ...
  setTimeout(function(){
    $.ajax({
      ...
      success: function (res) {
        ...
        $(".coupon i").removeClass("icon").addClass("showz")
        ga('send', 'event', 'bfbuy', 'buy', 'enaff2020bfpopup5');
        $('.coupon i.hide').removeAttr('onclick').attr('onclick',`ga('send', 'event', 'bfbuy', 'buy', 'enaff2020bfpopup6')`)
        set = setTimeout(()=>{
          z()
          allNum()
        },10000)
...
//     $('.coupon').removeAttr('onclick').attr('onclick',`ga('send', 'event', 'bfbuy', 'buy', 'enaff2020bfpopup8')`)
//     $('.coupon i.hide').removeAttr('onclick').attr('onclick',`ga('send', 'event', 'bfbuy', 'buy', 'enaff2020bfpopup9')`)
//     wl = false
//   }
// })
...
function getSales(type,button) {
  ...
  $.ajax({
    ...
    success: function(res) {
      ...
      $('#'+type).find('.'+button).children('p').find('del').css('width',al.toFixed(2)+'px')
      if (packs > 0) {
...
function getRetime(type, button) {
  var date = new Date();
  var packsNum_p = cGet('bfriday' + type + button + '_p',1);
  if (type == "asc") {
    if (button == 'onepc') {
...
function onPopClosed(orderReference) {
  if (orderReference) {
    if(cGet('2020sale') == null && cGet('2021salecj') === '1'){
      $(".email").css("display", "block");
      ga('send', 'event', 'bfbuy', 'buy', 'enaff2020bfpopup12')
    }else{
...
(function () {
  ...
  if(refPattern.test(ref)){
    var buyBtn=$('a');
    buyBtn.eq(0).attr('href', '#').attr('data-fsc-action', 'Add,Checkout').attr('data-fsc-item-path-value','iobit-black-friday-best-value-pack-1-pc-2258');
    buyBtn.eq(1).attr('href', '#').attr('data-fsc-action', 'Add,Checkout').attr('data-fsc-item-path-value','iobit-black-friday-best-value-pack-3-pcs-2758');
    ...
    buyBtn.eq(14).attr('href', '#').attr('data-fsc-action', 'Add,Checkout').attr('data-fsc-item-path-value','iobit-black-friday-pack-asc-db-1-pc-1928');
    buyBtn.eq(15).attr('href', '#').attr('data-fsc-action', 'Add,Checkout').attr('data-fsc-item-path-value','iobit-black-friday-pack-asc-db-3-pcs-2362');
    buyBtn.eq(16).attr('href', '#').attr('data-fsc-action', 'Add,Checkout').attr('data-fsc-item-path-value','iobit-black-friday-pack-asc-iu-1-pc-1570');
    buyBtn.eq(17).attr('href', '#').attr('data-fsc-action', 'Add,Checkout').attr('data-fsc-item-path-value','iobit-black-friday-pack-asc-iu-3-pcs-2002');
    buyBtn.eq(18).attr('href', '#').attr('data-fsc-action', 'Add,Checkout').attr('data-fsc-item-path-value','iobit-black-friday-pack-db-imf-1-pc-2078');
    buyBtn.eq(19).attr('href', '#').attr('data-fsc-action', 'Add,Checkout').attr('data-fsc-item-path-value','iobit-black-friday-pack-db-imf-3-pcs-2521');
  }
