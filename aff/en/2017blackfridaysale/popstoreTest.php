...
if(($_GET['src']=='tp') && in_array($_GET['t'],array('4719026','4718966','4718965','4718973',
        '4718972','4718980','4718979','4718982','4718981','4718984'))){
    if($_COOKIE[$cName]!=1){
                ...
                <div class="right fl">
                    ...
                    <ul class="btnbox clearfix">
                        <li>
                            ...
                            <a class="buybtn bfp1" href="http://www.iobit.com/buy.php?product=enaffbfpack2398&ref=enaff-asc11dbimf-2017bf1pc&aff=<?php echo $_GET['aff'];?>" onclick="ga('send', 'event', 'ascbuy', 'buy', 'enaffasc11dbimf2017bf1pc')">
                                <i class="all-icons"></i>
                        ...
                        <li id="introbtn" class="red">
                            ...
                            <a class="buybtn bfp3" href="http://www.iobit.com/buy.php?product=enaffbfpack3398&ref=enaff-asc11dbimf-2017bf3pc&aff=<?php echo $_GET['aff'];?>" onclick="ga('send', 'event', 'ascbuy', 'buy', 'enaffasc11dbimf2017bf3pc')">
                                <i class="all-icons"></i>
                ...
                <div class="gift fl">
                    ...
                    <ul class="btnbox clearfix">
                        <li>
                            ...
                            <a class="buybtn asc1" href="http://www.iobit.com/buy.php?product=enaffasc111199&ref=enaff-asc11-2017bf1pc&aff=<?php echo $_GET['aff'];?>" onclick="ga('send', 'event', 'ascbuy', 'buy', 'enaffasc112017bf1pc')">
                                <i class="all-icons"></i>
                                <b>BUY NOW <em>1 Year/ 1 PC</em></b>
                            </a>
                        </li>
                        <li class="red">
                            ...
                            <a class="buybtn asc3" href="http://www.iobit.com/buy.php?product=enaffasc111499&ref=enaff-asc11-2017bf3pc&aff=<?php echo $_GET['aff'];?>" onclick="ga('send', 'event', 'ascbuy', 'buy', 'enaffasc112017bf3pc')">
                                <i class="all-icons"></i>
                                <b>BUY NOW <em>1Year/ 3 PCs</em></b>
                            </a>
                        </li>
                ...
                <div class="gift fr">
                    ...
                    <ul class="btnbox clearfix">
                        <li>
                            ...
                            <a class="buybtn db1" href="http://www.iobit.com/buy.php?product=enaffdb51199&ref=enaff-db5-2017bf1pc&aff=<?php echo $_GET['aff'];?>" onclick="ga('send', 'event', 'dbbuy', 'buy', 'enaffdb52017bf1pc')">
                                <i class="all-icons"></i>
                                <b>BUY NOW <em>1 Year/ 1 PC</em></b>
                            </a>
                        </li>
                        <li class="red">
                            ...
                            <a class="buybtn db3" href="http://www.iobit.com/buy.php?product=enaffdb51799&ref=enaff-db5-2017bf3pc&aff=<?php echo $_GET['aff'];?>" onclick="ga('send', 'event', 'dbbuy', 'buy', 'enaffdb52017bf3pc')">
                                <i class="all-icons"></i>
                                <b>BUY NOW <em>1Year/ 3 PCs</em></b>
                            </a>
                        </li>
            ...
            <div class="giftbox clearfix">
                <div class="gift fl">
                    ...
                    <ul class="btnbox clearfix">
                        <li>
                            <p>Only $<strong>11<small>.95</small></strong> <del>$39.95</del></p>
                            <a class="buybtn imf1" href="http://www.iobit.com/buy.php?product=enaffimf51199&ref=enaff-imf5-2017bf1pc&aff=<?php echo $_GET['aff'];?>" onclick="ga('send', 'event', 'imfbuy', 'buy', 'enaffimf52017bf1pc')">
                                <i class="all-icons"></i>
                                <b>BUY NOW <em>1 Year/ 1 PC</em></b>
                            </a>
                        </li>
                        <li class="red">
                            ...
                            <a class="buybtn imf3" href="http://www.iobit.com/buy.php?product=enaffimf51799&ref=enaff-imf5-2017bf3pc&aff=<?php echo $_GET['aff'];?>" onclick="ga('send', 'event', 'imfbuy', 'buy', 'enaffimf52017bf3pc')">
                                <i class="all-icons"></i>
                                <b>BUY NOW <em>1Year/ 3 PCs</em></b>
                            </a>
                        </li>
                ...
                <div class="gift fr">
                    ...
                    <ul class="btnbox clearfix">
                        <li>
                            ...
                            <a class="buybtn mb1" href="http://www.iobit.com/buy.php?product=enaffmb61499&ref=enaff-mb6-2017bf1pc&aff=<?php echo $_GET['aff'];?>" onclick="ga('send', 'event', 'mbbuy', 'buy', 'enaffmb62017bf1pc')">
                                <i class="all-icons"></i>
                                <b>BUY NOW <em>1 Year/ 1 PC</em></b>
                            </a>
                        </li>
                        <li class="red">
                            ...
                            <a class="buybtn mb3" href="http://www.iobit.com/buy.php?product=enaffmb63299&ref=enaff-mb6-2017bf3pc&aff=<?php echo $_GET['aff'];?>" onclick="ga('send', 'event', 'mbbuy', 'buy', 'enaffmb62017bf3pc')">
                                <i class="all-icons"></i>
                                <b>BUY NOW <em>1Year/ 3 PCs</em></b>
                            </a>
                        </li>
