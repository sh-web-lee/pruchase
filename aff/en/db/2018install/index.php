<?php  
  ...
  if (empty($_GET['ref'])) $_GET['ref'] = 'enaff_db6_2018install';
  include $pRootUrl.'include/common.inc.php';
$buyLink="https://www.iobit.com/buy.php?product=enaff-db61pc1598&ref=".$_GET['ref']."&aff=".$_GET['aff']."&tw=-8";
$refStr=$_GET['ref'];
		...
		<div class="container comp-heading clearfix">
			...
			<div class="heading-info">
				...
				<div class="price-zone clearfix">
					...
					<a href="<?php echo $buyLink;?>" onclick="ga('send', 'event', 'dbbuy', 'buy', 'enaffdb62018install')" class="button btn-orange large">Buy Now</a>
				</div>
			</div>
		</div>
	</div>
					...
					<thead>
						<tr>
							...
							<td class="itempro">
								...
								<a href="<?php echo $buyLink;?>" onclick="ga('send', 'event', 'dbbuy', 'buy', 'enaffdb62018install')" class="button btn-orange small">BUY NOW <small>(Only $15.98)</small></a>
		...
		<div class="container">
			...
			<div class="price-zone clearfix" style="width: 280px;">
				<dl>
					...
					<dd><a href="<?php echo $buyLink;?>" onclick="ga('send', 'event', 'dbbuy', 'buy', 'enaffdb62018install')" class="button btn-orange large">Buy Now</a></dd>
