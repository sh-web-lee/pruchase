...
// $refStr=empty($_GET['ref'])?'cyri_enaff_db7_2019launchsale':$_GET['ref'];
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
	...
	<div class="banner">
		<div class="wrapper">
            ...
            <!-- DB+SD+IU -->
						<a class="buybtn"
						   href="https://www.iobit.com/buy.php?product=enaff-driverbooster72395&ref=cyri_enaff_db7_2019launchsale<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>"
...
<script src="<?php echo getStaticUrl('script/script-cyri.js')?>"></script>
</body>
</html>