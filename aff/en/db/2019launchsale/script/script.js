...
if(refStr.indexOf('fspi')==-1){
	buyLinkArr=[
		"https://www.iobit.com/buy.php?product=enaff-driverbooster72395&ref="+ refStr +"&aff=" + affStr + "&tw=" + tw,
		"https://www.iobit.com/buy.php?product=enaff-db7sd&ref="+ refStr +"&aff=" + affStr + "&tw=" + tw,
		"https://www.iobit.com/buy.php?product=enaff-db7iu&ref="+ refStr +"&aff=" + affStr + "&tw=" + tw,
		"https://www.iobit.com/buy.php?product=enaff-db7sdiu&ref="+ refStr +"&aff=" + affStr + "&tw=" + tw
	];
}else{
	buyLinkArr=[
		"https://iobit.onfastspring.com/driver-booster-pro-1-year-subscription-3-pcs-2395?ref="+refStr,
		"https://iobit.onfastspring.com/driver-booster-pro-with-smart-defrag-pro-2495?ref="+refStr,
		"https://iobit.onfastspring.com/driver-booster-pro-with-iobit-uninstaller-pro-2495?ref="+refStr,
		"https://iobit.onfastspring.com/driver-booster-pro-valued-pack-2595?ref="+refStr
	]
}
