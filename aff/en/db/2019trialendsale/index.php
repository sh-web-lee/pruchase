...
if(empty(json_decode(base64_decode($_GET['tdata'])))){
	...
	$refStr=empty($_GET['ref'])?'enaff_db7_2019trialendsale':$_GET['ref'];
}
?>
<!DOCTYPE html>
<html lang="en">
			...
			<div class="offer clearfix">
				...
				<div class="right fr">
					...
					<ul class="price clearfix">
						...
						<li class="last">
							<a class="buybtn" 
							   href="https://www.iobit.com/buy.php?product=enaff-driverbooster71995&ref=<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>"
							   onclick="ga('send', 'event', 'dbbuy', 'buy', 'enaffdb72019trialendsale')">
