...
$pageDevice=in_array($_GET['pri'],array('asc','imf','iu','sd'))?1:0;
  if (empty($_GET['ref'])) $_GET['ref'] = 'enaff_db8_2021newyearsale';

$buyUrl_dsi = "https://www.iobit.com/buy.php?product=enaff-db8sdiu&ref=".$_GET['ref']."&aff=".$_GET['aff'];

$buyUrl_ds = "https://www.iobit.com/buy.php?product=enaff-db8sd&ref=".$_GET['ref']."&aff=".$_GET['aff'];

$buyUrl_di = "https://www.iobit.com/buy.php?product=enaff-db8iu&ref=".$_GET['ref']."&aff=".$_GET['aff'];

$buyUrl_db = "https://www.iobit.com/buy.php?product=enaff-db82395&ref=".$_GET['ref']."&aff=".$_GET['aff'];

if(!empty($_GET['ref'])){

	$ref = strtolower($_GET['ref']);

	if(strpos($ref,'ir') !== false){

		$buyUrl_dsi = "https://iobit.onfastspring.com/driver-booster-pro-valued-pack-2595";

		$buyUrl_ds = "https://iobit.onfastspring.com/driver-booster-pro-with-smart-defrag-pro-2495?ref=".$_GET['ref'];

		$buyUrl_di = "https://iobit.onfastspring.com/driver-booster-pro-with-iobit-uninstaller-pro-2495?ref=".$_GET['ref'];

		$buyUrl_db = "https://iobit.onfastspring.com/driver-booster-pro-1-year-subscription-3-pcs-2395?ref=".$_GET['ref'];
	}
}
?>
<!DOCTYPE html>
...
<div class="banner">
  ...
  <div class="wrapper">
    ...
    <div class="title"><h1 class="new">New Year Big Sale</h1></div>
...
<div class="giftbox">
  <div class="wrapper">
    <h2 class="new">New Year Sale - Buy IObit Signature Products for $1</h2>
    ...
    <ul class="clearfix">
      <li>
        ...
        <p>Maximize Hard Drive Optimization<br> for <span>Faster PC</span></p>
      </li>
      <li class="last">
        <img src="<?php echo getStaticUrl('images/iu-icon.png')?>" alt="IObit Uninstaller PRO"/>
        <h3>IObit Uninstaller PRO</h3>
        <strong>$1</strong> <del>$19.99</del>
        <p>Uninstall Unwanted Plug-ins <br>for <span>Cleaner PC & Browsing</span></p>
      </li>
    </ul>
  </div>
</div>
...
<script>
  var buyUrl_dsi="<?= $buyUrl_dsi; ?>";
  var buyUrl_ds="<?= $buyUrl_ds; ?>";
  var buyUrl_di="<?= $buyUrl_di; ?>";
  var buyUrl_db="<?= $buyUrl_db; ?>";
</script>
