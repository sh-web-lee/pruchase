...
var refstr = MApp(2.2).url.getParameters('ref');
paramtw = refstr.indexOf('ir') < 0 ? ("&tw=" + tw) : '';
...
function addUrl(name) {
	switch (name) {
		case "sd":
			$(".buybtn").attr({
				"href": buyUrl_ds + paramtw,
				"onclick": "ga('send', 'event', 'dbbuy', 'buy', 'enaffdb82021newyearsale')",
			});
			break;
		case "iu":
			$(".buybtn").attr({
				"href": buyUrl_di + paramtw,
				"onclick": "ga('send', 'event', 'dbbuy', 'buy', 'enaffdb82021newyearsale')",
			});
			break;
		case "iusd":
			$(".buybtn").attr({
				"href": buyUrl_dsi + paramtw,
				"onclick": "ga('send', 'event', 'dbbuy', 'buy', 'enaffdb82021newyearsale')",
			});
			break;
		default:
