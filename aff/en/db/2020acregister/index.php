...
if(in_array($_GET['st'],array('ascu_acdb','asc_acdb'))){
  ...
  if (empty($_GET['ref'])) $_GET['ref'] = 'enaff_db7_2020acregister';
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<meta property="og:url" content="https://purchase.iobit.com/aff/en/db/2020acregister/index.php">
...
<meta property="og:image" content="https://purchase.iobit.com/aff/en/db/2020acregister/images/snapshot-large-db7.png">
    ...
    <div class="wrapper">
      ...
      <div class="pricebox">
        <dl class="price">
          ...
          <dd>
            <a class="buybtn bigbtn" href="https://www.iobit.com/buy.php?product=enaff-db7-acak&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" onclick="ga('send', 'event', 'dbbuy', 'buy', 'enaffdb72020acregister');">
              <div class="inner">
                <i class="all-icons"></i>
    ...
    <div class="clearfix">
      <dl>
        ...
        <dd>
          ...
          <p>Detect & update over 3,500,000 drivers with 1-click, <br>which improves your computer’s stability and performance.</p>
        </dd>
      </dl>
      <dl class="right">
    ...
    <div class="wrapper clearfix">
      ...
      <div class="pricebox">
        <dl class="price fr">
          ...
          <dd>
            <a class="buybtn smallbtn" href="https://www.iobit.com/buy.php?product=enaff-db7-acak&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" onclick="ga('send', 'event', 'dbbuy', 'buy', 'enaffdb72020acregister');">
              <div class="inner">
                <i class="all-icons"></i>
                <span>Activate Now</span>
              </div>
