...
function addUrl(name) {
	...
	switch (name) {
		case "sd":
			reLink="https://www.iobit.com/buy.php?product=enaff-db6sd&ref=" + refStr + "&aff=" + affStr + "&tw=" + tw;
			if(buyLinkRe){
				reLink="https://iobit.onfastspring.com/driver-booster-pro-with-smart-defrag-pro-2495";
			}
			$(".buybtn").attr({
				"href": reLink,
			});
			break;
		case "iu":
			reLink="https://www.iobit.com/buy.php?product=enaff-db6iu&ref=" + refStr + "&aff=" + affStr + "&tw=" + tw;
			if(buyLinkRe){
				reLink="https://iobit.onfastspring.com/driver-booster-pro-with-iobit-uninstaller-pro-2495";
			}
			$(".buybtn").attr({
				"href": reLink,
			});
			break;
		case "iusd":
			reLink="https://www.iobit.com/buy.php?product=enaff-db6sdiu&ref=" + refStr + "&aff=" + affStr + "&tw=" + tw;
			if(buyLinkRe){
				reLink="https://iobit.onfastspring.com/driver-booster-pro-valued-pack-2595";
			}
			$(".buybtn").attr({
				"href": reLink,
			});
...
function soldProduct() {
	...
	if(buyLinkRe){
		$(".buybtn").attr({
			"href": "https://iobit.onfastspring.com/driver-booster-pro-1-year-subscription-3-pcs-2395",
		});
	}else {
		$(".buybtn").attr({
			"href": "https://www.iobit.com/buy.php?product=enaff-driverbooster62395&ref=" + refStr + "&aff=" + affStr + "&tw=" + tw,
		});
	}
	$(".subscript em").text("3");
}
