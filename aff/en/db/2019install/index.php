<?php  
  ...
  if (empty($_GET['ref'])) $_GET['ref'] = 'enaff_db7_2019install';
  include $pRootUrl.'include/common.inc.php';
$buyLink="https://www.iobit.com/buy.php?product=enaff-driverbooster7cp&ref=".$_GET['ref']."&aff=".$_GET['aff']."&tw=-8";
$refStr=$_GET['ref'];
	...
	<div class="pagebanner">
		<div class="container comp-heading clearfix">
			<div class="heading-img">
				<img src="https://www.iobit.com/tpl/images/banner/heading/heading_db7_629.png" />
			</div>
			<div class="heading-info">
				...
				<p>Unlocking all features, Driver Booster PRO significantly improves PC and game performance. With larger online database, it allows you to get 3,500,000+ PC drivers up-to-date securely with just one-click. Popular game components and Game Ready Drivers help you enjoy smoother gaming experience. With auto driver update, your computer would run smoothly at all times. More about PRO edition you can go through the table below.</p>
				<div class="price-zone clearfix">
					<div class="price">Only <strong>$15.98</strong> <del>$53.27</del></div>
					<a href="<?php echo $buyLink;?>" onclick="ga('send', 'event', 'dbbuy', 'buy', 'enaffdb72019install');" class="button btn-orange large">Buy Now</a>
				</div>
			</div>
		</div>
	</div>
					...
					<thead>
						<tr>
							...
							<td class="itempro">
								...
								<a href="<?php echo $buyLink;?>" onclick="ga('send', 'event', 'dbbuy', 'buy', 'enaffdb72019install')" class="button btn-orange small">BUY NOW <small>(Only $15.98)</small></a>
	...
	<div class="btmarea compare clearfix">
		<div class="container">
			...
			<div class="price-zone clearfix" style="width: 280px;">
				<dl>
					<dt>Only <strong>$15.98</strong> <del>$53.27</del></dt>
					<dd><a href="<?php echo $buyLink;?>" onclick="ga('send', 'event', 'dbbuy', 'buy', 'enaffdb72019install')" class="button btn-orange large">Buy Now</a></dd>
	...
	<div class="footer clearfix">
		<div class="container">
			<div class="bottom clearfix">
				<p class="copy" style="padding: 0; width: 100%; text-align: center;"> &copy; 2005 - 2018 IObit. All Rights Reserved</p>
			</div>
		</div>
	</div>
	<!-- end footer -->
