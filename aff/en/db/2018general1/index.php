<?php  
  ...
  $buyHref="https://www.iobit.com/buy.php?product=enaffdb61pc1247&ref=".(empty($_GET['ref'])?'enaff_db6_2018general1':$_GET['ref'])."&aff=".$_GET['aff'];
  ...
  <div class="banner">
    <div class="wrapper">
      ...
      <ul class="btnbox clearfix">
        <li>
          <a class="btn buy" href="<?php echo $buyHref;?>" onclick="ga('send', 'event', 'dbbuy', 'buy', 'enaffdb62018general1')" data-text="Buy Now &amp; Save 50% >>">
            <span>Buy Now &amp; Save <b>50%</b> >></span>
          </a>
        </li>
      </ul>
