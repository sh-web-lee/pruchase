...
if(($transData->LftTrlDay<=4)&&($_GET['to']=='trialbuy_8')){
	header("location:../2019trialendsale/index.php".(empty($_SERVER['QUERY_STRING'])?'':('?'.$_SERVER['QUERY_STRING'])));
}
...
$refStr=empty($_GET['ref'])?'enaff_db7_2019trialsale':$_GET['ref'];
?>
<!DOCTYPE html>
<html lang="en">
<head>
			...
			<div class="clearfix">
				<div class="offer left">
					...
					<div class="price">
						...
						<a class="buybtn nonshadow"
						   href="https://www.iobit.com/buy.php?product=enaff-driverbooster7&ref=<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>"
						   onclick="ga('send', 'event', 'dbbuy', 'buy', 'enaffdb72019trialsale')">
					...
					<ul>
						...
						<li><i class="all-icons">√</i> Driver Booster 7 Pro   <del>$74.85</del></li>
						<li class="line">-</li>
						<li class="line">-</li>
						<li class="line">-</li>
					</ul>
				...
				<div class="offer right">
					...
					<div class="price">
						...
						<a class="buybtn shadow"
						   href="https://www.iobit.com/buy.php?product=enaff-db7sdiupf&ref=<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>"
						   onclick="ga('send', 'event', 'dbbuy', 'buy', 'enaffdb72019trialsale')">
						...
						<div class="txt">
							<p>
								The price shown in the page is valid only for this promotion.
								 Your Driver Booster subscription will continue after the initial subscription period at the non-promotional price of $29.99. <br>If you choose the Driver Booster 7 bundle pack, all products will also continue after the first year at the normal price shown in the page below.
							</p>
							<p>
		...
		<div class="wrapper">
			...
			<div class="content">
				...
				<dl class="two">
					...
					<dd>
						<h3>Fast Game Loading</h3>
						<p>Update suitable components to guarantee smooth launching.</p>
					</dd>
				</dl>
				<dl class="three">
				...
				<dl class="four">
					...
					<dd>
						...
						<p>Update game-related drivers to experience advanced & new features.</p>
					</dd>
				</dl>
			</div>
		</div>
	  ...
	  <table>
	    ...
	    <tbody>
	      ...
	      <tr>
	        ...
	        <td class="itema"><p class="exTxt first"><span class="days">14</span> <span class="dayStr">days</span></p></td>
	        <td class="space"></td>
	      ...
	      <tr>
	        ...
	        <td class="itema"><p class="exTxt"><span class="days">14</span> <span class="dayStr">days</span></p></td>
	        <td class="space"></td>
	        <td class="itemb"><i class="all-icons black">√</i></td>
	        <td class="space"></td>
	        <td class="itemc"><i class="all-icons red">√</i></td>
	      ...
	      <tr>
	        ...
	        <td class="virtue">Auto download & backup</td>
	        <td class="itema"><p class="exTxt"><span class="days">14</span> <span class="dayStr">days</span></p></td>
	        <td class="space"></td>
	        <td class="itemb"><i class="all-icons black">√</i></td>
	        <td class="space"></td>
...
<script>
	...
	var _href = "https://www.iobit.com/buy.php?product=driverbooster7&ref=trialdb73pcsoldout<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_db&tw=-8";
