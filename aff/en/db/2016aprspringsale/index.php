...
//    $ref3.=$refstr;
//}
$refstr=empty($_GET['ref'])?'enaff_db_2016aprspringsale':$_GET['ref'];
...
<div class="main">
			...
			<div class="panel clearfix">
				...
				<div class="cart">
					...
					<dl class="order clearfix">
						...
						<dd><a  href="http://www.iobit.com/buy.php?product=db14m3pc&ref=<?php echo $refstr;?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', ' enaffdb2016aprspringsale ');" class="active-btn link-btn">Activate Now</a></dd>
					</dl>
					<div class="mask"></div>
				</div>
			</div>
		...
		<table border="0" cellspacing="0" cellpadding="0" width="100%">
			...
			<tr>
				...
				<th class="itema">
					...
					<a class="activebtn link-btn" href="http://www.iobit.com/buy.php?product=db14m3pc&ref=<?php echo $refstr;?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', ' enaffdb2016aprspringsale ');">Activate Now</a>
	...
	<div class="footer wrapper">
		...
		<p class="copyright">Copyright © 2005 - 2016 IObit. All Rights Reserved</p>
	</div>
    <div class="pop-up">
        <div class="pop-main">
            <div class="pop-box">
