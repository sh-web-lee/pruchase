<?php
	...
	if (empty($_GET['ref'])) $_GET['ref'] = 'db2014may';
	//if (empty($_GET['aff'])) $_GET['aff'] = 'db2014easter';
...
<title>Save 75% on Driver Booster PRO & Get Super Gifts for FREE!</title>
	...
	<div class="header">
    	<div class="warpper clearfix">
            ...
            <dl class="time">
                ...
                <dd id="counttime"><span>00</span><span>00</span><span>00</span><em>000</em></dd>
            </dl>
        </div>
    </div>
    <div class="middle">
    	<div class="warpper clearfix">
    		<div class="lace">
              <div class="introduce">
                <h3>Save <span>75%</span> on Driver Booster PRO & Get Super Gifts for FREE!</h3>
                <p>Activate Driver Booster PRO for 3 PCs, get FREE Gift Pack your PC will adore! <span><em id="packs"><?php echo $packsNum; ?> Packs</em> Left Today!</span></p>
              ...
              <div class="control">
                <ul>
                  ...
                  <li class="link"><a href="http://www.iobit.com/buy.php?product=dbsdebook&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_db">ACTIVATE NOW</a></li>
            ...
            <h3 class="corssname">Enjoy More Stable PC Performance with Up-to-date Drivers! <p id="counttime2"><span>00</span>h: <span>00</span>m: <span>00</span>s <em>000</em></p></h3>
                    ...
                    <dl>
                        ...
                        <dd>
                            <ul>
                                ...
                                <li>300% Higher Driver Updating Speed</li>
            ...
            <div class="cross clearfix">
                ...
                <dl class="link">
					...
					<dd><a href="http://www.iobit.com/buy.php?product=dbsdebook&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_db">activate now</a></dd>
                </dl>
                <dl class="right">
           ...
           <div class="floatlayer" id="floatlayer">
                ...
                <dl class="right">
                	<dt><a href="http://www.iobit.com/buy.php?product=dbsdebook&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_db">activate now</a></dt>
