...
if ($_GET['action'] == 'getPacks') {
    ...
    $type = $_GET['type'];
    $button = $_GET['button'];
    $c_name = 'newyear'.$type.$button.'_p' . $date;
    $c_name_t = 'newyear'.$type.$button.'_t' . $date;
...
//   $sql = "insert into newyearsale (email, date) values('$email', '$date')";
//   if ($conn->query($sql)) {
//       sendMail($email,'Congratulations! Enjoy the Free gift pack from IObit',$body);
//   }
//   exit();
//}
$buyLinkAscDbImf1pc='https://www.iobit.com/buy.php?product=enaff-ny2020valuepack2797&ref='.($refStr ? $refStr : 'enaff_asc14dbimf_2020ny1pc').'&aff='.$affStr;
$buyLinkAscDbImf3pc='https://www.iobit.com/buy.php?product=enaff-ny2020valuepack3397&ref='.($refStr ? $refStr : 'enaff_asc14dbimf_2020ny3pc').'&aff='.$affStr;;
$buyLinkAsc1pc='https://www.iobit.com/buy.php?product=enaff-nyasc141199&ref='. ($refStr ? $refStr : "enaff_asc14_2020ny1pc").'&aff='.$affStr;
$buyLinkAsc3pc='https://www.iobit.com/buy.php?product=enaff-nyasc141499&ref='. ($refStr ? $refStr : 'enaff_asc14_2020ny3pc').'&aff='.$affStr;
$buyLinkDb1pc='https://www.iobit.com/buy.php?product=enaff-nydb81499&ref='. ($refStr ? $refStr : 'enaff_db8_2020ny1pc') .'&aff='. $affStr;
$buyLinkDb3pc='https://www.iobit.com/buy.php?product=enaff-nydb81799&ref='. ($refStr ? $refStr : 'enaff_db8_2020ny3pc') .'&aff='. $affStr;
$buyLinkImf1pc='https://www.iobit.com/buy.php?product=enaff-nyimf81499&ref='. ($refStr ? $refStr : 'enaff_imf8_2020ny1pc') .'&aff='. $affStr;
$buyLinkImf3pc='https://www.iobit.com/buy.php?product=enaff-nyimf81799&ref='. ($refStr ? $refStr : 'enaff_imf8_2020ny3pc') .'&aff='. $affStr;
$buyLinkMb1pc='https://www.iobit.com/buy.php?product=enaff-nymb81599&ref='. ($refStr ? $refStr : 'enaff_mb8_2020ny1mac') .'&aff='. $affStr;
$buyLinkMb3pc='https://www.iobit.com/buy.php?product=enaff-nymb82799&ref='. ($refStr ? $refStr : 'enaff_mb8_2020ny3mac') .'&aff='. $affStr;
$buyLinkIsu1pc='https://www.iobit.com/buy.php?product=enaff-nyisu3899&ref'. ($refStr ? $refStr : 'enaff_isu3_2020ny1pc') .'&aff='. $affStr;
$buyLinkIsu3pc='https://www.iobit.com/buy.php?product=enaff-nyisu31199&ref'. ($refStr ? $refStr : 'enaff_isu3_2020ny3pc') .'&aff='. $affStr;
$buyLinkIu1pc='https://www.iobit.com/buy.php?product=enaff-nyiu10999&ref='. ($refStr ? $refStr : 'enaff_iu10_2020ny1pc') .'&aff='. $affStr;
$buyLinkIu3pc='https://www.iobit.com/buy.php?product=enaff-nyiu101299&ref='. ($refStr ? $refStr : 'enaff_iu10_2020ny3pc') .'&aff='. $affStr;
$buyLinkAscDb1pc='https://www.iobit.com/buy.php?product=enaff-ny2020toppacka2248&ref='. ($refStr ? $refStr : 'enaff_asc14db_2020ny1pc') .'&aff='. $affStr;
$buyLinkAscDb3pc='https://www.iobit.com/buy.php?product=enaff-ny2020toppacka2748&ref='. ($refStr ? $refStr : 'enaff_asc14db_2020ny3pc') .'&aff='. $affStr;
$buyLinkAscIu1pc='https://www.iobit.com/buy.php?product=enaff-ny2020toppackb1831&ref='. ($refStr ? $refStr : 'enaff_asc14iu_2020ny1pc') .'&aff='. $affStr;
$buyLinkAscIu3pc='https://www.iobit.com/buy.php?product=enaff-ny2020toppackb2331&ref='. ($refStr ? $refStr : 'enaff_asc14iu_2020ny3pc') .'&aff='. $affStr;
$buyLinkDbImf1pc='https://www.iobit.com/buy.php?product=enaff-ny2020toppackc2498&ref='. ($refStr ? $refStr : 'enaff_db8imf_2020ny1pc') .'&aff='. $affStr;
$buyLinkDbImf3pc='https://www.iobit.com/buy.php?product=enaff-ny2020toppackc2998&ref='. ($refStr ? $refStr : 'enaff_db8imf_2020ny3pc') .'&aff='. $affStr;
...
<link href="https://fonts.googleapis.com/css2?family=Lato:wght@300;400;700&family=Montserrat:wght@400;500;600;700;900&display=swap" rel="stylesheet">
...
<div class="coupon">
    <div class="pop">
      <i class="hide icon" onclick="ga('send', 'event', 'nybuy', 'buy', 'enaff2020nypopup2')"></i>
      <dl>
        <dd class="cj">
          <h2>Congrats! You've been selected!</h2>
          <p class="text"><span>Spin the wheel</span>&nbsp;and win your exclusive Black Friday Prize</p>
          <a class="now"><button class="now playnow btn" onclick="ga('send', 'event', 'nybuy', 'buy', 'enaff2020nypopup3')">Play now</button></a>
          <img class="gifet" src="<?php echo getStaticUrl('images/cj/60-zk.png')?>" alt="" />
          <div class="zp">
            ...
            <a class="play"><button class="play playnow btn" onclick="ga('send', 'event', 'nybuy', 'buy', 'enaff2020nypopup4')">Play now</button></a>
        ...
        <dd class="zj">
          ...
          <a class="zj_b"><button class="zj_b btn" onclick="ga('send', 'event', 'nybuy', 'buy', 'enaff2020nypopup7')">Shop Now</button></a>
        </dd>
        <!-- <dd class="wl">
          ...
          <button class="now icon" onclick="ga('send', 'event', 'nybuy', 'buy', 'enaff2020nypopup10')">Continue shopping</button>
          <p class="l hide icon" onclick="ga('send', 'event', 'nybuy', 'buy', 'enaff2020nypopup11')">No thanks, I want to give up the prize</p>
        </dd> -->
      </dl>
...
<div class="email">
  <div class="bg">
    <i class="hide" onclick="ga('send', 'event', 'nybuy', 'buy', 'enaff2020nypopup13')"></i>
    <div class="cont">
      ...
      <button class="emailbtn" onclick="ga('send', 'event', 'nybuy', 'buy', 'enaff2020nypopup14')"><img class="gift-h" src="<?php echo getStaticUrl('images/yx/gift-h.png')?>" alt="" /><img class="gift" src="<?php echo getStaticUrl('images/yx/gift.png')?>" alt="" /> Claim My Grand Prize</button>
    ...
    <div class="_cont">
      ...
      <p class="to">The <span>Grand Prize</span> pack has been sent to your mail box</p>
...
<div class="snowflakes snowflakes_body"></div>
<div class="pop-up">
    <div class="pop-main">
        <div class="pop-box">
            <h2>Note:</h2>
...
<script src="<?php echo getStaticUrl('script/snowflakes.js')?>"></script>
