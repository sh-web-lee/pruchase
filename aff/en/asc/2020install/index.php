...
if (empty($_GET['ref'])) $_GET['ref'] = 'enaff_asc13_2020install';
...
<title>Thank you for installing Advanced SystemCare 13 - IObit</title>
      ...
      <div class="heading-info">
        ...
        <div class="price-zone clearfix">
          ...
          <a class="button btn-orange large"
             href="https://www.iobit.com/buy.php?product=enaff-asc131pc1477&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" 
             onclick="ga('send', 'event', 'ascbuy', 'buy', 'enaffasc132020install');">
            Buy Now
          </a>
        </div>
      </div>
            ...
            <tr>
              ...
              <td class="itempro">
                ...
                <a class="button btn-orange small" 
                   href="https://www.iobit.com/buy.php?product=enaff-asc131pc1477&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" 
                   onclick="ga('send', 'event', 'ascbuy', 'buy', 'enaffasc132020install');">
                  BUY NOW <small>(Only $14.77)</small>
                </a>
