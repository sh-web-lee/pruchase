...
if (empty($_GET['ref'])) $_GET['ref'] = 'enaff_asc_2017scaninstall';
if($_GET['ref']=='cb1712en'){
	$buyHref="https://www.cleverbridge.com/289/?scope=checkout&cart=184421&pricerule=asc1477&ref=".$_GET['ref']."&AFFILIATE=".$_GET['aff'];
	...
	$buyHref="https://safecart.com/iobit/ascpro1pc/1year1pc1477?coupon=1";
}elseif($_GET['ref']=='fs269814'){
	$buyHref="http://macbooster.7eer.net/c/269814/378282/4385";
}elseif($_GET['ref']=='fs391813'){
	$buyHref="http://macbooster.7eer.net/c/391813/378282/4385";
}else{
...
if(preg_match('/^ir([0-9]*)$/',$_GET['ref'],$matches)){
	...
	if($match==''){
		...
		$buyHref='http://macbooster.7eer.net/c/'.$match.'/556563/4385';
	}
}

if((!empty($_COOKIE['affasccid']))&&($_GET['ref']=='adcs')){
	file_get_contents("https://www.pixelhere.com/et/event.php?advertiser=42761&cid=".$_COOKIE['affasccid']."&id=f6ec43&type=CPAtarget");
}
?>
<!DOCTYPE html>
<html lang="en">
<head>
	...
	<link href='https://fonts.googleapis.com/css?family=Open+Sans:400,300,600,600italic' rel='stylesheet' type='text/css'>
		...
		<div class="wrapper">
			...
			<div class="major-title">
				<div class="leftarea">
					...
					<ul>
						...
						<li><a href="<?php echo $buyHref;?>" onclick="ga('send', 'event', 'ascbuy', 'buy', 'enaffasc102017scaninstall');" class="button yellowbtn"><span>Buy Now</span></a></li>
					</ul>
				</div>
				<dl class="rightarea">
			...
			<table border="0" cellspacing="0" cellpadding="0" width="100%" class="comparetab">
				...
				<tr>
					...
					<td class="items itemb">
						<table>
							...
							<tr class="handle">
								<td><a href="<?php echo $buyHref;?>" onclick="ga('send', 'event', 'ascbuy', 'buy', 'enaffasc102017scaninstall');" target="" class="button yellowbtn middle"><span>Buy Now</span></a></td>
							</tr>
							<tr class="special">
								<td>
				...
				<tr class="handle">
					<td></td>
					<td></td>
					<td class="items"><a href="<?php echo $buyHref;?>" onclick="ga('send', 'event', 'ascbuy', 'buy', 'enaffasc102017scaninstall');" target="" class="button yellowbtn middle"><span>Buy Now</span></a></td>
				</tr>
				<tr class="limit">
					<td></td>
					<td></td>
			...
			<div class="user_rev" id="user_rev">
				<div class="content">
					...
					<dl class="show">
						...
						<dd>"In my opinion, IObit's ASC Pro is the best maintenance application available for the Windows user, providing excellent value and function. Meanwhile, IObit provides expert technical support that is competent, knowledgeable and responsive, adding significant value to their products and services for their customers."</dd>
					</dl>
				</div>
	...
	<div class="btmarea clearfix">
		<div class="wrapper">
			...
			<dl class="handelbuy">
				...
				<dd>
					<p class="butt-holder">
						<a href="<?php echo $buyHref;?>" onclick="ga('send', 'event', 'ascbuy', 'buy', 'enaffasc102017scaninstall');" target="" class="button yellowbtn"><span>Buy Now</span></a>
					</p>
				</dd>
