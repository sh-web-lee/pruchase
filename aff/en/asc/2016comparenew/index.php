...
if (empty($_GET['ref'])) $_GET['ref'] = 'enaff_asc_2016comparenew';
?>
<!DOCTYPE html>
<html lang="en">
<head>
				...
				<div class="major-title">
					<div class="leftarea">
						...
						<ul>
							...
							<li><a href="http://www.iobit.com/buy.php?product=asc101pc1477_aff&ref=<?php echo $_GET['ref'];?>&aff=<?php echo $_GET['aff']; ?>" onclick="ga('send', 'event', 'ascbuy', 'buy', 'enaffasc2016comparenew');" class="button yellowbtn"><span>UPGRADE TO PRO</span></a></li>
						</ul>
					</div>
					<dl class="rightarea">
				...
				<table border="0" cellspacing="0" cellpadding="0" width="100%" class="comparetab">
					<thead>
						<tr>
							<td colspan="2" class="intro">
								...
								<dl>
									<dd> * Enjoy an internet speed up to 300% faster than the Free edition</dd>
									<dd> * Make your PC up to 200% faster startup by managing resources automatically and intelligently</dd>
									<dd> * Enhanced deep cleaning and full protection for better PC & browser performance</dd>
									<dd> * Automatically clear browsing data to avoid privacy leak</dd>
								</dl>			
								<br>					
							...
							<td class="items itemb">
								<table>
									<thead>
										...
										<tr class="handle">
											<td><a href="http://www.iobit.com/buy.php?product=asc101pc1477_aff&ref=<?php echo $_GET['ref'];?>&aff=<?php echo $_GET['aff']; ?>" onclick="ga('send', 'event', 'ascbuy', 'buy', 'enaffasc2016comparenew');" target="" class="button yellowbtn middle"><span>Upgrade <em>to pro</em></span></a></td>
										</tr>
										<tr class="special">
											<td>
					...
					<tfoot>
						...
						<tr class="handle">
							...
							<td></td>
							<td class="items">Your current edition</td>
							<td class="items"><a href="http://www.iobit.com/buy.php?product=asc101pc1477_aff&ref=<?php echo $_GET['ref'];?>&aff=<?php echo $_GET['aff']; ?>" onclick="ga('send', 'event', 'ascbuy', 'buy', 'enaffasc2016comparenew');" target="" class="button yellowbtn middle"><span>Upgrade <em>to pro</em></span></a></td>
						</tr>
						<tr class="limit">
							<td></td>
							<td></td>
		...
		<div class="btmarea clearfix">
			<div class="wrapper">
				...
				<dl class="handelbuy">
					...
					<dd>
						<p class="butt-holder">
							<a href="http://www.iobit.com/buy.php?product=asc101pc1477_aff&ref=<?php echo $_GET['ref'];?>&aff=<?php echo $_GET['aff']; ?>" onclick="ga('send', 'event', 'ascbuy', 'buy', 'enaffasc2016comparenew');" target="" class="button yellowbtn"><span>Buy Now</span></a>
						</p>
					</dd>
