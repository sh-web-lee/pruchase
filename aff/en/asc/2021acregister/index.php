...
if(in_array($_GET['to'],array('db_ac_asc_p1','db_ac_asc_p2'))){
  ...
  if (empty($_GET['ref'])) $_GET['ref'] = 'enaff_asc14_2021acregister';


$buyUrl = "https://www.iobit.com/buy.php?product=enaff-asc141pc1399&ref=".$_GET['ref']."&aff=". $_GET['aff'];
if (preg_match_all('/ir([0-9]*)/', $_GET['ref'], $arr)) {
    $buyUrl = "https://iobit.onfastspring.com/advanced-systemcare-pro-1-year-subscription-1-pc-1399";
    if ($arr[1][0] != null) {
        $buyUrl = "https://macbooster.7eer.net/c/" . $arr[1][0] . "/1086674/4385";
    }
}
?>
<!DOCTYPE html>
...
<title>85% OFF on Advanced SystemCare PRO - IObit</title>
...
<meta property="og:title" content="85% OFF on Advanced SystemCare PRO - IObit">
...
<meta property="og:image" content="http://purchase.iobit.com/2017/asc/aprasc1677/images/snapshot-large.png?t=3">
...
<script type="text/javascript" src="<?php echo $pRootUrl; ?>tpl/js/stats.js"></script>
  ...
  <div class="banner">
    <div class="wrapper">
      ...
      <div class="title">
        ...
        <p>Powerful tune-up utility ensures a clean, safe and fast PC</p>
      </div>
      ...
      <div class="pricebox">
        <dl class="price">
          <dt>ONLY: <strong>$13.99 </strong><del>$93.27</del></dt>
          <dd>
            <a class="buybtn bigbtn" href="<?= $buyUrl; ?>" onclick="ga('send', 'event', 'ascbuy', 'buy', 'enaffasc142021acregister')">
              <div class="inner">
                <i class="all-icons"></i>
  ...
  <div class="feature wrapper">
    <h2>What Advanced SystemCare PRO can do for you?</h2>
    <div class="clearfix">
      <dl>
        <dt><img src="<?php echo getStaticUrl('images/feature_icons_01.png')?>" alt=""></dt>
        <dd>
          <h3>DEEP CLEANING with AI</h3>
          <p>Scan more intelligently with new AI Mode, and get rid of useless registry files to avoid system freezes or crashes.</p>
        </dd>
      </dl>
      <dl class="right">
        ...
        <dd>
          <h3>Fast PC</h3>
          <p>Manage system resources intelligently to speed up PC up to 200%* faster.</p>
        </dd>
      </dl>
    </div>
    <div class="clearfix">
      <dl>
        ...
        <dd>
          <h3>Fast Online Surfing</h3>
          <p>Optimize browser settings for up to 300%* faster downloading, video viewing, online gaming etc.  </p>
        </dd>
      </dl>
      <dl class="right">
        ...
        <dd>
          ...
          <p>Detect & block secret accesses to your personal data immediately.</p>
        </dd>
      </dl>
    </div>
    <div class="clearfix">
      <dl>
        ...
        <dd>
          <h3>Keep PC Safe</h3>
          <p>Prevent malware, spyware and others from infecting your computer in real time.  </p>
        </dd>
      </dl>
      <dl class="right">
        <dt><img src="<?php echo getStaticUrl('images/feature_icons_02.png')?>" alt=""></dt>
        <dd>
          <h3>Automatic Service</h3>
          <p>Auto care your PC as scheduled and clean RAM to improve PC performance.</p>
        </dd>
      </dl>
    </div>
  </div>
    ...
    <div id="dg-container" class="dg-container">
      ...
      <div class="content dg-wrapper">
        ...
        <dl class="reviews">
          <dt><h2><span>User Review</span></h2></dt>
          <dd> 
            <p>"I have been using Advanced SystemCare Pro for a long time and this latest version 14 is even better than version 13. It can find and fix problems very quickly and has so many extra features you can use to keep your computer running well and stable. I cannot recommend it more highly."</p>
      ...
      <ul>
        ...
        <li class="two" data-num="5"><img src="<?php echo getStaticUrl('images/danny-r-sheets.png')?>" alt="Danny R. Sheets"></li>
        ...
        <li class="four" data-num="1"><img src="<?php echo getStaticUrl('images/lyle-stelmaschuk.png')?>" alt="Lyle Stelmaschuk"></li>
        <li class="five" data-num="2"><img src="<?php echo getStaticUrl('images/brendon-o-rourke.png')?>" alt="Brendon O'Rourke"></li>
        <li class="six last" data-num="3"><img src="<?php echo getStaticUrl('images/anthony-baker.png')?>" alt="Anthony Baker"></li>
      </ul>
    </div>
  </div>
  <!-- review end -->
  ...
  <div class="footbuy">
    <div class="wrapper">
      <h2>Enjoy Clean, Secure and Fast PC with All-in-one PC Optimizer </h2>
      <div class="pricebox">
        <dl class="price">
          <dt>ONLY: <strong>$13.99 </strong><del>$93.27</del></dt>
          <dd>
  ...
  <div class="floatlayer" id="floatlayer">
    <div class="wrapper clearfix">
      <div class="left">
        ...
        <p><strong>85% OFF</strong> to Keep Your PC Running at Peak Performance</p>
      </div>
      <div class="pricebox">
        <dl class="price fr">
          <dt><strong>$13.99 </strong><del>$93.27</del></dt>
          <dd>
            <a class="buybtn smallbtn" href="<?= $buyUrl; ?>" onclick="ga('send', 'event', 'ascbuy', 'buy', 'enaffasc142021acregister')">
              <div class="inner">
                <i class="all-icons"></i>
                <span>Activate Now</span>
              </div>
