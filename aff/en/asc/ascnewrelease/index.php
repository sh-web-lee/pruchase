...
if (substr($_GET['ref'], 0, 2) == 'ir') {
	$buyoneLink="https://iobit.onfastspring.com/advanced-systemcare-10-pro-1-year-subscription-3-pcs-1999?";
	$buythreeLink="https://iobit.onfastspring.com/advanced-systemcare-pro-with-3-free-gifts?";
	
	$buypoponeLink="https://iobit.onfastspring.com/advanced-systemcare-pro-1-year-subscription-3-pcs-1799?";
	$buypopthreeLink="https://iobit.onfastspring.com/advanced-systemcare-pro-with-3-free-gifts-1978?";
	
	$buysoldLink="https://iobit.onfastspring.com/advanced-systemcare-10-pro-1-year-subscription-3-pcs-1999?";
	
	$buypopLink ="https://iobit.onfastspring.com/advanced-systemcare-pro-1-year-subscription-3-pcs-1799?";

}else{
	$buyoneLink="https://www.iobit.com/buy.php?product=enaff-asc133pc1999&ref=".(empty($_GET['ref'])?'enaff_asc13_ascnewrelease':$_GET['ref'])."&aff=".$_GET['aff'];
	$buythreeLink="https://www.iobit.com/buy.php?product=enaff-asc13sdiuamc2198&ref=".(empty($_GET['ref'])?'enaff_asc13_ascnewrelease':$_GET['ref'])."&aff=".$_GET['aff'];
	
	$buypoponeLink="https://www.iobit.com/buy.php?product=enaff-asc133pc1799&ref=".(empty($_GET['ref'])?'enaff_asc13_ascnewrelease':$_GET['ref'])."&aff=".$_GET['aff'];
	$buypopthreeLink="https://www.iobit.com/buy.php?product=enaff-asc13sdiuamc1978&ref=".(empty($_GET['ref'])?'enaff_asc13_ascnewrelease':$_GET['ref'])."&aff=".$_GET['aff'];
	
	$buysoldLink="https://www.iobit.com/buy.php?product=enaff-asc133pc1999&ref=".(empty($_GET['ref'])?'enaff_asc13_ascnewrelease':$_GET['ref'])."&aff=".$_GET['aff'];
	
	$buypopLink ="https://www.iobit.com/buy.php?product=enaff-asc133pc1799&ref=".(empty($_GET['ref'])?'enaff_asc13_ascnewrelease':$_GET['ref'])."&aff=".$_GET['aff'];
}
...
//		if((browserLanguage=='tr')&&(irpid!=1)){
//			window.location.replace('./tkasec.php' + queryStr);
//		}else {
...
<div class="banner">
    ...
    <!-- asc message -->
        ...
        <!-- buybtn -->
				<a class="buybtn"
           href="<?php echo $buyoneLink;?>"
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'enaffasc13ascnewrelease');">
