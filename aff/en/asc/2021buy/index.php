  ...
  <div class="offer clearfix">
    ...
    <div class="box pc">
      ...
      <div class="price">
        ...
        <!-- 1pc buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=enaff-asc141pc1477&ref=enaff_asc14_2021buy1pc&aff=<?php echo $_GET['aff'];?>"
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'enaffasc142021buy1pc')">
          Add to Cart
        </a>
      </div>
    </div>
    ...
    <div class="box pcs">
      ...
      <div class="price">
        ...
        <!-- 3pc buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=enaff-asc143pc1999&ref=enaff_asc14_2021buy3pc&aff=<?php echo $_GET['aff'];?>"
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'enaffasc142021buy3pc')">
          Add to Cart
        </a>
