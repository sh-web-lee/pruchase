...
var pcsga = "ga('send', 'event', 'ascbuy', 'buy', 'enaffasc112018buy3pc')";
var pcgab = "ga('send', 'event', 'ascbuy', 'buy', 'enaffasc112018buy1pcoff');";
var pcga = "ga('send', 'event', 'ascbuy', 'buy', 'enaffasc112018buy1pc');";
var pcsgab = "ga('send', 'event', 'ascbuy', 'buy', 'enaffasc112018buy3pcoff');";
...
function planA() {
  ...
  $(".offer .pc").find(".price").html('<p><strong><small>$</small>14.77</strong> <del>$29.99</del></p><a class="buybtn" href="https://www.iobit.com/buy.php?product=enaffasc111pc1477&ref=' + $ref1pc + '&aff=' + aff + '&tw=-8" onclick="' + pcga + '">Add to Cart</a>');
  $(".offer .pcs").find(".price").html('<p><strong><small>$</small>19.99</strong> <del>$49.99</del></p><a class="buybtn" href="https://www.iobit.com/buy.php?product=enaffasc113pc1999&ref=' + $ref3pc + '&aff=' + aff + '&tw=-8" onclick="' + pcsga + '">Add to Cart </a><p class = "people" ><b class="buynum">2,829,369</b>people has bought</p>');
}

function planB() {
  $(".offer .price").addClass("priceb");
  $(".offer .pc").find(".price").html('<p><span>Original</span><span>Sale Price</span><b>After Extra 25% OFF</b></p><p><del>$29.99</del><del class="center">$14.77</del><strong>$11.08</strong></p><a class="buybtn" href="https://www.iobit.com/buy.php?product=enaffasc111pc1108&ref=' + $ref1pcoff + '&aff=' + aff + '&tw=-8" onclick="' + pcgab + '">Add to Cart</a><h5>Save: $18.91</h5>');
  $(".offer .pcs").find(".price").html('<p><span><b>Original</b></span><span><b>Sale Price </b></span><b>After Extra 25% OFF</b></p><p><del>$49.99</del><del class="center">$19.99</del><strong>$14.99</strong></p><a class="buybtn" href="https://www.iobit.com/buy.php?product=enaffasc113pc1499&ref=' + $ref3pcoff + '&aff=' + aff + '&tw=-8" onclick="' + pcsgab + '">Add to Cart</a><h5>Save: $35.00</h5>');
}
