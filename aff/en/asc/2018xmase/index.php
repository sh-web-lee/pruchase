...
if (empty($_GET['ref'])) $_GET['ref'] = 'enaff_asc12_2018xmase';
  ...
  <div class="main">
        ...
        <div class="palen clearfix">
          ...
          <div class="right fr">
            ...
            <div class="price">
              ...
              <a class="buybtn" href="https://www.iobit.com/buy.php?product=enaff-asc123pc1477&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff'];?>" onclick="ga('send', 'event', 'ascbuy', 'buy', 'enaffasc122018xmase');">
                Renew Now
              </a>
    ...
    <div class="centbuy">
      <div class="wrapper">
        ...
        <div class="price">
          <a class="buybtn bigbtn" href="https://www.iobit.com/buy.php?product=enaff-asc123pc1477&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" onclick="ga('send', 'event', 'ascbuy', 'buy', 'enaffasc122018xmase');">
            Renew Now & Save 70%
          </a>
          <p class="year">1 Year Subscription / 3 PCs</p>
        </div>
    ...
    <div class="floatlayer">
        <div class="wrapper clearfix">
          ...
          <!-- buybtn -->
          <a class="buybtn yellow fr" href="https://www.iobit.com/buy.php?product=enaff-asc123pc1477&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" onclick="ga('send', 'event', 'ascbuy', 'buy', 'enaffasc122018xmase');">
            Renew Now & Save 70%
          </a>
        </div>
    </div>
    ...
    <div class="popShow">
      ...
      <div class="clearfix">
        ...
        <div class="price fl">
          ...
          <a class="buybtn yellow" href="https://www.iobit.com/buy.php?product=enaff-asc123pc1677&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" onclick="ga('send', 'event', 'ascbuy', 'buy', 'enaffasc122018xmase');">
            Renew Now
          </a>
          <p class="year">1 Year Subscription / 3 PCs</p>
        </div>
