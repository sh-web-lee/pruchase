...
if (empty($_GET['ref'])) $_GET['ref'] = 'enaff_asc_2017installnew';
...
<head>
	...
	<link href="http://www.iobit.com/tpl/styles/lang.css" rel="stylesheet" media="all">
	...
	<div class="compare">
		<div class="wrapper">
			...
			<div class="major-title">
				<div class="leftarea">
					...
					<ul>
						...
						<li><a href="<?php echo $buyHref;?>" onclick="ga('send', 'event', 'ascbuy', 'buy', 'enaffasc2017installnew');" class="button yellowbtn"><span>UPGRADE TO PRO</span></a></li>
					</ul>
				</div>
				<dl class="rightarea">
			...
			<table border="0" cellspacing="0" cellpadding="0" width="100%" class="comparetab">
				...
				<tr>
					...
					<td class="items itemb">
						<table>
							...
							<tr class="handle">
								<td><a href="<?php echo $buyHref;?>" onclick="ga('send', 'event', 'ascbuy', 'buy', 'enaffasc2017installnew');" target="" class="button yellowbtn middle"><span>UPGRADE TO PRO</span></a></td>
							</tr>
							<tr class="special">
								<td>
				...
				<tr>
					<td class="icons"><img src="http://www.iobit.com/tpl/images/comparison/asc/cop_asc_i_03.png" alt="" data-pin-nopin="true"></td>
					<td class="text"><span>Up to 300% Internet Speedup with Internet Booster</span><i class="improved">Improved</i></td>
					<td class="items itemb"><span class="yellowstar"></span></td>
				</tr>
				<tr>
					<td class="icons"><img src="http://www.iobit.com/tpl/images/comparison/asc/cop_asc_i_16.png" alt=""></td>
				...
				<tr>
					<td class="icons"><img src="http://www.iobit.com/tpl/images/comparison/asc/cop_asc_i_18.png" alt=""></td>
					<td class="text"><span>Monitor RAM, CPU &amp; Disk with Enhanced Performance Monitor</span><i class="improved">Improved</i></td>
					<td class="items itemb"><span class="yellowstar"></span></td>
				</tr>
				<tr>
					<td class="icons"><img src="http://www.iobit.com/tpl/images/comparison/asc/cop_asc_i_17.png" alt=""></td>
				...
				<tr class="handle">
					<td></td>
					<td></td>
					<td class="items"><a href="<?php echo $buyHref;?>" onclick="ga('send', 'event', 'ascbuy', 'buy', 'enaffasc2017installnew');" target="" class="button yellowbtn middle"><span>UPGRADE TO PRO</span></a></td>
				</tr>
				<tr class="limit">
					<td></td>
					<td></td>
	...
	<div class="btmarea clearfix">
		<div class="wrapper">
			...
			<dl class="handelbuy">
				...
				<dd>
					<p class="butt-holder">
						<a href="<?php echo $buyHref;?>" onclick="ga('send', 'event', 'ascbuy', 'buy', 'enaffasc2017installnew');" target="" class="button yellowbtn"><span>UPGRADE TO PRO</span></a>
					</p>
				</dd>
