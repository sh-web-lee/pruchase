...
session_start();
  ...
  $ref1pc='enaff_asc12_2019buya1pc';
  $ref3pc='enaff_asc12_2019buya3pc';
  $ref3pcgift = 'enaff_asc12_2019buya3pcoff';
  if(!empty($_GET['ref'])){
...
if($_GET['action']=='maskCount'){
  ...
  if(in_array($maskType,array(1,2))) {
    ...
    try {
      ...
      $sql = "insert into affascmaskcount2019a (ip,addTime,maskType,buttonClick) values(:ip,:addTime,:maskType,:buttonClick)";
      $pre = $pdo->prepare($sql);
      $pre->bindParam(':ip', $ip);
    ...
    <div class="offer">
      <div class="box pc">
        ...
        <div class="price">
          ...
          <a class="buybtn" 
             href="https://www.iobit.com/buy.php?product=enaff-asc121pc1477a&ref=<?php echo $ref1pc;?>&aff=<?php echo $_GET['aff'];?>"
             onclick="ga('send', 'event', 'ascbuy', 'buy', 'enaffasc122019buya1pc')">
            Add to Cart
          </a>
        </div>
      </div>
      <div class="box pcs">
        ...
        <div class="price">
          ...
          <a class="buybtn" 
             href="https://www.iobit.com/buy.php?product=enaff-asc123pc1999a&ref=<?php echo $ref3pc;?>&aff=<?php echo $_GET['aff'];?>"
             onclick="ga('send', 'event', 'ascbuy', 'buy', 'enaffasc122019buya3pc')">
            Add to Cart
          </a>
      ...
      <div class="plana">
        ...
        <div class="panel clearfix">
          ...
          <div class="right fl">
            ...
            <div class="buybox">
              <a class="buybtn"
                 href="https://www.iobit.com/buy.php?product=enaff-asc123pc1499a&ref=<?php echo $ref3pcgift;?>&aff=<?php echo $_GET['aff'];?>"
