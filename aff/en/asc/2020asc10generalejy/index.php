...
if (empty($_GET['ref'])) {
  ...
  $refDownloadStr='ir387082';
}else{
  $refStr=$refDownloadStr=$_GET['ref'];
}
$affStr=empty($_GET['AFF'])?$_GET['aff']:$_GET['AFF'];
$clickStr=empty($_GET['clickid'])?'':'&clickid='.$_GET['clickid'];
if($_GET['ref']=='cb1712en'){
  ...
  // $buyHref="https://www.iobit.com/buy.php?product=enaffasc123pc1499&ref=".$refStr."&aff=".$affStr;
  $buyHref="https://www.iobit.com/buy.php?product=enaffasc123pc1499&ref=".$refStr."&aff=135678".$clickStr;
}
...
<script type="text/javascript" src="<?php echo $pRootUrl; ?>tpl/js/stats.js"></script>
  ...
  <div class="header">
    <div class="wrapper">
      ...
      <div class="btnbox">
        <a class="btn down" href="https://www.iobit.com/downloadcenter.php?product=ejyascpro&ref=<?php echo $_GET['ref']; ?>" onclick="ga('send', 'event', 'ascdl', 'download', 'ejy')">
          <p>Download a Free Scan</p>
          For Win 10/8/7/Vista/XP
        </a>
        <a class="btn buy" href="<?php echo $buyHref;?>" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ejy2');">
