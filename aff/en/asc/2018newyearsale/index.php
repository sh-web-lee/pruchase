...
if (empty($_GET['ref'])) $_GET['ref'] = 'enaff_asc11_2018newyearsale';
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<title>Save up to 85% OFF. Xmas Exclusive Discount - IObit</title>
...
<div class="header container clearfix">
	<div class="wrapper head">
		...
		<h1>Christmas Sale Happy New Year </h1>
				...
				<div class="defult">
					...
					<div class="price-box">
						<div class="price-btn clearfix">
							...
							<a href="https://www.iobit.com/buy.php?product=enaff-asc11sdiuamc2198&ref=<?php echo $_GET['ref'];?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'enaffasc112018newyearsale');clickCount(2)" class="buy-btn banner-btn-words fr buy-link link-gift"><i class="car"></i><span>ACTIVATE NOW</span></a>
						</div>
						<ul class="price-dec">
							<li class="first">
								<span>Original</span>
...
<div class="middle-buy container clearfix">
	<div class="wrapper">
		...
		<div class="btn-content">
			<a href="https://www.iobit.com/buy.php?product=enaff-asc11sdiuamc2198&ref=<?php echo $_GET['ref'];?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'enaffasc112018newyearsale');clickCount(2)" class="buy-btn middle-btn link-gift">
					<i class="car"></i>
		...
		<div class="bar-banner">
			...
			<div class="bar-right fr">
				...
				<div class="price-btn bar-btn">
					<span class="price-num">Now $<strong>21</strong>.98</span>
					<a href="https://www.iobit.com/buy.php?product=enaff-asc11sdiuamc2198&ref=<?php echo $_GET['ref'];?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'enaffasc112018newyearsale');clickCount(2)" class="buy-btn banner-btn-words buy-link link-gift"><i class="car"></i><span>ACTIVATE NOW</span></a>
				</div>
			</div>
		</div>
	</div>
...
<div class="compar-tab wrapper clearfix">
	<table border="0" cellspacing="0" cellpadding="0" width="100%">
		...
		<tr>
			...
			<td class="text">Fix System Weakness to Prevent Hacking with 1-click <sup><img src="<?php echo $pResUrl; ?>images/sup-green.png"></sup></td>
			<td class="space"></td>
			<td class="item-pro"><img src="<?php echo $pResUrl; ?>images/check-pro.png"></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class="text">New Disk Optimization Engine for Quicker System Speed <sup><img src="<?php echo $pResUrl; ?>images/sup-green.png"></sup></td>
			<td class="space"></td>
			<td class="item-pro"><img src="<?php echo $pResUrl; ?>images/check-pro.png"></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<th class="item-pro">
				...
				<a href="https://www.iobit.com/buy.php?product=enaff-asc11sdiuamc2198&ref=<?php echo $_GET['ref'];?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'enaffasc112018newyearsale');clickCount(2)" class="buy-btn smail-btn link-gift"><i class="car"></i><span>ACTIVATE NOW</span></a>
...
<div class="mask-box" style="display: none;">
	...
	<div class="mask-main clearfix">
		...
		<div class="mask-main-right fl">
			...
			<div class="btn-box">
				<a href="https://www.iobit.com/buy.php?product=enaff-asc11sdiuamc1999&ref=<?php echo $_GET['ref'];?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'enaffasc112018newyearsale');clickCount(3)" class="buy-btn mask-btn link-gift-pop"><i class="car"></i><span>Get My Extra 10% OFF &amp; 3 FREE Gifts</span></a>
			</div>
