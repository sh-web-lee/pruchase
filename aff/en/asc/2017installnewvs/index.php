...
if (empty($_GET['ref'])) $_GET['ref'] = 'enaff_asc11_2017installnewvs';
		...
		<div class="wrapper">
			...
			<div class="major-title">
				<div class="leftarea">
					...
					<ul>
						...
						<li><a href="<?php echo $buyHref;?>" onclick="ga('send', 'event', 'ascbuy', 'buy', 'enaffasc112017installnewvs')" class="button yellowbtn"><span>UPGRADE TO PRO</span></a></li>
					</ul>
				</div>
				<dl class="rightarea">
			...
			<table border="0" cellspacing="0" cellpadding="0" width="100%" class="comparetab">
				...
				<tr>
					...
					<td class="items itemb">
						<table>
							...
							<tr class="handle">
								<td><a href="<?php echo $buyHref;?>" onclick="ga('send', 'event', 'ascbuy', 'buy', 'enaffasc112017installnewvs')" target="" class="button yellowbtn middle"><span>UPGRADE TO PRO</span></a></td>
							</tr>
							<tr class="special">
								<td>
				...
				<tr class="handle">
					<td></td>
					<td></td>
					<td class="items"><a href="<?php echo $buyHref;?>" onclick="ga('send', 'event', 'ascbuy', 'buy', 'enaffasc112017installnewvs')" target="" class="button yellowbtn middle"><span>UPGRADE TO PRO</span></a></td>
				</tr>
				<tr class="limit">
					<td></td>
					<td></td>
	...
	<div class="btmarea clearfix">
		<div class="wrapper">
			...
			<dl class="handelbuy">
				...
				<dd>
					<p class="butt-holder">
						<a href="<?php echo $buyHref;?>" onclick="ga('send', 'event', 'ascbuy', 'buy', 'enaffasc112017installnewvs')" target="" class="button yellowbtn"><span>UPGRADE TO PRO</span></a>
					</p>
				</dd>
