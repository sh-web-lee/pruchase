...
$buyLink="https://www.iobit.com/buy.php?product=enaff-asc121pc1477&ref=".(empty($_GET['ref'])?'enaff_asc12_2019install':$_GET['ref'])."&aff=".$_GET['aff']."&refs=".$_GET['refs'];
$refStr=$_GET['ref'];
if(preg_match('/fspi([0-9]*)/',$refStr,$matches)){
	$buyLink='https://iobit.onfastspring.com/advanced-systemcare-10-pro-1-year-subscription-1-pc-1477';
	$pregNum=$matches[1];
	if(!empty($pregNum)){
		$buyLink='http://macbooster.7eer.net/c/'.$pregNum.'/556563/4385';
	}
}
if(preg_match('/ir([0-9]*)/',$refStr,$matches)){
	$buyLink='https://iobit.onfastspring.com/advanced-systemcare-10-pro-1-year-subscription-1-pc-1477';
	$pregNum=$matches[1];
	if(!empty($pregNum)){
		$buyLink='http://macbooster.7eer.net/c/'.$pregNum.'/556563/4385';
...
<head>
	...
	<title>Thank you for installing Advanced SystemCare 12 - IObit</title>
	<meta name="description" content="Upgrade to Advanced SystemCare Pro to enjoy up to 300% PC speedup and full protection."/>
	...
	<div class="pagebanner">
		<div class="container comp-heading clearfix">
			...
			<div class="heading-info">
				...
				<h3>Thanks for Installing Advanced SystemCare Pro! Upgrade now for a Cleaner, Faster & Safer PC</h3>
				...
				<div class="price-zone clearfix">
					...
					<a href="<?php echo $buyLink;?>" onclick="ga('send', 'event', 'ascbuy', 'buy', 'enaffasc122019install')" class="button btn-orange large">Buy Now</a>
			</div>
			</div>
		</div>
	</div>
					...
					<thead>
						<tr>
							...
							<td class="itempro">
								...
								<a href="<?php echo $buyLink;?>" onclick="ga('send', 'event', 'ascbuy', 'buy', 'enaffasc122019install')" class="button btn-orange small">BUY NOW <small>(Only $14.77)</small></a>
		...
		<div class="container">
			...
			<div class="price-zone clearfix" style="width: 280px;">
				<dl>
					...
					<dd><a href="<?php echo $buyLink;?>" onclick="ga('send', 'event', 'ascbuy', 'buy', 'enaffasc122019install')" class="button btn-orange large">Buy Now</a></dd>
