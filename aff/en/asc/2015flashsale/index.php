...
function addToCart(product){
	...
	productCfgArr['buyUrl']['amc'] = 'http://www.iobit.com/buy.php?product=asc8amc&ref=2014octascamc&aff=<?php echo $_GET['aff']; ?>&refs=purchase_asc';
	productCfgArr['buyUrl']['iu'] = 'http://www.iobit.com/buy.php?product=asc8iu&ref=2014augasciu&aff=<?php echo $_GET['aff']; ?>&refs=purchase_asc';
	productCfgArr['buyUrl']['sd'] = 'http://www.iobit.com/buy.php?product=asc8sd&ref=2014augascsd&aff=<?php echo $_GET['aff']; ?>&refs=purchase_asc';
    ...
    <div class="intro">      
      ...
      <div class="choosecart">
        ...
        <div class="tip">
          ...
          <a href="http://www.iobit.com/buy.php?product=asc8sd&ref=2014augascsd&aff=<?php echo $_GET['aff']; ?>&refs=purchase_asc"  onclick="ga('send', 'event', 'ascbuy', 'buy', '2015flashsale-en-aff')" id="buyButton" class="activebtn">Activate Now</a>
      ...
      <thead>
        <tr>
          ...
          <th class="itema">
            ...
            <a href="http://www.iobit.com/buy.php?product=asc81pc1477&ref=2014augasc&aff=<?php echo $_GET['aff']; ?>&refs=purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase-201408compare');" class="tbbuybtn">Activate Now</a>
