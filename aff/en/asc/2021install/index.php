<?php  
  ...
  if ($_GET['ref']) {
    ...
    $refStr = 'enaff_asc14_2021install';
  }
...
if (empty($_GET['ref'])) $_GET['ref'] = 'enaff_asc14_2021install';
...
<title>Thank you for installing Advanced SystemCare 14 - IObit</title>
<meta name="Copyright" content="IObit">
<meta name="description" content="Advanced SystemCare 14 PRO is your best choice to boost your slow PC and internet up to 200% faster.">
      ...
      <div class="heading-info">
        ...
        <div class="price-zone clearfix">
          ...
          <a class="button btn-orange large"
             ...
             onclick="ga('send', 'event', 'ascbuy', 'buy', 'enaffasc142021install');">
            Buy Now
          </a>
        </div>
      </div>
        ...
        <table border="0" cellspacing="0" cellpadding="0" width="100%" class="comparetab">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="describe">1-click to fix disk errors for more stable and efficient PC system <i class="tags new"></i></td>
              <td class="itempro"><i class="fa fa-check"></i></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="describe">Block malicious links and suspicious senders in web emails <i class="tags new"></i></td>
              <td class="itempro"><i class="fa fa-check"></i></td>
            </tr>
            <tr>
              <td class="icon">
