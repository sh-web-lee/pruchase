...
if($_GET['ref']=='cb1712en'){
  ...
  $buyHref="https://www.iobit.com/buy.php?product=enaffasc123pc1499&ref=jta&aff=115701&jtacid=".$_GET['click_id'];
}
...
<script type="text/javascript" src="<?php echo $pRootUrl; ?>tpl/js/stats.js"></script>
  ...
  <div class="header">
    <div class="wrapper">
      ...
      <div class="btnbox">
        <a class="btn down" href="https://www.iobit.com/downloadcenter.php?product=jtaascpro&jtacid=<?php echo $_GET['click_id'];?>" onclick="ga('send', 'event', 'ascdl', 'download', 'asc12g20jta')">
          <p>Download a Free Scan</p>
          For Win 10/8/7/Vista/XP
        </a>
        <a class="btn buy" href="<?php echo $buyHref;?>" onclick="ga('send', 'event', 'ascbuy', 'buy', 'jta');">
  ...
  <div class="container">
    ...
    <div class="footbuy">
      <div class="wrapper clearfix">
        ...
        <div class="btnbox">
          <a class="btn down" href="https://www.iobit.com/downloadcenter.php?product=jtaascpro" onclick="ga('send', 'event', 'ascdl', 'download', 'asc12g20jta')">
            <p>Download a Free Scan</p>
            For Win 10/8/7/Vista/XP
          </a>
          <a class="btn buy" href="<?php echo $buyHref;?>" onclick="ga('send', 'event', 'ascbuy', 'buy', 'jta');">
