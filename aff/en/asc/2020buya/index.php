  ...
  <div class="offer clearfix">
    ...
    <div class="box pc">
      ...
      <div class="price">
        ...
        <!-- 1pc buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=enaff-asc131pc1477a&ref=enaff_asc13_2020buya1pc&aff=<?php echo $_GET['aff'];?>"
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'enaffasc132020buya1pc')">
          Add to Cart
        </a>
      </div>
    </div>
    ...
    <div class="box pcs">
      ...
      <div class="price">
        ...
        <!-- 3pc buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=enaff-asc133pc1999a&ref=enaff_asc13_2020buya3pc&aff=<?php echo $_GET['aff'];?>"
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'enaffasc132020buya3pc')">
          Add to Cart
        </a>
    ...
    <div class="plana">
      ...
      <div class="panel clearfix">
        ...
        <div class="right fl">
          ...
          <div class="buybox">
            <!-- <a class="buybtn"
               href="https://www.iobit.com/buy.php?product=enaffasc13sdiu1799&ref=<?php echo $ref3pcgift;?>&aff=<?php echo $_GET['aff'];?>"
               onclick="ga('send', 'event', 'ascbuy', 'buy', 'enaffasc132020buya3pcgift');maskCount(1)">
              ADD TO CART
            </a> -->
            <a class="buybtn"
