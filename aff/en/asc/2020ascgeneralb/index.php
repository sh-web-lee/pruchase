...
if (empty($_GET['ref'])) {
  $refStr = 'enaff_asc13_2020generalb';
...
if($_GET['ref']=='cb1712en'){
  ...
  $buyHref="https://www.iobit.com/buy.php?product=enaffasc133pc1499&ref=enaff_asc13_2020generalb&aff=".$affStr;
}
...
if ($_POST['action'] == 'download') {
  ...
  // 检测AFF变量
  $fileName = "cus/asc-trial-setup.exe";
  $file = "asc-trial-setup.exe";

  if (!$_POST['aff']||!is_numeric($_POST['aff']) || mb_strlen($_POST['aff']) > 9) {
    $filePath = "http://update.iobit.com/dl/" . $fileName;
...
<script type="text/javascript" src="<?php echo $pRootUrl; ?>tpl/js/stats.js"></script>
  ...
  <div class="header">
    <div class="wrapper">
      ...
      <div class="btnbox">
        <a class="btn down" href="javascript:;" onclick="downloadFile();ga('send', 'event', 'ascdl', 'download', '2020ascgenb')">
          <p>Download a Free Trial</p>
          For Win 10/8/7/Vista/XP
        </a>
        <a class="btn buy" href="<?php echo $buyHref;?>" onclick="ga('send', 'event', 'ascbuy', 'buy', 'enaffasc132020generalb')">
...
<script>   
  ...
  function downloadFile(){
    post('index.php', {action :'download',aff:aff});
  }
</script>
</body>
</html>