...
if($_GET['ref']=='cb1712en'){
  ...
  $buyHref="https://www.iobit.com/buy.php?product=enaffasc123pc1499&ref=".$refStr."&aff=".$_GET['aff'];
}
...
if(!empty($_GET['cid'])){
  setcookie('affasccid',$_GET['cid'],time()+3600*30,'/');
}
?>
<!DOCTYPE html>
<html lang="en">
...
<script type="text/javascript" src="<?php echo $pRootUrl; ?>tpl/js/stats.js"></script>
  ...
  <div class="header">
    <div class="wrapper">
      ...
      <div class="btnbox">
        <a class="btn down" href="https://ld.iobit.com/freedownload/affascfreedownload/download.php?product=asc&ref=<?php echo $refDownloadStr;?>&aff=<?php echo $_GET['aff'];?>" onclick="ga('send', 'event', 'ascdl', 'download', 'adcs');">
          <p>Download a Free Scan</p>
          For Win 10/8/7/Vista/XP
        </a>
        <a class="btn buy" href="<?php echo $buyHref;?>" onclick="ga('send', 'event', 'ascbuy', 'buy', 'adcs2');">
