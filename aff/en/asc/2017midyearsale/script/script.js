...
function soldOut() {
    TweenMax.to($('.cut-box'), 3, {
        ...
        onComplete: function() {
            ...
            if (ref.length <= 0) ref = 'enaff_asc10_2017midyearsale';
            ...
            if(ref=='fs1702en'){
                ...
                $(".buy-btn").attr("href", "https://www.iobit.com/buy.php?product=asc103pc2198_aff&ref=" + ref + "&aff=" + aff + "&refs=purchase_asc&tw=" + tw).attr('onclick', "ga('send', 'event', 'ascbuy', 'buy', 'enaffasc102017midyearsale');clickCount(4)");
            }
