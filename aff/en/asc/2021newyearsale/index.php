<?php
  ...
  if (empty($_GET['ref'])) $_GET['ref'] = 'enaff_asc14_2021newyearsale';
  // $ref1pc='enaff_asc14_2021newyearsale';
  // $ref3pc='deaff_asc13_2020buy3pc';
  // $ref4pd='deaff_asc13_2020buy3pc';
  // if(!empty($_GET['ref'])){
  //   $ref1pc=$ref3pc=$ref4pd=$_GET['ref'];
  // }

$buyUrl_pc1 = "https://www.iobit.com/buy.php?product=enaff-asc143pc1999a&ref=".$_GET['ref']."&aff=".$_GET['aff'];

$buyUrl_pc3 = "https://www.iobit.com/buy.php?product=enaff-asc143pc1999a&ref=".$_GET['ref']."&aff=".$_GET['aff'];

$buyUrl_pack = "https://www.iobit.com/buy.php?product=enaff-asc143pc2398&ref=".$_GET['ref']."&aff=".$_GET['aff'];

$buyUrl_pop = "https://www.iobit.com/buy.php?product=enaff-asc143pc2198a&ref=".$_GET['ref']."&aff=".$_GET['aff'];
...
if(!empty($_GET['ref'])){
	...
	if(strpos($ref,'ir') !== false){
		...
		$buyUrl_pc1 = "https://iobit.onfastspring.com/advanced-systemcare-pro-1-year-subscription-1-pc-1677";

		$buyUrl_pc3 = "https://iobit.onfastspring.com/advanced-systemcare-10-pro-1-year-subscription-3-pcs-1999";

		$buyUrl_pack = "https://iobit.onfastspring.com/advanced-systemcare-pro-with-super-value-pack-2398";

		$buyUrl_pop = "https://iobit.onfastspring.com/advanced-systemcare-pro-with-super-value-pack-2198";
	}
}
?>
            ...
            <li>
              ...
              <div class="li-bottom">
                ...
                <div class="btn">
                  <a
                    href=<?= $buyUrl_pc1; ?>
                    onclick="ga('send', 'event', 'ascbuy', 'buy', 'enaffasc142021newyearsale')">
        ...
        <div class="box-bottom">
          ...
          <div>
            ...
            <div style="text-align: center; padding-left: 5px;">
              <a
                href="https://www.iobit.com/buy.php?product=asc145pc1975&ref=<?php echo $_GET['ref']?>&aff=<?php echo $_GET['aff']?>"
                onclick="ga('send', 'event', 'ascbuy', 'buy', 'enaffasc142021newyearsale')">
                <button>Get It Now</button>
              </a>
            </div>
