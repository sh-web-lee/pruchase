...
if (empty($_GET['ref'])) $_GET['ref'] = 'enaff_asc10_2016newlaunch';
...
<div class="header">
	<div class="wrapper">
		...
		<h1>Mid Year Big Sale 80% OFF & FREE GIFT</h1>
		<div class="container">
			<dl class="left">
				...
				<dd>
					<ul class="big">
						<li><img src="<?php echo $pResUrl; ?>images/asc9-banner.png" alt=""></li>
			...
			<dl class="right">
				...
				<dd><a class="buybtn" href="http://www.iobit.com/buy.php?product=asc10sd_aff&ref=<?php echo $_GET['ref'];?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'enaffasc102016newlaunch');" >Activate Now</a></dd>
...
<div class="wrapper">
	...
	<div class="asc-message clearfix">
		<h2>Keep Your PC Running Like a New One with ASC PRO & Get a Gift for Free!</h2>
		<dl>
			...
			<dd><img src="<?php echo $pResUrl; ?>images/ico-check.png" alt="">Auto RAM Clean & Auto Online Privacy Trace Clean <img class="improved" src="<?php echo $pResUrl; ?>images/improved.png" alt=""></dd>
			<dd><img src="<?php echo $pResUrl; ?>images/ico-check.png" alt="">One-click Cleaning and Fixing All Kinds of PC Problems <img class="new" src="<?php echo $pResUrl; ?>images/ico-new.png" alt=""></dd>
			<dd><img src="<?php echo $pResUrl; ?>images/ico-check.png" alt="">One-click to Manage System Resource for Top Performance</dd>
			...
			<table border="0" cellspacing="0" cellpadding="0" width="100%">
				...
				<tr>
					...
					<th class="itema"><span>Advanced SystemCare PRO</span><br>
						<a href="http://www.iobit.com/buy.php?product=asc10sd_aff&ref=<?php echo $_GET['ref'];?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'enaffasc102016newlaunch');"  class="tbbuybtn">Activate Now</a>
...
<script type="text/javascript">
	...
	$(".container .sd a").click(function(){
		...
		$(".banner-center .gift img").attr("src","<?php echo $pResUrl; ?>images/gift-sd.png");
			if(lan=='en'){
//					$(".buybtn,.tbbuybtn").attr("href","http://www.iobit.com/buy.php?product=asc9cb1sd");
                $(".buybtn,.tbbuybtn").attr("href", "http://www.iobit.com/buy.php?product=asc10sd_aff&ref=<?php echo $_GET['ref'];?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_asc&tw="+tw);
			}else {
					$(".buybtn,.tbbuybtn").attr("href", "http://www.iobit.com/buy.php?product=asc10sd_aff&ref=<?php echo $_GET['ref'];?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_asc&tw="+tw);
			}
			});
	$(".container .pf a").click(function(){
		...
		$(".banner-center .gift img").attr("src","<?php echo $pResUrl; ?>images/gift-pf.png");
			if(lan=='en'){
//					$(".buybtn,.tbbuybtn").attr("href","http://www.iobit.com/buy.php?product=asc9cb2pf");
                $(".buybtn,.tbbuybtn").attr("href", "http://www.iobit.com/buy.php?product=asc10pf_aff&ref=<?php echo $_GET['ref'];?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_asc&tw="+tw);
	...
	$(".container .amc a").click(function(){
		...
		$(".banner-center .gift img").attr("src","<?php echo $pResUrl; ?>images/gift-amc.png");
			if(lan=='en'){
//					$(".buybtn,.tbbuybtn").attr("href","http://www.iobit.com/buy.php?product=asc9cb3amc");
                $(".buybtn,.tbbuybtn").attr("href", "http://www.iobit.com/buy.php?product=asc10amc_aff&ref=<?php echo $_GET['ref'];?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_asc&tw="+tw);
			}else {
					$(".buybtn,.tbbuybtn").attr("href", "http://www.iobit.com/buy.php?product=asc10amc_aff&ref=<?php echo $_GET['ref'];?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_asc&tw="+tw);
			}
			});
