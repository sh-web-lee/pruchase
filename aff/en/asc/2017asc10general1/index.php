...
<script type="text/javascript" src="<?php echo $pRootUrl; ?>tpl/js/stats.js"></script>
  ...
  <div class="header">
    <div class="wrapper">
      ...
      <div class="btnbox">
        <a class="btn down" href="https://cdn.iobit.com/dl/cus/asc10scan-700.exe" onclick="ga('send', 'event', 'ascdl', 'download', 'enaffasc2017general1');">
          <p>Download a Free Scan</p>
          For Win 10/8/7/Vista/XP
        </a>
        <a class="btn buy" href="http://www.iobit.com/buy.php?product=enaffasc103pc1499&ref=enaff_asc10_2017general1&aff=700" onclick="ga('send', 'event', 'ascbuy', 'buy', 'enaffasc2017general1');">
  ...
  <div class="container">
    ...
    <dl class="mediareview wrapper clearfix">
      ...
      <dd>
        <h3>You can rely on Advanced SystemCare for keeping your system clean, fast and secure.</h3>
        <p>
          "Advanced SystemCare PRO is a software suite that contains essential components for increasing computer performance, protecting private information, and blocking spyware. It works very well, and it uses minimum memory resources. It definitely has powerful features you need to maintain and protect your system."-SOFTPEDIA
        </p>
      </dd>
    </dl>
    <!-- mediareview end -->
