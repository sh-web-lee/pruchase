...
if (!empty($_GET['action'])&&$_GET['action'] == 'getPacks') {
  ...
  if (empty($_GET['ref'])) $_GET['ref'] = 'enaff_iu8_2019anniversarysale';
        ...
        <div class="showcase">
          ...
          <div class="checkout">
            <dl>
              ...
              <dd>
                <a class="buybtn activebtn" href="https://www.iobit.com/buy.php?product=enaff-iu8pro1677&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" onclick="ga('send', 'event', 'iubuy', 'buy', 'enaffiu82019anniversarysale')">
                  Activate Now
                </a>
              </dd>
          ...
          <tr>
            ...
            <th class="item-pro">
              <dl>
                ...
                <dd>
                  <a class="buybtn activesmall" href="https://www.iobit.com/buy.php?product=enaff-iu8pro1677&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" onclick="ga('send', 'event', 'iubuy', 'buy', 'enaffiu82019anniversarysale')">
                    ACTIVATE NOW
                  </a>
                </dd>
