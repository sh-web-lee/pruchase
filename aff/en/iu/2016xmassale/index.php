...
if (empty($_GET['ref'])) $_GET['ref'] = 'enaff_iu_2016xmassale';
    ...
    <div class="container">
      <div class="wrapper">
        ...
        <div class="header">
           ...
           <div class="title">
             <h1>IObit Uninstaller BIG CHRISTMAS SALE</h1>
        ...
        <div class="showcase">
          ...
          <div class="checkout">
            <dl>
              ...
              <dd>
                <a class="buybtn activebtn" href="http://www.iobit.com/buy.php?product=iupro1677_aff&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_iu" onclick="ga('send', 'event', 'iubuy', 'buy', 'enaffiu2016xmassale');">
                  <div class="inner">
                    <i class="all-icons"></i>
