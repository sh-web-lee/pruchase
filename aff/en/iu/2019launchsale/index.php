...
if (empty($_GET['ref'])) $_GET['ref'] = 'enaff_iu9_2019launchsale'; 

if(preg_match('/fspi/',$_GET['ref'])){
  $buyLink='https://iobit.onfastspring.com/iobit-uninstaller-6-pro-with-gift-pack?ref='.$_GET['ref'];
}else{
  $buyLink='https://www.iobit.com/buy.php?product=enaff-iu9pro1677&ref='.$_GET['ref'].'&aff='.$_GET['aff'];
}
  ?>
<!DOCTYPE html>
<html lang="en">
...
//      pageDevice('entrdab','autoclean.php');
    ...
    }else if(paramTo=='softwarehealth'){
      pageDevice('eniusoft','softwarehealth.php');
    }else if((paramTo=='installmonitor')||(paramTo=='cleanuninstall')||(paramTo=='enable')){
      pageDevice('eniuinstall','installmonitor.php');
  ...
  <div class="banner">
    <div class="container">
      <div class="wrapper">
        ...
        <h1 class="title">New Launch Special</h1>
        <!-- activity -->
        <div class="activity">
            ...
            <dl>
              ...
              <dd>
                <a class="buybtn activebtn"
                   ...
                   onclick="ga('send', 'event', 'iubuy', 'buy', 'enaffiu92019launchsale');">
                  Activate Now
                </a>
              </dd>
