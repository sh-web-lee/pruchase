...
include $pRootUrl.'include/common.inc.php';
  if (empty($_GET['ref'])) $_GET['ref'] = 'enaff_iu10_2021newyearsale';

$buyUrl = "https://www.iobit.com/buy.php?product=enaff-iu10pro1677&ref=".$_GET['ref']."&aff=".$_GET['aff'];
...
if(!empty($_GET['ref'])){
	...
	if(strpos($ref,'ir') !== false){
		...
		$buyUrl = "https://iobit.onfastspring.com/iobit-uninstaller-pro-with-gift-pack-1677";
	}
}
?>
<!DOCTYPE html>
        ...
        <dl>
          ...
          <dd>
            <a class="buybtn activebtn"
               href=<?= $buyUrl; ?>
               onclick="ga('send', 'event', 'iubuy', 'buy', 'enaffiu102021newyearsale')">
              Activate Now
            </a>
          </dd>
