<?php  
  ...
  if ($_GET['ref']) {
    ...
    $refStr = 'enaff_iu10_2021acregister';
  }
...
$buyUrl = "https://www.iobit.com/buy.php?product=enaff-iu10-acak&ref=".$refStr."&aff=".$_GET['aff'];

if (preg_match_all('/ir([0-9]*)/', $_GET['ref'], $arr)) {
    $buyUrl = "https://iobit.onfastspring.com/iobit-uninstaller-pro-1-year-subscription-1-pc-999";
    if ($arr[1][0] != null) {
        $buyUrl = "https://macbooster.7eer.net/c/" . $arr[1][0] . "/1086666/4385";
    }
}
?>
<!DOCTYPE html>
...
<title>85% OFF on IObit Uninstaller PRO - IObit</title>
...
<meta property="og:url" content="https://purchase.iobit.com/aff/en/iu/2021acregister/index.php">
<meta property="og:type" content="website">
<meta property="og:title" content="85% OFF on IObit Uninstaller PRO - IObit">
...
<meta property="og:image" content="https://purchase.iobit.com/2017/iu/2021acregister/images/snapshot-large.png?t=1">
    ...
    <div class="wrapper">
      ...
      <div class="pricebox">
        <dl class="price">
          ...
          <dd>
            <a class="buybtn bigbtn" href="<?= $buyUrl; ?>" onclick="ga('send', 'event', 'iubuy', 'buy', 'enaffiu102021acregister');">
              <div class="inner">
                <i class="all-icons"></i>
    ...
    <div class="clearfix">
      <dl>
        ...
        <dd>
          ...
          <p>Completely delete stubborn programs that can't be uninstalled by conventional means.</p>
        </dd>
      </dl>
      <dl class="right one">
        ...
        <dd>
          ...
          <p>Monitor and record all things that a program did to your system during installation and fully revert all changes when the program is no longer needed.</p>
        </dd>
      </dl>
    </div>
    <div class="clearfix">
    ...
    <div class="wrapper clearfix">
      ...
      <div class="pricebox">
        <dl class="price fr">
          ...
          <dd>
            <a class="buybtn smallbtn" href="<?= $buyUrl; ?>" onclick="ga('send', 'event', 'iubuy', 'buy', 'enaffiu102021acregister');">
              <div class="inner">
                <i class="all-icons"></i>
                <span>Activate Now</span>
              </div>
