...
if (empty($_GET['ref'])) $_GET['ref'] = 'enaff_ascu_2016aprspringsale';
      ...
      <div class="panel clearfix">
        ...
        <div class="infor fr">
          ...
          <dl>
            ...
            <dd>
              <a class="buybtn inforbtn" href="http://www.iobit.com/buy.php?product=ascu9pf&ref=<?php echo $_GET['ref'];?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_ascu"  onclick="ga('send', 'event', 'ascubuy', 'buy', 'enaffascu2016aprspringsale');">
  ...
  <div class="wrapper main">
    ...
    <div class="descrip clearfix">
      ...
      <dl class="handle fr">
        ...
        <dd>
          <a class="buybtn descripbtn" href="http://www.iobit.com/buy.php?product=ascu9pf&ref=<?php echo $_GET['ref'];?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_ascu"  onclick="ga('send', 'event', 'ascubuy', 'buy', 'enaffascu2016aprspringsale');">
  ...
  <div class="floatlayer">
    <div class="wrapper">
      ...
      <dl>
        ...
        <dd>
          <a class="buybtn floatbtn" href="http://www.iobit.com/buy.php?product=ascu9pf&ref=<?php echo $_GET['ref'];?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_ascu"  onclick="ga('send', 'event', 'ascubuy', 'buy', 'enaffascu2016aprspringsale');">
            <i class="all-icons">car</i>
            Activate Now
          </a>
        </dd>
