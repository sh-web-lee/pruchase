...
if (empty($_GET['ref'])) $_GET['ref'] = 'enaff_ascu_2017newyearsale';
...
<link href='http://fonts.googleapis.com/css?family=Open+Sans:300,400,600,600i' rel='stylesheet' type='text/css'>
...
<script type="text/javascript" src="<?php echo $pRootUrl; ?>tpl/js/stats.js"></script>
      ...
      <div class="panel clearfix">
        ...
        <div class="infor fr">
          ...
          <dl>
            ...
            <dd>
              <a class="buybtn inforbtn" href="http://www.iobit.com/buy.php?product=ascu10pf_aff&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_ascu&tw=-8" onclick="ga('send', 'event', 'ascubuy', 'buy', 'enaffascu2017newyearsale')">
  ...
  <div class="wrapper main">
    ...
    <h2>Your PC´s Ultimate Protection and Ultimate Performance!</h2>
    <div class="product-intro clearfix">
      <div class="left-part clearfix">
        ...
        <i>Sale</i>
        <div class="continer">
          <h3>What you can get by <br><span>ACTIVATING</span> ASC Ultimate 10:</h3>
          <p>An always-on, automated, and all-in-one protection against all kinds of viruses, system slowdown, freezing and crashes. It's your best solution for security and performance.</p>
    ...
    <div class="descrip clearfix">
      ...
      <dl class="handle fr">
        <dt>
          Only <strong  class="price">$29.99</strong> <del>$109.93</del>
        </dt>
        <dd>
          <a class="buybtn descripbtn" href="http://www.iobit.com/buy.php?product=ascu10pf_aff&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_ascu&tw=-8"  onclick="ga('send', 'event', 'ascubuy', 'buy', 'enaffascu2017newyearsale')">
    ...
    <div class="review">
      ...
      <div class="user-rev">
        <div class="content">
          ...
          <dl>
            <dt><h4>"One of the simplest yet effective programs I have found to keep all three of my computers healthy."</h4></dt>
            <dd>
        ...
        <ul class="users">
          <li class="current">
            <img src="<?php echo $pResUrl; ?>images/rod-garnett.jpg" alt="Rod Garnett">
            Rod Garnett
            <em>2014</em>
          </li>
          <li>
          ...
          <li>
            <img src="<?php echo $pResUrl; ?>images/russell-peck.jpg" alt="Russell Peck">
             Russell Peck
            <em>2016</em>
          </li>
        </ul>
    ...
    <div class="comparison">
      <h4>Why Choose Advanced SystemCare Ultimate 10?</h4>
  ...
  <div class="floatlayer">
    <div class="wrapper">
      ...
      <dl>
        <dt>Only <strong class="price">$29.99</strong> <del>$109.93</del></dt>
        <dd>
          <a class="buybtn floatbtn" href="http://www.iobit.com/buy.php?product=ascu10pf_aff&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_ascu&tw=-8" onclick="ga('send', 'event', 'ascubuy', 'buy', 'enaffascu2017newyearsale');">
            <i class="all-icons">car</i>
            Activate Now
          </a>
        </dd>
