<?php
	...
	//if (empty($_GET['aff'])) $_GET['aff'] = 'imf2014easter';
...
<div class="main">
    ...
    <div class="middle">
    	<div class="warpper clearfix">
            <div class="lace">
              <div class="introduce">
                <h3>Save <span>70%</span> on IMF PRO & Get Super Gifts for FREE!</h3>
                <p>Activate IMF PRO today, get FREE Gift Pack your PC will adore! <span><em id="packs"><?php echo $packsNum; ?> Packs</em> Left Today!</span></p>
              ...
              <div class="control">
                <ul>
                  ...
                  <li class="link"><a href="http://www.iobit.com/buy.php?product=imfpfebook&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_imf">ACTIVATE NOW</a></li>
            ...
            <div class="cross clearfix">
                ...
                <dl class="link">
					...
					<dd><a href="http://www.iobit.com/buy.php?product=imfpfebook&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_imf">activate now</a></dd>
                </dl>
                <dl class="right">
           ...
           <div class="floatlayer" id="floatlayer">
                ...
                <dl class="right">
                	<dt><a href="http://www.iobit.com/buy.php?product=imfpfebook&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_imf">activate now</a></dt>
