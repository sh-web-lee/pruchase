...
if (empty($_GET['ref'])) $_GET['ref'] = 'enaff_imf6_2018birthdaysale';
...
<head>
	<meta charset="UTF-8">
	<title>Save up to 73% OFF on IMF PRO. Xmas Exclusive Discount - IObit</title>
...
<div class="main">
		...
		<div class="wrapper">
			<!-- header -->
				<div class="header">
					...
					<div class="title">
						<h1>IObit 13  Birthday Big Sale</h1>
					</div>
				</div>
				<!-- stage before-->
				<div class="stage before active">
					...
					<div class="details">
						...
						<dl class="checkout">
							...
							<dd><a href="https://www.iobit.com/buy.php?product=enaff-imf63pcpfamc2599&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'enaffimf62018birthdaysale');" class="checkbtn large buylink">Activate Now</a></dd>
				...
				<div class="extra single">
					...
					<dl class="checkout">
						...
						<dd><a href="https://www.iobit.com/buy.php?product=enaff-imf61pc&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'enaffimf62018birthdaysale');" class="checkbtn middle link1pc buylink">Activate Now</a></dd>
					</dl>
				</div>
				<div class="extra family-pack">
					...
					<dl class="checkout">
						...
						<dd><a href="https://www.iobit.com/buy.php?product=enaff-imf63pc&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'enaffimf62018birthdaysale');" class="checkbtn middle buylink">Activate Now</a></dd>
					</dl>
				</div>
	...
	<div class="gift-pack">
		<div class="wrapper">
			<h2>IObit Malware Fighter 6 PRO Valuable Birthday Pack Includes</h2>
			<div class="container clearfix">
				<ul>
	...
	<div class="compar-tab wrapper">
		<table border="0" cellspacing="0" cellpadding="0" width="100%">
			...
			<tr>
				...
				<th class="item-pro">
					...
					<dl>
						...
						<dd><a href="https://www.iobit.com/buy.php?product=enaff-imf63pcpfamc2599&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'enaffimf62018birthdaysale');" class="checkbtn small link3pc buylink">Activate Now</a></dd>
					</dl>
				</th>
			</tr>
			</thead>
			...
			<tr>
				...
				<td class="text">Advanced Threat Protection with Bitdefender Anti-Virus Engine IMPROVED  <sup class="c-green">IMPROVED</sup></td>
				<td class="space"></td>
				<td class="item-pro"><img src="<?php echo $pResUrl; ?>images/ginger-star.png"></td>
			</tr>
			<tr>
	...
	<!-- float -->
	<div class="float">
		<a href="https://www.iobit.com/buy.php?product=enaff-imf63pcpfamc2599&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'enaffimf62018birthdaysale');" class="buylink">
			<div class="inner">
    ...
    <script>setTimeout('window.location.href="https://purchase.iobit.com/aff/en/imf/2020newlaunchsale/index.php'+location.search+'"',5000);</script></div>
</body>
</html>