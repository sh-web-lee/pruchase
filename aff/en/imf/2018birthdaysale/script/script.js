...
function change() {
	...
	var refLink = 'enaff_imf6_2018birthdaysale';
	var refStr = 'enaff_imf6_2018birthdaysale';
	if (ref.length > 0) {
		refStr = ref;
	}
	...
	var new3pc = "https://www.iobit.com/buy.php?product=enaff-imf63pc&ref=" + refStr + "&aff=" + aff + "&refs=purchase_imf&tw=" + tw;
	var new1pc = "https://www.iobit.com/buy.php?product=enaff-imf61pc&ref=" + refStr + "&aff=" + aff + "&refs=purchase_imf&tw=" + tw;
	var _ga = "ga('send', 'event', 'imfbuy', 'buy', 'enaffimf62018birthdaysale');";
	$('.link3pc').attr('href', new3pc);
	$('.link3pc').attr('onclick', _ga);
