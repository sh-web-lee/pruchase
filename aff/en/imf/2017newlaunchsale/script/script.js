...
function change(){
	...
	var details ='<div class="details">'+
					'<div class="info">'+
						'<h3>Valuable New Launch Pack Sold Out!</h3>'+
						'<dl>'+
	...
	if(ref==''){ref='enaff_imf5_2017newlaunchsale'}
	...
	var new3pc = "https://www.iobit.com/buy.php?product=imf53pc_aff&ref="+ref+"&aff"+aff+"=&refs=purchase_imf&tw="+tw;
	var new3pcStat = "ga('send', 'event', 'imfbuy', 'buy', 'enaffimf52017newlaunchsale')";
