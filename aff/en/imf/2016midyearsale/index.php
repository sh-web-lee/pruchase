...
$refstr=empty($_GET['ref'])?'enaff_imf_2016midyearsale':$_GET['ref'];
        ...
        <div class="intro clearfix">
          <div class="single fl">
            <dl class="title">
              ...
              <dd>
                <a class="probuybtn" href="http://www.iobit.com/buy.php?product=affimf4-upgrade&ref=<?php echo $refstr;?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'enaffimf2016midyearsale');">
                  Get It Now
                </a>
              </dd>
            </dl>
          ...
          <div class="family fl">
            <dl class="title">
              ...
              <dd>
                <a class="probuybtn" href="http://www.iobit.com/buy.php?product=affimf4iusdpf2399&ref=<?php echo $refstr;?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'enaffimf2016midyearsale');">
                  Get It Now
                </a>
              </dd>
            </dl>
          ...
          <tfoot>
            <tr>
              ...
              <th class="itema">
                ...
                <a href="http://www.iobit.com/buy.php?product=affimf4-upgrade&ref=<?php echo $refstr;?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'enaffimf2016midyearsale');" class="tbbuybtn">
                  Buy Now
                </a>
              </th>
              <th class="itemb">
                ...
                <a href="http://www.iobit.com/buy.php?product=affimf4iusdpf2399&ref=<?php echo $refstr;?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'enaffimf2016midyearsale');" class="tbbuybtn">
                  Buy Now
                </a>
                We Recommend
              </th>
