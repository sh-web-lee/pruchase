...
if(in_array($_GET['st'],array('asc_acimf'))){
  ...
  if (empty($_GET['ref'])) $_GET['ref'] = 'enaff_imf7_2020acregister';
...
<meta property="og:url" content="https://purchase.iobit.com/aff/en/imf/2020acregister/index.php">
...
<meta property="og:image" content="https://purchase.iobit.com/aff/en/imf/2020acregister/images/snapshot-large.png">
<link rel="icon" href="<?php echo $pRootUrl; ?>tpl/img/favicon.ico" mce_href="<?php echo $pRootUrl; ?>tpl/img/favicon.ico" type="image/x-icon">
<link rel="shortcut icon" href="<?php echo $pRootUrl; ?>tpl/img/favicon.ico" mce_href="<?php echo $pRootUrl; ?>tpl/img/favicon.ico" type="image/x-icon">
<link rel="stylesheet" href='http://fonts.googleapis.com/css?family=Montserrat:400,600,,700'>
...
<script type="text/javascript" src="<?php echo $pRootUrl; ?>tpl/js/stats.js"></script>
  ...
  <div class="banner">
    <div class="wrapper">
      ...
      <div class="title">
        <h1>IObit Malware Fighter 7 PRO</h1>
      ...
      <div class="pricebox">
        <dl class="price">
          ...
          <dd>
            <a class="buybtn bigbtn" href="https://www.iobit.com/buy.php?product=enaff-imf7-acak&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" onclick="ga('send', 'event', 'imfbuy', 'buy', 'enaffimf72020acregister');">
              <div class="inner">
                <i class="all-icons"></i>
  ...
  <div class="feature wrapper">
    ...
    <div class="clearfix">
      <dl>
        ...
        <dd>
          <h3>DETECT 203,000,000+ THREATS</h3>
  ...
  <div class="review wrapper">
    <div class="content">
      ...
      <dl class="active">
        ...
        <dd>
          <h4>"The program uses two AV engines, its own and BitDefender, and seems to be effective against malware that cannot be detected by other similar tools"</h4>
        </dd>
      ...
      <dl>
        ...
        <h3>User Review</h3></dt>
        <dd>
          <h4>"I would like to say a great thanks to all the staff at IObit for working hard to bring us the best programs out."</h4>
        </dd>
    ...
    <div class="wrapper clearfix">
      ...
      <div class="pricebox">
        <dl class="price fr">
          ...
          <dd>
            <a class="buybtn smallbtn" href="https://www.iobit.com/buy.php?product=enaff-imf7-acak&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" onclick="ga('send', 'event', 'imfbuy', 'buy', 'enaffimf72020acregister');">
              <div class="inner">
                <i class="all-icons"></i>
                <span>Activate Now</span>
              </div>
