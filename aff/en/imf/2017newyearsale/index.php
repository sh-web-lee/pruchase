...
if (!empty($_GET['action'])&&$_GET['action'] == 'getPacks') {
	...
	if (empty($_GET['ref'])) $_GET['ref'] = 'enaff_imf_2017newyearsale';
...
<div class="main">
			...
			<!-- header -->
				...
				<div class="stage before active">
					...
					<div class="details">
						...
						<dl class="checkout">
							...
							<dd><a href="https://www.iobit.com/buy.php?product=imf53pcpfamc2599_aff&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_imf&tw=-8" onclick="ga('send', 'event', 'imfbuy', 'buy', 'enaffimf2017newyearsale')" class="checkbtn large">Activate Now</a></dd>
				...
				<div class="extra single">
					...
					<dl class="checkout">
						...
						<dd><a href="https://www.iobit.com/buy.php?product=imf51pc_aff&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_imf&tw=-8" onclick="ga('send', 'event', 'imfbuy', 'buy', 'enaffimf2017newyearsale')" class="checkbtn middle link1pc">Activate Now</a></dd>
					</dl>
				</div>
				<div class="extra family-pack">
					...
					<dl class="checkout">
						...
						<dd><a href="https://www.iobit.com/buy.php?product=imf53pc_aff&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_imftw=-8" onclick="ga('send', 'event', 'imfbuy', 'buy', 'enaffimf2017newyearsale')" class="checkbtn middle">Activate Now</a></dd>
					</dl>
				</div>
			...
			<div class="container clearfix">
				...
				<div class="list last">
					<dl>
						...
						<dd> Analyze any Suspicious Act to Prevent All Kinds of Ransomware Attacks & Protect Your Personal Assets</dd>
					</dl>
					<dl>
						<dt><img src="<?php echo $pResUrl; ?>images/benfits-icon-04.png" alt=""></dt>
						<dd class="titlebar"><h3>Track-free Online Browsing </h3></dd>
						<dd>Clear All Online Surfing Data Automatically to Avoid Privacy Leak When the Browser is Closed</dd>
					</dl>
				</div>
			</div>
		</div>
	...
	<!-- float -->
	<div class="float">
		<a href="https://www.iobit.com/buy.php?product=imf53pcpfamc2599_aff&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_imf&tw=-8" onclick="ga('send', 'event', 'imfbuy', 'buy', 'enaffimf2017newyearsale')">
			<div class="inner">
