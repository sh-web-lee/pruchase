...
$ascRef='enaff-asc10-2017newyear';
$dbRef='enaff-db4-2017newyear';
$iuRef='enaff-iu6-2017newyear';
$mbRef='enaff-mb4-2017newyear';
$imfRef='enaff-imf4pack-2017newyear';
$amcRef='enaff-sdamc-2017newyear';
if(!empty($_GET['ref'])){
  $ascRef=$dbRef=$iuRef=$mbRef=$imfRef=$amcRef=$_GET['ref'];
}
...
<head>
  ...
  <title> 50% Off Everything- The Most Unbelievable offer from IObit</title>
  ...
  <div class="wrapper">
    ...
    <div class="box db">
      ...
      <dl class="price">
        ...
        <dd><a href="http://www.iobit.com/buy.php?product=enaffdb41247&ref=<?php echo $dbRef;?>&aff=<?php echo $_GET['aff']; ?>" onclick="ga('send', 'event', 'dbbuy', 'buy', 'enaffdb42017newyear')" class="buybtn"><span><img src="<?php echo $pResUrl; ?>images/shop.png" alt="" /></span>BUY NOW <i></i></a></dd>
      </dl>
      <div class="clear"></div>
      <div class="line"></div>
      <div class="message">
    ...
    <div class="box asc">
      ...
      <dl class="price">
        ...
        <dd><a href="http://www.iobit.com/buy.php?product=enaffasc101499&ref=<?php echo $ascRef;?>&aff=<?php echo $_GET['aff']; ?>" onclick="ga('send', 'event', 'ascbuy', 'buy', 'enaffasc102017newyear')" class="buybtn"><span><img src="<?php echo $pResUrl; ?>images/shop.png" alt="" /></span>BUY NOW <i></i></a></dd>
      </dl>
      <div class="clear"></div>
      <div class="message">
...
<div class="gift-content wrapper">
  ...
  <div class="right-message">
    ...
    <a href="http://www.iobit.com/buy.php?product=enaffimf4pack1997&ref=<?php echo $imfRef;?>&aff=<?php echo $_GET['aff']; ?>" onclick="ga('send', 'event', 'imfbuy', 'buy', 'enaffimfpack2017newyear')" class="buybtn"><span><img src="<?php echo $pResUrl; ?>images/shop.png" alt="" /></span>BUY NOW <i></i></a>
  </div>
</div>
<div class="three-box wrapper ">
  <div class="box imf">
    ...
    <a href="http://www.iobit.com/buy.php?product=enaffiu6999&ref=<?php echo $iuRef;?>&aff=<?php echo $_GET['aff']; ?>" onclick="ga('send', 'event', 'iubuy', 'buy', 'enaffiu62017newyear')" class="buybtn"><span><img src="<?php echo $pResUrl; ?>images/shop.png" alt="" /></span>BUY NOW <i></i></a>
  </div>
  <div class="box sd-amc">
    ...
    <a href="http://www.iobit.com/buy.php?product=enaffsd5amc1499&ref=<?php echo $amcRef;?>&aff=<?php echo $_GET['aff']; ?>" onclick="ga('send', 'event', 'sdbuy', 'buy', 'enaffsdamc2017newyear')" class="buybtn"><span><img src="<?php echo $pResUrl; ?>images/shop.png" alt="" /></span>BUY NOW <i></i></a>
  </div>
  <div class="box mb">
    ...
    <a href="http://www.iobit.com/buy.php?product=enaffmb42498&ref=<?php echo $mbRef;?>&aff=<?php echo $_GET['aff']; ?>" onclick="ga('send', 'event', 'mbbuy', 'buy', 'enaffmb42017newyear')" class="buybtn"><span><img src="<?php echo $pResUrl; ?>images/shop.png" alt="" /></span>BUY NOW <i></i></a>
  </div>
</div>
<div class="bottom">
  <div class="wrapper">
