...
if (empty($_GET['ref'])) $_GET['ref'] = 'svaff_db8_2021trialendsale';
?>
<!DOCTYPE html>
<html lang="sv">
<head>
			...
			<div class="offer clearfix">
              ...
              <i class="date0">01</i>-<i class="date1">02</i> <em class="month">juli</em>
					...
					<ul class="price clearfix">
						...
						<li class="last">
							<a class="buybtn" 
							   href="https://www.iobit.com/buy.php?product=svaff-db83pc279&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff'];?>"
							   onclick="ga('send', 'event', 'dbbuy', 'buy', 'svaffdb82021trialendsale')">
