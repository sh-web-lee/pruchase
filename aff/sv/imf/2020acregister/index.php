...
if (empty($_GET['ref'])) $_GET['ref'] = 'svaff_imf7_2020acregister';
?>
<!DOCTYPE html>
<html lang="sv">
<head>
	...
	<div class="wrapper">
		...
		<div class="intro">
			...
			<div class="discount">
				...
				<div class="wprice">ENDAST <em>199 kr</em> <del> 1393 kr</del> <span> 1 Års Prenumation / 1 PC</span></div>
				<div class="btnarea">
					<a href="https://www.iobit.com/buy.php?product=svaff-imf7-ac&ref=<?php echo $_GET['ref'];?>&aff=<?php echo $_GET['aff'];?>" onclick="ga('send', 'event', 'imfbuy', 'buy', 'svaffimf72020acregister')" class="checkbtn imfbuybtn">Köp Nu >></a>
			...
			<div class="leftbox">
				...
				<ul>
					...
					<li>
						...
						Hitta och ta bort över 203,000,000 dolda hot
					</li>
					<li>
					...
					<li>
						...
						Stoppa hot som gömmer sig i USB-diskar från att skada din dator.
					</li>
				</ul>
			 </div>
			<div class="review">
		...
		<div class="checkout">
			<div class="moneyback">
				Du skyddas helt av vår 100% pengarna tillbaka garanti och du KOMMER att se en betydande förbättring av datorns prestanda INOM 60 DAGAR, eller så gör vi en full återbetalning. Inga frågor.  <a class="imfbuybtn" href="https://www.iobit.com/buy.php?product=svaff-imf7-ac&ref=<?php echo $_GET['ref'];?>&aff=<?php echo $_GET['aff'];?>" onclick="ga('send', 'event', 'imfbuy', 'buy', 'svaffimf72020acregister')" >Köp Nu</a>
			</div>
			<div class="btn">
				<a href="https://www.iobit.com/buy.php?product=svaff-imf7-ac&ref=<?php echo $_GET['ref'];?>&aff=<?php echo $_GET['aff'];?>" onclick="ga('send', 'event', 'imfbuy', 'buy', 'svaffimf72020acregister')"  class="checkbtn imfbuybtn">Köp Nu >></a>
				<span>100% PENGARNA TILLBAKA GARANTI</span>
