...
if (empty($_GET['ref'])) $_GET['ref'] = 'svaff_iu9_2020acregister';
...
<div id="main" class="wrapper">
	<div class="intro">
		...
		<div class="discount">
			...
			<dl>
				<dt>85% Rabatt</dt>
				<dd class="price">ENDAST <em> 164kr</em> <del> 1093 kr</del> <span>1 År / 1 PC</span></dd>
				<dd><a href="https://www.iobit.com/buy.php?product=svaff-iu9-acak&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" onclick="ga('send', 'event', 'iubuy', 'buy', 'svaffiu92020acregister')" class="checkbtn iubuybtn">Köp Nu >></a></dd>
		...
		<div class="leftbox">
			...
			<ul>
				...
				<li>
					...
					Ta bort annonsbaserade och skadliga plug-ins för att garantera säker och ren webbupplevelse. 
				</li>
				<li>
	...
	<div class="checkout">
		<div class="moneyback">
				Du skyddas helt av vår 100% pengarna tillbaka garanti och du KOMMER att se en betydande förbättring av datorns prestanda INOM 60 DAGAR, eller så gör vi en full återbetalning. Inga frågor. <a class="iubuybtn" href="https://www.iobit.com/buy.php?product=svaff-iu9-acak&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" onclick="ga('send', 'event', 'iubuy', 'buy', 'svaffiu92020acregister')">Köp Nu</a>
			</div>
			<div class="btn">
				<a href="https://www.iobit.com/buy.php?product=svaff-iu9-acak&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" onclick="ga('send', 'event', 'iubuy', 'buy', 'svaffiu92020acregister')" class="checkbtn iubuybtn">Köp Nu >></a>
