...
var pcga = "ga('send', 'event', 'ascbuy', 'buy', 'svaffasc122019buy1pc');";
var pcsga = "ga('send', 'event', 'ascbuy', 'buy', 'svaffasc122019buy3pc');";

var pcgab = "ga('send', 'event', 'ascbuy', 'buy', 'svaffasc122019buy1pcoff');";
var pcsgab = "ga('send', 'event', 'ascbuy', 'buy', 'svaffasc122019buy3pcoff');";

var pcgabc = "ga('send', 'event', 'ascbuy', 'buy', 'svaffasc122019buy1pc');";
var pcsgabc = "ga('send', 'event', 'ascbuy', 'buy', 'svaffasc122019buy3pc')";

if ($ref1pc.length <= 0) $ref1pc = 'svaff_asc12_2019buy1pc';
if ($ref3pc.length <= 0) $ref3pc = 'svaff_asc12_2019buy3pc';

if ($ref1pcoff.length <= 0) $ref1pcoff = 'svaff_asc12_2019buy1pcoff';
if ($ref3pcoff.length <= 0) $ref3pcoff = 'svaff_asc12_2019buy3pcoff';
...
function planA() {
  ...
  $(".offer .pc").find(".price").html('' +
    ...
    '<a class="buybtn"' +
    ' href="https://www.iobit.com/buy.php?product=svaff-asc121pc219&ref='+ $ref1pc +'&aff='+ aff +'&tw='+ tw +'"' +
    'onclick="' + pcga + '">' +
  ...
  $(".offer .pcs").find(".price").html('' +
    ...
    '<a class="buybtn" ' +
    'href="https://www.iobit.com/buy.php?product=svaff-asc123pc309&ref='+ $ref3pc +'&aff='+ aff +'&tw='+ tw +'"' +
    'onclick="' + pcsga + '">' +
    'Lägg till i Kundvagn' +
    '</a>' +
...
function planB() {
  ...
  $(".offer .pc").find(".price").html('<table>' +
    ...
    '</tr></table>' +
    '<a class="buybtn" ' +
    'href=https://www.iobit.com/buy.php?product=svaff-asc121pc165&ref='+ $ref1pcoff +'&aff='+ aff +'&tw='+ tw +'"' +
    ' onclick="' + pcgab + '">' +
    'Lägg till i Kundvagn' +
    '</a>' +
    '<h5>Sparar: 273 kr</h5>');
  $(".offer .pcs").find(".price").html('<table>' +
    ...
    '</tr></table>' +
    '<a class="buybtn" ' +
    'href="https://www.iobit.com/buy.php?product=svaff-asc123pc232&ref='+ $ref3pcoff +'&aff='+ aff +'&tw='+ tw +'" ' +
    'onclick="' + pcsgab + '">' +
    'Lägg till i Kundvagn' +
    '</a>' +
    '<h5>Sparar: 540 kr</h5>');
