...
$ref1pc='svaff_asc12_2019buy1pc';
$ref3pc='svaff_asc12_2019buy3pc';
if(!empty($_GET['ref'])){
  ...
  <div class="offer clearfix">
    ...
    <div class="box pc">
      ...
      <div class="price">
        ...
        <!-- 1pc buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=svaff-asc121pc219&ref=<?php echo $ref1pc;?>&aff=<?php echo $_GET['aff']?>"
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'svaffasc122019buy1pc')">
    ...
    <div class="box pcs">
      ...
      <div class="price">
        ...
        <!-- 3pc buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=svaff-asc123pc309&ref=<?php echo $ref3pc;?>&aff=<?php echo $_GET['aff']?>"
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'svaffasc122019buy3pc')">
          Lägg till i Kundvagn
        </a>
