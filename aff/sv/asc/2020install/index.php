...
if (empty($_GET['ref'])) $_GET['ref'] = 'svaff_asc13_2020install';
...
<title>Tack för att du installerade Advanced SystemCare 13 - IObit</title>
  ...
  <div class="pagebanner">
    <div class="container comp-heading clearfix">
      ...
      <div class="heading-info">
        ...
        <p>
          Genom att Advanced SystemCare PRO låser upp samtliga funktioner förbättras datorns prestanda och effektivitet. Djupgående registreringsrensning och automatisk RAM-rensning frigör ytterligare diskutrymme och säkerställer stabil systemkörning. Optimerad Internet Booster höjer internetuppkopplingens hastighet distinkt med upp till 300%. Dessutom skyddas din online-integritet med privatlivsskyddet och webbläsarens anti-spårning. För mer information om PRO-versionen, se tabellen nedan.
        </p>
        <div class="price-zone clearfix">
          ...
          <a class="button btn-orange large"
             href="https://www.iobit.com/buy.php?product=svaff-asc131pc219&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" 
             onclick="ga('send', 'event', 'ascbuy', 'buy', 'svaffasc132020install');">
            KÖP NU
          </a>
        </div>
      </div>
    ...
    <div class="container">
      <div class="compare">
        <table border="0" cellspacing="0" cellpadding="0" width="100%" class="comparetab">
          ...
          <tbody>
            <tr><td colspan="4" class="mid-header">Rensa & förbättra PC prestanda</td></tr>
            <tr>
            ...
            <tr><td colspan="4" class="mid-header">Förbättra PC hastighet</td></tr>
            <tr>
              <td class="icon">
                <img src="https://www.iobit.com/tpl/images/comparison/speedup/sp_startup.png" alt="">
              </td>
              <td class="describe">Upp till <strong>200%</strong> snabbare uppstart <i class="tags improved"></i></td>
              <td class="itempro"><i class="fa fa-check"></i></td>
            </tr>
            <tr>
              <td class="icon">
              ...
              <td class="describe">Upp till <strong>300%</strong> snabbare internethastighet med Internet Boostern</td>
              <td class="itempro"><i class="fa fa-check"></i></td>
            </tr>
            <tr><td colspan="4" class="mid-header">Försäkra Dator och Integritets Säkerhet</td></tr>
            <tr>
              <td class="icon">
            ...
            <tr>
              ...
              <td class="describe">Blockera skadliga länkar och misstänkta avsändare i e-postmeddelanden <i class="tags new"></i></td>
              <td class="itempro"><i class="fa fa-check"></i></td>
            </tr>
            <tr>
              <td class="icon">
            ...
            <tr><td colspan="4" class="mid-header">Optimal IObit service</td></tr>
            <tr>
              <td class="icon">
