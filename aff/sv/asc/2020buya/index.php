...
$ref1pc='svaff_asc13_2020buya1pc';
$ref3pc='svaff_asc13_2020buya3pc';
if(!empty($_GET['ref'])){
    ...
    <div class="box pc">
      ...
      <div class="price">
        ...
        <a class="buybtn"
           ...
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'svaffasc132020buya1pc')">
    ...
    <div class="box pcs">
      ...
      <div class="price">
        ...
        <a class="buybtn"
           ...
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'svaffasc132020buya3pc')">
          Lägg till i Kundvagn
        </a>
