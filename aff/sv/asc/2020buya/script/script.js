...
var pcga = "ga('send', 'event', 'ascbuy', 'buy', 'svaffasc132020buya1pc');";
var pcsga = "ga('send', 'event', 'ascbuy', 'buy', 'svaffasc132020buya3pc');";

var pcgab = "ga('send', 'event', 'ascbuy', 'buy', 'svaffasc132020buya1pcoff');";
var pcsgab = "ga('send', 'event', 'ascbuy', 'buy', 'svaffasc132020buya3pcoff');";

var pcgabc = "ga('send', 'event', 'ascbuy', 'buy', 'svaffasc132020buya1pc');";
var pcsgabc = "ga('send', 'event', 'ascbuy', 'buy', 'svaffasc132020buya3pc')";

if ($ref1pc.length <= 0) $ref1pc = 'svaff_asc13_2020buya1pc';
if ($ref3pc.length <= 0) $ref3pc = 'svaff_asc13_2020buya3pc';

if ($ref1pcoff.length <= 0) $ref1pcoff = 'svaff_asc13_2020buya1pcoff';
if ($ref3pcoff.length <= 0) $ref3pcoff = 'svaff_asc13_2020buya3pcoff';
...
function planA() {
  ...
  $(".offer .pc").find(".price").html('' +
    ...
    '<a class="buybtn"' +
    ' href="https://www.iobit.com/buy.php?product=svaff-asc131pc219&ref='+ $ref1pc +'&aff='+ aff +'&tw='+ tw +'"' +
    'onclick="' + pcga + '">' +
  ...
  $(".offer .pcs").find(".price").html('' +
    ...
    '<a class="buybtn" ' +
    'href="https://www.iobit.com/buy.php?product=svaff-asc133pc309&ref='+ $ref3pc +'&aff='+ aff +'&tw='+ tw +'"' +
    'onclick="' + pcsga + '">' +
    'Lägg till i Kundvagn' +
    '</a>' +
...
function planB() {
  ...
  $(".offer .pc").find(".price").html('<table>' +
    ...
    '</tr></table>' +
    '<a class="buybtn" ' +
    'href=https://www.iobit.com/buy.php?product=svaff-asc131pc165&ref='+ $ref1pcoff +'&aff='+ aff +'&tw='+ tw +'"' +
    ' onclick="' + pcgab + '">' +
    'Lägg till i Kundvagn' +
    '</a>' +
    '<h5>Sparar: 273 kr</h5>');
  $(".offer .pcs").find(".price").html('<table>' +
    ...
    '</tr></table>' +
    '<a class="buybtn" ' +
    'href="https://www.iobit.com/buy.php?product=svaff-asc133pc232&ref='+ $ref3pcoff +'&aff='+ aff +'&tw='+ tw +'" ' +
    'onclick="' + pcsgab + '">' +
    'Lägg till i Kundvagn' +
    '</a>' +
    '<h5>Sparar: 540 kr</h5>');
