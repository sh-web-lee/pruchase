<?php  
  ...
  if (empty($_GET['ref'])) {
    $_GET['ref'] = 'svaff_asc12_2018acregister';
  }
?>
<!DOCTYPE html>
<html lang="sv">
        ...
        <dl class="price">
          ...
          <dd>
            <a class="buybtn bigbtn" 
               href="https://www.iobit.com/buy.php?product=svaff-asc123pc299&ref=<?php echo $_GET['ref']?>&aff=<?php echo $_GET['aff']?>"
               onclick="ga('send', 'event', 'ascbuy', 'buy', 'svaffasc122018acregister')">
              <div class="inner">
                <i class="all-icons"></i>
  ...
  <div class="feature wrapper">
    ...
    <div class="clearfix">
      <dl>
        ...
        <dd>
          <h3>DJUPRENGÖRING</h3>
          <p>Rengör din dator på djupet och lös registerfel och andra problem som får Windows att krascha.</p>
        </dd>
      </dl>
      <dl class="right">
        <dt><img src="<?php echo getStaticUrl('images/feature_icons_02.png')?>" alt=""></dt>
        <dd>
          <h3>AUTOMATISK SKÖTSEL</h3>
          <p>Ta hand om din dator automatiskt på schemalagd tid och rensa ditt RAM-minne för att förbättra din dators prestanda.</p>
        </dd>
      </dl>
    </div>
    <div class="clearfix">
      <dl>
        ...
        <dd>
          <h3>SNABBARE PC</h3>
          <p>Minska din uppstartstid och öka din internethastighet med 200% respektive 300% och upplev en bättre dator med snabbare internet.*</p>
        </dd>
      </dl>
      <dl class="right">
        <dt><img src="<?php echo getStaticUrl('images/feature_icons_04.png')?>" alt=""></dt>
        <dd>
          <h3>HÅLL DATOR OCH INTEGRITET SÄKER</h3>
          <p>Radera spår och dölja digitalt fingeravtryck för att hålla ditt online beteende privat, blockera hemliga åtkomster till dina personuppgifter för att hålla dem säkra från snokar.</p>
        </dd>
      </dl>
    </div>
  </div>
