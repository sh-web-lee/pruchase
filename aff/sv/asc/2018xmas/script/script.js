...
function maskFirst() {
  ...
  $('.main').append('<div class="mask"></div><div class="mask-box"><h2>Julöverraskning</h2><div class="clearfix"><div class="fl left"><img src="' + imgSrc + '" alt="Advanced SystemCare 12 Pro"/></div><div class="price fl"><h3>Extra <b>10kr</b> Rabattbara för dig!</h3><p><big>Bara </big><strong>229</strong> <span>kr 1 år / 3 PC</span></p> <a class="buybtn" href="' + _href + '" onclick="' + _ga + '">Aktivera Nu</a><p class="year">Missa inte din sista chans till största besparingen någonsin!</p></div></div></div>');
}
...
function timeInit() {
  var date = new Date();
  var cName = "svascpre" + date.getDate();
