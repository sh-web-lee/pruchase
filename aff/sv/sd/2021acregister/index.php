...
if(in_array($_GET['st'],array('ascu_acsd','asc_acsd'))){
	...
	if (empty($_GET['ref'])) $_GET['ref'] = 'svaff_sd6_2021acregister';
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<title>85% Rabatt på Smart Defrag 7 PRO</title>
	...
	<div class="wrapper">
		...
		<div class="intro">
			...
			<div class="discount">
				...
				<div class="wprice">ENDAST <em>164kr</em> <del>1093kr </del><span>1 Års Prenumation / 1 PC</span></div>
				<div class="btnarea">
					<a href="https://www.iobit.com/buy.php?product=svaff-sd61pc164&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" onclick="ga('send', 'event', 'sdbuy', 'buy', 'svaffsd62021acregister')" class="checkbtn sdbuybtn">Köp Nu >></a>
		...
		<div class="clear"></div>
		<div class="checkout">
			<div class="moneyback">Du skyddas helt av vår 100% pengarna tillbaka garanti och du KOMMER att se en betydande förbättring av datorns prestanda INOM 60 DAGAR, eller så gör vi en full återbetalning. Inga frågor.  <a class="sdbuybtn" href="https://www.iobit.com/buy.php?product=svaff-sd61pc164&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" onclick="ga('send', 'event', 'sdbuy', 'buy', 'svaffsd62021acregister')">Köp nu</a></div>
			<div class="btn">
				<a href="https://www.iobit.com/buy.php?product=svaff-sd61pc164&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" onclick="ga('send', 'event', 'sdbuy', 'buy', 'svaffsd62021acregister')" class="checkbtn sdbuybtn">Köp Nu >></a>
					<span>100% PENGARNA TILLBAKA GARANTI</span>
			</div>
