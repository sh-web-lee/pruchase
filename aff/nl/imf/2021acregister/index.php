...
if(in_array($_GET['st'],array('asc_acimf'))){
  ...
  if (empty($_GET['ref'])) $_GET['ref'] = 'nlaff_imf8_2021acregister';
?>
  ...
  <div class="wrapper">
    ...
    <div class="intro">
      ...
      <div class="discount">
        ...
        <div class="btnarea">
          <a href="https://www.iobit.com/buy.php?product=nlaff-imf81pc1349&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" onclick="ga('send', 'event', 'imfbuy', 'buy', 'nlaffimf82021acregister')" class="checkbtn">Koop nu >></a>
...
- download.com</div></div>            
        ...
        <div class="checkout">
          <div class="moneyback">
              U bent volledig beschermd door ons 100% geld terug garantie programma, en u ZULT een aanzienkelijke verbetering in uw PC prestaties’s ervaren BINNEN 60 dagen. Zo niet, dan verzorgen wij een volledige terugbetaling, zonder vragen te stellen. <a href="https://www.iobit.com/buy.php?product=nlaff-imf81pc1349&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" onclick="ga('send', 'event', 'imfbuy', 'buy', 'nlaffimf82021acregister')">Koop nu</a>
            </div>
            <div class="btn">
              <a href="https://www.iobit.com/buy.php?product=nlaff-imf81pc1349&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" title="CHECKOUT" onclick="ga('send', 'event', 'imfbuy', 'buy', 'nlaffimf82021acregister')" class="checkbtn">Koop nu >></a>
                <span>100% GELD TERUG GARANTIE</span>
            </div>
        </div>
        <div class="clear"></div>
