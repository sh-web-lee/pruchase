...
if(in_array($_GET['st'],array('asc_acimf'))){
  ...
  if (empty($_GET['ref'])) $_GET['ref'] = 'nlaff_imf7_2020acregister';
?>
  ...
  <div class="wrapper">
    ...
    <div class="intro">
      ...
      <div class="discount">
        ...
        <div class="wprice">SLECHTS <em>€13,49</em> <del>€89,93</del> <span>1-jarig abonnement / 1 PC</span></div>
        <div class="btnarea">
          <a href="https://www.iobit.com/buy.php?product=nlaff-imf7-ac&ref=<?php echo $_GET['ref'];?>&aff=<?php echo $_GET['aff'];?>" onclick="ga('send', 'event', 'imfbuy', 'buy', 'nlaffimf72020acregister')" class="checkbtn">Koop nu >></a>
      ...
      <div class="leftbox">
        ...
        <ul>
          <li>
            ...
            Verwijder meer dan 203.000.000 bedreigingen met de Bitdefender Anti-virus engine & IObit Anti-malware engine.
          </li>
          <li>
          ...
          <li>
            ...
            Voorkom infecties door virussen op USB-schijven die op uw computer worden aangesloten.
          </li>
        </ul>
      </div>
...
- download.com</div></div>            
        ...
        <div class="checkout">
          <div class="moneyback">
              U bent volledig beschermd door ons 100% geld terug garantie programma, en u ZULT een aanzienkelijke verbetering in uw PC prestaties’s ervaren BINNEN 60 dagen. Zo niet, dan verzorgen wij een volledige terugbetaling, zonder vragen te stellen. <a href="https://www.iobit.com/buy.php?product=nlaff-imf7-ac&ref=<?php echo $_GET['ref'];?>&aff=<?php echo $_GET['aff'];?>" onclick="ga('send', 'event', 'imfbuy', 'buy', 'nlaffimf72020acregister')">Koop nu</a>
            </div>
            <div class="btn">
              <a href="https://www.iobit.com/buy.php?product=nlaff-imf7-ac&ref=<?php echo $_GET['ref'];?>&aff=<?php echo $_GET['aff'];?>" onclick="ga('send', 'event', 'imfbuy', 'buy', 'nlaffimf72020acregister')" title="CHECKOUT" class="checkbtn">Koop nu >></a>
                <span>100% GELD TERUG GARANTIE</span>
            </div>
        </div>
        <div class="clear"></div>
