...
if (empty($_GET['ref'])) $_GET['ref'] = 'nlaff_asc13_2020install';
      ...
      <div class="heading-info">
        ...
        <div class="price-zone clearfix">
          ...
          <a class="button btn-orange large"
             href="https://www.iobit.com/buy.php?product=nlaff-asc131pc1499&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" 
             onclick="ga('send', 'event', 'ascbuy', 'buy', 'nlaffasc132020install');">
            Koop Nu
          </a>
        </div>
      </div>
    ...
    <div class="container">
      <div class="compare">
        <table border="0" cellspacing="0" cellpadding="0" width="100%" class="comparetab">
          ...
          <tbody>
            <tr><td colspan="4" class="mid-header">Opschonen & Optimalisatie</td></tr>
            <tr>
            ...
            <tr>
              ...
              <td class="describe">Tot wel <strong>200%</strong> snellere opstarttijd  <i class="tags improved"></i></td>
              <td class="itempro"><i class="fa fa-check"></i></td>
            </tr>
            <tr>
              <td class="icon">
              ...
              <td class="describe">Tot wel <strong>300%</strong> sneller internet met internet booster</td>
              <td class="itempro"><i class="fa fa-check"></i></td>
            </tr>
            <tr><td colspan="4" class="mid-header">Bescherm PC & Privacy</td></tr>
            <tr>
              <td class="icon">
            ...
            <tr>
              ...
              <td class="describe">Blokkeer schadelijke links en verdachte afzenders in uw web-based e-mail <i class="tags new"></i></td>
              <td class="itempro"><i class="fa fa-check"></i></td>
            </tr>
            <tr>
              <td class="icon">
            ...
            <tr><td colspan="4" class="mid-header">Premium IObit Service</td></tr>
            <tr>
              <td class="icon">
