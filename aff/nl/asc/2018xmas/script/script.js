...
function firstShow() {
  ...
  $('.main').append('<div class="mask"></div><div class="mask-box"><h2>Kerstcadeautje</h2><div class="clearfix"><div class="fl left"><img src="' + imgSrc + '" alt="Advanced SystemCare 12 Pro"/></div><div class="price fl"><h3><b>€1</b> extra KORTING speciaal voor jou!</h3><p>Slechts <strong>€16<big>,</big></strong> <span>99<del>€119,93</del></span></p> <a class="buybtn" href="' + _href + '" onclick="' + _ga + '">Activeer Nu</a><p class="year">Grijp uw laatste kans!</p></div></div></div>');
}
...
function timeInit() {
  var date = new Date();
  var cName = "nlascpre" + date.getDate();
