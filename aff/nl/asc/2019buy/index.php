...
$ref1pc='nlaff_asc12_2019buy1pc';
$ref3pc='nlaff_asc12_2019buy3pc';
if(!empty($_GET['ref'])){
  ...
  <div class="offer clearfix">
    ...
    <div class="box pc">
      ...
      <div class="price">
        ...
        <!-- 1pc buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=nlaff-asc121pc1499a&ref=nlaff_asc12_2019buy1pc&aff=<?php echo $_GET['aff']?>"
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'nlaffasc122019buy1pc')">
          Activeer Nu!
        </a>
      </div>
    </div>
    ...
    <div class="box pcs">
      ...
      <div class="price">
        ...
        <!-- 3pc buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=nlaff-asc123pc1999a&ref=nlaff_asc12_2019buy3pc&aff=<?php echo $_GET['aff']?>"
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'nlaffasc122019buy3pc')">
          Activeer Nu!
        </a>
