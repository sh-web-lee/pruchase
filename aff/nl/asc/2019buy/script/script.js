...
var pcga = "ga('send', 'event', 'ascbuy', 'buy', 'nlaffasc122019buy1pc');";
var pcsga = "ga('send', 'event', 'ascbuy', 'buy', 'nlaffasc122019buy3pc');";
var pcgab = "ga('send', 'event', 'ascbuy', 'buy', 'nlaffasc122019buy1pcoff');";
var pcsgab = "ga('send', 'event', 'ascbuy', 'buy', 'nlaffasc122019buy3pcoff');";
var pcgabc = "ga('send', 'event', 'ascbuy', 'buy', 'nlaffasc122019buy1pc')";
var pcsgabc = "ga('send', 'event', 'ascbuy', 'buy', 'nlaffasc122019buy3pc')";

if ($ref1pc.length <= 0) $ref1pc = 'nlaff_asc12_2019buy1pc';
if ($ref3pc.length <= 0) $ref3pc = 'nlaff_asc12_2019buy3pc';
if ($ref1pcoff.length <= 0) $ref1pcoff = 'nlaff_asc12_2019buy1pcoff';
if ($ref3pcoff.length <= 0) $ref3pcoff = 'nlaff_asc12_2019buy3pcoff';
...
function planA() {
  ...
  $(".offer .pc").find(".price").html('<p><strong><small>€</small>14,99</strong> <del>€29,99</del></p><a class="buybtn" href="https://www.iobit.com/buy.php?product=nlaff-asc121pc1499a&ref=nlaff_asc12_2019buy1pc&aff=' + aff + '&tw=' + tw + '" onclick="' + pcga + '">Activeer Nu!</a>');
  $(".offer .pcs").find(".price").html('<p><strong><small>€</small>19,99</strong> <del>€49,98</del></p><a class="buybtn" href="https://www.iobit.com/buy.php?product=nlaff-asc123pc1999a&ref=nlaff_asc12_2019buy3pc&aff=' + aff + '&tw=' + tw +'" onclick="' + pcsga + '">Activeer Nu!</a><p class = "people" ><i></i><b class="buynum">3.966.571</b> keer geactiveerd</p>');
  reBuyLink();
}
...
function planB() {
  ...
  $(".offer .pc").find(".price").html('<p><span>Oorspronkelijk</span><span>  Aanbieding  </span><b> Met Extra 25% KORTING</b></p><p><del>€29,99</del><del class="center">€14,99</del><strong>€11,24</strong></p><a class="buybtn" href="https://www.iobit.com/buy.php?product=nlaff-asc121pc1124a&ref=nlaff_asc12_2019buy1pcoff&aff=' + aff + '&tw='+ tw +'" onclick="'+ pcgab +'"> Activeer Nu!</a><h5> Bespaar: € 18,75</h5>');
  $(".offer .pcs").find(".price").html('<p><span><b>Oorspronkelijk</b></span><span><b>  Aanbieding  </b></span><b> Met Extra 25% KORTING</b></p><p><del>€49,98</del><del class="center">€19,99 </del><strong>€14,99</strong></p><a class="buybtn" href="https://www.iobit.com/buy.php?product=nlaff-asc123pc1499&ref=nlaff_asc12_2019buy3pcoff&aff='+ aff +'&tw='+ tw +'" onclick="' + pcsgab + '"> Activeer Nu!</a><h5> Bespaar: €35</h5>');
  reBuyLink();
}
...
function planC() {
  ...
  $(".offer .pc").find(".price").html('<dl class="clearfix"><dd>Met Extra 25% KORTING<del>€11,24</del></dd><dd class="nowsaleprice">Aanbieding<strong>€14,99</strong></dd><dt></dt></dl><a class="buybtn" href="https://www.iobit.com/buy.php?product=nlaff-asc121pc1499a&ref=nlaff_asc12_2019buy1pc&aff='+ aff +'&tw='+ tw +'" onclick="' + pcgabc + '">Activeer Nu!</a>');
  $(".offer .pcs").find(".price").html('<dl class="clearfix"><dd>Met Extra 25% KORTING<del>€14,99</del></dd><dd class="nowsaleprice">Aanbieding<strong>€19,99</strong></dd><dt></dt></dl><a class="buybtn" href="https://www.iobit.com/buy.php?product=nlaff-asc123pc1999a&ref=nlaff_asc12_2019buy3pc&aff='+ aff +'&tw='+ tw +'" onclick="' + pcsgabc + '">Activeer Nu!</a>');
  reBuyLink();
}
...
function maskB() {
  ...
  $(".planb").html("<h2>GEFELICITEERD!</h2><p>U Heeft Vandaag Geluk! Krijg <b>25% Extra Korting</b>, beperkt beschikbaar!</p><img class='off' src='" + imgSrc + "'><div class='buybox'><a class='buybtn' href='javascript: void(0);' onclick='maskCount(1);cycleCountdown(2);'>VOEG MIJN KORTING NU TOE</a><p onclick='maskClose()'>Nee bedankt, ik betaal liever de volle prijs</p></div>");
