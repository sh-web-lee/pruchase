...
var pcga = "ga('send', 'event', 'ascbuy', 'buy', 'nlaffasc142021buy1pc');";
var pcsga = "ga('send', 'event', 'ascbuy', 'buy', 'nlaffasc142021buy3pc');";
var pcgab = "ga('send', 'event', 'ascbuy', 'buy', 'nlaffasc142021buy1pcoff');";
var pcsgab = "ga('send', 'event', 'ascbuy', 'buy', 'nlaffasc142021buy3pcoff');";
var pcgabc = "ga('send', 'event', 'ascbuy', 'buy', 'nlaffasc142021buy1pc')";
var pcsgabc = "ga('send', 'event', 'ascbuy', 'buy', 'nlaffasc142021buy3pc')";

if ($ref1pc.length <= 0) $ref1pc = 'nlaff_asc14_2021buy1pc';
if ($ref3pc.length <= 0) $ref3pc = 'nlaff_asc14_2021buy3pc';
if ($ref1pcoff.length <= 0) $ref1pcoff = 'nlaff_asc14_2021buy1pcoff';
if ($ref3pcoff.length <= 0) $ref3pcoff = 'nlaff_asc14_2021buy3pcoff';
...
function planA() {
  ...
  $(".offer .pc").find(".price").html('<p><strong><small>€</small>14,99</strong> <del>€29,99</del></p><a class="buybtn" href="https://www.iobit.com/buy.php?product=nlaff-asc141pc1499&ref=nlaff_asc14_2021buy1pc&aff=' + aff + '&tw=' + tw + '" onclick="' + pcga + '">Activeer Nu!</a>');
  $(".offer .pcs").find(".price").html('<p><strong><small>€</small>19,99</strong> <del>€49,98</del></p><a class="buybtn" href="https://www.iobit.com/buy.php?product=nlaff-asc143pc1999&ref=nlaff_asc14_2021buy3pc&aff=' + aff + '&tw=' + tw +'" onclick="' + pcsga + '">Activeer Nu!</a><p class = "people" ><i></i><b class="buynum">3.966.571</b> keer geactiveerd</p>');
  reBuyLink();
}
...
function planB() {
  ...
  $(".offer .pc").find(".price").html('<p><span>Oorspronkelijk</span><span>  Aanbieding  </span><b> Met Extra 25% KORTING</b></p><p><del>€29,99</del><del class="center">€14,99</del><strong>€11,24</strong></p><a class="buybtn" href="https://www.iobit.com/buy.php?product=nlaff-asc141pc1124&ref=nlaff_asc14_2021buy1pcoff&aff=' + aff + '&tw='+ tw +'" onclick="'+ pcgab +'"> Activeer Nu!</a><h5> Bespaar: € 18,75</h5>');
  $(".offer .pcs").find(".price").html('<p><span><b>Oorspronkelijk</b></span><span><b>  Aanbieding  </b></span><b> Met Extra 25% KORTING</b></p><p><del>€49,98</del><del class="center">€19,99 </del><strong>€14,99</strong></p><a class="buybtn" href="https://www.iobit.com/buy.php?product=nlaff-asc143pc1499&ref=nlaff_asc14_2021buy3pcoff&aff='+ aff +'&tw='+ tw +'" onclick="' + pcsgab + '"> Activeer Nu!</a><h5> Bespaar: €35</h5>');
  reBuyLink();
}
...
function planC() {
  ...
  $(".offer .pc").find(".price").html('<dl class="clearfix"><dd>Met Extra 25% KORTING<del>€11,24</del></dd><dd class="nowsaleprice">Aanbieding<strong>€14,99</strong></dd><dt></dt></dl><a class="buybtn" href="https://www.iobit.com/buy.php?product=nlaff-asc141pc1499&ref=nlaff_asc14_2021buy1pc&aff='+ aff +'&tw='+ tw +'" onclick="' + pcgabc + '">Activeer Nu!</a>');
  $(".offer .pcs").find(".price").html('<dl class="clearfix"><dd>Met Extra 25% KORTING<del>€14,99</del></dd><dd class="nowsaleprice">Aanbieding<strong>€19,99</strong></dd><dt></dt></dl><a class="buybtn" href="https://www.iobit.com/buy.php?product=nlaff-asc143pc1999&ref=nlaff_asc14_2021buy3pc&aff='+ aff +'&tw='+ tw +'" onclick="' + pcsgabc + '">Activeer Nu!</a>');
  reBuyLink();
}
