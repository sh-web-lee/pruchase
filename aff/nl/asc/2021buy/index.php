...
$ref1pc='nlaff_asc14_2021buy1pc';
$ref3pc='nlaff_asc14_2021buy3pc';
if(!empty($_GET['ref'])){
  ...
  <div class="offer clearfix">
    ...
    <div class="box pc">
      ...
      <div class="price">
        ...
        <!-- 1pc buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=nlaff-asc141pc1499&ref=nlaff_asc14_2021buy1pc&aff=<?php echo $_GET['aff']?>"
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'nlaffasc142021buy1pc')">
          Activeer Nu!
        </a>
      </div>
    </div>
    ...
    <div class="box pcs">
      ...
      <div class="price">
        ...
        <!-- 3pc buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=nlaff-asc143pc1999&ref=nlaff_asc14_2021buy3pc&aff=<?php echo $_GET['aff']?>"
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'nlaffasc142021buy3pc')">
          Activeer Nu!
        </a>
