...
var pcga = "ga('send', 'event', 'ascbuy', 'buy', 'nlaffasc132020buy1pc');";
var pcsga = "ga('send', 'event', 'ascbuy', 'buy', 'nlaffasc132020buy3pc');";
var pcgab = "ga('send', 'event', 'ascbuy', 'buy', 'nlaffasc132020buy1pcoff');";
var pcsgab = "ga('send', 'event', 'ascbuy', 'buy', 'nlaffasc132020buy3pcoff');";
var pcgabc = "ga('send', 'event', 'ascbuy', 'buy', 'nlaffasc132020buy1pc')";
var pcsgabc = "ga('send', 'event', 'ascbuy', 'buy', 'nlaffasc132020buy3pc')";

if ($ref1pc.length <= 0) $ref1pc = 'nlaff_asc13_2020buy1pc';
if ($ref3pc.length <= 0) $ref3pc = 'nlaff_asc13_2020buy3pc';
if ($ref1pcoff.length <= 0) $ref1pcoff = 'nlaff_asc13_2020buy1pcoff';
if ($ref3pcoff.length <= 0) $ref3pcoff = 'nlaff_asc13_2020buy3pcoff';
...
function planA() {
  ...
  $(".offer .pc").find(".price").html('<p><strong><small>€</small>14,99</strong> <del>€29,99</del></p><a class="buybtn" href="https://www.iobit.com/buy.php?product=nlaff-asc131pc1499&ref=nlaff_asc13_2020buy1pc&aff=' + aff + '&tw=' + tw + '" onclick="' + pcga + '">Activeer Nu!</a>');
  $(".offer .pcs").find(".price").html('<p><strong><small>€</small>19,99</strong> <del>€49,98</del></p><a class="buybtn" href="https://www.iobit.com/buy.php?product=nlaff-asc133pc1999&ref=nlaff_asc13_2020buy3pc&aff=' + aff + '&tw=' + tw +'" onclick="' + pcsga + '">Activeer Nu!</a><p class = "people" ><i></i><b class="buynum">3.966.571</b> keer geactiveerd</p>');
  reBuyLink();
}
...
function planC() {
  ...
  $(".offer .pc").find(".price").html('<dl class="clearfix"><dd>Met Extra 25% KORTING<del>€11,24</del></dd><dd class="nowsaleprice">Aanbieding<strong>€14,99</strong></dd><dt></dt></dl><a class="buybtn" href="https://www.iobit.com/buy.php?product=nlaff-asc131pc1499&ref=nlaff_asc13_2020buy1pc&aff='+ aff +'&tw='+ tw +'" onclick="' + pcgabc + '">Activeer Nu!</a>');
  $(".offer .pcs").find(".price").html('<dl class="clearfix"><dd>Met Extra 25% KORTING<del>€14,99</del></dd><dd class="nowsaleprice">Aanbieding<strong>€19,99</strong></dd><dt></dt></dl><a class="buybtn" href="https://www.iobit.com/buy.php?product=nlaff-asc133pc1999&ref=nlaff_asc13_2020buy3pc&aff='+ aff +'&tw='+ tw +'" onclick="' + pcsgabc + '">Activeer Nu!</a>');
  reBuyLink();
}
