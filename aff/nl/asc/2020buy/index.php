...
$ref1pc='nlaff_asc13_2020buy1pc';
$ref3pc='nlaff_asc13_2020buy3pc';
if(!empty($_GET['ref'])){
  ...
  <div class="offer clearfix">
    ...
    <div class="box pc">
      ...
      <div class="price">
        ...
        <!-- 1pc buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=nlaff-asc131pc1499&ref=nlaff_asc13_2020buy1pc&aff=<?php echo $_GET['aff']?>"
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'nlaffasc132020buy1pc')">
          Activeer Nu!
        </a>
      </div>
    </div>
    ...
    <div class="box pcs">
      ...
      <div class="price">
        ...
        <!-- 3pc buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=nlaff-asc133pc1999&ref=nlaff_asc13_2020buy3pc&aff=<?php echo $_GET['aff']?>"
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'nlaffasc132020buy3pc')">
          Activeer Nu!
        </a>
