...
if (empty($_GET['ref'])) $_GET['ref'] = 'nlaff_asc14_2021acregister';
?>
<!DOCTYPE html>
<html lang="nl">
<head>
...
<title>85% korting op de Advanced SystemCare PRO</title>
...
<meta property="og:title" content="85% korting op de Advanced SystemCare PRO">
    ...
    <div class="wrapper">
      ...
      <div class="offer clearfix">
        ...
        <div class="discount fl">
          <h2><b>85%</b> <span>KORTING</span></h2>
          <p>Esclusivo per gli VIP di IObit</p>
        </div>
      </div>
      <div class="price">
        <p>SLECHTS: <strong>€14.99 </strong><del>€83.93</del></p>
        <a class="buybtn bigbtn"
           href="https://www.iobit.com/buy.php?product=nlaff-asc141pc1499a&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']?>"
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'nlaffasc142021acregister')">
              <div class="inner">
                <i class="all-icons"></i>
  ...
  <div class="floatlayer" id="floatlayer">
    <div class="wrapper clearfix">
      <div class="left">
        ...
        <p><strong>85% Korting</strong> om uw PC in topconditie te houden</p>
      </div>
      <div class="pricebox">
        <dl class="price fr">
          <dt>SLECHTS: <strong>€14.99 </strong><del>€83.93</del></dt>
          <dd>
