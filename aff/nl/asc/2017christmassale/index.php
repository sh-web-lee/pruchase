<?php  
  ...
  if (empty($_GET['ref'])) $_GET['ref'] = 'nlaff_asc11_2017christmassale';
...
<title> Advanced SystemCare Kerstknaller, Ontvang het beste giftpack van 2017 GRATIS </title>
...
<script type="text/javascript" src="<?php echo $pRootUrl; ?>tpl/js/stats.js"></script>
  ...
  <div class="banner">
    <div class="wrapper">
      ...
      <dl class="price">
        ...
        <dd><a href="https://www.iobit.com/buy.php?product=nlaff-asc111y3pcsdiu1999&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>&refs=nl_purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'nlaffasc112017christmassale')" class="buybtn">Nu Activeren</a></dd>
  ...
  <div class="bottom-buy">
    <div class="wrapper">
      <h2>ASC KERSTKNALLER + GRATIS GIFTPACK</h2>
      <div class="asc-box">
