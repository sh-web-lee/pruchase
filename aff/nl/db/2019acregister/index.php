<?php
    ...
    if (empty($_GET['ref'])) $_GET['ref'] = 'nlaff_db6_2019acregister'; 
?>
<!DOCTYPE html>
<html lang="nl">
<head>
...
<div id="main">
    ...
    <div class="intro">
      ...
      <div class="discount">
          ...
          <div class="btnarea">
            <a href="https://www.iobit.com/buy.php?product=nlaff-db61pc1349&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" onclick="ga('send', 'event', 'dbbuy', 'buy', 'nlaffdb62019acregister')" class="checkbtn">Koop nu >></a>
    ...
    <div class="checkout">
    	<div class="moneyback">
        U bent volledig beschermd door ons 100% geld terug garantie programma, en u ZULT een aanzienkelijke verbetering in uw PC prestaties’s ervaren BINNEN 60 dagen. Zo niet, dan verzorgen wij een volledige terugbetaling, zonder vragen te stellen. <a href="https://www.iobit.com/buy.php?product=nlaff-db61pc1349&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" onclick="ga('send', 'event', 'dbbuy', 'buy', 'nlaffdb62019acregister')">Koop nu</a>
      </div>
      <div class="btn">
      	<a href="https://www.iobit.com/buy.php?product=nlaff-db61pc1349&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" onclick="ga('send', 'event', 'dbbuy', 'buy', 'nlaffdb62019acregister')" title="CHECKOUT" class="checkbtn">Koop nu >></a>
        <span>100% geld terug garantie</span>
      </div>
    </div>
    <div class="clear"></div>
