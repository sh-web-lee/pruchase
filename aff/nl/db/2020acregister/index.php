...
if (empty($_GET['ref'])) $_GET['ref'] = 'nlaff_db7_2020acregister';
...
<script type="text/javascript" src="<?php echo $pRootUrl; ?>tpl/js/stats.js"></script>
  ...
  <div class="banner">
    <div class="wrapper">
      ...
      <div class="pricebox">
        <dl class="price">
          <dt>SLECHTS: <strong>€13,49 </strong><del>€89,93</del></dt>
          <dd>
            <a class="buybtn bigbtn"
               href="https://www.iobit.com/buy.php?product=nlaff-db7-ac&ref=<?php echo $_GET['ref']?>&aff=<?php echo $_GET['aff']?>"
               onclick="ga('send', 'event', 'dbbuy', 'buy', 'nlaffdb72020acregister');">
              <div class="inner">
                <i class="all-icons"></i>
    ...
    <div class="clearfix">
      <dl>
        ...
        <dd>
          ...
          <p>Detecteer en update meer dan 3.500.000 drivers in 1 klik, om de stabiliteit en prestaties van uw computer te verbeteren.</p>
        </dd>
      </dl>
      <dl class="right">
