...
if (empty($_GET['ref'])) $_GET['ref'] = 'nlaff_db8_2021trialsale';
    ...
    <div class="panel clearfix">
      <div class="box left">
        ...
        <div class="price">
          ...
          <a class="buybtn"
             href="https://www.iobit.com/buy.php?product=nlaff-db83pc2499&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']?>"
             onclick="ga('send', 'event', 'dbbuy', 'buy', 'nlaffdb82021trialsale')">
            KOOP NU
          </a>
        </div>
      </div>
      <div class="box center active">
        ...
        <div class="price">
          ...
          <a class="buybtn green"
             href="https://www.iobit.com/buy.php?product=nlaff-db83pciupf2699&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']?>"
             onclick="ga('send', 'event', 'dbbuy', 'buy', 'nlaffdb82021trialsale')">
            PROFITEER NU
          </a>
      ...
      <div class="box right">
        ...
        <div class="price">
          ...
          <a class="buybtn"
             href="https://www.iobit.com/buy.php?product=nlaff-db83pciu2599&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']?>"
             onclick="ga('send', 'event', 'dbbuy', 'buy', 'nlaffdb82021trialsale')">
            KOOP NU
          </a>
        </div>
...
<div id="floatlayer" class="floatlayer">
  <div class="wrapper clearfix">
    <div class="left fl"><img src="<?php echo getStaticUrl('images/db-bundle-box.png')?>" alt="Driver Booster PRO"></div>
