...
if(in_array($_GET['st'],array('asc_acsd','ascu_acsd'))){
  ...
  if (empty($_GET['ref'])) $_GET['ref'] = 'nlaff_sd6_2021acregister';
?>
...
<title>85% korting op de Smart Defrag 7 PRO</title>
...
<div id="main">
    ...
    <div class="intro">
      ...
      <div class="discount">
          ...
          <div class="btnarea">
            <a href="https://www.iobit.com/buy.php?product=nlaff-sd61pc999&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" onclick="ga('send', 'event', 'sdbuy', 'buy', 'nlaffsd62021acregister') " class="checkbtn">Koop nu >></a>
    ...
    <div class="checkout">
    	<div class="moneyback">
      	U bent volledig beschermd door ons 100% geld terug garantie programma, en u ZULT een aanzienkelijke verbetering in uw PC prestaties’s ervaren BINNEN 60 dagen. Zo niet, dan verzorgen wij een volledige terugbetaling, zonder vragen te stellen. <a href="https://www.iobit.com/buy.php?product=nlaff-sd61pc999&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" onclick="ga('send', 'event', 'sdbuy', 'buy', 'nlaffsd62021acregister') ">Koop nu</a>
      </div>
      <div class="btn">
      	<a href="https://www.iobit.com/buy.php?product=nlaff-sd61pc999&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" title="CHECKOUT" onclick="ga('send', 'event', 'sdbuy', 'buy', 'nlaffsd62021acregister') " class="checkbtn">Koop nu >></a>
        <span>100% geld terug garantie</span>
      </div>
    </div>
    <div class="clear"></div>
