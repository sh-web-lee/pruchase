...
if (empty($_GET['ref'])) $_GET['ref'] = 'esaff_sd6_2021acregister';
?>
	...
	<div class="wrapper">
        ...
        <div class="intro">
            ...
            <div class="discount">
                ...
                <div class="btnarea">
                    <a href="https://www.iobit.com/buy.php?product=esaff-sd61pc899&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" onclick="ga('send', 'event', 'sdbuy', 'buy', 'esaffsd62021acregister') ;" class="checkbtn">Comprar ahora >></a>
...
- PCWORLD.com</div></div>            
        ...
        <div class="checkout">
        	<div class="moneyback">
            	Usted está totalmente protegido por nuestra 100% garantía de reembolso y verá una mejora significativa en el rendimiento de su PC DENTRO DE 60 DÍAS, o le enviaremos un reembolso completo. Sin preguntas hechas. <a href="https://www.iobit.com/buy.php?product=esaff-sd61pc899&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" onclick="ga('send', 'event', 'sdbuy', 'buy', 'esaffsd62021acregister') ;">Comprar ahora</a>
            </div>
            <div class="btn">
            	<a href="https://www.iobit.com/buy.php?product=esaff-sd61pc899&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" title="CHECKOUT" onclick="ga('send', 'event', 'sdbuy', 'buy', 'esaffsd62021acregister') ;" class="checkbtn">Comprar ahora >></a>
                <span>100% garantía de reembolso</span>
            </div>
        </div>
        <div class="clear"></div>
