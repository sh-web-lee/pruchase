...
function getCycleCountdown() {
  var date = new Date();
  if (MApp(2.2).cookie.get('2020specialsale')) {
    dt = MApp(2.2).cookie.get('2020specialsale');

  } else {
    dt = date.setMinutes(date.getMinutes() + 10);
    MApp(2.2).cookie.set('2020specialsale', dt);
  }
...
function getPacksNum() {
  var e = new Date;
  var n1 = MApp(2.2).cookie.get('2020specialsale') / 1000;
