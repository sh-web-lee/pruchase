...
if (empty($_GET['ref'])) $_GET['ref'] = 'esaff_asc12_2018xmas';
...
<body>
        ...
        <div class="palen clearfix">
          ...
          <div class="right fr">
            ...
            <div class="price">
              ...
              <a class="buybtn" href="https://www.iobit.com/buy.php?product=esaff-asc12pfsdamc1677&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" onclick="ga('send', 'event', 'ascbuy', 'buy', 'esaffasc122018xmas')">
                 Comprar ahora
              </a>
    ...
    <div class="comparison" id="compare">
      <div class="wrapper">
        <table border="0" cellspacing="0" cellpadding="0" width="100%">
          <thead>
            <tr>
              <th class="itemb"><p>Ve claramente lo que obtendrás de Pro, <span>si compras ahora:</span></p></th>
          ...
          <tbody>
            ...
            <tr>
              <td class="itemb">Elimina automáticamente los rastros de privacidad <p>para navegación segura</p></td>
              <td class="itemc"><i class="all-icons pro">√</i></td>
            </tr>
            <tr>
  ...
  <script>
    ...
    var _href = "https://www.iobit.com/buy.php?product=esaff-asc12pfsdamc1577&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>&tw=-8";
    var _ga = "ga('send', 'event', 'ascbuy', 'buy', 'esaffasc122018xmas')";
