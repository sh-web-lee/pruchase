...
if (empty($_GET['ref'])) $_GET['ref'] = 'esaff_asc14_2020specialsale';

if ($_GET['action'] == 'getPacks') {
  $date = $_GET['d'];
  $c_name = 'esascapraff_p' . $date;
  $c_name_t='esascapraff_t' . $date;
  ...
  <div class="wrapper">
    ...
    <div class="content clearfix">
      ...
      <div class="message fr">
        ...
        <!-- buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=esaff-asc143pciu1799&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>"
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'esaffasc142020specialsale');">
