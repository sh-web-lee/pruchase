...
if (empty($_GET['ref'])) $_GET['ref'] = 'esaff_asc13_2020install';
      ...
      <div class="heading-info">
        ...
        <div class="price-zone clearfix">
          ...
          <a class="button btn-orange large"
             href="https://www.iobit.com/buy.php?product=esaff-asc131pc1499&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" 
             onclick="ga('send', 'event', 'ascbuy', 'buy', 'esaffasc132020install');">
            Comprar Ahora
          </a>
        </div>
      </div>
    ...
    <div class="container">
      <div class="compare">
        <table border="0" cellspacing="0" cellpadding="0" width="100%" class="comparetab">
          ...
          <tbody>
            <tr><td colspan="4" class="mid-header">Limpia y optimiza el rendimiento de PC</td></tr>
            <tr>
            ...
            <tr><td colspan="4" class="mid-header">Aumenta la velocidad de PC</td></tr>
            <tr>
              <td class="icon">
                <img src="https://www.iobit.com/tpl/images/comparison/speedup/sp_startup.png" alt="">
              </td>
              <td class="describe"> Encendido hasta un <strong>200%</strong> más rápido <i class="tags improved"></i></td>
              <td class="itempro"><i class="fa fa-check"></i></td>
            </tr>
            <tr>
              <td class="icon">
              ...
              <td class="describe"> Encendido hasta un <strong>300%</strong> de velocidad Web </td>
              <td class="itempro"><i class="fa fa-check"></i></td>
            </tr>
            <tr><td colspan="4" class="mid-header">Garantizar la seguridad del PC y la privacidad</td></tr>
            <tr>
              <td class="icon">
            ...
            <tr><td colspan="4" class="mid-header">Servicio óptimo de IObit</td></tr>
            <tr>
              <td class="icon">
