...
$ref1pc='esaff_asc14_2021buy1pc';
$ref3pc='esaff_asc14_2021buy3pc';
if(!empty($_GET['ref'])){
  ...
  <div class="offer clearfix">
    ...
    <div class="box pc">
      ...
      <div class="price">
        ...
        <!-- 1pc buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=esaff-asc141pc1499&ref=esaff_asc14_2021buy1pc&aff=<?php echo $_GET['aff']?>"
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'esaffasc142021buy1pc')">
          Añadir a la cesta
        </a>
      </div>
    </div>
    ...
    <div class="box pcs">
      ...
      <div class="price">
        ...
        <!-- 3pc buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=esaff-asc143pc1799&ref=esaff_asc14_2021buy3pc&aff=<?php echo $_GET['aff']?>"
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'esaffasc142021buy3pc')">
          Añadir a la cesta
        </a>
