...
if (empty($_GET['ref'])) $_GET['ref'] = 'esaff_ascu13_2020specialsale';
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<div class="banner">
  <div class="wrapper clearfix">
    ...
    <h1>La Mejor Oferta para El Año Nuevo</h1>
    <div class="banlist">
      <img src="<?php echo getStaticUrl('images/asc-box.png')?>" alt=""/>
      <div class="price">
        <p><strong><big>22</big>,95€</strong>  <del>49,99€</del></p>
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=esaff-ascu133pc2295&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>"
           onclick="ga('send', 'event', 'ascubuy', 'buy', 'esaffascu132020specialsale')">
          COMPRAR AHORA 
        </a>
      </div>
      <ul class="txtlist">
    ...
    <div class="banlist big">
      ...
      <div class="price">
        ...
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=esaff-ascu133pcsdpfamc2295&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>"
           onclick="ga('send', 'event', 'ascubuy', 'buy', 'esaffascu132020specialsale')">
          COMPRAR AHORA
        </a>
      </div>
