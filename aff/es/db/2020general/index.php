<?php
header("location:../2017general/index.php" . (empty($_SERVER['QUERY_STRING']) ? '' : ('?' . $_SERVER['QUERY_STRING'])));
exit();
error_reporting(0);
define("IObit", "IObit");
if (@!$include) {
...
$buyLink = "https://www.iobit.com/buy.php?product=esaff-db63pc1499&ref=" . (empty($_GET['ref']) ? 'esaff_db6_2020general' : $_GET['ref']) . "&aff=" . $affStr;
$refStr = $_GET['ref'];
  ...
  <div class="banner">
    <div class="wrapper">
      ...
      <ul class="btnbox clearfix">
        <li class="first">
          <a class="btn down" href="./download.php?ref=<?php echo (empty($_GET['ref'])?'esdb6g':$_GET['ref']);?>&aff=<?php echo $_GET['aff'];?>" onclick="ga('send', 'event', 'dbdl', 'download', 'esdb6g')" data-text="Free Download">
            <span>Descarga gratis</span>
            <i class="all-icons"></i>
          </a>
        </li>
        <li>
          <a class="btn buy" href="<?php echo $buyLink;?>" onclick="ga('send', 'event', 'dbbuy', 'buy', 'esaffdb62020general')  ;dlCount()" data-text="Compra ahora y ahorra un 50% >>">
  ...
  <div class="container">
    ...
    <div class="feature">
      <div class="wrapper clearfix">
        <div class="text">
          <h2>Soporte de actualización de más de 3.000.000 de controladores de dispositivo</h2>
          <span></span>
          <p>
            Obtén automáticamente los controladores y actualizaciones recomendadas para tu hardware con Driver Booster PRO. Al admitir más de 3.000.000 de controladores de dispositivo, Driver Booster PRO puede solucionar problemas de controladores faltantes / defectuosos / obsoletos para ayudarte a reducir la congelación y el bloqueo del sistema.
          </p>
        </div>
    ...
    <div class="feature gray">
      <div class="wrapper clearfix">
        ...
        <div class="text">
          ...
          <span></span>
          <p>
            Al eliminar archivos inútiles en el paquete de instalación y comprimirlo claramente, Driver Booster 6 te ayuda a ahorrar tiempo en la actualización de controladores. Driver Booster PRO también ofrece una velocidad de descarga más rápida y permite la descarga e instalación durante el tiempo de inactividad del sistema para que los usuarios puedan concentrarse en sus cosas evitando molestias innecesarias.
          </p>
        </div>
      </div>
    </div>
