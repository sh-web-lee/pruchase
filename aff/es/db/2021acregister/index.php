...
if (empty($_GET['ref'])) $_GET['ref'] = 'esaff_db8_2021acregister';
...
<div class="banner">
  <div class="wrapper">
    <a class="logo" href="https://it/www.iobit.com" target="_blank">
    ...
    <div class="pricebox">
      <dl class="price">
        <dt>Sólo <strong>11,99€  </strong><del>79,93€</del></dt>
        <dd>
          <a class="buybtn bigbtn"
             href="https://www.iobit.com/buy.php?product=esaff-db8-ac&ref=<?php echo $_GET['ref']?>&aff=<?php echo $_GET['aff']; ?>"
             onclick="ga('send', 'event', 'dbbuy', 'buy', 'esaffdb82021acregister');">
            <div class="inner">
              <i class="all-icons"></i>
  ...
  <div class="clearfix">
    <dl>
      ...
      <dd>
        ...
        <p>Detecta y actualiza más de 3,500,000 drivers con 1 solo clic, mejorando así la estabilidad y el rendimiento del sistema.</p>
      </dd>
    </dl>
    <dl class="right">
