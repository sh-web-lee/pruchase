...
if (empty($_GET['ref'])) $_GET['ref'] = 'esaff_db8_2021trialendsale';
          ...
          <div class="curvebox">
            ...
            <span class="four">
					...
					<ul class="price clearfix">
						...
						<li class="last">
							<a class="buybtn" 
							   href="https://www.iobit.com/buy.php?product=esaff-db83pc1799&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']?>"
							   onclick="ga('send', 'event', 'dbbuy', 'buy', 'esaffdb82021trialendsale')">
