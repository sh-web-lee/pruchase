...
if (empty($_GET['ref'])) $_GET['ref'] = 'esaff_db7_2020specialsale'; 
...
<div class="banner">
  ...
  <div class="wrapper">
    ...
    <dl class="price">
      ...
      <dd>
        <a href="https://www.iobit.com/buy.php?product=esaff-db73pcsdpfiu1999&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" onclick="ga('send', 'event', 'dbbuy', 'buy', 'esaffdb72020specialsale')" class="buybtn">Comprar ahora</a>
      </dd>
...
<div class="comparison-table" id="compare">
  <table border="0" cellspacing="0" cellpadding="0" width="100%">
    <thead>
    <tr>
      <th colspan="2">Vea por qué Driver Booster PRO es necesario para tu PC</th>
      <th class="space"></th>
