...
if (empty($_GET['ref'])) $_GET['ref'] = 'esaff_iu9_2020xmasale';
?>
<!DOCTYPE html>
<html lang="es">
<head>
  ...
  <title>Hasta 84% de descuento y regalos gratis en IObit Uninstaller Pro. Oferta especial de Navidad – IObit</title>
...
<div class="banner">
  ...
  <div class="wrapper">
    ...
    <!-- title -->
    <h1>Feliz Navidad REBAJA Hasta -84%</h1>
    <div class="box">
      <dl>
        <dt><del>19,99€</del></dt>
        <dd>
      ...
      <!-- 1pc buybtn -->
      <a href="https://www.iobit.com/buy.php?product=esaff-iu91pc1299&ref=<?php echo $_GET['ref']?>&aff=<?php echo $_GET['aff']?>"
         onclick="ga('send', 'event', 'iubuy', 'buy', 'esaffiu92020xmasale')"
         class="buybtn small">
        Comprar ahora
      </a>
    </div>
    <div class="box gift-box">
      ...
      <!-- 3pc buybtn -->
      <a href="https://www.iobit.com/buy.php?product=esaff-iu93pcpfamc1599&ref=<?php echo $_GET['ref']?>&aff=<?php echo $_GET['aff']?>"
         onclick="ga('send', 'event', 'iubuy', 'buy', 'esaffiu92020xmasale')"
         class="buybtn">
        Comprar ahora
      </a>
