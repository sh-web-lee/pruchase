...
if (empty($_GET['ref'])) $_GET['ref'] = 'esaff_iu9_2020flashsale';
  ...
  <div class="wrapper clearfix">
    ...
    <div class="box">
      ...
      <div class="message">
        ...
        <!-- buybtn -->
        <a href="https://www.iobit.com/buy.php?product=esaff-iu93pcpf1599&ref=<?php echo $_GET['ref']?>&aff=<?php echo $_GET['aff']?>"
           onclick="ga('send', 'event', 'iubuy', 'buy', 'esaffiu92020flashsale')"
           class="buybtn">
          Comprar ahora
        </a>
      </div>
...
<div class="betweenbuy clearfix">
  ...
  <div class="wrapper">
    ...
    <!-- buybtn -->
    <a class="buybtn"
       href="https://www.iobit.com/buy.php?product=esaff-iu93pcpf1599&ref=<?php echo $_GET['ref']?>&aff=<?php echo $_GET['aff']?>"
       onclick="ga('send', 'event', 'iubuy', 'buy', 'esaffiu92020flashsale')">
