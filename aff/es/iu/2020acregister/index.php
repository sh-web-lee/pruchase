...
if (empty($_GET['ref'])) $_GET['ref'] = 'esaff_iu9_2020acregister';
...
<div id="main" class="wrapper">
	<div class="intro">
		...
		<div class="discount">
			...
			<dl>
				...
				<dd><a href="https://www.iobit.com/buy.php?product=esaff-iu9-acak&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" title="CHECKOUT" onclick="ga('send', 'event', 'iubuy', 'buy', 'esaffiu92020acregister')" class="checkbtn">Comprar ahora >></a></dd>
		...
		<div class="leftbox">
			...
			<ul>
				...
				<li>
					...
					Desinstala programas obstinados y plugins maliciosos y publicitarios para garantizar una experiencia de navegación segura y limpia.
				</li>
				<li>
	...
	<div class="checkout">
		<div class="moneyback">
				Usted está totalmente protegido por nuestra 100% garantía de reembolso y verá una mejora significativa en el rendimiento de PC DENTRO DE 60 DÍAS , o le enviaremos un reembolso completo. Sin preguntas hechas. <a href="https://www.iobit.com/buy.php?product=esaff-iu9-acak&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" title="CHECKOUT" onclick="ga('send', 'event', 'iubuy', 'buy', 'esaffiu92020acregister')">Comprar ahora</a>
			</div>
			<div class="btn">
				<a href="https://www.iobit.com/buy.php?product=esaff-iu9-acak&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" title="CHECKOUT" onclick="ga('send', 'event', 'iubuy', 'buy', 'esaffiu92020acregister')" class="checkbtn">Comprar ahora >></a>
