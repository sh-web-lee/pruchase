...
if (empty($_GET['ref'])) $_GET['ref'] = 'ptaff_sd6_2021acregister';
?>
<!DOCTYPE html>
<html lang="pt">
<head>
	...
	<div class="wrapper">
        ...
        <div class="intro">
            ...
            <div class="discount">
                ...
                <div class="wprice">APENAS <em>R$ 29.99</em> <del>R$199.93 </del><span>1 Ano de Assinatura / 1 PC</span></div>
                <div class="btnarea">
                    <a href="https://www.iobit.com/buy.php?product=ptaff-sd61pc2999&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" onclick="ga('send', 'event', 'sdbuy', 'buy', 'ptaffsd62021acregister');" class="checkbtn">Compre Agora >></a>
