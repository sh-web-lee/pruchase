<?php
   ...
   if (empty($_GET['ref'])) $_GET['ref'] = 'ptaff_sd6_2020acregister';
if($_GET['to']=='db_ac_sd'){
    $refStr.='-'.$_GET['to'];
}
...
<title>85% de desconto no Smart Defrag 6 PRO. Oferta Limitada da IObit.</title>
	...
	<div class="wrapper">
        ...
        <div class="intro">
            ...
            <div class="discount">
                ...
                <div class="wprice">APENAS <em>R$ 29,99</em> <del>R$ 199,93</del><br><span>1 Ano de Assinatura / 1 PC</span></div>
                <div class="btnarea">
                    <a href="https://www.iobit.com/buy.php?product=ptaff-sd6-acak&ref=<?php echo $_GET['ref']; ?><?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>" onclick="ga('send', 'event', 'sdbuy', 'buy', 'ptaffsd62020acregister');" class="checkbtn">Compre Agora >></a>
