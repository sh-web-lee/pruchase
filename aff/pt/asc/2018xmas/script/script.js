...
function firstShow() {
  ...
  $('.main').append('<div class="mask"></div><div class="mask-box"><h2>Presentão de Natal </h2><div class="clearfix"><div class="fl left"><img src="' + imgSrc + '" alt="Advanced SystemCare 12 Pro"/></div><div class="price fl"><h3><b>R$ 5</b> extra de desconto pra você!</h3><p>Apenas <strong><big>  R$</big>59<big>,99</big></strong>  1 ano / 3 PCs</p> <a class="buybtn" href="' + _href + '" onclick="' + _ga + '">Ativar Agora</a></div></div><p class="year"> Sua última chance para aproveitar o preço mais baixo da história! </p></div>');
}
...
function packsInit() {
  ...
  packs = Math.ceil(timeDiff / 5.2) > 0 ? Math.ceil(timeDiff / 5.2) : 0;
  reduceNum(packs, 1);
...
function getSales() {
  ...
  var nowTime = Math.floor(date.getTime() / 1000);
  var timeDiff = countTime - nowTime;
  var packsNow = Math.ceil(timeDiff / 5.2) > 0 ? Math.ceil(timeDiff / 5.2) : 0;
  if (packsNow != packs) {
    if (statusCheck() == 2) {
      packs = 0;
    } else {
