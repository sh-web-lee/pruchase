...
$ref1pc='ptaff_asc12_2019buy1pc';
$ref3pc='ptaff_asc12_2019buy3pc';
if(!empty($_GET['ref'])){
  ...
  <div class="offer clearfix">
    ...
    <div class="box pc">
      ...
      <div class="price">
        ...
        <!-- 1pc buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=ptaff-asc121pc5499&ref=ptaff_asc12_2019buy1pc&aff=<?php echo $_GET['aff']?>"
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'ptaffasc122019buy1pc')">
    ...
    <div class="box pcs">
      ...
      <div class="price">
        ...
        <!-- 3pc buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=ptaff-asc123pc7699&ref=ptaff_asc12_2019buy3pc&aff=<?php echo $_GET['aff']?>"
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'ptaffasc122019buy3pc')">
          Adicionar para o Carrinho
        </a>
