...
<title>Obrigado por instalar Advanced SystemCare 14 - IObit</title>
  ...
  <div class="pagebanner">
    <div class="container comp-heading clearfix">
      ...
      <div class="heading-info">
        ...
        <h3>Obrigado por Instalar Advanced SystemCare Pro!  <br>Obtenha a versão PRO para um PC mais Limpo, Rápido e Seguro</h3>
        <p>
        ...
        <div class="price-zone clearfix">
          ...
          <a class="button btn-orange large"
             href="https://www.iobit.com/buy.php?product=ptaff-asc141pc5499&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" 
             onclick="ga('send', 'event', 'ascbuy', 'buy', 'ptaffasc142021install');">
            Comprar Agora
          </a>
        </div>
      </div>
      ...
      <div class="compare">
        <table border="0" cellspacing="0" cellpadding="0" width="100%" class="comparetab">
          ...
          <tbody>
							...
							<td class="describe">1-clique para corrigir erros de disco para um sistema de PC mais eficiente e estável <i class="tags new"></i></td>
							...
							<td class="describe">Modo AI para limpeza e otimização total do PC <i class="tags improved"></i></td>
							<td class="itempro"><i class="fa fa-check" aria-hidden="true"></i></td>
						</tr>
												<tr>
							<td class="icon">
							...
							<td class="describe">Limpeza profunda do registro para prevenir erros e travamentos  <i class="tags improved"></i>
              </td><td class="itempro"><i class="fa fa-check" aria-hidden="true"></i></td>
						</tr>
												<tr>
							<td class="icon">
							...
							<td class="describe">Inicialização do PC até 200% mais Rápida <i class="tags improved"></i></td>
							<td class="itempro"><i class="fa fa-check" aria-hidden="true"></i></td>
						</tr>
												<tr>
							<td class="icon">
							...
							<td class="describe">Proteção Básica do PC com remoção de spyware </td>
							...
							<td class="describe">Bloqueia links maliciosos e remetentes suspeitos em e-mails </td>
							...
							<td class="describe">Proteção de navegação premium com limpeza automática de rastros de navegação <i class="tags improved"></i></td>
							<td class="itempro"><i class="fa fa-check" aria-hidden="true"></i></td>
						</tr>
												<tr>
							<td class="icon">
							...
							<td class="describe">Detecta e ativa ambos antivírus e firewall para proteção dupla <i class="tags new"></i></td>
