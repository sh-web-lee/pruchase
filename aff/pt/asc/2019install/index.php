<?php  
  ...
  if (empty($_GET['ref'])) $_GET['ref'] = 'ptaff_asc12_2019install';
...
<head>
	...
	<title>Obrigado por instalar Advanced SystemCare 12- IObit</title>
...
<body class="compare" id="compare">
	...
	<div class="pagebanner">
		<div class="container comp-heading clearfix">
			...
			<div class="heading-info">
				...
				<p>Com todas as funções destravadas, Advanced SystemCare PRO aumenta poderosamente o desempenho de seu computador. A limpeza profunda de registro e limpeza automática de RAM libera espaço em disco e garante um PC estável. Além disso, as funções anti-rastreamento do navegador e escudo de privacidade garantem sua privacidade online. A aceleração de internet otimizada acelera sua conexão de internet em até 300%. Para mais informações sobre a edição PRO, veja a tabela abaixo.</p>
				<div class="price-zone clearfix">
					<div class="price">Apenas <strong>R$ 59,99</strong> <del>R$ 199,90</del></div>
					<a href="https://www.iobit.com/buy.php?product=ptaff-asc123pc5999&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ptaffasc122019install')" class="button btn-orange large">Comprar Agora</a>
			</div>
			</div>
		</div>
	</div>
					...
					<thead>
						<tr>
							...
							<td class="itempro">
								...
								<a href="https://www.iobit.com/buy.php?product=ptaff-asc123pc5999&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ptaffasc122019install')" class="button btn-orange small">COMPRAR AGORA <small>(Apenas R$ 59,99)</small></a>
								<small>1 Ano de Assinatura / 3 PCs</small>
							</td>
						</tr>
					</thead>
					<tbody>
						<tr>
							<td colspan="4" class="mid-header">Limpa e Otimiza o Desempenho do PC </td>
						</tr>
						<tr>
							<td class="icon">
						...
						<tr>
							...
							<td class="describe">Desfragmenta dados do disco rígido para otimizar o desempenho do disco <i class="tags improved"></i></td>
							<td class="itempro"><i class="fa fa-check"></i></td>
						</tr>
						<tr>
							<td class="icon">
							...
							<td class="describe">Sistema mais Rápido com Limpeza Automática de RAM <i class="tags improved"></i></td>
							<td class="itempro"><i class="fa fa-check"></i></td>
						</tr>
						<tr>
							<td class="icon">
						...
						<tr>
							...
							<td class="describe">Monitora a condição do sistema em tempo real  <i class="tags improved"></i></td>
							<td class="itempro"><i class="fa fa-check"></i></td>
						</tr>
							<tr>
							<td colspan="4" class="mid-header">Acelera a Velocidade do PC </td>
						</tr>
							<tr>
							<td class="icon">
								<img src="https://www.iobit.com/tpl/images/comparison/speedup/sp_startup.png" alt="">
							</td>
							<td class="describe">Inicialização do PC até 200% mais Rápida </td>
							<td class="itempro"><i class="fa fa-check"></i></td>
						</tr>
						<tr>
							<td class="icon">
							...
							<td class="describe">Navegação na Internet até 300% mais Rápida com "Acelerar Internet" </td>
							<td class="itempro"><i class="fa fa-check"></i></td>
						</tr>
						<tr>
							<td colspan="4" class="mid-header">Garante a Segurança do PC </td>
						</tr>
						<tr>
							<td class="icon">
						...
						<tr>
							...
							<td class="describe">Captura intrusos automaticamente com FaceID <i class="tags improved"></i></td>
							<td class="itempro"><i class="fa fa-check"></i></td>
						</tr>
						<tr>
							<td class="icon">
						...
						<tr>
							...
							<td class="describe">Esconde a assinatura digital para manter sua vida online privada <i class="tags new"></i></td>
							<td class="itempro"><i class="fa fa-check"></i></td>
						</tr>
						<tr>
							<td class="icon">
							...
							<td class="describe">Mantém seus dados pessoais livres de programas não-confiáveis <i class="tags new"></i></td>
							<td class="itempro"><i class="fa fa-check"></i></td>
						</tr>
						<tr>
							<td class="icon">
							...
							<td class="describe">Detecta e bloqueia falhas de segurança ativamente </td>
							<td class="itempro"><i class="fa fa-check"></i></td>
						</tr>
						<tr>
	...
	<div class="btmarea compare clearfix">
		<div class="container">
			<h2>Compre PRO para ter o PC Novamente Rodando como Novo</h2>
			<div class="price-zone clearfix" style="width: 312px;">
				<dl>
					<dt><span>Apenas <strong>R$ 59,99</strong> <del>R$ 199,90</del></span></dt>
					<dd><a href="https://www.iobit.com/buy.php?product=ptaff-asc123pc5999&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ptaffasc122019install')" class="button btn-orange large">Comprar Agora</a></dd>
	...
	<div class="footer clearfix">
		<div class="container">
			<div class="bottom clearfix">
				<p class="copy" style="padding: 0; width: 100%; text-align: center;"> &copy; 2005 - <?php echo date('Y')?> IObit. Todos os Direitos Reservados </p>
			</div>
		</div>
	</div>
	<!-- end footer -->
