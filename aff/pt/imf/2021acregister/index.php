...
if (empty($_GET['ref'])) $_GET['ref'] = 'ptaff_imf8_2021acregister';
?>
<!DOCTYPE html>
<html lang="pt">
<head>
    ...
    <div class="wrapper">
        ...
        <div class="intro">
            ...
            <div class="discount">
                ...
                <div class="btnarea">
                    <a href="https://www.iobit.com/buy.php?product=ptaff-imf81pc4999&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" onclick="ga('send', 'event', 'imfbuy', 'buy', 'ptaffimf82021acregister');" class="checkbtn">Compre Agora >></a>
