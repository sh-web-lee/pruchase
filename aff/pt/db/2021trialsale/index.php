...
if (empty($_GET['ref'])) $_GET['ref'] = 'ptaff_db8_2021trialsale';
	  ...
	  <div class="wrapper">
	    ...
	    <div class="panel clearfix">
	      ...
	      <div class="right fr">
	        ...
	        <span class="line"></span>
	        <a class="buybtn" 
	           href="https://www.iobit.com/buy.php?product=ptaff-db83pc7999&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff'];?>"
	           onclick="ga('send', 'event', 'dbbuy', 'buy', 'ptaffdb82021trialsale')">
