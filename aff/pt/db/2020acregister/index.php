...
if (empty($_GET['ref'])) $_GET['ref'] = 'ptaff_db7_2020acregister';
...
<div class="banner">
  <div class="wrapper">
    ...
    <div class="pricebox">
      <dl class="price">
        <dt>APENAS: <strong>R$ 49,99 </strong><del>R$ 333,27</del></dt>
        <dd>
          <a class="buybtn bigbtn"
             href="https://www.iobit.com/buy.php?product=ptaff-db7-ac&ref=<?php echo $_GET['ref']?>&aff=<?php echo $_GET['aff']?>"
             onclick="ga('send', 'event', 'dbbuy', 'buy', 'ptaffdb72020acregister');">
            <div class="inner">
              <i class="all-icons"></i>
  ...
  <div class="clearfix">
    <dl>
      ...
      <dd>
        ...
        <p>Detecta e atualiza mais de 3.500.000 drivers com 1-clique para aumentar o desempenho e estabilidade de seu computador.</p>
      </dd>
    </dl>
    <dl class="right">
...
<div class="floatlayer" id="floatlayer">
  <div class="wrapper clearfix">
    ...
    <div class="pricebox">
      <dl class="price fr">
        <dt><strong>R$ 49,99 </strong><del>R$ 333,27</del></dt>
        <dd>
