...
if (empty($_GET['ref'])) $_GET['ref'] = 'ptaff_iu10_2021acregister';
?>
<!DOCTYPE html>
<html lang="pt">
<head>
...
<div id="main" class="wrapper">
	<div class="intro">
		...
		<div class="discount">
			...
			<dl>
				...
				<dd>
					<a class="checkbtn" href="https://www.iobit.com/buy.php?product=ptaff-iu101pc2999&ref=<?php echo $_GET['ref']?>&aff=<?php echo $_GET['aff']?>" title="CHECKOUT" onclick="ga('send', 'event', 'iubuy', 'buy', 'ptaffiu102021acregister');">
						Compre Agora >>
					</a>
				</dd>
	...
	<div class="checkout">
		<div class="moneyback">
				Você está totalmente protegido pela nossa garantia de reembolso 100% e você VAI ver uma melhora significativa no desempenho do seu PC DENTRO DE 60 DIAS ou devolveremos todo seu dinheiro. Sem perguntas. <a href="https://www.iobit.com/buy.php?product=ptaff-iu101pc2999&ref=<?php echo $_GET['ref']?>&aff=<?php echo $_GET['aff']?>" title="CHECKOUT" onclick="ga('send', 'event', 'iubuy', 'buy', 'ptaffiu102021acregister');"> Compre agora</a>
			</div>
			<div class="btn">
				<a href="https://www.iobit.com/buy.php?product=ptaff-iu101pc2999&ref=<?php echo $_GET['ref']?>&aff=<?php echo $_GET['aff']?>" title="CHECKOUT" onclick="ga('send', 'event', 'iubuy', 'buy', 'ptaffiu102021acregister');" class="checkbtn">
					Compre Agora >>
				</a>
