...
var pcgab = "ga('send', 'event', 'ascbuy', 'buy', 'jpaffasc142021buy1pcoff');";
var pcsgab = "ga('send', 'event', 'ascbuy', 'buy', 'jpaffasc142021buy3pcoff');";
var pcgabc = "ga('send', 'event', 'ascbuy', 'buy', 'jpaffasc142021buy1pc');";
var pcsgabc = "ga('send', 'event', 'ascbuy', 'buy', 'jpaffasc142021buy3pc');";
...
function planB() {
  ...
  $("h2.title").removeClass("planc").addClass("planb").html("割引が適用されました。 今なら<b>あなただけのエクストラ25％オフ</b>をお楽しみください！" +
    "<span id='countdown2' class='countdown'><i></i> 終了まで " +
    "<strong>00</strong>M: " +
    "<strong>00</strong>S: " +
    "<strong class='last'>000</strong>ms*</span>");
  $(".offer .price").addClass("priceb");
  $(".offer .pc").find(".price").html('<p><span>原価</span><span>販売価格</span><b>追加25％オフ後</b></p><p><del>4,470円</del><del class="center">2,235円</del><strong>1,676円</strong></p><a class="buybtn" href="https://www.iobit.com/buy.php?product=jpaff-asc141pc1676&ref=jpaff_asc14_2021buy1pcoff&aff=' + aff + '&tw=-8" onclick="' + pcgab + '">今すぐ購入</a><h5> 割引： 2,794円</h5>');
  $(".offer .pcs").find(".price").html('<p><span><b>原価</b></span><span><b>販売価格 </b></span><b>追加25％オフ後</b></p><p><del>7,450円</del><del class="center">2,980円</del><strong>2,235円</strong></p><a class="buybtn" href="https://www.iobit.com/buy.php?product=jpaff-asc143pc2235&ref=jpaff_asc14_2021buy3pcoff&aff=' + aff + '&tw=-8" onclick="' + pcsgab + '">今すぐ購入</a><h5> 割引： 5,215円 </h5>');
  reBuyLink();
}
...
function planC() {
  ...
  $("h2.title").removeClass("planb").addClass("planc").html("おっと！ クーポンの有効期限が切れました。");
  $(".offer .price").removeClass("priceb").addClass("pricec");
  $(".offer .pc").find(".price").html('<dl class="clearfix"><dd>追加25％オフ後 <del>1,676円</del></dd><dd class="nowsaleprice">販売価格 <strong>2,235円</strong></dd><dt></dt></dl><a class="buybtn" href="https://www.iobit.com/buy.php?product=jpaff-asc141pc2235&ref=jpaff_asc14_2021buy1pc&aff=' + aff + '&tw=-8" onclick="' + pcgabc + '">今すぐ購入</a>');
  $(".offer .pcs").find(".price").html('<dl class="clearfix"><dd>追加25％オフ後 <del>2,235円</del></dd><dd class="nowsaleprice">販売価格 <strong>2,980円</strong></dd><dt></dt></dl><a class="buybtn" href="https://www.iobit.com/buy.php?product=jpaff-asc143pc2980&ref=jpaff_asc14_2021buy3pc&aff=' + aff + '&tw=-8" onclick="' + pcsgabc + '">今すぐ購入</a>');
  reBuyLink();
}
...
function maskB() {
  ...
  $(".mask-planb").html("<h2>おめでとうございます！</h2><p>あなたは今日のラッキービジターです！<b>さらに期間限定の25％割引</b>がもたらします。</p><img class='off' src='" + imgSrc + "'><div class='buybox'><a class='buybtn' href='javascript: void(0);' onclick='maskCount(1);cycleCountdown(2);'>今すぐ割引を適用する</a><p onclick='maskClose()'>いいえ、全額を支払いたいです</p></div>");
