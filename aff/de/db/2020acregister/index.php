...
if (empty($_GET['ref'])) $_GET['ref'] = 'deaff_db7_2020acregister';
...
<div class="banner">
  <div class="wrapper">
    ...
    <div class="pricebox">
      <dl class="price">
        <dt>NUR: <strong>13,49€</strong> <del>89,93€</del></dt>
        <dd>
          <a class="buybtn bigbtn"
             href="https://www.iobit.com/buy.php?product=deaff-db7-ac&ref=<?php echo $_GET['ref']?>&aff=<?php echo $_GET['aff']?>"
             onclick="ga('send', 'event', 'dbbuy', 'buy', 'deaffdb72020acregister');">
            <div class="inner">
              <i class="all-icons"></i>
  ...
  <div class="clearfix">
    <dl>
      ...
      <dd>
        ...
        <p>Erfasst & updatet über 3.500.000 Treiber mit 1-Klick, was die Stabilität und Performance Ihres Computers verbessert.</p>
      </dd>
    </dl>
    <dl class="right">
