...
$refStr=empty($_GET['ref'])?'deaff_db5_2018summersale':$_GET['ref'];
$affStr=$_GET['aff'];
?>
<!DOCTYPE html>
<html lang="de">
...
<title>Spare 85% auf Driver Booster 5 PRO &amp; erhalte ein tolles Geschenk gratis!</title>
...
<!--  end -->
  ...
  <div class="banner">
    <div class="wrapper">
      ...
      <div class="clearfix">
        <div class="left fl">
          <h2>Mehr als <b class="off">156,75€</b> <span><strong class="percent">85%</strong> reduziert !</span></h2>
          <div class="boxpc">
        ...
        <div class="right fr">
          ...
          <h4>Spare bis zu 156,75€ auf Driver Booster 5 Pro &amp; erhalte ein Produkt gratis! </h4>
          <div class="choice">
            <div class="list pcs active" data-url="https://www.iobit.com/buy.php?product=deaffdb53pcpf2699&ref=<?php echo $refStr;?>&aff=<?php echo $affStr;?>&refs=de_purchase_db" data-off="156,75€" data-percent="85%">
              <div class="fl">
                <h3>Driver Booster PRO</h3>
                <b>3PCs, 1 Jahr</b>
                <p><i class="all-icons"></i>Protected Folder  <b>GRATIS</b></p>
              </div>
              <div class="fr"><strong class="original">26,99€ </strong> <del class="discount">183,74€</del></div>
            </div>
            <div class="list pc" data-url="https://www.iobit.com/buy.php?product=deaffdb51pc2499&ref=<?php echo $refStr;?>&aff=<?php echo $affStr;?>&refs=de_purchase_db" data-off="45€" data-percent="60%">
              <div class="fl">
                <h3>Driver Booster PRO</h3>
                <b>1PC, 1 Jahr  </b>
              </div>
              <div class="fr"><strong class="original">24,99€ </strong> <del class="discount">69,99€</del></div>
            </div>
          </div>
          <a class="buybtn" 
             href="https://www.iobit.com/buy.php?product=deaffdb53pcpf2699&ref=<?php echo $refStr;?>&aff=<?php echo $affStr;?>&refs=de_purchase_db"
             onclick="ga('send', 'event', 'dbbuy', 'buy', 'deaffdb52018summersale')">
            JETZT KAUFEN
          </a>
          <p>
            <i class="all-icons"></i>
  ...
  <div class="cause">
    <div class="wrapper">
      ...
      <p>
        Denn wird dein PC bis zu 200% schneller als bisher laufen,  Driver Booster hält die Gerätetreiber <span>immer auf dem neuesten Stand und verbessert die Stabilität der PC -Performance, mit der</span> bewährten Treiberaktualisierung und Sicherheitstechnik.
      </p>
    ...
    <div class="clearfix panel">
      <div class="fl">
        <div class="list one">
          ...
          <dl>
            <dt><h3>Spiel-Komponenten-Datenbank</h3></dt>
            <dd>Einschließlich VC Runtime 2008, VC Runtime 2010 und VC Runtime 2012, VC Runtime 2013</dd>
          </dl>
        </div>
        <div class="list">
          <img src="<?php echo getStaticUrl('images/list02.png')?>" alt="" />
          <dl>
            <dt><h3>100% Sicher</h3></dt>
            <dd>Alle Treiber aus Driver Booster 5 haben die WHQL-Tests bestanden</dd>
          </dl>
        </div>
      </div>
      <div class="fr">
        <div class="list one">
          ...
          <dl>
            <dt><h3>Größere Datenbank</h3></dt>
            <dd>Unterstützung für über 1.000.000 Treiber,und erkennt fehlende und fehlerhafte Treiber</dd>
          </dl>
        </div>
        <div class="list">
          <img src="<?php echo getStaticUrl('images/list04.png')?>" alt="" />
          <dl>
            <dt><h3>Auto-Backup-Funktion</h3></dt>
            <dd>Hilft bei der Wiederherstellung unerwünschter Treiber-Updates jederzeit!</dd>
          </dl>
        </div>
      </div>
    </div>
  ...
  <div class="centbuy">
    <div class="wrapper">
      <h2>Spare bis zu 85% Rabatt auf Driver Booster PRO heute,</h2>
      ...
      <div class="clearfix">
        ...
        <div class="smchoice fl">
          ...
          <div class="list pc">
            <h3>1PC <b>45€ sparen</b></h3>
          </div>
        </div>
        <div class="price fr">
          <strong class="original">26,99€ </strong> <del class="discount">183,74€</del>
          <a class="buybtn" 
             href="https://www.iobit.com/buy.php?product=deaffdb53pcpf2699&ref=<?php echo $refStr;?>&aff=<?php echo $affStr;?>&refs=de_purchase_db"
             onclick="ga('send', 'event', 'dbbuy', 'buy', 'deaffdb52018summersale')">
            JETZT KAUFEN
  ...
  <div class="describe">
    <div class="wrapper">
      ...
      <ul>
        ...
        <li><i class="all-icons"></i>frustriert mit Zeitverschwendung durch langsame Aktualisierungsgeschwindigkeit</li>
        <li><i class="all-icons"></i>alle Treiber Up-to-Date und meinen PC auf das höchste Leistungsniveau halten</li>
      </ul>
    </div>
  </div>
  <!-- describe end -->
  ...
  <div class="footbuy">
    <div class="wrapper clearfix">
      <div class="fl">
        <h2>Optimiere deine PC-Leistung mit den aktuellsten Treibern!</h2>
        <ul class="fchoice">
          <li class="list active"><b>1 Jahr, 3 PCs</b><span><strong>26,99€ </strong> UVP*<del>183,74€</del></span></li>
          <li class="list"><b>1 Jahr, 1 PC</b> <span><strong>24,99€ </strong> UVP*<del>69,99€</del></span></li>
        </ul>
      </div>
      <div class="fr">
        <p>Mehr als <b class="off">156,75€</b> <b class="percent">85%</b> reduziert !</p>
        <a class="buybtn" 
           href="https://www.iobit.com/buy.php?product=deaffdb53pcpf2699&ref=<?php echo $refStr;?>&aff=<?php echo $affStr;?>&refs=de_purchase_db"
           onclick="ga('send', 'event', 'dbbuy', 'buy', 'deaffdb52018summersale')">
          JETZT KAUFEN
