  ...
  <div class="banner">
    <div class="wrapper">
      ...
      <ul class="btnbox clearfix">
        ...
        <li>
          <a class="btn buy" href="https://www.iobit.com/buy.php?product=deaff-db63pc2098&ref=<?php echo $_GET['ref'];?>&aff=<?php echo $_GET['aff'];?>" onclick="ga('send', 'event', 'dbbuy', 'buy', 'deaffdb62019general')" data-text="Jetzt kaufen & 75% sparen>>">
  ...
  <div class="container">
    ...
    <div class="feature">
      <div class="wrapper clearfix">
        <div class="text">
          <h2>Unterstützt die Aktualisierung von über 3.000.000 Gerätetreibern</h2>
          <span></span>
          <p>Bekommen Sie automatisch empfohlene Treiber und Updates für ihre Hardware mit dem Driver Booster PRO. Es werden mehr als 3.000.000 Gerätetreiber unterstützt und Driver Booster PRO kann fehlende, fehlerhafte oder veraltete Treiber aktualisieren und somit das Einfrieren des Systems oder Systemabstürze reduzieren.</p>
        </div>
    ...
    <div class="feature gray">
      <div class="wrapper clearfix">
        ...
        <div class="text">
          ...
          <span></span>
          <p>Indem Driver Booster 6 nicht benötigte Dateien in Installationspaketen löscht und diese Pakete deutlich komprimiert, wird Zeit bei der Aktualisierung von Treibern gespart und ihre Routine bleibt ungestört.</p>
        </div>
      </div>
    </div>
    <!-- feature end -->
