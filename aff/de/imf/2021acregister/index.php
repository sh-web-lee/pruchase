...
if(in_array($_GET['st'],array('asc_acimf'))){
  ...
  if (empty($_GET['ref'])) $_GET['ref'] = 'deaff_imf8_2021acregister';
?>
<!DOCTYPE html>
<html lang="de">
<head>
    ...
    <div class="wrapper">
      ...
      <div class="pricebox">
        <dl class="price">
          ...
          <dd>
            <a class="buybtn bigbtn" href="https://www.iobit.com/buy.php?product=deaff-imf81pc1349&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" onclick="ga('send', 'event', 'imfbuy', 'buy', 'deaffimf82021acregister');">
              <div class="inner">
                <i class="all-icons"></i>
    ...
    <div class="wrapper clearfix">
      ...
      <div class="pricebox">
        <dl class="price fr">
          ...
          <dd>
            <a class="buybtn smallbtn" href="https://www.iobit.com/buy.php?product=deaff-imf81pc1349&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" onclick="ga('send', 'event', 'imfbuy', 'buy', 'deaffimf82021acregister');">
              <div class="inner">
                <i class="all-icons"></i>
                <span>Jetzt aktivieren</span>
              </div>
