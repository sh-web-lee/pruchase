...
if (empty($_GET['ref'])) $_GET['ref'] = 'deaff_imf7_2020acregister';
?>
<!DOCTYPE html>
<html lang="de">
<head>
...
<meta property="og:url" content="https://purchase.iobit.com/aff/de/imf/2020acregister/index.php">
...
<meta property="og:image" content="https://purchase.iobit.com/aff/de/imf/2020acregister/images/snapshot.png">
    ...
    <div class="wrapper">
      ...
      <div class="pricebox">
        <dl class="price">
          ...
          <dd>
            <a class="buybtn bigbtn" href="https://www.iobit.com/buy.php?product=deaff-imf7-ac&ref=<?php echo $_GET['ref'];?>&aff=<?php echo $_GET['aff'];?>" onclick="ga('send', 'event', 'imfbuy', 'buy', 'deaffimf72020acregister')">
              <div class="inner">
                <i class="all-icons"></i>
  ...
  <div class="feature wrapper">
    ...
    <div class="clearfix">
      <dl>
        ...
        <dd>
          <h3>Erkennt über 203.000.000 Bedrohungen</h3>
    ...
    <div class="clearfix">
      ...
      <dl class="right">
        ...
        <dd>
          <h3>Leistungsfähiger USB-Stick-Wächter</h3>
          <p>Verhindert die Bedrohungen, die sich auf einem USB-Stick verbergen und Ihren Computer beschädigen.</p>
        </dd>
      </dl>
    </div>
    <div class="clearfix">
    ...
    <div class="wrapper clearfix">
      ...
      <div class="pricebox">
        <dl class="price fr">
          ...
          <dd>
            <a class="buybtn smallbtn" href="https://www.iobit.com/buy.php?product=deaff-imf7-ac&ref=<?php echo $_GET['ref'];?>&aff=<?php echo $_GET['aff'];?>" onclick="ga('send', 'event', 'imfbuy', 'buy', 'deaffimf72020acregister')">
              <div class="inner">
                <i class="all-icons"></i>
                <span>Jetzt aktivieren</span>
              </div>
