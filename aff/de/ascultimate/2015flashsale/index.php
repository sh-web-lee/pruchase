...
ga('require', 'linker');
ga('linker:autoLink', ['cleverbridge.com', 'iobit.com']);
...
<div class="header">
    <div class="warpper">
      <div class="logo"><a href="http://www.iobit.com" class="logo" target="_blank"></a></div>
      <div class="title">Deal des Tages<span>nur solange der vorrat reicht</span></div>
      <div class="content">
          <div class="arealeft">
            <h2>Sparen Sie <span>70%</span> auf ASC & erhalten Sie das Super-Geschenke GRATIS!</h2>
            <h3>Vermissen Sie nicht die Gelegenheit! <span>Nur noch <em id="packs"><?php echo $packsNum; ?></em> erhältlich!</span></h3>
            <div class="intro"><img src="<?php echo $pResUrl; ?>img/giftpack.jpg" alt=""/></div>
          </div>
          <div class="arearight">
            <dl class="countdown">
            ...
            <dl class="checkarea clearfix">
        	    <dd class="ultimate">Ultimativer PC-Schutz</dd>
              <dd class="price">Jetzt nur <span>29,99€</span></dd>
              <dd class="old">Statt <del>109,99€</del></dd>
              <dt><a href="http://www.iobit.com/buy.php?product=de-ascupf-aff&ref=de-aff-ascu8purchase&aff=<?php echo $_GET['aff']; ?>&refs=de_purchase_ascu8aff" onclick="ga('send', 'event', 'ascubuy', 'buy', '2015flashsale-de-aff');" class="checkbtn mainbtn">JETZT AKTIVIEREN<em></em></a></dt>
              <dd class="num">Von<em><?php echo $buyNum; ?></em> Nutzern aktiviert</dd>
              <dd class="pcs">Für <span>3 PCs</span> / 1 Jahr Abo</dd>
            </dl>
          </div>
      </div>
    </div>
  ...
  <div class="warpper clearfix">
    ...
    <div class="whatdo clearfix">
      <div class="left">
        ...
        <dl>
          ...
          <dd class="edition"><a href="//www.iobit.com/de/advanced-systemcare-antivirus.php" target="_blank">Erfahren Sie mehr über Pro Edition >></a></dd>
          <dd class="sale"></dd>
        </dl>
      </div>
        <div class="right">
    ...
    <div class="cross clearfix">
      ...
      <dl class="link">
        ...
        <dd><a href="http://www.iobit.com/buy.php?product=de-ascupf-aff&ref=de-aff-ascu8purchase&aff=<?php echo $_GET['aff']; ?>&refs=de_purchase_ascu8aff" onclick="ga('send', 'event', 'ascubuy', 'buy', '2015flashsale-de-aff');" title="Purchase  Advanced SystemCare Ultimate to get Protected Folder for FREE.">JETZT AKTIVIEREN</a></dd>
      </dl>
      <dl class="right">
    ...
    <div class="comparison_table">
      <h4>Warum wählen Sie Advanced SystemCare Ultimate 8 aus?</h4>
      <div id="hidetab">
        <dl class="comtable">
        ...
        <dl class="comlist">
          ...
          <dd>Reinigung von versteckte und hartnäckige Viren, Trojaner, Würmer, Spyware, Adware und verschiedenen Malware mit nur einem Klick. Advanced SystemCare Ultimate 8 bietet auch einen always-on, automatisierten und proaktiven Schutz gegen alle Arten von Internet-Bedrohungen mit schnellen Aktualisierung der Virendatenbank.</dd>
    ...
    <div class="floatlayer" id="floatlayer">
      <dl class="left">
        <dd>Sparen Sie <span>70%</span> , genießen Sie besten Schutz und beste Leistung!</dd>
        <dt>Von<em><?php echo $buyNum; ?></em> Nutzern aktiviert</dt>
      </dl>
      <dl class="checkarea">
        <dt>Jetzt nur <span>29,99€</span></dt>
        <dd><a href="http://www.iobit.com/buy.php?product=de-ascupf-aff&ref=de-aff-ascu8purchase&aff=<?php echo $_GET['aff']; ?>&refs=de_purchase_ascu8aff" onclick="ga('send', 'event', 'ascubuy', 'buy', '2015flashsale-de-aff');" class="checkbtn floatbtn">JETZT AKTIVIEREN</a></dd>
        <dd class="countdown" id="counttime1"><span>02</span><span>02</span><span>02</span><em>222</em><sub>①</sub></dd>
      </dl>
    </div>
    <dl class="annotation">
      <dt>Note:</dt>
...
<script type="text/javascript">
  $(function () {
	...
	function cycleCountdown(){
		...
		document.getElementById('counttime').innerHTML = '<span>' + h + '</span><i>h</i><span>' + i + '</span><i>m</i><span>' + s + '</span><i>s</i><em>' + mi + '</em><sub>①</sub>';
