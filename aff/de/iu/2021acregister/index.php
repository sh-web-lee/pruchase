...
if (empty($_GET['ref'])) $_GET['ref'] = 'deaff_iu10_2021acregister';
?>
<!DOCTYPE html>
<html lang="de">
<head>
...
<title> 85% Rabatt auf IObit Uninstaller PRO</title>
...
<div id="main" class="wrapper">
	<div class="intro">
		...
		<div class="discount">
			...
			<dl>
				...
				<dd class="price">Nur <em>9.99€</em> <del>66.60€ </del> <span>für ein Jahresabo für 1 PC</span></dd>
				<dd><a href="https://www.iobit.com/buy.php?product=deaff-iu101pc999&ref=<?php echo $_GET['ref']?>&aff=<?php echo $_GET['aff']?>" title="CHECKOUT" onclick="ga('send', 'event', 'iubuy', 'buy', 'deaffiu102021acregister');" class="checkbtn">JETZT KAUFEN>></a></dd>
	...
	<div class="checkout">
		<div class="moneyback">
			Sie sind vollständig durch unsere 100%ige Geld-Zurück-Garantie geschützt und werden innerhalb von 60 Tagen eine deutliche Verbesserung Ihrer PC-Performance erleben, andernfalls bekommen Sie Ihr Geld vollständig zurück. Ohne Kompromiss. <a href="https://www.iobit.com/buy.php?product=deaff-iu101pc999&ref=<?php echo $_GET['ref']?>&aff=<?php echo $_GET['aff']?>" title="CHECKOUT" onclick="ga('send', 'event', 'iubuy', 'buy', 'deaffiu102021acregister');">Jetzt kaufen</a>
		</div>
		<div class="btn">
			<a href="https://www.iobit.com/buy.php?product=deaff-iu101pc999&ref=<?php echo $_GET['ref']?>&aff=<?php echo $_GET['aff']?>" title="CHECKOUT" onclick="ga('send', 'event', 'iubuy', 'buy', 'deaffiu102021acregister');" class="checkbtn">JETZT KAUFEN >></a>
