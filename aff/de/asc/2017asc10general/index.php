...
$buyUrl = "https://www.iobit.com/buy.php?product=deaff-asc123pc1499&ref=" . $_GET['ref'] . "&aff=" . $_GET['aff'];
  ...
  <div class="header">
    <div class="wrapper">
      ...
      <div class="btnbox">
        ...
        <a class="btn buy" href="<?= $buyUrl; ?>" onclick="ga('send', 'event', 'ascbuy', 'buy', 'deaffasc122019general')">
