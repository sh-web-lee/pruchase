...
function soldout() {
		...
		threePc();
		$(".centbuy .buybtn").attr("href", "https://www.iobit.com/buy.php?product=de-asc113pc2499_aff&ref="+refStr+"&aff="+affStr+"&refs=de_purchase_asc&tw="+tw);
		$(".centbuy .buybtn").attr("onclick", "ga('send', 'event', 'ascbuy', 'buy', 'deaffasc112018febsale')");
}
function onePc() {
		$(".footbuy dl strong b").html("22")
		$(".footbuy dl del").html("39,99€")
		$(".footbuy .left-img .box").addClass("one-pc").removeClass("three-pc");
		$(".footbuy dl .buybtn").attr("href", "https://www.iobit.com/buy.php?product=de-asc111pc2299_aff&ref="+refStr+"&aff="+affStr+"&refs=de_purchase_asc&tw="+tw);
		$(".footbuy dl .buybtn").attr("onclick", "ga('send', 'event', 'ascbuy', 'buy', 'deaffasc112018febsale')");
}
function threePc() {
		$(".footbuy dl strong b").html("24")
		$(".footbuy dl del").html("59,99€")
		$(".footbuy .left-img .box").addClass("three-pc").removeClass("one-pc");
		$(".footbuy dl .buybtn").attr("href", "https://www.iobit.com/buy.php?product=de-asc113pc2499_aff&ref="+refStr+"&aff="+affStr+"&refs=de_purchase_asc&tw="+tw);
		$(".footbuy dl .buybtn").attr("onclick", "ga('send', 'event', 'ascbuy', 'buy', 'deaffasc112018febsale')");
}
function threeBox() {
		$(".footbuy dl strong b").html("24")
		...
		$(".footbuy dl .buybtn").attr("href", "https://www.iobit.com/buy.php?product=de-asc11iu3pc2499_aff&ref="+refStr+"&aff="+affStr+"&refs=de_purchase_asc&tw="+tw);
		$(".footbuy dl .buybtn").attr("onclick", "ga('send', 'event', 'ascbuy', 'buy', 'deaffasc112018febsale')");
}
function zoomout() {
