...
$name=explode(' ',trim(get_line($pRootUrl.'/de/asc/data/maysale.txt',rand(1,40))));
...
$refStr=empty($_GET['ref'])?'deaff_asc11_2018febsale':$_GET['ref'];
?>
<!DOCTYPE html>
<html lang="de">
<head>
...
<script type="text/javascript" src="<?php echo $pRootUrl; ?>tpl/js/stats.js"></script>
    ...
    <div class="wrapper clearfix">
      ...
      <div class="box one-pc">
        ...
        <dl>
          ...
          <dd><a href="https://www.iobit.com/buy.php?product=de-asc111pc2299_aff&ref=<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=de_purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'deaffasc112018febsale')" class="buybtn border"><span>Jetzt kaufen</span> 17€ sparen</a></dd>
        </dl>
      </div>
      <div class="box three-box active">
        ...
        <dl>
          ...
          <dd><a href="https://www.iobit.com/buy.php?product=de-asc11iu3pc2499_aff&ref=<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=de_purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'deaffasc112018febsale')" class="buybtn middle"><span>Jetzt kaufen</span> 74,95€ sparen</a></dd>
      ...
      <div class="box three-pc">
        ...
        <dl>
          ...
          <dd><a href="https://www.iobit.com/buy.php?product=de-asc113pc2499_aff&ref=<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=de_purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'deaffasc112018febsale')" class="buybtn border"><span>Jetzt kaufen</span> 35€ sparen</a></dd>
        </dl>
      </div>
    </div>
  </div>
  ...
  <div class="intro wrapper">
    ...
    <div class="clearfix panel">
      <div class="list one">
        ...
        <dl>
          <dt>Keine lästige Anzeigen und <br> sicheres Surfen <b>Verbessert</b></dt>
          <dd>Entfernt verschiedene Onlineanzeigen und blockiert mehr <br> bösartige Webseiten.</dd>
        </dl>
      </div>
      <div class="list two">
  ...
  <div class="centbuy">
    <div class="wrapper">
      ...
      <a href="https://www.iobit.com/buy.php?product=de-asc11iu3pc2499_aff&ref=<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=de_purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'deaffasc112018febsale')" class="buybtn center">Jetzt erhalten</a>
  ...
  <div class="footbuy">
    <div class="wrapper clearfix">
      ...
      <dl>
         <dt><strong><b>24</b>,99€</strong><i>UVP</i> <del>99,94€</del></dt>
          <dd><a href="https://www.iobit.com/buy.php?product=de-asc11iu3pc2499_aff&ref=<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=de_purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'deaffasc112018febsale')" class="buybtn center">Jetzt kaufen</a></dd>
      </dl>
    </div>
  </div>
  <!-- footbuy start -->
