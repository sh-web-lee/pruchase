...
var pcga = "ga('send', 'event', 'ascbuy', 'buy', 'deaffasc132020buy1pc');";
var pcsga = "ga('send', 'event', 'ascbuy', 'buy', 'deaffasc132020buy3pc');";
var pcgab = "ga('send', 'event', 'ascbuy', 'buy', 'deaffasc132020buy1pcoff');";
var pcsgab = "ga('send', 'event', 'ascbuy', 'buy', 'deaffasc132020buy3pcoff');";
var pcgabc = "ga('send', 'event', 'ascbuy', 'buy', 'deaffasc132020buy1pc')";
var pcsgabc = "ga('send', 'event', 'ascbuy', 'buy', 'deaffasc132020buy3pc')";

if ($ref1pc.length <= 0) $ref1pc = 'deaff_asc13_2020buy1pc';
if ($ref3pc.length <= 0) $ref3pc = 'deaff_asc13_2020buy3pc';
if ($ref1pcoff.length <= 0) $ref1pcoff = 'deaff_asc13_2020buy1pcoff';
if ($ref3pcoff.length <= 0) $ref3pcoff = 'deaff_asc13_2020buy3pcoff';
...
function planA() {
  ...
  $(".offer .pc").find(".price").html('<p><strong>17,99<small>€</small></strong> <del>35,98€</del></p><a class="buybtn" href="https://www.iobit.com/buy.php?product=deaff-asc131pc1799&ref=deaff_asc13_2020buy1pc&aff=' + aff + '&tw=' + tw + '" onclick="' + pcga + '">In den Warenkorb legen</a>');
  $(".offer .pcs").find(".price").html('<p><strong>24,99<small>€</small></strong> <del>62,48€</del></p><a class="buybtn" href="https://www.iobit.com/buy.php?product=deaff-asc133pc2499&ref=deaff_asc13_2020buy3pc&aff=' + aff + '&tw=' + tw +'" onclick="' + pcsga + '"> In den Warenkorb legen </a><p class = "people" ><i></i><b class="buynum">3.966.571</b>Menschen haben es bereits gekauft</p>');
  reBuyLink();
}
...
function planC() {
  ...
  $(".offer .pc").find(".price").html('<dl class="clearfix"><dd>25% Rabatt <del>13,50€</del></dd><dd class="nowsaleprice">Verkaufspreis <strong>17,99€</strong></dd><dt></dt></dl><a class="buybtn" href="https://www.iobit.com/buy.php?product=deaff-asc131pc1799&ref=deaff_asc13_2020buy1pc&aff='+ aff +'&tw='+ tw +'" onclick="' + pcgabc + '">In den Warenkorb legen</a>');
  $(".offer .pcs").find(".price").html('<dl class="clearfix"><dd>25% Rabatt <del>18,74€</del></dd><dd class="nowsaleprice">Verkaufspreis <strong>24,99€</strong></dd><dt></dt></dl><a class="buybtn" href="https://www.iobit.com/buy.php?product=deaff-asc133pc2499&ref=deaff_asc13_2020buy3pc&aff='+ aff +'&tw='+ tw +'" onclick="' + pcsgabc + '">In den Warenkorb legen</a>');
  reBuyLink();
}
