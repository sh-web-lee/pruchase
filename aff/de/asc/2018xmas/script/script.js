...
function firstShow() {
  ...
  $('.main').append('<div class="mask"></div><div class="mask-box"><h2>Eine Überraschung zu Weihnachten.</h2><div class="clearfix"><div class="fl left"><img src="' + imgSrc + '" alt="Advanced SystemCare 12 Pro"/></div><div class="price"><h3><b>1 € </b>Rabatt nur für Sie!</h3><p>Nur<strong>18<big>,</big></strong> <span>99€ <del>149,92€</del></span></p> <a class="buybtn" href="' + _href + '" onclick="' + _ga + '">Jetzt aktivieren</a><p class="year">Ihre letzte Chance auf das größte Schnäppchen aller Zeiten!</p></div></div></div>');
}
...
function timeInit() {
  var date = new Date();
  var cName = "deascpre" + date.getDate();
