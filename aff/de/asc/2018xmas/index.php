...
if (empty($_GET['ref'])) $_GET['ref'] = 'deaff_asc12_2018xmas';
...
<body>
        ...
        <div class="palen clearfix">
          ...
          <div class="right fr">
            ...
            <div class="price">
              ...
              <a class="buybtn" href="https://www.iobit.com/buy.php?product=deaff-asc12sdpfamc1999&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" onclick="ga('send', 'event', 'ascbuy', 'buy', 'deaffasc122018xmas')">
                 Jetzt aktivieren
              </a>
    ...
    <div class="comparison" id="compare">
      <div class="wrapper">
        <table border="0" cellspacing="0" cellpadding="0" width="100%">
          <thead>
            <tr>
              <th class="itemb"><p>Aktivieren Sie die Pro-Version, <span>genießen Sie die folgenden Vorteile:</span></p></th>
          ...
          <tbody>
            ...
            <tr>
              <td class="itemb">Hält Ihre wichtigen Programmeautomatisch immer <span>auf dem neuesten Stand</span></td>
              <td class="itemc"><i class="all-icons pro">√</i></td>
            </tr>
            <tr>
  ...
  <script>
    ...
    var _href = "http://www.iobit.com/buy.php?product=deaff-asc3pc1899&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>&tw=-8";
    var _ga = "ga('send', 'event', 'ascbuy', 'buy', 'deaffasc122018xmas')";
