...
if (empty($_GET['ref'])) $_GET['ref'] = 'deaff_sd6_2021acregister';
?>
<!DOCTYPE html>
<html lang="de">
<head>
...
<div id="main">
    ...
    <div class="intro">
      ...
      <div class="discount">
        ...
        <div class="btnarea">
          <a class="checkbtn"
             href="https://www.iobit.com/buy.php?product=deaff-sd61pc999&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>"
             onclick="ga('send', 'event', 'sdbuy', 'buy', 'deaffsd62021acregister');" >
            Jetzt kaufen >>
          </a>
    ...
    <div class="checkout">
      <div class="moneyback">
        ...
        <a href="https://www.iobit.com/buy.php?product=deaff-sd61pc999&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>"
             onclick="ga('send', 'event', 'sdbuy', 'buy', 'deaffsd62021acregister');">
          Jetzt kaufen
        </a>
      </div>
