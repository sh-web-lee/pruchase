<?php  
  ...
  if (empty($_GET['ref'])) $_GET['ref'] = 'fraff_asc14_2021acregister';
?>
<!DOCTYPE html>
<html lang="fr">
<head>
...
<title>85% de rabais sur Advanced SystemCare PRO</title>
...
<script type="text/javascript" src="<?php echo $pRootUrl; ?>tpl/js/stats.js"></script>
  ...
  <div class="banner">
    <div class="wrapper">
      ...
      <div class="title">
        ...
        <p>Utilitaire d’optimisation puissant vous assure un PC propre, sécurisé et super rapide</p>
      </div>
      ...
      <div class="pricebox">
        <dl class="price">
          <dt>Seulement: <strong>14.99€ </strong><del>83.93€</del></dt>
          <dd>
            <a class="buybtn bigbtn" 
               href="https://www.iobit.com/buy.php?product=fraff-asc141pc1499a&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']?>"
               onclick="ga('send', 'event', 'ascbuy', 'buy', 'fraffasc142021acregister')">
              <div class="inner">
                <i class="all-icons"></i>
  ...
  <div class="feature wrapper">
    <h2>Que Advanced SystemCare PRO peut-il faire pour vous?</h2>
    <div class="clearfix">
      <dl>
        <dt><img src="<?php echo getStaticUrl('images/feature_icons_01.png')?>" alt=""></dt>
        <dd>
          <h3>Nettoyage plus profond avec l'IA</h3>
          <p>Nettoyez en profondeur les registres cachés, inutiles ou invalides pour libérer de l'espace disque et améliorer complètement les performances du PC avec le nouveau mode IA.</p>
      </dl>
      <dl class="right">
        <dt><img src="<?php echo getStaticUrl('images/feature_icons_06.png')?>" alt=""></dt>
        <dd>
          <h3>Ordinateur plus rapide</h3>
          <p>Gérez les ressources du système intelligemment afin d’accélérer votre PC jusqu’à 200% plus rapide.</p>
        </dd>
      </dl>
    </div>
    <div class="clearfix">
      <dl>
        ...
        <dd>
          <h3>Navigation en ligne plus rapide</h3>
          <p>Optimisez les paramètres du navigateur pour un téléchargement, une navigation sur le Web, un jeu en ligne et une visualisation vidéo 4 fois plus rapides.  </p>
        </dd>
      </dl>
      <dl class="right">
        ...
        <dd>
          ...
          <p>Détectez et bloquez l’accès secret à vos données sensibles immédiatement.</p>
        </dd>
      </dl>
    </div>
    <div class="clearfix">
      <dl>
        ...
        <dd>
          ...
          <p>Empêchez, en temps réel, les logiciels malveillants, les logiciels espions et d’autres menaces d’infecter votre ordinateur. </p>
        </dd>
      </dl>
      <dl class="right">
        <dt><img src="<?php echo getStaticUrl('images/feature_icons_02.png')?>" alt=""></dt>
        <dd>
          <h3>Service automatique</h3>
          <p>Maintenez automatiquement votre PC selon un planning et nettoyez le processeur et la RAM pour améliorer les peformances du PC.</p>
        </dd>
      </dl>
    </div>
  </div>
    ...
    <div id="dg-container" class="dg-container">
      ...
      <div class="content dg-wrapper">
        ...
        <dl class="reviews">
          <dt><h2><span>Avis des utilisateurs</span></h2></dt>
          <dd> 
            <p>« J’utilise Advanced SystemCare Pro depuis longtemps et cette dernière version 14 est encore meilleure que la version 13. Il peut détecter et résoudre les problèmes très rapidement et dispose de nombreuses fonctionnalités supplémentaires dont vous pouvez bénéficier pour un démarrage du PC plus rapide et un système plus stable. Je le recommande vivement. »</p>
  ...
  <div class="footbuy">
    <div class="wrapper">
      <h2>Profitez d’un PC propre, sécurisé et rapide avec cet utilitaire tout-en-un d’optimisation système</h2>
      <div class="pricebox">
        <dl class="price">
          <dt>Seulement: <strong>14.99€ </strong><del>83.93€</del></dt>
          <dd>
  ...
  <div class="bottom">
    <div class="wrapper">
      <!-- annotation start -->
      <p class="annotation">Note: *Les données peuvent varier en fonction de différents systèmes ou ordinateurs.</p>
      <!-- annotation end -->
  ...
  <div class="floatlayer" id="floatlayer">
    <div class="wrapper clearfix">
      <div class="left">
        ...
        <p><strong>-85%</strong> sur ASC PRO pour rendre votre PC fonctionner à sa vitesse maximale</p>
      </div>
      <div class="pricebox">
        <dl class="price fr">
          <dt><strong>14.99€ </strong><del>83.93€</del></dt>
          <dd>
