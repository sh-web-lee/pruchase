...
$ref1pc='fraff_asc13_2020buy1pc';
$ref3pc='fraff_asc13_2020buy3pc';
if(!empty($_GET['ref'])){
  ...
  <div class="offer clearfix">
    ...
    <div class="box pc">
      ...
      <div class="price">
        ...
        <!-- 1pc buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=fraff-asc131pc1499&ref=fraff_asc13_2020buy1pc&aff=<?php echo $_GET['aff']?>"
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'fraffasc132020buy1pc')">
          J’EN PROFITE
        </a>
      </div>
    </div>
    ...
    <div class="box pcs">
      ...
      <div class="price">
        ...
        <!-- 3pc buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=fraff-asc133pc1999a&ref=fraff_asc13_2020buy3pc&aff=<?php echo $_GET['aff']?>"
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'fraffasc132020buy3pc')">
          J’EN PROFITE
        </a>
