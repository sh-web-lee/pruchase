...
function microtime_float()
{
 ...
 if (empty($_GET['ref'])) $_GET['ref'] = 'fraff_asc13_2019flashsale';
?>
<!DOCTYPE html>
<html lang="fr">
<head>
  ...
  <div class="wrapper">
    ...
    <div class="bundle-container clearfix">
      <div class="bundle left">
        ...
        <a class="buyBTN"
           href="https://www.iobit.com/buy.php?product=fraff-asc133pc1999&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>"
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'fraffasc132019flashsale')"
        >VITE, J'EN PROFITE</a>
      </div>
      <div class="bundle right">
        ...
        <a class="buyBTN"
           href="https://www.iobit.com/buy.php?product=fraff-asc133pcpfiusd1999&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>"
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'fraffasc132019flashsale')">VITE, J'EN PROFITE</a>
...
<div class="giftbox">
  ...
  <div class="wrapper">
    ...
    <a href="https://www.iobit.com/buy.php?product=fraff-asc133pcpfiusd1999&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>"
       onclick="ga('send', 'event', 'ascbuy', 'buy', 'fraffasc132019flashsale')"
    >VITE, J'EN PROFITE</a>
...
<div class="popbox">
  ...
  <div class="clearfix">
    ...
    <div class="right fl">
      ...
      <a href="https://www.iobit.com/buy.php?product=fraff-asc133pcpfiusd1799&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>"
          onclick="ga('send', 'event', 'ascbuy', 'buy', 'fraffasc132019flashsale')">
