...
if (empty($_GET['ref'])) $_GET['ref'] = 'fraff_asc11_2018augustsale';
?>
<!DOCTYPE html>
<html lang="fr">
<head>
...
<body>
    ...
    <div class="wrapper">
      ...
      <!-- title -->
      <div class="title">
        <h1>Vente Flash spéciale rentrée</h1>
        <h2>Pour la rentrée, optimisez votre PC à prix mini !</h2>
        <h3>Economisez jusqu'à 85% et boostez votre PC tout de suite !</h3>
      </div>
      <!-- offer65 -->
      <div class="offer65 clearfix">
        ...
        <div class="message fl">
          ...
          <!-- buybtn -->
          <a class="buybtn" href="https://www.iobit.com/buy.php?product=fraff-asc113pc1799&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'fraffasc112018augustsale');">Profiter de l'Offre</a>
        </div>
      </div>
      <!-- offer85 -->
      <div class="offer85 clearfix">
        ...
        <div class="message fl">
          ...
          <!-- buybtn -->
          <a class="buybtn" href="https://www.iobit.com/buy.php?product=fraff-asc11pfsd1999&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'fraffasc112018augustsale');">Profiter de l'Offre</a>
        </div>
        <!-- pop -->
        <div class="pop">
          <dl>
  ...
  <div class="bottombuy">
    <div class="wrapper clearfix">
      ...
      <div class="asc-select fl">
        <!-- offer65 -->
        <div class="selecter offer65" data-discount="<?php echo $pResUrl;?>images/bottombuy-offer65.png" data-original="49.99 €" data-href="https://www.iobit.com/buy.php?product=fraff-asc113pc1799&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_asc">
          <img src="<?php echo $pResUrl;?>images/bottombuy-offer65-off.png" alt="">
          <p>ASC PRO 11 <span>1 an / 3 PC</span></p>
        </div>
        <!-- offer85 -->
        <div class="selecter offer85 active" data-discount="<?php echo $pResUrl;?>images/bottombuy-offer85.png" data-original="119.97 €" data-href="https://www.iobit.com/buy.php?product=fraff-asc11pfsd1999&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_asc">
      ...
      <div class="asc-message fr">
        ...
        <!-- buybtn -->
        <a class="bottombuy-btn" href="https://www.iobit.com/buy.php?product=fraff-asc11pfsd1999&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']?>&refs=fr_purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'fraffasc112018augustsale');">Profiter de l'Offre</a>
      </div>
      <!-- pop -->
      <div class="pop">
        <dl>
