...
$buyUrl = "https://www.iobit.com/buy.php?product=fraff-asc123pc1499&ref=" . $_GET['ref'] . "&aff=" . $_GET['aff'];

if(!empty($_GET['ref'])){

    if(preg_match_all('/ir([0-9]*)/', $_GET['ref'], $arr)) {

        $buyUrl = "https://iobit.onfastspring.com/advanced-systemcare-pro-1-year-subscription-3-pcs-1499";

        if ($arr[1][0] != null) {

            $buyUrl = "http://macbooster.7eer.net/c/" . $arr[1][0] . "/556566/4385";
        }
    }
}
?>
  ...
  <div class="header">
    <div class="wrapper">
      ...
      <div class="btnbox">
        ...
        <a class="btn buy" href="<?= $buyUrl; ?>" onclick="ga('send', 'event', 'ascbuy', 'buy', 'fraffasc122019general') ">
