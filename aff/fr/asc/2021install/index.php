...
if (empty($_GET['ref'])) $_GET['ref'] = 'fraff_asc14_2021install';
  ...
  <div class="pagebanner">
    <div class="container comp-heading clearfix">
      ...
      <div class="heading-info">
        ...
        <h3>Merci d'avoir installé Advanced SystemCare Pro! <br>Mettez à niveau maintenant pour un PC plus propre, plus rapide & plus sûr</h3>
        <p>
        ...
        <div class="price-zone clearfix">
          ...
          <a class="button btn-orange large"
             href="https://www.iobit.com/buy.php?product=fraff-asc141pc1499&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" 
             onclick="ga('send', 'event', 'ascbuy', 'buy', 'fraffasc142021install');">
            Acheter Maintenant
          </a>
        </div>
      </div>
    ...
    <div class="container">
      <div class="compare">
        <table border="0" cellspacing="0" cellpadding="0" width="100%" class="comparetab">
          ...
          <tbody>
												<tr>
							<td colspan="4" class="mid-header">Nettoyer et optimiser les performances de votre PC </td>
						</tr>
												<tr>
							<td class="icon">
								<img src="https://www.iobit.com/tpl/images/comparison/clean/cl_basic.png" alt="">
							</td>
							<td class="describe">Nettoyage et optimisation PC basiques </td>
							...
							<td class="describe">1-clic pour corriger les erreurs de disque pour un système PC plus stable et plus efficace <i class="tags new"></i></td>
							...
							<td class="describe">Mode IA plus intelligent pour une analyse plus efficace, un nettoyage plus profond et une optimisation de PC haut de gamme <i class="tags new"></i></td>
							...
							<td class="itempro"><i class="fa fa-check"></i></td>
																		...
																		<tr>
							<td colspan="4" class="mid-header">Accélérer la vitesse de votre PC </td>
						</tr>
												<tr>
							<td class="icon">
								<img src="https://www.iobit.com/tpl/images/comparison/speedup/sp_startup.png" alt="">
							</td>
							<td class="describe">Augmentation de la vitesse de démarrage (jusqu’à 200%) </td>
							...
							<td class="describe">Augmentez votre vitesse de navigation Internet grâce à l’accélérateur internet (jusqu’à 300%) </td>
							
							<td class="itempro"><i class="fa fa-check"></i></td>
						</tr>
																		<tr>
							<td colspan="4" class="mid-header">Sécurisez vos données personnelles </td>
						</tr>
												<tr>
							<td class="icon">
								<img src="https://www.iobit.com/tpl/images/comparison/protect/pr_b_spy.png" alt="">
							</td>
							<td class="describe">Protection basique avec suppression des logiciels espions </td>
							...
							<td class="describe">Protection prémium de la navigation avec nettoyage automatique des données de navigation  <i class="tags improved"></i></td>
							...
							<td class="describe">Cryptez les empreintes numériques pour cacher vos comportements en ligne <i class="tags improved"></i></td>
							...
							<td class="describe">Mettez vos données personnelles à l’abri des programmes frauduleux <i class="tags improved"></i></td>
							...
							<td class="describe">Détectez et activez à la fois Antivirus et le pare-feu pour une double protection <i class="tags new"></i></td>
