...
var pcga = "ga('send', 'event', 'ascbuy', 'buy', 'fraffasc142021buy1pc');";
var pcsga = "ga('send', 'event', 'ascbuy', 'buy', 'fraffasc142021buy3pc');";
var pcgab = "ga('send', 'event', 'ascbuy', 'buy', 'fraffasc142021buy1pcoff');";
var pcsgab = "ga('send', 'event', 'ascbuy', 'buy', 'fraffasc142021buy3pcoff');";
var pcgabc = "ga('send', 'event', 'ascbuy', 'buy', 'fraffasc142021buy1pc')";
var pcsgabc = "ga('send', 'event', 'ascbuy', 'buy', 'fraffasc142021buy3pc')";

if ($ref1pc.length <= 0) $ref1pc = 'fraff_asc14_2021buy1pc';
if ($ref3pc.length <= 0) $ref3pc = 'fraff_asc14_2021buy3pc';
if ($ref1pcoff.length <= 0) $ref1pcoff = 'fraff_asc14_2021buy1pcoff';
if ($ref3pcoff.length <= 0) $ref3pcoff = 'fraff_asc14_2021buy3pcoff';
...
function planA() {
  ...
  $(".offer .pc").find(".price").html('<p><strong>14,99<small>€</small></strong> <del>29,99€</del></p><a class="buybtn" href="https://www.iobit.com/buy.php?product=fraff-asc141pc1499a&ref=fraff_asc14_2021buy1pc&aff=' + aff + '&tw=' + tw + '" onclick="' + pcga + '">    J’EN PROFITE </a>');
  $(".offer .pcs").find(".price").html('<p><strong>19,99<small>€</small></strong> <del>49,98€/del></p><a class="buybtn" href="https://www.iobit.com/buy.php?product=fraff-asc143pc1999a&ref=fraff_asc14_2021buy3pc&aff=' + aff + '&tw=' + tw +'" onclick="' + pcsga + '">      J’EN PROFITE </a><p class = "people" ><i></i><b class="buynum">3 966 571</b> personnes l’ont acheté</p>');
  reBuyLink();
}
...
function planB() {
  ...
  $(".offer .pc").find(".price").html('<p><span>Original</span><span> Prix ​​de vente </span><b>25% de remise SUPP.</b></p><p><del>29,99€</del><del class="center">14,99€</del><strong>11,24€</strong></p><a class="buybtn" href="https://www.iobit.com/buy.php?product=fraff-asc141pc1124&ref=fraff_asc14_2021buy1pcoff&aff=' + aff + '&tw='+ tw +'" onclick="'+ pcgab +'"> J’EN PROFITE</a><h5>Économisez: 18,75€</h5>');
  $(".offer .pcs").find(".price").html('<p><span><b>Original</b></span><span><b> Prix ​​de vente </b></span><b>25% de remise SUPP.</b></p><p><del>49,98€</del><del class="center">19,99€ </del><strong>14,99€</strong></p><a class="buybtn" href="https://www.iobit.com/buy.php?product=fraff-asc143pc1499&ref=fraff_asc14_2021buy3pcoff&aff='+ aff +'&tw='+ tw +'" onclick="' + pcsgab + '"> J’EN PROFITE</a><h5>Économisez: 35€</h5>');
  reBuyLink();
}
...
function planC() {
  ...
  $(".offer .pc").find(".price").html('<dl class="clearfix"><dd>25% de remise SUPP.<del>11,24€</del></dd><dd class="nowsaleprice">Prix ​​de vente<strong>14,99€</strong></dd><dt></dt></dl><a class="buybtn" href="https://www.iobit.com/buy.php?product=fraff-asc141pc1499&ref=fraff_asc14_2021buy1pc&aff='+ aff +'&tw='+ tw +'" onclick="' + pcgabc + '">J’EN PROFITE</a>');
  $(".offer .pcs").find(".price").html('<dl class="clearfix"><dd>25% de remise SUPP.<del>14,99€</del></dd><dd class="nowsaleprice">Prix ​​de vente<strong>19,99€</strong></dd><dt></dt></dl><a class="buybtn" href="https://www.iobit.com/buy.php?product=fraff-asc143pc1999&ref=fraff_asc14_2021buy3pc&aff='+ aff +'&tw='+ tw +'" onclick="' + pcsgabc + '">J’EN PROFITE</a>');
  reBuyLink();
}
