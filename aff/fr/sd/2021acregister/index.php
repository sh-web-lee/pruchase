...
if (empty($_GET['ref'])) $_GET['ref'] = 'fraff_sd6_2021acregister';
?>
<!DOCTYPE html>
<html lang="fr">
<head>
	...
	<div class="wrapper">
        ...
        <div class="intro">
            ...
            <div class="discount">
                ...
                <div class="wprice">SEULEMENT <em>9.99€</em> <del>66.60€</del><span>1 an d'abonnement / 1 PC</span></div>
                <div class="btnarea">
                    <a href="https://www.iobit.com/buy.php?product=fraff-sd61pc999&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" onclick="ga('send', 'event', 'sdbuy', 'buy', 'fraffsd62021acregister') ;" class="checkbtn">Achetez Maintenant >></a>
...
- PCWORLD.com</div></div>            
        ...
        <div class="checkout">
        	<div class="moneyback">
            	Vous êtes complètement protégé par notre 100% garantie de remboursement et vous VERREZ une amélioration significative de la performance de votre PC Dans les 60 JOURS, ou nous vous enverrons un remboursement complet. Sans aucun souci. <a href="https://www.iobit.com/buy.php?product=fraff-sd61pc999&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" onclick="ga('send', 'event', 'sdbuy', 'buy', 'fraffsd62021acregister') ;">Achetez maintenant </a>
            </div>
            <div class="btn">
            	<a href="https://www.iobit.com/buy.php?product=fraff-sd61pc999&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" title="CHECKOUT" onclick="ga('send', 'event', 'sdbuy', 'buy', 'fraffsd62021acregister') ;" class="checkbtn">Achetez Maintenant >></a>
                <span>100% Garantie de remboursement</span>
            </div>
        </div>
        <div class="clear"></div>
