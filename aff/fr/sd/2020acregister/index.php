...
if (empty($_GET['ref'])) $_GET['ref'] = 'fraff_sd6_2020acregister';
	...
	<div class="wrapper">
        ...
        <div class="intro">
            ...
            <div class="discount">
                ...
                <div class="btnarea">
                    <a href="https://www.iobit.com/buy.php?product=fraff-sd6-acak&ref=<?php echo $_GET['ref']; ?><?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>" onclick="ga('send', 'event', 'sdbuy', 'buy', 'fraffsd62020acregister');" class="checkbtn">Achetez Maintenant >></a>
...
- PCWORLD.com</div></div>            
        ...
        <div class="checkout">
        	<div class="moneyback">
            	Vous êtes complètement protégé par notre 100% garantie de remboursement et vous VERREZ une amélioration significative de la performance de votre PC Dans les 60 JOURS, ou nous vous enverrons un remboursement complet. Sans aucun souci. <a href="https://www.iobit.com/buy.php?product=fraff-sd6-acak&ref=<?php echo $_GET['ref']; ?><?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>" onclick="ga('send', 'event', 'sdbuy', 'buy', 'fraffsd62020acregister');">Achetez maintenant </a>
            </div>
            <div class="btn">
            	<a href="https://www.iobit.com/buy.php?product=fraff-sd6-acak&ref=<?php echo $_GET['ref']; ?><?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>" onclick="ga('send', 'event', 'sdbuy', 'buy', 'fraffsd62020acregister');" class="checkbtn">Achetez Maintenant >></a>
                <span>100% Garantie de remboursement</span>
