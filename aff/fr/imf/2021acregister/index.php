...
if (empty($_GET['ref'])) $_GET['ref'] = 'fraff_imf8_2021acregister';
?>
<!DOCTYPE html>
<html lang="fr">
<head>
...
<div id="main">
	<div class="wrapper">
		...
		<div class="intro">
			...
			<div class="discount">
				<h3><span>Offre Exclusive</span><br />pour Nos Utilisateurs Importants SEULEMENT!</h3>
					...
					<div class="btnarea">
						<a href="https://www.iobit.com/buy.php?product=fraff-imf81pc1349&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" onclick="ga('send', 'event', 'imfbuy', 'buy', 'fraffimf82021acregister');" class="checkbtn">Achetez Maintenant >></a>
		...
		<div class="checkout">
			<div class="moneyback">
					Vous êtes complètement protégé par notre 100% garantie de remboursement et vous VERREZ une amélioration significative de la performance de votre PC Dans les 60 JOURS, ou nous vous enverrons un remboursement complet. Sans aucun souci. <a href="https://www.iobit.com/buy.php?product=fraff-imf81pc1349&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" onclick="ga('send', 'event', 'imfbuy', 'buy', 'fraffimf82021acregister');"> Achetez maintenant</a>
			</div>
			<div class="btn">
				<a href="https://www.iobit.com/buy.php?product=fraff-imf81pc1349&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" title="CHECKOUT" onclick="ga('send', 'event', 'imfbuy', 'buy', 'fraffimf82021acregister');" class="checkbtn">Achetez maintenant >></a>
					<span>100% Garantie de remboursement</span>
			</div>
		</div>
		<div class="clear"></div>
