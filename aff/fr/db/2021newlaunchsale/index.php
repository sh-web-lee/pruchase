...
$refStr=empty($_GET['ref']) ? 'fraff_db8_2021newlaunchsale' : ($_GET['ref']);
?>
<!DOCTYPE html>
<html lang="fr">
<head>
    ...
    <ul class="content clearfix">
      <li id="db-1pc" class="on-left">
        ...
        <div class="price">
          ...
          <a class="buybtn gray"
             href="https://www.iobit.com/buy.php?product=fraff-db81pc2999&ref=<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>"
             onclick="ga('send', 'event', 'dbbuy', 'buy', 'enaffdb82021newlaunchsale')">
            J’EN PROFITE VITE 
          </a>
        </div>
      </li>
      <li id="db-pf-sd" class="on-middle">
        ...
        <div class="price">
          ...
          <a class="buybtn red"
             href="https://www.iobit.com/buy.php?product=fraff-db8iusdpf2499&ref=<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>"
             onclick="ga('send', 'event', 'dbbuy', 'buy', 'enaffdb82021newlaunchsale')">
            J’EN PROFITE VITE 
          </a>
...
<div class="reviewcompare">
  ...
  <div class="comparison wrapper" id="compare">
    <h2>Découvrez plus d’avantages d’Driver Booster PRO</h2>
