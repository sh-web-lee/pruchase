...
if (empty($_GET['ref'])) $_GET['ref'] = 'fraff_db7_2020acregister';
...
<head>
  ...
  <title>Profitez de Driver Booster PRO avec 85% de réduction - IObit</title>
  <meta name="Copyright" content="IObit">
  <meta name="description" content="Offre exclusive réservée aux utilisateurs importants d'IObit et aux membres invités. Obtenez le meilleur programme de mise à jour de pilotes pour garder les pilotes et les composants du jeu toujours à jour !">
...
<div class="banner">
  <div class="wrapper">
    ...
    <div class="title">
      <h1>Driver Booster 7 PRO</h1>
      <p>Mettez à jour tous vos pilotes facilement, rapidement et en toute sécurité !</p>
    </div>
    <div class="offer clearfix">
      <img class="fl" src="<?php echo getStaticUrl('images/boxshot.png')?>" alt="Driver Booster 6 PRO">
      <div class="discount fl">
        <h2>85% de remise</h2>
        <p>Offre exclusive pour nos utilisateurs importants</p>
      </div>
    </div>
    <div class="pricebox">
      <dl class="price">
        <dt>Seulement : <strong>13,49€ </strong><del>89,93€</del></dt>
        <dd>
          <a class="buybtn bigbtn"
             href="https://www.iobit.com/buy.php?product=fraff-db7-ac&ref=<?php echo $_GET['ref']?>&aff=<?php echo $_GET['aff']?>"
             onclick="ga('send', 'event', 'dbbuy', 'buy', 'fraffdb72020acregister');">
            <div class="inner">
              <i class="all-icons"></i>
...
<div class="feature wrapper">
  <h2>Que Driver Booster PRO peut faire pour vous ?</h2>
  <div class="clearfix">
    <dl>
      <dt><img src="<?php echo $pResUrl; ?>images/feature_icons_01.png" alt=""></dt>
      <dd>
        <h3>Une grande base de données de pilotes</h3>
        <p>Détecte et met à jour plus de 3 500 000 pilotes en 1 clic afin d’améliorer la stabilité et les performances de votre ordinateur.</p>
      </dd>
    </dl>
    <dl class="right">
      <dt><img src="<?php echo $pResUrl; ?>images/feature_icons_02.png" alt=""></dt>
      <dd>
        <h3>Expérience de jeu maximale</h3>
        <p>Augmente les performances de jeu avec les derniers pilotes Game Ready et améliore l’expérience de jeu avec les composants mis à jour et appropriés.</p>
      </dd>
    </dl>
  </div>
  <div class="clearfix">
    <dl>
      ...
      <dd>
        <h3>Mise à jour automatique de pilote</h3>
        <p>Met à jour les pilotes automatiquement lorsque l’ordinateur est moins occupé</p>
      </dd>
    </dl>
    <dl class="right">
      <dt><img src="<?php echo $pResUrl; ?>images/feature_icons_04.png" alt=""></dt>
      <dd>
        <h3>Mise à jour sécurisée du pilote</h3>
        <p>Sauvegarde automatiquement les pilotes précédents avant la mise à jour.</p>
      </dd>
    </dl>
  </div>
</div>
...
<div class="footbuy">
  <div class="wrapper">
    <h2>Profitez d’une meilleure performance de votre PC & d’une expérience de jeu plus fluide</h2>
    <div class="pricebox">
      <dl class="price">
        <dt>Seulement : <strong>13,49€ </strong><del>89,93€</del></dt>
        <dd>
...
<div class="floatlayer" id="floatlayer">
  <div class="wrapper clearfix">
    <div class="left">
      ...
      <p>Économisez <strong>85%</strong> pour éviter des crashs de système et des expériences de jeu instables</p>
    </div>
    <div class="pricebox">
      <dl class="price fr">
        <dt><strong>13,49€ </strong><del>89,93€</del></dt>
        <dd>
