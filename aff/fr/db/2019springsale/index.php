...
if (empty($_GET['ref'])) $_GET['ref'] = 'fraff_db6_2019springsale';
  ...
  <div class="wrapper">
    ...
    <ul class="content">
      ...
      <li id="db-1pc" class="on-left">
        ...
        <!-- buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=fraff-db61pc2999&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']?>"
           onclick="ga('send', 'event', 'dbbuy', 'buy', 'fraffdb62019springsale')">
      ...
      <li id="db-3pc" class="on-middle">
        ...
        <!-- buybtn -->
        <a class="buybtn cart"
           href="https://www.iobit.com/buy.php?product=fraff-db63pc2499&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']?>"
           onclick="ga('send', 'event', 'dbbuy', 'buy', 'fraffdb62019springsale')">
      ...
      <li id="db-pf-sd" class="on-right nobegin">
        ...
        <!-- buybtn -->
        <a class="buybtn cart"
           href="https://www.iobit.com/buy.php?product=fraff-db6iusdpf2499&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']?>"
           onclick="ga('send', 'event', 'dbbuy', 'buy', 'fraffdb62019springsale')">
          <span>VITE, J’EN PROFITE</span>
        </a>
        <!-- attention -->
...
<div class="gift-box">
  <div class="wrapper clearfix">
    ...
    <a class="buybtn cart disabled"
       disabled="ture"
       data-url="https://www.iobit.com/buy.php?product=fraff-db6iusdpf2499&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']?>&tw=-8"
       data-ga="ga('send', 'event', 'dbbuy', 'buy', 'fraffdb62019springsale')"
...
<div class="comparison-table" id="compare">
  <table border="0" cellspacing="0" cellpadding="0" width="100%">
    <thead>
    <tr>
      <th colspan="2">Les avantages de Pro, si vous l’activez maintenant</th>
      <th class="space"></th>
...
<div class="bottomcart">
  <div class="wrapper">
    ...
    <ul>
      ...
      <li class="one-pc"
          data-url="https://www.iobit.com/buy.php?product=fraff-db61pc2999&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']?>&tw=-8"
          data-ga="ga('send', 'event', 'dbbuy', 'buy', 'fraffdb62019springsale')"
          data-price="29"
          data-original="">
      ...
      <li class="three-pc"
          data-url="https://www.iobit.com/buy.php?product=fraff-db63pc2499&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']?>&tw=-8"
          data-ga="ga('send', 'event', 'dbbuy', 'buy', 'fraffdb62019springsale')"
          data-price="24"
          data-original="74,85€">
