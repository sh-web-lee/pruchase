  ...
  <div class="banner">
    <div class="wrapper">
      ...
      <ul class="btnbox clearfix">
        ...
        <li>
          <a class="btn buy" href="https://www.iobit.com/buy.php?product=fraff-db63pc2098&ref=<?php echo $_GET['ref'];?>&aff=<?php echo $_GET['aff'];?>" onclick="ga('send', 'event', 'dbbuy', 'buy', 'fraffdb62019general') " data-text="Achetez Maintenant & -65% >>">
  ...
  <div class="container">
    ...
    <div class="feature">
      <div class="wrapper clearfix">
        <div class="text">
          <h2>Prend en charge plus de 3 000 000 pilotes</h2>
          <span></span>
          <p>Obtenez automatiquement les pilotes et les mises à jour recommandés pour votre matériel avec Driver Booster PRO. Il est capable de détecter et mettre à jour plus de <br> 3 000 000 pilotes obsolètes, manquants et incompatibles afin de réduire les blocages et les pannes du système.</p>
        </div>
