...
$ref1pc='itaff_asc14_2021buy1pc';
$ref3pc='itaff_asc14_2021buy3pc';
if(!empty($_GET['ref'])){
  ...
  <div class="offer clearfix">
    ...
    <div class="box pc">
      ...
      <div class="price">
        ...
        <!-- 1pc buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=itaff-asc141pc1499&ref=itaff_asc14_2021buy1pc&aff=<?php echo $_GET['aff']?>"
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'itaffasc142021buy1pc')">
    ...
    <div class="box pcs">
      ...
      <div class="price">
        ...
        <!-- 3pc buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=itaff-asc143pc2199&ref=itaff_asc14_2021buy3pc&aff=<?php echo $_GET['aff']?>"
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'itaffasc142021buy3pc')">
          Aggiungi al carrello
        </a>
