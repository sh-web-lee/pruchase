...
$ref1pc='itaff_asc13_2020buya1pc';
$ref3pc='itaff_asc13_2020buya3pc';
if(!empty($_GET['ref'])){
  ...
  <div class="offer clearfix">
    ...
    <div class="box pc">
      ...
      <div class="price">
        ...
        <!-- 1pc buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=itaff-asc131pc1499&ref=itaff_asc13_2020buya1pc&aff=<?php echo $_GET['aff']?>"
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'itaffasc132020buya1pc')">
    ...
    <div class="box pcs">
      ...
      <div class="price">
        ...
        <!-- 3pc buybtn -->
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=itaff-asc133pc2199&ref=itaff_asc13_2020buya3pc&aff=<?php echo $_GET['aff']?>"
           onclick="ga('send', 'event', 'ascbuy', 'buy', 'itaffasc132020buya3pc')">
          Aggiungi al carrello
        </a>
