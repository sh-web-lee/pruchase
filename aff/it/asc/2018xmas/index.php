...
if (empty($_GET['ref'])) $_GET['ref'] = 'itaff_asc12_2018xmas';
      ...
      <div class="palen clearfix">
        ...
        <div class="right fr">
          ...
          <div class="price">
            ...
            <!-- buybtn -->
            <a class="buybtn"
               href="https://www.iobit.com/buy.php?product=itaff-asc123pcsdpfiu1677&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>"
               onclick="ga('send', 'event', 'ascbuy', 'buy', 'itaffasc122018xmas')">
              Approfittane Ora
            </a>
  ...
  <div class="comparison" id="compare">
    <div class="wrapper">
      <table border="0" cellspacing="0" cellpadding="0" width="100%">
        <thead>
        <tr>
          <th class="itemb"><p>Cosa ricevi immediatamente dopo avere <span>attivato la versione PRO:</span></p></th>
        ...
        <tr>
          <td class="itemb">Rimozione dei tracciamenti della privacy automatica per <span>una navigazione online più sicura</span></td>
          <td class="itemc"><i class="all-icons pro">√</i></td>
        </tr>
        <tr>
...
<script>
  ...
  var _href = "https://www.iobit.com/buy.php?product=itaff-asc123pcsdpfiu1577&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>&tw=-8";
  var _ga = "ga('send', 'event', 'ascbuy', 'buy', 'itaffasc122018xmas')";
