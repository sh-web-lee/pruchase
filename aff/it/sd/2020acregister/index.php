...
if (empty($_GET['ref'])) $_GET['ref'] = 'itaff_sd6_2020acregister';
					...
					<h1>Smart Defrag PRO</h1>
						...
						<div class="discount">
							<h3><span>Offerta Esclusiva</span><br />Solo per gli Utenti Importanti di IObit!</h3>
								...
								<div class="wprice">Solo <em>8.99€</em> <del>59,93€</del><span>1PC / 1 Anno</span></div>
								<div class="btnarea">
										<a href="https://www.iobit.com/buy.php?product=itaff-sd6-acak&ref=<?php echo $_GET['ref']; ?><?php echo $refStr;?>&aff=<?php echo $_GET['aff']; ?>" onclick="ga('send', 'event', 'sdbuy', 'buy', 'itaffsd62020acregister');" class="checkbtn">Acquista Ora >></a>
