...
if (empty($_GET['ref'])) $_GET['ref'] = 'itaff_sd6_2021acregister';
?>
<!DOCTYPE html>
<html lang="it">
<head>
					...
					<h1>Smart Defrag PRO</h1>
						...
						<div class="discount">
							<h3><span>Offerta Esclusiva</span><br />Solo per gli Utenti Importanti di IObit!</h3>
								...
								<div class="btnarea">
										<a href="https://www.iobit.com/buy.php?product=itaff-sd61pc899&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" onclick="ga('send', 'event', 'sdbuy', 'buy', 'itaffsd62021acregister') ;" class="checkbtn">Acquista Ora >></a>
