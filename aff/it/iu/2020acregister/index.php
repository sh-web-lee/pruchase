...
if (empty($_GET['ref'])) $_GET['ref'] = 'itaff_iu9_2020acregister';
...
<title>85% di Sconti su IObit Uninstaller PRO</title>
...
<div id="main" class="wrapper">
	<div class="intro">
		...
		<div class="discount">
			...
			<dl>
				...
				<dd>
					<a class="checkbtn" href="https://www.iobit.com/buy.php?product=itaff-iu9-acak&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" title="CHECKOUT" onclick="ga('send', 'event', 'iubuy', 'buy', 'itaffiu92020acregister')">
						ACQUISTA ORA >>
					</a>
				</dd>
		...
		<div class="leftbox">
			...
			<ul>
				<li>
				  ...
				  Rileva adware, barre degli strumenti e programmi di terze parti indesiderati che intendono rubare i tuoi dati di privacy.
				</li>
				<li>
					<span><img src="<?php echo getStaticUrl('images/icon02.png')?>" alt=""/></span>
					Navigazione sicura con la rimozione dei plug-in pubblicitari e maligni
				</li>
				<li>
					<span><img src="<?php echo getStaticUrl('images/icon03.png')?>" alt=""/></span>
					Rimuove completamente i file residui dai programmi disinstallati sul PC con un solo clic.
				</li>
				<li class="last">
	...
	<div class="checkout">
		<div class="moneyback">
				Sei stato protetto completamente dalla nostra garanzia di 100% rimborso. Scoprirai un miglioramento significativo della prestazione del tuo PC ENTRO 60 giorni, altrimenti, ti procederemo il rimborso subito. Senza preoccupazione. <a href="https://www.iobit.com/buy.php?product=itaff-iu9-acak&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" title="CHECKOUT" onclick="ga('send', 'event', 'iubuy', 'buy', 'itaffiu92020acregister')"> Acquista Ora</a>
			</div>
			<div class="btn">
				<a href="https://www.iobit.com/buy.php?product=itaff-iu9-acak&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" title="CHECKOUT" onclick="ga('send', 'event', 'iubuy', 'buy', 'itaffiu92020acregister')" class="checkbtn">
					ACQUISTA ORA >>
				</a>
