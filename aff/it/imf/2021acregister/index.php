...
if (empty($_GET['ref'])) $_GET['ref'] = 'itaff_imf8_2021acregister';
?>
<!DOCTYPE html>
<html lang="it">
<head>
		...
		<div class="wrapper">
				...
				<div class="intro">
						...
						<div class="discount">
								...
								<div class="btnarea">
										<a href="https://www.iobit.com/buy.php?product=itaff-imf81pc1199&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" onclick="ga('send', 'event', 'imfbuy', 'buy', 'itaffimf82021acregister');" class="checkbtn">Acquista Ora >></a>
						...
						<div class="leftbox">
							...
							<ul>
								...
								<li>
									...
									Aggiunge un <strong>extra strato di protezione per i tuoi dati sensibili</strong> come documenti, immagini e video.
								</li>
								<li>
				...
				<div class="checkout">
						<div class="moneyback">
								Sei stato protetto completamente dalla nostra garanzia di 100% rimborso. Scoprirai un miglioramento significativo della prestazione del tuo PC ENTRO 60 giorni, altrimenti, ti procederemo il rimborso subito. Senza preoccupazione.<a href="https://www.iobit.com/buy.php?product=itaff-imf81pc1199&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" onclick="ga('send', 'event', 'imfbuy', 'buy', 'itaffimf82021acregister');">Acquista Ora.</a>
						</div>
						<div class="btn">
								<a href="https://www.iobit.com/buy.php?product=itaff-imf81pc1199&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" title="CHECKOUT" onclick="ga('send', 'event', 'imfbuy', 'buy', 'itaffimf82021acregister');" class="checkbtn">Acquista Ora >></a>
								<span>100% GARANZIA DI RIMBORSO</span>
						</div>
				</div>
				<div class="clear"></div>
