...
if (empty($_GET['ref'])) $_GET['ref'] = 'itaff_db7_2020acregister';
...
<script type="text/javascript" src="<?php echo $pRootUrl; ?>tpl/js/stats.js"></script>
  ...
  <div class="banner">
    <div class="wrapper">
      ...
      <div class="pricebox">
        <dl class="price">
          <dt>Solo <strong>€11,99 </strong><del>€79,93</del></dt>
          <dd>
            <a class="buybtn bigbtn"
               href="https://www.iobit.com/buy.php?product=itaff-db7-ac&ref=<?php echo $_GET['ref']?>&aff=<?php echo $_GET['aff']?>"
               onclick="ga('send', 'event', 'dbbuy', 'buy', 'itaffdb72020acregister');">
              <div class="inner">
                <i class="all-icons"></i>
    ...
    <div class="clearfix">
      <dl>
        ...
        <dd>
          ...
          <p>Rileva e aggiorna oltre 3.500.000 driver con 1 clic, <br> che migliora la stabilità e le prestazioni del tuo computer.</p>
        </dd>
      </dl>
      <dl class="right">
  ...
  <div class="floatlayer" id="floatlayer">
    <div class="wrapper clearfix">
      ...
      <div class="pricebox">
        <dl class="price fr">
          <dt><strong>€11,99 </strong><del>€79,93</del></dt>
          <dd>
