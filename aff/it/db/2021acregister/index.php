...
if (empty($_GET['ref'])) $_GET['ref'] = 'itaff_db8_2021acregister';
        ...
        <dl class="price">
          ...
          <dd>
            <a class="buybtn bigbtn"
               href="https://www.iobit.com/buy.php?product=itaff-db8-ac&ref=<?php echo $_GET['ref']?>&aff=<?php echo $_GET['aff']?>"
               onclick="ga('send', 'event', 'dbbuy', 'buy', 'itaffdb82021acregister');">
              <div class="inner">
                <i class="all-icons"></i>
