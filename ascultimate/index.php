<?php
header('location:http://purchase.iobit.com/en/ascu/index.php');exit();
//	初始化
	error_reporting(0);
	define('IObit', 'IObit');
	$pRootUrl = '../';
...
<body>
	...
	<div class="header">
    	<div class="warpper clearfix">
            ...
            <div class="title"></div>
            <dl class="time">
                <dt>Time-limited Offer<sub>①</sub></dt>
    	...
    	<div class="warpper clearfix">
			<div class="lace">
              ...
              <div class="control">
                <ul>
                  ...
                  <li class="link"><a id="buyUrl1" href="http://www.iobit.com/buy.php?product=<?php echo $buyTag; ?>&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_ascu"  onclick="ga('send', 'event', 'ascubuy', 'buy', 'ascupurchase');" title="Purchase  Advanced SystemCare Ultimate to get Protected Folder for FREE.">ACTIVATE NOW</a></li>
            ...
            <div class="cross clearfix">
                ...
                <dl class="link">
					...
					<dd><a id="buyUrl2" href="http://www.iobit.com/buy.php?product=<?php echo $buyTag; ?>&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_ascu"  onclick="ga('send', 'event', 'ascubuy', 'buy', 'ascupurchase');" title="Purchase  Advanced SystemCare Ultimate to get Protected Folder for FREE.">activate now</a></dd>
                </dl>
                <dl class="right">
           ...
           <div class="floatlayer" id="floatlayer">
                ...
                <!-- <dd>Call to Order: <span>1-855-287-0986</span> (Toll-Free 7*24)</dd> -->
              </dl>
              <div class="price" id="money3"><?php echo $price; ?></div>
              <dl class="right">
              	<dt><a id="buyUrl3" href="http://www.iobit.com/buy.php?product=<?php echo $buyTag; ?>&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_ascu"  onclick="ga('send', 'event', 'ascubuy', 'buy', 'ascupurchase');" title="Purchase  Advanced SystemCare Ultimate to get Protected Folder for FREE.">activate now</a></dt>
