...
<body>
    ...
    <div class="middle">
    	<div class="warpper clearfix">
    		<div class="lace">
            	<dl class="introduce">
                	<dt><span>Save <em id="discount1"><?php echo $discount; ?></em>%</span> on ASC Ultimate &amp; Get Easter Gifts for FREE!</dt>
                    <dd><img src="img/introduce.jpg"></dd>
                </dl>
                <div class="control">
                	<h2>Ultimate PC Protection</h2>
                    <ul>
                    	<li class="price">Today <span id="money1"><?php echo $price; ?></span> <em>$109.99</em></li>
                        ...
                        <li class="subscription">1 year subscription / <span>3PCs</span></li>
