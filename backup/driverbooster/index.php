...
k='73319726-55',d=document,l=d.location,c=d.cookie;
...
<div id="main">
	<div class="floatlayer" id="floatlayer">
		<div class="moneyback"> You're fully protected by our 100% money back guarantee and you WILL see a significant improvement in your PC's performance WITHIN 60 DAYS, or we'll send you a full refund. No questions asked. <a href="http://www.iobit.com/buy.php?product=driver-booster&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>">Upgrade Now</a> </div>
		<div class="btn"> <span>Original <del>$60.93</del> Now $28.95</span> <a href="http://www.iobit.com/buy.php?product=driver-booster&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" title="CHECKOUT" class="checkbtn">Checkout >></a> <span>100% money back guarantee</span> </div>
	</div>
	<div class="head">
		<div id="lang"><span id="google_translate_element"></span> </div>
		<div class="logo"><a href="http://www.iobit.com"></a></div>
		<div class="maintitle">50% OFF</div>
		...
		<div class="intro left">
			<div class="salebox">
				...
				<div class="bgwihte">
					...
					<div class="link">Price <span>$28.95</span> &nbsp;&nbsp;&nbsp;<a href="http://www.iobit.com/buy.php?product=driver-booster&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>">Get it now&gt;&gt;</a></div>
					<div class="clear"></div>
				</div>
			</div>
			<div class="freebox ml10 left">
				...
				<div class="bgwihte">
					...
					<div class="link">Original <span class="del">$21.99</span>&nbsp;&nbsp;&nbsp;<a href="http://www.iobit.com/buy.php?product=driver-booster&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>">Get it now&gt;&gt;</a></div>
					<div class="clear"></div>
				</div>
			</div>
			<div class="freebox right">
				...
				<div class="bgwihte">
					...
					<div class="link">Original <span class="del">$9.99</span>&nbsp;&nbsp;&nbsp;<a href="http://www.iobit.com/buy.php?product=driver-booster&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>">Get it now&gt;&gt;</a></div>
					<div class="clear"></div>
				</div>
			</div>
			<div class="clear"></div>
			...
			<table cellpadding="0" cellspacing="0" width="100%" class="pricetab">
				...
				<tr>
					...
					<td class="topborder f11">Identify & Update outdated drivers and improve PC performance.<br />
						<a href="http://www.iobit.com/buy.php?product=driver-booster&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>">Get it now>></a></td>
					<td class="tlborder bf16 center"><span class="price">$28.95</span></td>
					<td class="tlborder rborder bf16 center red">$28.95</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="topborder f11">Get the complete, step-by-step system optimization e-Book completely FREE when you upgrade to PRO today. <a href="http://www.iobit.com/buy.php?product=driver-booster&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>">Get it now>></a></td>
				...
				<tr>
					...
					<td class="tlborder rborder bborder grybg bf16 center red">$28.95</td>
				</tr>
			</table>
		</div>
		<div class="checkout">
			<div class="moneyback"> You're fully protected by our 100% money back guarantee and you WILL see a significant improvement in your PC's performance WITHIN 60 DAYS, or we'll send you a full refund. No questions asked. <a href="http://www.iobit.com/buy.php?product=driver-booster&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>">Upgrade Now</a> </div>
			<div class="btn"> <a href="http://www.iobit.com/buy.php?product=driver-booster&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" title="CHECKOUT" class="checkbtn order_url">Check out >></a> <span>100% money back guarantee</span> </div>
		</div>
		<div class="clear"></div>
		<div class="awards">
