<?php
	...
	if (empty($_GET['ref'])) $_GET['ref'] = '2014newyear';
?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>IObit New Year Exclusive </title>
...
// Closed browser window popup discount layer
var viewFloatLayer = true;
window.onbeforeunload = function(){
	if (viewFloatLayer){
		viewFloatLayer = false;
		$('#popout').css({'z-index': '20', 'opacity': '1'});
		var warning = '50% OFF for ASC PRO Single solution Now. Take a look!';           
		return warning;
	}
}
</script>
...
<div id="popout">
  <div id="popout_lightbox">
    <div class="box_btp">
      ...
      <h2>Don't want the gifts & <span>only need a ASC license for 1 PC?</span><br />You have the option! AND it's 50% OFF Today!</h2>
    </div>
    <div class="box_mid">
      <img src="img/popout_boxshot.png" alt="" class="light_boxshot"/>
      <dl class="light_benfits">
        <dt><strong>Advanced SystemCare PRO</strong> Single Solution:</dt>
        <dd>200% Faster PC</dd>
        <dd>300% Faster Internet</dd>
        <dd>No More Junk Files</dd>
        <dd>Safe Online Surfing</dd>
      </dl>
      <dl class="payment">   
        <dt><img src="img/moneyback.png" alt="" /></dt>     
        <dd class="price">Only <span>$14.77</span> Original <del>$29.99</del></dd>
        <dd>1 Year Subscription / 1 PC</dd>        
      </dl>
      <div class="light_btnarea">
        <a href="http://www.iobit.com/buy.php?product=asc71pc1477&ref=2014newyearb&aff=<?php echo $_GET['aff']; ?>" class="light_checkbtn"><span>Make Your PC fully optimized for only $0.04/day</span></a>
        <div class="light_countdown"><p>Limited for New Year Celebration</p> <div class="countdown" id="counttime3">0d: 0h: 0m: 0s</div> </div>
      </div>
      <div class="clear"></div>
    </div>
  </div>
...
<div id="main">
  <div class="floatlayer" id="floatlayer">
    <div class="moneyback"> You're fully protected by our 100% money back guarantee and you WILL see a significant improvement in your PC's performance WITHIN 60 DAYS, or we'll send you a full refund. No questions asked. <a href="http://www.iobit.com/buy.php?product=asc7sdpfiu&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>">Upgrade Now</a> </div>
    <div class="btn"> <span>Original <del>$119.99</del> Now $23.98</span> <a href="http://www.iobit.com/buy.php?product=asc7sdpfiu&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" title="CHECKOUT" class="checkbtn">Checkout >></a>
  ...
  <div class="mbody">
    <div class="intro">
      ...
      <dl class="topbuy">
        <dt>Activate ASC PRO today, get Protected Folder, Smart Defrag PRO and IObit Uninstaller PRO for FREE!</dt>
        <dd>
          <div class="buyarea">
            <div class="count">
              <?php
            ...
            <a href="http://www.iobit.com/buy.php?product=asc7sdpfiu&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" class="buybtn">Activate Now</a> <span>Today <em class="brownyellow">$23.98</em> <del>$119.99</del> </span> </div>
          <dl class="guarantee">
            <dt><img src="img/moneyback.png" alt="" /></dt>
    ...
    <div class="conf">
      <dl>
        ...
        <dd>IObit Once-per-year Offer, Limited for New Year Celebration Only! 
    ...
    <div class="procdetail">
      ...
      <div class="freebox"> <span class="iconfree"></span>
        <dl>
          <dt><img src="img/boxshot_iu.png" alt="" /></dt>
          <dd><strong>IObit Uninstaller PRO</strong> <br />
            Most Powerful Uninstaller to Remove Plug-ins & Apps!<br />
            <em>$19.99</em></dd>
        </dl>
      </div>
      ...
      <div class="freebox" style="margin-top:15px;"> <span class="iconfree"></span>
        <dl>
          ...
          <dd><strong>Smart Defrag PRO</strong> <br />
    ...
    <div class="clear"></div>
    <div class="pricebox">
      <p class="describe">Get all these four powerful tools today with the price of one! Offer limited for New Year Celebration!<br />
        ...
        <tfoot>
          <tr>
            ...
            <th class="itema"><span>Advanced Systemcare PRO</span><br />
              <a href="http://www.iobit.com/buy.php?product=asc7sdpfiu&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" class="tbbuybtn">Activate Now</a> </th>
          </tr>
        </tfoot>
      </table>
    </div>
...
function cycleCountdown(){
	...
	document.getElementById('counttime3').innerHTML = d+'d: '+h+'h: '+i+'m: '+s+'s';
