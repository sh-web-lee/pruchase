<?php
	...
	//if (empty($_GET['ref'])) $_GET['ref'] = '20146thbday2';
  $_GET['ref'] = '20146thbday2';
?>
...
k='73319726-82',d=document,l=d.location,c=d.cookie;
...
<div id="main">
  ...
  <div class="mbody">
    ...
    <div class="floatlayer" id="floatlayer">
      <dl class="left">
        <dt>Save <span>80%</span>, Share 300% Faster PC Feeling with Your Family!</dt>
      ...
      <dl class="right">
        <dt><a href="http://www.iobit.com/buy.php?product=asc7sdpfiu&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_asc">activate now</a></dt>
          <dd id="counttime2"><span>0</span>d: <span>0</span>h: <span>0</span>m: <span>0</span>s <em>000</em></dd>
      </dl>
    </div> 
  </div>
