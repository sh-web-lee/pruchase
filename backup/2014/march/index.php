<?php
	...
	if (empty($_GET['ref'])) $_GET['ref'] = '2014march';
?>
...
k='73319726-76',d=document,l=d.location,c=d.cookie;
...
<div id="main">
  <div class="floatlayer" id="floatlayer">
    <div class="moneyback"> You're fully protected by our 100% money back guarantee and you WILL see a significant improvement in your PC's performance WITHIN 60 DAYS, or we'll send you a full refund. No questions asked. <a href="http://www.iobit.com/buy.php?product=asc7sdpfiu&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_asc">Upgrade Now</a> </div>
    <div class="btn"> <span>Original <del>$119.99</del> Now $23.98</span> <a href="http://www.iobit.com/buy.php?product=asc7sdpfiu&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_asc" title="CHECKOUT" class="checkbtn">Checkout >></a>
  ...
  <div class="mbody">
    <div class="intro">
      <div class="ladybird"><img src="img/ladybird.png" alt="" /></div>
      <h1>Save <span>80</span>% on ASC & Get Gifts your PC will adore!</h1>
      <div class="boxgroup"><a href="http://www.iobit.com/buy.php?product=asc7sdpfiu&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_asc"><img src="img/boxgroup.png" alt="" /></a></div>
      <dl class="topbuy">
        ...
        <dd>
          <div class="buyarea">
            ...
            <a href="http://www.iobit.com/buy.php?product=asc7sdpfiu&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_asc" class="buybtn">Activate Now</a> <span>Today <em class="brownyellow">$23.98</em> <del>$119.99</del> </span> </div>
          <dl class="guarantee">
    ...
    <div class="conf">
      <dl>
        <dt><img src="img/butterfly.jpg" alt="" /></dt>
        <dd>Treat your PC to the best protection & optimization with affordable price! 
    ...
    <div class="clear"></div>
    <div class="pricebox">
      <p class="describe">Get all these four powerful tools today with the price of one! Offer limited for this Spring only!<br />
