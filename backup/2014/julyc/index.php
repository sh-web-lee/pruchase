<?php
    ...
    if (rand(1, 100)%2==0){
        header("Location:../aug/index.php".$param );
        exit;
    }
...
k='17473586-100',d=document,l=d.location,c=d.cookie;
...
function addToCart(product){
	if($('#'+product+' a').attr('class') == 'addbtn_a_disable') return;
	$('#imf a').attr('class', 'addbtn_b');
	$('#iu a').attr('class', 'addbtn_a');
	$('#sd a').attr('class', 'addbtn_a');
	if (product == 'imf'){
		$('#'+product+' a').attr('class', 'addbtn_b_disable');
	} else {
		$('#'+product+' a').attr('class', 'addbtn_a_disable');
	}
	...
	productCfgArr['buyUrl']['imf'] = 'http://www.iobit.com/buy.php?product=asc7imf&ref=2014julyascimfc&aff=&refs=purchase_asc';
	productCfgArr['buyUrl']['iu'] = 'http://www.iobit.com/buy.php?product=asc7iu&ref=2014julyasciuc&aff=&refs=purchase_asc';
	productCfgArr['buyUrl']['sd'] = 'http://www.iobit.com/buy.php?product=asc7sd&ref=2014julyascsdc&aff=&refs=purchase_asc';
	productCfgArr['name']['imf'] = 'IObit Malware Fighter PRO';
	productCfgArr['name']['iu'] = 'IObit Uninstaller PRO';
	productCfgArr['name']['sd'] = 'Smart Defrag PRO';
	productCfgArr['listPrice']['imf'] = '$19.95';
	productCfgArr['sellPrice']['imf'] = '$9.99';
	...
	if (product == 'imf'){
		$('#totalSellPrice').html('$29.98');
		$('#totalListPrice').html('$109.94');
	} else {
...
<div class="wrapper">
  ...
  <div class="intro">
    <h2>Save 80% on ASC PRO & Choose a PRO Gift start from <span>$0</span>！</h2>
    ...
    <div class="addproclist clearfix">
      <p>Activate ASC PRO for 3 PCs, and get one of the three products with minimum cost !</p>
      <dl class="mainproc">
      ...
      <dl class="addproc" id="sd">
        ...
        <dd><a href="#none" class="addbtn_a_disable" onclick="addToCart('sd');"></a></dd>
      ...
      <dl class="addproc" id="iu">
        ...
        <dd class="price">$0 <del>$19.99</del></dd>
        <dd><a href="#none" class="addbtn_a" onclick="addToCart('iu');"></a></dd>
        <dd class="introduce">Most Powerful Uninstaller to Remove Plug-ins &amp; Apps!</dd>
      </dl>
      <dl class="addproc" id="imf">
        <dt><img src="<?php echo $pResUrl; ?>img/boxshot_imf.jpg" alt="" /></dt>
        <dd class="name">IMF PRO</dd>
        <dd class="price">$9.99 <del>$19.95</del></dd>
        <dd><a href="#none" class="addbtn_b" onclick="addToCart('imf');"></a></dd>
        <dd class="introduce">Extra Protection for Your PC Security!</dd>
      </dl>
    </div>
    <div class="choosecart">
      ...
      <a href="http://www.iobit.com/buy.php?product=asc7sd&ref=2014julyascsdc&aff=&refs=purchase_asc" id="buyButton"  onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase-201407');" class="activebtn">Activate Now</a>
      ...
      <thead>
        <tr>
          ...
          <th class="itema">
            ...
            <a href="http://www.iobit.com/buy.php?product=asc71pc1477&ref=2014julyascc&aff=&refs=purchase_asc"  onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase-201407compare');" class="tbbuybtn">Activate Now</a>
