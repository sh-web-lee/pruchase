...
<body>
    ...
    <div class="middle">
    	<div class="warpper clearfix">
    		<div class="lace">
            	<dl class="introduce">
                	<dt><span>Save 80%</span> on ASC PRO &amp; Get Aircover Security for Free!</dt>
                    <dd><img src="img/introduce.jpg"></dd>
                </dl>
                <div class="control">
                	<h2>Ultimate PC Performance</h2>
                    <ul>
                    	<li class="price">Today <span>$19.99</span> <em>$89.97</em></li>
                        <li class="link"><a href="http://www.iobit.com/buy.php?product=asc7aircover&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_asc">activate now</a></li>
            ...
            <h2>Ultimate PC Performance &amp; Ultimate Mobile Security! <p id="counttime2"><span>00</span>d: <span>00</span>h: <span>00</span>m: <span>00</span>s <em>000</em></p></h2>
            ...
            <div class="cross clearfix">
                ...
                <dl class="link">
					...
					<dd><a href="http://www.iobit.com/buy.php?product=asc7aircover&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_asc">activate now</a></dd>
                </dl>
                <dl class="right">
