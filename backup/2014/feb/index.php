<?php
	...
	if (empty($_GET['ref'])) $_GET['ref'] = '2014feb';
?>
...
<title>IObit SWEET SAVING on Feb</title>
...
<div id="main">
  ...
  <div class="mbody">
    ...
    <div class="conf">
      <dl>
        <dt><img src="img/cockade.png" alt="" /></dt>
    ...
    <div class="clear"></div>
    <div class="pricebox">
      <p class="describe">Get all these four powerful tools today with the price of one! Offer limited for this February only!<br />
