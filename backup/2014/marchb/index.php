<?php
	...
	if (empty($_GET['ref'])) $_GET['ref'] = '20146thbday';
?>
...
k='73319726-81',d=document,l=d.location,c=d.cookie;
...
<title>Celebration of ASC 6th Birthday</title>
...
<div id="main">
  ...
  <div class="mbody">
    <div class="intro">
      <h1>Save <span>80</span>%, Share 300% Faster PC Feeling with Your Family!</h1>
    ...
    <div class="conf">
      <dl>
        <dt><img src="img/gift.jpg" alt="" /></dt>
    ...
    <div class="clear"></div>
    <div class="pricebox">
      <p class="describe">Get all these four powerful tools today with the price of one! Time-limited Offer!<br />
