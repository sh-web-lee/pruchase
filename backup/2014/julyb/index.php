...
function addToCart(product){
	...
	productCfgArr['buyUrl']['db'] = 'http://www.iobit.com/buy.php?product=asc7db&ref=2014julyascdb&aff=&refs=purchase_asc';
	productCfgArr['buyUrl']['iu'] = 'http://www.iobit.com/buy.php?product=asc7iu&ref=2014julyasciu&aff=&refs=purchase_asc';
	productCfgArr['buyUrl']['sd'] = 'http://www.iobit.com/buy.php?product=asc7sd&ref=2014julyascsd&aff=&refs=purchase_asc';
	productCfgArr['name']['db'] = 'Driver Booster PRO';
	productCfgArr['name']['iu'] = 'IObit Uninstaller PRO';
	productCfgArr['name']['sd'] = 'Smart Defrag PRO';
	productCfgArr['listPrice']['db'] = '$22.95';
	productCfgArr['sellPrice']['db'] = '$9.99';
  ...
  <div class="intro">
    ...
    <div class="addproclist clearfix">
      ...
      <dl id="sd">
        ...
        <dd><a href="#none" class="addbtn_disable" onclick="addToCart('sd');">ADD TO CART<span>$0</span></a></dd>
        <dd class="introduce">Get the Maximum Hard Drive Performance!</dd>
      </dl>      
      <dl id="db">
        <dt><img src="<?php echo $pResUrl; ?>img/boxshot_db.jpg" alt="" /></dt>
        <dd class="name">Driver Booster PRO</dd>
        <dd class="price">$9.99 <del>$22.95</del></dd>
        <dd><a href="#none" class="addbtn" onclick="addToCart('db');">ADD TO CART<span>$9.99</span></a></dd>
        <dd class="introduce">Update Outdated Drivers Safely and Rapidly with One Click!</dd>
      </dl>
      <dl id="iu">
        <dt><img src="<?php echo $pResUrl; ?>img/boxshot_iu.jpg" alt="" /></dt>
        <dd class="name">IObit Uninstaller PRO</dd>
        <dd class="price">$0 <del>$19.99</del></dd>
        <dd><a href="#none" class="addbtn" onclick="addToCart('iu');">ADD TO CART<span>$0</span></a></dd>
    ...
    <div class="choosecart">
      ...
      <a href="http://www.iobit.com/buy.php?product=asc7sd&ref=2014julyascsd&aff=&refs=purchase_asc" id="buyButton" class="activebtn">Activate Now</a>
      ...
      <thead>
        <tr>
          ...
          <th class="itema">
            ...
            <a href="http://www.iobit.com/buy.php?product=asc71pc1477&ref=2014julyasc&aff=&refs=purchase_asc" class="tbbuybtn">Activate Now</a>
