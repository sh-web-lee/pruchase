        ...
        <div class="rightsharp"><img src="<?php echo $pResUrl; ?>img/rightsharp.png" alt="" /></div>
          <div class="introduce">
            <dl class="introtitle">
              ...
              <dd>Activate ASC Ultimate for 3 PCs today, get FREE Gift Pack your PC will adore! <span><em id="packs"><?php echo $packsNum; ?> Packs</em> Left Today!</span></dd>
            </dl>
          ...
          <div class="control">
            ...
            <div class="whatdo clearfix">
                ...
                <div class="right">
                	<dl class="clearfix">
                    	<dt><img src="<?php echo $pResUrl; ?>img/boxshot_additional.jpg"></dt>
