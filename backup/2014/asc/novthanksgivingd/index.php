...
<div class="bodytop">
  <div class="wrapper">
    <div class="header">
      ...
      <dl class="title">
        <dt>Happy Thanksgiving</dt>
        <dd>OUR THANKS TO YOU</dd>
      </dl>
    </div>
    <div class="intro">      
      ...
      <div class="addproclist clearfix">
        <dl class="introtitle">
          <dt>Save 80% on ASC PRO & Get Super Gift Pack for <span>FREE</span>!</dt>
          <dd>Activate ASC PRO for 3 PCs, and get IObit Uninstaller PRO, Smart Defrag PRO and AMC Security PRO for FREE. <span id="packs">18 Packs</span> Left Today!</dd>
        </dl>
        <dl class="mainproc">
          <dt><img src="<?php echo $pResUrl; ?>img/intro_boxshot_asc.jpg" alt="" /></dt>
          <dd>1 Year Subscription / 3 PCs</dd>
          <dd class="price">Only <span>$23.98</span> <del>$59.97</del></dd>
        </dl>
      ...
      <div class="choosecart">
        ...
        <dl class="mainproc">
          <dt>Boost PC up to 300% Faster</dt>
          <dd>ASC PRO  1 year / 3 PCs</dd>
          <dd class="price">Only: <span>$23.98</span> <del>$59.97</del></dd>
        </dl>
        <p class="addicon"><img src="<?php echo $pResUrl; ?>img/icon_add.png" alt="" /></p>
        <dl class="chooseproc">
          <dt id="additionName">Super Gift Pack</dt>
          <dd class="price"><span id="additionSellPrice">$0</span> <del id="additionListPrice">$59.97</del></dd>
        </dl>
        <a href="http://www.iobit.com/buy.php?product=asc8iusdamc&ref=2014thanksgivingascb&aff=&refs=purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase-201411');" id="buyButton" class="activebtn">Activate Now</a>
        <p class="total">Total: <span id="totalSellPrice">$23.98</span> <del id="totalListPrice">$119.94</del></p>
      ...
      <tfoot>
        <tr>
          ...
          <th class="itema"><span>Advanced SystemCare PRO</span><br />
            <a href="http://www.iobit.com/buy.php?product=asc8iusdamc&ref=2014thanksgivingascb&aff=&refs=purchase_asc"  onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase-201411');" class="tbbuybtn">Activate Now</a></p>
          </th>
        </tr>
      </tfoot>
    </table>
...
<div id="float">
    <div class="wrapper">
        ...
        <dl class="paybox">
            ...
            <dd><a href="http://www.iobit.com/buy.php?product=asc8iusdamc&ref=2014thanksgivingascb&aff=&refs=purchase_asc"  onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase-201411');" class="btnactivate">Activate Now</a></dd>
        </dl>
    </div>
</div>
<script type="text/javascript">
