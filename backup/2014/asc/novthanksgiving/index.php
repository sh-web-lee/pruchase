	...
	<div class="wrapper">
    	<div class="content">
            ...
            <div class="header clearfix">
            	<h2>Happy Thanksgiving<span>OUR THANKS TO YOU</span></h2>
                <dl>
            ...
            <div class="middle">
                ...
                <dl class="button">
                	<dt>Only <span>$21.98</span> <del>$119.94</del></dt>
                    <dd>
                    	<em></em>
                    	<a href="http://www.iobit.com/buy.php?product=asc8iusdamc&ref=2014thanksgivingascb&aff=&refs=purchase_asc"  onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase-201411');" class="btnactivate">Activate Now</a>
                        <p><span><?php echo $buyNum; ?></span> people activated</p>
                    </dd>
                </dl>
                <dl class="payment">
                	<dt>100% Money-back Guarantee within 60 Days</dt>
                    <dd><img src="<?php echo $pResUrl; ?>img/payment.png" alt="" /></dd>
                </dl>
                <a href="http://www.iobit.com/buy.php?product=asc8iusdamc&ref=2014thanksgivingascb&aff=&refs=purchase_asc"  onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase-201411');" class="floatbtn"></a>
            </div>
        </div>
    </div>
</div>
...
<div class="wrapper">
  ...
  <div class="giftpack">
  	...
  	<dl>
        ...
        <dd class="price"><span>$0</span> <del>$19.99</del></dd>
    </dl>
    <dl>
  ...
  <div class="payments">
    ...
    <dl class="price">
        <dt>Now <span>$21.98</span></dt>
        <dd>Valued at $119.94</dd>
    </dl>
    <div class="clear"></div>
  </div>
  <dl class="awards">
...
<div id="float">
    <div class="wrapper">
        ...
        <dl class="paybox">
            <dt>Only<span>$21.98</span> <del>Original:$119.94</del></dt>
            <dd><a href="http://www.iobit.com/buy.php?product=asc8iusdamc&ref=2014thanksgivingascb&aff=&refs=purchase_asc"  onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase-201411');" class="btnactivate">Activate Now</a></dd>
        </dl>
    </div>
</div>
