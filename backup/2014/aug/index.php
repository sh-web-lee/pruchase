...
<link type="text/css" rel="stylesheet" href="<?php echo $pResUrl; ?>css/style.css?201410131738"/>
...
function addToCart(product){
	...
	productCfgArr['buyUrl']['amc'] = 'http://www.iobit.com/buy.php?product=asc7amc&ref=2014octascamc&aff=&refs=purchase_asc';
	productCfgArr['buyUrl']['iu'] = 'http://www.iobit.com/buy.php?product=asc7iu&ref=2014augasciu&aff=&refs=purchase_asc';
	productCfgArr['buyUrl']['sd'] = 'http://www.iobit.com/buy.php?product=asc7sd&ref=2014augascsd&aff=&refs=purchase_asc';
...
<div class="wrapper">
  ...
  <div class="intro">
    <h2>Save 80% on ASC PRO & Choose a PRO Gift for <span>FREE</span>！</h2>
    ...
    <div class="addproclist clearfix">
      <p>Activate ASC PRO for 3 PCs, and get one of the three PRO products with $0!</p>
      <dl class="mainproc">
      ...
      <dl class="addproc" id="amc">
        ...
        <dd class="price">$0 <del>$19.99</del></dd>
        <dd><a href="#none" class="addbtn_a" onclick="addToCart('amc');"></a></dd>
    ...
    <div class="choosecart">
      ...
      <a href="http://www.iobit.com/buy.php?product=asc7sd&ref=2014augascsd&aff=&refs=purchase_asc"  onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase-201408');" id="buyButton" class="activebtn">Activate Now</a>
      ...
      <thead>
        <tr>
          ...
          <th class="itema">
            ...
            <a href="http://www.iobit.com/buy.php?product=asc71pc1477&ref=2014augasc&aff=&refs=purchase_asc" onclick="ga('send', 'event', 'ascbuy', 'buy', 'ascpurchase-201408compare');" class="tbbuybtn">Activate Now</a>
