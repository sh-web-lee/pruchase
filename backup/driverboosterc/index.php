<?php
	...
	if (empty($_GET['ref'])) $_GET['ref'] = 'dbxmas';
?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>IObit X'mas Special Offer</title>
...
<div id="main">
	<div class="floatlayer" id="floatlayer">
		<div class="moneyback"> You're fully protected by our 100% money back guarantee and you WILL see a significant improvement in your PC's performance WITHIN 60 DAYS, or we'll send you a full refund. No questions asked. <a href="http://www.iobit.com/buy.php?product=dbsdebook2&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>">Upgrade Now</a> </div>
		<div class="btn"> <span>Original <del>$116.83</del> Now $22.95</span> <a href="http://www.iobit.com/buy.php?product=dbsdebook2&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" title="Purchase Driver Booster PRO to get Smart Defrag for FREE!" class="checkbtn">Checkout >></a> 
	...
	<div class="mbody">
		<h1>Save 80%, Get Our Holiday Gift Pack & Share it with Your Family! </h1>
		<div class="procdetail">
			...
			<div class="freebox">
				...
				<dl>
					...
					<dd><span>Smart Defrag </span>Get the Maximum Hard Drive Performance!</dd>
				</dl>
			</div>
				...
				<tr>
					...
					<td width="268">
						<div class="buyarea">
							...
							<a href="http://www.iobit.com/buy.php?product=dbsdebook2&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" class="buybtn" title="Purchase Driver Booster PRO to get Smart Defrag for FREE!">Active Now</a>
		      ...
		      <tfoot>
		        <tr>
		          ...
		          <th class="itema"><span>Driver Booster PRO</span><br />
		            <a href="http://www.iobit.com/buy.php?product=dbsdebook2&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" class="tbbuybtn" >Buy Now</a> </th>
		        </tr>
		      </tfoot>
		  </table>
	    </div>
