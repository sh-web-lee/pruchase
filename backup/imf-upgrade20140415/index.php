<?php
    ...
    if (empty($_GET['ref'])) $_GET['ref'] = 'imf20143rdbday';
?>
...
<div id="main">
	<div class="floatlayer" id="floatlayer">
		<div class="moneyback"> You're fully protected by our 100% money back guarantee and you WILL see a significant improvement in your PC's performance WITHIN 60 DAYS, or we'll send you a full refund. No questions asked. <a href="http://www.iobit.com/buy.php?product=imfpfebook&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_imf">Upgrade Now</a> </div>
		<div class="btn"> <span>Original <del>$64.88</del> Now $19.95</span> <a href="http://www.iobit.com/buy.php?product=imfpfebook&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_imf" title="Purchase IObit Malware Fighter PRO to get Protected Folder for FREE!" class="checkbtn">Checkout >></a> 
	...
	<div class="mbody">
		<h1>Save <span>70%</span>, Get Extra Protection for Your PC Security!</h1>
		<div class="procdetail">
			<div class="salebox">
				<span class="iconsale"></span>
				<dl>
					<dt><a href="http://www.iobit.com/buy.php?product=imfpfebook&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_imf"><img src="img/boximf.png" alt="" /></a></dt>
				...
				<tr>
					...
					<td width="268">
						<div class="buyarea">
							...
							<a href="http://www.iobit.com/buy.php?product=imfpfebook&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_imf" class="buybtn" title="Purchase IObit Malware Fighter PRO to get Protected Folder for FREE!">Active Now</a>
		      ...
		      <tfoot>
		        <tr>
		          ...
		          <th class="itema"><span>IObit Malware Fighter PRO</span><br />
		            <a href="http://www.iobit.com/buy.php?product=imfpfebook&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_imf" class="tbbuybtn" >Buy Now</a><br />
					</span>
		        </th>
		        </tr>
		      </tfoot>
