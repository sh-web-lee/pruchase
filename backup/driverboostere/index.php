<?php
	...
	if (empty($_GET['ref'])) $_GET['ref'] = 'db2014marchc';
?>
...
<div id="main">
  <div class="floatlayer" id="floatlayer">
    ...
    <div class="btn"> <span>Original <del>$104.83</del> Now $24.95</span> <a href="http://www.iobit.com/buy.php?product=dbsdebook&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_db" title="Purchase Driver Booster PRO to get Smart Defrag for FREE!" class="checkbtn">Checkout >></a>
      <div class="countdown"> Hurry! Offer Valid Before <span id="counttime1"></span></div>
    </div>
  </div>
  <div class="head">
    <div id="lang"><span id="google_translate_element"></span> </div>
    <div class="logo"><a href="http://www.iobit.com"></a></div>
    <div class="warning"> Hurry! Offer Valid Before <span id="counttime">Mar. 7, 2014</span> </div>
  </div>
  <div class="mbody">
    <div class="ladybird"><img src="img/ladybird.png" alt="" /></div>
    <h1>Save 75% on Driver Booster PRO & Get Gifts your PC will adore!</h1>
      ...
      <table cellpadding="0" cellspacing="0" width="100%" class="pricetab">
        <tr>
          ...
          <td width="268"><div class="buyarea">
              ...
              <a href="http://www.iobit.com/buy.php?product=dbsdebook&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_db" class="buybtn" title="Purchase Driver Booster PRO to get Smart Defrag for FREE!">Active Now</a> <span>1 Year Subscription</span> </div></td>
...
<script type="text/javascript">
var timestamp = MApp(2.2).datetime.getTimestamp();
var datetime = MApp(2.2).datetime.get('dates', timestamp+3*24*60*60);
document.getElementById('counttime').innerHTML = datetime;
document.getElementById('counttime1').innerHTML = datetime;
</script>
</body>
</html>
