<?php
	...
	if (empty($_GET['ref'])) $_GET['ref'] = 'prexmas';
?>
...
k='73319726-63',d=document,l=d.location,c=d.cookie;
...
<div id="main">
  ...
  <div class="mbody">
    <div class="intro">
      ...
      <dl class="topbuy">
        <dt>Activate ASC PRO today, get Protected Folder, Smart Defrag PRO and Ashampoo Snap 7 for FREE! </dt>
        <dd>
          <div class="buyarea">
            <div class="count">
              <?php
