<?php
	...
	if (empty($_GET['ref'])) $_GET['ref'] = 'xmas';
?>
...
<div id="main">
  <div class="floatlayer" id="floatlayer">
    <div class="moneyback"> You're fully protected by our 100% money back guarantee and you WILL see a significant improvement in your PC's performance WITHIN 60 DAYS, or we'll send you a full refund. No questions asked. <a href="http://www.iobit.com/buy.php?product=asc7sdpfebook&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>">Upgrade Now</a> </div>
    <div class="btn"> <span>Original <del>$119.99</del> Now $23.98</span> <a href="http://www.iobit.com/buy.php?product=asc7sdpfebook&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" title="CHECKOUT" class="checkbtn">Checkout >></a>
  ...
  <div class="mbody">
    <div class="intro">
      ...
      <dl class="topbuy">
        <dt>Activate ASC PRO today, get Protected Folder, Smart Defrag and Windows Tweak Guide for FREE! </dt>
        <dd>
          <div class="buyarea">
            <div class="count">
              <?php
            ...
            <a href="http://www.iobit.com/buy.php?product=asc7sdpfebook&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" class="buybtn">Activate Now</a> <span>Today <em class="brownyellow">$23.98</em> <del>$119.99</del> </span> </div>
          <dl class="guarantee">
    ...
    <div class="procdetail">
      ...
      <div class="freebox" style="margin-top:15px;"> <span class="iconfree"></span>
        <dl>
          <dt><img src="img/boxshot_ebook.png" alt="" /></dt>
          <dd><strong>Windows Tweak Guide</strong> <br />
            Get rid of PC troubles with this step-by-step system optimization guide!<br />
            <em>$9.99</em></dd>
        </dl>
      </div>
    </div>
        ...
        <tfoot>
          <tr>
            ...
            <th class="itema"><span>Advanced Systemcare PRO</span><br />
              <a href="http://www.iobit.com/buy.php?product=asc7sdpfebook&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" class="tbbuybtn">Activate Now</a> </th>
          </tr>
        </tfoot>
      </table>
    </div>
