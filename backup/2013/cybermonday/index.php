<?php
	...
	if (empty($_GET['ref'])) $_GET['ref'] = '2013cyber';
?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>IObit CyberWeek Sale</title>
...
<div id="main">
  <div class="floatlayer" id="floatlayer">
    <div class="moneyback"> You're fully protected by our 100% money back guarantee and you WILL see a significant improvement in your PC's performance WITHIN 60 DAYS, or we'll send you a full refund. No questions asked. <a href="http://www.iobit.com/buy.php?product=asc7sdpfash&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>">Upgrade Now</a> </div>
    <div class="btn"> <span>Original <del>$119.99</del> Now $23.98</span> <a href="http://www.iobit.com/buy.php?product=asc7sdpfash&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" title="CHECKOUT" class="checkbtn">Checkout >></a>
  ...
  <div class="head">
    ...
    <div id="counttime" class="countdown"><span class="day">00</span><span class="hor">00</span><span class="min">00</span><span class="sec">00</span><span class="minsec">000</span></div>
  </div>
  <div class="mbody">
    <div class="intro">
      ...
      <dl class="topbuy">
        <dt>Activate ASC PRO today, get Protected Folder, Smart Defrag and Ashampoo Snap 6 for FREE! </dt>
        <dd>
          <div class="buyarea">
            <div class="count">
              <?php
            ...
            <a href="http://www.iobit.com/buy.php?product=asc7sdpfash&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" class="buybtn">Activate Now</a> <span>Today <em class="brownyellow">$23.98</em> <del>$119.99</del> </span> </div>
          <dl class="guarantee">
    ...
    <div class="conf">
      <dl>
        <dt><img src="img/giftbox.png" alt="" /></dt>
        <dd>IObit Once-per-year Offer, Limited for Cyber Week Only! 
    ...
    <div class="procdetail">
      ...
      <div class="freebox"> <span class="iconfree"></span>
        <dl>
          ...
          <dd><strong>Ashampoo Snap 6</strong> <br />
    ...
    <div class="clear"></div>
    <div class="pricebox">
      <p class="describe">Get all these four powerful tools today with the price of one! Offer limited for Cyber Week!<br />
        ...
        <tfoot>
          <tr>
            ...
            <th class="itema"><span>Advanced Systemcare PRO</span><br />
              <a href="http://www.iobit.com/buy.php?product=asc7sdpfash&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" class="tbbuybtn">Activate Now</a> </th>
          </tr>
        </tfoot>
      </table>
    </div>
...
var currentTimestamp = MApp(2.2).datetime.getTimestamp('2013-12-05 23:59:59');
var timezone = MApp(2.2).datetime.getTimeZone();
currentTimestamp -= (timezone-8)*60*60;
var countdownTime = MApp(2.2).datetime.get('datetime', currentTimestamp);
function countdown(){
	var datetime = MApp(2.2).datetime.getCountdown(countdownTime);
	if (datetime[0] == 0 && datetime[1] == 0 && datetime[2] == 0 && datetime[3] == 0 && datetime[4] == 0) return;
