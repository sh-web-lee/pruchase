<?php
    ...
    $end_time = strtotime('2013-11-04 23:59:59').'000';
	$pRootUrl = '../../';
...
var setArr = Array();
setArr['default'] = '';
setArr['ja'] = 'http://jp.iobit.com/lp/upgrade?ref=asc';
...
<div id="main">
	<div class="floatlayer" id="floatlayer">
		...
		<div class="btn"> <span>Original <del>$99.95</del> Now $19.99</span> <a href="http://www.iobit.com/buy.php?product=asc6sdpf&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" title="CHECKOUT" class="checkbtn">Checkout >></a>
	...
	<div class="head">
		...
		<div class="valid">Valid from Oct.16-Nov.4</div>
	</div>
	<div class="mbody">
				...
				<tr>
					...
					<td width="268">
						<div class="buyarea">
							...
							<a href="http://www.iobit.com/buy.php?product=asc6sdpf&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" class="buybtn">Buy Now</a>
