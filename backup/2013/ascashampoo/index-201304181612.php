				...
				<div class="bgwihte">
					<div class="textconns">
						<h3 style="width:210px">Gift for Your Family</h3>
						 <img src="img/g.png" alt="" />You can get additional support for <span>2 PCs and an eBook for Windows Tweak Guide</span> when you buy ASC today. Share it with your families and they’ll thank you for a lightning fast PC!
						<div class="clear"></div>
					</div>
					<div class="link">Original <span class="del">$59.97</span>&nbsp;&nbsp;&nbsp;<a href="http://www.iobit.com/buy.php?product=asc6ashampoo&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>">Get it now&gt;&gt;</a></div>
					<div class="clear"></div>
				</div>
			</div>
			<div class="clear"></div>
		...
		<div class="pricebox"> <a name="cart"></a>
			...
			<table cellpadding="0" cellspacing="0" width="100%" class="pricetab">
				...
				<tr>
					...
					<td class="topborder bf14">ASC Extra Support for 2 PCs</td>
					<td class="topborder f11">Get ultimate performance boost and full protection for 2 additional PCs with your license code. <a href="http://www.iobit.com/buy.php?product=asc6ashampoo&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>">Get it now>></a></td>
					<td class="tlborder bf16 center"><span class="price">$39.98<em></em></span></td>
					<td class="tlborder rborder bf16 center red">FREE</td>
				</tr>
				<tr>
					<td height="50" class="tlborder center"><img src="img/ebooks.png"/></td>
					<td class="topborder bf14">Windows Tweak Guide</td>
					<td class="topborder f11">Get the complete, step-by-step system optimization e-Book completely FREE when you upgrade to PRO today. <a href="http://www.iobit.com/buy.php?product=asc6ashampoo&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>">Get it now>></a></td>
