...
<title>Easter Special Offer- Save up to 70% Today!</title>
<link type="text/css" rel="stylesheet" href="style/2013easter.css" />
	...
	<div class="head">
		<div class="wrapper">
			<div id="lang"><span id="google_translate_element"></span> </div>
	  		...
	  		<h2>Easter Special Offer- Save up to <span>70%</span> Today!</h2>
		</div>
	</div>
	<div class="mainbody">			
					...
					<td width="350">
						<a href="http://www.iobit.com/buy.php?product=asc6ebook3pc3&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>">
							<table cellpadding="0" cellspacing="0" width="100%">
								...
								<tr>
									<td><a href="http://www.iobit.com/buy.php?product=asc6ebook3pc3&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" class="btnb">Get it Now<span></span></a></td>
								</tr>
							</table>
						</a>
