...
<title>Save 75% with our most popular Family Pack!</title>
...
<div id="main">
	<div class="floatlayer" id="floatlayer">
		<div class="maintxt">Save 75% with our most popular Family Pack! </div>
		<div class="btn"> <span>Original <del>$79.96</del> Now $19.99</span> <a href="http://www.iobit.com/buy.php?product=asc6ebook3pc3&ref=2013mar3" title="CHECKOUT" class="checkbtn">Checkout >></a> <span>100% money back guarantee</span> </div>
	</div>
	<div class="head">
		<div class="wrapper">
			<div id="lang"><span id="google_translate_element"></span> </div>
	  		<a href="http://www.iobit.com" class="homelink">Iobit</a>	
	  		<h2>Save 75% with our most popular Family Pack!</h2>		    
		</div>
	</div>
	<div class="mainbody">			
		...
		<div class="comprestab">
			...
			<table cellpadding="0" cellspacing="0" width="100%" class="compress">
				<tr>
					<td width="315">
						<a href="http://www.iobit.com/buy.php?product=asc61pc1297&ref=2013mar1">
							<table cellpadding="0" cellspacing="0" width="100%">
								...
								<tr>
									<td><a href="http://www.iobit.com/buy.php?product=asc61pc1297&ref=2013mar1" class="btna">Get it Now</a></td>
								</tr>
							</table>
						</a>
					</td>
					<td width="350">
						<a href="http://www.iobit.com/buy.php?product=asc6ebook3pc3&ref=2013mar3">
							<table cellpadding="0" cellspacing="0" width="100%">
								<tr>
								...
								<tr>
									<td><a href="http://www.iobit.com/buy.php?product=asc6ebook3pc3&ref=2013mar3" class="btnb">Get it Now<span></span></a></td>
								</tr>
							</table>
						</a>
				...
				<tr>
					<td class="lists">&nbsp;</td>
					<td class="lists" valign="middle"><img src="img/icons.png">&nbsp;&nbsp;<strong class="c_yellow">$10.99</strong> Live Setup Guide&nbsp;&nbsp;<sup>FREE</sup></td>
				</tr>
				<tr>
					<td class="lists"><del>$19.99</del>&nbsp;&nbsp;Save 35%</td>
					<td class="lists"><del>$79.96</del>&nbsp;&nbsp;Save <strong class="c_yellow">75%</strong></td>
				</tr>
			</table>
		</div>
		<div class="awards">
