<?php
	...
	if (empty($_GET['ref'])) $_GET['ref'] = 'asc6pf';
?>
...
k='73319726-47',d=document,l=d.location,c=d.cookie;
...
<title>IObit<?php echo date('F'); ?>Special Offer</title>
...
<div id="main">
  <div class="floatlayer" id="floatlayer">
    ...
    <div class="btn"> <span>Original <del>$99.91</del> Now $19.99</span> <a href="http://www.iobit.com/buy.php?product=asc6pf&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" title="CHECKOUT" class="checkbtn">Checkout >></a> <span>100% money back guarantee</span> </div>
  </div>
  <div class="head">
    <div id="lang"><span id="google_translate_element"></span> </div>
    <div class="logo"><a href="http://www.iobit.com"></a></div>
    <div class="maintitle"><?php echo date('F'); ?> Special Offer</div>
    <div class="savepoint">Save <span>80%</span>, Get 3 Fully Optimized PCs and the Best Folder Protection Tool! </div>
    <!-- <div class="countdown">
		  			<ul>
		    	<li id="leftD">--</li>
		    	<li id="leftH">--</li>
    ...
    <div class="intro left">
      <div class="salebox">
        ...
        <div class="bgwihte">
          ...
          <div class="link">Original <span class="del">$29.99</span> Now $19.99&nbsp;&nbsp;&nbsp;<a href="http://www.iobit.com/buy.php?product=asc6pf&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>">Get it now&gt;&gt;</a></div>
          <div class="clear"></div>
        </div>
      </div>
      <div class="freebox ml10 left">
        ...
        <div class="bgwihte">
          <div class="textconns">
            <h3 style="width:150px">Protected Folder</h3>
            <img src="img/pf_big.png" alt="" />Protected Folder protects your privacy and important data from theft, loss or leaks. Just drag and drop the files and folders into Protected Folder's safety box and your data is sealed!
            <div class="clear"></div>
          </div>
          <div class="link">Original <span class="del">$19.95</span>&nbsp;&nbsp;&nbsp;<a href="http://www.iobit.com/buy.php?product=asc6pf&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>">Get it now&gt;&gt;</a></div>
          <div class="clear"></div>
        </div>
      </div>
      <div class="freebox right">
        ...
        <div class="bgwihte">
          ...
          <div class="link">Original <span class="del">$49.97</span>&nbsp;&nbsp;&nbsp;<a href="http://www.iobit.com/buy.php?product=asc6pf&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>">Get it now&gt;&gt;</a></div>
          <div class="clear"></div>
        </div>
      </div>
      <div class="clear"></div>
      ...
      <table cellpadding="0" cellspacing="0" width="100%" class="pricetab">
        ...
        <tr>
          ...
          <td class="topborder f11">Boost your PC performance up to 300% and get full protection.<br />
            <a href="http://www.iobit.com/buy.php?product=asc6pf&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>">Get it now>></a></td>
          <td class="tlborder bf16 center"><span class="price">$29.99<em></em></span></td>
          <td class="tlborder rborder bf16 center red">$19.99</td>
        </tr>
        <tr>
          <td height="50" class="tlborder center"><img src="img/pf_small.png" alt="Protected Folder" /></td>
          <td class="topborder bf14">Protected Folder</td>
          <td class="topborder f11">With Protected Folder, you don't need to worry about Data Theft or Privacy Leaks any more!<br />
            <a href="http://www.iobit.com/buy.php?product=asc6pf&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>">Get it now>></a></td>
          <td class="tlborder bf16 center"><span class="price">$19.95<em></em></span></td>
        ...
        <tr>
          ...
          <td class="topborder f11">With your ASC license supporting extra 2 PCs and a system tweak guide, you can share the new PC feeling with families and friends now! <a href="http://www.iobit.com/buy.php?product=asc6pf&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>">Get it now>></a></td>
          <td class="tlborder bf16 center"><span class="price">$49.97<em></em></span></td>
          <td class="tlborder rborder bf16 center red">FREE</td>
        </tr>
        <tr>
          <td height="50" class="topborder center"></td>
          <td class="topborder myfont" colspan="2" align="right">Save 80% When You Purchase Today!(1 Year Subscription/3PCs)&nbsp;&nbsp;&nbsp;</td>
          <td class="tlborder bborder grybg bf16 center"><span class="price">$99.91<em></em></span></td>
          <td class="tlborder rborder bborder grybg bf16 center red">$19.99</td>
        </tr>
      </table>
    </div>
    <div class="checkout"> 
      <!-- <div class="moneyback"> You're fully protected by our 100% money back guarantee and you WILL see a significant improvement in your PC's performance WITHIN 30 DAYS, or we'll send you a full refund. No questions asked. <a href="http://www.iobit.com/buy.php?product=asc6pf&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>">Upgrade Now</a> </div> -->
      <dl class="callhelp">
      ...
      <div class="btn"> <a href="http://www.iobit.com/buy.php?product=asc6pf&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" title="CHECKOUT" class="checkbtn order_url">Check out >></a> <span>100% money back guarantee</span> </div>
    </div>
    <div class="clear"></div>
    <div class="awards">
