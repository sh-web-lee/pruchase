...
<div id="main">
	<div class="floatlayer" id="floatlayer">
		...
		<div class="btn"> <span>Original <del>$88.96</del> Now $19.99</span> <a href="http://www.iobit.com/buy.php?product=asc6ebook3pc4&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" title="CHECKOUT" class="checkbtn">Checkout >></a> <span>100% money back guarantee</span> </div>
	</div>
	<div class="head">
		<div class="wrapper">
	...
	<div class="mainbody">			
		...
		<div class="comprestab">
			...
			<table cellpadding="0" cellspacing="0" width="100%" class="compress">
				<tr>
					<td width="315">
						<a href="http://www.iobit.com/buy.php?product=asc61pc1477&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>">
							<table cellpadding="0" cellspacing="0" width="100%">
								<tr>
									<td><span class="itema_head">Single Solution</span></td>
								</tr>
								<tr>
									<td><span class="itema_price">$14.77 <em>1 year / 1 PC</em></span></td>
								</tr>
								<tr>
									<td><a href="http://www.iobit.com/buy.php?product=asc61pc1477&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" class="btna">Get it Now</a></td>
								</tr>
							</table>
						</a>
					</td>
					<td width="350">
						<a href="http://www.iobit.com/buy.php?product=asc6ebook3pc4&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>">
							<table cellpadding="0" cellspacing="0" width="100%">
								<tr>
								...
								<tr>
									<td><a href="http://www.iobit.com/buy.php?product=asc6ebook3pc4&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" class="btnb">Get it Now<span></span></a></td>
								</tr>
							</table>
						</a>
