<?php
	...
	if (empty($_GET['ref'])) $_GET['ref'] = 'thxgivinga7';
?>
...
k='73319726-60',d=document,l=d.location,c=d.cookie;
...
<title>IObit Thanksgiving Special Offer</title>
...
<div id="main">
  ...
  <div class="mbody">
    ...
    <div class="conf">
      <dl>
        <dt><img src="img/turkey.png" alt="" /></dt>
        <dd>IObit Once-per-year Offer, Limited for Thanksgiving Celebration Only! <br />
    ...
    <div class="clear"></div>
    <div class="pricebox">
      <p class="describe">Get all these four powerful tools today with the price of one! Offer limited for Thanksgiving Celebration!<br />
