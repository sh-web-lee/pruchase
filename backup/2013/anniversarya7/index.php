<?php
	...
	if (empty($_GET['ref'])) $_GET['ref'] = 'asc7sdpf';
?>
...
k='73319726-58',d=document,l=d.location,c=d.cookie;
...
<link type="text/css" rel="stylesheet" href="./style/style.css?201311041807" />
...
<div id="main">
	<div class="floatlayer" id="floatlayer">
		<div class="moneyback"> You're fully protected by our 100% money back guarantee and you WILL see a significant improvement in your PC's performance WITHIN 60 DAYS, or we'll send you a full refund. No questions asked. <a href="http://www.iobit.com/buy.php?product=asc7sdpf&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>">Upgrade Now</a> </div>
		<div class="btn"> <span>Original <del>$99.95</del> Now $19.99</span> <a href="http://www.iobit.com/buy.php?product=asc7sdpf&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" title="CHECKOUT" class="checkbtn">Checkout >></a>
				...
				<tr>
					...
					<td width="268">
						<div class="buyarea">
							...
							<a href="http://www.iobit.com/buy.php?product=asc7sdpf&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" class="buybtn">Buy Now</a>
