  ...
  <div id="popout_lightbox">
    <div class="box_btp">
    	<dl>
    		...
    		<dd class="tips">This offer is limited for <span id="countHiddendPopoutTime">60</span> seconds only!</dd>
    	</dl>
    </div>
    <div class="box_mid">
      <div class="leftbox">
      	<dl>
      		<dt><img src="img/leftpack.png" alt="" /><br /><span>IObit Malware Fighter<br />PRO</span></dt>
      		<dd><div class="namebox"><span>Single Solution</span></div></dd>
      		<dd class="newprice">Only $14.77</dd>
      		<dd class="oldprice">Original <del>$19.95</del> 1 Year / 1 PC</dd>
      		<dd><a href="http://www.iobit.com/buy.php?product=imf-update&ref=imf2014newyearpop&aff=<?php echo $_GET['aff']; ?>" class="txtlink">Buy Now</a></dd>
      	</dl>
      </div>
      <div class="rightbox">
      	<dl>
      		<dt><img src="img/rightpack.png" alt="" /></dt>
      		<dd><div class="namebox"><span>Gift Pack</span></div></dd>
      		<dd class="newprice">Only $19.95</dd>
      		<dd class="oldprice">Original <del>$64.88</del> 1 Year / 1 PC</dd>
      		<dd>
      			<div class="light_btnarea">
			        <a href="http://www.iobit.com/buy.php?product=imfpfebook&ref=imf2014newyearpop&aff=<?php echo $_GET['aff']; ?>" class="light_checkbtn"><span>Secure PC for only $0.05/day</span></a>
			        <div class="callorder">
			        	Or Call to Order: <span>1-855-855-6343</span><em>Toll-Free 7*24</em>
	      			</div>	      			
		        </div>
      		</dd>
      	</dl>
      </div>   
      <a href="#" class="pop_skip" onclick="hiddenDiscount();">Skip</a>
      <div class="clear"></div>
    </div>    
  </div>
