<?php
	...
	if (empty($_GET['ref'])) $_GET['ref'] = 'db2014newyear';
?>
...
function showDiscount(){
	...
	MApp(2.2).cookie.set('driverboosterd', '1');
}
$(function () {
	...
	var discountPurchase = MApp(2.2).cookie.get('driverboosterd');
  ...
  <div id="popout_lightbox">
    ...
    <div class="box_mid">
      <div class="leftbox">
      	<dl>
      		...
      		<dd class="price">Only <strong>$22.95</strong> Original <del>$75.99</del> 1 Year / 3 PCs</dd>
      		<dd><a href="http://www.iobit.com/buy.php?product=driver-booster4&ref=db2014newyearpop&aff=<?php echo $_GET['aff']; ?>" class="txtlink">Get Single Solution </a></dd>
      	</dl>
      ...
      <div class="rightbox">
      	<dl>
      		...
      		<dd></dd>
      		<dd class="price">Only <strong>$24.95</strong> Original <del>$104.83</del> 1 Year / 3 PCs</dd>
      		<dd>
      			<div class="light_btnarea">
			        <a href="http://www.iobit.com/buy.php?product=dbsdebook&ref=db2014newyearpop&aff=<?php echo $_GET['aff']; ?>" class="light_checkbtn"><em><img src="img/giftbox.png" alt="" /></em><span>Get Gift Pack</span></a>	       
		        </div>
    ...
    <div class="box_btm">
    	<ul>
    		...
    		<li class="callorder">Or Call to Order: <span>1-855-336-3824</span> (Toll-Free 7*24)</li>
...
<div id="main">
  <div class="floatlayer" id="floatlayer">
    <div class="moneyback"> You're fully protected by our 100% money back guarantee and you WILL see a significant improvement in your PC's performance WITHIN 60 DAYS, or we'll send you a full refund. No questions asked. <a href="http://www.iobit.com/buy.php?product=dbsdebook&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>">Upgrade Now</a> </div>
    <div class="btn"> <span>Original <del>$104.83</del> Now $24.95</span> <a href="http://www.iobit.com/buy.php?product=dbsdebook&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" title="Purchase Driver Booster PRO to get Smart Defrag for FREE!" class="checkbtn">Checkout >></a>
  ...
  <div class="mbody">
    <h1>Save 75%, Get Our Holiday Gift Pack & Share it with Your Family! </h1>
    <div class="procdetail">
      <div class="salebox"> <span class="iconsale"></span>
        <dl>
          <dt><img src="img/boxdb.png" alt="" /></dt>
    ...
    <div class="pricebox">
      <table cellpadding="0" cellspacing="0" width="100%" class="pricetab">
        <tr>
          ...
          <td width="268"><div class="buyarea">
              <div class="count">
                <?php
              ...
              <a href="http://www.iobit.com/buy.php?product=dbsdebook&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" class="buybtn" title="Purchase Driver Booster PRO to get Smart Defrag for FREE!">Active Now</a> <span>1 Year Subscription</span> </div></td>
        ...
        <tfoot>
          <tr>
            ...
            <th class="itema"><span>Driver Booster PRO</span><br />
              <a href="http://www.iobit.com/buy.php?product=dbsdebook&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>" class="tbbuybtn" >Buy Now</a> </th>
          </tr>
        </tfoot>
      </table>
    </div>
...
function cycleCountdown(){
	...
	//document.getElementById('counttime2').innerHTML = d+'d : '+h+'h : '+i+'m : '+s+'s';
