  ...
  function soldout() {
    ...
    $(".floatlayer .number").html("<h2>80% OFF</h2> <p>Fully protect and optimize your PC!</p>");
    $(".floatlayer .price p").html("<strong> $9.99</strong> <del>$49.99</del>");
    $(".banner .message p:eq(1),.gift-message").remove();
    var soldhref = "https://www.iobit.com/buy.php?product=ascu14999&ref=en-ascu3pcsoldoutcd6m" + refStr + "&aff=" + aff + "&refs=purchase_ascu&tw=" + tw;
    var soldga = "ga('send', 'event', 'ascusoldoutbuy', 'buy', 'ascupurchase-999');  "
  ...
  $(function() {
    ...
    if (paramTo != 'buyascu') {
      var maskStatus = cGet('enascuxmas2020cdm_s');
      if (maskStatus != -1) {
  ...
  function getReTime() {
    var packsNumTotal = cGet('enascuxmas2020cdm_t');
    if (packsNumTotal > 1) {
