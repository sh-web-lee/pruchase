  ...
  function soldout() {
    if (typeof discountArr == 'undefined') {
      discountArr = ['40', '$29.99', 'ascu14', '-$20'];
    } else {
      if (packs <= 0) {
    ...
    var soldhref = "https://www.iobit.com/buy.php?product=" + discountArr[2] + "&ref=en-ascu3pcsoldout" + refStr + "&aff=" + aff + "&refs=purchase_ascu&tw=" + tw;
  ...
  function popOut() {
    ...
    var soldhref = "https://www.iobit.com/buy.php?product=ascu142699&ref=en-ascu3pc2699soldoutpop" + refStr + "&aff=" + aff + "&refs=purchase_ascu&tw=" + tw;
    var soldga = "ga('send', 'event', 'ascusoldpopbuy', 'buy', 'ascupurchase-201902');"
    $('.congrats-pop .buybtn').attr('href', soldhref);
    $('.congrats-pop .buybtn').attr('onclick', soldga);
  }
  ...
  $(document).ready(function() {
    ...
    $('.pop-rc-close').on("click", function() {
      $('.pop-rc').remove();
    });
  });
  ...
  $(function() {
    ...
    if (paramTo != 'buyascu') {
      var maskStatus = cGet('enascuxmas2020_s');
      if (maskStatus != -1) {
  ...
  function getReTime() {
    var packsNumTotal = cGet('enascuxmas2020_t');
    if (packsNumTotal > 1) {
  ...
  function timeInit() {
    if (cGet('enascuxmas2020_s') == -1) {
      ...
      var date = new Date();
      var cName = "enascuxmas2020_c";
      var arr = cGet("enascuxmas2020_c");
