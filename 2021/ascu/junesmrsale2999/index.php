...
if ($_GET['action'] == 'getPacks') {
  $date = $_GET['d'];
  $c_name = 'enascuxmas2020_p' . $date;
  $c_name_t='enascuxmas2020_t' . $date;
...
$refStr .= empty($_GET['st']) ? '-unknown' : '-'.$_GET['st'];
$refStr .= '-'.$ver;
...
$discountListArr = array(
  // 折扣比例、价格、购买链接标签
    '6m' => array('80', '$9.99', 'ascu14iusdpf999', '-$40', 'en-ascu14iusdpf999'.$refStr, 'ascu14999', 'en-ascu14soldout999'.$refStr), // 到期大于6个月 pro2
    '6' => array('74', '$12.99', 'ascu14iusdpf1299', '-$37', 'en-ascu14iusdpf1299'.$refStr, 'ascu141299', 'en-ascu14soldout1299'.$refStr), // 到期小于6个月 pro1
    'default' => array('40', '$29.99', 'ascu14iusdpf', '-$20','en-ascu14iusdpf2999'.$refStr,'ascu14','en-ascu14soldout2999'.$refStr),
    'title' => array(
        'um10trial' => array(
...
<head>
  ...
  <script type="text/javascript">
    function getDiscountInfo(codeType){
      $.ajax({
        type : 'post',
        url : './index.php?cd='+codeType+'&<?php echo $_SERVER['QUERY_STRING']?>',
        timeout: 5000,
        dataType : 'text',
...
<div class="banner">
  <div class="wrapper">
    ...
    <h2><i class="left"></i>Take <span class="my-num">40</span>% OFF + Free Gift Pack<i class="right"></i></h2>
    <div class="img-box discount40">
       <img src="<?php echo getStaticUrl('images/ascu-box1.png')?>" alt="" class="show">
	   <img src="<?php echo getStaticUrl('images/white.png')?>" alt="" class="white">
    ...
    <div class="message">
      ...
      <dl>
        <dt><a href="https://www.iobit.com/buy.php?product=ascu14iusdpf&ref=en-ascu3pciusdpf<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_ascu" onclick="ga('send', 'event', 'ascubundlebuy', 'buy', 'ascupurchase-201902');" class="buybtn change-buybtn">Activate Now</a></dt>
...
<div class="gift-message">
  ...
  <div class="wrapper clearfix">
    <dl>
      ...
      <dd>
      Remove Useless Programs & Plug-ins <br> <strong>for Cleaner PC</strong>
      </dd>
    </dl>
    <dl class="center">
      <dt>
    ...
    <a href="https://www.iobit.com/buy.php?product=ascu14iusdpf&ref=en-ascu3pciusdpf<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_ascu" onclick="ga('send', 'event', 'ascubundlebuy', 'buy', 'ascupurchase-201902');" class="buybtn change-buybtn">Get It Now</a>
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%">
      ...
      <tfoot>
        ...
        <th class="itemb">
          ...
          <a href="https://www.iobit.com/buy.php?product=ascu14iusdpf&ref=en-ascu3pciusdpf<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_ascu" onclick="ga('send', 'event', 'ascubundlebuy', 'buy', 'ascupurchase-201902');" class="buybtn change-buybtn">Activate Now</a>
        </th>
      </tfoot>
    </table>
  </div>
...
<div class="floatlayer">
  <div class="wrapper clearfix">
    ...
    <div class="price">
      <p></p>
      <a class="buybtn change-buybtn" href="https://www.iobit.com/buy.php?product=ascu14iusdpf&ref=en-ascu3pciusdpf<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_ascu" onclick="ga('send', 'event', 'ascubundlebuy', 'buy', 'ascupurchase-201902');">
        Get It Now
      </a>
    </div>
  </div>  
...
<div class="congrats-pop hide">
  ...
  <div class="message number">
    ...
    <a href="https://www.iobit.com/buy.php?product=ascu14iusdpf2699&ref=en-ascu3pciusdpf2699pop<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_ascu" onclick="ga('send', 'event', 'ascupopbuy', 'buy', 'ascupurchase-201902');" class="buybtn">Get It Now</a>
  </div>
</div>
<!-- <div class='popout'><p>ASCU v14 will recognize ASCU v13 license key as <strong>valid for ASCU v14.</strong></p></div> -->
