...
if ($_GET['action'] == 'getPacks') {
  $date = $_GET['d'];
  $c_name = 'enascuxmas2020cd6_p' . $date;
  $c_name_t='enascuxmas2020cd6_t' . $date;
...
<head>
  ...
  <title>74% OFF Advanced SystemCare Ultimate</title>
...
<div class="banner">
  <div class="wrapper">
    ...
    <h2><i class="left"></i>Take <span class="percent">74</span>% OFF + Free Gift Pack<i class="right"></i></h2>
    <div class="img-box discount74">
      <img src="<?php echo getStaticUrl('images/ascu-box.png')?>" alt="" class="show">
    ...
    <div class="message">
      ...
      <p class="off">
        ...
        <strong> 74% OFF</strong> <span>-$37</span>
      </p>
      <p class="last">
        <strong> Total</strong> <span class="prime"> $12.99</span>
      </p>
      <dl>
        <dt><a href="https://www.iobit.com/buy.php?product=ascu14iusdpf1299&ref=en-ascu3pciusdpfcd6<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_ascu" onclick="ga('send', 'event', 'ascubuy', 'buy', 'ascupurchase-1299');" class="buybtn change-buybtn">Activate Now</a></dt>
...
<div class="gift-message">
  ...
  <div class="wrapper clearfix">
    ...
    <a href="https://www.iobit.com/buy.php?product=ascu14iusdpf1299&ref=en-ascu3pciusdpfcd6<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_ascu" onclick="ga('send', 'event', 'ascubuy', 'buy', 'ascupurchase-1299');" class="buybtn change-buybtn">Get It Now</a>
  ...
  <div class="ctable">
    <table border="0" cellspacing="0" cellpadding="0" width="100%">
      ...
      <tfoot>
        ...
        <th class="space"></th>
        <th class="itemb">
          <strong class="prime">$12.99</strong> <del>$49.99</del>
          <a href="https://www.iobit.com/buy.php?product=ascu14iusdpf1299&ref=en-ascu3pciusdpfcd6<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_ascu" onclick="ga('send', 'event', 'ascubuy', 'buy', 'ascupurchase-1299');" class="buybtn change-buybtn">Activate Now</a>
        </th>
      </tfoot>
    </table>
  </div>
  ...
  <div class="wrapper clearfix">
    ...
    <div class="number">
      <div class="countdown countdown2">
        <div class="scroll-tick"><span>1</span></div>
        <div class="scroll-tick"><span>0</span></div>
        <div class="scroll-tick"><span>0</span></div>
      </div>
    ...
    <div class="price">
      <p></p>
      <a class="buybtn change-buybtn" href="https://www.iobit.com/buy.php?product=ascu14iusdpf1299&ref=en-ascu3pciusdpfcd6<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_ascu" onclick="ga('send', 'event', 'ascubuy', 'buy', 'ascupurchase-1299');">
        Get It Now
      </a>
    </div>
  </div>  
