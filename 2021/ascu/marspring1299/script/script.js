  ...
  function soldout() {
    ...
    var soldhref = "https://www.iobit.com/buy.php?product=ascu141299&ref=en-ascu3pcsoldoutcd6" + refStr + "&aff=" + aff + "&refs=purchase_ascu&tw=" + tw;
  ...
  $(function() {
    ...
    if (paramTo != 'buyascu') {
      var maskStatus = cGet('enascuxmas2020cd6_s');
      if (maskStatus != -1) {
  ...
  function getReTime() {
    var packsNumTotal = cGet('enascuxmas2020cd6_t');
    if (packsNumTotal > 1) {
