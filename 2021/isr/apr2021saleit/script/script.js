...
function countInit(){
	var count;
	console.log(cGet('apr2021it'))
	var TIME_COUNT = cGet('apr2021it');
...
$('.font-layer ul li').click(function(){
	...
	var idx = $(this).index()
	if(idx === 0){
		$('.float-footer .heart').css({'background-position-y': '0'});
	} else if (idx === 1){
		$('.float-footer .heart').css({'background-position-y': '-200px'});
	} else {
		$('.float-footer .heart').css({'background-position-y': '-100px'});
	}
})

$('.offer-list .offer-wrap').click(function() {
	$('.offer-list .offer-wrap').removeClass('active')
	$(this).addClass('active')
	var idx = $(this).index()
	if (idx === 0) {
		$('#banner-box i').css({'background-position-y': '-200px'});
		$(this).next().css('margin-right', '-30px').css('margin-left', '0px');
	} else if (idx === 1) {
		$('#banner-box i').css({'background-position-y': '0'});
		$(this).css('margin', '0px');
	} else {
		$('#banner-box i').css({'background-position-y': '-100px'});
		$(this).prev().css('margin-left', '-30px').css('margin-right', '0px');
	}
})
