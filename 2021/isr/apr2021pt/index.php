...
<head>
  ...
  <title>Adquira iFun Screen Recorder com até 65% de desconto. Oferta Especial de Lançamento da IObit.</title>
  ...
  <?php echo $gJavascript ['head']?>
    ...
    <script>
        ...
        // pageDivide('maysale2021', 'maysale.php')
				...
				<div class="banner-option">
					...
					<ul>
						<li class="custom-radio">
							...
							<div class="sel-list">
								<p>Licença de 1 PC por 1 Ano (Inclui Novas Versões)</p>
						...
						<li class="custom-radio active">
							...
							<label>1 PC / Vitalício<i>-65%</i></label>
							<div class="sel-list">
								<p>Licença de 1 PC Vitalícia (para a Versão Atual)</p>
								<p>Remove a Marca d'Água e Adiciona Sua Própria Marca d’Água</p>
								<p>Grava em Alta Definição com Qualidade Blu-Ray</p>
								<p>Recomendado para Vídeo Aulas, Youtubers e Gamers.</p>
							</div>
					...
					<dl class="price">
						<dd>
							...
							<div class="getItNow">
								<a class="button"onclick="ga('send', 'event', 'isrbuy', 'buy', 'isr11pcpurchase2103-pt')" href="https://www.iobit.com/buy.php?product=pt-isr11pc8999&ref=pt_isr11pc8999purchase2103<?= $refStr; ?>&refs=pt_purchase_isr">Comprar Agora</a>
							</div>
						</dd>
						<dd style="display: block;">
							...
							<div class="getItNow">
								<a class="button" onclick="ga('send', 'event', 'isrbuy', 'buy', 'isr1lf1pcpurchase2103-pt')" href="https://www.iobit.com/buy.php?product=pt-isr1lf1pc16999&ref=pt_isr1lf1pc16999purchase2103<?= $refStr; ?>&refs=pt_purchase_isr">Comprar Agora</a>
							</div>
						</dd>
					</dl>
				</div>
				...
				<div class="versionPro">
					...
					<div class="buyPro">
						<div class="tableOptions">
							...
							<label for="option3">1 ano</label>
						</div>
						<div class="tableOptions">
							<input type="radio" name="tableOps" id="option4" value="2" checked="">
							<label for="option4">Vitalício</label>
						</div>
						<div class="optionsLink">

							<a class="button" id="planA" onclick="ga('send', 'event', 'isrbuy', 'buy', 'isr11pcpurchase2103-pt')" href="https://www.iobit.com/buy.php?product=pt-isr11pc8999&ref=pt_isr11pc8999purchase2103<?= $refStr; ?>&refs=pt_purchase_isr">Comprar Agora-$15.99</a>
							<a class="button" id="planB" onclick="ga('send', 'event', 'isrbuy', 'buy', 'isr1lf1pcpurchase2103-pt')" href="https://www.iobit.com/buy.php?product=pt-isr1lf1pc16999&ref=pt_isr1lf1pc16999purchase2103<?= $refStr; ?>&refs=pt_purchase_isr" style="display: block;">Comprar Agora-$29.99</a>
						</div>
					</div>
				</div>
			</div>
	...
	<div class="float-footer">
		<div class="content planA" style="display: block;">
			...
			<div class="font-layer">
				<ul>
					<li class="">1 ano / 1 PC <span>-60%</span></li>
					<li class="active">Vitalício / 1 PC <span>-65%</span></li>
				</ul>
			</div>
