					...
					<dl class="price">
						...
						<dd style="display: block;">
							...
							<div class="getItNow">
								...
								Pagar sólo <strong>US$1.9</strong> cada mes para el uso de <strong> 1 </strong> año.
							</div>
						</dd>
					</dl>
				</div>
				...
				<div class="versionPro">
					...
					<div class="buyPro">
						...
						<div class="optionsLink" id="planA" style="display: block;">
							...
							<!-- <p style="font-size: 12px; margin-top: 10px; text-align: center; line-height: 1.5;">Se necesitaría pagar 24,99US$ por uso <br />de 1 año y sólo 2.08US$ cada mes.</p> -->
						</div>
	...
	<div class="float-footer">
		<div class="content planA" style="display: block;">
			...
			<div class="font-layer">
				<ul>
					<li class="active">1 Año / 1 PC <span>-60%</span></li>
			...
			<div class="footer-btn">
				<dl class="price">
					<dd style="display: block;">
						...
						<a class="button" onclick="ga('send', 'event', 'isrbuy', 'buy', 'isr11pcpurchase2105usd2299-es')" href="https://www.iobit.com/buy.php?product=es-isr11pcusd2299&ref=es_isr11pcusd2299purchase2105<?= $refStr; ?>&refs=es_purchase_isr">Comprar Ahora</a>
						<!-- <p>Se necesitarían 24,99US$ para uso de 1 año.</p> -->
					</dd>
					<dd>
						<div class="now">
							<span class="symbol">US$</span>
