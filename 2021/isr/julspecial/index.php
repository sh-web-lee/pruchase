...
$buyUrl = 'https://www.iobit.com/buy.php?product=isr1y2699&ref=en-isr1y1pcspecial'.$refStr.'&aff='.$_GET['aff'].'&refs=purchase_isr';
...
<head>
  ...
  <title>Upgrade to iFun Screen Recorder PRO with 48% OFF to recorder your screen and webcam smoothly - IObit</title>
		...
		<div class="banner">
			...
			<div class="banner-cont">
				<div class="banner-option">
					<ul>
						<li class="fl">
							<div class="saveMark">Save<span>37%</span></div>
							...
							<a class="button" onclick="ga('send', 'event', 'isr1ybuy', 'buy', 'isrpurchasespecial')"
						...
						<li class="fr active">
							<div class="saveMark saveMark02">Save<span>48%</span></div>
							...
							<a class="button" onclick="ga('send', 'event', 'isrltbuy', 'buy', 'isrpurchasespecial')"
                               href=" https://www.iobit.com/buy.php?product=isrlifetime3599&ref=en-isrlt1pcspecial<?= $refStr; ?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_isr">Buy Now<i class="btn-arrow"></i></a>
							<div class="plan-list">
								<div class="plan-item">
									<i class="icon"></i>
			...
			<div class="versionTable">
				...
				<div class="versionMonth">
					<div class="topTitle">Annual Plan
						<a class="button-month" href="<?= $buyUrl; ?>" onclick="ga('send', 'event', 'isr1ybuy', 'buy', 'isrpurchasespecial')">Buy Now -<span style="font-size: 18px;">$26.99</span></a>
					</div>
					<ul> <li>1 Year</li> </ul>
				...
				<div class="versionPro">
					<div class="topTitle">Lifetime Plan
						<a class="button-year" href=" https://www.iobit.com/buy.php?product=isrlifetime3599&ref=en-isrlt1pcspecial<?= $refStr; ?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_isr" onclick="ga('send', 'event', 'isrltbuy', 'buy', 'isrpurchasespecial')"><div>Buy Now -<span style="font-size: 18px;">$35.99</span></div></a>
					</div>
