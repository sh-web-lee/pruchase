          ...
          <ul class="animate__animated animate__fadeInLeft clearfix">
            <li class="one">
              ...
              <div class="price">
                ...
                <a 
                  class="buybtn normal" 
                  href="https://www.iobit.com/buy.php?product=asc141pc1677&ref=en-asc1pcjannewyear<?php echo $refStr?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_asc" 
            ...
            <li class="two sell">
              ...
              <div class="price">
                ...
                <a 
                  class="buybtn normal" 
                  href="https://www.iobit.com/buy.php?product=asc143pc1999&ref=en-asc3pcjannewyear<?php echo $refStr?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_asc" 
            ...
            <li class="three bigsell">
              ...
              <div class="price">
                ...
                <a 
                  class="buybtn sell" 
                  href="https://www.iobit.com/buy.php?product=asc143pc2398&ref=en-asc3pciusdpf<?php echo $refStr?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_asc" 
      ...
      <div class="wrapper">
        ...
        <div id="super-value-pack">
          ...
          <div class="pack-list">
            ...
            <div class="button">
              <a href="https://www.iobit.com/buy.php?product=asc143pc2398&ref=en-asc3pciusdpf<?php echo $refStr?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_asc" onclick="ga('send', 'event', 'asc2398buy', 'buy', 'ascpurchase-2021newyear')">
        ...
        <div class="box-bottom">
          ...
          <div>
            ...
            <div style="text-align: center; padding-left: 5px;">
              <a
                href="https://www.iobit.com/buy.php?product=asc145pc1975&ref=en-asc5pcpopjannewyear<?php echo $refStr?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_asc"
      ...
      <div class="tc-box animate__animated animate__bounceIn tc2">
        ...
        <div class="box-bottom">
          ...
          <div>
            ...
            <div style="text-align: center;padding-left: 5px;">
              <a
                href="https://www.iobit.com/buy.php?product=asc143pc2198a&ref=en-asc3pcpopiusdpf<?php echo $refStr?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_asc"
