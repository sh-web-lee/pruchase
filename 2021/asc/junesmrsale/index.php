...
$refStr .= empty($_GET['k']) ? '' : '-' . $_GET['k'];
$refStr .= empty($_GET['c']) ? '' : '-' . $_GET['c'];
  ...
  <div id="container">
    ...
    <div id="product-list" class="do">
      <div class="wrapper">
        ...
        <div class="title-logo">
          ...
          <div class="newadd-text">
            <span>only for our loyal users</span>
          </div>
        </div>
        <div class="product-content">
          <ul class="animate__animated animate__fadeInLeft clearfix">
            <li class="one">
              <div class="imgbox">
                <p class="tag">1 PC / YEAR</p>
                <img src="<?php echo getStaticUrl('images/asc-boxone.png')?>" alt=""/>
                <div class="discount"><strong>45% OFF</strong></div>
              </div>
              <div class="price">
                <p><strong><small>$</small>16.77</strong> <del>$29.99</del></p>
                <a 
                  class="buybtn normal" 
                  href="https://www.iobit.com/buy.php?product=asc151pc1677&ref=en-asc1pcjannewyear<?php echo $refStr?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_asc" 
                  onclick="ga('send', 'event', 'asc1677buy', 'buy', 'ascpurchase-2021newyear')"
                >
                  Activate Now
                </a>
                <p>Only $1.40 / Month</p>
                <p class="save">Save $13.22 </p>
              </div>
            </li>
            <li class="two sell">
              <div class="imgbox">
                <p class="tag">3 PCs / YEAR</p>
                <img src="<?php echo getStaticUrl('images/asc-boxone.png')?>" alt=""/>
                <div class="discount"><strong>45% OFF</strong></div>
              </div>
              <div class="price">
                <p><strong><small>$</small>19.99</strong> <del>$89.97</del></p>
                <a 
                  class="buybtn normal" 
                  href="https://www.iobit.com/buy.php?product=asc153pc1999&ref=en-asc3pcjannewyear<?php echo $refStr?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_asc" 
                  onclick="ga('send', 'event', 'asc1999buy', 'buy', 'ascpurchase-2021newyear')"
                >
                  Activate Now
                </a>
                <p>Only $1.66 / Month</p>
                <p class="save">Save $69.98</p>
              </div>
            </li>
            <li class="three bigsell">
              <div class="imgbox">
                <p class="tag">Super Value Pack</p>
                <img src="<?php echo getStaticUrl('images/asc-box-giftsone.png')?>" alt=""/>
                <div class="discount"><strong>45% OFF</strong></div>
                <div class="top-cover"><p>Hurry! Only <span class="num">100</span> Left Today!</p></div>
              </div>
              <div class="price">
                <p><strong><small>$</small>23.98</strong> <del>$149.90</del></p>
                <a 
                  class="buybtn sell" 
                  href="https://www.iobit.com/buy.php?product=asc153pc2398&ref=en-asc3pciusdpf<?php echo $refStr?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_asc" 
                  onclick="ga('send', 'event', 'asc2398buy', 'buy', 'ascpurchase-2021newyear')"
                >
                  Activate Now
                </a>
                <p>Only $1.99 / Month</p>
                <p class="save">Save $125.92</p>
              </div>
            </li>
          </ul>
        </div>
    ...
    <div class="center-bg">
      <div class="wrapper">
              ...
              <div class="cover">
                <ul>
                  ...
                  <li>
                    ...
                    <p>Proactively prevent online tracking and block untrusted access</p>
                    <p>to personal data to fully protect your privacy.</p>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <ul>
            <li>
              ...
              <div class="li-bottom">
                <h2>Auto Clean</h2>
                <p>
                 junk files and registry to <br> make PC run faster.
                </p>
              </div>
            </li>
            <li>
            ...
            <li>
              ...
              <div class="li-bottom">
                <h2>Auto Update</h2>
                <p>
                 your critical software to avoid <br> security holes.
                </p>
              </div>
            </li>
          </ul>
          ...
          <div class="pack-list">
            <ul>
              <li>
                ...
                <span>Remove Useless Programs & Plug-ins <i style="color: #ff3d1d;">for Cleaner PC</i></span>
              </li>
              <li>
            ...
            <div class="button">
              <a href="https://www.iobit.com/buy.php?product=asc153pc2398&ref=en-asc3pciusdpf<?php echo $refStr?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_asc" onclick="ga('send', 'event', 'asc2398buy', 'buy', 'ascpurchase-2021newyear')">
        ...
        <h2 class="review-h2">Users and Media Review</h2>
      </div>
    </div>
        ...
        <div class="comments">
          ...
          <div class="comments-content">
            ...
            <li class="on">
              ...
              <li>
                <p>"Advanced system care 15 is the most complete all in one system on the market. I've been using the
              ...
              <li>
                <p>"I have purchased many different software programs to speed up and fix problems with my PC.
                  ...
                  Care 15. I love that there are so many options and solutions to fix any problem. It's amazing how much
                  faster my PC is now after the first scan and repair. Definitely the best product I have come across."
                </p>
                <h3>Lyle Stelmaschuk</h3>
              </li>
              <li>
                <p>"I love using Advanced SystemCare 15 Beta. It is fast. It cleans up privacy traces, junk files and
              ...
              <li>
                <p>"I have been using ASC for years now. I have recently tested the latest version V15. And it is by far
              ...
              <li>
                <p>"The features in Advanced System Care (ASC) 15 are awesome and the overall appearance is clean,
                  fresh, and modern. I have used other all-in-one system maintenance programs, but none have been as
                  effective as ASC 15. The program reduces and eliminates the use of non-essential resources which allow
                  your computer to run cooler and more efficiently. This product is amazing and the best in class. If
                  you care about your laptop or pc, use Advanced System Care 15!"</p>
                <h3>Anthony Baker</h3>
              </li>
            </ul>
          </div>
    ...
    <div class="floatlayer animate__animated animate__fadeInUp">
      <div class="wrapper clearfix">
        <div class="imgbox">
          <img src="<?php echo getStaticUrl('images/asc-box-gifts.png')?>" alt=""/>
          <!-- <div class="discount"><strong>85% OFF</strong></div> -->
        </div>
        <div class="countDown">
          <div class="box">
            <div class="bai">
    ...
    <div class="tc">
      <div class="tc-box animate__animated animate__bounceIn tc1" style="display: none;">
        ...
        <div class="box-top">
          ...
          <div class="img-posi">
            <img src="<?php echo getStaticUrl('images/lucky-you.png')?>" alt="" width="235">
          </div>
        </div>
        <div class="box-bottom">
          ...
          <div>
            ...
            <div style="text-align: center; padding-left: 5px;">
              <a
                href="https://www.iobit.com/buy.php?product=asc153pc2198a&ref=en-asc3pcpopiusdpf<?php echo $refStr?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_asc"
      ...
      <div class="tc-box animate__animated animate__bounceIn tc2">
        ...
        <div class="box-top">
          ...
          <div class="img-posi">
            <img src="<?php echo getStaticUrl('images/lucky-you.png')?>" alt="" width="258" />
          </div>
        </div>
        <div class="box-bottom">
          <img src="<?php echo getStaticUrl('images/3pcs.png')?>" alt="" width="248" height="155">
          <div>
            <p>Hurry! This Offer Ends in <span class="shi1">6</span><span class="fen1">0</span> s</p>
            <ul>
              <li>
