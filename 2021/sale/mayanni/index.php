  ...
  <link rel="icon" href="<?php echo $pRootUrl; ?>tpl/img/favicon.ico" mce_href="<?php echo $pRootUrl; ?>tpl/img/favicon.ico" type="image/x-icon">
    ...
    <?php echo $gJavascript ['head']?>
      <script>
          ...
          var queryStr = <?php echo empty($_SERVER['QUERY_STRING'])?'""':('"?'.$_SERVER['QUERY_STRING']).'"';?>;
          // if($.inArray(paramRef, ['navi_icon', 'navi_banner', 'pbanner', 'popbanner']) === -1) window.location.replace('anniversaryb.php' + queryStr);
          ...
          <div class="banner-cont">
            ...
            <div class="m-product">
              ...
              <div class="m-price">
                ...
                <a class="btn" href="https://www.iobit.com/buy.php?product=ascdbiuimfisusd3299&ref=en-ascdbiuimfisusdanniversary<?php echo $refStr ?>&aff=<?php echo $_GET['aff'] ?>&refs=purchase_anni" onclick="ga('send', 'event', 'bpackbuy', 'buy', 'purchase-2021anni')">Buy Now</a>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="pack-list">
              <div class="pack-item">
                <dl>
                  ...
                  <dd>
                    <a class="btn" href="https://www.iobit.com/buy.php?product=2020ascdbiu3292&ref=en-ascdbiuanniversary<?php echo $refStr ?>&aff=<?php echo $_GET['aff'] ?>&refs=purchase_anni" onclick="ga('send', 'event', 'ascdbiubuy', 'buy', 'purchase-2021anni')">Buy Now</a>
                  </dd>
                </dl>
              </div>
              <div class="pack-item">
                <dl>
                  ...
                  <dd>
                    <a class="btn" href="https://www.iobit.com/buy.php?product=2021ascdbisu2922&ref=en-ascdbisuanniversary<?php echo $refStr ?>&aff=<?php echo $_GET['aff'] ?>&refs=purchase_anni" onclick="ga('send', 'event', 'ascdbisubuy', 'buy', 'purchase-2021anni')">Buy Now</a>
                  </dd>
                </dl>
              </div>
              <div class="pack-item">
                <dl>
                  ...
                  <dd>
                    <a class="btn" href="https://www.iobit.com/buy.php?product=2020ascdb2497&ref=en-ascdbanniversary<?php echo $refStr ?>&aff=<?php echo $_GET['aff'] ?>&refs=purchase_anni" onclick="ga('send', 'event', 'ascdbbuy', 'buy', 'purchase-2021anni')">Buy Now</a>
                  </dd>
                </dl>
              </div>
              <div class="pack-item">
                <dl>
                  ...
                  <dd>
                    <a class="btn" href="https://www.iobit.com/buy.php?product=asciu2295&ref=en-asciuanniversary<?php echo $refStr ?>&aff=<?php echo $_GET['aff'] ?>&refs=purchase_anni" onclick="ga('send', 'event', 'asciubuy', 'buy', 'purchase-2021anni')">Buy Now</a>
                  </dd>
                </dl>
              </div>
            </div>
            ...
            <div class="product-list">
              <div class="product-item mr">
                ...
                <div class="info">
                  ...
                  <a href="https://www.iobit.com/buy.php?product=asc3pc1999&ref=en-asc3pcanniversary<?php echo $refStr ?>&aff=<?php echo $_GET['aff'] ?>&refs=purchase_anni" onclick="ga('send', 'event', 'ascbuy', 'buy', 'purchase-2021anni')" class="btn">Buy Now</a>
                </div>
              </div>
              <div class="product-item mr">
                <div class="img">
                ...
                <div class="info">
                  ...
                  <a class="btn" href="https://www.iobit.com/buy.php?product=db3pc2295&ref=en-db3pcanniversary<?php echo $refStr ?>&aff=<?php echo $_GET['aff'] ?>&refs=purchase_anni" onclick="ga('send', 'event', 'dbbuy', 'buy', 'purchase-2021anni')">Buy Now</a>
                </div>
              </div>
              <div class="product-item">
                ...
                <div class="info">
                  ...
                  <a class="btn" href="https://www.iobit.com/buy.php?product=iu3pc1677&ref=en-iu3pcanniversary<?php echo $refStr ?>&aff=<?php echo $_GET['aff'] ?>&refs=purchase_anni" onclick="ga('send', 'event', 'iubuy', 'buy', 'purchase-2021anni')">Buy Now</a>
                </div>
              </div>
              <div class="product-item mr">
                <div class="img">
                ...
                <div class="info">
                  ...
                  <a class="btn" href="https://www.iobit.com/buy.php?product=imf3pc2399&ref=en-imf3pcanniversary<?php echo $refStr ?>&aff=<?php echo $_GET['aff'] ?>&refs=purchase_anni" onclick="ga('send', 'event', 'imfbuy', 'buy', 'purchase-2021anni')">Buy Now</a>
                </div>
              </div>
              <div class="product-item mr">
                <div class="img">
                ...
                <div class="info">
                  ...
                  <a class="btn" href="https://www.iobit.com/buy.php?product=isu3pc1297&ref=en-isu3pcanniversary<?php echo $refStr ?>&aff=<?php echo $_GET['aff'] ?>&refs=purchase_anni" onclick="ga('send', 'event', 'isubuy', 'buy', 'purchase-2021anni')">Buy Now</a>
                </div>
              </div>
              <div class="product-item">
                <div class="img">
                ...
                <div class="info">
                  ...
                  <a class="btn" href="https://www.iobit.com/buy.php?product=sd3pc1999&ref=en-sd3pcanniversary<?php echo $refStr ?>&aff=<?php echo $_GET['aff'] ?>&refs=purchase_anni" onclick="ga('send', 'event', 'sdbuy', 'buy', 'purchase-2021anni')">Buy Now</a>
                </div>
              </div>
            </div>
          </div>
