...
<html lang="en"> <!-- 12 -->
  <head>
    ...
    <title>IObit Halloween Party with Spooky ‘Under $10’ Deals - Up to 88% OFF</title>
          ...
          <div class="cont-purchase">
            ...
            <ul class="cont-purchase-ul">
              <li data-name="asc-img">
                ...
                <span><i>3 Months / 3 PCs</i><del>$29.99</del></span>
              </li>
              <li data-name="iu-img">
                <b>IObit Uninstaller 11 PRO</b>
                <span><i>3 Months / 3 PCs</i><del>$19.99</del></span>
              </li>
              <li data-name="sd-img">
              ...
              <li data-name="pf-img">
                ...
                <span><i>3 Months / 1 PC</i><del>$19.99</del></span>
              </li>
            </ul>
            <div class="purchase-box">
              ...
              <a href="https://www.iobit.com/buy.php?product=asciusdpf999&ref=en-asciusdpfhalloween<?php echo $refStr?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_halloween" onclick="ga('send', 'event', 'bpackbuy', 'buy', 'purchase-2021halloween')" class="btn_bundle">Get It Now</a>
            </div>
          </div>
        </div>
      </div>
            ...
            <ul>
              <li class="packs-items1">
                ...
                <div class="item-cont">
                  ...
                  <div class="item-cont-main">
                    ...
                    <h2>3 Months / 3 PCs</h2>
                    <ul>
                      <li>Intelligent PC care with AI</li>
                      <li>200% faster system running</li>
                      <li>300% faster Internet speedup</li>
                    </ul>
                    <p><sup>$</sup><span>9.99</span><sup><del>$29.99</del></sup></p>
                    <a href="https://www.iobit.com/buy.php?product=asc3m999&ref=en-aschalloween<?php echo $refStr?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_halloween" onclick="ga('send', 'event', 'ascbuy', 'buy', 'purchase-2021halloween')" class="btn_bundle">Get It Now</a>
                  </div>
                </div>
              </li>
              <li class="packs-items2">
                ...
                <div class="item-cont">
                  ...
                  <div class="item-cont-main">
                    ...
                    <p><sup>$</sup><span>9.99</span><sup><del>$29.99</del></sup></p>
                    <a href="https://www.iobit.com/buy.php?product=db3m999&ref=en-dbhalloween<?php echo $refStr?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_halloween" onclick="ga('send', 'event', 'dbbuy', 'buy', 'purchase-2021halloween')" class="btn_bundle">Get It Now</a>
                  </div>
                </div>
              </li>
              <li class="packs-items3">
                ...
                <div class="item-cont">
                  ...
                  <div class="item-cont-main">
                    ...
                    <p><sup>$</sup><span>9.99</span><sup><del>$19.99</del></sup></p>
                    <a href="https://www.iobit.com/buy.php?product=iu3m999&ref=en-iuhalloween<?php echo $refStr?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_halloween" onclick="ga('send', 'event', 'iubuy', 'buy', 'purchase-2021halloween')" class="btn_bundle">Get It Now</a>
                  </div>
                </div>
              </li>
              <li class="packs-items4">
                ...
                <div class="item-cont">
                  ...
                  <div class="item-cont-main">
                    ...
                    <p><sup>$</sup><span>9.99</span><sup><del>$29.99</del></sup></p>
                    <a href="https://www.iobit.com/buy.php?product=ascu3m999&ref=en-ascuhalloween<?php echo $refStr?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_halloween" onclick="ga('send', 'event', 'ascubuy', 'buy', 'purchase-2021halloween')" class="btn_bundle">Get It Now</a>
                  </div>
                </div>
              </li>
              <li class="packs-items5">
                ...
                <div class="item-cont">
                  ...
                  <div class="item-cont-main">
                    ...
                    <p><sup>$</sup><span>9.99</span><sup><del>$29.99</del></sup></p>
                    <a href="https://www.iobit.com/buy.php?product=imf3m999&ref=en-imfhalloween<?php echo $refStr?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_halloween" onclick="ga('send', 'event', 'imfbuy', 'buy', 'purchase-2021halloween')" class="btn_bundle">Get It Now</a>
                  </div>
                </div>
              </li>
              <li class="packs-items6">
                ...
                <div class="item-cont">
                  ...
                  <div class="item-cont-main">
                    ...
                    <p><sup>$</sup><span>9.99</span><sup><del>$19.99</del></sup></p>
                    <a href="https://www.iobit.com/buy.php?product=isu3m999&ref=en-isuhalloween<?php echo $refStr?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_halloween" onclick="ga('send', 'event', 'isubuy', 'buy', 'purchase-2021halloween')" class="btn_bundle">Get It Now</a>
                  </div>
                </div>
              </li>
              <li class="packs-items7">
                ...
                <div class="item-cont">
                  ...
                  <div class="item-cont-main">
                    <h1>Fast & Deep Defraggler <span><img src="<?php echo $pResUrl; ?>images/pro icon.svg" alt=""></span></h1>
                    <h2>3 Months / 3 PCs</h2>
                    <ul>
                    ...
                    <p><sup>$</sup><span>9.99</span><sup><del>$29.99</del></sup></p>
                    <a href="https://www.iobit.com/buy.php?product=sd3m999&ref=en-sdhalloween<?php echo $refStr?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_halloween" onclick="ga('send', 'event', 'sdbuy', 'buy', 'purchase-2021halloween')" class="btn_bundle">Get It Now</a>
                  </div>
                </div>
              </li>
              <li class="packs-items8">
                ...
                <div class="item-cont">
                  ...
                  <div class="item-cont-main">
                    ...
                    <p><sup>$</sup><span>9.99</span><sup><del>$29.99</del></sup></p>
                    <a href="https://www.iobit.com/buy.php?product=pf3m999&ref=en-pfhalloween<?php echo $refStr?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_halloween" onclick="ga('send', 'event', 'pfbuy', 'buy', 'purchase-2021halloween')" class="btn_bundle">Get It Now</a>
                  </div>
                </div>
              </li>
            </ul>
        ...
        <div class="footer-cont">
          <div class="footer-awards">
            <div class="footer-awards-ins">
              ...
              <div class="intr">
                <h2>Try it RISK FREE - with our 30-day Money Back Guarantee</h2>
                <p>If you're not satisfied in the first 30 days, we will give you<br> back your money.</p>
              </div>
            </div>
