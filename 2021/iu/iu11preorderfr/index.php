			...
			<div class="clearfix">
				...
				<div class="right fr">
					...
					<div class="price" data-name="default">
						...
						<a class="buybtn"
						   href="https://www.iobit.com/buy.php?product=fr-iu11preorder&ref=fr_iu11preorder<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=fr_purchase_iu"
						   onclick="ga('send', 'event', 'iubuy', 'buy', 'iu11preorder-fr');">
						  Vite, J’en Profite
						</a>
					</div>
				</div>
