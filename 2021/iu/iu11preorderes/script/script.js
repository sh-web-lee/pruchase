...
function soldOut() {
	...
	$(".buybtn").attr({
		"href": 'https://www.iobit.com/buy.php?product=es-iu11preorder1599&ref=es_iu11preordersoldout' + refStr + '&aff=' + aff + '&refs=es_purchase_iu&tw=' + tw,
		"onclick": "ga('send', 'event', 'iusoldbuy', 'buy', 'iu11predorder-es');"
	});
}
// soldOut();
var c =0;
