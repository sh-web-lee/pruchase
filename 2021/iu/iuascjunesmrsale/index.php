  ...
  <div class="wrapper">
    ...
    <div class="container clearfix">
      <dl class="left">
        ...
        <dd><span>$<strong>19.99 </strong></span><del>$59.93</del></dd>
        <dd>
          <a class="buybtn small"
             href="https://www.iobit.com/buy.php?product=iu11pro3pc1999&ref=en-iu3pciuasc<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=purchase-iu"
        ...
        <dd class="last">
          ...
          <p><img src="<?php echo $pResUrl; ?>images/greenmark.png" alt=""><del>$59.93</del> Save $39.94</p>
        </dd>
      </dl>
      <dl class="right">
        ...
        <dd><span>$<strong>22.95 </strong></span><del>$149.9</del></dd>
        <dd>
          <a class="buybtn"
             href="https://www.iobit.com/buy.php?product=asc15iu3pc&ref=en-iuasc3pciuasc<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=purchase-iu"
        ...
        <dd class="last">
          ...
          <p><img src="<?php echo $pResUrl; ?>images/greenmark.png" alt=""><del>$149.9</del>  Save <strong>$126.95</strong></p>
        </dd>
      </dl>
    </div>
  </div>
...
<div class="product">
  ...
  <div class="wrapper">
    ...
    <dl class="right">
      ...
      <dd><img src="<?php echo $pResUrl; ?>images/blackmark.png" alt="">Easily Uninstall 1000+ Stubborn Programs</dd>
      <dd><img src="<?php echo $pResUrl; ?>images/blackmark.png" alt="">Auto Clean Leftovers Failed to Remove by Other Utilities</dd>
      <dd><img src="<?php echo $pResUrl; ?>images/blackmark.png" alt="">Remove Malware And Malicious Plug-ins For Safer PC</dd>
      <dd><img src="<?php echo $pResUrl; ?>images/blackmark.png" alt="">Record And Revert System Changes Made by Program lnstallations</dd>
      <dd><img src="<?php echo $pResUrl; ?>images/blackmark.png" alt="">Update All Your lmportant Software With 1-Click</dd>
...
<!-- end product -->
<!-- windows -->
<p class="wrapper windows"><img src="<?php echo $pResUrl; ?>images/windows.png" alt="">Compatible with Windows 11, 10, 8, 7, Vista, xp sp3</p>
<!-- end windows -->
<!-- foot-banner -->
<div class="foot-banner">
  ...
  <div class="wrapper">
    ...
    <dl>
      <dt>ONLY <strong> <b>$</b>22.95</strong> <del>$149.9</del></dt>
      <dd>
        <a href="https://www.iobit.com/buy.php?product=asc15iu3pc&ref=en-iuasc3pciuasc<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=purchase-iu"
           onclick="ga('send', 'event', 'asciubuy', 'buy', ' iupurchase-asc201612');"
           class="buybtn bottom">
          Activate Now
        </a>
