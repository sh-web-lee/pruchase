			...
			<div class="clearfix">
				...
				<div class="right fr">
					...
					<div class="price" data-name="default">
						...
						<a class="buybtn"
						   href="https://www.iobit.com/buy.php?product=nl-iu11preorder1499&ref=nl_iu11preorder1499<?php echo $refStr;?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_iu"
						   onclick="ga('send', 'event', 'iubuy', 'buy', 'iu11preorder-nl');">
						  Bestel Nu
						</a>
					</div>
				</div>
		...
		<div class="wrapper">
			...
			<div class="message">
				<dl data-name="default" class="one">
					...
					<dd>
						<h3>Registreer Wijzigingen <i class="first-tag">VERBETERD</i></h3>
				...
				<dl data-name="default" class="two">
					...
					<dd>
						<h3>Hardnekkige Software Verwijderen <i class="second-tag">1000+</i></h3>
				...
				<dl data-name="default" class="three">
					...
					<dd>
						<h3>Software Health <i class="third-tag">VERNIEUWD</i></h3>
						<p>Volledig vernieuwde Software Health houdt alle software op uw pc in goede staat, herstelt overbodige toestemmingen en blokkeert notificaties.</p>
					</dd>
				</dl>
			</div> 
		</div>
	...
	<div class="bottom">
		<div class="wrapper">
			<dl class="annotation">
				<dt>Opmerking: </dt>
				<dd>
					U kunt direct na de bestelling aan de slag met de RC versie van IObit Uninstaller 11 PRO. Deze versie bevat vrijwel alle functies van de definitieve versie. Bij de officiële lancering van IObit Uninstaller 11 PRO, laten we u weten dat u kunt updaten naar de definitieve versie.
				</dd>
			</dl>
