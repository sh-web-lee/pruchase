...
function soldOut() {
	...
	$(".banner h2,.floatlayer .number").html("Adquira o melhor desinstalador com <strong>40% OFF</strong>");
	$(".price").find("strong").html("R$ 59,99");
	$(".buybtn").attr({
		"href": 'https://www.iobit.com/buy.php?product=pt-iu11preorder5999&ref=pt-iu11preordersoldout' + refStr + '&aff=' + aff + '&tw=' + tw,
		"onclick": "ga('send', 'event', 'iubuy', 'buy', 'iu11preordersoldout-pt');"
	});
}
// soldOut();
