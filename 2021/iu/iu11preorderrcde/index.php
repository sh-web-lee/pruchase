...
<head>
  ...
  <title> Zahlen Sie 0 €, um IObit Uninstaller 11 PRO zu erhalten</title>
...
<div class="container">
    ...
    <div class="wrapper">
      ...
      <div class=" content clearfix">
        ...
        <div class="right fr">
          ...
          <h3 data-name="default">Begrenzt auf die ersten 500 Kunden pro Tag</h3>
          <!-- number -->
          ...
          <div class="price" data-name="default">
            ...
            <!-- buybtn -->
            <a class="buybtn"
              href="https://www.iobit.com/buy.php?product=de-iu11preorder&ref=de_iu11preorderrc<?php echo $refStr; ?>&aff=<?php echo $_GET['aff']?>&refs=de_purchase_iu"
  ...
  <div class="feature">
    <div class="wrapper">
      <!-- title -->
      <h2>Entfernen von unerwünschten Programmen und Datenresten <br> IObit Uninstaller 11 PRO macht Deinstallation einfacher, sauberer and sicherer. </h2>
      <!-- content -->
      <div class="content">
        <!-- feature-nav -->
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="text">Aktualisiert sich automatisch auf die neueste Version </td>
            <td class="free"><i class="all-icons">×</i></td>
            <td class="pro"><i class="all-icons">√</i></td>
          </tr>
          <!-- 11 -->
