...
function soldOut() {
  ...
  $(".buybtn").attr({
    "href": 'https://www.iobit.com/buy.php?product=iu11preorder1477&ref=en-iu11preordersoldout' + refStr + '&aff=' + aff + '&refs=purchase_iu&tw=' + tw,
    "onclick": "ga('send', 'event', 'iusoldbuy', 'buy', 'iu11preorder');",
  });
  $(".sec4 .buybtn").html("Get PRO Now")
}
// soldOut();
