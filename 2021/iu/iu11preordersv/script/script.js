...
function soldOut() {
	...
	$(".buybtn").attr({
		"href": 'https://www.iobit.com/buy.php?product=sv-iu11preorder239&ref=sv_iu11preordersoldout&aff=' + aff + '&refs=sv_purchase_iu&tw=' + tw,
		"onclick": "ga('send', 'event', 'iusoldbuy', 'buy', 'iu11predorder-sv');"
	});
}
// soldOut();
var c =0;
