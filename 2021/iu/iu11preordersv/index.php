		...
		<div class="wrapper">
            ...
            kvar nu
					...
					<div class="price" data-name="default">
						...
						<a class="buybtn"
						   href="https://www.iobit.com/buy.php?product=sv-iu11preorder&ref=sv_iu11preorder<?php echo $refStr; ?>&aff=<?php echo $_GET['aff']?>&refs=sv_purchase_iu"
						   onclick="ga('send', 'event', 'iubuy', 'buy', 'iu11predorder-sv');">
              Förbeställ Nu
            </a>
					</div>
				</div>
		...
		<div class="wrapper">
			...
			<dl data-name="default" class="three">
				<dt><img src="<?php echo getStaticUrl('images/feature-icon06.png')?>" alt=""></dt>
		 		<dd>
		 			<h3>Hantera behörigheter</h3>
		 			<p>Hantera schemalagda uppgifter och programvaror som startar automatiskt efter start.</p>
		 		</dd>
			</dl>
		</div>
	</div>
