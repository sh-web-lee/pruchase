...
function soldOut() {
	...
	flipNum(0, 2);
	$(".banner .number").html("");
	$(".banner h2").html("Zdobądź najlepszy deinstalator z<br><strong>67% ZNIŻKI</strong>");
	$(".floatlayer .number").html('Zdobądź najlepszy deinstalator z <strong> 67% ZNIŻKI</strong>');
	$(".price").find("strong").html("64,90zł<del>199,90zł</del>")
	$(".buybtn").attr({
		"href": 'https://www.iobit.com/buy.php?product=pl-iu11preorder64&ref=pl_iu11preordersoldout64' + refStr + '&aff=' + aff + '&refs=pl_purchase_iu&tw=' + tw,
		"onclick": "ga('send', 'event', 'iubuy', 'buy', 'iu11preordersoldout-pl');"
	});
}
// soldOut();
var c =0;
...
function getReTime() {
	var packsNumTotal = cGet('pliujune_t');
