...
<head>
  ...
  <title>Ottieni il nuovo IObit Uninstaller PRO per 0€</title>
...
<div class="container">
  ...
  <div class="banner" data-name="animation">
    <div class="wrapper">
      ...
      <div class="top clearfix">
        ...
        <!-- icon -->
        <div class="icon"><img src="<?php echo getStaticUrl('images/iu-icon.png')?>" alt=""> IObit Uninstaller 11</div>
      </div>
      <!-- content -->
      <div class=" content clearfix">
        ...
        <!-- right -->
        <div class="right fr">
          <h1 data-name="default">Prevendita IObit Uninstaller 11 PRO</h1>
          <h2 data-name="default">Ottieni la versione PRO per 0€</h2>
          <h3 data-name="default"> Solo per i primi 500 utenti giornalieri</h3>
          <!-- number -->
          ...
          <div class="price" data-name="default">
            ...
            <!-- buybtn -->
            <a class="buybtn"
               href="https://www.iobit.com/buy.php?product=it-iu11preorder&ref=it_iu11preorderrc<?php echo $refStr; ?>&aff=<?php echo $_GET['aff']?>&refs=it_purchase_iu"
               onclick="ga('send', 'event', 'iubuy', 'buy', 'iu11preorderrc-it');">
              OTTIENILO ORA
            </a>
          </div>
        </div>
  ...
  <div class="feature">
    <div class="wrapper">
      <!-- title -->
      <h2>Rimuove i programmi indesiderati e le tracce della privacy in profondità</h2>
      <h3>IObit Uninstaller 11 PRO rende la disinstallazione più facile, veloce e pulita.</h3>
      <!-- content -->
      <div class="content">
        <!-- feature-nav -->
        ...
        <div class="feature-container clearfix">
          ...
          <div class="detail-list fr" id="wheelUl">
            <!-- one -->
            <div class="detail">
              <h3>Disinstalla qualsiasi programma, plugin e app di Windows</h3>
              <ul>
            ...
            <!-- three -->
            <div class="detail">
              <h3><br>Riduce i rischi e aumenta la sicurezza del PC</h3>
              <ul>
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="text">Scansiona i residui per una disinstallazione standard</td>
            <td class="free"><i class="all-icons yes">√</i></td>
            <td class="pro"><i class="all-icons">√</i></td>
          </tr>
          <!-- 03 -->
