...
$refStr='';
if(in_array($_GET['st'],array('dbxmasr'))){$refStr='-'.$_GET['st'];}
...
$refStr .= empty($_GET['pdt']) ? '' : '-'.$_GET['pdt'];
...
<body id="body">
	...
	<div class="banner-wrap">
		<div class="banner">
			<a class="logo" target="_blank" href="https://www.iobit.com/en/index.php"></a>
			<div class="banner-title"><img src="<?php echo getStaticUrl('images/newtitle.png')?>" style="margin-right: -40px;" /></div>
	...
	<div class="float-footer">
		<div class="content planA" style="display: block;">
			...
			<div class="font-layer">
				<p style="font-size: 16px; font-weight: 700; color: #8b1401;">80% OFF to Get Annual Plan for 3 PCs</p>
