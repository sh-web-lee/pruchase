...
function soldout() {
	...
	$(".buybtn").attr({
		"href": 'https://www.iobit.com/buy.php?product=db9preorder2295&ref=en-db9preorderofficialsoldout' + refStr + '&aff=' + aff + '&refs=purchase_db&tw=-8',
		"onclick": "ga('send', 'event', 'db3pcbuy', 'buy', 'db9preorderofficial');"
	})
