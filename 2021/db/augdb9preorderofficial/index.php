      ...
      <div class="offer clearfix">
        ...
        <div class="right">
          ...
          <div class="price">
            ...
            <a href="https://www.iobit.com/buy.php?product=db9preorder&ref=en-db9preorderofficial<?php echo $refStr; ?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_db"
               onclick="ga('send', 'event', 'dbbuy', 'buy', 'db9preorderofficial');" class="buybtn">Pre-order Now</a>
          </div>
          <div class="numbox">
            <h3>
  ...
  <div class="feature">
    <div class="message01 wrapper">
      ...
      <div class="message-box">
        ...
        <dl>
          <dt><i></i>Safe Driver Backup & Restore</dt>
          <dd>Automatically back up drivers before they are properly  <br> installed. Keep multiple backup driver versions for safe <br>  restore when necessary.</dd>
        </dl>
        <dl>
          <dt><i></i>Fix Hardware Issues </dt>
          <dd>Provide 1-click solution to fix 50+ device errors, and <br> problems of unclear sound, dropped Internet con- <br> nection, and external device not working.</dd>
        </dl>
        <dl>
    ...
    <div class="feature-list" data-name='animation'>
      ...
      <div class="wrapper">
        ...
        <dl class="center two" data-name='default'>
          ...
          <dd>
            <h3>Fast Download</h3>
            <p>Accelerate driver download <br> speed up to 100% faster.</p>
          </dd>
        </dl>
...
<div class="floatlayer clearfix">
  <div class="wrapper clearfix">
    ...
    <div class="price fr">
     ...
     <span></span>
        <a class="buybtn"
           href="https://www.iobit.com/buy.php?product=db9preorder&ref=en-db9preorderofficial<?php echo $refStr; ?>&aff=<?php echo $_GET['aff'];?>&refs=purchase_db"
           onclick="ga('send', 'event', 'dbbuy', 'buy', 'db9preorderofficial');">
          Pre-order Now
        </a>
    </div>
  </div>
