...
<head>
  <meta charset="UTF-8">
  <title>Pay $0 to Upgrade to Driver Booster 9 PRO - IObit</title>
      ...
      <div class="offer clearfix">
        ...
        <div class="right">
          ...
          <div class="price">
            ...
            <a class="buybtn" href="https://www.iobit.com/buy.php?product=db9preorder&ref=en-db9preorderpre<?php echo $refStr; ?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'db9preorderpre');">Upgrade Now</a>
          </div>
          <div class="numbox">
            <h3>
      ...
      <div class="message-box">
        ...
        <dl class='one'>
          <dt><i></i>
            ...
            Driver Database
            <span class='soportes green_soportes'>56% <img src="<?php echo getStaticUrl('images/subir.png') ?>" alt=""></span></dt>
          <dd>Supports 8,000,000+ drivers now, and provides precisely matched updates for all outdated, mismatched or missing drivers.</dd>
        </dl>
        <dl class='two'>
          <dt><i></i>
            <em>
            ...
            Backup & Restore
            <span class='soportes yellow_soportes'>Improved </span></dt>
          <dd>Automatically back up drivers before they are properly installed. Keep multiple backup driver versions for safe restore when necessary.
            <br/>
        ...
        <dl class='three'>
          <dt><i></i>
            ...
            Game Boost
            <span class='soportes yellow_soportes'>Improved </span></dt>
          <dd>Helps users easily activate Game Mode in Windows 10 and optimizes PC performance for play in just 1 click.</dd>
        </dl>
        <dl class='four'>
          <dt><i></i>
            <em>
            ...
            Issue Fix
            <span class='soportes yellow_soportes'>Improved</span></dt>
          <dd>1-Click to check & fix 50+ device errors, sound or connection problems, mouse or printer issues, etc.</dd>
        </dl>
    ...
    <div class="feature-list" data-name='animation'>
      ...
      <div class="wrapper">
        ...
        <ul class='benefits-ul'>
          ...
          <li>
            <i class='_icon'></i>
            <span>Super-huge database with 8,000,000+ drivers support</span>
            <div class='_booster'>
              <img src="<?php echo getStaticUrl('images/true.png') ?>" alt="">
            </div>
            <div class='_version'>
          ...
          <li>
            <i class='_icon'></i>
            <span>Easily fix 50+ device errors for better performance</span>
            <div class='_booster'>
              <img src="<?php echo getStaticUrl('images/true.png') ?>" alt="">
            </div>
            <div class='_version'>
  ...
  <div class="floatlayer clearfix">
    <div class="wrapper clearfix">
      ...
      <div class="price fr">
        <strong>$0 <sup>*</sup></strong>
        <span></span>
        <a class="buybtn" href="https://www.iobit.com/buy.php?product=db9preorder&ref=en-db9preorderpre<?php echo $refStr; ?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_db" onclick="ga('send', 'event', 'dbbuy', 'buy', 'db9preorderpre');">
          Upgrade Now
        </a>
      </div>
    </div>
