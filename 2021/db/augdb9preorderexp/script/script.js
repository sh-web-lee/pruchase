...
function soldout() {
	...
	$(".floatlayer .numbox").html(' Renew the NO.1 Driver Updater with <strong>70% OFF</strong>');
	$(".buybtn").attr({
		"href": 'https://www.iobit.com/buy.php?product=db9preorder2295&ref=en-db9preorderexpsoldout' + refStr + '&aff=' + aff + '&refs=purchase_db&tw=-8',
		"onclick": "ga('send', 'event', 'db3pcbuy', 'buy', 'db9preorderexp');"
	})
	$(".banner .buybtn").html("Renew Now – 70% OFF");
}
function seview() {
			...
			if (flag) {
				...
				setTimeout(function() {
					...
					if($(".message02 .updated").text()!=0) {
						$(".message02 .message-box strong").addClass("on");
