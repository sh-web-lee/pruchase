...
if ($_GET['action'] == 'getPacks') {
	$date = $_GET['d'];
	$c_name = 'isuxmas2020_p' . $date;
	$c_name_t='isuxmas2020_t' . $date;
...
<head>
	...
	<title>Save 80% OFF on IObit Software Updater PRO and valuable gift pack - IObit</title>
...
<body>
	...
	<div class="banner">
		<div class="wrapper">
          ...
          <p class="price">
            ...
            <a href="https://www.iobit.com/buy.php?product=isu43pcsdpf&ref=en-isu3pcsdpf<?php echo $refStr;?>&aff=<?php echo $_GET['aff']?>&refs=purchase_isu" onclick="ga('send', 'event', 'isubundlebuy', 'buy', 'isupurchase');  " class="buybtn">Activate Now</a>
          </p>
          <ul class="list">
          	<li>
	...
	<div class="intro">
		<div class="wrapper clearfix">
			<h2>Why IObit Software Updater 4 PRO?</h2>
			...
			<div class="right-message">
				...
				<dl>
					...
					<dd><strong>Real-time & Automatic</strong> Automatically update programs at the scheduled time or simply update them in real-time once updates are available. </dd>
				</dl>
				<dl>
	...
	<div class="feature">
		<div class="wrapper">
			<h2> IObit Software Updater 4 PRO Can Serve You Better</h2>
			<div class="clearfix">
				<div class="left fl">
				...
				<div class="right fr">
					<ul class="feature-list">
						<li><i class="all-icons">◎</i> 1-click to update all software (<span>Free version: 2 per day</span>)</li>
						...
						<li><i class="all-icons">◎</i> Automatically update outdated programs in real-time</li>
...
<script>
  ...
  var _imgSrc = "<?php echo getStaticUrl('images/sold-fl-box.png')?>";
</script>
