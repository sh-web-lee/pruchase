...
<div id="main">
    ...
    <div class="intro">
      ...
      <div class="discount">
          ...
          <div class="wprice">SLECHTS <em>€3,99</em> <del>€29,99</del><span>1-jarig abonnement / 1 PC</span></div>
          <div class="btnarea">
            <a href="https://www.iobit.com/buy.php?product=nl-sd6-ac&ref=nl_sd-ac-register<?php echo $refStr;?>&aff=&refs=nl_ac_sd" onclick="ga('send', 'event', 'sdbuy', 'buy', 'sdac-nl')" class="checkbtn">Koop nu >></a>
    ...
    <div class="checkout">
    	<div class="moneyback">
      	U bent volledig beschermd door ons 100% geld terug garantie programma, en u ZULT een aanzienkelijke verbetering in uw PC prestaties’s ervaren BINNEN 60 dagen. Zo niet, dan verzorgen wij een volledige terugbetaling, zonder vragen te stellen. <a href="https://www.iobit.com/buy.php?product=nl-sd6-ac&ref=nl_sd-ac-register<?php echo $refStr;?>&aff=&refs=nl_ac_sd" onclick="ga('send', 'event', 'sdbuy', 'buy', 'sdac-nl')">Koop nu</a>
      </div>
      <div class="btn">
      	<a href="https://www.iobit.com/buy.php?product=nl-sd6-ac&ref=nl_sd-ac-register<?php echo $refStr;?>&aff=&refs=nl_ac_sd" title="CHECKOUT" onclick="ga('send', 'event', 'sdbuy', 'buy', 'sdac-nl')" class="checkbtn">Koop nu >></a>
        <span>100% geld terug garantie</span>
      </div>
    </div>
    <div class="clear"></div>
