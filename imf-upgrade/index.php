            ...
            <div class="lace">
              ...
              <div class="control">
                <ul>
                  ...
                  <li class="link"><a href="http://www.iobit.com/buy.php?product=imfpfebook&ref=<?php echo $_GET['ref']; ?>&aff=<?php echo $_GET['aff']; ?>&refs=purchase_imf" onclick="ga('send', 'event', 'imfbuy', 'buy', 'imfpurchase');">ACTIVATE NOW</a></li>
